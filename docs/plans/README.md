...
| M4 wave 10 — collision-derived navmesh rebuild; portal quarantine, preferred costs, setlock init | [M4_WAVE10_PROMPT.md](M4_WAVE10_PROMPT.md) | [M4_WAVE10_PLAN.md](M4_WAVE10_PLAN.md) — see "Shipped amendments" (A1–A6) | PR pending (#162, #168, #169; #153 substantially delivered, #148 carried by #171); follow-ups #171, #172; manual script [M4_WAVE10_MANUAL.md](M4_WAVE10_MANUAL.md) |
| M4 wave 11 — finish the navmesh saga; start AI packages | [M4_WAVE11_PROMPT.md](M4_WAVE11_PROMPT.md) | [M4_WAVE11_PLAN.md](M4_WAVE11_PLAN.md) — see "Shipped amendments" (A1–A6) | PR pending (#171, #175, #176, #180; #172 closed as premise-disproven, #148 carried by #177); follow-ups #177, #179, #181; manual script [M4_WAVE11_MANUAL.md](M4_WAVE11_MANUAL.md) |
