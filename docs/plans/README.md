...
| M4 AI-packages wave — autonomous AI: packages, families, perception, key-aware doors | [M4_AI_PACKAGES_PROMPT.md](M4_AI_PACKAGES_PROMPT.md) | [M4_AI_PACKAGES_PLAN.md](M4_AI_PACKAGES_PLAN.md) — see "Shipped amendments" | PR #214 (#193–#198, #116, #185); follow-up #213 (deferred package-location subrecords); manual script [M4_AI_PACKAGES_MANUAL.md](M4_AI_PACKAGES_MANUAL.md) |
| M4 package-points — patrol linked-ref chains + editor-location resolution | [M4_PACKAGE_POINTS_PROMPT.md](M4_PACKAGE_POINTS_PROMPT.md) | [M4_PACKAGE_POINTS_PLAN.md](M4_PACKAGE_POINTS_PLAN.md) — see "Shipped amendments" | PR #223 (#213); follow-up #222 (radius not FO3-scaled); manual script [M4_PACKAGE_POINTS_MANUAL.md](M4_PACKAGE_POINTS_MANUAL.md) |
| M4 gate wave — Sandbox/patrol unblockers and final M4 gate | [M4_GATE_WAVE_PROMPT.md](M4_GATE_WAVE_PROMPT.md) | [M4_GATE_WAVE_PLAN.md](M4_GATE_WAVE_PLAN.md) | Planned (#222, #231, #242, #10); manual script [M4_GATE_WAVE_MANUAL.md](M4_GATE_WAVE_MANUAL.md) |
...
| M5 wave 3 — weapon condition, degradation, jams, deterministic combat RNG | [M5_WAVE3_PROMPT.md](M5_WAVE3_PROMPT.md) | [M5_WAVE3_PLAN.md](M5_WAVE3_PLAN.md) | PR #271 (#262, #263, #266, #265); manual script [M5_WAVE3_MANUAL.md](M5_WAVE3_MANUAL.md) |
| M6 wave 1 — native exterior decision, contracts, packages, first streaming lifecycle | [M6_WAVE1_PROMPT.md](M6_WAVE1_PROMPT.md) | [M6_WAVE1_PLAN.md](M6_WAVE1_PLAN.md) — see "Shipped amendments"; continuation [M6_CONTINUATION_ROADMAP.md](M6_CONTINUATION_ROADMAP.md) | foundation merged in PR #261; #13 continues; manual script [M6_WAVE1_MANUAL.md](M6_WAVE1_MANUAL.md) |
| M6 wave 2 — streaming reliability and measured process memory | [M6_WAVE2_PROMPT.md](M6_WAVE2_PROMPT.md) | [M6_WAVE2_PLAN.md](M6_WAVE2_PLAN.md) | in progress (#274, #275); manual script [M6_WAVE2_MANUAL.md](M6_WAVE2_MANUAL.md) |
| M6 wave 3 — actor residency and lifecycle-safe NAVM policy | [M6_WAVE3_PROMPT.md](M6_WAVE3_PROMPT.md) | [M6_WAVE3_PLAN.md](M6_WAVE3_PLAN.md) | policy lanes integrated (#276, #277); runtime #278 blocked by #10; manual [M6_WAVE3_MANUAL.md](M6_WAVE3_MANUAL.md) |
| M6 wave 4 — exact travel, persistence, and player physics | [M6_WAVE4_PROMPT.md](M6_WAVE4_PROMPT.md) | [M6_WAVE4_PLAN.md](M6_WAVE4_PLAN.md) | policy lanes integrated (#279, #280); W4-C runtime integration pending |
| M6 wave 5 — environment and lighting isolation | [M6_WAVE5_PROMPT.md](M6_WAVE5_PROMPT.md) | [M6_WAVE5_PLAN.md](M6_WAVE5_PLAN.md) | policy lanes integrated (#281, #282); W5-C runtime integration pending |
| M6 wave 6 — bounded-route convergence preparation | [M6_WAVE6_PROMPT.md](M6_WAVE6_PROMPT.md) | [M6_WAVE6_PLAN.md](M6_WAVE6_PLAN.md) | W6-A diagnostics and W6-B current-data protocol integrated; W6-C #285 tracks threshold sign-off; W7 held for runtime dependencies |
| PERF wave 1 — verified idle-frame quick wins: zero-write shadow path, change-driven HUDs, event-driven AO/glow, one material-clamp owner | [PERF_WAVE1_PROMPT.md](PERF_WAVE1_PROMPT.md) | [PERF_WAVE1_PLAN.md](PERF_WAVE1_PLAN.md) — see "Shipped amendments" (A1–A3) | PR #272 (#267, #268, #269, #270; standalone, no epic); manual script [PERF_WAVE1_MANUAL.md](PERF_WAVE1_MANUAL.md) |
...
| M4 autonomous-actors — on-load auto-bind + patrol + animation, ECS roster, native clips | [M4_AUTONOMOUS_ACTORS_PROMPT.md](M4_AUTONOMOUS_ACTORS_PROMPT.md) | [M4_AUTONOMOUS_ACTORS_PLAN.md](M4_AUTONOMOUS_ACTORS_PLAN.md) — see "Shipped amendments" | PR #228 (#215, #218, #224, #225; stacked on #213); follow-ups #226 (creature clips), #227 (turn oscillation), #231/#242 (patrol arrival/dwell); manual script [M4_AUTONOMOUS_ACTORS_MANUAL.md](M4_AUTONOMOUS_ACTORS_MANUAL.md) |
| M5 gate-support — ImageSpace/IMAD screen feedback + M4A actor gate evidence | [M5_SCREENFX_M4A_PROMPT.md](M5_SCREENFX_M4A_PROMPT.md) | [M5_SCREENFX_M4A_PLAN.md](M5_SCREENFX_M4A_PLAN.md) | PR #260 (#96, #86); manual script [M5_SCREENFX_M4A_MANUAL.md](M5_SCREENFX_M4A_MANUAL.md) |
