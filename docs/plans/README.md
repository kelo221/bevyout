...
| M4 wave 4 — travel-door navigation and intercell agents | [M4_WAVE4_PROMPT.md](M4_WAVE4_PROMPT.md) | [M4_WAVE4_PLAN.md](M4_WAVE4_PLAN.md) | PR #135 (#113, #134); follow-ups #137/#138 landed in PR #140 and #136 in PR #149; manual script [M4_WAVE4_MANUAL.md](M4_WAVE4_MANUAL.md) |
| M4 wave 5 — grounded movement, mid-route door gating, tnm path | [M4_WAVE5_PROMPT.md](M4_WAVE5_PROMPT.md) | [M4_WAVE5_PLAN.md](M4_WAVE5_PLAN.md) | PR #140 (#114, #137, #138); #136 completed in PR #149; manual script [M4_WAVE5_MANUAL.md](M4_WAVE5_MANUAL.md) |
...
| M4 wave 7 — actor assembly and deterministic appearance fallbacks | [M4_WAVE7_PROMPT.md](M4_WAVE7_PROMPT.md) | [M4_WAVE7_PLAN.md](M4_WAVE7_PLAN.md) — see "Shipped amendments" (A1–A5) | PR #160 (#107, #108); manual script [M4_WAVE7_MANUAL.md](M4_WAVE7_MANUAL.md) |
| M4 wave 8 — nav correctness: portals, door topology, stuck progress, setlock | [M4_WAVE8_PROMPT.md](M4_WAVE8_PROMPT.md) | [M4_WAVE8_PLAN.md](M4_WAVE8_PLAN.md) — see "Shipped amendments" (A1–A8) | PR #166 (#154, #155, #157, #163); follow-ups #162/#164/#165 landed in PRs #173/#170; manual script [M4_WAVE8_MANUAL.md](M4_WAVE8_MANUAL.md) |
| M4 wave 9 — nav follow-ups: lock-respecting travel hand-off, fall-out guard + collision root cause, authored NAVM semantics | [M4_WAVE9_PROMPT.md](M4_WAVE9_PROMPT.md) | [M4_WAVE9_PLAN.md](M4_WAVE9_PLAN.md) — see "Shipped amendments" (A1–A5) | PR #170 (#165, #164, #156; #148 remains open as a root-cause follow-up); #168/#169 landed in PR #173; manual script [M4_WAVE9_MANUAL.md](M4_WAVE9_MANUAL.md) |
| M4 wave 10 — collision-derived navmesh rebuild; portal quarantine, preferred costs, setlock init | [M4_WAVE10_PROMPT.md](M4_WAVE10_PROMPT.md) | [M4_WAVE10_PLAN.md](M4_WAVE10_PLAN.md) — see "Shipped amendments" (A1–A6) | PR #173 (#162, #168, #169, #153); #171/#172 landed in PR #182; manual script [M4_WAVE10_MANUAL.md](M4_WAVE10_MANUAL.md) |
| M4 wave 10 — actor KF compatibility and animation zoo | [M4_WAVE10_ACTOR_PROMPT.md](M4_WAVE10_ACTOR_PROMPT.md) | [M4_WAVE10_ACTOR_PLAN.md](M4_WAVE10_ACTOR_PLAN.md) — see "Shipped amendments" | PR #183 (#104) plus PR #187 (#106); manual script [M4_WAVE10_ACTOR_MANUAL.md](M4_WAVE10_ACTOR_MANUAL.md) |
| M4 wave 11 — finish the navmesh saga; start AI packages | [M4_WAVE11_PROMPT.md](M4_WAVE11_PROMPT.md) | [M4_WAVE11_PLAN.md](M4_WAVE11_PLAN.md) — see "Shipped amendments" (A1–A6) | PR #182 (#171, #175, #176, #180; #172 closed as premise-disproven); #177 landed in doors PR #192, while #179/#181 remain follow-ups; manual script [M4_WAVE11_MANUAL.md](M4_WAVE11_MANUAL.md) |
...
| M4 wave 13 — actor state and persistence | [M4_WAVE13_ACTOR_PROMPT.md](M4_WAVE13_ACTOR_PROMPT.md) | [M4_WAVE13_ACTOR_PLAN.md](M4_WAVE13_ACTOR_PLAN.md) | PR #200 (#110); manual script [M4_WAVE13_ACTOR_MANUAL.md](M4_WAVE13_ACTOR_MANUAL.md) |
| M4 doors wave — doors as real blockers, agents that open them, ORCA stall | (see plan §"Why this wave existed") | [M4_DOORS_WAVE_PLAN.md](M4_DOORS_WAVE_PLAN.md) — see "Shipped amendments" (A1–A4) | PR #192 (#177, #184); #148 remains an open collision follow-up; post-mortem in [docs/postmortem/](../postmortem/VERDICT.md); manual script [M4_DOORS_WAVE_MANUAL.md](M4_DOORS_WAVE_MANUAL.md) |
...
| M4 HeadAnims wave — actor animation stale-cache finding + regression tests | [M4_HEADANIMS_PROMPT.md](M4_HEADANIMS_PROMPT.md) | [M4_HEADANIMS_PLAN.md](M4_HEADANIMS_PLAN.md) — see "Outcome" | PR #207; #206 was a stale actor-GLB cache finding (regression tests retained), #205 closed as not-needed; manual script [M4_HEADANIMS_MANUAL.md](M4_HEADANIMS_MANUAL.md) |
| M4 AI-packages wave — autonomous AI: packages, families, perception, key-aware doors | [M4_AI_PACKAGES_PROMPT.md](M4_AI_PACKAGES_PROMPT.md) | [M4_AI_PACKAGES_PLAN.md](M4_AI_PACKAGES_PLAN.md) — see "Shipped amendments" | PR #214 (#193–#198, #116, #185); follow-up #213 landed in PR #223; manual script [M4_AI_PACKAGES_MANUAL.md](M4_AI_PACKAGES_MANUAL.md) |
| M4 package-points — patrol linked-ref chains + editor-location resolution | [M4_PACKAGE_POINTS_PROMPT.md](M4_PACKAGE_POINTS_PROMPT.md) | [M4_PACKAGE_POINTS_PLAN.md](M4_PACKAGE_POINTS_PLAN.md) — see "Shipped amendments" | PR #223 (#213); follow-up #222 (radius not FO3-scaled) remains open; manual script [M4_PACKAGE_POINTS_MANUAL.md](M4_PACKAGE_POINTS_MANUAL.md) |
| M4 autonomous-actors — on-load auto-bind + patrol + animation, ECS roster, native clips | [M4_AUTONOMOUS_ACTORS_PROMPT.md](M4_AUTONOMOUS_ACTORS_PROMPT.md) | [M4_AUTONOMOUS_ACTORS_PLAN.md](M4_AUTONOMOUS_ACTORS_PLAN.md) — see "Shipped amendments" | PR #228 (#215, #218, #224, #225); agent-set follow-up #241 is closed, while #226 (creature clips) and #227 (turn oscillation) remain open; manual script [M4_AUTONOMOUS_ACTORS_MANUAL.md](M4_AUTONOMOUS_ACTORS_MANUAL.md) |
...
| Standalone Yarn dialogue — replaceable dialogue-flow adapter | [DIALOGUE_YARN_ROADMAP.md](DIALOGUE_YARN_ROADMAP.md) | Waves [0–9](DIALOGUE_YARN_ROADMAP.md#delivery-sequence) — prompt/plan pairs are linked from the roadmap | Planned; manual scripts are added before each implementation PR |
