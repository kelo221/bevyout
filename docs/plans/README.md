...
| M6 wave 4 — exact travel, persistence, and player physics | [M6_WAVE4_PROMPT.md](M6_WAVE4_PROMPT.md) | [M6_WAVE4_PLAN.md](M6_WAVE4_PLAN.md) | policy lanes dispatched (#279, #280); W4-C runtime integration pending |
