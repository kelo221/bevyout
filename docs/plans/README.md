...
| M6 wave 3 — actor residency and lifecycle-safe NAVM policy | [M6_WAVE3_PROMPT.md](M6_WAVE3_PROMPT.md) | [M6_WAVE3_PLAN.md](M6_WAVE3_PLAN.md) | policy work in progress (#276, #277); runtime integration blocked by #10 |
