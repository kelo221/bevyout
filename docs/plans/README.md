...
| M6 wave 6 — bounded-route convergence preparation | [M6_WAVE6_PROMPT.md](M6_WAVE6_PROMPT.md) | [M6_WAVE6_PLAN.md](M6_WAVE6_PLAN.md) | W6-A diagnostics and W6-B current-data protocol integrated; W7 held for runtime dependencies and threshold sign-off |
