...
| M4 wave 12 — actor animation game-flow integration | [M4_WAVE12_ACTOR_PROMPT.md](M4_WAVE12_ACTOR_PROMPT.md) | [M4_WAVE12_ACTOR_PLAN.md](M4_WAVE12_ACTOR_PLAN.md) — see "Shipped amendments" | PR-ready (#104 closed by PR #183; #106); manual script [M4_WAVE12_ACTOR_MANUAL.md](M4_WAVE12_ACTOR_MANUAL.md) |
