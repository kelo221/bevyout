...
| M3 wave 1 — OpenMW-based inventory, Pip-Boy Items, persistent dropping | [M3_WAVE1_PROMPT.md](M3_WAVE1_PROMPT.md) | [M3_WAVE1_PLAN.md](M3_WAVE1_PLAN.md) | In progress (#70, #71, #72) |
