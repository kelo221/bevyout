...
| M4 wave 9 — nav follow-ups: lock-respecting travel hand-off, fall-out guard + collision root cause, authored NAVM semantics | [M4_WAVE9_PROMPT.md](M4_WAVE9_PROMPT.md) | [M4_WAVE9_PLAN.md](M4_WAVE9_PLAN.md) — see "Shipped amendments" (A1–A5) | PR pending (#165, #164, #156; #148 root-caused, stays open); follow-ups #168, #169; manual script [M4_WAVE9_MANUAL.md](M4_WAVE9_MANUAL.md) |
