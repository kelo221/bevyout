...
| M4 wave 8 — nav correctness: portals, door topology, stuck progress, setlock | [M4_WAVE8_PROMPT.md](M4_WAVE8_PROMPT.md) | [M4_WAVE8_PLAN.md](M4_WAVE8_PLAN.md) — see "Shipped amendments" (A1–A8) | PR pending (#154, #155, #157, #163); follow-ups #162, #164, #165; manual script [M4_WAVE8_MANUAL.md](M4_WAVE8_MANUAL.md) |
| M4 wave 10 — actor KF compatibility and animation zoo | [M4_WAVE10_PROMPT.md](M4_WAVE10_PROMPT.md) | [M4_WAVE10_PLAN.md](M4_WAVE10_PLAN.md) — see "Shipped amendments" | PR-ready (#104); manual script [M4_WAVE10_MANUAL.md](M4_WAVE10_MANUAL.md) |
