...
| M6 wave 6 — bounded-route convergence preparation | [M6_WAVE6_PROMPT.md](M6_WAVE6_PROMPT.md) | [M6_WAVE6_PLAN.md](M6_WAVE6_PLAN.md) | W6-A diagnostics integrated; W6-B held for current-data preflight |
