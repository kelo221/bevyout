...
| DynamicLighting volumetric fog follow-up | current-state audit in plan | [DYNAMIC_LIGHTING_VOLUMETRIC_FOG_PLAN.md](DYNAMIC_LIGHTING_VOLUMETRIC_FOG_PLAN.md) — see "Shipped amendments" (A1–A3) | implemented and locally validated |
