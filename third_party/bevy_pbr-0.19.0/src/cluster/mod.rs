...
pub struct GpuClusteredLight {
    ...
    /// Point lights store a stable cubemap layer; spot lights store the bit
    /// representation of their tangent angle. The light kind selects which
    /// interpretation is valid, keeping the uniform layout at 64 bytes.
    pub(crate) shadow_map_index_or_spot_light_tan_angle: u32,
