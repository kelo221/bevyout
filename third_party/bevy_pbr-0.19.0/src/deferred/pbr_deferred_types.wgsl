...
#import bevy_pbr::{
    mesh_types::{MESH_FLAGS_BAKED_POINT_SHADOW_RECEIVER_BIT, MESH_FLAGS_SHADOW_RECEIVER_BIT},
...
const DEFERRED_MESH_FLAGS_BAKED_POINT_SHADOW_RECEIVER_BIT: u32 = 1u << 3u;
...
fn deferred_flags_from_mesh_material_flags(mesh_flags: u32, mat_flags: u32) -> u32 {
    ...
    flags |= u32((mesh_flags & MESH_FLAGS_BAKED_POINT_SHADOW_RECEIVER_BIT) != 0u) * DEFERRED_MESH_FLAGS_BAKED_POINT_SHADOW_RECEIVER_BIT;
...
fn mesh_material_flags_from_deferred_flags(deferred_flags: u32) -> vec2<u32> {
    ...
    mesh_flags |= u32((deferred_flags & DEFERRED_MESH_FLAGS_BAKED_POINT_SHADOW_RECEIVER_BIT) != 0u) * MESH_FLAGS_BAKED_POINT_SHADOW_RECEIVER_BIT;
