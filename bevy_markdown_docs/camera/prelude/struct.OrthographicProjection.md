...
[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/projection.rs.html#580)
...
The volume contained in the projection is called the _view frustum_. Since the viewport is rectangular and projection lines are parallel, the view frustum takes the shape of a cuboid.
...
`near: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`
...
`far: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`
...
`viewport_origin: [Vec2](../../prelude/struct.Vec2.html "struct bevy::prelude::Vec2")`
...
`scaling_mode: [ScalingMode](../enum.ScalingMode.html "enum bevy::camera::ScalingMode")`

How the projection will scale to the viewport.

Defaults to [`ScalingMode::WindowSize`](../enum.ScalingMode.html#variant.WindowSize "variant bevy::camera::ScalingMode::WindowSize"), and works in concert with [`OrthographicProjection::scale`](../../prelude/struct.OrthographicProjection.html#structfield.scale "field bevy::prelude::OrthographicProjection::scale") to determine the final effect.

For simplicity, zooming should be done by changing [`OrthographicProjection::scale`](../../prelude/struct.OrthographicProjection.html#structfield.scale "field bevy::prelude::OrthographicProjection::scale"), rather than changing the parameters of the scaling mode.

`scale: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Scales the projection.

As scale increases, the apparent size of objects decreases, and vice versa.

Note: scaling can be set by [`scaling_mode`](../../prelude/struct.OrthographicProjection.html#structfield.scaling_mode "field bevy::prelude::OrthographicProjection::scaling_mode") as well. This parameter scales on top of that.

This property is particularly useful in implementing zoom functionality.

Defaults to `1.0`, which under standard settings corresponds to a 1:1 mapping of world units to rendered pixels. See [`ScalingMode::WindowSize`](../enum.ScalingMode.html#variant.WindowSize "variant bevy::camera::ScalingMode::WindowSize") for more information.

`area: [Rect](../../prelude/struct.Rect.html "struct bevy::prelude::Rect")`
...
[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/projection.rs.html#766)

### impl [OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/projection.rs.html#771)

#### pub fn [default\_2d](#method.default_2d)() -> [OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")
...
examples/asset/asset\_saving.rs ([line 96](../../../src/asset_saving/asset_saving.rs.html#96))
...
[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/projection.rs.html#782)

#### pub fn [default\_3d](#method.default_3d)() -> [OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")
...
examples/3d/anti\_aliasing.rs ([line 270](../../../src/anti_aliasing/anti_aliasing.rs.html#270))
...
examples/3d/orthographic.rs ([line 26](../../../src/orthographic/orthographic.rs.html#26))
...
examples/camera/projection\_zoom.rs ([line 62](../../../src/projection_zoom/projection_zoom.rs.html#62))
...
examples/testbed/3d.rs ([line 600](../../../src/testbed_3d/3d.rs.html#600))
...
tests/3d/test\_invalid\_skinned\_mesh.rs ([line 57](../../../src/test_invalid_skinned_mesh/test_invalid_skinned_mesh.rs.html#57))
...
examples/stress\_tests/many\_lights.rs ([line 96](../../../src/many_lights/many_lights.rs.html#96))
...
*   [examples/3d/pbr.rs](../../../src/pbr/pbr.rs.html#116)
*   [examples/3d/camera\_sub\_view.rs](../../../src/camera_sub_view/camera_sub_view.rs.html#147)
...
[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/projection.rs.html#637)

#### fn [get\_clip\_from\_view](../trait.CameraProjection.html#tymethod.get_clip_from_view)(&self) -> [Mat4](../../prelude/struct.Mat4.html "struct bevy::prelude::Mat4")

Generate the projection matrix.

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/projection.rs.html#650)

#### fn [get\_clip\_from\_view\_for\_sub](../trait.CameraProjection.html#tymethod.get_clip_from_view_for_sub)(&self, sub\_view: &[SubCameraView](../struct.SubCameraView.html "struct bevy::camera::SubCameraView")) -> [Mat4](../../prelude/struct.Mat4.html "struct bevy::prelude::Mat4")

Generate the projection matrix for a [`SubCameraView`](../struct.SubCameraView.html "struct bevy::camera::SubCameraView").

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/projection.rs.html#693)

#### fn [update](../trait.CameraProjection.html#tymethod.update)(&mut self, width: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), height: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html))
...
[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/projection.rs.html#740)

#### fn [far](../trait.CameraProjection.html#tymethod.far)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

The far plane distance of the projection.

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/projection.rs.html#744)

#### fn [get\_frustum\_corners](../trait.CameraProjection.html#tymethod.get_frustum_corners)(&self, z\_near: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), z\_far: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> \[[Vec3A](../../prelude/struct.Vec3A.html "struct bevy::prelude::Vec3A"); [8](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]

The eight corners of the camera frustum, as defined by this projection. [Read more](../trait.CameraProjection.html#tymethod.get_frustum_corners)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/projection.rs.html#70)

#### fn [compute\_frustum](../trait.CameraProjection.html#method.compute_frustum)(&self, camera\_transform: &[GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")) -> [Frustum](../primitives/struct.Frustum.html "struct bevy::camera::primitives::Frustum")

Compute camera frustum for camera with given projection and transform. [Read more](../trait.CameraProjection.html#method.compute_frustum)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/projection.rs.html#578)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/projection.rs.html#578)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")\> for [Projection](../../prelude/enum.Projection.html "enum bevy::prelude::Projection")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/projection.rs.html#214)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")) -> [Projection](../../prelude/enum.Projection.html "enum bevy::prelude::Projection")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/projection.rs.html#578)

### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/projection.rs.html#578)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/projection.rs.html#578)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")\>
...
### impl [FromWorld](../../prelude/trait.FromWorld.html "trait bevy::prelude::FromWorld") for [OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/projection.rs.html#761)

#### fn [from\_world](../../prelude/trait.FromWorld.html#tymethod.from_world)(\_world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World")) -> [OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")

Creates `Self` using data from the given [`World`](../../prelude/struct.World.html "struct bevy::prelude::World").

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/projection.rs.html#578)

### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")
...
where [OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection"): 'into\_return,
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/projection.rs.html#578)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")\>, ) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/projection.rs.html#579)
...
#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [OrthographicProjection](../../prelude/struct.OrthographicProjection.html "struct bevy::prelude::OrthographicProjection")
