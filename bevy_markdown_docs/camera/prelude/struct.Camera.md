[bevy](../../index.html)::[camera](../index.html)::[prelude](index.html)

# Struct Camera 

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#384)
...
The [`Camera`](../../prelude/struct.Camera.html "struct bevy::prelude::Camera") component is added to an entity to define the properties of the viewpoint from which rendering occurs. It defines the position of the view to render, the projection method to transform the 3D objects into a 2D image, as well as the render target into which that image is produced.

Note that a [`Camera`](../../prelude/struct.Camera.html "struct bevy::prelude::Camera") needs a `CameraRenderGraph` to render anything. This is typically provided by adding a [`Camera2d`](../../prelude/struct.Camera2d.html "struct bevy::prelude::Camera2d") or [`Camera3d`](../../prelude/struct.Camera3d.html "struct bevy::prelude::Camera3d") component, but custom render graphs can also be defined. Inserting a [`Camera`](../../prelude/struct.Camera.html "struct bevy::prelude::Camera") with no render graph will emit an error at runtime.

## Fields

`viewport: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Viewport](../struct.Viewport.html "struct bevy::camera::Viewport")>`

If set, this camera will render to the given [`Viewport`](../struct.Viewport.html "struct bevy::camera::Viewport") rectangle within the configured [`RenderTarget`](../enum.RenderTarget.html "enum bevy::camera::RenderTarget").

`order: [isize](https://doc.rust-lang.org/nightly/std/primitive.isize.html)`

Cameras with a higher order are rendered later, and thus on top of lower order cameras.

`is_active: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

If this is set to `true`, this camera will be rendered to its specified [`RenderTarget`](../enum.RenderTarget.html "enum bevy::camera::RenderTarget"). If `false`, this camera will not be rendered.

`computed: [ComputedCameraValues](../struct.ComputedCameraValues.html "struct bevy::camera::ComputedCameraValues")`

Computed values for this camera, such as the projection matrix and the render target size.

`output_mode: [CameraOutputMode](../enum.CameraOutputMode.html "enum bevy::camera::CameraOutputMode")`

The [`CameraOutputMode`](../enum.CameraOutputMode.html "enum bevy::camera::CameraOutputMode") for this camera.

`msaa_writeback: [MsaaWriteback](../../prelude/enum.MsaaWriteback.html "enum bevy::prelude::MsaaWriteback")`

Controls when MSAA writeback occurs for this camera. See [`MsaaWriteback`](../../prelude/enum.MsaaWriteback.html "enum bevy::prelude::MsaaWriteback") for available options.

`clear_color: [ClearColorConfig](../../prelude/enum.ClearColorConfig.html "enum bevy::prelude::ClearColorConfig")`

The clear color operation to perform on the render target.

`invert_culling: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`
...
`sub_camera_view: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[SubCameraView](../struct.SubCameraView.html "struct bevy::camera::SubCameraView")>`

If set, this camera will be a sub camera of a large view, defined by a [`SubCameraView`](../struct.SubCameraView.html "struct bevy::camera::SubCameraView").

## Implementations

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#431)

### impl [Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#434)

#### pub fn [to\_logical](#method.to_logical)(&self, physical\_size: [UVec2](../../prelude/struct.UVec2.html "struct bevy::prelude::UVec2")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Vec2](../../prelude/struct.Vec2.html "struct bevy::prelude::Vec2")\>

Converts a physical size in this `Camera` to a logical size.

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#443)

#### pub fn [physical\_viewport\_rect](#method.physical_viewport_rect)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[URect](../../prelude/struct.URect.html "struct bevy::prelude::URect")\>

The rendered physical bounds [`URect`](../../prelude/struct.URect.html "struct bevy::prelude::URect") of the camera. If the `viewport` field is set to [`Some`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.Some "variant core::option::Option::Some"), this will be the rect of that custom viewport. Otherwise it will default to the full physical rect of the current [`RenderTarget`](../enum.RenderTarget.html "enum bevy::camera::RenderTarget").

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#457)

#### pub fn [logical\_viewport\_rect](#method.logical_viewport_rect)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Rect](../../prelude/struct.Rect.html "struct bevy::prelude::Rect")\>

The rendered logical bounds [`Rect`](../../prelude/struct.Rect.html "struct bevy::prelude::Rect") of the camera. If the `viewport` field is set to [`Some`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.Some "variant core::option::Option::Some"), this will be the rect of that custom viewport. Otherwise it will default to the full logical rect of the current [`RenderTarget`](../enum.RenderTarget.html "enum bevy::camera::RenderTarget").

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#479)

#### pub fn [logical\_viewport\_size](#method.logical_viewport_size)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Vec2](../../prelude/struct.Vec2.html "struct bevy::prelude::Vec2")\>

The logical size of this camera’s viewport. If the `viewport` field is set to [`Some`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.Some "variant core::option::Option::Some"), this will be the size of that custom viewport. Otherwise it will default to the full logical size of the current [`RenderTarget`](../enum.RenderTarget.html "enum bevy::camera::RenderTarget"). For logic that requires the full logical size of the [`RenderTarget`](../enum.RenderTarget.html "enum bevy::camera::RenderTarget"), prefer [`Camera::logical_target_size`](../../prelude/struct.Camera.html#method.logical_target_size "method bevy::prelude::Camera::logical_target_size").

Returns `None` if either:

*   the function is called just after the `Camera` is created, before `camera_system` is executed,
*   the [`RenderTarget`](../enum.RenderTarget.html "enum bevy::camera::RenderTarget") isn’t correctly set:
    *   it references the [`PrimaryWindow`](../enum.RenderTarget.html#variant.Window "variant bevy::camera::RenderTarget::Window") when there is none,
    *   it references a [`Window`](../enum.RenderTarget.html#variant.Window "variant bevy::camera::RenderTarget::Window") entity that doesn’t exist or doesn’t actually have a `Window` component,
    *   it references an [`Image`](../enum.RenderTarget.html#variant.Image "variant bevy::camera::RenderTarget::Image") that doesn’t exist (invalid handle),
    *   it references a [`TextureView`](../enum.RenderTarget.html#variant.TextureView "variant bevy::camera::RenderTarget::TextureView") that doesn’t exist (invalid handle).

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#492)

#### pub fn [physical\_viewport\_size](#method.physical_viewport_size)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[UVec2](../../prelude/struct.UVec2.html "struct bevy::prelude::UVec2")\>

The physical size of this camera’s viewport (in physical pixels). If the `viewport` field is set to [`Some`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.Some "variant core::option::Option::Some"), this will be the size of that custom viewport. Otherwise it will default to the full physical size of the current [`RenderTarget`](../enum.RenderTarget.html "enum bevy::camera::RenderTarget"). For logic that requires the full physical size of the [`RenderTarget`](../enum.RenderTarget.html "enum bevy::camera::RenderTarget"), prefer [`Camera::physical_target_size`](../../prelude/struct.Camera.html#method.physical_target_size "method bevy::prelude::Camera::physical_target_size").

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#503)

#### pub fn [logical\_target\_size](#method.logical_target_size)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Vec2](../../prelude/struct.Vec2.html "struct bevy::prelude::Vec2")\>

The full logical size of this camera’s [`RenderTarget`](../enum.RenderTarget.html "enum bevy::camera::RenderTarget"), ignoring custom `viewport` configuration. Note that if the `viewport` field is [`Some`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.Some "variant core::option::Option::Some"), this will not represent the size of the rendered area. For logic that requires the size of the actually rendered area, prefer [`Camera::logical_viewport_size`](../../prelude/struct.Camera.html#method.logical_viewport_size "method bevy::prelude::Camera::logical_viewport_size").

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#515)

#### pub fn [physical\_target\_size](#method.physical_target_size)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[UVec2](../../prelude/struct.UVec2.html "struct bevy::prelude::UVec2")\>

The full physical size of this camera’s [`RenderTarget`](../enum.RenderTarget.html "enum bevy::camera::RenderTarget") (in physical pixels), ignoring custom `viewport` configuration. Note that if the `viewport` field is [`Some`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.Some "variant core::option::Option::Some"), this will not represent the size of the rendered area. For logic that requires the size of the actually rendered area, prefer [`Camera::physical_viewport_size`](../../prelude/struct.Camera.html#method.physical_viewport_size "method bevy::prelude::Camera::physical_viewport_size").

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#520)

#### pub fn [target\_scaling\_factor](#method.target_scaling_factor)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\>

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#529)

#### pub fn [clip\_from\_view](#method.clip_from_view)(&self) -> [Mat4](../../prelude/struct.Mat4.html "struct bevy::prelude::Mat4")

The projection matrix computed using this camera’s [`Projection`](../../prelude/enum.Projection.html "enum bevy::prelude::Projection").

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#579-583)

#### pub fn [world\_to\_viewport](#method.world_to_viewport)( &self, camera\_transform: &[GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform"), world\_position: [Vec3](../../prelude/struct.Vec3.html "struct bevy::prelude::Vec3"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Vec2](../../prelude/struct.Vec2.html "struct bevy::prelude::Vec2"), [ViewportConversionError](../enum.ViewportConversionError.html "enum bevy::camera::ViewportConversionError")\>

Given a position in world space, use the camera to compute the viewport-space coordinates.

To get the coordinates in Normalized Device Coordinates, you should use [`world_to_ndc`](../../prelude/struct.Camera.html#method.world_to_ndc "method bevy::prelude::Camera::world_to_ndc").

##### Panics

Will panic if `glam_assert` is enabled and the `camera_transform` contains `NAN` (see [`world_to_ndc`](../../prelude/struct.Camera.html#method.world_to_ndc "method bevy::prelude::Camera::world_to_ndc")).

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/2d/2d\_viewport\_to\_world.rs ([line 33](../../../src/2d_viewport_to_world/2d_viewport_to_world.rs.html#33))
...
examples/3d/blend\_modes.rs ([line 324](../../../src/blend_modes/blend_modes.rs.html#324))
...
[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#599-603)

#### pub fn [world\_to\_viewport\_with\_depth](#method.world_to_viewport_with_depth)( &self, camera\_transform: &[GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform"), world\_position: [Vec3](../../prelude/struct.Vec3.html "struct bevy::prelude::Vec3"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Vec3](../../prelude/struct.Vec3.html "struct bevy::prelude::Vec3"), [ViewportConversionError](../enum.ViewportConversionError.html "enum bevy::camera::ViewportConversionError")\>
...
[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#647-651)

#### pub fn [viewport\_to\_world](#method.viewport_to_world)( &self, camera\_transform: &[GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform"), viewport\_position: [Vec2](../../prelude/struct.Vec2.html "struct bevy::prelude::Vec2"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Ray3d](../../prelude/struct.Ray3d.html "struct bevy::prelude::Ray3d"), [ViewportConversionError](../enum.ViewportConversionError.html "enum bevy::camera::ViewportConversionError")\>
...
To get the world space coordinates with Normalized Device Coordinates, you should use [`ndc_to_world`](../../prelude/struct.Camera.html#method.ndc_to_world "method bevy::prelude::Camera::ndc_to_world").
...
Will panic if the camera’s projection matrix is invalid (has a determinant of 0) and `glam_assert` is enabled (see [`ndc_to_world`](../../prelude/struct.Camera.html#method.ndc_to_world "method bevy::prelude::Camera::ndc_to_world").

##### [Examples found in repository](#scraped-examples-1)[?](../../../scrape-examples-help.html)

examples/ecs/observers.rs ([line 203](../../../src/observers/observers.rs.html#203))
...
examples/3d/3d\_viewport\_to\_world.rs ([line 23](../../../src/3d_viewport_to_world/3d_viewport_to_world.rs.html#23))
...
examples/3d/irradiance\_volumes.rs ([line 469](../../../src/irradiance_volumes/irradiance_volumes.rs.html#469))
...
examples/3d/mirror.rs ([line 478](../../../src/mirror/mirror.rs.html#478))
...
[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#709-713)

#### pub fn [viewport\_to\_world\_2d](#method.viewport_to_world_2d)( &self, camera\_transform: &[GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform"), viewport\_position: [Vec2](../../prelude/struct.Vec2.html "struct bevy::prelude::Vec2"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Vec2](../../prelude/struct.Vec2.html "struct bevy::prelude::Vec2"), [ViewportConversionError](../enum.ViewportConversionError.html "enum bevy::camera::ViewportConversionError")\>

Returns a 2D world position computed from a position on this [`Camera`](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")’s viewport.
...
examples/showcase/desk\_toy.rs ([line 214](../../../src/desk_toy/desk_toy.rs.html#214))
...
examples/asset/asset\_saving\_with\_subassets.rs ([line 280](../../../src/asset_saving_with_subassets/asset_saving_with_subassets.rs.html#280))
...
examples/2d/2d\_viewport\_to\_world.rs ([line 31](../../../src/2d_viewport_to_world/2d_viewport_to_world.rs.html#31))
...
examples/2d/rotate\_to\_cursor.rs ([line 47](../../../src/rotate_to_cursor/rotate_to_cursor.rs.html#47))
...
examples/ecs/delayed\_commands.rs ([line 45](../../../src/delayed_commands/delayed_commands.rs.html#45))
...
examples/asset/asset\_saving.rs ([line 220](../../../src/asset_saving/asset_saving.rs.html#220))
...
*   [examples/math/cubic\_splines.rs](../../../src/cubic_splines/cubic_splines.rs.html#342)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#736-740)

#### pub fn [world\_to\_ndc](#method.world_to_ndc)<V>( &self, camera\_transform: &[GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform"), world\_point: V, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<V>

where V: [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Vec3A](../../prelude/struct.Vec3A.html "struct bevy::prelude::Vec3A")\> + [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Vec3A](../../prelude/struct.Vec3A.html "struct bevy::prelude::Vec3A")\>,

Given a point in world space, use the camera’s viewport to compute the Normalized Device Coordinates of the point.

When the point is within the viewport the values returned will be between -1.0 (bottom left) and 1.0 (top right) on the X and Y axes, and between 0.0 (far) and 1.0 (near) on the Z axis. To get the coordinates in the render target’s viewport dimensions, you should use [`world_to_viewport`](../../prelude/struct.Camera.html#method.world_to_viewport "method bevy::prelude::Camera::world_to_viewport").

Returns `None` if the `camera_transform`, the `world_position`, or the projection matrix defined by [`Projection`](../../prelude/enum.Projection.html "enum bevy::prelude::Projection") contain `NAN`.

##### Panics

Will panic if the `camera_transform` contains `NAN` and the `glam_assert` feature is enabled.

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#763-767)

#### pub fn [ndc\_to\_world](#method.ndc_to_world)<V>( &self, camera\_transform: &[GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform"), ndc\_point: V, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<V>

where V: [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Vec3A](../../prelude/struct.Vec3A.html "struct bevy::prelude::Vec3A")\> + [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Vec3A](../../prelude/struct.Vec3A.html "struct bevy::prelude::Vec3A")\>,

Given a position in Normalized Device Coordinates, use the camera’s viewport to compute the world space position.

The input is expected to be in NDC: `x` and `y` in the range `[-1.0, 1.0]`, and `z` in `[0.0, 1.0]` (with `z = 0.0` at the far plane and `z = 1.0` at the near plane). The returned value is a position in world space (your game’s world units) and is not limited to `[-1.0, 1.0]`. To convert from a viewport position to world space, you should use [`viewport_to_world`](../../prelude/struct.Camera.html#method.viewport_to_world "method bevy::prelude::Camera::viewport_to_world").

Returns `None` if the `camera_transform`, the `ndc_point`, or the projection matrix defined by [`Projection`](../../prelude/enum.Projection.html "enum bevy::prelude::Projection") contain `NAN`.

##### Panics

Will panic if the projection matrix is invalid (has a determinant of 0) and `glam_assert` is enabled.

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#784)

#### pub fn [depth\_ndc\_to\_view\_z](#method.depth_ndc_to_view_z)(&self, ndc\_depth: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Converts the depth in Normalized Device Coordinates to linear view z for perspective projections.

Note: Depth values in front of the camera will be negative as -z is forward

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#793)

#### pub fn [depth\_ndc\_to\_view\_z\_2d](#method.depth_ndc_to_view_z_2d)(&self, ndc\_depth: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Converts the depth in Normalized Device Coordinates to linear view z for orthographic projections.

Note: Depth values in front of the camera will be negative as -z is forward

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#799-802)

#### pub fn [viewport\_to\_ndc](#method.viewport_to_ndc)( &self, viewport\_position: [Vec2](../../prelude/struct.Vec2.html "struct bevy::prelude::Vec2"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Vec2](../../prelude/struct.Vec2.html "struct bevy::prelude::Vec2"), [ViewportConversionError](../enum.ViewportConversionError.html "enum bevy::camera::ViewportConversionError")\>
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#374)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")

where [Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

**Required Components**: [`Frustum`](../primitives/struct.Frustum.html "struct bevy::camera::primitives::Frustum"), [`CameraMainTextureUsages`](../struct.CameraMainTextureUsages.html "struct bevy::camera::CameraMainTextureUsages"), [`VisibleEntities`](../visibility/struct.VisibleEntities.html "struct bevy::camera::visibility::VisibleEntities"), [`Transform`](../../prelude/struct.Transform.html "struct bevy::prelude::Transform"), [`Visibility`](../../prelude/enum.Visibility.html "enum bevy::prelude::Visibility"), [`RenderTarget`](../enum.RenderTarget.html "enum bevy::camera::RenderTarget").
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")
...
[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#415)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#416)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#374)

### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#374)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#374)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")
...
where [Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera"): 'into\_return,
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#374)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#375)
...
#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")
