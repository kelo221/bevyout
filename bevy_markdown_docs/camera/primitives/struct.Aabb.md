...
[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#64)
...
This component is notably used during “frustum culling”, a process to determine if an entity should be rendered by a [`Camera`](../../prelude/struct.Camera.html "struct bevy::prelude::Camera") if its bounding box intersects with the camera’s [`Frustum`](struct.Frustum.html "struct bevy::camera::primitives::Frustum").

It will be added automatically by the systems in [`CalculateBounds`](../visibility/enum.VisibilitySystems.html#variant.CalculateBounds "variant bevy::camera::visibility::VisibilitySystems::CalculateBounds") to entities that:

*   could be subject to frustum culling, for example with a [`Mesh3d`](../../prelude/struct.Mesh.html "struct bevy::prelude::Mesh") or `Sprite` component,
*   don’t have the [`NoFrustumCulling`](../visibility/struct.NoFrustumCulling.html "struct bevy::camera::visibility::NoFrustumCulling") component.

It won’t be updated automatically if the space occupied by the entity changes, for example if the vertex positions of a [`Mesh3d`](../../prelude/struct.Mesh.html "struct bevy::prelude::Mesh") are updated.

## Fields

`center: [Vec3A](../../prelude/struct.Vec3A.html "struct bevy::prelude::Vec3A")``half_extents: [Vec3A](../../prelude/struct.Vec3A.html "struct bevy::prelude::Vec3A")`

## Implementations

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#69)

### impl [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#71)

#### pub fn [from\_min\_max](#method.from_min_max)(minimum: [Vec3](../../prelude/struct.Vec3.html "struct bevy::prelude::Vec3"), maximum: [Vec3](../../prelude/struct.Vec3.html "struct bevy::prelude::Vec3")) -> [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#95)

#### pub fn [enclosing](#method.enclosing)<T>(iter: impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = T>) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")\>

where T: [Borrow](https://doc.rust-lang.org/nightly/core/borrow/trait.Borrow.html "trait core::borrow::Borrow")<[Vec3](../../prelude/struct.Vec3.html "struct bevy::prelude::Vec3")\>,
...
[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#108)

#### pub fn [relative\_radius](#method.relative_radius)(&self, p\_normal: &[Vec3A](../../prelude/struct.Vec3A.html "struct bevy::prelude::Vec3A"), world\_from\_local: &[Mat3A](../../prelude/struct.Mat3A.html "struct bevy::prelude::Mat3A")) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Calculate the relative radius of the AABB with respect to a plane

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#121)

#### pub fn [min](#method.min)(&self) -> [Vec3A](../../prelude/struct.Vec3A.html "struct bevy::prelude::Vec3A")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#126)

#### pub fn [max](#method.max)(&self) -> [Vec3A](../../prelude/struct.Vec3A.html "struct bevy::prelude::Vec3A")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#133)

#### pub fn [is\_in\_half\_space](#method.is_in_half_space)( &self, half\_space: &[HalfSpace](../../prelude/struct.HalfSpace.html "struct bevy::prelude::HalfSpace"), world\_from\_local: &[Affine3A](../../math/struct.Affine3A.html "struct bevy::math::Affine3A"), ) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Check if the AABB is at the front side of the bisecting plane. Referenced from: [AABB Plane intersection](https://gdbooks.gitbooks.io/3dcollisions/content/Chapter2/static_aabb_plane.html)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#147)

#### pub fn [is\_in\_half\_space\_identity](#method.is_in_half_space_identity)(&self, half\_space: &[HalfSpace](../../prelude/struct.HalfSpace.html "struct bevy::prelude::HalfSpace")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Optimized version of [`Self::is_in_half_space`](struct.Aabb.html#method.is_in_half_space "method bevy::camera::primitives::Aabb::is_in_half_space") when the AABB is already in world space. Use this when `world_from_local` would be the identity transform.

## Trait Implementations

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#62)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#62)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")

where [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#62)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#62)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Aabb3d](../../math/bounding/struct.Aabb3d.html "struct bevy::math::bounding::Aabb3d")\> for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#156)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(aabb: [Aabb3d](../../math/bounding/struct.Aabb3d.html "struct bevy::math::bounding::Aabb3d")) -> [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#164)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")\> for [Aabb3d](../../math/bounding/struct.Aabb3d.html "struct bevy::math::bounding::Aabb3d")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#165)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(aabb: [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")) -> [Aabb3d](../../math/bounding/struct.Aabb3d.html "struct bevy::math::bounding::Aabb3d")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#173)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Sphere](struct.Sphere.html "struct bevy::camera::primitives::Sphere")\> for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#175)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(sphere: [Sphere](struct.Sphere.html "struct bevy::camera::primitives::Sphere")) -> [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#62)

### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#62)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#62)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#62)

### impl [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#62)

#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")
...
where [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#62)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#62)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#63)
...
### impl [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#62)

#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Struct](../../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#62)

### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")
