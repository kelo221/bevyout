...
[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#249)
...
This process is called frustum culling, and entities can opt out of it using the [`NoFrustumCulling`](../visibility/struct.NoFrustumCulling.html "struct bevy::camera::visibility::NoFrustumCulling") component.

The frustum component is typically added automatically for cameras, either [`Camera2d`](../../prelude/struct.Camera2d.html "struct bevy::prelude::Camera2d") or [`Camera3d`](../../prelude/struct.Camera3d.html "struct bevy::prelude::Camera3d"). It is usually updated automatically by [`update_frusta`](../visibility/fn.update_frusta.html "fn bevy::camera::visibility::update_frusta") from the [`CameraProjection`](../trait.CameraProjection.html "trait bevy::camera::CameraProjection") component and [`GlobalTransform`](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform") of the camera entity.

## Tuple Fields

`0: [ViewFrustum](../../prelude/struct.ViewFrustum.html "struct bevy::prelude::ViewFrustum")`

## Implementations

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#251)

### impl [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#254)

#### pub fn [intersects\_sphere](#method.intersects_sphere)(&self, sphere: &[Sphere](struct.Sphere.html "struct bevy::camera::primitives::Sphere"), intersect\_far: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Checks if a sphere intersects the frustum.

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#271-277)

#### pub fn [intersects\_obb](#method.intersects_obb)( &self, aabb: &[Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb"), world\_from\_local: &[Affine3A](../../math/struct.Affine3A.html "struct bevy::math::Affine3A"), intersect\_near: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), intersect\_far: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), ) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Checks if an Oriented Bounding Box (obb) intersects the frustum.

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#298)

#### pub fn [intersects\_obb\_identity](#method.intersects_obb_identity)(&self, aabb: &[Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Optimized version of [`Frustum::intersects_obb`](struct.Frustum.html#method.intersects_obb "method bevy::camera::primitives::Frustum::intersects_obb") where the transform is [`Affine3A::IDENTITY`](../../math/struct.Affine3A.html#associatedconstant.IDENTITY "associated constant bevy::math::Affine3A::IDENTITY") and both `intersect_near` and `intersect_far` are `true`.

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#313)

#### pub fn [contains\_aabb](#method.contains_aabb)(&self, aabb: &[Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb"), world\_from\_local: &[Affine3A](../../math/struct.Affine3A.html "struct bevy::math::Affine3A")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Check if the frustum contains the entire Axis-Aligned Bounding Box (AABB). Referenced from: [Frustum Culling](https://learnopengl.com/Guest-Articles/2021/Scene/Frustum-Culling)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#325)

#### pub fn [contains\_aabb\_identity](#method.contains_aabb_identity)(&self, aabb: &[Aabb](struct.Aabb.html "struct bevy::camera::primitives::Aabb")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Optimized version of [`Self::contains_aabb`](struct.Frustum.html#method.contains_aabb "method bevy::camera::primitives::Frustum::contains_aabb") when the AABB is already in world space. Use this when `world_from_local` would be [`Affine3A::IDENTITY`](../../math/struct.Affine3A.html#associatedconstant.IDENTITY "associated constant bevy::math::Affine3A::IDENTITY").

## Methods from [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")<Target = [ViewFrustum](../../prelude/struct.ViewFrustum.html "struct bevy::prelude::ViewFrustum")\>

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/view_frustum.rs.html#32)

#### pub const [NEAR\_PLANE\_IDX](#associatedconstant.NEAR_PLANE_IDX): [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html) = 4

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/view_frustum.rs.html#34)

#### pub const [FAR\_PLANE\_IDX](#associatedconstant.FAR_PLANE_IDX): [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html) = 5

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/view_frustum.rs.html#72)

#### pub fn [corners](#method.corners)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<\[[Vec3](../../prelude/struct.Vec3.html "struct bevy::prelude::Vec3"); [8](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]>

Calculates the corners of this frustum. Returns `None` if the frustum isn’t properly defined.

If `Some`, the corners are returned in the following order: near top left, near top right, near bottom right, near bottom left, far top left, far top right, far bottom right, far bottom left. If the far plane is an inactive half space, the intersection points that include the far plane will be `Vec3::NAN`.

## Trait Implementations

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#247)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#247)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")

where [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#247)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#247)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#247)

### impl [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#247)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = [ViewFrustum](../../prelude/struct.ViewFrustum.html "struct bevy::prelude::ViewFrustum")

The resulting type after dereferencing.

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#247)

#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum") as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#247)

### impl [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#247)

#### fn [deref\_mut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html#tymethod.deref_mut)(&mut self) -> &mut <[Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum") as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Mutably dereferences the value.

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#247)

### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#247)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#247)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#247)

### impl [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#247)

#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")
...
where [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum"): 'into\_return,
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#248)
...
### impl [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/primitives.rs.html#247)

#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [TupleStruct](../../prelude/trait.TupleStruct.html "trait bevy::prelude::TupleStruct") for [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")
...
### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Frustum](struct.Frustum.html "struct bevy::camera::primitives::Frustum")
