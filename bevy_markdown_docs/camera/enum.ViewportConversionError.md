...
[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#331)
...
See [`world_to_viewport`](../prelude/struct.Camera.html#method.world_to_viewport "method bevy::prelude::Camera::world_to_viewport") and [`viewport_to_world`](../prelude/struct.Camera.html#method.viewport_to_world "method bevy::prelude::Camera::viewport_to_world").
...
This may be because the `Camera` was just created and `camera_system` has not been executed yet, or because the [`RenderTarget`](enum.RenderTarget.html "enum bevy::camera::RenderTarget") is misconfigured in one of the following ways:
...
The Normalized Device Coordinates could not be computed because the `camera_transform`, the `world_position`, or the projection matrix defined by [`Projection`](../prelude/enum.Projection.html "enum bevy::prelude::Projection") contained `NAN` (see [`world_to_ndc`](../prelude/struct.Camera.html#method.world_to_ndc "method bevy::prelude::Camera::world_to_ndc") and [`ndc_to_world`](../prelude/struct.Camera.html#method.ndc_to_world "method bevy::prelude::Camera::ndc_to_world")).

## Trait Implementations

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#330)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ViewportConversionError](enum.ViewportConversionError.html "enum bevy::camera::ViewportConversionError")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#330)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ViewportConversionError](enum.ViewportConversionError.html "enum bevy::camera::ViewportConversionError")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [ViewportConversionError](enum.ViewportConversionError.html "enum bevy::camera::ViewportConversionError")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#330)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ViewportConversionError](enum.ViewportConversionError.html "enum bevy::camera::ViewportConversionError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [ViewportConversionError](enum.ViewportConversionError.html "enum bevy::camera::ViewportConversionError")
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [ViewportConversionError](enum.ViewportConversionError.html "enum bevy::camera::ViewportConversionError")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#330)

### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [ViewportConversionError](enum.ViewportConversionError.html "enum bevy::camera::ViewportConversionError")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [ViewportConversionError](enum.ViewportConversionError.html "enum bevy::camera::ViewportConversionError")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#330)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[ViewportConversionError](enum.ViewportConversionError.html "enum bevy::camera::ViewportConversionError")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [ViewportConversionError](enum.ViewportConversionError.html "enum bevy::camera::ViewportConversionError")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ViewportConversionError](enum.ViewportConversionError.html "enum bevy::camera::ViewportConversionError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ViewportConversionError](enum.ViewportConversionError.html "enum bevy::camera::ViewportConversionError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ViewportConversionError](enum.ViewportConversionError.html "enum bevy::camera::ViewportConversionError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ViewportConversionError](enum.ViewportConversionError.html "enum bevy::camera::ViewportConversionError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ViewportConversionError](enum.ViewportConversionError.html "enum bevy::camera::ViewportConversionError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ViewportConversionError](enum.ViewportConversionError.html "enum bevy::camera::ViewportConversionError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ViewportConversionError](enum.ViewportConversionError.html "enum bevy::camera::ViewportConversionError")
