...
# Struct ShadowLodOrigin 

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#857)
...
1.  If an entity has this [`ShadowLodOrigin`](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin") component, then it’s the LOD origin. If there’s more than one entity with the [`ShadowLodOrigin`](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin") component, one is chosen arbitrarily in a manner that’s stable from frame to frame.
    
2.  If a camera renders to a window (that is, the camera’s [`RenderTarget`](enum.RenderTarget.html "enum bevy::camera::RenderTarget") is [`RenderTarget::Window`](enum.RenderTarget.html#variant.Window "variant bevy::camera::RenderTarget::Window")), then that camera is the shadow LOD origin. If there’s more than one such camera that renders to a window, then one is chosen arbitrarily in a manner that’s stable from frame to frame.
    
3.  A camera is chosen to be the LOD origin arbitrarily from all cameras in the scene in a manner that’s stable from frame to frame.
    

This algorithm means that, in most cases, you don’t need to add this [`ShadowLodOrigin`](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin") component explicitly to the scene; usually, Bevy chooses the right origin automatically. You only need to use this component explicitly if you have multiple cameras rendering to the window: e.g. in a split-screen game.

## Trait Implementations

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#854)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#854)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")

where [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#854)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#854)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#854)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#854)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#854)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#854)

### impl [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#854)

#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")
...
where [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin"): 'into\_return,
...
### impl [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")
...
#### fn [reflect\_owned](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#854)

#### fn [try\_into\_reflect](../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#855)
...
### impl [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#854)

#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Struct](../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")
...
### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ShadowLodOrigin](struct.ShadowLodOrigin.html "struct bevy::camera::ShadowLodOrigin")
