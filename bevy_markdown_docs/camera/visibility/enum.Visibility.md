...
To read the visibility of an entity, query for its [`InheritedVisibility`](../../prelude/struct.InheritedVisibility.html "struct bevy::prelude::InheritedVisibility") instead. For more information, see [module level documentation](index.html#what-is-the-difference-between-visibility-components "mod bevy::camera::visibility").
