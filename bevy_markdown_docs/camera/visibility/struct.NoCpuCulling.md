...
[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/mod.rs.html#69)
...
*   disabling CPU culling completely for a [`Camera`](../../prelude/struct.Camera.html "struct bevy::prelude::Camera"), using only GPU culling.
*   when overwriting a [`Mesh`](../../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")’s transform on the GPU side (e.g. overwriting `MeshInputUniform`’s `world_from_local`), resulting in stale CPU-side positions.

## Trait Implementations

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/mod.rs.html#68)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [NoCpuCulling](struct.NoCpuCulling.html "struct bevy::camera::visibility::NoCpuCulling")

where [NoCpuCulling](struct.NoCpuCulling.html "struct bevy::camera::visibility::NoCpuCulling"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [NoCpuCulling](struct.NoCpuCulling.html "struct bevy::camera::visibility::NoCpuCulling")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/mod.rs.html#68)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [NoCpuCulling](struct.NoCpuCulling.html "struct bevy::camera::visibility::NoCpuCulling")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [NoCpuCulling](struct.NoCpuCulling.html "struct bevy::camera::visibility::NoCpuCulling")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [NoCpuCulling](struct.NoCpuCulling.html "struct bevy::camera::visibility::NoCpuCulling")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [NoCpuCulling](struct.NoCpuCulling.html "struct bevy::camera::visibility::NoCpuCulling")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [NoCpuCulling](struct.NoCpuCulling.html "struct bevy::camera::visibility::NoCpuCulling")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [NoCpuCulling](struct.NoCpuCulling.html "struct bevy::camera::visibility::NoCpuCulling")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [NoCpuCulling](struct.NoCpuCulling.html "struct bevy::camera::visibility::NoCpuCulling")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [NoCpuCulling](struct.NoCpuCulling.html "struct bevy::camera::visibility::NoCpuCulling")
