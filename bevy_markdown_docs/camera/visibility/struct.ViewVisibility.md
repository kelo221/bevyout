...
Not to be confused with [`Visibility`](../../prelude/enum.Visibility.html "enum bevy::prelude::Visibility") and [`InheritedVisibility`](../../prelude/struct.InheritedVisibility.html "struct bevy::prelude::InheritedVisibility"). For more information, see [module level documentation](index.html#what-is-the-difference-between-visibility-components "mod bevy::camera::visibility").

If you wish to add a custom visibility system that sets this value, be sure to add it to the [`CheckVisibility`](enum.VisibilitySystems.html#variant.CheckVisibility "variant bevy::camera::visibility::VisibilitySystems::CheckVisibility") set.
