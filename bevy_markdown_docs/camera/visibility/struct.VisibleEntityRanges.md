...
# Struct VisibleEntityRanges 

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/range.rs.html#188)

```rust
pub struct VisibleEntityRanges { /* private fields */ }
```
...
This doesn’t store the results of frustum or occlusion culling; use [`ViewVisibility`](../../prelude/struct.ViewVisibility.html "struct bevy::prelude::ViewVisibility") for that. Thus entities in this list may not actually be visible.

For efficiency, these tables only store entities that have [`VisibilityRange`](struct.VisibilityRange.html "struct bevy::camera::visibility::VisibilityRange") components. Entities without such a component won’t be in these tables at all.
...
[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/range.rs.html#199)

### impl [VisibleEntityRanges](struct.VisibleEntityRanges.html "struct bevy::camera::visibility::VisibleEntityRanges")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/range.rs.html#214)

#### pub fn [entity\_is\_in\_range\_of\_view](#method.entity_is_in_range_of_view)(&self, entity: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), view: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns true if the entity is in range of the given camera.

This only checks [`VisibilityRange`](struct.VisibilityRange.html "struct bevy::camera::visibility::VisibilityRange")s and doesn’t perform any frustum or occlusion culling. Thus the entity might not _actually_ be visible.

The entity is assumed to have a [`VisibilityRange`](struct.VisibilityRange.html "struct bevy::camera::visibility::VisibilityRange") component. If the entity doesn’t have that component, this method will return false.

## Trait Implementations

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/range.rs.html#187)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [VisibleEntityRanges](struct.VisibleEntityRanges.html "struct bevy::camera::visibility::VisibleEntityRanges")

where [VisibleEntityRanges](struct.VisibleEntityRanges.html "struct bevy::camera::visibility::VisibleEntityRanges"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [VisibleEntityRanges](struct.VisibleEntityRanges.html "struct bevy::camera::visibility::VisibleEntityRanges")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/range.rs.html#187)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [VisibleEntityRanges](struct.VisibleEntityRanges.html "struct bevy::camera::visibility::VisibleEntityRanges")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/range.rs.html#187)

### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [VisibleEntityRanges](struct.VisibleEntityRanges.html "struct bevy::camera::visibility::VisibleEntityRanges")

where [VisibleEntityRanges](struct.VisibleEntityRanges.html "struct bevy::camera::visibility::VisibleEntityRanges"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [VisibleEntityRanges](struct.VisibleEntityRanges.html "struct bevy::camera::visibility::VisibleEntityRanges")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [VisibleEntityRanges](struct.VisibleEntityRanges.html "struct bevy::camera::visibility::VisibleEntityRanges")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [VisibleEntityRanges](struct.VisibleEntityRanges.html "struct bevy::camera::visibility::VisibleEntityRanges")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [VisibleEntityRanges](struct.VisibleEntityRanges.html "struct bevy::camera::visibility::VisibleEntityRanges")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [VisibleEntityRanges](struct.VisibleEntityRanges.html "struct bevy::camera::visibility::VisibleEntityRanges")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [VisibleEntityRanges](struct.VisibleEntityRanges.html "struct bevy::camera::visibility::VisibleEntityRanges")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [VisibleEntityRanges](struct.VisibleEntityRanges.html "struct bevy::camera::visibility::VisibleEntityRanges")
