...
[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/mod.rs.html#211)
...
Bevy’s various rendering subsystems (3D, 2D, etc.) want to be able to quickly winnow the set of entities to only those that the subsystem is tasked with rendering, to avoid spending time examining irrelevant entities. At the same time, Bevy wants the [`check_visibility_cpu_culling`](fn.check_visibility_cpu_culling.html "fn bevy::camera::visibility::check_visibility_cpu_culling") system to determine all entities’ visibilities at the same time, regardless of what rendering subsystem is responsible for drawing them. Additionally, your application may want to add more types of renderable objects that Bevy determines visibility for just as it does for Bevy’s built-in objects.

The solution to this problem is _visibility classes_. A visibility class is a type, typically the type of a component, that represents the subsystem that renders it: for example, `Mesh3d`, `Mesh2d`, and `Sprite`. The [`VisibilityClass`](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass") component stores the visibility class or classes that the entity belongs to. (Generally, an object will belong to only one visibility class, but in rare cases it may belong to multiple.)

When adding a new renderable component, you’ll typically want to write an add-component hook that adds the type ID of that component to the [`VisibilityClass`](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass") array. See `custom_phase_item` for an example.

`VisibilityClass` is automatically added by a hook on the `Mesh3d` and `Mesh2d` components. To avoid duplicating the `VisibilityClass` and causing issues when cloning, we use `#[component(clone_behavior=Ignore)]`

## Tuple Fields

`0: [SmallVec](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/struct.SmallVec.html "struct smallvec::SmallVec")<[[TypeId](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId"); [1](https://doc.rust-lang.org/nightly/std/primitive.array.html)]>`

## Methods from [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")<Target = [SmallVec](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/struct.SmallVec.html "struct smallvec::SmallVec")<\[[TypeId](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId"); [1](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]>>

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#923)
...
[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#950)

#### pub fn [inline\_size](#method.inline_size)(&self) -> [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)

The maximum number of elements this vector can hold inline

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#956)

#### pub fn [len](#method.len)(&self) -> [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)

The number of elements stored in the vector

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#962)

#### pub fn [is\_empty](#method.is_empty)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if the vector is empty

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#968)

#### pub fn [capacity](#method.capacity)(&self) -> [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)

The number of items the vector can hold without reallocating

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1005)

#### pub fn [spilled](#method.spilled)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if the data has spilled into a separate heap-allocated buffer.

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1022-1024)

#### pub fn [drain](#method.drain)<R>(&mut self, range: R) -> [Drain](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/struct.Drain.html "struct smallvec::Drain")<'\_, A> [ⓘ](#)
...
[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1118)

#### pub fn [push](#method.push)(&mut self, value: <A as [Array](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html "trait smallvec::Array")\>::[Item](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html#associatedtype.Item "type smallvec::Array::Item"))

Append an item to the vector.

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1134)

#### pub fn [pop](#method.pop)(&mut self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<A as [Array](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html "trait smallvec::Array")\>::[Item](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html#associatedtype.Item "type smallvec::Array::Item")\>

Remove an item from the end of the vector and return it, or None if empty.

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1159-1161)

#### pub fn [append](#method.append)<B>(&mut self, other: &mut [SmallVec](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/struct.SmallVec.html "struct smallvec::SmallVec")<B>)

where B: [Array](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html "trait smallvec::Array")<Item = <A as [Array](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html "trait smallvec::Array")\>::[Item](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html#associatedtype.Item "type smallvec::Array::Item")\>,
...
[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1170)

#### pub fn [grow](#method.grow)(&mut self, new\_cap: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html))

Re-allocate to set the capacity to `max(new_cap, inline_size())`.

Panics if `new_cap` is less than the vector’s length or if the capacity computation overflows `usize`.

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1177)

#### pub fn [try\_grow](#method.try_grow)(&mut self, new\_cap: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [CollectionAllocErr](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/enum.CollectionAllocErr.html "enum smallvec::CollectionAllocErr")\>

Re-allocate to set the capacity to `max(new_cap, inline_size())`.

Panics if `new_cap` is less than the vector’s length

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1223)
...
[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1241)

#### pub fn [try\_reserve](#method.try_reserve)( &mut self, additional: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [CollectionAllocErr](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/enum.CollectionAllocErr.html "enum smallvec::CollectionAllocErr")\>

Reserve capacity for `additional` more elements to be inserted.

May reserve more space to avoid frequent reallocations.

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1258)
...
[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1263)

#### pub fn [try\_reserve\_exact](#method.try_reserve_exact)( &mut self, additional: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [CollectionAllocErr](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/enum.CollectionAllocErr.html "enum smallvec::CollectionAllocErr")\>

Reserve the minimum capacity for `additional` more elements to be inserted.

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1278)
...
[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1303)
...
[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1318)

#### pub fn [as\_slice](#method.as_slice)(&self) -> &\[<A as [Array](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html "trait smallvec::Array")\>::[Item](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html#associatedtype.Item "type smallvec::Array::Item")\]

Extracts a slice containing the entire vector.

Equivalent to `&s[..]`.

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1325)

#### pub fn [as\_mut\_slice](#method.as_mut_slice)(&mut self) -> &mut \[<A as [Array](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html "trait smallvec::Array")\>::[Item](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html#associatedtype.Item "type smallvec::Array::Item")\]

Extracts a mutable slice of the entire vector.

Equivalent to `&mut s[..]`.

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1335)

#### pub fn [swap\_remove](#method.swap_remove)(&mut self, index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> <A as [Array](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html "trait smallvec::Array")\>::[Item](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html#associatedtype.Item "type smallvec::Array::Item")
...
[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1344)

#### pub fn [clear](#method.clear)(&mut self)

Remove all elements from the vector.

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1352)

#### pub fn [remove](#method.remove)(&mut self, index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> <A as [Array](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html "trait smallvec::Array")\>::[Item](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html#associatedtype.Item "type smallvec::Array::Item")

Remove and return the element at position `index`, shifting all elements after it to the left.

Panics if `index` is out of bounds.

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1368)

#### pub fn [insert](#method.insert)(&mut self, index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), element: <A as [Array](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html "trait smallvec::Array")\>::[Item](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html#associatedtype.Item "type smallvec::Array::Item"))

Insert an element at position `index`, shifting all elements after it to the right.

Panics if `index > len`.

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1395)

#### pub fn [insert\_many](#method.insert_many)<I>(&mut self, index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), iterable: I)

where I: [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = <A as [Array](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html "trait smallvec::Array")\>::[Item](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html#associatedtype.Item "type smallvec::Array::Item")\>,

Insert multiple elements at position `index`, shifting all following elements toward the back.

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1524)

#### pub fn [retain](#method.retain)<F>(&mut self, f: F)

where F: [FnMut](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html "trait core::ops::function::FnMut")(&mut <A as [Array](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html "trait smallvec::Array")\>::[Item](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html#associatedtype.Item "type smallvec::Array::Item")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html),
...
[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1542)
...
[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1547-1549)

#### pub fn [dedup](#method.dedup)(&mut self)

where <A as [Array](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html "trait smallvec::Array")\>::[Item](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html#associatedtype.Item "type smallvec::Array::Item"): [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"),

Removes consecutive duplicate elements.

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1555-1557)

#### pub fn [dedup\_by](#method.dedup_by)<F>(&mut self, same\_bucket: F)

where F: [FnMut](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html "trait core::ops::function::FnMut")(&mut <A as [Array](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html "trait smallvec::Array")\>::[Item](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html#associatedtype.Item "type smallvec::Array::Item"), &mut <A as [Array](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html "trait smallvec::Array")\>::[Item](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html#associatedtype.Item "type smallvec::Array::Item")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html),

Removes consecutive duplicate elements using the given equality relation.

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1587-1590)

#### pub fn [dedup\_by\_key](#method.dedup_by_key)<F, K>(&mut self, key: F)

where F: [FnMut](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html "trait core::ops::function::FnMut")(&mut <A as [Array](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html "trait smallvec::Array")\>::[Item](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html#associatedtype.Item "type smallvec::Array::Item")) -> K, K: [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"),

Removes consecutive elements that map to the same key.

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1620-1622)
...
where F: [FnMut](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html "trait core::ops::function::FnMut")() -> <A as [Array](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html "trait smallvec::Array")\>::[Item](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html#associatedtype.Item "type smallvec::Array::Item"),
...
[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1720)

#### pub fn [as\_ptr](#method.as_ptr)(&self) -> [\*const](https://doc.rust-lang.org/nightly/std/primitive.pointer.html) <A as [Array](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html "trait smallvec::Array")\>::[Item](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html#associatedtype.Item "type smallvec::Array::Item")

Returns a raw pointer to the vector’s buffer.

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1728)

#### pub fn [as\_mut\_ptr](#method.as_mut_ptr)(&mut self) -> [\*mut](https://doc.rust-lang.org/nightly/std/primitive.pointer.html) <A as [Array](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html "trait smallvec::Array")\>::[Item](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html#associatedtype.Item "type smallvec::Array::Item")

Returns a raw mutable pointer to the vector’s buffer.

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1775)

#### pub fn [insert\_from\_slice](#method.insert_from_slice)(&mut self, index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), slice: &\[<A as [Array](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html "trait smallvec::Array")\>::[Item](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html#associatedtype.Item "type smallvec::Array::Item")\])

Copy elements from a slice into the vector at position `index`, shifting any following elements toward the back.

For slices of `Copy` types, this is more efficient than `insert`.

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1794)

#### pub fn [extend\_from\_slice](#method.extend_from_slice)(&mut self, slice: &\[<A as [Array](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html "trait smallvec::Array")\>::[Item](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html#associatedtype.Item "type smallvec::Array::Item")\])

Copy elements from a slice and append them to the vector.

For slices of `Copy` types, this is more efficient than `extend`.

[Source](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/src/smallvec/lib.rs.html#1810)

#### pub fn [resize](#method.resize)(&mut self, len: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), value: <A as [Array](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html "trait smallvec::Array")\>::[Item](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html#associatedtype.Item "type smallvec::Array::Item"))
...
## Methods from [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")<Target = \[<A as [Array](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html "trait smallvec::Array")\>::[Item](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/trait.Array.html#associatedtype.Item "type smallvec::Array::Item")\]>
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/mod.rs.html#208)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")

where [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/mod.rs.html#208)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/mod.rs.html#208)

### impl [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/mod.rs.html#208)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = [SmallVec](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/struct.SmallVec.html "struct smallvec::SmallVec")<\[[TypeId](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId"); [1](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]>

The resulting type after dereferencing.

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/mod.rs.html#208)

#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass") as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/mod.rs.html#208)

### impl [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/mod.rs.html#208)

#### fn [deref\_mut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html#tymethod.deref_mut)(&mut self) -> &mut <[VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass") as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Mutably dereferences the value.

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/mod.rs.html#208)

### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/mod.rs.html#208)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/mod.rs.html#208)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/mod.rs.html#208)

### impl [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/mod.rs.html#208)

#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")
...
where [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass"): 'into\_return,
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/mod.rs.html#208)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/mod.rs.html#209)
...
### impl [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/visibility/mod.rs.html#208)

#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [TupleStruct](../../prelude/trait.TupleStruct.html "trait bevy::prelude::TupleStruct") for [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")
...
### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [VisibilityClass](struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass")
