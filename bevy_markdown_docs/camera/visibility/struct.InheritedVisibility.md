...
This is a computed component that users should not change manually. To set the visibility of an entity, use [`Visibility`](../../prelude/enum.Visibility.html "enum bevy::prelude::Visibility") instead. For more information, see [module level documentation](index.html#what-is-the-difference-between-visibility-components "mod bevy::camera::visibility").

This property is updated in [`VisibilityPropagate`](enum.VisibilitySystems.html#variant.VisibilityPropagate "variant bevy::camera::visibility::VisibilitySystems::VisibilityPropagate") in the [`PostUpdate`](../../prelude/struct.PostUpdate.html "struct bevy::prelude::PostUpdate") schedule. Until then, it is not up to date with [`Visibility`](../../prelude/enum.Visibility.html "enum bevy::prelude::Visibility") if it was changed in the same frame.
