...
# Struct AtmosphereEnvironmentMapLight 

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#300)
...
Attach this to a [`Camera3d`](../prelude/struct.Camera3d.html "struct bevy::prelude::Camera3d") to light the entire view, or to a [`LightProbe`](../prelude/struct.LightProbe.html "struct bevy::prelude::LightProbe") to light only a specific region. Behind the scenes, this generates an environment map from the atmosphere for image-based lighting and inserts a corresponding [`GeneratedEnvironmentMapLight`](../prelude/struct.GeneratedEnvironmentMapLight.html "struct bevy::prelude::GeneratedEnvironmentMapLight").

For HDRI-based lighting, use a preauthored [`EnvironmentMapLight`](../prelude/struct.EnvironmentMapLight.html "struct bevy::prelude::EnvironmentMapLight") or filter one at runtime with [`GeneratedEnvironmentMapLight`](../prelude/struct.GeneratedEnvironmentMapLight.html "struct bevy::prelude::GeneratedEnvironmentMapLight").
...
[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#299)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [AtmosphereEnvironmentMapLight](struct.AtmosphereEnvironmentMapLight.html "struct bevy::light::AtmosphereEnvironmentMapLight")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#299)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [AtmosphereEnvironmentMapLight](struct.AtmosphereEnvironmentMapLight.html "struct bevy::light::AtmosphereEnvironmentMapLight")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [AtmosphereEnvironmentMapLight](struct.AtmosphereEnvironmentMapLight.html "struct bevy::light::AtmosphereEnvironmentMapLight")

where [AtmosphereEnvironmentMapLight](struct.AtmosphereEnvironmentMapLight.html "struct bevy::light::AtmosphereEnvironmentMapLight"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#313)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [AtmosphereEnvironmentMapLight](struct.AtmosphereEnvironmentMapLight.html "struct bevy::light::AtmosphereEnvironmentMapLight")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#314)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [AtmosphereEnvironmentMapLight](struct.AtmosphereEnvironmentMapLight.html "struct bevy::light::AtmosphereEnvironmentMapLight")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AtmosphereEnvironmentMapLight](struct.AtmosphereEnvironmentMapLight.html "struct bevy::light::AtmosphereEnvironmentMapLight")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AtmosphereEnvironmentMapLight](struct.AtmosphereEnvironmentMapLight.html "struct bevy::light::AtmosphereEnvironmentMapLight")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AtmosphereEnvironmentMapLight](struct.AtmosphereEnvironmentMapLight.html "struct bevy::light::AtmosphereEnvironmentMapLight")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AtmosphereEnvironmentMapLight](struct.AtmosphereEnvironmentMapLight.html "struct bevy::light::AtmosphereEnvironmentMapLight")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AtmosphereEnvironmentMapLight](struct.AtmosphereEnvironmentMapLight.html "struct bevy::light::AtmosphereEnvironmentMapLight")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AtmosphereEnvironmentMapLight](struct.AtmosphereEnvironmentMapLight.html "struct bevy::light::AtmosphereEnvironmentMapLight")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AtmosphereEnvironmentMapLight](struct.AtmosphereEnvironmentMapLight.html "struct bevy::light::AtmosphereEnvironmentMapLight")
