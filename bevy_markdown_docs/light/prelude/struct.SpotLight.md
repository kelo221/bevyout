[bevy](../../index.html)::[light](../index.html)::[prelude](index.html)

# Struct SpotLight 

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/spot_light.rs.html#26)
...
Behaves like a point light in a perfectly absorbent housing that shines light only in a given direction. The direction is taken from the transform, and can be specified with [`Transform::looking_at`](../../prelude/struct.Transform.html#method.looking_at "method bevy::prelude::Transform::looking_at").

To control the resolution of the shadow maps, use the [`DirectionalLightShadowMap`](../struct.DirectionalLightShadowMap.html "struct bevy::light::DirectionalLightShadowMap") resource.
...
`range: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`
...
`shadow_maps_enabled: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`
...
`contact_shadows_enabled: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

Whether this light casts contact shadows. Cameras must also have the `ContactShadows` component.

`soft_shadows_enabled: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

Available on **crate feature `experimental_pbr_pcss`** only.

Whether soft shadows are enabled.

Soft shadows, also known as _percentage-closer soft shadows_ or PCSS, cause shadows to become blurrier (i.e. their penumbra increases in radius) as they extend away from objects. The blurriness of the shadow depends on the [`SpotLight::radius`](../../prelude/struct.SpotLight.html#structfield.radius "field bevy::prelude::SpotLight::radius") of the light; larger lights result in larger penumbras and therefore blurrier shadows.

Currently, soft shadows are rather noisy if not using the temporal mode. If you enable soft shadows, consider choosing [`ShadowFilteringMethod::Temporal`](../enum.ShadowFilteringMethod.html#variant.Temporal "variant bevy::light::ShadowFilteringMethod::Temporal") and enabling temporal antialiasing (TAA) to smooth the noise out over time.

Note that soft shadows are significantly more expensive to render than hard shadows.

`affects_lightmapped_mesh_diffuse: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`
...
`shadow_depth_bias: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

A value that adjusts the tradeoff between self-shadowing artifacts and proximity of shadows to their casters.

This value frequently must be tuned to the specific scene; this is normal and a well-known part of the shadow mapping workflow. If set too low, unsightly shadow patterns appear on objects not in shadow as objects incorrectly cast shadows on themselves, known as _shadow acne_. If set too high, shadows detach from the objects casting them and seem to “fly” off the objects, known as _Peter Panning_.

`shadow_normal_bias: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`
...
`shadow_map_near_z: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`
...
`outer_angle: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Angle defining the distance from the spot light direction to the outer limit of the light’s cone of effect. `outer_angle` should be < `PI / 2.0`. `PI / 2.0` defines a hemispherical spot light, but shadows become very blocky as the angle approaches this limit.

`inner_angle: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Angle defining the distance from the spot light direction to the inner limit of the light’s cone of effect. Light is attenuated from `inner_angle` to `outer_angle` to give a smooth falloff. `inner_angle` should be <= `outer_angle`

## Implementations

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/spot_light.rs.html#132)

### impl [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/spot_light.rs.html#134)

#### pub const [DEFAULT\_SHADOW\_DEPTH\_BIAS](#associatedconstant.DEFAULT_SHADOW_DEPTH_BIAS): [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html) = 0.02

The default value of [`SpotLight::shadow_depth_bias`](../../prelude/struct.SpotLight.html#structfield.shadow_depth_bias "field bevy::prelude::SpotLight::shadow_depth_bias").

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/spot_light.rs.html#136)

#### pub const [DEFAULT\_SHADOW\_NORMAL\_BIAS](#associatedconstant.DEFAULT_SHADOW_NORMAL_BIAS): [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html) = 1.8

The default value of [`SpotLight::shadow_normal_bias`](../../prelude/struct.SpotLight.html#structfield.shadow_normal_bias "field bevy::prelude::SpotLight::shadow_normal_bias").

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/spot_light.rs.html#138)

#### pub const [DEFAULT\_SHADOW\_MAP\_NEAR\_Z](#associatedconstant.DEFAULT_SHADOW_MAP_NEAR_Z): [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html) = 0.1

The default value of [`SpotLight::shadow_map_near_z`](../../prelude/struct.SpotLight.html#structfield.shadow_map_near_z "field bevy::prelude::SpotLight::shadow_map_near_z").

## Trait Implementations

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/spot_light.rs.html#22)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/spot_light.rs.html#22)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")

where [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

**Required Components**: [`Frustum`](../../camera/primitives/struct.Frustum.html "struct bevy::camera::primitives::Frustum"), [`VisibleMeshEntities`](../../camera/visibility/struct.VisibleMeshEntities.html "struct bevy::camera::visibility::VisibleMeshEntities"), [`Transform`](../../prelude/struct.Transform.html "struct bevy::prelude::Transform"), [`Visibility`](../../prelude/enum.Visibility.html "enum bevy::prelude::Visibility"), [`VisibilityClass`](../../camera/visibility/struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass").
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/spot_light.rs.html#22)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")
...
[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/spot_light.rs.html#141)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/spot_light.rs.html#142)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/spot_light.rs.html#22)

### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/spot_light.rs.html#22)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/spot_light.rs.html#22)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")
...
where [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight"): 'into\_return,
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/spot_light.rs.html#22)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/spot_light.rs.html#23)
...
#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [SyncComponent](../../render/sync_component/trait.SyncComponent.html "trait bevy::render::sync_component::SyncComponent")<[PbrPlugin](../../pbr/struct.PbrPlugin.html "struct bevy::pbr::PbrPlugin")\> for [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/lib.rs.html#529)

#### type [Target](../../render/sync_component/trait.SyncComponent.html#associatedtype.Target) = ([SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight"), [ExtractedPointLight](../../pbr/struct.ExtractedPointLight.html "struct bevy::pbr::ExtractedPointLight"), [RenderExtractedShadowMapVisibleEntities](../../render/view/struct.RenderExtractedShadowMapVisibleEntities.html "struct bevy::render::view::RenderExtractedShadowMapVisibleEntities"), [RenderShadowMapVisibleEntities](../../render/view/struct.RenderShadowMapVisibleEntities.html "struct bevy::render::view::RenderShadowMapVisibleEntities"), [PointAndSpotLightViewEntities](../../pbr/struct.PointAndSpotLightViewEntities.html "struct bevy::pbr::PointAndSpotLightViewEntities"))
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SpotLight](../../prelude/struct.SpotLight.html "struct bevy::prelude::SpotLight")
