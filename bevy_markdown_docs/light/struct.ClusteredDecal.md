...
[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/cluster/mod.rs.html#233)
...
Conceptually, a clustered decal is a 1×1×1 cube centered on its origin. It projects its images onto surfaces in the -Z direction (thus you may find [`Transform::looking_at`](../prelude/struct.Transform.html#method.looking_at "method bevy::prelude::Transform::looking_at") useful).

Each decal may project any of a base color texture, a normal map, a metallic/roughness map, and/or a texture that specifies emissive light. In addition, you may associate an arbitrary integer [`Self::tag`](struct.ClusteredDecal.html#structfield.tag "field bevy::light::ClusteredDecal::tag") with each clustered decal, which Bevy doesn’t use, but that you can use in your shaders in order to associate application-specific data with your decals.
...
The image that the clustered decal projects onto the base color of the surface material.
...
Bevy uses the _Whiteout_ method to combine normal maps from decals with any normal map that the surface has, as described in the [_Blending in Detail_ article](https://blog.selfshadow.com/publications/blending-in-detail/).

Note that the normal map must be three-channel and must be in OpenGL format, not DirectX format. That is, the green channel must point up, not down.
...
The metallic-roughness map that the clustered decal projects onto surfaces.

Metallic and roughness PBR parameters are blended onto the base surface using the alpha channel of the base color.

Metallic is expected to be in the blue channel, while roughness is expected to be in the green channel, following glTF conventions.
...
Including this texture effectively causes the decal to glow. The emissive component is blended onto the surface according to the alpha channel.

`tag: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

An application-specific tag you can use for any purpose you want, in conjunction with a custom shader.

This value is exposed to the shader via the iterator API (`bevy_pbr::decal::clustered::clustered_decal_iterator_new` and `bevy_pbr::decal::clustered::clustered_decal_iterator_next`).

For example, you might use the tag to restrict the set of surfaces to which a decal can be rendered.
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/cluster/mod.rs.html#229)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")

where [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

**Required Components**: [`Transform`](../prelude/struct.Transform.html "struct bevy::prelude::Transform"), [`ViewVisibility`](../prelude/struct.ViewVisibility.html "struct bevy::prelude::ViewVisibility"), [`Visibility`](../prelude/enum.Visibility.html "enum bevy::prelude::Visibility"), [`VisibilityClass`](../camera/visibility/struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass").
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/cluster/mod.rs.html#229)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/cluster/mod.rs.html#229)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/cluster/mod.rs.html#229)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/cluster/mod.rs.html#229)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/cluster/mod.rs.html#229)

### impl [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/cluster/mod.rs.html#229)

#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")
...
where [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal"): 'into\_return,
...
### impl [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")
...
#### fn [reflect\_owned](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/cluster/mod.rs.html#229)

#### fn [try\_into\_reflect](../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/cluster/mod.rs.html#230)
...
### impl [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/cluster/mod.rs.html#229)

#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Struct](../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")
...
### impl [SyncComponent](../render/sync_component/trait.SyncComponent.html "trait bevy::render::sync_component::SyncComponent")<[ClusteredDecalPlugin](../pbr/struct.ClusteredDecalPlugin.html "struct bevy::pbr::ClusteredDecalPlugin")\> for [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/decal/clustered.rs.html#188)

#### type [Target](../render/sync_component/trait.SyncComponent.html#associatedtype.Target) = [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")

Describes what components should be removed from the render world if the implementing component is removed.

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/cluster/mod.rs.html#229)

### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ClusteredDecal](struct.ClusteredDecal.html "struct bevy::light::ClusteredDecal")
