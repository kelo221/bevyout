...
[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/atmosphere.rs.html#133)
...
*   how much light the medium _absorbs_ per unit length
*   how much light the medium _scatters_ per unit length
*   what _directions_ the medium is likely to scatter light in.

The first two are fairly simple, and are sometimes referred to together (accurately enough) as the medium’s [optical density](https://en.wikipedia.org/wiki/Optical_Density).

The last, defined by a [phase function](https://www.pbr-book.org/4ed/Volume_Scattering/Phase_Functions), is the most important in creating the look of a medium. Our brains are very good at noticing (if unconsciously) that a dust storm scatters light differently than a rain cloud, for example. See the docs on [`PhaseFunction`](enum.PhaseFunction.html "enum bevy::light::atmosphere::PhaseFunction") for more info.

In reality, media are often composed of multiple elements that scatter light independently, for Earth’s atmosphere is composed of the gas itself, but also suspended dust and particulate. These each scatter light differently, and are distributed in different amounts at different altitudes. In a [`ScatteringMedium`](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium"), these are each represented by a [`ScatteringTerm`](struct.ScatteringTerm.html "struct bevy::light::atmosphere::ScatteringTerm")

### Technical Details

A [`ScatteringMedium`](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium") is represented on the GPU by a set of two LUTs, which are re-created every time the asset is modified. See the docs on `bevy_pbr::GpuScatteringMedium` for more info.

## Fields

`label: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Cow](https://doc.rust-lang.org/nightly/alloc/borrow/enum.Cow.html "enum alloc::borrow::Cow")<'static, [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)>>`
...
The resolution at which to sample the falloff distribution of each scattering term. Custom or more detailed distributions may benefit from a higher value, at the cost of more memory use.

`phase_resolution: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

The resolution at which to sample the phase function of each scattering term. Custom or more detailed phase functions may benefit from a higher value, at the cost of more memory use.

`terms: [SmallVec](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/struct.SmallVec.html "struct smallvec::SmallVec")<[[ScatteringTerm](struct.ScatteringTerm.html "struct bevy::light::atmosphere::ScatteringTerm"); [1](https://doc.rust-lang.org/nightly/std/primitive.array.html)]>`

The list of [`ScatteringTerm`](struct.ScatteringTerm.html "struct bevy::light::atmosphere::ScatteringTerm")s that compose this [`ScatteringMedium`](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")

## Implementations

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/atmosphere.rs.html#154)

### impl [ScatteringMedium](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/atmosphere.rs.html#157-161)

#### pub fn [new](#method.new)( falloff\_resolution: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html), phase\_resolution: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html), terms: impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [ScatteringTerm](struct.ScatteringTerm.html "struct bevy::light::atmosphere::ScatteringTerm")\>, ) -> [ScatteringMedium](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")

Returns a scattering medium with a default label and the specified scattering terms.

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/atmosphere.rs.html#171)

#### pub fn [with\_label](#method.with_label)(self, label: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Cow](https://doc.rust-lang.org/nightly/alloc/borrow/enum.Cow.html "enum alloc::borrow::Cow")<'static, [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>>) -> [ScatteringMedium](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")

Consumes and returns this scattering medium with a new label.

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/atmosphere.rs.html#180)

#### pub fn [with\_density\_multiplier](#method.with_density_multiplier)(self, multiplier: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [ScatteringMedium](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")

Consumes and returns this scattering medium with each scattering terms’ densities multiplied by `multiplier`.

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/atmosphere.rs.html#195)

#### pub fn [earth](#method.earth)(falloff\_resolution: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html), phase\_resolution: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [ScatteringMedium](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")
...
examples/3d/atmosphere.rs ([line 132](../../../src/atmosphere/atmosphere.rs.html#132))
...
[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/atmosphere.rs.html#238)

#### pub fn [mars](#method.mars)( falloff\_resolution: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html), phase\_resolution: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html), dust\_phase: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Image](../../prelude/struct.Image.html "struct bevy::prelude::Image")\>, ) -> [ScatteringMedium](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")

Returns a scattering medium representing a Martian atmosphere [Schneegans et al. 2024](https://doi.org/10.1111/cgf.15010).
...
examples/3d/atmosphere.rs ([line 134](../../../src/atmosphere/atmosphere.rs.html#134))
...
### impl [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset") for [ScatteringMedium](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/atmosphere.rs.html#132)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ScatteringMedium](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/atmosphere.rs.html#132)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ScatteringMedium](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")
...
[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/atmosphere.rs.html#148)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [ScatteringMedium](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/atmosphere.rs.html#149)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [ScatteringMedium](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/atmosphere.rs.html#132)

### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [ScatteringMedium](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")
...
### impl [VisitAssetDependencies](../../asset/trait.VisitAssetDependencies.html "trait bevy::asset::VisitAssetDependencies") for [ScatteringMedium](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ScatteringMedium](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ScatteringMedium](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ScatteringMedium](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ScatteringMedium](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ScatteringMedium](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ScatteringMedium](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ScatteringMedium](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")
