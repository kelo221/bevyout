...
`medium: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[ScatteringMedium](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")>`

A handle to a [`ScatteringMedium`](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium"), which describes the substance of the atmosphere and how it scatters light.
...
#### pub fn [earth](#method.earth)(medium: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[ScatteringMedium](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")\>) -> [Atmosphere](../struct.Atmosphere.html "struct bevy::light::Atmosphere")

An atmosphere like that of earth. Use this with a [`ScatteringMedium::earth`](struct.ScatteringMedium.html#method.earth "associated function bevy::light::atmosphere::ScatteringMedium::earth") handle.
...
#### pub fn [mars](#method.mars)(medium: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[ScatteringMedium](struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")\>) -> [Atmosphere](../struct.Atmosphere.html "struct bevy::light::Atmosphere")

Martian atmosphere; use this with a [`ScatteringMedium::mars`](struct.ScatteringMedium.html#method.mars "associated function bevy::light::atmosphere::ScatteringMedium::mars") handle.
...
#### type [Template](../../prelude/trait.FromTemplate.html#associatedtype.Template) = [AtmosphereTemplate](struct.AtmosphereTemplate.html "struct bevy::light::atmosphere::AtmosphereTemplate")
