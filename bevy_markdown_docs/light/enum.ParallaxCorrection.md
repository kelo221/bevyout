...
[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#412)
...
For environment maps added directly to a camera, Bevy renders the reflected scene that a cubemap captures as though it were infinitely far away. This is acceptable if the cubemap captures very distant objects, such as distant mountains in outdoor scenes. It’s less ideal, however, if the cubemap reflects near objects, such as the interior of a room. Therefore, by default for reflection probes Bevy uses _parallax-corrected cubemaps_ (PCCM), which causes Bevy to treat the reflected scene as though it coincided with the boundaries of the light probe.

As an example, for indoor scenes, it’s common to place reflection probes inside each room and to make the boundaries of the reflection probe (as determined by the light probe’s [`bevy_transform::components::Transform`](../prelude/struct.Transform.html "struct bevy::prelude::Transform")) coincide with the walls of the room. That way, the reflection probes will (1) apply to the objects inside the room and (2) take the positions of those objects into account in order to create a realistic reflection.

Instead of having the simulated boundaries of the reflected area coincide with the boundaries of the light probe, it’s also possible to specify _custom_ parallax correction boundaries, so that the region of influence of the light probe doesn’t correspond with the simulated boundaries used for parallax correction. This is commonly used when the boundaries of the light probe are slightly larger than the room that the light probe contains, for instance in order to avoid artifacts along the edges of the room that occur due to rounding error, or else when the _falloff_ feature is used that blends reflection probes into adjacent ones.

Place this component on an entity that has a [`LightProbe`](../prelude/struct.LightProbe.html "struct bevy::prelude::LightProbe") and [`EnvironmentMapLight`](../prelude/struct.EnvironmentMapLight.html "struct bevy::prelude::EnvironmentMapLight") component in order to either (1) opt out of parallax correction via [`ParallaxCorrection::None`](enum.ParallaxCorrection.html#variant.None "variant bevy::light::ParallaxCorrection::None") or (2) specify custom parallax correction boundaries via [`ParallaxCorrection::Custom`](enum.ParallaxCorrection.html#variant.Custom "variant bevy::light::ParallaxCorrection::Custom"). If you don’t manually place this component on a reflection probe, Bevy will automatically add a [`ParallaxCorrection::Auto`](enum.ParallaxCorrection.html#variant.Auto "variant bevy::light::ParallaxCorrection::Auto") component so that the boundaries of the light probe will coincide with the simulated boundaries used for parallax correction.

See the `pccm` example for an example of usage of parallax-corrected cubemaps and the `light_probe_blending` example for an example of use of custom parallax correction boundaries.
...
This component causes Bevy to render the reflection as though the reflected surface were infinitely distant.

### Auto

The parallax correction boundaries correspond with the boundaries of the light probe.

This is the default value. Bevy automatically adds this component value to reflection probes that don’t have a [`ParallaxCorrection`](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection") component. It’s equivalent to `ParallaxCorrection::Custom(Vec3::splat(0.5))`.

### Custom([Vec3](../prelude/struct.Vec3.html "struct bevy::prelude::Vec3"))

The parallax correction boundaries are specified manually.

The simulated reflection boundaries are specified as an axis-aligned cube _in light probe space_ with the given _half_ extents. Thus, for example, if you set the parallax correction boundaries to `vec3(0.5, 1.0, 2.0)` and the scale of the light probe is `vec3(3.0, 3.0, 3.0)`, then the simulated boundaries of the reflected area used for parallax correction will be centered on the reflection probe with a width of 3.0 m, a height of 6.0 m, and a depth of 12.0 m.

## Trait Implementations

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#410)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#410)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")

where [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
#### fn [map\_entities](../prelude/trait.Component.html#method.map_entities)<M>(this: &mut [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection"), mapper: [&mut M](https://doc.rust-lang.org/nightly/std/primitive.reference.html))
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#410)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#410)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#410)

### impl [Enum](../reflect/enums/trait.Enum.html "trait bevy::reflect::enums::Enum") for [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")
...
### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#410)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#410)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#410)

### impl [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#410)

#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)( \_\_param0: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")
...
where [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection"): 'into\_return,
...
### impl [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")
...
#### fn [reflect\_owned](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#410)

#### fn [try\_into\_reflect](../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")\>, ) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#411)
...
### impl [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#410)

#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ParallaxCorrection](enum.ParallaxCorrection.html "enum bevy::light::ParallaxCorrection")
