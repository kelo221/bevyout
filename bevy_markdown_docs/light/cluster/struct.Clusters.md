...
[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/cluster/mod.rs.html#143)
...
`tile_size: [UVec2](../../prelude/struct.UVec2.html "struct bevy::prelude::UVec2")`
...
Distance to the far plane of the first depth slice. The first depth slice is special and explicitly-configured to avoid having unnecessarily many slices close to the camera.

`far: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Distance to the far plane of the last depth slice. This may change depending on [`ClusterZConfig`](struct.ClusterZConfig.html "struct bevy::light::cluster::ClusterZConfig") used.

`last_frame_farthest_z: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)>`

The farthest Z value of any bounding sphere of any clusterable object on the previous frame.

This is used for the [`ClusterFarZMode::MaxClusterableObjectRange`](enum.ClusterFarZMode.html#variant.MaxClusterableObjectRange "variant bevy::light::cluster::ClusterFarZMode::MaxClusterableObjectRange") feature.

`last_frame_total_cluster_index_count: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)>`

The sum of the number of objects that all clusters contained last frame.

This is used for the `dynamic_resizing` feature, which automatically grows the number of clusters if clusters have likely become too large.

`clusterable_objects: [ClusterableObjects](enum.ClusterableObjects.html "enum bevy::light::cluster::ClusterableObjects")`

All objects within the cluster.

## Trait Implementations

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/cluster/mod.rs.html#142)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [Clusters](struct.Clusters.html "struct bevy::light::cluster::Clusters")

where [Clusters](struct.Clusters.html "struct bevy::light::cluster::Clusters"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Clusters](struct.Clusters.html "struct bevy::light::cluster::Clusters")
...
[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/cluster/mod.rs.html#379)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Clusters](struct.Clusters.html "struct bevy::light::cluster::Clusters")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/cluster/mod.rs.html#380)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Clusters](struct.Clusters.html "struct bevy::light::cluster::Clusters")
...
### impl<'a> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'a [Clusters](struct.Clusters.html "struct bevy::light::cluster::Clusters")\> for [ExtractedClusterConfig](../../pbr/struct.ExtractedClusterConfig.html "struct bevy::pbr::ExtractedClusterConfig")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#173)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(clusters: &'a [Clusters](struct.Clusters.html "struct bevy::light::cluster::Clusters")) -> [ExtractedClusterConfig](../../pbr/struct.ExtractedClusterConfig.html "struct bevy::pbr::ExtractedClusterConfig")

Converts to this type from the input type.

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Clusters](struct.Clusters.html "struct bevy::light::cluster::Clusters")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Clusters](struct.Clusters.html "struct bevy::light::cluster::Clusters")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Clusters](struct.Clusters.html "struct bevy::light::cluster::Clusters")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Clusters](struct.Clusters.html "struct bevy::light::cluster::Clusters")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Clusters](struct.Clusters.html "struct bevy::light::cluster::Clusters")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Clusters](struct.Clusters.html "struct bevy::light::cluster::Clusters")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Clusters](struct.Clusters.html "struct bevy::light::cluster::Clusters")
