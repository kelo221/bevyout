...
[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/atmosphere.rs.html#35)
...
If [`GlobalTransform`](../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform") is still [`Default`](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") when this component is first added, it is placed `radius` units directly below the origin on the `Y` axis, so that the planet’s normal is roughly `Vec3::Y` around the origin, likely where your camera/scene is located. Unless you’re making a game set in space, this is probably what you want. Otherwise, feel free to override this default by setting a transform manually.

The scale on [`GlobalTransform`](../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform") rescales the planet in world space. Tune it with the radius offset when your scene uses other units, like kilometer-sized scenes.

## Fields

`inner_radius: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Radius of the planet

units: m

`outer_radius: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Radius at which we consider the atmosphere to ‘end’ for our calculations (from center of planet)

units: m

`ground_albedo: [Vec3](../prelude/struct.Vec3.html "struct bevy::prelude::Vec3")`
...
`medium: [Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[ScatteringMedium](atmosphere/struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")>`

A handle to a [`ScatteringMedium`](atmosphere/struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium"), which describes the substance of the atmosphere and how it scatters light.

## Implementations

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/atmosphere.rs.html#70)

### impl [Atmosphere](struct.Atmosphere.html "struct bevy::light::Atmosphere")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/atmosphere.rs.html#72)

#### pub fn [earth](#method.earth)(medium: [Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[ScatteringMedium](atmosphere/struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")\>) -> [Atmosphere](struct.Atmosphere.html "struct bevy::light::Atmosphere")

An atmosphere like that of earth. Use this with a [`ScatteringMedium::earth`](atmosphere/struct.ScatteringMedium.html#method.earth "associated function bevy::light::atmosphere::ScatteringMedium::earth") handle.

##### [Examples found in repository](#scraped-examples)[?](../../scrape-examples-help.html)

examples/3d/atmosphere.rs ([line 82](../../src/atmosphere/atmosphere.rs.html#82))
...
[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/atmosphere.rs.html#89)

#### pub fn [mars](#method.mars)(medium: [Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[ScatteringMedium](atmosphere/struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")\>) -> [Atmosphere](struct.Atmosphere.html "struct bevy::light::Atmosphere")

Martian atmosphere; use this with a [`ScatteringMedium::mars`](atmosphere/struct.ScatteringMedium.html#method.mars "associated function bevy::light::atmosphere::ScatteringMedium::mars") handle.

Mean radius 3389.50 ± 0.2 km [Seidelmann et al. 2007, Table 4](https://doi.org/10.1007/s10569-007-9072-y).

##### [Examples found in repository](#scraped-examples-1)[?](../../scrape-examples-help.html)

examples/3d/atmosphere.rs ([line 90](../../src/atmosphere/atmosphere.rs.html#90))
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Atmosphere](struct.Atmosphere.html "struct bevy::light::Atmosphere")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/atmosphere.rs.html#32)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Atmosphere](struct.Atmosphere.html "struct bevy::light::Atmosphere")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [Atmosphere](struct.Atmosphere.html "struct bevy::light::Atmosphere")

where [Atmosphere](struct.Atmosphere.html "struct bevy::light::Atmosphere"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

**Required Components**: [`GlobalTransform`](../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform").
...
### impl [FromTemplate](../prelude/trait.FromTemplate.html "trait bevy::prelude::FromTemplate") for [Atmosphere](struct.Atmosphere.html "struct bevy::light::Atmosphere")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/atmosphere.rs.html#32)

#### type [Template](../prelude/trait.FromTemplate.html#associatedtype.Template) = [AtmosphereTemplate](atmosphere/struct.AtmosphereTemplate.html "struct bevy::light::atmosphere::AtmosphereTemplate")

The [`Template`](../prelude/trait.Template.html "trait bevy::prelude::Template") for this type.

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/atmosphere.rs.html#32)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Atmosphere](struct.Atmosphere.html "struct bevy::light::Atmosphere")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Atmosphere](struct.Atmosphere.html "struct bevy::light::Atmosphere")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Atmosphere](struct.Atmosphere.html "struct bevy::light::Atmosphere")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Atmosphere](struct.Atmosphere.html "struct bevy::light::Atmosphere")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Atmosphere](struct.Atmosphere.html "struct bevy::light::Atmosphere")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Atmosphere](struct.Atmosphere.html "struct bevy::light::Atmosphere")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Atmosphere](struct.Atmosphere.html "struct bevy::light::Atmosphere")
