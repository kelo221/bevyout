...
`cascades: [EntityHashMap](../../ecs/entity/struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<[Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[Cascade](struct.Cascade.html "struct bevy::light::cascade::Cascade")>>`

Map from a view to the configuration of each of its [`Cascade`](struct.Cascade.html "struct bevy::light::cascade::Cascade")s.
