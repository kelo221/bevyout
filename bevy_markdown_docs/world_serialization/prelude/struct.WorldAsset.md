...
To spawn a [`WorldAsset`](../../prelude/struct.WorldAsset.html "struct bevy::prelude::WorldAsset"), you can use either:

*   [`WorldInstanceSpawner::spawn`](../../prelude/struct.WorldInstanceSpawner.html#method.spawn "method bevy::prelude::WorldInstanceSpawner::spawn")
*   adding the [`WorldAssetRoot`](../../prelude/struct.WorldAssetRoot.html "struct bevy::prelude::WorldAssetRoot") component to an entity.

## Fields

`world: [World](../../prelude/struct.World.html "struct bevy::prelude::World")`
...
### impl [WorldAsset](../../prelude/struct.WorldAsset.html "struct bevy::prelude::WorldAsset")
...
#### pub fn [new](#method.new)(world: [World](../../prelude/struct.World.html "struct bevy::prelude::World")) -> [WorldAsset](../../prelude/struct.WorldAsset.html "struct bevy::prelude::WorldAsset")

Creates a new [`WorldAsset`](../../prelude/struct.WorldAsset.html "struct bevy::prelude::WorldAsset") with the given world.
...
#### pub fn [from\_dynamic\_world](#method.from_dynamic_world)( dynamic\_world: &[DynamicWorld](../../prelude/struct.DynamicWorld.html "struct bevy::prelude::DynamicWorld"), type\_registry: &[TypeRegistry](../../reflect/struct.TypeRegistry.html "struct bevy::reflect::TypeRegistry"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[WorldAsset](../../prelude/struct.WorldAsset.html "struct bevy::prelude::WorldAsset"), [WorldInstanceSpawnError](../enum.WorldInstanceSpawnError.html "enum bevy::world_serialization::WorldInstanceSpawnError")\>

Create a new [`WorldAsset`](../../prelude/struct.WorldAsset.html "struct bevy::prelude::WorldAsset") from a given dynamic world.
...
#### pub fn [clone\_with](#method.clone_with)( &self, type\_registry: &[AppTypeRegistry](../../prelude/struct.AppTypeRegistry.html "struct bevy::prelude::AppTypeRegistry"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[WorldAsset](../../prelude/struct.WorldAsset.html "struct bevy::prelude::WorldAsset"), [WorldInstanceSpawnError](../enum.WorldInstanceSpawnError.html "enum bevy::world_serialization::WorldInstanceSpawnError")\>

Clone the [`WorldAsset`](../../prelude/struct.WorldAsset.html "struct bevy::prelude::WorldAsset").

This method will return a [`WorldInstanceSpawnError`](../enum.WorldInstanceSpawnError.html "enum bevy::world_serialization::WorldInstanceSpawnError") if a type either is not registered in the provided [`AppTypeRegistry`](../../prelude/struct.AppTypeRegistry.html "struct bevy::prelude::AppTypeRegistry") or doesn’t reflect the [`Component`](../../prelude/trait.Component.html "trait bevy::prelude::Component") trait.
...
#### pub fn [write\_to\_world\_with](#method.write_to_world_with)( &self, world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World"), entity\_map: &mut [EntityHashMap](../../ecs/entity/struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\>, type\_registry: &[AppTypeRegistry](../../prelude/struct.AppTypeRegistry.html "struct bevy::prelude::AppTypeRegistry"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [WorldInstanceSpawnError](../enum.WorldInstanceSpawnError.html "enum bevy::world_serialization::WorldInstanceSpawnError")\>
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [WorldAsset](../../prelude/struct.WorldAsset.html "struct bevy::prelude::WorldAsset")
...
### impl [VisitAssetDependencies](../../asset/trait.VisitAssetDependencies.html "trait bevy::asset::VisitAssetDependencies") for [WorldAsset](../../prelude/struct.WorldAsset.html "struct bevy::prelude::WorldAsset")
...
### impl ![Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [WorldAsset](../../prelude/struct.WorldAsset.html "struct bevy::prelude::WorldAsset")

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [WorldAsset](../../prelude/struct.WorldAsset.html "struct bevy::prelude::WorldAsset")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [WorldAsset](../../prelude/struct.WorldAsset.html "struct bevy::prelude::WorldAsset")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [WorldAsset](../../prelude/struct.WorldAsset.html "struct bevy::prelude::WorldAsset")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [WorldAsset](../../prelude/struct.WorldAsset.html "struct bevy::prelude::WorldAsset")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [WorldAsset](../../prelude/struct.WorldAsset.html "struct bevy::prelude::WorldAsset")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [WorldAsset](../../prelude/struct.WorldAsset.html "struct bevy::prelude::WorldAsset")
