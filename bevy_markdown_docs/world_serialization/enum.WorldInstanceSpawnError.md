...
# Enum WorldInstanceSpawnError 

[Source](https://docs.rs/bevy_world_serialization/0.19.0/x86_64-unknown-linux-gnu/src/bevy_world_serialization/world_asset_spawner.rs.html#110)
...
`std_type_name: [DebugName](../prelude/struct.DebugName.html "struct bevy::prelude::DebugName")`

The [type name](https://doc.rust-lang.org/nightly/core/any/fn.type_name.html "fn core::any::type_name") for the unregistered type.
...
`id: [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[DynamicWorld](../prelude/struct.DynamicWorld.html "struct bevy::prelude::DynamicWorld")>`
...
`id: [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[WorldAsset](../prelude/struct.WorldAsset.html "struct bevy::prelude::WorldAsset")>`

Id of the non-existent world asset.

## Trait Implementations

[Source](https://docs.rs/bevy_world_serialization/0.19.0/x86_64-unknown-linux-gnu/src/bevy_world_serialization/world_asset_spawner.rs.html#109)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [WorldInstanceSpawnError](enum.WorldInstanceSpawnError.html "enum bevy::world_serialization::WorldInstanceSpawnError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [WorldInstanceSpawnError](enum.WorldInstanceSpawnError.html "enum bevy::world_serialization::WorldInstanceSpawnError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [WorldInstanceSpawnError](enum.WorldInstanceSpawnError.html "enum bevy::world_serialization::WorldInstanceSpawnError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [WorldInstanceSpawnError](enum.WorldInstanceSpawnError.html "enum bevy::world_serialization::WorldInstanceSpawnError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [WorldInstanceSpawnError](enum.WorldInstanceSpawnError.html "enum bevy::world_serialization::WorldInstanceSpawnError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [WorldInstanceSpawnError](enum.WorldInstanceSpawnError.html "enum bevy::world_serialization::WorldInstanceSpawnError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [WorldInstanceSpawnError](enum.WorldInstanceSpawnError.html "enum bevy::world_serialization::WorldInstanceSpawnError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [WorldInstanceSpawnError](enum.WorldInstanceSpawnError.html "enum bevy::world_serialization::WorldInstanceSpawnError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [WorldInstanceSpawnError](enum.WorldInstanceSpawnError.html "enum bevy::world_serialization::WorldInstanceSpawnError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [WorldInstanceSpawnError](enum.WorldInstanceSpawnError.html "enum bevy::world_serialization::WorldInstanceSpawnError")
