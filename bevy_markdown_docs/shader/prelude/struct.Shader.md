[bevy](../../index.html)::[shader](../index.html)::[prelude](index.html)
...
`path: [String](../../prelude/struct.String.html "struct bevy::prelude::String")`

The asset path of the shader.

`source: [Source](../enum.Source.html "enum bevy::shader::Source")`

The raw source code of the shader.

`import_path: [ShaderImport](../enum.ShaderImport.html "enum bevy::shader::ShaderImport")`

The path from which this shader can be imported by other shaders.

`imports: [Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[ShaderImport](../enum.ShaderImport.html "enum bevy::shader::ShaderImport")>`

The import paths this shader depends on.

`additional_imports: [Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[ImportDefinition](https://docs.rs/naga_oil/0.22.0/x86_64-unknown-linux-gnu/naga_oil/compose/struct.ImportDefinition.html "struct naga_oil::compose::ImportDefinition")>`

Extra imports not specified in the source string.

`shader_defs: [Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[ShaderDefVal](../enum.ShaderDefVal.html "enum bevy::shader::ShaderDefVal")>`

Any shader defs that should be included when this module is used.

`file_dependencies: [Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Shader](../../prelude/struct.Shader.html "struct bevy::prelude::Shader")>>`
...
#### pub fn [from\_wgsl\_with\_defs](#method.from_wgsl_with_defs)( source: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Cow](https://doc.rust-lang.org/nightly/alloc/borrow/enum.Cow.html "enum alloc::borrow::Cow")<'static, [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>>, path: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[String](../../prelude/struct.String.html "struct bevy::prelude::String")\>, shader\_defs: [Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[ShaderDefVal](../enum.ShaderDefVal.html "enum bevy::shader::ShaderDefVal")\>, ) -> [Shader](../../prelude/struct.Shader.html "struct bevy::prelude::Shader")
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Shader](../../prelude/struct.Shader.html "struct bevy::prelude::Shader")

[Source](https://docs.rs/bevy_shader/0.19.0/x86_64-unknown-linux-gnu/src/bevy_shader/shader.rs.html#34)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Shader](../../prelude/struct.Shader.html "struct bevy::prelude::Shader")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Shader](../../prelude/struct.Shader.html "struct bevy::prelude::Shader")
...
### impl [VisitAssetDependencies](../../asset/trait.VisitAssetDependencies.html "trait bevy::asset::VisitAssetDependencies") for [Shader](../../prelude/struct.Shader.html "struct bevy::prelude::Shader")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Shader](../../prelude/struct.Shader.html "struct bevy::prelude::Shader")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Shader](../../prelude/struct.Shader.html "struct bevy::prelude::Shader")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Shader](../../prelude/struct.Shader.html "struct bevy::prelude::Shader")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Shader](../../prelude/struct.Shader.html "struct bevy::prelude::Shader")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Shader](../../prelude/struct.Shader.html "struct bevy::prelude::Shader")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Shader](../../prelude/struct.Shader.html "struct bevy::prelude::Shader")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Shader](../../prelude/struct.Shader.html "struct bevy::prelude::Shader")
