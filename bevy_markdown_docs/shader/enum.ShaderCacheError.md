...
# Enum ShaderCacheError 

[Source](https://docs.rs/bevy_shader/0.19.0/x86_64-unknown-linux-gnu/src/bevy_shader/shader_cache.rs.html#457)

```rust
pub enum ShaderCacheError {
    ShaderNotLoaded(AssetId<Shader>),
    ProcessShaderError(Box<ComposerError>),
...
### ShaderNotLoaded([AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[Shader](../prelude/struct.Shader.html "struct bevy::prelude::Shader")\>)

### ProcessShaderError([Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ComposerError](https://docs.rs/naga_oil/0.22.0/x86_64-unknown-linux-gnu/naga_oil/compose/error/struct.ComposerError.html "struct naga_oil::compose::error::ComposerError")\>)

### ShaderImportNotYetAvailable

### CreateShaderModule([String](../prelude/struct.String.html "struct bevy::prelude::String"))

## Trait Implementations

[Source](https://docs.rs/bevy_shader/0.19.0/x86_64-unknown-linux-gnu/src/bevy_shader/shader_cache.rs.html#456)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ShaderCacheError](enum.ShaderCacheError.html "enum bevy::shader::ShaderCacheError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [ShaderCacheError](enum.ShaderCacheError.html "enum bevy::shader::ShaderCacheError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [ShaderCacheError](enum.ShaderCacheError.html "enum bevy::shader::ShaderCacheError")
...
[Source](https://docs.rs/bevy_shader/0.19.0/x86_64-unknown-linux-gnu/src/bevy_shader/shader_cache.rs.html#463)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ComposerError](https://docs.rs/naga_oil/0.22.0/x86_64-unknown-linux-gnu/naga_oil/compose/error/struct.ComposerError.html "struct naga_oil::compose::error::ComposerError")\>> for [ShaderCacheError](enum.ShaderCacheError.html "enum bevy::shader::ShaderCacheError")

[Source](https://docs.rs/bevy_shader/0.19.0/x86_64-unknown-linux-gnu/src/bevy_shader/shader_cache.rs.html#456)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(source: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ComposerError](https://docs.rs/naga_oil/0.22.0/x86_64-unknown-linux-gnu/naga_oil/compose/error/struct.ComposerError.html "struct naga_oil::compose::error::ComposerError")\>) -> [ShaderCacheError](enum.ShaderCacheError.html "enum bevy::shader::ShaderCacheError")

Converts to this type from the input type.

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ShaderCacheError](enum.ShaderCacheError.html "enum bevy::shader::ShaderCacheError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ShaderCacheError](enum.ShaderCacheError.html "enum bevy::shader::ShaderCacheError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ShaderCacheError](enum.ShaderCacheError.html "enum bevy::shader::ShaderCacheError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ShaderCacheError](enum.ShaderCacheError.html "enum bevy::shader::ShaderCacheError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ShaderCacheError](enum.ShaderCacheError.html "enum bevy::shader::ShaderCacheError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ShaderCacheError](enum.ShaderCacheError.html "enum bevy::shader::ShaderCacheError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ShaderCacheError](enum.ShaderCacheError.html "enum bevy::shader::ShaderCacheError")
