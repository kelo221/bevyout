...
[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/lib.rs.html#107)
...
For most cases, [`TimeUpdateStrategy::Automatic`](enum.TimeUpdateStrategy.html#variant.Automatic "variant bevy::time::TimeUpdateStrategy::Automatic") is fine. When writing tests, dealing with networking or similar, you may prefer to set the next [`Time`](../prelude/struct.Time.html "struct bevy::prelude::Time") value manually.

## Variants

### Automatic

[`Time`](../prelude/struct.Time.html "struct bevy::prelude::Time") will be automatically updated each frame using an [`Instant`](../platform/time/struct.Instant.html "struct bevy::platform::time::Instant") sent from the render world. If nothing is sent, the system clock will be used instead. See [`TimeSender`](struct.TimeSender.html "struct bevy::time::TimeSender") for more details.

### ManualInstant([Instant](../platform/time/struct.Instant.html "struct bevy::platform::time::Instant"))

[`Time`](../prelude/struct.Time.html "struct bevy::prelude::Time") will be updated to the specified [`Instant`](../platform/time/struct.Instant.html "struct bevy::platform::time::Instant") value each frame. In order for time to progress, this value must be manually updated each frame.

Note that the `Time` resource will not be updated until [`TimeSystems`](struct.TimeSystems.html "struct bevy::time::TimeSystems") runs.

### ManualDuration([Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration"))

[`Time`](../prelude/struct.Time.html "struct bevy::prelude::Time") will be incremented by the specified [`Duration`](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration") each frame.

### FixedTimesteps([u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html))

[`Time`](../prelude/struct.Time.html "struct bevy::prelude::Time") will be incremented by the fixed timestep each frame, multiplied by the specified factor `n`. This means that a call to [`App::update`](../prelude/struct.App.html#method.update "method bevy::prelude::App::update") will always run the fixed loop exactly n times.

## Trait Implementations

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/lib.rs.html#106)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [TimeUpdateStrategy](enum.TimeUpdateStrategy.html "enum bevy::time::TimeUpdateStrategy")

where [TimeUpdateStrategy](enum.TimeUpdateStrategy.html "enum bevy::time::TimeUpdateStrategy"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
#### fn [map\_entities](../prelude/trait.Component.html#method.map_entities)<M>(this: &mut [TimeUpdateStrategy](enum.TimeUpdateStrategy.html "enum bevy::time::TimeUpdateStrategy"), mapper: [&mut M](https://doc.rust-lang.org/nightly/std/primitive.reference.html))
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [TimeUpdateStrategy](enum.TimeUpdateStrategy.html "enum bevy::time::TimeUpdateStrategy")

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/lib.rs.html#106)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [TimeUpdateStrategy](enum.TimeUpdateStrategy.html "enum bevy::time::TimeUpdateStrategy")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/lib.rs.html#106)

### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [TimeUpdateStrategy](enum.TimeUpdateStrategy.html "enum bevy::time::TimeUpdateStrategy")

where [TimeUpdateStrategy](enum.TimeUpdateStrategy.html "enum bevy::time::TimeUpdateStrategy"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TimeUpdateStrategy](enum.TimeUpdateStrategy.html "enum bevy::time::TimeUpdateStrategy")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TimeUpdateStrategy](enum.TimeUpdateStrategy.html "enum bevy::time::TimeUpdateStrategy")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TimeUpdateStrategy](enum.TimeUpdateStrategy.html "enum bevy::time::TimeUpdateStrategy")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TimeUpdateStrategy](enum.TimeUpdateStrategy.html "enum bevy::time::TimeUpdateStrategy")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TimeUpdateStrategy](enum.TimeUpdateStrategy.html "enum bevy::time::TimeUpdateStrategy")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TimeUpdateStrategy](enum.TimeUpdateStrategy.html "enum bevy::time::TimeUpdateStrategy")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TimeUpdateStrategy](enum.TimeUpdateStrategy.html "enum bevy::time::TimeUpdateStrategy")
