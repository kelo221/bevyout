...
[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/lib.rs.html#128)
...
`0: [Receiver](https://docs.rs/crossbeam-channel/0.5.15/x86_64-unknown-linux-gnu/crossbeam_channel/channel/struct.Receiver.html "struct crossbeam_channel::channel::Receiver")<[Instant](../platform/time/struct.Instant.html "struct bevy::platform::time::Instant")>`

## Trait Implementations

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/lib.rs.html#127)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [TimeReceiver](struct.TimeReceiver.html "struct bevy::time::TimeReceiver")

where [TimeReceiver](struct.TimeReceiver.html "struct bevy::time::TimeReceiver"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [TimeReceiver](struct.TimeReceiver.html "struct bevy::time::TimeReceiver")

where [TimeReceiver](struct.TimeReceiver.html "struct bevy::time::TimeReceiver"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TimeReceiver](struct.TimeReceiver.html "struct bevy::time::TimeReceiver")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TimeReceiver](struct.TimeReceiver.html "struct bevy::time::TimeReceiver")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TimeReceiver](struct.TimeReceiver.html "struct bevy::time::TimeReceiver")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TimeReceiver](struct.TimeReceiver.html "struct bevy::time::TimeReceiver")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TimeReceiver](struct.TimeReceiver.html "struct bevy::time::TimeReceiver")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TimeReceiver](struct.TimeReceiver.html "struct bevy::time::TimeReceiver")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TimeReceiver](struct.TimeReceiver.html "struct bevy::time::TimeReceiver")
