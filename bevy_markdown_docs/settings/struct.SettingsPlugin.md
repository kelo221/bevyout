...
[Source](https://docs.rs/bevy-settings/0.19.0/x86_64-unknown-linux-gnu/src/bevy_settings/lib.rs.html#82)
...
Saving of settings is not automatic; the recommended practice is to issue a [`SaveSettingsDeferred`](struct.SaveSettingsDeferred.html "struct bevy::settings::SaveSettingsDeferred") command after modifying a settings resource. This will wait for a short interval and then spawn an i/o task to write out the changed settings file. You can also issue a [`SaveSettingsSync::IfChanged`](enum.SaveSettingsSync.html#variant.IfChanged "variant bevy::settings::SaveSettingsSync::IfChanged") command immediately before exiting the app. Note that on some platforms, depending on how the user exits (such as invoking Command-Q on `MacOS`) there may be no opportunity to intercept the app exit event, so the most reliable approach is to use both techniques: deferred save and save-on-exit.
...
`app_name: [String](../prelude/struct.String.html "struct bevy::prelude::String")`

The unique name of the application.

## Implementations

[Source](https://docs.rs/bevy-settings/0.19.0/x86_64-unknown-linux-gnu/src/bevy_settings/lib.rs.html#87)

### impl [SettingsPlugin](struct.SettingsPlugin.html "struct bevy::settings::SettingsPlugin")

[Source](https://docs.rs/bevy-settings/0.19.0/x86_64-unknown-linux-gnu/src/bevy_settings/lib.rs.html#89)

#### pub fn [new](#method.new)(app\_name: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [SettingsPlugin](struct.SettingsPlugin.html "struct bevy::settings::SettingsPlugin")

Construct a new `SettingsPlugin` for the given application name.

##### [Examples found in repository](#scraped-examples)[?](../../scrape-examples-help.html)

examples/app/settings.rs ([line 31](../../src/settings/settings.rs.html#31))
...
examples/window/persisting\_window\_settings.rs ([lines 29-31](../../src/persisting_window_settings/persisting_window_settings.rs.html#29-31))
...
### impl [Plugin](../prelude/trait.Plugin.html "trait bevy::prelude::Plugin") for [SettingsPlugin](struct.SettingsPlugin.html "struct bevy::settings::SettingsPlugin")

[Source](https://docs.rs/bevy-settings/0.19.0/x86_64-unknown-linux-gnu/src/bevy_settings/lib.rs.html#97)
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SettingsPlugin](struct.SettingsPlugin.html "struct bevy::settings::SettingsPlugin")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SettingsPlugin](struct.SettingsPlugin.html "struct bevy::settings::SettingsPlugin")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SettingsPlugin](struct.SettingsPlugin.html "struct bevy::settings::SettingsPlugin")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SettingsPlugin](struct.SettingsPlugin.html "struct bevy::settings::SettingsPlugin")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SettingsPlugin](struct.SettingsPlugin.html "struct bevy::settings::SettingsPlugin")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SettingsPlugin](struct.SettingsPlugin.html "struct bevy::settings::SettingsPlugin")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SettingsPlugin](struct.SettingsPlugin.html "struct bevy::settings::SettingsPlugin")
