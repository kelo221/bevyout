...
[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/diagnostic.rs.html#305)
...
[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/diagnostic.rs.html#309)

### impl [DiagnosticsStore](struct.DiagnosticsStore.html "struct bevy::diagnostic::DiagnosticsStore")

[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/diagnostic.rs.html#313)

#### pub fn [add](#method.add)(&mut self, diagnostic: [Diagnostic](struct.Diagnostic.html "struct bevy::diagnostic::Diagnostic"))

Add a new [`Diagnostic`](struct.Diagnostic.html "struct bevy::diagnostic::Diagnostic").

If possible, prefer calling [`App::register_diagnostic`](../prelude/struct.App.html#method.register_diagnostic "method bevy::prelude::App::register_diagnostic").

[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/diagnostic.rs.html#318)

#### pub fn [get](#method.get)(&self, path: &[DiagnosticPath](struct.DiagnosticPath.html "struct bevy::diagnostic::DiagnosticPath")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[Diagnostic](struct.Diagnostic.html "struct bevy::diagnostic::Diagnostic")\>

Get the [`Diagnostic`](struct.Diagnostic.html "struct bevy::diagnostic::Diagnostic") with the given [`DiagnosticPath`](struct.DiagnosticPath.html "struct bevy::diagnostic::DiagnosticPath"), if it exists.

##### [Examples found in repository](#scraped-examples)[?](../../scrape-examples-help.html)

examples/ui/text/text.rs ([line 195](../../src/text/text.rs.html#195))
...
examples/stress\_tests/many\_gizmos.rs ([line 101](../../src/many_gizmos/many_gizmos.rs.html#101))
...
examples/stress\_tests/bevymark.rs ([line 608](../../src/bevymark/bevymark.rs.html#608))
...
examples/stress\_tests/bevymark\_3d.rs ([line 468](../../src/bevymark_3d/bevymark_3d.rs.html#468))
...
examples/gizmos/2d\_text\_gizmos.rs ([line 65](../../src/2d_text_gizmos/2d_text_gizmos.rs.html#65))
...
examples/ui/text/text\_debug.rs ([line 269](../../src/text_debug/text_debug.rs.html#269))
...
*   [examples/3d/solari.rs](../../src/solari/solari.rs.html#587)

[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/diagnostic.rs.html#323)

#### pub fn [get\_mut](#method.get_mut)(&mut self, path: &[DiagnosticPath](struct.DiagnosticPath.html "struct bevy::diagnostic::DiagnosticPath")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&mut [Diagnostic](struct.Diagnostic.html "struct bevy::diagnostic::Diagnostic")\>

Mutably get the [`Diagnostic`](struct.Diagnostic.html "struct bevy::diagnostic::Diagnostic") with the given [`DiagnosticPath`](struct.DiagnosticPath.html "struct bevy::diagnostic::DiagnosticPath"), if it exists.

[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/diagnostic.rs.html#328)

#### pub fn [get\_measurement](#method.get_measurement)( &self, path: &[DiagnosticPath](struct.DiagnosticPath.html "struct bevy::diagnostic::DiagnosticPath"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[DiagnosticMeasurement](struct.DiagnosticMeasurement.html "struct bevy::diagnostic::DiagnosticMeasurement")\>

Get the latest [`DiagnosticMeasurement`](struct.DiagnosticMeasurement.html "struct bevy::diagnostic::DiagnosticMeasurement") from an enabled [`Diagnostic`](struct.Diagnostic.html "struct bevy::diagnostic::Diagnostic").

[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/diagnostic.rs.html#336)

#### pub fn [iter](#method.iter)(&self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = &[Diagnostic](struct.Diagnostic.html "struct bevy::diagnostic::Diagnostic")\>

Return an iterator over all [`Diagnostic`](struct.Diagnostic.html "struct bevy::diagnostic::Diagnostic")s.

[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/diagnostic.rs.html#341)

#### pub fn [iter\_mut](#method.iter_mut)(&mut self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = &mut [Diagnostic](struct.Diagnostic.html "struct bevy::diagnostic::Diagnostic")\>

Return an iterator over all [`Diagnostic`](struct.Diagnostic.html "struct bevy::diagnostic::Diagnostic")s, by mutable reference.

##### [Examples found in repository](#scraped-examples-1)[?](../../scrape-examples-help.html)

examples/diagnostics/enabling\_disabling\_diagnostic.rs ([line 26](../../src/enabling_disabling_diagnostic/enabling_disabling_diagnostic.rs.html#26))
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [DiagnosticsStore](struct.DiagnosticsStore.html "struct bevy::diagnostic::DiagnosticsStore")

where [DiagnosticsStore](struct.DiagnosticsStore.html "struct bevy::diagnostic::DiagnosticsStore"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [DiagnosticsStore](struct.DiagnosticsStore.html "struct bevy::diagnostic::DiagnosticsStore")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [DiagnosticsStore](struct.DiagnosticsStore.html "struct bevy::diagnostic::DiagnosticsStore")

[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/diagnostic.rs.html#304)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [DiagnosticsStore](struct.DiagnosticsStore.html "struct bevy::diagnostic::DiagnosticsStore")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/diagnostic.rs.html#304)

### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [DiagnosticsStore](struct.DiagnosticsStore.html "struct bevy::diagnostic::DiagnosticsStore")

where [DiagnosticsStore](struct.DiagnosticsStore.html "struct bevy::diagnostic::DiagnosticsStore"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DiagnosticsStore](struct.DiagnosticsStore.html "struct bevy::diagnostic::DiagnosticsStore")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DiagnosticsStore](struct.DiagnosticsStore.html "struct bevy::diagnostic::DiagnosticsStore")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DiagnosticsStore](struct.DiagnosticsStore.html "struct bevy::diagnostic::DiagnosticsStore")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DiagnosticsStore](struct.DiagnosticsStore.html "struct bevy::diagnostic::DiagnosticsStore")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DiagnosticsStore](struct.DiagnosticsStore.html "struct bevy::diagnostic::DiagnosticsStore")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DiagnosticsStore](struct.DiagnosticsStore.html "struct bevy::diagnostic::DiagnosticsStore")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DiagnosticsStore](struct.DiagnosticsStore.html "struct bevy::diagnostic::DiagnosticsStore")
