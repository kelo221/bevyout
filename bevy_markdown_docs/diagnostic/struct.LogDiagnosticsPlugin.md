...
[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/log_diagnostics_plugin.rs.html#17)
...
Diagnostics are collected by plugins such as [`FrameTimeDiagnosticsPlugin`](struct.FrameTimeDiagnosticsPlugin.html "struct bevy::diagnostic::FrameTimeDiagnosticsPlugin") or can be provided by the user.

When no diagnostics are provided, this plugin does nothing.

## Fields

`debug: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`
...
`wait_duration: [Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration")`

Time to wait between logging diagnostics and logging them again.

`filter: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[HashSet](../platform/collections/struct.HashSet.html "struct bevy::platform::collections::HashSet")<[DiagnosticPath](struct.DiagnosticPath.html "struct bevy::diagnostic::DiagnosticPath")>>`

If `Some` then only these diagnostics are logged.

## Implementations

[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/log_diagnostics_plugin.rs.html#115)

### impl [LogDiagnosticsPlugin](struct.LogDiagnosticsPlugin.html "struct bevy::diagnostic::LogDiagnosticsPlugin")

[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/log_diagnostics_plugin.rs.html#117)

#### pub fn [filtered](#method.filtered)(filter: [HashSet](../platform/collections/struct.HashSet.html "struct bevy::platform::collections::HashSet")<[DiagnosticPath](struct.DiagnosticPath.html "struct bevy::diagnostic::DiagnosticPath")\>) -> [LogDiagnosticsPlugin](struct.LogDiagnosticsPlugin.html "struct bevy::diagnostic::LogDiagnosticsPlugin")

Filter logging to only the paths in `filter`.

##### [Examples found in repository](#scraped-examples)[?](../../scrape-examples-help.html)

examples/stress\_tests/many\_components.rs ([lines 166-168](../../src/many_components/many_components.rs.html#166-168))
...
[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/log_diagnostics_plugin.rs.html#90)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [LogDiagnosticsPlugin](struct.LogDiagnosticsPlugin.html "struct bevy::diagnostic::LogDiagnosticsPlugin")

[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/log_diagnostics_plugin.rs.html#91)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [LogDiagnosticsPlugin](struct.LogDiagnosticsPlugin.html "struct bevy::diagnostic::LogDiagnosticsPlugin")
...
### impl [Plugin](../prelude/trait.Plugin.html "trait bevy::prelude::Plugin") for [LogDiagnosticsPlugin](struct.LogDiagnosticsPlugin.html "struct bevy::diagnostic::LogDiagnosticsPlugin")

[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/log_diagnostics_plugin.rs.html#101)
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [LogDiagnosticsPlugin](struct.LogDiagnosticsPlugin.html "struct bevy::diagnostic::LogDiagnosticsPlugin")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [LogDiagnosticsPlugin](struct.LogDiagnosticsPlugin.html "struct bevy::diagnostic::LogDiagnosticsPlugin")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [LogDiagnosticsPlugin](struct.LogDiagnosticsPlugin.html "struct bevy::diagnostic::LogDiagnosticsPlugin")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [LogDiagnosticsPlugin](struct.LogDiagnosticsPlugin.html "struct bevy::diagnostic::LogDiagnosticsPlugin")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [LogDiagnosticsPlugin](struct.LogDiagnosticsPlugin.html "struct bevy::diagnostic::LogDiagnosticsPlugin")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [LogDiagnosticsPlugin](struct.LogDiagnosticsPlugin.html "struct bevy::diagnostic::LogDiagnosticsPlugin")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [LogDiagnosticsPlugin](struct.LogDiagnosticsPlugin.html "struct bevy::diagnostic::LogDiagnosticsPlugin")
