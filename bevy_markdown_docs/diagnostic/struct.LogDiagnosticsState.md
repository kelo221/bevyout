...
[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/log_diagnostics_plugin.rs.html#31)
...
[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/log_diagnostics_plugin.rs.html#36)

### impl [LogDiagnosticsState](struct.LogDiagnosticsState.html "struct bevy::diagnostic::LogDiagnosticsState")

[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/log_diagnostics_plugin.rs.html#38)

#### pub fn [set\_timer\_duration](#method.set_timer_duration)(&mut self, duration: [Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration"))

Sets a new duration for the log timer

[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/log_diagnostics_plugin.rs.html#45)

#### pub fn [add\_filter](#method.add_filter)(&mut self, diagnostic\_path: [DiagnosticPath](struct.DiagnosticPath.html "struct bevy::diagnostic::DiagnosticPath")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Add a filter to the log state, returning `true` if the [`DiagnosticPath`](struct.DiagnosticPath.html "struct bevy::diagnostic::DiagnosticPath") was not present

[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/log_diagnostics_plugin.rs.html#55)

#### pub fn [extend\_filter](#method.extend_filter)(&mut self, iter: impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [DiagnosticPath](struct.DiagnosticPath.html "struct bevy::diagnostic::DiagnosticPath")\>)

Extends the filter of the log state with multiple [`DiagnosticPaths`](struct.DiagnosticPath.html "struct bevy::diagnostic::DiagnosticPath")

##### [Examples found in repository](#scraped-examples)[?](../../scrape-examples-help.html)

examples/diagnostics/log\_diagnostics.rs ([line 168](../../src/log_diagnostics/log_diagnostics.rs.html#168))
...
[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/log_diagnostics_plugin.rs.html#64)

#### pub fn [remove\_filter](#method.remove_filter)(&mut self, diagnostic\_path: &[DiagnosticPath](struct.DiagnosticPath.html "struct bevy::diagnostic::DiagnosticPath")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Removes a filter from the log state, returning `true` if it was present

##### [Examples found in repository](#scraped-examples-1)[?](../../scrape-examples-help.html)

examples/diagnostics/log\_diagnostics.rs ([line 176](../../src/log_diagnostics/log_diagnostics.rs.html#176))
...
[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/log_diagnostics_plugin.rs.html#73)

#### pub fn [clear\_filter](#method.clear_filter)(&mut self)

Clears the filters of the log state

[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/log_diagnostics_plugin.rs.html#80)

#### pub fn [enable\_filtering](#method.enable_filtering)(&mut self)

Enables filtering with empty filters

##### [Examples found in repository](#scraped-examples-2)[?](../../scrape-examples-help.html)

examples/diagnostics/log\_diagnostics.rs ([line 116](../../src/log_diagnostics/log_diagnostics.rs.html#116))
...
[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/log_diagnostics_plugin.rs.html#85)

#### pub fn [disable\_filtering](#method.disable_filtering)(&mut self)

Disables filtering

##### [Examples found in repository](#scraped-examples-3)[?](../../scrape-examples-help.html)

examples/diagnostics/log\_diagnostics.rs ([line 112](../../src/log_diagnostics/log_diagnostics.rs.html#112))
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [LogDiagnosticsState](struct.LogDiagnosticsState.html "struct bevy::diagnostic::LogDiagnosticsState")

where [LogDiagnosticsState](struct.LogDiagnosticsState.html "struct bevy::diagnostic::LogDiagnosticsState"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [LogDiagnosticsState](struct.LogDiagnosticsState.html "struct bevy::diagnostic::LogDiagnosticsState")

where [LogDiagnosticsState](struct.LogDiagnosticsState.html "struct bevy::diagnostic::LogDiagnosticsState"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [LogDiagnosticsState](struct.LogDiagnosticsState.html "struct bevy::diagnostic::LogDiagnosticsState")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [LogDiagnosticsState](struct.LogDiagnosticsState.html "struct bevy::diagnostic::LogDiagnosticsState")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [LogDiagnosticsState](struct.LogDiagnosticsState.html "struct bevy::diagnostic::LogDiagnosticsState")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [LogDiagnosticsState](struct.LogDiagnosticsState.html "struct bevy::diagnostic::LogDiagnosticsState")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [LogDiagnosticsState](struct.LogDiagnosticsState.html "struct bevy::diagnostic::LogDiagnosticsState")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [LogDiagnosticsState](struct.LogDiagnosticsState.html "struct bevy::diagnostic::LogDiagnosticsState")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [LogDiagnosticsState](struct.LogDiagnosticsState.html "struct bevy::diagnostic::LogDiagnosticsState")
