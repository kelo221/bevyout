...
The resource is updated inside of the [`touch_screen_input_system`](fn.touch_screen_input_system.html "fn bevy::input::touch::touch_screen_input_system").
...
#### pub fn [iter](#method.iter)(&self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = &[Touch](struct.Touch.html "struct bevy::input::touch::Touch")\>

An iterator visiting every pressed [`Touch`](struct.Touch.html "struct bevy::input::touch::Touch") input in arbitrary order.
...
#### pub fn [get\_pressed](#method.get_pressed)(&self, id: [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[Touch](struct.Touch.html "struct bevy::input::touch::Touch")\>

Returns the [`Touch`](struct.Touch.html "struct bevy::input::touch::Touch") input corresponding to the `id` if it is being pressed.
...
#### pub fn [iter\_just\_pressed](#method.iter_just_pressed)(&self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = &[Touch](struct.Touch.html "struct bevy::input::touch::Touch")\>

An iterator visiting every just pressed [`Touch`](struct.Touch.html "struct bevy::input::touch::Touch") input in arbitrary order.
...
#### pub fn [get\_released](#method.get_released)(&self, id: [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[Touch](struct.Touch.html "struct bevy::input::touch::Touch")\>

Returns the [`Touch`](struct.Touch.html "struct bevy::input::touch::Touch") input corresponding to the `id` if it has just been released.
...
#### pub fn [iter\_just\_released](#method.iter_just_released)(&self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = &[Touch](struct.Touch.html "struct bevy::input::touch::Touch")\>

An iterator visiting every just released [`Touch`](struct.Touch.html "struct bevy::input::touch::Touch") input in arbitrary order.
...
#### pub fn [iter\_just\_canceled](#method.iter_just_canceled)(&self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = &[Touch](struct.Touch.html "struct bevy::input::touch::Touch")\>

An iterator visiting every just canceled [`Touch`](struct.Touch.html "struct bevy::input::touch::Touch") input in arbitrary order.
