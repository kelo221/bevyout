...
Every time the user touches the screen, a new [`TouchPhase::Started`](enum.TouchPhase.html#variant.Started "variant bevy::input::touch::TouchPhase::Started") event with an unique identifier for the finger is generated. When the finger is lifted, the [`TouchPhase::Ended`](enum.TouchPhase.html#variant.Ended "variant bevy::input::touch::TouchPhase::Ended") event is generated with the same finger id.

After a [`TouchPhase::Started`](enum.TouchPhase.html#variant.Started "variant bevy::input::touch::TouchPhase::Started") event has been emitted, there may be zero or more [`TouchPhase::Moved`](enum.TouchPhase.html#variant.Moved "variant bevy::input::touch::TouchPhase::Moved") events when the finger is moved or the touch pressure changes.

The finger id may be reused by the system after an [`TouchPhase::Ended`](enum.TouchPhase.html#variant.Ended "variant bevy::input::touch::TouchPhase::Ended") event. The user should assume that a new [`TouchPhase::Started`](enum.TouchPhase.html#variant.Started "variant bevy::input::touch::TouchPhase::Started") event received with the same id has nothing to do with the old finger and is a new finger.

A [`TouchPhase::Canceled`](enum.TouchPhase.html#variant.Canceled "variant bevy::input::touch::TouchPhase::Canceled") event is emitted when the system has canceled tracking this touch, such as when the window loses focus, or on iOS if the user moves the device against their face.
...
`phase: [TouchPhase](enum.TouchPhase.html "enum bevy::input::touch::TouchPhase")`
...
`force: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ForceTouch](enum.ForceTouch.html "enum bevy::input::touch::ForceTouch")>`
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&[TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")\> for [Touch](struct.Touch.html "struct bevy::input::touch::Touch")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/touch.rs.html#225)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(input: &[TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")) -> [Touch](struct.Touch.html "struct bevy::input::touch::Touch")
