...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/mouse.rs.html#129)
...
Describes how a value of a [`MouseWheel`](struct.MouseWheel.html "struct bevy::input::mouse::MouseWheel") event has to be interpreted.
...
The delta of the associated [`MouseWheel`](struct.MouseWheel.html "struct bevy::input::mouse::MouseWheel") event corresponds to the amount of lines or rows to scroll.

### Pixel

The pixel scroll unit.

The delta of the associated [`MouseWheel`](struct.MouseWheel.html "struct bevy::input::mouse::MouseWheel") event corresponds to the amount of pixels to scroll.

## Implementations

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/mouse.rs.html#142)

### impl [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/mouse.rs.html#151)

#### pub const [SCROLL\_UNIT\_CONVERSION\_FACTOR](#associatedconstant.SCROLL_UNIT_CONVERSION_FACTOR): [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html) = 100.

An approximate conversion factor to account for the difference between [`MouseScrollUnit::Line`](enum.MouseScrollUnit.html#variant.Line "variant bevy::input::mouse::MouseScrollUnit::Line") and [`MouseScrollUnit::Pixel`](enum.MouseScrollUnit.html#variant.Pixel "variant bevy::input::mouse::MouseScrollUnit::Pixel").

Each line corresponds to many pixels; this must be corrected for in order to ensure that mouse wheel controls are scaled properly regardless of the provided input events for the end user.

This value is correct for Microsoft Edge, but its validity has not been broadly tested. Please file an issue if you find that this differs on certain platforms or hardware!

## Trait Implementations

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/mouse.rs.html#118)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/mouse.rs.html#118)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/mouse.rs.html#118)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/mouse.rs.html#124)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/mouse.rs.html#124)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [Enum](../../reflect/enums/trait.Enum.html "trait bevy::reflect::enums::Enum") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/mouse.rs.html#121)

### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/mouse.rs.html#121)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/mouse.rs.html#121)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/mouse.rs.html#121)

### impl [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/mouse.rs.html#121)

#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( \_\_param0: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")
...
### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")
...
where [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/mouse.rs.html#118)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/mouse.rs.html#122)
...
### impl [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/mouse.rs.html#121)

#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/mouse.rs.html#121)

### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MouseScrollUnit](enum.MouseScrollUnit.html "enum bevy::input::mouse::MouseScrollUnit")
