[bevy](../../index.html)::[input](../index.html)::[prelude](index.html)

# Struct Gamepad 

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#375)
...
An entity with this component is spawned automatically after [`GamepadConnectionEvent`](../gamepad/struct.GamepadConnectionEvent.html "struct bevy::input::gamepad::GamepadConnectionEvent") and updated by [`gamepad_event_processing_system`](../gamepad/fn.gamepad_event_processing_system.html "fn bevy::input::gamepad::gamepad_event_processing_system").

See also [`GamepadSettings`](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings") for configuration.
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#389)

### impl [Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#391)

#### pub fn [vendor\_id](#method.vendor_id)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[u16](https://doc.rust-lang.org/nightly/std/primitive.u16.html)\>

Returns the USB vendor ID as assigned by the USB-IF, if available.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#398)

#### pub fn [product\_id](#method.product_id)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[u16](https://doc.rust-lang.org/nightly/std/primitive.u16.html)\>

Returns the USB product ID as assigned by the [vendor](../../prelude/struct.Gamepad.html#method.vendor_id "method bevy::prelude::Gamepad::vendor_id"), if available.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#405)

#### pub fn [get](#method.get)(&self, input: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[GamepadInput](../gamepad/enum.GamepadInput.html "enum bevy::input::gamepad::GamepadInput")\>) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\>

Returns the analog data of the provided [`GamepadAxis`](../../prelude/enum.GamepadAxis.html "enum bevy::prelude::GamepadAxis") or [`GamepadButton`](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton").

This will be clamped between \[[`Axis::MIN`](../../prelude/struct.Axis.html#associatedconstant.MIN "associated constant bevy::prelude::Axis::MIN"),[`Axis::MAX`](../../prelude/struct.Axis.html#associatedconstant.MAX "associated constant bevy::prelude::Axis::MAX")\].

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/input/gamepad\_input.rs ([line 20](../../../src/gamepad_input/gamepad_input.rs.html#20))
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#412)

#### pub fn [get\_unclamped](#method.get_unclamped)(&self, input: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[GamepadInput](../gamepad/enum.GamepadInput.html "enum bevy::input::gamepad::GamepadInput")\>) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\>

Returns the unclamped analog data of the provided [`GamepadAxis`](../../prelude/enum.GamepadAxis.html "enum bevy::prelude::GamepadAxis") or [`GamepadButton`](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton").

This value may be outside the [`Axis::MIN`](../../prelude/struct.Axis.html#associatedconstant.MIN "associated constant bevy::prelude::Axis::MIN") and [`Axis::MAX`](../../prelude/struct.Axis.html#associatedconstant.MAX "associated constant bevy::prelude::Axis::MAX") range.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#417)

#### pub fn [left\_stick](#method.left_stick)(&self) -> [Vec2](../../prelude/struct.Vec2.html "struct bevy::prelude::Vec2")

Returns the left stick as a [`Vec2`](../../prelude/struct.Vec2.html "struct bevy::prelude::Vec2").

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#425)

#### pub fn [right\_stick](#method.right_stick)(&self) -> [Vec2](../../prelude/struct.Vec2.html "struct bevy::prelude::Vec2")

Returns the right stick as a [`Vec2`](../../prelude/struct.Vec2.html "struct bevy::prelude::Vec2").

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#433)

#### pub fn [dpad](#method.dpad)(&self) -> [Vec2](../../prelude/struct.Vec2.html "struct bevy::prelude::Vec2")

Returns the directional pad as a [`Vec2`](../../prelude/struct.Vec2.html "struct bevy::prelude::Vec2").

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#443)

#### pub fn [pressed](#method.pressed)(&self, button\_type: [GamepadButton](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if the [`GamepadButton`](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton") has been pressed.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#448)

#### pub fn [any\_pressed](#method.any_pressed)( &self, button\_inputs: impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [GamepadButton](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton")\>, ) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if any item in the [`GamepadButton`](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton") iterator has been pressed.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#453)

#### pub fn [all\_pressed](#method.all_pressed)( &self, button\_inputs: impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [GamepadButton](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton")\>, ) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if all items in the [`GamepadButton`](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton") iterator have been pressed.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#460)

#### pub fn [just\_pressed](#method.just_pressed)(&self, button\_type: [GamepadButton](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if the [`GamepadButton`](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton") has been pressed during the current frame.

Note: This function does not imply information regarding the current state of [`ButtonInput::pressed`](../../prelude/struct.ButtonInput.html#method.pressed "method bevy::prelude::ButtonInput::pressed") or [`ButtonInput::just_released`](../../prelude/struct.ButtonInput.html#method.just_released "method bevy::prelude::ButtonInput::just_released").

##### [Examples found in repository](#scraped-examples-1)[?](../../../scrape-examples-help.html)

examples/ui/navigation/directional\_navigation.rs ([line 325](../../../src/directional_navigation/directional_navigation.rs.html#325))
...
examples/ui/navigation/directional\_navigation\_overrides.rs ([line 697](../../../src/directional_navigation_overrides/directional_navigation_overrides.rs.html#697))
...
examples/input/gamepad\_input.rs ([line 14](../../../src/gamepad_input/gamepad_input.rs.html#14))
...
examples/input/gamepad\_rumble.rs ([line 22](../../../src/gamepad_rumble/gamepad_rumble.rs.html#22))
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#465)

#### pub fn [any\_just\_pressed](#method.any_just_pressed)( &self, button\_inputs: impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [GamepadButton](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton")\>, ) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if any item in the [`GamepadButton`](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton") iterator has been pressed during the current frame.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#470)

#### pub fn [all\_just\_pressed](#method.all_just_pressed)( &self, button\_inputs: impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [GamepadButton](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton")\>, ) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if all items in the [`GamepadButton`](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton") iterator have been just pressed.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#477)

#### pub fn [just\_released](#method.just_released)(&self, button\_type: [GamepadButton](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if the [`GamepadButton`](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton") has been released during the current frame.

Note: This function does not imply information regarding the current state of [`ButtonInput::pressed`](../../prelude/struct.ButtonInput.html#method.pressed "method bevy::prelude::ButtonInput::pressed") or [`ButtonInput::just_pressed`](../../prelude/struct.ButtonInput.html#method.just_pressed "method bevy::prelude::ButtonInput::just_pressed").

##### [Examples found in repository](#scraped-examples-2)[?](../../../scrape-examples-help.html)

examples/input/gamepad\_input.rs ([line 16](../../../src/gamepad_input/gamepad_input.rs.html#16))
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#482-485)

#### pub fn [any\_just\_released](#method.any_just_released)( &self, button\_inputs: impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [GamepadButton](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton")\>, ) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if any item in the [`GamepadButton`](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton") iterator has just been released.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#490-493)

#### pub fn [all\_just\_released](#method.all_just_released)( &self, button\_inputs: impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [GamepadButton](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton")\>, ) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if all items in the [`GamepadButton`](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton") iterator have just been released.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#500)

#### pub fn [get\_pressed](#method.get_pressed)(&self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = &[GamepadButton](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton")\>

Returns an iterator over all digital [button](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton")s that are pressed.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#507)

#### pub fn [get\_just\_pressed](#method.get_just_pressed)(&self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = &[GamepadButton](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton")\>

Returns an iterator over all digital [button](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton")s that were just pressed.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#514)

#### pub fn [get\_just\_released](#method.get_just_released)(&self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = &[GamepadButton](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton")\>

Returns an iterator over all digital [button](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton")s that were just released.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#519)

#### pub fn [get\_analog\_axes](#method.get_analog_axes)(&self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = &[GamepadInput](../gamepad/enum.GamepadInput.html "enum bevy::input::gamepad::GamepadInput")\>

Returns an iterator over all analog [axes](../gamepad/enum.GamepadInput.html "enum bevy::input::gamepad::GamepadInput").

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#524)

#### pub fn [digital](#method.digital)(&self) -> &[ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<[GamepadButton](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton")\>

[`ButtonInput`](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput") of [`GamepadButton`](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton") representing their digital state.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#529)

#### pub fn [digital\_mut](#method.digital_mut)(&mut self) -> &mut [ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<[GamepadButton](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton")\>

Mutable [`ButtonInput`](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput") of [`GamepadButton`](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton") representing their digital state. Useful for mocking inputs.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#534)

#### pub fn [analog](#method.analog)(&self) -> &[Axis](../../prelude/struct.Axis.html "struct bevy::prelude::Axis")<[GamepadInput](../gamepad/enum.GamepadInput.html "enum bevy::input::gamepad::GamepadInput")\>

[`Axis`](../../prelude/struct.Axis.html "struct bevy::prelude::Axis") of [`GamepadButton`](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton") representing their analog state.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#539)

#### pub fn [analog\_mut](#method.analog_mut)(&mut self) -> &mut [Axis](../../prelude/struct.Axis.html "struct bevy::prelude::Axis")<[GamepadInput](../gamepad/enum.GamepadInput.html "enum bevy::input::gamepad::GamepadInput")\>

Mutable [`Axis`](../../prelude/struct.Axis.html "struct bevy::prelude::Axis") of [`GamepadButton`](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton") representing their analog state. Useful for mocking inputs.

## Trait Implementations

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#368)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")

where [Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

**Required Components**: [`GamepadSettings`](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings").
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#544)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#545)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")
...
### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#371)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#371)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")
...
where [Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad"): 'into\_return,
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#371)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#372)
...
#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Gamepad](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad")
