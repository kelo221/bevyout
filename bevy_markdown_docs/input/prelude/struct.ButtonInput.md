...
*   [`ButtonInput::pressed`](../../prelude/struct.ButtonInput.html#method.pressed "method bevy::prelude::ButtonInput::pressed") will return `true` between a press and a release event.
*   [`ButtonInput::just_pressed`](../../prelude/struct.ButtonInput.html#method.just_pressed "method bevy::prelude::ButtonInput::just_pressed") will return `true` for one frame after a press event.
*   [`ButtonInput::just_released`](../../prelude/struct.ButtonInput.html#method.just_released "method bevy::prelude::ButtonInput::just_released") will return `true` for one frame after a release event.

### Multiple systems

In case multiple systems are checking for [`ButtonInput::just_pressed`](../../prelude/struct.ButtonInput.html#method.just_pressed "method bevy::prelude::ButtonInput::just_pressed") or [`ButtonInput::just_released`](../../prelude/struct.ButtonInput.html#method.just_released "method bevy::prelude::ButtonInput::just_released") but only one should react, for example when modifying a [`Resource`](../../prelude/trait.Resource.html "trait bevy::prelude::Resource"), you should consider clearing the input state, either by:

*   Using [`ButtonInput::clear_just_pressed`](../../prelude/struct.ButtonInput.html#method.clear_just_pressed "method bevy::prelude::ButtonInput::clear_just_pressed") or [`ButtonInput::clear_just_released`](../../prelude/struct.ButtonInput.html#method.clear_just_released "method bevy::prelude::ButtonInput::clear_just_released") instead.
*   Calling [`ButtonInput::clear`](../../prelude/struct.ButtonInput.html#method.clear "method bevy::prelude::ButtonInput::clear") or [`ButtonInput::reset`](../../prelude/struct.ButtonInput.html#method.reset "method bevy::prelude::ButtonInput::reset") immediately after the state change.
...
| **[`ButtonInput`](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput") operations** | **Computational complexity** |
| --- | --- |
| [`ButtonInput::any_just_pressed`](../../prelude/struct.ButtonInput.html#method.any_just_pressed "method bevy::prelude::ButtonInput::any_just_pressed") | _O_(m)~ |
| [`ButtonInput::any_just_released`](../../prelude/struct.ButtonInput.html#method.any_just_released "method bevy::prelude::ButtonInput::any_just_released") | _O_(m)~ |
| [`ButtonInput::any_pressed`](../../prelude/struct.ButtonInput.html#method.any_pressed "method bevy::prelude::ButtonInput::any_pressed") | _O_(m)~ |
| [`ButtonInput::get_just_pressed`](../../prelude/struct.ButtonInput.html#method.get_just_pressed "method bevy::prelude::ButtonInput::get_just_pressed") | _O_(n) |
| [`ButtonInput::get_just_released`](../../prelude/struct.ButtonInput.html#method.get_just_released "method bevy::prelude::ButtonInput::get_just_released") | _O_(n) |
| [`ButtonInput::get_pressed`](../../prelude/struct.ButtonInput.html#method.get_pressed "method bevy::prelude::ButtonInput::get_pressed") | _O_(n) |
| [`ButtonInput::just_pressed`](../../prelude/struct.ButtonInput.html#method.just_pressed "method bevy::prelude::ButtonInput::just_pressed") | _O_(1)~ |
| [`ButtonInput::just_released`](../../prelude/struct.ButtonInput.html#method.just_released "method bevy::prelude::ButtonInput::just_released") | _O_(1)~ |
| [`ButtonInput::pressed`](../../prelude/struct.ButtonInput.html#method.pressed "method bevy::prelude::ButtonInput::pressed") | _O_(1)~ |
| [`ButtonInput::press`](../../prelude/struct.ButtonInput.html#method.press "method bevy::prelude::ButtonInput::press") | _O_(1)~\* |
| [`ButtonInput::release`](../../prelude/struct.ButtonInput.html#method.release "method bevy::prelude::ButtonInput::release") | _O_(1)~\* |
| [`ButtonInput::release_all`](../../prelude/struct.ButtonInput.html#method.release_all "method bevy::prelude::ButtonInput::release_all") | _O_(n)~\* |
| [`ButtonInput::clear_just_pressed`](../../prelude/struct.ButtonInput.html#method.clear_just_pressed "method bevy::prelude::ButtonInput::clear_just_pressed") | _O_(1)~ |
| [`ButtonInput::clear_just_released`](../../prelude/struct.ButtonInput.html#method.clear_just_released "method bevy::prelude::ButtonInput::clear_just_released") | _O_(1)~ |
| [`ButtonInput::reset_all`](../../prelude/struct.ButtonInput.html#method.reset_all "method bevy::prelude::ButtonInput::reset_all") | _O_(n) |
| [`ButtonInput::clear`](../../prelude/struct.ButtonInput.html#method.clear "method bevy::prelude::ButtonInput::clear") | _O_(n) |

### Window focus

`ButtonInput<KeyCode>` is tied to window focus. For example, if the user holds a button while the window loses focus, [`ButtonInput::just_released`](../../prelude/struct.ButtonInput.html#method.just_released "method bevy::prelude::ButtonInput::just_released") will be triggered. Similarly if the window regains focus, [`ButtonInput::just_pressed`](../../prelude/struct.ButtonInput.html#method.just_pressed "method bevy::prelude::ButtonInput::just_pressed") will be triggered.
...
*   Call the [`ButtonInput::press`](../../prelude/struct.ButtonInput.html#method.press "method bevy::prelude::ButtonInput::press") method for each press event.
*   Call the [`ButtonInput::release`](../../prelude/struct.ButtonInput.html#method.release "method bevy::prelude::ButtonInput::release") method for each release event.
*   Call the [`ButtonInput::clear`](../../prelude/struct.ButtonInput.html#method.clear "method bevy::prelude::ButtonInput::clear") method at each frame start, before processing events.

Note: Calling `clear` from a [`ResMut`](../../prelude/struct.ResMut.html "struct bevy::prelude::ResMut") will trigger change detection. It may be preferable to use [`DetectChangesMut::bypass_change_detection`](../../prelude/trait.DetectChangesMut.html#tymethod.bypass_change_detection "method bevy::prelude::DetectChangesMut::bypass_change_detection") to avoid causing the resource to always be marked as changed.

## Implementations

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/button_input.rs.html#144-146)

### impl<T> [ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>
...
Future calls to [`ButtonInput::just_pressed`](../../prelude/struct.ButtonInput.html#method.just_pressed "method bevy::prelude::ButtonInput::just_pressed") for the given input will return false until a new press event occurs.
...
Future calls to [`ButtonInput::just_released`](../../prelude/struct.ButtonInput.html#method.just_released "method bevy::prelude::ButtonInput::just_released") for the given input will return false until a new release event occurs.
...
See also [`ButtonInput::clear`](../../prelude/struct.ButtonInput.html#method.clear "method bevy::prelude::ButtonInput::clear") for simulating elapsed time steps.
...
See also [`ButtonInput::reset_all`](../../prelude/struct.ButtonInput.html#method.reset_all "method bevy::prelude::ButtonInput::reset_all") for a full reset.
...
Note: Returned elements do not imply information regarding the current state of [`ButtonInput::pressed`](../../prelude/struct.ButtonInput.html#method.pressed "method bevy::prelude::ButtonInput::pressed") or [`ButtonInput::just_released`](../../prelude/struct.ButtonInput.html#method.just_released "method bevy::prelude::ButtonInput::just_released").
...
### impl<T> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>

where T: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") + [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") + [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/button_input.rs.html#123)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>
...
### impl<T> [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>
...
### impl<T> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>
...
### impl<T> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>

where T: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") + [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") + [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/button_input.rs.html#135)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>
...
### impl<T> [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>
...
#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/button_input.rs.html#124)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T> as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>>
...
### impl<T> [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>
...
### impl<T> [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>
...
### impl<T> [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>
...
where [ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>: 'into\_return,
...
### impl<T> [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/button_input.rs.html#124)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<T> [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>
...
### impl<T> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>

### impl<T> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>
...
### impl<T> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>

### impl<T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>

### impl<T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>

where T: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<T> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>

### impl<T> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ButtonInput](../../prelude/struct.ButtonInput.html "struct bevy::prelude::ButtonInput")<T>
