...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/touch.rs.html#53)
...
Every time the user touches the screen, a new [`TouchPhase::Started`](../touch/enum.TouchPhase.html#variant.Started "variant bevy::input::touch::TouchPhase::Started") event with an unique identifier for the finger is generated. When the finger is lifted, the [`TouchPhase::Ended`](../touch/enum.TouchPhase.html#variant.Ended "variant bevy::input::touch::TouchPhase::Ended") event is generated with the same finger id.

After a [`TouchPhase::Started`](../touch/enum.TouchPhase.html#variant.Started "variant bevy::input::touch::TouchPhase::Started") event has been emitted, there may be zero or more [`TouchPhase::Moved`](../touch/enum.TouchPhase.html#variant.Moved "variant bevy::input::touch::TouchPhase::Moved") events when the finger is moved or the touch pressure changes.

The finger id may be reused by the system after an [`TouchPhase::Ended`](../touch/enum.TouchPhase.html#variant.Ended "variant bevy::input::touch::TouchPhase::Ended") event. The user should assume that a new [`TouchPhase::Started`](../touch/enum.TouchPhase.html#variant.Started "variant bevy::input::touch::TouchPhase::Started") event received with the same id has nothing to do with the old finger and is a new finger.

A [`TouchPhase::Canceled`](../touch/enum.TouchPhase.html#variant.Canceled "variant bevy::input::touch::TouchPhase::Canceled") event is emitted when the system has canceled tracking this touch, such as when the window loses focus, or on iOS if the user moves the device against their face.
...
`phase: [TouchPhase](../touch/enum.TouchPhase.html "enum bevy::input::touch::TouchPhase")`

The phase of the touch input.

`position: [Vec2](../../prelude/struct.Vec2.html "struct bevy::prelude::Vec2")`

The position of the finger on the touchscreen.

`window: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")`

The window entity registering the touch.

`force: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ForceTouch](../touch/enum.ForceTouch.html "enum bevy::input::touch::ForceTouch")>`

Describes how hard the screen was pressed.

May be [`None`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.None "variant core::option::Option::None") if the platform does not support pressure sensitivity. This feature is only available on **iOS** 9.0+ and **Windows** 8+.

`id: [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)`
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/touch.rs.html#42)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/touch.rs.html#42)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/touch.rs.html#48)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/touch.rs.html#48)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/touch.rs.html#224)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&[TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")\> for [Touch](../touch/struct.Touch.html "struct bevy::input::touch::Touch")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/touch.rs.html#225)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(input: &[TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")) -> [Touch](../touch/struct.Touch.html "struct bevy::input::touch::Touch")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#711)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")\> for [WindowEvent](../../window/enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#712)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")) -> [WindowEvent](../../window/enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/touch.rs.html#45)

### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/touch.rs.html#45)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/touch.rs.html#45)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")
...
where [TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/touch.rs.html#42)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/touch.rs.html#45)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/touch.rs.html#46)
...
#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TouchInput](../../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")
