...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#739)
...
It is used to create a `bevy` component that stores the settings of [`GamepadButton`](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton") and [`GamepadAxis`](../../prelude/enum.GamepadAxis.html "enum bevy::prelude::GamepadAxis") in [`Gamepad`](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad"). If no user defined [`ButtonSettings`](../gamepad/struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings"), [`AxisSettings`](../gamepad/struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings"), or [`ButtonAxisSettings`](../gamepad/struct.ButtonAxisSettings.html "struct bevy::input::gamepad::ButtonAxisSettings") are defined, the default settings of each are used as a fallback accordingly.

### Note

The [`GamepadSettings`](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings") are used to determine when raw gamepad events should register. Events that don’t meet the change thresholds defined in [`GamepadSettings`](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings") will not register. To modify these settings, mutate the corresponding component.

## Fields

`default_button_settings: [ButtonSettings](../gamepad/struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")`

The default button settings.

`default_axis_settings: [AxisSettings](../gamepad/struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")`

The default axis settings.

`default_button_axis_settings: [ButtonAxisSettings](../gamepad/struct.ButtonAxisSettings.html "struct bevy::input::gamepad::ButtonAxisSettings")`

The default button axis settings.

`button_settings: [HashMap](../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[GamepadButton](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton"), [ButtonSettings](../gamepad/struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")>`

The user defined button settings.

`axis_settings: [HashMap](../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[GamepadAxis](../../prelude/enum.GamepadAxis.html "enum bevy::prelude::GamepadAxis"), [AxisSettings](../gamepad/struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")>`

The user defined axis settings.

`button_axis_settings: [HashMap](../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[GamepadButton](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton"), [ButtonAxisSettings](../gamepad/struct.ButtonAxisSettings.html "struct bevy::input::gamepad::ButtonAxisSettings")>`

The user defined button axis settings.

## Implementations

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#754)

### impl [GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#767)

#### pub fn [get\_button\_settings](#method.get_button_settings)(&self, button: [GamepadButton](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton")) -> &[ButtonSettings](../gamepad/struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")

Returns the [`ButtonSettings`](../gamepad/struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings") of the [`GamepadButton`](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton").

If no user defined [`ButtonSettings`](../gamepad/struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings") are specified the default [`ButtonSettings`](../gamepad/struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings") get returned.
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#785)

#### pub fn [get\_axis\_settings](#method.get_axis_settings)(&self, axis: [GamepadAxis](../../prelude/enum.GamepadAxis.html "enum bevy::prelude::GamepadAxis")) -> &[AxisSettings](../gamepad/struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")

Returns the [`AxisSettings`](../gamepad/struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings") of the [`GamepadAxis`](../../prelude/enum.GamepadAxis.html "enum bevy::prelude::GamepadAxis").

If no user defined [`AxisSettings`](../gamepad/struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings") are specified the default [`AxisSettings`](../gamepad/struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings") get returned.
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#803)

#### pub fn [get\_button\_axis\_settings](#method.get_button_axis_settings)( &self, button: [GamepadButton](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton"), ) -> &[ButtonAxisSettings](../gamepad/struct.ButtonAxisSettings.html "struct bevy::input::gamepad::ButtonAxisSettings")

Returns the [`ButtonAxisSettings`](../gamepad/struct.ButtonAxisSettings.html "struct bevy::input::gamepad::ButtonAxisSettings") of the [`GamepadButton`](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton").

If no user defined [`ButtonAxisSettings`](../gamepad/struct.ButtonAxisSettings.html "struct bevy::input::gamepad::ButtonAxisSettings") are specified the default [`ButtonAxisSettings`](../gamepad/struct.ButtonAxisSettings.html "struct bevy::input::gamepad::ButtonAxisSettings") get returned.
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#733)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#733)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")

where [GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#733)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")
...
### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#736)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#736)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")
...
where [GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings"): 'into\_return,
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#736)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#737)
...
#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [GamepadSettings](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings")
