...
# Enum AxisSettingsError 

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#287)
...
### LiveZoneLowerBoundOutOfRange([f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html))

The given parameter `livezone_lowerbound` was not in range -1.0..=0.0.

### DeadZoneLowerBoundOutOfRange([f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html))

The given parameter `deadzone_lowerbound` was not in range -1.0..=0.0.

### DeadZoneUpperBoundOutOfRange([f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html))

The given parameter `deadzone_lowerbound` was not in range -1.0..=0.0.

### LiveZoneUpperBoundOutOfRange([f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html))
...
`livezone_lowerbound: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

The value of the `livezone_lowerbound` parameter.

`deadzone_lowerbound: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`
...
`livezone_upperbound: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

The value of the `livezone_upperbound` parameter.

`deadzone_upperbound: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#286)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [AxisSettingsError](enum.AxisSettingsError.html "enum bevy::input::gamepad::AxisSettingsError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [AxisSettingsError](enum.AxisSettingsError.html "enum bevy::input::gamepad::AxisSettingsError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [AxisSettingsError](enum.AxisSettingsError.html "enum bevy::input::gamepad::AxisSettingsError")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [AxisSettingsError](enum.AxisSettingsError.html "enum bevy::input::gamepad::AxisSettingsError")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#286)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[AxisSettingsError](enum.AxisSettingsError.html "enum bevy::input::gamepad::AxisSettingsError")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [AxisSettingsError](enum.AxisSettingsError.html "enum bevy::input::gamepad::AxisSettingsError")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AxisSettingsError](enum.AxisSettingsError.html "enum bevy::input::gamepad::AxisSettingsError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AxisSettingsError](enum.AxisSettingsError.html "enum bevy::input::gamepad::AxisSettingsError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AxisSettingsError](enum.AxisSettingsError.html "enum bevy::input::gamepad::AxisSettingsError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AxisSettingsError](enum.AxisSettingsError.html "enum bevy::input::gamepad::AxisSettingsError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AxisSettingsError](enum.AxisSettingsError.html "enum bevy::input::gamepad::AxisSettingsError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AxisSettingsError](enum.AxisSettingsError.html "enum bevy::input::gamepad::AxisSettingsError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AxisSettingsError](enum.AxisSettingsError.html "enum bevy::input::gamepad::AxisSettingsError")
