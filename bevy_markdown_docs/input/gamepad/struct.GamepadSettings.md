...
It is used to create a `bevy` component that stores the settings of [`GamepadButton`](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton") and [`GamepadAxis`](../../prelude/enum.GamepadAxis.html "enum bevy::prelude::GamepadAxis") in [`Gamepad`](../../prelude/struct.Gamepad.html "struct bevy::prelude::Gamepad"). If no user defined [`ButtonSettings`](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings"), [`AxisSettings`](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings"), or [`ButtonAxisSettings`](struct.ButtonAxisSettings.html "struct bevy::input::gamepad::ButtonAxisSettings") are defined, the default settings of each are used as a fallback accordingly.
...
`default_button_settings: [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")`

The default button settings.

`default_axis_settings: [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")`

The default axis settings.

`default_button_axis_settings: [ButtonAxisSettings](struct.ButtonAxisSettings.html "struct bevy::input::gamepad::ButtonAxisSettings")`

The default button axis settings.

`button_settings: [HashMap](../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[GamepadButton](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton"), [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")>`

The user defined button settings.

`axis_settings: [HashMap](../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[GamepadAxis](../../prelude/enum.GamepadAxis.html "enum bevy::prelude::GamepadAxis"), [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")>`

The user defined axis settings.

`button_axis_settings: [HashMap](../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[GamepadButton](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton"), [ButtonAxisSettings](struct.ButtonAxisSettings.html "struct bevy::input::gamepad::ButtonAxisSettings")>`
...
#### pub fn [get\_button\_settings](#method.get_button_settings)(&self, button: [GamepadButton](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton")) -> &[ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")

Returns the [`ButtonSettings`](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings") of the [`GamepadButton`](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton").

If no user defined [`ButtonSettings`](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings") are specified the default [`ButtonSettings`](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings") get returned.
...
#### pub fn [get\_axis\_settings](#method.get_axis_settings)(&self, axis: [GamepadAxis](../../prelude/enum.GamepadAxis.html "enum bevy::prelude::GamepadAxis")) -> &[AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")

Returns the [`AxisSettings`](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings") of the [`GamepadAxis`](../../prelude/enum.GamepadAxis.html "enum bevy::prelude::GamepadAxis").

If no user defined [`AxisSettings`](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings") are specified the default [`AxisSettings`](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings") get returned.
...
#### pub fn [get\_button\_axis\_settings](#method.get_button_axis_settings)( &self, button: [GamepadButton](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton"), ) -> &[ButtonAxisSettings](struct.ButtonAxisSettings.html "struct bevy::input::gamepad::ButtonAxisSettings")

Returns the [`ButtonAxisSettings`](struct.ButtonAxisSettings.html "struct bevy::input::gamepad::ButtonAxisSettings") of the [`GamepadButton`](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton").

If no user defined [`ButtonAxisSettings`](struct.ButtonAxisSettings.html "struct bevy::input::gamepad::ButtonAxisSettings") are specified the default [`ButtonAxisSettings`](struct.ButtonAxisSettings.html "struct bevy::input::gamepad::ButtonAxisSettings") get returned.
