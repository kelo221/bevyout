...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#987)
...
It is used inside the [`GamepadSettings`](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings") to define the sensitivity range and threshold for an axis. Values that are higher than `livezone_upperbound` will be rounded up to 1.0. Values that are lower than `livezone_lowerbound` will be rounded down to -1.0. Values that are in-between `deadzone_lowerbound` and `deadzone_upperbound` will be rounded to 0.0. Otherwise, values will be linearly rescaled to fit into the sensitivity range. For example, a value that is one fourth of the way from `deadzone_upperbound` to `livezone_upperbound` will be scaled to 0.25.

The valid range is `[-1.0, 1.0]`.

## Implementations

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#1012)

### impl [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#1034-1040)

#### pub fn [new](#method.new)( livezone\_lowerbound: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), deadzone\_lowerbound: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), deadzone\_upperbound: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), livezone\_upperbound: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), threshold: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings"), [AxisSettingsError](enum.AxisSettingsError.html "enum bevy::input::gamepad::AxisSettingsError")\>

Creates a new [`AxisSettings`](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings") instance.
...
Returns an [`AxisSettingsError`](enum.AxisSettingsError.html "enum bevy::input::gamepad::AxisSettingsError") if any restrictions on the zone values are not met. If the zone restrictions are met, but the `threshold` value restrictions are not met, returns [`AxisSettingsError::Threshold`](enum.AxisSettingsError.html#variant.Threshold "variant bevy::input::gamepad::AxisSettingsError::Threshold").

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#1085)

#### pub fn [livezone\_upperbound](#method.livezone_upperbound)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Get the value above which inputs will be rounded up to 1.0.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#1096)

#### pub fn [try\_set\_livezone\_upperbound](#method.try_set_livezone_upperbound)( &mut self, value: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [AxisSettingsError](enum.AxisSettingsError.html "enum bevy::input::gamepad::AxisSettingsError")\>

Try to set the value above which inputs will be rounded up to 1.0.

##### Errors

If the value passed is less than the deadzone upper bound, returns `AxisSettingsError::DeadZoneUpperBoundGreaterThanLiveZoneUpperBound`. If the value passed is not in range \[0.0..=1.0\], returns `AxisSettingsError::LiveZoneUpperBoundOutOfRange`.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#1117)

#### pub fn [set\_livezone\_upperbound](#method.set_livezone_upperbound)(&mut self, value: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#1123)

#### pub fn [deadzone\_upperbound](#method.deadzone_upperbound)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Get the value below which positive inputs will be rounded down to 0.0.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#1134)

#### pub fn [try\_set\_deadzone\_upperbound](#method.try_set_deadzone_upperbound)( &mut self, value: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [AxisSettingsError](enum.AxisSettingsError.html "enum bevy::input::gamepad::AxisSettingsError")\>
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#1155)

#### pub fn [set\_deadzone\_upperbound](#method.set_deadzone_upperbound)(&mut self, value: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#1161)

#### pub fn [livezone\_lowerbound](#method.livezone_lowerbound)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Get the value below which negative inputs will be rounded down to -1.0.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#1172)

#### pub fn [try\_set\_livezone\_lowerbound](#method.try_set_livezone_lowerbound)( &mut self, value: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [AxisSettingsError](enum.AxisSettingsError.html "enum bevy::input::gamepad::AxisSettingsError")\>

Try to set the value below which negative inputs will be rounded down to -1.0.

##### Errors

If the value passed is less than the deadzone lower bound, returns `AxisSettingsError::LiveZoneLowerBoundGreaterThanDeadZoneLowerBound`. If the value passed is not in range \[-1.0..=0.0\], returns `AxisSettingsError::LiveZoneLowerBoundOutOfRange`.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#1193)

#### pub fn [set\_livezone\_lowerbound](#method.set_livezone_lowerbound)(&mut self, value: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#1199)

#### pub fn [deadzone\_lowerbound](#method.deadzone_lowerbound)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Get the value above which inputs will be rounded up to 0.0.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#1210)

#### pub fn [try\_set\_deadzone\_lowerbound](#method.try_set_deadzone_lowerbound)( &mut self, value: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [AxisSettingsError](enum.AxisSettingsError.html "enum bevy::input::gamepad::AxisSettingsError")\>
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#1231)

#### pub fn [set\_deadzone\_lowerbound](#method.set_deadzone_lowerbound)(&mut self, value: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#1237)

#### pub fn [threshold](#method.threshold)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Get the minimum value by which input must change before the change is registered.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#1246)

#### pub fn [try\_set\_threshold](#method.try_set_threshold)(&mut self, value: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [AxisSettingsError](enum.AxisSettingsError.html "enum bevy::input::gamepad::AxisSettingsError")\>
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#1259)

#### pub fn [set\_threshold](#method.set_threshold)(&mut self, value: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#1265)

#### pub fn [clamp](#method.clamp)(&self, raw\_value: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Clamps the `raw_value` according to the `AxisSettings`.

## Trait Implementations

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#981)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#981)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#1000)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#1001)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")
...
### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#984)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#984)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#984)

### impl [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#984)

#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")
...
where [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#981)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#985)
...
### impl [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#984)

#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Struct](../../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#984)

### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AxisSettings](struct.AxisSettings.html "struct bevy::input::gamepad::AxisSettings")
