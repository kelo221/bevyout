...
# Enum ButtonSettingsError 

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#323)
...
### ReleaseThresholdOutOfRange([f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html))

The given parameter was not in range 0.0..=1.0.

### PressThresholdOutOfRange([f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html))
...
`press_threshold: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

The value of the `press_threshold` parameter.

`release_threshold: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

The value of the `release_threshold` parameter.

## Trait Implementations

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#322)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ButtonSettingsError](enum.ButtonSettingsError.html "enum bevy::input::gamepad::ButtonSettingsError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [ButtonSettingsError](enum.ButtonSettingsError.html "enum bevy::input::gamepad::ButtonSettingsError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [ButtonSettingsError](enum.ButtonSettingsError.html "enum bevy::input::gamepad::ButtonSettingsError")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [ButtonSettingsError](enum.ButtonSettingsError.html "enum bevy::input::gamepad::ButtonSettingsError")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#322)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[ButtonSettingsError](enum.ButtonSettingsError.html "enum bevy::input::gamepad::ButtonSettingsError")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [ButtonSettingsError](enum.ButtonSettingsError.html "enum bevy::input::gamepad::ButtonSettingsError")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ButtonSettingsError](enum.ButtonSettingsError.html "enum bevy::input::gamepad::ButtonSettingsError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ButtonSettingsError](enum.ButtonSettingsError.html "enum bevy::input::gamepad::ButtonSettingsError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ButtonSettingsError](enum.ButtonSettingsError.html "enum bevy::input::gamepad::ButtonSettingsError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ButtonSettingsError](enum.ButtonSettingsError.html "enum bevy::input::gamepad::ButtonSettingsError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ButtonSettingsError](enum.ButtonSettingsError.html "enum bevy::input::gamepad::ButtonSettingsError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ButtonSettingsError](enum.ButtonSettingsError.html "enum bevy::input::gamepad::ButtonSettingsError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ButtonSettingsError](enum.ButtonSettingsError.html "enum bevy::input::gamepad::ButtonSettingsError")
