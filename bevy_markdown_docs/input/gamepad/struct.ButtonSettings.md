...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#823)
...
It is used inside [`GamepadSettings`](../../prelude/struct.GamepadSettings.html "struct bevy::prelude::GamepadSettings") to define the threshold for a [`GamepadButton`](../../prelude/enum.GamepadButton.html "enum bevy::prelude::GamepadButton") to be considered pressed or released. A button is considered pressed if the `press_threshold` value is surpassed and released if the `release_threshold` value is undercut.

Allowed values: `0.0 <= ``release_threshold`` <= ``press_threshold`` <= 1.0`

## Implementations

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#837)

### impl [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#854-857)

#### pub fn [new](#method.new)( press\_threshold: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), release\_threshold: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings"), [ButtonSettingsError](enum.ButtonSettingsError.html "enum bevy::input::gamepad::ButtonSettingsError")\>

Creates a new [`ButtonSettings`](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings") instance.
...
If the restrictions are not met, returns one of `GamepadSettingsError::ButtonReleaseThresholdOutOfRange`, `GamepadSettingsError::ButtonPressThresholdOutOfRange`, or `GamepadSettingsError::ButtonReleaseThresholdGreaterThanPressThreshold`.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#884)

#### pub fn [is\_pressed](#method.is_pressed)(&self, value: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if the button is pressed.

A button is considered pressed if the `value` passed is greater than or equal to the press threshold.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#891)

#### pub fn [is\_released](#method.is_released)(&self, value: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if the button is released.

A button is considered released if the `value` passed is lower than or equal to the release threshold.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#896)

#### pub fn [press\_threshold](#method.press_threshold)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Get the button input threshold above which the button is considered pressed.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#907)

#### pub fn [try\_set\_press\_threshold](#method.try_set_press_threshold)( &mut self, value: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [ButtonSettingsError](enum.ButtonSettingsError.html "enum bevy::input::gamepad::ButtonSettingsError")\>

Try to set the button input threshold above which the button is considered pressed.

##### Errors

If the value passed is outside the range \[release threshold..=1.0\], returns either `GamepadSettingsError::ButtonPressThresholdOutOfRange` or `GamepadSettingsError::ButtonReleaseThresholdGreaterThanPressThreshold`.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#927)

#### pub fn [set\_press\_threshold](#method.set_press_threshold)(&mut self, value: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#933)

#### pub fn [release\_threshold](#method.release_threshold)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Get the button input threshold below which the button is considered released.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#944)

#### pub fn [try\_set\_release\_threshold](#method.try_set_release_threshold)( &mut self, value: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [ButtonSettingsError](enum.ButtonSettingsError.html "enum bevy::input::gamepad::ButtonSettingsError")\>

Try to set the button input threshold below which the button is considered released.

##### Errors

If the value passed is outside the range \[0.0..=press threshold\], returns `ButtonSettingsError::ReleaseThresholdOutOfRange` or `ButtonSettingsError::ReleaseThresholdGreaterThanPressThreshold`.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#964)

#### pub fn [set\_release\_threshold](#method.set_release_threshold)(&mut self, value: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#817)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#817)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#828)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#829)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")
...
### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#820)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#820)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#820)

### impl [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#820)

#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")
...
where [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#817)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#820)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#821)
...
### impl [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#820)

#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Struct](../../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/gamepad.rs.html#820)

### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ButtonSettings](struct.ButtonSettings.html "struct bevy::input::gamepad::ButtonSettings")
