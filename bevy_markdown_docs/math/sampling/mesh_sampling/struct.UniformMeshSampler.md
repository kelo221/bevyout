[bevy](../../../index.html)::[math](../../index.html)::[sampling](../index.html)::[mesh\_sampling](index.html)

# Struct UniformMeshSampler 

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/sampling/mesh_sampling.rs.html#32)

```rust
pub struct UniformMeshSampler { /* private fields */ }
```
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/sampling/mesh_sampling.rs.html#44)

### impl [UniformMeshSampler](../struct.UniformMeshSampler.html "struct bevy::math::sampling::UniformMeshSampler")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/sampling/mesh_sampling.rs.html#51-53)

#### pub fn [try\_new](#method.try_new)<T>(triangles: T) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[UniformMeshSampler](../struct.UniformMeshSampler.html "struct bevy::math::sampling::UniformMeshSampler"), [Error](https://docs.rs/rand/0.9.4/x86_64-unknown-linux-gnu/rand/distr/weighted/enum.Error.html "enum rand::distr::weighted::Error")\>

where T: [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [Triangle3d](../../../prelude/struct.Triangle3d.html "struct bevy::prelude::Triangle3d")\>,

Construct a new [`UniformMeshSampler`](../struct.UniformMeshSampler.html "struct bevy::math::sampling::UniformMeshSampler") from a list of [triangles](../../../prelude/struct.Triangle3d.html "struct bevy::prelude::Triangle3d").

Returns an error if the distribution of areas for the collection of triangles could not be formed (most notably if the collection has zero surface area).

##### [Examples found in repository](#scraped-examples)[?](../../../../scrape-examples-help.html)

examples/ecs/error\_handling.rs ([line 102](../../../../src/error_handling/error_handling.rs.html#102))
...
### impl [Distribution](https://docs.rs/rand/0.9.4/x86_64-unknown-linux-gnu/rand/distr/distribution/trait.Distribution.html "trait rand::distr::distribution::Distribution")<[Vec3](../../../prelude/struct.Vec3.html "struct bevy::prelude::Vec3")\> for [UniformMeshSampler](../struct.UniformMeshSampler.html "struct bevy::math::sampling::UniformMeshSampler")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [UniformMeshSampler](../struct.UniformMeshSampler.html "struct bevy::math::sampling::UniformMeshSampler")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [UniformMeshSampler](../struct.UniformMeshSampler.html "struct bevy::math::sampling::UniformMeshSampler")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [UniformMeshSampler](../struct.UniformMeshSampler.html "struct bevy::math::sampling::UniformMeshSampler")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [UniformMeshSampler](../struct.UniformMeshSampler.html "struct bevy::math::sampling::UniformMeshSampler")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [UniformMeshSampler](../struct.UniformMeshSampler.html "struct bevy::math::sampling::UniformMeshSampler")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [UniformMeshSampler](../struct.UniformMeshSampler.html "struct bevy::math::sampling::UniformMeshSampler")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [UniformMeshSampler](../struct.UniformMeshSampler.html "struct bevy::math::sampling::UniformMeshSampler")
