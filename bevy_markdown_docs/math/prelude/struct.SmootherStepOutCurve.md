...
# Struct SmootherStepOutCurve 

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#827)
...
This has f″(0) = 0, unlike [`CubicOutCurve`](../../prelude/struct.CubicOutCurve.html "struct bevy::prelude::CubicOutCurve") which ends similarly.

SmootherStepOut

## Trait Implementations

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#826)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [SmootherStepOutCurve](../../prelude/struct.SmootherStepOutCurve.html "struct bevy::prelude::SmootherStepOutCurve")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#826)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [SmootherStepOutCurve](../../prelude/struct.SmootherStepOutCurve.html "struct bevy::prelude::SmootherStepOutCurve")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [SmootherStepOutCurve](../../prelude/struct.SmootherStepOutCurve.html "struct bevy::prelude::SmootherStepOutCurve")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SmootherStepOutCurve](../../prelude/struct.SmootherStepOutCurve.html "struct bevy::prelude::SmootherStepOutCurve")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SmootherStepOutCurve](../../prelude/struct.SmootherStepOutCurve.html "struct bevy::prelude::SmootherStepOutCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SmootherStepOutCurve](../../prelude/struct.SmootherStepOutCurve.html "struct bevy::prelude::SmootherStepOutCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SmootherStepOutCurve](../../prelude/struct.SmootherStepOutCurve.html "struct bevy::prelude::SmootherStepOutCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SmootherStepOutCurve](../../prelude/struct.SmootherStepOutCurve.html "struct bevy::prelude::SmootherStepOutCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SmootherStepOutCurve](../../prelude/struct.SmootherStepOutCurve.html "struct bevy::prelude::SmootherStepOutCurve")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SmootherStepOutCurve](../../prelude/struct.SmootherStepOutCurve.html "struct bevy::prelude::SmootherStepOutCurve")
