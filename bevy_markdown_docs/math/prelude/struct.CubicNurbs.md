...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#612)
...
When there is no knot multiplicity, the curve is C2 continuous, meaning it has no holes or jumps and the tangent vector changes smoothly along the entire curve length. Like the [`CubicBSpline`](../../prelude/struct.CubicBSpline.html "struct bevy::prelude::CubicBSpline"), the acceleration continuity makes it useful for camera paths. Knot multiplicity of 2 in intermediate knots reduces the continuity to C1, and knot multiplicity of 3 reduces the continuity to C0. The curve is always at least C0, meaning it has no jumps or holes.
...
`weights: [Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)>`

Weights

`knots: [Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)>`

Knots

## Implementations

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#622)

### impl<P> [CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#632-636)

#### pub fn [new](#method.new)( control\_points: impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = P>, weights: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\>>, knots: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>, [CubicNurbsError](../../prelude/enum.CubicNurbsError.html "enum bevy::prelude::CubicNurbsError")\>
...
If provided, the number of knots must be n + 4 elements, where n is the amount of control points. Defaults to open uniform knots: [`Self::open_uniform_knots`](../../prelude/struct.CubicNurbs.html#method.open_uniform_knots "associated function bevy::prelude::CubicNurbs::open_uniform_knots"). Knots cannot all be equal.

At least 4 points must be provided, otherwise an error will be returned.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#714)

#### pub fn [uniform\_knots](#method.uniform_knots)(control\_points: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\>>

Generates uniform knots that will generate the same curve as [`CubicBSpline`](../../prelude/struct.CubicBSpline.html "struct bevy::prelude::CubicBSpline").
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#732)

#### pub fn [open\_uniform\_knots](#method.open_uniform_knots)(control\_points: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\>>
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#609)

### impl<P> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>
...
#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>
...
### impl<P> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>
...
### impl<P> [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>

where P: [VectorSpace](../trait.VectorSpace.html "trait bevy::math::VectorSpace") + [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath"), [CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>: [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"), [Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<P>: [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") + [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") + MaybeTyped + RegisterForReflection,

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#611)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#611)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P> as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>>
...
### impl<P> [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>
...
### impl<P> [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>
...
### impl<P> [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>
...
where [CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>: 'into\_return,
...
### impl<P> [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#611)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### type [Error](../../prelude/trait.RationalGenerator.html#associatedtype.Error) = [InsufficientDataError](../cubic_splines/struct.InsufficientDataError.html "struct bevy::math::cubic_splines::InsufficientDataError")

An error type indicating why construction might fail.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#787)

#### fn [to\_curve](../../prelude/trait.RationalGenerator.html#tymethod.to_curve)( &self, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[RationalCurve](../../prelude/struct.RationalCurve.html "struct bevy::prelude::RationalCurve")<P>, <[CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P> as [RationalGenerator](../../prelude/trait.RationalGenerator.html "trait bevy::prelude::RationalGenerator")<P>>::[Error](../../prelude/trait.RationalGenerator.html#associatedtype.Error "type bevy::prelude::RationalGenerator::Error")\>
...
#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<P> [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>
...
### impl<P> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>

### impl<P> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>
...
### impl<P> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>

where P: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<P> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>

where P: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<P> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>

where P: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<P> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>

### impl<P> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [CubicNurbs](../../prelude/struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>
