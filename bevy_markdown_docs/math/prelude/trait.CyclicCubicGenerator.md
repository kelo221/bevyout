...
#### fn [to\_curve\_cyclic](#tymethod.to_curve_cyclic)(&self) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[CubicCurve](../../prelude/struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>, Self::[Error](../../prelude/trait.CyclicCubicGenerator.html#associatedtype.Error "type bevy::prelude::CyclicCubicGenerator::Error")\>
...
### impl<P> [CyclicCubicGenerator](../../prelude/trait.CyclicCubicGenerator.html "trait bevy::prelude::CyclicCubicGenerator")<P> for [LinearSpline](../cubic_splines/struct.LinearSpline.html "struct bevy::math::cubic_splines::LinearSpline")<P>
