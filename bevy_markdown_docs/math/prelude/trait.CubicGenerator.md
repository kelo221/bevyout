...
#### fn [to\_curve](#tymethod.to_curve)(&self) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[CubicCurve](../../prelude/struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>, Self::[Error](../../prelude/trait.CubicGenerator.html#associatedtype.Error "type bevy::prelude::CubicGenerator::Error")\>
...
#### type [Error](#associatedtype.Error) = [InsufficientDataError](../cubic_splines/struct.InsufficientDataError.html "struct bevy::math::cubic_splines::InsufficientDataError")
...
#### type [Error](#associatedtype.Error) = [CubicBezierError](../cubic_splines/struct.CubicBezierError.html "struct bevy::math::cubic_splines::CubicBezierError")
...
### impl<P> [CubicGenerator](../../prelude/trait.CubicGenerator.html "trait bevy::prelude::CubicGenerator")<P> for [LinearSpline](../cubic_splines/struct.LinearSpline.html "struct bevy::math::cubic_splines::LinearSpline")<P>
