...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/compass.rs.html#139)
...
Corresponds to [`Dir2::Y`](../prelude/struct.Dir2.html#associatedconstant.Y "associated constant bevy::prelude::Dir2::Y") and [`Dir2::NORTH`](../prelude/struct.Dir2.html#associatedconstant.NORTH "associated constant bevy::prelude::Dir2::NORTH")

### NorthEast

Corresponds to [`Dir2::NORTH_EAST`](../prelude/struct.Dir2.html#associatedconstant.NORTH_EAST "associated constant bevy::prelude::Dir2::NORTH_EAST")

### East

Corresponds to [`Dir2::X`](../prelude/struct.Dir2.html#associatedconstant.X "associated constant bevy::prelude::Dir2::X") and [`Dir2::EAST`](../prelude/struct.Dir2.html#associatedconstant.EAST "associated constant bevy::prelude::Dir2::EAST")

### SouthEast

Corresponds to [`Dir2::SOUTH_EAST`](../prelude/struct.Dir2.html#associatedconstant.SOUTH_EAST "associated constant bevy::prelude::Dir2::SOUTH_EAST")

### South

Corresponds to [`Dir2::NEG_Y`](../prelude/struct.Dir2.html#associatedconstant.NEG_Y "associated constant bevy::prelude::Dir2::NEG_Y") and [`Dir2::SOUTH`](../prelude/struct.Dir2.html#associatedconstant.SOUTH "associated constant bevy::prelude::Dir2::SOUTH")

### SouthWest

Corresponds to [`Dir2::SOUTH_WEST`](../prelude/struct.Dir2.html#associatedconstant.SOUTH_WEST "associated constant bevy::prelude::Dir2::SOUTH_WEST")

### West

Corresponds to [`Dir2::NEG_X`](../prelude/struct.Dir2.html#associatedconstant.NEG_X "associated constant bevy::prelude::Dir2::NEG_X") and [`Dir2::WEST`](../prelude/struct.Dir2.html#associatedconstant.WEST "associated constant bevy::prelude::Dir2::WEST")

### NorthWest

Corresponds to [`Dir2::NORTH_WEST`](../prelude/struct.Dir2.html#associatedconstant.NORTH_WEST "associated constant bevy::prelude::Dir2::NORTH_WEST")

## Implementations

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/compass.rs.html#158)

### impl [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/compass.rs.html#162)

#### pub const fn [from\_index](#method.from_index)(index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")\>

Converts a standard index to a [`CompassOctant`](enum.CompassOctant.html "enum bevy::math::CompassOctant").

Starts at 0 for [`CompassOctant::North`](enum.CompassOctant.html#variant.North "variant bevy::math::CompassOctant::North") and increments clockwise.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/compass.rs.html#179)

#### pub const fn [to\_index](#method.to_index)(self) -> [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)

Converts a [`CompassOctant`](enum.CompassOctant.html "enum bevy::math::CompassOctant") to a standard index.

Starts at 0 for [`CompassOctant::North`](enum.CompassOctant.html#variant.North "variant bevy::math::CompassOctant::North") and increments clockwise.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/compass.rs.html#195)

#### pub const fn [opposite](#method.opposite)(&self) -> [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")

Returns the opposite [`CompassOctant`](enum.CompassOctant.html "enum bevy::math::CompassOctant"), located 180 degrees from `self`.

This can also be accessed via the `-` operator, using the [`Neg`](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Neg.html "trait core::ops::arith::Neg") trait.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/compass.rs.html#236)

#### pub fn [is\_in\_direction](#method.is_in_direction)(self, origin: [Vec2](../prelude/struct.Vec2.html "struct bevy::prelude::Vec2"), candidate: [Vec2](../prelude/struct.Vec2.html "struct bevy::prelude::Vec2")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Checks if a point is in the direction represented by this [`CompassOctant`](enum.CompassOctant.html "enum bevy::math::CompassOctant") from an origin.

This uses a cone-based check: the vector from origin to the candidate point must have a positive dot product with the direction vector.
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/compass.rs.html#128)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/compass.rs.html#128)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/compass.rs.html#128)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/compass.rs.html#129)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/compass.rs.html#129)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [Enum](../reflect/enums/trait.Enum.html "trait bevy::reflect::enums::Enum") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")
...
### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/compass.rs.html#132)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/compass.rs.html#132)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/compass.rs.html#132)

### impl [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/compass.rs.html#132)

#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)( \_\_param0: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")
...
### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")
...
where [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant"): 'into\_return,
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/compass.rs.html#313)

### impl [Neg](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Neg.html "trait core::ops::arith::Neg") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/compass.rs.html#314)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Neg.html#associatedtype.Output) = [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")

The resulting type after applying the `-` operator.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/compass.rs.html#316)

#### fn [neg](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Neg.html#tymethod.neg)(self) -> <[CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant") as [Neg](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Neg.html "trait core::ops::arith::Neg")\>::[Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Neg.html#associatedtype.Output "type core::ops::arith::Neg::Output")

Performs the unary `-` operation. [Read more](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Neg.html#tymethod.neg)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/compass.rs.html#128)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/compass.rs.html#128)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")
...
#### fn [reflect\_owned](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/compass.rs.html#132)

#### fn [try\_into\_reflect](../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/compass.rs.html#133)
...
### impl [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/compass.rs.html#132)

#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/compass.rs.html#132)

### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [CompassOctant](enum.CompassOctant.html "enum bevy::math::CompassOctant")
