...
# Struct ElasticInCurve 

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#907)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#906)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ElasticInCurve](../../prelude/struct.ElasticInCurve.html "struct bevy::prelude::ElasticInCurve")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#906)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ElasticInCurve](../../prelude/struct.ElasticInCurve.html "struct bevy::prelude::ElasticInCurve")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [ElasticInCurve](../../prelude/struct.ElasticInCurve.html "struct bevy::prelude::ElasticInCurve")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ElasticInCurve](../../prelude/struct.ElasticInCurve.html "struct bevy::prelude::ElasticInCurve")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ElasticInCurve](../../prelude/struct.ElasticInCurve.html "struct bevy::prelude::ElasticInCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ElasticInCurve](../../prelude/struct.ElasticInCurve.html "struct bevy::prelude::ElasticInCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ElasticInCurve](../../prelude/struct.ElasticInCurve.html "struct bevy::prelude::ElasticInCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ElasticInCurve](../../prelude/struct.ElasticInCurve.html "struct bevy::prelude::ElasticInCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ElasticInCurve](../../prelude/struct.ElasticInCurve.html "struct bevy::prelude::ElasticInCurve")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ElasticInCurve](../../prelude/struct.ElasticInCurve.html "struct bevy::prelude::ElasticInCurve")
