...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#435)
...
`EaseFunction` can be used on its own to interpolate between `0.0` and `1.0`. It can also be combined with [`EasingCurve`](../../prelude/struct.EasingCurve.html "struct bevy::prelude::EasingCurve") to interpolate between other intervals and types, including vectors and rotations.

## Example

[`sample`](../../prelude/enum.EaseFunction.html#method.sample "method bevy::prelude::EaseFunction::sample") the smoothstep function at various points. This will return `None` if the parameter is outside the unit interval.
...
[`sample_clamped`](../../prelude/enum.EaseFunction.html#method.sample_clamped "method bevy::prelude::EaseFunction::sample_clamped") will clamp the parameter to the unit interval, so it always returns a value.
...
A quadratic has too low of a degree to be both an `InOut` and C², so consider using at least a cubic (such as [`EaseFunction::SmoothStep`](../../prelude/enum.EaseFunction.html#variant.SmoothStep "variant bevy::prelude::EaseFunction::SmoothStep")) if you want the acceleration to be continuous.
...
Consider using [`EaseFunction::SmoothStep`](../../prelude/enum.EaseFunction.html#variant.SmoothStep "variant bevy::prelude::EaseFunction::SmoothStep") instead, which is also cubic, or [`EaseFunction::SmootherStep`](../../prelude/enum.EaseFunction.html#variant.SmootherStep "variant bevy::prelude::EaseFunction::SmootherStep") if you picked this because you wanted the acceleration at the endpoints to also be zero.
...
Consider using [`EaseFunction::SmootherStep`](../../prelude/enum.EaseFunction.html#variant.SmootherStep "variant bevy::prelude::EaseFunction::SmootherStep") instead, which is also quintic.

QuinticInOut

### SmoothStepIn

Behaves as the first half of [`EaseFunction::SmoothStep`](../../prelude/enum.EaseFunction.html#variant.SmoothStep "variant bevy::prelude::EaseFunction::SmoothStep").

This has f″(1) = 0, unlike [`EaseFunction::QuadraticIn`](../../prelude/enum.EaseFunction.html#variant.QuadraticIn "variant bevy::prelude::EaseFunction::QuadraticIn") which starts similarly.

SmoothStepIn

### SmoothStepOut

Behaves as the second half of [`EaseFunction::SmoothStep`](../../prelude/enum.EaseFunction.html#variant.SmoothStep "variant bevy::prelude::EaseFunction::SmoothStep").

This has f″(0) = 0, unlike [`EaseFunction::QuadraticOut`](../../prelude/enum.EaseFunction.html#variant.QuadraticOut "variant bevy::prelude::EaseFunction::QuadraticOut") which ends similarly.
...
See also [`smoothstep` in GLSL](https://registry.khronos.org/OpenGL-Refpages/gl4/html/smoothstep.xhtml).

SmoothStep

### SmootherStepIn

Behaves as the first half of [`EaseFunction::SmootherStep`](../../prelude/enum.EaseFunction.html#variant.SmootherStep "variant bevy::prelude::EaseFunction::SmootherStep").

This has f″(1) = 0, unlike [`EaseFunction::CubicIn`](../../prelude/enum.EaseFunction.html#variant.CubicIn "variant bevy::prelude::EaseFunction::CubicIn") which starts similarly.

SmootherStepIn

### SmootherStepOut

Behaves as the second half of [`EaseFunction::SmootherStep`](../../prelude/enum.EaseFunction.html#variant.SmootherStep "variant bevy::prelude::EaseFunction::SmootherStep").

This has f″(0) = 0, unlike [`EaseFunction::CubicOut`](../../prelude/enum.EaseFunction.html#variant.CubicOut "variant bevy::prelude::EaseFunction::CubicOut") which ends similarly.
...
As with `EaseFunction::ExponentialIn`, the precise definition adjusts it slightly so it hits both `(0, 0)` and `(1, 1)`.
...
### Steps([usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), [JumpAt](../../prelude/enum.JumpAt.html "enum bevy::prelude::JumpAt"))
...
### Elastic([f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html))
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#427)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#427)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#1352)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#1357)

#### fn [sample\_unchecked](../../prelude/trait.Curve.html#tymethod.sample_unchecked)(&self, t: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#428)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#428)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [Enum](../../reflect/enums/trait.Enum.html "trait bevy::reflect::enums::Enum") for [EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")
...
### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#431)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#431)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( \_\_param0: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")
...
where [EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#427)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#431)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#432)
...
#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [EaseFunction](../../prelude/enum.EaseFunction.html "enum bevy::prelude::EaseFunction")
