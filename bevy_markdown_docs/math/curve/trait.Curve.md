...
Typical examples of this are actual geometric curves where `T: VectorSpace`, but other kinds of output data can be represented as well. See the [module-level documentation](index.html "mod bevy::math::curve") for details.
