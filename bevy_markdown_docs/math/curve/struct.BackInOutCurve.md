...
# Struct BackInOutCurve 

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#937)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#936)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [BackInOutCurve](../../prelude/struct.BackInOutCurve.html "struct bevy::prelude::BackInOutCurve")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#936)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [BackInOutCurve](../../prelude/struct.BackInOutCurve.html "struct bevy::prelude::BackInOutCurve")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [BackInOutCurve](../../prelude/struct.BackInOutCurve.html "struct bevy::prelude::BackInOutCurve")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [BackInOutCurve](../../prelude/struct.BackInOutCurve.html "struct bevy::prelude::BackInOutCurve")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [BackInOutCurve](../../prelude/struct.BackInOutCurve.html "struct bevy::prelude::BackInOutCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [BackInOutCurve](../../prelude/struct.BackInOutCurve.html "struct bevy::prelude::BackInOutCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [BackInOutCurve](../../prelude/struct.BackInOutCurve.html "struct bevy::prelude::BackInOutCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [BackInOutCurve](../../prelude/struct.BackInOutCurve.html "struct bevy::prelude::BackInOutCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [BackInOutCurve](../../prelude/struct.BackInOutCurve.html "struct bevy::prelude::BackInOutCurve")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [BackInOutCurve](../../prelude/struct.BackInOutCurve.html "struct bevy::prelude::BackInOutCurve")
