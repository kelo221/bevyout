...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/direction.rs.html#23)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/direction.rs.html#35)

### impl [InvalidDirectionError](enum.InvalidDirectionError.html "enum bevy::math::InvalidDirectionError")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/direction.rs.html#37)

#### pub fn [from\_length](#method.from_length)(length: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [InvalidDirectionError](enum.InvalidDirectionError.html "enum bevy::math::InvalidDirectionError")

Creates an [`InvalidDirectionError`](enum.InvalidDirectionError.html "enum bevy::math::InvalidDirectionError") from the length of an invalid direction vector.

## Trait Implementations

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/direction.rs.html#22)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [InvalidDirectionError](enum.InvalidDirectionError.html "enum bevy::math::InvalidDirectionError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [InvalidDirectionError](enum.InvalidDirectionError.html "enum bevy::math::InvalidDirectionError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [InvalidDirectionError](enum.InvalidDirectionError.html "enum bevy::math::InvalidDirectionError")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [InvalidDirectionError](enum.InvalidDirectionError.html "enum bevy::math::InvalidDirectionError")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/direction.rs.html#22)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[InvalidDirectionError](enum.InvalidDirectionError.html "enum bevy::math::InvalidDirectionError")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [InvalidDirectionError](enum.InvalidDirectionError.html "enum bevy::math::InvalidDirectionError")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [InvalidDirectionError](enum.InvalidDirectionError.html "enum bevy::math::InvalidDirectionError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [InvalidDirectionError](enum.InvalidDirectionError.html "enum bevy::math::InvalidDirectionError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [InvalidDirectionError](enum.InvalidDirectionError.html "enum bevy::math::InvalidDirectionError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [InvalidDirectionError](enum.InvalidDirectionError.html "enum bevy::math::InvalidDirectionError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [InvalidDirectionError](enum.InvalidDirectionError.html "enum bevy::math::InvalidDirectionError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [InvalidDirectionError](enum.InvalidDirectionError.html "enum bevy::math::InvalidDirectionError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [InvalidDirectionError](enum.InvalidDirectionError.html "enum bevy::math::InvalidDirectionError")
