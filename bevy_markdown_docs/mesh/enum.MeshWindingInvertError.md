...
This error occurs when you try to invert the winding for a mesh with [`PrimitiveTopology::PointList`](enum.PrimitiveTopology.html#variant.PointList "variant bevy::mesh::PrimitiveTopology::PointList").

### AbruptIndicesEnd

This error occurs when you try to invert the winding for a mesh with

*   [`PrimitiveTopology::TriangleList`](enum.PrimitiveTopology.html#variant.TriangleList "variant bevy::mesh::PrimitiveTopology::TriangleList"), but the indices are not in chunks of 3.
*   [`PrimitiveTopology::LineList`](enum.PrimitiveTopology.html#variant.LineList "variant bevy::mesh::PrimitiveTopology::LineList"), but the indices are not in chunks of 2.
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [MeshWindingInvertError](enum.MeshWindingInvertError.html "enum bevy::mesh::MeshWindingInvertError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [MeshWindingInvertError](enum.MeshWindingInvertError.html "enum bevy::mesh::MeshWindingInvertError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [MeshWindingInvertError](enum.MeshWindingInvertError.html "enum bevy::mesh::MeshWindingInvertError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MeshWindingInvertError](enum.MeshWindingInvertError.html "enum bevy::mesh::MeshWindingInvertError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MeshWindingInvertError](enum.MeshWindingInvertError.html "enum bevy::mesh::MeshWindingInvertError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MeshWindingInvertError](enum.MeshWindingInvertError.html "enum bevy::mesh::MeshWindingInvertError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MeshWindingInvertError](enum.MeshWindingInvertError.html "enum bevy::mesh::MeshWindingInvertError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MeshWindingInvertError](enum.MeshWindingInvertError.html "enum bevy::mesh::MeshWindingInvertError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MeshWindingInvertError](enum.MeshWindingInvertError.html "enum bevy::mesh::MeshWindingInvertError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MeshWindingInvertError](enum.MeshWindingInvertError.html "enum bevy::mesh::MeshWindingInvertError")
