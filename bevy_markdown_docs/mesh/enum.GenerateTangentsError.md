...
### UnsupportedTopology([PrimitiveTopology](enum.PrimitiveTopology.html "enum bevy::mesh::PrimitiveTopology"))

### MissingIndices

### MissingVertexAttribute(&'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html))

### InvalidVertexAttributeFormat(&'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html), [VertexFormat](enum.VertexFormat.html "enum bevy::mesh::VertexFormat"))
...
### MeshAccessError([MeshAccessError](enum.MeshAccessError.html "enum bevy::mesh::MeshAccessError"))

## Trait Implementations

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/mikktspace.rs.html#62)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [GenerateTangentsError](enum.GenerateTangentsError.html "enum bevy::mesh::GenerateTangentsError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [GenerateTangentsError](enum.GenerateTangentsError.html "enum bevy::mesh::GenerateTangentsError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [GenerateTangentsError](enum.GenerateTangentsError.html "enum bevy::mesh::GenerateTangentsError")
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[GenerateTangentsError](enum.GenerateTangentsError.html "enum bevy::mesh::GenerateTangentsError")\> for [GltfError](../gltf/enum.GltfError.html "enum bevy::gltf::GltfError")

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/loader/mod.rs.html#84)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(source: [GenerateTangentsError](enum.GenerateTangentsError.html "enum bevy::mesh::GenerateTangentsError")) -> [GltfError](../gltf/enum.GltfError.html "enum bevy::gltf::GltfError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [GenerateTangentsError](enum.GenerateTangentsError.html "enum bevy::mesh::GenerateTangentsError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [GenerateTangentsError](enum.GenerateTangentsError.html "enum bevy::mesh::GenerateTangentsError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [GenerateTangentsError](enum.GenerateTangentsError.html "enum bevy::mesh::GenerateTangentsError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [GenerateTangentsError](enum.GenerateTangentsError.html "enum bevy::mesh::GenerateTangentsError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [GenerateTangentsError](enum.GenerateTangentsError.html "enum bevy::mesh::GenerateTangentsError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [GenerateTangentsError](enum.GenerateTangentsError.html "enum bevy::mesh::GenerateTangentsError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [GenerateTangentsError](enum.GenerateTangentsError.html "enum bevy::mesh::GenerateTangentsError")
