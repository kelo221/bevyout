...
# Struct InfluenceIterator 

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/skinning.rs.html#349)

```rust
pub struct InfluenceIterator<'a> { /* private fields */ }
```
...
[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/skinning.rs.html#357)

### impl<'a> [InfluenceIterator](struct.InfluenceIterator.html "struct bevy::mesh::skinning::InfluenceIterator")<'a>

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/skinning.rs.html#358)

#### pub fn [new](#method.new)(mesh: &'a [Mesh](../../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[InfluenceIterator](struct.InfluenceIterator.html "struct bevy::mesh::skinning::InfluenceIterator")<'a>, [MeshAttributeError](enum.MeshAttributeError.html "enum bevy::mesh::skinning::MeshAttributeError")\>

## Trait Implementations

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/skinning.rs.html#348)

### impl<'a> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [InfluenceIterator](struct.InfluenceIterator.html "struct bevy::mesh::skinning::InfluenceIterator")<'a>

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/skinning.rs.html#348)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [InfluenceIterator](struct.InfluenceIterator.html "struct bevy::mesh::skinning::InfluenceIterator")<'a> [ⓘ](#)
...
### impl<'a> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [InfluenceIterator](struct.InfluenceIterator.html "struct bevy::mesh::skinning::InfluenceIterator")<'a>
...
[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/skinning.rs.html#377)

### impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator") for [InfluenceIterator](struct.InfluenceIterator.html "struct bevy::mesh::skinning::InfluenceIterator")<'\_>

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/skinning.rs.html#378)

#### type [Item](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#associatedtype.Item) = [Influence](struct.Influence.html "struct bevy::mesh::skinning::Influence")

The type of the elements being iterated over.

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/skinning.rs.html#380)

#### fn [next](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#tymethod.next)(&mut self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Influence](struct.Influence.html "struct bevy::mesh::skinning::Influence")\>
...
### impl<'a> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [InfluenceIterator](struct.InfluenceIterator.html "struct bevy::mesh::skinning::InfluenceIterator")<'a>

### impl<'a> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [InfluenceIterator](struct.InfluenceIterator.html "struct bevy::mesh::skinning::InfluenceIterator")<'a>

### impl<'a> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [InfluenceIterator](struct.InfluenceIterator.html "struct bevy::mesh::skinning::InfluenceIterator")<'a>

### impl<'a> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [InfluenceIterator](struct.InfluenceIterator.html "struct bevy::mesh::skinning::InfluenceIterator")<'a>

### impl<'a> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [InfluenceIterator](struct.InfluenceIterator.html "struct bevy::mesh::skinning::InfluenceIterator")<'a>

### impl<'a> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [InfluenceIterator](struct.InfluenceIterator.html "struct bevy::mesh::skinning::InfluenceIterator")<'a>

### impl<'a> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [InfluenceIterator](struct.InfluenceIterator.html "struct bevy::mesh::skinning::InfluenceIterator")<'a>
