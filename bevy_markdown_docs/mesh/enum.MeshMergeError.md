...
`self_attribute: [MeshVertexAttribute](struct.MeshVertexAttribute.html "struct bevy::mesh::MeshVertexAttribute")`

`other_attribute: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[MeshVertexAttribute](struct.MeshVertexAttribute.html "struct bevy::mesh::MeshVertexAttribute")>`

### IncompatiblePrimitiveTopology

#### Fields

`self_primitive_topology: [PrimitiveTopology](enum.PrimitiveTopology.html "enum bevy::mesh::PrimitiveTopology")`

`other_primitive_topology: [PrimitiveTopology](enum.PrimitiveTopology.html "enum bevy::mesh::PrimitiveTopology")`
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [MeshMergeError](enum.MeshMergeError.html "enum bevy::mesh::MeshMergeError")

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/mesh.rs.html#2702)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [MeshMergeError](enum.MeshMergeError.html "enum bevy::mesh::MeshMergeError")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [MeshMergeError](enum.MeshMergeError.html "enum bevy::mesh::MeshMergeError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [MeshMergeError](enum.MeshMergeError.html "enum bevy::mesh::MeshMergeError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [MeshMergeError](enum.MeshMergeError.html "enum bevy::mesh::MeshMergeError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MeshMergeError](enum.MeshMergeError.html "enum bevy::mesh::MeshMergeError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MeshMergeError](enum.MeshMergeError.html "enum bevy::mesh::MeshMergeError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MeshMergeError](enum.MeshMergeError.html "enum bevy::mesh::MeshMergeError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MeshMergeError](enum.MeshMergeError.html "enum bevy::mesh::MeshMergeError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MeshMergeError](enum.MeshMergeError.html "enum bevy::mesh::MeshMergeError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MeshMergeError](enum.MeshMergeError.html "enum bevy::mesh::MeshMergeError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MeshMergeError](enum.MeshMergeError.html "enum bevy::mesh::MeshMergeError")
