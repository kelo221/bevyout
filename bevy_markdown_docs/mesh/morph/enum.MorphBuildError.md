...
# Enum MorphBuildError 

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/morph.rs.html#25)
...
`vertex_count: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)`

`component_count: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

### TooManyTargets

#### Fields

`target_count: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)`

## Trait Implementations

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/morph.rs.html#24)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [MorphBuildError](enum.MorphBuildError.html "enum bevy::mesh::morph::MorphBuildError")

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/morph.rs.html#24)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [MorphBuildError](enum.MorphBuildError.html "enum bevy::mesh::morph::MorphBuildError")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [MorphBuildError](enum.MorphBuildError.html "enum bevy::mesh::morph::MorphBuildError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [MorphBuildError](enum.MorphBuildError.html "enum bevy::mesh::morph::MorphBuildError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [MorphBuildError](enum.MorphBuildError.html "enum bevy::mesh::morph::MorphBuildError")
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[MorphBuildError](enum.MorphBuildError.html "enum bevy::mesh::morph::MorphBuildError")\> for [GltfError](../../gltf/enum.GltfError.html "enum bevy::gltf::GltfError")

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/loader/mod.rs.html#84)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(source: [MorphBuildError](enum.MorphBuildError.html "enum bevy::mesh::morph::MorphBuildError")) -> [GltfError](../../gltf/enum.GltfError.html "enum bevy::gltf::GltfError")

Converts to this type from the input type.

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MorphBuildError](enum.MorphBuildError.html "enum bevy::mesh::morph::MorphBuildError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MorphBuildError](enum.MorphBuildError.html "enum bevy::mesh::morph::MorphBuildError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MorphBuildError](enum.MorphBuildError.html "enum bevy::mesh::morph::MorphBuildError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MorphBuildError](enum.MorphBuildError.html "enum bevy::mesh::morph::MorphBuildError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MorphBuildError](enum.MorphBuildError.html "enum bevy::mesh::morph::MorphBuildError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MorphBuildError](enum.MorphBuildError.html "enum bevy::mesh::morph::MorphBuildError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MorphBuildError](enum.MorphBuildError.html "enum bevy::mesh::morph::MorphBuildError")
