...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [MissingVertexAttributeError](struct.MissingVertexAttributeError.html "struct bevy::mesh::MissingVertexAttributeError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [MissingVertexAttributeError](struct.MissingVertexAttributeError.html "struct bevy::mesh::MissingVertexAttributeError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [MissingVertexAttributeError](struct.MissingVertexAttributeError.html "struct bevy::mesh::MissingVertexAttributeError")
...
#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(source: [MissingVertexAttributeError](struct.MissingVertexAttributeError.html "struct bevy::mesh::MissingVertexAttributeError")) -> [SpecializedMeshPipelineError](../material/specialize/enum.SpecializedMeshPipelineError.html "enum bevy::material::specialize::SpecializedMeshPipelineError")

Converts to this type from the input type.

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MissingVertexAttributeError](struct.MissingVertexAttributeError.html "struct bevy::mesh::MissingVertexAttributeError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MissingVertexAttributeError](struct.MissingVertexAttributeError.html "struct bevy::mesh::MissingVertexAttributeError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MissingVertexAttributeError](struct.MissingVertexAttributeError.html "struct bevy::mesh::MissingVertexAttributeError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MissingVertexAttributeError](struct.MissingVertexAttributeError.html "struct bevy::mesh::MissingVertexAttributeError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MissingVertexAttributeError](struct.MissingVertexAttributeError.html "struct bevy::mesh::MissingVertexAttributeError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MissingVertexAttributeError](struct.MissingVertexAttributeError.html "struct bevy::mesh::MissingVertexAttributeError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MissingVertexAttributeError](struct.MissingVertexAttributeError.html "struct bevy::mesh::MissingVertexAttributeError")
