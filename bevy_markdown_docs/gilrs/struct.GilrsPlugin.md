...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [GilrsPlugin](../prelude/struct.GilrsPlugin.html "struct bevy::prelude::GilrsPlugin")

[Source](https://docs.rs/bevy_gilrs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gilrs/lib.rs.html#83)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [GilrsPlugin](../prelude/struct.GilrsPlugin.html "struct bevy::prelude::GilrsPlugin")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [GilrsPlugin](../prelude/struct.GilrsPlugin.html "struct bevy::prelude::GilrsPlugin")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [GilrsPlugin](../prelude/struct.GilrsPlugin.html "struct bevy::prelude::GilrsPlugin")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [GilrsPlugin](../prelude/struct.GilrsPlugin.html "struct bevy::prelude::GilrsPlugin")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [GilrsPlugin](../prelude/struct.GilrsPlugin.html "struct bevy::prelude::GilrsPlugin")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [GilrsPlugin](../prelude/struct.GilrsPlugin.html "struct bevy::prelude::GilrsPlugin")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [GilrsPlugin](../prelude/struct.GilrsPlugin.html "struct bevy::prelude::GilrsPlugin")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [GilrsPlugin](../prelude/struct.GilrsPlugin.html "struct bevy::prelude::GilrsPlugin")
