...
[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/pipeline.rs.html#44)
...
[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/pipeline.rs.html#53)

### impl [TextPipeline](struct.TextPipeline.html "struct bevy::text::TextPipeline")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/pipeline.rs.html#57-80)

#### pub fn [update\_buffer](#method.update_buffer)<'a>( &mut self, fonts: &[Assets](../prelude/struct.Assets.html "struct bevy::prelude::Assets")<[Font](../prelude/struct.Font.html "struct bevy::prelude::Font")\>, text\_spans: impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = ([Entity](../prelude/struct.Entity.html "struct bevy::prelude::Entity"), [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), &'a [str](https://doc.rust-lang.org/nightly/std/primitive.str.html), &'a [TextFont](../prelude/struct.TextFont.html "struct bevy::prelude::TextFont"), [Color](../prelude/enum.Color.html "enum bevy::prelude::Color"), [LineHeight](enum.LineHeight.html "enum bevy::text::LineHeight"), [LetterSpacing](enum.LetterSpacing.html "enum bevy::text::LetterSpacing"))>, linebreak: [LineBreak](../prelude/enum.LineBreak.html "enum bevy::prelude::LineBreak"), justify: [Justify](../prelude/enum.Justify.html "enum bevy::prelude::Justify"), bounds: [TextBounds](struct.TextBounds.html "struct bevy::text::TextBounds"), scale\_factor: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), computed: &mut [ComputedTextBlock](struct.ComputedTextBlock.html "struct bevy::text::ComputedTextBlock"), font\_cx: &mut [FontCx](struct.FontCx.html "struct bevy::text::FontCx"), layout\_cx: &mut [LayoutCx](struct.LayoutCx.html "struct bevy::text::LayoutCx"), logical\_viewport\_size: [Vec2](../prelude/struct.Vec2.html "struct bevy::prelude::Vec2"), base\_rem\_size: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [TextError](../prelude/enum.TextError.html "enum bevy::prelude::TextError")\>

Shapes and lays out text spans into the computed buffer.

Negative or 0.0 font sizes will not be laid out.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/pipeline.rs.html#249-271)

#### pub fn [create\_text\_measure](#method.create_text_measure)<'a>( &mut self, entity: [Entity](../prelude/struct.Entity.html "struct bevy::prelude::Entity"), fonts: &[Assets](../prelude/struct.Assets.html "struct bevy::prelude::Assets")<[Font](../prelude/struct.Font.html "struct bevy::prelude::Font")\>, text\_spans: impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = ([Entity](../prelude/struct.Entity.html "struct bevy::prelude::Entity"), [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), &'a [str](https://doc.rust-lang.org/nightly/std/primitive.str.html), &'a [TextFont](../prelude/struct.TextFont.html "struct bevy::prelude::TextFont"), [Color](../prelude/enum.Color.html "enum bevy::prelude::Color"), [LineHeight](enum.LineHeight.html "enum bevy::text::LineHeight"), [LetterSpacing](enum.LetterSpacing.html "enum bevy::text::LetterSpacing"))>, scale\_factor: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), layout: &[TextLayout](../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout"), computed: &mut [ComputedTextBlock](struct.ComputedTextBlock.html "struct bevy::text::ComputedTextBlock"), font\_system: &mut [FontCx](struct.FontCx.html "struct bevy::text::FontCx"), layout\_cx: &mut [LayoutCx](struct.LayoutCx.html "struct bevy::text::LayoutCx"), logical\_viewport\_size: [Vec2](../prelude/struct.Vec2.html "struct bevy::prelude::Vec2"), base\_rem\_size: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[TextMeasureInfo](struct.TextMeasureInfo.html "struct bevy::text::TextMeasureInfo"), [TextError](../prelude/enum.TextError.html "enum bevy::prelude::TextError")\>

Queues text for measurement.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/pipeline.rs.html#304-314)

#### pub fn [update\_text\_layout\_info](#method.update_text_layout_info)( &mut self, layout\_info: &mut [TextLayoutInfo](struct.TextLayoutInfo.html "struct bevy::text::TextLayoutInfo"), font\_atlas\_set: &mut [FontAtlasSet](struct.FontAtlasSet.html "struct bevy::text::FontAtlasSet"), textures: &mut [Assets](../prelude/struct.Assets.html "struct bevy::prelude::Assets")<[Image](../prelude/struct.Image.html "struct bevy::prelude::Image")\>, computed: &mut [ComputedTextBlock](struct.ComputedTextBlock.html "struct bevy::text::ComputedTextBlock"), scale\_cx: &mut [ScaleCx](struct.ScaleCx.html "struct bevy::text::ScaleCx"), bounds: [TextBounds](struct.TextBounds.html "struct bevy::text::TextBounds"), justify: [Justify](../prelude/enum.Justify.html "enum bevy::prelude::Justify"), hinting: [FontHinting](../prelude/enum.FontHinting.html "enum bevy::prelude::FontHinting"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [TextError](../prelude/enum.TextError.html "enum bevy::prelude::TextError")\>

Update [`TextLayoutInfo`](struct.TextLayoutInfo.html "struct bevy::text::TextLayoutInfo") with the new [`PositionedGlyph`](struct.PositionedGlyph.html "struct bevy::text::PositionedGlyph") layout.

## Trait Implementations

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/pipeline.rs.html#43)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [TextPipeline](struct.TextPipeline.html "struct bevy::text::TextPipeline")

where [TextPipeline](struct.TextPipeline.html "struct bevy::text::TextPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [TextPipeline](struct.TextPipeline.html "struct bevy::text::TextPipeline")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/pipeline.rs.html#43)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [TextPipeline](struct.TextPipeline.html "struct bevy::text::TextPipeline")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/pipeline.rs.html#43)

### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [TextPipeline](struct.TextPipeline.html "struct bevy::text::TextPipeline")

where [TextPipeline](struct.TextPipeline.html "struct bevy::text::TextPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TextPipeline](struct.TextPipeline.html "struct bevy::text::TextPipeline")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TextPipeline](struct.TextPipeline.html "struct bevy::text::TextPipeline")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TextPipeline](struct.TextPipeline.html "struct bevy::text::TextPipeline")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TextPipeline](struct.TextPipeline.html "struct bevy::text::TextPipeline")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TextPipeline](struct.TextPipeline.html "struct bevy::text::TextPipeline")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TextPipeline](struct.TextPipeline.html "struct bevy::text::TextPipeline")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TextPipeline](struct.TextPipeline.html "struct bevy::text::TextPipeline")
