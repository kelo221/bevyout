...
[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#840)
...
Examples features include ligatures, small-caps, and fractional number display. For the complete list of OpenType features, see the spec at `<https://learn.microsoft.com/en-us/typography/opentype/spec/featurelist>`.
...
[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#844)

### impl [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#846)

#### pub fn [builder](#method.builder)() -> [FontFeaturesBuilder](struct.FontFeaturesBuilder.html "struct bevy::text::FontFeaturesBuilder")

Create a new [`FontFeaturesBuilder`](struct.FontFeaturesBuilder.html "struct bevy::text::FontFeaturesBuilder").

##### [Examples found in repository](#scraped-examples)[?](../../scrape-examples-help.html)

examples/ui/text/text.rs ([line 140](../../src/text/text.rs.html#140))

```rust
29fn setup(mut commands: Commands, asset_server: Res<AssetServer>) {
30    // UI camera
31    commands.spawn(Camera2d);
32    // Text with one section
33    commands.spawn((
34        // Accepts a `String` or any type that converts into a `String`, such as `&str`
35        Text::new("hello\nbevy!"),
36        Underline,
37        TextFont {
38            // This font is loaded and will be used instead of the default font.
39            font: asset_server.load("fonts/FiraSans-Bold.ttf").into(),
40            // The size of the text will be 20% of the viewport height.
41            font_size: FontSize::Vh(20.0),
42            ..default()
43        },
44        TextShadow::default(),
45        // Set the justification of the Text
46        TextLayout::justify(Justify::Center),
47        // Set the style of the Node itself.
48        Node {
...
55    ));
56
57    // Text with multiple sections
58    commands
59        .spawn((
60            // Create a Text with multiple child spans.
61            Text::new("FPS: "),
62            TextFont {
63                // This font is loaded and will be used instead of the default font.
64                font: asset_server.load("fonts/FiraSans-Bold.ttf").into(),
...
71            (
72                TextFont {
73                    // If the "default_font" feature is unavailable, load a font to use instead.
74                    #[cfg(not(feature = "default_font"))]
...
82        ));
83
84    // Text with OpenType features
85    let opentype_font_handle: FontSource =
...
148    commands.spawn((
149        // Here we are able to call the `From` method instead of creating a new `TextSection`.
150        // This will use the default font (a minimal subset of FiraMono) and apply the default styling.
151        Text::new("From an &str into a Text with the default font!"),
152        Node {
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#839)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#839)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#886-888)

### impl<T> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<T> for [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")

where T: [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")\>,

Allow [`FontFeatures`](struct.FontFeatures.html "struct bevy::text::FontFeatures") to be built from a list. This is suitable for the standard case when each listed feature is a boolean type. If any features require a numeric value (like “wght”), use [`FontFeaturesBuilder`](struct.FontFeaturesBuilder.html "struct bevy::text::FontFeaturesBuilder") instead.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#890)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: T) -> [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#839)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#839)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#839)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#839)

### impl [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#839)

#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")
...
where [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#839)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")
...
#### fn [reflect\_owned](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#839)

#### fn [try\_into\_reflect](../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
### impl [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#839)

#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Struct](../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#839)

### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [FontFeatures](struct.FontFeatures.html "struct bevy::text::FontFeatures")
