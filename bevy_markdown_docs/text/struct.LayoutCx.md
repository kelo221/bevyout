...
[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/parley_context.rs.html#176)
...
`0: [LayoutContext](https://docs.rs/parley/0.9.0/x86_64-unknown-linux-gnu/parley/context/struct.LayoutContext.html "struct parley::context::LayoutContext")<[TextBrush](struct.TextBrush.html "struct bevy::text::TextBrush")>`

## Methods from [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")<Target = [LayoutContext](https://docs.rs/parley/0.9.0/x86_64-unknown-linux-gnu/parley/context/struct.LayoutContext.html "struct parley::context::LayoutContext")<[TextBrush](struct.TextBrush.html "struct bevy::text::TextBrush")\>>

[Source](https://docs.rs/parley/0.9.0/x86_64-unknown-linux-gnu/src/parley/context.rs.html#87-93)

#### pub fn [ranged\_builder](#method.ranged_builder)<'a>( &'a mut self, fcx: &'a mut [FontContext](https://docs.rs/parley/0.9.0/x86_64-unknown-linux-gnu/parley/font/struct.FontContext.html "struct parley::font::FontContext"), text: &'a [str](https://doc.rust-lang.org/nightly/std/primitive.str.html), scale: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), quantize: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), ) -> [RangedBuilder](https://docs.rs/parley/0.9.0/x86_64-unknown-linux-gnu/parley/builder/struct.RangedBuilder.html "struct parley::builder::RangedBuilder")<'a, B>

Create a ranged style layout builder.

Set `quantize` as `true` to have the layout coordinates aligned to pixel boundaries. That is the easiest way to avoid blurry text and to receive ready-to-paint layout metrics.

For advanced rendering use cases you can set `quantize` as `false` and receive fractional coordinates. This ensures the most accurate results if you want to perform some post-processing on the coordinates before painting. To avoid blurry text you will still need to quantize the coordinates just before painting.
...
Keep in mind that for the simple `f32::round` to be effective, you need to first ensure the coordinates are in physical pixel space.

[Source](https://docs.rs/parley/0.9.0/x86_64-unknown-linux-gnu/src/parley/context.rs.html#118-124)

#### pub fn [style\_run\_builder](#method.style_run_builder)<'a>( &'a mut self, fcx: &'a mut [FontContext](https://docs.rs/parley/0.9.0/x86_64-unknown-linux-gnu/parley/font/struct.FontContext.html "struct parley::font::FontContext"), text: &'a [str](https://doc.rust-lang.org/nightly/std/primitive.str.html), scale: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), quantize: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), ) -> [StyleRunBuilder](https://docs.rs/parley/0.9.0/x86_64-unknown-linux-gnu/parley/builder/struct.StyleRunBuilder.html "struct parley::builder::StyleRunBuilder")<'a, B>

Create a builder for constructing a layout from indexed style runs.

Unlike [`Self::ranged_builder`](https://docs.rs/parley/0.9.0/x86_64-unknown-linux-gnu/parley/context/struct.LayoutContext.html#method.ranged_builder "method parley::context::LayoutContext::ranged_builder"), this builder expects callers to provide:

*   a style table of fully specified [`TextStyle`](https://docs.rs/parley/0.9.0/x86_64-unknown-linux-gnu/parley/style/struct.TextStyle.html "struct parley::style::TextStyle") values (via [`StyleRunBuilder::push_style`](https://docs.rs/parley/0.9.0/x86_64-unknown-linux-gnu/parley/builder/struct.StyleRunBuilder.html#method.push_style "method parley::builder::StyleRunBuilder::push_style"))
*   a complete sequence of **contiguous**, **non-overlapping** spans that cover `0..text.len()` and reference style indices (via [`StyleRunBuilder::push_style_run`](https://docs.rs/parley/0.9.0/x86_64-unknown-linux-gnu/parley/builder/struct.StyleRunBuilder.html#method.push_style_run "method parley::builder::StyleRunBuilder::push_style_run"))

Parley then skips its internal range-splitting logic.

[Source](https://docs.rs/parley/0.9.0/x86_64-unknown-linux-gnu/src/parley/context.rs.html#158-164)

#### pub fn [tree\_builder](#method.tree_builder)<'a>( &'a mut self, fcx: &'a mut [FontContext](https://docs.rs/parley/0.9.0/x86_64-unknown-linux-gnu/parley/font/struct.FontContext.html "struct parley::font::FontContext"), scale: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), quantize: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), root\_style: &[TextStyle](https://docs.rs/parley/0.9.0/x86_64-unknown-linux-gnu/parley/style/struct.TextStyle.html "struct parley::style::TextStyle")<'\_, '\_, B>, ) -> [TreeBuilder](https://docs.rs/parley/0.9.0/x86_64-unknown-linux-gnu/parley/builder/struct.TreeBuilder.html "struct parley::builder::TreeBuilder")<'a, B>
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [LayoutCx](struct.LayoutCx.html "struct bevy::text::LayoutCx")

where [LayoutCx](struct.LayoutCx.html "struct bevy::text::LayoutCx"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [LayoutCx](struct.LayoutCx.html "struct bevy::text::LayoutCx")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/parley_context.rs.html#175)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [LayoutCx](struct.LayoutCx.html "struct bevy::text::LayoutCx")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/parley_context.rs.html#175)

### impl [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [LayoutCx](struct.LayoutCx.html "struct bevy::text::LayoutCx")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/parley_context.rs.html#175)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = [LayoutContext](https://docs.rs/parley/0.9.0/x86_64-unknown-linux-gnu/parley/context/struct.LayoutContext.html "struct parley::context::LayoutContext")<[TextBrush](struct.TextBrush.html "struct bevy::text::TextBrush")\>

The resulting type after dereferencing.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/parley_context.rs.html#175)

#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[LayoutCx](struct.LayoutCx.html "struct bevy::text::LayoutCx") as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/parley_context.rs.html#175)

### impl [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [LayoutCx](struct.LayoutCx.html "struct bevy::text::LayoutCx")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/parley_context.rs.html#175)

#### fn [deref\_mut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html#tymethod.deref_mut)(&mut self) -> &mut <[LayoutCx](struct.LayoutCx.html "struct bevy::text::LayoutCx") as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Mutably dereferences the value.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/parley_context.rs.html#175)

### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [LayoutCx](struct.LayoutCx.html "struct bevy::text::LayoutCx")

where [LayoutCx](struct.LayoutCx.html "struct bevy::text::LayoutCx"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [LayoutCx](struct.LayoutCx.html "struct bevy::text::LayoutCx")

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [LayoutCx](struct.LayoutCx.html "struct bevy::text::LayoutCx")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [LayoutCx](struct.LayoutCx.html "struct bevy::text::LayoutCx")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [LayoutCx](struct.LayoutCx.html "struct bevy::text::LayoutCx")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [LayoutCx](struct.LayoutCx.html "struct bevy::text::LayoutCx")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [LayoutCx](struct.LayoutCx.html "struct bevy::text::LayoutCx")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [LayoutCx](struct.LayoutCx.html "struct bevy::text::LayoutCx")
