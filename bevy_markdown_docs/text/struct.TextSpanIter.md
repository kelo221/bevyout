...
[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text_access.rs.html#176)

```rust
pub struct TextSpanIter<'a, R>where
...
Iterates all spans in a text block according to hierarchy traversal order. Does _not_ flatten interspersed ghost nodes. Only contiguous spans are traversed.

## Trait Implementations

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text_access.rs.html#276)

### impl<'a, R> [Drop](https://doc.rust-lang.org/nightly/core/ops/drop/trait.Drop.html "trait core::ops::drop::Drop") for [TextSpanIter](struct.TextSpanIter.html "struct bevy::text::TextSpanIter")<'a, R>

where R: [TextSection](trait.TextSection.html "trait bevy::text::TextSection"),

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text_access.rs.html#277)
...
[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text_access.rs.html#207)

### impl<'a, R> [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator") for [TextSpanIter](struct.TextSpanIter.html "struct bevy::text::TextSpanIter")<'a, R>

where R: [TextSection](trait.TextSection.html "trait bevy::text::TextSection"),

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text_access.rs.html#209)
...
[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text_access.rs.html#218)

#### fn [next](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#tymethod.next)(&mut self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[TextSpanIter](struct.TextSpanIter.html "struct bevy::text::TextSpanIter")<'a, R> as [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")\>::[Item](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#associatedtype.Item "type core::iter::traits::iterator::Iterator::Item")\>
...
### impl<'a, R> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TextSpanIter](struct.TextSpanIter.html "struct bevy::text::TextSpanIter")<'a, R>

### impl<'a, R> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TextSpanIter](struct.TextSpanIter.html "struct bevy::text::TextSpanIter")<'a, R>

### impl<'a, R> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TextSpanIter](struct.TextSpanIter.html "struct bevy::text::TextSpanIter")<'a, R>

### impl<'a, R> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TextSpanIter](struct.TextSpanIter.html "struct bevy::text::TextSpanIter")<'a, R>

### impl<'a, R> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TextSpanIter](struct.TextSpanIter.html "struct bevy::text::TextSpanIter")<'a, R>

### impl<'a, R> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TextSpanIter](struct.TextSpanIter.html "struct bevy::text::TextSpanIter")<'a, R>

### impl<'a, R> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TextSpanIter](struct.TextSpanIter.html "struct bevy::text::TextSpanIter")<'a, R>
