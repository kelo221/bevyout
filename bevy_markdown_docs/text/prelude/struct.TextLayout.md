...
A block of text is composed of text spans, which each have a separate string value and [`TextFont`](../../prelude/struct.TextFont.html "struct bevy::prelude::TextFont"). Text spans associated with a text block are collected into [`ComputedTextBlock`](../struct.ComputedTextBlock.html "struct bevy::text::ComputedTextBlock") for layout, and then inserted to [`TextLayoutInfo`](../struct.TextLayoutInfo.html "struct bevy::text::TextLayoutInfo") for rendering.

See `Text2d` in `bevy_sprite` for the core component of 2d text, and `Text` in `bevy_ui` for UI text.

## Fields

`justify: [Justify](../../prelude/enum.Justify.html "enum bevy::prelude::Justify")`

The text’s internal alignment. Should not affect its position within a container.

`linebreak: [LineBreak](../../prelude/enum.LineBreak.html "enum bevy::prelude::LineBreak")`
...
### impl [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#143)

#### pub const fn [new](#method.new)(justify: [Justify](../../prelude/enum.Justify.html "enum bevy::prelude::Justify"), linebreak: [LineBreak](../../prelude/enum.LineBreak.html "enum bevy::prelude::LineBreak")) -> [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")

Makes a new [`TextLayout`](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout").
...
#### pub fn [justify](#method.justify)(justify: [Justify](../../prelude/enum.Justify.html "enum bevy::prelude::Justify")) -> [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")

Makes a new [`TextLayout`](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout") with the specified [`Justify`](../../prelude/enum.Justify.html "enum bevy::prelude::Justify").
...
#### pub fn [linebreak](#method.linebreak)(linebreak: [LineBreak](../../prelude/enum.LineBreak.html "enum bevy::prelude::LineBreak")) -> [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")

Makes a new [`TextLayout`](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout") with the specified [`LineBreak`](../../prelude/enum.LineBreak.html "enum bevy::prelude::LineBreak").

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#159)

#### pub fn [no\_wrap](#method.no_wrap)() -> [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")

Makes a new [`TextLayout`](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout") with soft wrapping disabled. Hard wrapping, where text contains an explicit linebreak such as the escape sequence `\n`, will still occur.
...
#### pub const fn [with\_justify](#method.with_justify)(self, justify: [Justify](../../prelude/enum.Justify.html "enum bevy::prelude::Justify")) -> [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")

Returns this [`TextLayout`](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout") with the specified [`Justify`](../../prelude/enum.Justify.html "enum bevy::prelude::Justify").

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#170)

#### pub const fn [with\_linebreak](#method.with_linebreak)(self, linebreak: [LineBreak](../../prelude/enum.LineBreak.html "enum bevy::prelude::LineBreak")) -> [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")

Returns this [`TextLayout`](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout") with the specified [`LineBreak`](../../prelude/enum.LineBreak.html "enum bevy::prelude::LineBreak").

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#177)

#### pub const fn [with\_no\_wrap](#method.with_no_wrap)(self) -> [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")

Returns this [`TextLayout`](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout") with soft wrapping disabled. Hard wrapping, where text contains an explicit linebreak such as the escape sequence `\n`, will still occur.
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#130)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")

where [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

**Required Components**: [`ComputedTextBlock`](../struct.ComputedTextBlock.html "struct bevy::text::ComputedTextBlock"), [`TextLayoutInfo`](../struct.TextLayoutInfo.html "struct bevy::text::TextLayoutInfo").
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#130)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#130)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#130)

### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#130)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#130)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")
...
where [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout"): 'into\_return,
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#130)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TextLayout](../../prelude/struct.TextLayout.html "struct bevy::prelude::TextLayout")
