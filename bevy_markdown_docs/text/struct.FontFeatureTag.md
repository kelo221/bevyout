...
[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#729)

```rust
pub struct FontFeatureTag(/* private fields */);
```
...
[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#731)

### impl [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#733)

#### pub const [STANDARD\_LIGATURES](#associatedconstant.STANDARD_LIGATURES): [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

Replaces character combinations like fi, fl with ligatures.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#736)

#### pub const [CONTEXTUAL\_LIGATURES](#associatedconstant.CONTEXTUAL_LIGATURES): [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

Enables ligatures based on character context.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#739)

#### pub const [DISCRETIONARY\_LIGATURES](#associatedconstant.DISCRETIONARY_LIGATURES): [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

Enables optional ligatures for stylistic use (e.g., ct, st).

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#742)

#### pub const [CONTEXTUAL\_ALTERNATES](#associatedconstant.CONTEXTUAL_ALTERNATES): [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

Adjust glyph shapes based on surrounding letters.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#745)

#### pub const [STYLISTIC\_ALTERNATES](#associatedconstant.STYLISTIC_ALTERNATES): [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

Use alternate glyph designs.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#748)

#### pub const [SMALL\_CAPS](#associatedconstant.SMALL_CAPS): [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

Replaces lowercase letters with small caps.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#751)

#### pub const [CAPS\_TO\_SMALL\_CAPS](#associatedconstant.CAPS_TO_SMALL_CAPS): [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

Replaces uppercase letters with small caps.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#754)

#### pub const [SWASH](#associatedconstant.SWASH): [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

Replaces characters with swash versions (often decorative).

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#757)

#### pub const [TITLING\_ALTERNATES](#associatedconstant.TITLING_ALTERNATES): [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

Enables alternate glyphs for large sizes or titles.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#760)

#### pub const [FRACTIONS](#associatedconstant.FRACTIONS): [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

Converts numbers like 1/2 into true fractions (½).

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#763)

#### pub const [ORDINALS](#associatedconstant.ORDINALS): [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

Formats characters like 1st, 2nd properly.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#766)

#### pub const [SLASHED\_ZERO](#associatedconstant.SLASHED_ZERO): [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

Uses a slashed version of zero (0) to differentiate from O.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#769)

#### pub const [SUPERSCRIPT](#associatedconstant.SUPERSCRIPT): [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

Replaces figures with superscript figures, e.g. for indicating footnotes.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#772)

#### pub const [SUBSCRIPT](#associatedconstant.SUBSCRIPT): [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

Replaces figures with subscript figures.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#775)

#### pub const [OLDSTYLE\_FIGURES](#associatedconstant.OLDSTYLE_FIGURES): [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

Changes numbers to “oldstyle” form, which fit better in the flow of sentences or other text.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#779)

#### pub const [LINING\_FIGURES](#associatedconstant.LINING_FIGURES): [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

Changes numbers to “lining” form, which are better suited for standalone numbers. When enabled, the bottom of all numbers will be aligned with each other.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#782)

#### pub const [PROPORTIONAL\_FIGURES](#associatedconstant.PROPORTIONAL_FIGURES): [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

Changes numbers to be of proportional width. When enabled, numbers may have varying widths.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#786)

#### pub const [TABULAR\_FIGURES](#associatedconstant.TABULAR_FIGURES): [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

Changes numbers to be of uniform (tabular) width. When enabled, all numbers will have the same width.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#789)

#### pub const [WEIGHT](#associatedconstant.WEIGHT): [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

Varies the stroke thickness. Valid values are in the range of 1 to 1000, inclusive.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#793)

#### pub const [WIDTH](#associatedconstant.WIDTH): [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

Varies the width of text from narrower to wider. Must be a value greater than 0. A value of 100 is typically considered standard width.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#797)

#### pub const [SLANT](#associatedconstant.SLANT): [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

Varies between upright and slanted text. Must be a value greater than -90 and less than +90. A value of 0 is upright.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#800)

#### pub const fn [new](#method.new)(src: &\[[u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html); [4](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]) -> [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

Create a new [`FontFeatureTag`](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag") from raw bytes.

## Trait Implementations

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#728)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#728)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#805)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#806)
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#728)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#728)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#728)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#728)

### impl [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#728)

#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")
...
### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")
...
where [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag"): 'into\_return,
...
### impl [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#728)

#### fn [cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html#tymethod.cmp)(&self, other: &[FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#728)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#728)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")\>
...
### impl [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")
...
#### fn [reflect\_owned](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#728)

#### fn [try\_into\_reflect](../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
### impl [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#728)

#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#728)

### impl [TupleStruct](../prelude/trait.TupleStruct.html "trait bevy::prelude::TupleStruct") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")
...
### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [FontFeatureTag](struct.FontFeatureTag.html "struct bevy::text::FontFeatureTag")
