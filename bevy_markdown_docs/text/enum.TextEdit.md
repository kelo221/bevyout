...
[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text_edit.rs.html#26)
...
### Insert([SmolStr](https://docs.rs/smol_str/0.2.2/x86_64-unknown-linux-gnu/smol_str/struct.SmolStr.html "struct smol_str::SmolStr"))

Insert a character or string at the cursor. If there is a selection, replaces the selection with the character instead.

Ordinarily, this is derived from `bevy_input::keyboard::KeyboardInput::logical_key`, which stores a [`SmolStr`](https://docs.rs/smol_str/0.2.2/x86_64-unknown-linux-gnu/smol_str/struct.SmolStr.html "struct smol_str::SmolStr") inside of the `Key::Character` variant, which may represent multiple bytes.

### Backspace

Delete the character behind the cursor. If there is a selection, deletes the selection instead.

Typically generated in response to the Backspace key.

This operation removes an entire Unicode grapheme cluster, which may consist of multiple bytes, shifting the cursor position accordingly.

### BackspaceWord

Delete the word behind the cursor. If there is a selection, deletes the selection instead.

Typically generated in response to Ctrl + Backspace or Option + Backspace.

### Delete

Delete the character at the cursor. If there is a selection, deletes the selection instead.
...
Delete the word at the cursor. If there is a selection, deletes the selection instead.

Typically generated in response to Ctrl + Delete or Option + Delete.

### Left([bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Moves the cursor by one position to the left. `true` moves and extends selection.

Typically generated in response to the Left key.

### Right([bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Moves the cursor by one position to the right. `true` moves and extends selection.

Typically generated in response to the Right key.

### WordLeft([bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Moves the cursor a word to the left. `true` moves and extends selection.

Typically generated in response to Ctrl + Left or Option + Left.

### WordRight([bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Moves the cursor a word to the right. `true` moves and extends selection.

Typically generated in response to Ctrl + Right or Option + Right.

### Up([bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Moves the cursor up by one visual line. `true` moves and extends selection.

Typically generated in response to the Up key.

### Down([bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Moves the cursor down by one visual line. `true` moves and extends selection.

Typically generated in response to the Down key.

### TextStart([bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Moves the cursor to the start of the text. `true` moves and extends selection.

Typically generated in response to Ctrl + Home or Command + Up.

### TextEnd([bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Moves the cursor to the end of the text. `true` moves and extends selection.

Typically generated in response to Ctrl + End or Command + Down.

### HardLineStart([bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Moves the cursor to the start of the current hard line. A hardline is a line separated by a newline character. `true` moves and extends selection.

Typically generated in response to Command + Left.

### HardLineEnd([bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Moves the cursor to the end of the current hard line. `true` moves and extends selection.

Typically generated in response to Command + Right.

### LineStart([bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Moves the cursor to the start of the current visual line. `true` moves and extends selection.

Typically generated in response to the Home key.

### LineEnd([bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Moves the cursor to the end of the current visual line. `true` moves and extends selection.
...
Typically generated in response to a chain of focus gained by pointer press into pointer release events.

### MoveToPoint([Vec2](../prelude/struct.Vec2.html "struct bevy::prelude::Vec2"))

Moves the cursor to the given point.

Typically generated in response to a pointer press within the text area.

### SelectWordAtPoint([Vec2](../prelude/struct.Vec2.html "struct bevy::prelude::Vec2"))

Selects the word at the given point.

Typically generated in response to a double-click within the text area.

### SelectLineAtPoint([Vec2](../prelude/struct.Vec2.html "struct bevy::prelude::Vec2"))
...
### SelectedHardLineAtPoint([Vec2](../prelude/struct.Vec2.html "struct bevy::prelude::Vec2"))
...
### ExtendSelectionToPoint([Vec2](../prelude/struct.Vec2.html "struct bevy::prelude::Vec2"))
...
### ShiftClickExtension([Vec2](../prelude/struct.Vec2.html "struct bevy::prelude::Vec2"))
...
The preedit text is excluded from [`EditableText::value`](struct.EditableText.html#method.value "method bevy::text::EditableText::value"). `cursor` describes the selection within the preedit text, or `None` to hide the cursor.

Passing an empty `value` clears any in-progress composition; `cursor` is ignored in that case. Use [`TextEdit::clear_ime_compose`](enum.TextEdit.html#method.clear_ime_compose "associated function bevy::text::TextEdit::clear_ime_compose") as a convenience constructor.

Typically generated in response to [`bevy_window::Ime::Preedit`](https://docs.rs/bevy/latest/bevy/prelude/enum.Ime.html#variant.Preedit) events.

#### Fields

`value: [SmolStr](https://docs.rs/smol_str/0.2.2/x86_64-unknown-linux-gnu/smol_str/struct.SmolStr.html "struct smol_str::SmolStr")`

The current preedit string. An empty string clears the composition.

`cursor: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[PreeditCursor](struct.PreeditCursor.html "struct bevy::text::PreeditCursor")>`
...
Clears any in-progress preedit first, then inserts the committed string, respecting [`EditableText::max_characters`](struct.EditableText.html#structfield.max_characters "field bevy::text::EditableText::max_characters") and the `char_filter`.

Typically generated in response to [`bevy_window::Ime::Commit`](https://docs.rs/bevy/latest/bevy/prelude/enum.Ime.html#variant.Commit) events.
...
[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text_edit.rs.html#204)

### impl [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text_edit.rs.html#206)

#### pub fn [clear\_ime\_compose](#method.clear_ime_compose)() -> [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")

Convenience constructor for a [`TextEdit::ImeSetCompose`](enum.TextEdit.html#variant.ImeSetCompose "variant bevy::text::TextEdit::ImeSetCompose") that clears the preedit.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text_edit.rs.html#218-224)

#### pub fn [apply](#method.apply)<'a>( self, driver: &'a mut [PlainEditorDriver](https://docs.rs/parley/0.9.0/x86_64-unknown-linux-gnu/parley/editing/editor/struct.PlainEditorDriver.html "struct parley::editing::editor::PlainEditorDriver")<'\_, [TextBrush](struct.TextBrush.html "struct bevy::text::TextBrush")\>, clipboard: &mut [Clipboard](../prelude/struct.Clipboard.html "struct bevy::prelude::Clipboard"), max\_characters: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\>, char\_filter: impl [Fn](https://doc.rust-lang.org/nightly/core/ops/function/trait.Fn.html "trait core::ops::function::Fn")([char](https://doc.rust-lang.org/nightly/std/primitive.char.html)) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), )

Apply the [`TextEdit`](enum.TextEdit.html "enum bevy::text::TextEdit") to the text editor driver.

Note that some edits, such as [`TextEdit::Paste`](enum.TextEdit.html#variant.Paste "variant bevy::text::TextEdit::Paste"), may need to be deferred across frames due to asynchronous clipboard I/O. For proper handling of deferred edits, use [`EditableText::apply_pending_edits`](struct.EditableText.html#method.apply_pending_edits "method bevy::text::EditableText::apply_pending_edits") instead, which manages the queuing and application of edits by storing them in the [`EditableText`](struct.EditableText.html "struct bevy::text::EditableText") component.

## Trait Implementations

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text_edit.rs.html#25)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text_edit.rs.html#25)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")
...
### impl [Enum](../reflect/enums/trait.Enum.html "trait bevy::reflect::enums::Enum") for [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")
...
### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text_edit.rs.html#25)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text_edit.rs.html#25)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text_edit.rs.html#25)

### impl [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text_edit.rs.html#25)

#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)(\_\_param0: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")
...
where [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text_edit.rs.html#25)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")
...
#### fn [reflect\_owned](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text_edit.rs.html#25)

#### fn [try\_into\_reflect](../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
### impl [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text_edit.rs.html#25)

#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text_edit.rs.html#25)

### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TextEdit](enum.TextEdit.html "enum bevy::text::TextEdit")
