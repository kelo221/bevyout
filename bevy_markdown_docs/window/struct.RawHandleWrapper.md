...
[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/raw_handle.rs.html#52)
...
Depending on the platform, the underlying pointer-containing handle cannot be used on all threads, and so we cannot simply make it (or any type that has a safe operation to get a [`RawWindowHandle`](https://docs.rs/raw-window-handle/0.6.2/x86_64-unknown-linux-gnu/raw_window_handle/enum.RawWindowHandle.html "enum raw_window_handle::RawWindowHandle") or [`RawDisplayHandle`](https://docs.rs/raw-window-handle/0.6.2/x86_64-unknown-linux-gnu/raw_window_handle/enum.RawDisplayHandle.html "enum raw_window_handle::RawDisplayHandle")) thread-safe.

## Implementations

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/raw_handle.rs.html#64)

### impl [RawHandleWrapper](struct.RawHandleWrapper.html "struct bevy::window::RawHandleWrapper")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/raw_handle.rs.html#66-68)

#### pub fn [new](#method.new)<W>( window: &[WindowWrapper](struct.WindowWrapper.html "struct bevy::window::WindowWrapper")<W>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[RawHandleWrapper](struct.RawHandleWrapper.html "struct bevy::window::RawHandleWrapper"), [HandleError](https://docs.rs/raw-window-handle/0.6.2/x86_64-unknown-linux-gnu/raw_window_handle/enum.HandleError.html "enum raw_window_handle::HandleError")\>

where W: [HasWindowHandle](https://docs.rs/raw-window-handle/0.6.2/x86_64-unknown-linux-gnu/raw_window_handle/borrowed/trait.HasWindowHandle.html "trait raw_window_handle::borrowed::HasWindowHandle") + [HasDisplayHandle](https://docs.rs/raw-window-handle/0.6.2/x86_64-unknown-linux-gnu/raw_window_handle/borrowed/trait.HasDisplayHandle.html "trait raw_window_handle::borrowed::HasDisplayHandle") + 'static,

Creates a `RawHandleWrapper` from a `WindowWrapper`.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/raw_handle.rs.html#82)

#### pub unsafe fn [get\_handle](#method.get_handle)(&self) -> [ThreadLockedRawWindowHandleWrapper](struct.ThreadLockedRawWindowHandleWrapper.html "struct bevy::window::ThreadLockedRawWindowHandleWrapper")

Returns a [`HasWindowHandle`](https://docs.rs/raw-window-handle/0.6.2/x86_64-unknown-linux-gnu/raw_window_handle/borrowed/trait.HasWindowHandle.html "trait raw_window_handle::borrowed::HasWindowHandle") + [`HasDisplayHandle`](https://docs.rs/raw-window-handle/0.6.2/x86_64-unknown-linux-gnu/raw_window_handle/borrowed/trait.HasDisplayHandle.html "trait raw_window_handle::borrowed::HasDisplayHandle") impl, which exposes [`WindowHandle`](https://docs.rs/raw-window-handle/0.6.2/x86_64-unknown-linux-gnu/raw_window_handle/borrowed/struct.WindowHandle.html "struct raw_window_handle::borrowed::WindowHandle") and [`DisplayHandle`](https://docs.rs/raw-window-handle/0.6.2/x86_64-unknown-linux-gnu/raw_window_handle/borrowed/struct.DisplayHandle.html "struct raw_window_handle::borrowed::DisplayHandle").

##### Safety

Some platforms have constraints on where/how this handle can be used. For example, some platforms don’t support doing window operations off of the main thread. The caller must ensure the [`RawHandleWrapper`](struct.RawHandleWrapper.html "struct bevy::window::RawHandleWrapper") is only used in valid contexts.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/raw_handle.rs.html#87)

#### pub fn [get\_window\_handle](#method.get_window_handle)(&self) -> [RawWindowHandle](https://docs.rs/raw-window-handle/0.6.2/x86_64-unknown-linux-gnu/raw_window_handle/enum.RawWindowHandle.html "enum raw_window_handle::RawWindowHandle")

Gets the stored window handle.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/raw_handle.rs.html#99)

#### pub unsafe fn [set\_window\_handle](#method.set_window_handle)( &mut self, window\_handle: [RawWindowHandle](https://docs.rs/raw-window-handle/0.6.2/x86_64-unknown-linux-gnu/raw_window_handle/enum.RawWindowHandle.html "enum raw_window_handle::RawWindowHandle"), ) -> &mut [RawHandleWrapper](struct.RawHandleWrapper.html "struct bevy::window::RawHandleWrapper")

Sets the window handle.

##### Safety

The passed in [`RawWindowHandle`](https://docs.rs/raw-window-handle/0.6.2/x86_64-unknown-linux-gnu/raw_window_handle/enum.RawWindowHandle.html "enum raw_window_handle::RawWindowHandle") must be a valid window handle.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/raw_handle.rs.html#106)

#### pub fn [get\_display\_handle](#method.get_display_handle)(&self) -> [RawDisplayHandle](https://docs.rs/raw-window-handle/0.6.2/x86_64-unknown-linux-gnu/raw_window_handle/enum.RawDisplayHandle.html "enum raw_window_handle::RawDisplayHandle")

Gets the stored display handle

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/raw_handle.rs.html#115)

#### pub fn [set\_display\_handle](#method.set_display_handle)( &mut self, display\_handle: [RawDisplayHandle](https://docs.rs/raw-window-handle/0.6.2/x86_64-unknown-linux-gnu/raw_window_handle/enum.RawDisplayHandle.html "enum raw_window_handle::RawDisplayHandle"), ) -> &mut [RawHandleWrapper](struct.RawHandleWrapper.html "struct bevy::window::RawHandleWrapper")

Sets the display handle.

##### Safety

The passed in [`RawDisplayHandle`](https://docs.rs/raw-window-handle/0.6.2/x86_64-unknown-linux-gnu/raw_window_handle/enum.RawDisplayHandle.html "enum raw_window_handle::RawDisplayHandle") must be a valid display handle.

## Trait Implementations

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/raw_handle.rs.html#51)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [RawHandleWrapper](struct.RawHandleWrapper.html "struct bevy::window::RawHandleWrapper")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/raw_handle.rs.html#51)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [RawHandleWrapper](struct.RawHandleWrapper.html "struct bevy::window::RawHandleWrapper")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [RawHandleWrapper](struct.RawHandleWrapper.html "struct bevy::window::RawHandleWrapper")

where [RawHandleWrapper](struct.RawHandleWrapper.html "struct bevy::window::RawHandleWrapper"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [RawHandleWrapper](struct.RawHandleWrapper.html "struct bevy::window::RawHandleWrapper")
...
[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/raw_handle.rs.html#127)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RawHandleWrapper](struct.RawHandleWrapper.html "struct bevy::window::RawHandleWrapper")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/raw_handle.rs.html#129)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RawHandleWrapper](struct.RawHandleWrapper.html "struct bevy::window::RawHandleWrapper")

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RawHandleWrapper](struct.RawHandleWrapper.html "struct bevy::window::RawHandleWrapper")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RawHandleWrapper](struct.RawHandleWrapper.html "struct bevy::window::RawHandleWrapper")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RawHandleWrapper](struct.RawHandleWrapper.html "struct bevy::window::RawHandleWrapper")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RawHandleWrapper](struct.RawHandleWrapper.html "struct bevy::window::RawHandleWrapper")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RawHandleWrapper](struct.RawHandleWrapper.html "struct bevy::window::RawHandleWrapper")
