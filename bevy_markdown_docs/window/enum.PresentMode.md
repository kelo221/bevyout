...
[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#1223)
...
The presentation mode specifies when a frame is presented to the window. The [`Fifo`](enum.PresentMode.html#variant.Fifo "variant bevy::window::PresentMode::Fifo") option corresponds to a traditional `VSync`, where the framerate is capped by the display refresh rate. Both [`Immediate`](enum.PresentMode.html#variant.Immediate "variant bevy::window::PresentMode::Immediate") and [`Mailbox`](enum.PresentMode.html#variant.Mailbox "variant bevy::window::PresentMode::Mailbox") are low-latency and are not capped by the refresh rate, but may not be available on all platforms. Tearing may be observed with [`Immediate`](enum.PresentMode.html#variant.Immediate "variant bevy::window::PresentMode::Immediate") mode, but will not be observed with [`Mailbox`](enum.PresentMode.html#variant.Mailbox "variant bevy::window::PresentMode::Mailbox") or [`Fifo`](enum.PresentMode.html#variant.Fifo "variant bevy::window::PresentMode::Fifo").

[`AutoVsync`](enum.PresentMode.html#variant.AutoVsync "variant bevy::window::PresentMode::AutoVsync") or [`AutoNoVsync`](enum.PresentMode.html#variant.AutoNoVsync "variant bevy::window::PresentMode::AutoNoVsync") will gracefully fallback to [`Fifo`](enum.PresentMode.html#variant.Fifo "variant bevy::window::PresentMode::Fifo") when unavailable.

[`Immediate`](enum.PresentMode.html#variant.Immediate "variant bevy::window::PresentMode::Immediate") or [`Mailbox`](enum.PresentMode.html#variant.Mailbox "variant bevy::window::PresentMode::Mailbox") will panic if not supported by the platform.

## Variants

### AutoVsync = 0

Chooses [`FifoRelaxed`](enum.PresentMode.html#variant.FifoRelaxed "variant bevy::window::PresentMode::FifoRelaxed") -> [`Fifo`](enum.PresentMode.html#variant.Fifo "variant bevy::window::PresentMode::Fifo") based on availability.

Because of the fallback behavior, it is supported everywhere.

### AutoNoVsync = 1

Chooses [`Immediate`](enum.PresentMode.html#variant.Immediate "variant bevy::window::PresentMode::Immediate") -> [`Mailbox`](enum.PresentMode.html#variant.Mailbox "variant bevy::window::PresentMode::Mailbox") -> [`Fifo`](enum.PresentMode.html#variant.Fifo "variant bevy::window::PresentMode::Fifo") (on web) based on availability.
...
When a present command is executed on the gpu, the frame will be put into the queue. If there was already a frame in the queue, the new frame will _replace_ the old frame on the queue.
...
[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#1211)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#1211)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#1211)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#1211)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#1217)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#1217)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [Enum](../reflect/enums/trait.Enum.html "trait bevy::reflect::enums::Enum") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#1214)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#1214)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#1214)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#1214)

### impl [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#1214)

#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)( \_\_param0: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")
...
### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")
...
where [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#1211)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")
...
#### fn [reflect\_owned](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#1214)

#### fn [try\_into\_reflect](../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#1215)
...
### impl [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#1214)

#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#1214)

### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [PresentMode](enum.PresentMode.html "enum bevy::window::PresentMode")
