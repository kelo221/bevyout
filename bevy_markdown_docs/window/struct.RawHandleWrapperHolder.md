...
# Struct RawHandleWrapperHolder 

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/raw_handle.rs.html#166)
...
`0: [Arc](../platform/sync/struct.Arc.html "struct bevy::platform::sync::Arc")<[Mutex](../platform/sync/struct.Mutex.html "struct bevy::platform::sync::Mutex")<[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[RawHandleWrapper](struct.RawHandleWrapper.html "struct bevy::window::RawHandleWrapper")>>>`

## Trait Implementations

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/raw_handle.rs.html#165)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [RawHandleWrapperHolder](struct.RawHandleWrapperHolder.html "struct bevy::window::RawHandleWrapperHolder")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/raw_handle.rs.html#165)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [RawHandleWrapperHolder](struct.RawHandleWrapperHolder.html "struct bevy::window::RawHandleWrapperHolder")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [RawHandleWrapperHolder](struct.RawHandleWrapperHolder.html "struct bevy::window::RawHandleWrapperHolder")

where [RawHandleWrapperHolder](struct.RawHandleWrapperHolder.html "struct bevy::window::RawHandleWrapperHolder"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [RawHandleWrapperHolder](struct.RawHandleWrapperHolder.html "struct bevy::window::RawHandleWrapperHolder")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RawHandleWrapperHolder](struct.RawHandleWrapperHolder.html "struct bevy::window::RawHandleWrapperHolder")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RawHandleWrapperHolder](struct.RawHandleWrapperHolder.html "struct bevy::window::RawHandleWrapperHolder")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RawHandleWrapperHolder](struct.RawHandleWrapperHolder.html "struct bevy::window::RawHandleWrapperHolder")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RawHandleWrapperHolder](struct.RawHandleWrapperHolder.html "struct bevy::window::RawHandleWrapperHolder")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RawHandleWrapperHolder](struct.RawHandleWrapperHolder.html "struct bevy::window::RawHandleWrapperHolder")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RawHandleWrapperHolder](struct.RawHandleWrapperHolder.html "struct bevy::window::RawHandleWrapperHolder")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RawHandleWrapperHolder](struct.RawHandleWrapperHolder.html "struct bevy::window::RawHandleWrapperHolder")
