...
[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#1558)
...
This component is inserted after window creation, this means that there is a small period of time when the Window exists, but does not know the monitor it is on.
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [OnMonitor](struct.OnMonitor.html "struct bevy::window::OnMonitor")

where [OnMonitor](struct.OnMonitor.html "struct bevy::window::OnMonitor"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
#### fn [map\_entities](../prelude/trait.Component.html#method.map_entities)<M>(this: &mut [OnMonitor](struct.OnMonitor.html "struct bevy::window::OnMonitor"), mapper: [&mut M](https://doc.rust-lang.org/nightly/std/primitive.reference.html))
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [OnMonitor](struct.OnMonitor.html "struct bevy::window::OnMonitor")
...
### impl [Relationship](../ecs/relationship/trait.Relationship.html "trait bevy::ecs::relationship::Relationship") for [OnMonitor](struct.OnMonitor.html "struct bevy::window::OnMonitor")
...
#### type [RelationshipTarget](../ecs/relationship/trait.Relationship.html#associatedtype.RelationshipTarget) = [HasWindows](struct.HasWindows.html "struct bevy::window::HasWindows")

The [`Component`](../prelude/trait.Component.html "trait bevy::prelude::Component") added to the “target” entities of this [`Relationship`](../ecs/relationship/trait.Relationship.html "trait bevy::ecs::relationship::Relationship"), which contains the list of all “source” entities that relate to the “target”.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#1556)

#### fn [get](../ecs/relationship/trait.Relationship.html#tymethod.get)(&self) -> [Entity](../prelude/struct.Entity.html "struct bevy::prelude::Entity")

Gets the [`Entity`](../prelude/struct.Entity.html "struct bevy::prelude::Entity") ID of the related entity.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#1556)

#### fn [from](../ecs/relationship/trait.Relationship.html#tymethod.from)(entity: [Entity](../prelude/struct.Entity.html "struct bevy::prelude::Entity")) -> [OnMonitor](struct.OnMonitor.html "struct bevy::window::OnMonitor")
...
#### fn [set\_risky](../ecs/relationship/trait.Relationship.html#tymethod.set_risky)(&mut self, entity: [Entity](../prelude/struct.Entity.html "struct bevy::prelude::Entity"))

Changes the current [`Entity`](../prelude/struct.Entity.html "struct bevy::prelude::Entity") ID of the entity containing the [`RelationshipTarget`](../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") to another one. [Read more](../ecs/relationship/trait.Relationship.html#tymethod.set_risky)
...
The `on_insert` component hook that maintains the [`Relationship`](../ecs/relationship/trait.Relationship.html "trait bevy::ecs::relationship::Relationship") / [`RelationshipTarget`](../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") connection.
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [OnMonitor](struct.OnMonitor.html "struct bevy::window::OnMonitor")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [OnMonitor](struct.OnMonitor.html "struct bevy::window::OnMonitor")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [OnMonitor](struct.OnMonitor.html "struct bevy::window::OnMonitor")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [OnMonitor](struct.OnMonitor.html "struct bevy::window::OnMonitor")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [OnMonitor](struct.OnMonitor.html "struct bevy::window::OnMonitor")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [OnMonitor](struct.OnMonitor.html "struct bevy::window::OnMonitor")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [OnMonitor](struct.OnMonitor.html "struct bevy::window::OnMonitor")
