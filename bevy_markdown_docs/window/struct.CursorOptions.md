...
[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#752)
...
*   **`Windows`**, **`X11`**, and **`Wayland`**: The cursor is hidden only when inside the window. To stop the cursor from leaving the window, change [`CursorOptions::grab_mode`](struct.CursorOptions.html#structfield.grab_mode "field bevy::window::CursorOptions::grab_mode") to [`CursorGrabMode::Locked`](enum.CursorGrabMode.html#variant.Locked "variant bevy::window::CursorGrabMode::Locked") or [`CursorGrabMode::Confined`](enum.CursorGrabMode.html#variant.Confined "variant bevy::window::CursorGrabMode::Confined")
*   **`macOS`**: The cursor is hidden only when the window is focused.
*   **`iOS`** and **`Android`** do not have cursors

`grab_mode: [CursorGrabMode](enum.CursorGrabMode.html "enum bevy::window::CursorGrabMode")`

Whether or not the cursor is locked by or confined within the window.

#### Platform-specific

*   **`macOS`** doesn’t support [`CursorGrabMode::Confined`](enum.CursorGrabMode.html#variant.Confined "variant bevy::window::CursorGrabMode::Confined")
*   **`X11`** doesn’t support [`CursorGrabMode::Locked`](enum.CursorGrabMode.html#variant.Locked "variant bevy::window::CursorGrabMode::Locked")
*   **`iOS/Android`** don’t have cursors.

Since `macOS` and `X11` don’t have full [`CursorGrabMode`](enum.CursorGrabMode.html "enum bevy::window::CursorGrabMode") support, we first try to set the grab mode that was asked for. If it doesn’t work then use the alternate grab mode.

`hit_test: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

Set whether or not mouse events within _this_ window are captured or fall through to the Window below.
...
[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#741)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#741)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")

where [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")
...
[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#782)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#783)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#747)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#747)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#744)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#744)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#744)

### impl [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#744)

#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")
...
where [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions"): 'into\_return,
...
### impl [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")
...
#### fn [reflect\_owned](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#744)

#### fn [try\_into\_reflect](../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#745)
...
### impl [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#744)

#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")
...
### impl [Struct](../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")
...
### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [CursorOptions](struct.CursorOptions.html "struct bevy::window::CursorOptions")
