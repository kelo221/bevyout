...
[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/monitor.rs.html#61)

```rust
pub struct HasWindows(/* private fields */);
```
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [HasWindows](struct.HasWindows.html "struct bevy::window::HasWindows")

where [HasWindows](struct.HasWindows.html "struct bevy::window::HasWindows"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
#### fn [map\_entities](../prelude/trait.Component.html#method.map_entities)<M>(this: &mut [HasWindows](struct.HasWindows.html "struct bevy::window::HasWindows"), mapper: [&mut M](https://doc.rust-lang.org/nightly/std/primitive.reference.html))
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [HasWindows](struct.HasWindows.html "struct bevy::window::HasWindows")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [HasWindows](struct.HasWindows.html "struct bevy::window::HasWindows")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/monitor.rs.html#59)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [HasWindows](struct.HasWindows.html "struct bevy::window::HasWindows")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/monitor.rs.html#59)

### impl [RelationshipTarget](../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") for [HasWindows](struct.HasWindows.html "struct bevy::window::HasWindows")
...
#### type [Relationship](../prelude/trait.RelationshipTarget.html#associatedtype.Relationship) = [OnMonitor](struct.OnMonitor.html "struct bevy::window::OnMonitor")

The [`Relationship`](../ecs/relationship/trait.Relationship.html "trait bevy::ecs::relationship::Relationship") that populates this [`RelationshipTarget`](../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") collection.
...
#### fn [collection](../prelude/trait.RelationshipTarget.html#tymethod.collection)(&self) -> &<[HasWindows](struct.HasWindows.html "struct bevy::window::HasWindows") as [RelationshipTarget](../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget")\>::[Collection](../prelude/trait.RelationshipTarget.html#associatedtype.Collection "type bevy::prelude::RelationshipTarget::Collection")
...
#### fn [from\_collection\_risky](../prelude/trait.RelationshipTarget.html#tymethod.from_collection_risky)( collection: <[HasWindows](struct.HasWindows.html "struct bevy::window::HasWindows") as [RelationshipTarget](../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget")\>::[Collection](../prelude/trait.RelationshipTarget.html#associatedtype.Collection "type bevy::prelude::RelationshipTarget::Collection"), ) -> [HasWindows](struct.HasWindows.html "struct bevy::window::HasWindows")
...
#### fn [on\_discard](../prelude/trait.RelationshipTarget.html#method.on_discard)(world: [DeferredWorld](../ecs/world/struct.DeferredWorld.html "struct bevy::ecs::world::DeferredWorld")<'\_>, \_: [HookContext](../ecs/lifecycle/struct.HookContext.html "struct bevy::ecs::lifecycle::HookContext"))

The `on_discard` component hook that maintains the [`Relationship`](../ecs/relationship/trait.Relationship.html "trait bevy::ecs::relationship::Relationship") / [`RelationshipTarget`](../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") connection.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/mod.rs.html#332)

#### fn [on\_despawn](../prelude/trait.RelationshipTarget.html#method.on_despawn)(world: [DeferredWorld](../ecs/world/struct.DeferredWorld.html "struct bevy::ecs::world::DeferredWorld")<'\_>, \_: [HookContext](../ecs/lifecycle/struct.HookContext.html "struct bevy::ecs::lifecycle::HookContext"))
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [HasWindows](struct.HasWindows.html "struct bevy::window::HasWindows")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [HasWindows](struct.HasWindows.html "struct bevy::window::HasWindows")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [HasWindows](struct.HasWindows.html "struct bevy::window::HasWindows")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [HasWindows](struct.HasWindows.html "struct bevy::window::HasWindows")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [HasWindows](struct.HasWindows.html "struct bevy::window::HasWindows")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [HasWindows](struct.HasWindows.html "struct bevy::window::HasWindows")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [HasWindows](struct.HasWindows.html "struct bevy::window::HasWindows")
...
#### fn [spawn](../prelude/trait.SpawnRelated.html#tymethod.spawn)<L>( list: L, ) -> [SpawnRelatedBundle](../ecs/spawn/struct.SpawnRelatedBundle.html "struct bevy::ecs::spawn::SpawnRelatedBundle")<<T as [RelationshipTarget](../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget")\>::[Relationship](../prelude/trait.RelationshipTarget.html#associatedtype.Relationship "type bevy::prelude::RelationshipTarget::Relationship"), L>
