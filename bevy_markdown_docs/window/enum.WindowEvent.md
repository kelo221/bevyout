...
[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#504)
...
### AppLifecycle([AppLifecycle](enum.AppLifecycle.html "enum bevy::window::AppLifecycle"))

An application lifecycle event.

### CursorEntered([CursorEntered](../prelude/struct.CursorEntered.html "struct bevy::prelude::CursorEntered"))

The user’s cursor has entered a window.

### CursorLeft([CursorLeft](../prelude/struct.CursorLeft.html "struct bevy::prelude::CursorLeft"))

The user’s cursor has left a window.

### CursorMoved([CursorMoved](../prelude/struct.CursorMoved.html "struct bevy::prelude::CursorMoved"))

The user’s cursor has moved inside a window.

### FileDragAndDrop([FileDragAndDrop](../prelude/enum.FileDragAndDrop.html "enum bevy::prelude::FileDragAndDrop"))

A file drag and drop event.

### Ime([Ime](../prelude/enum.Ime.html "enum bevy::prelude::Ime"))

An Input Method Editor event.

### RequestRedraw([RequestRedraw](struct.RequestRedraw.html "struct bevy::window::RequestRedraw"))

A redraw of all of the application’s windows has been requested.

### WindowBackendScaleFactorChanged([WindowBackendScaleFactorChanged](struct.WindowBackendScaleFactorChanged.html "struct bevy::window::WindowBackendScaleFactorChanged"))

The window’s OS-reported scale factor has changed.

### WindowCloseRequested([WindowCloseRequested](struct.WindowCloseRequested.html "struct bevy::window::WindowCloseRequested"))

The OS has requested that a window be closed.

### WindowCreated([WindowCreated](struct.WindowCreated.html "struct bevy::window::WindowCreated"))

A new window has been created.

### WindowDestroyed([WindowDestroyed](struct.WindowDestroyed.html "struct bevy::window::WindowDestroyed"))

A window has been destroyed by the underlying windowing system.

### WindowFocused([WindowFocused](struct.WindowFocused.html "struct bevy::window::WindowFocused"))

A window has received or lost focus.

### WindowMoved([WindowMoved](../prelude/struct.WindowMoved.html "struct bevy::prelude::WindowMoved"))

A window has been moved.

### WindowOccluded([WindowOccluded](struct.WindowOccluded.html "struct bevy::window::WindowOccluded"))

A window has started or stopped being occluded.

### WindowResized([WindowResized](struct.WindowResized.html "struct bevy::window::WindowResized"))

A window’s logical size has changed.

### WindowScaleFactorChanged([WindowScaleFactorChanged](struct.WindowScaleFactorChanged.html "struct bevy::window::WindowScaleFactorChanged"))

A window’s scale factor has changed.

### WindowThemeChanged([WindowThemeChanged](struct.WindowThemeChanged.html "struct bevy::window::WindowThemeChanged"))

Sent for windows that are using the system theme when the system theme changes.

### MouseButtonInput([MouseButtonInput](../input/mouse/struct.MouseButtonInput.html "struct bevy::input::mouse::MouseButtonInput"))

The state of a mouse button has changed.

### MouseMotion([MouseMotion](../input/mouse/struct.MouseMotion.html "struct bevy::input::mouse::MouseMotion"))

The physical position of a pointing device has changed.

### MouseWheel([MouseWheel](../input/mouse/struct.MouseWheel.html "struct bevy::input::mouse::MouseWheel"))

The mouse wheel has moved.

### PinchGesture([PinchGesture](../input/gestures/struct.PinchGesture.html "struct bevy::input::gestures::PinchGesture"))

A two finger pinch gesture.

### RotationGesture([RotationGesture](../input/gestures/struct.RotationGesture.html "struct bevy::input::gestures::RotationGesture"))

A two finger rotation gesture.

### DoubleTapGesture([DoubleTapGesture](../input/gestures/struct.DoubleTapGesture.html "struct bevy::input::gestures::DoubleTapGesture"))

A double tap gesture.

### PanGesture([PanGesture](../input/gestures/struct.PanGesture.html "struct bevy::input::gestures::PanGesture"))

A pan gesture.

### TouchInput([TouchInput](../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput"))

A touch input state change.

### KeyboardInput([KeyboardInput](../input/keyboard/struct.KeyboardInput.html "struct bevy::input::keyboard::KeyboardInput"))

A keyboard input.

### KeyboardFocusLost([KeyboardFocusLost](../input/keyboard/struct.KeyboardFocusLost.html "struct bevy::input::keyboard::KeyboardFocusLost"))
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#493)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")
...
[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#499)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#499)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [Enum](../reflect/enums/trait.Enum.html "trait bevy::reflect::enums::Enum") for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")
...
[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#567)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[AppLifecycle](enum.AppLifecycle.html "enum bevy::window::AppLifecycle")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#568)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [AppLifecycle](enum.AppLifecycle.html "enum bevy::window::AppLifecycle")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#573)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[CursorEntered](../prelude/struct.CursorEntered.html "struct bevy::prelude::CursorEntered")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#574)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [CursorEntered](../prelude/struct.CursorEntered.html "struct bevy::prelude::CursorEntered")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#579)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[CursorLeft](../prelude/struct.CursorLeft.html "struct bevy::prelude::CursorLeft")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#580)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [CursorLeft](../prelude/struct.CursorLeft.html "struct bevy::prelude::CursorLeft")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#585)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[CursorMoved](../prelude/struct.CursorMoved.html "struct bevy::prelude::CursorMoved")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#586)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [CursorMoved](../prelude/struct.CursorMoved.html "struct bevy::prelude::CursorMoved")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#699)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[DoubleTapGesture](../input/gestures/struct.DoubleTapGesture.html "struct bevy::input::gestures::DoubleTapGesture")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#700)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [DoubleTapGesture](../input/gestures/struct.DoubleTapGesture.html "struct bevy::input::gestures::DoubleTapGesture")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#591)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[FileDragAndDrop](../prelude/enum.FileDragAndDrop.html "enum bevy::prelude::FileDragAndDrop")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#592)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [FileDragAndDrop](../prelude/enum.FileDragAndDrop.html "enum bevy::prelude::FileDragAndDrop")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#597)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Ime](../prelude/enum.Ime.html "enum bevy::prelude::Ime")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#598)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [Ime](../prelude/enum.Ime.html "enum bevy::prelude::Ime")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#723)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[KeyboardFocusLost](../input/keyboard/struct.KeyboardFocusLost.html "struct bevy::input::keyboard::KeyboardFocusLost")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#724)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [KeyboardFocusLost](../input/keyboard/struct.KeyboardFocusLost.html "struct bevy::input::keyboard::KeyboardFocusLost")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#717)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[KeyboardInput](../input/keyboard/struct.KeyboardInput.html "struct bevy::input::keyboard::KeyboardInput")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#718)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [KeyboardInput](../input/keyboard/struct.KeyboardInput.html "struct bevy::input::keyboard::KeyboardInput")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#669)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[MouseButtonInput](../input/mouse/struct.MouseButtonInput.html "struct bevy::input::mouse::MouseButtonInput")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#670)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [MouseButtonInput](../input/mouse/struct.MouseButtonInput.html "struct bevy::input::mouse::MouseButtonInput")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#675)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[MouseMotion](../input/mouse/struct.MouseMotion.html "struct bevy::input::mouse::MouseMotion")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#676)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [MouseMotion](../input/mouse/struct.MouseMotion.html "struct bevy::input::mouse::MouseMotion")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#681)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[MouseWheel](../input/mouse/struct.MouseWheel.html "struct bevy::input::mouse::MouseWheel")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#682)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [MouseWheel](../input/mouse/struct.MouseWheel.html "struct bevy::input::mouse::MouseWheel")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#705)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[PanGesture](../input/gestures/struct.PanGesture.html "struct bevy::input::gestures::PanGesture")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#706)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [PanGesture](../input/gestures/struct.PanGesture.html "struct bevy::input::gestures::PanGesture")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#687)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[PinchGesture](../input/gestures/struct.PinchGesture.html "struct bevy::input::gestures::PinchGesture")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#688)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [PinchGesture](../input/gestures/struct.PinchGesture.html "struct bevy::input::gestures::PinchGesture")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#603)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[RequestRedraw](struct.RequestRedraw.html "struct bevy::window::RequestRedraw")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#604)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [RequestRedraw](struct.RequestRedraw.html "struct bevy::window::RequestRedraw")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#693)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[RotationGesture](../input/gestures/struct.RotationGesture.html "struct bevy::input::gestures::RotationGesture")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#694)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [RotationGesture](../input/gestures/struct.RotationGesture.html "struct bevy::input::gestures::RotationGesture")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#711)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[TouchInput](../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#712)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [TouchInput](../prelude/struct.TouchInput.html "struct bevy::prelude::TouchInput")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#609)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[WindowBackendScaleFactorChanged](struct.WindowBackendScaleFactorChanged.html "struct bevy::window::WindowBackendScaleFactorChanged")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#610)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [WindowBackendScaleFactorChanged](struct.WindowBackendScaleFactorChanged.html "struct bevy::window::WindowBackendScaleFactorChanged")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#615)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[WindowCloseRequested](struct.WindowCloseRequested.html "struct bevy::window::WindowCloseRequested")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#616)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [WindowCloseRequested](struct.WindowCloseRequested.html "struct bevy::window::WindowCloseRequested")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#621)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[WindowCreated](struct.WindowCreated.html "struct bevy::window::WindowCreated")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#622)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [WindowCreated](struct.WindowCreated.html "struct bevy::window::WindowCreated")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#627)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[WindowDestroyed](struct.WindowDestroyed.html "struct bevy::window::WindowDestroyed")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#628)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [WindowDestroyed](struct.WindowDestroyed.html "struct bevy::window::WindowDestroyed")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#633)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[WindowFocused](struct.WindowFocused.html "struct bevy::window::WindowFocused")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#634)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [WindowFocused](struct.WindowFocused.html "struct bevy::window::WindowFocused")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#639)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[WindowMoved](../prelude/struct.WindowMoved.html "struct bevy::prelude::WindowMoved")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#640)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [WindowMoved](../prelude/struct.WindowMoved.html "struct bevy::prelude::WindowMoved")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#645)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[WindowOccluded](struct.WindowOccluded.html "struct bevy::window::WindowOccluded")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#646)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [WindowOccluded](struct.WindowOccluded.html "struct bevy::window::WindowOccluded")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#651)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[WindowResized](struct.WindowResized.html "struct bevy::window::WindowResized")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#652)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [WindowResized](struct.WindowResized.html "struct bevy::window::WindowResized")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#657)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[WindowScaleFactorChanged](struct.WindowScaleFactorChanged.html "struct bevy::window::WindowScaleFactorChanged")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#658)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [WindowScaleFactorChanged](struct.WindowScaleFactorChanged.html "struct bevy::window::WindowScaleFactorChanged")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#663)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[WindowThemeChanged](struct.WindowThemeChanged.html "struct bevy::window::WindowThemeChanged")\> for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#664)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(e: [WindowThemeChanged](struct.WindowThemeChanged.html "struct bevy::window::WindowThemeChanged")) -> [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#496)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#496)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#496)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#496)

### impl [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#496)

#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)( \_\_param0: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")
...
where [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent"): 'into\_return,
...
### impl [Message](../prelude/trait.Message.html "trait bevy::prelude::Message") for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

where [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#493)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#493)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")
...
[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#497)
...
### impl [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#496)

#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/event.rs.html#496)

### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [WindowEvent](enum.WindowEvent.html "enum bevy::window::WindowEvent")
