...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#141)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#139)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [EvenCoreError](enum.EvenCoreError.html "enum bevy::prelude::cores::EvenCoreError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [EvenCoreError](enum.EvenCoreError.html "enum bevy::prelude::cores::EvenCoreError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [EvenCoreError](enum.EvenCoreError.html "enum bevy::prelude::cores::EvenCoreError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [EvenCoreError](enum.EvenCoreError.html "enum bevy::prelude::cores::EvenCoreError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [EvenCoreError](enum.EvenCoreError.html "enum bevy::prelude::cores::EvenCoreError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [EvenCoreError](enum.EvenCoreError.html "enum bevy::prelude::cores::EvenCoreError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [EvenCoreError](enum.EvenCoreError.html "enum bevy::prelude::cores::EvenCoreError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [EvenCoreError](enum.EvenCoreError.html "enum bevy::prelude::cores::EvenCoreError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [EvenCoreError](enum.EvenCoreError.html "enum bevy::prelude::cores::EvenCoreError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [EvenCoreError](enum.EvenCoreError.html "enum bevy::prelude::cores::EvenCoreError")
