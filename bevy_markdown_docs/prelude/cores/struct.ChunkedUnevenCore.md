...
# Struct ChunkedUnevenCore 

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#468)
...
`times: [Vec](../struct.Vec.html "struct bevy::prelude::Vec")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)>`
...
`values: [Vec](../struct.Vec.html "struct bevy::prelude::Vec")<T>`
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#520)

### impl<T> [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#530-534)

#### pub fn [new](#method.new)( times: impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\>, values: impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = T>, width: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>, [ChunkedUnevenCoreError](enum.ChunkedUnevenCoreError.html "enum bevy::prelude::cores::ChunkedUnevenCoreError")\>

Create a new [`ChunkedUnevenCore`](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore"). The given `times` are sorted, filtered to finite times, and deduplicated. See the [type-level documentation](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore") for more information about this type.
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#577-580)

#### pub fn [new\_width\_inferred](#method.new_width_inferred)( times: impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\>, values: impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = T>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>, [ChunkedUnevenCoreError](enum.ChunkedUnevenCoreError.html "enum bevy::prelude::cores::ChunkedUnevenCoreError")\>

Create a new [`ChunkedUnevenCore`](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore"), inferring the width from the sizes of the inputs. The given `times` are sorted, filtered to finite times, and deduplicated. See the [type-level documentation](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore") for more information about this type. Prefer using [`new`](struct.ChunkedUnevenCore.html#method.new "associated function bevy::prelude::cores::ChunkedUnevenCore::new") if possible, since that constructor has richer error checking.

Produces an error in any of the following circumstances:

*   `values` has length zero.
*   `times` has less than `2` unique valid entries.
*   The length of `values` is not divisible by that of `times` (once sorted, filtered, and deduplicated).

The [width](struct.ChunkedUnevenCore.html#method.width "method bevy::prelude::cores::ChunkedUnevenCore::width") is implicitly taken to be the length of `values` divided by that of `times` (once sorted, filtered, and deduplicated).

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#611)

#### pub fn [domain](#method.domain)(&self) -> [Interval](../struct.Interval.html "struct bevy::prelude::Interval")
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#619)

#### pub fn [width](#method.width)(&self) -> [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)

The sample width: the number of values that are contained in each sample.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#630)

#### pub fn [sample\_interp](#method.sample_interp)(&self, t: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [InterpolationDatum](enum.InterpolationDatum.html "enum bevy::prelude::cores::InterpolationDatum")<&[\[T\]](https://doc.rust-lang.org/nightly/std/primitive.slice.html)\>

Given a time `t`, obtain a [`InterpolationDatum`](enum.InterpolationDatum.html "enum bevy::prelude::cores::InterpolationDatum") which governs how interpolation might recover a sample at time `t`. For example, when a [`Between`](enum.InterpolationDatum.html#variant.Between "variant bevy::prelude::cores::InterpolationDatum::Between") value is returned, its contents can be used to interpolate between the two contained values with the given parameter. The other variants give additional context about where the value is relative to the family of samples.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#638)

#### pub fn [sample\_interp\_timed](#method.sample_interp_timed)(&self, t: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [InterpolationDatum](enum.InterpolationDatum.html "enum bevy::prelude::cores::InterpolationDatum")<([f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), &[\[T\]](https://doc.rust-lang.org/nightly/std/primitive.slice.html))>

Like [`sample_interp`](struct.ChunkedUnevenCore.html#method.sample_interp "method bevy::prelude::cores::ChunkedUnevenCore::sample_interp"), but the returned values include the sample times. This can be useful when sample interpolation is not scale-invariant.

## Trait Implementations

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#465)

### impl<T> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>

where T: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#465)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>
...
### impl<T> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#466)

### impl<'de, T> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>
...
#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>, <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl<T> [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>

where [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>: [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"), T: [TypePath](../trait.TypePath.html "trait bevy::prelude::TypePath"), [Vec](../struct.Vec.html "struct bevy::prelude::Vec")<T>: [FromReflect](../trait.FromReflect.html "trait bevy::prelude::FromReflect") + [TypePath](../trait.TypePath.html "trait bevy::prelude::TypePath") + MaybeTyped + RegisterForReflection,

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#467)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#467)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T> as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#467)

### impl<T> [FromReflect](../trait.FromReflect.html "trait bevy::prelude::FromReflect") for [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>

where [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>: [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"), T: [TypePath](../trait.TypePath.html "trait bevy::prelude::TypePath"), [Vec](../struct.Vec.html "struct bevy::prelude::Vec")<T>: [FromReflect](../trait.FromReflect.html "trait bevy::prelude::FromReflect") + [TypePath](../trait.TypePath.html "trait bevy::prelude::TypePath") + MaybeTyped + RegisterForReflection,

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#467)

#### fn [from\_reflect](../trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>>
...
### impl<T> [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>
...
### impl<T> [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>
...
### impl<T> [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>
...
where [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>: 'into\_return,
...
### impl<T> [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>
...
#### fn [reflect\_owned](../trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#467)

#### fn [try\_into\_reflect](../trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../trait.PartialReflect.html#tymethod.into_partial_reflect)( self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>>, ) -> [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
### impl<T> [Reflect](../trait.Reflect.html "trait bevy::prelude::Reflect") for [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>

where [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>: [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"), T: [TypePath](../trait.TypePath.html "trait bevy::prelude::TypePath"), [Vec](../struct.Vec.html "struct bevy::prelude::Vec")<T>: [FromReflect](../trait.FromReflect.html "trait bevy::prelude::FromReflect") + [TypePath](../trait.TypePath.html "trait bevy::prelude::TypePath") + MaybeTyped + RegisterForReflection,

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#467)

#### fn [into\_any](../trait.Reflect.html#tymethod.into_any)(self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>>) -> [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../trait.Reflect.html#tymethod.into_reflect)(self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>>) -> [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<T> [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>
...
### impl<T> [Struct](../trait.Struct.html "trait bevy::prelude::Struct") for [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>
...
### impl<T> [TypePath](../trait.TypePath.html "trait bevy::prelude::TypePath") for [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>
...
### impl<T> [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>
...
### impl<T> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>

### impl<T> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>
...
### impl<T> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>

where T: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>

where T: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>

where T: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<T> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>

### impl<T> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ChunkedUnevenCore](struct.ChunkedUnevenCore.html "struct bevy::prelude::cores::ChunkedUnevenCore")<T>
