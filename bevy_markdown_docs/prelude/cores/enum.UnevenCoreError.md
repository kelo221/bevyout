...
# Enum UnevenCoreError 

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#345)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#343)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [UnevenCoreError](enum.UnevenCoreError.html "enum bevy::prelude::cores::UnevenCoreError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [UnevenCoreError](enum.UnevenCoreError.html "enum bevy::prelude::cores::UnevenCoreError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [UnevenCoreError](enum.UnevenCoreError.html "enum bevy::prelude::cores::UnevenCoreError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [UnevenCoreError](enum.UnevenCoreError.html "enum bevy::prelude::cores::UnevenCoreError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [UnevenCoreError](enum.UnevenCoreError.html "enum bevy::prelude::cores::UnevenCoreError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [UnevenCoreError](enum.UnevenCoreError.html "enum bevy::prelude::cores::UnevenCoreError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [UnevenCoreError](enum.UnevenCoreError.html "enum bevy::prelude::cores::UnevenCoreError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [UnevenCoreError](enum.UnevenCoreError.html "enum bevy::prelude::cores::UnevenCoreError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [UnevenCoreError](enum.UnevenCoreError.html "enum bevy::prelude::cores::UnevenCoreError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [UnevenCoreError](enum.UnevenCoreError.html "enum bevy::prelude::cores::UnevenCoreError")
