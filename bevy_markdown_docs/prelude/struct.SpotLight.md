...
Behaves like a point light in a perfectly absorbent housing that shines light only in a given direction. The direction is taken from the transform, and can be specified with [`Transform::looking_at`](struct.Transform.html#method.looking_at "method bevy::prelude::Transform::looking_at").

To control the resolution of the shadow maps, use the [`DirectionalLightShadowMap`](../light/struct.DirectionalLightShadowMap.html "struct bevy::light::DirectionalLightShadowMap") resource.
...
Soft shadows, also known as _percentage-closer soft shadows_ or PCSS, cause shadows to become blurrier (i.e. their penumbra increases in radius) as they extend away from objects. The blurriness of the shadow depends on the [`SpotLight::radius`](struct.SpotLight.html#structfield.radius "field bevy::prelude::SpotLight::radius") of the light; larger lights result in larger penumbras and therefore blurrier shadows.

Currently, soft shadows are rather noisy if not using the temporal mode. If you enable soft shadows, consider choosing [`ShadowFilteringMethod::Temporal`](../light/enum.ShadowFilteringMethod.html#variant.Temporal "variant bevy::light::ShadowFilteringMethod::Temporal") and enabling temporal antialiasing (TAA) to smooth the noise out over time.
...
### impl [SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")
...
The default value of [`SpotLight::shadow_depth_bias`](struct.SpotLight.html#structfield.shadow_depth_bias "field bevy::prelude::SpotLight::shadow_depth_bias").
...
The default value of [`SpotLight::shadow_normal_bias`](struct.SpotLight.html#structfield.shadow_normal_bias "field bevy::prelude::SpotLight::shadow_normal_bias").
...
The default value of [`SpotLight::shadow_map_near_z`](struct.SpotLight.html#structfield.shadow_map_near_z "field bevy::prelude::SpotLight::shadow_map_near_z").

## Trait Implementations

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/spot_light.rs.html#22)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/spot_light.rs.html#22)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")
...
### impl [Component](trait.Component.html "trait bevy::prelude::Component") for [SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")

where [SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

**Required Components**: [`Frustum`](../camera/primitives/struct.Frustum.html "struct bevy::camera::primitives::Frustum"), [`VisibleMeshEntities`](../camera/visibility/struct.VisibleMeshEntities.html "struct bevy::camera::visibility::VisibleMeshEntities"), [`Transform`](struct.Transform.html "struct bevy::prelude::Transform"), [`Visibility`](enum.Visibility.html "enum bevy::prelude::Visibility"), [`VisibilityClass`](../camera/visibility/struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass").
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/spot_light.rs.html#22)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/spot_light.rs.html#142)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/spot_light.rs.html#22)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/spot_light.rs.html#22)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/spot_light.rs.html#22)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")
...
where [SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight"): 'into\_return,
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/spot_light.rs.html#22)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SpotLight](struct.SpotLight.html "struct bevy::prelude::SpotLight")
