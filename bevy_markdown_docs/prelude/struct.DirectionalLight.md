...
Some of these are provided as constants in [`light_consts::lux`](light_consts/lux/index.html "mod bevy::prelude::light_consts::lux").
...
To modify the cascade setup, such as the number of cascades or the maximum shadow distance, change the [`CascadeShadowConfig`](../light/struct.CascadeShadowConfig.html "struct bevy::light::CascadeShadowConfig") component of the entity with the [`DirectionalLight`](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight").
...
### impl [DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")
...
The default value of [`DirectionalLight::shadow_depth_bias`](struct.DirectionalLight.html#structfield.shadow_depth_bias "field bevy::prelude::DirectionalLight::shadow_depth_bias").
...
The default value of [`DirectionalLight::shadow_normal_bias`](struct.DirectionalLight.html#structfield.shadow_normal_bias "field bevy::prelude::DirectionalLight::shadow_normal_bias").

## Trait Implementations

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/directional_light.rs.html#61)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/directional_light.rs.html#61)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")
...
### impl [Component](trait.Component.html "trait bevy::prelude::Component") for [DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")

where [DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

**Required Components**: [`Cascades`](../light/struct.Cascades.html "struct bevy::light::Cascades"), [`CascadesFrusta`](../camera/primitives/struct.CascadesFrusta.html "struct bevy::camera::primitives::CascadesFrusta"), [`CascadeShadowConfig`](../light/struct.CascadeShadowConfig.html "struct bevy::light::CascadeShadowConfig"), [`CascadesVisibleEntities`](../camera/visibility/struct.CascadesVisibleEntities.html "struct bevy::camera::visibility::CascadesVisibleEntities"), [`Transform`](struct.Transform.html "struct bevy::prelude::Transform"), [`Visibility`](enum.Visibility.html "enum bevy::prelude::Visibility"), [`VisibilityClass`](../camera/visibility/struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass").
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/directional_light.rs.html#61)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/directional_light.rs.html#148)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/directional_light.rs.html#61)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/directional_light.rs.html#61)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/directional_light.rs.html#61)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")
...
where [DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight"): 'into\_return,
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/directional_light.rs.html#61)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DirectionalLight](struct.DirectionalLight.html "struct bevy::prelude::DirectionalLight")
