...
This system parameter takes exclusive access to the [`Messages<T>`](struct.Messages.html "struct bevy::prelude::Messages") resource, so a system cannot also have a [`MessageReader`](struct.MessageReader.html "struct bevy::prelude::MessageReader") parameter of the same type. If you need to both read and write messages of the same type, use [`MessageMutator`](struct.MessageMutator.html "struct bevy::prelude::MessageMutator").

## Usage

`MessageWriter`s are usually declared as a [`SystemParam`](../ecs/system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam").
...
`MessageWriter` param has [`ResMut<Messages<T>>`](struct.Messages.html "struct bevy::prelude::Messages") inside. So two systems declaring `MessageWriter<T>` params for the same message type won’t be executed concurrently.
...
### impl<'w, M> [MessageWriter](struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'w, M>
...
### impl<'w, 's, M> [ReadOnlySystemParam](../ecs/system/trait.ReadOnlySystemParam.html "trait bevy::ecs::system::ReadOnlySystemParam") for [MessageWriter](struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'w, M>

where M: [Message](trait.Message.html "trait bevy::prelude::Message"), [ResMut](struct.ResMut.html "struct bevy::prelude::ResMut")<'w, [Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>>: [ReadOnlySystemParam](../ecs/system/trait.ReadOnlySystemParam.html "trait bevy::ecs::system::ReadOnlySystemParam"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/message_writer.rs.html#61)

### impl<M> [SystemParam](../ecs/system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam") for [MessageWriter](struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'\_, M>
...
#### type [Item](../ecs/system/trait.SystemParam.html#associatedtype.Item)<'w, 's> = [MessageWriter](struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'w, M>
...
#### unsafe fn [get\_param](../ecs/system/trait.SystemParam.html#tymethod.get_param)<'w, 's>( state: &'s mut <[MessageWriter](struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'\_, M> as [SystemParam](../ecs/system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](../ecs/system/trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State"), system\_meta: &[SystemMeta](../ecs/system/struct.SystemMeta.html "struct bevy::ecs::system::SystemMeta"), world: [UnsafeWorldCell](../ecs/world/unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'w>, change\_tick: [Tick](../ecs/change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[MessageWriter](struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'\_, M> as [SystemParam](../ecs/system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[Item](../ecs/system/trait.SystemParam.html#associatedtype.Item "type bevy::ecs::system::SystemParam::Item")<'w, 's>, [SystemParamValidationError](../ecs/system/struct.SystemParamValidationError.html "struct bevy::ecs::system::SystemParamValidationError")\>
...
### impl<'w, M> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MessageWriter](struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'w, M>

### impl<'w, M> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MessageWriter](struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'w, M>

### impl<'w, M> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MessageWriter](struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'w, M>
...
### impl<'w, M> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MessageWriter](struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'w, M>

### impl<'w, M> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MessageWriter](struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'w, M>

### impl<'w, M> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MessageWriter](struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'w, M>

### impl<'w, M> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MessageWriter](struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'w, M>
