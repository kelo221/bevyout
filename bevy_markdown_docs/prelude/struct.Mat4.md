...
This 4x4 matrix type features convenience methods for creating and using affine transforms and perspective projections. If you are primarily dealing with 3D affine transformations considering using [`Affine3A`](../math/struct.Affine3A.html "struct bevy::math::Affine3A") which is faster than a 4x4 matrix for some affine operations.

Affine transformations including 3D translation, rotation and scale can be created using methods such as [`Self::from_translation()`](struct.Mat4.html#method.from_translation "associated function bevy::prelude::Mat4::from_translation"), [`Self::from_quat()`](struct.Mat4.html#method.from_quat "associated function bevy::prelude::Mat4::from_quat"), [`Self::from_scale()`](struct.Mat4.html#method.from_scale "associated function bevy::prelude::Mat4::from_scale") and [`Self::from_scale_rotation_translation()`](struct.Mat4.html#method.from_scale_rotation_translation "associated function bevy::prelude::Mat4::from_scale_rotation_translation").

Orthographic projections can be created using the methods [`Self::orthographic_lh()`](struct.Mat4.html#method.orthographic_lh "associated function bevy::prelude::Mat4::orthographic_lh") for left-handed coordinate systems and [`Self::orthographic_rh()`](struct.Mat4.html#method.orthographic_rh "associated function bevy::prelude::Mat4::orthographic_rh") for right-handed systems. The resulting matrix is also an affine transformation.

The [`Self::transform_point3()`](struct.Mat4.html#method.transform_point3 "method bevy::prelude::Mat4::transform_point3") and [`Self::transform_vector3()`](struct.Mat4.html#method.transform_vector3 "method bevy::prelude::Mat4::transform_vector3") convenience methods are provided for performing affine transformations on 3D vectors and points. These multiply 3D inputs as 4D vectors with an implicit `w` value of `1` for points and `0` for vectors respectively. These methods assume that `Self` contains a valid affine transform.

Perspective projections can be created using methods such as [`Self::perspective_lh()`](struct.Mat4.html#method.perspective_lh "associated function bevy::prelude::Mat4::perspective_lh"), [`Self::perspective_infinite_lh()`](struct.Mat4.html#method.perspective_infinite_lh "associated function bevy::prelude::Mat4::perspective_infinite_lh") and [`Self::perspective_infinite_reverse_lh()`](struct.Mat4.html#method.perspective_infinite_reverse_lh "associated function bevy::prelude::Mat4::perspective_infinite_reverse_lh") for left-handed co-ordinate systems and [`Self::perspective_rh()`](struct.Mat4.html#method.perspective_rh "associated function bevy::prelude::Mat4::perspective_rh"), [`Self::perspective_infinite_rh()`](struct.Mat4.html#method.perspective_infinite_rh "associated function bevy::prelude::Mat4::perspective_infinite_rh") and [`Self::perspective_infinite_reverse_rh()`](struct.Mat4.html#method.perspective_infinite_reverse_rh "associated function bevy::prelude::Mat4::perspective_infinite_reverse_rh") for right-handed co-ordinate systems.

The resulting perspective project can be use to transform 3D vectors as points with perspective correction using the [`Self::project_point3()`](struct.Mat4.html#method.project_point3 "method bevy::prelude::Mat4::project_point3") convenience method.

## Fields

`x_axis: [Vec4](struct.Vec4.html "struct bevy::prelude::Vec4")``y_axis: [Vec4](struct.Vec4.html "struct bevy::prelude::Vec4")``z_axis: [Vec4](struct.Vec4.html "struct bevy::prelude::Vec4")``w_axis: [Vec4](struct.Vec4.html "struct bevy::prelude::Vec4")`

## Implementations

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#72)

### impl [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#74)

#### pub const [ZERO](#associatedconstant.ZERO): [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub const [IDENTITY](#associatedconstant.IDENTITY): [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub const [NAN](#associatedconstant.NAN): [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

All NAN:s.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#114)

#### pub const fn [from\_cols](#method.from_cols)( x\_axis: [Vec4](struct.Vec4.html "struct bevy::prelude::Vec4"), y\_axis: [Vec4](struct.Vec4.html "struct bevy::prelude::Vec4"), z\_axis: [Vec4](struct.Vec4.html "struct bevy::prelude::Vec4"), w\_axis: [Vec4](struct.Vec4.html "struct bevy::prelude::Vec4"), ) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

Creates a 4x4 matrix from four column vectors.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#128)

#### pub const fn [from\_cols\_array](#method.from_cols_array)(m: &\[[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html); [16](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub const fn [from\_cols\_array\_2d](#method.from_cols_array_2d)(m: &\[\[[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html); [4](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]; [4](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub const fn [from\_diagonal](#method.from_diagonal)(diagonal: [Vec4](struct.Vec4.html "struct bevy::prelude::Vec4")) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

Creates a 4x4 matrix with its diagonal set to `diagonal` and all other entries set to 0.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#226)

#### pub fn [from\_scale\_rotation\_translation](#method.from_scale_rotation_translation)( scale: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3"), rotation: [Quat](struct.Quat.html "struct bevy::prelude::Quat"), translation: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3"), ) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

Creates an affine transformation matrix from the given 3D `scale`, `rotation` and `translation`.

The resulting matrix can be used to transform 3D points and vectors. See [`Self::transform_point3()`](struct.Mat4.html#method.transform_point3 "method bevy::prelude::Mat4::transform_point3") and [`Self::transform_vector3()`](struct.Mat4.html#method.transform_vector3 "method bevy::prelude::Mat4::transform_vector3").
...
#### pub fn [from\_rotation\_translation](#method.from_rotation_translation)(rotation: [Quat](struct.Quat.html "struct bevy::prelude::Quat"), translation: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [from\_quat](#method.from_quat)(rotation: [Quat](struct.Quat.html "struct bevy::prelude::Quat")) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [from\_mat3](#method.from_mat3)(m: [Mat3](struct.Mat3.html "struct bevy::prelude::Mat3")) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [from\_mat3\_translation](#method.from_mat3_translation)(mat3: [Mat3](struct.Mat3.html "struct bevy::prelude::Mat3"), translation: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [from\_mat3a](#method.from_mat3a)(m: [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [from\_translation](#method.from_translation)(translation: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [from\_axis\_angle](#method.from_axis_angle)(axis: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3"), angle: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [from\_euler](#method.from_euler)(order: [EulerRot](enum.EulerRot.html "enum bevy::prelude::EulerRot"), a: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), b: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), c: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [from\_rotation\_x](#method.from_rotation_x)(angle: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [from\_rotation\_y](#method.from_rotation_y)(angle: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [from\_rotation\_z](#method.from_rotation_z)(angle: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [from\_scale](#method.from_scale)(scale: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub const fn [from\_cols\_slice](#method.from_cols_slice)(slice: &\[[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\]) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [col](#method.col)(&self, index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [Vec4](struct.Vec4.html "struct bevy::prelude::Vec4")
...
#### pub fn [col\_mut](#method.col_mut)(&mut self, index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> &mut [Vec4](struct.Vec4.html "struct bevy::prelude::Vec4")
...
#### pub fn [row](#method.row)(&self, index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [Vec4](struct.Vec4.html "struct bevy::prelude::Vec4")
...
#### pub fn [transpose](#method.transpose)(&self) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

Returns the transpose of `self`.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#640)

#### pub fn [diagonal](#method.diagonal)(&self) -> [Vec4](struct.Vec4.html "struct bevy::prelude::Vec4")
...
#### pub fn [inverse](#method.inverse)(&self) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [try\_inverse](#method.try_inverse)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\>
...
#### pub fn [inverse\_or\_zero](#method.inverse_or_zero)(&self) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [look\_to\_lh](#method.look_to_lh)(eye: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3"), dir: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3"), up: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [look\_to\_rh](#method.look_to_rh)(eye: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3"), dir: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3"), up: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [look\_at\_lh](#method.look_at_lh)(eye: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3"), center: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3"), up: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [look\_at\_rh](#method.look_at_rh)(eye: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3"), center: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3"), up: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [frustum\_rh\_gl](#method.frustum_rh_gl)( left: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), right: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), bottom: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), top: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), z\_near: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), z\_far: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [frustum\_lh](#method.frustum_lh)( left: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), right: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), bottom: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), top: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), z\_near: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), z\_far: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [frustum\_rh](#method.frustum_rh)( left: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), right: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), bottom: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), top: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), z\_near: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), z\_far: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [perspective\_rh\_gl](#method.perspective_rh_gl)( fov\_y\_radians: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), aspect\_ratio: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), z\_near: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), z\_far: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [perspective\_lh](#method.perspective_lh)( fov\_y\_radians: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), aspect\_ratio: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), z\_near: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), z\_far: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [perspective\_rh](#method.perspective_rh)( fov\_y\_radians: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), aspect\_ratio: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), z\_near: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), z\_far: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [perspective\_infinite\_lh](#method.perspective_infinite_lh)( fov\_y\_radians: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), aspect\_ratio: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), z\_near: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [perspective\_infinite\_reverse\_lh](#method.perspective_infinite_reverse_lh)( fov\_y\_radians: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), aspect\_ratio: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), z\_near: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [perspective\_infinite\_rh](#method.perspective_infinite_rh)( fov\_y\_radians: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), aspect\_ratio: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), z\_near: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [perspective\_infinite\_reverse\_rh](#method.perspective_infinite_reverse_rh)( fov\_y\_radians: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), aspect\_ratio: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), z\_near: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [project\_point3](#method.project_point3)(&self, rhs: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")) -> [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")
...
#### pub fn [transform\_point3](#method.transform_point3)(&self, rhs: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")) -> [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")

Transforms the given 3D vector as a point.

This is the equivalent of multiplying the 3D vector as a 4D vector where `w` is `1.0`.

This method assumes that `self` contains a valid affine transform. It does not perform a perspective divide, if `self` contains a perspective transform, or if you are unsure, the [`Self::project_point3()`](struct.Mat4.html#method.project_point3 "method bevy::prelude::Mat4::project_point3") method should be used instead.
...
#### pub fn [transform\_vector3](#method.transform_vector3)(&self, rhs: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")) -> [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")
...
#### pub fn [project\_point3a](#method.project_point3a)(&self, rhs: [Vec3A](struct.Vec3A.html "struct bevy::prelude::Vec3A")) -> [Vec3A](struct.Vec3A.html "struct bevy::prelude::Vec3A")

Transforms the given [`Vec3A`](struct.Vec3A.html "struct bevy::prelude::Vec3A") as a 3D point, applying perspective correction.

This is the equivalent of multiplying the [`Vec3A`](struct.Vec3A.html "struct bevy::prelude::Vec3A") as a 4D vector where `w` is `1.0`. The perspective divide is performed meaning the resulting 3D vector is divided by `w`.

This method assumes that `self` contains a projective transform.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1383)

#### pub fn [transform\_point3a](#method.transform_point3a)(&self, rhs: [Vec3A](struct.Vec3A.html "struct bevy::prelude::Vec3A")) -> [Vec3A](struct.Vec3A.html "struct bevy::prelude::Vec3A")

Transforms the given [`Vec3A`](struct.Vec3A.html "struct bevy::prelude::Vec3A") as 3D point.

This is the equivalent of multiplying the [`Vec3A`](struct.Vec3A.html "struct bevy::prelude::Vec3A") as a 4D vector where `w` is `1.0`.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1397)

#### pub fn [transform\_vector3a](#method.transform_vector3a)(&self, rhs: [Vec3A](struct.Vec3A.html "struct bevy::prelude::Vec3A")) -> [Vec3A](struct.Vec3A.html "struct bevy::prelude::Vec3A")

Transforms the give [`Vec3A`](struct.Vec3A.html "struct bevy::prelude::Vec3A") as 3D vector.

This is the equivalent of multiplying the [`Vec3A`](struct.Vec3A.html "struct bevy::prelude::Vec3A") as a 4D vector where `w` is `0.0`.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1408)

#### pub fn [mul\_vec4](#method.mul_vec4)(&self, rhs: [Vec4](struct.Vec4.html "struct bevy::prelude::Vec4")) -> [Vec4](struct.Vec4.html "struct bevy::prelude::Vec4")

Transforms a 4D vector.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1419)

#### pub fn [mul\_transpose\_vec4](#method.mul_transpose_vec4)(&self, rhs: [Vec4](struct.Vec4.html "struct bevy::prelude::Vec4")) -> [Vec4](struct.Vec4.html "struct bevy::prelude::Vec4")
...
#### pub fn [mul\_mat4](#method.mul_mat4)(&self, rhs: &[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

Multiplies two 4x4 matrices.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1438)

#### pub fn [add\_mat4](#method.add_mat4)(&self, rhs: &[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

Adds two 4x4 matrices.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1445)

#### pub fn [sub\_mat4](#method.sub_mat4)(&self, rhs: &[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

Subtracts two 4x4 matrices.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1452)

#### pub fn [mul\_scalar](#method.mul_scalar)(&self, rhs: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

Multiplies a 4x4 matrix by a scalar.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1466)

#### pub fn [mul\_diagonal\_scale](#method.mul_diagonal_scale)(&self, scale: [Vec4](struct.Vec4.html "struct bevy::prelude::Vec4")) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [div\_scalar](#method.div_scalar)(&self, rhs: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [recip](#method.recip)(&self) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### pub fn [abs\_diff\_eq](#method.abs_diff_eq)(&self, rhs: [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4"), max\_abs\_diff: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
#### pub fn [abs](#method.abs)(&self) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

Takes the absolute value of each element in `self`

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1531)

#### pub fn [as\_dmat4](#method.as_dmat4)(&self) -> [DMat4](../math/struct.DMat4.html "struct bevy::math::DMat4")

## Trait Implementations

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1548)

### impl [Add](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Add.html "trait core::ops::arith::Add") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1549)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Add.html#associatedtype.Output) = [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

The resulting type after applying the `+` operator.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1551)

#### fn [add](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Add.html#tymethod.add)(self, rhs: [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [Add](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Add.html "trait core::ops::arith::Add")<&[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\> for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [AddAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.AddAssign.html "trait core::ops::arith::AddAssign") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1587)

#### fn [add\_assign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.AddAssign.html#tymethod.add_assign)(&mut self, rhs: [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4"))
...
### impl [AddAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.AddAssign.html "trait core::ops::arith::AddAssign")<&[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\> for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [AsMut](https://doc.rust-lang.org/nightly/core/convert/trait.AsMut.html "trait core::convert::AsMut")<\[[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html); [16](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]> for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [AsMutMatrixParts](../render/render_resource/encase/matrix/trait.AsMutMatrixParts.html "trait bevy::render::render_resource::encase::matrix::AsMutMatrixParts")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), 4, 4> for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

where [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4"): [AsMut](https://doc.rust-lang.org/nightly/core/convert/trait.AsMut.html "trait core::convert::AsMut")<\[[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html); [16](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]>, [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html): [MatrixScalar](../render/render_resource/encase/matrix/trait.MatrixScalar.html "trait bevy::render::render_resource::encase::matrix::MatrixScalar"),
...
### impl [AsRef](https://doc.rust-lang.org/nightly/core/convert/trait.AsRef.html "trait core::convert::AsRef")<\[[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html); [16](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]> for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [AsRefMatrixParts](../render/render_resource/encase/matrix/trait.AsRefMatrixParts.html "trait bevy::render::render_resource::encase::matrix::AsRefMatrixParts")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), 4, 4> for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

where [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4"): [AsRef](https://doc.rust-lang.org/nightly/core/convert/trait.AsRef.html "trait core::convert::AsRef")<\[[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html); [16](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]>, [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html): [MatrixScalar](../render/render_resource/encase/matrix/trait.MatrixScalar.html "trait bevy::render::render_resource::encase::matrix::MatrixScalar"),
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#58)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/features/impl_encase.rs.html#61)

### impl [CreateFrom](../render/render_resource/encase/internal/trait.CreateFrom.html "trait bevy::render::render_resource::encase::internal::CreateFrom") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

where [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4"): [ShaderType](../render/render_resource/trait.ShaderType.html "trait bevy::render::render_resource::ShaderType")<ExtraMetadata = MatrixMetadata> + [FromMatrixParts](../render/render_resource/encase/matrix/trait.FromMatrixParts.html "trait bevy::render::render_resource::encase::matrix::FromMatrixParts")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), 4, 4>, [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html): [MatrixScalar](../render/render_resource/encase/matrix/trait.MatrixScalar.html "trait bevy::render::render_resource::encase::matrix::MatrixScalar") + [CreateFrom](../render/render_resource/encase/internal/trait.CreateFrom.html "trait bevy::render::render_resource::encase::internal::CreateFrom"),

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/features/impl_encase.rs.html#61)

#### fn [create\_from](../render/render_resource/encase/internal/trait.CreateFrom.html#tymethod.create_from)<B>(reader: &mut [Reader](../render/render_resource/encase/internal/struct.Reader.html "struct bevy::render::render_resource::encase::internal::Reader")<B>) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1543)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

Deserialize expects a sequence of 16 values.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/features/impl_serde.rs.html#1058)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<D>( deserializer: D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4"), <D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [Div](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Div.html "trait core::ops::arith::Div")<&[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\> for [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1846)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Div.html#associatedtype.Output) = [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

The resulting type after applying the `/` operator.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1848)

#### fn [div](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Div.html#tymethod.div)(self, rhs: &[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [Div](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Div.html "trait core::ops::arith::Div")<&[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\> for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### fn [div](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Div.html#tymethod.div)(self, rhs: &[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### fn [div](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Div.html#tymethod.div)(self, rhs: [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")) -> <[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html) as [Div](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Div.html "trait core::ops::arith::Div")<[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\>>::[Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Div.html#associatedtype.Output "type core::ops::arith::Div::Output")
...
### impl [DivAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.DivAssign.html "trait core::ops::arith::DivAssign")<&[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\> for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Affine3](../math/struct.Affine3.html "struct bevy::math::Affine3")\> for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/affine3.rs.html#660)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(m: [Affine3](../math/struct.Affine3.html "struct bevy::math::Affine3")) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

Converts to this type from the input type.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/affine3a.rs.html#691)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Affine3A](../math/struct.Affine3A.html "struct bevy::math::Affine3A")\> for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/affine3a.rs.html#693)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(m: [Affine3A](../math/struct.Affine3A.html "struct bevy::math::Affine3A")) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/impls/glam.rs.html#369-378)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/impls/glam.rs.html#369-378)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/features/impl_encase.rs.html#57)

### impl [FromMatrixParts](../render/render_resource/encase/matrix/trait.FromMatrixParts.html "trait bevy::render::render_resource::encase::matrix::FromMatrixParts")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), 4, 4> for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/features/impl_encase.rs.html#57)

#### fn [from\_parts](../render/render_resource/encase/matrix/trait.FromMatrixParts.html#tymethod.from_parts)(parts: \[\[[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html); [4](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]; [4](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
where [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4"): 'into\_return,
...
### impl [Mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html "trait core::ops::arith::Mul") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1672)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html#associatedtype.Output) = [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

The resulting type after applying the `*` operator.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1674)

#### fn [mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html#tymethod.mul)(self, rhs: [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [Mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html "trait core::ops::arith::Mul")<&[Affine3](../math/struct.Affine3.html "struct bevy::math::Affine3")\> for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### fn [mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html#tymethod.mul)(self, rhs: &[Affine3](../math/struct.Affine3.html "struct bevy::math::Affine3")) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [Mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html "trait core::ops::arith::Mul")<&[Affine3A](../math/struct.Affine3A.html "struct bevy::math::Affine3A")\> for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### fn [mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html#tymethod.mul)(self, rhs: &[Affine3A](../math/struct.Affine3A.html "struct bevy::math::Affine3A")) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [Mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html "trait core::ops::arith::Mul")<&[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\> for [Affine3](../math/struct.Affine3.html "struct bevy::math::Affine3")
...
### impl [Mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html "trait core::ops::arith::Mul")<&[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\> for [Affine3A](../math/struct.Affine3A.html "struct bevy::math::Affine3A")
...
### impl [Mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html "trait core::ops::arith::Mul")<&[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\> for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [Mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html "trait core::ops::arith::Mul")<&[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\> for [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)
...
### impl [Mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html "trait core::ops::arith::Mul")<&[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\> for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### fn [mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html#tymethod.mul)(self, rhs: &[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### fn [mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html#tymethod.mul)(self, rhs: [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")) -> <[Affine3](../math/struct.Affine3.html "struct bevy::math::Affine3") as [Mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html "trait core::ops::arith::Mul")<[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\>>::[Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html#associatedtype.Output "type core::ops::arith::Mul::Output")
...
#### fn [mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html#tymethod.mul)(self, rhs: [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")) -> <[Affine3A](../math/struct.Affine3A.html "struct bevy::math::Affine3A") as [Mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html "trait core::ops::arith::Mul")<[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\>>::[Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html#associatedtype.Output "type core::ops::arith::Mul::Output")
...
#### fn [mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html#tymethod.mul)(self, rhs: [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")) -> <[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html) as [Mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html "trait core::ops::arith::Mul")<[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\>>::[Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html#associatedtype.Output "type core::ops::arith::Mul::Output")
...
### impl [MulAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.MulAssign.html "trait core::ops::arith::MulAssign") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1710)

#### fn [mul\_assign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.MulAssign.html#tymethod.mul_assign)(&mut self, rhs: [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4"))
...
### impl [MulAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.MulAssign.html "trait core::ops::arith::MulAssign")<&[Affine3](../math/struct.Affine3.html "struct bevy::math::Affine3")\> for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/affine3.rs.html#653)

#### fn [mul\_assign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.MulAssign.html#tymethod.mul_assign)(&mut self, rhs: &[Affine3](../math/struct.Affine3.html "struct bevy::math::Affine3"))

Performs the `*=` operation. [Read more](https://doc.rust-lang.org/nightly/core/ops/arith/trait.MulAssign.html#tymethod.mul_assign)

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/affine3a.rs.html#684)

### impl [MulAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.MulAssign.html "trait core::ops::arith::MulAssign")<&[Affine3A](../math/struct.Affine3A.html "struct bevy::math::Affine3A")\> for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/affine3a.rs.html#686)

#### fn [mul\_assign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.MulAssign.html#tymethod.mul_assign)(&mut self, rhs: &[Affine3A](../math/struct.Affine3A.html "struct bevy::math::Affine3A"))

Performs the `*=` operation. [Read more](https://doc.rust-lang.org/nightly/core/ops/arith/trait.MulAssign.html#tymethod.mul_assign)

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1715)

### impl [MulAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.MulAssign.html "trait core::ops::arith::MulAssign")<&[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\> for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [MulAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.MulAssign.html "trait core::ops::arith::MulAssign")<&[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\> for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [Neg](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Neg.html "trait core::ops::arith::Neg") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1651)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Neg.html#associatedtype.Output) = [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

The resulting type after applying the `-` operator.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1653)

#### fn [neg](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Neg.html#tymethod.neg)(self) -> <[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4") as [Neg](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Neg.html "trait core::ops::arith::Neg")\>::[Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Neg.html#associatedtype.Output "type core::ops::arith::Neg::Output")
...
#### fn [neg](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Neg.html#tymethod.neg)(self) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

Performs the unary `-` operation. [Read more](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Neg.html#tymethod.neg)

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1951)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1953)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, rhs: &[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/impls/glam.rs.html#369-378)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
### impl [Pod](https://docs.rs/bytemuck/1.25.0/x86_64-unknown-linux-gnu/bytemuck/pod/trait.Pod.html "trait bytemuck::pod::Pod") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1933)

### impl [Product](https://doc.rust-lang.org/nightly/core/iter/traits/accum/trait.Product.html "trait core::iter::traits::accum::Product") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1934-1936)

#### fn [product](https://doc.rust-lang.org/nightly/core/iter/traits/accum/trait.Product.html#tymethod.product)<I>(iter: I) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

where I: [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\>,

Takes an iterator and generates `Self` from the elements by multiplying the items.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1942)

### impl<'a> [Product](https://doc.rust-lang.org/nightly/core/iter/traits/accum/trait.Product.html "trait core::iter::traits::accum::Product")<&'a [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\> for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1943-1945)

#### fn [product](https://doc.rust-lang.org/nightly/core/iter/traits/accum/trait.Product.html#tymethod.product)<I>(iter: I) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

where I: [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = &'a [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\>,

Takes an iterator and generates `Self` from the elements by multiplying the items.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/features/impl_encase.rs.html#61)

### impl [ReadFrom](../render/render_resource/encase/internal/trait.ReadFrom.html "trait bevy::render::render_resource::encase::internal::ReadFrom") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

where [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4"): [ShaderType](../render/render_resource/trait.ShaderType.html "trait bevy::render::render_resource::ShaderType")<ExtraMetadata = MatrixMetadata> + [AsMutMatrixParts](../render/render_resource/encase/matrix/trait.AsMutMatrixParts.html "trait bevy::render::render_resource::encase::matrix::AsMutMatrixParts")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), 4, 4>, [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html): [MatrixScalar](../render/render_resource/encase/matrix/trait.MatrixScalar.html "trait bevy::render::render_resource::encase::matrix::MatrixScalar") + [ReadFrom](../render/render_resource/encase/internal/trait.ReadFrom.html "trait bevy::render::render_resource::encase::internal::ReadFrom"),
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [ShaderSize](../render/render_resource/trait.ShaderSize.html "trait bevy::render::render_resource::ShaderSize") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [ShaderType](../render/render_resource/trait.ShaderType.html "trait bevy::render::render_resource::ShaderType") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [Sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html "trait core::ops::arith::Sub") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1600)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#associatedtype.Output) = [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

The resulting type after applying the `-` operator.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1602)

#### fn [sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#tymethod.sub)(self, rhs: [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [Sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html "trait core::ops::arith::Sub")<&[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\> for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [SubAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html "trait core::ops::arith::SubAssign") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1638)

#### fn [sub\_assign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html#tymethod.sub_assign)(&mut self, rhs: [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4"))
...
### impl [SubAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html "trait core::ops::arith::SubAssign")<&[Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\> for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [Sum](https://doc.rust-lang.org/nightly/core/iter/traits/accum/trait.Sum.html "trait core::iter::traits::accum::Sum") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat4.rs.html#1916-1918)

#### fn [sum](https://doc.rust-lang.org/nightly/core/iter/traits/accum/trait.Sum.html#tymethod.sum)<I>(iter: I) -> [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl<'a> [Sum](https://doc.rust-lang.org/nightly/core/iter/traits/accum/trait.Sum.html "trait core::iter::traits::accum::Sum")<&'a [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")\> for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [TransformPoint](trait.TransformPoint.html "trait bevy::prelude::TransformPoint") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [WriteInto](../render/render_resource/encase/internal/trait.WriteInto.html "trait bevy::render::render_resource::encase::internal::WriteInto") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

where [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4"): [ShaderType](../render/render_resource/trait.ShaderType.html "trait bevy::render::render_resource::ShaderType")<ExtraMetadata = MatrixMetadata> + [AsRefMatrixParts](../render/render_resource/encase/matrix/trait.AsRefMatrixParts.html "trait bevy::render::render_resource::encase::matrix::AsRefMatrixParts")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), 4, 4>, [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html): [MatrixScalar](../render/render_resource/encase/matrix/trait.MatrixScalar.html "trait bevy::render::render_resource::encase::matrix::MatrixScalar") + [WriteInto](../render/render_resource/encase/internal/trait.WriteInto.html "trait bevy::render::render_resource::encase::internal::WriteInto"),
...
### impl [Zeroable](https://docs.rs/bytemuck/1.25.0/x86_64-unknown-linux-gnu/bytemuck/zeroable/trait.Zeroable.html "trait bytemuck::zeroable::Zeroable") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")
