...
# Struct NonPathHandleError 

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/graph.rs.html#845)
...
[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/graph.rs.html#843)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [NonPathHandleError](struct.NonPathHandleError.html "struct bevy::prelude::NonPathHandleError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [NonPathHandleError](struct.NonPathHandleError.html "struct bevy::prelude::NonPathHandleError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [NonPathHandleError](struct.NonPathHandleError.html "struct bevy::prelude::NonPathHandleError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [NonPathHandleError](struct.NonPathHandleError.html "struct bevy::prelude::NonPathHandleError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [NonPathHandleError](struct.NonPathHandleError.html "struct bevy::prelude::NonPathHandleError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [NonPathHandleError](struct.NonPathHandleError.html "struct bevy::prelude::NonPathHandleError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [NonPathHandleError](struct.NonPathHandleError.html "struct bevy::prelude::NonPathHandleError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [NonPathHandleError](struct.NonPathHandleError.html "struct bevy::prelude::NonPathHandleError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [NonPathHandleError](struct.NonPathHandleError.html "struct bevy::prelude::NonPathHandleError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [NonPathHandleError](struct.NonPathHandleError.html "struct bevy::prelude::NonPathHandleError")
