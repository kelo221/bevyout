...
This trait is used to allow implementors of [`States`](trait.States.html "trait bevy::prelude::States"), as well as tuples containing exclusively implementors of [`States`](trait.States.html "trait bevy::prelude::States"), to be used as [`ComputedStates::SourceStates`](trait.ComputedStates.html#associatedtype.SourceStates "associated type bevy::prelude::ComputedStates::SourceStates").

It is sealed, and auto implemented for all [`States`](trait.States.html "trait bevy::prelude::States") types and tuples containing them.
...
The total [`DEPENDENCY_DEPTH`](trait.States.html#associatedconstant.DEPENDENCY_DEPTH "associated constant bevy::prelude::States::DEPENDENCY_DEPTH") of all the states that are part of this [`StateSet`](trait.StateSet.html "trait bevy::prelude::StateSet"), added together.
...
#### fn [register\_computed\_state\_systems\_in\_schedule](#tymethod.register_computed_state_systems_in_schedule)<T>(schedule: &mut [Schedule](struct.Schedule.html "struct bevy::prelude::Schedule"))

where T: [ComputedStates](trait.ComputedStates.html "trait bevy::prelude::ComputedStates")<SourceStates = Self>,
...
#### fn [register\_sub\_state\_systems\_in\_schedule](#tymethod.register_sub_state_systems_in_schedule)<T>(schedule: &mut [Schedule](struct.Schedule.html "struct bevy::prelude::Schedule"))

where T: [SubStates](trait.SubStates.html "trait bevy::prelude::SubStates")<SourceStates = Self>,
...
### impl<S> [StateSet](trait.StateSet.html "trait bevy::prelude::StateSet") for [(S₁, S₂, …, Sₙ)](https://doc.rust-lang.org/nightly/std/primitive.tuple.html#trait-implementations-1)
...
where T: [ComputedStates](trait.ComputedStates.html "trait bevy::prelude::ComputedStates")<SourceStates = [(S,)](https://doc.rust-lang.org/nightly/std/primitive.tuple.html)\>,

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state/state_set.rs.html#384-392)

#### fn [register\_sub\_state\_systems\_in\_schedule](#tymethod.register_sub_state_systems_in_schedule)<T>(schedule: &mut [Schedule](struct.Schedule.html "struct bevy::prelude::Schedule"))

where T: [SubStates](trait.SubStates.html "trait bevy::prelude::SubStates")<SourceStates = [(S,)](https://doc.rust-lang.org/nightly/std/primitive.tuple.html)\>,

## Implementors

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state/state_set.rs.html#91)

### impl<S> [StateSet](trait.StateSet.html "trait bevy::prelude::StateSet") for S
