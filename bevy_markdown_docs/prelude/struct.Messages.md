...
Each message can be consumed by multiple systems, in parallel, with consumption tracked by the [`MessageReader`](struct.MessageReader.html "struct bevy::prelude::MessageReader") on a per-system basis.
...
This collection is meant to be paired with a system that calls [`Messages::update`](struct.Messages.html#method.update "method bevy::prelude::Messages::update") exactly once per update/frame.

[`message_update_system`](../ecs/message/fn.message_update_system.html "fn bevy::ecs::message::message_update_system") is a system that does this, typically initialized automatically using [`add_message`](https://docs.rs/bevy/*/bevy/app/struct.App.html#method.add_message). [`MessageReader`](struct.MessageReader.html "struct bevy::prelude::MessageReader")s are expected to read messages from this collection at least once per loop/frame. Messages will persist across a single frame boundary and so ordering of message producers and consumers is not critical (although poorly-planned ordering may cause accumulating lag). If messages are not handled by the end of the frame after they are updated, they will be dropped silently.
...
[`Messages`](struct.Messages.html "struct bevy::prelude::Messages") is implemented using a variation of a double buffer strategy. Each call to [`update`](struct.Messages.html#method.update "method bevy::prelude::Messages::update") swaps buffers and clears out the oldest one.

*   [`MessageReader`](struct.MessageReader.html "struct bevy::prelude::MessageReader")s will read messages from both buffers.
*   [`MessageReader`](struct.MessageReader.html "struct bevy::prelude::MessageReader")s that read at least once per update will never drop messages.
*   [`MessageReader`](struct.MessageReader.html "struct bevy::prelude::MessageReader")s that read once within two updates might still receive some messages
*   [`MessageReader`](struct.MessageReader.html "struct bevy::prelude::MessageReader")s that read after two updates are guaranteed to drop all messages that occurred before those updates.

The buffers in [`Messages`](struct.Messages.html "struct bevy::prelude::Messages") will grow indefinitely if [`update`](struct.Messages.html#method.update "method bevy::prelude::Messages::update") is never called.

An alternative call pattern would be to call [`update`](struct.Messages.html#method.update "method bevy::prelude::Messages::update") manually across frames to control when messages are cleared. This complicates consumption and risks ever-expanding memory usage if not cleaned up, but can be done by adding your message as a resource instead of using [`add_message`](https://docs.rs/bevy/*/bevy/app/struct.App.html#method.add_message).
...
### impl<M> [Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>
...
#### pub fn [write](#method.write)(&mut self, message: M) -> [MessageId](../ecs/message/struct.MessageId.html "struct bevy::ecs::message::MessageId")<M>

Writes an `message` to the current message buffer. [`MessageReader`](struct.MessageReader.html "struct bevy::prelude::MessageReader")s can then read the message. This method returns the [ID](../ecs/message/struct.MessageId.html "struct bevy::ecs::message::MessageId") of the written `message`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#153)

#### pub fn [write\_batch](#method.write_batch)( &mut self, messages: impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = M>, ) -> [WriteBatchIds](../ecs/message/struct.WriteBatchIds.html "struct bevy::ecs::message::WriteBatchIds")<M> [ⓘ](#)

Writes a list of `messages` all at once, which can later be read by [`MessageReader`](struct.MessageReader.html "struct bevy::prelude::MessageReader")s. This is more efficient than writing each message individually. This method returns the [IDs](../ecs/message/struct.MessageId.html "struct bevy::ecs::message::MessageId") of the written `messages`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#168-170)

#### pub fn [write\_default](#method.write_default)(&mut self) -> [MessageId](../ecs/message/struct.MessageId.html "struct bevy::ecs::message::MessageId")<M>

where M: [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default"),

Writes the default value of the message. Useful when the message is an empty struct. This method returns the [ID](../ecs/message/struct.MessageId.html "struct bevy::ecs::message::MessageId") of the written `message`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#176)

#### pub fn [get\_cursor](#method.get_cursor)(&self) -> [MessageCursor](../ecs/message/struct.MessageCursor.html "struct bevy::ecs::message::MessageCursor")<M>

Gets a new [`MessageCursor`](../ecs/message/struct.MessageCursor.html "struct bevy::ecs::message::MessageCursor"). This will include all messages already in the message buffers.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#182)

#### pub fn [get\_cursor\_current](#method.get_cursor_current)(&self) -> [MessageCursor](../ecs/message/struct.MessageCursor.html "struct bevy::ecs::message::MessageCursor")<M>

Gets a new [`MessageCursor`](../ecs/message/struct.MessageCursor.html "struct bevy::ecs::message::MessageCursor"). This will ignore all messages already in the message buffers. It will read all future messages.
...
If you need access to the messages that were removed, consider using [`Messages::update_drain`](struct.Messages.html#method.update_drain "method bevy::prelude::Messages::update_drain").
...
If you do not need to take ownership of the removed messages, use [`Messages::update`](struct.Messages.html#method.update "method bevy::prelude::Messages::update") instead.
...
### impl<M> [Component](trait.Component.html "trait bevy::prelude::Component") for [Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>
...
### impl<M> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>

where M: [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") + [Message](trait.Message.html "trait bevy::prelude::Message"),
...
### impl<M> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>

where M: [Message](trait.Message.html "trait bevy::prelude::Message"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#106)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>
...
### impl<M> [Extend](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.Extend.html "trait core::iter::traits::collect::Extend")<M> for [Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>
...
### impl<M> [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>
...
#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#94)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Messages](struct.Messages.html "struct bevy::prelude::Messages")<M> as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>>
...
### impl<M> [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>
...
### impl<M> [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>
...
### impl<M> [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>
...
where [Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>: 'into\_return,
...
### impl<M> [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#94)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<M> [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>
...
### impl<M> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>

### impl<M> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>
...
### impl<M> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>

### impl<M> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>

### impl<M> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>

where M: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<M> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>

### impl<M> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Messages](struct.Messages.html "struct bevy::prelude::Messages")<M>
