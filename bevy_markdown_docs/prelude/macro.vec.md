...
*   Create a [`Vec`](struct.Vec.html "struct bevy::prelude::Vec") containing a given list of elements:
...
*   Create a [`Vec`](struct.Vec.html "struct bevy::prelude::Vec") from a given element and size:
