...
When working with color spaces that do not have native saturation components the operations are performed in [`Hsla`](struct.Hsla.html "struct bevy::prelude::Hsla").
