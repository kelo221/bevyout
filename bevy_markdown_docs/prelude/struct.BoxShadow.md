...
Draw order is determined implicitly from the vector of [`ShadowStyle`](struct.ShadowStyle.html "struct bevy::prelude::ShadowStyle")s, back-to-front.

## Tuple Fields

`0: [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[ShadowStyle](struct.ShadowStyle.html "struct bevy::prelude::ShadowStyle")>`

## Implementations

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#2843)

### impl [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#2845-2851)

#### pub fn [new](#method.new)( color: [Color](enum.Color.html "enum bevy::prelude::Color"), x\_offset: [Val](enum.Val.html "enum bevy::prelude::Val"), y\_offset: [Val](enum.Val.html "enum bevy::prelude::Val"), spread\_radius: [Val](enum.Val.html "enum bevy::prelude::Val"), blur\_radius: [Val](enum.Val.html "enum bevy::prelude::Val"), ) -> [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")
...
## Methods from [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")<Target = [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[ShadowStyle](struct.ShadowStyle.html "struct bevy::prelude::ShadowStyle")\>>
...
Note that the allocator may give the collection more space than it requests. Therefore, capacity can not be relied upon to be precisely minimal. Prefer [`reserve`](struct.Vec.html#method.reserve "method bevy::prelude::Vec::reserve") if future insertions are expected.
...
Note that the allocator may give the collection more space than it requests. Therefore, capacity can not be relied upon to be precisely minimal. Prefer [`try_reserve`](struct.Vec.html#method.try_reserve "method bevy::prelude::Vec::try_reserve") if future insertions are expected.
...
The [`drain`](struct.Vec.html#method.drain "method bevy::prelude::Vec::drain") method can emulate `truncate`, but causes the excess elements to be returned instead of dropped.
...
Truncating when `len == 0` is equivalent to calling the [`clear`](struct.Vec.html#method.clear "method bevy::prelude::Vec::clear") method.
...
Deallocating a vector using [`Box`](struct.Box.html "struct bevy::prelude::Box") (which uses [`dealloc`](https://doc.rust-lang.org/nightly/core/alloc/global/trait.GlobalAlloc.html#tymethod.dealloc "method core::alloc::global::GlobalAlloc::dealloc") internally):
...
This is a low-level operation that maintains none of the normal invariants of the type. Normally changing the length of a vector is done using one of the safe operations instead, such as [`truncate`](struct.Vec.html#method.truncate "method bevy::prelude::Vec::truncate"), [`resize`](struct.Vec.html#method.resize "method bevy::prelude::Vec::resize"), [`extend`](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.Extend.html#tymethod.extend "method core::iter::traits::collect::Extend::extend"), or [`clear`](struct.Vec.html#method.clear "method bevy::prelude::Vec::clear").

##### Safety

*   `new_len` must be less than or equal to [`capacity()`](struct.Vec.html#method.capacity "method bevy::prelude::Vec::capacity").
*   The elements at `old_len..new_len` must be initialized.

##### Examples

See [`spare_capacity_mut()`](struct.Vec.html#method.spare_capacity_mut "method bevy::prelude::Vec::spare_capacity_mut") for an example with safe initialization of capacity elements and use of this method.
...
Normally, here, one would use [`clear`](struct.Vec.html#method.clear "method bevy::prelude::Vec::clear") instead to correctly drop the contents and thus not leak memory.
...
This does not preserve ordering of the remaining elements, but is _O_(1). If you need to preserve the element order, use [`remove`](struct.Vec.html#method.remove "method bevy::prelude::Vec::remove") instead.
...
Takes _O_([`Vec::len`](struct.Vec.html#method.len "method bevy::prelude::Vec::len")) time. All items after the insertion index must be shifted to the right. In the worst case, all elements are shifted when the insertion index is 0.
...
Unlike [`push`](struct.Vec.html#method.push "method bevy::prelude::Vec::push") this method will not reallocate when there’s insufficient capacity. The caller should use [`reserve`](struct.Vec.html#method.reserve "method bevy::prelude::Vec::reserve") or [`try_reserve`](struct.Vec.html#method.try_reserve "method bevy::prelude::Vec::try_reserve") to ensure that there is enough capacity.
...
#### pub fn [peek\_mut](#method.peek_mut)(&mut self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[PeekMut](vec/struct.PeekMut.html "struct bevy::prelude::vec::PeekMut")<'\_, T, A>>
...
#### pub fn [append](#method.append)(&mut self, other: &mut [Vec](struct.Vec.html "struct bevy::prelude::Vec")<T, A>)
...
#### pub fn [drain](#method.drain)<R>(&mut self, range: R) -> [Drain](vec/struct.Drain.html "struct bevy::prelude::vec::Drain")<'\_, T, A> [ⓘ](#)
...
#### pub fn [split\_off](#method.split_off)(&mut self, at: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [Vec](struct.Vec.html "struct bevy::prelude::Vec")<T, A>
...
*   If you don’t need the returned vector at all, see [`Vec::truncate`](struct.Vec.html#method.truncate "method bevy::prelude::Vec::truncate").
*   If you want to take ownership of an arbitrary subslice, or you don’t necessarily want to store the removed items in a vector, see [`Vec::drain`](struct.Vec.html#method.drain "method bevy::prelude::Vec::drain").
...
The returned slice can be used to fill the vector with data (e.g. by reading from a file) before marking the data as initialized using the [`set_len`](struct.Vec.html#method.set_len "method bevy::prelude::Vec::set_len") method.
...
The returned spare capacity slice can be used to fill the vector with data (e.g. by reading from a file) before marking the data as initialized using the [`set_len`](struct.Vec.html#method.set_len "method bevy::prelude::Vec::set_len") method.

Note that this is a low-level API, which should be used with care for optimization purposes. If you need to append data to a `Vec` you can use [`push`](struct.Vec.html#method.push "method bevy::prelude::Vec::push"), [`extend`](struct.Vec.html#method.extend "method bevy::prelude::Vec::extend"), [`extend_from_slice`](struct.Vec.html#method.extend_from_slice "method bevy::prelude::Vec::extend_from_slice"), [`extend_from_within`](struct.Vec.html#method.extend_from_within "method bevy::prelude::Vec::extend_from_within"), [`insert`](struct.Vec.html#method.insert "method bevy::prelude::Vec::insert"), [`append`](struct.Vec.html#method.append "method bevy::prelude::Vec::append"), [`resize`](struct.Vec.html#method.resize "method bevy::prelude::Vec::resize") or [`resize_with`](struct.Vec.html#method.resize_with "method bevy::prelude::Vec::resize_with"), depending on your exact needs.
...
Note that this function is the same as [`extend`](struct.Vec.html#method.extend "method bevy::prelude::Vec::extend"), except that it also works with slice elements that are Clone but not Copy. If Rust gets specialization this function may be deprecated.
...
#### pub fn [extract\_if](#method.extract_if)<F, R>( &mut self, range: R, filter: F, ) -> [ExtractIf](vec/struct.ExtractIf.html "struct bevy::prelude::vec::ExtractIf")<'\_, T, F, A> [ⓘ](#)
...
#### pub fn [to\_vec](#method.to_vec)(&self) -> [Vec](struct.Vec.html "struct bevy::prelude::Vec")<T>
...
#### pub fn [to\_vec\_in](#method.to_vec_in)<A>(&self, alloc: A) -> [Vec](struct.Vec.html "struct bevy::prelude::Vec")<T, A>
...
#### pub fn [repeat](#method.repeat)(&self, n: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [Vec](struct.Vec.html "struct bevy::prelude::Vec")<T>
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#2831)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")
...
### impl [Component](trait.Component.html "trait bevy::prelude::Component") for [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")

where [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#2831)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#2831)

### impl [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#2831)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[ShadowStyle](struct.ShadowStyle.html "struct bevy::prelude::ShadowStyle")\>

The resulting type after dereferencing.

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#2831)

#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow") as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#2831)

### impl [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#2831)

#### fn [deref\_mut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html#tymethod.deref_mut)(&mut self) -> &mut <[BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow") as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Mutably dereferences the value.

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#2835)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#2835)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[ShadowStyle](struct.ShadowStyle.html "struct bevy::prelude::ShadowStyle")\> for [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#2863)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [ShadowStyle](struct.ShadowStyle.html "struct bevy::prelude::ShadowStyle")) -> [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#2831)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#2831)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#2831)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")
...
where [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#2831)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#2831)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [BoxShadow](struct.BoxShadow.html "struct bevy::prelude::BoxShadow")
