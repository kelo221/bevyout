...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1262)
...
`vertices: [[Vec2](struct.Vec2.html "struct bevy::prelude::Vec2"); [2](https://doc.rust-lang.org/nightly/std/primitive.array.html)]`

The endpoints of the line segment.

## Implementations

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1277)

### impl [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1280)

#### pub const fn [new](#method.new)(point1: [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2"), point2: [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")) -> [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

Create a new `Segment2d` from its endpoints.

##### [Examples found in repository](#scraped-examples)[?](../../scrape-examples-help.html)

examples/2d/2d\_shapes.rs ([lines 69-72](../../src/2d_shapes/2d_shapes.rs.html#69-72))

```rust
47fn setup(
48    mut commands: Commands,
49    mut meshes: ResMut<Assets<Mesh>>,
50    mut materials: ResMut<Assets<ColorMaterial>>,
51) {
52    commands.spawn(Camera2d);
53
54    let shapes = [
55        meshes.add(Circle::new(50.0)),
56        meshes.add(CircularSector::new(50.0, 1.0)),
57        meshes.add(CircularSegment::new(50.0, 1.25)),
58        meshes.add(Ellipse::new(25.0, 50.0)),
59        meshes.add(Annulus::new(25.0, 50.0)),
60        meshes.add(Capsule2d::new(25.0, 50.0)),
61        meshes.add(Rhombus::new(75.0, 100.0)),
62        meshes.add(Rectangle::new(50.0, 100.0)),
63        meshes.add(RegularPolygon::new(50.0, 6)),
64        meshes.add(Triangle2d::new(
65            Vec2::Y * 50.0,
66            Vec2::new(-50.0, -50.0),
67            Vec2::new(50.0, -50.0),
68        )),
69        meshes.add(Segment2d::new(
70            Vec2::new(-50.0, 50.0),
71            Vec2::new(50.0, -50.0),
72        )),
73        meshes.add(Polyline2d::new(vec![
74            Vec2::new(-50.0, 50.0),
75            Vec2::new(0.0, -50.0),
76            Vec2::new(50.0, 50.0),
77        ])),
78    ];
79    let num_shapes = shapes.len();
80
81    for (i, shape) in shapes.into_iter().enumerate() {
82        // Distribute colors evenly across the rainbow.
83        let color = Color::hsl(360. * i as f32 / num_shapes as f32, 0.95, 0.7);
84
85        commands.spawn((
86            Mesh2d(shape),
87            MeshMaterial2d(materials.add(color)),
88            Transform::from_xyz(
89                // Distribute shapes from -X_EXTENT/2 to +X_EXTENT/2.
90                -X_EXTENT / 2. + i as f32 / (num_shapes - 1) as f32 * X_EXTENT,
91                Y_EXTENT / 2.,
92                0.0,
93            ),
94        ));
...
96
97    let rings = [
98        meshes.add(Circle::new(50.0).to_ring(THICKNESS)),
99        // this visually produces an arc segment but this is not technically accurate
100        meshes.add(Ring::new(
101            CircularSector::new(50.0, 1.0),
102            CircularSector::new(45.0, 1.0),
103        )),
104        meshes.add(CircularSegment::new(50.0, 1.25).to_ring(THICKNESS)),
105        meshes.add({
106            // This is an approximation; Ellipse does not implement Inset as concentric ellipses do not have parallel curves
107            let outer = Ellipse::new(25.0, 50.0);
108            let mut inner = outer;
109            inner.half_size -= Vec2::splat(THICKNESS);
110            Ring::new(outer, inner)
111        }),
112        // this is equivalent to the Annulus::new(25.0, 50.0) above
113        meshes.add(Ring::new(Circle::new(50.0), Circle::new(25.0))),
114        meshes.add(Capsule2d::new(25.0, 50.0).to_ring(THICKNESS)),
115        meshes.add(Rhombus::new(75.0, 100.0).to_ring(THICKNESS)),
116        meshes.add(Rectangle::new(50.0, 100.0).to_ring(THICKNESS)),
117        meshes.add(RegularPolygon::new(50.0, 6).to_ring(THICKNESS)),
118        meshes.add(
119            Triangle2d::new(
120                Vec2::Y * 50.0,
121                Vec2::new(-50.0, -50.0),
122                Vec2::new(50.0, -50.0),
123            )
124            .to_ring(THICKNESS),
125        ),
126    ];
127    // Allow for 2 empty spaces
128    let num_rings = rings.len() + 2;
129
130    for (i, shape) in rings.into_iter().enumerate() {
131        // Distribute colors evenly across the rainbow.
132        let color = Color::hsl(360. * i as f32 / num_rings as f32, 0.95, 0.7);
133
134        commands.spawn((
135            Mesh2d(shape),
136            MeshMaterial2d(materials.add(color)),
137            Transform::from_xyz(
138                // Distribute shapes from -X_EXTENT/2 to +X_EXTENT/2.
139                -X_EXTENT / 2. + i as f32 / (num_rings - 1) as f32 * X_EXTENT,
140                -Y_EXTENT / 2.,
141                0.0,
142            ),
143        ));
144    }
145
146    let mut text = "Press 'R' to pause/resume rotation".to_string();
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1290)

#### pub fn [from\_direction\_and\_length](#method.from_direction_and_length)(direction: [Dir2](struct.Dir2.html "struct bevy::prelude::Dir2"), length: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")
...
examples/math/bounding\_2d.rs ([lines 234-237](../../src/bounding_2d/bounding_2d.rs.html#234-237))
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1302)

#### pub fn [from\_scaled\_direction](#method.from_scaled_direction)(scaled\_direction: [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")) -> [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1314)

#### pub fn [from\_ray\_and\_length](#method.from_ray_and_length)(ray: [Ray2d](struct.Ray2d.html "struct bevy::prelude::Ray2d"), length: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1322)

#### pub const fn [point1](#method.point1)(&self) -> [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")

Get the position of the first endpoint of the line segment.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1328)

#### pub const fn [point2](#method.point2)(&self) -> [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")

Get the position of the second endpoint of the line segment.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1335)

#### pub fn [center](#method.center)(&self) -> [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")

Compute the midpoint between the two endpoints of the line segment.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1341)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1347)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1359)

#### pub fn [direction](#method.direction)(&self) -> [Dir2](struct.Dir2.html "struct bevy::prelude::Dir2")

Compute the normalized direction pointing from the first endpoint to the second endpoint.

For the non-panicking version, see [`Segment2d::try_direction`](struct.Segment2d.html#method.try_direction "method bevy::prelude::Segment2d::try_direction").

##### Panics

Panics if a valid direction could not be computed, for example when the endpoints are coincident, NaN, or infinite.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1370)

#### pub fn [try\_direction](#method.try_direction)(&self) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Dir2](struct.Dir2.html "struct bevy::prelude::Dir2"), [InvalidDirectionError](../math/enum.InvalidDirectionError.html "enum bevy::math::InvalidDirectionError")\>

Try to compute the normalized direction pointing from the first endpoint to the second endpoint.

Returns [`Err(InvalidDirectionError)`](../math/enum.InvalidDirectionError.html "enum bevy::math::InvalidDirectionError") if a valid direction could not be computed, for example when the endpoints are coincident, NaN, or infinite.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1376)

#### pub fn [scaled\_direction](#method.scaled_direction)(&self) -> [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")

Compute the vector from the first endpoint to the second endpoint.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1388)

#### pub fn [left\_normal](#method.left_normal)(&self) -> [Dir2](struct.Dir2.html "struct bevy::prelude::Dir2")

Compute the normalized counterclockwise normal on the left-hand side of the line segment.

For the non-panicking version, see [`Segment2d::try_left_normal`](struct.Segment2d.html#method.try_left_normal "method bevy::prelude::Segment2d::try_left_normal").

##### Panics

Panics if a valid normal could not be computed, for example when the endpoints are coincident, NaN, or infinite.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1399)

#### pub fn [try\_left\_normal](#method.try_left_normal)(&self) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Dir2](struct.Dir2.html "struct bevy::prelude::Dir2"), [InvalidDirectionError](../math/enum.InvalidDirectionError.html "enum bevy::math::InvalidDirectionError")\>

Try to compute the normalized counterclockwise normal on the left-hand side of the line segment.

Returns [`Err(InvalidDirectionError)`](../math/enum.InvalidDirectionError.html "enum bevy::math::InvalidDirectionError") if a valid normal could not be computed, for example when the endpoints are coincident, NaN, or infinite.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1407)

#### pub fn [scaled\_left\_normal](#method.scaled_left_normal)(&self) -> [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1420)

#### pub fn [right\_normal](#method.right_normal)(&self) -> [Dir2](struct.Dir2.html "struct bevy::prelude::Dir2")

Compute the normalized clockwise normal on the right-hand side of the line segment.

For the non-panicking version, see [`Segment2d::try_right_normal`](struct.Segment2d.html#method.try_right_normal "method bevy::prelude::Segment2d::try_right_normal").

##### Panics

Panics if a valid normal could not be computed, for example when the endpoints are coincident, NaN, or infinite.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1431)

#### pub fn [try\_right\_normal](#method.try_right_normal)(&self) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Dir2](struct.Dir2.html "struct bevy::prelude::Dir2"), [InvalidDirectionError](../math/enum.InvalidDirectionError.html "enum bevy::math::InvalidDirectionError")\>

Try to compute the normalized clockwise normal on the right-hand side of the line segment.

Returns [`Err(InvalidDirectionError)`](../math/enum.InvalidDirectionError.html "enum bevy::math::InvalidDirectionError") if a valid normal could not be computed, for example when the endpoints are coincident, NaN, or infinite.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1439)

#### pub fn [scaled\_right\_normal](#method.scaled_right_normal)(&self) -> [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")

Compute the non-normalized clockwise normal on the right-hand side of the line segment.

The length of the normal is the distance between the endpoints.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1446)

#### pub fn [transformed](#method.transformed)(&self, isometry: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Isometry2d](struct.Isometry2d.html "struct bevy::prelude::Isometry2d")\>) -> [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

Compute the segment transformed by the given [`Isometry2d`](struct.Isometry2d.html "struct bevy::prelude::Isometry2d").

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1456)

#### pub fn [translated](#method.translated)(&self, translation: [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")) -> [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

Compute the segment translated by the given vector.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1462)

#### pub fn [rotated](#method.rotated)(&self, rotation: [Rot2](struct.Rot2.html "struct bevy::prelude::Rot2")) -> [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

Compute the segment rotated around the origin by the given rotation.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1468)

#### pub fn [rotated\_around](#method.rotated_around)(&self, rotation: [Rot2](struct.Rot2.html "struct bevy::prelude::Rot2"), point: [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")) -> [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

Compute the segment rotated around the given point by the given rotation.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1477)

#### pub fn [rotated\_around\_center](#method.rotated_around_center)(&self, rotation: [Rot2](struct.Rot2.html "struct bevy::prelude::Rot2")) -> [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

Compute the segment rotated around its own center.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1483)

#### pub fn [centered](#method.centered)(&self) -> [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

Compute the segment with its center at the origin, keeping the same direction and length.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1490)

#### pub fn [resized](#method.resized)(&self, length: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

Compute the segment with a new length, keeping the same direction and center.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1500)

#### pub fn [reverse](#method.reverse)(&mut self)

Reverses the direction of the line segment by swapping the endpoints.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1508)

#### pub fn [reversed](#method.reversed)(self) -> [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

Returns the line segment with its direction reversed by swapping the endpoints.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1515)

#### pub fn [closest\_point](#method.closest_point)(&self, point: [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")) -> [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")

Returns the point on the [`Segment2d`](struct.Segment2d.html "struct bevy::prelude::Segment2d") that is closest to the specified `point`.
...
### impl [Bounded2d](../math/bounding/trait.Bounded2d.html "trait bevy::math::bounding::Bounded2d") for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/bounding/bounded2d/primitive_impls.rs.html#268)

#### fn [aabb\_2d](../math/bounding/trait.Bounded2d.html#tymethod.aabb_2d)(&self, isometry: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Isometry2d](struct.Isometry2d.html "struct bevy::prelude::Isometry2d")\>) -> [Aabb2d](../math/bounding/struct.Aabb2d.html "struct bevy::math::bounding::Aabb2d")

Get an axis-aligned bounding box for the shape translated and rotated by the given isometry.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/bounding/bounded2d/primitive_impls.rs.html#272)

#### fn [bounding\_circle](../math/bounding/trait.Bounded2d.html#tymethod.bounding_circle)(&self, isometry: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Isometry2d](struct.Isometry2d.html "struct bevy::prelude::Isometry2d")\>) -> [BoundingCircle](../math/bounding/struct.BoundingCircle.html "struct bevy::math::bounding::BoundingCircle")
...
### impl [BoundedExtrusion](../math/bounding/trait.BoundedExtrusion.html "trait bevy::math::bounding::BoundedExtrusion") for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/bounding/bounded3d/extrusion.rs.html#90)

#### fn [extrusion\_aabb\_3d](../math/bounding/trait.BoundedExtrusion.html#method.extrusion_aabb_3d)( &self, half\_depth: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), isometry: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Isometry3d](struct.Isometry3d.html "struct bevy::prelude::Isometry3d")\>, ) -> [Aabb3d](../math/bounding/struct.Aabb3d.html "struct bevy::math::bounding::Aabb3d")
...
#### fn [extrusion\_bounding\_sphere](../math/bounding/trait.BoundedExtrusion.html#method.extrusion_bounding_sphere)( &self, half\_depth: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), isometry: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Isometry3d](struct.Isometry3d.html "struct bevy::prelude::Isometry3d")\>, ) -> [BoundingSphere](../math/bounding/struct.BoundingSphere.html "struct bevy::math::bounding::BoundingSphere")
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1250)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1250)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1250)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1269)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1270)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1251)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1251)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1553)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<([Vec2](struct.Vec2.html "struct bevy::prelude::Vec2"), [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2"))> for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1555)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(\_: ([Vec2](struct.Vec2.html "struct bevy::prelude::Vec2"), [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2"))) -> [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1546)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<\[[Vec2](struct.Vec2.html "struct bevy::prelude::Vec2"); [2](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]> for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1548)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(vertices: \[[Vec2](struct.Vec2.html "struct bevy::prelude::Vec2"); [2](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]) -> [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1254)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1254)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1254)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")
...
### impl<Config, Clear> [GizmoPrimitive2d](trait.GizmoPrimitive2d.html "trait bevy::prelude::GizmoPrimitive2d")<[Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")\> for [GizmoBuffer](../gizmos/gizmos/struct.GizmoBuffer.html "struct bevy::gizmos::gizmos::GizmoBuffer")<Config, Clear>
...
#### type [Output](trait.GizmoPrimitive2d.html#associatedtype.Output)<'a> = [Segment2dBuilder](../gizmos/primitives/dim2/struct.Segment2dBuilder.html "struct bevy::gizmos::primitives::dim2::Segment2dBuilder")<'a, Config, Clear> where [GizmoBuffer](../gizmos/gizmos/struct.GizmoBuffer.html "struct bevy::gizmos::gizmos::GizmoBuffer")<Config, Clear>: 'a
...
where [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d"): 'into\_return,
...
### impl [Meshable](trait.Meshable.html "trait bevy::prelude::Meshable") for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/primitives/dim2.rs.html#686)

#### type [Output](trait.Meshable.html#associatedtype.Output) = [Segment2dMeshBuilder](../mesh/struct.Segment2dMeshBuilder.html "struct bevy::mesh::Segment2dMeshBuilder")

The output of [`Self::mesh`](trait.Meshable.html#tymethod.mesh "method bevy::prelude::Meshable::mesh"). This will be a [`MeshBuilder`](trait.MeshBuilder.html "trait bevy::prelude::MeshBuilder") used for creating a [`Mesh`](struct.Mesh.html "struct bevy::prelude::Mesh").

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/primitives/dim2.rs.html#688)

#### fn [mesh](trait.Meshable.html#tymethod.mesh)(&self) -> <[Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d") as [Meshable](trait.Meshable.html "trait bevy::prelude::Meshable")\>::[Output](trait.Meshable.html#associatedtype.Output "type bevy::prelude::Meshable::Output")

Creates a [`Mesh`](struct.Mesh.html "struct bevy::prelude::Mesh") for a shape.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1250)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1250)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1254)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1255)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1267)

### impl [Primitive2d](trait.Primitive2d.html "trait bevy::prelude::Primitive2d") for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Segment2d](struct.Segment2d.html "struct bevy::prelude::Segment2d")
