...
Use any struct that implements the [`CubicGenerator`](trait.CubicGenerator.html "trait bevy::prelude::CubicGenerator") trait to create a new curve, such as [`CubicBezier`](struct.CubicBezier.html "struct bevy::prelude::CubicBezier").

## Implementations

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#1176)

### impl<P> [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>
...
#### pub fn [from\_segments](#method.from_segments)( segments: impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>>, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>>
...
#### pub fn [iter\_samples](#method.iter_samples)<'a, 'b>( &'b self, subdivisions: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), sample\_function: impl [FnMut](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html "trait core::ops::function::FnMut")(&[CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>, [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> P + 'a, ) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = P> + 'a
...
#### pub fn [segments](#method.segments)(&self) -> &\[[CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>\]
...
#### pub fn [push\_segment](#method.push_segment)(&mut self, segment: [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>)
...
### impl<P> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>
...
#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>
...
### impl<P> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>
...
### impl<'de, P> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>
...
### impl<P> [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>
...
#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#1169)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P> as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>>
...
### impl<P> [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>
...
### impl<P> [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>
...
where [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>: 'into\_return,
...
### impl<P> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>
...
#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl<P> [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#1169)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<P> [SampleDerivative](derivatives/trait.SampleDerivative.html "trait bevy::prelude::derivatives::SampleDerivative")<P> for [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>
...
### impl<P> [SampleTwoDerivatives](derivatives/trait.SampleTwoDerivatives.html "trait bevy::prelude::derivatives::SampleTwoDerivatives")<P> for [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>
...
### impl<P> [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>
...
### impl<P> [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>
...
### impl<P> [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>
...
### impl<P> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>

### impl<P> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>
...
### impl<P> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>

where P: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<P> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>

where P: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<P> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>

where P: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<P> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>

### impl<P> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>
