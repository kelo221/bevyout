...
Emitted whenever an [`Asset`](trait.Asset.html "trait bevy::prelude::Asset") is added.

#### Fields

`id: [AssetId](enum.AssetId.html "enum bevy::prelude::AssetId")<A>`

### Modified

Emitted whenever an [`Asset`](trait.Asset.html "trait bevy::prelude::Asset") value is modified.
...
Emitted whenever an [`Asset`](trait.Asset.html "trait bevy::prelude::Asset") is removed.
...
Emitted when the last [`Handle::Strong`](enum.Handle.html#variant.Strong "variant bevy::prelude::Handle::Strong") of an [`Asset`](trait.Asset.html "trait bevy::prelude::Asset") is dropped.
...
Emitted whenever an [`Asset`](trait.Asset.html "trait bevy::prelude::Asset") has been fully loaded (including its dependencies and all “recursive dependencies”).
...
### impl<A> [AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>
...
#### pub fn [is\_loaded\_with\_dependencies](#method.is_loaded_with_dependencies)( &self, asset\_id: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[AssetId](enum.AssetId.html "enum bevy::prelude::AssetId")<A>>, ) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if this event is [`AssetEvent::LoadedWithDependencies`](enum.AssetEvent.html#variant.LoadedWithDependencies "variant bevy::prelude::AssetEvent::LoadedWithDependencies") and matches the given `id`.
...
#### pub fn [is\_added](#method.is_added)(&self, asset\_id: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[AssetId](enum.AssetId.html "enum bevy::prelude::AssetId")<A>>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if this event is [`AssetEvent::Added`](enum.AssetEvent.html#variant.Added "variant bevy::prelude::AssetEvent::Added") and matches the given `id`.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/event.rs.html#75)

#### pub fn [is\_modified](#method.is_modified)(&self, asset\_id: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[AssetId](enum.AssetId.html "enum bevy::prelude::AssetId")<A>>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if this event is [`AssetEvent::Modified`](enum.AssetEvent.html#variant.Modified "variant bevy::prelude::AssetEvent::Modified") and matches the given `id`.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/event.rs.html#80)

#### pub fn [is\_removed](#method.is_removed)(&self, asset\_id: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[AssetId](enum.AssetId.html "enum bevy::prelude::AssetId")<A>>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if this event is [`AssetEvent::Removed`](enum.AssetEvent.html#variant.Removed "variant bevy::prelude::AssetEvent::Removed") and matches the given `id`.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/event.rs.html#85)

#### pub fn [is\_unused](#method.is_unused)(&self, asset\_id: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[AssetId](enum.AssetId.html "enum bevy::prelude::AssetId")<A>>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if this event is [`AssetEvent::Unused`](enum.AssetEvent.html#variant.Unused "variant bevy::prelude::AssetEvent::Unused") and matches the given `id`.

## Trait Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/event.rs.html#90)

### impl<A> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>

where A: [Asset](trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/event.rs.html#91)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>
...
### impl<A> [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>

where A: [Asset](trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/event.rs.html#98)

### impl<A> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>
...
### impl<A> [Enum](../reflect/enums/trait.Enum.html "trait bevy::reflect::enums::Enum") for [AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>
...
### impl<A> [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>

where A: [Asset](trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/event.rs.html#49)

### impl<A> [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>

where A: [Asset](trait.Asset.html "trait bevy::prelude::Asset") + [TypePath](trait.TypePath.html "trait bevy::prelude::TypePath"), [AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>: [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"), [AssetId](enum.AssetId.html "enum bevy::prelude::AssetId")<A>: [FromReflect](trait.FromReflect.html "trait bevy::prelude::FromReflect") + [TypePath](trait.TypePath.html "trait bevy::prelude::TypePath") + MaybeTyped + RegisterForReflection,

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/event.rs.html#49)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/event.rs.html#49)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A> as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)( \_\_param0: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>>
...
### impl<A> [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>
...
### impl<A> [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>
...
### impl<A> [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>
...
where [AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>: 'into\_return,
...
### impl<A> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>

where A: [Asset](trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/event.rs.html#114)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl<A> [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/event.rs.html#49)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<A> [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>
...
### impl<A> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>

### impl<A> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>

### impl<A> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>

### impl<A> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>

### impl<A> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>

### impl<A> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>

### impl<A> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AssetEvent](enum.AssetEvent.html "enum bevy::prelude::AssetEvent")<A>
