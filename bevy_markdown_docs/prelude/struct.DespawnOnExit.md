...
### impl<S> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>
...
#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>
...
### impl<S> [Component](trait.Component.html "trait bevy::prelude::Component") for [DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>

where S: [States](trait.States.html "trait bevy::prelude::States"), [DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl<S> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>
...
#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>
...
### impl<S> [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>
...
#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state_scoped.rs.html#148)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S> as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>>
...
### impl<S> [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>
...
### impl<S> [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>
...
### impl<S> [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>
...
where [DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>: 'into\_return,
...
### impl<S> [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state_scoped.rs.html#148)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<S> [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>
...
### impl<S> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>

where S: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"),

### impl<S> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>
...
### impl<S> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>

### impl<S> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>

### impl<S> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>

where S: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<S> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>

where S: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"),

### impl<S> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DespawnOnExit](struct.DespawnOnExit.html "struct bevy::prelude::DespawnOnExit")<S>
