...
[Source](https://docs.rs/bevy_world_serialization/0.19.0/x86_64-unknown-linux-gnu/src/bevy_world_serialization/world_asset.rs.html#23)
...
To spawn a [`WorldAsset`](struct.WorldAsset.html "struct bevy::prelude::WorldAsset"), you can use either:

*   [`WorldInstanceSpawner::spawn`](struct.WorldInstanceSpawner.html#method.spawn "method bevy::prelude::WorldInstanceSpawner::spawn")
*   adding the [`WorldAssetRoot`](struct.WorldAssetRoot.html "struct bevy::prelude::WorldAssetRoot") component to an entity.

## Fields

`world: [World](struct.World.html "struct bevy::prelude::World")`

The world, containing its entities and resources.

## Implementations

[Source](https://docs.rs/bevy_world_serialization/0.19.0/x86_64-unknown-linux-gnu/src/bevy_world_serialization/world_asset.rs.html#28)

### impl [WorldAsset](struct.WorldAsset.html "struct bevy::prelude::WorldAsset")

[Source](https://docs.rs/bevy_world_serialization/0.19.0/x86_64-unknown-linux-gnu/src/bevy_world_serialization/world_asset.rs.html#30)

#### pub fn [new](#method.new)(world: [World](struct.World.html "struct bevy::prelude::World")) -> [WorldAsset](struct.WorldAsset.html "struct bevy::prelude::WorldAsset")

Creates a new [`WorldAsset`](struct.WorldAsset.html "struct bevy::prelude::WorldAsset") with the given world.

[Source](https://docs.rs/bevy_world_serialization/0.19.0/x86_64-unknown-linux-gnu/src/bevy_world_serialization/world_asset.rs.html#35-38)

#### pub fn [from\_dynamic\_world](#method.from_dynamic_world)( dynamic\_world: &[DynamicWorld](struct.DynamicWorld.html "struct bevy::prelude::DynamicWorld"), type\_registry: &[TypeRegistry](../reflect/struct.TypeRegistry.html "struct bevy::reflect::TypeRegistry"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[WorldAsset](struct.WorldAsset.html "struct bevy::prelude::WorldAsset"), [WorldInstanceSpawnError](../world_serialization/enum.WorldInstanceSpawnError.html "enum bevy::world_serialization::WorldInstanceSpawnError")\>

Create a new [`WorldAsset`](struct.WorldAsset.html "struct bevy::prelude::WorldAsset") from a given dynamic world.

[Source](https://docs.rs/bevy_world_serialization/0.19.0/x86_64-unknown-linux-gnu/src/bevy_world_serialization/world_asset.rs.html#50-53)

#### pub fn [clone\_with](#method.clone_with)( &self, type\_registry: &[AppTypeRegistry](struct.AppTypeRegistry.html "struct bevy::prelude::AppTypeRegistry"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[WorldAsset](struct.WorldAsset.html "struct bevy::prelude::WorldAsset"), [WorldInstanceSpawnError](../world_serialization/enum.WorldInstanceSpawnError.html "enum bevy::world_serialization::WorldInstanceSpawnError")\>

Clone the [`WorldAsset`](struct.WorldAsset.html "struct bevy::prelude::WorldAsset").

This method will return a [`WorldInstanceSpawnError`](../world_serialization/enum.WorldInstanceSpawnError.html "enum bevy::world_serialization::WorldInstanceSpawnError") if a type either is not registered in the provided [`AppTypeRegistry`](struct.AppTypeRegistry.html "struct bevy::prelude::AppTypeRegistry") or doesn’t reflect the [`Component`](trait.Component.html "trait bevy::prelude::Component") trait.

[Source](https://docs.rs/bevy_world_serialization/0.19.0/x86_64-unknown-linux-gnu/src/bevy_world_serialization/world_asset.rs.html#64-69)

#### pub fn [write\_to\_world\_with](#method.write_to_world_with)( &self, world: &mut [World](struct.World.html "struct bevy::prelude::World"), entity\_map: &mut [EntityHashMap](../ecs/entity/struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<[Entity](struct.Entity.html "struct bevy::prelude::Entity")\>, type\_registry: &[AppTypeRegistry](struct.AppTypeRegistry.html "struct bevy::prelude::AppTypeRegistry"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [WorldInstanceSpawnError](../world_serialization/enum.WorldInstanceSpawnError.html "enum bevy::world_serialization::WorldInstanceSpawnError")\>
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [WorldAsset](struct.WorldAsset.html "struct bevy::prelude::WorldAsset")
...
### impl [VisitAssetDependencies](../asset/trait.VisitAssetDependencies.html "trait bevy::asset::VisitAssetDependencies") for [WorldAsset](struct.WorldAsset.html "struct bevy::prelude::WorldAsset")
...
### impl ![Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [WorldAsset](struct.WorldAsset.html "struct bevy::prelude::WorldAsset")

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [WorldAsset](struct.WorldAsset.html "struct bevy::prelude::WorldAsset")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [WorldAsset](struct.WorldAsset.html "struct bevy::prelude::WorldAsset")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [WorldAsset](struct.WorldAsset.html "struct bevy::prelude::WorldAsset")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [WorldAsset](struct.WorldAsset.html "struct bevy::prelude::WorldAsset")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [WorldAsset](struct.WorldAsset.html "struct bevy::prelude::WorldAsset")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [WorldAsset](struct.WorldAsset.html "struct bevy::prelude::WorldAsset")
