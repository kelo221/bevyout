...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [AnimationGraphLoadError](enum.AnimationGraphLoadError.html "enum bevy::prelude::AnimationGraphLoadError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [AnimationGraphLoadError](enum.AnimationGraphLoadError.html "enum bevy::prelude::AnimationGraphLoadError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [AnimationGraphLoadError](enum.AnimationGraphLoadError.html "enum bevy::prelude::AnimationGraphLoadError")
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Error](../tasks/futures_lite/io/struct.Error.html "struct bevy::tasks::futures_lite::io::Error")\> for [AnimationGraphLoadError](enum.AnimationGraphLoadError.html "enum bevy::prelude::AnimationGraphLoadError")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/graph.rs.html#262)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(source: [Error](../tasks/futures_lite/io/struct.Error.html "struct bevy::tasks::futures_lite::io::Error")) -> [AnimationGraphLoadError](enum.AnimationGraphLoadError.html "enum bevy::prelude::AnimationGraphLoadError")
...
#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(source: [Error](https://docs.rs/ron/0.12.1/x86_64-unknown-linux-gnu/ron/error/enum.Error.html "enum ron::error::Error")) -> [AnimationGraphLoadError](enum.AnimationGraphLoadError.html "enum bevy::prelude::AnimationGraphLoadError")
...
#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(source: [SpannedError](https://docs.rs/ron/0.12.1/x86_64-unknown-linux-gnu/ron/error/struct.SpannedError.html "struct ron::error::SpannedError")) -> [AnimationGraphLoadError](enum.AnimationGraphLoadError.html "enum bevy::prelude::AnimationGraphLoadError")

Converts to this type from the input type.

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AnimationGraphLoadError](enum.AnimationGraphLoadError.html "enum bevy::prelude::AnimationGraphLoadError")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AnimationGraphLoadError](enum.AnimationGraphLoadError.html "enum bevy::prelude::AnimationGraphLoadError")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AnimationGraphLoadError](enum.AnimationGraphLoadError.html "enum bevy::prelude::AnimationGraphLoadError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AnimationGraphLoadError](enum.AnimationGraphLoadError.html "enum bevy::prelude::AnimationGraphLoadError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AnimationGraphLoadError](enum.AnimationGraphLoadError.html "enum bevy::prelude::AnimationGraphLoadError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AnimationGraphLoadError](enum.AnimationGraphLoadError.html "enum bevy::prelude::AnimationGraphLoadError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AnimationGraphLoadError](enum.AnimationGraphLoadError.html "enum bevy::prelude::AnimationGraphLoadError")
