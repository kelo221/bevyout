...
This allows you to share configuration (like run conditions) across multiple systems, and order systems or system sets relative to conceptual groups of systems. To control the behavior of a system set as a whole, use [`Schedule::configure_sets`](struct.Schedule.html#method.configure_sets "method bevy::prelude::Schedule::configure_sets"), or the method of the same name on `App`.
...
To add systems to a system set, call [`in_set`](trait.IntoScheduleConfigs.html#method.in_set "method bevy::prelude::IntoScheduleConfigs::in_set") on the system function while adding it to your app or schedule.

Like usual, these methods can be chained with other configuration methods like [`before`](trait.IntoScheduleConfigs.html#method.before "method bevy::prelude::IntoScheduleConfigs::before"), or repeated to add systems to multiple sets.
...
#### fn [dyn\_clone](#tymethod.dyn_clone)(&self) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet")\>
...
#### fn [intern](#method.intern)(&self) -> [Interned](../ecs/intern/struct.Interned.html "struct bevy::ecs::intern::Interned")<dyn [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet")\>
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for dyn [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/set.rs.html#63-176)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for dyn [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet")
...
### impl [Internable](../ecs/intern/trait.Internable.html "trait bevy::ecs::intern::Internable") for dyn [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/set.rs.html#63-176)

#### fn [leak](../ecs/intern/trait.Internable.html#tymethod.leak)(&self) -> &'static dyn [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet")

Creates a static reference to `self`, possibly leaking memory.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/set.rs.html#63-176)

#### fn [ref\_eq](../ecs/intern/trait.Internable.html#tymethod.ref_eq)(&self, other: &(dyn [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") + 'static)) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for dyn [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/set.rs.html#63-176)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &(dyn [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") + 'static)) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [AccessibilitySystems](../a11y/enum.AccessibilitySystems.html "enum bevy::a11y::AccessibilitySystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [AnimationSystems](../app/struct.AnimationSystems.html "struct bevy::app::AnimationSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [AnonymousSet](../ecs/schedule/struct.AnonymousSet.html "struct bevy::ecs::schedule::AnonymousSet")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/lib.rs.html#708)

### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [AssetEventSystems](../asset/struct.AssetEventSystems.html "struct bevy::asset::AssetEventSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for bevy::render::erased\_render\_asset::[AssetExtractionSystems](../render/erased_render_asset/struct.AssetExtractionSystems.html "struct bevy::render::erased_render_asset::AssetExtractionSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for bevy::render::render\_asset::[AssetExtractionSystems](../render/render_asset/struct.AssetExtractionSystems.html "struct bevy::render::render_asset::AssetExtractionSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [AssetTrackingSystems](../asset/struct.AssetTrackingSystems.html "struct bevy::asset::AssetTrackingSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [CameraUpdateSystems](../camera/struct.CameraUpdateSystems.html "struct bevy::camera::CameraUpdateSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [Core2dSystems](../core_pipeline/enum.Core2dSystems.html "enum bevy::core_pipeline::Core2dSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [Core3dSystems](../core_pipeline/enum.Core3dSystems.html "enum bevy::core_pipeline::Core3dSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [DiagnosticsOverlaySystems](../dev_tools/diagnostics_overlay/enum.DiagnosticsOverlaySystems.html "enum bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlaySystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [DirtySpecializationSystems](../render/camera/enum.DirtySpecializationSystems.html "enum bevy::render::camera::DirtySpecializationSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [EditableTextSystems](../text/struct.EditableTextSystems.html "struct bevy::text::EditableTextSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [ExitSystems](../window/struct.ExitSystems.html "struct bevy::window::ExitSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [FpsOverlaySystems](../dev_tools/fps_overlay/enum.FpsOverlaySystems.html "enum bevy::dev_tools::fps_overlay::FpsOverlaySystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [FrustumGizmoSystems](../gizmos/frustum/struct.FrustumGizmoSystems.html "struct bevy::gizmos::frustum::FrustumGizmoSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [GizmoMeshSystems](../gizmos/struct.GizmoMeshSystems.html "struct bevy::gizmos::GizmoMeshSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [GizmoRenderSystems](../gizmos_render/enum.GizmoRenderSystems.html "enum bevy::gizmos_render::GizmoRenderSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [ImeSystems](../ui_widgets/enum.ImeSystems.html "enum bevy::ui_widgets::ImeSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [InputFocusSystems](../input_focus/enum.InputFocusSystems.html "enum bevy::input_focus::InputFocusSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [InputSystems](../input/struct.InputSystems.html "struct bevy::input::InputSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [Interned](../ecs/intern/struct.Interned.html "struct bevy::ecs::intern::Interned")<dyn [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet")\>

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/material.rs.html#609)

### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [MaterialExtractionSystems](../pbr/struct.MaterialExtractionSystems.html "struct bevy::pbr::MaterialExtractionSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [MeshExtractionSystems](../pbr/struct.MeshExtractionSystems.html "struct bevy::pbr::MeshExtractionSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [MeshPipelineSystems](../pbr/struct.MeshPipelineSystems.html "struct bevy::pbr::MeshPipelineSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [PickingSystems](../picking/enum.PickingSystems.html "enum bevy::picking::PickingSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [RemoteSystems](../remote/enum.RemoteSystems.html "enum bevy::remote::RemoteSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [RenderGraphSystems](../render/renderer/enum.RenderGraphSystems.html "enum bevy::render::renderer::RenderGraphSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [RenderSystems](../render/enum.RenderSystems.html "enum bevy::render::RenderSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [RenderUiSystems](../ui_render/enum.RenderUiSystems.html "enum bevy::ui_render::RenderUiSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [RumbleSystems](struct.RumbleSystems.html "struct bevy::prelude::RumbleSystems")

where [RumbleSystems](struct.RumbleSystems.html "struct bevy::prelude::RumbleSystems"): 'static + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") + [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") + [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") + [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash"),

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/main_schedule.rs.html#412)

### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [RunFixedMainLoopSystems](enum.RunFixedMainLoopSystems.html "enum bevy::prelude::RunFixedMainLoopSystems")

where [RunFixedMainLoopSystems](enum.RunFixedMainLoopSystems.html "enum bevy::prelude::RunFixedMainLoopSystems"): 'static + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") + [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") + [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") + [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash"),

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/main_schedule.rs.html#203)

### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [SceneSpawnerSystems](../app/enum.SceneSpawnerSystems.html "enum bevy::app::SceneSpawnerSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [SerializeSchedulesSystems](../dev_tools/schedule_data/plugin/struct.SerializeSchedulesSystems.html "struct bevy::dev_tools::schedule_data::plugin::SerializeSchedulesSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [SimulationLightSystems](../light/enum.SimulationLightSystems.html "enum bevy::light::SimulationLightSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for bevy::sprite::[SpriteSystems](../sprite/enum.SpriteSystems.html "enum bevy::sprite::SpriteSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for bevy::sprite\_render::[SpriteSystems](../sprite_render/enum.SpriteSystems.html "enum bevy::sprite_render::SpriteSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [StateTransitionSystems](../state/state/enum.StateTransitionSystems.html "enum bevy::state::state::StateTransitionSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [Text2dUpdateSystems](../text/struct.Text2dUpdateSystems.html "struct bevy::text::Text2dUpdateSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [TimeSystems](../time/struct.TimeSystems.html "struct bevy::time::TimeSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [TransformGizmoSystems](struct.TransformGizmoSystems.html "struct bevy::prelude::TransformGizmoSystems")

where [TransformGizmoSystems](struct.TransformGizmoSystems.html "struct bevy::prelude::TransformGizmoSystems"): 'static + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") + [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") + [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") + [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash"),

[Source](https://docs.rs/bevy_transform/0.19.0/x86_64-unknown-linux-gnu/src/bevy_transform/plugins.rs.html#12)

### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [TransformSystems](enum.TransformSystems.html "enum bevy::prelude::TransformSystems")

where [TransformSystems](enum.TransformSystems.html "enum bevy::prelude::TransformSystems"): 'static + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") + [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") + [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") + [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash"),

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/lib.rs.html#94)

### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [UiSystems](../ui/enum.UiSystems.html "enum bevy::ui::UiSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [ValidateParentHasComponentSystems](../app/struct.ValidateParentHasComponentSystems.html "struct bevy::app::ValidateParentHasComponentSystems")
...
### impl [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [VisibilitySystems](../camera/visibility/enum.VisibilitySystems.html "enum bevy::camera::visibility::VisibilitySystems")
...
### impl<C> [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [PropagateSet](../app/struct.PropagateSet.html "struct bevy::app::PropagateSet")<C>
...
### impl<S> [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [EnterSchedules](struct.EnterSchedules.html "struct bevy::prelude::EnterSchedules")<S>

where S: [States](trait.States.html "trait bevy::prelude::States"), [EnterSchedules](struct.EnterSchedules.html "struct bevy::prelude::EnterSchedules")<S>: 'static + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") + [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") + [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") + [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash"),

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state/transitions.rs.html#93)

### impl<S> [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [ExitSchedules](struct.ExitSchedules.html "struct bevy::prelude::ExitSchedules")<S>

where S: [States](trait.States.html "trait bevy::prelude::States"), [ExitSchedules](struct.ExitSchedules.html "struct bevy::prelude::ExitSchedules")<S>: 'static + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") + [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") + [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") + [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash"),

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state/transitions.rs.html#103)

### impl<S> [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [TransitionSchedules](struct.TransitionSchedules.html "struct bevy::prelude::TransitionSchedules")<S>

where S: [States](trait.States.html "trait bevy::prelude::States"), [TransitionSchedules](struct.TransitionSchedules.html "struct bevy::prelude::TransitionSchedules")<S>: 'static + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") + [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") + [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") + [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/set.rs.html#227)

### impl<T> [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet") for [SystemTypeSet](../ecs/schedule/struct.SystemTypeSet.html "struct bevy::ecs::schedule::SystemTypeSet")<T>