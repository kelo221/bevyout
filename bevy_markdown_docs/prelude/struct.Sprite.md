...
`image: [Handle](enum.Handle.html "enum bevy::prelude::Handle")<[Image](struct.Image.html "struct bevy::prelude::Image")>`

The image used to render the sprite

`texture_atlas: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[TextureAtlas](struct.TextureAtlas.html "struct bevy::prelude::TextureAtlas")>`

The (optional) texture atlas used to render the sprite

`color: [Color](enum.Color.html "enum bevy::prelude::Color")`
...
`custom_size: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")>`

An optional custom size for the sprite that will be used when rendering, instead of the size of the sprite’s image

`rect: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Rect](struct.Rect.html "struct bevy::prelude::Rect")>`

An optional rectangle representing the region of the sprite’s image to render, instead of rendering the full image. This is an easy one-off alternative to using a [`TextureAtlas`](struct.TextureAtlas.html "struct bevy::prelude::TextureAtlas").

When used with a [`TextureAtlas`](struct.TextureAtlas.html "struct bevy::prelude::TextureAtlas"), the rect is offset by the atlas’s minimal (top-left) corner position.

`image_mode: [SpriteImageMode](enum.SpriteImageMode.html "enum bevy::prelude::SpriteImageMode")`
...
### impl [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")

[Source](https://docs.rs/bevy_sprite/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite/sprite.rs.html#46)

#### pub fn [sized](#method.sized)(custom\_size: [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")) -> [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")
...
#### pub fn [from\_image](#method.from_image)(image: [Handle](enum.Handle.html "enum bevy::prelude::Handle")<[Image](struct.Image.html "struct bevy::prelude::Image")\>) -> [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")
...
#### pub fn [from\_atlas\_image](#method.from_atlas_image)(image: [Handle](enum.Handle.html "enum bevy::prelude::Handle")<[Image](struct.Image.html "struct bevy::prelude::Image")\>, atlas: [TextureAtlas](struct.TextureAtlas.html "struct bevy::prelude::TextureAtlas")) -> [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")
...
#### pub fn [from\_color](#method.from_color)(color: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Color](enum.Color.html "enum bevy::prelude::Color")\>, size: [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")) -> [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")
...
#### pub fn [compute\_pixel\_space\_point](#method.compute_pixel_space_point)( &self, point\_relative\_to\_sprite: [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2"), anchor: [Anchor](../sprite/struct.Anchor.html "struct bevy::sprite::Anchor"), images: &[Assets](struct.Assets.html "struct bevy::prelude::Assets")<[Image](struct.Image.html "struct bevy::prelude::Image")\>, texture\_atlases: &[Assets](struct.Assets.html "struct bevy::prelude::Assets")<[TextureAtlasLayout](struct.TextureAtlasLayout.html "struct bevy::prelude::TextureAtlasLayout")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Vec2](struct.Vec2.html "struct bevy::prelude::Vec2"), [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")\>
...
### impl [AsAssetId](../asset/trait.AsAssetId.html "trait bevy::asset::AsAssetId") for [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")

[Source](https://docs.rs/bevy_sprite/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite/sprite.rs.html#158)

#### type [Asset](../asset/trait.AsAssetId.html#associatedtype.Asset) = [Image](struct.Image.html "struct bevy::prelude::Image")
...
#### fn [as\_asset\_id](../asset/trait.AsAssetId.html#tymethod.as_asset_id)(&self) -> [AssetId](enum.AssetId.html "enum bevy::prelude::AssetId")<<[Sprite](struct.Sprite.html "struct bevy::prelude::Sprite") as [AsAssetId](../asset/trait.AsAssetId.html "trait bevy::asset::AsAssetId")\>::[Asset](../asset/trait.AsAssetId.html#associatedtype.Asset "type bevy::asset::AsAssetId::Asset")\>
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")

[Source](https://docs.rs/bevy_sprite/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite/sprite.rs.html#15)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")
...
### impl [Component](trait.Component.html "trait bevy::prelude::Component") for [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")

where [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

**Required Components**: [`Transform`](struct.Transform.html "struct bevy::prelude::Transform"), [`Visibility`](enum.Visibility.html "enum bevy::prelude::Visibility"), [`VisibilityClass`](../camera/visibility/struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass"), [`Anchor`](../sprite/struct.Anchor.html "struct bevy::sprite::Anchor").
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")

[Source](https://docs.rs/bevy_sprite/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite/sprite.rs.html#15)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")
...
### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")

[Source](https://docs.rs/bevy_sprite/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite/sprite.rs.html#15)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_sprite/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite/sprite.rs.html#15)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Sprite](struct.Sprite.html "struct bevy::prelude::Sprite") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")\>
...
### impl [FromTemplate](trait.FromTemplate.html "trait bevy::prelude::FromTemplate") for [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")

[Source](https://docs.rs/bevy_sprite/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite/sprite.rs.html#15)

#### type [Template](trait.FromTemplate.html#associatedtype.Template) = [SpriteTemplate](../sprite/struct.SpriteTemplate.html "struct bevy::sprite::SpriteTemplate")

The [`Template`](trait.Template.html "trait bevy::prelude::Template") for this type.

[Source](https://docs.rs/bevy_sprite/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite/sprite.rs.html#15)

### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")
...
where [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite"): 'into\_return,
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_sprite/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite/sprite.rs.html#15)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")
...
### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Sprite](struct.Sprite.html "struct bevy::prelude::Sprite")
