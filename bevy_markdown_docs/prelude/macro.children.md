...
Also see [`related`](macro.related.html "macro bevy::prelude::related") for a version of this that works with any [`RelationshipTarget`](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") type.
