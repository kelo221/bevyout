...
#### fn [sample\_interior](#tymethod.sample_interior)<R>(&self, rng: [&mut R](https://doc.rust-lang.org/nightly/std/primitive.reference.html)) -> Self::[Output](trait.ShapeSample.html#associatedtype.Output "type bevy::prelude::ShapeSample::Output")
...
Shapes like [`Cylinder`](struct.Cylinder.html "struct bevy::prelude::Cylinder"), [`Capsule2d`](struct.Capsule2d.html "struct bevy::prelude::Capsule2d") and [`Capsule3d`](struct.Capsule3d.html "struct bevy::prelude::Capsule3d") are oriented along the y-axis.
...
#### fn [sample\_boundary](#tymethod.sample_boundary)<R>(&self, rng: [&mut R](https://doc.rust-lang.org/nightly/std/primitive.reference.html)) -> Self::[Output](trait.ShapeSample.html#associatedtype.Output "type bevy::prelude::ShapeSample::Output")
...
#### fn [interior\_dist](#method.interior_dist)(self) -> impl [Distribution](https://docs.rs/rand/0.9.4/x86_64-unknown-linux-gnu/rand/distr/distribution/trait.Distribution.html "trait rand::distr::distribution::Distribution")<Self::[Output](trait.ShapeSample.html#associatedtype.Output "type bevy::prelude::ShapeSample::Output")\>
...
#### fn [boundary\_dist](#method.boundary_dist)(self) -> impl [Distribution](https://docs.rs/rand/0.9.4/x86_64-unknown-linux-gnu/rand/distr/distribution/trait.Distribution.html "trait rand::distr::distribution::Distribution")<Self::[Output](trait.ShapeSample.html#associatedtype.Output "type bevy::prelude::ShapeSample::Output")\>
...
#### type [Output](#associatedtype.Output) = [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")
...
#### type [Output](#associatedtype.Output) = [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")
