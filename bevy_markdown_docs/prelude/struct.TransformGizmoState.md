...
`hovered_axis: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[TransformGizmoAxis](enum.TransformGizmoAxis.html "enum bevy::prelude::TransformGizmoAxis")>`
...
`axis: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[TransformGizmoAxis](enum.TransformGizmoAxis.html "enum bevy::prelude::TransformGizmoAxis")>`

The axis being dragged, if any.

`start_transform: [Transform](struct.Transform.html "struct bevy::prelude::Transform")`

The transform snapshot taken when the drag started.

`entity: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Entity](struct.Entity.html "struct bevy::prelude::Entity")>`

The entity being dragged, if any.

`drag_start_world: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")`

World-space point (or normalized direction for rotation) where the drag started.

`gizmo_origin: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")`
...
### impl [Component](trait.Component.html "trait bevy::prelude::Component") for [TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState")

[Source](https://docs.rs/bevy_gizmos/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gizmos/transform_gizmo.rs.html#179)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_gizmos/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gizmos/transform_gizmo.rs.html#179)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState")

[Source](https://docs.rs/bevy_gizmos/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gizmos/transform_gizmo.rs.html#179)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_gizmos/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gizmos/transform_gizmo.rs.html#179)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState")
...
where [TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState"): 'into\_return,
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_gizmos/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gizmos/transform_gizmo.rs.html#179)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState")\>, ) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TransformGizmoState](struct.TransformGizmoState.html "struct bevy::prelude::TransformGizmoState")
