...
[`set_if_neq`](trait.DetectChangesMut.html#method.set_if_neq "method bevy::prelude::DetectChangesMut::set_if_neq") is a helper method for this common functionality.
...
#### fn [set\_last\_changed](#tymethod.set_last_changed)(&mut self, last\_changed: [Tick](../ecs/change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"))

Manually sets the change tick recording the time when this data was last mutated.

##### Warning

This is a complex and error-prone operation, primarily intended for use with rollback networking strategies. If you merely want to flag this data as changed, use [`set_changed`](trait.DetectChangesMut.html#tymethod.set_changed "method bevy::prelude::DetectChangesMut::set_changed") instead. If you want to avoid triggering change detection, use [`bypass_change_detection`](trait.DetectChangesMut.html#tymethod.bypass_change_detection "method bevy::prelude::DetectChangesMut::bypass_change_detection") instead.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/traits.rs.html#156)

#### fn [set\_last\_added](#tymethod.set_last_added)(&mut self, last\_added: [Tick](../ecs/change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"))

Manually sets the added tick recording the time when this data was last added.

##### Warning

The caveats of [`set_last_changed`](trait.DetectChangesMut.html#tymethod.set_last_changed "method bevy::prelude::DetectChangesMut::set_last_changed") apply. This modifies both the added and changed ticks together.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/traits.rs.html#165)

#### fn [bypass\_change\_detection](#tymethod.bypass_change_detection)(&mut self) -> &mut Self::[Inner](trait.DetectChangesMut.html#associatedtype.Inner "type bevy::prelude::DetectChangesMut::Inner")
...
#### fn [set\_if\_neq](#method.set_if_neq)(&mut self, value: Self::[Inner](trait.DetectChangesMut.html#associatedtype.Inner "type bevy::prelude::DetectChangesMut::Inner")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
If you’re dealing with non-trivial structs which have multiple fields of non-trivial size, then consider applying a `map_unchanged` beforehand to allow changing only the relevant field and prevent unnecessary copying and cloning. See the docs of [`Mut::map_unchanged`](struct.Mut.html#method.map_unchanged "method bevy::prelude::Mut::map_unchanged"), [`MutUntyped::map_unchanged`](../ecs/change_detection/struct.MutUntyped.html#method.map_unchanged "method bevy::ecs::change_detection::MutUntyped::map_unchanged"), [`ResMut::map_unchanged`](struct.ResMut.html#method.map_unchanged "method bevy::prelude::ResMut::map_unchanged") or [`NonSendMut::map_unchanged`](struct.NonSendMut.html#method.map_unchanged "method bevy::prelude::NonSendMut::map_unchanged") for an example

If you need the previous value, use [`replace_if_neq`](trait.DetectChangesMut.html#method.replace_if_neq "method bevy::prelude::DetectChangesMut::replace_if_neq").
...
If you don’t need the previous value, use [`set_if_neq`](trait.DetectChangesMut.html#method.set_if_neq "method bevy::prelude::DetectChangesMut::set_if_neq").
...
### impl<'w> [DetectChangesMut](trait.DetectChangesMut.html "trait bevy::prelude::DetectChangesMut") for [MutUntyped](../ecs/change_detection/struct.MutUntyped.html "struct bevy::ecs::change_detection::MutUntyped")<'w>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/params.rs.html#1361)

#### type [Inner](#associatedtype.Inner) = [PtrMut](../ecs/ptr/struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'w>