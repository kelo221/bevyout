...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [BounceInCurve](struct.BounceInCurve.html "struct bevy::prelude::BounceInCurve")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#942)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [BounceInCurve](struct.BounceInCurve.html "struct bevy::prelude::BounceInCurve")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [BounceInCurve](struct.BounceInCurve.html "struct bevy::prelude::BounceInCurve")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [BounceInCurve](struct.BounceInCurve.html "struct bevy::prelude::BounceInCurve")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [BounceInCurve](struct.BounceInCurve.html "struct bevy::prelude::BounceInCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [BounceInCurve](struct.BounceInCurve.html "struct bevy::prelude::BounceInCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [BounceInCurve](struct.BounceInCurve.html "struct bevy::prelude::BounceInCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [BounceInCurve](struct.BounceInCurve.html "struct bevy::prelude::BounceInCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [BounceInCurve](struct.BounceInCurve.html "struct bevy::prelude::BounceInCurve")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [BounceInCurve](struct.BounceInCurve.html "struct bevy::prelude::BounceInCurve")
