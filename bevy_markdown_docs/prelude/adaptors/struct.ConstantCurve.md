...
### impl<T> [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>
...
#### pub fn [new](#method.new)(domain: [Interval](../struct.Interval.html "struct bevy::prelude::Interval"), value: T) -> [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>
...
### impl<T> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>

where T: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/adaptors.rs.html#44)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>
...
### impl<T> [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>
...
#### fn [sample\_unchecked](../trait.Curve.html#tymethod.sample_unchecked)(&self, \_t: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> T
...
### impl<T> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>
...
### impl<'de, T> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>
...
### impl<T> [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>
...
#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/adaptors.rs.html#46)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T> as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>>
...
### impl<T> [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>
...
### impl<T> [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>
...
### impl<T> [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>
...
where [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>: 'into\_return,
...
### impl<T> [IterableCurve](../iterable/trait.IterableCurve.html "trait bevy::prelude::iterable::IterableCurve")<T> for [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<[Vec](../struct.Vec.html "struct bevy::prelude::Vec")<T>>
...
#### fn [domain](../iterable/trait.IterableCurve.html#tymethod.domain)(&self) -> [Interval](../struct.Interval.html "struct bevy::prelude::Interval")

The interval over which this curve is parametrized.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/iterable.rs.html#54)

#### fn [sample\_iter\_unchecked](../iterable/trait.IterableCurve.html#tymethod.sample_iter_unchecked)(&self, \_t: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = T>

Sample a point on this curve at the parameter value `t`, producing an iterator over values. This is the unchecked version of sampling, which should only be used if the sample time `t` is already known to lie within the curve’s domain. [Read more](../iterable/trait.IterableCurve.html#tymethod.sample_iter_unchecked)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/iterable.rs.html#29)

#### fn [sample\_iter\_clamped](../iterable/trait.IterableCurve.html#method.sample_iter_clamped)(&self, t: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = T>
...
### impl<T> [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>
...
#### fn [reflect\_owned](../trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/adaptors.rs.html#46)

#### fn [try\_into\_reflect](../trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>>) -> [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](../trait.Reflect.html#tymethod.into_any)(self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>>) -> [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../trait.Reflect.html#tymethod.into_reflect)(self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>>) -> [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<T> [SampleDerivative](../derivatives/trait.SampleDerivative.html "trait bevy::prelude::derivatives::SampleDerivative")<T> for [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>
...
#### fn [sample\_with\_derivative\_unchecked](../derivatives/trait.SampleDerivative.html#tymethod.sample_with_derivative_unchecked)(&self, \_t: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [WithDerivative](../../math/struct.WithDerivative.html "struct bevy::math::WithDerivative")<T>
...
### impl<T> [SampleTwoDerivatives](../derivatives/trait.SampleTwoDerivatives.html "trait bevy::prelude::derivatives::SampleTwoDerivatives")<T> for [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>

where T: [HasTangent](../../math/trait.HasTangent.html "trait bevy::math::HasTangent") + [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/derivatives/adaptor_impls.rs.html#32)

#### fn [sample\_with\_two\_derivatives\_unchecked](../derivatives/trait.SampleTwoDerivatives.html#tymethod.sample_with_two_derivatives_unchecked)( &self, \_t: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [WithTwoDerivatives](../../math/struct.WithTwoDerivatives.html "struct bevy::math::WithTwoDerivatives")<T>
...
### impl<T> [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>
...
### impl<T> [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>
...
### impl<T> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>

where T: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"),

### impl<T> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>
...
### impl<T> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>

where T: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>

where T: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>

where T: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<T> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>

where T: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"),

### impl<T> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ConstantCurve](../struct.ConstantCurve.html "struct bevy::prelude::ConstantCurve")<T>
