...
Curves of this type are produced by [`CurveExt::chain`](../trait.CurveExt.html#method.chain "method bevy::prelude::CurveExt::chain").

## Trait Implementations

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/adaptors.rs.html#520)

### impl<T, C, D> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ChainCurve](../struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, C, D>
...
#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ChainCurve](../struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, C, D>
...
### impl<T, C, D> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ChainCurve](../struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, C, D>
...
### impl<'de, T, C, D> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [ChainCurve](../struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, C, D>
...
### impl<T, C, D> [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [ChainCurve](../struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, C, D>
...
#### fn [from\_reflect](../trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ChainCurve](../struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, C, D>>
...
### impl<T, C, D> [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [ChainCurve](../struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, C, D>
...
### impl<T, C, D> [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [ChainCurve](../struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, C, D>
...
### impl<T, C, D> [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [ChainCurve](../struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, C, D>
...
where [ChainCurve](../struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, C, D>: 'into\_return,
...
### impl<T, C, D> [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [ChainCurve](../struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, C, D>
...
#### fn [into\_any](../trait.Reflect.html#tymethod.into_any)(self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[ChainCurve](../struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, C, D>>) -> [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../trait.Reflect.html#tymethod.into_reflect)(self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[ChainCurve](../struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, C, D>>) -> [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<T, C, D> [SampleDerivative](../derivatives/trait.SampleDerivative.html "trait bevy::prelude::derivatives::SampleDerivative")<T> for [ChainCurve](../struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, C, D>

where T: [HasTangent](../../math/trait.HasTangent.html "trait bevy::math::HasTangent"), C: [SampleDerivative](../derivatives/trait.SampleDerivative.html "trait bevy::prelude::derivatives::SampleDerivative")<T>, D: [SampleDerivative](../derivatives/trait.SampleDerivative.html "trait bevy::prelude::derivatives::SampleDerivative")<T>,
...
### impl<T, C, D> [SampleTwoDerivatives](../derivatives/trait.SampleTwoDerivatives.html "trait bevy::prelude::derivatives::SampleTwoDerivatives")<T> for [ChainCurve](../struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, C, D>
...
### impl<T, C, D> [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [ChainCurve](../struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, C, D>
...
### impl<T, C, D> [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [ChainCurve](../struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, C, D>
...
### impl<T, C, D> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ChainCurve](../struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, C, D>
...
### impl<T, C, D> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ChainCurve](../struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, C, D>
...
### impl<T, C, D> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ChainCurve](../struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, C, D>
...
### impl<T, C, D> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ChainCurve](../struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, C, D>
...
### impl<T, C, D> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ChainCurve](../struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, C, D>
...
### impl<T, C, D> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ChainCurve](../struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, C, D>
...
### impl<T, C, D> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ChainCurve](../struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, C, D>
