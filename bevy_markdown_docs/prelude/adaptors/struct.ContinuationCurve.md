[bevy](../../index.html)::[prelude](../index.html)::[adaptors](index.html)
...
Curves of this type are produced by [`CurveExt::chain_continue`](../trait.CurveExt.html#method.chain_continue "method bevy::prelude::CurveExt::chain_continue").

## Domain

The first curve’s domain must be right-finite and the second’s must be left-finite to get a valid [`ContinuationCurve`](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve").

## Trait Implementations

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/adaptors.rs.html#783)

### impl<T, C, D> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>
...
#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>
...
### impl<T, C, D> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>
...
### impl<'de, T, C, D> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>
...
### impl<T, C, D> [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>
...
#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>
...
#### fn [from\_reflect](../trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>>
...
### impl<T, C, D> [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>
...
### impl<T, C, D> [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>
...
### impl<T, C, D> [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>
...
where [ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>: 'into\_return,
...
### impl<T, C, D> [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>
...
#### fn [reflect\_owned](../trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/adaptors.rs.html#787)

#### fn [try\_into\_reflect](../trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../trait.PartialReflect.html#tymethod.into_partial_reflect)( self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>>, ) -> [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](../trait.Reflect.html#tymethod.into_any)(self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>>) -> [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../trait.Reflect.html#tymethod.into_reflect)(self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>>) -> [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<T, C, D> [SampleDerivative](../derivatives/trait.SampleDerivative.html "trait bevy::prelude::derivatives::SampleDerivative")<T> for [ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>

where T: [VectorSpace](../../math/trait.VectorSpace.html "trait bevy::math::VectorSpace"), C: [SampleDerivative](../derivatives/trait.SampleDerivative.html "trait bevy::prelude::derivatives::SampleDerivative")<T>, D: [SampleDerivative](../derivatives/trait.SampleDerivative.html "trait bevy::prelude::derivatives::SampleDerivative")<T>,
...
### impl<T, C, D> [SampleTwoDerivatives](../derivatives/trait.SampleTwoDerivatives.html "trait bevy::prelude::derivatives::SampleTwoDerivatives")<T> for [ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>

where T: [VectorSpace](../../math/trait.VectorSpace.html "trait bevy::math::VectorSpace"), C: [SampleTwoDerivatives](../derivatives/trait.SampleTwoDerivatives.html "trait bevy::prelude::derivatives::SampleTwoDerivatives")<T>, D: [SampleTwoDerivatives](../derivatives/trait.SampleTwoDerivatives.html "trait bevy::prelude::derivatives::SampleTwoDerivatives")<T>,

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/derivatives/adaptor_impls.rs.html#107)

#### fn [sample\_with\_two\_derivatives\_unchecked](../derivatives/trait.SampleTwoDerivatives.html#tymethod.sample_with_two_derivatives_unchecked)(&self, t: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [WithTwoDerivatives](../../math/struct.WithTwoDerivatives.html "struct bevy::math::WithTwoDerivatives")<T>
...
### impl<T, C, D> [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>
...
### impl<T, C, D> [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>
...
### impl<T, C, D> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>
...
### impl<T, C, D> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>
...
### impl<T, C, D> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>
...
### impl<T, C, D> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>
...
### impl<T, C, D> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>
...
### impl<T, C, D> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>
...
### impl<T, C, D> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ContinuationCurve](../struct.ContinuationCurve.html "struct bevy::prelude::ContinuationCurve")<T, C, D>
