...
### impl<T, C, D> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>
...
#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>
...
### impl<T, C, D> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>
...
### impl<'de, T, C, D> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>
...
### impl<T, C, D> [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>
...
#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/adaptors.rs.html#417)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D> as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>>
...
### impl<T, C, D> [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>
...
### impl<T, C, D> [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>
...
### impl<T, C, D> [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>
...
where [CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>: 'into\_return,
...
### impl<T, C, D> [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>
...
#### fn [reflect\_owned](../trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/adaptors.rs.html#417)

#### fn [try\_into\_reflect](../trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../trait.PartialReflect.html#tymethod.into_partial_reflect)( self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>>, ) -> [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_reflect](../trait.Reflect.html#tymethod.into_reflect)(self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>>) -> [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<V, T, C, D> [SampleDerivative](../derivatives/trait.SampleDerivative.html "trait bevy::prelude::derivatives::SampleDerivative")<T> for [CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>

where V: [VectorSpace](../../math/trait.VectorSpace.html "trait bevy::math::VectorSpace")<Scalar = [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\>, T: [HasTangent](../../math/trait.HasTangent.html "trait bevy::math::HasTangent")<Tangent = V>, C: [SampleDerivative](../derivatives/trait.SampleDerivative.html "trait bevy::prelude::derivatives::SampleDerivative")<T>, D: [SampleDerivative](../derivatives/trait.SampleDerivative.html "trait bevy::prelude::derivatives::SampleDerivative")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\>,
...
### impl<V, T, C, D> [SampleTwoDerivatives](../derivatives/trait.SampleTwoDerivatives.html "trait bevy::prelude::derivatives::SampleTwoDerivatives")<T> for [CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>

where V: [VectorSpace](../../math/trait.VectorSpace.html "trait bevy::math::VectorSpace")<Scalar = [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\>, T: [HasTangent](../../math/trait.HasTangent.html "trait bevy::math::HasTangent")<Tangent = V>, C: [SampleTwoDerivatives](../derivatives/trait.SampleTwoDerivatives.html "trait bevy::prelude::derivatives::SampleTwoDerivatives")<T>, D: [SampleTwoDerivatives](../derivatives/trait.SampleTwoDerivatives.html "trait bevy::prelude::derivatives::SampleTwoDerivatives")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\>,
...
### impl<T, C, D> [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>
...
### impl<T, C, D> [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>
...
### impl<T, C, D> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>
...
### impl<T, C, D> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>
...
### impl<T, C, D> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>
...
### impl<T, C, D> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>
...
### impl<T, C, D> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>
...
### impl<T, C, D> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>
...
### impl<T, C, D> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [CurveReparamCurve](../struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, C, D>
