...
Curves of this type are produced by [`CurveExt::forever`](../trait.CurveExt.html#method.forever "method bevy::prelude::CurveExt::forever").

## Domain

The original curve’s domain must be bounded to get a valid [`ForeverCurve`](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve").

## Trait Implementations

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/adaptors.rs.html#673)

### impl<T, C> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>
...
#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>
...
### impl<T, C> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>
...
### impl<'de, T, C> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>
...
### impl<T, C> [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>
...
#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/adaptors.rs.html#677)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C> as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>>
...
### impl<T, C> [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>
...
### impl<T, C> [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>
...
### impl<T, C> [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>
...
where [ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>: 'into\_return,
...
### impl<T, C> [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>
...
#### fn [reflect\_owned](../trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/adaptors.rs.html#677)

#### fn [try\_into\_reflect](../trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../trait.PartialReflect.html#tymethod.into_partial_reflect)( self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>>, ) -> [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](../trait.Reflect.html#tymethod.into_any)(self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>>) -> [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../trait.Reflect.html#tymethod.into_reflect)(self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>>) -> [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<T, C> [SampleDerivative](../derivatives/trait.SampleDerivative.html "trait bevy::prelude::derivatives::SampleDerivative")<T> for [ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>
...
### impl<T, C> [SampleTwoDerivatives](../derivatives/trait.SampleTwoDerivatives.html "trait bevy::prelude::derivatives::SampleTwoDerivatives")<T> for [ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>
...
### impl<T, C> [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>
...
### impl<T, C> [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>
...
### impl<T, C> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>

where C: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"),

### impl<T, C> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>
...
### impl<T, C> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>

where C: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<T, C> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>

where C: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<T, C> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>

where C: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<T, C> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>

where C: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"),

### impl<T, C> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ForeverCurve](../struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, C>
