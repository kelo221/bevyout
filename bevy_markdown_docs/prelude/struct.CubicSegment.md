...
Segments can be chained together to form a longer [compound curve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve").
...
### impl<P> [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>
...
#### pub fn [new\_bezier](#method.new_bezier)(points: [\[P; 4\]](https://doc.rust-lang.org/nightly/std/primitive.array.html)) -> [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>
...
### impl [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<[Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")\>
...
#### pub fn [new\_bezier\_easing](#method.new_bezier_easing)( p1: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")\>, p2: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")\>, ) -> [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<[Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")\>
...
### impl<P> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>

where P: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") + [VectorSpace](../math/trait.VectorSpace.html "trait bevy::math::VectorSpace"),

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#942)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>
...
### impl<P> [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>

where P: [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") + [VectorSpace](../math/trait.VectorSpace.html "trait bevy::math::VectorSpace"),
...
#### fn [sample\_unchecked](trait.Curve.html#tymethod.sample_unchecked)(&self, t: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> P
...
### impl<P> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>

where P: [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") + [VectorSpace](../math/trait.VectorSpace.html "trait bevy::math::VectorSpace"),
...
### impl<P> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>

where P: [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") + [VectorSpace](../math/trait.VectorSpace.html "trait bevy::math::VectorSpace"),

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#942)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>
...
### impl<'de, P> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>

where P: [VectorSpace](../math/trait.VectorSpace.html "trait bevy::math::VectorSpace") + [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de>,

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#943)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>, <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl<P> [Extend](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.Extend.html "trait core::iter::traits::collect::Extend")<[CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>> for [CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>
...
where T: [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>>,
...
### impl<P> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>> for [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>

where P: [VectorSpace](../math/trait.VectorSpace.html "trait bevy::math::VectorSpace"),

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#1627)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>) -> [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#946)

### impl<P> [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>>
...
### impl<P> [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>
...
### impl<P> [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>
...
### impl<P> [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>
...
where [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>: 'into\_return,
...
### impl<P> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>

where P: [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") + [VectorSpace](../math/trait.VectorSpace.html "trait bevy::math::VectorSpace"),

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#942)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl<P> [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#946)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<P> [SampleDerivative](derivatives/trait.SampleDerivative.html "trait bevy::prelude::derivatives::SampleDerivative")<P> for [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>

where P: [VectorSpace](../math/trait.VectorSpace.html "trait bevy::math::VectorSpace")<Scalar = [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\>,

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/curve_impls.rs.html#27)

#### fn [sample\_with\_derivative\_unchecked](derivatives/trait.SampleDerivative.html#tymethod.sample_with_derivative_unchecked)(&self, t: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [WithDerivative](../math/struct.WithDerivative.html "struct bevy::math::WithDerivative")<P>
...
### impl<P> [SampleTwoDerivatives](derivatives/trait.SampleTwoDerivatives.html "trait bevy::prelude::derivatives::SampleTwoDerivatives")<P> for [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>

where P: [VectorSpace](../math/trait.VectorSpace.html "trait bevy::math::VectorSpace")<Scalar = [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\>,

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/curve_impls.rs.html#37)

#### fn [sample\_with\_two\_derivatives\_unchecked](derivatives/trait.SampleTwoDerivatives.html#tymethod.sample_with_two_derivatives_unchecked)(&self, t: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [WithTwoDerivatives](../math/struct.WithTwoDerivatives.html "struct bevy::math::WithTwoDerivatives")<P>

Sample this curve at the parameter value `t`, extracting the associated value in addition to two derivatives. This is the unchecked version of sampling, which should only be used if the sample time `t` is already known to lie within the curve’s domain. [Read more](derivatives/trait.SampleTwoDerivatives.html#tymethod.sample_with_two_derivatives_unchecked)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/derivatives/mod.rs.html#132)

#### fn [sample\_with\_two\_derivatives](derivatives/trait.SampleTwoDerivatives.html#method.sample_with_two_derivatives)(&self, t: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[WithTwoDerivatives](../math/struct.WithTwoDerivatives.html "struct bevy::math::WithTwoDerivatives")<T>>
...
#### fn [sample\_with\_two\_derivatives\_clamped](derivatives/trait.SampleTwoDerivatives.html#method.sample_with_two_derivatives_clamped)(&self, t: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [WithTwoDerivatives](../math/struct.WithTwoDerivatives.html "struct bevy::math::WithTwoDerivatives")<T>

Sample this curve’s value and two derivatives at the parameter value `t`, clamping `t` to lie inside the domain of the curve.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#943)

### impl<P> [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>

where P: [VectorSpace](../math/trait.VectorSpace.html "trait bevy::math::VectorSpace") + [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"),
...
### impl<P> [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>
...
### impl<P> [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>
...
### impl<P> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>

where P: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"),

### impl<P> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>
...
### impl<P> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>

where P: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<P> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>

where P: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<P> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>

where P: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<P> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>

where P: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"),

### impl<P> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [CubicSegment](struct.CubicSegment.html "struct bevy::prelude::CubicSegment")<P>
...
### impl<T, C> [AnimationCompatibleCurve](trait.AnimationCompatibleCurve.html "trait bevy::prelude::AnimationCompatibleCurve")<T> for C

where C: [Curve](trait.Curve.html "trait bevy::prelude::Curve")<T> + [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") + [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") + [Reflectable](../reflect/trait.Reflectable.html "trait bevy::reflect::Reflectable"),
...
### impl<T, C> [CurveWithTwoDerivatives](derivatives/trait.CurveWithTwoDerivatives.html "trait bevy::prelude::derivatives::CurveWithTwoDerivatives")<T> for C

where T: [HasTangent](../math/trait.HasTangent.html "trait bevy::math::HasTangent"), C: [SampleTwoDerivatives](derivatives/trait.SampleTwoDerivatives.html "trait bevy::prelude::derivatives::SampleTwoDerivatives")<T> + [CurveWithDerivative](derivatives/trait.CurveWithDerivative.html "trait bevy::prelude::derivatives::CurveWithDerivative")<T>,

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/derivatives/mod.rs.html#227)

#### fn [with\_two\_derivatives](derivatives/trait.CurveWithTwoDerivatives.html#tymethod.with_two_derivatives)(self) -> [SampleTwoDerivativesWrapper](derivatives/struct.SampleTwoDerivativesWrapper.html "struct bevy::prelude::derivatives::SampleTwoDerivativesWrapper")<C>

This curve, but with its first two derivatives included in sampling. [Read more](derivatives/trait.CurveWithTwoDerivatives.html#tymethod.with_two_derivatives)
