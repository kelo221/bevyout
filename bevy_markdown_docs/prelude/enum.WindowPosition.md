...
Used at creation but will be changed to [`At`](enum.WindowPosition.html#variant.At "variant bevy::prelude::WindowPosition::At").

### Centered([MonitorSelection](enum.MonitorSelection.html "enum bevy::prelude::MonitorSelection"))

Window will be centered on the selected monitor.

Note that this does not account for window decorations.

Used at creation or for update but will be changed to [`At`](enum.WindowPosition.html#variant.At "variant bevy::prelude::WindowPosition::At")

### At([IVec2](struct.IVec2.html "struct bevy::prelude::IVec2"))
...
### impl [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#825)

#### pub fn [new](#method.new)(position: [IVec2](struct.IVec2.html "struct bevy::prelude::IVec2")) -> [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")

Creates a new [`WindowPosition`](enum.WindowPosition.html "enum bevy::prelude::WindowPosition") at a position.
...
#### pub fn [set](#method.set)(&mut self, position: [IVec2](struct.IVec2.html "struct bevy::prelude::IVec2"))
...
#### pub fn [center](#method.center)(&mut self, monitor: [MonitorSelection](enum.MonitorSelection.html "enum bevy::prelude::MonitorSelection"))
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#793)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#793)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#793)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")
...
### impl [Enum](../reflect/enums/trait.Enum.html "trait bevy::reflect::enums::Enum") for [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")
...
### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#796)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#796)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)( \_\_param0: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")
...
where [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#793)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_window/0.19.0/x86_64-unknown-linux-gnu/src/bevy_window/window.rs.html#796)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [WindowPosition](enum.WindowPosition.html "enum bevy::prelude::WindowPosition")
