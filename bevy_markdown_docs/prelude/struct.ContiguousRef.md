...
Data type returned by [`ContiguousQueryData::fetch_contiguous`](../ecs/query/trait.ContiguousQueryData.html#tymethod.fetch_contiguous "associated function bevy::ecs::query::ContiguousQueryData::fetch_contiguous") for [`Ref<T>`](struct.Ref.html "struct bevy::prelude::Ref").

## Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/params.rs.html#748)

### impl<'w, T> [ContiguousRef](struct.ContiguousRef.html "struct bevy::prelude::ContiguousRef")<'w, T>
...
#### pub fn [added\_ticks\_slice](#method.added_ticks_slice)(&self) -> &'w \[[Tick](../ecs/change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick")\]
...
#### pub fn [changed\_ticks\_slice](#method.changed_ticks_slice)(&self) -> &'w \[[Tick](../ecs/change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick")\]
...
#### pub fn [changed\_by\_ticks\_slice](#method.changed_by_ticks_slice)( &self, ) -> [MaybeLocation](../ecs/change_detection/struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<&\[&'static [Location](https://doc.rust-lang.org/nightly/core/panic/location/struct.Location.html "struct core::panic::location::Location")<'static>\]>
...
#### pub fn [new](#method.new)( value: &'w [\[T\]](https://doc.rust-lang.org/nightly/std/primitive.slice.html), added: &'w \[[Tick](../ecs/change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick")\], changed: &'w \[[Tick](../ecs/change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick")\], last\_run: [Tick](../ecs/change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"), this\_run: [Tick](../ecs/change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"), caller: [MaybeLocation](../ecs/change_detection/struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<&'w \[&'static [Location](https://doc.rust-lang.org/nightly/core/panic/location/struct.Location.html "struct core::panic::location::Location")<'static>\]>, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ContiguousRef](struct.ContiguousRef.html "struct bevy::prelude::ContiguousRef")<'w, T>>
...
#### pub fn [split](#method.split)( this: [ContiguousRef](struct.ContiguousRef.html "struct bevy::prelude::ContiguousRef")<'w, T>, ) -> (&'w [\[T\]](https://doc.rust-lang.org/nightly/std/primitive.slice.html), [ContiguousComponentTicksRef](../ecs/change_detection/struct.ContiguousComponentTicksRef.html "struct bevy::ecs::change_detection::ContiguousComponentTicksRef")<'w>)

Splits [`ContiguousRef`](struct.ContiguousRef.html "struct bevy::prelude::ContiguousRef") into it’s inner data types.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/params.rs.html#821)

#### pub fn [from\_parts](#method.from_parts)( value: &'w [\[T\]](https://doc.rust-lang.org/nightly/std/primitive.slice.html), ticks: [ContiguousComponentTicksRef](../ecs/change_detection/struct.ContiguousComponentTicksRef.html "struct bevy::ecs::change_detection::ContiguousComponentTicksRef")<'w>, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ContiguousRef](struct.ContiguousRef.html "struct bevy::prelude::ContiguousRef")<'w, T>>

Reverse of [`ContiguousRef::split`](struct.ContiguousRef.html#method.split "associated function bevy::prelude::ContiguousRef::split"), constructing a [`ContiguousRef`](struct.ContiguousRef.html "struct bevy::prelude::ContiguousRef") using components’ values and ticks.

Returns [`None`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.None "variant core::option::Option::None") if lengths of `value` and `ticks` do not match, which doesn’t happen if `ticks` and `value` come from the same [`Self::split`](struct.ContiguousRef.html#method.split "associated function bevy::prelude::ContiguousRef::split") call.
...
### impl<'w, T> [AsRef](https://doc.rust-lang.org/nightly/core/convert/trait.AsRef.html "trait core::convert::AsRef")<[\[T\]](https://doc.rust-lang.org/nightly/std/primitive.slice.html)\> for [ContiguousRef](struct.ContiguousRef.html "struct bevy::prelude::ContiguousRef")<'w, T>
...
### impl<'w, T> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ContiguousRef](struct.ContiguousRef.html "struct bevy::prelude::ContiguousRef")<'w, T>

where T: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/params.rs.html#742)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ContiguousRef](struct.ContiguousRef.html "struct bevy::prelude::ContiguousRef")<'w, T>
...
### impl<'w, T> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ContiguousRef](struct.ContiguousRef.html "struct bevy::prelude::ContiguousRef")<'w, T>
...
### impl<'w, T> [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [ContiguousRef](struct.ContiguousRef.html "struct bevy::prelude::ContiguousRef")<'w, T>
...
#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[ContiguousRef](struct.ContiguousRef.html "struct bevy::prelude::ContiguousRef")<'w, T> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")
...
### impl<'w, T> [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") for [ContiguousRef](struct.ContiguousRef.html "struct bevy::prelude::ContiguousRef")<'w, T>
...
#### fn [into\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)(self) -> <[ContiguousRef](struct.ContiguousRef.html "struct bevy::prelude::ContiguousRef")<'w, T> as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter "type core::iter::traits::collect::IntoIterator::IntoIter")

Creates an iterator from a value. [Read more](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)

## Auto Trait Implementations

### impl<'w, T> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ContiguousRef](struct.ContiguousRef.html "struct bevy::prelude::ContiguousRef")<'w, T>

### impl<'w, T> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ContiguousRef](struct.ContiguousRef.html "struct bevy::prelude::ContiguousRef")<'w, T>
...
### impl<'w, T> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ContiguousRef](struct.ContiguousRef.html "struct bevy::prelude::ContiguousRef")<'w, T>

where T: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<'w, T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ContiguousRef](struct.ContiguousRef.html "struct bevy::prelude::ContiguousRef")<'w, T>

where T: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<'w, T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ContiguousRef](struct.ContiguousRef.html "struct bevy::prelude::ContiguousRef")<'w, T>

### impl<'w, T> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ContiguousRef](struct.ContiguousRef.html "struct bevy::prelude::ContiguousRef")<'w, T>

### impl<'w, T> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ContiguousRef](struct.ContiguousRef.html "struct bevy::prelude::ContiguousRef")<'w, T>
