...
To use this component, place it on the same entity as the [`AnimationPlayer`](struct.AnimationPlayer.html "struct bevy::prelude::AnimationPlayer") and [`AnimationGraphHandle`](struct.AnimationGraphHandle.html "struct bevy::prelude::AnimationGraphHandle"). It’ll take responsibility for adjusting the weight on the [`ActiveAnimation`](../animation/struct.ActiveAnimation.html "struct bevy::animation::ActiveAnimation") in order to fade out animations smoothly.

When using an [`AnimationTransitions`](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions") component, you should play all animations through the [`AnimationTransitions::play`](struct.AnimationTransitions.html#method.play "method bevy::prelude::AnimationTransitions::play") method, rather than by directly manipulating the [`AnimationPlayer`](struct.AnimationPlayer.html "struct bevy::prelude::AnimationPlayer"). Playing animations through the [`AnimationPlayer`](struct.AnimationPlayer.html "struct bevy::prelude::AnimationPlayer") directly will cause the [`AnimationTransitions`](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions") component to get confused about which animation is the “main” animation, and transitions will usually be incorrect as a result.

## Implementations

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/transition.rs.html#65)

### impl [AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/transition.rs.html#68)

#### pub fn [new](#method.new)() -> [AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")

Creates a new [`AnimationTransitions`](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions") component, ready to be added to an entity with an [`AnimationPlayer`](struct.AnimationPlayer.html "struct bevy::prelude::AnimationPlayer").
...
#### pub fn [play](#method.play)<'p>( &mut self, player: &'p mut [AnimationPlayer](struct.AnimationPlayer.html "struct bevy::prelude::AnimationPlayer"), new\_animation: [NodeIndex](https://docs.rs/petgraph/0.8.3/x86_64-unknown-linux-gnu/petgraph/graph_impl/struct.NodeIndex.html "struct petgraph::graph_impl::NodeIndex"), transition\_duration: [Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration"), ) -> &'p mut [ActiveAnimation](../animation/struct.ActiveAnimation.html "struct bevy::animation::ActiveAnimation")

Plays a new animation on the given [`AnimationPlayer`](struct.AnimationPlayer.html "struct bevy::prelude::AnimationPlayer"), fading out any existing animations that were already playing over the `transition_duration`.
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/transition.rs.html#40)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")
...
#### fn [clone\_from](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#method.clone_from)(&mut self, source: &[AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions"))
...
### impl [Component](trait.Component.html "trait bevy::prelude::Component") for [AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")

where [AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/transition.rs.html#31)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/transition.rs.html#31)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/transition.rs.html#31)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/transition.rs.html#31)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")
...
where [AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions"): 'into\_return,
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/transition.rs.html#31)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")\>, ) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AnimationTransitions](struct.AnimationTransitions.html "struct bevy::prelude::AnimationTransitions")
