...
[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#81)
...
`0: [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [AnimationCurve](trait.AnimationCurve.html "trait bevy::prelude::AnimationCurve")>`

## Implementations

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#89)

### impl [VariableCurve](struct.VariableCurve.html "struct bevy::prelude::VariableCurve")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#93)

#### pub fn [new](#method.new)(animation\_curve: impl [AnimationCurve](trait.AnimationCurve.html "trait bevy::prelude::AnimationCurve")) -> [VariableCurve](struct.VariableCurve.html "struct bevy::prelude::VariableCurve")

Create a new [`VariableCurve`](struct.VariableCurve.html "struct bevy::prelude::VariableCurve") from an [animation curve](trait.AnimationCurve.html "trait bevy::prelude::AnimationCurve").

## Trait Implementations

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#83)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [VariableCurve](struct.VariableCurve.html "struct bevy::prelude::VariableCurve")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#84)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [VariableCurve](struct.VariableCurve.html "struct bevy::prelude::VariableCurve")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [VariableCurve](struct.VariableCurve.html "struct bevy::prelude::VariableCurve")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [VariableCurve](struct.VariableCurve.html "struct bevy::prelude::VariableCurve")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [VariableCurve](struct.VariableCurve.html "struct bevy::prelude::VariableCurve")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [VariableCurve](struct.VariableCurve.html "struct bevy::prelude::VariableCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [VariableCurve](struct.VariableCurve.html "struct bevy::prelude::VariableCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [VariableCurve](struct.VariableCurve.html "struct bevy::prelude::VariableCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [VariableCurve](struct.VariableCurve.html "struct bevy::prelude::VariableCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [VariableCurve](struct.VariableCurve.html "struct bevy::prelude::VariableCurve")
