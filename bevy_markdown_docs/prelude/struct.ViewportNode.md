...
[`update_viewport_render_target_size`](../ui/widget/fn.update_viewport_render_target_size.html "fn bevy::ui::widget::update_viewport_render_target_size")

## Fields

`camera: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Entity](struct.Entity.html "struct bevy::prelude::Entity")>`

The entity representing the [`Camera`](struct.Camera.html "struct bevy::prelude::Camera") associated with this viewport.

Note: Removing the [`ViewportNode`](struct.ViewportNode.html "struct bevy::prelude::ViewportNode") component will not despawn this entity.

Note: Despawning the camera entity will leave a viewport node with an invalid camera. It will automatically be set to none when [`update_viewport_render_target_size`](../ui/widget/fn.update_viewport_render_target_size.html "fn bevy::ui::widget::update_viewport_render_target_size") runs next.

## Implementations

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/widget/viewport.rs.html#55)

### impl [ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/widget/viewport.rs.html#58)

#### pub const fn [new](#method.new)(camera: [Entity](struct.Entity.html "struct bevy::prelude::Entity")) -> [ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")

Creates a new [`ViewportNode`](struct.ViewportNode.html "struct bevy::prelude::ViewportNode") with a given `camera`.
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/widget/viewport.rs.html#36)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")
...
### impl [Component](trait.Component.html "trait bevy::prelude::Component") for [ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")

where [ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

**Required Components**: [`Node`](struct.Node.html "struct bevy::prelude::Node"), [`PointerId`](../picking/pointer/enum.PointerId.html "enum bevy::picking::pointer::PointerId").
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/widget/viewport.rs.html#36)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")
...
### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/widget/viewport.rs.html#36)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/widget/viewport.rs.html#36)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")
...
where [ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode"): 'into\_return,
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/widget/viewport.rs.html#36)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ViewportNode](struct.ViewportNode.html "struct bevy::prelude::ViewportNode")
