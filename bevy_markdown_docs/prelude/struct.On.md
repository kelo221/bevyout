...
`On` contains the triggered [`Event`](trait.Event.html "trait bevy::prelude::Event") data for a given run of an `Observer`. It also provides access to the [`Trigger`](../ecs/event/trait.Trigger.html "trait bevy::ecs::event::Trigger"), which for things like [`EntityEvent`](trait.EntityEvent.html "trait bevy::prelude::EntityEvent") with a [`PropagateEntityTrigger`](../ecs/event/struct.PropagateEntityTrigger.html "struct bevy::ecs::event::PropagateEntityTrigger"), includes control over event propagation.
...
This is used to avoid providing a generic argument in your event, as is done for [`Add`](struct.Add.html "struct bevy::prelude::Add") and the other lifecycle events.
...
### impl<'w, 't, E, B> [On](struct.On.html "struct bevy::prelude::On")<'w, 't, E, B>
...
#### pub fn [new](#method.new)( event: [&'w mut E](https://doc.rust-lang.org/nightly/std/primitive.reference.html), observer: [Entity](struct.Entity.html "struct bevy::prelude::Entity"), trigger: &'w mut <E as [Event](trait.Event.html "trait bevy::prelude::Event")\>::[Trigger](trait.Event.html#associatedtype.Trigger "type bevy::prelude::Event::Trigger")<'t>, trigger\_context: &'w [TriggerContext](../ecs/observer/struct.TriggerContext.html "struct bevy::ecs::observer::TriggerContext"), ) -> [On](struct.On.html "struct bevy::prelude::On")<'w, 't, E, B>

Creates a new instance of [`On`](struct.On.html "struct bevy::prelude::On") for the given triggered event.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/observer/system_param.rs.html#67)

#### pub fn [event\_key](#method.event_key)(&self) -> [EventKey](../ecs/event/struct.EventKey.html "struct bevy::ecs::event::EventKey")

Returns the event type of this [`On`](struct.On.html "struct bevy::prelude::On") instance.
...
#### pub fn [event\_ptr](#method.event_ptr)(&self) -> [Ptr](../ecs/ptr/struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'\_>
...
#### pub fn [trigger](#method.trigger)(&self) -> &<E as [Event](trait.Event.html "trait bevy::prelude::Event")\>::[Trigger](trait.Event.html#associatedtype.Trigger "type bevy::prelude::Event::Trigger")<'t>

Returns the [`Trigger`](../ecs/event/trait.Trigger.html "trait bevy::ecs::event::Trigger") context for this event.
...
#### pub fn [trigger\_mut](#method.trigger_mut)(&mut self) -> &mut <E as [Event](trait.Event.html "trait bevy::prelude::Event")\>::[Trigger](trait.Event.html#associatedtype.Trigger "type bevy::prelude::Event::Trigger")<'t>

Returns the mutable [`Trigger`](../ecs/event/trait.Trigger.html "trait bevy::ecs::event::Trigger") context for this event.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/observer/system_param.rs.html#118)

#### pub fn [observer](#method.observer)(&self) -> [Entity](struct.Entity.html "struct bevy::prelude::Entity")

Returns the [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") of the [`Observer`](struct.Observer.html "struct bevy::prelude::Observer") of the triggered event. This allows you to despawn the observer, ceasing observation.
...
#### pub fn [caller](#method.caller)(&self) -> [MaybeLocation](../ecs/change_detection/struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")
...
### impl<'w, 't, const AUTO\_PROPAGATE: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), E, B, T> [On](struct.On.html "struct bevy::prelude::On")<'w, 't, E, B>

where E: [EntityEvent](trait.EntityEvent.html "trait bevy::prelude::EntityEvent")<Trigger<'a> = [PropagateEntityTrigger](../ecs/event/struct.PropagateEntityTrigger.html "struct bevy::ecs::event::PropagateEntityTrigger")<AUTO\_PROPAGATE, E, T>> + for<'a> [Event](trait.Event.html "trait bevy::prelude::Event"), B: [Bundle](trait.Bundle.html "trait bevy::prelude::Bundle"), T: [Traversal](../ecs/traversal/trait.Traversal.html "trait bevy::ecs::traversal::Traversal")<E>,

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/observer/system_param.rs.html#139)

#### pub fn [original\_event\_target](#method.original_event_target)(&self) -> [Entity](struct.Entity.html "struct bevy::prelude::Entity")

Returns the original [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") that this [`EntityEvent`](trait.EntityEvent.html "trait bevy::prelude::EntityEvent") targeted via [`EntityEvent::event_target`](trait.EntityEvent.html#tymethod.event_target "method bevy::prelude::EntityEvent::event_target") when it was _first_ triggered, prior to any propagation logic.
...
The path an [`EntityEvent`](trait.EntityEvent.html "trait bevy::prelude::EntityEvent") will propagate along is specified by the [`Traversal`](../ecs/traversal/trait.Traversal.html "trait bevy::ecs::traversal::Traversal") component defined in [`PropagateEntityTrigger`](../ecs/event/struct.PropagateEntityTrigger.html "struct bevy::ecs::event::PropagateEntityTrigger").

[`EntityEvent`](trait.EntityEvent.html "trait bevy::prelude::EntityEvent") does not propagate by default. To enable propagation, you must:

*   Enable propagation in [`EntityEvent`](trait.EntityEvent.html "trait bevy::prelude::EntityEvent") using `#[entity_event(propagate)]`. See [`EntityEvent`](trait.EntityEvent.html "trait bevy::prelude::EntityEvent") for details.
*   Either call `propagate(true)` in the first observer or in the [`EntityEvent`](trait.EntityEvent.html "trait bevy::prelude::EntityEvent") derive add `#[entity_event(auto_propagate)]`.

You can prevent an event from propagating further using `propagate(false)`. This will prevent the event from triggering on the next [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") in the [`Traversal`](../ecs/traversal/trait.Traversal.html "trait bevy::ecs::traversal::Traversal"), but note that all remaining observers for the _current_ entity will still run.
...
Returns the value of the flag that controls event propagation. See [`propagate`](struct.On.html#method.propagate "method bevy::prelude::On::propagate") for more information.

## Trait Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/observer/system_param.rs.html#168)

### impl<'w, 't, E, B> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [On](struct.On.html "struct bevy::prelude::On")<'w, 't, E, B>

where E: for<'a> [Event](trait.Event.html "trait bevy::prelude::Event") + [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug"), <E as [Event](trait.Event.html "trait bevy::prelude::Event")\>::[Trigger](trait.Event.html#associatedtype.Trigger "type bevy::prelude::Event::Trigger")<'a>: for<'a> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug"), B: [Bundle](trait.Bundle.html "trait bevy::prelude::Bundle"),
...
### impl<'w, 't, E, B> [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [On](struct.On.html "struct bevy::prelude::On")<'w, 't, E, B>
...
#### type [Param](trait.SystemInput.html#associatedtype.Param)<'i> = [On](struct.On.html "struct bevy::prelude::On")<'i, 'i, E, B>
...
#### type [Inner](trait.SystemInput.html#associatedtype.Inner)<'i> = [On](struct.On.html "struct bevy::prelude::On")<'i, 'i, E, B>
...
#### fn [wrap](trait.SystemInput.html#tymethod.wrap)( this: <[On](struct.On.html "struct bevy::prelude::On")<'\_, '\_, E, B> as [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput")\>::[Inner](trait.SystemInput.html#associatedtype.Inner "type bevy::prelude::SystemInput::Inner")<'\_>, ) -> <[On](struct.On.html "struct bevy::prelude::On")<'\_, '\_, E, B> as [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput")\>::[Param](trait.SystemInput.html#associatedtype.Param "type bevy::prelude::SystemInput::Param")<'\_>
...
### impl<'w, 't, E, B = [()](https://doc.rust-lang.org/nightly/std/primitive.unit.html)\> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [On](struct.On.html "struct bevy::prelude::On")<'w, 't, E, B>

### impl<'w, 't, E, B> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [On](struct.On.html "struct bevy::prelude::On")<'w, 't, E, B>

### impl<'w, 't, E, B> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [On](struct.On.html "struct bevy::prelude::On")<'w, 't, E, B>

where E: [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"), <E as [Event](trait.Event.html "trait bevy::prelude::Event")\>::[Trigger](trait.Event.html#associatedtype.Trigger "type bevy::prelude::Event::Trigger")<'t>: [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"), B: [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"),

### impl<'w, 't, E, B> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [On](struct.On.html "struct bevy::prelude::On")<'w, 't, E, B>

where <E as [Event](trait.Event.html "trait bevy::prelude::Event")\>::[Trigger](trait.Event.html#associatedtype.Trigger "type bevy::prelude::Event::Trigger")<'t>: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<'w, 't, E, B> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [On](struct.On.html "struct bevy::prelude::On")<'w, 't, E, B>

where <E as [Event](trait.Event.html "trait bevy::prelude::Event")\>::[Trigger](trait.Event.html#associatedtype.Trigger "type bevy::prelude::Event::Trigger")<'t>: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<'w, 't, E, B> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [On](struct.On.html "struct bevy::prelude::On")<'w, 't, E, B>

where B: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<'w, 't, E, B> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [On](struct.On.html "struct bevy::prelude::On")<'w, 't, E, B>
...
### impl<In> [FromInput](../ecs/system/trait.FromInput.html "trait bevy::ecs::system::FromInput")<In> for In

where In: [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/input.rs.html#71)

#### fn [from\_inner](../ecs/system/trait.FromInput.html#tymethod.from_inner)<'i>( inner: <In as [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput")\>::[Inner](trait.SystemInput.html#associatedtype.Inner "type bevy::prelude::SystemInput::Inner")<'i>, ) -> <In as [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput")\>::[Inner](trait.SystemInput.html#associatedtype.Inner "type bevy::prelude::SystemInput::Inner")<'i>
