...
This [`SystemParam`](../ecs/system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam") fails validation if no matching entities exist. This will cause the system to be skipped, according to the rules laid out in [`SystemParamValidationError`](../ecs/system/struct.SystemParamValidationError.html "struct bevy::ecs::system::SystemParamValidationError").

Much like [`Query::is_empty`](struct.Query.html#method.is_empty "method bevy::prelude::Query::is_empty") the worst case runtime will be `O(n)` where `n` is the number of _potential_ matches. This can be notably expensive for queries that rely on non-archetypal filters such as [`Added`](struct.Added.html "struct bevy::prelude::Added"), [`Changed`](struct.Changed.html "struct bevy::prelude::Changed") of [`Spawned`](../ecs/query/struct.Spawned.html "struct bevy::ecs::query::Spawned") which must individually check each query result for a match.

See [`Query`](struct.Query.html "struct bevy::prelude::Query") for more details.

If the system doesn’t need to perform the query but should still be skipped if it is empty, you may use the [`any_with_component`](fn.any_with_component.html "fn bevy::prelude::any_with_component") or [`any_match_filter`](fn.any_match_filter.html "fn bevy::prelude::any_match_filter") run conditions.

## Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/query.rs.html#2908)

### impl<'w, 's, D, F> [Populated](struct.Populated.html "struct bevy::prelude::Populated")<'w, 's, D, F>
...
#### pub fn [into\_inner](#method.into_inner)(self) -> [Query](struct.Query.html "struct bevy::prelude::Query")<'w, 's, D, F>

Returns the inner item with ownership.

## Methods from [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")<Target = [Query](struct.Query.html "struct bevy::prelude::Query")<'w, 's, D, F>>
...
### impl<'w, 's, D, F> [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [Populated](struct.Populated.html "struct bevy::prelude::Populated")<'w, 's, D, F>

where D: [QueryData](../ecs/query/trait.QueryData.html "trait bevy::ecs::query::QueryData"), F: [QueryFilter](../ecs/query/trait.QueryFilter.html "trait bevy::ecs::query::QueryFilter"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/query.rs.html#2895)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = [Query](struct.Query.html "struct bevy::prelude::Query")<'w, 's, D, F>

The resulting type after dereferencing.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/query.rs.html#2897)

#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[Populated](struct.Populated.html "struct bevy::prelude::Populated")<'w, 's, D, F> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/query.rs.html#2902)

### impl<D, F> [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [Populated](struct.Populated.html "struct bevy::prelude::Populated")<'\_, '\_, D, F>

where D: [QueryData](../ecs/query/trait.QueryData.html "trait bevy::ecs::query::QueryData"), F: [QueryFilter](../ecs/query/trait.QueryFilter.html "trait bevy::ecs::query::QueryFilter"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/query.rs.html#2903)

#### fn [deref\_mut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html#tymethod.deref_mut)(&mut self) -> &mut <[Populated](struct.Populated.html "struct bevy::prelude::Populated")<'\_, '\_, D, F> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Mutably dereferences the value.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/query.rs.html#2915)

### impl<'w, 's, D, F> [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") for [Populated](struct.Populated.html "struct bevy::prelude::Populated")<'w, 's, D, F>
...
#### fn [into\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)(self) -> <[Populated](struct.Populated.html "struct bevy::prelude::Populated")<'w, 's, D, F> as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter "type core::iter::traits::collect::IntoIterator::IntoIter")
...
### impl<'a, 'w, 's, D, F> [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") for &'a [Populated](struct.Populated.html "struct bevy::prelude::Populated")<'w, 's, D, F>

where D: [QueryData](../ecs/query/trait.QueryData.html "trait bevy::ecs::query::QueryData"), F: [QueryFilter](../ecs/query/trait.QueryFilter.html "trait bevy::ecs::query::QueryFilter"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/query.rs.html#2926)

#### type [Item](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.Item) = <&'a [Query](struct.Query.html "struct bevy::prelude::Query")<'w, 's, D, F> as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[Item](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.Item "type core::iter::traits::collect::IntoIterator::Item")

The type of the elements being iterated over.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/query.rs.html#2928)

#### type [IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter) = <&'a [Query](struct.Query.html "struct bevy::prelude::Query")<'w, 's, D, F> as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter "type core::iter::traits::collect::IntoIterator::IntoIter")

Which kind of iterator are we turning this into?

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/query.rs.html#2930)

#### fn [into\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)(self) -> <&'a [Populated](struct.Populated.html "struct bevy::prelude::Populated")<'w, 's, D, F> as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter "type core::iter::traits::collect::IntoIterator::IntoIter")

Creates an iterator from a value. [Read more](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/query.rs.html#2935-2936)

### impl<'a, 'w, 's, D, F> [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") for &'a mut [Populated](struct.Populated.html "struct bevy::prelude::Populated")<'w, 's, D, F>

where D: [IterQueryData](../ecs/query/trait.IterQueryData.html "trait bevy::ecs::query::IterQueryData"), F: [QueryFilter](../ecs/query/trait.QueryFilter.html "trait bevy::ecs::query::QueryFilter"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/query.rs.html#2938)

#### type [Item](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.Item) = <&'a mut [Query](struct.Query.html "struct bevy::prelude::Query")<'w, 's, D, F> as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[Item](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.Item "type core::iter::traits::collect::IntoIterator::Item")

The type of the elements being iterated over.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/query.rs.html#2940)

#### type [IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter) = <&'a mut [Query](struct.Query.html "struct bevy::prelude::Query")<'w, 's, D, F> as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter "type core::iter::traits::collect::IntoIterator::IntoIter")

Which kind of iterator are we turning this into?

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/query.rs.html#2942)

#### fn [into\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)( self, ) -> <&'a mut [Populated](struct.Populated.html "struct bevy::prelude::Populated")<'w, 's, D, F> as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter "type core::iter::traits::collect::IntoIterator::IntoIter")

Creates an iterator from a value. [Read more](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#433-434)

### impl<'w, 's, D, F> [ReadOnlySystemParam](../ecs/system/trait.ReadOnlySystemParam.html "trait bevy::ecs::system::ReadOnlySystemParam") for [Populated](struct.Populated.html "struct bevy::prelude::Populated")<'w, 's, D, F>
...
### impl<D, F> [SystemParam](../ecs/system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam") for [Populated](struct.Populated.html "struct bevy::prelude::Populated")<'\_, '\_, D, F>
...
#### type [Item](../ecs/system/trait.SystemParam.html#associatedtype.Item)<'w, 's> = [Populated](struct.Populated.html "struct bevy::prelude::Populated")<'w, 's, D, F>
...
### impl<'w, 's, D, F = [()](https://doc.rust-lang.org/nightly/std/primitive.unit.html)\> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Populated](struct.Populated.html "struct bevy::prelude::Populated")<'w, 's, D, F>

### impl<'w, 's, D, F = [()](https://doc.rust-lang.org/nightly/std/primitive.unit.html)\> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Populated](struct.Populated.html "struct bevy::prelude::Populated")<'w, 's, D, F>

### impl<'w, 's, D, F> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Populated](struct.Populated.html "struct bevy::prelude::Populated")<'w, 's, D, F>

### impl<'w, 's, D, F> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Populated](struct.Populated.html "struct bevy::prelude::Populated")<'w, 's, D, F>

### impl<'w, 's, D, F> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Populated](struct.Populated.html "struct bevy::prelude::Populated")<'w, 's, D, F>

### impl<'w, 's, D, F> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Populated](struct.Populated.html "struct bevy::prelude::Populated")<'w, 's, D, F>

### impl<'w, 's, D, F> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Populated](struct.Populated.html "struct bevy::prelude::Populated")<'w, 's, D, F>
