...
This trait should only be used as a bound for trait implementations or as an argument to a function. If a system needs to be returned from a function or stored somewhere, use [`System`](trait.System.html "trait bevy::prelude::System") instead of this trait.
...
#### type [System](#associatedtype.System): [System](trait.System.html "trait bevy::prelude::System")<In = In, Out = Out>
...
#### fn [into\_system](#tymethod.into_system)(this: Self) -> Self::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System")
...
#### fn [pipe](#method.pipe)<B, BIn, BOut, MarkerB>(self, system: B) -> [IntoPipeSystem](../ecs/system/struct.IntoPipeSystem.html "struct bevy::ecs::system::IntoPipeSystem")<Self, B>
...
The second system must have [`In<T>`](struct.In.html "struct bevy::prelude::In") as its first parameter, where `T` is the return type of the first system.
...
#### fn [map](#method.map)<T, F>(self, f: F) -> [IntoAdapterSystem](../ecs/system/struct.IntoAdapterSystem.html "struct bevy::ecs::system::IntoAdapterSystem")<F, Self>
...
#### fn [with\_input](#method.with_input)<T>(self, value: T) -> [WithInputWrapper](../ecs/system/struct.WithInputWrapper.html "struct bevy::ecs::system::WithInputWrapper")<Self::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System"), T>
...
`Self` can have any [`SystemInput`](trait.SystemInput.html "trait bevy::prelude::SystemInput") type that takes a mutable reference to `T`, such as [`InMut`](struct.InMut.html "struct bevy::prelude::InMut").
...
#### fn [with\_input\_from](#method.with_input_from)<T>(self) -> [WithInputFromWrapper](../ecs/system/struct.WithInputFromWrapper.html "struct bevy::ecs::system::WithInputFromWrapper")<Self::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System"), T>
...
Passes a mutable reference to a value of type `T` created via [`FromWorld`](trait.FromWorld.html "trait bevy::prelude::FromWorld") as input to the system each run, turning it into a system that takes no input.
...
### impl<A, B, IA, OA, IB, OB, MA, MB> [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<IA, OB, (IsPipeSystemMarker, OA, IB, MA, MB)> for [IntoPipeSystem](../ecs/system/struct.IntoPipeSystem.html "struct bevy::ecs::system::IntoPipeSystem")<A, B>

where IA: [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput"), A: [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<IA, OA, MA>, B: [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<IB, OB, MB>, IB: for<'a> [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput")<Inner<'a> = OA>,

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/combinator.rs.html#311)

#### type [System](#associatedtype.System) = [PipeSystem](../ecs/system/struct.PipeSystem.html "struct bevy::ecs::system::PipeSystem")<<A as [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<IA, OA, MA>>::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System"), <B as [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<IB, OB, MB>>::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System")\>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/adapter_system.rs.html#84-89)

### impl<Func, S, I, O, M> [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<<Func as [Adapt](../ecs/system/trait.Adapt.html "trait bevy::ecs::system::Adapt")<<S as [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<I, O, M>>::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System")\>>::[In](../ecs/system/trait.Adapt.html#associatedtype.In "type bevy::ecs::system::Adapt::In"), <Func as [Adapt](../ecs/system/trait.Adapt.html "trait bevy::ecs::system::Adapt")<<S as [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<I, O, M>>::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System")\>>::[Out](../ecs/system/trait.Adapt.html#associatedtype.Out "type bevy::ecs::system::Adapt::Out"), (IsAdapterSystemMarker, I, O, M)> for [IntoAdapterSystem](../ecs/system/struct.IntoAdapterSystem.html "struct bevy::ecs::system::IntoAdapterSystem")<Func, S>

where Func: [Adapt](../ecs/system/trait.Adapt.html "trait bevy::ecs::system::Adapt")<<S as [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<I, O, M>>::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System")\>, I: [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput"), S: [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<I, O, M>,

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/adapter_system.rs.html#91)

#### type [System](#associatedtype.System) = [AdapterSystem](../ecs/system/struct.AdapterSystem.html "struct bevy::ecs::system::AdapterSystem")<Func, <S as [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<I, O, M>>::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System")\>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/function_system.rs.html#576-581)

### impl<Marker, In, Out, F> [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<In, Out, (IsFunctionSystem, Marker)> for F
...
#### type [System](#associatedtype.System) = [FunctionSystem](../ecs/system/struct.FunctionSystem.html "struct bevy::ecs::system::FunctionSystem")<Marker, In, Out, F>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/builder.rs.html#284-291)

### impl<Marker, In, Out, Func, Builder> [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<In, Out, (IsBuilderSystem, Marker)> for [IntoBuilderSystem](../ecs/system/struct.IntoBuilderSystem.html "struct bevy::ecs::system::IntoBuilderSystem")<Marker, In, Out, Func, Builder>
...
#### type [System](#associatedtype.System) = [BuilderSystem](../ecs/system/struct.BuilderSystem.html "struct bevy::ecs::system::BuilderSystem")<Marker, In, Out, Func, Builder>
