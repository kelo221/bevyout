...
Since each command requires exclusive access to the `World`, all queued commands are automatically applied in sequence when the `ApplyDeferred` system runs (see [`ApplyDeferred`](struct.ApplyDeferred.html "struct bevy::prelude::ApplyDeferred") documentation for more details).

Each command can be used to modify the [`World`](struct.World.html "struct bevy::prelude::World") in arbitrary ways:
...
For a version of [`Commands`](struct.Commands.html "struct bevy::prelude::Commands") that works in parallel contexts (such as within [`Query::par_iter`](struct.Query.html#method.par_iter "method bevy::prelude::Query::par_iter")) see [`ParallelCommands`](struct.ParallelCommands.html "struct bevy::prelude::ParallelCommands")

## Usage

Add `mut commands: Commands` as a function argument to your system to get a copy of this struct that will be applied the next time a copy of [`ApplyDeferred`](struct.ApplyDeferred.html "struct bevy::prelude::ApplyDeferred") runs. Commands are almost always used as a [`SystemParam`](../ecs/system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam").
...
Each built-in command is implemented as a separate method, e.g. [`Commands::spawn`](struct.Commands.html#method.spawn "method bevy::prelude::Commands::spawn"). In addition to the pre-defined command methods, you can add commands with any arbitrary behavior using [`Commands::queue`](struct.Commands.html#method.queue "method bevy::prelude::Commands::queue"), which accepts any type implementing [`Command`](trait.Command.html "trait bevy::prelude::Command").
...
A [`Command`](trait.Command.html "trait bevy::prelude::Command") can return a [`Result`](type.Result.html "type bevy::prelude::Result"), which will be passed to an [error handler](../ecs/error/index.html "mod bevy::ecs::error") if the `Result` is an error.
...
Alternatively, you can customize the error handler for a specific command by calling [`Commands::queue_handled`](struct.Commands.html#method.queue_handled "method bevy::prelude::Commands::queue_handled").
...
### impl<'w, 's> [Commands](struct.Commands.html "struct bevy::prelude::Commands")<'w, 's>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/commands/mod.rs.html#220)

#### pub fn [new](#method.new)(queue: &'s mut [CommandQueue](../ecs/world/struct.CommandQueue.html "struct bevy::ecs::world::CommandQueue"), world: &'w [World](struct.World.html "struct bevy::prelude::World")) -> [Commands](struct.Commands.html "struct bevy::prelude::Commands")<'w, 's>

Returns a new `Commands` instance from a [`CommandQueue`](../ecs/world/struct.CommandQueue.html "struct bevy::ecs::world::CommandQueue") and a [`World`](struct.World.html "struct bevy::prelude::World").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/commands/mod.rs.html#225-229)

#### pub fn [new\_from\_entities](#method.new_from_entities)( queue: &'s mut [CommandQueue](../ecs/world/struct.CommandQueue.html "struct bevy::ecs::world::CommandQueue"), allocator: &'w [EntityAllocator](../ecs/entity/struct.EntityAllocator.html "struct bevy::ecs::entity::EntityAllocator"), entities: &'w [Entities](../ecs/entity/struct.Entities.html "struct bevy::ecs::entity::Entities"), ) -> [Commands](struct.Commands.html "struct bevy::prelude::Commands")<'w, 's>

Returns a new `Commands` instance from a [`CommandQueue`](../ecs/world/struct.CommandQueue.html "struct bevy::ecs::world::CommandQueue") and an [`Entities`](../ecs/entity/struct.Entities.html "struct bevy::ecs::entity::Entities") reference.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/commands/mod.rs.html#266)

#### pub fn [rebound\_to](#method.rebound_to)<'q>(&self, queue: &'q mut [CommandQueue](../ecs/world/struct.CommandQueue.html "struct bevy::ecs::world::CommandQueue")) -> [Commands](struct.Commands.html "struct bevy::prelude::Commands")<'w, 'q>

Returns a new [`Commands`](struct.Commands.html "struct bevy::prelude::Commands") that writes commands to the provided [`CommandQueue`](../ecs/world/struct.CommandQueue.html "struct bevy::ecs::world::CommandQueue") instead of the one from `self`.
...
#### pub fn [reborrow](#method.reborrow)(&mut self) -> [Commands](struct.Commands.html "struct bevy::prelude::Commands")<'w, '\_>

Returns a [`Commands`](struct.Commands.html "struct bevy::prelude::Commands") with a smaller lifetime.
...
#### pub fn [append](#method.append)(&mut self, other: &mut [CommandQueue](../ecs/world/struct.CommandQueue.html "struct bevy::ecs::world::CommandQueue"))
...
#### pub fn [spawn\_empty](#method.spawn_empty)(&mut self) -> [EntityCommands](struct.EntityCommands.html "struct bevy::prelude::EntityCommands")<'\_>

Spawns a new empty [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") and returns its corresponding [`EntityCommands`](struct.EntityCommands.html "struct bevy::prelude::EntityCommands").
...
*   [`spawn`](struct.Commands.html#method.spawn "method bevy::prelude::Commands::spawn") to spawn an entity with components.
*   [`spawn_batch`](struct.Commands.html#method.spawn_batch "method bevy::prelude::Commands::spawn_batch") to spawn many entities with the same combination of components.
...
#### pub fn [spawn](#method.spawn)<T>(&mut self, bundle: T) -> [EntityCommands](struct.EntityCommands.html "struct bevy::prelude::EntityCommands")<'\_>

where T: [Bundle](trait.Bundle.html "trait bevy::prelude::Bundle"),

Spawns a new [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") with the given components and returns the entity’s corresponding [`EntityCommands`](struct.EntityCommands.html "struct bevy::prelude::EntityCommands").

To spawn many entities with the same combination of components, [`spawn_batch`](struct.Commands.html#method.spawn_batch "method bevy::prelude::Commands::spawn_batch") can be used for better performance.
...
*   [`spawn_empty`](struct.Commands.html#method.spawn_empty "method bevy::prelude::Commands::spawn_empty") to spawn an entity without any components.
*   [`spawn_batch`](struct.Commands.html#method.spawn_batch "method bevy::prelude::Commands::spawn_batch") to spawn many entities with the same combination of components.
...
#### pub fn [entity](#method.entity)(&mut self, entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity")) -> [EntityCommands](struct.EntityCommands.html "struct bevy::prelude::EntityCommands")<'\_>

Returns the [`EntityCommands`](struct.EntityCommands.html "struct bevy::prelude::EntityCommands") for the given [`Entity`](struct.Entity.html "struct bevy::prelude::Entity").
...
*   [`get_entity`](struct.Commands.html#method.get_entity "method bevy::prelude::Commands::get_entity") for the fallible version.
...
#### pub fn [get\_entity](#method.get_entity)( &mut self, entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[EntityCommands](struct.EntityCommands.html "struct bevy::prelude::EntityCommands")<'\_>, [InvalidEntityError](../ecs/entity/struct.InvalidEntityError.html "struct bevy::ecs::entity::InvalidEntityError")\>

Returns the [`EntityCommands`](struct.EntityCommands.html "struct bevy::prelude::EntityCommands") for the requested [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") if it is valid. This method does not guarantee that commands queued by the returned `EntityCommands` will be successful, since the entity could be despawned before they are executed. This also does not error when the entity has not been spawned. For that behavior, see [`get_spawned_entity`](struct.Commands.html#method.get_spawned_entity "method bevy::prelude::Commands::get_spawned_entity"), which should be preferred for accessing entities you expect to already be spawned, like those found from a query. For details on entity spawning vs validity, see [`entity`](../ecs/entity/index.html "mod bevy::ecs::entity") module docs.

##### Errors

Returns [`InvalidEntityError`](../ecs/entity/struct.InvalidEntityError.html "struct bevy::ecs::entity::InvalidEntityError") if the requested entity does not exist.
...
*   [`entity`](struct.Commands.html#method.entity "method bevy::prelude::Commands::entity") for the infallible version.
...
#### pub fn [get\_spawned\_entity](#method.get_spawned_entity)( &mut self, entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[EntityCommands](struct.EntityCommands.html "struct bevy::prelude::EntityCommands")<'\_>, [EntityNotSpawnedError](../ecs/entity/enum.EntityNotSpawnedError.html "enum bevy::ecs::entity::EntityNotSpawnedError")\>

Returns the [`EntityCommands`](struct.EntityCommands.html "struct bevy::prelude::EntityCommands") for the requested [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") if it spawned in the world _now_. Note that for entities that have not been spawned _yet_, like ones from [`spawn`](struct.Commands.html#method.spawn "method bevy::prelude::Commands::spawn"), this will error. If that is not desired, try [`get_entity`](struct.Commands.html#method.get_entity "method bevy::prelude::Commands::get_entity"). This should be used over [`get_entity`](struct.Commands.html#method.get_entity "method bevy::prelude::Commands::get_entity") when you expect the entity to already be spawned in the world. If the entity is valid but not yet spawned, this will error that information, where [`get_entity`](struct.Commands.html#method.get_entity "method bevy::prelude::Commands::get_entity") would succeed, leading to potentially surprising results. For details on entity spawning vs validity, see [`entity`](../ecs/entity/index.html "mod bevy::ecs::entity") module docs.

This method does not guarantee that commands queued by the returned `EntityCommands` will be successful, since the entity could be despawned before they are executed.

##### Errors

Returns [`EntityNotSpawnedError`](../ecs/entity/enum.EntityNotSpawnedError.html "enum bevy::ecs::entity::EntityNotSpawnedError") if the requested entity does not exist.
...
Spawns multiple entities with the same combination of components, based on a batch of [`Bundles`](trait.Bundle.html "trait bevy::prelude::Bundle").

A batch can be any type that implements [`IntoIterator`](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") and contains bundles, such as a [`Vec<Bundle>`](struct.Vec.html "struct bevy::prelude::Vec") or an array `[Bundle; N]`.

This method is equivalent to iterating the batch and calling [`spawn`](struct.Commands.html#method.spawn "method bevy::prelude::Commands::spawn") for each bundle, but is faster by pre-allocating memory and having exclusive [`World`](struct.World.html "struct bevy::prelude::World") access.
...
*   [`spawn`](struct.Commands.html#method.spawn "method bevy::prelude::Commands::spawn") to spawn an entity with components.
*   [`spawn_empty`](struct.Commands.html#method.spawn_empty "method bevy::prelude::Commands::spawn_empty") to spawn an entity without components.
...
#### pub fn [queue](#method.queue)(&mut self, command: impl [Command](trait.Command.html "trait bevy::prelude::Command"))

Pushes a generic [`Command`](trait.Command.html "trait bevy::prelude::Command") to the command queue.

If the [`Command`](trait.Command.html "trait bevy::prelude::Command") returns a [`Result`](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result"), it will be handled using the [fallback error handler](../ecs/error/struct.FallbackErrorHandler.html "struct bevy::ecs::error::FallbackErrorHandler").

To use a custom error handler, see [`Commands::queue_handled`](struct.Commands.html#method.queue_handled "method bevy::prelude::Commands::queue_handled").

The command can be:

*   A custom struct that implements [`Command`](trait.Command.html "trait bevy::prelude::Command").
*   A closure or function that matches one of the following signatures:
    *   [`(&mut World)`](struct.World.html "struct bevy::prelude::World")
*   A built-in command from the [`command`](../ecs/system/command/index.html "mod bevy::ecs::system::command") module.
...
#### pub fn [queue\_handled](#method.queue_handled)( &mut self, command: impl [Command](trait.Command.html "trait bevy::prelude::Command"), error\_handler: [fn](https://doc.rust-lang.org/nightly/std/primitive.fn.html)([BevyError](struct.BevyError.html "struct bevy::prelude::BevyError"), [ErrorContext](../ecs/error/enum.ErrorContext.html "enum bevy::ecs::error::ErrorContext")), )

Pushes a generic [`Command`](trait.Command.html "trait bevy::prelude::Command") to the command queue.

If the [`Command`](trait.Command.html "trait bevy::prelude::Command") returns a [`Result`](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result"), the given `error_handler` will be used to handle error cases.

To implicitly use the fallback error handler, see [`Commands::queue`](struct.Commands.html#method.queue "method bevy::prelude::Commands::queue").
...
*   A closure or function that matches one of the following signatures:
    *   [`(&mut World)`](struct.World.html "struct bevy::prelude::World")
    *   [`(&mut World)`](struct.World.html "struct bevy::prelude::World") `->` [`Result`](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")
*   A built-in command from the [`command`](../ecs/system/command/index.html "mod bevy::ecs::system::command") module.
...
#### pub fn [queue\_silenced](#method.queue_silenced)(&mut self, command: impl [Command](trait.Command.html "trait bevy::prelude::Command"))

Pushes a generic [`Command`](trait.Command.html "trait bevy::prelude::Command") to the queue like [`Commands::queue_handled`](struct.Commands.html#method.queue_handled "method bevy::prelude::Commands::queue_handled"), but instead silently ignores any errors.
...
where I: [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = ([Entity](struct.Entity.html "struct bevy::prelude::Entity"), B)> + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static, B: [Bundle](trait.Bundle.html "trait bevy::prelude::Bundle"), <B as [DynamicBundle](../ecs/bundle/trait.DynamicBundle.html "trait bevy::ecs::bundle::DynamicBundle")\>::[Effect](../ecs/bundle/trait.DynamicBundle.html#associatedtype.Effect "type bevy::ecs::bundle::DynamicBundle::Effect"): [NoBundleEffect](../ecs/bundle/trait.NoBundleEffect.html "trait bevy::ecs::bundle::NoBundleEffect"),

Adds a series of [`Bundles`](trait.Bundle.html "trait bevy::prelude::Bundle") to each [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") they are paired with, based on a batch of `(Entity, Bundle)` pairs.

A batch can be any type that implements [`IntoIterator`](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") and contains `(Entity, Bundle)` tuples, such as a [`Vec<(Entity, Bundle)>`](struct.Vec.html "struct bevy::prelude::Vec") or an array `[(Entity, Bundle); N]`.

This will overwrite any pre-existing components shared by the [`Bundle`](trait.Bundle.html "trait bevy::prelude::Bundle") type. Use [`Commands::insert_batch_if_new`](struct.Commands.html#method.insert_batch_if_new "method bevy::prelude::Commands::insert_batch_if_new") to keep the pre-existing components instead.

This method is equivalent to iterating the batch and calling [`insert`](struct.EntityCommands.html#method.insert "method bevy::prelude::EntityCommands::insert") for each pair, but is faster by caching data that is shared between entities.

##### Fallible

This command will fail if any of the given entities do not exist.

It will internally return a [`TryInsertBatchError`](../ecs/world/error/struct.TryInsertBatchError.html "struct bevy::ecs::world::error::TryInsertBatchError"), which will be handled by the [fallback error handler](../ecs/error/struct.FallbackErrorHandler.html "struct bevy::ecs::error::FallbackErrorHandler").
...
This will keep any pre-existing components shared by the [`Bundle`](trait.Bundle.html "trait bevy::prelude::Bundle") type and discard the new values. Use [`Commands::insert_batch`](struct.Commands.html#method.insert_batch "method bevy::prelude::Commands::insert_batch") to overwrite the pre-existing components instead.

This method is equivalent to iterating the batch and calling [`insert_if_new`](struct.EntityCommands.html#method.insert_if_new "method bevy::prelude::EntityCommands::insert_if_new") for each pair, but is faster by caching data that is shared between entities.
...
This will overwrite any pre-existing components shared by the [`Bundle`](trait.Bundle.html "trait bevy::prelude::Bundle") type. Use [`Commands::try_insert_batch_if_new`](struct.Commands.html#method.try_insert_batch_if_new "method bevy::prelude::Commands::try_insert_batch_if_new") to keep the pre-existing components instead.
...
It will internally return a [`TryInsertBatchError`](../ecs/world/error/struct.TryInsertBatchError.html "struct bevy::ecs::world::error::TryInsertBatchError"), which will be handled by [logging the error at the `warn` level](../ecs/error/fn.warn.html "fn bevy::ecs::error::warn").
...
This will keep any pre-existing components shared by the [`Bundle`](trait.Bundle.html "trait bevy::prelude::Bundle") type and discard the new values. Use [`Commands::try_insert_batch`](struct.Commands.html#method.try_insert_batch "method bevy::prelude::Commands::try_insert_batch") to overwrite the pre-existing components instead.
...
Inserts a [`Resource`](trait.Resource.html "trait bevy::prelude::Resource") into the [`World`](struct.World.html "struct bevy::prelude::World") with an inferred value.

The inferred value is determined by the [`FromWorld`](trait.FromWorld.html "trait bevy::prelude::FromWorld") trait of the resource. Note that any resource with the [`Default`](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") trait automatically implements [`FromWorld`](trait.FromWorld.html "trait bevy::prelude::FromWorld"), and those default values will be used.
...
Inserts a [`Resource`](trait.Resource.html "trait bevy::prelude::Resource") into the [`World`](struct.World.html "struct bevy::prelude::World") with a specific value.
...
where R: [Resource](trait.Resource.html "trait bevy::prelude::Resource") + [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"),

Inserts a [`Resource`](trait.Resource.html "trait bevy::prelude::Resource") into the [`World`](struct.World.html "struct bevy::prelude::World") with a specific value if the resource is different or missing.
...
Removes a [`Resource`](trait.Resource.html "trait bevy::prelude::Resource") from the [`World`](struct.World.html "struct bevy::prelude::World").
...
#### pub fn [run\_system](#method.run_system)(&mut self, id: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[SystemId](../ecs/system/struct.SystemId.html "struct bevy::ecs::system::SystemId")\> + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"))

Runs the system corresponding to the given [`SystemId`](../ecs/system/struct.SystemId.html "struct bevy::ecs::system::SystemId"). Before running a system, it must first be registered via [`Commands::register_system`](struct.Commands.html#method.register_system "method bevy::prelude::Commands::register_system") or [`World::register_system`](struct.World.html#method.register_system "method bevy::prelude::World::register_system").

The system is run in an exclusive and single-threaded way. Running slow systems can become a bottleneck.

There is no way to get the output of a system when run as a command, because the execution of the system happens later. To get the output of a system, use [`World::run_system`](struct.World.html#method.run_system "method bevy::prelude::World::run_system") or [`World::run_system_with`](struct.World.html#method.run_system_with "method bevy::prelude::World::run_system_with") instead of running the system as a command.

##### Fallible

This command will fail if the given [`SystemId`](../ecs/system/struct.SystemId.html "struct bevy::ecs::system::SystemId") does not correspond to a [`System`](trait.System.html "trait bevy::prelude::System").

It will internally return a [`RegisteredSystemError`](../ecs/system/enum.RegisteredSystemError.html "enum bevy::ecs::system::RegisteredSystemError"), which will be handled by [logging the error at the `warn` level](../ecs/error/fn.warn.html "fn bevy::ecs::error::warn").
...
#### pub fn [run\_system\_with](#method.run_system_with)<I>( &mut self, id: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[SystemId](../ecs/system/struct.SystemId.html "struct bevy::ecs::system::SystemId")<I>> + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"), input: <I as [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput")\>::[Inner](trait.SystemInput.html#associatedtype.Inner "type bevy::prelude::SystemInput::Inner")<'static>, )

where I: [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput") + 'static, <I as [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput")\>::[Inner](trait.SystemInput.html#associatedtype.Inner "type bevy::prelude::SystemInput::Inner")<'static>: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

Runs the system corresponding to the given [`SystemId`](../ecs/system/struct.SystemId.html "struct bevy::ecs::system::SystemId") with input. Before running a system, it must first be registered via [`Commands::register_system`](struct.Commands.html#method.register_system "method bevy::prelude::Commands::register_system") or [`World::register_system`](struct.World.html#method.register_system "method bevy::prelude::World::register_system").
...
where I: [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + 'static, O: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + 'static,

Registers a system and returns its [`SystemId`](../ecs/system/struct.SystemId.html "struct bevy::ecs::system::SystemId") so it can later be called by [`Commands::run_system`](struct.Commands.html#method.run_system "method bevy::prelude::Commands::run_system") or [`World::run_system`](struct.World.html#method.run_system "method bevy::prelude::World::run_system").

This is different from adding systems to a [`Schedule`](struct.Schedule.html "struct bevy::prelude::Schedule"), because the [`SystemId`](../ecs/system/struct.SystemId.html "struct bevy::ecs::system::SystemId") that is returned can be used anywhere in the [`World`](struct.World.html "struct bevy::prelude::World") to run the associated system.

Using a [`Schedule`](struct.Schedule.html "struct bevy::prelude::Schedule") is still preferred for most cases due to its better performance and ability to run non-conflicting systems simultaneously.

##### Note

If the same system is registered more than once, each registration will be considered a different system, and they will each be given their own [`SystemId`](../ecs/system/struct.SystemId.html "struct bevy::ecs::system::SystemId").

If you want to avoid registering the same system multiple times, consider using [`Commands::run_system_cached`](struct.Commands.html#method.run_system_cached "method bevy::prelude::Commands::run_system_cached") or storing the [`SystemId`](../ecs/system/struct.SystemId.html "struct bevy::ecs::system::SystemId") in a [`Local`](struct.Local.html "struct bevy::prelude::Local").
...
#### pub fn [unregister\_system](#method.unregister_system)<I, O>(&mut self, system\_id: [SystemId](../ecs/system/struct.SystemId.html "struct bevy::ecs::system::SystemId")<I, O>)

where I: [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + 'static, O: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + 'static,

Removes a system previously registered with [`Commands::register_system`](struct.Commands.html#method.register_system "method bevy::prelude::Commands::register_system") or [`World::register_system`](struct.World.html#method.register_system "method bevy::prelude::World::register_system").

After removing a system, the [`SystemId`](../ecs/system/struct.SystemId.html "struct bevy::ecs::system::SystemId") becomes invalid and attempting to use it afterwards will result in an error. Re-adding the removed system will register it with a new `SystemId`.
...
where I: [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + 'static, O: 'static, M: 'static, S: [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<I, O, M> + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + 'static,

Removes a system previously registered with one of the following:

*   [`Commands::run_system_cached`](struct.Commands.html#method.run_system_cached "method bevy::prelude::Commands::run_system_cached")
*   [`World::run_system_cached`](struct.World.html#method.run_system_cached "method bevy::prelude::World::run_system_cached")
*   [`World::register_system_cached`](struct.World.html#method.register_system_cached "method bevy::prelude::World::register_system_cached")

##### Fallible

This command will fail if the given system is not currently cached in a [`CachedSystemId`](../ecs/system/struct.CachedSystemId.html "struct bevy::ecs::system::CachedSystemId") resource.
...
where M: 'static, S: [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), M> + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + 'static,

Runs a cached system, registering it if necessary.

Unlike [`Commands::run_system`](struct.Commands.html#method.run_system "method bevy::prelude::Commands::run_system"), this method does not require manual registration.

The first time this method is called for a particular system, it will register the system and store its [`SystemId`](../ecs/system/struct.SystemId.html "struct bevy::ecs::system::SystemId") in a [`CachedSystemId`](../ecs/system/struct.CachedSystemId.html "struct bevy::ecs::system::CachedSystemId") resource for later.

If you would rather manage the [`SystemId`](../ecs/system/struct.SystemId.html "struct bevy::ecs::system::SystemId") yourself, or register multiple copies of the same system, use [`Commands::register_system`](struct.Commands.html#method.register_system "method bevy::prelude::Commands::register_system") instead.
...
If you want to access values from the environment within a system, consider passing them in as inputs via [`Commands::run_system_cached_with`](struct.Commands.html#method.run_system_cached_with "method bevy::prelude::Commands::run_system_cached_with").

If that’s not an option, consider [`Commands::register_system`](struct.Commands.html#method.register_system "method bevy::prelude::Commands::register_system") instead.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/commands/mod.rs.html#1156-1160)

#### pub fn [run\_system\_cached\_with](#method.run_system_cached_with)<I, M, S>( &mut self, system: S, input: <I as [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput")\>::[Inner](trait.SystemInput.html#associatedtype.Inner "type bevy::prelude::SystemInput::Inner")<'static>, )

where I: [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + 'static, <I as [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput")\>::[Inner](trait.SystemInput.html#associatedtype.Inner "type bevy::prelude::SystemInput::Inner")<'static>: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"), M: 'static, S: [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<I, [()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), M> + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + 'static,

Runs a cached system with an input, registering it if necessary.

Unlike [`Commands::run_system_with`](struct.Commands.html#method.run_system_with "method bevy::prelude::Commands::run_system_with"), this method does not require manual registration.

To use the supplied input, the system should have a [`SystemInput`](trait.SystemInput.html "trait bevy::prelude::SystemInput") as the first parameter.
...
where <impl [Event](trait.Event.html "trait bevy::prelude::Event") as [Event](trait.Event.html "trait bevy::prelude::Event")\>::[Trigger](trait.Event.html#associatedtype.Trigger "type bevy::prelude::Event::Trigger")<'a>: [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default"),
...
#### pub fn [trigger\_with](#method.trigger_with)<E>( &mut self, event: E, trigger: <E as [Event](trait.Event.html "trait bevy::prelude::Event")\>::[Trigger](trait.Event.html#associatedtype.Trigger "type bevy::prelude::Event::Trigger")<'static>, )

where E: [Event](trait.Event.html "trait bevy::prelude::Event"), <E as [Event](trait.Event.html "trait bevy::prelude::Event")\>::[Trigger](trait.Event.html#associatedtype.Trigger "type bevy::prelude::Event::Trigger")<'static>: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),
...
#### pub fn [add\_observer](#method.add_observer)<M>( &mut self, observer: impl [IntoObserver](../ecs/observer/trait.IntoObserver.html "trait bevy::ecs::observer::IntoObserver")<M>, ) -> [EntityCommands](struct.EntityCommands.html "struct bevy::prelude::EntityCommands")<'\_>

Spawns an [`Observer`](struct.Observer.html "struct bevy::prelude::Observer") and returns the [`EntityCommands`](struct.EntityCommands.html "struct bevy::prelude::EntityCommands") associated with the entity that stores the observer.

`observer` can be any system whose first parameter is [`On`](struct.On.html "struct bevy::prelude::On").

**Calling [`observe`](struct.EntityCommands.html#method.observe "method bevy::prelude::EntityCommands::observe") on the returned [`EntityCommands`](struct.EntityCommands.html "struct bevy::prelude::EntityCommands") will observe the observer itself, which you very likely do not want.**
...
#### pub fn [write\_message](#method.write_message)<M>(&mut self, message: M) -> &mut [Commands](struct.Commands.html "struct bevy::prelude::Commands")<'w, 's>

where M: [Message](trait.Message.html "trait bevy::prelude::Message"),

Writes an arbitrary [`Message`](trait.Message.html "trait bevy::prelude::Message").

This is a convenience method for writing messages without requiring a [`MessageWriter`](struct.MessageWriter.html "struct bevy::prelude::MessageWriter").
...
If these messages are performance-critical or very frequently sent, consider using a [`MessageWriter`](struct.MessageWriter.html "struct bevy::prelude::MessageWriter") instead.
...
Runs the schedule corresponding to the given [`ScheduleLabel`](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel").

Calls [`World::try_run_schedule`](struct.World.html#method.try_run_schedule "method bevy::prelude::World::try_run_schedule").

##### Fallible

This command will fail if the given [`ScheduleLabel`](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel") does not correspond to a [`Schedule`](struct.Schedule.html "struct bevy::prelude::Schedule").

It will internally return a [`TryRunScheduleError`](../ecs/world/error/struct.TryRunScheduleError.html "struct bevy::ecs::world::error::TryRunScheduleError"), which will be handled by [logging the error at the `warn` level](../ecs/error/fn.warn.html "fn bevy::ecs::error::warn").
...
#### fn [set\_state](trait.CommandsStatesExt.html#tymethod.set_state)<S>(&mut self, state: S)

where S: [FreelyMutableState](../state/state/trait.FreelyMutableState.html "trait bevy::state::state::FreelyMutableState"),

Sets the next state the app should move to. [Read more](trait.CommandsStatesExt.html#tymethod.set_state)

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/commands.rs.html#38)

#### fn [set\_state\_if\_neq](trait.CommandsStatesExt.html#tymethod.set_state_if_neq)<S>(&mut self, state: S)

where S: [FreelyMutableState](../state/state/trait.FreelyMutableState.html "trait bevy::state::state::FreelyMutableState"),

Sets the next state the app should move to, skipping any state transitions if the next state is the same as the current state. [Read more](trait.CommandsStatesExt.html#tymethod.set_state_if_neq)

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/delayed_commands.rs.html#110)

### impl<'w, 's> [DelayedCommandsExt](trait.DelayedCommandsExt.html "trait bevy::prelude::DelayedCommandsExt")<'w> for [Commands](struct.Commands.html "struct bevy::prelude::Commands")<'w, 's>

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/delayed_commands.rs.html#111)

#### fn [delayed](trait.DelayedCommandsExt.html#tymethod.delayed)(&mut self) -> [DelayedCommands](../time/struct.DelayedCommands.html "struct bevy::time::DelayedCommands")<'w, '\_>

Returns a [`DelayedCommands`](../time/struct.DelayedCommands.html "struct bevy::time::DelayedCommands") instance that can be used to queue commands to be submitted at a later point in time. [Read more](trait.DelayedCommandsExt.html#tymethod.delayed)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/commands/mod.rs.html#205-208)

### impl<'w, 's> [ReadOnlySystemParam](../ecs/system/trait.ReadOnlySystemParam.html "trait bevy::ecs::system::ReadOnlySystemParam") for [Commands](struct.Commands.html "struct bevy::prelude::Commands")<'w, 's>

where [Deferred](struct.Deferred.html "struct bevy::prelude::Deferred")<'s, [CommandQueue](../ecs/world/struct.CommandQueue.html "struct bevy::ecs::world::CommandQueue")\>: [ReadOnlySystemParam](../ecs/system/trait.ReadOnlySystemParam.html "trait bevy::ecs::system::ReadOnlySystemParam"), &'w [Entities](../ecs/entity/struct.Entities.html "struct bevy::ecs::entity::Entities"): [ReadOnlySystemParam](../ecs/system/trait.ReadOnlySystemParam.html "trait bevy::ecs::system::ReadOnlySystemParam"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/commands/mod.rs.html#112)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Commands](struct.Commands.html "struct bevy::prelude::Commands")<'\_, '\_>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/commands/mod.rs.html#115)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Commands](struct.Commands.html "struct bevy::prelude::Commands")<'\_, '\_>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/commands/mod.rs.html#128)

### impl [SystemParam](../ecs/system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam") for [Commands](struct.Commands.html "struct bevy::prelude::Commands")<'\_, '\_>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/commands/mod.rs.html#129)

#### type [State](../ecs/system/trait.SystemParam.html#associatedtype.State) = FetchState

Used to store data which persists across invocations of a system.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/commands/mod.rs.html#131)

#### type [Item](../ecs/system/trait.SystemParam.html#associatedtype.Item)<'w, 's> = [Commands](struct.Commands.html "struct bevy::prelude::Commands")<'w, 's>
...
#### unsafe fn [get\_param](../ecs/system/trait.SystemParam.html#tymethod.get_param)<'w, 's>( state: &'s mut <[Commands](struct.Commands.html "struct bevy::prelude::Commands")<'\_, '\_> as [SystemParam](../ecs/system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](../ecs/system/trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State"), system\_meta: &[SystemMeta](../ecs/system/struct.SystemMeta.html "struct bevy::ecs::system::SystemMeta"), world: [UnsafeWorldCell](../ecs/world/unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'w>, change\_tick: [Tick](../ecs/change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Commands](struct.Commands.html "struct bevy::prelude::Commands")<'\_, '\_> as [SystemParam](../ecs/system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[Item](../ecs/system/trait.SystemParam.html#associatedtype.Item "type bevy::ecs::system::SystemParam::Item")<'w, 's>, [SystemParamValidationError](../ecs/system/struct.SystemParamValidationError.html "struct bevy::ecs::system::SystemParamValidationError")\>
...
### impl<'w, 's> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Commands](struct.Commands.html "struct bevy::prelude::Commands")<'w, 's>

### impl<'w, 's> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Commands](struct.Commands.html "struct bevy::prelude::Commands")<'w, 's>

### impl<'w, 's> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Commands](struct.Commands.html "struct bevy::prelude::Commands")<'w, 's>

### impl<'w, 's> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Commands](struct.Commands.html "struct bevy::prelude::Commands")<'w, 's>

### impl<'w, 's> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Commands](struct.Commands.html "struct bevy::prelude::Commands")<'w, 's>
