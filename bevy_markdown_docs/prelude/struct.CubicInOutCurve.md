...
Consider using [`SmoothStepCurve`](struct.SmoothStepCurve.html "struct bevy::prelude::SmoothStepCurve") instead, which is also cubic, or [`SmootherStepCurve`](struct.SmootherStepCurve.html "struct bevy::prelude::SmootherStepCurve") if you picked this because you wanted the acceleration at the endpoints to also be zero.
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [CubicInOutCurve](struct.CubicInOutCurve.html "struct bevy::prelude::CubicInOutCurve")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#737)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [CubicInOutCurve](struct.CubicInOutCurve.html "struct bevy::prelude::CubicInOutCurve")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [CubicInOutCurve](struct.CubicInOutCurve.html "struct bevy::prelude::CubicInOutCurve")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [CubicInOutCurve](struct.CubicInOutCurve.html "struct bevy::prelude::CubicInOutCurve")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [CubicInOutCurve](struct.CubicInOutCurve.html "struct bevy::prelude::CubicInOutCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [CubicInOutCurve](struct.CubicInOutCurve.html "struct bevy::prelude::CubicInOutCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [CubicInOutCurve](struct.CubicInOutCurve.html "struct bevy::prelude::CubicInOutCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [CubicInOutCurve](struct.CubicInOutCurve.html "struct bevy::prelude::CubicInOutCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [CubicInOutCurve](struct.CubicInOutCurve.html "struct bevy::prelude::CubicInOutCurve")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [CubicInOutCurve](struct.CubicInOutCurve.html "struct bevy::prelude::CubicInOutCurve")
