...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#292)
...
The segment is positioned so that it always includes [`Vec2::Y`](struct.Vec2.html#associatedconstant.Y "associated constant bevy::prelude::Vec2::Y") and is vertically symmetrical. To orient the sector differently, apply a rotation. The sector is drawn with the center of its circle at the origin [`Vec2::ZERO`](struct.Vec2.html#associatedconstant.ZERO "associated constant bevy::prelude::Vec2::ZERO").
...
`arc: [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")`

The arc defining the sector

## Implementations

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#323)

### impl [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#326)

#### pub const fn [new](#method.new)(radius: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), angle: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")

Create a new [`CircularSector`](struct.CircularSector.html "struct bevy::prelude::CircularSector") from a `radius` and an `angle`

##### [Examples found in repository](#scraped-examples)[?](../../scrape-examples-help.html)

examples/testbed/2d.rs ([line 121](../../src/testbed_2d/2d.rs.html#121))
...
examples/2d/2d\_shapes.rs ([line 56](../../src/2d_shapes/2d_shapes.rs.html#56))
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#334)

#### pub const fn [from\_radians](#method.from_radians)(radius: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), angle: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")

Create a new [`CircularSector`](struct.CircularSector.html "struct bevy::prelude::CircularSector") from a `radius` and an `angle` in radians.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#342)

#### pub const fn [from\_degrees](#method.from_degrees)(radius: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), angle: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")

Create a new [`CircularSector`](struct.CircularSector.html "struct bevy::prelude::CircularSector") from a `radius` and an `angle` in degrees.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#352)

#### pub const fn [from\_turns](#method.from_turns)(radius: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), fraction: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")

Create a new [`CircularSector`](struct.CircularSector.html "struct bevy::prelude::CircularSector") from a `radius` and a number of `turns` of a circle.

For instance, `0.5` turns is a semicircle.

##### [Examples found in repository](#scraped-examples-1)[?](../../scrape-examples-help.html)

examples/2d/mesh2d\_arcs.rs ([line 59](../../src/mesh2d_arcs/mesh2d_arcs.rs.html#59))
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#360)

#### pub const fn [half\_angle](#method.half_angle)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Get half the angle of the sector

##### [Examples found in repository](#scraped-examples-2)[?](../../scrape-examples-help.html)

examples/2d/mesh2d\_arcs.rs ([line 62](../../src/mesh2d_arcs/mesh2d_arcs.rs.html#62))
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#366)

#### pub const fn [angle](#method.angle)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Get the angle of the sector

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#372)

#### pub const fn [radius](#method.radius)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Get the radius of the sector

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#378)

#### pub const fn [arc\_length](#method.arc_length)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Get the length of the arc defining the sector

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#386)

#### pub fn [half\_chord\_length](#method.half_chord_length)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Get half the length of the chord defined by the sector

See [`Arc2d::half_chord_length`](struct.Arc2d.html#method.half_chord_length "method bevy::prelude::Arc2d::half_chord_length")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#394)

#### pub fn [chord\_length](#method.chord_length)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Get the length of the chord defined by the sector

See [`Arc2d::chord_length`](struct.Arc2d.html#method.chord_length "method bevy::prelude::Arc2d::chord_length")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#402)

#### pub fn [chord\_midpoint](#method.chord_midpoint)(&self) -> [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")

Get the midpoint of the chord defined by the sector

See [`Arc2d::chord_midpoint`](struct.Arc2d.html#method.chord_midpoint "method bevy::prelude::Arc2d::chord_midpoint")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#410)

#### pub fn [apothem](#method.apothem)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Get the length of the apothem of this sector

See [`Arc2d::apothem`](struct.Arc2d.html#method.apothem "method bevy::prelude::Arc2d::apothem")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#418)

#### pub fn [sagitta](#method.sagitta)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Get the length of the sagitta of this sector

See [`Arc2d::sagitta`](struct.Arc2d.html#method.sagitta "method bevy::prelude::Arc2d::sagitta")
...
### impl [Bounded2d](../math/bounding/trait.Bounded2d.html "trait bevy::math::bounding::Bounded2d") for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/bounding/bounded2d/primitive_impls.rs.html#100)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/bounding/bounded2d/primitive_impls.rs.html#115)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#281)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#281)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#281)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#300)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#302)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")

Returns the default [`CircularSector`](struct.CircularSector.html "struct bevy::prelude::CircularSector") with radius `0.5` and covering a third of a circle

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#282)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#282)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")\> for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#281)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")) -> [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")
...
### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#285)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#285)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")
...
### impl<Config, Clear> [GizmoPrimitive2d](trait.GizmoPrimitive2d.html "trait bevy::prelude::GizmoPrimitive2d")<[CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")\> for [GizmoBuffer](../gizmos/gizmos/struct.GizmoBuffer.html "struct bevy::gizmos::gizmos::GizmoBuffer")<Config, Clear>
...
#### fn [primitive\_2d](trait.GizmoPrimitive2d.html#tymethod.primitive_2d)( &mut self, primitive: &[CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector"), isometry: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Isometry2d](struct.Isometry2d.html "struct bevy::prelude::Isometry2d")\>, color: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Color](enum.Color.html "enum bevy::prelude::Color")\>, ) -> <[GizmoBuffer](../gizmos/gizmos/struct.GizmoBuffer.html "struct bevy::gizmos::gizmos::GizmoBuffer")<Config, Clear> as [GizmoPrimitive2d](trait.GizmoPrimitive2d.html "trait bevy::prelude::GizmoPrimitive2d")<[CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")\>>::[Output](trait.GizmoPrimitive2d.html#associatedtype.Output "type bevy::prelude::GizmoPrimitive2d::Output")<'\_>

Renders a 2D primitive with its associated details.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#285)

### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")
...
where [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector"): 'into\_return,
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#309)

#### fn [area](trait.Measured2d.html#tymethod.area)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Get the area of the shape

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#314)

#### fn [perimeter](trait.Measured2d.html#tymethod.perimeter)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Get the perimeter of the shape

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/primitives/dim2.rs.html#242)

### impl [Meshable](trait.Meshable.html "trait bevy::prelude::Meshable") for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/primitives/dim2.rs.html#243)

#### type [Output](trait.Meshable.html#associatedtype.Output) = [CircularSectorMeshBuilder](../mesh/struct.CircularSectorMeshBuilder.html "struct bevy::mesh::CircularSectorMeshBuilder")
...
[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/primitives/dim2.rs.html#245)

#### fn [mesh](trait.Meshable.html#tymethod.mesh)(&self) -> <[CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector") as [Meshable](trait.Meshable.html "trait bevy::prelude::Meshable")\>::[Output](trait.Meshable.html#associatedtype.Output "type bevy::prelude::Meshable::Output")

Creates a [`Mesh`](struct.Mesh.html "struct bevy::prelude::Mesh") for a shape.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#281)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#281)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#285)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#286)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#298)

### impl [Primitive2d](trait.Primitive2d.html "trait bevy::prelude::Primitive2d") for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")
...
### impl [ShapeSample](trait.ShapeSample.html "trait bevy::prelude::ShapeSample") for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/sampling/shape_sampling.rs.html#174)

#### type [Output](trait.ShapeSample.html#associatedtype.Output) = [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")

The type of vector returned by the sample methods, [`Vec2`](struct.Vec2.html "struct bevy::prelude::Vec2") for 2D shapes and [`Vec3`](struct.Vec3.html "struct bevy::prelude::Vec3") for 3D shapes.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/sampling/shape_sampling.rs.html#176)

#### fn [sample\_interior](trait.ShapeSample.html#tymethod.sample_interior)<R>(&self, rng: [&mut R](https://doc.rust-lang.org/nightly/std/primitive.reference.html)) -> [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")
...
Uniformly sample a point from inside the area/volume of this shape, centered on 0. [Read more](trait.ShapeSample.html#tymethod.sample_interior)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/sampling/shape_sampling.rs.html#184)

#### fn [sample\_boundary](trait.ShapeSample.html#tymethod.sample_boundary)<R>(&self, rng: [&mut R](https://doc.rust-lang.org/nightly/std/primitive.reference.html)) -> [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")

where R: [RngExt](https://docs.rs/rand/0.9.4/x86_64-unknown-linux-gnu/rand/rng/trait.RngExt.html "trait rand::rng::RngExt") + ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

Uniformly sample a point from the surface of this shape, centered on 0. [Read more](trait.ShapeSample.html#tymethod.sample_boundary)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/sampling/shape_sampling.rs.html#102-104)

#### fn [interior\_dist](trait.ShapeSample.html#method.interior_dist)(self) -> impl [Distribution](https://docs.rs/rand/0.9.4/x86_64-unknown-linux-gnu/rand/distr/distribution/trait.Distribution.html "trait rand::distr::distribution::Distribution")<Self::[Output](trait.ShapeSample.html#associatedtype.Output "type bevy::prelude::ShapeSample::Output")\>

where Self: [Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

Extract a [`Distribution`](https://docs.rs/rand/0.9.4/x86_64-unknown-linux-gnu/rand/distr/distribution/trait.Distribution.html "trait rand::distr::distribution::Distribution") whose samples are points of this shape’s interior, taken uniformly. [Read more](trait.ShapeSample.html#method.interior_dist)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/sampling/shape_sampling.rs.html#124-126)

#### fn [boundary\_dist](trait.ShapeSample.html#method.boundary_dist)(self) -> impl [Distribution](https://docs.rs/rand/0.9.4/x86_64-unknown-linux-gnu/rand/distr/distribution/trait.Distribution.html "trait rand::distr::distribution::Distribution")<Self::[Output](trait.ShapeSample.html#associatedtype.Output "type bevy::prelude::ShapeSample::Output")\>

where Self: [Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

Extract a [`Distribution`](https://docs.rs/rand/0.9.4/x86_64-unknown-linux-gnu/rand/distr/distribution/trait.Distribution.html "trait rand::distr::distribution::Distribution") whose samples are points of this shape’s boundary, taken uniformly. [Read more](trait.ShapeSample.html#method.boundary_dist)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [CircularSector](struct.CircularSector.html "struct bevy::prelude::CircularSector")
