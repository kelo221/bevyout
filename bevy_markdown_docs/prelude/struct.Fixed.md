...
A specialization of the [`Time`](struct.Time.html "struct bevy::prelude::Time") structure. **For method documentation, see [`Time<Fixed>`](struct.Time.html#impl-Time%3CFixed%3E "struct bevy::prelude::Time").**

It is automatically inserted as a resource by [`TimePlugin`](../time/struct.TimePlugin.html "struct bevy::time::TimePlugin") and updated based on [`Time<Virtual>`](struct.Virtual.html "struct bevy::prelude::Virtual"). The fixed clock is automatically set as the generic [`Time`](struct.Time.html "struct bevy::prelude::Time") resource during [`FixedUpdate`](struct.FixedUpdate.html "struct bevy::prelude::FixedUpdate") schedule processing.
...
The default [`timestep()`](struct.Time.html#method.timestep "method bevy::prelude::Time::timestep") is 64 hertz, or 15625 microseconds. This value was chosen because using 60 hertz has the potential for a pathological interaction with the monitor refresh rate where the game alternates between running two fixed timesteps and zero fixed timesteps per frame (for example when running two fixed timesteps takes longer than a frame). Additionally, the value is a power of two which losslessly converts into [`f32`](https://doc.rust-lang.org/nightly/std/primitive.f32.html "primitive f32") and [`f64`](https://doc.rust-lang.org/nightly/std/primitive.f64.html "primitive f64").

To run a system on a fixed timestep, add it to one of the [`FixedMain`](../app/struct.FixedMain.html "struct bevy::app::FixedMain") schedules, most commonly [`FixedUpdate`](struct.FixedUpdate.html "struct bevy::prelude::FixedUpdate").

This schedule is run a number of times between [`PreUpdate`](struct.PreUpdate.html "struct bevy::prelude::PreUpdate") and [`Update`](struct.Update.html "struct bevy::prelude::Update") according to the accumulated [`overstep()`](struct.Time.html#method.overstep "method bevy::prelude::Time::overstep") time divided by the [`timestep()`](struct.Time.html#method.timestep "method bevy::prelude::Time::timestep"). This means the schedule may run 0, 1 or more times during a single update (which typically corresponds to a rendered frame).

`Time<Fixed>` and the generic [`Time`](struct.Time.html "struct bevy::prelude::Time") resource will report a [`delta()`](struct.Time.html#method.delta "method bevy::prelude::Time::delta") equal to [`timestep()`](struct.Time.html#method.timestep "method bevy::prelude::Time::timestep") and always grow [`elapsed()`](struct.Time.html#method.elapsed "method bevy::prelude::Time::elapsed") by one [`timestep()`](struct.Time.html#method.timestep "method bevy::prelude::Time::timestep") per iteration.

The fixed timestep clock follows the [`Time<Virtual>`](struct.Virtual.html "struct bevy::prelude::Virtual") clock, which means it is affected by [`pause()`](struct.Time.html#method.pause "method bevy::prelude::Time::pause"), [`set_relative_speed()`](struct.Time.html#method.set_relative_speed "method bevy::prelude::Time::set_relative_speed") and [`set_max_delta()`](struct.Time.html#method.set_max_delta "method bevy::prelude::Time::set_max_delta") from virtual time. If the virtual clock is paused, the [`FixedUpdate`](struct.FixedUpdate.html "struct bevy::prelude::FixedUpdate") schedule will not run. It is guaranteed that the [`elapsed()`](struct.Time.html#method.elapsed "method bevy::prelude::Time::elapsed") time in `Time<Fixed>` is always between the previous `elapsed()` and the current `elapsed()` value in `Time<Virtual>`, so the values are compatible.

Changing the timestep size while the game is running should not normally be done, as having a regular interval is the point of this schedule, but it may be necessary for effects like “bullet-time” if the normal granularity of the fixed timestep is too big for the slowed down time. In this case, [`set_timestep()`](struct.Time.html#method.set_timestep "method bevy::prelude::Time::set_timestep") and be called to set a new value. The new value will be used immediately for the next run of the [`FixedUpdate`](struct.FixedUpdate.html "struct bevy::prelude::FixedUpdate") schedule, meaning that it will affect the [`delta()`](struct.Time.html#method.delta "method bevy::prelude::Time::delta") value for the very next [`FixedUpdate`](struct.FixedUpdate.html "struct bevy::prelude::FixedUpdate"), even if it is still during the same frame. Any [`overstep()`](struct.Time.html#method.overstep "method bevy::prelude::Time::overstep") present in the accumulator will be processed according to the new [`timestep()`](struct.Time.html#method.timestep "method bevy::prelude::Time::timestep") value.

## Trait Implementations

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/fixed.rs.html#67)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/fixed.rs.html#67)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/fixed.rs.html#67)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/fixed.rs.html#231)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/fixed.rs.html#68)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/fixed.rs.html#68)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/fixed.rs.html#68)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Fixed](struct.Fixed.html "struct bevy::prelude::Fixed") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")
...
where [Fixed](struct.Fixed.html "struct bevy::prelude::Fixed"): 'into\_return,
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/fixed.rs.html#68)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Fixed](struct.Fixed.html "struct bevy::prelude::Fixed")
