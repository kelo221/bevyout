...
The inner [curve](trait.Curve.html "trait bevy::prelude::Curve") whose values are used to animate the property.

## Implementations

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/animation_curves.rs.html#309-312)

### impl<P, C> [AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>

where P: [AnimatableProperty](trait.AnimatableProperty.html "trait bevy::prelude::AnimatableProperty"), C: [AnimationCompatibleCurve](trait.AnimationCompatibleCurve.html "trait bevy::prelude::AnimationCompatibleCurve")<<P as [AnimatableProperty](trait.AnimatableProperty.html "trait bevy::prelude::AnimatableProperty")\>::[Property](trait.AnimatableProperty.html#associatedtype.Property "type bevy::prelude::AnimatableProperty::Property")\>,

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/animation_curves.rs.html#318)

#### pub fn [new](#method.new)(property: P, curve: C) -> [AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>

Create an [`AnimatableCurve`](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve") (and thus an [`AnimationCurve`](trait.AnimationCurve.html "trait bevy::prelude::AnimationCurve")) from a curve valued in an [animatable property](trait.AnimatableProperty.html#associatedtype.Property "associated type bevy::prelude::AnimatableProperty::Property").
...
### impl<P, C> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>
...
#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>
...
### impl<P, C> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>
...
### impl<P, C> [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>
...
#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/animation_curves.rs.html#286)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C> as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>>
...
### impl<P, C> [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>
...
### impl<P, C> [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>
...
### impl<P, C> [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>
...
where [AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>: 'into\_return,
...
### impl<P, C> [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/animation_curves.rs.html#286)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>>, ) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<P, C> [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>
...
### impl<P, C> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>
...
### impl<P, C> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>
...
### impl<P, C> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>
...
### impl<P, C> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>
...
### impl<P, C> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>
...
### impl<P, C> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>
...
### impl<P, C> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AnimatableCurve](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve")<P, C>
