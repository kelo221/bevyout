...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [LinearReparamError](enum.LinearReparamError.html "enum bevy::prelude::LinearReparamError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [LinearReparamError](enum.LinearReparamError.html "enum bevy::prelude::LinearReparamError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [LinearReparamError](enum.LinearReparamError.html "enum bevy::prelude::LinearReparamError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [LinearReparamError](enum.LinearReparamError.html "enum bevy::prelude::LinearReparamError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [LinearReparamError](enum.LinearReparamError.html "enum bevy::prelude::LinearReparamError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [LinearReparamError](enum.LinearReparamError.html "enum bevy::prelude::LinearReparamError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [LinearReparamError](enum.LinearReparamError.html "enum bevy::prelude::LinearReparamError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [LinearReparamError](enum.LinearReparamError.html "enum bevy::prelude::LinearReparamError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [LinearReparamError](enum.LinearReparamError.html "enum bevy::prelude::LinearReparamError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [LinearReparamError](enum.LinearReparamError.html "enum bevy::prelude::LinearReparamError")
