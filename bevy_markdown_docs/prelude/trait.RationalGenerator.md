...
#### fn [to\_curve](#tymethod.to_curve)(&self) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[RationalCurve](struct.RationalCurve.html "struct bevy::prelude::RationalCurve")<P>, Self::[Error](trait.RationalGenerator.html#associatedtype.Error "type bevy::prelude::RationalGenerator::Error")\>
