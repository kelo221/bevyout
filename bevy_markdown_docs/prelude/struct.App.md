...
A single [`App`](struct.App.html "struct bevy::prelude::App") can contain multiple [`SubApp`](struct.SubApp.html "struct bevy::prelude::SubApp") instances, but [`App`](struct.App.html "struct bevy::prelude::App") methods only affect the “main” one. To access a particular [`SubApp`](struct.SubApp.html "struct bevy::prelude::SubApp"), use [`get_sub_app`](struct.App.html#method.get_sub_app "method bevy::prelude::App::get_sub_app") or [`get_sub_app_mut`](struct.App.html#method.get_sub_app_mut "method bevy::prelude::App::get_sub_app_mut").
...
### impl [App](struct.App.html "struct bevy::prelude::App")

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/app.rs.html#146)

#### pub fn [new](#method.new)() -> [App](struct.App.html "struct bevy::prelude::App")

Creates a new [`App`](struct.App.html "struct bevy::prelude::App") with some default structure to enable core engine features. This is the preferred constructor for most use cases.
...
#### pub fn [empty](#method.empty)() -> [App](struct.App.html "struct bevy::prelude::App")

Creates a new empty [`App`](struct.App.html "struct bevy::prelude::App") with minimal default configuration.
...
#### pub fn [run](#method.run)(&mut self) -> [AppExit](enum.AppExit.html "enum bevy::prelude::AppExit")

Runs the [`App`](struct.App.html "struct bevy::prelude::App") by calling its [runner](struct.App.html#method.set_runner "method bevy::prelude::App::set_runner").

This will (re)build the [`App`](struct.App.html "struct bevy::prelude::App") first. For general usage, see the example on the item level documentation.

##### Caveats

Calls to [`App::run()`](struct.App.html#method.run "method bevy::prelude::App::run") will never return on iOS and Web.
...
#### pub fn [set\_runner](#method.set_runner)( &mut self, f: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")([App](struct.App.html "struct bevy::prelude::App")) -> [AppExit](enum.AppExit.html "enum bevy::prelude::AppExit") + 'static, ) -> &mut [App](struct.App.html "struct bevy::prelude::App")

Sets the function that will be called when the app is run.

The runner function `f` is called only once by [`App::run`](struct.App.html#method.run "method bevy::prelude::App::run"). If the presence of a main loop in the app is desired, it is the responsibility of the runner function to provide it.
...
#### pub fn [plugins\_state](#method.plugins_state)(&mut self) -> [PluginsState](../app/enum.PluginsState.html "enum bevy::app::PluginsState")

Returns the state of all plugins. This is usually called by the event loop, but can be useful for situations where you want to use [`App::update`](struct.App.html#method.update "method bevy::prelude::App::update").
...
Runs [`Plugin::finish`](trait.Plugin.html#method.finish "method bevy::prelude::Plugin::finish") for each plugin. This is usually called by the event loop once all plugins are ready, but can be useful for situations where you want to use [`App::update`](struct.App.html#method.update "method bevy::prelude::App::update").
...
Runs [`Plugin::cleanup`](trait.Plugin.html#method.cleanup "method bevy::prelude::Plugin::cleanup") for each plugin. This is usually called by the event loop after [`App::finish`](struct.App.html#method.finish "method bevy::prelude::App::finish"), but can be useful for situations where you want to use [`App::update`](struct.App.html#method.update "method bevy::prelude::App::update").
...
#### pub fn [add\_systems](#method.add_systems)<M>( &mut self, schedule: impl [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel"), systems: impl [IntoScheduleConfigs](trait.IntoScheduleConfigs.html "trait bevy::prelude::IntoScheduleConfigs")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [System](trait.System.html "trait bevy::prelude::System")<Out = [()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), In = [()](https://doc.rust-lang.org/nightly/std/primitive.unit.html)\>>, M>, ) -> &mut [App](struct.App.html "struct bevy::prelude::App")

Adds one or more systems to the given schedule in this app’s [`Schedules`](struct.Schedules.html "struct bevy::prelude::Schedules").
...
#### pub fn [remove\_systems\_in\_set](#method.remove_systems_in_set)<M>( &mut self, schedule: impl [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel"), set: impl [IntoSystemSet](trait.IntoSystemSet.html "trait bevy::prelude::IntoSystemSet")<M>, policy: [ScheduleCleanupPolicy](../ecs/schedule/enum.ScheduleCleanupPolicy.html "enum bevy::ecs::schedule::ScheduleCleanupPolicy"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), [ScheduleError](../ecs/schedule/enum.ScheduleError.html "enum bevy::ecs::schedule::ScheduleError")\>

Removes all systems in a [`SystemSet`](trait.SystemSet.html "trait bevy::prelude::SystemSet"). This will cause the schedule to be rebuilt when the schedule is run again and can be slow. A [`ScheduleError`](../ecs/schedule/enum.ScheduleError.html "enum bevy::ecs::schedule::ScheduleError") is returned if the schedule needs to be [`Schedule::initialize`](struct.Schedule.html#method.initialize "method bevy::prelude::Schedule::initialize")’d or the `set` is not found.
...
This is different from adding systems to a [`Schedule`](struct.Schedule.html "struct bevy::prelude::Schedule") with [`App::add_systems`](struct.App.html#method.add_systems "method bevy::prelude::App::add_systems"), because the [`SystemId`](../ecs/system/struct.SystemId.html "struct bevy::ecs::system::SystemId") that is returned can be used anywhere in the [`World`](struct.World.html "struct bevy::prelude::World") to run the associated system. This allows for running systems in a push-based fashion. Using a [`Schedule`](struct.Schedule.html "struct bevy::prelude::Schedule") is still preferred for most cases due to its better performance and ability to run non-conflicting systems simultaneously.
...
See [`World::register_tracked_system`](struct.World.html#method.register_tracked_system "method bevy::prelude::World::register_tracked_system") for more details.

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/app.rs.html#409-413)

#### pub fn [configure\_sets](#method.configure_sets)<M>( &mut self, schedule: impl [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel"), sets: impl [IntoScheduleConfigs](trait.IntoScheduleConfigs.html "trait bevy::prelude::IntoScheduleConfigs")<[Interned](../ecs/intern/struct.Interned.html "struct bevy::ecs::intern::Interned")<dyn [SystemSet](trait.SystemSet.html "trait bevy::prelude::SystemSet")\>, M>, ) -> &mut [App](struct.App.html "struct bevy::prelude::App")
...
#### pub fn [add\_message](#method.add_message)<M>(&mut self) -> &mut [App](struct.App.html "struct bevy::prelude::App")

where M: [Message](trait.Message.html "trait bevy::prelude::Message"),

Initializes [`Message`](trait.Message.html "trait bevy::prelude::Message") handling for `T` by inserting a message queue resource ([`Messages::<T>`](struct.Messages.html "struct bevy::prelude::Messages")) and scheduling an [`message_update_system`](../ecs/message/fn.message_update_system.html "fn bevy::ecs::message::message_update_system") in [`First`](struct.First.html "struct bevy::prelude::First").

See [`Messages`](struct.Messages.html "struct bevy::prelude::Messages") for information on how to define messages.
...
#### pub fn [insert\_resource](#method.insert_resource)<R>(&mut self, resource: R) -> &mut [App](struct.App.html "struct bevy::prelude::App")

where R: [Resource](trait.Resource.html "trait bevy::prelude::Resource"),

Inserts the [`Resource`](trait.Resource.html "trait bevy::prelude::Resource") into the app, overwriting any existing resource of the same type.

There is also an [`init_resource`](struct.App.html#method.init_resource "method bevy::prelude::App::init_resource") for resources that have [`Default`](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") or [`FromWorld`](trait.FromWorld.html "trait bevy::prelude::FromWorld") implementations.
...
#### pub fn [init\_resource](#method.init_resource)<R>(&mut self) -> &mut [App](struct.App.html "struct bevy::prelude::App")
...
Inserts the [`Resource`](trait.Resource.html "trait bevy::prelude::Resource"), initialized with its default value, into the app, if there is no existing instance of `R`.

`R` must implement [`FromWorld`](trait.FromWorld.html "trait bevy::prelude::FromWorld"). If `R` implements [`Default`](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default"), [`FromWorld`](trait.FromWorld.html "trait bevy::prelude::FromWorld") will be automatically implemented and initialize the [`Resource`](trait.Resource.html "trait bevy::prelude::Resource") with [`Default::default`](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default "associated function core::default::Default::default").
...
#### pub fn [insert\_non\_send\_resource](#method.insert_non_send_resource)<R>(&mut self, resource: R) -> &mut [App](struct.App.html "struct bevy::prelude::App")
...
#### pub fn [insert\_non\_send](#method.insert_non_send)<R>(&mut self, resource: R) -> &mut [App](struct.App.html "struct bevy::prelude::App")
...
#### pub fn [init\_non\_send\_resource](#method.init_non_send_resource)<R>(&mut self) -> &mut [App](struct.App.html "struct bevy::prelude::App")
...
#### pub fn [init\_non\_send](#method.init_non_send)<R>(&mut self) -> &mut [App](struct.App.html "struct bevy::prelude::App")
...
where T: [Plugin](trait.Plugin.html "trait bevy::prelude::Plugin"),

Returns `true` if the [`Plugin`](trait.Plugin.html "trait bevy::prelude::Plugin") has already been added.

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/app.rs.html#617-619)

#### pub fn [get\_added\_plugins](#method.get_added_plugins)<T>(&self) -> [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[&T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\>

where T: [Plugin](trait.Plugin.html "trait bevy::prelude::Plugin"),

Returns a vector of references to all plugins of type `T` that have been added.

This can be used to read the settings of any existing plugins. This vector will be empty if no plugins of that type have been added. If multiple copies of the same plugin are added to the [`App`](struct.App.html "struct bevy::prelude::App"), they will be listed in insertion order in this vector.
...
#### pub fn [add\_plugins](#method.add_plugins)<M>(&mut self, plugins: impl [Plugins](../app/trait.Plugins.html "trait bevy::app::Plugins")<M>) -> &mut [App](struct.App.html "struct bevy::prelude::App")

Installs a [`Plugin`](trait.Plugin.html "trait bevy::prelude::Plugin") collection.
...
[`Plugin`](trait.Plugin.html "trait bevy::prelude::Plugin")s can be grouped into a set by using a [`PluginGroup`](trait.PluginGroup.html "trait bevy::prelude::PluginGroup").

There are built-in [`PluginGroup`](trait.PluginGroup.html "trait bevy::prelude::PluginGroup")s that provide core engine functionality. The [`PluginGroup`](trait.PluginGroup.html "trait bevy::prelude::PluginGroup")s available by default are `DefaultPlugins` and `MinimalPlugins`.

To customize the plugins in the group (reorder, disable a plugin, add a new plugin before / after another plugin), call [`build()`](trait.PluginGroup.html#tymethod.build "method bevy::prelude::PluginGroup::build") on the group, which will convert it to a [`PluginGroupBuilder`](../app/struct.PluginGroupBuilder.html "struct bevy::app::PluginGroupBuilder").

You can also specify a group of [`Plugin`](trait.Plugin.html "trait bevy::prelude::Plugin")s by using a tuple over [`Plugin`](trait.Plugin.html "trait bevy::prelude::Plugin")s and [`PluginGroup`](trait.PluginGroup.html "trait bevy::prelude::PluginGroup")s. See [`Plugins`](../app/trait.Plugins.html "trait bevy::app::Plugins") for more details.
...
#### pub fn [register\_type](#method.register_type)<T>(&mut self) -> &mut [App](struct.App.html "struct bevy::prelude::App")
...
Registers the type `T` in the [`AppTypeRegistry`](struct.AppTypeRegistry.html "struct bevy::prelude::AppTypeRegistry") resource, adding reflect data as specified in the [`Reflect`](trait.Reflect.html "trait bevy::prelude::Reflect") derive:
...
#### pub fn [register\_type\_data](#method.register_type_data)<T, D>(&mut self) -> &mut [App](struct.App.html "struct bevy::prelude::App")

where T: [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect") + [TypePath](trait.TypePath.html "trait bevy::prelude::TypePath"), D: [TypeData](../reflect/trait.TypeData.html "trait bevy::reflect::TypeData") + [FromType](../reflect/trait.FromType.html "trait bevy::reflect::FromType")<T>,

Available on **crate feature `bevy_reflect`** only.

Associates type data `D` with type `T` in the [`AppTypeRegistry`](struct.AppTypeRegistry.html "struct bevy::prelude::AppTypeRegistry") resource.

Most of the time [`register_type`](struct.App.html#method.register_type "method bevy::prelude::App::register_type") can be used instead to register a type you derived [`Reflect`](trait.Reflect.html "trait bevy::prelude::Reflect") for. However, in cases where you want to add a piece of type data that was not included in the list of `#[reflect(...)]` type data in the derive, or where the type is generic and cannot register e.g. `ReflectSerialize` unconditionally without knowing the specific type parameters, this method can be used to insert additional type data.
...
#### pub fn [register\_type\_conversion](#method.register_type_conversion)<T, U, F>(&mut self, function: F) -> &mut [App](struct.App.html "struct bevy::prelude::App")

where T: [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect") + [TypePath](trait.TypePath.html "trait bevy::prelude::TypePath"), U: [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect") + [TypePath](trait.TypePath.html "trait bevy::prelude::TypePath"), F: [Fn](https://doc.rust-lang.org/nightly/core/ops/function/trait.Fn.html "trait core::ops::function::Fn")(T) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<U, T> + [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
#### pub fn [register\_into\_type\_conversion](#method.register_into_type_conversion)<T, U>(&mut self) -> &mut [App](struct.App.html "struct bevy::prelude::App")

where T: [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect") + [TypePath](trait.TypePath.html "trait bevy::prelude::TypePath"), U: [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect") + [TypePath](trait.TypePath.html "trait bevy::prelude::TypePath") + [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<T>,
...
#### pub fn [register\_function](#method.register_function)<F, Marker>(&mut self, function: F) -> &mut [App](struct.App.html "struct bevy::prelude::App")

where F: [IntoFunction](trait.IntoFunction.html "trait bevy::prelude::IntoFunction")<'static, Marker> + 'static,

Available on **crate feature `reflect_functions`** only.

Registers the given function into the [`AppFunctionRegistry`](struct.AppFunctionRegistry.html "struct bevy::prelude::AppFunctionRegistry") resource.
...
Registers the given function or closure into the [`AppFunctionRegistry`](struct.AppFunctionRegistry.html "struct bevy::prelude::AppFunctionRegistry") resource using the given name.
...
For named functions (e.g. `fn add(a: i32, b: i32) -> i32 { a + b }`) where a custom name is not needed, it’s recommended to use [`register_function`](struct.App.html#method.register_function "method bevy::prelude::App::register_function") instead as the generated name is guaranteed to be unique.
...
#### pub fn [register\_required\_components](#method.register_required_components)<T, R>(&mut self) -> &mut [App](struct.App.html "struct bevy::prelude::App")
...
When `T` is added to an entity, `R` and its own required components will also be added if `R` was not already provided. The [`Default`](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") `constructor` will be used for the creation of `R`. If a custom constructor is desired, use [`App::register_required_components_with`](struct.App.html#method.register_required_components_with "method bevy::prelude::App::register_required_components_with") instead.

For the non-panicking version, see [`App::try_register_required_components`](struct.App.html#method.try_register_required_components "method bevy::prelude::App::try_register_required_components").
...
#### pub fn [register\_required\_components\_with](#method.register_required_components_with)<T, R>( &mut self, constructor: [fn](https://doc.rust-lang.org/nightly/std/primitive.fn.html)() -> R, ) -> &mut [App](struct.App.html "struct bevy::prelude::App")
...
For the panicking version, see [`App::register_required_components`](struct.App.html#method.register_required_components "method bevy::prelude::App::register_required_components").
...
For the panicking version, see [`App::register_required_components_with`](struct.App.html#method.register_required_components_with "method bevy::prelude::App::register_required_components_with").
...
Returns a reference to the main [`SubApp`](struct.SubApp.html "struct bevy::prelude::SubApp")’s [`World`](struct.World.html "struct bevy::prelude::World"). This is the same as calling [`app.main().world()`](struct.SubApp.html#method.world "method bevy::prelude::SubApp::world").

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/app.rs.html#1199)

#### pub fn [world\_mut](#method.world_mut)(&mut self) -> &mut [World](struct.World.html "struct bevy::prelude::World")

Returns a mutable reference to the main [`SubApp`](struct.SubApp.html "struct bevy::prelude::SubApp")’s [`World`](struct.World.html "struct bevy::prelude::World"). This is the same as calling [`app.main_mut().world_mut()`](struct.SubApp.html#method.world_mut "method bevy::prelude::SubApp::world_mut").
...
#### pub fn [main](#method.main)(&self) -> &[SubApp](struct.SubApp.html "struct bevy::prelude::SubApp")

Returns a reference to the main [`SubApp`](struct.SubApp.html "struct bevy::prelude::SubApp").

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/app.rs.html#1209)

#### pub fn [main\_mut](#method.main_mut)(&mut self) -> &mut [SubApp](struct.SubApp.html "struct bevy::prelude::SubApp")

Returns a mutable reference to the main [`SubApp`](struct.SubApp.html "struct bevy::prelude::SubApp").
...
#### pub fn [sub\_apps](#method.sub_apps)(&self) -> &[SubApps](../app/struct.SubApps.html "struct bevy::app::SubApps")

Returns a reference to the [`SubApps`](../app/struct.SubApps.html "struct bevy::app::SubApps") collection.

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/app.rs.html#1219)

#### pub fn [sub\_apps\_mut](#method.sub_apps_mut)(&mut self) -> &mut [SubApps](../app/struct.SubApps.html "struct bevy::app::SubApps")

Returns a mutable reference to the [`SubApps`](../app/struct.SubApps.html "struct bevy::app::SubApps") collection.
...
#### pub fn [sub\_app](#method.sub_app)(&self, label: impl [AppLabel](../app/trait.AppLabel.html "trait bevy::app::AppLabel")) -> &[SubApp](struct.SubApp.html "struct bevy::prelude::SubApp")

Returns a reference to the [`SubApp`](struct.SubApp.html "struct bevy::prelude::SubApp") with the given label.

##### Panics

Panics if the [`SubApp`](struct.SubApp.html "struct bevy::prelude::SubApp") doesn’t exist.

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/app.rs.html#1240)

#### pub fn [sub\_app\_mut](#method.sub_app_mut)(&mut self, label: impl [AppLabel](../app/trait.AppLabel.html "trait bevy::app::AppLabel")) -> &mut [SubApp](struct.SubApp.html "struct bevy::prelude::SubApp")
...
#### pub fn [get\_sub\_app](#method.get_sub_app)(&self, label: impl [AppLabel](../app/trait.AppLabel.html "trait bevy::app::AppLabel")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[SubApp](struct.SubApp.html "struct bevy::prelude::SubApp")\>

Returns a reference to the [`SubApp`](struct.SubApp.html "struct bevy::prelude::SubApp") with the given label, if it exists.

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/app.rs.html#1253)

#### pub fn [get\_sub\_app\_mut](#method.get_sub_app_mut)(&mut self, label: impl [AppLabel](../app/trait.AppLabel.html "trait bevy::app::AppLabel")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&mut [SubApp](struct.SubApp.html "struct bevy::prelude::SubApp")\>

Returns a mutable reference to the [`SubApp`](struct.SubApp.html "struct bevy::prelude::SubApp") with the given label, if it exists.
...
#### pub fn [insert\_sub\_app](#method.insert_sub_app)(&mut self, label: impl [AppLabel](../app/trait.AppLabel.html "trait bevy::app::AppLabel"), sub\_app: [SubApp](struct.SubApp.html "struct bevy::prelude::SubApp"))

Inserts a [`SubApp`](struct.SubApp.html "struct bevy::prelude::SubApp") with the given label.

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/app.rs.html#1268)

#### pub fn [remove\_sub\_app](#method.remove_sub_app)(&mut self, label: impl [AppLabel](../app/trait.AppLabel.html "trait bevy::app::AppLabel")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[SubApp](struct.SubApp.html "struct bevy::prelude::SubApp")\>

Removes the [`SubApp`](struct.SubApp.html "struct bevy::prelude::SubApp") with the given label, if it exists.

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/app.rs.html#1273)

#### pub fn [update\_sub\_app\_by\_label](#method.update_sub_app_by_label)(&mut self, label: impl [AppLabel](../app/trait.AppLabel.html "trait bevy::app::AppLabel"))

Extract data from the main world into the [`SubApp`](struct.SubApp.html "struct bevy::prelude::SubApp") with the given label and perform an update if it exists.

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/app.rs.html#1279)

#### pub fn [add\_schedule](#method.add_schedule)(&mut self, schedule: [Schedule](struct.Schedule.html "struct bevy::prelude::Schedule")) -> &mut [App](struct.App.html "struct bevy::prelude::App")
...
#### pub fn [init\_schedule](#method.init_schedule)(&mut self, label: impl [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")) -> &mut [App](struct.App.html "struct bevy::prelude::App")

Initializes an empty `schedule` under the provided `label`, if it does not exist.

See [`add_schedule`](struct.App.html#method.add_schedule "method bevy::prelude::App::add_schedule") to insert an existing schedule.
...
#### pub fn [get\_schedule](#method.get_schedule)(&self, label: impl [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[Schedule](struct.Schedule.html "struct bevy::prelude::Schedule")\>

Returns a reference to the [`Schedule`](struct.Schedule.html "struct bevy::prelude::Schedule") with the provided `label` if it exists.

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/app.rs.html#1298)

#### pub fn [get\_schedule\_mut](#method.get_schedule_mut)( &mut self, label: impl [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&mut [Schedule](struct.Schedule.html "struct bevy::prelude::Schedule")\>

Returns a mutable reference to the [`Schedule`](struct.Schedule.html "struct bevy::prelude::Schedule") with the provided `label` if it exists.

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/app.rs.html#1305-1309)

#### pub fn [edit\_schedule](#method.edit_schedule)( &mut self, label: impl [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel"), f: impl [FnMut](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html "trait core::ops::function::FnMut")(&mut [Schedule](struct.Schedule.html "struct bevy::prelude::Schedule")), ) -> &mut [App](struct.App.html "struct bevy::prelude::App")

Runs function `f` with the [`Schedule`](struct.Schedule.html "struct bevy::prelude::Schedule") associated with `label`.
...
#### pub fn [configure\_schedules](#method.configure_schedules)( &mut self, schedule\_build\_settings: [ScheduleBuildSettings](../ecs/schedule/struct.ScheduleBuildSettings.html "struct bevy::ecs::schedule::ScheduleBuildSettings"), ) -> &mut [App](struct.App.html "struct bevy::prelude::App")
...
#### pub fn [allow\_ambiguous\_component](#method.allow_ambiguous_component)<T>(&mut self) -> &mut [App](struct.App.html "struct bevy::prelude::App")

where T: [Component](trait.Component.html "trait bevy::prelude::Component"),

When doing [ambiguity checking](../ecs/schedule/struct.ScheduleBuildSettings.html "struct bevy::ecs::schedule::ScheduleBuildSettings") this ignores systems that are ambiguous on [`Component`](trait.Component.html "trait bevy::prelude::Component") T.

This settings only applies to the main world. To apply this to other worlds call the [corresponding method](struct.World.html#method.allow_ambiguous_component "method bevy::prelude::World::allow_ambiguous_component") on World
...
#### pub fn [allow\_ambiguous\_resource](#method.allow_ambiguous_resource)<T>(&mut self) -> &mut [App](struct.App.html "struct bevy::prelude::App")

where T: [Resource](trait.Resource.html "trait bevy::prelude::Resource"),

When doing [ambiguity checking](../ecs/schedule/struct.ScheduleBuildSettings.html "struct bevy::ecs::schedule::ScheduleBuildSettings") this ignores systems that are ambiguous on [`Resource`](trait.Resource.html "trait bevy::prelude::Resource") T.

This settings only applies to the main world. To apply this to other worlds call the [corresponding method](struct.World.html#method.allow_ambiguous_resource "method bevy::prelude::World::allow_ambiguous_resource") on World
...
#### pub fn [ignore\_ambiguity](#method.ignore_ambiguity)<M1, M2, S1, S2>( &mut self, schedule: impl [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel"), a: S1, b: S2, ) -> &mut [App](struct.App.html "struct bevy::prelude::App")

where S1: [IntoSystemSet](trait.IntoSystemSet.html "trait bevy::prelude::IntoSystemSet")<M1>, S2: [IntoSystemSet](trait.IntoSystemSet.html "trait bevy::prelude::IntoSystemSet")<M2>,
...
#### pub fn [should\_exit](#method.should_exit)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[AppExit](enum.AppExit.html "enum bevy::prelude::AppExit")\>

Attempts to determine if an [`AppExit`](enum.AppExit.html "enum bevy::prelude::AppExit") was raised since the last update.

Will attempt to return the first [`Error`](enum.AppExit.html#variant.Error "variant bevy::prelude::AppExit::Error") it encounters. This should be called after every [`update()`](struct.App.html#method.update "method bevy::prelude::App::update") otherwise you risk dropping possible [`AppExit`](enum.AppExit.html "enum bevy::prelude::AppExit") events.
...
#### pub fn [add\_observer](#method.add_observer)<M>(&mut self, observer: impl [IntoObserver](../ecs/observer/trait.IntoObserver.html "trait bevy::ecs::observer::IntoObserver")<M>) -> &mut [App](struct.App.html "struct bevy::prelude::App")

Spawns an [`Observer`](struct.Observer.html "struct bevy::prelude::Observer") entity, which will watch for and respond to the given event.

`observer` can be any system whose first parameter is [`On`](struct.On.html "struct bevy::prelude::On").
...
#### pub fn [get\_error\_handler](#method.get_error_handler)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[fn](https://doc.rust-lang.org/nightly/std/primitive.fn.html)([BevyError](struct.BevyError.html "struct bevy::prelude::BevyError"), [ErrorContext](../ecs/error/enum.ErrorContext.html "enum bevy::ecs::error::ErrorContext"))>
...
#### pub fn [set\_error\_handler](#method.set_error_handler)( &mut self, handler: [fn](https://doc.rust-lang.org/nightly/std/primitive.fn.html)([BevyError](struct.BevyError.html "struct bevy::prelude::BevyError"), [ErrorContext](../ecs/error/enum.ErrorContext.html "enum bevy::ecs::error::ErrorContext")), ) -> &mut [App](struct.App.html "struct bevy::prelude::App")
...
### impl [AddAudioSource](../audio/trait.AddAudioSource.html "trait bevy::audio::AddAudioSource") for [App](struct.App.html "struct bevy::prelude::App")

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/lib.rs.html#108-111)

#### fn [add\_audio\_source](../audio/trait.AddAudioSource.html#tymethod.add_audio_source)<T>(&mut self) -> &mut [App](struct.App.html "struct bevy::prelude::App")

where T: [Decodable](trait.Decodable.html "trait bevy::prelude::Decodable") + [Asset](trait.Asset.html "trait bevy::prelude::Asset"), [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html): [FromSample](https://docs.rs/dasp_sample/0.11.0/x86_64-unknown-linux-gnu/dasp_sample/conv/trait.FromSample.html "trait dasp_sample::conv::FromSample")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\>,

Registers an audio source. The type must implement [`Decodable`](trait.Decodable.html "trait bevy::prelude::Decodable"), so that it can be converted to a [`rodio::Source`](../audio/trait.Source.html "trait bevy::audio::Source") type, and [`Asset`](trait.Asset.html "trait bevy::prelude::Asset"), so that it can be registered as an asset. To use this method on [`App`](struct.App.html "struct bevy::prelude::App"), the [audio](../audio/struct.AudioPlugin.html "struct bevy::audio::AudioPlugin") and [asset](struct.AssetPlugin.html "struct bevy::prelude::AssetPlugin") plugins must be added first.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/draw.rs.html#383)

### impl [AddRenderCommand](../render/render_phase/trait.AddRenderCommand.html "trait bevy::render::render_phase::AddRenderCommand") for [App](struct.App.html "struct bevy::prelude::App")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/draw.rs.html#384-388)

#### fn [add\_render\_command](../render/render_phase/trait.AddRenderCommand.html#tymethod.add_render_command)<P, C>(&mut self) -> &mut [App](struct.App.html "struct bevy::prelude::App")
...
### impl [AppExtStates](trait.AppExtStates.html "trait bevy::prelude::AppExtStates") for [App](struct.App.html "struct bevy::prelude::App")

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/app.rs.html#289)

#### fn [init\_state](trait.AppExtStates.html#tymethod.init_state)<S>(&mut self) -> &mut [App](struct.App.html "struct bevy::prelude::App")

where S: [FreelyMutableState](../state/state/trait.FreelyMutableState.html "trait bevy::state::state::FreelyMutableState") + [FromWorld](trait.FromWorld.html "trait bevy::prelude::FromWorld"),

Initializes a [`State`](struct.State.html "struct bevy::prelude::State") with standard starting values. [Read more](trait.AppExtStates.html#tymethod.init_state)

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/app.rs.html#294)

#### fn [insert\_state](trait.AppExtStates.html#tymethod.insert_state)<S>(&mut self, state: S) -> &mut [App](struct.App.html "struct bevy::prelude::App")

where S: [FreelyMutableState](../state/state/trait.FreelyMutableState.html "trait bevy::state::state::FreelyMutableState"),

Inserts a specific [`State`](struct.State.html "struct bevy::prelude::State") to the current [`App`](struct.App.html "struct bevy::prelude::App") and overrides any [`State`](struct.State.html "struct bevy::prelude::State") previously added of the same type. [Read more](trait.AppExtStates.html#tymethod.insert_state)

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/app.rs.html#299)

#### fn [add\_computed\_state](trait.AppExtStates.html#tymethod.add_computed_state)<S>(&mut self) -> &mut [App](struct.App.html "struct bevy::prelude::App")

where S: [ComputedStates](trait.ComputedStates.html "trait bevy::prelude::ComputedStates"),

Sets up a type implementing [`ComputedStates`](trait.ComputedStates.html "trait bevy::prelude::ComputedStates"). [Read more](trait.AppExtStates.html#tymethod.add_computed_state)

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/app.rs.html#304)

#### fn [add\_sub\_state](trait.AppExtStates.html#tymethod.add_sub_state)<S>(&mut self) -> &mut [App](struct.App.html "struct bevy::prelude::App")

where S: [SubStates](trait.SubStates.html "trait bevy::prelude::SubStates"),

Sets up a type implementing [`SubStates`](trait.SubStates.html "trait bevy::prelude::SubStates"). [Read more](trait.AppExtStates.html#tymethod.add_sub_state)

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/app.rs.html#310-312)

#### fn [register\_type\_state](trait.AppExtStates.html#tymethod.register_type_state)<S>(&mut self) -> &mut [App](struct.App.html "struct bevy::prelude::App")

where S: [States](trait.States.html "trait bevy::prelude::States") + [FromReflect](trait.FromReflect.html "trait bevy::prelude::FromReflect") + [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") + [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed"),

Available on **crate feature `bevy_reflect`** only.

Registers the state type `T` using [`App::register_type`](struct.App.html#method.register_type "method bevy::prelude::App::register_type"), and adds [`ReflectState`](struct.ReflectState.html "struct bevy::prelude::ReflectState") type data to `T` in the type registry. [Read more](trait.AppExtStates.html#tymethod.register_type_state)

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/app.rs.html#319-321)

#### fn [register\_type\_mutable\_state](trait.AppExtStates.html#tymethod.register_type_mutable_state)<S>(&mut self) -> &mut [App](struct.App.html "struct bevy::prelude::App")

where S: [FreelyMutableState](../state/state/trait.FreelyMutableState.html "trait bevy::state::state::FreelyMutableState") + [FromReflect](trait.FromReflect.html "trait bevy::prelude::FromReflect") + [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") + [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed"),

Available on **crate feature `bevy_reflect`** only.

Registers the state type `T` using [`App::register_type`](struct.App.html#method.register_type "method bevy::prelude::App::register_type"), and adds [`crate::reflect::ReflectState`](struct.ReflectState.html "struct bevy::prelude::ReflectState") and [`crate::reflect::ReflectFreelyMutableState`](struct.ReflectFreelyMutableState.html "struct bevy::prelude::ReflectFreelyMutableState") type data to `T` in the type registry. [Read more](trait.AppExtStates.html#tymethod.register_type_mutable_state)
...
#### fn [init\_gizmo\_group](trait.AppGizmoBuilder.html#tymethod.init_gizmo_group)<Config>(&mut self) -> &mut [App](struct.App.html "struct bevy::prelude::App")

where Config: [GizmoConfigGroup](trait.GizmoConfigGroup.html "trait bevy::prelude::GizmoConfigGroup"),

Registers [`GizmoConfigGroup`](trait.GizmoConfigGroup.html "trait bevy::prelude::GizmoConfigGroup") in the app enabling the use of [Gizmos<Config>](struct.Gizmos.html "struct bevy::prelude::Gizmos"). [Read more](trait.AppGizmoBuilder.html#tymethod.init_gizmo_group)

[Source](https://docs.rs/bevy_gizmos/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gizmos/lib.rs.html#185-189)

#### fn [insert\_gizmo\_config](trait.AppGizmoBuilder.html#tymethod.insert_gizmo_config)<Config>( &mut self, group: Config, config: [GizmoConfig](struct.GizmoConfig.html "struct bevy::prelude::GizmoConfig"), ) -> &mut [App](struct.App.html "struct bevy::prelude::App")

where Config: [GizmoConfigGroup](trait.GizmoConfigGroup.html "trait bevy::prelude::GizmoConfigGroup"),

Insert a [`GizmoConfig`](struct.GizmoConfig.html "struct bevy::prelude::GizmoConfig") into a specific [`GizmoConfigGroup`](trait.GizmoConfigGroup.html "trait bevy::prelude::GizmoConfigGroup"). [Read more](trait.AppGizmoBuilder.html#tymethod.insert_gizmo_config)
...
#### fn [register\_asset\_loader](trait.AssetApp.html#tymethod.register_asset_loader)<L>(&mut self, loader: L) -> &mut [App](struct.App.html "struct bevy::prelude::App")
...
#### fn [register\_asset\_processor](trait.AssetApp.html#tymethod.register_asset_processor)<P>(&mut self, processor: P) -> &mut [App](struct.App.html "struct bevy::prelude::App")
...
#### fn [register\_asset\_source](trait.AssetApp.html#tymethod.register_asset_source)( &mut self, id: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[AssetSourceId](../asset/io/enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'static>>, source: [AssetSourceBuilder](../asset/io/struct.AssetSourceBuilder.html "struct bevy::asset::io::AssetSourceBuilder"), ) -> &mut [App](struct.App.html "struct bevy::prelude::App")

Registers the given [`AssetSourceBuilder`](../asset/io/struct.AssetSourceBuilder.html "struct bevy::asset::io::AssetSourceBuilder") with the given `id`. [Read more](trait.AssetApp.html#tymethod.register_asset_source)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/lib.rs.html#627)

#### fn [set\_default\_asset\_processor](trait.AssetApp.html#tymethod.set_default_asset_processor)<P>(&mut self, extension: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> &mut [App](struct.App.html "struct bevy::prelude::App")
...
#### fn [init\_asset\_loader](trait.AssetApp.html#tymethod.init_asset_loader)<L>(&mut self) -> &mut [App](struct.App.html "struct bevy::prelude::App")
...
#### fn [init\_asset](trait.AssetApp.html#tymethod.init_asset)<A>(&mut self) -> &mut [App](struct.App.html "struct bevy::prelude::App")

where A: [Asset](trait.Asset.html "trait bevy::prelude::Asset"),

Initializes the given [`Asset`](trait.Asset.html "trait bevy::prelude::Asset") in the [`App`](struct.App.html "struct bevy::prelude::App") by: [Read more](trait.AssetApp.html#tymethod.init_asset)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/lib.rs.html#673-675)

#### fn [register\_asset\_reflect](trait.AssetApp.html#tymethod.register_asset_reflect)<A>(&mut self) -> &mut [App](struct.App.html "struct bevy::prelude::App")
...
Registers the asset type `T` using `[App::register]`, and adds [`ReflectAsset`](../asset/struct.ReflectAsset.html "struct bevy::asset::ReflectAsset") type data to `T` and [`ReflectHandle`](../asset/struct.ReflectHandle.html "struct bevy::asset::ReflectHandle") type data to [`Handle<T>`](enum.Handle.html "enum bevy::prelude::Handle") in the type registry. [Read more](trait.AssetApp.html#tymethod.register_asset_reflect)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/lib.rs.html#693)

#### fn [preregister\_asset\_loader](trait.AssetApp.html#tymethod.preregister_asset_loader)<L>(&mut self, extensions: &\[&[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\]) -> &mut [App](struct.App.html "struct bevy::prelude::App")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [App](struct.App.html "struct bevy::prelude::App")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [App](struct.App.html "struct bevy::prelude::App")

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/app.rs.html#110)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [App](struct.App.html "struct bevy::prelude::App")
...
### impl [GetAssetServer](../asset/io/embedded/trait.GetAssetServer.html "trait bevy::asset::io::embedded::GetAssetServer") for [App](struct.App.html "struct bevy::prelude::App")
...
### impl [RegisterDiagnostic](../diagnostic/trait.RegisterDiagnostic.html "trait bevy::diagnostic::RegisterDiagnostic") for [App](struct.App.html "struct bevy::prelude::App")

[Source](https://docs.rs/bevy_diagnostic/0.19.0/x86_64-unknown-linux-gnu/src/bevy_diagnostic/diagnostic.rs.html#434)

#### fn [register\_diagnostic](../diagnostic/trait.RegisterDiagnostic.html#tymethod.register_diagnostic)(&mut self, diagnostic: [Diagnostic](../diagnostic/struct.Diagnostic.html "struct bevy::diagnostic::Diagnostic")) -> &mut [App](struct.App.html "struct bevy::prelude::App")

Register a new [`Diagnostic`](../diagnostic/struct.Diagnostic.html "struct bevy::diagnostic::Diagnostic") with an [`App`](struct.App.html "struct bevy::prelude::App"). [Read more](../diagnostic/trait.RegisterDiagnostic.html#tymethod.register_diagnostic)
...
#### fn [clear\_messages\_on\_exit](trait.StateScopedMessagesAppExt.html#tymethod.clear_messages_on_exit)<M>(&mut self, state: impl [States](trait.States.html "trait bevy::prelude::States")) -> &mut [App](struct.App.html "struct bevy::prelude::App")

where M: [Message](trait.Message.html "trait bevy::prelude::Message"),

Clears a [`Message`](trait.Message.html "trait bevy::prelude::Message") when exiting the specified `state`. [Read more](trait.StateScopedMessagesAppExt.html#tymethod.clear_messages_on_exit)

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state_scoped_events.rs.html#161)

#### fn [clear\_messages\_on\_enter](trait.StateScopedMessagesAppExt.html#tymethod.clear_messages_on_enter)<M>(&mut self, state: impl [States](trait.States.html "trait bevy::prelude::States")) -> &mut [App](struct.App.html "struct bevy::prelude::App")

where M: [Message](trait.Message.html "trait bevy::prelude::Message"),

Clears a [`Message`](trait.Message.html "trait bevy::prelude::Message") when entering the specified `state`. [Read more](trait.StateScopedMessagesAppExt.html#tymethod.clear_messages_on_enter)

## Auto Trait Implementations

### impl ![Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [App](struct.App.html "struct bevy::prelude::App")

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [App](struct.App.html "struct bevy::prelude::App")

### impl ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [App](struct.App.html "struct bevy::prelude::App")

### impl ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [App](struct.App.html "struct bevy::prelude::App")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [App](struct.App.html "struct bevy::prelude::App")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [App](struct.App.html "struct bevy::prelude::App")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [App](struct.App.html "struct bevy::prelude::App")
