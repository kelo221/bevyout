...
#### fn [queue\_spawn\_related\_scenes](#tymethod.queue_spawn_related_scenes)<T>(&mut self, scenes: impl [SceneList](trait.SceneList.html "trait bevy::prelude::SceneList")) -> &mut Self
...
This will write directly on top of any existing components on the entity. [`Scene`](trait.Scene.html "trait bevy::prelude::Scene") is generally used as a spawning mechanism, so for most things, prefer using [`Commands::spawn_scene`](struct.Commands.html#method.spawn_scene "method bevy::prelude::Commands::spawn_scene").

See [`Scene`](trait.Scene.html "trait bevy::prelude::Scene") for the features of the scene system (and how to use it).

If your scene has a dependency that might not be loaded yet (for example, it includes a `.bsn` asset file), consider using [`Commands::spawn_scene`](struct.Commands.html#method.spawn_scene "method bevy::prelude::Commands::spawn_scene"). Note that the .bsn file format is not yet released.
