...
`color: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[LightGizmoColor](enum.LightGizmoColor.html "enum bevy::prelude::LightGizmoColor")>`

Default color strategy for this light gizmo. if [`None`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.None "variant core::option::Option::None"), use the one provided by [`LightGizmoConfigGroup`](struct.LightGizmoConfigGroup.html "struct bevy::prelude::LightGizmoConfigGroup").
...
### impl [Component](trait.Component.html "trait bevy::prelude::Component") for [ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo")

where [ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/gizmos.rs.html#210)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/gizmos.rs.html#210)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/gizmos.rs.html#210)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/gizmos.rs.html#210)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo")
...
where [ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo"): 'into\_return,
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/gizmos.rs.html#210)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ShowLightGizmo](struct.ShowLightGizmo.html "struct bevy::prelude::ShowLightGizmo")
