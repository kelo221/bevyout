...
See the comments in [`SerializedAnimationGraph`](struct.SerializedAnimationGraph.html "struct bevy::prelude::SerializedAnimationGraph") for more information.

## Fields

`node_type: [SerializedAnimationNodeType](enum.SerializedAnimationNodeType.html "enum bevy::prelude::SerializedAnimationNodeType")`

Corresponds to the `node_type` field on [`AnimationGraphNode`](struct.AnimationGraphNode.html "struct bevy::prelude::AnimationGraphNode").

`mask: [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)`

Corresponds to the `mask` field on [`AnimationGraphNode`](struct.AnimationGraphNode.html "struct bevy::prelude::AnimationGraphNode").

`weight: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Corresponds to the `weight` field on [`AnimationGraphNode`](struct.AnimationGraphNode.html "struct bevy::prelude::AnimationGraphNode").

## Trait Implementations

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/graph.rs.html#398)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [SerializedAnimationGraphNode](struct.SerializedAnimationGraphNode.html "struct bevy::prelude::SerializedAnimationGraphNode")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/graph.rs.html#398)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[SerializedAnimationGraphNode](struct.SerializedAnimationGraphNode.html "struct bevy::prelude::SerializedAnimationGraphNode"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [SerializedAnimationGraphNode](struct.SerializedAnimationGraphNode.html "struct bevy::prelude::SerializedAnimationGraphNode")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SerializedAnimationGraphNode](struct.SerializedAnimationGraphNode.html "struct bevy::prelude::SerializedAnimationGraphNode")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SerializedAnimationGraphNode](struct.SerializedAnimationGraphNode.html "struct bevy::prelude::SerializedAnimationGraphNode")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SerializedAnimationGraphNode](struct.SerializedAnimationGraphNode.html "struct bevy::prelude::SerializedAnimationGraphNode")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SerializedAnimationGraphNode](struct.SerializedAnimationGraphNode.html "struct bevy::prelude::SerializedAnimationGraphNode")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SerializedAnimationGraphNode](struct.SerializedAnimationGraphNode.html "struct bevy::prelude::SerializedAnimationGraphNode")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SerializedAnimationGraphNode](struct.SerializedAnimationGraphNode.html "struct bevy::prelude::SerializedAnimationGraphNode")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SerializedAnimationGraphNode](struct.SerializedAnimationGraphNode.html "struct bevy::prelude::SerializedAnimationGraphNode")
