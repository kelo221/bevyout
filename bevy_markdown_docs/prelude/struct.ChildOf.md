...
This is a [`Relationship`](../ecs/relationship/trait.Relationship.html "trait bevy::ecs::relationship::Relationship") component, and creates the canonical “parent / child” hierarchy. This is the “source of truth” component, and it pairs with the [`Children`](struct.Children.html "struct bevy::prelude::Children") [`RelationshipTarget`](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget").
...
[`ChildOf`](struct.ChildOf.html "struct bevy::prelude::ChildOf") contains a single “target” [`Entity`](struct.Entity.html "struct bevy::prelude::Entity"). When [`ChildOf`](struct.ChildOf.html "struct bevy::prelude::ChildOf") is inserted on a “source” entity, the “target” entity will automatically (and immediately, via a component hook) have a [`Children`](struct.Children.html "struct bevy::prelude::Children") component inserted, and the “source” entity will be added to that [`Children`](struct.Children.html "struct bevy::prelude::Children") instance.

If the [`ChildOf`](struct.ChildOf.html "struct bevy::prelude::ChildOf") component is replaced with a different “target” entity, the old target’s [`Children`](struct.Children.html "struct bevy::prelude::Children") will be automatically (and immediately, via a component hook) be updated to reflect that change.

Likewise, when the [`ChildOf`](struct.ChildOf.html "struct bevy::prelude::ChildOf") component is removed, the “source” entity will be removed from the old target’s [`Children`](struct.Children.html "struct bevy::prelude::Children"). If this results in [`Children`](struct.Children.html "struct bevy::prelude::Children") being empty, [`Children`](struct.Children.html "struct bevy::prelude::Children") will be automatically removed.

When a parent is despawned, all children (and their descendants) will _also_ be despawned.

You can create parent-child relationships in a variety of ways. The most direct way is to insert a [`ChildOf`](struct.ChildOf.html "struct bevy::prelude::ChildOf") component:
...
However if you are spawning many children, you might want to use the [`EntityWorldMut::with_children`](struct.EntityWorldMut.html#method.with_children "method bevy::prelude::EntityWorldMut::with_children") helper instead:
...
`0: [Entity](struct.Entity.html "struct bevy::prelude::Entity")`

## Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#109)

### impl [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#112)

#### pub fn [parent](#method.parent)(&self) -> [Entity](struct.Entity.html "struct bevy::prelude::Entity")
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#94)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")
...
### impl [Component](trait.Component.html "trait bevy::prelude::Component") for [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")

where [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
#### type [Mutability](trait.Component.html#associatedtype.Mutability) = [Immutable](../ecs/component/struct.Immutable.html "struct bevy::ecs::component::Immutable")
...
#### fn [map\_entities](trait.Component.html#method.map_entities)<M>(this: &mut [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf"), mapper: [&mut M](https://doc.rust-lang.org/nightly/std/primitive.reference.html))
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")
...
### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#100)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#95)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#95)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#95)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")\>
...
### impl [FromTemplate](trait.FromTemplate.html "trait bevy::prelude::FromTemplate") for [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#94)

#### type [Template](trait.FromTemplate.html#associatedtype.Template) = [ChildOfTemplate](../ecs/hierarchy/struct.ChildOfTemplate.html "struct bevy::ecs::hierarchy::ChildOfTemplate")
...
#### fn [from\_world](trait.FromWorld.html#tymethod.from_world)(\_world: &mut [World](struct.World.html "struct bevy::prelude::World")) -> [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")

Creates `Self` using data from the given [`World`](struct.World.html "struct bevy::prelude::World").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#95)

### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")
...
where [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#94)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#95)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Relationship](../ecs/relationship/trait.Relationship.html "trait bevy::ecs::relationship::Relationship") for [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#94)

#### const [ALLOW\_SELF\_REFERENTIAL](../ecs/relationship/trait.Relationship.html#associatedconstant.ALLOW_SELF_REFERENTIAL): [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html) = false

If `true`, a relationship is allowed to point to its own entity. [Read more](../ecs/relationship/trait.Relationship.html#associatedconstant.ALLOW_SELF_REFERENTIAL)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#94)

#### type [RelationshipTarget](../ecs/relationship/trait.Relationship.html#associatedtype.RelationshipTarget) = [Children](struct.Children.html "struct bevy::prelude::Children")

The [`Component`](trait.Component.html "trait bevy::prelude::Component") added to the “target” entities of this [`Relationship`](../ecs/relationship/trait.Relationship.html "trait bevy::ecs::relationship::Relationship"), which contains the list of all “source” entities that relate to the “target”.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#94)

#### fn [get](../ecs/relationship/trait.Relationship.html#tymethod.get)(&self) -> [Entity](struct.Entity.html "struct bevy::prelude::Entity")

Gets the [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") ID of the related entity.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#94)

#### fn [from](../ecs/relationship/trait.Relationship.html#tymethod.from)(entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity")) -> [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")

Creates this [`Relationship`](../ecs/relationship/trait.Relationship.html "trait bevy::ecs::relationship::Relationship") from the given `entity`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#94)

#### fn [set\_risky](../ecs/relationship/trait.Relationship.html#tymethod.set_risky)(&mut self, entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity"))

Changes the current [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") ID of the entity containing the [`RelationshipTarget`](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") to another one. [Read more](../ecs/relationship/trait.Relationship.html#tymethod.set_risky)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/mod.rs.html#150-158)

#### fn [on\_insert](../ecs/relationship/trait.Relationship.html#method.on_insert)(world: [DeferredWorld](../ecs/world/struct.DeferredWorld.html "struct bevy::ecs::world::DeferredWorld")<'\_>, \_: [HookContext](../ecs/lifecycle/struct.HookContext.html "struct bevy::ecs::lifecycle::HookContext"))

The `on_insert` component hook that maintains the [`Relationship`](../ecs/relationship/trait.Relationship.html "trait bevy::ecs::relationship::Relationship") / [`RelationshipTarget`](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") connection.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/mod.rs.html#219-226)

#### fn [on\_discard](../ecs/relationship/trait.Relationship.html#method.on_discard)(world: [DeferredWorld](../ecs/world/struct.DeferredWorld.html "struct bevy::ecs::world::DeferredWorld")<'\_>, \_: [HookContext](../ecs/lifecycle/struct.HookContext.html "struct bevy::ecs::lifecycle::HookContext"))
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")
...
### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")
