...
For more information, see the [module-level documentation](../math/curve/index.html "mod bevy::math::curve").
...
#### fn [map](#method.map)<S, F>(self, f: F) -> [MapCurve](struct.MapCurve.html "struct bevy::prelude::MapCurve")<T, S, Self, F>
...
#### fn [reparametrize](#method.reparametrize)<F>(self, domain: [Interval](struct.Interval.html "struct bevy::prelude::Interval"), f: F) -> [ReparamCurve](struct.ReparamCurve.html "struct bevy::prelude::ReparamCurve")<T, Self, F>
...
This kind of linear remapping is provided by the convenience method [`CurveExt::reparametrize_linear`](trait.CurveExt.html#method.reparametrize_linear "method bevy::prelude::CurveExt::reparametrize_linear"), which requires only the desired domain for the new curve.
...
#### fn [reparametrize\_by\_curve](#method.reparametrize_by_curve)<C>(self, other: C) -> [CurveReparamCurve](struct.CurveReparamCurve.html "struct bevy::prelude::CurveReparamCurve")<T, Self, C>

where C: [Curve](trait.Curve.html "trait bevy::prelude::Curve")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\>,

Reparametrize this [`Curve`](trait.Curve.html "trait bevy::prelude::Curve") by sampling from another curve.
...
#### fn [graph](#method.graph)(self) -> [GraphCurve](struct.GraphCurve.html "struct bevy::prelude::GraphCurve")<T, Self>

Create a new [`Curve`](trait.Curve.html "trait bevy::prelude::Curve") which is the graph of this one; that is, its output echoes the sample time as part of a tuple.
...
#### fn [zip](#method.zip)<S, C>( self, other: C, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[ZipCurve](struct.ZipCurve.html "struct bevy::prelude::ZipCurve")<T, S, Self, C>, [InvalidIntervalError](interval/struct.InvalidIntervalError.html "struct bevy::prelude::interval::InvalidIntervalError")\>

where C: [Curve](trait.Curve.html "trait bevy::prelude::Curve")<S>,

Create a new [`Curve`](trait.Curve.html "trait bevy::prelude::Curve") by zipping this curve together with another.
...
#### fn [chain](#method.chain)<C>(self, other: C) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[ChainCurve](struct.ChainCurve.html "struct bevy::prelude::ChainCurve")<T, Self, C>, [ChainError](enum.ChainError.html "enum bevy::prelude::ChainError")\>

where C: [Curve](trait.Curve.html "trait bevy::prelude::Curve")<T>,

Create a new [`Curve`](trait.Curve.html "trait bevy::prelude::Curve") by composing this curve end-to-start with another, producing another curve with outputs of the same type. The domain of the other curve is translated so that its start coincides with where this curve ends.

##### Errors

A [`ChainError`](enum.ChainError.html "enum bevy::prelude::ChainError") is returned if this curve’s domain doesn’t have a finite end or if `other`’s domain doesn’t have a finite start.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/mod.rs.html#589)

#### fn [reverse](#method.reverse)(self) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[ReverseCurve](struct.ReverseCurve.html "struct bevy::prelude::ReverseCurve")<T, Self>, [ReverseError](enum.ReverseError.html "enum bevy::prelude::ReverseError")\>

Create a new [`Curve`](trait.Curve.html "trait bevy::prelude::Curve") inverting this curve on the x-axis, producing another curve with outputs of the same type, effectively playing backwards starting at `self.domain().end()` and transitioning over to `self.domain().start()`. The domain of the new curve is still the same.

##### Errors

A [`ReverseError`](enum.ReverseError.html "enum bevy::prelude::ReverseError") is returned if this curve’s domain isn’t bounded.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/mod.rs.html#613)

#### fn [repeat](#method.repeat)(self, count: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[RepeatCurve](struct.RepeatCurve.html "struct bevy::prelude::RepeatCurve")<T, Self>, [RepeatError](enum.RepeatError.html "enum bevy::prelude::RepeatError")\>

Create a new [`Curve`](trait.Curve.html "trait bevy::prelude::Curve") repeating this curve `N` times, producing another curve with outputs of the same type. The domain of the new curve will be bigger by a factor of `n + 1`.
...
A [`RepeatError`](enum.RepeatError.html "enum bevy::prelude::RepeatError") is returned if this curve’s domain isn’t bounded.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/mod.rs.html#646)

#### fn [forever](#method.forever)(self) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[ForeverCurve](struct.ForeverCurve.html "struct bevy::prelude::ForeverCurve")<T, Self>, [RepeatError](enum.RepeatError.html "enum bevy::prelude::RepeatError")\>

Create a new [`Curve`](trait.Curve.html "trait bevy::prelude::Curve") repeating this curve forever, producing another curve with outputs of the same type. The domain of the new curve will be unbounded.
...
#### fn [ping\_pong](#method.ping_pong)(self) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[PingPongCurve](struct.PingPongCurve.html "struct bevy::prelude::PingPongCurve")<T, Self>, [PingPongError](enum.PingPongError.html "enum bevy::prelude::PingPongError")\>

Create a new [`Curve`](trait.Curve.html "trait bevy::prelude::Curve") chaining the original curve with its inverse, producing another curve with outputs of the same type. The domain of the new curve will be twice as long. The transition point is guaranteed to not make any jumps.

##### Errors

A [`PingPongError`](enum.PingPongError.html "enum bevy::prelude::PingPongError") is returned if this curve’s domain isn’t right-finite.
...
If `samples` is less than 2 or if this curve has unbounded domain, a [`ResamplingError`](enum.ResamplingError.html "enum bevy::prelude::ResamplingError") is returned.
...
#### fn [flip](#method.flip)<U, V>(self) -> impl [Curve](trait.Curve.html "trait bevy::prelude::Curve")<[(V, U)](https://doc.rust-lang.org/nightly/std/primitive.tuple.html)\>
