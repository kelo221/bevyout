...
[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/font.rs.html#29)
...
Loaded by [`FontLoader`](../text/struct.FontLoader.html "struct bevy::text::FontLoader").

## A note on fonts

`Font` may differ from the everyday notion of what a “font” is. A font _face_ (e.g. Fira Sans Semibold Italic) is part of a font _family_ (e.g. Fira Sans), and is distinguished from other font faces in the same family by its style (e.g. italic), its weight (e.g. bold) and its stretch (e.g. condensed).

Bevy currently loads a single font face as a single `Font` asset.

## Fields

`data: [Blob](https://docs.rs/linebender_resource_handle/0.1.1/x86_64-unknown-linux-gnu/linebender_resource_handle/blob/struct.Blob.html "struct linebender_resource_handle::blob::Blob")<[u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)>`

Content of a font file as bytes

`alias: [String](struct.String.html "struct bevy::prelude::String")`

Alias used to identify the asset in the when referenced by handle.

## Implementations

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/font.rs.html#36)

### impl [Font](struct.Font.html "struct bevy::prelude::Font")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/font.rs.html#38)

#### pub fn [from\_bytes](#method.from_bytes)(font\_data: [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)\>) -> [Font](struct.Font.html "struct bevy::prelude::Font")

Creates a [`Font`](struct.Font.html "struct bevy::prelude::Font") from bytes
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Font](struct.Font.html "struct bevy::prelude::Font")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/font.rs.html#28)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Font](struct.Font.html "struct bevy::prelude::Font")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Font](struct.Font.html "struct bevy::prelude::Font")
...
### impl [VisitAssetDependencies](../asset/trait.VisitAssetDependencies.html "trait bevy::asset::VisitAssetDependencies") for [Font](struct.Font.html "struct bevy::prelude::Font")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Font](struct.Font.html "struct bevy::prelude::Font")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Font](struct.Font.html "struct bevy::prelude::Font")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Font](struct.Font.html "struct bevy::prelude::Font")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Font](struct.Font.html "struct bevy::prelude::Font")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Font](struct.Font.html "struct bevy::prelude::Font")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Font](struct.Font.html "struct bevy::prelude::Font")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Font](struct.Font.html "struct bevy::prelude::Font")
