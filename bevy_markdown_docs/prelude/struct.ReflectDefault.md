...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/std_traits.rs.html#12)
...
A [`ReflectDefault`](struct.ReflectDefault.html "struct bevy::prelude::ReflectDefault") for type `T` can be obtained via [`FromType::from_type`](../reflect/trait.FromType.html#tymethod.from_type "associated function bevy::reflect::FromType::from_type").

## Implementations

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/std_traits.rs.html#16)

### impl [ReflectDefault](struct.ReflectDefault.html "struct bevy::prelude::ReflectDefault")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/std_traits.rs.html#18)

#### pub fn [default](#method.default)(&self) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>

Returns the default value for a type.

##### [Examples found in repository](#scraped-examples)[?](../../scrape-examples-help.html)

examples/reflection/dynamic\_types.rs ([line 125](../../src/dynamic_types/dynamic_types.rs.html#125))
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/std_traits.rs.html#11)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ReflectDefault](struct.ReflectDefault.html "struct bevy::prelude::ReflectDefault")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/std_traits.rs.html#11)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ReflectDefault](struct.ReflectDefault.html "struct bevy::prelude::ReflectDefault")
...
### impl<T> [FromType](../reflect/trait.FromType.html "trait bevy::reflect::FromType")<T> for [ReflectDefault](struct.ReflectDefault.html "struct bevy::prelude::ReflectDefault")

where T: [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect") + [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default"),

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/std_traits.rs.html#24)

#### fn [from\_type](../reflect/trait.FromType.html#tymethod.from_type)() -> [ReflectDefault](struct.ReflectDefault.html "struct bevy::prelude::ReflectDefault")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ReflectDefault](struct.ReflectDefault.html "struct bevy::prelude::ReflectDefault")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ReflectDefault](struct.ReflectDefault.html "struct bevy::prelude::ReflectDefault")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ReflectDefault](struct.ReflectDefault.html "struct bevy::prelude::ReflectDefault")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ReflectDefault](struct.ReflectDefault.html "struct bevy::prelude::ReflectDefault")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ReflectDefault](struct.ReflectDefault.html "struct bevy::prelude::ReflectDefault")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ReflectDefault](struct.ReflectDefault.html "struct bevy::prelude::ReflectDefault")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ReflectDefault](struct.ReflectDefault.html "struct bevy::prelude::ReflectDefault")
