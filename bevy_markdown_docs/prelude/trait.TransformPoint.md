...
#### fn [transform\_point](#tymethod.transform_point)(&self, point: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")\>) -> [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")
...
### impl [TransformPoint](trait.TransformPoint.html "trait bevy::prelude::TransformPoint") for [Affine3A](../math/struct.Affine3A.html "struct bevy::math::Affine3A")
