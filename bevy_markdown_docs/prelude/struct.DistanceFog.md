...
*   [`FogFalloff::Linear`](enum.FogFalloff.html#variant.Linear "variant bevy::prelude::FogFalloff::Linear")
*   [`FogFalloff::Exponential`](enum.FogFalloff.html#variant.Exponential "variant bevy::prelude::FogFalloff::Exponential")
*   [`FogFalloff::ExponentialSquared`](enum.FogFalloff.html#variant.ExponentialSquared "variant bevy::prelude::FogFalloff::ExponentialSquared")
*   [`FogFalloff::Atmospheric`](enum.FogFalloff.html#variant.Atmospheric "variant bevy::prelude::FogFalloff::Atmospheric")
...
Once enabled for a specific camera, the fog effect can also be disabled for individual [`StandardMaterial`](struct.StandardMaterial.html "struct bevy::prelude::StandardMaterial") instances via the `fog_enabled` flag.
...
`directional_light_color: [Color](enum.Color.html "enum bevy::prelude::Color")`
...
Use [`Color::NONE`](enum.Color.html#associatedconstant.NONE "associated constant bevy::prelude::Color::NONE") to disable the effect.
...
`falloff: [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")`
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#51)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")
...
### impl [Component](trait.Component.html "trait bevy::prelude::Component") for [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")

where [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#469)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#51)

### impl [ExtractComponent](../render/extract_component/trait.ExtractComponent.html "trait bevy::render::extract_component::ExtractComponent") for [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")

where [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog"): [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#51)

#### type [QueryData](../render/extract_component/trait.ExtractComponent.html#associatedtype.QueryData) = &'static [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")
...
#### type [QueryFilter](../render/extract_component/trait.ExtractComponent.html#associatedtype.QueryFilter) = [With](struct.With.html "struct bevy::prelude::With")<[Camera](struct.Camera.html "struct bevy::prelude::Camera")\>

Filters the entities with additional constraints.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#51)

#### type [Out](../render/extract_component/trait.ExtractComponent.html#associatedtype.Out) = [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")
...
#### fn [extract\_component](../render/extract_component/trait.ExtractComponent.html#tymethod.extract_component)( item: <<[DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog") as [ExtractComponent](../render/extract_component/trait.ExtractComponent.html "trait bevy::render::extract_component::ExtractComponent")\>::[QueryData](../render/extract_component/trait.ExtractComponent.html#associatedtype.QueryData "type bevy::render::extract_component::ExtractComponent::QueryData") as [QueryData](../ecs/query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../ecs/query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'\_, '\_>, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog") as [ExtractComponent](../render/extract_component/trait.ExtractComponent.html "trait bevy::render::extract_component::ExtractComponent")\>::[Out](../render/extract_component/trait.ExtractComponent.html#associatedtype.Out "type bevy::render::extract_component::ExtractComponent::Out")\>
...
### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#51)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#51)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")
...
where [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog"): 'into\_return,
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#51)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [SyncComponent](../render/sync_component/trait.SyncComponent.html "trait bevy::render::sync_component::SyncComponent") for [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")

where [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog"): [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#51)

#### type [Target](../render/sync_component/trait.SyncComponent.html#associatedtype.Target) = ([DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog"), [ViewFogUniformOffset](../pbr/struct.ViewFogUniformOffset.html "struct bevy::pbr::ViewFogUniformOffset"))
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DistanceFog](struct.DistanceFog.html "struct bevy::prelude::DistanceFog")
