...
The resource is updated inside of the [`touch_screen_input_system`](../input/touch/fn.touch_screen_input_system.html "fn bevy::input::touch::touch_screen_input_system").

## Implementations

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/touch.rs.html#260)

### impl [Touches](struct.Touches.html "struct bevy::prelude::Touches")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/touch.rs.html#262)

#### pub fn [iter](#method.iter)(&self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = &[Touch](../input/touch/struct.Touch.html "struct bevy::input::touch::Touch")\>

An iterator visiting every pressed [`Touch`](../input/touch/struct.Touch.html "struct bevy::input::touch::Touch") input in arbitrary order.
...
#### pub fn [get\_pressed](#method.get_pressed)(&self, id: [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[Touch](../input/touch/struct.Touch.html "struct bevy::input::touch::Touch")\>

Returns the [`Touch`](../input/touch/struct.Touch.html "struct bevy::input::touch::Touch") input corresponding to the `id` if it is being pressed.
...
Future calls to [`Touches::just_pressed`](struct.Touches.html#method.just_pressed "method bevy::prelude::Touches::just_pressed") for the given touch input will return false until a new press event occurs.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/touch.rs.html#301)

#### pub fn [iter\_just\_pressed](#method.iter_just_pressed)(&self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = &[Touch](../input/touch/struct.Touch.html "struct bevy::input::touch::Touch")\>

An iterator visiting every just pressed [`Touch`](../input/touch/struct.Touch.html "struct bevy::input::touch::Touch") input in arbitrary order.
...
#### pub fn [get\_released](#method.get_released)(&self, id: [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[Touch](../input/touch/struct.Touch.html "struct bevy::input::touch::Touch")\>

Returns the [`Touch`](../input/touch/struct.Touch.html "struct bevy::input::touch::Touch") input corresponding to the `id` if it has just been released.
...
Future calls to [`Touches::just_released`](struct.Touches.html#method.just_released "method bevy::prelude::Touches::just_released") for the given touch input will return false until a new release event occurs.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/touch.rs.html#328)

#### pub fn [iter\_just\_released](#method.iter_just_released)(&self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = &[Touch](../input/touch/struct.Touch.html "struct bevy::input::touch::Touch")\>

An iterator visiting every just released [`Touch`](../input/touch/struct.Touch.html "struct bevy::input::touch::Touch") input in arbitrary order.
...
Future calls to [`Touches::just_canceled`](struct.Touches.html#method.just_canceled "method bevy::prelude::Touches::just_canceled") for the given touch input will return false until a new cancel event occurs.

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/touch.rs.html#350)

#### pub fn [iter\_just\_canceled](#method.iter_just_canceled)(&self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = &[Touch](../input/touch/struct.Touch.html "struct bevy::input::touch::Touch")\>

An iterator visiting every just canceled [`Touch`](../input/touch/struct.Touch.html "struct bevy::input::touch::Touch") input in arbitrary order.
...
#### pub fn [first\_pressed\_position](#method.first_pressed_position)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")\>
...
See also [`Touches::reset_all`](struct.Touches.html#method.reset_all "method bevy::prelude::Touches::reset_all") for a full reset.
...
See also [`Touches::clear`](struct.Touches.html#method.clear "method bevy::prelude::Touches::clear") for clearing only touches that have just been pressed, released or canceled.

## Trait Implementations

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/touch.rs.html#248)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Touches](struct.Touches.html "struct bevy::prelude::Touches")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/touch.rs.html#248)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Touches](struct.Touches.html "struct bevy::prelude::Touches")
...
### impl [Component](trait.Component.html "trait bevy::prelude::Component") for [Touches](struct.Touches.html "struct bevy::prelude::Touches")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Touches](struct.Touches.html "struct bevy::prelude::Touches")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Touches](struct.Touches.html "struct bevy::prelude::Touches")

[Source](https://docs.rs/bevy_input/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input/touch.rs.html#248)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Touches](struct.Touches.html "struct bevy::prelude::Touches")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Touches](struct.Touches.html "struct bevy::prelude::Touches")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Touches](struct.Touches.html "struct bevy::prelude::Touches")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Touches](struct.Touches.html "struct bevy::prelude::Touches")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Touches](struct.Touches.html "struct bevy::prelude::Touches")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Touches](struct.Touches.html "struct bevy::prelude::Touches")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Touches](struct.Touches.html "struct bevy::prelude::Touches")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Touches](struct.Touches.html "struct bevy::prelude::Touches")
