...
The internals are made transparent to give curve authors freedom, but [the provided constructor](struct.EvenCore.html#method.new "associated function bevy::prelude::EvenCore::new") enforces the required invariants, and the methods maintain those invariants.
...
`domain: [Interval](struct.Interval.html "struct bevy::prelude::Interval")`
...
Like [`sample_interp`](struct.EvenCore.html#method.sample_interp "method bevy::prelude::EvenCore::sample_interp"), but the returned values include the sample times. This can be useful when sample interpolation is not scale-invariant.

## Trait Implementations

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#120)

### impl<T> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>

where T: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#120)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>
...
### impl<T> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>
...
### impl<'de, T> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>
...
### impl<T> [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>
...
#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#122)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T> as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>>
...
### impl<T> [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>
...
### impl<T> [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>
...
### impl<T> [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>
...
where [EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>: 'into\_return,
...
### impl<T> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>

where T: [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"),

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#120)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl<T> [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#122)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<T> [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>
...
### impl<T> [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>
...
### impl<T> [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>
...
### impl<T> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>

### impl<T> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>
...
### impl<T> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>

where T: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>

where T: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>

where T: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<T> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>

### impl<T> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [EvenCore](struct.EvenCore.html "struct bevy::prelude::EvenCore")<T>
