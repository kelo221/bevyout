...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [BackOutCurve](struct.BackOutCurve.html "struct bevy::prelude::BackOutCurve")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#930)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [BackOutCurve](struct.BackOutCurve.html "struct bevy::prelude::BackOutCurve")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [BackOutCurve](struct.BackOutCurve.html "struct bevy::prelude::BackOutCurve")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [BackOutCurve](struct.BackOutCurve.html "struct bevy::prelude::BackOutCurve")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [BackOutCurve](struct.BackOutCurve.html "struct bevy::prelude::BackOutCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [BackOutCurve](struct.BackOutCurve.html "struct bevy::prelude::BackOutCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [BackOutCurve](struct.BackOutCurve.html "struct bevy::prelude::BackOutCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [BackOutCurve](struct.BackOutCurve.html "struct bevy::prelude::BackOutCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [BackOutCurve](struct.BackOutCurve.html "struct bevy::prelude::BackOutCurve")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [BackOutCurve](struct.BackOutCurve.html "struct bevy::prelude::BackOutCurve")
