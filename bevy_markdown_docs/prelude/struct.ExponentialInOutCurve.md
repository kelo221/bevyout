...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ExponentialInOutCurve](struct.ExponentialInOutCurve.html "struct bevy::prelude::ExponentialInOutCurve")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#900)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ExponentialInOutCurve](struct.ExponentialInOutCurve.html "struct bevy::prelude::ExponentialInOutCurve")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [ExponentialInOutCurve](struct.ExponentialInOutCurve.html "struct bevy::prelude::ExponentialInOutCurve")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ExponentialInOutCurve](struct.ExponentialInOutCurve.html "struct bevy::prelude::ExponentialInOutCurve")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ExponentialInOutCurve](struct.ExponentialInOutCurve.html "struct bevy::prelude::ExponentialInOutCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ExponentialInOutCurve](struct.ExponentialInOutCurve.html "struct bevy::prelude::ExponentialInOutCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ExponentialInOutCurve](struct.ExponentialInOutCurve.html "struct bevy::prelude::ExponentialInOutCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ExponentialInOutCurve](struct.ExponentialInOutCurve.html "struct bevy::prelude::ExponentialInOutCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ExponentialInOutCurve](struct.ExponentialInOutCurve.html "struct bevy::prelude::ExponentialInOutCurve")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ExponentialInOutCurve](struct.ExponentialInOutCurve.html "struct bevy::prelude::ExponentialInOutCurve")
