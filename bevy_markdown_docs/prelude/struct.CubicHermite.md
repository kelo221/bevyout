...
`control_points: [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[(P, P)](https://doc.rust-lang.org/nightly/std/primitive.tuple.html)>`
...
### impl<P> [CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P>
...
### impl<P> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P>
...
#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P>
...
#### fn [to\_curve](trait.CubicGenerator.html#tymethod.to_curve)( &self, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>, <[CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P> as [CubicGenerator](trait.CubicGenerator.html "trait bevy::prelude::CubicGenerator")<P>>::[Error](trait.CubicGenerator.html#associatedtype.Error "type bevy::prelude::CubicGenerator::Error")\>
...
#### fn [to\_curve\_cyclic](trait.CyclicCubicGenerator.html#tymethod.to_curve_cyclic)( &self, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>, <[CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P> as [CyclicCubicGenerator](trait.CyclicCubicGenerator.html "trait bevy::prelude::CyclicCubicGenerator")<P>>::[Error](trait.CyclicCubicGenerator.html#associatedtype.Error "type bevy::prelude::CyclicCubicGenerator::Error")\>
...
### impl<P> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P>
...
### impl<P> [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P>>
...
### impl<P> [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P>
...
### impl<P> [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P>
...
### impl<P> [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P>
...
where [CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P>: 'into\_return,
...
### impl<P> [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P>
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P>>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#144)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<P> [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P>
...
### impl<P> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P>

### impl<P> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P>
...
### impl<P> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P>

where P: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<P> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P>

where P: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<P> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P>

where P: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<P> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P>

### impl<P> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [CubicHermite](struct.CubicHermite.html "struct bevy::prelude::CubicHermite")<P>
