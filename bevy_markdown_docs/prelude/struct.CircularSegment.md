...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#444)
...
The segment is drawn starting from [`Vec2::Y`](struct.Vec2.html#associatedconstant.Y "associated constant bevy::prelude::Vec2::Y"), extending equally on either side. To orient the segment differently, apply a rotation. The segment is drawn with the center of its circle at the origin [`Vec2::ZERO`](struct.Vec2.html#associatedconstant.ZERO "associated constant bevy::prelude::Vec2::ZERO"). When positioning a segment, the [`apothem`](struct.CircularSegment.html#method.apothem "method bevy::prelude::CircularSegment::apothem") function may be particularly useful.
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#471)

### impl [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#474)

#### pub const fn [new](#method.new)(radius: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), half\_angle: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")

Create a new [`CircularSegment`](struct.CircularSegment.html "struct bevy::prelude::CircularSegment") from a `radius`, and a `half_angle` in radians.

##### [Examples found in repository](#scraped-examples)[?](../../scrape-examples-help.html)

examples/testbed/2d.rs ([line 122](../../src/testbed_2d/2d.rs.html#122))
...
examples/2d/2d\_shapes.rs ([line 57](../../src/2d_shapes/2d_shapes.rs.html#57))
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#482)

#### pub const fn [from\_radians](#method.from_radians)(radius: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), angle: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")

Create a new [`CircularSegment`](struct.CircularSegment.html "struct bevy::prelude::CircularSegment") from a `radius` and an `angle` in radians.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#490)

#### pub const fn [from\_degrees](#method.from_degrees)(radius: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), angle: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")

Create a new [`CircularSegment`](struct.CircularSegment.html "struct bevy::prelude::CircularSegment") from a `radius` and an `angle` in degrees.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#500)

#### pub const fn [from\_turns](#method.from_turns)(radius: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), fraction: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")

Create a new [`CircularSegment`](struct.CircularSegment.html "struct bevy::prelude::CircularSegment") from a `radius` and a number of `turns` of a circle.

For instance, `0.5` turns is a semicircle.

##### [Examples found in repository](#scraped-examples-1)[?](../../scrape-examples-help.html)

examples/2d/mesh2d\_arcs.rs ([line 78](../../src/mesh2d_arcs/mesh2d_arcs.rs.html#78))
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#508)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#514)

#### pub const fn [angle](#method.angle)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Get the angle of the segment

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#520)

#### pub const fn [radius](#method.radius)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Get the radius of the segment

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#526)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#533)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#541)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#548)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#557)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#566)
...
### impl [Bounded2d](../math/bounding/trait.Bounded2d.html "trait bevy::math::bounding::Bounded2d") for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/bounding/bounded2d/primitive_impls.rs.html#139)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/bounding/bounded2d/primitive_impls.rs.html#143)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#433)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#433)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#433)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#452)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#454)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")

Returns the default [`CircularSegment`](struct.CircularSegment.html "struct bevy::prelude::CircularSegment") with radius `0.5` and covering a third of a circle

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#434)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#434)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")\> for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#433)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")) -> [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")
...
### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#437)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#437)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")
...
### impl<Config, Clear> [GizmoPrimitive2d](trait.GizmoPrimitive2d.html "trait bevy::prelude::GizmoPrimitive2d")<[CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")\> for [GizmoBuffer](../gizmos/gizmos/struct.GizmoBuffer.html "struct bevy::gizmos::gizmos::GizmoBuffer")<Config, Clear>
...
#### fn [primitive\_2d](trait.GizmoPrimitive2d.html#tymethod.primitive_2d)( &mut self, primitive: &[CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment"), isometry: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Isometry2d](struct.Isometry2d.html "struct bevy::prelude::Isometry2d")\>, color: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Color](enum.Color.html "enum bevy::prelude::Color")\>, ) -> <[GizmoBuffer](../gizmos/gizmos/struct.GizmoBuffer.html "struct bevy::gizmos::gizmos::GizmoBuffer")<Config, Clear> as [GizmoPrimitive2d](trait.GizmoPrimitive2d.html "trait bevy::prelude::GizmoPrimitive2d")<[CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")\>>::[Output](trait.GizmoPrimitive2d.html#associatedtype.Output "type bevy::prelude::GizmoPrimitive2d::Output")<'\_>

Renders a 2D primitive with its associated details.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/inset.rs.html#80)

### impl [Inset](trait.Inset.html "trait bevy::prelude::Inset") for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/inset.rs.html#81)

#### fn [inset](trait.Inset.html#tymethod.inset)(self, distance: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")

Create a new version of this primitive that is resized uniformly. That is, it resizes the shape inwards such that for the lines between vertices, it creates new parallel lines that are `distance` inwards from the original lines. [Read more](trait.Inset.html#tymethod.inset)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#437)

### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")
...
where [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment"): 'into\_return,
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#461)

#### fn [area](trait.Measured2d.html#tymethod.area)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Get the area of the shape

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#466)
...
### impl [Meshable](trait.Meshable.html "trait bevy::prelude::Meshable") for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/primitives/dim2.rs.html#390)

#### type [Output](trait.Meshable.html#associatedtype.Output) = [CircularSegmentMeshBuilder](../mesh/struct.CircularSegmentMeshBuilder.html "struct bevy::mesh::CircularSegmentMeshBuilder")
...
[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/primitives/dim2.rs.html#392)

#### fn [mesh](trait.Meshable.html#tymethod.mesh)(&self) -> <[CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment") as [Meshable](trait.Meshable.html "trait bevy::prelude::Meshable")\>::[Output](trait.Meshable.html#associatedtype.Output "type bevy::prelude::Meshable::Output")

Creates a [`Mesh`](struct.Mesh.html "struct bevy::prelude::Mesh") for a shape.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#433)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#433)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#437)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#438)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#450)

### impl [Primitive2d](trait.Primitive2d.html "trait bevy::prelude::Primitive2d") for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [CircularSegment](struct.CircularSegment.html "struct bevy::prelude::CircularSegment")
...
#### fn [to\_ring](trait.ToRing.html#tymethod.to_ring)(self, thickness: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Ring](struct.Ring.html "struct bevy::prelude::Ring")<P>
