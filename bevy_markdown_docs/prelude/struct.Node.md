...
When defining new types of UI entities, require [`Node`](struct.Node.html "struct bevy::prelude::Node") to make them behave like UI nodes.
...
*   [`RelativeCursorPosition`](../ui/struct.RelativeCursorPosition.html "struct bevy::ui::RelativeCursorPosition") to obtain the cursor position relative to this node
*   [`Interaction`](enum.Interaction.html "enum bevy::prelude::Interaction") to obtain the interaction state of this node

## Fields

`display: [Display](enum.Display.html "enum bevy::prelude::Display")`

Which layout algorithm to use when laying out this node’s contents:

*   [`Display::Flex`](enum.Display.html#variant.Flex "variant bevy::prelude::Display::Flex"): Use the Flexbox layout algorithm
*   [`Display::Grid`](enum.Display.html#variant.Grid "variant bevy::prelude::Display::Grid"): Use the CSS Grid layout algorithm
*   [`Display::None`](enum.Display.html#variant.None "variant bevy::prelude::Display::None"): Hide this node and perform layout as if it does not exist.

[https://developer.mozilla.org/en-US/docs/Web/CSS/display](https://developer.mozilla.org/en-US/docs/Web/CSS/display)

`box_sizing: [BoxSizing](enum.BoxSizing.html "enum bevy::prelude::BoxSizing")`

Which part of a Node’s box length styles like width and height control

*   [`BoxSizing::BorderBox`](enum.BoxSizing.html#variant.BorderBox "variant bevy::prelude::BoxSizing::BorderBox"): They refer to the “border box” size (size including padding and border)
*   [`BoxSizing::ContentBox`](enum.BoxSizing.html#variant.ContentBox "variant bevy::prelude::BoxSizing::ContentBox"): They refer to the “content box” size (size excluding padding and border)
...
`position_type: [PositionType](enum.PositionType.html "enum bevy::prelude::PositionType")`

Whether a node should be laid out in-flow with, or independently of its siblings:

*   [`PositionType::Relative`](enum.PositionType.html#variant.Relative "variant bevy::prelude::PositionType::Relative"): Layout this node in-flow with other nodes using the usual (flexbox/grid) layout algorithm.
*   [`PositionType::Absolute`](enum.PositionType.html#variant.Absolute "variant bevy::prelude::PositionType::Absolute"): Layout this node on top and independently of other nodes.

[https://developer.mozilla.org/en-US/docs/Web/CSS/position](https://developer.mozilla.org/en-US/docs/Web/CSS/position)

`overflow: [Overflow](struct.Overflow.html "struct bevy::prelude::Overflow")`
...
`overflow_clip_margin: [OverflowClipMargin](struct.OverflowClipMargin.html "struct bevy::prelude::OverflowClipMargin")`
...
`left: [Val](enum.Val.html "enum bevy::prelude::Val")`
...
`right: [Val](enum.Val.html "enum bevy::prelude::Val")`
...
`top: [Val](enum.Val.html "enum bevy::prelude::Val")`
...
`bottom: [Val](enum.Val.html "enum bevy::prelude::Val")`
...
`width: [Val](enum.Val.html "enum bevy::prelude::Val")`
...
`height: [Val](enum.Val.html "enum bevy::prelude::Val")`
...
`min_width: [Val](enum.Val.html "enum bevy::prelude::Val")`
...
`min_height: [Val](enum.Val.html "enum bevy::prelude::Val")`
...
`max_width: [Val](enum.Val.html "enum bevy::prelude::Val")`
...
`max_height: [Val](enum.Val.html "enum bevy::prelude::Val")`
...
`align_items: [AlignItems](enum.AlignItems.html "enum bevy::prelude::AlignItems")`
...
This value is overridden if [`AlignSelf`](enum.AlignSelf.html "enum bevy::prelude::AlignSelf") on the child node is set.

[https://developer.mozilla.org/en-US/docs/Web/CSS/align-items](https://developer.mozilla.org/en-US/docs/Web/CSS/align-items)

`justify_items: [JustifyItems](enum.JustifyItems.html "enum bevy::prelude::JustifyItems")`
...
This value is overridden if [`JustifySelf`](enum.JustifySelf.html "enum bevy::prelude::JustifySelf") on the child node is set.
...
`align_self: [AlignSelf](enum.AlignSelf.html "enum bevy::prelude::AlignSelf")`
...
If set to `Auto`, alignment is inherited from the value of [`AlignItems`](enum.AlignItems.html "enum bevy::prelude::AlignItems") set on the parent node.

[https://developer.mozilla.org/en-US/docs/Web/CSS/align-self](https://developer.mozilla.org/en-US/docs/Web/CSS/align-self)

`justify_self: [JustifySelf](enum.JustifySelf.html "enum bevy::prelude::JustifySelf")`
...
If set to `Auto`, alignment is inherited from the value of [`JustifyItems`](enum.JustifyItems.html "enum bevy::prelude::JustifyItems") set on the parent node.

[https://developer.mozilla.org/en-US/docs/Web/CSS/justify-self](https://developer.mozilla.org/en-US/docs/Web/CSS/justify-self)

`align_content: [AlignContent](enum.AlignContent.html "enum bevy::prelude::AlignContent")`

Used to control how items are distributed.

*   For Flexbox containers, controls alignment of lines if `flex_wrap` is set to [`FlexWrap::Wrap`](enum.FlexWrap.html#variant.Wrap "variant bevy::prelude::FlexWrap::Wrap") and there are multiple lines of items.
...
`justify_content: [JustifyContent](enum.JustifyContent.html "enum bevy::prelude::JustifyContent")`
...
`direction: [InlineDirection](enum.InlineDirection.html "enum bevy::prelude::InlineDirection")`
...
`margin: [UiRect](struct.UiRect.html "struct bevy::prelude::UiRect")`
...
`padding: [UiRect](struct.UiRect.html "struct bevy::prelude::UiRect")`
...
`border: [UiRect](struct.UiRect.html "struct bevy::prelude::UiRect")`
...
`border_radius: [BorderRadius](struct.BorderRadius.html "struct bevy::prelude::BorderRadius")`
...
`flex_direction: [FlexDirection](enum.FlexDirection.html "enum bevy::prelude::FlexDirection")`
...
`flex_wrap: [FlexWrap](enum.FlexWrap.html "enum bevy::prelude::FlexWrap")`
...
`flex_basis: [Val](enum.Val.html "enum bevy::prelude::Val")`
...
`row_gap: [Val](enum.Val.html "enum bevy::prelude::Val")`
...
`column_gap: [Val](enum.Val.html "enum bevy::prelude::Val")`
...
`grid_auto_flow: [GridAutoFlow](enum.GridAutoFlow.html "enum bevy::prelude::GridAutoFlow")`
...
`grid_template_rows: [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[RepeatedGridTrack](struct.RepeatedGridTrack.html "struct bevy::prelude::RepeatedGridTrack")>`
...
`grid_template_columns: [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[RepeatedGridTrack](struct.RepeatedGridTrack.html "struct bevy::prelude::RepeatedGridTrack")>`
...
`grid_auto_rows: [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[GridTrack](struct.GridTrack.html "struct bevy::prelude::GridTrack")>`
...
`grid_auto_columns: [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[GridTrack](struct.GridTrack.html "struct bevy::prelude::GridTrack")>`
...
`grid_row: [GridPlacement](struct.GridPlacement.html "struct bevy::prelude::GridPlacement")`
...
`grid_column: [GridPlacement](struct.GridPlacement.html "struct bevy::prelude::GridPlacement")`
...
### impl [Node](struct.Node.html "struct bevy::prelude::Node")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#822)

#### pub const [DEFAULT](#associatedconstant.DEFAULT): [Node](struct.Node.html "struct bevy::prelude::Node")

## Trait Implementations

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#471)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Node](struct.Node.html "struct bevy::prelude::Node")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#471)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Node](struct.Node.html "struct bevy::prelude::Node")
...
### impl [Component](trait.Component.html "trait bevy::prelude::Component") for [Node](struct.Node.html "struct bevy::prelude::Node")

where [Node](struct.Node.html "struct bevy::prelude::Node"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

**Required Components**: [`ComputedNode`](struct.ComputedNode.html "struct bevy::prelude::ComputedNode"), [`ComputedStackIndex`](../ui/struct.ComputedStackIndex.html "struct bevy::ui::ComputedStackIndex"), [`ContentSize`](../ui/struct.ContentSize.html "struct bevy::ui::ContentSize"), [`ComputedUiTargetCamera`](struct.ComputedUiTargetCamera.html "struct bevy::prelude::ComputedUiTargetCamera"), [`ComputedUiRenderTargetInfo`](struct.ComputedUiRenderTargetInfo.html "struct bevy::prelude::ComputedUiRenderTargetInfo"), [`UiTransform`](struct.UiTransform.html "struct bevy::prelude::UiTransform"), [`BackgroundColor`](struct.BackgroundColor.html "struct bevy::prelude::BackgroundColor"), [`BorderColor`](struct.BorderColor.html "struct bevy::prelude::BorderColor"), [`FocusPolicy`](../ui/enum.FocusPolicy.html "enum bevy::ui::FocusPolicy"), [`ScrollPosition`](struct.ScrollPosition.html "struct bevy::prelude::ScrollPosition"), [`Visibility`](enum.Visibility.html "enum bevy::prelude::Visibility"), [`ZIndex`](struct.ZIndex.html "struct bevy::prelude::ZIndex").
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Node](struct.Node.html "struct bevy::prelude::Node")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Node](struct.Node.html "struct bevy::prelude::Node")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#869)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Node](struct.Node.html "struct bevy::prelude::Node")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#489)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [Node](struct.Node.html "struct bevy::prelude::Node")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#489)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Node](struct.Node.html "struct bevy::prelude::Node"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Node](struct.Node.html "struct bevy::prelude::Node")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#471)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Node](struct.Node.html "struct bevy::prelude::Node")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#471)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Node](struct.Node.html "struct bevy::prelude::Node") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Node](struct.Node.html "struct bevy::prelude::Node")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Node](struct.Node.html "struct bevy::prelude::Node")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Node](struct.Node.html "struct bevy::prelude::Node")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Node](struct.Node.html "struct bevy::prelude::Node")
...
where [Node](struct.Node.html "struct bevy::prelude::Node"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Node](struct.Node.html "struct bevy::prelude::Node")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#471)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Node](struct.Node.html "struct bevy::prelude::Node")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Node](struct.Node.html "struct bevy::prelude::Node")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Node](struct.Node.html "struct bevy::prelude::Node")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#471)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Node](struct.Node.html "struct bevy::prelude::Node")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Node](struct.Node.html "struct bevy::prelude::Node")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Node](struct.Node.html "struct bevy::prelude::Node")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Node](struct.Node.html "struct bevy::prelude::Node")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [Node](struct.Node.html "struct bevy::prelude::Node")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Node](struct.Node.html "struct bevy::prelude::Node")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Node](struct.Node.html "struct bevy::prelude::Node")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Node](struct.Node.html "struct bevy::prelude::Node")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Node](struct.Node.html "struct bevy::prelude::Node")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Node](struct.Node.html "struct bevy::prelude::Node")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Node](struct.Node.html "struct bevy::prelude::Node")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Node](struct.Node.html "struct bevy::prelude::Node")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Node](struct.Node.html "struct bevy::prelude::Node")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Node](struct.Node.html "struct bevy::prelude::Node")
