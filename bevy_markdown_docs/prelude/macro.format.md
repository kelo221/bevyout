...
To convert a single value to a string, use the [`to_string`](trait.ToString.html "trait bevy::prelude::ToString") method. This will use the [`Display`](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") formatting trait.
