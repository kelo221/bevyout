...
# Struct ExitSchedules 

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state/transitions.rs.html#95)
...
### impl<S> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ExitSchedules](struct.ExitSchedules.html "struct bevy::prelude::ExitSchedules")<S>
...
#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ExitSchedules](struct.ExitSchedules.html "struct bevy::prelude::ExitSchedules")<S>
...
### impl<S> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ExitSchedules](struct.ExitSchedules.html "struct bevy::prelude::ExitSchedules")<S>
...
[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state/transitions.rs.html#97)

### impl<S> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [ExitSchedules](struct.ExitSchedules.html "struct bevy::prelude::ExitSchedules")<S>

where S: [States](trait.States.html "trait bevy::prelude::States"),

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state/transitions.rs.html#98)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [ExitSchedules](struct.ExitSchedules.html "struct bevy::prelude::ExitSchedules")<S>

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state/transitions.rs.html#93)

### impl<S> [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [ExitSchedules](struct.ExitSchedules.html "struct bevy::prelude::ExitSchedules")<S>
...
### impl<S> [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [ExitSchedules](struct.ExitSchedules.html "struct bevy::prelude::ExitSchedules")<S>
...
### impl<S> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [ExitSchedules](struct.ExitSchedules.html "struct bevy::prelude::ExitSchedules")<S>
...
#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[ExitSchedules](struct.ExitSchedules.html "struct bevy::prelude::ExitSchedules")<S>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl<S> [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [ExitSchedules](struct.ExitSchedules.html "struct bevy::prelude::ExitSchedules")<S>
...
### impl<S> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ExitSchedules](struct.ExitSchedules.html "struct bevy::prelude::ExitSchedules")<S>

### impl<S> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ExitSchedules](struct.ExitSchedules.html "struct bevy::prelude::ExitSchedules")<S>
...
### impl<S> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ExitSchedules](struct.ExitSchedules.html "struct bevy::prelude::ExitSchedules")<S>

### impl<S> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ExitSchedules](struct.ExitSchedules.html "struct bevy::prelude::ExitSchedules")<S>

### impl<S> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ExitSchedules](struct.ExitSchedules.html "struct bevy::prelude::ExitSchedules")<S>

where S: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<S> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ExitSchedules](struct.ExitSchedules.html "struct bevy::prelude::ExitSchedules")<S>

### impl<S> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ExitSchedules](struct.ExitSchedules.html "struct bevy::prelude::ExitSchedules")<S>
