...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ResamplingError](enum.ResamplingError.html "enum bevy::prelude::ResamplingError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [ResamplingError](enum.ResamplingError.html "enum bevy::prelude::ResamplingError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [ResamplingError](enum.ResamplingError.html "enum bevy::prelude::ResamplingError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ResamplingError](enum.ResamplingError.html "enum bevy::prelude::ResamplingError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ResamplingError](enum.ResamplingError.html "enum bevy::prelude::ResamplingError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ResamplingError](enum.ResamplingError.html "enum bevy::prelude::ResamplingError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ResamplingError](enum.ResamplingError.html "enum bevy::prelude::ResamplingError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ResamplingError](enum.ResamplingError.html "enum bevy::prelude::ResamplingError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ResamplingError](enum.ResamplingError.html "enum bevy::prelude::ResamplingError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ResamplingError](enum.ResamplingError.html "enum bevy::prelude::ResamplingError")
