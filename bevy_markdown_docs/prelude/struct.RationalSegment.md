...
Note that the `knot_span` is used only by [compound curves](struct.RationalCurve.html "struct bevy::prelude::RationalCurve") constructed by chaining these together.
...
### impl<P> [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>
...
### impl<P> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>
...
#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>
...
### impl<P> [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>
...
### impl<P> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>
...
### impl<P> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>
...
#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>
...
### impl<'de, P> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>
...
### impl<P> [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>
...
#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#1328)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P> as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>>
...
### impl<P> [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>
...
### impl<P> [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>
...
### impl<P> [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>
...
where [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>: 'into\_return,
...
### impl<P> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>
...
#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl<P> [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#1328)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>>, ) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<P> [SampleDerivative](derivatives/trait.SampleDerivative.html "trait bevy::prelude::derivatives::SampleDerivative")<P> for [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>
...
### impl<P> [SampleTwoDerivatives](derivatives/trait.SampleTwoDerivatives.html "trait bevy::prelude::derivatives::SampleTwoDerivatives")<P> for [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>
...
### impl<P> [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>
...
### impl<P> [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>
...
### impl<P> [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>
...
### impl<P> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>

where P: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"),

### impl<P> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>
...
### impl<P> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>

where P: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<P> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>

where P: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<P> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>

where P: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<P> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>

where P: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"),

### impl<P> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RationalSegment](struct.RationalSegment.html "struct bevy::prelude::RationalSegment")<P>
