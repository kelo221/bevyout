...
When set to `true` sprite picking will only consider cameras marked with [`SpritePickingCamera`](struct.SpritePickingCamera.html "struct bevy::prelude::SpritePickingCamera"). Defaults to `false`. Regardless of this setting, only sprites marked with [`Pickable`](struct.Pickable.html "struct bevy::prelude::Pickable") will be considered.
...
`picking_mode: [SpritePickingMode](enum.SpritePickingMode.html "enum bevy::prelude::SpritePickingMode")`
...
### impl [Component](trait.Component.html "trait bevy::prelude::Component") for [SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings")

[Source](https://docs.rs/bevy_sprite/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite/picking_backend.rs.html#68)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_sprite/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite/picking_backend.rs.html#51)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings")

[Source](https://docs.rs/bevy_sprite/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite/picking_backend.rs.html#51)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_sprite/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite/picking_backend.rs.html#51)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings")
...
where [SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings"): 'into\_return,
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_sprite/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite/picking_backend.rs.html#51)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings")\>, ) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SpritePickingSettings](struct.SpritePickingSettings.html "struct bevy::prelude::SpritePickingSettings")
