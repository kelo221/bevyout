...
[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#282)
...
A [`FontSource`](enum.FontSource.html "enum bevy::prelude::FontSource") can be a handle to a font asset, a font family name, or a generic font category that is resolved using Parley’s font database.

Font family fallback (selection of a font when the requested font is not found) is automatically handled by [`parley::fontique`](https://docs.rs/fontique/0.9.0/x86_64-unknown-linux-gnu/fontique/index.html "mod fontique"). Be sure to enable the `parley/system` feature for automatic discovery of system fonts.

Generally speaking, these fallbacks are OS-specific, and do not require manual configuration.

You can check which font family is used for a given [`FontSource`](enum.FontSource.html "enum bevy::prelude::FontSource") by calling [`FontCx::get_family`](../text/struct.FontCx.html#method.get_family "method bevy::text::FontCx::get_family").

## Variants

### Handle([Handle](enum.Handle.html "enum bevy::prelude::Handle")<[Font](struct.Font.html "struct bevy::prelude::Font")\>)

Use a specific font face referenced by a [`Font`](struct.Font.html "struct bevy::prelude::Font") asset handle.

If the default font handle is used, then

*   if `default_font` feature is enabled (enabled by default in `bevy` crate), `FiraMono-subset.ttf` compiled into the library is used.
*   otherwise no text will be rendered, unless a custom font is loaded into the default font handle.

### Family([SmolStr](https://docs.rs/smol_str/0.2.2/x86_64-unknown-linux-gnu/smol_str/struct.SmolStr.html "struct smol_str::SmolStr"))
...
Serif fonts are typically used for long passages of text and represent a more traditional or formal typographic style.

### SansSerif

Fonts without serifs.

Sans-serif fonts generally have low stroke contrast and plain stroke endings, making them common for UI text and on-screen reading.

### Cursive

Fonts that use a cursive or handwritten style.

Glyphs often resemble connected or flowing pen or brush strokes rather than printed letterforms.

### Fantasy

Decorative or expressive fonts.

Fantasy fonts are primarily intended for display purposes and may prioritize visual style over readability.

### Monospace

Fonts in which all glyphs have the same fixed advance width.

Monospace fonts are commonly used for code, tabular data, and text where vertical alignment is important.
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#267)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")
...
[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#342)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#343)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#267)

### impl [Enum](../reflect/enums/trait.Enum.html "trait bevy::reflect::enums::Enum") for [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")
...
[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#366)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\> for [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#367)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(family: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")
...
[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#360)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[SmolStr](https://docs.rs/smol_str/0.2.2/x86_64-unknown-linux-gnu/smol_str/struct.SmolStr.html "struct smol_str::SmolStr")\> for [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#361)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(family: [SmolStr](https://docs.rs/smol_str/0.2.2/x86_64-unknown-linux-gnu/smol_str/struct.SmolStr.html "struct smol_str::SmolStr")) -> [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#267)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#267)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#267)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[FontSource](enum.FontSource.html "enum bevy::prelude::FontSource") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)(\_\_param0: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")\>
...
#### type [Template](trait.FromTemplate.html#associatedtype.Template) = [FontSourceTemplate](../text/enum.FontSourceTemplate.html "enum bevy::text::FontSourceTemplate")

The [`Template`](trait.Template.html "trait bevy::prelude::Template") for this type.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#267)

### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")
...
where [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#267)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")
...
### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [FontSource](enum.FontSource.html "enum bevy::prelude::FontSource")
