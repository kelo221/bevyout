...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#98)
...
Each [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") has a set of unique components, based on their type. Entity components can be created, updated, removed, and queried using a given [`World`](struct.World.html "struct bevy::prelude::World").

For complex access patterns involving [`SystemParam`](../ecs/system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam"), consider using [`SystemState`](../ecs/system/struct.SystemState.html "struct bevy::ecs::system::SystemState").

To mutate different parts of the world simultaneously, use [`World::resource_scope`](struct.World.html#method.resource_scope "method bevy::prelude::World::resource_scope") or [`SystemState`](../ecs/system/struct.SystemState.html "struct bevy::ecs::system::SystemState").

### Resources

Worlds can also store [`Resource`](trait.Resource.html "trait bevy::prelude::Resource")s, which are unique instances of a given type that belong to a specific unique Entity. There are also _non send resources_, which can only be accessed on the main thread. These are stored outside of the ECS. See [`Resource`](trait.Resource.html "trait bevy::prelude::Resource") for usage.

## Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/event/mod.rs.html#347)

### impl [World](struct.World.html "struct bevy::prelude::World")
...
where E: [Event](trait.Event.html "trait bevy::prelude::Event"),
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/observer/mod.rs.html#26)

### impl [World](struct.World.html "struct bevy::prelude::World")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/observer/mod.rs.html#55)

#### pub fn [add\_observer](#method.add_observer)<M>( &mut self, observer: impl [IntoObserver](../ecs/observer/trait.IntoObserver.html "trait bevy::ecs::observer::IntoObserver")<M>, ) -> [EntityWorldMut](struct.EntityWorldMut.html "struct bevy::prelude::EntityWorldMut")<'\_>

Spawns a “global” [`Observer`](struct.Observer.html "struct bevy::prelude::Observer") which will watch for the given event. Returns its [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") as a [`EntityWorldMut`](struct.EntityWorldMut.html "struct bevy::prelude::EntityWorldMut").

`system` can be any system whose first parameter is [`On`](struct.On.html "struct bevy::prelude::On").
...
**Calling [`observe`](struct.EntityWorldMut.html#method.observe "method bevy::prelude::EntityWorldMut::observe") on the returned [`EntityWorldMut`](struct.EntityWorldMut.html "struct bevy::prelude::EntityWorldMut") will observe the observer itself, which you very likely do not want.**
...
where E: [Event](trait.Event.html "trait bevy::prelude::Event"), <E as [Event](trait.Event.html "trait bevy::prelude::Event")\>::[Trigger](trait.Event.html#associatedtype.Trigger "type bevy::prelude::Event::Trigger")<'a>: [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default"),

Triggers the given [`Event`](trait.Event.html "trait bevy::prelude::Event"), which will run any [`Observer`](struct.Observer.html "struct bevy::prelude::Observer")s watching for it.

For a variant that borrows the `event` rather than consuming it, use [`World::trigger_ref`](struct.World.html#method.trigger_ref "method bevy::prelude::World::trigger_ref") instead.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/observer/mod.rs.html#75)

#### pub fn [trigger\_with](#method.trigger_with)<'a, E>( &mut self, event: E, trigger: <E as [Event](trait.Event.html "trait bevy::prelude::Event")\>::[Trigger](trait.Event.html#associatedtype.Trigger "type bevy::prelude::Event::Trigger")<'a>, )

where E: [Event](trait.Event.html "trait bevy::prelude::Event"),

Triggers the given [`Event`](trait.Event.html "trait bevy::prelude::Event") using the given [`Trigger`](../ecs/event/trait.Trigger.html "trait bevy::ecs::event::Trigger"), which will run any [`Observer`](struct.Observer.html "struct bevy::prelude::Observer")s watching for it.
...
Triggers the given mutable [`Event`](trait.Event.html "trait bevy::prelude::Event") reference, which will run any [`Observer`](struct.Observer.html "struct bevy::prelude::Observer")s watching for it.

Compared to [`World::trigger`](struct.World.html#method.trigger "method bevy::prelude::World::trigger"), this method is most useful when it’s necessary to check or use the event after it has been modified by observers.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/observer/mod.rs.html#97)

#### pub fn [trigger\_ref\_with](#method.trigger_ref_with)<'a, E>( &mut self, event: [&mut E](https://doc.rust-lang.org/nightly/std/primitive.reference.html), trigger: &mut <E as [Event](trait.Event.html "trait bevy::prelude::Event")\>::[Trigger](trait.Event.html#associatedtype.Trigger "type bevy::prelude::Event::Trigger")<'a>, )

where E: [Event](trait.Event.html "trait bevy::prelude::Event"),

Triggers the given mutable [`Event`](trait.Event.html "trait bevy::prelude::Event") reference using the given mutable [`Trigger`](../ecs/event/trait.Trigger.html "trait bevy::ecs::event::Trigger") reference, which will run any [`Observer`](struct.Observer.html "struct bevy::prelude::Observer")s watching for it.
...
Triggers global [`Observer`](struct.Observer.html "struct bevy::prelude::Observer")s for `event_key` with untyped event and trigger data.

Dynamic equivalent of [`World::trigger`](struct.World.html#method.trigger "method bevy::prelude::World::trigger"). Only fires global observers, not entity- or component-scoped ones.

Use [`World::trigger_dynamic_targets`](struct.World.html#method.trigger_dynamic_targets "method bevy::prelude::World::trigger_dynamic_targets") to also fire entity-scoped observers.
...
#### pub unsafe fn [trigger\_dynamic\_targets](#method.trigger_dynamic_targets)( &mut self, event\_key: [EventKey](../ecs/event/struct.EventKey.html "struct bevy::ecs::event::EventKey"), entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity"), event\_data: [PtrMut](../ecs/ptr/struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'\_>, trigger\_data: [PtrMut](../ecs/ptr/struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'\_>, )

Triggers [`Observer`](struct.Observer.html "struct bevy::prelude::Observer")s for `event_key` targeting `entity`, with untyped event and trigger data.

Fires global and entity-scoped observers. Dynamic equivalent of [`EntityWorldMut::trigger`](struct.EntityWorldMut.html#method.trigger "method bevy::prelude::EntityWorldMut::trigger").
...
#### pub unsafe fn [trigger\_dynamic\_targets\_components](#method.trigger_dynamic_targets_components)( &mut self, event\_key: [EventKey](../ecs/event/struct.EventKey.html "struct bevy::ecs::event::EventKey"), entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity"), components: &\[[ComponentId](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")\], event\_data: [PtrMut](../ecs/ptr/struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'\_>, trigger\_data: [PtrMut](../ecs/ptr/struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'\_>, )

Triggers [`Observer`](struct.Observer.html "struct bevy::prelude::Observer")s for `event_key` targeting `entity` and `components`, with untyped event and trigger data.
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_registry.rs.html#443)

### impl [World](struct.World.html "struct bevy::prelude::World")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_registry.rs.html#455-461)

#### pub fn [register\_system](#method.register_system)<I, O, M>( &mut self, system: impl [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<I, O, M> + 'static, ) -> [SystemId](../ecs/system/struct.SystemId.html "struct bevy::ecs::system::SystemId")<I, O>

where I: [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput") + 'static, O: 'static,

Registers a system and returns a [`SystemId`](../ecs/system/struct.SystemId.html "struct bevy::ecs::system::SystemId") so it can later be called by [`World::run_system`](struct.World.html#method.run_system "method bevy::prelude::World::run_system").

It’s possible to register multiple copies of the same system by calling this function multiple times. If that’s not what you want, consider using [`World::register_system_cached`](struct.World.html#method.register_system_cached "method bevy::prelude::World::register_system_cached") instead.

This is different from adding systems to a [`Schedule`](struct.Schedule.html "struct bevy::prelude::Schedule"), because the [`SystemId`](../ecs/system/struct.SystemId.html "struct bevy::ecs::system::SystemId") that is returned can be used anywhere in the [`World`](struct.World.html "struct bevy::prelude::World") to run the associated system. This allows for running systems in a pushed-based fashion. Using a [`Schedule`](struct.Schedule.html "struct bevy::prelude::Schedule") is still preferred for most cases due to its better performance and ability to run non-conflicting systems simultaneously.
...
#### pub fn [register\_boxed\_system](#method.register_boxed_system)<I, O>( &mut self, system: [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [System](trait.System.html "trait bevy::prelude::System")<Out = O, In = I>>, ) -> [SystemId](../ecs/system/struct.SystemId.html "struct bevy::ecs::system::SystemId")<I, O>

where I: [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput") + 'static, O: 'static,

Similar to [`Self::register_system`](struct.World.html#method.register_system "method bevy::prelude::World::register_system"), but allows passing in a [`BoxedSystem`](../ecs/system/type.BoxedSystem.html "type bevy::ecs::system::BoxedSystem").

This is useful if the [`IntoSystem`](trait.IntoSystem.html "trait bevy::prelude::IntoSystem") implementor has already been turned into a [`System`](trait.System.html "trait bevy::prelude::System") trait object and put in a [`Box`](struct.Box.html "struct bevy::prelude::Box").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_registry.rs.html#491-497)

#### pub fn [register\_tracked\_system](#method.register_tracked_system)<I, O, M>( &mut self, system: impl [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<I, O, M> + 'static, ) -> [SystemHandle](../ecs/system/enum.SystemHandle.html "enum bevy::ecs::system::SystemHandle")<I, O>

where I: [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput") + 'static, O: 'static,

Registers a system and returns a tracked [`SystemHandle`](../ecs/system/enum.SystemHandle.html "enum bevy::ecs::system::SystemHandle") so it can later be called by [`World::run_system`](struct.World.html#method.run_system "method bevy::prelude::World::run_system"). The system entity will be automatically queued for despawn when the last clone of the returned handle is dropped.
...
#### pub fn [register\_tracked\_boxed\_system](#method.register_tracked_boxed_system)<I, O>( &mut self, system: [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [System](trait.System.html "trait bevy::prelude::System")<Out = O, In = I>>, ) -> [SystemHandle](../ecs/system/enum.SystemHandle.html "enum bevy::ecs::system::SystemHandle")<I, O>

where I: [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput") + 'static, O: 'static,

Similar to [`Self::register_tracked_system`](struct.World.html#method.register_tracked_system "method bevy::prelude::World::register_tracked_system"), but allows passing in a [`BoxedSystem`](../ecs/system/type.BoxedSystem.html "type bevy::ecs::system::BoxedSystem").
...
To use the supplied input, the system should have a [`SystemInput`](trait.SystemInput.html "trait bevy::prelude::SystemInput") as the first parameter. Also runs any queued-up commands.
...
See [`World::run_system`](struct.World.html#method.run_system "method bevy::prelude::World::run_system") for more examples.
...
where I: [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput") + 'static, O: 'static, S: [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<I, O, M> + 'static,

Registers a system or returns its cached [`SystemId`](../ecs/system/struct.SystemId.html "struct bevy::ecs::system::SystemId").

If you want to run the system immediately and you don’t need its `SystemId`, see [`World::run_system_cached`](struct.World.html#method.run_system_cached "method bevy::prelude::World::run_system_cached").
...
See [`World::register_system_cached`](struct.World.html#method.register_system_cached "method bevy::prelude::World::register_system_cached") for more information.
...
where O: 'static, S: [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), O, M> + 'static,
...
#### pub fn [run\_system\_cached\_with](#method.run_system_cached_with)<I, O, M, S>( &mut self, system: S, input: <I as [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput")\>::[Inner](trait.SystemInput.html#associatedtype.Inner "type bevy::prelude::SystemInput::Inner")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<O, [RegisteredSystemError](../ecs/system/enum.RegisteredSystemError.html "enum bevy::ecs::system::RegisteredSystemError")<I, O>>

where I: [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput") + 'static, O: 'static, S: [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<I, O, M> + 'static,

Runs a cached system with an input, registering it if necessary.

To use the supplied input, the system should have a [`SystemInput`](trait.SystemInput.html "trait bevy::prelude::SystemInput") as the first parameter. See [`World::register_system_cached`](struct.World.html#method.register_system_cached "method bevy::prelude::World::register_system_cached") for more information.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/reflect.rs.html#13)

### impl [World](struct.World.html "struct bevy::prelude::World")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/reflect.rs.html#69-73)

#### pub fn [get\_reflect](#method.get_reflect)( &self, entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity"), type\_id: [TypeId](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<&(dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect") + 'static), [GetComponentReflectError](../ecs/world/reflect/enum.GetComponentReflectError.html "enum bevy::ecs::world::reflect::GetComponentReflectError")\>

Retrieves a reference to the given `entity`’s [`Component`](trait.Component.html "trait bevy::prelude::Component") of the given `type_id` using reflection.

Requires implementing [`Reflect`](trait.Reflect.html "trait bevy::prelude::Reflect") for the [`Component`](trait.Component.html "trait bevy::prelude::Component") (e.g., using [`#[derive(Reflect)`](derive.Reflect.html "derive bevy::prelude::Reflect")) and `app.register_type::<TheComponent>()` to have been called[1](#fn1).

If you want to call this with a [`ComponentId`](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId"), see [`World::components`](struct.World.html#method.components "method bevy::prelude::World::components") and [`Components::get_id`](../ecs/component/struct.Components.html#method.get_id "method bevy::ecs::component::Components::get_id") to get the corresponding [`TypeId`](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId").

Also see the crate documentation for [`bevy_reflect`](../reflect/index.html "mod bevy::reflect") for more information on [`Reflect`](trait.Reflect.html "trait bevy::prelude::Reflect") and bevy’s reflection capabilities.
...
1.  More specifically: Requires [`TypeData`](../reflect/trait.TypeData.html "trait bevy::reflect::TypeData") for [`ReflectFromPtr`](../reflect/struct.ReflectFromPtr.html "struct bevy::reflect::ReflectFromPtr") to be registered for the given `type_id`, which is automatically handled when deriving [`Reflect`](trait.Reflect.html "trait bevy::prelude::Reflect") and calling [`App::register_type`](../../bevy_app/struct.App.html#method.register_type). [↩](#fnref1)
    

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/reflect.rs.html#141-145)

#### pub fn [get\_reflect\_mut](#method.get_reflect_mut)( &mut self, entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity"), type\_id: [TypeId](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Mut](struct.Mut.html "struct bevy::prelude::Mut")<'\_, dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [GetComponentReflectError](../ecs/world/reflect/enum.GetComponentReflectError.html "enum bevy::ecs::world::reflect::GetComponentReflectError")\>

Retrieves a mutable reference to the given `entity`’s [`Component`](trait.Component.html "trait bevy::prelude::Component") of the given `type_id` using reflection.

Requires implementing [`Reflect`](trait.Reflect.html "trait bevy::prelude::Reflect") for the [`Component`](trait.Component.html "trait bevy::prelude::Component") (e.g., using [`#[derive(Reflect)`](derive.Reflect.html "derive bevy::prelude::Reflect")) and `app.register_type::<TheComponent>()` to have been called.

This is the mutable version of [`World::get_reflect`](struct.World.html#method.get_reflect "method bevy::prelude::World::get_reflect"), see its docs for more information and an example.
...
See the documentation for [`World::get_reflect`](struct.World.html#method.get_reflect "method bevy::prelude::World::get_reflect").
...
#### pub fn [insert\_reflect\_resource](#method.insert_reflect_resource)( &mut self, resource\_id: [ComponentId](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId"), reflected\_resource: [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>, )

Inserts a reflected resource into the world. If the resource already exists, it is overwritten.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#157)

### impl [World](struct.World.html "struct bevy::prelude::World")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#192)

#### pub fn [new](#method.new)() -> [World](struct.World.html "struct bevy::prelude::World")

Creates a new empty [`World`](struct.World.html "struct bevy::prelude::World").

##### Panics

If [`usize::MAX`](https://doc.rust-lang.org/nightly/std/primitive.usize.html#associatedconstant.MAX "associated constant usize::MAX") [`World`](struct.World.html "struct bevy::prelude::World")s have been created. This guarantee allows System Parameters to safely uniquely identify a [`World`](struct.World.html "struct bevy::prelude::World"), since its [`WorldId`](../ecs/world/struct.WorldId.html "struct bevy::ecs::world::WorldId") is unique

##### [Examples found in repository](#scraped-examples-2)[?](../../scrape-examples-help.html)

examples/ecs/custom\_executor.rs ([line 46](../../src/custom_executor/custom_executor.rs.html#46))
...
examples/scene/world\_serialization.rs ([line 175](../../src/world_serialization/world_serialization.rs.html#175))
...
examples/ecs/relationships.rs ([line 39](../../src/relationships/relationships.rs.html#39))
...
examples/ecs/dynamic.rs ([line 70](../../src/dynamic/dynamic.rs.html#70))
...
Retrieves this [`World`](struct.World.html "struct bevy::prelude::World")’s unique ID
...
Mutable reference must not be used to put the [`Entities`](../ecs/entity/struct.Entities.html "struct bevy::ecs::entity::Entities") data in an invalid state for this [`World`](struct.World.html "struct bevy::prelude::World")
...
#### pub fn [commands](#method.commands)(&mut self) -> [Commands](struct.Commands.html "struct bevy::prelude::Commands")<'\_, '\_>

Creates a new [`Commands`](struct.Commands.html "struct bevy::prelude::Commands") instance that writes to the world’s command queue Use [`World::flush`](struct.World.html#method.flush "method bevy::prelude::World::flush") to apply all queued commands
...
Registers a new [`Component`](trait.Component.html "trait bevy::prelude::Component") type and returns the [`ComponentId`](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId") created for it.
...
Returns a mutable reference to the [`ComponentHooks`](../ecs/lifecycle/struct.ComponentHooks.html "struct bevy::ecs::lifecycle::ComponentHooks") for a [`Component`](trait.Component.html "trait bevy::prelude::Component") type.
...
Returns a mutable reference to the [`ComponentHooks`](../ecs/lifecycle/struct.ComponentHooks.html "struct bevy::ecs::lifecycle::ComponentHooks") for a [`Component`](trait.Component.html "trait bevy::prelude::Component") with the given id if it exists.
...
where T: [Component](trait.Component.html "trait bevy::prelude::Component"), R: [Component](trait.Component.html "trait bevy::prelude::Component") + [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default"),

Registers the given component `R` as a [required component](trait.Component.html#required-components "trait bevy::prelude::Component") for `T`.

When `T` is added to an entity, `R` and its own required components will also be added if `R` was not already provided. The [`Default`](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") `constructor` will be used for the creation of `R`. If a custom constructor is desired, use [`World::register_required_components_with`](struct.World.html#method.register_required_components_with "method bevy::prelude::World::register_required_components_with") instead.

For the non-panicking version, see [`World::try_register_required_components`](struct.World.html#method.try_register_required_components "method bevy::prelude::World::try_register_required_components").
...
where T: [Component](trait.Component.html "trait bevy::prelude::Component"), R: [Component](trait.Component.html "trait bevy::prelude::Component"),

Registers the given component `R` as a [required component](trait.Component.html#required-components "trait bevy::prelude::Component") for `T`.

When `T` is added to an entity, `R` and its own required components will also be added if `R` was not already provided. The given `constructor` will be used for the creation of `R`. If a [`Default`](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") constructor is desired, use [`World::register_required_components`](struct.World.html#method.register_required_components "method bevy::prelude::World::register_required_components") instead.

For the non-panicking version, see [`World::try_register_required_components_with`](struct.World.html#method.try_register_required_components_with "method bevy::prelude::World::try_register_required_components_with").
...
Tries to register the given component `R` as a [required component](trait.Component.html#required-components "trait bevy::prelude::Component") for `T`.

When `T` is added to an entity, `R` and its own required components will also be added if `R` was not already provided. The [`Default`](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") `constructor` will be used for the creation of `R`. If a custom constructor is desired, use [`World::register_required_components_with`](struct.World.html#method.register_required_components_with "method bevy::prelude::World::register_required_components_with") instead.

For the panicking version, see [`World::register_required_components`](struct.World.html#method.register_required_components "method bevy::prelude::World::register_required_components").
...
For the panicking version, see [`World::register_required_components_with`](struct.World.html#method.register_required_components_with "method bevy::prelude::World::register_required_components_with").
...
Returns the [`ComponentId`](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId") of the given [`Component`](trait.Component.html "trait bevy::prelude::Component") type `T`.
...
where R: [Resource](trait.Resource.html "trait bevy::prelude::Resource"),

👎Deprecated since 0.19.0:

Use register\_component::<R>() instead.

Registers a new [`Resource`](trait.Resource.html "trait bevy::prelude::Resource") type and returns the [`ComponentId`](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId") created for it.

The [`Resource`](trait.Resource.html "trait bevy::prelude::Resource") doesn’t have a value in the [`World`](struct.World.html "struct bevy::prelude::World"), it’s only registered. If you want to insert the [`Resource`](trait.Resource.html "trait bevy::prelude::Resource") in the [`World`](struct.World.html "struct bevy::prelude::World"), use [`World::init_resource`](struct.World.html#method.init_resource "method bevy::prelude::World::init_resource") or [`World::insert_resource`](struct.World.html#method.insert_resource "method bevy::prelude::World::insert_resource") instead.
...
where T: [Resource](trait.Resource.html "trait bevy::prelude::Resource"),

👎Deprecated since 0.19.0:

use component\_id

Returns the [`ComponentId`](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId") of the given [`Resource`](trait.Resource.html "trait bevy::prelude::Resource") type `T`.

The returned [`ComponentId`](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId") is specific to the [`World`](struct.World.html "struct bevy::prelude::World") instance it was retrieved from and should not be used with another [`World`](struct.World.html "struct bevy::prelude::World") instance.

Returns [`None`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.None "variant core::option::Option::None") if the [`Resource`](trait.Resource.html "trait bevy::prelude::Resource") type has not yet been initialized within the [`World`](struct.World.html "struct bevy::prelude::World") using [`World::register_resource`](struct.World.html#method.register_resource "method bevy::prelude::World::register_resource"), [`World::init_resource`](struct.World.html#method.init_resource "method bevy::prelude::World::init_resource") or [`World::insert_resource`](struct.World.html#method.insert_resource "method bevy::prelude::World::insert_resource").
...
Returns [`EntityRef`](struct.EntityRef.html "struct bevy::prelude::EntityRef")s that expose read-only operations for the given `entities`. This will panic if any of the given entities do not exist. Use [`World::get_entity`](struct.World.html#method.get_entity "method bevy::prelude::World::get_entity") if you want to check for entity existence instead of implicitly panicking.

This function supports fetching a single entity or multiple entities:

*   Pass an [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") to receive a single [`EntityRef`](struct.EntityRef.html "struct bevy::prelude::EntityRef").
*   Pass a slice of [`Entity`](struct.Entity.html "struct bevy::prelude::Entity")s to receive a [`Vec<EntityRef>`](struct.Vec.html "struct bevy::prelude::Vec").
*   Pass an array of [`Entity`](struct.Entity.html "struct bevy::prelude::Entity")s to receive an equally-sized array of [`EntityRef`](struct.EntityRef.html "struct bevy::prelude::EntityRef")s.
...
###### Single [`Entity`](struct.Entity.html "struct bevy::prelude::Entity")
...
###### Array of [`Entity`](struct.Entity.html "struct bevy::prelude::Entity")s
...
###### Slice of [`Entity`](struct.Entity.html "struct bevy::prelude::Entity")s
...
Returns [`EntityMut`](struct.EntityMut.html "struct bevy::prelude::EntityMut")s that expose read and write operations for the given `entities`. This will panic if any of the given entities do not exist. Use [`World::get_entity_mut`](struct.World.html#method.get_entity_mut "method bevy::prelude::World::get_entity_mut") if you want to check for entity existence instead of implicitly panicking.

This function supports fetching a single entity or multiple entities:

*   Pass an [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") to receive a single [`EntityWorldMut`](struct.EntityWorldMut.html "struct bevy::prelude::EntityWorldMut").
...
*   Pass a slice of [`Entity`](struct.Entity.html "struct bevy::prelude::Entity")s to receive a [`Vec<EntityMut>`](struct.Vec.html "struct bevy::prelude::Vec").
*   Pass an array of [`Entity`](struct.Entity.html "struct bevy::prelude::Entity")s to receive an equally-sized array of [`EntityMut`](struct.EntityMut.html "struct bevy::prelude::EntityMut")s.
...
In order to perform structural changes on the returned entity reference, such as adding or removing components, or despawning the entity, only a single [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") can be passed to this function. Allowing multiple entities at the same time with structural access would lead to undefined behavior, so [`EntityMut`](struct.EntityMut.html "struct bevy::prelude::EntityMut") is returned when requesting multiple entities.
...
#### pub fn [inspect\_entity](#method.inspect_entity)( &self, entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = &[ComponentInfo](../ecs/component/struct.ComponentInfo.html "struct bevy::ecs::component::ComponentInfo")\>, [EntityNotSpawnedError](../ecs/entity/enum.EntityNotSpawnedError.html "enum bevy::ecs::entity::EntityNotSpawnedError")\>

Returns the components of an [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") through [`ComponentInfo`](../ecs/component/struct.ComponentInfo.html "struct bevy::ecs::component::ComponentInfo").
...
If any of the given `entities` do not exist in the world, the first [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") found to be missing will return an [`EntityNotSpawnedError`](../ecs/entity/enum.EntityNotSpawnedError.html "enum bevy::ecs::entity::EntityNotSpawnedError").

##### Examples

For examples, see [`World::entity`](struct.World.html#method.entity "method bevy::prelude::World::entity").
...
Returns [`EntityMut`](struct.EntityMut.html "struct bevy::prelude::EntityMut")s that expose read and write operations for the given `entities`, returning [`Err`](https://doc.rust-lang.org/nightly/core/result/enum.Result.html#variant.Err "variant core::result::Result::Err") if any of the given entities do not exist. Instead of immediately unwrapping the value returned from this function, prefer [`World::entity_mut`](struct.World.html#method.entity_mut "method bevy::prelude::World::entity_mut").
...
For examples, see [`World::entity_mut`](struct.World.html#method.entity_mut "method bevy::prelude::World::entity_mut").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#1010)

#### pub fn [iter\_entities](#method.iter_entities)(&self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = [EntityRef](struct.EntityRef.html "struct bevy::prelude::EntityRef")<'\_>>

Returns an [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") iterator of current entities.

This is useful in contexts where you only have immutable access to the [`World`](struct.World.html "struct bevy::prelude::World"). If you have mutable access to the [`World`](struct.World.html "struct bevy::prelude::World"), use [`query()::<EntityRef>().iter(&world)`](struct.World.html#method.query "method bevy::prelude::World::query") instead.
...
#### pub fn [entities\_and\_commands](#method.entities_and_commands)(&mut self) -> ([EntityFetcher](../ecs/world/struct.EntityFetcher.html "struct bevy::ecs::world::EntityFetcher")<'\_>, [Commands](struct.Commands.html "struct bevy::prelude::Commands")<'\_, '\_>)
...
#### pub fn [spawn\_at](#method.spawn_at)<B>( &mut self, entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity"), bundle: B, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[EntityWorldMut](struct.EntityWorldMut.html "struct bevy::prelude::EntityWorldMut")<'\_>, [SpawnError](../ecs/entity/enum.SpawnError.html "enum bevy::ecs::entity::SpawnError")\>
...
In general, you should prefer [`spawn`](struct.World.html#method.spawn "method bevy::prelude::World::spawn"). Spawn internally calls this method, but it takes care of finding a suitable [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") for you. This is made available for advanced use, which you can see at [`EntityAllocator::alloc`](../ecs/entity/struct.EntityAllocator.html#method.alloc "method bevy::ecs::entity::EntityAllocator::alloc").
...
#### pub fn [spawn\_empty\_at](#method.spawn_empty_at)( &mut self, entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[EntityWorldMut](struct.EntityWorldMut.html "struct bevy::prelude::EntityWorldMut")<'\_>, [SpawnError](../ecs/entity/enum.SpawnError.html "enum bevy::ecs::entity::SpawnError")\>

A faster version of [`spawn_at`](struct.World.html#method.spawn_at "method bevy::prelude::World::spawn_at") for the empty bundle.
...
#### pub fn [spawn](#method.spawn)<B>(&mut self, bundle: B) -> [EntityWorldMut](struct.EntityWorldMut.html "struct bevy::prelude::EntityWorldMut")<'\_>

where B: [Bundle](trait.Bundle.html "trait bevy::prelude::Bundle"),

Spawns a new [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") with a given [`Bundle`](trait.Bundle.html "trait bevy::prelude::Bundle") of [components](trait.Component.html "trait bevy::prelude::Component") and returns a corresponding [`EntityWorldMut`](struct.EntityWorldMut.html "struct bevy::prelude::EntityWorldMut"), which can be used to add components to the entity or retrieve its id. In case large batches of entities need to be spawned, consider using [`World::spawn_batch`](struct.World.html#method.spawn_batch "method bevy::prelude::World::spawn_batch") instead.
...
#### pub fn [spawn\_empty](#method.spawn_empty)(&mut self) -> [EntityWorldMut](struct.EntityWorldMut.html "struct bevy::prelude::EntityWorldMut")<'\_>

Spawns a new [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") and returns a corresponding [`EntityWorldMut`](struct.EntityWorldMut.html "struct bevy::prelude::EntityWorldMut"), which can be used to add components to the entity or retrieve its id.
...
where I: [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator"), <I as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[Item](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.Item "type core::iter::traits::collect::IntoIterator::Item"): [Bundle](trait.Bundle.html "trait bevy::prelude::Bundle"), <<I as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[Item](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.Item "type core::iter::traits::collect::IntoIterator::Item") as [DynamicBundle](../ecs/bundle/trait.DynamicBundle.html "trait bevy::ecs::bundle::DynamicBundle")\>::[Effect](../ecs/bundle/trait.DynamicBundle.html#associatedtype.Effect "type bevy::ecs::bundle::DynamicBundle::Effect"): [NoBundleEffect](../ecs/bundle/trait.NoBundleEffect.html "trait bevy::ecs::bundle::NoBundleEffect"),

Spawns a batch of entities with the same component [`Bundle`](trait.Bundle.html "trait bevy::prelude::Bundle") type. Takes a given [`Bundle`](trait.Bundle.html "trait bevy::prelude::Bundle") iterator and returns a corresponding [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") iterator. This is more efficient than spawning entities and adding components to them individually using [`World::spawn`](struct.World.html#method.spawn "method bevy::prelude::World::spawn"), but it is limited to spawning entities with the same [`Bundle`](trait.Bundle.html "trait bevy::prelude::Bundle") type, whereas spawning individually is more flexible.
...
#### pub fn [get](#method.get)<T>(&self, entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[&T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\>

where T: [Component](trait.Component.html "trait bevy::prelude::Component"),

Retrieves a reference to the given `entity`’s [`Component`](trait.Component.html "trait bevy::prelude::Component") of the given type. Returns `None` if the `entity` does not have a [`Component`](trait.Component.html "trait bevy::prelude::Component") of the given type.
...
#### pub fn [get\_mut](#method.get_mut)<T>(&mut self, entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Mut](struct.Mut.html "struct bevy::prelude::Mut")<'\_, T>>

where T: [Component](trait.Component.html "trait bevy::prelude::Component")<Mutability = [Mutable](../ecs/component/struct.Mutable.html "struct bevy::ecs::component::Mutable")\>,

Retrieves a mutable reference to the given `entity`’s [`Component`](trait.Component.html "trait bevy::prelude::Component") of the given type. Returns `None` if the `entity` does not have a [`Component`](trait.Component.html "trait bevy::prelude::Component") of the given type.
...
#### pub fn [modify\_component\_by\_id](#method.modify_component_by_id)<R>( &mut self, entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity"), component\_id: [ComponentId](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId"), f: impl for<'a> [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")([MutUntyped](../ecs/change_detection/struct.MutUntyped.html "struct bevy::ecs::change_detection::MutUntyped")<'a>) -> R, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<R>, [EntityMutableFetchError](../ecs/world/error/enum.EntityMutableFetchError.html "enum bevy::ecs::world::error::EntityMutableFetchError")\>

Temporarily removes a [`Component`](trait.Component.html "trait bevy::prelude::Component") identified by the provided [`ComponentId`](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId") from the provided [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") and runs the provided closure on it, returning the result if the component was available. This will trigger the `Remove` and `Discard` component hooks without causing an archetype move.

This is most useful with immutable components, where removal and reinsertion is the only way to modify a value.

If you do not need to ensure the above hooks are triggered, and your component is mutable, prefer using [`get_mut_by_id`](struct.World.html#method.get_mut_by_id "method bevy::prelude::World::get_mut_by_id").

You should prefer the typed [`modify_component`](struct.World.html#method.modify_component "method bevy::prelude::World::modify_component") whenever possible.
...
Temporarily removes a [`Resource`](trait.Resource.html "trait bevy::prelude::Resource") `R` and runs the provided closure on it, returning the result if `R` was available. This will trigger the `Remove` and `Discard` component hooks without causing an archetype move.

This is most useful with immutable resources, where removal and reinsertion is the only way to modify a value.

If you do not need to ensure the above hooks are triggered, and your resource is mutable, prefer using [`get_resource_mut`](struct.World.html#method.get_resource_mut "method bevy::prelude::World::get_resource_mut").
...
Temporarily removes a [`Resource`](trait.Resource.html "trait bevy::prelude::Resource") identified by the provided [`ComponentId`](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId") and runs the provided closure on it, returning the result if the component was available. This will trigger the `Remove` and `Discard` component hooks without causing an archetype move.

This is most useful with immutable resources, where removal and reinsertion is the only way to modify a value.

If you do not need to ensure the above hooks are triggered, and your resource is mutable, prefer using [`get_resource_mut_by_id`](struct.World.html#method.get_resource_mut_by_id "method bevy::prelude::World::get_resource_mut_by_id").

You should prefer the typed [`modify_resource`](struct.World.html#method.modify_resource "method bevy::prelude::World::modify_resource") whenever possible.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#1598)

#### pub fn [despawn](#method.despawn)(&mut self, entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Despawns the given [`Entity`](struct.Entity.html "struct bevy::prelude::Entity"), if it exists. This will also remove all of the entity’s [`Components`](trait.Component.html "trait bevy::prelude::Component").
...
This will also despawn the entities in any [`RelationshipTarget`](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") that is configured to despawn descendants. For example, this will recursively despawn [`Children`](struct.Children.html "struct bevy::prelude::Children").
...
#### pub fn [try\_despawn](#method.try_despawn)(&mut self, entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity")) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [EntityDespawnError](../ecs/world/error/struct.EntityDespawnError.html "struct bevy::ecs::world::error::EntityDespawnError")\>

Despawns the given `entity`, if it exists. This will also remove all of the entity’s [`Components`](trait.Component.html "trait bevy::prelude::Component").
...
#### pub fn [despawn\_no\_free](#method.despawn_no_free)(&mut self, entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Entity](struct.Entity.html "struct bevy::prelude::Entity")\>

Performs [`try_despawn_no_free`](struct.World.html#method.try_despawn_no_free "method bevy::prelude::World::try_despawn_no_free"), warning on errors. See that method for more information.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#1677)

#### pub fn [try\_despawn\_no\_free](#method.try_despawn_no_free)( &mut self, entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Entity](struct.Entity.html "struct bevy::prelude::Entity"), [EntityDespawnError](../ecs/world/error/struct.EntityDespawnError.html "struct bevy::ecs::world::error::EntityDespawnError")\>

Despawns the given `entity`, if it exists. This will also remove all of the entity’s [`Component`](trait.Component.html "trait bevy::prelude::Component")s.

The _only_ difference between this and [despawning](struct.World.html#method.despawn "method bevy::prelude::World::despawn") an entity is that this does not release the `entity` to be reused. It is up to the caller to either re-spawn or free the `entity`; otherwise, the [`EntityIndex`](../ecs/entity/struct.EntityIndex.html "struct bevy::ecs::entity::EntityIndex") will not be able to be reused. In general, [`despawn`](struct.World.html#method.despawn "method bevy::prelude::World::despawn") should be used instead, which automatically allows the row to be reused.

Returns the new [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") if of the despawned [`EntityIndex`](../ecs/entity/struct.EntityIndex.html "struct bevy::ecs::entity::EntityIndex"), which should eventually either be re-spawned or freed to the allocator. Returns an [`EntityDespawnError`](../ecs/world/error/struct.EntityDespawnError.html "struct bevy::ecs::world::error::EntityDespawnError") if the entity is not spawned.

##### Note

This will also _despawn_ the entities in any [`RelationshipTarget`](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") that is configured to despawn descendants. For example, this will recursively despawn [`Children`](struct.Children.html "struct bevy::prelude::Children").
...
The world maintains some internal state about changed and removed components. This state is used by [`RemovedComponents`](struct.RemovedComponents.html "struct bevy::prelude::RemovedComponents") to provide access to the entities that had a specific type of component removed since last tick.

The state is also used for change detection when accessing components and resources outside of a system, for example via [`World::get_mut()`](struct.World.html#method.get_mut "method bevy::prelude::World::get_mut") or [`World::get_resource_mut()`](struct.World.html#method.get_resource_mut "method bevy::prelude::World::get_resource_mut").
...
#### pub fn [query](#method.query)<D>(&mut self) -> [QueryState](struct.QueryState.html "struct bevy::prelude::QueryState")<D>

where D: [QueryData](../ecs/query/trait.QueryData.html "trait bevy::ecs::query::QueryData"),

Returns [`QueryState`](struct.QueryState.html "struct bevy::prelude::QueryState") for the given [`QueryData`](../ecs/query/trait.QueryData.html "trait bevy::ecs::query::QueryData"), which is used to efficiently run queries on the [`World`](struct.World.html "struct bevy::prelude::World") by storing and reusing the [`QueryState`](struct.QueryState.html "struct bevy::prelude::QueryState").
...
To iterate over entities in a deterministic order, sort the results of the query using the desired component as a key. Note that this requires fetching the whole result set from the query and allocation of a [`Vec`](struct.Vec.html "struct bevy::prelude::Vec") to store it.
...
#### pub fn [query\_filtered](#method.query_filtered)<D, F>(&mut self) -> [QueryState](struct.QueryState.html "struct bevy::prelude::QueryState")<D, F>
...
Returns [`QueryState`](struct.QueryState.html "struct bevy::prelude::QueryState") for the given filtered [`QueryData`](../ecs/query/trait.QueryData.html "trait bevy::ecs::query::QueryData"), which is used to efficiently run queries on the [`World`](struct.World.html "struct bevy::prelude::World") by storing and reusing the [`QueryState`](struct.QueryState.html "struct bevy::prelude::QueryState").
...
#### pub fn [try\_query](#method.try_query)<D>(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[QueryState](struct.QueryState.html "struct bevy::prelude::QueryState")<D>>
...
#### pub fn [try\_query\_filtered](#method.try_query_filtered)<D, F>(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[QueryState](struct.QueryState.html "struct bevy::prelude::QueryState")<D, F>>
...
#### pub fn [removed](#method.removed)<T>(&self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = [Entity](struct.Entity.html "struct bevy::prelude::Entity")\>

where T: [Component](trait.Component.html "trait bevy::prelude::Component"),

Returns an iterator of entities that had components of type `T` removed since the last call to [`World::clear_trackers`](struct.World.html#method.clear_trackers "method bevy::prelude::World::clear_trackers").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#1921)

#### pub fn [removed\_with\_id](#method.removed_with_id)( &self, component\_id: [ComponentId](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId"), ) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = [Entity](struct.Entity.html "struct bevy::prelude::Entity")\>

Returns an iterator of entities that had components with the given `component_id` removed since the last call to [`World::clear_trackers`](struct.World.html#method.clear_trackers "method bevy::prelude::World::clear_trackers").
...
Registering a non-send resource does not insert it into [`World`](struct.World.html "struct bevy::prelude::World"). For insertion, you could use [`World::insert_non_send_by_id`](struct.World.html#method.insert_non_send_by_id "method bevy::prelude::World::insert_non_send_by_id").
...
where R: [Resource](trait.Resource.html "trait bevy::prelude::Resource") + [FromWorld](trait.FromWorld.html "trait bevy::prelude::FromWorld"),
...
where R: 'static + [FromWorld](trait.FromWorld.html "trait bevy::prelude::FromWorld"),
...
The value given by the [`FromWorld::from_world`](trait.FromWorld.html#tymethod.from_world "associated function bevy::prelude::FromWorld::from_world") method will be used. Note that any non-send data with the `Default` trait automatically implements `FromWorld`, and those default values will be here instead.
...
Returns `true` if a resource of type `R` exists and was added since the world’s [`last_change_tick`](struct.World.html#method.last_change_tick "method bevy::prelude::World::last_change_tick"). Otherwise, this returns `false`.

This means that:

*   When called from an exclusive system, this will check for additions since the system last ran.
*   When called elsewhere, this will check for additions since the last time that [`World::clear_trackers`](struct.World.html#method.clear_trackers "method bevy::prelude::World::clear_trackers") was called.
...
Returns `true` if a resource with id `component_id` exists and was added since the world’s [`last_change_tick`](struct.World.html#method.last_change_tick "method bevy::prelude::World::last_change_tick"). Otherwise, this returns `false`.
...
Returns `true` if a resource of type `R` exists and was modified since the world’s [`last_change_tick`](struct.World.html#method.last_change_tick "method bevy::prelude::World::last_change_tick"). Otherwise, this returns `false`.

This means that:

*   When called from an exclusive system, this will check for changes since the system last ran.
*   When called elsewhere, this will check for changes since the last time that [`World::clear_trackers`](struct.World.html#method.clear_trackers "method bevy::prelude::World::clear_trackers") was called.
...
Returns `true` if a resource with id `component_id` exists and was modified since the world’s [`last_change_tick`](struct.World.html#method.last_change_tick "method bevy::prelude::World::last_change_tick"). Otherwise, this returns `false`.
...
**You should prefer to use the typed API [`World::get_resource_change_ticks`](struct.World.html#method.get_resource_change_ticks "method bevy::prelude::World::get_resource_change_ticks") where possible.**
...
Panics if the resource does not exist. Use [`get_resource`](struct.World.html#method.get_resource "method bevy::prelude::World::get_resource") instead if you want to handle this case.

If you want to instead insert a value if the resource does not exist, use [`get_resource_or_insert_with`](struct.World.html#method.get_resource_or_insert_with "method bevy::prelude::World::get_resource_or_insert_with").
...
#### pub fn [resource\_ref](#method.resource_ref)<R>(&self) -> [Ref](struct.Ref.html "struct bevy::prelude::Ref")<'\_, R>
...
Panics if the resource does not exist. Use [`get_resource_ref`](struct.World.html#method.get_resource_ref "method bevy::prelude::World::get_resource_ref") instead if you want to handle this case.

If you want to instead insert a value if the resource does not exist, use [`get_resource_or_insert_with`](struct.World.html#method.get_resource_or_insert_with "method bevy::prelude::World::get_resource_or_insert_with").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#2287)

#### pub fn [resource\_mut](#method.resource_mut)<R>(&mut self) -> [Mut](struct.Mut.html "struct bevy::prelude::Mut")<'\_, R>

where R: [Resource](trait.Resource.html "trait bevy::prelude::Resource")<Mutability = [Mutable](../ecs/component/struct.Mutable.html "struct bevy::ecs::component::Mutable")\>,

Gets a mutable reference to the resource of the given type

##### Panics

Panics if the resource does not exist. Use [`get_resource_mut`](struct.World.html#method.get_resource_mut "method bevy::prelude::World::get_resource_mut") instead if you want to handle this case.
...
#### pub fn [get\_resource\_ref](#method.get_resource_ref)<R>(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ref](struct.Ref.html "struct bevy::prelude::Ref")<'\_, R>>
...
#### pub fn [get\_resource\_mut](#method.get_resource_mut)<R>(&mut self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Mut](struct.Mut.html "struct bevy::prelude::Mut")<'\_, R>>
...
#### pub fn [get\_resource\_or\_insert\_with](#method.get_resource_or_insert_with)<R>( &mut self, func: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")() -> R, ) -> [Mut](struct.Mut.html "struct bevy::prelude::Mut")<'\_, R>
...
#### pub fn [get\_resource\_or\_init](#method.get_resource_or_init)<R>(&mut self) -> [Mut](struct.Mut.html "struct bevy::prelude::Mut")<'\_, R>

where R: [Resource](trait.Resource.html "trait bevy::prelude::Resource")<Mutability = [Mutable](../ecs/component/struct.Mutable.html "struct bevy::ecs::component::Mutable")\> + [FromWorld](trait.FromWorld.html "trait bevy::prelude::FromWorld"),

Gets a mutable reference to the resource of type `T` if it exists, otherwise initializes the resource by calling its [`FromWorld`](trait.FromWorld.html "trait bevy::prelude::FromWorld") implementation.
...
Panics if the data does not exist. Use [`get_non_send`](struct.World.html#method.get_non_send "method bevy::prelude::World::get_non_send") instead if you want to handle this case.

This function will panic if it isn’t called from the same thread that the resource was inserted from.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#2434)

#### pub fn [non\_send\_resource\_mut](#method.non_send_resource_mut)<R>(&mut self) -> [Mut](struct.Mut.html "struct bevy::prelude::Mut")<'\_, R>
...
#### pub fn [non\_send\_mut](#method.non_send_mut)<R>(&mut self) -> [Mut](struct.Mut.html "struct bevy::prelude::Mut")<'\_, R>
...
Panics if the data does not exist. Use [`get_non_send_mut`](struct.World.html#method.get_non_send_mut "method bevy::prelude::World::get_non_send_mut") instead if you want to handle this case.
...
#### pub fn [get\_non\_send\_resource\_mut](#method.get_non_send_resource_mut)<R>(&mut self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Mut](struct.Mut.html "struct bevy::prelude::Mut")<'\_, R>>
...
#### pub fn [get\_non\_send\_mut](#method.get_non_send_mut)<R>(&mut self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Mut](struct.Mut.html "struct bevy::prelude::Mut")<'\_, R>>
...
where I: [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator"), <I as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter "type core::iter::traits::collect::IntoIterator::IntoIter"): [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = ([Entity](struct.Entity.html "struct bevy::prelude::Entity"), B)>, B: [Bundle](trait.Bundle.html "trait bevy::prelude::Bundle"), <B as [DynamicBundle](../ecs/bundle/trait.DynamicBundle.html "trait bevy::ecs::bundle::DynamicBundle")\>::[Effect](../ecs/bundle/trait.DynamicBundle.html#associatedtype.Effect "type bevy::ecs::bundle::DynamicBundle::Effect"): [NoBundleEffect](../ecs/bundle/trait.NoBundleEffect.html "trait bevy::ecs::bundle::NoBundleEffect"),

For a given batch of ([`Entity`](struct.Entity.html "struct bevy::prelude::Entity"), [`Bundle`](trait.Bundle.html "trait bevy::prelude::Bundle")) pairs, adds the `Bundle` of components to each `Entity`. This is faster than doing equivalent operations one-by-one.

A batch can be any type that implements [`IntoIterator`](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") containing `(Entity, Bundle)` tuples, such as a [`Vec<(Entity, Bundle)>`](struct.Vec.html "struct bevy::prelude::Vec") or an array `[(Entity, Bundle); N]`.

This will overwrite any previous values of components shared by the `Bundle`. See [`World::insert_batch_if_new`](struct.World.html#method.insert_batch_if_new "method bevy::prelude::World::insert_batch_if_new") to keep the old values instead.

##### Panics

This function will panic if any of the associated entities do not exist.

For the fallible version, see [`World::try_insert_batch`](struct.World.html#method.try_insert_batch "method bevy::prelude::World::try_insert_batch").
...
For a given batch of ([`Entity`](struct.Entity.html "struct bevy::prelude::Entity"), [`Bundle`](trait.Bundle.html "trait bevy::prelude::Bundle")) pairs, adds the `Bundle` of components to each `Entity` without overwriting. This is faster than doing equivalent operations one-by-one.

A batch can be any type that implements [`IntoIterator`](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") containing `(Entity, Bundle)` tuples, such as a [`Vec<(Entity, Bundle)>`](struct.Vec.html "struct bevy::prelude::Vec") or an array `[(Entity, Bundle); N]`.

This is the same as [`World::insert_batch`](struct.World.html#method.insert_batch "method bevy::prelude::World::insert_batch"), but in case of duplicate components it will leave the old values instead of replacing them with new ones.

##### Panics

This function will panic if any of the associated entities do not exist.

For the fallible version, see [`World::try_insert_batch_if_new`](struct.World.html#method.try_insert_batch_if_new "method bevy::prelude::World::try_insert_batch_if_new").
...
This will overwrite any previous values of components shared by the `Bundle`. See [`World::try_insert_batch_if_new`](struct.World.html#method.try_insert_batch_if_new "method bevy::prelude::World::try_insert_batch_if_new") to keep the old values instead.
...
For the panicking version, see [`World::insert_batch`](struct.World.html#method.insert_batch "method bevy::prelude::World::insert_batch").
...
This is the same as [`World::try_insert_batch`](struct.World.html#method.try_insert_batch "method bevy::prelude::World::try_insert_batch"), but in case of duplicate components it will leave the old values instead of replacing them with new ones.

Returns a [`TryInsertBatchError`](../ecs/world/error/struct.TryInsertBatchError.html "struct bevy::ecs::world::error::TryInsertBatchError") if any of the provided entities do not exist.

For the panicking version, see [`World::insert_batch_if_new`](struct.World.html#method.insert_batch_if_new "method bevy::prelude::World::insert_batch_if_new").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#2851)

#### pub fn [resource\_scope](#method.resource_scope)<R, U>( &mut self, f: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")(&mut [World](struct.World.html "struct bevy::prelude::World"), [Mut](struct.Mut.html "struct bevy::prelude::Mut")<'\_, R>) -> U, ) -> U

where R: [Resource](trait.Resource.html "trait bevy::prelude::Resource"),

Temporarily removes the requested resource from this [`World`](struct.World.html "struct bevy::prelude::World"), runs custom user code, then re-adds the resource before returning.

This enables safe simultaneous mutable access to both a resource and the rest of the [`World`](struct.World.html "struct bevy::prelude::World"). For more complex access patterns, consider using [`SystemState`](../ecs/system/struct.SystemState.html "struct bevy::ecs::system::SystemState").

##### Panics

Panics if the resource does not exist. Use [`try_resource_scope`](struct.World.html#method.try_resource_scope "method bevy::prelude::World::try_resource_scope") instead if you want to handle this case.
...
If the world’s resource metadata is cleared within the scope, such as by calling [`World::clear_resources`](struct.World.html#method.clear_resources "method bevy::prelude::World::clear_resources") or [`World::clear_all`](struct.World.html#method.clear_all "method bevy::prelude::World::clear_all"), the resource will _not_ be re-inserted at the end of the scope.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#2869-2872)

#### pub fn [try\_resource\_scope](#method.try_resource_scope)<R, U>( &mut self, f: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")(&mut [World](struct.World.html "struct bevy::prelude::World"), [Mut](struct.Mut.html "struct bevy::prelude::Mut")<'\_, R>) -> U, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<U>

where R: [Resource](trait.Resource.html "trait bevy::prelude::Resource"),

Temporarily removes the requested resource from this [`World`](struct.World.html "struct bevy::prelude::World") if it exists, runs custom user code, then re-adds the resource before returning. Returns `None` if the resource does not exist in this [`World`](struct.World.html "struct bevy::prelude::World").

This enables safe simultaneous mutable access to both a resource and the rest of the [`World`](struct.World.html "struct bevy::prelude::World"). For more complex access patterns, consider using [`SystemState`](../ecs/system/struct.SystemState.html "struct bevy::ecs::system::SystemState").

See also [`resource_scope`](struct.World.html#method.resource_scope "method bevy::prelude::World::resource_scope").
...
where M: [Message](trait.Message.html "trait bevy::prelude::Message") + [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default"),

Writes the default value of the [`Message`](trait.Message.html "trait bevy::prelude::Message") of type `M`. This method returns the [`MessageId`](../ecs/message/struct.MessageId.html "struct bevy::ecs::message::MessageId") of the written message, or [`None`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.None "variant core::option::Option::None") if the `event` could not be written.
...
**You should prefer to use the typed API [`World::insert_resource`](struct.World.html#method.insert_resource "method bevy::prelude::World::insert_resource") where possible and only use this in cases where the actual types are not known at compile time.**
...
**You should prefer to use the typed API [`World::insert_non_send`](struct.World.html#method.insert_non_send "method bevy::prelude::World::insert_non_send") where possible and only use this in cases where the actual types are not known at compile time.**
...
If you have exclusive (`&mut`) access to the world, consider using [`change_tick()`](struct.World.html#method.change_tick "method bevy::prelude::World::change_tick"), which is more efficient since it does not require atomic synchronization.
...
This does the same thing as [`read_change_tick()`](struct.World.html#method.read_change_tick "method bevy::prelude::World::read_change_tick"), only this method is more efficient since it does not require atomic synchronization.
...
When called from within an exclusive system (a [`System`](trait.System.html "trait bevy::prelude::System") that takes `&mut World` as its first parameter), this method returns the [`Tick`](../ecs/change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick") indicating the last time the exclusive system was run.

Otherwise, this returns the `Tick` indicating the last time that [`World::clear_trackers`](struct.World.html#method.clear_trackers "method bevy::prelude::World::clear_trackers") was called.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#3290-3294)

#### pub fn [last\_change\_tick\_scope](#method.last_change_tick_scope)<T>( &mut self, last\_change\_tick: [Tick](../ecs/change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"), f: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")(&mut [World](struct.World.html "struct bevy::prelude::World")) -> T, ) -> T

Sets [`World::last_change_tick()`](struct.World.html#method.last_change_tick "method bevy::prelude::World::last_change_tick") to the specified value during a scope. When the scope terminates, it will return to its old value.
...
**Note:** Does nothing and returns `None` if the [`World`](struct.World.html "struct bevy::prelude::World") counter has not been incremented at least [`CHECK_TICK_THRESHOLD`](../ecs/change_detection/constant.CHECK_TICK_THRESHOLD.html "constant bevy::ecs::change_detection::CHECK_TICK_THRESHOLD") times since the previous pass.
...
Clears all entities, resources, and non-send data. This invalidates all [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") and resource fetches such as [`Res`](struct.Res.html "struct bevy::prelude::Res"), [`ResMut`](struct.ResMut.html "struct bevy::prelude::ResMut")
...
Despawns all entities in this [`World`](struct.World.html "struct bevy::prelude::World").

**Note:** This includes all resources, as they are stored as components. Any resource fetch to this [`World`](struct.World.html "struct bevy::prelude::World") will fail unless they are re-initialized, including engine-internal resources that are only initialized on app/world construction.
...
Clears all resources in this [`World`](struct.World.html "struct bevy::prelude::World").

**Note:** Any resource fetch to this [`World`](struct.World.html "struct bevy::prelude::World") will fail unless they are re-initialized, including engine-internal resources that are only initialized on app/world construction.
...
Clears all non-send data in this [`World`](struct.World.html "struct bevy::prelude::World").
...
Registers all of the components in the given [`Bundle`](trait.Bundle.html "trait bevy::prelude::Bundle") and returns both the component ids and the bundle id.

This is largely equivalent to calling [`register_component`](struct.World.html#method.register_component "method bevy::prelude::World::register_component") on each component in the bundle.
...
Note that the components need to be registered first, this function only creates a bundle combining them. Components can be registered with [`World::register_component`](struct.World.html#method.register_component "method bevy::prelude::World::register_component")/[`_with_descriptor`](struct.World.html#method.register_component_with_descriptor "method bevy::prelude::World::register_component_with_descriptor").

**You should prefer to use the typed API [`World::register_bundle`](struct.World.html#method.register_bundle "method bevy::prelude::World::register_bundle") where possible and only use this in cases where not all of the actual types are known at compile time.**

##### Panics

This function will panic if any of the provided component ids do not belong to a component known to this [`World`](struct.World.html "struct bevy::prelude::World").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#3461)

#### pub fn [fallback\_error\_handler](#method.fallback_error_handler)(&self) -> [fn](https://doc.rust-lang.org/nightly/std/primitive.fn.html)([BevyError](struct.BevyError.html "struct bevy::prelude::BevyError"), [ErrorContext](../ecs/error/enum.ErrorContext.html "enum bevy::ecs::error::ErrorContext"))
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#3469)
...
Gets a pointer to the resource with the id [`ComponentId`](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId") if it exists. The returned pointer must not be used to modify the resource, and must not be dereferenced after the immutable borrow of the [`World`](struct.World.html "struct bevy::prelude::World") ends.

**You should prefer to use the typed API [`World::get_resource`](struct.World.html#method.get_resource "method bevy::prelude::World::get_resource") where possible and only use this in cases where the actual types are not known at compile time.**
...
Gets a pointer to the resource with the id [`ComponentId`](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId") if it exists and is mutable. The returned pointer may be used to modify the resource, as long as the mutable borrow of the [`World`](struct.World.html "struct bevy::prelude::World") is still valid.

**You should prefer to use the typed API [`World::get_resource_mut`](struct.World.html#method.get_resource_mut "method bevy::prelude::World::get_resource_mut") where possible and only use this in cases where the actual types are not known at compile time.**
...
**You should prefer to use the typed API [`World::get_non_send`](struct.World.html#method.get_non_send "method bevy::prelude::World::get_non_send") where possible and only use this in cases where the actual types are not known at compile time.**
...
Gets mutable access to `!Send` data with the id [`ComponentId`](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId") if it exists. The returned pointer may be used to modify the data, as long as the mutable borrow of the [`World`](struct.World.html "struct bevy::prelude::World") is still valid.

**You should prefer to use the typed API [`World::get_non_send_mut`](struct.World.html#method.get_non_send_mut "method bevy::prelude::World::get_non_send_mut") where possible and only use this in cases where the actual types are not known at compile time.**
...
**You should prefer to use the typed API [`World::remove_resource`](struct.World.html#method.remove_resource "method bevy::prelude::World::remove_resource") where possible and only use this in cases where the actual types are not known at compile time.**
...
**You should prefer to use the typed API [`World::remove_non_send`](struct.World.html#method.remove_non_send "method bevy::prelude::World::remove_non_send") where possible and only use this in cases where the actual types are not known at compile time.**
...
#### pub fn [get\_by\_id](#method.get_by_id)( &self, entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity"), component\_id: [ComponentId](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ptr](../ecs/ptr/struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'\_>>

Retrieves an immutable untyped reference to the given `entity`’s [`Component`](trait.Component.html "trait bevy::prelude::Component") of the given [`ComponentId`](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId"). Returns `None` if the `entity` does not have a [`Component`](trait.Component.html "trait bevy::prelude::Component") of the given type.

**You should prefer to use the typed API [`World::get_mut`](struct.World.html#method.get_mut "method bevy::prelude::World::get_mut") where possible and only use this in cases where the actual types are not known at compile time.**
...
#### pub fn [get\_mut\_by\_id](#method.get_mut_by_id)( &mut self, entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity"), component\_id: [ComponentId](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[MutUntyped](../ecs/change_detection/struct.MutUntyped.html "struct bevy::ecs::change_detection::MutUntyped")<'\_>>

Retrieves a mutable untyped reference to the given `entity`’s [`Component`](trait.Component.html "trait bevy::prelude::Component") of the given [`ComponentId`](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId"). Returns `None` if the `entity` does not have a [`Component`](trait.Component.html "trait bevy::prelude::Component") of the given type.

**You should prefer to use the typed API [`World::get_mut`](struct.World.html#method.get_mut "method bevy::prelude::World::get_mut") where possible and only use this in cases where the actual types are not known at compile time.**

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#3799)

### impl [World](struct.World.html "struct bevy::prelude::World")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#3812)

#### pub fn [add\_schedule](#method.add_schedule)(&mut self, schedule: [Schedule](struct.Schedule.html "struct bevy::prelude::Schedule"))

Adds the specified [`Schedule`](struct.Schedule.html "struct bevy::prelude::Schedule") to the world. If a schedule already exists with the same [label](struct.Schedule.html#method.label "method bevy::prelude::Schedule::label"), it will be replaced.

The schedule can later be run by calling [`.run_schedule(label)`](struct.World.html#method.run_schedule "method bevy::prelude::World::run_schedule") or by directly accessing the [`Schedules`](struct.Schedules.html "struct bevy::prelude::Schedules") resource.

The `Schedules` resource will be initialized if it does not already exist.

An alternative to this is to call [`Schedules::add_systems()`](struct.Schedules.html#method.add_systems "method bevy::prelude::Schedules::add_systems") with some [`ScheduleLabel`](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel") and let the schedule for that label be created if it does not already exist.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#3828-3832)

#### pub fn [try\_schedule\_scope](#method.try_schedule_scope)<R>( &mut self, label: impl [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel"), f: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")(&mut [World](struct.World.html "struct bevy::prelude::World"), &mut [Schedule](struct.Schedule.html "struct bevy::prelude::Schedule")) -> R, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<R, [TryRunScheduleError](../ecs/world/error/struct.TryRunScheduleError.html "struct bevy::ecs::world::error::TryRunScheduleError")\>
...
The [`Schedule`](struct.Schedule.html "struct bevy::prelude::Schedule") is fetched from the [`Schedules`](struct.Schedules.html "struct bevy::prelude::Schedules") resource of the world by its label, and system state is cached.

For simple cases where you just need to call the schedule once, consider using [`World::try_run_schedule`](struct.World.html#method.try_run_schedule "method bevy::prelude::World::try_run_schedule") instead. For other use cases, see the example on [`World::schedule_scope`](struct.World.html#method.schedule_scope "method bevy::prelude::World::schedule_scope").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#3888-3892)

#### pub fn [schedule\_scope](#method.schedule_scope)<R>( &mut self, label: impl [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel"), f: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")(&mut [World](struct.World.html "struct bevy::prelude::World"), &mut [Schedule](struct.Schedule.html "struct bevy::prelude::Schedule")) -> R, ) -> R
...
For simple cases where you just need to call the schedule once, consider using [`World::run_schedule`](struct.World.html#method.run_schedule "method bevy::prelude::World::run_schedule") instead.
...
Attempts to run the [`Schedule`](struct.Schedule.html "struct bevy::prelude::Schedule") associated with the `label` a single time, and returns a [`TryRunScheduleError`](../ecs/world/error/struct.TryRunScheduleError.html "struct bevy::ecs::world::error::TryRunScheduleError") if the schedule does not exist.

The [`Schedule`](struct.Schedule.html "struct bevy::prelude::Schedule") is fetched from the [`Schedules`](struct.Schedules.html "struct bevy::prelude::Schedules") resource of the world by its label, and system state is cached.

For simple testing use cases, call [`Schedule::run(&mut world)`](struct.Schedule.html#method.run "method bevy::prelude::Schedule::run") instead.
...
Runs the [`Schedule`](struct.Schedule.html "struct bevy::prelude::Schedule") associated with the `label` a single time.

The [`Schedule`](struct.Schedule.html "struct bevy::prelude::Schedule") is fetched from the [`Schedules`](struct.Schedules.html "struct bevy::prelude::Schedules") resource of the world by its label, and system state is cached.

For simple testing use cases, call [`Schedule::run(&mut world)`](struct.Schedule.html#method.run "method bevy::prelude::Schedule::run") instead. This avoids the need to create a unique [`ScheduleLabel`](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel").
...
Ignore system order ambiguities caused by conflicts on [`Component`](trait.Component.html "trait bevy::prelude::Component")s of type `T`.
...
Ignore system order ambiguities caused by conflicts on [`Resource`](trait.Resource.html "trait bevy::prelude::Resource")s of type `T`.

## Trait Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#3941)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [World](struct.World.html "struct bevy::prelude::World")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#3942)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")\>

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#117)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [World](struct.World.html "struct bevy::prelude::World")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#118)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [World](struct.World.html "struct bevy::prelude::World")
...
### impl [DirectAssetAccessExt](trait.DirectAssetAccessExt.html "trait bevy::prelude::DirectAssetAccessExt") for [World](struct.World.html "struct bevy::prelude::World")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/direct_access_ext.rs.html#33)

#### fn [add\_asset](trait.DirectAssetAccessExt.html#tymethod.add_asset)<'a, A>(&mut self, asset: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<A>) -> [Handle](enum.Handle.html "enum bevy::prelude::Handle")<A>

where A: [Asset](trait.Asset.html "trait bevy::prelude::Asset"),

Insert an asset similarly to [`Assets::add`](struct.Assets.html#method.add "method bevy::prelude::Assets::add").

##### Panics

If `self` doesn’t have an [`AssetServer`](struct.AssetServer.html "struct bevy::prelude::AssetServer") resource initialized yet.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/direct_access_ext.rs.html#41)

#### fn [load\_asset](trait.DirectAssetAccessExt.html#tymethod.load_asset)<'a, A>(&self, path: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[AssetPath](../asset/struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>>) -> [Handle](enum.Handle.html "enum bevy::prelude::Handle")<A>

where A: [Asset](trait.Asset.html "trait bevy::prelude::Asset"),

Load an asset similarly to [`AssetServer::load`](struct.AssetServer.html#method.load "method bevy::prelude::AssetServer::load").

##### Panics

If `self` doesn’t have an [`AssetServer`](struct.AssetServer.html "struct bevy::prelude::AssetServer") resource initialized yet.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/direct_access_ext.rs.html#49)

#### fn [load\_builder](trait.DirectAssetAccessExt.html#tymethod.load_builder)(&self) -> [LoadBuilder](../asset/struct.LoadBuilder.html "struct bevy::asset::LoadBuilder")<'\_>

Creates a new [`LoadBuilder`](../asset/struct.LoadBuilder.html "struct bevy::asset::LoadBuilder") similar to [`AssetServer::load_builder`](struct.AssetServer.html#method.load_builder "method bevy::prelude::AssetServer::load_builder").

##### Panics

If `self` doesn’t have an [`AssetServer`](struct.AssetServer.html "struct bevy::prelude::AssetServer") resource initialized yet.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/direct_access_ext.rs.html#57-61)

#### fn [load\_asset\_with\_settings](trait.DirectAssetAccessExt.html#tymethod.load_asset_with_settings)<'a, A, S>( &self, path: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[AssetPath](../asset/struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>>, settings: impl [Fn](https://doc.rust-lang.org/nightly/core/ops/function/trait.Fn.html "trait core::ops::function::Fn")([&mut S](https://doc.rust-lang.org/nightly/std/primitive.reference.html)) + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static, ) -> [Handle](enum.Handle.html "enum bevy::prelude::Handle")<A>

where A: [Asset](trait.Asset.html "trait bevy::prelude::Asset"), S: [Settings](../asset/meta/trait.Settings.html "trait bevy::asset::meta::Settings"),

👎Deprecated:

Use `world.load_builder().with_settings(settings).load(path)`

Load an asset with settings, similarly to [`AssetServer::load_with_settings`](struct.AssetServer.html#method.load_with_settings "method bevy::prelude::AssetServer::load_with_settings").

##### Panics

If `self` doesn’t have an [`AssetServer`](struct.AssetServer.html "struct bevy::prelude::AssetServer") resource initialized yet.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#144)

### impl [Drop](https://doc.rust-lang.org/nightly/core/ops/drop/trait.Drop.html "trait core::ops::drop::Drop") for [World](struct.World.html "struct bevy::prelude::World")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#145)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/filtered_resource.rs.html#221)

### impl<'w> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'w [World](struct.World.html "struct bevy::prelude::World")\> for [FilteredResources](struct.FilteredResources.html "struct bevy::prelude::FilteredResources")<'w, 'static>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/filtered_resource.rs.html#222)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: &'w [World](struct.World.html "struct bevy::prelude::World")) -> [FilteredResources](struct.FilteredResources.html "struct bevy::prelude::FilteredResources")<'w, 'static>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/unsafe_world_cell.rs.html#103)

### impl<'w> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'w [World](struct.World.html "struct bevy::prelude::World")\> for [UnsafeWorldCell](../ecs/world/unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'w>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/unsafe_world_cell.rs.html#104)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: &'w [World](struct.World.html "struct bevy::prelude::World")) -> [UnsafeWorldCell](../ecs/world/unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'w>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/deferred_world.rs.html#54)

### impl<'w> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'w mut [World](struct.World.html "struct bevy::prelude::World")\> for [DeferredWorld](../ecs/world/struct.DeferredWorld.html "struct bevy::ecs::world::DeferredWorld")<'w>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/deferred_world.rs.html#55)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(world: &'w mut [World](struct.World.html "struct bevy::prelude::World")) -> [DeferredWorld](../ecs/world/struct.DeferredWorld.html "struct bevy::ecs::world::DeferredWorld")<'w>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/filtered_resource.rs.html#239)

### impl<'w> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'w mut [World](struct.World.html "struct bevy::prelude::World")\> for [FilteredResources](struct.FilteredResources.html "struct bevy::prelude::FilteredResources")<'w, 'static>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/filtered_resource.rs.html#240)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: &'w mut [World](struct.World.html "struct bevy::prelude::World")) -> [FilteredResources](struct.FilteredResources.html "struct bevy::prelude::FilteredResources")<'w, 'static>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/filtered_resource.rs.html#510)

### impl<'w> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'w mut [World](struct.World.html "struct bevy::prelude::World")\> for [FilteredResourcesMut](struct.FilteredResourcesMut.html "struct bevy::prelude::FilteredResourcesMut")<'w, 'static>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/filtered_resource.rs.html#511)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: &'w mut [World](struct.World.html "struct bevy::prelude::World")) -> [FilteredResourcesMut](struct.FilteredResourcesMut.html "struct bevy::prelude::FilteredResourcesMut")<'w, 'static>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/unsafe_world_cell.rs.html#97)

### impl<'w> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'w mut [World](struct.World.html "struct bevy::prelude::World")\> for [UnsafeWorldCell](../ecs/world/unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'w>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/unsafe_world_cell.rs.html#98)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: &'w mut [World](struct.World.html "struct bevy::prelude::World")) -> [UnsafeWorldCell](../ecs/world/unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'w>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/embedded/mod.rs.html#159)

### impl [GetAssetServer](../asset/io/embedded/trait.GetAssetServer.html "trait bevy::asset::io::embedded::GetAssetServer") for [World](struct.World.html "struct bevy::prelude::World")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/embedded/mod.rs.html#160)

#### fn [get\_asset\_server](../asset/io/embedded/trait.GetAssetServer.html#tymethod.get_asset_server)(&self) -> &[AssetServer](struct.AssetServer.html "struct bevy::prelude::AssetServer")

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/lib.rs.html#449)

### impl [IsFocused](../input_focus/trait.IsFocused.html "trait bevy::input_focus::IsFocused") for [World](struct.World.html "struct bevy::prelude::World")

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/lib.rs.html#450)

#### fn [is\_focused](../input_focus/trait.IsFocused.html#tymethod.is_focused)(&self, entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns true if the given entity has input focus.

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/lib.rs.html#456)

#### fn [is\_focus\_within](../input_focus/trait.IsFocused.html#tymethod.is_focus_within)(&self, entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns true if the given entity or any of its descendants has input focus. [Read more](../input_focus/trait.IsFocused.html#tymethod.is_focus_within)

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/lib.rs.html#473)

#### fn [is\_focus\_visible](../input_focus/trait.IsFocused.html#tymethod.is_focus_visible)(&self, entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns true if the given entity has input focus and the focus indicator should be visible.

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/lib.rs.html#479)

#### fn [is\_focus\_within\_visible](../input_focus/trait.IsFocused.html#tymethod.is_focus_within_visible)(&self, entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl<'w> [ReadOnlySystemParam](../ecs/system/trait.ReadOnlySystemParam.html "trait bevy::ecs::system::ReadOnlySystemParam") for &'w [World](struct.World.html "struct bevy::prelude::World")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#373)

### impl [RunSystemOnce](../ecs/system/trait.RunSystemOnce.html "trait bevy::ecs::system::RunSystemOnce") for &mut [World](struct.World.html "struct bevy::prelude::World")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#374-381)

#### fn [run\_system\_once\_with](../ecs/system/trait.RunSystemOnce.html#tymethod.run_system_once_with)<T, In, Out, Marker>( self, system: T, input: <<<T as [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<In, Out, Marker>>::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System") as [System](trait.System.html "trait bevy::prelude::System")\>::[In](trait.System.html#associatedtype.In "type bevy::prelude::System::In") as [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput")\>::[Inner](trait.SystemInput.html#associatedtype.Inner "type bevy::prelude::SystemInput::Inner")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<Out, [RunSystemError](../ecs/system/enum.RunSystemError.html "enum bevy::ecs::system::RunSystemError")\>

where T: [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<In, Out, Marker>, In: [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput"),
...
#### fn [run\_system\_once](../ecs/system/trait.RunSystemOnce.html#method.run_system_once)<T, Out, Marker>( self, system: T, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<Out, [RunSystemError](../ecs/system/enum.RunSystemError.html "enum bevy::ecs::system::RunSystemError")\>

where T: [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), Out, Marker>,

Tries to run a system and apply its deferred parameters.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#3955)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [World](struct.World.html "struct bevy::prelude::World")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/mod.rs.html#3957)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [World](struct.World.html "struct bevy::prelude::World")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#788)

### impl [SystemParam](../ecs/system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam") for &[World](struct.World.html "struct bevy::prelude::World")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#789)

#### type [State](../ecs/system/trait.SystemParam.html#associatedtype.State) = [()](https://doc.rust-lang.org/nightly/std/primitive.unit.html)

Used to store data which persists across invocations of a system.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#790)

#### type [Item](../ecs/system/trait.SystemParam.html#associatedtype.Item)<'w, 's> = &'w [World](struct.World.html "struct bevy::prelude::World")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#792)

#### fn [init\_state](../ecs/system/trait.SystemParam.html#tymethod.init_state)(\_world: &mut [World](struct.World.html "struct bevy::prelude::World")) -> <&[World](struct.World.html "struct bevy::prelude::World") as [SystemParam](../ecs/system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](../ecs/system/trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#794-799)

#### fn [init\_access](../ecs/system/trait.SystemParam.html#tymethod.init_access)( \_state: &<&[World](struct.World.html "struct bevy::prelude::World") as [SystemParam](../ecs/system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](../ecs/system/trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State"), \_system\_meta: &mut [SystemMeta](../ecs/system/struct.SystemMeta.html "struct bevy::ecs::system::SystemMeta"), component\_access\_set: &mut [FilteredAccessSet](../ecs/query/struct.FilteredAccessSet.html "struct bevy::ecs::query::FilteredAccessSet"), \_world: &mut [World](struct.World.html "struct bevy::prelude::World"), )
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#813-818)

#### unsafe fn [get\_param](../ecs/system/trait.SystemParam.html#tymethod.get_param)<'w, 's>( \_state: &'s mut <&[World](struct.World.html "struct bevy::prelude::World") as [SystemParam](../ecs/system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](../ecs/system/trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State"), \_system\_meta: &[SystemMeta](../ecs/system/struct.SystemMeta.html "struct bevy::ecs::system::SystemMeta"), world: [UnsafeWorldCell](../ecs/world/unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'w>, \_change\_tick: [Tick](../ecs/change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<&[World](struct.World.html "struct bevy::prelude::World") as [SystemParam](../ecs/system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[Item](../ecs/system/trait.SystemParam.html#associatedtype.Item "type bevy::ecs::system::SystemParam::Item")<'w, 's>, [SystemParamValidationError](../ecs/system/struct.SystemParamValidationError.html "struct bevy::ecs::system::SystemParamValidationError")\>
...
### impl ![Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [World](struct.World.html "struct bevy::prelude::World")

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [World](struct.World.html "struct bevy::prelude::World")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [World](struct.World.html "struct bevy::prelude::World")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [World](struct.World.html "struct bevy::prelude::World")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [World](struct.World.html "struct bevy::prelude::World")
