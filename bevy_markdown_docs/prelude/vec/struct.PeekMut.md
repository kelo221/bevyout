...
[Source](https://doc.rust-lang.org/nightly/src/alloc/vec/peek_mut.rs.html#15-19)
...
This `struct` is created by the [`peek_mut`](../struct.Vec.html#method.peek_mut "method bevy::prelude::Vec::peek_mut") method on [`Vec`](../struct.Vec.html "struct bevy::prelude::Vec"). See its documentation for more.

## Implementations

[Source](https://doc.rust-lang.org/nightly/src/alloc/vec/peek_mut.rs.html#30)

### impl<'a, T, A> [PeekMut](struct.PeekMut.html "struct bevy::prelude::vec::PeekMut")<'a, T, A>

where A: [Allocator](https://doc.rust-lang.org/nightly/core/alloc/trait.Allocator.html "trait core::alloc::Allocator"),

[Source](https://doc.rust-lang.org/nightly/src/alloc/vec/peek_mut.rs.html#37)

#### pub fn [pop](#method.pop)(this: [PeekMut](struct.PeekMut.html "struct bevy::prelude::vec::PeekMut")<'a, T, A>) -> T
...
[Source](https://doc.rust-lang.org/nightly/src/alloc/vec/peek_mut.rs.html#24)

### impl<T, A> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [PeekMut](struct.PeekMut.html "struct bevy::prelude::vec::PeekMut")<'\_, T, A>
...
[Source](https://doc.rust-lang.org/nightly/src/alloc/vec/peek_mut.rs.html#25)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")\>

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](https://doc.rust-lang.org/nightly/src/alloc/vec/peek_mut.rs.html#44)

### impl<'a, T, A> [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [PeekMut](struct.PeekMut.html "struct bevy::prelude::vec::PeekMut")<'a, T, A>

where A: [Allocator](https://doc.rust-lang.org/nightly/core/alloc/trait.Allocator.html "trait core::alloc::Allocator"),

[Source](https://doc.rust-lang.org/nightly/src/alloc/vec/peek_mut.rs.html#45)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = T

The resulting type after dereferencing.

[Source](https://doc.rust-lang.org/nightly/src/alloc/vec/peek_mut.rs.html#47)

#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[PeekMut](struct.PeekMut.html "struct bevy::prelude::vec::PeekMut")<'a, T, A> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://doc.rust-lang.org/nightly/src/alloc/vec/peek_mut.rs.html#55)

### impl<'a, T, A> [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [PeekMut](struct.PeekMut.html "struct bevy::prelude::vec::PeekMut")<'a, T, A>

where A: [Allocator](https://doc.rust-lang.org/nightly/core/alloc/trait.Allocator.html "trait core::alloc::Allocator"),

[Source](https://doc.rust-lang.org/nightly/src/alloc/vec/peek_mut.rs.html#56)

#### fn [deref\_mut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html#tymethod.deref_mut)(&mut self) -> &mut <[PeekMut](struct.PeekMut.html "struct bevy::prelude::vec::PeekMut")<'a, T, A> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Mutably dereferences the value.

## Auto Trait Implementations

### impl<'a, T, A = [Global](https://doc.rust-lang.org/nightly/alloc/alloc/struct.Global.html "struct alloc::alloc::Global")\> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [PeekMut](struct.PeekMut.html "struct bevy::prelude::vec::PeekMut")<'a, T, A>

### impl<'a, T, A> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [PeekMut](struct.PeekMut.html "struct bevy::prelude::vec::PeekMut")<'a, T, A>

### impl<'a, T, A> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [PeekMut](struct.PeekMut.html "struct bevy::prelude::vec::PeekMut")<'a, T, A>
...
### impl<'a, T, A> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [PeekMut](struct.PeekMut.html "struct bevy::prelude::vec::PeekMut")<'a, T, A>

where A: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"), T: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<'a, T, A> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [PeekMut](struct.PeekMut.html "struct bevy::prelude::vec::PeekMut")<'a, T, A>

where A: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"), T: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<'a, T, A> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [PeekMut](struct.PeekMut.html "struct bevy::prelude::vec::PeekMut")<'a, T, A>

### impl<'a, T, A> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [PeekMut](struct.PeekMut.html "struct bevy::prelude::vec::PeekMut")<'a, T, A>
