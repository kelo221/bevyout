...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ConvexPolygonError](enum.ConvexPolygonError.html "enum bevy::prelude::ConvexPolygonError")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#1967)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ConvexPolygonError](enum.ConvexPolygonError.html "enum bevy::prelude::ConvexPolygonError")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ConvexPolygonError](enum.ConvexPolygonError.html "enum bevy::prelude::ConvexPolygonError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [ConvexPolygonError](enum.ConvexPolygonError.html "enum bevy::prelude::ConvexPolygonError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [ConvexPolygonError](enum.ConvexPolygonError.html "enum bevy::prelude::ConvexPolygonError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ConvexPolygonError](enum.ConvexPolygonError.html "enum bevy::prelude::ConvexPolygonError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ConvexPolygonError](enum.ConvexPolygonError.html "enum bevy::prelude::ConvexPolygonError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ConvexPolygonError](enum.ConvexPolygonError.html "enum bevy::prelude::ConvexPolygonError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ConvexPolygonError](enum.ConvexPolygonError.html "enum bevy::prelude::ConvexPolygonError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ConvexPolygonError](enum.ConvexPolygonError.html "enum bevy::prelude::ConvexPolygonError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ConvexPolygonError](enum.ConvexPolygonError.html "enum bevy::prelude::ConvexPolygonError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ConvexPolygonError](enum.ConvexPolygonError.html "enum bevy::prelude::ConvexPolygonError")
