...
`pointer_buttons: [HashMap](../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<([PointerId](../picking/pointer/enum.PointerId.html "enum bevy::picking::pointer::PointerId"), [PointerButton](enum.PointerButton.html "enum bevy::prelude::PointerButton")), [PointerButtonState](struct.PointerButtonState.html "struct bevy::prelude::PointerButtonState")>`

Pressing and dragging state, organized by pointer and button.

`hovered_entity_ancestors: [HoveredEntityAncestors](struct.HoveredEntityAncestors.html "struct bevy::prelude::HoveredEntityAncestors")`
...
### impl [PointerState](struct.PointerState.html "struct bevy::prelude::PointerState")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#559)

#### pub fn [get](#method.get)( &self, pointer\_id: [PointerId](../picking/pointer/enum.PointerId.html "enum bevy::picking::pointer::PointerId"), button: [PointerButton](enum.PointerButton.html "enum bevy::prelude::PointerButton"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[PointerButtonState](struct.PointerButtonState.html "struct bevy::prelude::PointerButtonState")\>
...
#### pub fn [get\_mut](#method.get_mut)( &mut self, pointer\_id: [PointerId](../picking/pointer/enum.PointerId.html "enum bevy::picking::pointer::PointerId"), button: [PointerButton](enum.PointerButton.html "enum bevy::prelude::PointerButton"), ) -> &mut [PointerButtonState](struct.PointerButtonState.html "struct bevy::prelude::PointerButtonState")
...
#### pub fn [get\_ancestors](#method.get_ancestors)(&self, hovered\_entity: &[Entity](struct.Entity.html "struct bevy::prelude::Entity")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[EntityHashSet](../ecs/entity/struct.EntityHashSet.html "struct bevy::ecs::entity::EntityHashSet")\>
...
#### pub fn [clear](#method.clear)(&mut self, pointer\_id: [PointerId](../picking/pointer/enum.PointerId.html "enum bevy::picking::pointer::PointerId"))
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [PointerState](struct.PointerState.html "struct bevy::prelude::PointerState")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#549)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [PointerState](struct.PointerState.html "struct bevy::prelude::PointerState")
...
### impl [Component](trait.Component.html "trait bevy::prelude::Component") for [PointerState](struct.PointerState.html "struct bevy::prelude::PointerState")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [PointerState](struct.PointerState.html "struct bevy::prelude::PointerState")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [PointerState](struct.PointerState.html "struct bevy::prelude::PointerState")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#549)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [PointerState](struct.PointerState.html "struct bevy::prelude::PointerState")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [PointerState](struct.PointerState.html "struct bevy::prelude::PointerState")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [PointerState](struct.PointerState.html "struct bevy::prelude::PointerState")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [PointerState](struct.PointerState.html "struct bevy::prelude::PointerState")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [PointerState](struct.PointerState.html "struct bevy::prelude::PointerState")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [PointerState](struct.PointerState.html "struct bevy::prelude::PointerState")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [PointerState](struct.PointerState.html "struct bevy::prelude::PointerState")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [PointerState](struct.PointerState.html "struct bevy::prelude::PointerState")
