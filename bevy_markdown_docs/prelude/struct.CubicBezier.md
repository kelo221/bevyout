...
Useful for user-drawn curves with local control, or animation easing. See [`CubicSegment::new_bezier_easing`](struct.CubicSegment.html#method.new_bezier_easing "associated function bevy::prelude::CubicSegment::new_bezier_easing") for use in easing.
...
`control_points: [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[[P; 4]](https://doc.rust-lang.org/nightly/std/primitive.array.html)>`
...
### impl<P> [CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>
...
#### pub fn [new](#method.new)(control\_points: impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [\[P; 4\]](https://doc.rust-lang.org/nightly/std/primitive.array.html)\>) -> [CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>
...
### impl<P> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>
...
#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>
...
#### type [Error](trait.CubicGenerator.html#associatedtype.Error) = [CubicBezierError](../math/cubic_splines/struct.CubicBezierError.html "struct bevy::math::cubic_splines::CubicBezierError")
...
#### fn [to\_curve](trait.CubicGenerator.html#tymethod.to_curve)( &self, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[CubicCurve](struct.CubicCurve.html "struct bevy::prelude::CubicCurve")<P>, <[CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P> as [CubicGenerator](trait.CubicGenerator.html "trait bevy::prelude::CubicGenerator")<P>>::[Error](trait.CubicGenerator.html#associatedtype.Error "type bevy::prelude::CubicGenerator::Error")\>
...
### impl<P> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>
...
### impl<P> [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>
...
#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#54)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P> as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>>
...
### impl<P> [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>
...
### impl<P> [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>
...
### impl<P> [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>
...
where [CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>: 'into\_return,
...
### impl<P> [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#54)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<P> [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>
...
### impl<P> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>

### impl<P> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>
...
### impl<P> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>

where P: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<P> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>

where P: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<P> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>

where P: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<P> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>

### impl<P> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [CubicBezier](struct.CubicBezier.html "struct bevy::prelude::CubicBezier")<P>
