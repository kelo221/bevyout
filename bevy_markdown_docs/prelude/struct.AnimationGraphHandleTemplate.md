...
`0: <[Handle](enum.Handle.html "enum bevy::prelude::Handle")<[AnimationGraph](struct.AnimationGraph.html "struct bevy::prelude::AnimationGraph")> as [FromTemplate](trait.FromTemplate.html "trait bevy::prelude::FromTemplate")>::[Template](trait.FromTemplate.html#associatedtype.Template "type bevy::prelude::FromTemplate::Template")`

## Trait Implementations

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/graph.rs.html#135)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [AnimationGraphHandleTemplate](struct.AnimationGraphHandleTemplate.html "struct bevy::prelude::AnimationGraphHandleTemplate")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/graph.rs.html#135)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [AnimationGraphHandleTemplate](struct.AnimationGraphHandleTemplate.html "struct bevy::prelude::AnimationGraphHandleTemplate")
...
#### fn [clone\_template](trait.Template.html#tymethod.clone_template)(&self) -> [AnimationGraphHandleTemplate](struct.AnimationGraphHandleTemplate.html "struct bevy::prelude::AnimationGraphHandleTemplate")

Clones this template. See [`Clone`](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone").

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AnimationGraphHandleTemplate](struct.AnimationGraphHandleTemplate.html "struct bevy::prelude::AnimationGraphHandleTemplate")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AnimationGraphHandleTemplate](struct.AnimationGraphHandleTemplate.html "struct bevy::prelude::AnimationGraphHandleTemplate")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AnimationGraphHandleTemplate](struct.AnimationGraphHandleTemplate.html "struct bevy::prelude::AnimationGraphHandleTemplate")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AnimationGraphHandleTemplate](struct.AnimationGraphHandleTemplate.html "struct bevy::prelude::AnimationGraphHandleTemplate")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AnimationGraphHandleTemplate](struct.AnimationGraphHandleTemplate.html "struct bevy::prelude::AnimationGraphHandleTemplate")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AnimationGraphHandleTemplate](struct.AnimationGraphHandleTemplate.html "struct bevy::prelude::AnimationGraphHandleTemplate")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AnimationGraphHandleTemplate](struct.AnimationGraphHandleTemplate.html "struct bevy::prelude::AnimationGraphHandleTemplate")
