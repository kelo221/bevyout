...
When Bevy begins the audio playback, an [`AudioSink`](struct.AudioSink.html "struct bevy::prelude::AudioSink") component will be added to the entity. You can use that component to control the audio settings during playback.

Playback can be configured using the [`PlaybackSettings`](struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings") component. Note that changes to the [`PlaybackSettings`](struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings") component will _not_ affect already-playing audio.

## Tuple Fields

`0: [Handle](enum.Handle.html "enum bevy::prelude::Handle")<Source>`

## Implementations

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#264)

### impl [AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#270)

#### pub fn [new](#method.new)(source: [Handle](enum.Handle.html "enum bevy::prelude::Handle")<[AudioSource](struct.AudioSource.html "struct bevy::prelude::AudioSource")\>) -> [AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")

Creates a new [`AudioPlayer`](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer") with the given [`Handle<AudioSource>`](enum.Handle.html "enum bevy::prelude::Handle").

For convenience reasons, this hard-codes the [`AudioSource`](struct.AudioSource.html "struct bevy::prelude::AudioSource") type. If you want to initialize an [`AudioPlayer`](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer") with a different type, just initialize it directly using normal tuple struct syntax.
...
### impl<Source> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>
...
#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>
...
### impl<Source> [Component](trait.Component.html "trait bevy::prelude::Component") for [AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>

where Source: [Asset](trait.Asset.html "trait bevy::prelude::Asset") + [Decodable](trait.Decodable.html "trait bevy::prelude::Decodable"), [AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

**Required Components**: [`PlaybackSettings`](struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings").
...
### impl<Source> [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>
...
#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#248)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source> as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>>
...
#### type [Template](trait.FromTemplate.html#associatedtype.Template) = [AudioPlayerTemplate](../audio/struct.AudioPlayerTemplate.html "struct bevy::audio::AudioPlayerTemplate")<Source>

The [`Template`](trait.Template.html "trait bevy::prelude::Template") for this type.

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#248)

### impl<Source> [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>
...
### impl<Source> [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>
...
### impl<Source> [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>
...
where [AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>: 'into\_return,
...
### impl<Source> [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#248)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>>, ) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<Source> [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>
...
### impl<Source> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>

where Source: [Asset](trait.Asset.html "trait bevy::prelude::Asset") + [Decodable](trait.Decodable.html "trait bevy::prelude::Decodable"), \[[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html)\]: for<'a> [SpecializeFromTemplate](../ecs/template/trait.SpecializeFromTemplate.html "trait bevy::ecs::template::SpecializeFromTemplate"),

## Auto Trait Implementations

### impl<Source = [AudioSource](struct.AudioSource.html "struct bevy::prelude::AudioSource")\> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>

### impl<Source = [AudioSource](struct.AudioSource.html "struct bevy::prelude::AudioSource")\> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>

### impl<Source> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>

### impl<Source> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>

### impl<Source> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>

### impl<Source> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AudioPlayer](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer")<Source>
