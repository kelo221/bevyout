...
Using types that implement [`DetectChanges`](trait.DetectChanges.html "trait bevy::prelude::DetectChanges"), such as [`Res`](struct.Res.html "struct bevy::prelude::Res"), provide a way to query if a value has been mutated in another system.
...
#### fn [is\_added\_after](#tymethod.is_added_after)(&self, other: [Tick](../ecs/change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
#### fn [is\_changed\_after](#tymethod.is_changed_after)(&self, other: [Tick](../ecs/change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
#### fn [last\_changed](#tymethod.last_changed)(&self) -> [Tick](../ecs/change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick")

Returns the change tick recording the time this data was most recently changed.

Note that components and resources are also marked as changed upon insertion.

For comparison, the previous change tick of a system can be read using the [`SystemChangeTick`](../ecs/system/struct.SystemChangeTick.html "struct bevy::ecs::system::SystemChangeTick") [`SystemParam`](../ecs/system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/traits.rs.html#83)

#### fn [added](#tymethod.added)(&self) -> [Tick](../ecs/change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick")
...
#### fn [changed\_by](#tymethod.changed_by)(&self) -> [MaybeLocation](../ecs/change_detection/struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")
...
### impl<'w> [DetectChanges](trait.DetectChanges.html "trait bevy::prelude::DetectChanges") for [MutUntyped](../ecs/change_detection/struct.MutUntyped.html "struct bevy::ecs::change_detection::MutUntyped")<'w>