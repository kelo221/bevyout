...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [QuarticInCurve](struct.QuarticInCurve.html "struct bevy::prelude::QuarticInCurve")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#743)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [QuarticInCurve](struct.QuarticInCurve.html "struct bevy::prelude::QuarticInCurve")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [QuarticInCurve](struct.QuarticInCurve.html "struct bevy::prelude::QuarticInCurve")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [QuarticInCurve](struct.QuarticInCurve.html "struct bevy::prelude::QuarticInCurve")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [QuarticInCurve](struct.QuarticInCurve.html "struct bevy::prelude::QuarticInCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [QuarticInCurve](struct.QuarticInCurve.html "struct bevy::prelude::QuarticInCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [QuarticInCurve](struct.QuarticInCurve.html "struct bevy::prelude::QuarticInCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [QuarticInCurve](struct.QuarticInCurve.html "struct bevy::prelude::QuarticInCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [QuarticInCurve](struct.QuarticInCurve.html "struct bevy::prelude::QuarticInCurve")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [QuarticInCurve](struct.QuarticInCurve.html "struct bevy::prelude::QuarticInCurve")
