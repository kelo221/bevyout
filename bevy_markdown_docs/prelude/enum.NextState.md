...
This can be fetched as a resource and used to queue state transitions. To queue a transition, call [`NextState::set`](enum.NextState.html#method.set "method bevy::prelude::NextState::set") or mutate the value to [`NextState::Pending`](enum.NextState.html#variant.Pending "variant bevy::prelude::NextState::Pending") directly.

Note that these transitions can be overridden by other systems: only the actual value of this resource during the [`StateTransition`](struct.StateTransition.html "struct bevy::prelude::StateTransition") schedule matters.
...
### impl<S> [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>
...
This will run the state transition schedules [`OnEnter`](struct.OnEnter.html "struct bevy::prelude::OnEnter") and [`OnExit`](struct.OnExit.html "struct bevy::prelude::OnExit"). If you want to skip those schedules for the same where we are transitioning to the same state, use [`set_if_neq`](enum.NextState.html#method.set_if_neq "method bevy::prelude::NextState::set_if_neq") instead.
...
Like [`set`](enum.NextState.html#method.set "method bevy::prelude::NextState::set"), but will not run any state transition schedules if the target state is the same as the current one. If [`set`](enum.NextState.html#method.set "method bevy::prelude::NextState::set") has already been called in the same frame with the same state, the transition schedules will be run anyways.
...
Remove any pending changes to [`State<S>`](struct.State.html "struct bevy::prelude::State")

## Trait Implementations

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state/resources.rs.html#175)

### impl<S> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>

where S: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") + [FreelyMutableState](../state/state/trait.FreelyMutableState.html "trait bevy::state::state::FreelyMutableState"),

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state/resources.rs.html#175)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>
...
### impl<S> [Component](trait.Component.html "trait bevy::prelude::Component") for [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>
...
#### fn [map\_entities](trait.Component.html#method.map_entities)<M>(this: &mut [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>, mapper: [&mut M](https://doc.rust-lang.org/nightly/std/primitive.reference.html))
...
### impl<S> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>

where S: [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") + [FreelyMutableState](../state/state/trait.FreelyMutableState.html "trait bevy::state::state::FreelyMutableState"),
...
### impl<S> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>

where S: [FreelyMutableState](../state/state/trait.FreelyMutableState.html "trait bevy::state::state::FreelyMutableState"),

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state/resources.rs.html#175)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>
...
### impl<S> [Enum](../reflect/enums/trait.Enum.html "trait bevy::reflect::enums::Enum") for [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>
...
### impl<S> [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>

where S: [FreelyMutableState](../state/state/trait.FreelyMutableState.html "trait bevy::state::state::FreelyMutableState") + [TypePath](trait.TypePath.html "trait bevy::prelude::TypePath") + [FromReflect](trait.FromReflect.html "trait bevy::prelude::FromReflect") + MaybeTyped + RegisterForReflection, [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>: [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state/resources.rs.html#178)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state/resources.rs.html#178)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[NextState](enum.NextState.html "enum bevy::prelude::NextState")<S> as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)( \_\_param0: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>>
...
### impl<S> [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>
...
### impl<S> [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>
...
### impl<S> [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>
...
where [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>: 'into\_return,
...
### impl<S> [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state/resources.rs.html#178)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<S> [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>
...
### impl<S> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>

where S: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"),

### impl<S> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>
...
### impl<S> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>

### impl<S> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>

### impl<S> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>

where S: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<S> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>

where S: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"),

### impl<S> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [NextState](enum.NextState.html "enum bevy::prelude::NextState")<S>
