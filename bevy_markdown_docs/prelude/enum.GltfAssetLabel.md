...
You can use [`GltfAssetLabel::from_asset`](enum.GltfAssetLabel.html#method.from_asset "method bevy::prelude::GltfAssetLabel::from_asset") to add it to an asset path
...
`Scene{}`: glTF Scene as a Bevy [`WorldAsset`](struct.WorldAsset.html "struct bevy::prelude::WorldAsset")

### Node([usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html))

`Node{}`: glTF Node as a [`GltfNode`](../gltf/struct.GltfNode.html "struct bevy::gltf::GltfNode")

### Mesh([usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html))

`Mesh{}`: glTF Mesh as a [`GltfMesh`](../gltf/struct.GltfMesh.html "struct bevy::gltf::GltfMesh")

### Primitive

`Mesh{}/Primitive{}`: glTF Primitive as a Bevy [`Mesh`](struct.Mesh.html "struct bevy::prelude::Mesh")
...
`Texture{}`: glTF Texture as a Bevy [`Image`](struct.Image.html "struct bevy::prelude::Image")

### Material

`Material{}`: glTF Material as Bevy [`GltfMaterial`](../gltf/struct.GltfMaterial.html "struct bevy::gltf::GltfMaterial")
...
`Animation{}`: glTF Animation as Bevy [`AnimationClip`](struct.AnimationClip.html "struct bevy::prelude::AnimationClip")

### Skin([usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html))

`Skin{}`: glTF mesh skin as [`GltfSkin`](../gltf/struct.GltfSkin.html "struct bevy::gltf::GltfSkin")
...
### impl [GltfAssetLabel](enum.GltfAssetLabel.html "enum bevy::prelude::GltfAssetLabel")
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [GltfAssetLabel](enum.GltfAssetLabel.html "enum bevy::prelude::GltfAssetLabel")

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/label.rs.html#32)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [GltfAssetLabel](enum.GltfAssetLabel.html "enum bevy::prelude::GltfAssetLabel")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [GltfAssetLabel](enum.GltfAssetLabel.html "enum bevy::prelude::GltfAssetLabel")

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/label.rs.html#32)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [GltfAssetLabel](enum.GltfAssetLabel.html "enum bevy::prelude::GltfAssetLabel")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [GltfAssetLabel](enum.GltfAssetLabel.html "enum bevy::prelude::GltfAssetLabel")
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [GltfAssetLabel](enum.GltfAssetLabel.html "enum bevy::prelude::GltfAssetLabel")

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/label.rs.html#32)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [GltfAssetLabel](enum.GltfAssetLabel.html "enum bevy::prelude::GltfAssetLabel")

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/label.rs.html#32)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[GltfAssetLabel](enum.GltfAssetLabel.html "enum bevy::prelude::GltfAssetLabel")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [GltfAssetLabel](enum.GltfAssetLabel.html "enum bevy::prelude::GltfAssetLabel")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [GltfAssetLabel](enum.GltfAssetLabel.html "enum bevy::prelude::GltfAssetLabel")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [GltfAssetLabel](enum.GltfAssetLabel.html "enum bevy::prelude::GltfAssetLabel")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [GltfAssetLabel](enum.GltfAssetLabel.html "enum bevy::prelude::GltfAssetLabel")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [GltfAssetLabel](enum.GltfAssetLabel.html "enum bevy::prelude::GltfAssetLabel")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [GltfAssetLabel](enum.GltfAssetLabel.html "enum bevy::prelude::GltfAssetLabel")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [GltfAssetLabel](enum.GltfAssetLabel.html "enum bevy::prelude::GltfAssetLabel")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [GltfAssetLabel](enum.GltfAssetLabel.html "enum bevy::prelude::GltfAssetLabel")
