...
The internals are made transparent to give curve authors freedom, but [the provided constructor](struct.UnevenCore.html#method.new "associated function bevy::prelude::UnevenCore::new") enforces the required invariants, and the methods maintain those invariants.
...
`samples: [Vec](struct.Vec.html "struct bevy::prelude::Vec")<T>`
...
### impl<T> [UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#361)

#### pub fn [new](#method.new)( timed\_samples: impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = ([f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), T)>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>, [UnevenCoreError](cores/enum.UnevenCoreError.html "enum bevy::prelude::cores::UnevenCoreError")\>

Create a new [`UnevenCore`](struct.UnevenCore.html "struct bevy::prelude::UnevenCore"). The given samples are filtered to finite times and sorted internally; if there are not at least 2 valid timed samples, an error will be returned.
...
#### pub fn [sample\_interp](#method.sample_interp)(&self, t: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [InterpolationDatum](cores/enum.InterpolationDatum.html "enum bevy::prelude::cores::InterpolationDatum")<[&T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\>

Given a time `t`, obtain a [`InterpolationDatum`](cores/enum.InterpolationDatum.html "enum bevy::prelude::cores::InterpolationDatum") which governs how interpolation might recover a sample at time `t`. For example, when a [`Between`](cores/enum.InterpolationDatum.html#variant.Between "variant bevy::prelude::cores::InterpolationDatum::Between") value is returned, its contents can be used to interpolate between the two contained values with the given parameter. The other variants give additional context about where the value is relative to the family of samples.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#430)

#### pub fn [sample\_interp\_timed](#method.sample_interp_timed)(&self, t: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [InterpolationDatum](cores/enum.InterpolationDatum.html "enum bevy::prelude::cores::InterpolationDatum")<([f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), [&T](https://doc.rust-lang.org/nightly/std/primitive.reference.html))>

Like [`sample_interp`](struct.UnevenCore.html#method.sample_interp "method bevy::prelude::UnevenCore::sample_interp"), but the returned values include the sample times. This can be useful when sample interpolation is not scale-invariant.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#444)

#### pub fn [map\_sample\_times](#method.map_sample_times)(self, f: impl [Fn](https://doc.rust-lang.org/nightly/core/ops/function/trait.Fn.html "trait core::ops::function::Fn")([f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>

This core, but with the sample times moved by the map `f`. In principle, when `f` is monotone, this is equivalent to [`CurveExt::reparametrize`](trait.CurveExt.html#method.reparametrize "method bevy::prelude::CurveExt::reparametrize"), but the function inputs to each are inverses of one another.
...
### impl<T> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>

where T: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#324)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>
...
### impl<T> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>
...
### impl<'de, T> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>
...
### impl<T> [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>
...
#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#326)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T> as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>>
...
### impl<T> [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>
...
### impl<T> [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>
...
### impl<T> [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>
...
where [UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>: 'into\_return,
...
### impl<T> [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/cores.rs.html#326)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<T> [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>
...
### impl<T> [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>
...
### impl<T> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>

### impl<T> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>
...
### impl<T> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>

where T: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>

where T: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>

where T: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<T> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>

### impl<T> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [UnevenCore](struct.UnevenCore.html "struct bevy::prelude::UnevenCore")<T>
