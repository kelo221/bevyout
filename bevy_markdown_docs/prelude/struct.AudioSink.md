...
Bevy inserts this component onto your entities when it begins playing an audio source. Use [`AudioPlayer`](struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer") to trigger that to happen.

You can use this component to modify the playback settings while the audio is playing.

If this component is removed from an entity, and an [`AudioSource`](struct.AudioSource.html "struct bevy::prelude::AudioSource") is attached to that entity, that [`AudioSource`](struct.AudioSource.html "struct bevy::prelude::AudioSource") will start playing. If that source is unchanged, that translates to the audio restarting.

## Implementations

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/sinks.rs.html#156)

### impl [AudioSink](struct.AudioSink.html "struct bevy::prelude::AudioSink")

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/sinks.rs.html#158)

#### pub fn [new](#method.new)(sink: [Player](https://docs.rs/rodio/0.22.2/x86_64-unknown-linux-gnu/rodio/player/struct.Player.html "struct rodio::player::Player")) -> [AudioSink](struct.AudioSink.html "struct bevy::prelude::AudioSink")
...
### impl [Component](trait.Component.html "trait bevy::prelude::Component") for [AudioSink](struct.AudioSink.html "struct bevy::prelude::AudioSink")

where [AudioSink](struct.AudioSink.html "struct bevy::prelude::AudioSink"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AudioSink](struct.AudioSink.html "struct bevy::prelude::AudioSink")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AudioSink](struct.AudioSink.html "struct bevy::prelude::AudioSink")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AudioSink](struct.AudioSink.html "struct bevy::prelude::AudioSink")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AudioSink](struct.AudioSink.html "struct bevy::prelude::AudioSink")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AudioSink](struct.AudioSink.html "struct bevy::prelude::AudioSink")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AudioSink](struct.AudioSink.html "struct bevy::prelude::AudioSink")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AudioSink](struct.AudioSink.html "struct bevy::prelude::AudioSink")
