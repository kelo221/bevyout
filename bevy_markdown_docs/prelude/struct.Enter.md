...
[`Enter`](struct.Enter.html "struct bevy::prelude::Enter") events would be sent for both E and its direct ancestor D. An [`Enter`](struct.Enter.html "struct bevy::prelude::Enter") event would not be sent for A because it is a shared ancestor of both C and E.

Note: An [`Enter`](struct.Enter.html "struct bevy::prelude::Enter") event may be fired for an ancestor even if the pointer does not enter within the ancestor’s bounds. More concretely, if a child’s bounds extend beyond the parent’s and the pointer enters the child’s bounds without crossing into the parent’s, two [`Enter`](struct.Enter.html "struct bevy::prelude::Enter") events are still emitted for both the child and the parent. This matches the triggering behavior of `mouseenter` events on the web. To find out whether a pointer is within the target entity’s bounds immediately upon entering, check the value of [`is_in_bounds`](struct.Enter.html#structfield.is_in_bounds "field bevy::prelude::Enter::is_in_bounds").

Refer to [`pointer_events`](fn.pointer_events.html "fn bevy::prelude::pointer_events") for more information on how these events are triggered.

## Fields

`hit: [HitData](../picking/backend/struct.HitData.html "struct bevy::picking::backend::HitData")`
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Enter](struct.Enter.html "struct bevy::prelude::Enter")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#223)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Enter](struct.Enter.html "struct bevy::prelude::Enter")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Enter](struct.Enter.html "struct bevy::prelude::Enter")
...
### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Enter](struct.Enter.html "struct bevy::prelude::Enter")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#223)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Enter](struct.Enter.html "struct bevy::prelude::Enter")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#223)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Enter](struct.Enter.html "struct bevy::prelude::Enter") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Enter](struct.Enter.html "struct bevy::prelude::Enter")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Enter](struct.Enter.html "struct bevy::prelude::Enter")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Enter](struct.Enter.html "struct bevy::prelude::Enter")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Enter](struct.Enter.html "struct bevy::prelude::Enter")
...
where [Enter](struct.Enter.html "struct bevy::prelude::Enter"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Enter](struct.Enter.html "struct bevy::prelude::Enter")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#223)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Enter](struct.Enter.html "struct bevy::prelude::Enter")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Enter](struct.Enter.html "struct bevy::prelude::Enter")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Enter](struct.Enter.html "struct bevy::prelude::Enter")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#223)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Enter](struct.Enter.html "struct bevy::prelude::Enter")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Enter](struct.Enter.html "struct bevy::prelude::Enter")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Enter](struct.Enter.html "struct bevy::prelude::Enter")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Enter](struct.Enter.html "struct bevy::prelude::Enter")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Enter](struct.Enter.html "struct bevy::prelude::Enter")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Enter](struct.Enter.html "struct bevy::prelude::Enter")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Enter](struct.Enter.html "struct bevy::prelude::Enter")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Enter](struct.Enter.html "struct bevy::prelude::Enter")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Enter](struct.Enter.html "struct bevy::prelude::Enter")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Enter](struct.Enter.html "struct bevy::prelude::Enter")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Enter](struct.Enter.html "struct bevy::prelude::Enter")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Enter](struct.Enter.html "struct bevy::prelude::Enter")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Enter](struct.Enter.html "struct bevy::prelude::Enter")
