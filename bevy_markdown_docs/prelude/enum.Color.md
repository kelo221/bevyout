...
For example, the [sRGB](struct.Srgba.html "struct bevy::prelude::Srgba") space is defined by its relationship with [Linear RGB](struct.LinearRgba.html "struct bevy::prelude::LinearRgba"), and [HWB](struct.Hwba.html "struct bevy::prelude::Hwba") by its with [sRGB](struct.Srgba.html "struct bevy::prelude::Srgba"). As such, it is the responsibility of [sRGB](struct.Srgba.html "struct bevy::prelude::Srgba") to provide [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From") implementations for [Linear RGB](struct.LinearRgba.html "struct bevy::prelude::LinearRgba"), and [HWB](struct.Hwba.html "struct bevy::prelude::Hwba") for [sRGB](struct.Srgba.html "struct bevy::prelude::Srgba"). To then provide conversion between [Linear RGB](struct.LinearRgba.html "struct bevy::prelude::LinearRgba") and [HWB](struct.Hwba.html "struct bevy::prelude::Hwba") directly, [HWB](struct.Hwba.html "struct bevy::prelude::Hwba") is responsible for implementing these conversions, delegating to [sRGB](struct.Srgba.html "struct bevy::prelude::Srgba") as an intermediatory. This ensures that all conversions take the shortest path between any two spaces, and limit the proliferation of domain specific knowledge for each color space to their respective definitions.
...
[`Color`](enum.Color.html "enum bevy::prelude::Color") supports all the standard color operations, such as [mixing](trait.Mix.html "trait bevy::prelude::Mix"), [luminance](trait.Luminance.html "trait bevy::prelude::Luminance") and [hue](trait.Hue.html "trait bevy::prelude::Hue") adjustment, and [diffing](../color/color_difference/trait.EuclideanDistance.html "trait bevy::color::color_difference::EuclideanDistance"). These operations delegate to the concrete color space contained by [`Color`](enum.Color.html "enum bevy::prelude::Color"), but will convert to [`Oklch`](struct.Oklcha.html "struct bevy::prelude::Oklcha") for operations which aren’t supported in the current space. After performing the operation, if a conversion was required, the result will be converted back into the original color space.
...
[`Oklch`](struct.Oklcha.html "struct bevy::prelude::Oklcha") has been chosen as the intermediary space in cases where conversion is required due to its perceptual uniformity and broad support for Bevy’s color operations. To avoid the cost of repeated conversion, and ensure consistent results where that is desired, first convert this [`Color`](enum.Color.html "enum bevy::prelude::Color") into your desired color space.

## Variants

### Srgba([Srgba](struct.Srgba.html "struct bevy::prelude::Srgba"))

A color in the sRGB color space with alpha.

### LinearRgba([LinearRgba](struct.LinearRgba.html "struct bevy::prelude::LinearRgba"))

A color in the linear sRGB color space with alpha.

### Hsla([Hsla](struct.Hsla.html "struct bevy::prelude::Hsla"))

A color in the HSL color space with alpha.

### Hsva([Hsva](struct.Hsva.html "struct bevy::prelude::Hsva"))

A color in the HSV color space with alpha.

### Hwba([Hwba](struct.Hwba.html "struct bevy::prelude::Hwba"))

A color in the HWB color space with alpha.

### Laba([Laba](struct.Laba.html "struct bevy::prelude::Laba"))

A color in the LAB color space with alpha.

### Lcha([Lcha](struct.Lcha.html "struct bevy::prelude::Lcha"))

A color in the LCH color space with alpha.

### Oklaba([Oklaba](struct.Oklaba.html "struct bevy::prelude::Oklaba"))

A color in the Oklab color space with alpha.

### Oklcha([Oklcha](struct.Oklcha.html "struct bevy::prelude::Oklcha"))

A color in the Oklch color space with alpha.

### Xyza([Xyza](struct.Xyza.html "struct bevy::prelude::Xyza"))
...
### impl [Color](enum.Color.html "enum bevy::prelude::Color")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#503)

#### pub const [WHITE](#associatedconstant.WHITE): [Color](enum.Color.html "enum bevy::prelude::Color")

A fully white [`Color::LinearRgba`](enum.Color.html#variant.LinearRgba "variant bevy::prelude::Color::LinearRgba") color with an alpha of 1.0.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#506)

#### pub const [BLACK](#associatedconstant.BLACK): [Color](enum.Color.html "enum bevy::prelude::Color")

A fully black [`Color::LinearRgba`](enum.Color.html#variant.LinearRgba "variant bevy::prelude::Color::LinearRgba") color with an alpha of 1.0.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#509)

#### pub const [NONE](#associatedconstant.NONE): [Color](enum.Color.html "enum bevy::prelude::Color")

A fully transparent [`Color::LinearRgba`](enum.Color.html#variant.LinearRgba "variant bevy::prelude::Color::LinearRgba") color with 0 red, green and blue.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#83)

#### pub fn [to\_linear](#method.to_linear)(&self) -> [LinearRgba](struct.LinearRgba.html "struct bevy::prelude::LinearRgba")
...
#### pub fn [to\_srgba](#method.to_srgba)(&self) -> [Srgba](struct.Srgba.html "struct bevy::prelude::Srgba")
...
#### pub const fn [srgba](#method.srgba)(red: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), green: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), blue: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), alpha: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`Srgba`](struct.Srgba.html "struct bevy::prelude::Srgba") color.
...
#### pub const fn [srgb](#method.srgb)(red: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), green: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), blue: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`Srgba`](struct.Srgba.html "struct bevy::prelude::Srgba") color with an alpha of 1.0.
...
#### pub const fn [srgb\_from\_array](#method.srgb_from_array)(array: \[[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html); [3](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Reads an array of floats to creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`Srgba`](struct.Srgba.html "struct bevy::prelude::Srgba") color with an alpha of 1.0.
...
#### pub const fn [srgba\_u8](#method.srgba_u8)(red: [u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html), green: [u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html), blue: [u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html), alpha: [u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`Srgba`](struct.Srgba.html "struct bevy::prelude::Srgba") color from [`u8`](https://doc.rust-lang.org/nightly/std/primitive.u8.html "primitive u8") values.
...
#### pub const fn [srgb\_u8](#method.srgb_u8)(red: [u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html), green: [u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html), blue: [u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`Srgba`](struct.Srgba.html "struct bevy::prelude::Srgba") color from [`u8`](https://doc.rust-lang.org/nightly/std/primitive.u8.html "primitive u8") values with an alpha of 1.0.
...
#### pub fn [srgb\_u32](#method.srgb_u32)(color: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`Srgba`](struct.Srgba.html "struct bevy::prelude::Srgba") color from a [`u32`](https://doc.rust-lang.org/nightly/std/primitive.u32.html "primitive u32") value with an alpha of 1.0.
...
#### pub fn [srgba\_u32](#method.srgba_u32)(color: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`Srgba`](struct.Srgba.html "struct bevy::prelude::Srgba") color from a [`u32`](https://doc.rust-lang.org/nightly/std/primitive.u32.html "primitive u32") value with the alpha value extracted from the input.
...
Creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`LinearRgba`](struct.LinearRgba.html "struct bevy::prelude::LinearRgba") color.
...
#### pub const fn [linear\_rgb](#method.linear_rgb)(red: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), green: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), blue: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`LinearRgba`](struct.LinearRgba.html "struct bevy::prelude::LinearRgba") color with an alpha of 1.0.
...
#### pub const fn [hsla](#method.hsla)( hue: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), saturation: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), lightness: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), alpha: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`Hsla`](struct.Hsla.html "struct bevy::prelude::Hsla") color.
...
#### pub const fn [hsl](#method.hsl)(hue: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), saturation: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), lightness: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`Hsla`](struct.Hsla.html "struct bevy::prelude::Hsla") color with an alpha of 1.0.
...
#### pub const fn [hsva](#method.hsva)(hue: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), saturation: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), value: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), alpha: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`Hsva`](struct.Hsva.html "struct bevy::prelude::Hsva") color.
...
#### pub const fn [hsv](#method.hsv)(hue: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), saturation: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), value: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`Hsva`](struct.Hsva.html "struct bevy::prelude::Hsva") color with an alpha of 1.0.
...
#### pub const fn [hwba](#method.hwba)(hue: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), whiteness: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), blackness: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), alpha: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`Hwba`](struct.Hwba.html "struct bevy::prelude::Hwba") color.
...
#### pub const fn [hwb](#method.hwb)(hue: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), whiteness: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), blackness: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`Hwba`](struct.Hwba.html "struct bevy::prelude::Hwba") color with an alpha of 1.0.
...
#### pub const fn [laba](#method.laba)(lightness: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), a: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), b: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), alpha: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`Laba`](struct.Laba.html "struct bevy::prelude::Laba") color.
...
#### pub const fn [lab](#method.lab)(lightness: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), a: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), b: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`Laba`](struct.Laba.html "struct bevy::prelude::Laba") color with an alpha of 1.0.
...
Creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`Lcha`](struct.Lcha.html "struct bevy::prelude::Lcha") color.
...
#### pub const fn [lch](#method.lch)(lightness: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), chroma: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), hue: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`Lcha`](struct.Lcha.html "struct bevy::prelude::Lcha") color with an alpha of 1.0.
...
#### pub const fn [oklaba](#method.oklaba)(lightness: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), a: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), b: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), alpha: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`Oklaba`](struct.Oklaba.html "struct bevy::prelude::Oklaba") color.
...
#### pub const fn [oklab](#method.oklab)(lightness: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), a: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), b: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`Oklaba`](struct.Oklaba.html "struct bevy::prelude::Oklaba") color with an alpha of 1.0.
...
Creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`Oklcha`](struct.Oklcha.html "struct bevy::prelude::Oklcha") color.
...
#### pub const fn [oklch](#method.oklch)(lightness: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), chroma: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), hue: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`Oklcha`](struct.Oklcha.html "struct bevy::prelude::Oklcha") color with an alpha of 1.0.
...
#### pub const fn [xyza](#method.xyza)(x: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), y: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), z: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), alpha: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`Xyza`](struct.Xyza.html "struct bevy::prelude::Xyza") color.
...
#### pub const fn [xyz](#method.xyz)(x: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), y: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), z: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Creates a new [`Color`](enum.Color.html "enum bevy::prelude::Color") object storing a [`Xyza`](struct.Xyza.html "struct bevy::prelude::Xyza") color with an alpha of 1.0.
...
#### fn [with\_alpha](trait.Alpha.html#tymethod.with_alpha)(&self, alpha: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Return a new version of this color with the given alpha value.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#539)

#### fn [alpha](trait.Alpha.html#tymethod.alpha)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Return the alpha component of this color.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#554)

#### fn [set\_alpha](trait.Alpha.html#tymethod.set_alpha)(&mut self, alpha: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html))

Sets the alpha component of this color.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color_ops.rs.html#70)

#### fn [is\_fully\_transparent](trait.Alpha.html#method.is_fully_transparent)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
#### fn [is\_fully\_opaque](trait.Alpha.html#method.is_fully_opaque)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Color](enum.Color.html "enum bevy::prelude::Color")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#45)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Color](enum.Color.html "enum bevy::prelude::Color")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [Color](enum.Color.html "enum bevy::prelude::Color")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#45)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Color](enum.Color.html "enum bevy::prelude::Color")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Color](enum.Color.html "enum bevy::prelude::Color")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#514)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Color](enum.Color.html "enum bevy::prelude::Color")

A fully white [`Color::LinearRgba`](enum.Color.html#variant.LinearRgba "variant bevy::prelude::Color::LinearRgba") color with an alpha of 1.0.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#51)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [Color](enum.Color.html "enum bevy::prelude::Color")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#51)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Color](enum.Color.html "enum bevy::prelude::Color"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [Enum](../reflect/enums/trait.Enum.html "trait bevy::reflect::enums::Enum") for [Color](enum.Color.html "enum bevy::prelude::Color")
...
### impl [EuclideanDistance](../color/color_difference/trait.EuclideanDistance.html "trait bevy::color::color_difference::EuclideanDistance") for [Color](enum.Color.html "enum bevy::prelude::Color")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#917)

#### fn [distance\_squared](../color/color_difference/trait.EuclideanDistance.html#tymethod.distance_squared)(&self, other: &[Color](enum.Color.html "enum bevy::prelude::Color")) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)
...
#### fn [distance](../color/color_difference/trait.EuclideanDistance.html#method.distance)(&self, other: &Self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Distance from `self` to `other`.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#570)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Color](enum.Color.html "enum bevy::prelude::Color")\> for [Srgba](struct.Srgba.html "struct bevy::prelude::Srgba")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#571)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Color](enum.Color.html "enum bevy::prelude::Color")) -> [Srgba](struct.Srgba.html "struct bevy::prelude::Srgba")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#587)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Color](enum.Color.html "enum bevy::prelude::Color")\> for [LinearRgba](struct.LinearRgba.html "struct bevy::prelude::LinearRgba")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#588)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Color](enum.Color.html "enum bevy::prelude::Color")) -> [LinearRgba](struct.LinearRgba.html "struct bevy::prelude::LinearRgba")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#604)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Color](enum.Color.html "enum bevy::prelude::Color")\> for [Hsla](struct.Hsla.html "struct bevy::prelude::Hsla")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#605)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Color](enum.Color.html "enum bevy::prelude::Color")) -> [Hsla](struct.Hsla.html "struct bevy::prelude::Hsla")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#621)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Color](enum.Color.html "enum bevy::prelude::Color")\> for [Hsva](struct.Hsva.html "struct bevy::prelude::Hsva")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#622)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Color](enum.Color.html "enum bevy::prelude::Color")) -> [Hsva](struct.Hsva.html "struct bevy::prelude::Hsva")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#638)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Color](enum.Color.html "enum bevy::prelude::Color")\> for [Hwba](struct.Hwba.html "struct bevy::prelude::Hwba")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#639)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Color](enum.Color.html "enum bevy::prelude::Color")) -> [Hwba](struct.Hwba.html "struct bevy::prelude::Hwba")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#655)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Color](enum.Color.html "enum bevy::prelude::Color")\> for [Laba](struct.Laba.html "struct bevy::prelude::Laba")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#656)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Color](enum.Color.html "enum bevy::prelude::Color")) -> [Laba](struct.Laba.html "struct bevy::prelude::Laba")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#672)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Color](enum.Color.html "enum bevy::prelude::Color")\> for [Lcha](struct.Lcha.html "struct bevy::prelude::Lcha")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#673)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Color](enum.Color.html "enum bevy::prelude::Color")) -> [Lcha](struct.Lcha.html "struct bevy::prelude::Lcha")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#689)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Color](enum.Color.html "enum bevy::prelude::Color")\> for [Oklaba](struct.Oklaba.html "struct bevy::prelude::Oklaba")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#690)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Color](enum.Color.html "enum bevy::prelude::Color")) -> [Oklaba](struct.Oklaba.html "struct bevy::prelude::Oklaba")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#706)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Color](enum.Color.html "enum bevy::prelude::Color")\> for [Oklcha](struct.Oklcha.html "struct bevy::prelude::Oklcha")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#707)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Color](enum.Color.html "enum bevy::prelude::Color")) -> [Oklcha](struct.Oklcha.html "struct bevy::prelude::Oklcha")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#723)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Color](enum.Color.html "enum bevy::prelude::Color")\> for [Xyza](struct.Xyza.html "struct bevy::prelude::Xyza")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#724)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Color](enum.Color.html "enum bevy::prelude::Color")) -> [Xyza](struct.Xyza.html "struct bevy::prelude::Xyza")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/clear_color.rs.html#11)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Color](enum.Color.html "enum bevy::prelude::Color")\> for [ClearColorConfig](enum.ClearColorConfig.html "enum bevy::prelude::ClearColorConfig")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/clear_color.rs.html#11)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Color](enum.Color.html "enum bevy::prelude::Color")) -> [ClearColorConfig](enum.ClearColorConfig.html "enum bevy::prelude::ClearColorConfig")
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Color](enum.Color.html "enum bevy::prelude::Color")\> for [ColorStop](struct.ColorStop.html "struct bevy::prelude::ColorStop")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/gradients.rs.html#83)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(color: [Color](enum.Color.html "enum bevy::prelude::Color")) -> [ColorStop](struct.ColorStop.html "struct bevy::prelude::ColorStop")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/gradients.rs.html#194)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Color](enum.Color.html "enum bevy::prelude::Color")\> for [AngularColorStop](struct.AngularColorStop.html "struct bevy::prelude::AngularColorStop")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/gradients.rs.html#195)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(color: [Color](enum.Color.html "enum bevy::prelude::Color")) -> [AngularColorStop](struct.AngularColorStop.html "struct bevy::prelude::AngularColorStop")
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Color](enum.Color.html "enum bevy::prelude::Color")\> for [ColorMaterial](struct.ColorMaterial.html "struct bevy::prelude::ColorMaterial")
...
#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(color: [Color](enum.Color.html "enum bevy::prelude::Color")) -> [ColorMaterial](struct.ColorMaterial.html "struct bevy::prelude::ColorMaterial")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#45)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Hsla](struct.Hsla.html "struct bevy::prelude::Hsla")\> for [Color](enum.Color.html "enum bevy::prelude::Color")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#45)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Hsla](struct.Hsla.html "struct bevy::prelude::Hsla")) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#45)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Hsva](struct.Hsva.html "struct bevy::prelude::Hsva")\> for [Color](enum.Color.html "enum bevy::prelude::Color")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#45)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Hsva](struct.Hsva.html "struct bevy::prelude::Hsva")) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#45)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Hwba](struct.Hwba.html "struct bevy::prelude::Hwba")\> for [Color](enum.Color.html "enum bevy::prelude::Color")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#45)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Hwba](struct.Hwba.html "struct bevy::prelude::Hwba")) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#45)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Laba](struct.Laba.html "struct bevy::prelude::Laba")\> for [Color](enum.Color.html "enum bevy::prelude::Color")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#45)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Laba](struct.Laba.html "struct bevy::prelude::Laba")) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#45)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Lcha](struct.Lcha.html "struct bevy::prelude::Lcha")\> for [Color](enum.Color.html "enum bevy::prelude::Color")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#45)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Lcha](struct.Lcha.html "struct bevy::prelude::Lcha")) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#45)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[LinearRgba](struct.LinearRgba.html "struct bevy::prelude::LinearRgba")\> for [Color](enum.Color.html "enum bevy::prelude::Color")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#45)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [LinearRgba](struct.LinearRgba.html "struct bevy::prelude::LinearRgba")) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#45)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Oklaba](struct.Oklaba.html "struct bevy::prelude::Oklaba")\> for [Color](enum.Color.html "enum bevy::prelude::Color")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#45)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Oklaba](struct.Oklaba.html "struct bevy::prelude::Oklaba")) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#45)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Oklcha](struct.Oklcha.html "struct bevy::prelude::Oklcha")\> for [Color](enum.Color.html "enum bevy::prelude::Color")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#45)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Oklcha](struct.Oklcha.html "struct bevy::prelude::Oklcha")) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#45)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Srgba](struct.Srgba.html "struct bevy::prelude::Srgba")\> for [Color](enum.Color.html "enum bevy::prelude::Color")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#45)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Srgba](struct.Srgba.html "struct bevy::prelude::Srgba")) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#45)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Xyza](struct.Xyza.html "struct bevy::prelude::Xyza")\> for [Color](enum.Color.html "enum bevy::prelude::Color")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#45)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Xyza](struct.Xyza.html "struct bevy::prelude::Xyza")) -> [Color](enum.Color.html "enum bevy::prelude::Color")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#48)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Color](enum.Color.html "enum bevy::prelude::Color")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#48)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Color](enum.Color.html "enum bevy::prelude::Color")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#48)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Color](enum.Color.html "enum bevy::prelude::Color") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)(\_\_param0: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Color](enum.Color.html "enum bevy::prelude::Color")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Color](enum.Color.html "enum bevy::prelude::Color")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Color](enum.Color.html "enum bevy::prelude::Color")
...
### impl [Hue](trait.Hue.html "trait bevy::prelude::Hue") for [Color](enum.Color.html "enum bevy::prelude::Color")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#818)

#### fn [with\_hue](trait.Hue.html#tymethod.with_hue)(&self, hue: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Color](enum.Color.html "enum bevy::prelude::Color")
...
#### fn [hue](trait.Hue.html#tymethod.hue)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)
...
#### fn [set\_hue](trait.Hue.html#tymethod.set_hue)(&mut self, hue: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html))
...
#### fn [rotate\_hue](trait.Hue.html#method.rotate_hue)(&self, degrees: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> Self

Return a new version of this color with the hue channel rotated by the given degrees.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#48)

### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Color](enum.Color.html "enum bevy::prelude::Color")
...
where [Color](enum.Color.html "enum bevy::prelude::Color"): 'into\_return,
...
### impl [Luminance](trait.Luminance.html "trait bevy::prelude::Luminance") for [Color](enum.Color.html "enum bevy::prelude::Color")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#744)

#### fn [luminance](trait.Luminance.html#tymethod.luminance)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)
...
#### fn [with\_luminance](trait.Luminance.html#tymethod.with_luminance)(&self, value: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Color](enum.Color.html "enum bevy::prelude::Color")
...
#### fn [mix\_assign](trait.Mix.html#method.mix_assign)(&mut self, other: Self, factor: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html))
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Color](enum.Color.html "enum bevy::prelude::Color")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#45)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Color](enum.Color.html "enum bevy::prelude::Color")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Color](enum.Color.html "enum bevy::prelude::Color")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Color](enum.Color.html "enum bevy::prelude::Color")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#48)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Color](enum.Color.html "enum bevy::prelude::Color")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Color](enum.Color.html "enum bevy::prelude::Color")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Color](enum.Color.html "enum bevy::prelude::Color")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Color](enum.Color.html "enum bevy::prelude::Color")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Saturation](trait.Saturation.html "trait bevy::prelude::Saturation") for [Color](enum.Color.html "enum bevy::prelude::Color")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#858)

#### fn [with\_saturation](trait.Saturation.html#tymethod.with_saturation)(&self, saturation: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Color](enum.Color.html "enum bevy::prelude::Color")
...
#### fn [saturation](trait.Saturation.html#tymethod.saturation)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)
...
#### fn [set\_saturation](trait.Saturation.html#tymethod.set_saturation)(&mut self, saturation: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html))

Sets the saturation of this color.

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#51)

### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [Color](enum.Color.html "enum bevy::prelude::Color")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Color](enum.Color.html "enum bevy::prelude::Color")

[Source](https://docs.rs/bevy_color/0.19.0/x86_64-unknown-linux-gnu/src/bevy_color/color.rs.html#933)

### impl [TryStableInterpolate](../math/trait.TryStableInterpolate.html "trait bevy::math::TryStableInterpolate") for [Color](enum.Color.html "enum bevy::prelude::Color")
...
#### fn [try\_interpolate\_stable](../math/trait.TryStableInterpolate.html#tymethod.try_interpolate_stable)( &self, other: &[Color](enum.Color.html "enum bevy::prelude::Color"), t: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Color](enum.Color.html "enum bevy::prelude::Color"), <[Color](enum.Color.html "enum bevy::prelude::Color") as [TryStableInterpolate](../math/trait.TryStableInterpolate.html "trait bevy::math::TryStableInterpolate")\>::[Error](../math/trait.TryStableInterpolate.html#associatedtype.Error "type bevy::math::TryStableInterpolate::Error")\>
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Color](enum.Color.html "enum bevy::prelude::Color")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Color](enum.Color.html "enum bevy::prelude::Color")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Color](enum.Color.html "enum bevy::prelude::Color")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Color](enum.Color.html "enum bevy::prelude::Color")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Color](enum.Color.html "enum bevy::prelude::Color")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Color](enum.Color.html "enum bevy::prelude::Color")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Color](enum.Color.html "enum bevy::prelude::Color")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Color](enum.Color.html "enum bevy::prelude::Color")
