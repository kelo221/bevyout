...
When set to `true` ray casting will only consider cameras marked with [`MeshPickingCamera`](struct.MeshPickingCamera.html "struct bevy::prelude::MeshPickingCamera") and entities marked with [`Pickable`](struct.Pickable.html "struct bevy::prelude::Pickable"). `false` by default.
...
`ray_cast_visibility: [RayCastVisibility](enum.RayCastVisibility.html "enum bevy::prelude::RayCastVisibility")`

Determines how mesh picking should consider [`Visibility`](enum.Visibility.html "enum bevy::prelude::Visibility"). When set to [`RayCastVisibility::Any`](enum.RayCastVisibility.html#variant.Any "variant bevy::prelude::RayCastVisibility::Any"), ray casts can be performed against both visible and hidden entities.

Defaults to [`RayCastVisibility::VisibleInView`](enum.RayCastVisibility.html#variant.VisibleInView "variant bevy::prelude::RayCastVisibility::VisibleInView"), only performing picking against visible entities that are in the view of a camera.

## Trait Implementations

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/mesh_picking/mod.rs.html#38)

### impl [Component](trait.Component.html "trait bevy::prelude::Component") for [MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/mesh_picking/mod.rs.html#57)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/mesh_picking/mod.rs.html#38)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/mesh_picking/mod.rs.html#38)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/mesh_picking/mod.rs.html#38)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings")
...
where [MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings"): 'into\_return,
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/mesh_picking/mod.rs.html#38)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings")\>, ) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MeshPickingSettings](struct.MeshPickingSettings.html "struct bevy::prelude::MeshPickingSettings")
