...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [SmoothStepCurve](struct.SmoothStepCurve.html "struct bevy::prelude::SmoothStepCurve")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#810)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [SmoothStepCurve](struct.SmoothStepCurve.html "struct bevy::prelude::SmoothStepCurve")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [SmoothStepCurve](struct.SmoothStepCurve.html "struct bevy::prelude::SmoothStepCurve")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SmoothStepCurve](struct.SmoothStepCurve.html "struct bevy::prelude::SmoothStepCurve")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SmoothStepCurve](struct.SmoothStepCurve.html "struct bevy::prelude::SmoothStepCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SmoothStepCurve](struct.SmoothStepCurve.html "struct bevy::prelude::SmoothStepCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SmoothStepCurve](struct.SmoothStepCurve.html "struct bevy::prelude::SmoothStepCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SmoothStepCurve](struct.SmoothStepCurve.html "struct bevy::prelude::SmoothStepCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SmoothStepCurve](struct.SmoothStepCurve.html "struct bevy::prelude::SmoothStepCurve")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SmoothStepCurve](struct.SmoothStepCurve.html "struct bevy::prelude::SmoothStepCurve")
