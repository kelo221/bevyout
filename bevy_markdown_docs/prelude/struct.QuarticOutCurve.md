...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [QuarticOutCurve](struct.QuarticOutCurve.html "struct bevy::prelude::QuarticOutCurve")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#749)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [QuarticOutCurve](struct.QuarticOutCurve.html "struct bevy::prelude::QuarticOutCurve")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [QuarticOutCurve](struct.QuarticOutCurve.html "struct bevy::prelude::QuarticOutCurve")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [QuarticOutCurve](struct.QuarticOutCurve.html "struct bevy::prelude::QuarticOutCurve")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [QuarticOutCurve](struct.QuarticOutCurve.html "struct bevy::prelude::QuarticOutCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [QuarticOutCurve](struct.QuarticOutCurve.html "struct bevy::prelude::QuarticOutCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [QuarticOutCurve](struct.QuarticOutCurve.html "struct bevy::prelude::QuarticOutCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [QuarticOutCurve](struct.QuarticOutCurve.html "struct bevy::prelude::QuarticOutCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [QuarticOutCurve](struct.QuarticOutCurve.html "struct bevy::prelude::QuarticOutCurve")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [QuarticOutCurve](struct.QuarticOutCurve.html "struct bevy::prelude::QuarticOutCurve")
