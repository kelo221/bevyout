...
A specialization of the [`Time`](struct.Time.html "struct bevy::prelude::Time") structure. **For method documentation, see [`Time<Virtual>`](struct.Time.html#impl-Time%3CVirtual%3E "struct bevy::prelude::Time").**

Normally used as `Time<Virtual>`. It is automatically inserted as a resource by [`TimePlugin`](../time/struct.TimePlugin.html "struct bevy::time::TimePlugin") and updated based on [`Time<Real>`](struct.Real.html "struct bevy::prelude::Real"). The virtual clock is automatically set as the default generic [`Time`](struct.Time.html "struct bevy::prelude::Time") resource for the update.
...
The virtual clock can be paused by calling [`pause()`](struct.Time.html#method.pause "method bevy::prelude::Time::pause"), unpaused by calling [`unpause()`](struct.Time.html#method.unpause "method bevy::prelude::Time::unpause"), or toggled by calling [`toggle()`](struct.Time.html#method.toggle "method bevy::prelude::Time::toggle"). When the game clock is paused [`delta()`](struct.Time.html#method.delta "method bevy::prelude::Time::delta") will be zero on each update, and [`elapsed()`](struct.Time.html#method.elapsed "method bevy::prelude::Time::elapsed") will not grow. [`effective_speed()`](struct.Time.html#method.effective_speed "method bevy::prelude::Time::effective_speed") will return `0.0`. Calling [`pause()`](struct.Time.html#method.pause "method bevy::prelude::Time::pause") will not affect value the [`delta()`](struct.Time.html#method.delta "method bevy::prelude::Time::delta") value for the update currently being processed.

The speed of the virtual clock can be changed by calling [`set_relative_speed()`](struct.Time.html#method.set_relative_speed "method bevy::prelude::Time::set_relative_speed"). A value of `2.0` means that virtual clock should advance twice as fast as real time, meaning that [`delta()`](struct.Time.html#method.delta "method bevy::prelude::Time::delta") values will be double of what [`Time<Real>::delta()`](struct.Time.html#method.delta "method bevy::prelude::Time::delta") reports and [`elapsed()`](struct.Time.html#method.elapsed "method bevy::prelude::Time::elapsed") will go twice as fast as [`Time<Real>::elapsed()`](struct.Time.html#method.elapsed "method bevy::prelude::Time::elapsed"). Calling [`set_relative_speed()`](struct.Time.html#method.set_relative_speed "method bevy::prelude::Time::set_relative_speed") will not affect the [`delta()`](struct.Time.html#method.delta "method bevy::prelude::Time::delta") value for the update currently being processed.

The maximum amount of delta time that can be added by a single update can be set by [`set_max_delta()`](struct.Time.html#method.set_max_delta "method bevy::prelude::Time::set_max_delta"). This value serves a dual purpose in the virtual clock.

If the game temporarily freezes due to any reason, such as disk access, a blocking system call, or operating system level suspend, reporting the full elapsed delta time is likely to cause bugs in game logic. Usually if a laptop is suspended for an hour, it doesn’t make sense to try to simulate the game logic for the elapsed hour when resuming. Instead it is better to lose the extra time and pretend a shorter duration of time passed. Setting [`max_delta()`](struct.Time.html#method.max_delta "method bevy::prelude::Time::max_delta") to a relatively short time means that the impact on game logic will be minimal.
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [Virtual](struct.Virtual.html "struct bevy::prelude::Virtual")

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/virt.rs.html#73)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Virtual](struct.Virtual.html "struct bevy::prelude::Virtual")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Virtual](struct.Virtual.html "struct bevy::prelude::Virtual")

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/virt.rs.html#267)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Virtual](struct.Virtual.html "struct bevy::prelude::Virtual")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/virt.rs.html#74)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Virtual](struct.Virtual.html "struct bevy::prelude::Virtual")

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/virt.rs.html#74)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Virtual](struct.Virtual.html "struct bevy::prelude::Virtual")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/virt.rs.html#74)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Virtual](struct.Virtual.html "struct bevy::prelude::Virtual") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Virtual](struct.Virtual.html "struct bevy::prelude::Virtual")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Virtual](struct.Virtual.html "struct bevy::prelude::Virtual")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Virtual](struct.Virtual.html "struct bevy::prelude::Virtual")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Virtual](struct.Virtual.html "struct bevy::prelude::Virtual")
...
where [Virtual](struct.Virtual.html "struct bevy::prelude::Virtual"): 'into\_return,
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Virtual](struct.Virtual.html "struct bevy::prelude::Virtual")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Virtual](struct.Virtual.html "struct bevy::prelude::Virtual")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/virt.rs.html#74)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Virtual](struct.Virtual.html "struct bevy::prelude::Virtual")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Virtual](struct.Virtual.html "struct bevy::prelude::Virtual")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Virtual](struct.Virtual.html "struct bevy::prelude::Virtual")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Virtual](struct.Virtual.html "struct bevy::prelude::Virtual")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Virtual](struct.Virtual.html "struct bevy::prelude::Virtual")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Virtual](struct.Virtual.html "struct bevy::prelude::Virtual")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Virtual](struct.Virtual.html "struct bevy::prelude::Virtual")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Virtual](struct.Virtual.html "struct bevy::prelude::Virtual")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Virtual](struct.Virtual.html "struct bevy::prelude::Virtual")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Virtual](struct.Virtual.html "struct bevy::prelude::Virtual")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Virtual](struct.Virtual.html "struct bevy::prelude::Virtual")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Virtual](struct.Virtual.html "struct bevy::prelude::Virtual")
