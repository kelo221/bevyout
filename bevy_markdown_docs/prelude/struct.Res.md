...
If you need a unique mutable borrow, use [`ResMut`](struct.ResMut.html "struct bevy::prelude::ResMut") instead.
...
### impl<'w, T> [Res](struct.Res.html "struct bevy::prelude::Res")<'w, T>
...
#### pub fn [clone](#method.clone)(this: &[Res](struct.Res.html "struct bevy::prelude::Res")<'w, T>) -> [Res](struct.Res.html "struct bevy::prelude::Res")<'w, T>
...
Due to lifetime limitations of the `Deref` trait, this method can be used to obtain a reference of the [`Resource`](trait.Resource.html "trait bevy::prelude::Resource") with a lifetime bound to `'w` instead of the lifetime of the struct itself.
...
### impl<'w, T> [AsRef](https://doc.rust-lang.org/nightly/core/convert/trait.AsRef.html "trait core::convert::AsRef")<T> for [Res](struct.Res.html "struct bevy::prelude::Res")<'w, T>
...
### impl<'w, T> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Res](struct.Res.html "struct bevy::prelude::Res")<'w, T>

where T: [Resource](trait.Resource.html "trait bevy::prelude::Resource") + [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") + ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),
...
### impl<'w, T> [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [Res](struct.Res.html "struct bevy::prelude::Res")<'w, T>

where T: [Resource](trait.Resource.html "trait bevy::prelude::Resource") + ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),
...
#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[Res](struct.Res.html "struct bevy::prelude::Res")<'w, T> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/params.rs.html#522)

### impl<'w, T> [DetectChanges](trait.DetectChanges.html "trait bevy::prelude::DetectChanges") for [Res](struct.Res.html "struct bevy::prelude::Res")<'w, T>
...
### impl<'w, 'a, T> [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") for &'a [Res](struct.Res.html "struct bevy::prelude::Res")<'w, T>

where T: [Resource](trait.Resource.html "trait bevy::prelude::Resource"), [&'a T](https://doc.rust-lang.org/nightly/std/primitive.reference.html): [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator"),
...
#### fn [into\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)(self) -> <&'a [Res](struct.Res.html "struct bevy::prelude::Res")<'w, T> as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter "type core::iter::traits::collect::IntoIterator::IntoIter")
...
### impl<'a, T> [ReadOnlySystemParam](../ecs/system/trait.ReadOnlySystemParam.html "trait bevy::ecs::system::ReadOnlySystemParam") for [Res](struct.Res.html "struct bevy::prelude::Res")<'a, T>

where T: [Resource](trait.Resource.html "trait bevy::prelude::Resource"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#672)

### impl<'a, T> [SystemParam](../ecs/system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam") for [Res](struct.Res.html "struct bevy::prelude::Res")<'a, T>
...
#### type [Item](../ecs/system/trait.SystemParam.html#associatedtype.Item)<'w, 's> = [Res](struct.Res.html "struct bevy::prelude::Res")<'w, T>
...
### impl<'w, T> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Res](struct.Res.html "struct bevy::prelude::Res")<'w, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

### impl<'w, T> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Res](struct.Res.html "struct bevy::prelude::Res")<'w, T>
...
### impl<'w, T> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Res](struct.Res.html "struct bevy::prelude::Res")<'w, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

### impl<'w, T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Res](struct.Res.html "struct bevy::prelude::Res")<'w, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

### impl<'w, T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Res](struct.Res.html "struct bevy::prelude::Res")<'w, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

### impl<'w, T> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Res](struct.Res.html "struct bevy::prelude::Res")<'w, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

### impl<'w, T> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Res](struct.Res.html "struct bevy::prelude::Res")<'w, T>
