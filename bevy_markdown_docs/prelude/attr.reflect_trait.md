...
For a trait named `MyTrait`, this will generate the struct `ReflectMyTrait`. The generated struct can be created using `FromType` with any type that implements the trait. The creation and registration of this generated struct as type data can be automatically handled by [`#[derive(Reflect)]`](derive.Reflect.html "derive bevy::prelude::Reflect").
