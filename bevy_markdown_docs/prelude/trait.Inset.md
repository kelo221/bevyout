...
See documentation on [`Inset::inset`](trait.Inset.html#tymethod.inset "method bevy::prelude::Inset::inset").

See also [`ToRing`](trait.ToRing.html "trait bevy::prelude::ToRing").
...
This is useful for creating smaller shapes or making outlines of `distance` thickness with [`Ring`](struct.Ring.html "struct bevy::prelude::Ring").

See also [`ToRing::to_ring`](trait.ToRing.html#tymethod.to_ring "method bevy::prelude::ToRing::to_ring")
