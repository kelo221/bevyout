...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#124)
...
An arc has no area. If you want to include the portion of a circle’s area swept out by the arc, use the pie-shaped [`CircularSector`](struct.CircularSector.html "struct bevy::prelude::CircularSector"). If you want to include only the space inside the convex hull of the arc, use the bowl-shaped [`CircularSegment`](struct.CircularSegment.html "struct bevy::prelude::CircularSegment").

The arc is drawn starting from [`Vec2::Y`](struct.Vec2.html#associatedconstant.Y "associated constant bevy::prelude::Vec2::Y"), extending by `half_angle` radians on either side. The center of the circle is the origin [`Vec2::ZERO`](struct.Vec2.html#associatedconstant.ZERO "associated constant bevy::prelude::Vec2::ZERO"). Note that this means that the origin may not be within the `Arc2d`’s convex hull.
...
`half_angle: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Half the angle defining the arc

## Implementations

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#143)

### impl [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#146)

#### pub const fn [new](#method.new)(radius: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), half\_angle: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")

Create a new [`Arc2d`](struct.Arc2d.html "struct bevy::prelude::Arc2d") from a `radius` and a `half_angle`

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#152)

#### pub const fn [from\_radians](#method.from_radians)(radius: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), angle: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")

Create a new [`Arc2d`](struct.Arc2d.html "struct bevy::prelude::Arc2d") from a `radius` and an `angle` in radians

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#161)

#### pub const fn [from\_degrees](#method.from_degrees)(radius: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), angle: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")

Create a new [`Arc2d`](struct.Arc2d.html "struct bevy::prelude::Arc2d") from a `radius` and an `angle` in degrees.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#172)

#### pub const fn [from\_turns](#method.from_turns)(radius: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), fraction: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")

Create a new [`Arc2d`](struct.Arc2d.html "struct bevy::prelude::Arc2d") from a `radius` and a `fraction` of a single turn.

For instance, `0.5` turns is a semicircle.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#181)

#### pub const fn [angle](#method.angle)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Get the angle of the arc

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#187)

#### pub const fn [length](#method.length)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Get the length of the arc

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#193)

#### pub fn [right\_endpoint](#method.right_endpoint)(&self) -> [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")

Get the right-hand end point of the arc

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#199)

#### pub fn [left\_endpoint](#method.left_endpoint)(&self) -> [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")

Get the left-hand end point of the arc

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#205)

#### pub fn [endpoints](#method.endpoints)(&self) -> \[[Vec2](struct.Vec2.html "struct bevy::prelude::Vec2"); [2](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]

Get the endpoints of the arc

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#211)

#### pub fn [midpoint](#method.midpoint)(&self) -> [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")

Get the midpoint of the arc

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#217)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#223)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#229)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#242)

#### pub fn [apothem](#method.apothem)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Get the length of the apothem of this arc, that is, the distance from the center of the circle to the midpoint of the chord, in the direction of the midpoint of the arc. Equivalently, the [`radius`](struct.Arc2d.html#structfield.radius "field bevy::prelude::Arc2d::radius") minus the [`sagitta`](struct.Arc2d.html#method.sagitta "method bevy::prelude::Arc2d::sagitta").

Note that for a [`major`](struct.Arc2d.html#method.is_major "method bevy::prelude::Arc2d::is_major") arc, the apothem will be negative.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#252)
...
The sagitta is also the sum of the [`radius`](struct.Arc2d.html#structfield.radius "field bevy::prelude::Arc2d::radius") and the [`apothem`](struct.Arc2d.html#method.apothem "method bevy::prelude::Arc2d::apothem").

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#260)

#### pub const fn [is\_minor](#method.is_minor)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Produces true if the arc is at most half a circle.

**Note:** This is not the negation of [`is_major`](struct.Arc2d.html#method.is_major "method bevy::prelude::Arc2d::is_major"): an exact semicircle is both major and minor.

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#268)

#### pub const fn [is\_major](#method.is_major)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Produces true if the arc is at least half a circle.

**Note:** This is not the negation of [`is_minor`](struct.Arc2d.html#method.is_minor "method bevy::prelude::Arc2d::is_minor"): an exact semicircle is both major and minor.
...
### impl [Bounded2d](../math/bounding/trait.Bounded2d.html "trait bevy::math::bounding::Bounded2d") for [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/bounding/bounded2d/primitive_impls.rs.html#68)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/bounding/bounded2d/primitive_impls.rs.html#82)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#112)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#112)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#112)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#133)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#135)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")

Returns the default [`Arc2d`](struct.Arc2d.html "struct bevy::prelude::Arc2d") with radius `0.5`, covering one third of a circle

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#114)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#114)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#117)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#117)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")
...
### impl<Config, Clear> [GizmoPrimitive2d](trait.GizmoPrimitive2d.html "trait bevy::prelude::GizmoPrimitive2d")<[Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")\> for [GizmoBuffer](../gizmos/gizmos/struct.GizmoBuffer.html "struct bevy::gizmos::gizmos::GizmoBuffer")<Config, Clear>
...
where [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#112)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#117)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#118)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/primitives/dim2.rs.html#131)

### impl [Primitive2d](trait.Primitive2d.html "trait bevy::prelude::Primitive2d") for [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Arc2d](struct.Arc2d.html "struct bevy::prelude::Arc2d")
