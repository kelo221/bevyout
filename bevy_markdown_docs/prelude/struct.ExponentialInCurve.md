...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ExponentialInCurve](struct.ExponentialInCurve.html "struct bevy::prelude::ExponentialInCurve")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#885)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ExponentialInCurve](struct.ExponentialInCurve.html "struct bevy::prelude::ExponentialInCurve")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [ExponentialInCurve](struct.ExponentialInCurve.html "struct bevy::prelude::ExponentialInCurve")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ExponentialInCurve](struct.ExponentialInCurve.html "struct bevy::prelude::ExponentialInCurve")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ExponentialInCurve](struct.ExponentialInCurve.html "struct bevy::prelude::ExponentialInCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ExponentialInCurve](struct.ExponentialInCurve.html "struct bevy::prelude::ExponentialInCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ExponentialInCurve](struct.ExponentialInCurve.html "struct bevy::prelude::ExponentialInCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ExponentialInCurve](struct.ExponentialInCurve.html "struct bevy::prelude::ExponentialInCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ExponentialInCurve](struct.ExponentialInCurve.html "struct bevy::prelude::ExponentialInCurve")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ExponentialInCurve](struct.ExponentialInCurve.html "struct bevy::prelude::ExponentialInCurve")
