...
[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/morph.rs.html#21)
...
[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/morph.rs.html#71)

#### fn [clone\_value](trait.AnimationCurve.html#tymethod.clone_value)(&self) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [AnimationCurve](trait.AnimationCurve.html "trait bevy::prelude::AnimationCurve")\>

Returns a boxed clone of this value.

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/morph.rs.html#75)

#### fn [domain](trait.AnimationCurve.html#tymethod.domain)(&self) -> [Interval](struct.Interval.html "struct bevy::prelude::Interval")

The range of times for which this animation is defined.

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/morph.rs.html#79)

#### fn [evaluator\_id](trait.AnimationCurve.html#tymethod.evaluator_id)(&self) -> [EvaluatorId](enum.EvaluatorId.html "enum bevy::prelude::EvaluatorId")<'\_>

Returns the type ID of the [`AnimationCurveEvaluator`](trait.AnimationCurveEvaluator.html "trait bevy::prelude::AnimationCurveEvaluator"). [Read more](trait.AnimationCurve.html#tymethod.evaluator_id)

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/morph.rs.html#83)

#### fn [create\_evaluator](trait.AnimationCurve.html#tymethod.create_evaluator)(&self) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [AnimationCurveEvaluator](trait.AnimationCurveEvaluator.html "trait bevy::prelude::AnimationCurveEvaluator")\>

Returns a newly-instantiated [`AnimationCurveEvaluator`](trait.AnimationCurveEvaluator.html "trait bevy::prelude::AnimationCurveEvaluator") for use with this curve. [Read more](trait.AnimationCurve.html#tymethod.create_evaluator)

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/morph.rs.html#93-99)

#### fn [apply](trait.AnimationCurve.html#tymethod.apply)( &self, curve\_evaluator: &mut (dyn [AnimationCurveEvaluator](trait.AnimationCurveEvaluator.html "trait bevy::prelude::AnimationCurveEvaluator") + 'static), t: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), weight: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), graph\_node: [NodeIndex](https://docs.rs/petgraph/0.8.3/x86_64-unknown-linux-gnu/petgraph/graph_impl/struct.NodeIndex.html "struct petgraph::graph_impl::NodeIndex"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [AnimationEvaluationError](../animation/enum.AnimationEvaluationError.html "enum bevy::animation::AnimationEvaluationError")\>

Samples the curve at the given time `t`, and pushes the sampled value onto the evaluation stack of the `curve_evaluator`. [Read more](trait.AnimationCurve.html#tymethod.apply)

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/morph.rs.html#119)

#### fn [sample\_clamped](trait.AnimationCurve.html#tymethod.sample_clamped)(&self, t: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
### impl<C> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C>

where C: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/morph.rs.html#19)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C>
...
### impl<C> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C>
...
### impl<C> [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C>
...
#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C>

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/morph.rs.html#19)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C> as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C>>
...
### impl<C> [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C>
...
### impl<C> [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C>
...
### impl<C> [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C>
...
where [WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C>: 'into\_return,
...
### impl<C> [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C>
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C>>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/morph.rs.html#19)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<C> [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C>
...
### impl<C> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C>

where C: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"),

### impl<C> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C>
...
### impl<C> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C>

where C: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<C> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C>

where C: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<C> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C>

where C: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<C> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C>

where C: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"),

### impl<C> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [WeightsCurve](struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve")<C>
