...
To make an [`Event`](trait.Event.html "trait bevy::prelude::Event") “happen”, you “trigger” it on a [`World`](struct.World.html "struct bevy::prelude::World") using [`World::trigger`](struct.World.html#method.trigger "method bevy::prelude::World::trigger") or via a [`Command`](trait.Command.html "trait bevy::prelude::Command") using [`Commands::trigger`](struct.Commands.html#method.trigger "method bevy::prelude::Commands::trigger"). This causes any [`Observer`](struct.Observer.html "struct bevy::prelude::Observer") watching for that [`Event`](trait.Event.html "trait bevy::prelude::Event") to run _immediately_, as part of the [`World::trigger`](struct.World.html#method.trigger "method bevy::prelude::World::trigger") call.

First, we create an [`Event`](trait.Event.html "trait bevy::prelude::Event") type, typically by deriving the trait.
...
Then, we add an [`Observer`](struct.Observer.html "struct bevy::prelude::Observer") to watch for this event type:
...
Finally, we trigger the event by calling [`World::trigger`](struct.World.html#method.trigger "method bevy::prelude::World::trigger"):
...
Every [`Event`](trait.Event.html "trait bevy::prelude::Event") has an associated [`Trigger`](../ecs/event/trait.Trigger.html "trait bevy::ecs::event::Trigger") implementation (set via [`Event::Trigger`](trait.Event.html#associatedtype.Trigger "associated type bevy::prelude::Event::Trigger")), which defines which observers will run, what data will be passed to them, and the order they will be run in. Unless you are an internals developer or you have very specific needs, you don’t need to worry too much about [`Trigger`](../ecs/event/trait.Trigger.html "trait bevy::ecs::event::Trigger"). When you derive [`Event`](trait.Event.html "trait bevy::prelude::Event") (or a more specific event trait like [`EntityEvent`](trait.EntityEvent.html "trait bevy::prelude::EntityEvent")), a [`Trigger`](../ecs/event/trait.Trigger.html "trait bevy::ecs::event::Trigger") will be provided for you.

The [`Event`](trait.Event.html "trait bevy::prelude::Event") derive defaults [`Event::Trigger`](trait.Event.html#associatedtype.Trigger "associated type bevy::prelude::Event::Trigger") to [`GlobalTrigger`](../ecs/event/struct.GlobalTrigger.html "struct bevy::ecs::event::GlobalTrigger"), which will run all observers that watch for the [`Event`](trait.Event.html "trait bevy::prelude::Event").

## Entity Events

For events that “target” a specific [`Entity`](struct.Entity.html "struct bevy::prelude::Entity"), see [`EntityEvent`](trait.EntityEvent.html "trait bevy::prelude::EntityEvent").

## Required Associated Types

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/event/mod.rs.html#90)

#### type [Trigger](#associatedtype.Trigger)<'a>: [Trigger](../ecs/event/trait.Trigger.html "trait bevy::ecs::event::Trigger")<Self>
...
### impl [Event](trait.Event.html "trait bevy::prelude::Event") for [AcquireFocus](../input_focus/struct.AcquireFocus.html "struct bevy::input_focus::AcquireFocus")
...
#### type [Trigger](#associatedtype.Trigger)<'a> = [PropagateEntityTrigger](../ecs/event/struct.PropagateEntityTrigger.html "struct bevy::ecs::event::PropagateEntityTrigger")<true, [AcquireFocus](../input_focus/struct.AcquireFocus.html "struct bevy::input_focus::AcquireFocus"), [WindowTraversal](../input_focus/struct.WindowTraversal.html "struct bevy::input_focus::WindowTraversal")\>

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/lib.rs.html#80)

### impl [Event](trait.Event.html "trait bevy::prelude::Event") for [Activate](../ui_widgets/struct.Activate.html "struct bevy::ui_widgets::Activate")
...
#### type [Trigger](#associatedtype.Trigger)<'a> = [EntityTrigger](../ecs/event/struct.EntityTrigger.html "struct bevy::ecs::event::EntityTrigger")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/lifecycle.rs.html#331)

### impl [Event](trait.Event.html "trait bevy::prelude::Event") for [Add](struct.Add.html "struct bevy::prelude::Add")
...
#### type [Trigger](#associatedtype.Trigger)<'a> = [EntityComponentsTrigger](../ecs/event/struct.EntityComponentsTrigger.html "struct bevy::ecs::event::EntityComponentsTrigger")<'a>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/tick.rs.html#113)

### impl [Event](trait.Event.html "trait bevy::prelude::Event") for [CheckChangeTicks](../ecs/change_detection/struct.CheckChangeTicks.html "struct bevy::ecs::change_detection::CheckChangeTicks")

where [CheckChangeTicks](../ecs/change_detection/struct.CheckChangeTicks.html "struct bevy::ecs::change_detection::CheckChangeTicks"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/tick.rs.html#113)

#### type [Trigger](#associatedtype.Trigger)<'a> = [GlobalTrigger](../ecs/event/struct.GlobalTrigger.html "struct bevy::ecs::event::GlobalTrigger")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/lifecycle.rs.html#386)

### impl [Event](trait.Event.html "trait bevy::prelude::Event") for [Despawn](struct.Despawn.html "struct bevy::prelude::Despawn")
...
### impl [Event](trait.Event.html "trait bevy::prelude::Event") for [Discard](struct.Discard.html "struct bevy::prelude::Discard")
...
### impl [Event](trait.Event.html "trait bevy::prelude::Event") for [FocusGained](../input_focus/struct.FocusGained.html "struct bevy::input_focus::FocusGained")
...
#### type [Trigger](#associatedtype.Trigger)<'a> = [PropagateEntityTrigger](../ecs/event/struct.PropagateEntityTrigger.html "struct bevy::ecs::event::PropagateEntityTrigger")<true, [FocusGained](../input_focus/struct.FocusGained.html "struct bevy::input_focus::FocusGained"), &'static [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")\>

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/gained_and_lost.rs.html#46)

### impl [Event](trait.Event.html "trait bevy::prelude::Event") for [FocusLost](../input_focus/struct.FocusLost.html "struct bevy::input_focus::FocusLost")
...
#### type [Trigger](#associatedtype.Trigger)<'a> = [PropagateEntityTrigger](../ecs/event/struct.PropagateEntityTrigger.html "struct bevy::ecs::event::PropagateEntityTrigger")<true, [FocusLost](../input_focus/struct.FocusLost.html "struct bevy::input_focus::FocusLost"), &'static [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")\>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/lifecycle.rs.html#344)

### impl [Event](trait.Event.html "trait bevy::prelude::Event") for [Insert](struct.Insert.html "struct bevy::prelude::Insert")
...
### impl [Event](trait.Event.html "trait bevy::prelude::Event") for [MenuEvent](../ui_widgets/struct.MenuEvent.html "struct bevy::ui_widgets::MenuEvent")
...
#### type [Trigger](#associatedtype.Trigger)<'a> = [PropagateEntityTrigger](../ecs/event/struct.PropagateEntityTrigger.html "struct bevy::ecs::event::PropagateEntityTrigger")<true, [MenuEvent](../ui_widgets/struct.MenuEvent.html "struct bevy::ui_widgets::MenuEvent"), &'static [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")\>

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/gpu_readback.rs.html#114)

### impl [Event](trait.Event.html "trait bevy::prelude::Event") for [ReadbackComplete](../render/gpu_readback/struct.ReadbackComplete.html "struct bevy::render::gpu_readback::ReadbackComplete")
...
### impl [Event](trait.Event.html "trait bevy::prelude::Event") for [Remove](struct.Remove.html "struct bevy::prelude::Remove")
...
### impl [Event](trait.Event.html "trait bevy::prelude::Event") for [ScheduleBuilt](../ecs/schedule/struct.ScheduleBuilt.html "struct bevy::ecs::schedule::ScheduleBuilt")

where [ScheduleBuilt](../ecs/schedule/struct.ScheduleBuilt.html "struct bevy::ecs::schedule::ScheduleBuilt"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Event](trait.Event.html "trait bevy::prelude::Event") for [ScreenshotCaptured](../render/view/window/screenshot/struct.ScreenshotCaptured.html "struct bevy::render::view::window::screenshot::ScreenshotCaptured")
...
### impl [Event](trait.Event.html "trait bevy::prelude::Event") for [ScrollIntoView](../ui_widgets/struct.ScrollIntoView.html "struct bevy::ui_widgets::ScrollIntoView")
...
#### type [Trigger](#associatedtype.Trigger)<'a> = [PropagateEntityTrigger](../ecs/event/struct.PropagateEntityTrigger.html "struct bevy::ecs::event::PropagateEntityTrigger")<false, [ScrollIntoView](../ui_widgets/struct.ScrollIntoView.html "struct bevy::ui_widgets::ScrollIntoView"), &'static [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")\>

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/checkbox.rs.html#181)

### impl [Event](trait.Event.html "trait bevy::prelude::Event") for [SetChecked](../ui_widgets/struct.SetChecked.html "struct bevy::ui_widgets::SetChecked")
...
### impl [Event](trait.Event.html "trait bevy::prelude::Event") for [SetSliderValue](../ui_widgets/struct.SetSliderValue.html "struct bevy::ui_widgets::SetSliderValue")
...
### impl [Event](trait.Event.html "trait bevy::prelude::Event") for [TextEditChange](../text/struct.TextEditChange.html "struct bevy::text::TextEditChange")
...
### impl [Event](trait.Event.html "trait bevy::prelude::Event") for [ToggleChecked](../ui_widgets/struct.ToggleChecked.html "struct bevy::ui_widgets::ToggleChecked")
...
### impl [Event](trait.Event.html "trait bevy::prelude::Event") for [UpdateNumberInput](../feathers/controls/struct.UpdateNumberInput.html "struct bevy::feathers::controls::UpdateNumberInput")
...
### impl [Event](trait.Event.html "trait bevy::prelude::Event") for [WorldInstanceReady](../world_serialization/struct.WorldInstanceReady.html "struct bevy::world_serialization::WorldInstanceReady")
...
#### type [Trigger](#associatedtype.Trigger)<'a> = [PropagateEntityTrigger](../ecs/event/struct.PropagateEntityTrigger.html "struct bevy::ecs::event::PropagateEntityTrigger")<true, [Pointer](struct.Pointer.html "struct bevy::prelude::Pointer")<E>, [PointerTraversal](struct.PointerTraversal.html "struct bevy::prelude::PointerTraversal")\>

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/lib.rs.html#185)

### impl<M> [Event](trait.Event.html "trait bevy::prelude::Event") for [FocusedInput](../input_focus/struct.FocusedInput.html "struct bevy::input_focus::FocusedInput")<M>
...
#### type [Trigger](#associatedtype.Trigger)<'a> = [PropagateEntityTrigger](../ecs/event/struct.PropagateEntityTrigger.html "struct bevy::ecs::event::PropagateEntityTrigger")<true, [FocusedInput](../input_focus/struct.FocusedInput.html "struct bevy::input_focus::FocusedInput")<M>, [WindowTraversal](../input_focus/struct.WindowTraversal.html "struct bevy::input_focus::WindowTraversal")\>

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/lib.rs.html#88)

### impl<T> [Event](trait.Event.html "trait bevy::prelude::Event") for [ValueChange](../ui_widgets/struct.ValueChange.html "struct bevy::ui_widgets::ValueChange")<T>
...
### impl<T> [Event](trait.Event.html "trait bevy::prelude::Event") for [VirtualKeyPressed](../feathers/controls/struct.VirtualKeyPressed.html "struct bevy::feathers::controls::VirtualKeyPressed")<T>
