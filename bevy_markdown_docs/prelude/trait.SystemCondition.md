...
Implemented for functions and closures that convert into [`System<Out=bool>`](trait.System.html "trait bevy::prelude::System") with [read-only](../ecs/system/trait.ReadOnlySystemParam.html "trait bevy::ecs::system::ReadOnlySystemParam") parameters.
...
Type parameter in return type can be set to `<()>` by calling [`IntoSystem::into_system`](trait.IntoSystem.html#tymethod.into_system "associated function bevy::prelude::IntoSystem::into_system"), but usually have to be specified when passing a condition to a function.
...
#### fn [and\_then](#method.and_then)<M, C>( self, then\_run: C, ) -> [CombinatorSystem](../ecs/system/struct.CombinatorSystem.html "struct bevy::ecs::system::CombinatorSystem")<AndThenMarker, Self::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System"), <C as [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<In, [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), M>>::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System")\>

where C: [SystemCondition](trait.SystemCondition.html "trait bevy::prelude::SystemCondition")<M, In>,
...
Short-circuiting may not be desired in all cases; when utilizing change detection, the `then_run` condition will react to changes since the last time that _`self` returned `true`_, which may introduce subtle inconsistencies if short-circuiting was not intended. Similar issues may arise for run conditions that rely on internal state, such as those using [`Local<T>`](struct.Local.html "struct bevy::prelude::Local") parameters or [`MessageReader<T>`](struct.MessageReader.html "struct bevy::prelude::MessageReader"), as they may not be updated every time the combined condition is evaluated.

See also [`and_eager`](trait.SystemCondition.html#method.and_eager "method bevy::prelude::SystemCondition::and_eager"), which always evaluates both conditions.
...
Note that in this specific case, it’s better to just use the run condition [`resource_exists_and_equals`](fn.resource_exists_and_equals.html "fn bevy::prelude::resource_exists_and_equals").
...
#### fn [and\_eager](#method.and_eager)<M, C>( self, other: C, ) -> [CombinatorSystem](../ecs/system/struct.CombinatorSystem.html "struct bevy::ecs::system::CombinatorSystem")<AndEagerMarker, Self::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System"), <C as [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<In, [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), M>>::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System")\>
...
See also [`nand_eager`](trait.SystemCondition.html#method.nand_eager "method bevy::prelude::SystemCondition::nand_eager"), which always evaluates both conditions.
...
#### fn [nand\_eager](#method.nand_eager)<M, C>( self, other: C, ) -> [CombinatorSystem](../ecs/system/struct.CombinatorSystem.html "struct bevy::ecs::system::CombinatorSystem")<NandEagerMarker, Self::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System"), <C as [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<In, [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), M>>::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System")\>
...
See also [`nand_then`](trait.SystemCondition.html#method.nand_then "method bevy::prelude::SystemCondition::nand_then"), which short-circuits if `self` returns `false`.
...
See also [`nor_eager`](trait.SystemCondition.html#method.nor_eager "method bevy::prelude::SystemCondition::nor_eager"), which always evaluates both conditions.
...
See also [`nor_else`](trait.SystemCondition.html#method.nor_else "method bevy::prelude::SystemCondition::nor_else"), which short-circuits if `self` returns `true`.
...
#### fn [or\_else](#method.or_else)<M, C>( self, else\_run: C, ) -> [CombinatorSystem](../ecs/system/struct.CombinatorSystem.html "struct bevy::ecs::system::CombinatorSystem")<OrElseMarker, Self::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System"), <C as [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<In, [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), M>>::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System")\>
...
See also [`or_eager`](trait.SystemCondition.html#method.or_eager "method bevy::prelude::SystemCondition::or_eager"), which always evaluates both conditions.
...
#### fn [or\_eager](#method.or_eager)<M, C>( self, other: C, ) -> [CombinatorSystem](../ecs/system/struct.CombinatorSystem.html "struct bevy::ecs::system::CombinatorSystem")<OrEagerMarker, Self::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System"), <C as [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<In, [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), M>>::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System")\>
...
See also [`or_else`](trait.SystemCondition.html#method.or_else "method bevy::prelude::SystemCondition::or_else"), which short-circuits if `self` returns `true`.
...
#### fn [xnor](#method.xnor)<M, C>( self, other: C, ) -> [CombinatorSystem](../ecs/system/struct.CombinatorSystem.html "struct bevy::ecs::system::CombinatorSystem")<XnorMarker, Self::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System"), <C as [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<In, [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), M>>::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System")\>
...
#### fn [xor](#method.xor)<M, C>( self, other: C, ) -> [CombinatorSystem](../ecs/system/struct.CombinatorSystem.html "struct bevy::ecs::system::CombinatorSystem")<XorMarker, Self::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System"), <C as [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<In, [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), M>>::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System")\>
...
### impl<Marker, In, F> [SystemCondition](trait.SystemCondition.html "trait bevy::prelude::SystemCondition")<Marker, In> for F

where In: [SystemInput](trait.SystemInput.html "trait bevy::prelude::SystemInput"), F: [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<In, [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), Marker>, <F as [IntoSystem](trait.IntoSystem.html "trait bevy::prelude::IntoSystem")<In, [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), Marker>>::[System](trait.IntoSystem.html#associatedtype.System "type bevy::prelude::IntoSystem::System"): [ReadOnlySystem](trait.ReadOnlySystem.html "trait bevy::prelude::ReadOnlySystem"),