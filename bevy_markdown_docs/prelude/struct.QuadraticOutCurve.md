...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [QuadraticOutCurve](struct.QuadraticOutCurve.html "struct bevy::prelude::QuadraticOutCurve")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#696)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [QuadraticOutCurve](struct.QuadraticOutCurve.html "struct bevy::prelude::QuadraticOutCurve")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [QuadraticOutCurve](struct.QuadraticOutCurve.html "struct bevy::prelude::QuadraticOutCurve")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [QuadraticOutCurve](struct.QuadraticOutCurve.html "struct bevy::prelude::QuadraticOutCurve")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [QuadraticOutCurve](struct.QuadraticOutCurve.html "struct bevy::prelude::QuadraticOutCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [QuadraticOutCurve](struct.QuadraticOutCurve.html "struct bevy::prelude::QuadraticOutCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [QuadraticOutCurve](struct.QuadraticOutCurve.html "struct bevy::prelude::QuadraticOutCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [QuadraticOutCurve](struct.QuadraticOutCurve.html "struct bevy::prelude::QuadraticOutCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [QuadraticOutCurve](struct.QuadraticOutCurve.html "struct bevy::prelude::QuadraticOutCurve")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [QuadraticOutCurve](struct.QuadraticOutCurve.html "struct bevy::prelude::QuadraticOutCurve")
