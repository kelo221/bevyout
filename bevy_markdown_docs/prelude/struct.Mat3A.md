...
Linear transformations including 3D rotation and scale can be created using methods such as [`Self::from_diagonal()`](struct.Mat3A.html#method.from_diagonal "associated function bevy::prelude::Mat3A::from_diagonal"), [`Self::from_quat()`](struct.Mat3A.html#method.from_quat "associated function bevy::prelude::Mat3A::from_quat"), [`Self::from_axis_angle()`](struct.Mat3A.html#method.from_axis_angle "associated function bevy::prelude::Mat3A::from_axis_angle"), [`Self::from_rotation_x()`](struct.Mat3A.html#method.from_rotation_x "associated function bevy::prelude::Mat3A::from_rotation_x"), [`Self::from_rotation_y()`](struct.Mat3A.html#method.from_rotation_y "associated function bevy::prelude::Mat3A::from_rotation_y"), or [`Self::from_rotation_z()`](struct.Mat3A.html#method.from_rotation_z "associated function bevy::prelude::Mat3A::from_rotation_z").

The resulting matrices can be use to transform 3D vectors using regular vector multiplication.

Affine transformations including 2D translation, rotation and scale can be created using methods such as [`Self::from_translation()`](struct.Mat3A.html#method.from_translation "associated function bevy::prelude::Mat3A::from_translation"), [`Self::from_angle()`](struct.Mat3A.html#method.from_angle "associated function bevy::prelude::Mat3A::from_angle"), [`Self::from_scale()`](struct.Mat3A.html#method.from_scale "associated function bevy::prelude::Mat3A::from_scale") and [`Self::from_scale_angle_translation()`](struct.Mat3A.html#method.from_scale_angle_translation "associated function bevy::prelude::Mat3A::from_scale_angle_translation").

The [`Self::transform_point2()`](struct.Mat3A.html#method.transform_point2 "method bevy::prelude::Mat3A::transform_point2") and [`Self::transform_vector2()`](struct.Mat3A.html#method.transform_vector2 "method bevy::prelude::Mat3A::transform_vector2") convenience methods are provided for performing affine transforms on 2D vectors and points. These multiply 2D inputs as 3D vectors with an implicit `z` value of `1` for points and `0` for vectors respectively. These methods assume that `Self` contains a valid affine transform.

## Fields

`x_axis: [Vec3A](struct.Vec3A.html "struct bevy::prelude::Vec3A")``y_axis: [Vec3A](struct.Vec3A.html "struct bevy::prelude::Vec3A")``z_axis: [Vec3A](struct.Vec3A.html "struct bevy::prelude::Vec3A")`

## Implementations

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#65)

### impl [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#67)

#### pub const [ZERO](#associatedconstant.ZERO): [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### pub const [IDENTITY](#associatedconstant.IDENTITY): [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### pub const [NAN](#associatedconstant.NAN): [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

All NAN:s.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#99)

#### pub const fn [from\_cols](#method.from_cols)(x\_axis: [Vec3A](struct.Vec3A.html "struct bevy::prelude::Vec3A"), y\_axis: [Vec3A](struct.Vec3A.html "struct bevy::prelude::Vec3A"), z\_axis: [Vec3A](struct.Vec3A.html "struct bevy::prelude::Vec3A")) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

Creates a 3x3 matrix from three column vectors.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#112)

#### pub const fn [from\_cols\_array](#method.from_cols_array)(m: &\[[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html); [9](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### pub const fn [from\_cols\_array\_2d](#method.from_cols_array_2d)(m: &\[\[[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html); [3](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]; [3](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### pub const fn [from\_diagonal](#method.from_diagonal)(diagonal: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

Creates a 3x3 matrix with its diagonal set to `diagonal` and all other entries set to 0.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#169)

#### pub fn [from\_mat4](#method.from_mat4)(m: [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4")) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

Creates a 3x3 matrix from a 4x4 matrix, discarding the 4th row and column.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#185)

#### pub fn [from\_mat4\_minor](#method.from_mat4_minor)(m: [Mat4](struct.Mat4.html "struct bevy::prelude::Mat4"), i: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), j: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### pub fn [from\_quat](#method.from_quat)(rotation: [Quat](struct.Quat.html "struct bevy::prelude::Quat")) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### pub fn [from\_axis\_angle](#method.from_axis_angle)(axis: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3"), angle: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### pub fn [from\_euler](#method.from_euler)(order: [EulerRot](enum.EulerRot.html "enum bevy::prelude::EulerRot"), a: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), b: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), c: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### pub fn [from\_rotation\_x](#method.from_rotation_x)(angle: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

Creates a 3D rotation matrix from `angle` (in radians) around the x axis.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#369)

#### pub fn [from\_rotation\_y](#method.from_rotation_y)(angle: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

Creates a 3D rotation matrix from `angle` (in radians) around the y axis.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#381)

#### pub fn [from\_rotation\_z](#method.from_rotation_z)(angle: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

Creates a 3D rotation matrix from `angle` (in radians) around the z axis.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#396)

#### pub fn [from\_translation](#method.from_translation)(translation: [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

Creates an affine transformation matrix from the given 2D `translation`.

The resulting matrix can be used to transform 2D points and vectors. See [`Self::transform_point2()`](struct.Mat3A.html#method.transform_point2 "method bevy::prelude::Mat3A::transform_point2") and [`Self::transform_vector2()`](struct.Mat3A.html#method.transform_vector2 "method bevy::prelude::Mat3A::transform_vector2").

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#411)

#### pub fn [from\_angle](#method.from_angle)(angle: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### pub fn [from\_scale\_angle\_translation](#method.from_scale_angle_translation)( scale: [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2"), angle: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), translation: [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2"), ) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### pub fn [from\_scale](#method.from_scale)(scale: [Vec2](struct.Vec2.html "struct bevy::prelude::Vec2")) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### pub fn [from\_mat2](#method.from_mat2)(m: [Mat2](struct.Mat2.html "struct bevy::prelude::Mat2")) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### pub const fn [from\_cols\_slice](#method.from_cols_slice)(slice: &\[[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\]) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### pub fn [col](#method.col)(&self, index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [Vec3A](struct.Vec3A.html "struct bevy::prelude::Vec3A")
...
#### pub fn [col\_mut](#method.col_mut)(&mut self, index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> &mut [Vec3A](struct.Vec3A.html "struct bevy::prelude::Vec3A")
...
#### pub fn [row](#method.row)(&self, index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [Vec3A](struct.Vec3A.html "struct bevy::prelude::Vec3A")
...
#### pub fn [transpose](#method.transpose)(&self) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

Returns the transpose of `self`.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#579)

#### pub fn [diagonal](#method.diagonal)(&self) -> [Vec3A](struct.Vec3A.html "struct bevy::prelude::Vec3A")
...
#### pub fn [inverse](#method.inverse)(&self) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### pub fn [try\_inverse](#method.try_inverse)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")\>
...
#### pub fn [inverse\_or\_zero](#method.inverse_or_zero)(&self) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### pub fn [look\_to\_lh](#method.look_to_lh)(dir: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3"), up: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### pub fn [look\_to\_rh](#method.look_to_rh)(dir: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3"), up: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### pub fn [look\_at\_lh](#method.look_at_lh)(eye: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3"), center: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3"), up: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### pub fn [look\_at\_rh](#method.look_at_rh)(eye: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3"), center: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3"), up: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### pub fn [mul\_transpose\_vec3a](#method.mul_transpose_vec3a)(&self, rhs: [Vec3A](struct.Vec3A.html "struct bevy::prelude::Vec3A")) -> [Vec3A](struct.Vec3A.html "struct bevy::prelude::Vec3A")

Transforms a [`Vec3A`](struct.Vec3A.html "struct bevy::prelude::Vec3A") by the transpose of `self`.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#787)

#### pub fn [mul\_mat3](#method.mul_mat3)(&self, rhs: &[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

Multiplies two 3x3 matrices.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#794)

#### pub fn [add\_mat3](#method.add_mat3)(&self, rhs: &[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

Adds two 3x3 matrices.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#801)

#### pub fn [sub\_mat3](#method.sub_mat3)(&self, rhs: &[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

Subtracts two 3x3 matrices.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#808)

#### pub fn [mul\_scalar](#method.mul_scalar)(&self, rhs: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

Multiplies a 3x3 matrix by a scalar.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#821)

#### pub fn [mul\_diagonal\_scale](#method.mul_diagonal_scale)(&self, scale: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### pub fn [div\_scalar](#method.div_scalar)(&self, rhs: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

Divides a 3x3 matrix by a scalar.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#844)

#### pub fn [recip](#method.recip)(&self) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### pub fn [abs\_diff\_eq](#method.abs_diff_eq)(&self, rhs: [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A"), max\_abs\_diff: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
#### pub fn [abs](#method.abs)(&self) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [Add](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Add.html "trait core::ops::arith::Add") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#894)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Add.html#associatedtype.Output) = [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

The resulting type after applying the `+` operator.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#896)

#### fn [add](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Add.html#tymethod.add)(self, rhs: [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [Add](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Add.html "trait core::ops::arith::Add")<&[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")\> for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [AddAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.AddAssign.html "trait core::ops::arith::AddAssign") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#931)

#### fn [add\_assign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.AddAssign.html#tymethod.add_assign)(&mut self, rhs: [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A"))
...
### impl [AddAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.AddAssign.html "trait core::ops::arith::AddAssign")<&[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")\> for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#52)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#1337)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#888)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

Deserialize expects a sequence of 9 values.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/features/impl_serde.rs.html#1060)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<D>( deserializer: D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A"), <D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [Div](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Div.html "trait core::ops::arith::Div")<&[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")\> for [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#1182)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Div.html#associatedtype.Output) = [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

The resulting type after applying the `/` operator.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#1184)

#### fn [div](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Div.html#tymethod.div)(self, rhs: &[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [Div](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Div.html "trait core::ops::arith::Div")<&[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\> for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### fn [div](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Div.html#tymethod.div)(self, rhs: &[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### fn [div](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Div.html#tymethod.div)(self, rhs: [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")) -> <[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html) as [Div](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Div.html "trait core::ops::arith::Div")<[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")\>>::[Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Div.html#associatedtype.Output "type core::ops::arith::Div::Output")
...
### impl [DivAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.DivAssign.html "trait core::ops::arith::DivAssign")<&[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\> for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Affine2](../math/struct.Affine2.html "struct bevy::math::Affine2")\> for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/affine2.rs.html#628)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(m: [Affine2](../math/struct.Affine2.html "struct bevy::math::Affine2")) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/impls/glam.rs.html#360-368)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/impls/glam.rs.html#360-368)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
where [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A"): 'into\_return,
...
### impl [Mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html "trait core::ops::arith::Mul") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#1010)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html#associatedtype.Output) = [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

The resulting type after applying the `*` operator.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#1012)

#### fn [mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html#tymethod.mul)(self, rhs: [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [Mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html "trait core::ops::arith::Mul")<&[Affine2](../math/struct.Affine2.html "struct bevy::math::Affine2")\> for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### fn [mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html#tymethod.mul)(self, rhs: &[Affine2](../math/struct.Affine2.html "struct bevy::math::Affine2")) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [Mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html "trait core::ops::arith::Mul")<&[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")\> for [Affine2](../math/struct.Affine2.html "struct bevy::math::Affine2")
...
### impl [Mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html "trait core::ops::arith::Mul")<&[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")\> for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [Mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html "trait core::ops::arith::Mul")<&[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")\> for [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)
...
### impl [Mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html "trait core::ops::arith::Mul")<&[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\> for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### fn [mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html#tymethod.mul)(self, rhs: &[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### fn [mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html#tymethod.mul)(self, rhs: [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")) -> <[Affine2](../math/struct.Affine2.html "struct bevy::math::Affine2") as [Mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html "trait core::ops::arith::Mul")<[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")\>>::[Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html#associatedtype.Output "type core::ops::arith::Mul::Output")
...
#### fn [mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html#tymethod.mul)(self, rhs: [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")) -> <[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html) as [Mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html "trait core::ops::arith::Mul")<[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")\>>::[Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html#associatedtype.Output "type core::ops::arith::Mul::Output")
...
### impl [MulAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.MulAssign.html "trait core::ops::arith::MulAssign") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#1047)

#### fn [mul\_assign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.MulAssign.html#tymethod.mul_assign)(&mut self, rhs: [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A"))
...
### impl [MulAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.MulAssign.html "trait core::ops::arith::MulAssign")<&[Affine2](../math/struct.Affine2.html "struct bevy::math::Affine2")\> for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [MulAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.MulAssign.html "trait core::ops::arith::MulAssign")<&[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")\> for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [MulAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.MulAssign.html "trait core::ops::arith::MulAssign")<&[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\> for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [Neg](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Neg.html "trait core::ops::arith::Neg") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#994)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Neg.html#associatedtype.Output) = [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

The resulting type after applying the `-` operator.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#996)

#### fn [neg](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Neg.html#tymethod.neg)(self) -> <[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A") as [Neg](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Neg.html "trait core::ops::arith::Neg")\>::[Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Neg.html#associatedtype.Output "type core::ops::arith::Neg::Output")
...
#### fn [neg](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Neg.html#tymethod.neg)(self) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

Performs the unary `-` operation. [Read more](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Neg.html#tymethod.neg)

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#1330)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#1332)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, rhs: &[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/impls/glam.rs.html#360-368)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
### impl [Pod](https://docs.rs/bytemuck/1.25.0/x86_64-unknown-linux-gnu/bytemuck/pod/trait.Pod.html "trait bytemuck::pod::Pod") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#1312)

### impl [Product](https://doc.rust-lang.org/nightly/core/iter/traits/accum/trait.Product.html "trait core::iter::traits::accum::Product") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#1313-1315)

#### fn [product](https://doc.rust-lang.org/nightly/core/iter/traits/accum/trait.Product.html#tymethod.product)<I>(iter: I) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

where I: [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")\>,

Takes an iterator and generates `Self` from the elements by multiplying the items.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#1321)

### impl<'a> [Product](https://doc.rust-lang.org/nightly/core/iter/traits/accum/trait.Product.html "trait core::iter::traits::accum::Product")<&'a [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")\> for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#1322-1324)

#### fn [product](https://doc.rust-lang.org/nightly/core/iter/traits/accum/trait.Product.html#tymethod.product)<I>(iter: I) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

where I: [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = &'a [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")\>,
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [Sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html "trait core::ops::arith::Sub") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#944)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#associatedtype.Output) = [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

The resulting type after applying the `-` operator.

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#946)

#### fn [sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#tymethod.sub)(self, rhs: [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [Sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html "trait core::ops::arith::Sub")<&[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")\> for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [SubAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html "trait core::ops::arith::SubAssign") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#981)

#### fn [sub\_assign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html#tymethod.sub_assign)(&mut self, rhs: [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A"))
...
### impl [SubAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html "trait core::ops::arith::SubAssign")<&[Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")\> for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [Sum](https://doc.rust-lang.org/nightly/core/iter/traits/accum/trait.Sum.html "trait core::iter::traits::accum::Sum") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

[Source](https://docs.rs/glam/0.32.1/x86_64-unknown-linux-gnu/src/glam/f32/sse2/mat3a.rs.html#1295-1297)

#### fn [sum](https://doc.rust-lang.org/nightly/core/iter/traits/accum/trait.Sum.html#tymethod.sum)<I>(iter: I) -> [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl<'a> [Sum](https://doc.rust-lang.org/nightly/core/iter/traits/accum/trait.Sum.html "trait core::iter::traits::accum::Sum")<&'a [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")\> for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [Zeroable](https://docs.rs/bytemuck/1.25.0/x86_64-unknown-linux-gnu/bytemuck/zeroable/trait.Zeroable.html "trait bytemuck::zeroable::Zeroable") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Mat3A](struct.Mat3A.html "struct bevy::prelude::Mat3A")
