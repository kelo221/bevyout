...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [SmootherStepCurve](../struct.SmootherStepCurve.html "struct bevy::prelude::SmootherStepCurve")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#840)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [SmootherStepCurve](../struct.SmootherStepCurve.html "struct bevy::prelude::SmootherStepCurve")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [SmootherStepCurve](../struct.SmootherStepCurve.html "struct bevy::prelude::SmootherStepCurve")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SmootherStepCurve](../struct.SmootherStepCurve.html "struct bevy::prelude::SmootherStepCurve")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SmootherStepCurve](../struct.SmootherStepCurve.html "struct bevy::prelude::SmootherStepCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SmootherStepCurve](../struct.SmootherStepCurve.html "struct bevy::prelude::SmootherStepCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SmootherStepCurve](../struct.SmootherStepCurve.html "struct bevy::prelude::SmootherStepCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SmootherStepCurve](../struct.SmootherStepCurve.html "struct bevy::prelude::SmootherStepCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SmootherStepCurve](../struct.SmootherStepCurve.html "struct bevy::prelude::SmootherStepCurve")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SmootherStepCurve](../struct.SmootherStepCurve.html "struct bevy::prelude::SmootherStepCurve")
