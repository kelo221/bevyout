...
This has f″(1) = 0, unlike [`CubicInCurve`](../struct.CubicInCurve.html "struct bevy::prelude::CubicInCurve") which starts similarly.
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [SmootherStepInCurve](../struct.SmootherStepInCurve.html "struct bevy::prelude::SmootherStepInCurve")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#818)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [SmootherStepInCurve](../struct.SmootherStepInCurve.html "struct bevy::prelude::SmootherStepInCurve")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [SmootherStepInCurve](../struct.SmootherStepInCurve.html "struct bevy::prelude::SmootherStepInCurve")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SmootherStepInCurve](../struct.SmootherStepInCurve.html "struct bevy::prelude::SmootherStepInCurve")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SmootherStepInCurve](../struct.SmootherStepInCurve.html "struct bevy::prelude::SmootherStepInCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SmootherStepInCurve](../struct.SmootherStepInCurve.html "struct bevy::prelude::SmootherStepInCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SmootherStepInCurve](../struct.SmootherStepInCurve.html "struct bevy::prelude::SmootherStepInCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SmootherStepInCurve](../struct.SmootherStepInCurve.html "struct bevy::prelude::SmootherStepInCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SmootherStepInCurve](../struct.SmootherStepInCurve.html "struct bevy::prelude::SmootherStepInCurve")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SmootherStepInCurve](../struct.SmootherStepInCurve.html "struct bevy::prelude::SmootherStepInCurve")
