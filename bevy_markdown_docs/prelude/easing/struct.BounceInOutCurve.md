...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [BounceInOutCurve](../struct.BounceInOutCurve.html "struct bevy::prelude::BounceInOutCurve")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#954)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [BounceInOutCurve](../struct.BounceInOutCurve.html "struct bevy::prelude::BounceInOutCurve")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [BounceInOutCurve](../struct.BounceInOutCurve.html "struct bevy::prelude::BounceInOutCurve")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [BounceInOutCurve](../struct.BounceInOutCurve.html "struct bevy::prelude::BounceInOutCurve")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [BounceInOutCurve](../struct.BounceInOutCurve.html "struct bevy::prelude::BounceInOutCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [BounceInOutCurve](../struct.BounceInOutCurve.html "struct bevy::prelude::BounceInOutCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [BounceInOutCurve](../struct.BounceInOutCurve.html "struct bevy::prelude::BounceInOutCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [BounceInOutCurve](../struct.BounceInOutCurve.html "struct bevy::prelude::BounceInOutCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [BounceInOutCurve](../struct.BounceInOutCurve.html "struct bevy::prelude::BounceInOutCurve")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [BounceInOutCurve](../struct.BounceInOutCurve.html "struct bevy::prelude::BounceInOutCurve")
