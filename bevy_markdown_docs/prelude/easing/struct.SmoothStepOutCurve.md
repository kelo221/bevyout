...
This has f″(0) = 0, unlike [`QuadraticOutCurve`](../struct.QuadraticOutCurve.html "struct bevy::prelude::QuadraticOutCurve") which ends similarly.
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [SmoothStepOutCurve](../struct.SmoothStepOutCurve.html "struct bevy::prelude::SmoothStepOutCurve")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#794)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [SmoothStepOutCurve](../struct.SmoothStepOutCurve.html "struct bevy::prelude::SmoothStepOutCurve")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [SmoothStepOutCurve](../struct.SmoothStepOutCurve.html "struct bevy::prelude::SmoothStepOutCurve")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SmoothStepOutCurve](../struct.SmoothStepOutCurve.html "struct bevy::prelude::SmoothStepOutCurve")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SmoothStepOutCurve](../struct.SmoothStepOutCurve.html "struct bevy::prelude::SmoothStepOutCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SmoothStepOutCurve](../struct.SmoothStepOutCurve.html "struct bevy::prelude::SmoothStepOutCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SmoothStepOutCurve](../struct.SmoothStepOutCurve.html "struct bevy::prelude::SmoothStepOutCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SmoothStepOutCurve](../struct.SmoothStepOutCurve.html "struct bevy::prelude::SmoothStepOutCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SmoothStepOutCurve](../struct.SmoothStepOutCurve.html "struct bevy::prelude::SmoothStepOutCurve")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SmoothStepOutCurve](../struct.SmoothStepOutCurve.html "struct bevy::prelude::SmoothStepOutCurve")
