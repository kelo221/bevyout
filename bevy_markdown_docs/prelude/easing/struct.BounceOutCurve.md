...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [BounceOutCurve](../struct.BounceOutCurve.html "struct bevy::prelude::BounceOutCurve")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#948)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [BounceOutCurve](../struct.BounceOutCurve.html "struct bevy::prelude::BounceOutCurve")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [BounceOutCurve](../struct.BounceOutCurve.html "struct bevy::prelude::BounceOutCurve")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [BounceOutCurve](../struct.BounceOutCurve.html "struct bevy::prelude::BounceOutCurve")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [BounceOutCurve](../struct.BounceOutCurve.html "struct bevy::prelude::BounceOutCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [BounceOutCurve](../struct.BounceOutCurve.html "struct bevy::prelude::BounceOutCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [BounceOutCurve](../struct.BounceOutCurve.html "struct bevy::prelude::BounceOutCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [BounceOutCurve](../struct.BounceOutCurve.html "struct bevy::prelude::BounceOutCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [BounceOutCurve](../struct.BounceOutCurve.html "struct bevy::prelude::BounceOutCurve")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [BounceOutCurve](../struct.BounceOutCurve.html "struct bevy::prelude::BounceOutCurve")
