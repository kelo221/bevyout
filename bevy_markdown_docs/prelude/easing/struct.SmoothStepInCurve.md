...
This has f″(1) = 0, unlike [`QuadraticInCurve`](../struct.QuadraticInCurve.html "struct bevy::prelude::QuadraticInCurve") which starts similarly.
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [SmoothStepInCurve](../struct.SmoothStepInCurve.html "struct bevy::prelude::SmoothStepInCurve")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#786)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [SmoothStepInCurve](../struct.SmoothStepInCurve.html "struct bevy::prelude::SmoothStepInCurve")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [SmoothStepInCurve](../struct.SmoothStepInCurve.html "struct bevy::prelude::SmoothStepInCurve")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SmoothStepInCurve](../struct.SmoothStepInCurve.html "struct bevy::prelude::SmoothStepInCurve")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SmoothStepInCurve](../struct.SmoothStepInCurve.html "struct bevy::prelude::SmoothStepInCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SmoothStepInCurve](../struct.SmoothStepInCurve.html "struct bevy::prelude::SmoothStepInCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SmoothStepInCurve](../struct.SmoothStepInCurve.html "struct bevy::prelude::SmoothStepInCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SmoothStepInCurve](../struct.SmoothStepInCurve.html "struct bevy::prelude::SmoothStepInCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SmoothStepInCurve](../struct.SmoothStepInCurve.html "struct bevy::prelude::SmoothStepInCurve")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SmoothStepInCurve](../struct.SmoothStepInCurve.html "struct bevy::prelude::SmoothStepInCurve")
