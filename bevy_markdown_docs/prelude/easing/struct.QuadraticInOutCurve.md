...
A quadratic has too low of a degree to be both an `InOut` and C², so consider using at least a cubic (such as [`SmoothStepCurve`](../struct.SmoothStepCurve.html "struct bevy::prelude::SmoothStepCurve")) if you want the acceleration to be continuous.
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [QuadraticInOutCurve](../struct.QuadraticInOutCurve.html "struct bevy::prelude::QuadraticInOutCurve")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#706)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [QuadraticInOutCurve](../struct.QuadraticInOutCurve.html "struct bevy::prelude::QuadraticInOutCurve")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [QuadraticInOutCurve](../struct.QuadraticInOutCurve.html "struct bevy::prelude::QuadraticInOutCurve")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [QuadraticInOutCurve](../struct.QuadraticInOutCurve.html "struct bevy::prelude::QuadraticInOutCurve")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [QuadraticInOutCurve](../struct.QuadraticInOutCurve.html "struct bevy::prelude::QuadraticInOutCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [QuadraticInOutCurve](../struct.QuadraticInOutCurve.html "struct bevy::prelude::QuadraticInOutCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [QuadraticInOutCurve](../struct.QuadraticInOutCurve.html "struct bevy::prelude::QuadraticInOutCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [QuadraticInOutCurve](../struct.QuadraticInOutCurve.html "struct bevy::prelude::QuadraticInOutCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [QuadraticInOutCurve](../struct.QuadraticInOutCurve.html "struct bevy::prelude::QuadraticInOutCurve")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [QuadraticInOutCurve](../struct.QuadraticInOutCurve.html "struct bevy::prelude::QuadraticInOutCurve")
