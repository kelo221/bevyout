...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [SineOutCurve](../struct.SineOutCurve.html "struct bevy::prelude::SineOutCurve")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#852)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [SineOutCurve](../struct.SineOutCurve.html "struct bevy::prelude::SineOutCurve")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [SineOutCurve](../struct.SineOutCurve.html "struct bevy::prelude::SineOutCurve")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SineOutCurve](../struct.SineOutCurve.html "struct bevy::prelude::SineOutCurve")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SineOutCurve](../struct.SineOutCurve.html "struct bevy::prelude::SineOutCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SineOutCurve](../struct.SineOutCurve.html "struct bevy::prelude::SineOutCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SineOutCurve](../struct.SineOutCurve.html "struct bevy::prelude::SineOutCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SineOutCurve](../struct.SineOutCurve.html "struct bevy::prelude::SineOutCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SineOutCurve](../struct.SineOutCurve.html "struct bevy::prelude::SineOutCurve")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SineOutCurve](../struct.SineOutCurve.html "struct bevy::prelude::SineOutCurve")
