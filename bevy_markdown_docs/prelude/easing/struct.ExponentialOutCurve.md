...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ExponentialOutCurve](../struct.ExponentialOutCurve.html "struct bevy::prelude::ExponentialOutCurve")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#894)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ExponentialOutCurve](../struct.ExponentialOutCurve.html "struct bevy::prelude::ExponentialOutCurve")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [ExponentialOutCurve](../struct.ExponentialOutCurve.html "struct bevy::prelude::ExponentialOutCurve")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ExponentialOutCurve](../struct.ExponentialOutCurve.html "struct bevy::prelude::ExponentialOutCurve")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ExponentialOutCurve](../struct.ExponentialOutCurve.html "struct bevy::prelude::ExponentialOutCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ExponentialOutCurve](../struct.ExponentialOutCurve.html "struct bevy::prelude::ExponentialOutCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ExponentialOutCurve](../struct.ExponentialOutCurve.html "struct bevy::prelude::ExponentialOutCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ExponentialOutCurve](../struct.ExponentialOutCurve.html "struct bevy::prelude::ExponentialOutCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ExponentialOutCurve](../struct.ExponentialOutCurve.html "struct bevy::prelude::ExponentialOutCurve")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ExponentialOutCurve](../struct.ExponentialOutCurve.html "struct bevy::prelude::ExponentialOutCurve")
