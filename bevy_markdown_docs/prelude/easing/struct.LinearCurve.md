...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [LinearCurve](../struct.LinearCurve.html "struct bevy::prelude::LinearCurve")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#674)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [LinearCurve](../struct.LinearCurve.html "struct bevy::prelude::LinearCurve")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [LinearCurve](../struct.LinearCurve.html "struct bevy::prelude::LinearCurve")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [LinearCurve](../struct.LinearCurve.html "struct bevy::prelude::LinearCurve")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [LinearCurve](../struct.LinearCurve.html "struct bevy::prelude::LinearCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [LinearCurve](../struct.LinearCurve.html "struct bevy::prelude::LinearCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [LinearCurve](../struct.LinearCurve.html "struct bevy::prelude::LinearCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [LinearCurve](../struct.LinearCurve.html "struct bevy::prelude::LinearCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [LinearCurve](../struct.LinearCurve.html "struct bevy::prelude::LinearCurve")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [LinearCurve](../struct.LinearCurve.html "struct bevy::prelude::LinearCurve")
