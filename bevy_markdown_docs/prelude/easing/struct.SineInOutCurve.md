...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [SineInOutCurve](../struct.SineInOutCurve.html "struct bevy::prelude::SineInOutCurve")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#858)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [SineInOutCurve](../struct.SineInOutCurve.html "struct bevy::prelude::SineInOutCurve")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [SineInOutCurve](../struct.SineInOutCurve.html "struct bevy::prelude::SineInOutCurve")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SineInOutCurve](../struct.SineInOutCurve.html "struct bevy::prelude::SineInOutCurve")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SineInOutCurve](../struct.SineInOutCurve.html "struct bevy::prelude::SineInOutCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SineInOutCurve](../struct.SineInOutCurve.html "struct bevy::prelude::SineInOutCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SineInOutCurve](../struct.SineInOutCurve.html "struct bevy::prelude::SineInOutCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SineInOutCurve](../struct.SineInOutCurve.html "struct bevy::prelude::SineInOutCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SineInOutCurve](../struct.SineInOutCurve.html "struct bevy::prelude::SineInOutCurve")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SineInOutCurve](../struct.SineInOutCurve.html "struct bevy::prelude::SineInOutCurve")
