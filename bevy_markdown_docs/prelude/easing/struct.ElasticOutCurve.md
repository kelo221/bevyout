...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ElasticOutCurve](../struct.ElasticOutCurve.html "struct bevy::prelude::ElasticOutCurve")

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#912)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ElasticOutCurve](../struct.ElasticOutCurve.html "struct bevy::prelude::ElasticOutCurve")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [ElasticOutCurve](../struct.ElasticOutCurve.html "struct bevy::prelude::ElasticOutCurve")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ElasticOutCurve](../struct.ElasticOutCurve.html "struct bevy::prelude::ElasticOutCurve")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ElasticOutCurve](../struct.ElasticOutCurve.html "struct bevy::prelude::ElasticOutCurve")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ElasticOutCurve](../struct.ElasticOutCurve.html "struct bevy::prelude::ElasticOutCurve")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ElasticOutCurve](../struct.ElasticOutCurve.html "struct bevy::prelude::ElasticOutCurve")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ElasticOutCurve](../struct.ElasticOutCurve.html "struct bevy::prelude::ElasticOutCurve")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ElasticOutCurve](../struct.ElasticOutCurve.html "struct bevy::prelude::ElasticOutCurve")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ElasticOutCurve](../struct.ElasticOutCurve.html "struct bevy::prelude::ElasticOutCurve")
