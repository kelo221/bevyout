...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#299)
...
*   an [easing function](../enum.EaseFunction.html "enum bevy::prelude::EaseFunction") to interpolate between the two values.

The resulting curve’s domain is always [the unit interval](../struct.Interval.html#associatedconstant.UNIT "associated constant bevy::prelude::Interval::UNIT").
...
[`sample`](../struct.EasingCurve.html#method.sample "method bevy::prelude::EasingCurve::sample") the curve at various points. This will return `None` if the parameter is outside the unit interval.
...
[`sample_clamped`](../struct.EasingCurve.html#method.sample_clamped "method bevy::prelude::EasingCurve::sample_clamped") will clamp the parameter to the unit interval, so it always returns a value.
...
`EasingCurve` can be used with any type that implements the [`Ease`](../trait.Ease.html "trait bevy::prelude::Ease") trait. This includes many math types, like vectors and rotations.
...
As a shortcut, an `EasingCurve` between `0.0` and `1.0` can be replaced by [`EaseFunction`](../enum.EaseFunction.html "enum bevy::prelude::EaseFunction").
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#305)

### impl<T> [EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#312)

#### pub fn [new](#method.new)(start: T, end: T, ease\_fn: [EaseFunction](../enum.EaseFunction.html "enum bevy::prelude::EaseFunction")) -> [EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>

Given a `start` and `end` value, create a curve parametrized over [the unit interval](../struct.Interval.html#associatedconstant.UNIT "associated constant bevy::prelude::Interval::UNIT") that connects them, using the given [ease function](../enum.EaseFunction.html "enum bevy::prelude::EaseFunction") to determine the form of the curve in between.

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/animation/easing\_functions.rs ([line 157](../../../src/easing_functions/easing_functions.rs.html#157))
...
examples/animation/eased\_motion.rs ([lines 108-112](../../../src/eased_motion/eased_motion.rs.html#108-112))
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#296)

### impl<T> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>

where T: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#296)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#326)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#331)
...
### impl<T> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#297)

### impl<'de, T> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>
...
### impl<T> [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>
...
#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#298)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T> as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>>
...
### impl<T> [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>
...
### impl<T> [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>
...
### impl<T> [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>
...
where [EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>: 'into\_return,
...
### impl<T> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>

where T: [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"),

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#296)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl<T> [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>
...
#### fn [reflect\_owned](../trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/easing.rs.html#298)

#### fn [try\_into\_reflect](../trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>>) -> [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](../trait.Reflect.html#tymethod.into_any)(self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>>) -> [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../trait.Reflect.html#tymethod.into_reflect)(self: [Box](../struct.Box.html "struct bevy::prelude::Box")<[EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>>) -> [Box](../struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<T> [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>
...
### impl<T> [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>
...
### impl<T> [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>
...
### impl<T> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>

where T: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"),

### impl<T> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>
...
### impl<T> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>

where T: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>

where T: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>

where T: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<T> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>

where T: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"),

### impl<T> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [EasingCurve](../struct.EasingCurve.html "struct bevy::prelude::EasingCurve")<T>
