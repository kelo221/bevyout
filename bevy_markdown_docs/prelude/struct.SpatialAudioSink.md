...
If this component is removed from an entity, and a [`AudioSource`](struct.AudioSource.html "struct bevy::prelude::AudioSource") is attached to that entity, that [`AudioSource`](struct.AudioSource.html "struct bevy::prelude::AudioSource") will start playing. If that source is unchanged, that translates to the audio restarting.

## Implementations

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/sinks.rs.html#260)

### impl [SpatialAudioSink](struct.SpatialAudioSink.html "struct bevy::prelude::SpatialAudioSink")

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/sinks.rs.html#262)

#### pub fn [new](#method.new)(sink: [SpatialPlayer](https://docs.rs/rodio/0.22.2/x86_64-unknown-linux-gnu/rodio/spatial_player/struct.SpatialPlayer.html "struct rodio::spatial_player::SpatialPlayer")) -> [SpatialAudioSink](struct.SpatialAudioSink.html "struct bevy::prelude::SpatialAudioSink")
...
#### pub fn [set\_ears\_position](#method.set_ears_position)(&self, left\_position: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3"), right\_position: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3"))
...
#### pub fn [set\_listener\_position](#method.set_listener_position)(&self, position: [Transform](struct.Transform.html "struct bevy::prelude::Transform"), gap: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html))
...
#### pub fn [set\_emitter\_position](#method.set_emitter_position)(&self, position: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3"))
...
#### fn [volume](trait.AudioSinkPlayback.html#tymethod.volume)(&self) -> [Volume](../audio/enum.Volume.html "enum bevy::audio::Volume")

Gets the volume of the sound as a [`Volume`](../audio/enum.Volume.html "enum bevy::audio::Volume"). [Read more](trait.AudioSinkPlayback.html#tymethod.volume)

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/sinks.rs.html#276)

#### fn [set\_volume](trait.AudioSinkPlayback.html#tymethod.set_volume)(&mut self, volume: [Volume](../audio/enum.Volume.html "enum bevy::audio::Volume"))

Changes the volume of the sound to the given [`Volume`](../audio/enum.Volume.html "enum bevy::audio::Volume"). [Read more](trait.AudioSinkPlayback.html#tymethod.set_volume)

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/sinks.rs.html#284)

#### fn [speed](trait.AudioSinkPlayback.html#tymethod.speed)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Gets the speed of the sound. [Read more](trait.AudioSinkPlayback.html#tymethod.speed)

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/sinks.rs.html#288)

#### fn [set\_speed](trait.AudioSinkPlayback.html#tymethod.set_speed)(&self, speed: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html))

Changes the speed of the sound. [Read more](trait.AudioSinkPlayback.html#tymethod.set_speed)

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/sinks.rs.html#292)

#### fn [play](trait.AudioSinkPlayback.html#tymethod.play)(&self)

Resumes playback of a paused sink. [Read more](trait.AudioSinkPlayback.html#tymethod.play)

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/sinks.rs.html#296)

#### fn [position](trait.AudioSinkPlayback.html#tymethod.position)(&self) -> [Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration")

Returns the position of the sound that’s being played. [Read more](trait.AudioSinkPlayback.html#tymethod.position)

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/sinks.rs.html#300)

#### fn [try\_seek](trait.AudioSinkPlayback.html#tymethod.try_seek)(&self, pos: [Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration")) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [SeekError](../audio/enum.SeekError.html "enum bevy::audio::SeekError")\>

Attempts to seek to a given position in the current source. [Read more](trait.AudioSinkPlayback.html#tymethod.try_seek)

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/sinks.rs.html#304)

#### fn [pause](trait.AudioSinkPlayback.html#tymethod.pause)(&self)

Pauses playback of this sink. [Read more](trait.AudioSinkPlayback.html#tymethod.pause)

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/sinks.rs.html#308)

#### fn [is\_paused](trait.AudioSinkPlayback.html#tymethod.is_paused)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns true if the sink is paused. [Read more](trait.AudioSinkPlayback.html#tymethod.is_paused)

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/sinks.rs.html#312)

#### fn [stop](trait.AudioSinkPlayback.html#tymethod.stop)(&self)

Stops the sink. [Read more](trait.AudioSinkPlayback.html#tymethod.stop)

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/sinks.rs.html#316)

#### fn [empty](trait.AudioSinkPlayback.html#tymethod.empty)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns true if this sink has no more sounds to play.

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/sinks.rs.html#320)

#### fn [is\_muted](trait.AudioSinkPlayback.html#tymethod.is_muted)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
#### fn [mute](trait.AudioSinkPlayback.html#tymethod.mute)(&mut self)

Mutes the sink. [Read more](trait.AudioSinkPlayback.html#tymethod.mute)

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/sinks.rs.html#329)

#### fn [unmute](trait.AudioSinkPlayback.html#tymethod.unmute)(&mut self)

Unmutes the sink. [Read more](trait.AudioSinkPlayback.html#tymethod.unmute)

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/sinks.rs.html#83)

#### fn [toggle\_playback](trait.AudioSinkPlayback.html#method.toggle_playback)(&self)

Toggles playback of the sink. [Read more](trait.AudioSinkPlayback.html#method.toggle_playback)

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/sinks.rs.html#119)

#### fn [toggle\_mute](trait.AudioSinkPlayback.html#method.toggle_mute)(&mut self)
...
### impl [Component](trait.Component.html "trait bevy::prelude::Component") for [SpatialAudioSink](struct.SpatialAudioSink.html "struct bevy::prelude::SpatialAudioSink")

where [SpatialAudioSink](struct.SpatialAudioSink.html "struct bevy::prelude::SpatialAudioSink"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SpatialAudioSink](struct.SpatialAudioSink.html "struct bevy::prelude::SpatialAudioSink")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SpatialAudioSink](struct.SpatialAudioSink.html "struct bevy::prelude::SpatialAudioSink")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SpatialAudioSink](struct.SpatialAudioSink.html "struct bevy::prelude::SpatialAudioSink")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SpatialAudioSink](struct.SpatialAudioSink.html "struct bevy::prelude::SpatialAudioSink")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SpatialAudioSink](struct.SpatialAudioSink.html "struct bevy::prelude::SpatialAudioSink")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SpatialAudioSink](struct.SpatialAudioSink.html "struct bevy::prelude::SpatialAudioSink")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SpatialAudioSink](struct.SpatialAudioSink.html "struct bevy::prelude::SpatialAudioSink")
