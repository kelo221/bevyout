...
Observers watch for a “trigger” of a specific [`Event`](trait.Event.html "trait bevy::prelude::Event"). An event can be triggered on the [`World`](struct.World.html "struct bevy::prelude::World") by calling [`World::trigger`](struct.World.html#method.trigger "method bevy::prelude::World::trigger"). It can also be queued up as a [`Command`](trait.Command.html "trait bevy::prelude::Command") using [`Commands::trigger`](struct.Commands.html#method.trigger "method bevy::prelude::Commands::trigger").

When a [`World`](struct.World.html "struct bevy::prelude::World") triggers an [`Event`](trait.Event.html "trait bevy::prelude::Event"), it will immediately run every [`Observer`](struct.Observer.html "struct bevy::prelude::Observer") that watches for that [`Event`](trait.Event.html "trait bevy::prelude::Event").
...
Notice that we used [`World::add_observer`](struct.World.html#method.add_observer "method bevy::prelude::World::add_observer"). This is just a shorthand for spawning an [`Entity`](struct.Entity.html "struct bevy::prelude::Entity") with an [`Observer`](struct.Observer.html "struct bevy::prelude::Observer") manually:
...
Observers are a specialized [`System`](trait.System.html "trait bevy::prelude::System") called an [`ObserverSystem`](../ecs/system/trait.ObserverSystem.html "trait bevy::ecs::system::ObserverSystem"). The first parameter must be [`On`](struct.On.html "struct bevy::prelude::On"), which provides access to the [`Event`](trait.Event.html "trait bevy::prelude::Event"), the [`Trigger`](../ecs/event/trait.Trigger.html "trait bevy::ecs::event::Trigger"), and some additional execution context.

Because they are systems, they can access arbitrary [`World`](struct.World.html "struct bevy::prelude::World") data by adding [`SystemParam`](../ecs/system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")s:
...
You can also add [`Commands`](struct.Commands.html "struct bevy::prelude::Commands"), which means you can spawn new entities, insert new components, etc:
...
### Event [`Trigger`](../ecs/event/trait.Trigger.html "trait bevy::ecs::event::Trigger") behavior

Each [`Event`](trait.Event.html "trait bevy::prelude::Event") defines a [`Trigger`](../ecs/event/trait.Trigger.html "trait bevy::ecs::event::Trigger") behavior, which determines _which_ observers will run for the given [`Event`](trait.Event.html "trait bevy::prelude::Event") and _how_ they will be run.

[`Event`](trait.Event.html "trait bevy::prelude::Event") by default (when derived) uses [`GlobalTrigger`](../ecs/event/struct.GlobalTrigger.html "struct bevy::ecs::event::GlobalTrigger"). When it is triggered any [`Observer`](struct.Observer.html "struct bevy::prelude::Observer") watching for it will be run.

### Event sub-types

There are some built-in specialized [`Event`](trait.Event.html "trait bevy::prelude::Event") types with custom [`Trigger`](../ecs/event/trait.Trigger.html "trait bevy::ecs::event::Trigger") logic:

*   [`EntityEvent`](trait.EntityEvent.html "trait bevy::prelude::EntityEvent") / [`EntityTrigger`](../ecs/event/struct.EntityTrigger.html "struct bevy::ecs::event::EntityTrigger"): An [`Event`](trait.Event.html "trait bevy::prelude::Event") that targets a _specific_ entity. This also has opt-in support for “event bubbling” behavior. See [`EntityEvent`](trait.EntityEvent.html "trait bevy::prelude::EntityEvent") for details.
*   [`EntityComponentsTrigger`](../ecs/event/struct.EntityComponentsTrigger.html "struct bevy::ecs::event::EntityComponentsTrigger"): An [`Event`](trait.Event.html "trait bevy::prelude::Event") that targets an entity _and_ one or more components on that entity. This is used for [component lifecycle events](../ecs/lifecycle/index.html "mod bevy::ecs::lifecycle").

You can also define your own!

### Observer execution timing

Observers triggered via [`World::trigger`](struct.World.html#method.trigger "method bevy::prelude::World::trigger") are evaluated immediately, as are all commands they queue up.

Observers triggered via [`Commands::trigger`](struct.Commands.html#method.trigger "method bevy::prelude::Commands::trigger") are evaluated at the next sync point in the ECS schedule, just like any other [`Command`](trait.Command.html "trait bevy::prelude::Command").
...
### [`ObservedBy`](../ecs/observer/struct.ObservedBy.html "struct bevy::ecs::observer::ObservedBy")

When entities are observed, they will receive an [`ObservedBy`](../ecs/observer/struct.ObservedBy.html "struct bevy::ecs::observer::ObservedBy") component, which will be updated to track the observers that are currently observing them.

### Manual [`Observer`](struct.Observer.html "struct bevy::prelude::Observer") target configuration

You can manually control the targets that an observer is watching by calling builder methods like [`Observer::with_entity`](struct.Observer.html#method.with_entity "method bevy::prelude::Observer::with_entity") _before_ inserting the [`Observer`](struct.Observer.html "struct bevy::prelude::Observer") component.

In general, it is better to use the [`EntityWorldMut::observe`](struct.EntityWorldMut.html#method.observe "method bevy::prelude::EntityWorldMut::observe") or [`EntityCommands::observe`](struct.EntityCommands.html#method.observe "method bevy::prelude::EntityCommands::observe") methods, which spawns a new observer, and configures it to watch the entity it is called on.

### Cleaning up observers

If an [`EntityEvent`](trait.EntityEvent.html "trait bevy::prelude::EntityEvent") [`Observer`](struct.Observer.html "struct bevy::prelude::Observer") targets specific entities, and all of those entities are despawned, the [`Observer`](struct.Observer.html "struct bevy::prelude::Observer") entity will also be despawned. This protects against observer “garbage” building up over time.

### Component lifecycle events: Observers vs Hooks

It is important to note that observers, just like [hooks](../ecs/lifecycle/struct.ComponentHooks.html "struct bevy::ecs::lifecycle::ComponentHooks"), can watch for and respond to [lifecycle](../ecs/lifecycle/index.html "mod bevy::ecs::lifecycle") events. Unlike hooks, observers are not treated as an “innate” part of component behavior: they can be added or removed at runtime, and multiple observers can be registered for the same lifecycle event for the same component.
...
For more efficient observer triggering, Observers make use of the internal [`CachedObservers`](../ecs/observer/struct.CachedObservers.html "struct bevy::ecs::observer::CachedObservers") storage. In general, this is an implementation detail developers don’t need to worry about, but it can be used when implementing custom [`Trigger`](../ecs/event/trait.Trigger.html "trait bevy::ecs::event::Trigger") types, or to add “dynamic” observers for cases like scripting / modding.

## Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/observer/distributed_storage.rs.html#218)

### impl [Observer](struct.Observer.html "struct bevy::prelude::Observer")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/observer/distributed_storage.rs.html#224)

#### pub fn [new](#method.new)<E, B, M, I>(system: I) -> [Observer](struct.Observer.html "struct bevy::prelude::Observer")

where E: [Event](trait.Event.html "trait bevy::prelude::Event"), B: [Bundle](trait.Bundle.html "trait bevy::prelude::Bundle"), I: [IntoObserverSystem](../ecs/system/trait.IntoObserverSystem.html "trait bevy::ecs::system::IntoObserverSystem")<E, B, M>,

Creates a new [`Observer`](struct.Observer.html "struct bevy::prelude::Observer"), which defaults to a “global” observer. This means it will run _whenever_ an event of type `E` is triggered.
...
#### pub fn [with\_dynamic\_runner](#method.with_dynamic_runner)( runner: unsafe [fn](https://doc.rust-lang.org/nightly/std/primitive.fn.html)([DeferredWorld](../ecs/world/struct.DeferredWorld.html "struct bevy::ecs::world::DeferredWorld")<'\_>, [Entity](struct.Entity.html "struct bevy::prelude::Entity"), &[TriggerContext](../ecs/observer/struct.TriggerContext.html "struct bevy::ecs::observer::TriggerContext"), [PtrMut](../ecs/ptr/struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'\_>, [PtrMut](../ecs/ptr/struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'\_>), ) -> [Observer](struct.Observer.html "struct bevy::prelude::Observer")

Creates a new [`Observer`](struct.Observer.html "struct bevy::prelude::Observer") with custom runner, this is mostly used for dynamic event observers
...
#### pub fn [with\_entity](#method.with_entity)(self, entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity")) -> [Observer](struct.Observer.html "struct bevy::prelude::Observer")

Observes the given `entity` (in addition to any entity already being observed). This will cause the [`Observer`](struct.Observer.html "struct bevy::prelude::Observer") to run whenever an [`EntityEvent::event_target`](trait.EntityEvent.html#tymethod.event_target "method bevy::prelude::EntityEvent::event_target") is the given `entity`. Note that if this is called _after_ an [`Observer`](struct.Observer.html "struct bevy::prelude::Observer") is spawned, it will produce no effects.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/observer/distributed_storage.rs.html#295)

#### pub fn [with\_entities](#method.with_entities)<I>(self, entities: I) -> [Observer](struct.Observer.html "struct bevy::prelude::Observer")

where I: [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [Entity](struct.Entity.html "struct bevy::prelude::Entity")\>,

Observes the given `entities` (in addition to any entity already being observed). This will cause the [`Observer`](struct.Observer.html "struct bevy::prelude::Observer") to run whenever an [`EntityEvent::event_target`](trait.EntityEvent.html#tymethod.event_target "method bevy::prelude::EntityEvent::event_target") is any of the `entities`. Note that if this is called _after_ an [`Observer`](struct.Observer.html "struct bevy::prelude::Observer") is spawned, it will produce no effects.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/observer/distributed_storage.rs.html#303)

#### pub fn [watch\_entity](#method.watch_entity)(&mut self, entity: [Entity](struct.Entity.html "struct bevy::prelude::Entity"))
...
#### pub fn [with\_component](#method.with_component)(self, component: [ComponentId](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")) -> [Observer](struct.Observer.html "struct bevy::prelude::Observer")

Observes the given `component`. This will cause the [`Observer`](struct.Observer.html "struct bevy::prelude::Observer") to run whenever the [`Event`](trait.Event.html "trait bevy::prelude::Event") has an [`EntityComponentsTrigger`](../ecs/event/struct.EntityComponentsTrigger.html "struct bevy::ecs::event::EntityComponentsTrigger") that targets the given `component`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/observer/distributed_storage.rs.html#323)

#### pub fn [with\_components](#method.with_components)<I>(self, components: I) -> [Observer](struct.Observer.html "struct bevy::prelude::Observer")

where I: [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [ComponentId](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")\>,

Observes the given `components`. This will cause the [`Observer`](struct.Observer.html "struct bevy::prelude::Observer") to run whenever the [`Event`](trait.Event.html "trait bevy::prelude::Event") has an [`EntityComponentsTrigger`](../ecs/event/struct.EntityComponentsTrigger.html "struct bevy::ecs::event::EntityComponentsTrigger") that targets any of the `components`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/observer/distributed_storage.rs.html#333)

#### pub unsafe fn [with\_event\_key](#method.with_event_key)(self, event\_key: [EventKey](../ecs/event/struct.EventKey.html "struct bevy::ecs::event::EventKey")) -> [Observer](struct.Observer.html "struct bevy::prelude::Observer")

Observes the given `event_key`. This will cause the [`Observer`](struct.Observer.html "struct bevy::prelude::Observer") to run whenever an event with the given [`EventKey`](../ecs/event/struct.EventKey.html "struct bevy::ecs::event::EventKey") is triggered.

##### Safety

The type of the `event_key` [`EventKey`](../ecs/event/struct.EventKey.html "struct bevy::ecs::event::EventKey") _must_ match the actual value of the event passed into the observer system.
...
#### pub fn [with\_error\_handler](#method.with_error_handler)( self, error\_handler: [fn](https://doc.rust-lang.org/nightly/std/primitive.fn.html)([BevyError](struct.BevyError.html "struct bevy::prelude::BevyError"), [ErrorContext](../ecs/error/enum.ErrorContext.html "enum bevy::ecs::error::ErrorContext")), ) -> [Observer](struct.Observer.html "struct bevy::prelude::Observer")

Sets the error handler to use for this observer.

See the [`error` module-level documentation](../ecs/error/index.html "mod bevy::ecs::error") for more information.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/observer/distributed_storage.rs.html#350)

#### pub fn [run\_if](#method.run_if)<M>(self, condition: impl [SystemCondition](trait.SystemCondition.html "trait bevy::prelude::SystemCondition")<M>) -> [Observer](struct.Observer.html "struct bevy::prelude::Observer")
...
#### pub fn [descriptor](#method.descriptor)(&self) -> &[ObserverDescriptor](../ecs/observer/struct.ObserverDescriptor.html "struct bevy::ecs::observer::ObserverDescriptor")

Returns the [`ObserverDescriptor`](../ecs/observer/struct.ObserverDescriptor.html "struct bevy::ecs::observer::ObserverDescriptor") for this [`Observer`](struct.Observer.html "struct bevy::prelude::Observer").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/observer/distributed_storage.rs.html#361)

#### pub fn [system\_name](#method.system_name)(&self) -> [DebugName](struct.DebugName.html "struct bevy::prelude::DebugName")

Returns the name of the [`Observer`](struct.Observer.html "struct bevy::prelude::Observer")’s system .

## Trait Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/observer/distributed_storage.rs.html#366)

### impl [Component](trait.Component.html "trait bevy::prelude::Component") for [Observer](struct.Observer.html "struct bevy::prelude::Observer")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/observer/distributed_storage.rs.html#367)

#### const [STORAGE\_TYPE](trait.Component.html#associatedconstant.STORAGE_TYPE): [StorageType](../ecs/component/enum.StorageType.html "enum bevy::ecs::component::StorageType") = StorageType::SparseSet
...
#### fn [register\_required\_components](trait.Component.html#method.register_required_components)( \_component\_id: [ComponentId](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId"), \_required\_components: &mut [RequiredComponentsRegistrator](../ecs/component/struct.RequiredComponentsRegistrator.html "struct bevy::ecs::component::RequiredComponentsRegistrator")<'\_, '\_>, )
...
### impl [IntoObserver](../ecs/observer/trait.IntoObserver.html "trait bevy::ecs::observer::IntoObserver")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html)\> for [Observer](struct.Observer.html "struct bevy::prelude::Observer")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/observer/distributed_storage.rs.html#567)

#### fn [into\_observer](../ecs/observer/trait.IntoObserver.html#tymethod.into_observer)(self) -> [Observer](struct.Observer.html "struct bevy::prelude::Observer")

Converts this type into an [`Observer`](struct.Observer.html "struct bevy::prelude::Observer").

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Observer](struct.Observer.html "struct bevy::prelude::Observer")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Observer](struct.Observer.html "struct bevy::prelude::Observer")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Observer](struct.Observer.html "struct bevy::prelude::Observer")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Observer](struct.Observer.html "struct bevy::prelude::Observer")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Observer](struct.Observer.html "struct bevy::prelude::Observer")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Observer](struct.Observer.html "struct bevy::prelude::Observer")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Observer](struct.Observer.html "struct bevy::prelude::Observer")
