...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [RepeatError](enum.RepeatError.html "enum bevy::prelude::RepeatError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [RepeatError](enum.RepeatError.html "enum bevy::prelude::RepeatError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [RepeatError](enum.RepeatError.html "enum bevy::prelude::RepeatError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RepeatError](enum.RepeatError.html "enum bevy::prelude::RepeatError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RepeatError](enum.RepeatError.html "enum bevy::prelude::RepeatError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RepeatError](enum.RepeatError.html "enum bevy::prelude::RepeatError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RepeatError](enum.RepeatError.html "enum bevy::prelude::RepeatError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RepeatError](enum.RepeatError.html "enum bevy::prelude::RepeatError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RepeatError](enum.RepeatError.html "enum bevy::prelude::RepeatError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RepeatError](enum.RepeatError.html "enum bevy::prelude::RepeatError")
