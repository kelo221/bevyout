...
`ignored_scheduling_ambiguities: [BTreeSet](https://doc.rust-lang.org/nightly/alloc/collections/btree/set/struct.BTreeSet.html "struct alloc::collections::btree::set::BTreeSet")<[ComponentId](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")>`

List of [`ComponentId`](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")s to ignore when reporting system order ambiguity conflicts

## Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#57)

### impl [Schedules](struct.Schedules.html "struct bevy::prelude::Schedules")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#59)

#### pub fn [new](#method.new)() -> [Schedules](struct.Schedules.html "struct bevy::prelude::Schedules")
...
#### pub fn [insert](#method.insert)(&mut self, schedule: [Schedule](struct.Schedule.html "struct bevy::prelude::Schedule")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Schedule](struct.Schedule.html "struct bevy::prelude::Schedule")\>
...
#### pub fn [reinsert](#method.reinsert)(&mut self, schedule: [Schedule](struct.Schedule.html "struct bevy::prelude::Schedule")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Schedule](struct.Schedule.html "struct bevy::prelude::Schedule")\>
...
#### pub fn [remove](#method.remove)(&mut self, label: impl [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Schedule](struct.Schedule.html "struct bevy::prelude::Schedule")\>

Removes the schedule corresponding to the `label` from the map, returning it if it existed.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#89)

#### pub fn [remove\_temporarily](#method.remove_temporarily)( &mut self, label: impl [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Schedule](struct.Schedule.html "struct bevy::prelude::Schedule")\>
...
#### pub fn [remove\_entry](#method.remove_entry)( &mut self, label: impl [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<([Interned](../ecs/intern/struct.Interned.html "struct bevy::ecs::intern::Interned")<dyn [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")\>, [Schedule](struct.Schedule.html "struct bevy::prelude::Schedule"))>
...
#### pub fn [get\_temporarily\_removed](#method.get_temporarily_removed)(&self) -> [HashSet](../platform/collections/struct.HashSet.html "struct bevy::platform::collections::HashSet")<[Interned](../ecs/intern/struct.Interned.html "struct bevy::ecs::intern::Interned")<dyn [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")\>>
...
#### pub fn [get\_empty\_labels](#method.get_empty_labels)(&self) -> [HashSet](../platform/collections/struct.HashSet.html "struct bevy::platform::collections::HashSet")<[Interned](../ecs/intern/struct.Interned.html "struct bevy::ecs::intern::Interned")<dyn [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")\>>
...
#### pub fn [contains](#method.contains)(&self, label: impl [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Does a schedule with the provided label already exist?

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#126)

#### pub fn [get](#method.get)(&self, label: impl [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[Schedule](struct.Schedule.html "struct bevy::prelude::Schedule")\>
...
#### pub fn [get\_mut](#method.get_mut)(&mut self, label: impl [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&mut [Schedule](struct.Schedule.html "struct bevy::prelude::Schedule")\>

Returns a mutable reference to the schedule associated with `label`, if it exists.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#136)

#### pub fn [entry](#method.entry)(&mut self, label: impl [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")) -> &mut [Schedule](struct.Schedule.html "struct bevy::prelude::Schedule")
...
#### pub fn [iter](#method.iter)( &self, ) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = (&(dyn [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel") + 'static), &[Schedule](struct.Schedule.html "struct bevy::prelude::Schedule"))>
...
#### pub fn [iter\_mut](#method.iter_mut)( &mut self, ) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = (&(dyn [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel") + 'static), &mut [Schedule](struct.Schedule.html "struct bevy::prelude::Schedule"))>
...
#### pub fn [configure\_schedules](#method.configure_schedules)( &mut self, schedule\_build\_settings: [ScheduleBuildSettings](../ecs/schedule/struct.ScheduleBuildSettings.html "struct bevy::ecs::schedule::ScheduleBuildSettings"), )
...
#### pub fn [allow\_ambiguous\_component](#method.allow_ambiguous_component)<T>(&mut self, world: &mut [World](struct.World.html "struct bevy::prelude::World"))
...
#### pub fn [allow\_ambiguous\_resource](#method.allow_ambiguous_resource)<T>(&mut self, world: &mut [World](struct.World.html "struct bevy::prelude::World"))
...
#### pub fn [iter\_ignored\_ambiguities](#method.iter_ignored_ambiguities)(&self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = &[ComponentId](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")\>

Iterate through the [`ComponentId`](../ecs/component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")’s that will be ignored.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#208)

#### pub fn [print\_ignored\_ambiguities](#method.print_ignored_ambiguities)(&self, components: &[Components](../ecs/component/struct.Components.html "struct bevy::ecs::component::Components"))
...
May panic or retrieve incorrect names if [`Components`](../ecs/component/struct.Components.html "struct bevy::ecs::component::Components") is not from the same world

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#220-224)

#### pub fn [add\_systems](#method.add_systems)<M>( &mut self, schedule: impl [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel"), systems: impl [IntoScheduleConfigs](trait.IntoScheduleConfigs.html "trait bevy::prelude::IntoScheduleConfigs")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [System](trait.System.html "trait bevy::prelude::System")<Out = [()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), In = [()](https://doc.rust-lang.org/nightly/std/primitive.unit.html)\>>, M>, ) -> &mut [Schedules](struct.Schedules.html "struct bevy::prelude::Schedules")

Adds one or more systems to the [`Schedule`](struct.Schedule.html "struct bevy::prelude::Schedule") matching the provided [`ScheduleLabel`](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#233-239)

#### pub fn [remove\_systems\_in\_set](#method.remove_systems_in_set)<M>( &mut self, schedule: impl [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel"), set: impl [IntoSystemSet](trait.IntoSystemSet.html "trait bevy::prelude::IntoSystemSet")<M>, world: &mut [World](struct.World.html "struct bevy::prelude::World"), policy: [ScheduleCleanupPolicy](../ecs/schedule/enum.ScheduleCleanupPolicy.html "enum bevy::ecs::schedule::ScheduleCleanupPolicy"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), [ScheduleError](../ecs/schedule/enum.ScheduleError.html "enum bevy::ecs::schedule::ScheduleError")\>
...
#### pub fn [ignore\_ambiguity](#method.ignore_ambiguity)<M1, M2, S1, S2>( &mut self, schedule: impl [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel"), a: S1, b: S2, ) -> &mut [Schedules](struct.Schedules.html "struct bevy::prelude::Schedules")
...
### impl [Component](trait.Component.html "trait bevy::prelude::Component") for [Schedules](struct.Schedules.html "struct bevy::prelude::Schedules")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Schedules](struct.Schedules.html "struct bevy::prelude::Schedules")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#45)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Schedules](struct.Schedules.html "struct bevy::prelude::Schedules")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Schedules](struct.Schedules.html "struct bevy::prelude::Schedules")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Schedules](struct.Schedules.html "struct bevy::prelude::Schedules")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Schedules](struct.Schedules.html "struct bevy::prelude::Schedules")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Schedules](struct.Schedules.html "struct bevy::prelude::Schedules")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Schedules](struct.Schedules.html "struct bevy::prelude::Schedules")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Schedules](struct.Schedules.html "struct bevy::prelude::Schedules")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Schedules](struct.Schedules.html "struct bevy::prelude::Schedules")
