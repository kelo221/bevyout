...
A [`RelationshipTarget`](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") collection component that is populated with entities that “target” this entity with the [`ChildOf`](struct.ChildOf.html "struct bevy::prelude::ChildOf") [`Relationship`](../ecs/relationship/trait.Relationship.html "trait bevy::ecs::relationship::Relationship") component.

Together, these components form the “canonical parent-child hierarchy”. See the [`ChildOf`](struct.ChildOf.html "struct bevy::prelude::ChildOf") component for the full description of this relationship and instructions on how to use it.

## Usage

Like all [`RelationshipTarget`](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") components, this data should not be directly manipulated to avoid desynchronization. Instead, modify the [`ChildOf`](struct.ChildOf.html "struct bevy::prelude::ChildOf") components on the “source” entities.

To access the children of an entity, you can iterate over the [`Children`](struct.Children.html "struct bevy::prelude::Children") component, using the [`IntoIterator`](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") trait. For more complex access patterns, see the [`RelationshipTarget`](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") trait.

## Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#154)

### impl [Children](struct.Children.html "struct bevy::prelude::Children")
...
where F: [FnMut](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html "trait core::ops::function::FnMut")(&[Entity](struct.Entity.html "struct bevy::prelude::Entity"), &[Entity](struct.Entity.html "struct bevy::prelude::Entity")) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering"),
...
For the unstable version, see [`sort_unstable_by`](struct.Children.html#method.sort_unstable_by "method bevy::prelude::Children::sort_unstable_by").

See also [`sort_by_key`](struct.Children.html#method.sort_by_key "method bevy::prelude::Children::sort_by_key"), [`sort_by_cached_key`](struct.Children.html#method.sort_by_cached_key "method bevy::prelude::Children::sort_by_cached_key").
...
where F: [FnMut](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html "trait core::ops::function::FnMut")(&[Entity](struct.Entity.html "struct bevy::prelude::Entity")) -> K, K: [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord"),
...
For the unstable version, see [`sort_unstable_by_key`](struct.Children.html#method.sort_unstable_by_key "method bevy::prelude::Children::sort_unstable_by_key").

See also [`sort_by`](struct.Children.html#method.sort_by "method bevy::prelude::Children::sort_by"), [`sort_by_cached_key`](struct.Children.html#method.sort_by_cached_key "method bevy::prelude::Children::sort_by_cached_key").
...
See also [`sort_by`](struct.Children.html#method.sort_by "method bevy::prelude::Children::sort_by"), [`sort_by_key`](struct.Children.html#method.sort_by_key "method bevy::prelude::Children::sort_by_key").
...
For the stable version, see [`sort_by`](struct.Children.html#method.sort_by "method bevy::prelude::Children::sort_by").

See also [`sort_unstable_by_key`](struct.Children.html#method.sort_unstable_by_key "method bevy::prelude::Children::sort_unstable_by_key").
...
For the stable version, see [`sort_by_key`](struct.Children.html#method.sort_by_key "method bevy::prelude::Children::sort_by_key").

See also [`sort_unstable_by`](struct.Children.html#method.sort_unstable_by "method bevy::prelude::Children::sort_unstable_by").

## Methods from [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")<Target = \[[Entity](struct.Entity.html "struct bevy::prelude::Entity")\]>
...
### impl [Component](trait.Component.html "trait bevy::prelude::Component") for [Children](struct.Children.html "struct bevy::prelude::Children")

where [Children](struct.Children.html "struct bevy::prelude::Children"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
#### fn [map\_entities](trait.Component.html#method.map_entities)<M>(this: &mut [Children](struct.Children.html "struct bevy::prelude::Children"), mapper: [&mut M](https://doc.rust-lang.org/nightly/std/primitive.reference.html))

where M: [EntityMapper](trait.EntityMapper.html "trait bevy::prelude::EntityMapper"),
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Children](struct.Children.html "struct bevy::prelude::Children")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Children](struct.Children.html "struct bevy::prelude::Children")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#147)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Children](struct.Children.html "struct bevy::prelude::Children")
...
### impl [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [Children](struct.Children.html "struct bevy::prelude::Children")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#256)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = \[[Entity](struct.Entity.html "struct bevy::prelude::Entity")\]

The resulting type after dereferencing.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#258)

#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[Children](struct.Children.html "struct bevy::prelude::Children") as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#147)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [Children](struct.Children.html "struct bevy::prelude::Children")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#149)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Children](struct.Children.html "struct bevy::prelude::Children")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#149)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Children](struct.Children.html "struct bevy::prelude::Children")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#149)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Children](struct.Children.html "struct bevy::prelude::Children") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Children](struct.Children.html "struct bevy::prelude::Children")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Children](struct.Children.html "struct bevy::prelude::Children")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Children](struct.Children.html "struct bevy::prelude::Children")
...
where [Children](struct.Children.html "struct bevy::prelude::Children"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Children](struct.Children.html "struct bevy::prelude::Children")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#147)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Children](struct.Children.html "struct bevy::prelude::Children")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Children](struct.Children.html "struct bevy::prelude::Children")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Children](struct.Children.html "struct bevy::prelude::Children")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#149)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Children](struct.Children.html "struct bevy::prelude::Children")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Children](struct.Children.html "struct bevy::prelude::Children")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Children](struct.Children.html "struct bevy::prelude::Children")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Children](struct.Children.html "struct bevy::prelude::Children")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [RelationshipTarget](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") for [Children](struct.Children.html "struct bevy::prelude::Children")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#147)

#### const [LINKED\_SPAWN](trait.RelationshipTarget.html#associatedconstant.LINKED_SPAWN): [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html) = true

If this is true, when despawning or cloning (when [linked cloning is enabled](../ecs/entity/struct.EntityClonerBuilder.html#method.linked_cloning "method bevy::ecs::entity::EntityClonerBuilder::linked_cloning")), the related entities targeting this entity will also be despawned or cloned. [Read more](trait.RelationshipTarget.html#associatedconstant.LINKED_SPAWN)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#147)

#### type [Relationship](trait.RelationshipTarget.html#associatedtype.Relationship) = [ChildOf](struct.ChildOf.html "struct bevy::prelude::ChildOf")

The [`Relationship`](../ecs/relationship/trait.Relationship.html "trait bevy::ecs::relationship::Relationship") that populates this [`RelationshipTarget`](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") collection.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#147)

#### type [Collection](trait.RelationshipTarget.html#associatedtype.Collection) = [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[Entity](struct.Entity.html "struct bevy::prelude::Entity")\>

The collection type that stores the “source” entities for this [`RelationshipTarget`](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") component. [Read more](trait.RelationshipTarget.html#associatedtype.Collection)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#147)

#### fn [collection](trait.RelationshipTarget.html#tymethod.collection)(&self) -> &<[Children](struct.Children.html "struct bevy::prelude::Children") as [RelationshipTarget](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget")\>::[Collection](trait.RelationshipTarget.html#associatedtype.Collection "type bevy::prelude::RelationshipTarget::Collection")

Returns a reference to the stored [`RelationshipTarget::Collection`](trait.RelationshipTarget.html#associatedtype.Collection "associated type bevy::prelude::RelationshipTarget::Collection").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#147)

#### fn [collection\_mut\_risky](trait.RelationshipTarget.html#tymethod.collection_mut_risky)( &mut self, ) -> &mut <[Children](struct.Children.html "struct bevy::prelude::Children") as [RelationshipTarget](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget")\>::[Collection](trait.RelationshipTarget.html#associatedtype.Collection "type bevy::prelude::RelationshipTarget::Collection")

Returns a mutable reference to the stored [`RelationshipTarget::Collection`](trait.RelationshipTarget.html#associatedtype.Collection "associated type bevy::prelude::RelationshipTarget::Collection"). [Read more](trait.RelationshipTarget.html#tymethod.collection_mut_risky)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#147)

#### fn [from\_collection\_risky](trait.RelationshipTarget.html#tymethod.from_collection_risky)( collection: <[Children](struct.Children.html "struct bevy::prelude::Children") as [RelationshipTarget](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget")\>::[Collection](trait.RelationshipTarget.html#associatedtype.Collection "type bevy::prelude::RelationshipTarget::Collection"), ) -> [Children](struct.Children.html "struct bevy::prelude::Children")

Creates a new [`RelationshipTarget`](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") from the given [`RelationshipTarget::Collection`](trait.RelationshipTarget.html#associatedtype.Collection "associated type bevy::prelude::RelationshipTarget::Collection"). [Read more](trait.RelationshipTarget.html#tymethod.from_collection_risky)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/mod.rs.html#307-314)

#### fn [on\_discard](trait.RelationshipTarget.html#method.on_discard)(world: [DeferredWorld](../ecs/world/struct.DeferredWorld.html "struct bevy::ecs::world::DeferredWorld")<'\_>, \_: [HookContext](../ecs/lifecycle/struct.HookContext.html "struct bevy::ecs::lifecycle::HookContext"))

The `on_discard` component hook that maintains the [`Relationship`](../ecs/relationship/trait.Relationship.html "trait bevy::ecs::relationship::Relationship") / [`RelationshipTarget`](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") connection.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/mod.rs.html#332)

#### fn [on\_despawn](trait.RelationshipTarget.html#method.on_despawn)(world: [DeferredWorld](../ecs/world/struct.DeferredWorld.html "struct bevy::ecs::world::DeferredWorld")<'\_>, \_: [HookContext](../ecs/lifecycle/struct.HookContext.html "struct bevy::ecs::lifecycle::HookContext"))

The `on_despawn` component hook that despawns entities stored in an entity’s [`RelationshipTarget`](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") when that entity is despawned.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/mod.rs.html#341)

#### fn [with\_capacity](trait.RelationshipTarget.html#method.with_capacity)(capacity: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> Self

Creates this [`RelationshipTarget`](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") with the given pre-allocated entity capacity.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/mod.rs.html#349)

#### fn [iter](trait.RelationshipTarget.html#method.iter)( &self, ) -> <Self::[Collection](trait.RelationshipTarget.html#associatedtype.Collection "type bevy::prelude::RelationshipTarget::Collection") as [RelationshipSourceCollection](../ecs/relationship/trait.RelationshipSourceCollection.html "trait bevy::ecs::relationship::RelationshipSourceCollection")\>::[SourceIter](../ecs/relationship/trait.RelationshipSourceCollection.html#associatedtype.SourceIter "type bevy::ecs::relationship::RelationshipSourceCollection::SourceIter")<'\_>
...
#### fn [len](trait.RelationshipTarget.html#method.len)(&self) -> [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)
...
#### fn [is\_empty](trait.RelationshipTarget.html#method.is_empty)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns true if this entity collection is empty.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#147)

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Children](struct.Children.html "struct bevy::prelude::Children")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Children](struct.Children.html "struct bevy::prelude::Children")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Children](struct.Children.html "struct bevy::prelude::Children")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Children](struct.Children.html "struct bevy::prelude::Children")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Children](struct.Children.html "struct bevy::prelude::Children")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Children](struct.Children.html "struct bevy::prelude::Children")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Children](struct.Children.html "struct bevy::prelude::Children")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Children](struct.Children.html "struct bevy::prelude::Children")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Children](struct.Children.html "struct bevy::prelude::Children")
...
#### fn [spawn](trait.SpawnRelated.html#tymethod.spawn)<L>( list: L, ) -> [SpawnRelatedBundle](../ecs/spawn/struct.SpawnRelatedBundle.html "struct bevy::ecs::spawn::SpawnRelatedBundle")<<T as [RelationshipTarget](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget")\>::[Relationship](trait.RelationshipTarget.html#associatedtype.Relationship "type bevy::prelude::RelationshipTarget::Relationship"), L>

where L: [SpawnableList](../ecs/spawn/trait.SpawnableList.html "trait bevy::ecs::spawn::SpawnableList")<<T as [RelationshipTarget](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget")\>::[Relationship](trait.RelationshipTarget.html#associatedtype.Relationship "type bevy::prelude::RelationshipTarget::Relationship")\>,

Returns a [`Bundle`](trait.Bundle.html "trait bevy::prelude::Bundle") containing this [`RelationshipTarget`](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") component. It also spawns a [`SpawnableList`](../ecs/spawn/trait.SpawnableList.html "trait bevy::ecs::spawn::SpawnableList") of entities, each related to the bundle’s entity via [`RelationshipTarget::Relationship`](trait.RelationshipTarget.html#associatedtype.Relationship "associated type bevy::prelude::RelationshipTarget::Relationship"). The [`RelationshipTarget`](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") (when possible) will pre-allocate space for the related entities. [Read more](trait.SpawnRelated.html#tymethod.spawn)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/spawn.rs.html#452)

#### fn [spawn\_one](trait.SpawnRelated.html#tymethod.spawn_one)<B>( bundle: B, ) -> [SpawnOneRelated](../ecs/spawn/struct.SpawnOneRelated.html "struct bevy::ecs::spawn::SpawnOneRelated")<<T as [RelationshipTarget](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget")\>::[Relationship](trait.RelationshipTarget.html#associatedtype.Relationship "type bevy::prelude::RelationshipTarget::Relationship"), B>

where B: [Bundle](trait.Bundle.html "trait bevy::prelude::Bundle"),

Returns a [`Bundle`](trait.Bundle.html "trait bevy::prelude::Bundle") containing this [`RelationshipTarget`](trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") component. It also spawns a single entity containing [`Bundle`](trait.Bundle.html "trait bevy::prelude::Bundle") that is related to the bundle’s entity via [`RelationshipTarget::Relationship`](trait.RelationshipTarget.html#associatedtype.Relationship "associated type bevy::prelude::RelationshipTarget::Relationship"). [Read more](trait.SpawnRelated.html#tymethod.spawn_one)
