...
`AnimatableProperty` allows any value contained in an entity to be animated as long as it can be obtained by mutable reference. This makes it more flexible than [`animated_field`](../animation/macro.animated_field.html "macro bevy::animation::animated_field").
...
You can then create an [`AnimatableCurve`](struct.AnimatableCurve.html "struct bevy::prelude::AnimatableCurve") to animate this property like so:
...
#### type [Property](#associatedtype.Property): [Animatable](trait.Animatable.html "trait bevy::prelude::Animatable")
...
#### fn [get\_mut](#tymethod.get_mut)<'a>( &self, entity: &'a mut [EntityMutExcept](../ecs/world/struct.EntityMutExcept.html "struct bevy::ecs::world::EntityMutExcept")<'\_, '\_, ([AnimationTargetId](../animation/struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId"), [AnimatedBy](../animation/struct.AnimatedBy.html "struct bevy::animation::AnimatedBy"), [AnimationPlayer](struct.AnimationPlayer.html "struct bevy::prelude::AnimationPlayer"), [AnimationGraphHandle](struct.AnimationGraphHandle.html "struct bevy::prelude::AnimationGraphHandle"))>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<&'a mut Self::[Property](trait.AnimatableProperty.html#associatedtype.Property "type bevy::prelude::AnimatableProperty::Property"), [AnimationEvaluationError](../animation/enum.AnimationEvaluationError.html "enum bevy::animation::AnimationEvaluationError")\>
