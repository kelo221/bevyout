...
A specialization of the [`Time`](struct.Time.html "struct bevy::prelude::Time") structure. **For method documentation, see [`Time<Real>`](struct.Time.html#impl-Time%3CReal%3E "struct bevy::prelude::Time").**

It is automatically inserted as a resource by [`TimePlugin`](../time/struct.TimePlugin.html "struct bevy::time::TimePlugin") and updated with time instants according to [`TimeUpdateStrategy`](../time/enum.TimeUpdateStrategy.html "enum bevy::time::TimeUpdateStrategy").[1](#fn1)

Note: Using [`TimeUpdateStrategy::ManualDuration`](../time/enum.TimeUpdateStrategy.html#variant.ManualDuration "variant bevy::time::TimeUpdateStrategy::ManualDuration") allows for mocking the wall clock for testing purposes. Besides this use case, it is not recommended to do this, as it will no longer represent “wall clock” time as intended.

The [`delta()`](struct.Time.html#method.delta "method bevy::prelude::Time::delta") and [`elapsed()`](struct.Time.html#method.elapsed "method bevy::prelude::Time::elapsed") values of this clock should be used for anything which deals specifically with real time (wall clock time). It will not be affected by relative game speed adjustments, pausing or other adjustments.[1](#fn1)

The clock does not count time from [`startup()`](struct.Time.html#method.startup "method bevy::prelude::Time::startup") to [`first_update()`](struct.Time.html#method.first_update "method bevy::prelude::Time::first_update") into elapsed, but instead will start counting time from the first update call. [`delta()`](struct.Time.html#method.delta "method bevy::prelude::Time::delta") and [`elapsed()`](struct.Time.html#method.elapsed "method bevy::prelude::Time::elapsed") will report zero on the first update as there is no previous update instant. This means that a [`delta()`](struct.Time.html#method.delta "method bevy::prelude::Time::delta") of zero must be handled without errors in application logic, as it may theoretically also happen at other times.

[`Instant`](../platform/time/struct.Instant.html "struct bevy::platform::time::Instant")s for [`startup()`](struct.Time.html#method.startup "method bevy::prelude::Time::startup"), [`first_update()`](struct.Time.html#method.first_update "method bevy::prelude::Time::first_update") and [`last_update()`](struct.Time.html#method.last_update "method bevy::prelude::Time::last_update") are recorded and accessible.

* * *

1.  When using [`TimeUpdateStrategy::ManualDuration`](../time/enum.TimeUpdateStrategy.html#variant.ManualDuration "variant bevy::time::TimeUpdateStrategy::ManualDuration"), [`Time<Real>`](struct.Time.html#impl-Time%3CReal%3E "struct bevy::prelude::Time") is only a _mock_ of wall clock time. [↩ 1](#fnref1) [2](#fnref1-2)
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Real](struct.Real.html "struct bevy::prelude::Real")

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/real.rs.html#43)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Real](struct.Real.html "struct bevy::prelude::Real")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [Real](struct.Real.html "struct bevy::prelude::Real")

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/real.rs.html#43)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Real](struct.Real.html "struct bevy::prelude::Real")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Real](struct.Real.html "struct bevy::prelude::Real")

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/real.rs.html#52)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Real](struct.Real.html "struct bevy::prelude::Real")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/real.rs.html#44)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Real](struct.Real.html "struct bevy::prelude::Real")

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/real.rs.html#44)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Real](struct.Real.html "struct bevy::prelude::Real")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/real.rs.html#44)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Real](struct.Real.html "struct bevy::prelude::Real") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Real](struct.Real.html "struct bevy::prelude::Real")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Real](struct.Real.html "struct bevy::prelude::Real")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Real](struct.Real.html "struct bevy::prelude::Real")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Real](struct.Real.html "struct bevy::prelude::Real")
...
where [Real](struct.Real.html "struct bevy::prelude::Real"): 'into\_return,
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Real](struct.Real.html "struct bevy::prelude::Real")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Real](struct.Real.html "struct bevy::prelude::Real")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_time/0.19.0/x86_64-unknown-linux-gnu/src/bevy_time/real.rs.html#44)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Real](struct.Real.html "struct bevy::prelude::Real")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Real](struct.Real.html "struct bevy::prelude::Real")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Real](struct.Real.html "struct bevy::prelude::Real")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Real](struct.Real.html "struct bevy::prelude::Real")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Real](struct.Real.html "struct bevy::prelude::Real")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Real](struct.Real.html "struct bevy::prelude::Real")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Real](struct.Real.html "struct bevy::prelude::Real")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Real](struct.Real.html "struct bevy::prelude::Real")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Real](struct.Real.html "struct bevy::prelude::Real")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Real](struct.Real.html "struct bevy::prelude::Real")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Real](struct.Real.html "struct bevy::prelude::Real")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Real](struct.Real.html "struct bevy::prelude::Real")
