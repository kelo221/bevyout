...
The current state value can be accessed through this resource. To _change_ the state, queue a transition in the [`NextState<S>`](enum.NextState.html "enum bevy::prelude::NextState") resource, and it will be applied during the [`StateTransition`](struct.StateTransition.html "struct bevy::prelude::StateTransition") schedule - which by default runs after `PreUpdate`.

You can also manually trigger the [`StateTransition`](struct.StateTransition.html "struct bevy::prelude::StateTransition") schedule to apply the changes at an arbitrary time.
...
### impl<S> [State](struct.State.html "struct bevy::prelude::State")<S>
...
#### pub fn [new](#method.new)(state: S) -> [State](struct.State.html "struct bevy::prelude::State")<S>

Creates a new state with a specific value.

To change the state use [`NextState<S>`](enum.NextState.html "enum bevy::prelude::NextState") rather than using this to modify the `State<S>`.
...
### impl<S> [Component](trait.Component.html "trait bevy::prelude::Component") for [State](struct.State.html "struct bevy::prelude::State")<S>
...
### impl<S> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [State](struct.State.html "struct bevy::prelude::State")<S>
...
### impl<S> [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [State](struct.State.html "struct bevy::prelude::State")<S>
...
#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[State](struct.State.html "struct bevy::prelude::State")<S> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state/resources.rs.html#55)

### impl<S> [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [State](struct.State.html "struct bevy::prelude::State")<S>
...
#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [State](struct.State.html "struct bevy::prelude::State")<S>

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state/resources.rs.html#55)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[State](struct.State.html "struct bevy::prelude::State")<S> as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[State](struct.State.html "struct bevy::prelude::State")<S>>
...
#### fn [from\_world](trait.FromWorld.html#tymethod.from_world)(world: &mut [World](struct.World.html "struct bevy::prelude::World")) -> [State](struct.State.html "struct bevy::prelude::State")<S>

Creates `Self` using data from the given [`World`](struct.World.html "struct bevy::prelude::World").

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state/resources.rs.html#55)

### impl<S> [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [State](struct.State.html "struct bevy::prelude::State")<S>
...
### impl<S> [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [State](struct.State.html "struct bevy::prelude::State")<S>
...
### impl<S> [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [State](struct.State.html "struct bevy::prelude::State")<S>
...
where [State](struct.State.html "struct bevy::prelude::State")<S>: 'into\_return,
...
### impl<S> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq")<S> for [State](struct.State.html "struct bevy::prelude::State")<S>
...
### impl<S> [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [State](struct.State.html "struct bevy::prelude::State")<S>
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[State](struct.State.html "struct bevy::prelude::State")<S>>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state/resources.rs.html#55)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[State](struct.State.html "struct bevy::prelude::State")<S>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[State](struct.State.html "struct bevy::prelude::State")<S>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[State](struct.State.html "struct bevy::prelude::State")<S>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[State](struct.State.html "struct bevy::prelude::State")<S>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<S> [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [State](struct.State.html "struct bevy::prelude::State")<S>
...
### impl<S> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [State](struct.State.html "struct bevy::prelude::State")<S>

where S: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"),

### impl<S> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [State](struct.State.html "struct bevy::prelude::State")<S>
...
### impl<S> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [State](struct.State.html "struct bevy::prelude::State")<S>

### impl<S> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [State](struct.State.html "struct bevy::prelude::State")<S>

### impl<S> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [State](struct.State.html "struct bevy::prelude::State")<S>

where S: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<S> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [State](struct.State.html "struct bevy::prelude::State")<S>

where S: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"),

### impl<S> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [State](struct.State.html "struct bevy::prelude::State")<S>
