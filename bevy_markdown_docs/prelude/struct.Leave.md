...
An ancestor of a [target entity](trait.EntityEvent.html#tymethod.event_target "method bevy::prelude::EntityEvent::event_target") will receive a [`Leave`](struct.Leave.html "struct bevy::prelude::Leave") event when the ancestor does not have a direct relation to any entity hovered by the pointer in the current frame. For example, for a given pointer:
...
[`Leave`](struct.Leave.html "struct bevy::prelude::Leave") events would be sent for both C and its direct ancestor B. A [`Leave`](struct.Leave.html "struct bevy::prelude::Leave") event would not be sent for A because it is a shared ancestor of both C and E.

Note: A [`Leave`](struct.Leave.html "struct bevy::prelude::Leave") event may be fired for an ancestor even if the pointer does not leave the ancestor’s bounds. More concretely, if a child’s bounds extend beyond the parent’s and the pointer leaves from within those extended bounds, two [`Leave`](struct.Leave.html "struct bevy::prelude::Leave") events are still emitted for both the child and the parent. This matches the triggering behavior of `mouseleave` events on the web. To find out whether the pointer was within the target entity’s bounds right before leaving, check the value of [`was_in_bounds`](struct.Leave.html#structfield.was_in_bounds "field bevy::prelude::Leave::was_in_bounds").
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Leave](struct.Leave.html "struct bevy::prelude::Leave")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#273)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Leave](struct.Leave.html "struct bevy::prelude::Leave")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Leave](struct.Leave.html "struct bevy::prelude::Leave")
...
### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Leave](struct.Leave.html "struct bevy::prelude::Leave")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#273)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Leave](struct.Leave.html "struct bevy::prelude::Leave")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#273)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Leave](struct.Leave.html "struct bevy::prelude::Leave") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Leave](struct.Leave.html "struct bevy::prelude::Leave")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Leave](struct.Leave.html "struct bevy::prelude::Leave")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Leave](struct.Leave.html "struct bevy::prelude::Leave")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Leave](struct.Leave.html "struct bevy::prelude::Leave")
...
where [Leave](struct.Leave.html "struct bevy::prelude::Leave"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Leave](struct.Leave.html "struct bevy::prelude::Leave")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#273)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Leave](struct.Leave.html "struct bevy::prelude::Leave")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Leave](struct.Leave.html "struct bevy::prelude::Leave")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Leave](struct.Leave.html "struct bevy::prelude::Leave")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#273)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Leave](struct.Leave.html "struct bevy::prelude::Leave")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Leave](struct.Leave.html "struct bevy::prelude::Leave")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Leave](struct.Leave.html "struct bevy::prelude::Leave")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[Leave](struct.Leave.html "struct bevy::prelude::Leave")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Leave](struct.Leave.html "struct bevy::prelude::Leave")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Leave](struct.Leave.html "struct bevy::prelude::Leave")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Leave](struct.Leave.html "struct bevy::prelude::Leave")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Leave](struct.Leave.html "struct bevy::prelude::Leave")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Leave](struct.Leave.html "struct bevy::prelude::Leave")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Leave](struct.Leave.html "struct bevy::prelude::Leave")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Leave](struct.Leave.html "struct bevy::prelude::Leave")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Leave](struct.Leave.html "struct bevy::prelude::Leave")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Leave](struct.Leave.html "struct bevy::prelude::Leave")
