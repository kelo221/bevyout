...
[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/assets.rs.html#18)
...
`scenes: [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[Handle](enum.Handle.html "enum bevy::prelude::Handle")<[WorldAsset](struct.WorldAsset.html "struct bevy::prelude::WorldAsset")>>`

All scenes loaded from the glTF file.

`named_scenes: [HashMap](../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[Box](struct.Box.html "struct bevy::prelude::Box")<[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)>, [Handle](enum.Handle.html "enum bevy::prelude::Handle")<[WorldAsset](struct.WorldAsset.html "struct bevy::prelude::WorldAsset")>>`

Named scenes loaded from the glTF file.

`meshes: [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[Handle](enum.Handle.html "enum bevy::prelude::Handle")<[GltfMesh](../gltf/struct.GltfMesh.html "struct bevy::gltf::GltfMesh")>>`

All meshes loaded from the glTF file.

`named_meshes: [HashMap](../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[Box](struct.Box.html "struct bevy::prelude::Box")<[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)>, [Handle](enum.Handle.html "enum bevy::prelude::Handle")<[GltfMesh](../gltf/struct.GltfMesh.html "struct bevy::gltf::GltfMesh")>>`

Named meshes loaded from the glTF file.

`materials: [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[Handle](enum.Handle.html "enum bevy::prelude::Handle")<[GltfMaterial](../gltf/struct.GltfMaterial.html "struct bevy::gltf::GltfMaterial")>>`

All materials loaded from the glTF file.

`named_materials: [HashMap](../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[Box](struct.Box.html "struct bevy::prelude::Box")<[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)>, [Handle](enum.Handle.html "enum bevy::prelude::Handle")<[GltfMaterial](../gltf/struct.GltfMaterial.html "struct bevy::gltf::GltfMaterial")>>`

Named materials loaded from the glTF file.

`nodes: [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[Handle](enum.Handle.html "enum bevy::prelude::Handle")<[GltfNode](../gltf/struct.GltfNode.html "struct bevy::gltf::GltfNode")>>`

All nodes loaded from the glTF file.

`named_nodes: [HashMap](../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[Box](struct.Box.html "struct bevy::prelude::Box")<[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)>, [Handle](enum.Handle.html "enum bevy::prelude::Handle")<[GltfNode](../gltf/struct.GltfNode.html "struct bevy::gltf::GltfNode")>>`

Named nodes loaded from the glTF file.

`skins: [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[Handle](enum.Handle.html "enum bevy::prelude::Handle")<[GltfSkin](../gltf/struct.GltfSkin.html "struct bevy::gltf::GltfSkin")>>`

All skins loaded from the glTF file.

`named_skins: [HashMap](../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[Box](struct.Box.html "struct bevy::prelude::Box")<[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)>, [Handle](enum.Handle.html "enum bevy::prelude::Handle")<[GltfSkin](../gltf/struct.GltfSkin.html "struct bevy::gltf::GltfSkin")>>`

Named skins loaded from the glTF file.

`default_scene: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Handle](enum.Handle.html "enum bevy::prelude::Handle")<[WorldAsset](struct.WorldAsset.html "struct bevy::prelude::WorldAsset")>>`

Default scene to be displayed.

`animations: [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[Handle](enum.Handle.html "enum bevy::prelude::Handle")<[AnimationClip](struct.AnimationClip.html "struct bevy::prelude::AnimationClip")>>`

Available on **crate feature `bevy_animation`** only.

All animations loaded from the glTF file.

`named_animations: [HashMap](../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[Box](struct.Box.html "struct bevy::prelude::Box")<[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)>, [Handle](enum.Handle.html "enum bevy::prelude::Handle")<[AnimationClip](struct.AnimationClip.html "struct bevy::prelude::AnimationClip")>>`

Available on **crate feature `bevy_animation`** only.

Named animations loaded from the glTF file.

`source: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Gltf](../gltf/gltf/struct.Gltf.html "struct bevy::gltf::gltf::Gltf")>`

The gltf root of the gltf asset, see [https://docs.rs/gltf/latest/gltf/struct.Gltf.html](https://docs.rs/gltf/latest/gltf/struct.Gltf.html). Only has a value when `GltfLoaderSettings::include_source` is true.
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Gltf](struct.Gltf.html "struct bevy::prelude::Gltf")
...
### impl [VisitAssetDependencies](../asset/trait.VisitAssetDependencies.html "trait bevy::asset::VisitAssetDependencies") for [Gltf](struct.Gltf.html "struct bevy::prelude::Gltf")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Gltf](struct.Gltf.html "struct bevy::prelude::Gltf")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Gltf](struct.Gltf.html "struct bevy::prelude::Gltf")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Gltf](struct.Gltf.html "struct bevy::prelude::Gltf")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Gltf](struct.Gltf.html "struct bevy::prelude::Gltf")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Gltf](struct.Gltf.html "struct bevy::prelude::Gltf")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Gltf](struct.Gltf.html "struct bevy::prelude::Gltf")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Gltf](struct.Gltf.html "struct bevy::prelude::Gltf")
