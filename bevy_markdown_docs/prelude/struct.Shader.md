...
[Source](https://docs.rs/bevy_shader/0.19.0/x86_64-unknown-linux-gnu/src/bevy_shader/shader.rs.html#35)
...
`path: [String](struct.String.html "struct bevy::prelude::String")`

The asset path of the shader.

`source: [Source](../shader/enum.Source.html "enum bevy::shader::Source")`

The raw source code of the shader.

`import_path: [ShaderImport](../shader/enum.ShaderImport.html "enum bevy::shader::ShaderImport")`

The path from which this shader can be imported by other shaders.

`imports: [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[ShaderImport](../shader/enum.ShaderImport.html "enum bevy::shader::ShaderImport")>`

The import paths this shader depends on.

`additional_imports: [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[ImportDefinition](https://docs.rs/naga_oil/0.22.0/x86_64-unknown-linux-gnu/naga_oil/compose/struct.ImportDefinition.html "struct naga_oil::compose::ImportDefinition")>`

Extra imports not specified in the source string.

`shader_defs: [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[ShaderDefVal](../shader/enum.ShaderDefVal.html "enum bevy::shader::ShaderDefVal")>`

Any shader defs that should be included when this module is used.

`file_dependencies: [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[Handle](enum.Handle.html "enum bevy::prelude::Handle")<[Shader](struct.Shader.html "struct bevy::prelude::Shader")>>`

Strong handles to this shader’s dependencies, to prevent them from being immediately dropped if this shader is the only user.

`validate_shader: [ValidateShader](../shader/enum.ValidateShader.html "enum bevy::shader::ValidateShader")`

Enable or disable runtime shader validation, trading safety against speed.

Please read the [`ValidateShader`](../shader/enum.ValidateShader.html "enum bevy::shader::ValidateShader") docs for a discussion of the tradeoffs involved.

## Implementations

[Source](https://docs.rs/bevy_shader/0.19.0/x86_64-unknown-linux-gnu/src/bevy_shader/shader.rs.html#57)

### impl [Shader](struct.Shader.html "struct bevy::prelude::Shader")

[Source](https://docs.rs/bevy_shader/0.19.0/x86_64-unknown-linux-gnu/src/bevy_shader/shader.rs.html#86)

#### pub fn [from\_wgsl](#method.from_wgsl)( source: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Cow](https://doc.rust-lang.org/nightly/alloc/borrow/enum.Cow.html "enum alloc::borrow::Cow")<'static, [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>>, path: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[String](struct.String.html "struct bevy::prelude::String")\>, ) -> [Shader](struct.Shader.html "struct bevy::prelude::Shader")

Creates a new WGSL shader.

##### [Examples found in repository](#scraped-examples)[?](../../scrape-examples-help.html)

examples/2d/mesh2d\_manual.rs ([line 305](../../src/mesh2d_manual/mesh2d_manual.rs.html#305))
...
[Source](https://docs.rs/bevy_shader/0.19.0/x86_64-unknown-linux-gnu/src/bevy_shader/shader.rs.html#103-107)

#### pub fn [from\_wgsl\_with\_defs](#method.from_wgsl_with_defs)( source: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Cow](https://doc.rust-lang.org/nightly/alloc/borrow/enum.Cow.html "enum alloc::borrow::Cow")<'static, [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>>, path: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[String](struct.String.html "struct bevy::prelude::String")\>, shader\_defs: [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[ShaderDefVal](../shader/enum.ShaderDefVal.html "enum bevy::shader::ShaderDefVal")\>, ) -> [Shader](struct.Shader.html "struct bevy::prelude::Shader")

Creates a new WGSL shader with some given shader defs.

[Source](https://docs.rs/bevy_shader/0.19.0/x86_64-unknown-linux-gnu/src/bevy_shader/shader.rs.html#115-119)

#### pub fn [from\_glsl](#method.from_glsl)( source: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Cow](https://doc.rust-lang.org/nightly/alloc/borrow/enum.Cow.html "enum alloc::borrow::Cow")<'static, [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>>, stage: [ShaderStage](../render/render_resource/enum.ShaderStage.html "enum bevy::render::render_resource::ShaderStage"), path: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[String](struct.String.html "struct bevy::prelude::String")\>, ) -> [Shader](struct.Shader.html "struct bevy::prelude::Shader")

Creates a new GLSL shader.

[Source](https://docs.rs/bevy_shader/0.19.0/x86_64-unknown-linux-gnu/src/bevy_shader/shader.rs.html#136)

#### pub fn [from\_spirv](#method.from_spirv)( source: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Cow](https://doc.rust-lang.org/nightly/alloc/borrow/enum.Cow.html "enum alloc::borrow::Cow")<'static, \[[u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)\]>>, path: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[String](struct.String.html "struct bevy::prelude::String")\>, ) -> [Shader](struct.Shader.html "struct bevy::prelude::Shader")

Creates a new SPIR-V shader.

[Source](https://docs.rs/bevy_shader/0.19.0/x86_64-unknown-linux-gnu/src/bevy_shader/shader.rs.html#152)

#### pub fn [from\_wesl](#method.from_wesl)( source: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Cow](https://doc.rust-lang.org/nightly/alloc/borrow/enum.Cow.html "enum alloc::borrow::Cow")<'static, [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>>, path: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[String](struct.String.html "struct bevy::prelude::String")\>, ) -> [Shader](struct.Shader.html "struct bevy::prelude::Shader")

Available on **crate feature `shader_format_wesl`** only.
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Shader](struct.Shader.html "struct bevy::prelude::Shader")

[Source](https://docs.rs/bevy_shader/0.19.0/x86_64-unknown-linux-gnu/src/bevy_shader/shader.rs.html#34)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Shader](struct.Shader.html "struct bevy::prelude::Shader")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Shader](struct.Shader.html "struct bevy::prelude::Shader")
...
### impl [VisitAssetDependencies](../asset/trait.VisitAssetDependencies.html "trait bevy::asset::VisitAssetDependencies") for [Shader](struct.Shader.html "struct bevy::prelude::Shader")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Shader](struct.Shader.html "struct bevy::prelude::Shader")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Shader](struct.Shader.html "struct bevy::prelude::Shader")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Shader](struct.Shader.html "struct bevy::prelude::Shader")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Shader](struct.Shader.html "struct bevy::prelude::Shader")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Shader](struct.Shader.html "struct bevy::prelude::Shader")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Shader](struct.Shader.html "struct bevy::prelude::Shader")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Shader](struct.Shader.html "struct bevy::prelude::Shader")
