...
`0: <[Handle](enum.Handle.html "enum bevy::prelude::Handle")<M> as [FromTemplate](trait.FromTemplate.html "trait bevy::prelude::FromTemplate")>::[Template](trait.FromTemplate.html#associatedtype.Template "type bevy::prelude::FromTemplate::Template")`

## Trait Implementations

[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/ui_material.rs.html#167)

### impl<M> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [MaterialNodeTemplate](struct.MaterialNodeTemplate.html "struct bevy::prelude::MaterialNodeTemplate")<M>

where M: [UiMaterial](trait.UiMaterial.html "trait bevy::prelude::UiMaterial"),

[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/ui_material.rs.html#167)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [MaterialNodeTemplate](struct.MaterialNodeTemplate.html "struct bevy::prelude::MaterialNodeTemplate")<M>
...
#### type [Output](trait.Template.html#associatedtype.Output) = [MaterialNode](struct.MaterialNode.html "struct bevy::prelude::MaterialNode")<M>

The type of value produced by this [`Template`](trait.Template.html "trait bevy::prelude::Template").

[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/ui_material.rs.html#167)

#### fn [build\_template](trait.Template.html#tymethod.build_template)( &self, context: &mut [TemplateContext](../ecs/template/struct.TemplateContext.html "struct bevy::ecs::template::TemplateContext")<'\_, '\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[MaterialNodeTemplate](struct.MaterialNodeTemplate.html "struct bevy::prelude::MaterialNodeTemplate")<M> as [Template](trait.Template.html "trait bevy::prelude::Template")\>::[Output](trait.Template.html#associatedtype.Output "type bevy::prelude::Template::Output"), [BevyError](struct.BevyError.html "struct bevy::prelude::BevyError")\>
...
#### fn [clone\_template](trait.Template.html#tymethod.clone_template)(&self) -> [MaterialNodeTemplate](struct.MaterialNodeTemplate.html "struct bevy::prelude::MaterialNodeTemplate")<M>

Clones this template. See [`Clone`](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone").

## Auto Trait Implementations

### impl<M> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MaterialNodeTemplate](struct.MaterialNodeTemplate.html "struct bevy::prelude::MaterialNodeTemplate")<M>

### impl<M> ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MaterialNodeTemplate](struct.MaterialNodeTemplate.html "struct bevy::prelude::MaterialNodeTemplate")<M>

### impl<M> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MaterialNodeTemplate](struct.MaterialNodeTemplate.html "struct bevy::prelude::MaterialNodeTemplate")<M>

### impl<M> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MaterialNodeTemplate](struct.MaterialNodeTemplate.html "struct bevy::prelude::MaterialNodeTemplate")<M>

### impl<M> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MaterialNodeTemplate](struct.MaterialNodeTemplate.html "struct bevy::prelude::MaterialNodeTemplate")<M>

### impl<M> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MaterialNodeTemplate](struct.MaterialNodeTemplate.html "struct bevy::prelude::MaterialNodeTemplate")<M>

### impl<M> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MaterialNodeTemplate](struct.MaterialNodeTemplate.html "struct bevy::prelude::MaterialNodeTemplate")<M>
