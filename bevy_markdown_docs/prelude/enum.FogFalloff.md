...
*   For `FogFalloff::Exponential`:
    ...
    *   [`FogFalloff::from_visibility()`](enum.FogFalloff.html#method.from_visibility "associated function bevy::prelude::FogFalloff::from_visibility")
    *   [`FogFalloff::from_visibility_contrast()`](enum.FogFalloff.html#method.from_visibility_contrast "associated function bevy::prelude::FogFalloff::from_visibility_contrast")
*   For `FogFalloff::ExponentialSquared`:
    
    *   [`FogFalloff::from_visibility_squared()`](enum.FogFalloff.html#method.from_visibility_squared "associated function bevy::prelude::FogFalloff::from_visibility_squared")
    *   [`FogFalloff::from_visibility_contrast_squared()`](enum.FogFalloff.html#method.from_visibility_contrast_squared "associated function bevy::prelude::FogFalloff::from_visibility_contrast_squared")
*   For `FogFalloff::Atmospheric`:
    
    *   [`FogFalloff::from_visibility_color()`](enum.FogFalloff.html#method.from_visibility_color "associated function bevy::prelude::FogFalloff::from_visibility_color")
    *   [`FogFalloff::from_visibility_colors()`](enum.FogFalloff.html#method.from_visibility_colors "associated function bevy::prelude::FogFalloff::from_visibility_colors")
    *   [`FogFalloff::from_visibility_contrast_color()`](enum.FogFalloff.html#method.from_visibility_contrast_color "associated function bevy::prelude::FogFalloff::from_visibility_contrast_color")
    *   [`FogFalloff::from_visibility_contrast_colors()`](enum.FogFalloff.html#method.from_visibility_contrast_colors "associated function bevy::prelude::FogFalloff::from_visibility_contrast_colors")
...
Initially gains intensity quickly with distance, then more slowly. Typically produces more natural results than [`FogFalloff::Linear`](enum.FogFalloff.html#variant.Linear "variant bevy::prelude::FogFalloff::Linear"), but is a bit harder to control.

To move the fog “further away”, use lower density values. To move it “closer” use higher density values.

##### Tips

*   Use the [`FogFalloff::from_visibility()`](enum.FogFalloff.html#method.from_visibility "associated function bevy::prelude::FogFalloff::from_visibility") convenience method to create an exponential falloff with the proper density for a desired visibility distance in world units;
...
*   Combine the `density` parameter with the [`DistanceFog`](struct.DistanceFog.html "struct bevy::prelude::DistanceFog") `color`’s alpha channel for easier artistic control.
...
Similar to [`FogFalloff::Exponential`](enum.FogFalloff.html#variant.Exponential "variant bevy::prelude::FogFalloff::Exponential"), but grows more slowly in intensity for closer distances before “catching up”.

To move the fog “further away”, use lower density values. To move it “closer” use higher density values.

##### Tips

*   Use the [`FogFalloff::from_visibility_squared()`](enum.FogFalloff.html#method.from_visibility_squared "associated function bevy::prelude::FogFalloff::from_visibility_squared") convenience method to create an exponential squared falloff with the proper density for a desired visibility distance in world units;
*   Combine the `density` parameter with the [`DistanceFog`](struct.DistanceFog.html "struct bevy::prelude::DistanceFog") `color`’s alpha channel for easier artistic control.
...
##### Equivalence to [`FogFalloff::Exponential`](enum.FogFalloff.html#variant.Exponential "variant bevy::prelude::FogFalloff::Exponential")
...
**Note:** While the results are identical, [`FogFalloff::Atmospheric`](enum.FogFalloff.html#variant.Atmospheric "variant bevy::prelude::FogFalloff::Atmospheric") is computationally more expensive.

#### Fields

`extinction: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")`
...
Each component can be thought of as an independent per `R`/`G`/`B` channel `density` factor from [`FogFalloff::Exponential`](enum.FogFalloff.html#variant.Exponential "variant bevy::prelude::FogFalloff::Exponential"): Multiplier applied to the world distance (within the fog falloff calculation) for that specific channel.

**Note:** This value is not a `Color`, since it affects the channels exponentially in a non-intuitive way. For artistic control, use the [`FogFalloff::from_visibility_colors()`](enum.FogFalloff.html#method.from_visibility_colors "associated function bevy::prelude::FogFalloff::from_visibility_colors") convenience method.

`inscattering: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")`

Controls how much light is added due to light scattering from the sun through the atmosphere.

Each component can be thought of as an independent per `R`/`G`/`B` channel `density` factor from [`FogFalloff::Exponential`](enum.FogFalloff.html#variant.Exponential "variant bevy::prelude::FogFalloff::Exponential"): A multiplier applied to the world distance (within the fog falloff calculation) for that specific channel.
...
### impl [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")
...
#### pub fn [from\_visibility](#method.from_visibility)(visibility: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

Creates a [`FogFalloff::Exponential`](enum.FogFalloff.html#variant.Exponential "variant bevy::prelude::FogFalloff::Exponential") value from the given visibility distance in world units, using the revised Koschmieder contrast threshold, [`FogFalloff::REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD`](enum.FogFalloff.html#associatedconstant.REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD "associated constant bevy::prelude::FogFalloff::REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD").

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#321)

#### pub fn [from\_visibility\_contrast](#method.from_visibility_contrast)( visibility: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), contrast\_threshold: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

Creates a [`FogFalloff::Exponential`](enum.FogFalloff.html#variant.Exponential "variant bevy::prelude::FogFalloff::Exponential") value from the given visibility distance in world units, and a given contrast threshold in the range of `0.0` to `1.0`.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#329)

#### pub fn [from\_visibility\_squared](#method.from_visibility_squared)(visibility: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

Creates a [`FogFalloff::ExponentialSquared`](enum.FogFalloff.html#variant.ExponentialSquared "variant bevy::prelude::FogFalloff::ExponentialSquared") value from the given visibility distance in world units, using the revised Koschmieder contrast threshold, [`FogFalloff::REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD`](enum.FogFalloff.html#associatedconstant.REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD "associated constant bevy::prelude::FogFalloff::REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD").

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#338-341)

#### pub fn [from\_visibility\_contrast\_squared](#method.from_visibility_contrast_squared)( visibility: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), contrast\_threshold: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

Creates a [`FogFalloff::ExponentialSquared`](enum.FogFalloff.html#variant.ExponentialSquared "variant bevy::prelude::FogFalloff::ExponentialSquared") value from the given visibility distance in world units, and a given contrast threshold in the range of `0.0` to `1.0`.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#350-353)

#### pub fn [from\_visibility\_color](#method.from_visibility_color)( visibility: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), extinction\_inscattering\_color: [Color](enum.Color.html "enum bevy::prelude::Color"), ) -> [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

Creates a [`FogFalloff::Atmospheric`](enum.FogFalloff.html#variant.Atmospheric "variant bevy::prelude::FogFalloff::Atmospheric") value from the given visibility distance in world units, and a shared color for both extinction and inscattering, using the revised Koschmieder contrast threshold, [`FogFalloff::REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD`](enum.FogFalloff.html#associatedconstant.REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD "associated constant bevy::prelude::FogFalloff::REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD").

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#370-374)

#### pub fn [from\_visibility\_colors](#method.from_visibility_colors)( visibility: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), extinction\_color: [Color](enum.Color.html "enum bevy::prelude::Color"), inscattering\_color: [Color](enum.Color.html "enum bevy::prelude::Color"), ) -> [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

Creates a [`FogFalloff::Atmospheric`](enum.FogFalloff.html#variant.Atmospheric "variant bevy::prelude::FogFalloff::Atmospheric") value from the given visibility distance in world units, extinction and inscattering colors, using the revised Koschmieder contrast threshold, [`FogFalloff::REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD`](enum.FogFalloff.html#associatedconstant.REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD "associated constant bevy::prelude::FogFalloff::REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD").

###### Tips

*   Alpha values of the provided colors can modulate the `extinction` and `inscattering` effects;
*   Using an `extinction_color` of [`Color::WHITE`](enum.Color.html#associatedconstant.WHITE "associated constant bevy::prelude::Color::WHITE") or [`Color::NONE`](enum.Color.html#associatedconstant.NONE "associated constant bevy::prelude::Color::NONE") disables the extinction effect;
*   Using an `inscattering_color` of [`Color::BLACK`](enum.Color.html#associatedconstant.BLACK "associated constant bevy::prelude::Color::BLACK") or [`Color::NONE`](enum.Color.html#associatedconstant.NONE "associated constant bevy::prelude::Color::NONE") disables the inscattering effect.
...
#### pub fn [from\_visibility\_contrast\_color](#method.from_visibility_contrast_color)( visibility: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), contrast\_threshold: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), extinction\_inscattering\_color: [Color](enum.Color.html "enum bevy::prelude::Color"), ) -> [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

Creates a [`FogFalloff::Atmospheric`](enum.FogFalloff.html#variant.Atmospheric "variant bevy::prelude::FogFalloff::Atmospheric") value from the given visibility distance in world units, a contrast threshold in the range of `0.0` to `1.0`, and a shared color for both extinction and inscattering.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#405-410)

#### pub fn [from\_visibility\_contrast\_colors](#method.from_visibility_contrast_colors)( visibility: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), contrast\_threshold: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), extinction\_color: [Color](enum.Color.html "enum bevy::prelude::Color"), inscattering\_color: [Color](enum.Color.html "enum bevy::prelude::Color"), ) -> [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

Creates a [`FogFalloff::Atmospheric`](enum.FogFalloff.html#variant.Atmospheric "variant bevy::prelude::FogFalloff::Atmospheric") value from the given visibility distance in world units, a contrast threshold in the range of `0.0` to `1.0`, extinction and inscattering colors.
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#100)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")
...
### impl [Enum](../reflect/enums/trait.Enum.html "trait bevy::reflect::enums::Enum") for [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")
...
### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#100)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#100)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)(\_\_param0: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")
...
where [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff"): 'into\_return,
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#100)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [FogFalloff](enum.FogFalloff.html "enum bevy::prelude::FogFalloff")
