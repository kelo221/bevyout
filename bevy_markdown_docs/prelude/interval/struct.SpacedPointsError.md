...
# Struct SpacedPointsError 

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/interval.rs.html#43)
...
[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/curve/interval.rs.html#41)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [SpacedPointsError](struct.SpacedPointsError.html "struct bevy::prelude::interval::SpacedPointsError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [SpacedPointsError](struct.SpacedPointsError.html "struct bevy::prelude::interval::SpacedPointsError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [SpacedPointsError](struct.SpacedPointsError.html "struct bevy::prelude::interval::SpacedPointsError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SpacedPointsError](struct.SpacedPointsError.html "struct bevy::prelude::interval::SpacedPointsError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SpacedPointsError](struct.SpacedPointsError.html "struct bevy::prelude::interval::SpacedPointsError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SpacedPointsError](struct.SpacedPointsError.html "struct bevy::prelude::interval::SpacedPointsError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SpacedPointsError](struct.SpacedPointsError.html "struct bevy::prelude::interval::SpacedPointsError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SpacedPointsError](struct.SpacedPointsError.html "struct bevy::prelude::interval::SpacedPointsError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SpacedPointsError](struct.SpacedPointsError.html "struct bevy::prelude::interval::SpacedPointsError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SpacedPointsError](struct.SpacedPointsError.html "struct bevy::prelude::interval::SpacedPointsError")
