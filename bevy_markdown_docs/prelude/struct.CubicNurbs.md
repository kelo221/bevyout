...
When there is no knot multiplicity, the curve is C2 continuous, meaning it has no holes or jumps and the tangent vector changes smoothly along the entire curve length. Like the [`CubicBSpline`](struct.CubicBSpline.html "struct bevy::prelude::CubicBSpline"), the acceleration continuity makes it useful for camera paths. Knot multiplicity of 2 in intermediate knots reduces the continuity to C1, and knot multiplicity of 3 reduces the continuity to C0. The curve is always at least C0, meaning it has no jumps or holes.
...
`control_points: [Vec](struct.Vec.html "struct bevy::prelude::Vec")<P>`

The control points of the NURBS

`weights: [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)>`

Weights

`knots: [Vec](struct.Vec.html "struct bevy::prelude::Vec")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)>`
...
### impl<P> [CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>
...
If provided, the number of knots must be n + 4 elements, where n is the amount of control points. Defaults to open uniform knots: [`Self::open_uniform_knots`](struct.CubicNurbs.html#method.open_uniform_knots "associated function bevy::prelude::CubicNurbs::open_uniform_knots"). Knots cannot all be equal.
...
#### pub fn [uniform\_knots](#method.uniform_knots)(control\_points: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Vec](struct.Vec.html "struct bevy::prelude::Vec")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\>>

Generates uniform knots that will generate the same curve as [`CubicBSpline`](struct.CubicBSpline.html "struct bevy::prelude::CubicBSpline").
...
### impl<P> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>
...
#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>
...
### impl<P> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>
...
### impl<P> [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>
...
#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#611)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P> as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>>
...
### impl<P> [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>
...
### impl<P> [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>
...
### impl<P> [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>
...
where [CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>: 'into\_return,
...
### impl<P> [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#611)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
### impl<P> [RationalGenerator](trait.RationalGenerator.html "trait bevy::prelude::RationalGenerator")<P> for [CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>

where P: [VectorSpace](../math/trait.VectorSpace.html "trait bevy::math::VectorSpace")<Scalar = [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\>,

[Source](https://docs.rs/bevy_math/0.19.0/x86_64-unknown-linux-gnu/src/bevy_math/cubic_splines/mod.rs.html#784)

#### type [Error](trait.RationalGenerator.html#associatedtype.Error) = [InsufficientDataError](../math/cubic_splines/struct.InsufficientDataError.html "struct bevy::math::cubic_splines::InsufficientDataError")
...
#### fn [to\_curve](trait.RationalGenerator.html#tymethod.to_curve)( &self, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[RationalCurve](struct.RationalCurve.html "struct bevy::prelude::RationalCurve")<P>, <[CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P> as [RationalGenerator](trait.RationalGenerator.html "trait bevy::prelude::RationalGenerator")<P>>::[Error](trait.RationalGenerator.html#associatedtype.Error "type bevy::prelude::RationalGenerator::Error")\>

Build a [`RationalCurve`](struct.RationalCurve.html "struct bevy::prelude::RationalCurve") by computing the interpolation coefficients for each curve segment.
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<P> [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>
...
### impl<P> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>

### impl<P> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>
...
### impl<P> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>

where P: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<P> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>

where P: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<P> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>

where P: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<P> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>

### impl<P> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [CubicNurbs](struct.CubicNurbs.html "struct bevy::prelude::CubicNurbs")<P>
