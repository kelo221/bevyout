...
When set to `true` UI picking will only consider cameras marked with [`UiPickingCamera`](struct.UiPickingCamera.html "struct bevy::prelude::UiPickingCamera") and entities marked with [`Pickable`](struct.Pickable.html "struct bevy::prelude::Pickable"). `false` by default.
...
### impl [Component](trait.Component.html "trait bevy::prelude::Component") for [UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/picking_backend.rs.html#65)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/picking_backend.rs.html#45)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/picking_backend.rs.html#45)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/picking_backend.rs.html#45)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings")
...
where [UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings"): 'into\_return,
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/picking_backend.rs.html#45)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [UiPickingSettings](struct.UiPickingSettings.html "struct bevy::prelude::UiPickingSettings")
