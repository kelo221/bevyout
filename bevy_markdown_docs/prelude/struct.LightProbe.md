...
Note that a light probe will have no effect unless the entity contains some kind of illumination, which can either be an [`EnvironmentMapLight`](struct.EnvironmentMapLight.html "struct bevy::prelude::EnvironmentMapLight") or an [`IrradianceVolume`](../light/struct.IrradianceVolume.html "struct bevy::light::IrradianceVolume").

The light probe range is conceptually a unit cube (1×1×1) centered on the origin. The [`Transform`](struct.Transform.html "struct bevy::prelude::Transform") applied to this entity can scale, rotate, or translate that cube so that it contains all fragments that should take this light probe into account.
...
`falloff: [Vec3](struct.Vec3.html "struct bevy::prelude::Vec3")`
...
### impl [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#96)

#### pub fn [new](#method.new)() -> [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#71)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")
...
### impl [Component](trait.Component.html "trait bevy::prelude::Component") for [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")

where [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

**Required Components**: [`Transform`](struct.Transform.html "struct bevy::prelude::Transform"), [`ViewVisibility`](struct.ViewVisibility.html "struct bevy::prelude::ViewVisibility"), [`Visibility`](enum.Visibility.html "enum bevy::prelude::Visibility"), [`VisibilityClass`](../camera/visibility/struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass").
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#71)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#71)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#71)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#71)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#71)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")
...
where [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe"): 'into\_return,
...
### impl [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")
...
#### fn [reflect\_owned](trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_light/0.19.0/x86_64-unknown-linux-gnu/src/bevy_light/probe.rs.html#71)

#### fn [try\_into\_reflect](trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](struct.Box.html "struct bevy::prelude::Box")<[LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](trait.Reflect.html#tymethod.into_any)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](trait.Reflect.html#tymethod.into_reflect)(self: [Box](struct.Box.html "struct bevy::prelude::Box")<[LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")\>) -> [Box](struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [LightProbe](struct.LightProbe.html "struct bevy::prelude::LightProbe")
