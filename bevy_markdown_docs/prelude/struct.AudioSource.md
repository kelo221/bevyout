...
[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio_source.rs.html#8)
...
`bytes: [Arc](../platform/sync/struct.Arc.html "struct bevy::platform::sync::Arc")<[[u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)]>`

Raw data of the audio source.

The data must be one of the file formats supported by Bevy (`wav`, `ogg`, `flac`, or `mp3`). However, support for these file formats is not part of Bevy’s [`default feature set`](https://docs.rs/bevy/latest/bevy/index.html#default-features). In order to be able to use these file formats, you will have to enable the appropriate [`optional features`](https://docs.rs/bevy/latest/bevy/index.html#optional-features).

It is decoded using [`rodio::decoder::Decoder`](https://docs.rs/rodio/latest/rodio/decoder/struct.Decoder.html). The decoder has conditionally compiled methods depending on the features enabled. If the format used is not enabled, then this will panic with an `UnrecognizedFormat` error.

## Trait Implementations

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio_source.rs.html#23)

### impl [AsRef](https://doc.rust-lang.org/nightly/core/convert/trait.AsRef.html "trait core::convert::AsRef")<\[[u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)\]> for [AudioSource](struct.AudioSource.html "struct bevy::prelude::AudioSource")

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio_source.rs.html#24)
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [AudioSource](struct.AudioSource.html "struct bevy::prelude::AudioSource")

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio_source.rs.html#7)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [AudioSource](struct.AudioSource.html "struct bevy::prelude::AudioSource")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [AudioSource](struct.AudioSource.html "struct bevy::prelude::AudioSource")
...
### impl [Decodable](trait.Decodable.html "trait bevy::prelude::Decodable") for [AudioSource](struct.AudioSource.html "struct bevy::prelude::AudioSource")

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio_source.rs.html#94)

#### type [Decoder](trait.Decodable.html#associatedtype.Decoder) = [Decoder](https://docs.rs/rodio/0.22.2/x86_64-unknown-linux-gnu/rodio/decoder/struct.Decoder.html "struct rodio::decoder::Decoder")<[Cursor](https://doc.rust-lang.org/nightly/core/io/cursor/struct.Cursor.html "struct core::io::cursor::Cursor")<[AudioSource](struct.AudioSource.html "struct bevy::prelude::AudioSource")\>>

The type of the iterator of the audio samples, which iterates over samples of type [`rodio::Sample`](../audio/type.Sample.html "type bevy::audio::Sample"). Must be a [`rodio::Source`](../audio/trait.Source.html "trait bevy::audio::Source") so that it can provide information on the audio it is iterating over.

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio_source.rs.html#96)

#### fn [decoder](trait.Decodable.html#tymethod.decoder)(&self) -> <[AudioSource](struct.AudioSource.html "struct bevy::prelude::AudioSource") as [Decodable](trait.Decodable.html "trait bevy::prelude::Decodable")\>::[Decoder](trait.Decodable.html#associatedtype.Decoder "type bevy::prelude::Decodable::Decoder")

Build and return a [`Self::Decoder`](trait.Decodable.html#associatedtype.Decoder "associated type bevy::prelude::Decodable::Decoder") of the implementing type
...
### impl [VisitAssetDependencies](../asset/trait.VisitAssetDependencies.html "trait bevy::asset::VisitAssetDependencies") for [AudioSource](struct.AudioSource.html "struct bevy::prelude::AudioSource")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AudioSource](struct.AudioSource.html "struct bevy::prelude::AudioSource")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AudioSource](struct.AudioSource.html "struct bevy::prelude::AudioSource")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AudioSource](struct.AudioSource.html "struct bevy::prelude::AudioSource")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AudioSource](struct.AudioSource.html "struct bevy::prelude::AudioSource")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AudioSource](struct.AudioSource.html "struct bevy::prelude::AudioSource")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AudioSource](struct.AudioSource.html "struct bevy::prelude::AudioSource")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AudioSource](struct.AudioSource.html "struct bevy::prelude::AudioSource")
