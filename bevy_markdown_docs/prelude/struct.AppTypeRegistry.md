...
### impl [AppTypeRegistry](struct.AppTypeRegistry.html "struct bevy::prelude::AppTypeRegistry")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/reflect/mod.rs.html#59)

#### pub fn [new\_with\_derived\_types](#method.new_with_derived_types)() -> [AppTypeRegistry](struct.AppTypeRegistry.html "struct bevy::prelude::AppTypeRegistry")

Available on **crate feature `reflect_auto_register`** only.

Creates [`AppTypeRegistry`](struct.AppTypeRegistry.html "struct bevy::prelude::AppTypeRegistry") and automatically registers all types deriving [`Reflect`](trait.Reflect.html "trait bevy::prelude::Reflect").
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [AppTypeRegistry](struct.AppTypeRegistry.html "struct bevy::prelude::AppTypeRegistry")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/reflect/mod.rs.html#35)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [AppTypeRegistry](struct.AppTypeRegistry.html "struct bevy::prelude::AppTypeRegistry")
...
### impl [Component](trait.Component.html "trait bevy::prelude::Component") for [AppTypeRegistry](struct.AppTypeRegistry.html "struct bevy::prelude::AppTypeRegistry")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [AppTypeRegistry](struct.AppTypeRegistry.html "struct bevy::prelude::AppTypeRegistry")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/reflect/mod.rs.html#35)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [AppTypeRegistry](struct.AppTypeRegistry.html "struct bevy::prelude::AppTypeRegistry")
...
### impl [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [AppTypeRegistry](struct.AppTypeRegistry.html "struct bevy::prelude::AppTypeRegistry")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AppTypeRegistry](struct.AppTypeRegistry.html "struct bevy::prelude::AppTypeRegistry")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AppTypeRegistry](struct.AppTypeRegistry.html "struct bevy::prelude::AppTypeRegistry")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AppTypeRegistry](struct.AppTypeRegistry.html "struct bevy::prelude::AppTypeRegistry")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AppTypeRegistry](struct.AppTypeRegistry.html "struct bevy::prelude::AppTypeRegistry")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AppTypeRegistry](struct.AppTypeRegistry.html "struct bevy::prelude::AppTypeRegistry")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AppTypeRegistry](struct.AppTypeRegistry.html "struct bevy::prelude::AppTypeRegistry")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AppTypeRegistry](struct.AppTypeRegistry.html "struct bevy::prelude::AppTypeRegistry")
