...
If you know exactly what state you want to respond to ahead of time, consider [`OnEnter`](struct.OnEnter.html "struct bevy::prelude::OnEnter"), [`OnTransition`](struct.OnTransition.html "struct bevy::prelude::OnTransition"), or [`OnExit`](struct.OnExit.html "struct bevy::prelude::OnExit")
...
### impl<S> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [StateTransitionEvent](struct.StateTransitionEvent.html "struct bevy::prelude::StateTransitionEvent")<S>
...
#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [StateTransitionEvent](struct.StateTransitionEvent.html "struct bevy::prelude::StateTransitionEvent")<S>
...
### impl<S> [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [StateTransitionEvent](struct.StateTransitionEvent.html "struct bevy::prelude::StateTransitionEvent")<S>

where S: [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") + [States](trait.States.html "trait bevy::prelude::States"),

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state/transitions.rs.html#67)

### impl<S> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [StateTransitionEvent](struct.StateTransitionEvent.html "struct bevy::prelude::StateTransitionEvent")<S>
...
### impl<S> [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [StateTransitionEvent](struct.StateTransitionEvent.html "struct bevy::prelude::StateTransitionEvent")<S>
...
### impl<S> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [StateTransitionEvent](struct.StateTransitionEvent.html "struct bevy::prelude::StateTransitionEvent")<S>
...
#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[StateTransitionEvent](struct.StateTransitionEvent.html "struct bevy::prelude::StateTransitionEvent")<S>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl<S> [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [StateTransitionEvent](struct.StateTransitionEvent.html "struct bevy::prelude::StateTransitionEvent")<S>

where S: [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") + [States](trait.States.html "trait bevy::prelude::States"),

## Auto Trait Implementations

### impl<S> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [StateTransitionEvent](struct.StateTransitionEvent.html "struct bevy::prelude::StateTransitionEvent")<S>

where S: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"),

### impl<S> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [StateTransitionEvent](struct.StateTransitionEvent.html "struct bevy::prelude::StateTransitionEvent")<S>
...
### impl<S> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [StateTransitionEvent](struct.StateTransitionEvent.html "struct bevy::prelude::StateTransitionEvent")<S>

### impl<S> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [StateTransitionEvent](struct.StateTransitionEvent.html "struct bevy::prelude::StateTransitionEvent")<S>

### impl<S> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [StateTransitionEvent](struct.StateTransitionEvent.html "struct bevy::prelude::StateTransitionEvent")<S>

where S: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<S> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [StateTransitionEvent](struct.StateTransitionEvent.html "struct bevy::prelude::StateTransitionEvent")<S>

where S: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"),

### impl<S> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [StateTransitionEvent](struct.StateTransitionEvent.html "struct bevy::prelude::StateTransitionEvent")<S>
