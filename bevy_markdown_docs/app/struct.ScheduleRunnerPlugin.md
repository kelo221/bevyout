...
# Struct ScheduleRunnerPlugin 

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/schedule_runner.rs.html#50)
...
[`ScheduleRunnerPlugin`](struct.ScheduleRunnerPlugin.html "struct bevy::app::ScheduleRunnerPlugin") is included in the [`MinimalPlugins`](https://docs.rs/bevy/latest/bevy/struct.MinimalPlugins.html) plugin group.

[`ScheduleRunnerPlugin`](struct.ScheduleRunnerPlugin.html "struct bevy::app::ScheduleRunnerPlugin") is _not_ included in the [`DefaultPlugins`](https://docs.rs/bevy/latest/bevy/struct.DefaultPlugins.html) plugin group which assumes that the [`Schedule`](../prelude/struct.Schedule.html "struct bevy::prelude::Schedule") will be executed by other means: typically, the `winit` event loop (see [`WinitPlugin`](https://docs.rs/bevy/latest/bevy/winit/struct.WinitPlugin.html)) executes the schedule making [`ScheduleRunnerPlugin`](struct.ScheduleRunnerPlugin.html "struct bevy::app::ScheduleRunnerPlugin") unnecessary.

## Fields

`run_mode: [RunMode](enum.RunMode.html "enum bevy::app::RunMode")`

Determines whether the [`Schedule`](../prelude/struct.Schedule.html "struct bevy::prelude::Schedule") is run once or repeatedly.

## Implementations

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/schedule_runner.rs.html#55)

### impl [ScheduleRunnerPlugin](struct.ScheduleRunnerPlugin.html "struct bevy::app::ScheduleRunnerPlugin")

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/schedule_runner.rs.html#57)

#### pub fn [run\_once](#method.run_once)() -> [ScheduleRunnerPlugin](struct.ScheduleRunnerPlugin.html "struct bevy::app::ScheduleRunnerPlugin")

See [`RunMode::Once`](enum.RunMode.html#variant.Once "variant bevy::app::RunMode::Once").

##### [Examples found in repository](#scraped-examples)[?](../../scrape-examples-help.html)

examples/app/headless.rs ([line 28](../../src/headless/headless.rs.html#28))
...
[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/schedule_runner.rs.html#64)

#### pub fn [run\_loop](#method.run_loop)(wait\_duration: [Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration")) -> [ScheduleRunnerPlugin](struct.ScheduleRunnerPlugin.html "struct bevy::app::ScheduleRunnerPlugin")

See [`RunMode::Loop`](enum.RunMode.html#variant.Loop "variant bevy::app::RunMode::Loop").

##### [Examples found in repository](#scraped-examples-1)[?](../../scrape-examples-help.html)

examples/app/headless.rs ([lines 36-38](../../src/headless/headless.rs.html#36-38))
...
examples/app/headless\_renderer.rs ([lines 105-108](../../src/headless_renderer/headless_renderer.rs.html#105-108))
...
examples/ecs/ecs\_guide.rs ([line 302](../../src/ecs_guide/ecs_guide.rs.html#302))
...
[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/schedule_runner.rs.html#49)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [ScheduleRunnerPlugin](struct.ScheduleRunnerPlugin.html "struct bevy::app::ScheduleRunnerPlugin")

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/schedule_runner.rs.html#49)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [ScheduleRunnerPlugin](struct.ScheduleRunnerPlugin.html "struct bevy::app::ScheduleRunnerPlugin")
...
[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/schedule_runner.rs.html#74)
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ScheduleRunnerPlugin](struct.ScheduleRunnerPlugin.html "struct bevy::app::ScheduleRunnerPlugin")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ScheduleRunnerPlugin](struct.ScheduleRunnerPlugin.html "struct bevy::app::ScheduleRunnerPlugin")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ScheduleRunnerPlugin](struct.ScheduleRunnerPlugin.html "struct bevy::app::ScheduleRunnerPlugin")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ScheduleRunnerPlugin](struct.ScheduleRunnerPlugin.html "struct bevy::app::ScheduleRunnerPlugin")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ScheduleRunnerPlugin](struct.ScheduleRunnerPlugin.html "struct bevy::app::ScheduleRunnerPlugin")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ScheduleRunnerPlugin](struct.ScheduleRunnerPlugin.html "struct bevy::app::ScheduleRunnerPlugin")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ScheduleRunnerPlugin](struct.ScheduleRunnerPlugin.html "struct bevy::app::ScheduleRunnerPlugin")
