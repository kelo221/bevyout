...
[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/main_schedule.rs.html#57)
...
*   [`StateTransition`](https://docs.rs/bevy/latest/bevy/prelude/struct.StateTransition.html) [1](#fn1)
    *   This means that [`OnEnter(MyState::Foo)`](https://docs.rs/bevy/latest/bevy/prelude/struct.OnEnter.html) will be called _before_ [`PreStartup`](../prelude/struct.PreStartup.html "struct bevy::prelude::PreStartup") if `MyState` was added to the app with `MyState::Foo` as the initial state, as well as [`OnEnter(MyComputedState)`](https://docs.rs/bevy/latest/bevy/prelude/struct.OnEnter.html) if it `compute`s to `Some(Self)` in `MyState::Foo`.
    *   If you want to run systems before any state transitions, regardless of which state is the starting state, for example, for registering required components, you can add your own custom startup schedule before [`StateTransition`](https://docs.rs/bevy/latest/bevy/prelude/struct.StateTransition.html). See [`MainScheduleOrder::insert_startup_before`](struct.MainScheduleOrder.html#method.insert_startup_before "method bevy::app::MainScheduleOrder::insert_startup_before") for more details.
*   [`PreStartup`](../prelude/struct.PreStartup.html "struct bevy::prelude::PreStartup")
*   [`Startup`](../prelude/struct.Startup.html "struct bevy::prelude::Startup")
*   [`PostStartup`](../prelude/struct.PostStartup.html "struct bevy::prelude::PostStartup")

Then it will run:

*   [`First`](../prelude/struct.First.html "struct bevy::prelude::First")
*   [`PreUpdate`](../prelude/struct.PreUpdate.html "struct bevy::prelude::PreUpdate")
*   [`StateTransition`](https://docs.rs/bevy/latest/bevy/prelude/struct.StateTransition.html) [1](#fn1)
*   [`RunFixedMainLoop`](../prelude/struct.RunFixedMainLoop.html "struct bevy::prelude::RunFixedMainLoop")
    *   This will run [`FixedMain`](struct.FixedMain.html "struct bevy::app::FixedMain") zero to many times, based on how much time has elapsed.
*   [`Update`](../prelude/struct.Update.html "struct bevy::prelude::Update")
*   [`SpawnScene`](../prelude/struct.SpawnScene.html "struct bevy::prelude::SpawnScene")
*   [`PostUpdate`](../prelude/struct.PostUpdate.html "struct bevy::prelude::PostUpdate")
*   [`Last`](../prelude/struct.Last.html "struct bevy::prelude::Last")

## Rendering

Note rendering is not executed in the main schedule by default. Instead, rendering is performed in a separate [`SubApp`](../prelude/struct.SubApp.html "struct bevy::prelude::SubApp") which exchanges data with the main app in between the main schedule runs.

See [`RenderPlugin`](https://docs.rs/bevy/latest/bevy/render/struct.RenderPlugin.html) and [`PipelinedRenderingPlugin`](https://docs.rs/bevy/latest/bevy/render/pipelined_rendering/struct.PipelinedRenderingPlugin.html) for more details.

* * *

1.  [`StateTransition`](https://docs.rs/bevy/latest/bevy/prelude/struct.StateTransition.html) is inserted only if you have `bevy_state` feature enabled. It is enabled in `default` features. [↩ 1](#fnref1) [2](#fnref1-2)
    

## Implementations

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/main_schedule.rs.html#288)

### impl [Main](../prelude/struct.Main.html "struct bevy::prelude::Main")

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/main_schedule.rs.html#290)

#### pub fn [run\_main](#method.run_main)(world: &mut [World](../prelude/struct.World.html "struct bevy::prelude::World"), run\_at\_least\_once: [Local](../prelude/struct.Local.html "struct bevy::prelude::Local")<'\_, [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)\>)
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Main](../prelude/struct.Main.html "struct bevy::prelude::Main")

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/main_schedule.rs.html#56)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Main](../prelude/struct.Main.html "struct bevy::prelude::Main")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Main](../prelude/struct.Main.html "struct bevy::prelude::Main")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Main](../prelude/struct.Main.html "struct bevy::prelude::Main")

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/main_schedule.rs.html#56)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Main](../prelude/struct.Main.html "struct bevy::prelude::Main")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/main_schedule.rs.html#56)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [Main](../prelude/struct.Main.html "struct bevy::prelude::Main")

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/main_schedule.rs.html#56)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [Main](../prelude/struct.Main.html "struct bevy::prelude::Main")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Main](../prelude/struct.Main.html "struct bevy::prelude::Main")

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/main_schedule.rs.html#56)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Main](../prelude/struct.Main.html "struct bevy::prelude::Main")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel") for [Main](../prelude/struct.Main.html "struct bevy::prelude::Main")
...
#### fn [dyn\_clone](../ecs/schedule/trait.ScheduleLabel.html#tymethod.dyn_clone)(&self) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")\>
...
#### fn [intern](../ecs/schedule/trait.ScheduleLabel.html#method.intern)(&self) -> [Interned](../ecs/intern/struct.Interned.html "struct bevy::ecs::intern::Interned")<dyn [ScheduleLabel](../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")\>
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Main](../prelude/struct.Main.html "struct bevy::prelude::Main")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Main](../prelude/struct.Main.html "struct bevy::prelude::Main")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Main](../prelude/struct.Main.html "struct bevy::prelude::Main")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Main](../prelude/struct.Main.html "struct bevy::prelude::Main")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Main](../prelude/struct.Main.html "struct bevy::prelude::Main")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Main](../prelude/struct.Main.html "struct bevy::prelude::Main")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Main](../prelude/struct.Main.html "struct bevy::prelude::Main")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Main](../prelude/struct.Main.html "struct bevy::prelude::Main")
