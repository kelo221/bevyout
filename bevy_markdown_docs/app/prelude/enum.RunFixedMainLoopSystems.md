...
Note that in contrast to most other Bevy schedules, systems added directly to [`RunFixedMainLoop`](../../prelude/struct.RunFixedMainLoop.html "struct bevy::prelude::RunFixedMainLoop") will _not_ be parallelized between each other.
...
Contains the fixed update logic. Runs [`FixedMain`](../struct.FixedMain.html "struct bevy::app::FixedMain") zero or more times based on delta of [`Time<Virtual>`](https://docs.rs/bevy/latest/bevy/prelude/struct.Virtual.html) and [`Time::overstep`](https://docs.rs/bevy/latest/bevy/time/struct.Time.html#method.overstep).

Don’t place systems here, use [`FixedUpdate`](../../prelude/struct.FixedUpdate.html "struct bevy::prelude::FixedUpdate") and friends instead. Use this system instead to order your systems to run specifically inbetween the fixed update logic and all other systems that run in [`RunFixedMainLoopSystems::BeforeFixedMainLoop`](../../prelude/enum.RunFixedMainLoopSystems.html#variant.BeforeFixedMainLoop "variant bevy::prelude::RunFixedMainLoopSystems::BeforeFixedMainLoop") or [`RunFixedMainLoopSystems::AfterFixedMainLoop`](../../prelude/enum.RunFixedMainLoopSystems.html#variant.AfterFixedMainLoop "variant bevy::prelude::RunFixedMainLoopSystems::AfterFixedMainLoop").
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [RunFixedMainLoopSystems](../../prelude/enum.RunFixedMainLoopSystems.html "enum bevy::prelude::RunFixedMainLoopSystems")

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/main_schedule.rs.html#412)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [RunFixedMainLoopSystems](../../prelude/enum.RunFixedMainLoopSystems.html "enum bevy::prelude::RunFixedMainLoopSystems")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [RunFixedMainLoopSystems](../../prelude/enum.RunFixedMainLoopSystems.html "enum bevy::prelude::RunFixedMainLoopSystems")

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/main_schedule.rs.html#412)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [RunFixedMainLoopSystems](../../prelude/enum.RunFixedMainLoopSystems.html "enum bevy::prelude::RunFixedMainLoopSystems")
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [RunFixedMainLoopSystems](../../prelude/enum.RunFixedMainLoopSystems.html "enum bevy::prelude::RunFixedMainLoopSystems")

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/main_schedule.rs.html#412)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [RunFixedMainLoopSystems](../../prelude/enum.RunFixedMainLoopSystems.html "enum bevy::prelude::RunFixedMainLoopSystems")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [RunFixedMainLoopSystems](../../prelude/enum.RunFixedMainLoopSystems.html "enum bevy::prelude::RunFixedMainLoopSystems")

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/main_schedule.rs.html#412)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[RunFixedMainLoopSystems](../../prelude/enum.RunFixedMainLoopSystems.html "enum bevy::prelude::RunFixedMainLoopSystems")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [RunFixedMainLoopSystems](../../prelude/enum.RunFixedMainLoopSystems.html "enum bevy::prelude::RunFixedMainLoopSystems")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RunFixedMainLoopSystems](../../prelude/enum.RunFixedMainLoopSystems.html "enum bevy::prelude::RunFixedMainLoopSystems")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RunFixedMainLoopSystems](../../prelude/enum.RunFixedMainLoopSystems.html "enum bevy::prelude::RunFixedMainLoopSystems")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RunFixedMainLoopSystems](../../prelude/enum.RunFixedMainLoopSystems.html "enum bevy::prelude::RunFixedMainLoopSystems")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RunFixedMainLoopSystems](../../prelude/enum.RunFixedMainLoopSystems.html "enum bevy::prelude::RunFixedMainLoopSystems")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RunFixedMainLoopSystems](../../prelude/enum.RunFixedMainLoopSystems.html "enum bevy::prelude::RunFixedMainLoopSystems")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RunFixedMainLoopSystems](../../prelude/enum.RunFixedMainLoopSystems.html "enum bevy::prelude::RunFixedMainLoopSystems")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RunFixedMainLoopSystems](../../prelude/enum.RunFixedMainLoopSystems.html "enum bevy::prelude::RunFixedMainLoopSystems")
