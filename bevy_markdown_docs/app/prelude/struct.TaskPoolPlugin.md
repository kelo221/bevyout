...
`task_pool_options: [TaskPoolOptions](../../prelude/struct.TaskPoolOptions.html "struct bevy::prelude::TaskPoolOptions")`
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [TaskPoolPlugin](../../prelude/struct.TaskPoolPlugin.html "struct bevy::prelude::TaskPoolPlugin")

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/task_pool_plugin.rs.html#26)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [TaskPoolPlugin](../../prelude/struct.TaskPoolPlugin.html "struct bevy::prelude::TaskPoolPlugin")
...
#### fn [build](../../prelude/trait.Plugin.html#tymethod.build)(&self, \_app: &mut [App](../../prelude/struct.App.html "struct bevy::prelude::App"))
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TaskPoolPlugin](../../prelude/struct.TaskPoolPlugin.html "struct bevy::prelude::TaskPoolPlugin")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TaskPoolPlugin](../../prelude/struct.TaskPoolPlugin.html "struct bevy::prelude::TaskPoolPlugin")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TaskPoolPlugin](../../prelude/struct.TaskPoolPlugin.html "struct bevy::prelude::TaskPoolPlugin")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TaskPoolPlugin](../../prelude/struct.TaskPoolPlugin.html "struct bevy::prelude::TaskPoolPlugin")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TaskPoolPlugin](../../prelude/struct.TaskPoolPlugin.html "struct bevy::prelude::TaskPoolPlugin")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TaskPoolPlugin](../../prelude/struct.TaskPoolPlugin.html "struct bevy::prelude::TaskPoolPlugin")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TaskPoolPlugin](../../prelude/struct.TaskPoolPlugin.html "struct bevy::prelude::TaskPoolPlugin")
