...
[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/panic_handler.rs.html#38)
...
*   On Wasm, uses [`console_error_panic_hook`](https://crates.io/crates/console_error_panic_hook), logging to the browser console.
...
[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/panic_handler.rs.html#37)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [PanicHandlerPlugin](struct.PanicHandlerPlugin.html "struct bevy::app::PanicHandlerPlugin")

[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/panic_handler.rs.html#37)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [PanicHandlerPlugin](struct.PanicHandlerPlugin.html "struct bevy::app::PanicHandlerPlugin")
...
[Source](https://docs.rs/bevy_app/0.19.0/x86_64-unknown-linux-gnu/src/bevy_app/panic_handler.rs.html#41)
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [PanicHandlerPlugin](struct.PanicHandlerPlugin.html "struct bevy::app::PanicHandlerPlugin")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [PanicHandlerPlugin](struct.PanicHandlerPlugin.html "struct bevy::app::PanicHandlerPlugin")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [PanicHandlerPlugin](struct.PanicHandlerPlugin.html "struct bevy::app::PanicHandlerPlugin")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [PanicHandlerPlugin](struct.PanicHandlerPlugin.html "struct bevy::app::PanicHandlerPlugin")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [PanicHandlerPlugin](struct.PanicHandlerPlugin.html "struct bevy::app::PanicHandlerPlugin")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [PanicHandlerPlugin](struct.PanicHandlerPlugin.html "struct bevy::app::PanicHandlerPlugin")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [PanicHandlerPlugin](struct.PanicHandlerPlugin.html "struct bevy::app::PanicHandlerPlugin")
