...
1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/core/io/error.rs.html#45)
...
It is used with the [`io::Error`](../../std/io/struct.Error.html) type.
...
Unlike [`InvalidInput`](enum.ErrorKind.html#variant.InvalidInput "variant bevy::tasks::futures_lite::io::ErrorKind::InvalidInput"), this typically means that the operation parameters were valid, however the error was caused by malformed input data.
...
An error returned when an operation could not be completed because a call to [`write`](../../std/io/trait.Write.html#tymethod.write) returned [`Ok(0)`](https://doc.rust-lang.org/nightly/core/result/enum.Result.html#variant.Ok "variant core::result::Result::Ok").
...
This can be used to construct your own [`Error`](../../std/io/struct.Error.html)s that do not match any [`ErrorKind`](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind").

This [`ErrorKind`](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind") is not used by the standard library.

Errors from the standard library that do not fall under any of the I/O error kinds cannot be `match`ed on, and will only match a wildcard (`_`) pattern. New [`ErrorKind`](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind")s might be added in the future for some of those.

## Trait Implementations

1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/core/io/error.rs.html#40)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ErrorKind](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind")

[Source](https://doc.rust-lang.org/nightly/src/core/io/error.rs.html#40)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ErrorKind](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [ErrorKind](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind")

1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/core/io/error.rs.html#40)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ErrorKind](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind")
...
1.60.0 · [Source](https://doc.rust-lang.org/nightly/src/core/io/error.rs.html#388)

### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [ErrorKind](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind")

[Source](https://doc.rust-lang.org/nightly/src/core/io/error.rs.html#398)
...
Shows a human-readable description of the [`ErrorKind`](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind").
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [ErrorKind](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind")
...
### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [ErrorKind](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind")
...
### impl [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [ErrorKind](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind")

[Source](https://doc.rust-lang.org/nightly/src/core/io/error.rs.html#40)

#### fn [cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html#tymethod.cmp)(&self, other: &[ErrorKind](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind")) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [ErrorKind](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind")

[Source](https://doc.rust-lang.org/nightly/src/core/io/error.rs.html#40)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[ErrorKind](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [ErrorKind](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind")

[Source](https://doc.rust-lang.org/nightly/src/core/io/error.rs.html#40)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[ErrorKind](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")\>
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [ErrorKind](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ErrorKind](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ErrorKind](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ErrorKind](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ErrorKind](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ErrorKind](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ErrorKind](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ErrorKind](enum.ErrorKind.html "enum bevy::tasks::futures_lite::io::ErrorKind")
