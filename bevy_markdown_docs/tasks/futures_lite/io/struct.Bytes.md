...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/io.rs.html#2545-2552)
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/io.rs.html#2547)

### impl<R> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Bytes](struct.Bytes.html "struct bevy::tasks::futures_lite::io::Bytes")<R>
...
### impl<R> [Stream](../trait.Stream.html "trait bevy::tasks::futures_lite::Stream") for [Bytes](struct.Bytes.html "struct bevy::tasks::futures_lite::io::Bytes")<R>
...
#### type [Item](../trait.Stream.html#associatedtype.Item) = [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html), [Error](struct.Error.html "struct bevy::tasks::futures_lite::io::Error")\>

Values yielded by the stream.

[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/io.rs.html#2557)

#### fn [poll\_next](../trait.Stream.html#tymethod.poll_next)( self: [Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<&mut [Bytes](struct.Bytes.html "struct bevy::tasks::futures_lite::io::Bytes")<R>>, cx: &mut [Context](https://doc.rust-lang.org/nightly/core/task/wake/struct.Context.html "struct core::task::wake::Context")<'\_>, ) -> [Poll](https://doc.rust-lang.org/nightly/core/task/poll/enum.Poll.html "enum core::task::poll::Poll")<[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[Bytes](struct.Bytes.html "struct bevy::tasks::futures_lite::io::Bytes")<R> as [Stream](../trait.Stream.html "trait bevy::tasks::futures_lite::Stream")\>::[Item](../trait.Stream.html#associatedtype.Item "type bevy::tasks::futures_lite::Stream::Item")\>>
...
### impl<'\_\_pin, R> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Bytes](struct.Bytes.html "struct bevy::tasks::futures_lite::io::Bytes")<R>
...
### impl<R> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Bytes](struct.Bytes.html "struct bevy::tasks::futures_lite::io::Bytes")<R>

where R: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"),

### impl<R> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Bytes](struct.Bytes.html "struct bevy::tasks::futures_lite::io::Bytes")<R>
...
### impl<R> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Bytes](struct.Bytes.html "struct bevy::tasks::futures_lite::io::Bytes")<R>

where R: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<R> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Bytes](struct.Bytes.html "struct bevy::tasks::futures_lite::io::Bytes")<R>

where R: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<R> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Bytes](struct.Bytes.html "struct bevy::tasks::futures_lite::io::Bytes")<R>

where R: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"),

### impl<R> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Bytes](struct.Bytes.html "struct bevy::tasks::futures_lite::io::Bytes")<R>
...
#### fn [next](../trait.StreamExt.html#method.next)(&mut self) -> [NextFuture](../stream/struct.NextFuture.html "struct bevy::tasks::futures_lite::stream::NextFuture")<'\_, Self> [ⓘ](#)
...
#### fn [try\_next](../trait.StreamExt.html#method.try_next)<T, E>(&mut self) -> [TryNextFuture](../stream/struct.TryNextFuture.html "struct bevy::tasks::futures_lite::stream::TryNextFuture")<'\_, Self> [ⓘ](#)
...
#### fn [count](../trait.StreamExt.html#method.count)(self) -> [CountFuture](../stream/struct.CountFuture.html "struct bevy::tasks::futures_lite::stream::CountFuture")<Self> [ⓘ](#)
...
#### fn [map](../trait.StreamExt.html#method.map)<T, F>(self, f: F) -> [Map](../stream/struct.Map.html "struct bevy::tasks::futures_lite::stream::Map")<Self, F>
...
#### fn [flat\_map](../trait.StreamExt.html#method.flat_map)<U, F>(self, f: F) -> [FlatMap](../stream/struct.FlatMap.html "struct bevy::tasks::futures_lite::stream::FlatMap")<Self, U, F>
...
#### fn [flatten](../trait.StreamExt.html#method.flatten)(self) -> [Flatten](../stream/struct.Flatten.html "struct bevy::tasks::futures_lite::stream::Flatten")<Self>
...
#### fn [then](../trait.StreamExt.html#method.then)<F, Fut>(self, f: F) -> [Then](../stream/struct.Then.html "struct bevy::tasks::futures_lite::stream::Then")<Self, F, Fut>
...
#### fn [filter](../trait.StreamExt.html#method.filter)<P>(self, predicate: P) -> [Filter](../stream/struct.Filter.html "struct bevy::tasks::futures_lite::stream::Filter")<Self, P>
...
#### fn [filter\_map](../trait.StreamExt.html#method.filter_map)<T, F>(self, f: F) -> [FilterMap](../stream/struct.FilterMap.html "struct bevy::tasks::futures_lite::stream::FilterMap")<Self, F>
...
#### fn [take](../trait.StreamExt.html#method.take)(self, n: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [Take](../stream/struct.Take.html "struct bevy::tasks::futures_lite::stream::Take")<Self>
...
#### fn [take\_while](../trait.StreamExt.html#method.take_while)<P>(self, predicate: P) -> [TakeWhile](../stream/struct.TakeWhile.html "struct bevy::tasks::futures_lite::stream::TakeWhile")<Self, P>
...
#### fn [map\_while](../trait.StreamExt.html#method.map_while)<B, P>(self, predicate: P) -> [MapWhile](../stream/struct.MapWhile.html "struct bevy::tasks::futures_lite::stream::MapWhile")<Self, P>
...
#### fn [skip](../trait.StreamExt.html#method.skip)(self, n: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [Skip](../stream/struct.Skip.html "struct bevy::tasks::futures_lite::stream::Skip")<Self>
...
#### fn [skip\_while](../trait.StreamExt.html#method.skip_while)<P>(self, predicate: P) -> [SkipWhile](../stream/struct.SkipWhile.html "struct bevy::tasks::futures_lite::stream::SkipWhile")<Self, P>
...
#### fn [step\_by](../trait.StreamExt.html#method.step_by)(self, step: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [StepBy](../stream/struct.StepBy.html "struct bevy::tasks::futures_lite::stream::StepBy")<Self>
...
#### fn [chain](../trait.StreamExt.html#method.chain)<U>(self, other: U) -> [Chain](../stream/struct.Chain.html "struct bevy::tasks::futures_lite::stream::Chain")<Self, U>
...
#### fn [cloned](../trait.StreamExt.html#method.cloned)<'a, T>(self) -> [Cloned](../stream/struct.Cloned.html "struct bevy::tasks::futures_lite::stream::Cloned")<Self>
...
#### fn [copied](../trait.StreamExt.html#method.copied)<'a, T>(self) -> [Copied](../stream/struct.Copied.html "struct bevy::tasks::futures_lite::stream::Copied")<Self>
...
#### fn [collect](../trait.StreamExt.html#method.collect)<C>(self) -> [CollectFuture](../stream/struct.CollectFuture.html "struct bevy::tasks::futures_lite::stream::CollectFuture")<Self, C> [ⓘ](#)
...
#### fn [try\_collect](../trait.StreamExt.html#method.try_collect)<T, E, C>(self) -> [TryCollectFuture](../stream/struct.TryCollectFuture.html "struct bevy::tasks::futures_lite::stream::TryCollectFuture")<Self, C> [ⓘ](#)
...
#### fn [partition](../trait.StreamExt.html#method.partition)<B, P>(self, predicate: P) -> [PartitionFuture](../stream/struct.PartitionFuture.html "struct bevy::tasks::futures_lite::stream::PartitionFuture")<Self, P, B> [ⓘ](#)
...
#### fn [fold](../trait.StreamExt.html#method.fold)<T, F>(self, init: T, f: F) -> [FoldFuture](../stream/struct.FoldFuture.html "struct bevy::tasks::futures_lite::stream::FoldFuture")<Self, F, T> [ⓘ](#)
...
#### fn [try\_fold](../trait.StreamExt.html#method.try_fold)<T, E, F, B>( &mut self, init: B, f: F, ) -> [TryFoldFuture](../stream/struct.TryFoldFuture.html "struct bevy::tasks::futures_lite::stream::TryFoldFuture")<'\_, Self, F, B> [ⓘ](#)
...
#### fn [scan](../trait.StreamExt.html#method.scan)<St, B, F>(self, initial\_state: St, f: F) -> [Scan](../stream/struct.Scan.html "struct bevy::tasks::futures_lite::stream::Scan")<Self, St, F>
...
#### fn [fuse](../trait.StreamExt.html#method.fuse)(self) -> [Fuse](../stream/struct.Fuse.html "struct bevy::tasks::futures_lite::stream::Fuse")<Self>
...
#### fn [cycle](../trait.StreamExt.html#method.cycle)(self) -> [Cycle](../stream/struct.Cycle.html "struct bevy::tasks::futures_lite::stream::Cycle")<Self>
...
#### fn [enumerate](../trait.StreamExt.html#method.enumerate)(self) -> [Enumerate](../stream/struct.Enumerate.html "struct bevy::tasks::futures_lite::stream::Enumerate")<Self>
...
#### fn [inspect](../trait.StreamExt.html#method.inspect)<F>(self, f: F) -> [Inspect](../stream/struct.Inspect.html "struct bevy::tasks::futures_lite::stream::Inspect")<Self, F>
...
#### fn [nth](../trait.StreamExt.html#method.nth)(&mut self, n: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [NthFuture](../stream/struct.NthFuture.html "struct bevy::tasks::futures_lite::stream::NthFuture")<'\_, Self> [ⓘ](#)
...
#### fn [last](../trait.StreamExt.html#method.last)(self) -> [LastFuture](../stream/struct.LastFuture.html "struct bevy::tasks::futures_lite::stream::LastFuture")<Self> [ⓘ](#)
...
#### fn [find](../trait.StreamExt.html#method.find)<P>(&mut self, predicate: P) -> [FindFuture](../stream/struct.FindFuture.html "struct bevy::tasks::futures_lite::stream::FindFuture")<'\_, Self, P> [ⓘ](#)
...
#### fn [find\_map](../trait.StreamExt.html#method.find_map)<F, B>(&mut self, f: F) -> [FindMapFuture](../stream/struct.FindMapFuture.html "struct bevy::tasks::futures_lite::stream::FindMapFuture")<'\_, Self, F> [ⓘ](#)
...
#### fn [position](../trait.StreamExt.html#method.position)<P>(&mut self, predicate: P) -> [PositionFuture](../stream/struct.PositionFuture.html "struct bevy::tasks::futures_lite::stream::PositionFuture")<'\_, Self, P> [ⓘ](#)
...
#### fn [all](../trait.StreamExt.html#method.all)<P>(&mut self, predicate: P) -> [AllFuture](../stream/struct.AllFuture.html "struct bevy::tasks::futures_lite::stream::AllFuture")<'\_, Self, P> [ⓘ](#)
...
#### fn [any](../trait.StreamExt.html#method.any)<P>(&mut self, predicate: P) -> [AnyFuture](../stream/struct.AnyFuture.html "struct bevy::tasks::futures_lite::stream::AnyFuture")<'\_, Self, P> [ⓘ](#)
...
#### fn [for\_each](../trait.StreamExt.html#method.for_each)<F>(self, f: F) -> [ForEachFuture](../stream/struct.ForEachFuture.html "struct bevy::tasks::futures_lite::stream::ForEachFuture")<Self, F> [ⓘ](#)
...
#### fn [try\_for\_each](../trait.StreamExt.html#method.try_for_each)<F, E>(&mut self, f: F) -> [TryForEachFuture](../stream/struct.TryForEachFuture.html "struct bevy::tasks::futures_lite::stream::TryForEachFuture")<'\_, Self, F> [ⓘ](#)
...
#### fn [zip](../trait.StreamExt.html#method.zip)<U>(self, other: U) -> [Zip](../stream/struct.Zip.html "struct bevy::tasks::futures_lite::stream::Zip")<Self, U>
...
#### fn [unzip](../trait.StreamExt.html#method.unzip)<A, B, FromA, FromB>(self) -> [UnzipFuture](../stream/struct.UnzipFuture.html "struct bevy::tasks::futures_lite::stream::UnzipFuture")<Self, FromA, FromB> [ⓘ](#)
...
#### fn [or](../trait.StreamExt.html#method.or)<S>(self, other: S) -> [Or](../stream/struct.Or.html "struct bevy::tasks::futures_lite::stream::Or")<Self, S>
...
#### fn [race](../trait.StreamExt.html#method.race)<S>(self, other: S) -> [Race](../stream/struct.Race.html "struct bevy::tasks::futures_lite::stream::Race")<Self, S>
...
#### fn [drain](../trait.StreamExt.html#method.drain)(&mut self) -> [Drain](../stream/struct.Drain.html "struct bevy::tasks::futures_lite::stream::Drain")<'\_, Self>
