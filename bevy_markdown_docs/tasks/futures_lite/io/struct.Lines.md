...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/io.rs.html#1862-1873)
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/io.rs.html#1864)

### impl<R> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Lines](struct.Lines.html "struct bevy::tasks::futures_lite::io::Lines")<R>
...
### impl<R> [Stream](../trait.Stream.html "trait bevy::tasks::futures_lite::Stream") for [Lines](struct.Lines.html "struct bevy::tasks::futures_lite::io::Lines")<R>
...
#### type [Item](../trait.Stream.html#associatedtype.Item) = [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[String](../../../prelude/struct.String.html "struct bevy::prelude::String"), [Error](struct.Error.html "struct bevy::tasks::futures_lite::io::Error")\>

Values yielded by the stream.

[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/io.rs.html#1878)

#### fn [poll\_next](../trait.Stream.html#tymethod.poll_next)( self: [Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<&mut [Lines](struct.Lines.html "struct bevy::tasks::futures_lite::io::Lines")<R>>, cx: &mut [Context](https://doc.rust-lang.org/nightly/core/task/wake/struct.Context.html "struct core::task::wake::Context")<'\_>, ) -> [Poll](https://doc.rust-lang.org/nightly/core/task/poll/enum.Poll.html "enum core::task::poll::Poll")<[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[Lines](struct.Lines.html "struct bevy::tasks::futures_lite::io::Lines")<R> as [Stream](../trait.Stream.html "trait bevy::tasks::futures_lite::Stream")\>::[Item](../trait.Stream.html#associatedtype.Item "type bevy::tasks::futures_lite::Stream::Item")\>>
...
### impl<'\_\_pin, R> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Lines](struct.Lines.html "struct bevy::tasks::futures_lite::io::Lines")<R>
...
### impl<R> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Lines](struct.Lines.html "struct bevy::tasks::futures_lite::io::Lines")<R>

where R: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"),

### impl<R> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Lines](struct.Lines.html "struct bevy::tasks::futures_lite::io::Lines")<R>
...
### impl<R> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Lines](struct.Lines.html "struct bevy::tasks::futures_lite::io::Lines")<R>

where R: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<R> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Lines](struct.Lines.html "struct bevy::tasks::futures_lite::io::Lines")<R>

where R: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<R> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Lines](struct.Lines.html "struct bevy::tasks::futures_lite::io::Lines")<R>

where R: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"),

### impl<R> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Lines](struct.Lines.html "struct bevy::tasks::futures_lite::io::Lines")<R>
