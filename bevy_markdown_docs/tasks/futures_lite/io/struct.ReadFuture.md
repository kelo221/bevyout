...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/io.rs.html#2201)

```rust
pub struct ReadFuture<'a, R>where
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/io.rs.html#2199)

### impl<'a, R> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ReadFuture](struct.ReadFuture.html "struct bevy::tasks::futures_lite::io::ReadFuture")<'a, R>
...
### impl<R> [Future](../trait.Future.html "trait bevy::tasks::futures_lite::Future") for [ReadFuture](struct.ReadFuture.html "struct bevy::tasks::futures_lite::io::ReadFuture")<'\_, R>
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/io.rs.html#2211)

#### fn [poll](../trait.Future.html#tymethod.poll)( self: [Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<&mut [ReadFuture](struct.ReadFuture.html "struct bevy::tasks::futures_lite::io::ReadFuture")<'\_, R>>, cx: &mut [Context](https://doc.rust-lang.org/nightly/core/task/wake/struct.Context.html "struct core::task::wake::Context")<'\_>, ) -> [Poll](https://doc.rust-lang.org/nightly/core/task/poll/enum.Poll.html "enum core::task::poll::Poll")<<[ReadFuture](struct.ReadFuture.html "struct bevy::tasks::futures_lite::io::ReadFuture")<'\_, R> as [Future](../trait.Future.html "trait bevy::tasks::futures_lite::Future")\>::[Output](../trait.Future.html#associatedtype.Output "type bevy::tasks::futures_lite::Future::Output")\>
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/io.rs.html#2206)

### impl<R> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ReadFuture](struct.ReadFuture.html "struct bevy::tasks::futures_lite::io::ReadFuture")<'\_, R>
...
### impl<'a, R> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ReadFuture](struct.ReadFuture.html "struct bevy::tasks::futures_lite::io::ReadFuture")<'a, R>

### impl<'a, R> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ReadFuture](struct.ReadFuture.html "struct bevy::tasks::futures_lite::io::ReadFuture")<'a, R>

where R: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

### impl<'a, R> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ReadFuture](struct.ReadFuture.html "struct bevy::tasks::futures_lite::io::ReadFuture")<'a, R>
...
### impl<'a, R> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ReadFuture](struct.ReadFuture.html "struct bevy::tasks::futures_lite::io::ReadFuture")<'a, R>
...
### impl<'a, R> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ReadFuture](struct.ReadFuture.html "struct bevy::tasks::futures_lite::io::ReadFuture")<'a, R>
...
### impl<'a, R> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ReadFuture](struct.ReadFuture.html "struct bevy::tasks::futures_lite::io::ReadFuture")<'a, R>
