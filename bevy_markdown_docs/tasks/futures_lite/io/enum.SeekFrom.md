...
1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/std/io/mod.rs.html#1958)
...
It is used by the [`Seek`](https://doc.rust-lang.org/nightly/std/io/trait.Seek.html "trait std::io::Seek") trait.

## Variants

1.0.0

### Start([u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html))

Sets the offset to the provided number of bytes.

1.0.0

### End([i64](https://doc.rust-lang.org/nightly/std/primitive.i64.html))
...
### Current([i64](https://doc.rust-lang.org/nightly/std/primitive.i64.html))
...
1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/std/io/mod.rs.html#1955)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [SeekFrom](enum.SeekFrom.html "enum bevy::tasks::futures_lite::io::SeekFrom")

[Source](https://doc.rust-lang.org/nightly/src/std/io/mod.rs.html#1955)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [SeekFrom](enum.SeekFrom.html "enum bevy::tasks::futures_lite::io::SeekFrom")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [SeekFrom](enum.SeekFrom.html "enum bevy::tasks::futures_lite::io::SeekFrom")

1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/std/io/mod.rs.html#1955)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [SeekFrom](enum.SeekFrom.html "enum bevy::tasks::futures_lite::io::SeekFrom")
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [SeekFrom](enum.SeekFrom.html "enum bevy::tasks::futures_lite::io::SeekFrom")

1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/std/io/mod.rs.html#1955)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [SeekFrom](enum.SeekFrom.html "enum bevy::tasks::futures_lite::io::SeekFrom")

[Source](https://doc.rust-lang.org/nightly/src/std/io/mod.rs.html#1955)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[SeekFrom](enum.SeekFrom.html "enum bevy::tasks::futures_lite::io::SeekFrom")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [SeekFrom](enum.SeekFrom.html "enum bevy::tasks::futures_lite::io::SeekFrom")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SeekFrom](enum.SeekFrom.html "enum bevy::tasks::futures_lite::io::SeekFrom")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SeekFrom](enum.SeekFrom.html "enum bevy::tasks::futures_lite::io::SeekFrom")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SeekFrom](enum.SeekFrom.html "enum bevy::tasks::futures_lite::io::SeekFrom")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SeekFrom](enum.SeekFrom.html "enum bevy::tasks::futures_lite::io::SeekFrom")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SeekFrom](enum.SeekFrom.html "enum bevy::tasks::futures_lite::io::SeekFrom")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SeekFrom](enum.SeekFrom.html "enum bevy::tasks::futures_lite::io::SeekFrom")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SeekFrom](enum.SeekFrom.html "enum bevy::tasks::futures_lite::io::SeekFrom")
