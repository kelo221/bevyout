...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#555-565)
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#557)

### impl<T, F, Fut> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [TryUnfold](struct.TryUnfold.html "struct bevy::tasks::futures_lite::stream::TryUnfold")<T, F, Fut>
...
#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [TryUnfold](struct.TryUnfold.html "struct bevy::tasks::futures_lite::stream::TryUnfold")<T, F, Fut>
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#567-570)

### impl<T, F, Fut> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [TryUnfold](struct.TryUnfold.html "struct bevy::tasks::futures_lite::stream::TryUnfold")<T, F, Fut>
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#572)
...
### impl<T, E, F, Fut, Item> [Stream](../trait.Stream.html "trait bevy::tasks::futures_lite::Stream") for [TryUnfold](struct.TryUnfold.html "struct bevy::tasks::futures_lite::stream::TryUnfold")<T, F, Fut>
...
#### type [Item](../trait.Stream.html#associatedtype.Item) = [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<Item, E>

Values yielded by the stream.

[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#587)

#### fn [poll\_next](../trait.Stream.html#tymethod.poll_next)( self: [Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<&mut [TryUnfold](struct.TryUnfold.html "struct bevy::tasks::futures_lite::stream::TryUnfold")<T, F, Fut>>, cx: &mut [Context](https://doc.rust-lang.org/nightly/core/task/wake/struct.Context.html "struct core::task::wake::Context")<'\_>, ) -> [Poll](https://doc.rust-lang.org/nightly/core/task/poll/enum.Poll.html "enum core::task::poll::Poll")<[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[TryUnfold](struct.TryUnfold.html "struct bevy::tasks::futures_lite::stream::TryUnfold")<T, F, Fut> as [Stream](../trait.Stream.html "trait bevy::tasks::futures_lite::Stream")\>::[Item](../trait.Stream.html#associatedtype.Item "type bevy::tasks::futures_lite::Stream::Item")\>>
...
### impl<'\_\_pin, T, F, Fut> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TryUnfold](struct.TryUnfold.html "struct bevy::tasks::futures_lite::stream::TryUnfold")<T, F, Fut>
...
### impl<T, F, Fut> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TryUnfold](struct.TryUnfold.html "struct bevy::tasks::futures_lite::stream::TryUnfold")<T, F, Fut>
...
### impl<T, F, Fut> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TryUnfold](struct.TryUnfold.html "struct bevy::tasks::futures_lite::stream::TryUnfold")<T, F, Fut>
...
### impl<T, F, Fut> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TryUnfold](struct.TryUnfold.html "struct bevy::tasks::futures_lite::stream::TryUnfold")<T, F, Fut>
...
### impl<T, F, Fut> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TryUnfold](struct.TryUnfold.html "struct bevy::tasks::futures_lite::stream::TryUnfold")<T, F, Fut>
...
### impl<T, F, Fut> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TryUnfold](struct.TryUnfold.html "struct bevy::tasks::futures_lite::stream::TryUnfold")<T, F, Fut>
...
### impl<T, F, Fut> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TryUnfold](struct.TryUnfold.html "struct bevy::tasks::futures_lite::stream::TryUnfold")<T, F, Fut>
