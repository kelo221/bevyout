...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#2101)

```rust
pub struct NextFuture<'a, S>where
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#2099)

### impl<'a, S> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [NextFuture](struct.NextFuture.html "struct bevy::tasks::futures_lite::stream::NextFuture")<'a, S>
...
### impl<S> [Future](../trait.Future.html "trait bevy::tasks::futures_lite::Future") for [NextFuture](struct.NextFuture.html "struct bevy::tasks::futures_lite::stream::NextFuture")<'\_, S>
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#2110)

#### fn [poll](../trait.Future.html#tymethod.poll)( self: [Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<&mut [NextFuture](struct.NextFuture.html "struct bevy::tasks::futures_lite::stream::NextFuture")<'\_, S>>, cx: &mut [Context](https://doc.rust-lang.org/nightly/core/task/wake/struct.Context.html "struct core::task::wake::Context")<'\_>, ) -> [Poll](https://doc.rust-lang.org/nightly/core/task/poll/enum.Poll.html "enum core::task::poll::Poll")<<[NextFuture](struct.NextFuture.html "struct bevy::tasks::futures_lite::stream::NextFuture")<'\_, S> as [Future](../trait.Future.html "trait bevy::tasks::futures_lite::Future")\>::[Output](../trait.Future.html#associatedtype.Output "type bevy::tasks::futures_lite::Future::Output")\>
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#2105)

### impl<S> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [NextFuture](struct.NextFuture.html "struct bevy::tasks::futures_lite::stream::NextFuture")<'\_, S>
...
### impl<'a, S> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [NextFuture](struct.NextFuture.html "struct bevy::tasks::futures_lite::stream::NextFuture")<'a, S>

### impl<'a, S> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [NextFuture](struct.NextFuture.html "struct bevy::tasks::futures_lite::stream::NextFuture")<'a, S>

where S: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

### impl<'a, S> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [NextFuture](struct.NextFuture.html "struct bevy::tasks::futures_lite::stream::NextFuture")<'a, S>
...
### impl<'a, S> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [NextFuture](struct.NextFuture.html "struct bevy::tasks::futures_lite::stream::NextFuture")<'a, S>
...
### impl<'a, S> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [NextFuture](struct.NextFuture.html "struct bevy::tasks::futures_lite::stream::NextFuture")<'a, S>
...
### impl<'a, S> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [NextFuture](struct.NextFuture.html "struct bevy::tasks::futures_lite::stream::NextFuture")<'a, S>
