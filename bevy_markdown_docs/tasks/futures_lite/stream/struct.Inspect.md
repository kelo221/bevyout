...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#3099-3108)

```rust
pub struct Inspect<S, F> { /* private fields */ }
```
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#3101)

### impl<S, F> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Inspect](struct.Inspect.html "struct bevy::tasks::futures_lite::stream::Inspect")<S, F>

where S: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"), F: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#3101)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Inspect](struct.Inspect.html "struct bevy::tasks::futures_lite::stream::Inspect")<S, F>
...
### impl<S, F> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Inspect](struct.Inspect.html "struct bevy::tasks::futures_lite::stream::Inspect")<S, F>
...
### impl<S, F> [Stream](../trait.Stream.html "trait bevy::tasks::futures_lite::Stream") for [Inspect](struct.Inspect.html "struct bevy::tasks::futures_lite::stream::Inspect")<S, F>
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#3117)

#### fn [poll\_next](../trait.Stream.html#tymethod.poll_next)( self: [Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<&mut [Inspect](struct.Inspect.html "struct bevy::tasks::futures_lite::stream::Inspect")<S, F>>, cx: &mut [Context](https://doc.rust-lang.org/nightly/core/task/wake/struct.Context.html "struct core::task::wake::Context")<'\_>, ) -> [Poll](https://doc.rust-lang.org/nightly/core/task/poll/enum.Poll.html "enum core::task::poll::Poll")<[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[Inspect](struct.Inspect.html "struct bevy::tasks::futures_lite::stream::Inspect")<S, F> as [Stream](../trait.Stream.html "trait bevy::tasks::futures_lite::Stream")\>::[Item](../trait.Stream.html#associatedtype.Item "type bevy::tasks::futures_lite::Stream::Item")\>>
...
### impl<'\_\_pin, S, F> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Inspect](struct.Inspect.html "struct bevy::tasks::futures_lite::stream::Inspect")<S, F>
...
### impl<S, F> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Inspect](struct.Inspect.html "struct bevy::tasks::futures_lite::stream::Inspect")<S, F>
...
### impl<S, F> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Inspect](struct.Inspect.html "struct bevy::tasks::futures_lite::stream::Inspect")<S, F>
...
### impl<S, F> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Inspect](struct.Inspect.html "struct bevy::tasks::futures_lite::stream::Inspect")<S, F>
...
### impl<S, F> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Inspect](struct.Inspect.html "struct bevy::tasks::futures_lite::stream::Inspect")<S, F>
...
### impl<S, F> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Inspect](struct.Inspect.html "struct bevy::tasks::futures_lite::stream::Inspect")<S, F>
...
### impl<S, F> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Inspect](struct.Inspect.html "struct bevy::tasks::futures_lite::stream::Inspect")<S, F>
