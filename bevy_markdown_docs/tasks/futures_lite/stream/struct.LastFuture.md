...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#3156-3165)

```rust
pub struct LastFuture<S>where
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#3158)

### impl<S> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [LastFuture](struct.LastFuture.html "struct bevy::tasks::futures_lite::stream::LastFuture")<S>
...
### impl<S> [Future](../trait.Future.html "trait bevy::tasks::futures_lite::Future") for [LastFuture](struct.LastFuture.html "struct bevy::tasks::futures_lite::stream::LastFuture")<S>
...
#### type [Output](../trait.Future.html#associatedtype.Output) = [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<S as [Stream](../trait.Stream.html "trait bevy::tasks::futures_lite::Stream")\>::[Item](../trait.Stream.html#associatedtype.Item "type bevy::tasks::futures_lite::Stream::Item")\>

The type of value produced on completion.

[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#3170)

#### fn [poll](../trait.Future.html#tymethod.poll)( self: [Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<&mut [LastFuture](struct.LastFuture.html "struct bevy::tasks::futures_lite::stream::LastFuture")<S>>, cx: &mut [Context](https://doc.rust-lang.org/nightly/core/task/wake/struct.Context.html "struct core::task::wake::Context")<'\_>, ) -> [Poll](https://doc.rust-lang.org/nightly/core/task/poll/enum.Poll.html "enum core::task::poll::Poll")<<[LastFuture](struct.LastFuture.html "struct bevy::tasks::futures_lite::stream::LastFuture")<S> as [Future](../trait.Future.html "trait bevy::tasks::futures_lite::Future")\>::[Output](../trait.Future.html#associatedtype.Output "type bevy::tasks::futures_lite::Future::Output")\>
...
### impl<'\_\_pin, S> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [LastFuture](struct.LastFuture.html "struct bevy::tasks::futures_lite::stream::LastFuture")<S>
...
### impl<S> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [LastFuture](struct.LastFuture.html "struct bevy::tasks::futures_lite::stream::LastFuture")<S>
...
### impl<S> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [LastFuture](struct.LastFuture.html "struct bevy::tasks::futures_lite::stream::LastFuture")<S>
...
### impl<S> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [LastFuture](struct.LastFuture.html "struct bevy::tasks::futures_lite::stream::LastFuture")<S>
...
### impl<S> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [LastFuture](struct.LastFuture.html "struct bevy::tasks::futures_lite::stream::LastFuture")<S>
...
### impl<S> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [LastFuture](struct.LastFuture.html "struct bevy::tasks::futures_lite::stream::LastFuture")<S>
...
### impl<S> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [LastFuture](struct.LastFuture.html "struct bevy::tasks::futures_lite::stream::LastFuture")<S>
