...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#2728-2737)
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#2730)

### impl<S, F> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [FilterMap](struct.FilterMap.html "struct bevy::tasks::futures_lite::stream::FilterMap")<S, F>
...
#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [FilterMap](struct.FilterMap.html "struct bevy::tasks::futures_lite::stream::FilterMap")<S, F>
...
### impl<S, F> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [FilterMap](struct.FilterMap.html "struct bevy::tasks::futures_lite::stream::FilterMap")<S, F>
...
### impl<S, F, T> [Stream](../trait.Stream.html "trait bevy::tasks::futures_lite::Stream") for [FilterMap](struct.FilterMap.html "struct bevy::tasks::futures_lite::stream::FilterMap")<S, F>
...
#### type [Item](../trait.Stream.html#associatedtype.Item) = T

Values yielded by the stream.

[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#2746)

#### fn [poll\_next](../trait.Stream.html#tymethod.poll_next)( self: [Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<&mut [FilterMap](struct.FilterMap.html "struct bevy::tasks::futures_lite::stream::FilterMap")<S, F>>, cx: &mut [Context](https://doc.rust-lang.org/nightly/core/task/wake/struct.Context.html "struct core::task::wake::Context")<'\_>, ) -> [Poll](https://doc.rust-lang.org/nightly/core/task/poll/enum.Poll.html "enum core::task::poll::Poll")<[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[FilterMap](struct.FilterMap.html "struct bevy::tasks::futures_lite::stream::FilterMap")<S, F> as [Stream](../trait.Stream.html "trait bevy::tasks::futures_lite::Stream")\>::[Item](../trait.Stream.html#associatedtype.Item "type bevy::tasks::futures_lite::Stream::Item")\>>
...
### impl<'\_\_pin, S, F> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [FilterMap](struct.FilterMap.html "struct bevy::tasks::futures_lite::stream::FilterMap")<S, F>
...
### impl<S, F> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [FilterMap](struct.FilterMap.html "struct bevy::tasks::futures_lite::stream::FilterMap")<S, F>
...
### impl<S, F> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [FilterMap](struct.FilterMap.html "struct bevy::tasks::futures_lite::stream::FilterMap")<S, F>
...
### impl<S, F> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [FilterMap](struct.FilterMap.html "struct bevy::tasks::futures_lite::stream::FilterMap")<S, F>
...
### impl<S, F> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [FilterMap](struct.FilterMap.html "struct bevy::tasks::futures_lite::stream::FilterMap")<S, F>
...
### impl<S, F> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [FilterMap](struct.FilterMap.html "struct bevy::tasks::futures_lite::stream::FilterMap")<S, F>
...
### impl<S, F> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [FilterMap](struct.FilterMap.html "struct bevy::tasks::futures_lite::stream::FilterMap")<S, F>
