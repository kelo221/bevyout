...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#2356-2365)

```rust
pub struct Fuse<S> { /* private fields */ }
```
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#2358)

### impl<S> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Fuse](struct.Fuse.html "struct bevy::tasks::futures_lite::stream::Fuse")<S>

where S: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#2358)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Fuse](struct.Fuse.html "struct bevy::tasks::futures_lite::stream::Fuse")<S>
...
### impl<S> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Fuse](struct.Fuse.html "struct bevy::tasks::futures_lite::stream::Fuse")<S>
...
### impl<S> [Stream](../trait.Stream.html "trait bevy::tasks::futures_lite::Stream") for [Fuse](struct.Fuse.html "struct bevy::tasks::futures_lite::stream::Fuse")<S>
...
### impl<'\_\_pin, S> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Fuse](struct.Fuse.html "struct bevy::tasks::futures_lite::stream::Fuse")<S>
...
### impl<S> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Fuse](struct.Fuse.html "struct bevy::tasks::futures_lite::stream::Fuse")<S>

where S: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"),

### impl<S> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Fuse](struct.Fuse.html "struct bevy::tasks::futures_lite::stream::Fuse")<S>
...
### impl<S> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Fuse](struct.Fuse.html "struct bevy::tasks::futures_lite::stream::Fuse")<S>

where S: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<S> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Fuse](struct.Fuse.html "struct bevy::tasks::futures_lite::stream::Fuse")<S>

where S: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<S> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Fuse](struct.Fuse.html "struct bevy::tasks::futures_lite::stream::Fuse")<S>

where S: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"),

### impl<S> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Fuse](struct.Fuse.html "struct bevy::tasks::futures_lite::stream::Fuse")<S>
