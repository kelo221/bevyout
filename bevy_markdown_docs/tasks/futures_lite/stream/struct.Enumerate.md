...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#3068-3077)

```rust
pub struct Enumerate<S> { /* private fields */ }
```
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#3070)

### impl<S> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Enumerate](struct.Enumerate.html "struct bevy::tasks::futures_lite::stream::Enumerate")<S>

where S: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#3070)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Enumerate](struct.Enumerate.html "struct bevy::tasks::futures_lite::stream::Enumerate")<S>
...
### impl<S> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Enumerate](struct.Enumerate.html "struct bevy::tasks::futures_lite::stream::Enumerate")<S>
...
### impl<S> [Stream](../trait.Stream.html "trait bevy::tasks::futures_lite::Stream") for [Enumerate](struct.Enumerate.html "struct bevy::tasks::futures_lite::stream::Enumerate")<S>
...
#### type [Item](../trait.Stream.html#associatedtype.Item) = ([usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), <S as [Stream](../trait.Stream.html "trait bevy::tasks::futures_lite::Stream")\>::[Item](../trait.Stream.html#associatedtype.Item "type bevy::tasks::futures_lite::Stream::Item"))

Values yielded by the stream.

[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#3085)

#### fn [poll\_next](../trait.Stream.html#tymethod.poll_next)( self: [Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<&mut [Enumerate](struct.Enumerate.html "struct bevy::tasks::futures_lite::stream::Enumerate")<S>>, cx: &mut [Context](https://doc.rust-lang.org/nightly/core/task/wake/struct.Context.html "struct core::task::wake::Context")<'\_>, ) -> [Poll](https://doc.rust-lang.org/nightly/core/task/poll/enum.Poll.html "enum core::task::poll::Poll")<[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[Enumerate](struct.Enumerate.html "struct bevy::tasks::futures_lite::stream::Enumerate")<S> as [Stream](../trait.Stream.html "trait bevy::tasks::futures_lite::Stream")\>::[Item](../trait.Stream.html#associatedtype.Item "type bevy::tasks::futures_lite::Stream::Item")\>>
...
### impl<'\_\_pin, S> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Enumerate](struct.Enumerate.html "struct bevy::tasks::futures_lite::stream::Enumerate")<S>

where <PinnedFieldsOfHelperStruct<\_\_Origin<'\_\_pin, S>> as PinnedFieldsOfHelperTrait>::Actual: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

## Auto Trait Implementations

### impl<S> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Enumerate](struct.Enumerate.html "struct bevy::tasks::futures_lite::stream::Enumerate")<S>

where S: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"),

### impl<S> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Enumerate](struct.Enumerate.html "struct bevy::tasks::futures_lite::stream::Enumerate")<S>
...
### impl<S> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Enumerate](struct.Enumerate.html "struct bevy::tasks::futures_lite::stream::Enumerate")<S>

where S: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<S> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Enumerate](struct.Enumerate.html "struct bevy::tasks::futures_lite::stream::Enumerate")<S>

where S: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<S> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Enumerate](struct.Enumerate.html "struct bevy::tasks::futures_lite::stream::Enumerate")<S>

where S: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"),

### impl<S> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Enumerate](struct.Enumerate.html "struct bevy::tasks::futures_lite::stream::Enumerate")<S>
