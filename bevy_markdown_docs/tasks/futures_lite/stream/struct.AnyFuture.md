...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#3308)

```rust
pub struct AnyFuture<'a, S, P>where
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#3306)

### impl<'a, S, P> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [AnyFuture](struct.AnyFuture.html "struct bevy::tasks::futures_lite::stream::AnyFuture")<'a, S, P>
...
### impl<S, P> [Future](../trait.Future.html "trait bevy::tasks::futures_lite::Future") for [AnyFuture](struct.AnyFuture.html "struct bevy::tasks::futures_lite::stream::AnyFuture")<'\_, S, P>
...
#### type [Output](../trait.Future.html#associatedtype.Output) = [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

The type of value produced on completion.

[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#3322)

#### fn [poll](../trait.Future.html#tymethod.poll)( self: [Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<&mut [AnyFuture](struct.AnyFuture.html "struct bevy::tasks::futures_lite::stream::AnyFuture")<'\_, S, P>>, cx: &mut [Context](https://doc.rust-lang.org/nightly/core/task/wake/struct.Context.html "struct core::task::wake::Context")<'\_>, ) -> [Poll](https://doc.rust-lang.org/nightly/core/task/poll/enum.Poll.html "enum core::task::poll::Poll")<<[AnyFuture](struct.AnyFuture.html "struct bevy::tasks::futures_lite::stream::AnyFuture")<'\_, S, P> as [Future](../trait.Future.html "trait bevy::tasks::futures_lite::Future")\>::[Output](../trait.Future.html#associatedtype.Output "type bevy::tasks::futures_lite::Future::Output")\>
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#3313)

### impl<S, P> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AnyFuture](struct.AnyFuture.html "struct bevy::tasks::futures_lite::stream::AnyFuture")<'\_, S, P>
...
### impl<'a, S, P> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AnyFuture](struct.AnyFuture.html "struct bevy::tasks::futures_lite::stream::AnyFuture")<'a, S, P>

### impl<'a, S, P> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AnyFuture](struct.AnyFuture.html "struct bevy::tasks::futures_lite::stream::AnyFuture")<'a, S, P>
...
### impl<'a, S, P> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AnyFuture](struct.AnyFuture.html "struct bevy::tasks::futures_lite::stream::AnyFuture")<'a, S, P>
...
### impl<'a, S, P> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AnyFuture](struct.AnyFuture.html "struct bevy::tasks::futures_lite::stream::AnyFuture")<'a, S, P>
...
### impl<'a, S, P> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AnyFuture](struct.AnyFuture.html "struct bevy::tasks::futures_lite::stream::AnyFuture")<'a, S, P>
...
### impl<'a, S, P> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AnyFuture](struct.AnyFuture.html "struct bevy::tasks::futures_lite::stream::AnyFuture")<'a, S, P>
