...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#2535-2544)

```rust
pub struct Filter<S, P> { /* private fields */ }
```
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#2537)

### impl<S, P> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Filter](struct.Filter.html "struct bevy::tasks::futures_lite::stream::Filter")<S, P>
...
#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Filter](struct.Filter.html "struct bevy::tasks::futures_lite::stream::Filter")<S, P>
...
### impl<S, P> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Filter](struct.Filter.html "struct bevy::tasks::futures_lite::stream::Filter")<S, P>
...
### impl<S, P> [Stream](../trait.Stream.html "trait bevy::tasks::futures_lite::Stream") for [Filter](struct.Filter.html "struct bevy::tasks::futures_lite::stream::Filter")<S, P>
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#2553)

#### fn [poll\_next](../trait.Stream.html#tymethod.poll_next)( self: [Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<&mut [Filter](struct.Filter.html "struct bevy::tasks::futures_lite::stream::Filter")<S, P>>, cx: &mut [Context](https://doc.rust-lang.org/nightly/core/task/wake/struct.Context.html "struct core::task::wake::Context")<'\_>, ) -> [Poll](https://doc.rust-lang.org/nightly/core/task/poll/enum.Poll.html "enum core::task::poll::Poll")<[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[Filter](struct.Filter.html "struct bevy::tasks::futures_lite::stream::Filter")<S, P> as [Stream](../trait.Stream.html "trait bevy::tasks::futures_lite::Stream")\>::[Item](../trait.Stream.html#associatedtype.Item "type bevy::tasks::futures_lite::Stream::Item")\>>
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/stream.rs.html#2564)
...
### impl<'\_\_pin, S, P> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Filter](struct.Filter.html "struct bevy::tasks::futures_lite::stream::Filter")<S, P>
...
### impl<S, P> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Filter](struct.Filter.html "struct bevy::tasks::futures_lite::stream::Filter")<S, P>
...
### impl<S, P> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Filter](struct.Filter.html "struct bevy::tasks::futures_lite::stream::Filter")<S, P>
...
### impl<S, P> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Filter](struct.Filter.html "struct bevy::tasks::futures_lite::stream::Filter")<S, P>
...
### impl<S, P> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Filter](struct.Filter.html "struct bevy::tasks::futures_lite::stream::Filter")<S, P>
...
### impl<S, P> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Filter](struct.Filter.html "struct bevy::tasks::futures_lite::stream::Filter")<S, P>
...
### impl<S, P> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Filter](struct.Filter.html "struct bevy::tasks::futures_lite::stream::Filter")<S, P>
