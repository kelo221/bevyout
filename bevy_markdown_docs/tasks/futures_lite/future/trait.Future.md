...
### impl<F> [Future](../trait.Future.html "trait bevy::tasks::futures_lite::Future") for bevy::tasks::futures\_lite::future::[CatchUnwind](struct.CatchUnwind.html "struct bevy::tasks::futures_lite::future::CatchUnwind")<F>
...
### impl<Fut> [Future](../trait.Future.html "trait bevy::tasks::futures_lite::Future") for bevy::tasks::futures\_lite::future::[Fuse](struct.Fuse.html "struct bevy::tasks::futures_lite::future::Fuse")<Fut>
...
### impl<T, F> [Future](../trait.Future.html "trait bevy::tasks::futures_lite::Future") for bevy::tasks::futures\_lite::future::[PollFn](struct.PollFn.html "struct bevy::tasks::futures_lite::future::PollFn")<F>
...
### impl<T> [Future](../trait.Future.html "trait bevy::tasks::futures_lite::Future") for bevy::tasks::futures\_lite::future::[Pending](struct.Pending.html "struct bevy::tasks::futures_lite::future::Pending")<T>
...
### impl<T> [Future](../trait.Future.html "trait bevy::tasks::futures_lite::Future") for bevy::tasks::futures\_lite::future::[Ready](struct.Ready.html "struct bevy::tasks::futures_lite::future::Ready")<T>
