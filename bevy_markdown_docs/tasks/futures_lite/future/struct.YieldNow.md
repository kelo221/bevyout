...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/future.rs.html#223)

```rust
pub struct YieldNow(/* private fields */);
```
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/future.rs.html#221)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [YieldNow](struct.YieldNow.html "struct bevy::tasks::futures_lite::future::YieldNow")
...
### impl [Future](../trait.Future.html "trait bevy::tasks::futures_lite::Future") for [YieldNow](struct.YieldNow.html "struct bevy::tasks::futures_lite::future::YieldNow")
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/future.rs.html#228)

#### fn [poll](../trait.Future.html#tymethod.poll)( self: [Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<&mut [YieldNow](struct.YieldNow.html "struct bevy::tasks::futures_lite::future::YieldNow")\>, cx: &mut [Context](https://doc.rust-lang.org/nightly/core/task/wake/struct.Context.html "struct core::task::wake::Context")<'\_>, ) -> [Poll](https://doc.rust-lang.org/nightly/core/task/poll/enum.Poll.html "enum core::task::poll::Poll")<<[YieldNow](struct.YieldNow.html "struct bevy::tasks::futures_lite::future::YieldNow") as [Future](../trait.Future.html "trait bevy::tasks::futures_lite::Future")\>::[Output](../trait.Future.html#associatedtype.Output "type bevy::tasks::futures_lite::Future::Output")\>
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [YieldNow](struct.YieldNow.html "struct bevy::tasks::futures_lite::future::YieldNow")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [YieldNow](struct.YieldNow.html "struct bevy::tasks::futures_lite::future::YieldNow")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [YieldNow](struct.YieldNow.html "struct bevy::tasks::futures_lite::future::YieldNow")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [YieldNow](struct.YieldNow.html "struct bevy::tasks::futures_lite::future::YieldNow")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [YieldNow](struct.YieldNow.html "struct bevy::tasks::futures_lite::future::YieldNow")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [YieldNow](struct.YieldNow.html "struct bevy::tasks::futures_lite::future::YieldNow")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [YieldNow](struct.YieldNow.html "struct bevy::tasks::futures_lite::future::YieldNow")
