...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/future.rs.html#637-645)

```rust
pub struct CatchUnwind<F> { /* private fields */ }
```
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/future.rs.html#639)

### impl<F> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [CatchUnwind](struct.CatchUnwind.html "struct bevy::tasks::futures_lite::future::CatchUnwind")<F>
...
### impl<F> [Future](../trait.Future.html "trait bevy::tasks::futures_lite::Future") for [CatchUnwind](struct.CatchUnwind.html "struct bevy::tasks::futures_lite::future::CatchUnwind")<F>
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/future.rs.html#651)

#### fn [poll](../trait.Future.html#tymethod.poll)( self: [Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<&mut [CatchUnwind](struct.CatchUnwind.html "struct bevy::tasks::futures_lite::future::CatchUnwind")<F>>, cx: &mut [Context](https://doc.rust-lang.org/nightly/core/task/wake/struct.Context.html "struct core::task::wake::Context")<'\_>, ) -> [Poll](https://doc.rust-lang.org/nightly/core/task/poll/enum.Poll.html "enum core::task::poll::Poll")<<[CatchUnwind](struct.CatchUnwind.html "struct bevy::tasks::futures_lite::future::CatchUnwind")<F> as [Future](../trait.Future.html "trait bevy::tasks::futures_lite::Future")\>::[Output](../trait.Future.html#associatedtype.Output "type bevy::tasks::futures_lite::Future::Output")\>
...
### impl<'\_\_pin, F> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [CatchUnwind](struct.CatchUnwind.html "struct bevy::tasks::futures_lite::future::CatchUnwind")<F>
...
### impl<F> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [CatchUnwind](struct.CatchUnwind.html "struct bevy::tasks::futures_lite::future::CatchUnwind")<F>

where F: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"),

### impl<F> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [CatchUnwind](struct.CatchUnwind.html "struct bevy::tasks::futures_lite::future::CatchUnwind")<F>
...
### impl<F> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [CatchUnwind](struct.CatchUnwind.html "struct bevy::tasks::futures_lite::future::CatchUnwind")<F>

where F: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<F> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [CatchUnwind](struct.CatchUnwind.html "struct bevy::tasks::futures_lite::future::CatchUnwind")<F>

where F: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<F> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [CatchUnwind](struct.CatchUnwind.html "struct bevy::tasks::futures_lite::future::CatchUnwind")<F>

where F: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"),

### impl<F> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [CatchUnwind](struct.CatchUnwind.html "struct bevy::tasks::futures_lite::future::CatchUnwind")<F>
