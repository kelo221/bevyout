...
1.48.0 · [Source](https://doc.rust-lang.org/nightly/src/core/future/ready.rs.html#12)
...
This `struct` is created by [`ready()`](fn.ready.html "fn bevy::tasks::futures_lite::future::ready"). See its documentation for more.

## Implementations

[Source](https://doc.rust-lang.org/nightly/src/core/future/ready.rs.html#27)

### impl<T> [Ready](struct.Ready.html "struct bevy::tasks::futures_lite::future::Ready")<T>

1.82.0 · [Source](https://doc.rust-lang.org/nightly/src/core/future/ready.rs.html#45)
...
Will panic if this [`Ready`](struct.Ready.html "struct bevy::tasks::futures_lite::future::Ready") was already polled to completion.
...
1.48.0 · [Source](https://doc.rust-lang.org/nightly/src/core/future/ready.rs.html#10)

### impl<T> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Ready](struct.Ready.html "struct bevy::tasks::futures_lite::future::Ready")<T>

where T: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://doc.rust-lang.org/nightly/src/core/future/ready.rs.html#10)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Ready](struct.Ready.html "struct bevy::tasks::futures_lite::future::Ready")<T> [ⓘ](#)
...
### impl<T> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Ready](struct.Ready.html "struct bevy::tasks::futures_lite::future::Ready")<T>
...
### impl<T> [Future](../trait.Future.html "trait bevy::tasks::futures_lite::Future") for [Ready](struct.Ready.html "struct bevy::tasks::futures_lite::future::Ready")<T>
...
[Source](https://doc.rust-lang.org/nightly/src/core/future/ready.rs.html#22)

#### fn [poll](../trait.Future.html#tymethod.poll)(self: [Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<&mut [Ready](struct.Ready.html "struct bevy::tasks::futures_lite::future::Ready")<T>>, \_cx: &mut [Context](https://doc.rust-lang.org/nightly/core/task/wake/struct.Context.html "struct core::task::wake::Context")<'\_>) -> [Poll](https://doc.rust-lang.org/nightly/core/task/poll/enum.Poll.html "enum core::task::poll::Poll")<T>
...
1.48.0 · [Source](https://doc.rust-lang.org/nightly/src/core/future/ready.rs.html#15)

### impl<T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Ready](struct.Ready.html "struct bevy::tasks::futures_lite::future::Ready")<T>

## Auto Trait Implementations

### impl<T> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Ready](struct.Ready.html "struct bevy::tasks::futures_lite::future::Ready")<T>

where T: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"),

### impl<T> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Ready](struct.Ready.html "struct bevy::tasks::futures_lite::future::Ready")<T>
...
### impl<T> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Ready](struct.Ready.html "struct bevy::tasks::futures_lite::future::Ready")<T>

where T: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Ready](struct.Ready.html "struct bevy::tasks::futures_lite::future::Ready")<T>

where T: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<T> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Ready](struct.Ready.html "struct bevy::tasks::futures_lite::future::Ready")<T>

where T: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"),

### impl<T> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Ready](struct.Ready.html "struct bevy::tasks::futures_lite::future::Ready")<T>
