...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/future.rs.html#429-439)

```rust
pub struct Or<F1, F2> { /* private fields */ }
```
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/future.rs.html#431)

### impl<F1, F2> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Or](struct.Or.html "struct bevy::tasks::futures_lite::future::Or")<F1, F2>
...
### impl<T, F1, F2> [Future](../trait.Future.html "trait bevy::tasks::futures_lite::Future") for [Or](struct.Or.html "struct bevy::tasks::futures_lite::future::Or")<F1, F2>
...
[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/future.rs.html#448)

#### fn [poll](../trait.Future.html#tymethod.poll)( self: [Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<&mut [Or](struct.Or.html "struct bevy::tasks::futures_lite::future::Or")<F1, F2>>, cx: &mut [Context](https://doc.rust-lang.org/nightly/core/task/wake/struct.Context.html "struct core::task::wake::Context")<'\_>, ) -> [Poll](https://doc.rust-lang.org/nightly/core/task/poll/enum.Poll.html "enum core::task::poll::Poll")<<[Or](struct.Or.html "struct bevy::tasks::futures_lite::future::Or")<F1, F2> as [Future](../trait.Future.html "trait bevy::tasks::futures_lite::Future")\>::[Output](../trait.Future.html#associatedtype.Output "type bevy::tasks::futures_lite::Future::Output")\>
...
### impl<'\_\_pin, F1, F2> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Or](struct.Or.html "struct bevy::tasks::futures_lite::future::Or")<F1, F2>
...
### impl<F1, F2> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Or](struct.Or.html "struct bevy::tasks::futures_lite::future::Or")<F1, F2>
...
### impl<F1, F2> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Or](struct.Or.html "struct bevy::tasks::futures_lite::future::Or")<F1, F2>
...
### impl<F1, F2> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Or](struct.Or.html "struct bevy::tasks::futures_lite::future::Or")<F1, F2>
...
### impl<F1, F2> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Or](struct.Or.html "struct bevy::tasks::futures_lite::future::Or")<F1, F2>
...
### impl<F1, F2> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Or](struct.Or.html "struct bevy::tasks::futures_lite::future::Or")<F1, F2>
...
### impl<F1, F2> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Or](struct.Or.html "struct bevy::tasks::futures_lite::future::Or")<F1, F2>
