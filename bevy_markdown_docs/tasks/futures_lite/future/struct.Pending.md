...
1.48.0 · [Source](https://doc.rust-lang.org/nightly/src/core/future/pending.rs.html#14)
...
This `struct` is created by [`pending()`](fn.pending.html "fn bevy::tasks::futures_lite::future::pending"). See its documentation for more.

## Trait Implementations

1.48.0 · [Source](https://doc.rust-lang.org/nightly/src/core/future/pending.rs.html#54)

### impl<T> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Pending](struct.Pending.html "struct bevy::tasks::futures_lite::future::Pending")<T>

[Source](https://doc.rust-lang.org/nightly/src/core/future/pending.rs.html#55)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Pending](struct.Pending.html "struct bevy::tasks::futures_lite::future::Pending")<T> [ⓘ](#)
...
1.48.0 · [Source](https://doc.rust-lang.org/nightly/src/core/future/pending.rs.html#47)

### impl<T> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Pending](struct.Pending.html "struct bevy::tasks::futures_lite::future::Pending")<T>

[Source](https://doc.rust-lang.org/nightly/src/core/future/pending.rs.html#48)
...
### impl<T> [Future](../trait.Future.html "trait bevy::tasks::futures_lite::Future") for [Pending](struct.Pending.html "struct bevy::tasks::futures_lite::future::Pending")<T>
...
[Source](https://doc.rust-lang.org/nightly/src/core/future/pending.rs.html#41)

#### fn [poll](../trait.Future.html#tymethod.poll)(self: [Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<&mut [Pending](struct.Pending.html "struct bevy::tasks::futures_lite::future::Pending")<T>>, \_: &mut [Context](https://doc.rust-lang.org/nightly/core/task/wake/struct.Context.html "struct core::task::wake::Context")<'\_>) -> [Poll](https://doc.rust-lang.org/nightly/core/task/poll/enum.Poll.html "enum core::task::poll::Poll")<T>
...
### impl<T> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Pending](struct.Pending.html "struct bevy::tasks::futures_lite::future::Pending")<T>

### impl<T> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Pending](struct.Pending.html "struct bevy::tasks::futures_lite::future::Pending")<T>

### impl<T> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Pending](struct.Pending.html "struct bevy::tasks::futures_lite::future::Pending")<T>

### impl<T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Pending](struct.Pending.html "struct bevy::tasks::futures_lite::future::Pending")<T>

### impl<T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Pending](struct.Pending.html "struct bevy::tasks::futures_lite::future::Pending")<T>

### impl<T> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Pending](struct.Pending.html "struct bevy::tasks::futures_lite::future::Pending")<T>

### impl<T> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Pending](struct.Pending.html "struct bevy::tasks::futures_lite::future::Pending")<T>
