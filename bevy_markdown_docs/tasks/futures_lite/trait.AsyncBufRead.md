...
### impl [AsyncBufRead](trait.AsyncBufRead.html "trait bevy::tasks::futures_lite::AsyncBufRead") for [Empty](io/struct.Empty.html "struct bevy::tasks::futures_lite::io::Empty")

[Source](https://docs.rs/futures-lite/2.6.1/x86_64-unknown-linux-gnu/src/futures_lite/io.rs.html#2698)

### impl<R1, R2> [AsyncBufRead](trait.AsyncBufRead.html "trait bevy::tasks::futures_lite::AsyncBufRead") for [Chain](io/struct.Chain.html "struct bevy::tasks::futures_lite::io::Chain")<R1, R2>
...
### impl<R> [AsyncBufRead](trait.AsyncBufRead.html "trait bevy::tasks::futures_lite::AsyncBufRead") for [BufReader](io/struct.BufReader.html "struct bevy::tasks::futures_lite::io::BufReader")<R>
...
### impl<R> [AsyncBufRead](trait.AsyncBufRead.html "trait bevy::tasks::futures_lite::AsyncBufRead") for [Take](io/struct.Take.html "struct bevy::tasks::futures_lite::io::Take")<R>
...
### impl<T> [AsyncBufRead](trait.AsyncBufRead.html "trait bevy::tasks::futures_lite::AsyncBufRead") for [Cursor](io/struct.Cursor.html "struct bevy::tasks::futures_lite::io::Cursor")<T>
