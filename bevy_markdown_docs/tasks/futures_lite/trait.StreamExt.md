...
#### fn [next](#method.next)(&mut self) -> [NextFuture](stream/struct.NextFuture.html "struct bevy::tasks::futures_lite::stream::NextFuture")<'\_, Self> [ⓘ](#)
...
#### fn [try\_next](#method.try_next)<T, E>(&mut self) -> [TryNextFuture](stream/struct.TryNextFuture.html "struct bevy::tasks::futures_lite::stream::TryNextFuture")<'\_, Self> [ⓘ](#)
...
#### fn [count](#method.count)(self) -> [CountFuture](stream/struct.CountFuture.html "struct bevy::tasks::futures_lite::stream::CountFuture")<Self> [ⓘ](#)
...
#### fn [map](#method.map)<T, F>(self, f: F) -> [Map](stream/struct.Map.html "struct bevy::tasks::futures_lite::stream::Map")<Self, F>
...
#### fn [flat\_map](#method.flat_map)<U, F>(self, f: F) -> [FlatMap](stream/struct.FlatMap.html "struct bevy::tasks::futures_lite::stream::FlatMap")<Self, U, F>
...
#### fn [flatten](#method.flatten)(self) -> [Flatten](stream/struct.Flatten.html "struct bevy::tasks::futures_lite::stream::Flatten")<Self>
...
#### fn [then](#method.then)<F, Fut>(self, f: F) -> [Then](stream/struct.Then.html "struct bevy::tasks::futures_lite::stream::Then")<Self, F, Fut>
...
#### fn [filter](#method.filter)<P>(self, predicate: P) -> [Filter](stream/struct.Filter.html "struct bevy::tasks::futures_lite::stream::Filter")<Self, P>
...
#### fn [filter\_map](#method.filter_map)<T, F>(self, f: F) -> [FilterMap](stream/struct.FilterMap.html "struct bevy::tasks::futures_lite::stream::FilterMap")<Self, F>
...
#### fn [take](#method.take)(self, n: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [Take](stream/struct.Take.html "struct bevy::tasks::futures_lite::stream::Take")<Self>
...
#### fn [take\_while](#method.take_while)<P>(self, predicate: P) -> [TakeWhile](stream/struct.TakeWhile.html "struct bevy::tasks::futures_lite::stream::TakeWhile")<Self, P>
...
#### fn [map\_while](#method.map_while)<B, P>(self, predicate: P) -> [MapWhile](stream/struct.MapWhile.html "struct bevy::tasks::futures_lite::stream::MapWhile")<Self, P>
...
#### fn [skip](#method.skip)(self, n: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [Skip](stream/struct.Skip.html "struct bevy::tasks::futures_lite::stream::Skip")<Self>
...
#### fn [skip\_while](#method.skip_while)<P>(self, predicate: P) -> [SkipWhile](stream/struct.SkipWhile.html "struct bevy::tasks::futures_lite::stream::SkipWhile")<Self, P>
...
#### fn [step\_by](#method.step_by)(self, step: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [StepBy](stream/struct.StepBy.html "struct bevy::tasks::futures_lite::stream::StepBy")<Self>
...
#### fn [chain](#method.chain)<U>(self, other: U) -> [Chain](stream/struct.Chain.html "struct bevy::tasks::futures_lite::stream::Chain")<Self, U>
...
#### fn [cloned](#method.cloned)<'a, T>(self) -> [Cloned](stream/struct.Cloned.html "struct bevy::tasks::futures_lite::stream::Cloned")<Self>
...
#### fn [copied](#method.copied)<'a, T>(self) -> [Copied](stream/struct.Copied.html "struct bevy::tasks::futures_lite::stream::Copied")<Self>
...
#### fn [collect](#method.collect)<C>(self) -> [CollectFuture](stream/struct.CollectFuture.html "struct bevy::tasks::futures_lite::stream::CollectFuture")<Self, C> [ⓘ](#)
...
#### fn [try\_collect](#method.try_collect)<T, E, C>(self) -> [TryCollectFuture](stream/struct.TryCollectFuture.html "struct bevy::tasks::futures_lite::stream::TryCollectFuture")<Self, C> [ⓘ](#)
...
#### fn [partition](#method.partition)<B, P>(self, predicate: P) -> [PartitionFuture](stream/struct.PartitionFuture.html "struct bevy::tasks::futures_lite::stream::PartitionFuture")<Self, P, B> [ⓘ](#)
...
#### fn [fold](#method.fold)<T, F>(self, init: T, f: F) -> [FoldFuture](stream/struct.FoldFuture.html "struct bevy::tasks::futures_lite::stream::FoldFuture")<Self, F, T> [ⓘ](#)
...
#### fn [try\_fold](#method.try_fold)<T, E, F, B>( &mut self, init: B, f: F, ) -> [TryFoldFuture](stream/struct.TryFoldFuture.html "struct bevy::tasks::futures_lite::stream::TryFoldFuture")<'\_, Self, F, B> [ⓘ](#)
...
#### fn [scan](#method.scan)<St, B, F>(self, initial\_state: St, f: F) -> [Scan](stream/struct.Scan.html "struct bevy::tasks::futures_lite::stream::Scan")<Self, St, F>
...
#### fn [fuse](#method.fuse)(self) -> [Fuse](stream/struct.Fuse.html "struct bevy::tasks::futures_lite::stream::Fuse")<Self>
...
#### fn [cycle](#method.cycle)(self) -> [Cycle](stream/struct.Cycle.html "struct bevy::tasks::futures_lite::stream::Cycle")<Self>
...
#### fn [enumerate](#method.enumerate)(self) -> [Enumerate](stream/struct.Enumerate.html "struct bevy::tasks::futures_lite::stream::Enumerate")<Self>
...
#### fn [inspect](#method.inspect)<F>(self, f: F) -> [Inspect](stream/struct.Inspect.html "struct bevy::tasks::futures_lite::stream::Inspect")<Self, F>
...
#### fn [nth](#method.nth)(&mut self, n: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [NthFuture](stream/struct.NthFuture.html "struct bevy::tasks::futures_lite::stream::NthFuture")<'\_, Self> [ⓘ](#)
...
#### fn [last](#method.last)(self) -> [LastFuture](stream/struct.LastFuture.html "struct bevy::tasks::futures_lite::stream::LastFuture")<Self> [ⓘ](#)
...
#### fn [find](#method.find)<P>(&mut self, predicate: P) -> [FindFuture](stream/struct.FindFuture.html "struct bevy::tasks::futures_lite::stream::FindFuture")<'\_, Self, P> [ⓘ](#)
...
#### fn [find\_map](#method.find_map)<F, B>(&mut self, f: F) -> [FindMapFuture](stream/struct.FindMapFuture.html "struct bevy::tasks::futures_lite::stream::FindMapFuture")<'\_, Self, F> [ⓘ](#)
...
#### fn [position](#method.position)<P>(&mut self, predicate: P) -> [PositionFuture](stream/struct.PositionFuture.html "struct bevy::tasks::futures_lite::stream::PositionFuture")<'\_, Self, P> [ⓘ](#)
...
#### fn [all](#method.all)<P>(&mut self, predicate: P) -> [AllFuture](stream/struct.AllFuture.html "struct bevy::tasks::futures_lite::stream::AllFuture")<'\_, Self, P> [ⓘ](#)
...
#### fn [any](#method.any)<P>(&mut self, predicate: P) -> [AnyFuture](stream/struct.AnyFuture.html "struct bevy::tasks::futures_lite::stream::AnyFuture")<'\_, Self, P> [ⓘ](#)
...
#### fn [for\_each](#method.for_each)<F>(self, f: F) -> [ForEachFuture](stream/struct.ForEachFuture.html "struct bevy::tasks::futures_lite::stream::ForEachFuture")<Self, F> [ⓘ](#)
...
#### fn [try\_for\_each](#method.try_for_each)<F, E>(&mut self, f: F) -> [TryForEachFuture](stream/struct.TryForEachFuture.html "struct bevy::tasks::futures_lite::stream::TryForEachFuture")<'\_, Self, F> [ⓘ](#)
...
#### fn [zip](#method.zip)<U>(self, other: U) -> [Zip](stream/struct.Zip.html "struct bevy::tasks::futures_lite::stream::Zip")<Self, U>
...
#### fn [unzip](#method.unzip)<A, B, FromA, FromB>(self) -> [UnzipFuture](stream/struct.UnzipFuture.html "struct bevy::tasks::futures_lite::stream::UnzipFuture")<Self, FromA, FromB> [ⓘ](#)
...
#### fn [or](#method.or)<S>(self, other: S) -> [Or](stream/struct.Or.html "struct bevy::tasks::futures_lite::stream::Or")<Self, S>
...
#### fn [race](#method.race)<S>(self, other: S) -> [Race](stream/struct.Race.html "struct bevy::tasks::futures_lite::stream::Race")<Self, S>
...
#### fn [drain](#method.drain)(&mut self) -> [Drain](stream/struct.Drain.html "struct bevy::tasks::futures_lite::stream::Drain")<'\_, Self>
...
This returns a [`Stream`](trait.Stream.html "trait bevy::tasks::futures_lite::Stream") instead of an [`Iterator`](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator") because it still needs access to the polling context in order to poll the underlying stream. Since this stream will never return `Poll::Pending`, wrapping it in [`block_on`](stream/fn.block_on.html "fn bevy::tasks::futures_lite::stream::block_on") will allow it to be effectively used as an [`Iterator`](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator").
