[bevy](../../index.html)::[state](../index.html)::[commands](index.html)
...
Internally this schedules a command that updates the [`NextState<S>`](../../prelude/enum.NextState.html "enum bevy::prelude::NextState") resource with `state`.
