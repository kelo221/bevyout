...
[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state_scoped.rs.html#561)

```rust
pub struct EnableWhen<S>where
    S: States,{
...
See also [`EnableOnExit`](../../prelude/struct.EnableOnExit.html "struct bevy::prelude::EnableOnExit") and [`EnableOnEnter`](../../prelude/struct.EnableOnEnter.html "struct bevy::prelude::EnableOnEnter").
...
[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state_scoped.rs.html#567)

### impl<S> [EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>

where S: [States](../../prelude/trait.States.html "trait bevy::prelude::States"),

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state_scoped.rs.html#569)

#### pub fn [new](#method.new)( f: impl [Fn](https://doc.rust-lang.org/nightly/core/ops/function/trait.Fn.html "trait core::ops::function::Fn")(&[StateTransitionEvent](../../prelude/struct.StateTransitionEvent.html "struct bevy::prelude::StateTransitionEvent")<S>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html) + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + 'static, ) -> [EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>

Creates a [`EnableWhen`](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen") for the given predicate.

## Trait Implementations

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state_scoped.rs.html#559)

### impl<S> [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>

where S: [States](../../prelude/trait.States.html "trait bevy::prelude::States"), [EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl<S> [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>
...
#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state_scoped.rs.html#560)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S> as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>>
...
### impl<S> [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>
...
### impl<S> [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>
...
### impl<S> [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>
...
where [EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>: 'into\_return,
...
### impl<S> [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state_scoped.rs.html#560)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<S> [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>
...
### impl<S> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>

### impl<S> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>

### impl<S> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>

### impl<S> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>

### impl<S> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>

### impl<S> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>

### impl<S> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [EnableWhen](../../prelude/struct.EnableWhen.html "struct bevy::prelude::EnableWhen")<S>
