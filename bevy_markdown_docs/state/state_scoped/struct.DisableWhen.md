...
[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state_scoped.rs.html#314)

```rust
pub struct DisableWhen<S>where
    S: States,{
...
See also [`DisableOnExit`](../../prelude/struct.DisableOnExit.html "struct bevy::prelude::DisableOnExit") and [`DisableOnEnter`](../../prelude/struct.DisableOnEnter.html "struct bevy::prelude::DisableOnEnter").
...
[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state_scoped.rs.html#320)

### impl<S> [DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>

where S: [States](../../prelude/trait.States.html "trait bevy::prelude::States"),

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state_scoped.rs.html#322)

#### pub fn [new](#method.new)( f: impl [Fn](https://doc.rust-lang.org/nightly/core/ops/function/trait.Fn.html "trait core::ops::function::Fn")(&[StateTransitionEvent](../../prelude/struct.StateTransitionEvent.html "struct bevy::prelude::StateTransitionEvent")<S>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html) + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + 'static, ) -> [DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>

Creates a [`DisableWhen`](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen") for the given predicate.

## Trait Implementations

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state_scoped.rs.html#312)

### impl<S> [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>

where S: [States](../../prelude/trait.States.html "trait bevy::prelude::States"), [DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl<S> [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>
...
#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state_scoped.rs.html#313)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S> as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>>
...
### impl<S> [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>
...
### impl<S> [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>
...
### impl<S> [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>
...
where [DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>: 'into\_return,
...
### impl<S> [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state_scoped.rs.html#313)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<S> [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>
...
### impl<S> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>

### impl<S> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>

### impl<S> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>

### impl<S> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>

### impl<S> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>

### impl<S> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>

### impl<S> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DisableWhen](../../prelude/struct.DisableWhen.html "struct bevy::prelude::DisableWhen")<S>
