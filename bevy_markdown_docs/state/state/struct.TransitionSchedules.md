...
### impl<S> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [TransitionSchedules](../../prelude/struct.TransitionSchedules.html "struct bevy::prelude::TransitionSchedules")<S>
...
#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [TransitionSchedules](../../prelude/struct.TransitionSchedules.html "struct bevy::prelude::TransitionSchedules")<S>
...
### impl<S> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [TransitionSchedules](../../prelude/struct.TransitionSchedules.html "struct bevy::prelude::TransitionSchedules")<S>
...
### impl<S> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [TransitionSchedules](../../prelude/struct.TransitionSchedules.html "struct bevy::prelude::TransitionSchedules")<S>
...
#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [TransitionSchedules](../../prelude/struct.TransitionSchedules.html "struct bevy::prelude::TransitionSchedules")<S>

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_state/0.19.0/x86_64-unknown-linux-gnu/src/bevy_state/state/transitions.rs.html#103)

### impl<S> [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [TransitionSchedules](../../prelude/struct.TransitionSchedules.html "struct bevy::prelude::TransitionSchedules")<S>
...
### impl<S> [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [TransitionSchedules](../../prelude/struct.TransitionSchedules.html "struct bevy::prelude::TransitionSchedules")<S>

where S: [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") + [States](../../prelude/trait.States.html "trait bevy::prelude::States"),
...
### impl<S> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [TransitionSchedules](../../prelude/struct.TransitionSchedules.html "struct bevy::prelude::TransitionSchedules")<S>
...
#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[TransitionSchedules](../../prelude/struct.TransitionSchedules.html "struct bevy::prelude::TransitionSchedules")<S>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl<S> [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [TransitionSchedules](../../prelude/struct.TransitionSchedules.html "struct bevy::prelude::TransitionSchedules")<S>
...
### impl<S> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TransitionSchedules](../../prelude/struct.TransitionSchedules.html "struct bevy::prelude::TransitionSchedules")<S>

### impl<S> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TransitionSchedules](../../prelude/struct.TransitionSchedules.html "struct bevy::prelude::TransitionSchedules")<S>
...
### impl<S> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TransitionSchedules](../../prelude/struct.TransitionSchedules.html "struct bevy::prelude::TransitionSchedules")<S>

### impl<S> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TransitionSchedules](../../prelude/struct.TransitionSchedules.html "struct bevy::prelude::TransitionSchedules")<S>

### impl<S> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TransitionSchedules](../../prelude/struct.TransitionSchedules.html "struct bevy::prelude::TransitionSchedules")<S>

where S: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<S> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TransitionSchedules](../../prelude/struct.TransitionSchedules.html "struct bevy::prelude::TransitionSchedules")<S>

### impl<S> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TransitionSchedules](../../prelude/struct.TransitionSchedules.html "struct bevy::prelude::TransitionSchedules")<S>
