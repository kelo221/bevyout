...
This schedule is split up into four phases, as described in [`StateTransitionSystems`](enum.StateTransitionSystems.html "enum bevy::state::state::StateTransitionSystems").
