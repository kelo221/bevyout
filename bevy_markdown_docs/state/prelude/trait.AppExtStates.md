...
The use of any states requires the presence of [`StatesPlugin`](../app/struct.StatesPlugin.html "struct bevy::state::app::StatesPlugin") (which is included in `DefaultPlugins`).
