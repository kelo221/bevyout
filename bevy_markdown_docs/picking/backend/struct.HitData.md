...
[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#135)
...
Backends can attach arbitrary typed data via [`HitData::extra`](struct.HitData.html#structfield.extra "field bevy::picking::backend::HitData::extra"). See [`HitDataExtra`](trait.HitDataExtra.html "trait bevy::picking::backend::HitDataExtra").

## Fields

`camera: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")`

The camera entity used to detect this hit. Useful when you need to find the ray that was cast for this hit when using a raycasting backend.

`depth: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

`depth` only needs to be self-consistent with other [`PointerHits`](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")s using the same [`RenderTarget`](../../camera/enum.RenderTarget.html "enum bevy::camera::RenderTarget"). However, it is recommended to use the distance from the pointer to the hit, measured from the near plane of the camera, to the point, in world space.

`position: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Vec3](../../prelude/struct.Vec3.html "struct bevy::prelude::Vec3")>`
...
`normal: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Vec3](../../prelude/struct.Vec3.html "struct bevy::prelude::Vec3")>`

The normal vector of the hit test, if the data is available from the backend.

`extra: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Arc](../../platform/sync/struct.Arc.html "struct bevy::platform::sync::Arc")<dyn [HitDataExtra](trait.HitDataExtra.html "trait bevy::picking::backend::HitDataExtra")>>`

Optional backend-specific extra data attached to this hit. Read it with [`HitData::extra_as`](struct.HitData.html#method.extra_as "method bevy::picking::backend::HitData::extra_as").

This is stored in an [`Arc`](../../platform/sync/struct.Arc.html "struct bevy::platform::sync::Arc") so cloning [`HitData`](struct.HitData.html "struct bevy::picking::backend::HitData") stays cheap. This field is excluded from [`PartialEq`](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") because value equality for trait objects would require extra dynamic downcasting that the picking pipeline does not need.

## Implementations

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#179)

### impl [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#181)

#### pub fn [new](#method.new)( camera: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), depth: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), position: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Vec3](../../prelude/struct.Vec3.html "struct bevy::prelude::Vec3")\>, normal: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Vec3](../../prelude/struct.Vec3.html "struct bevy::prelude::Vec3")\>, ) -> [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")

Construct a [`HitData`](struct.HitData.html "struct bevy::picking::backend::HitData").

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#195)

#### pub fn [extra\_as](#method.extra_as)<T>(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[&T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\>

where T: [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any"),

Returns any attached extra data as `T` if available.

This returns `None` if no extra data was attached, or if the hit stores a different concrete extra data type.

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/picking/custom\_hit\_data.rs ([line 169](../../../src/custom_hit_data/custom_hit_data.rs.html#169))
...
[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#214-220)

#### pub fn [new\_with\_extra](#method.new_with_extra)( camera: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), depth: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), position: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Vec3](../../prelude/struct.Vec3.html "struct bevy::prelude::Vec3")\>, normal: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Vec3](../../prelude/struct.Vec3.html "struct bevy::prelude::Vec3")\>, extra: impl [HitDataExtra](trait.HitDataExtra.html "trait bevy::picking::backend::HitDataExtra"), ) -> [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")

Creates a [`HitData`](struct.HitData.html "struct bevy::picking::backend::HitData") with backend-specific extra data. `extra` can be any [`HitDataExtra`](trait.HitDataExtra.html "trait bevy::picking::backend::HitDataExtra").
...
examples/picking/custom\_hit\_data.rs ([lines 139-145](../../../src/custom_hit_data/custom_hit_data.rs.html#139-145))
...
[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#158)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#159)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")
...
### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#133)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#133)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[HitData](struct.HitData.html "struct bevy::picking::backend::HitData") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#133)

### impl [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#133)

#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[HitData](struct.HitData.html "struct bevy::picking::backend::HitData")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")
...
where [HitData](struct.HitData.html "struct bevy::picking::backend::HitData"): 'into\_return,
...
[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#170)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#171)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[HitData](struct.HitData.html "struct bevy::picking::backend::HitData")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[HitData](struct.HitData.html "struct bevy::picking::backend::HitData")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#133)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[HitData](struct.HitData.html "struct bevy::picking::backend::HitData")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[HitData](struct.HitData.html "struct bevy::picking::backend::HitData")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#134)
...
### impl [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#133)

#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[HitData](struct.HitData.html "struct bevy::picking::backend::HitData")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[HitData](struct.HitData.html "struct bevy::picking::backend::HitData")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Struct](../../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")
...
### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [HitData](struct.HitData.html "struct bevy::picking::backend::HitData")
