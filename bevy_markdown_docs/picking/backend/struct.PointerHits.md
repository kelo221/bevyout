...
[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#93)
...
Some backends may only support providing the topmost entity; this is a valid limitation. For example, a picking shader might only have data on the topmost rendered output from its buffer.

Note that systems reading these messages in [`PreUpdate`](../../prelude/struct.PreUpdate.html "struct bevy::prelude::PreUpdate") will not report ordering ambiguities with picking backends. Take care to ensure such systems are explicitly ordered against [`PickingSystems::Backend`](../enum.PickingSystems.html#variant.Backend "variant bevy::picking::PickingSystems::Backend"), or better, avoid reading `PointerHits` in `PreUpdate`.

## Fields

`pointer: [PointerId](../pointer/enum.PointerId.html "enum bevy::picking::pointer::PointerId")`

The pointer associated with this hit test.

`picks: [Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<([Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), [HitData](struct.HitData.html "struct bevy::picking::backend::HitData"))>`

An unordered collection of entities and their distance (depth) from the cursor.

`order: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Set the order of this group of picks. Normally, this is the [`bevy_camera::Camera::order`](../../prelude/struct.Camera.html#structfield.order "field bevy::prelude::Camera::order").
...
[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#119)

### impl [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#121)

#### pub fn [new](#method.new)( pointer: [PointerId](../pointer/enum.PointerId.html "enum bevy::picking::pointer::PointerId"), picks: [Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<([Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), [HitData](struct.HitData.html "struct bevy::picking::backend::HitData"))>, order: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")

Construct [`PointerHits`](struct.PointerHits.html "struct bevy::picking::backend::PointerHits").

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/picking/custom\_hit\_data.rs ([line 152](../../../src/custom_hit_data/custom_hit_data.rs.html#152))
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#91)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")
...
### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#91)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#91)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#91)

### impl [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#91)

#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")
...
where [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits"): 'into\_return,
...
### impl [Message](../../prelude/trait.Message.html "trait bevy::prelude::Message") for [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")

where [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#91)

### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#91)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#92)
...
### impl [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/backend.rs.html#91)

#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Struct](../../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")
...
### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [PointerHits](struct.PointerHits.html "struct bevy::picking::backend::PointerHits")
