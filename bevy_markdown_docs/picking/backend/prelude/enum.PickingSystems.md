...
Reads inputs and produces [`backend::PointerHits`](../struct.PointerHits.html "struct bevy::picking::backend::PointerHits")s. In the [`PreUpdate`](../../../prelude/struct.PreUpdate.html "struct bevy::prelude::PreUpdate") schedule.

### Hover

Reads [`backend::PointerHits`](../struct.PointerHits.html "struct bevy::picking::backend::PointerHits")s, and updates the hovermap, selection, and highlighting states. In the [`PreUpdate`](../../../prelude/struct.PreUpdate.html "struct bevy::prelude::PreUpdate") schedule.
