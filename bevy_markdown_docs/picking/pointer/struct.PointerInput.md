...
[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/pointer.rs.html#280)
...
`pointer_id: [PointerId](enum.PointerId.html "enum bevy::picking::pointer::PointerId")`

The id of the pointer.

`location: [Location](struct.Location.html "struct bevy::picking::pointer::Location")`

The location of the pointer. For [`PointerAction::Move`](enum.PointerAction.html#variant.Move "variant bevy::picking::pointer::PointerAction::Move"), this is the location after the movement.

`action: [PointerAction](enum.PointerAction.html "enum bevy::picking::pointer::PointerAction")`

The action that the event describes.

## Implementations

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/pointer.rs.html#289)

### impl [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/pointer.rs.html#293)

#### pub fn [new](#method.new)( pointer\_id: [PointerId](enum.PointerId.html "enum bevy::picking::pointer::PointerId"), location: [Location](struct.Location.html "struct bevy::picking::pointer::Location"), action: [PointerAction](enum.PointerAction.html "enum bevy::picking::pointer::PointerAction"), ) -> [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")

Creates a new pointer input event.

Note that `location` refers to the position of the pointer _after_ the event occurred.

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/ui/render\_ui\_to\_texture.rs ([lines 207-216](../../../src/render_ui_to_texture/render_ui_to_texture.rs.html#207-216))
...
[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/pointer.rs.html#303)

#### pub fn [button\_just\_pressed](#method.button_just_pressed)(&self, target\_button: [PointerButton](../../prelude/enum.PointerButton.html "enum bevy::prelude::PointerButton")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns true if the `target_button` of this pointer was just pressed.

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/pointer.rs.html#313)

#### pub fn [button\_just\_released](#method.button_just_released)(&self, target\_button: [PointerButton](../../prelude/enum.PointerButton.html "enum bevy::prelude::PointerButton")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns true if the `target_button` of this pointer was just released.

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/pointer.rs.html#322-325)

#### pub fn [receive](#method.receive)( events: [MessageReader](../../prelude/struct.MessageReader.html "struct bevy::prelude::MessageReader")<'\_, '\_, [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")\>, pointers: [Query](../../prelude/struct.Query.html "struct bevy::prelude::Query")<'\_, '\_, (&[PointerId](enum.PointerId.html "enum bevy::picking::pointer::PointerId"), &mut [PointerLocation](struct.PointerLocation.html "struct bevy::picking::pointer::PointerLocation"), &mut [PointerPress](struct.PointerPress.html "struct bevy::picking::pointer::PointerPress"))>, )
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/pointer.rs.html#278)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")
...
### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/pointer.rs.html#278)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/pointer.rs.html#278)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/pointer.rs.html#278)

### impl [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/pointer.rs.html#278)

#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")
...
where [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput"): 'into\_return,
...
### impl [Message](../../prelude/trait.Message.html "trait bevy::prelude::Message") for [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")

where [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/pointer.rs.html#278)

### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/pointer.rs.html#279)
...
### impl [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/pointer.rs.html#278)

#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Struct](../../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")
...
### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [PointerInput](struct.PointerInput.html "struct bevy::picking::pointer::PointerInput")
