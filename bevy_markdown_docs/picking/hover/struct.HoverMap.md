...
[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/hover.rs.html#60)
...
“Hovering” refers to the _hover_ state, which is not the same as whether or not a picking backend is reporting hits between a pointer and an entity. A pointer is “hovering” an entity only if the pointer is hitting the entity (as reported by a picking backend) _and_ no entities between it and the pointer block interactions.

For example, if a pointer is hitting a UI button and a 3d mesh, but the button is in front of the mesh, the UI button will be hovered, but the mesh will not. Unless, the [`Pickable`](../../prelude/struct.Pickable.html "struct bevy::prelude::Pickable") component is present with [`should_block_lower`](../../prelude/struct.Pickable.html#structfield.should_block_lower "field bevy::prelude::Pickable::should_block_lower") set to `false`.

## Advanced Users

If you want to completely replace the provided picking events or state produced by this plugin, you can use this resource to do that. All of the event systems for picking are built _on top of_ this authoritative hover state, and you can do the same. You can also use the [`PreviousHoverMap`](struct.PreviousHoverMap.html "struct bevy::picking::hover::PreviousHoverMap") as a robust way of determining changes in hover state from the previous update.

## Tuple Fields

`0: [HashMap](../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[PointerId](../pointer/enum.PointerId.html "enum bevy::picking::pointer::PointerId"), [EntityHashMap](../../ecs/entity/struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<[HitData](../backend/struct.HitData.html "struct bevy::picking::backend::HitData")>>`

## Methods from [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")<Target = [HashMap](../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[PointerId](../pointer/enum.PointerId.html "enum bevy::picking::pointer::PointerId"), [EntityHashMap](../../ecs/entity/struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<[HitData](../backend/struct.HitData.html "struct bevy::picking::backend::HitData")\>>>
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [HoverMap](struct.HoverMap.html "struct bevy::picking::hover::HoverMap")

where [HoverMap](struct.HoverMap.html "struct bevy::picking::hover::HoverMap"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [HoverMap](struct.HoverMap.html "struct bevy::picking::hover::HoverMap")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [HoverMap](struct.HoverMap.html "struct bevy::picking::hover::HoverMap")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/hover.rs.html#59)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [HoverMap](struct.HoverMap.html "struct bevy::picking::hover::HoverMap")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/hover.rs.html#59)

### impl [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [HoverMap](struct.HoverMap.html "struct bevy::picking::hover::HoverMap")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/hover.rs.html#59)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = [HashMap](../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[PointerId](../pointer/enum.PointerId.html "enum bevy::picking::pointer::PointerId"), [EntityHashMap](../../ecs/entity/struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<[HitData](../backend/struct.HitData.html "struct bevy::picking::backend::HitData")\>>

The resulting type after dereferencing.

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/hover.rs.html#59)

#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[HoverMap](struct.HoverMap.html "struct bevy::picking::hover::HoverMap") as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/hover.rs.html#59)

### impl [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [HoverMap](struct.HoverMap.html "struct bevy::picking::hover::HoverMap")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/hover.rs.html#59)

#### fn [deref\_mut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html#tymethod.deref_mut)(&mut self) -> &mut <[HoverMap](struct.HoverMap.html "struct bevy::picking::hover::HoverMap") as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Mutably dereferences the value.

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/hover.rs.html#59)

### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [HoverMap](struct.HoverMap.html "struct bevy::picking::hover::HoverMap")

where [HoverMap](struct.HoverMap.html "struct bevy::picking::hover::HoverMap"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [HoverMap](struct.HoverMap.html "struct bevy::picking::hover::HoverMap")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [HoverMap](struct.HoverMap.html "struct bevy::picking::hover::HoverMap")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [HoverMap](struct.HoverMap.html "struct bevy::picking::hover::HoverMap")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [HoverMap](struct.HoverMap.html "struct bevy::picking::hover::HoverMap")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [HoverMap](struct.HoverMap.html "struct bevy::picking::hover::HoverMap")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [HoverMap](struct.HoverMap.html "struct bevy::picking::hover::HoverMap")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [HoverMap](struct.HoverMap.html "struct bevy::picking::hover::HoverMap")
