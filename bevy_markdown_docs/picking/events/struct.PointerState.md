...
[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#550)
...
`pointer_buttons: [HashMap](../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<([PointerId](../pointer/enum.PointerId.html "enum bevy::picking::pointer::PointerId"), [PointerButton](../../prelude/enum.PointerButton.html "enum bevy::prelude::PointerButton")), [PointerButtonState](../../prelude/struct.PointerButtonState.html "struct bevy::prelude::PointerButtonState")>`

Pressing and dragging state, organized by pointer and button.

`hovered_entity_ancestors: [HoveredEntityAncestors](../../prelude/struct.HoveredEntityAncestors.html "struct bevy::prelude::HoveredEntityAncestors")`

A cache map providing the set of an entity’s ancestors for a given hovered entity.

## Implementations

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#557)

### impl [PointerState](../../prelude/struct.PointerState.html "struct bevy::prelude::PointerState")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#559)

#### pub fn [get](#method.get)( &self, pointer\_id: [PointerId](../pointer/enum.PointerId.html "enum bevy::picking::pointer::PointerId"), button: [PointerButton](../../prelude/enum.PointerButton.html "enum bevy::prelude::PointerButton"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[PointerButtonState](../../prelude/struct.PointerButtonState.html "struct bevy::prelude::PointerButtonState")\>

Retrieves the current state for a specific pointer and button, if it has been created.

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#564-568)

#### pub fn [get\_mut](#method.get_mut)( &mut self, pointer\_id: [PointerId](../pointer/enum.PointerId.html "enum bevy::picking::pointer::PointerId"), button: [PointerButton](../../prelude/enum.PointerButton.html "enum bevy::prelude::PointerButton"), ) -> &mut [PointerButtonState](../../prelude/struct.PointerButtonState.html "struct bevy::prelude::PointerButtonState")

Provides write access to the state of a pointer and button, creating it if it does not yet exist.

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#575)

#### pub fn [get\_ancestors](#method.get_ancestors)(&self, hovered\_entity: &[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[EntityHashSet](../../ecs/entity/struct.EntityHashSet.html "struct bevy::ecs::entity::EntityHashSet")\>

Retrieves the ancestors for a given hovered entity

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#580)

#### pub fn [get\_ancestors\_union](#method.get_ancestors_union)( &self, hovered\_entities: &[EntityHashSet](../../ecs/entity/struct.EntityHashSet.html "struct bevy::ecs::entity::EntityHashSet"), ) -> [EntityHashSet](../../ecs/entity/struct.EntityHashSet.html "struct bevy::ecs::entity::EntityHashSet")

Retrieves the union of ancestors for the given hovered entities

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#586)

#### pub fn [clear](#method.clear)(&mut self, pointer\_id: [PointerId](../pointer/enum.PointerId.html "enum bevy::picking::pointer::PointerId"))
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [PointerState](../../prelude/struct.PointerState.html "struct bevy::prelude::PointerState")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#549)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [PointerState](../../prelude/struct.PointerState.html "struct bevy::prelude::PointerState")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [PointerState](../../prelude/struct.PointerState.html "struct bevy::prelude::PointerState")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [PointerState](../../prelude/struct.PointerState.html "struct bevy::prelude::PointerState")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [PointerState](../../prelude/struct.PointerState.html "struct bevy::prelude::PointerState")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#549)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [PointerState](../../prelude/struct.PointerState.html "struct bevy::prelude::PointerState")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [PointerState](../../prelude/struct.PointerState.html "struct bevy::prelude::PointerState")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [PointerState](../../prelude/struct.PointerState.html "struct bevy::prelude::PointerState")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [PointerState](../../prelude/struct.PointerState.html "struct bevy::prelude::PointerState")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [PointerState](../../prelude/struct.PointerState.html "struct bevy::prelude::PointerState")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [PointerState](../../prelude/struct.PointerState.html "struct bevy::prelude::PointerState")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [PointerState](../../prelude/struct.PointerState.html "struct bevy::prelude::PointerState")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [PointerState](../../prelude/struct.PointerState.html "struct bevy::prelude::PointerState")
