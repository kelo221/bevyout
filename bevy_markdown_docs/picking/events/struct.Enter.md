...
[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#225)
...
An ancestor of a [target entity](../../prelude/trait.EntityEvent.html#tymethod.event_target "method bevy::prelude::EntityEvent::event_target") will receive an [`Enter`](../../prelude/struct.Enter.html "struct bevy::prelude::Enter") event when the ancestor does not have a direct relation to any entity hovered by the pointer in the previous frame. For example, for a given pointer:
...
[`Enter`](../../prelude/struct.Enter.html "struct bevy::prelude::Enter") events would be sent for both E and its direct ancestor D. An [`Enter`](../../prelude/struct.Enter.html "struct bevy::prelude::Enter") event would not be sent for A because it is a shared ancestor of both C and E.

Note: An [`Enter`](../../prelude/struct.Enter.html "struct bevy::prelude::Enter") event may be fired for an ancestor even if the pointer does not enter within the ancestor’s bounds. More concretely, if a child’s bounds extend beyond the parent’s and the pointer enters the child’s bounds without crossing into the parent’s, two [`Enter`](../../prelude/struct.Enter.html "struct bevy::prelude::Enter") events are still emitted for both the child and the parent. This matches the triggering behavior of `mouseenter` events on the web. To find out whether a pointer is within the target entity’s bounds immediately upon entering, check the value of [`is_in_bounds`](../../prelude/struct.Enter.html#structfield.is_in_bounds "field bevy::prelude::Enter::is_in_bounds").

Refer to [`pointer_events`](../../prelude/fn.pointer_events.html "fn bevy::prelude::pointer_events") for more information on how these events are triggered.

## Fields

`hit: [HitData](../backend/struct.HitData.html "struct bevy::picking::backend::HitData")`

Information about the picking intersection.

`is_in_bounds: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

Whether this pointer directly entered into the target entity’s bounds at the time of the event. This may be false if this entity’s child’s bounds extended beyond the entity and the pointer entered within the child’s bounds only.

## Trait Implementations

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#223)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#223)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")
...
### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#223)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#223)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")
...
where [Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#223)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#223)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_picking/0.19.0/x86_64-unknown-linux-gnu/src/bevy_picking/events.rs.html#224)
...
#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Enter](../../prelude/struct.Enter.html "struct bevy::prelude::Enter")
