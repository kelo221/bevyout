...
[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#492)
...
When defining new types of UI entities, require [`Node`](../../prelude/struct.Node.html "struct bevy::prelude::Node") to make them behave like UI nodes.
...
*   [`RelativeCursorPosition`](../struct.RelativeCursorPosition.html "struct bevy::ui::RelativeCursorPosition") to obtain the cursor position relative to this node
*   [`Interaction`](../../prelude/enum.Interaction.html "enum bevy::prelude::Interaction") to obtain the interaction state of this node

## Fields

`display: [Display](../../prelude/enum.Display.html "enum bevy::prelude::Display")`

Which layout algorithm to use when laying out this node’s contents:

*   [`Display::Flex`](../../prelude/enum.Display.html#variant.Flex "variant bevy::prelude::Display::Flex"): Use the Flexbox layout algorithm
*   [`Display::Grid`](../../prelude/enum.Display.html#variant.Grid "variant bevy::prelude::Display::Grid"): Use the CSS Grid layout algorithm
*   [`Display::None`](../../prelude/enum.Display.html#variant.None "variant bevy::prelude::Display::None"): Hide this node and perform layout as if it does not exist.

[https://developer.mozilla.org/en-US/docs/Web/CSS/display](https://developer.mozilla.org/en-US/docs/Web/CSS/display)

`box_sizing: [BoxSizing](../../prelude/enum.BoxSizing.html "enum bevy::prelude::BoxSizing")`

Which part of a Node’s box length styles like width and height control

*   [`BoxSizing::BorderBox`](../../prelude/enum.BoxSizing.html#variant.BorderBox "variant bevy::prelude::BoxSizing::BorderBox"): They refer to the “border box” size (size including padding and border)
*   [`BoxSizing::ContentBox`](../../prelude/enum.BoxSizing.html#variant.ContentBox "variant bevy::prelude::BoxSizing::ContentBox"): They refer to the “content box” size (size excluding padding and border)

`BoxSizing::BorderBox` is generally considered more intuitive and is the default in Bevy even though it is not on the web.

See: [https://developer.mozilla.org/en-US/docs/Web/CSS/box-sizing](https://developer.mozilla.org/en-US/docs/Web/CSS/box-sizing)

`position_type: [PositionType](../../prelude/enum.PositionType.html "enum bevy::prelude::PositionType")`

Whether a node should be laid out in-flow with, or independently of its siblings:

*   [`PositionType::Relative`](../../prelude/enum.PositionType.html#variant.Relative "variant bevy::prelude::PositionType::Relative"): Layout this node in-flow with other nodes using the usual (flexbox/grid) layout algorithm.
*   [`PositionType::Absolute`](../../prelude/enum.PositionType.html#variant.Absolute "variant bevy::prelude::PositionType::Absolute"): Layout this node on top and independently of other nodes.

[https://developer.mozilla.org/en-US/docs/Web/CSS/position](https://developer.mozilla.org/en-US/docs/Web/CSS/position)

`overflow: [Overflow](../../prelude/struct.Overflow.html "struct bevy::prelude::Overflow")`
...
`scrollbar_width: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

How much space in logical pixels should be reserved for scrollbars when overflow is set to scroll or auto on an axis.

`overflow_clip_margin: [OverflowClipMargin](../../prelude/struct.OverflowClipMargin.html "struct bevy::prelude::OverflowClipMargin")`
...
*   For absolutely positioned nodes, this is relative to the _parent_ node’s bounding box.
...
[https://developer.mozilla.org/en-US/docs/Web/CSS/top](https://developer.mozilla.org/en-US/docs/Web/CSS/top)
...
[https://developer.mozilla.org/en-US/docs/Web/CSS/bottom](https://developer.mozilla.org/en-US/docs/Web/CSS/bottom)

`width: [Val](../../prelude/enum.Val.html "enum bevy::prelude::Val")`
...
`height: [Val](../../prelude/enum.Val.html "enum bevy::prelude::Val")`
...
`min_width: [Val](../../prelude/enum.Val.html "enum bevy::prelude::Val")`
...
`min_height: [Val](../../prelude/enum.Val.html "enum bevy::prelude::Val")`
...
`max_width: [Val](../../prelude/enum.Val.html "enum bevy::prelude::Val")`
...
`max_height: [Val](../../prelude/enum.Val.html "enum bevy::prelude::Val")`
...
`aspect_ratio: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)>`
...
`align_items: [AlignItems](../../prelude/enum.AlignItems.html "enum bevy::prelude::AlignItems")`
...
This value is overridden if [`AlignSelf`](../../prelude/enum.AlignSelf.html "enum bevy::prelude::AlignSelf") on the child node is set.

[https://developer.mozilla.org/en-US/docs/Web/CSS/align-items](https://developer.mozilla.org/en-US/docs/Web/CSS/align-items)

`justify_items: [JustifyItems](../../prelude/enum.JustifyItems.html "enum bevy::prelude::JustifyItems")`
...
This value is overridden if [`JustifySelf`](../../prelude/enum.JustifySelf.html "enum bevy::prelude::JustifySelf") on the child node is set.
...
`align_self: [AlignSelf](../../prelude/enum.AlignSelf.html "enum bevy::prelude::AlignSelf")`
...
If set to `Auto`, alignment is inherited from the value of [`AlignItems`](../../prelude/enum.AlignItems.html "enum bevy::prelude::AlignItems") set on the parent node.

[https://developer.mozilla.org/en-US/docs/Web/CSS/align-self](https://developer.mozilla.org/en-US/docs/Web/CSS/align-self)

`justify_self: [JustifySelf](../../prelude/enum.JustifySelf.html "enum bevy::prelude::JustifySelf")`
...
If set to `Auto`, alignment is inherited from the value of [`JustifyItems`](../../prelude/enum.JustifyItems.html "enum bevy::prelude::JustifyItems") set on the parent node.

[https://developer.mozilla.org/en-US/docs/Web/CSS/justify-self](https://developer.mozilla.org/en-US/docs/Web/CSS/justify-self)

`align_content: [AlignContent](../../prelude/enum.AlignContent.html "enum bevy::prelude::AlignContent")`

Used to control how items are distributed.

*   For Flexbox containers, controls alignment of lines if `flex_wrap` is set to [`FlexWrap::Wrap`](../../prelude/enum.FlexWrap.html#variant.Wrap "variant bevy::prelude::FlexWrap::Wrap") and there are multiple lines of items.
...
`justify_content: [JustifyContent](../../prelude/enum.JustifyContent.html "enum bevy::prelude::JustifyContent")`
...
`direction: [InlineDirection](../../prelude/enum.InlineDirection.html "enum bevy::prelude::InlineDirection")`

Sets the inline axis direction (LTR or RTL) used for layout.

[https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/direction](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/direction)

`margin: [UiRect](../../prelude/struct.UiRect.html "struct bevy::prelude::UiRect")`
...
`padding: [UiRect](../../prelude/struct.UiRect.html "struct bevy::prelude::UiRect")`
...
`border: [UiRect](../../prelude/struct.UiRect.html "struct bevy::prelude::UiRect")`
...
`border_radius: [BorderRadius](../../prelude/struct.BorderRadius.html "struct bevy::prelude::BorderRadius")`
...
`flex_direction: [FlexDirection](../../prelude/enum.FlexDirection.html "enum bevy::prelude::FlexDirection")`
...
`flex_wrap: [FlexWrap](../../prelude/enum.FlexWrap.html "enum bevy::prelude::FlexWrap")`
...
`flex_grow: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`
...
`flex_shrink: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`
...
`flex_basis: [Val](../../prelude/enum.Val.html "enum bevy::prelude::Val")`
...
`row_gap: [Val](../../prelude/enum.Val.html "enum bevy::prelude::Val")`
...
`column_gap: [Val](../../prelude/enum.Val.html "enum bevy::prelude::Val")`
...
`grid_auto_flow: [GridAutoFlow](../../prelude/enum.GridAutoFlow.html "enum bevy::prelude::GridAutoFlow")`
...
`grid_template_rows: [Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[RepeatedGridTrack](../../prelude/struct.RepeatedGridTrack.html "struct bevy::prelude::RepeatedGridTrack")>`
...
[https://developer.mozilla.org/en-US/docs/Web/CSS/grid-template-rows](https://developer.mozilla.org/en-US/docs/Web/CSS/grid-template-rows)

`grid_template_columns: [Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[RepeatedGridTrack](../../prelude/struct.RepeatedGridTrack.html "struct bevy::prelude::RepeatedGridTrack")>`
...
`grid_auto_rows: [Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[GridTrack](../../prelude/struct.GridTrack.html "struct bevy::prelude::GridTrack")>`
...
`grid_auto_columns: [Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[GridTrack](../../prelude/struct.GridTrack.html "struct bevy::prelude::GridTrack")>`
...
`grid_row: [GridPlacement](../../prelude/struct.GridPlacement.html "struct bevy::prelude::GridPlacement")`
...
`grid_column: [GridPlacement](../../prelude/struct.GridPlacement.html "struct bevy::prelude::GridPlacement")`
...
[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#821)

### impl [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#822)

#### pub const [DEFAULT](#associatedconstant.DEFAULT): [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")

## Trait Implementations

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#471)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#471)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")

where [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

**Required Components**: [`ComputedNode`](../../prelude/struct.ComputedNode.html "struct bevy::prelude::ComputedNode"), [`ComputedStackIndex`](../struct.ComputedStackIndex.html "struct bevy::ui::ComputedStackIndex"), [`ContentSize`](../struct.ContentSize.html "struct bevy::ui::ContentSize"), [`ComputedUiTargetCamera`](../../prelude/struct.ComputedUiTargetCamera.html "struct bevy::prelude::ComputedUiTargetCamera"), [`ComputedUiRenderTargetInfo`](../../prelude/struct.ComputedUiRenderTargetInfo.html "struct bevy::prelude::ComputedUiRenderTargetInfo"), [`UiTransform`](../../prelude/struct.UiTransform.html "struct bevy::prelude::UiTransform"), [`BackgroundColor`](../../prelude/struct.BackgroundColor.html "struct bevy::prelude::BackgroundColor"), [`BorderColor`](../../prelude/struct.BorderColor.html "struct bevy::prelude::BorderColor"), [`FocusPolicy`](../enum.FocusPolicy.html "enum bevy::ui::FocusPolicy"), [`ScrollPosition`](../../prelude/struct.ScrollPosition.html "struct bevy::prelude::ScrollPosition"), [`Visibility`](../../prelude/enum.Visibility.html "enum bevy::prelude::Visibility"), [`ZIndex`](../../prelude/struct.ZIndex.html "struct bevy::prelude::ZIndex").
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")
...
[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#868)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#869)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#489)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#489)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Node](../../prelude/struct.Node.html "struct bevy::prelude::Node"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#471)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#471)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Node](../../prelude/struct.Node.html "struct bevy::prelude::Node") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")
...
where [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#471)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#471)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/ui_node.rs.html#486)
...
#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Node](../../prelude/struct.Node.html "struct bevy::prelude::Node")
