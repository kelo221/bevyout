...
# Struct UiChildrenIter 

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/experimental/ghost_hierarchy.rs.html#168)

```rust
pub struct UiChildrenIter<'w, 's> { /* private fields */ }
```
...
[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/experimental/ghost_hierarchy.rs.html#179)

### impl<'w, 's> [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator") for [UiChildrenIter](struct.UiChildrenIter.html "struct bevy::ui::experimental::UiChildrenIter")<'w, 's>

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/experimental/ghost_hierarchy.rs.html#180)
...
[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/experimental/ghost_hierarchy.rs.html#181)

#### fn [next](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#tymethod.next)(&mut self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[UiChildrenIter](struct.UiChildrenIter.html "struct bevy::ui::experimental::UiChildrenIter")<'w, 's> as [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")\>::[Item](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#associatedtype.Item "type core::iter::traits::iterator::Iterator::Item")\>
...
### impl<'w, 's> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [UiChildrenIter](struct.UiChildrenIter.html "struct bevy::ui::experimental::UiChildrenIter")<'w, 's>

### impl<'w, 's> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [UiChildrenIter](struct.UiChildrenIter.html "struct bevy::ui::experimental::UiChildrenIter")<'w, 's>

### impl<'w, 's> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [UiChildrenIter](struct.UiChildrenIter.html "struct bevy::ui::experimental::UiChildrenIter")<'w, 's>

### impl<'w, 's> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [UiChildrenIter](struct.UiChildrenIter.html "struct bevy::ui::experimental::UiChildrenIter")<'w, 's>

### impl<'w, 's> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [UiChildrenIter](struct.UiChildrenIter.html "struct bevy::ui::experimental::UiChildrenIter")<'w, 's>

### impl<'w, 's> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [UiChildrenIter](struct.UiChildrenIter.html "struct bevy::ui::experimental::UiChildrenIter")<'w, 's>

### impl<'w, 's> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [UiChildrenIter](struct.UiChildrenIter.html "struct bevy::ui::experimental::UiChildrenIter")<'w, 's>
