...
[`update_viewport_render_target_size`](fn.update_viewport_render_target_size.html "fn bevy::ui::widget::update_viewport_render_target_size")
...
Note: Despawning the camera entity will leave a viewport node with an invalid camera. It will automatically be set to none when [`update_viewport_render_target_size`](fn.update_viewport_render_target_size.html "fn bevy::ui::widget::update_viewport_render_target_size") runs next.
