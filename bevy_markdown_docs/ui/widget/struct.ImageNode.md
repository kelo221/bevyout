...
**Required Components**: [`Node`](../../prelude/struct.Node.html "struct bevy::prelude::Node"), [`ImageNodeSize`](struct.ImageNodeSize.html "struct bevy::ui::widget::ImageNodeSize").
...
#### type [Template](../../prelude/trait.FromTemplate.html#associatedtype.Template) = [ImageNodeTemplate](struct.ImageNodeTemplate.html "struct bevy::ui::widget::ImageNodeTemplate")
