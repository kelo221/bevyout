...
[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#833)
...
This types mirrors [`SamplerDescriptor`](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/texture/struct.SamplerDescriptor.html "struct wgpu_types::texture::SamplerDescriptor"), but that might change in future versions.

## Fields

`label: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[String](../prelude/struct.String.html "struct bevy::prelude::String")>`

An optional label used to identify this sampler in logs.

`address_mode_u: [ImageAddressMode](enum.ImageAddressMode.html "enum bevy::image::ImageAddressMode")`

How to deal with out of bounds accesses in the u (i.e. x) direction.

`address_mode_v: [ImageAddressMode](enum.ImageAddressMode.html "enum bevy::image::ImageAddressMode")`

How to deal with out of bounds accesses in the v (i.e. y) direction.

`address_mode_w: [ImageAddressMode](enum.ImageAddressMode.html "enum bevy::image::ImageAddressMode")`

How to deal with out of bounds accesses in the w (i.e. z) direction.

`mag_filter: [ImageFilterMode](enum.ImageFilterMode.html "enum bevy::image::ImageFilterMode")`

How to filter the texture when it needs to be magnified (made larger).

`min_filter: [ImageFilterMode](enum.ImageFilterMode.html "enum bevy::image::ImageFilterMode")`

How to filter the texture when it needs to be minified (made smaller).

`mipmap_filter: [ImageFilterMode](enum.ImageFilterMode.html "enum bevy::image::ImageFilterMode")`
...
`compare: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ImageCompareFunction](enum.ImageCompareFunction.html "enum bevy::image::ImageCompareFunction")>`
...
`border_color: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ImageSamplerBorderColor](enum.ImageSamplerBorderColor.html "enum bevy::image::ImageSamplerBorderColor")>`

Border color to use when `address_mode` is [`ImageAddressMode::ClampToBorder`](enum.ImageAddressMode.html#variant.ClampToBorder "variant bevy::image::ImageAddressMode::ClampToBorder").

## Implementations

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#879)

### impl [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#882)

#### pub fn [linear](#method.linear)() -> [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

Returns a sampler descriptor with [`Linear`](enum.ImageFilterMode.html#variant.Linear "variant bevy::image::ImageFilterMode::Linear") min and mag filters

##### [Examples found in repository](#scraped-examples)[?](../../scrape-examples-help.html)

examples/3d/motion\_blur.rs ([line 386](../../src/motion_blur/motion_blur.rs.html#386))
...
[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#893)

#### pub fn [nearest](#method.nearest)() -> [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

Returns a sampler descriptor with [`Nearest`](enum.ImageFilterMode.html#variant.Nearest "variant bevy::image::ImageFilterMode::Nearest") min and mag filters

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#904)

#### pub fn [set\_filter](#method.set_filter)( &mut self, filter: [ImageFilterMode](enum.ImageFilterMode.html "enum bevy::image::ImageFilterMode"), ) -> &mut [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

Returns this sampler descriptor with a new `ImageFilterMode` min, mag, and mipmap filters

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#913)

#### pub fn [set\_address\_mode](#method.set_address_mode)( &mut self, address\_mode: [ImageAddressMode](enum.ImageAddressMode.html "enum bevy::image::ImageAddressMode"), ) -> &mut [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

Returns this sampler descriptor with a new `ImageAddressMode` for u, v, and w

##### [Examples found in repository](#scraped-examples-1)[?](../../scrape-examples-help.html)

examples/3d/solari.rs ([line 252](../../src/solari/solari.rs.html#252))
...
[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#924)

#### pub fn [set\_anisotropic\_filter](#method.set_anisotropic_filter)( &mut self, anisotropy\_clamp: [u16](https://doc.rust-lang.org/nightly/std/primitive.u16.html), ) -> &mut [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

Returns this sampler descriptor with an `anisotropy_clamp` value and also set filters to `ImageFilterMode::Linear`, which is required to use anisotropy.

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#933)
...
[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#827)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#827)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")
...
[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#860)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#861)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#827)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#827)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#1061)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[SamplerDescriptor](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/texture/struct.SamplerDescriptor.html "struct wgpu_types::texture::SamplerDescriptor")<[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>>> for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#1062)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [SamplerDescriptor](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/texture/struct.SamplerDescriptor.html "struct wgpu_types::texture::SamplerDescriptor")<[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>>) -> [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#830)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#830)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#830)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#830)

### impl [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#830)

#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")
...
where [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#827)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")
...
#### fn [reflect\_owned](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#830)

#### fn [try\_into\_reflect](../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")\>, ) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#831)
...
### impl [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#830)

#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")
...
### impl [Struct](../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#830)

### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ImageSamplerDescriptor](struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")
