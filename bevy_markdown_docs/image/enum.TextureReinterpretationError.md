...
# Enum TextureReinterpretationError 

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#2170)
...
`old: [Extent3d](../render/render_resource/struct.Extent3d.html "struct bevy::render::render_resource::Extent3d")`

The original image extent.

`new: [Extent3d](../render/render_resource/struct.Extent3d.html "struct bevy::render::render_resource::Extent3d")`
...
In a texture 2d array, there needs to be at least 2 layers or else a render validation error will be throw.
...
`layers: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
`tile_count_y: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
`tile_count_x: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#2169)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [TextureReinterpretationError](enum.TextureReinterpretationError.html "enum bevy::image::TextureReinterpretationError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [TextureReinterpretationError](enum.TextureReinterpretationError.html "enum bevy::image::TextureReinterpretationError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [TextureReinterpretationError](enum.TextureReinterpretationError.html "enum bevy::image::TextureReinterpretationError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TextureReinterpretationError](enum.TextureReinterpretationError.html "enum bevy::image::TextureReinterpretationError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TextureReinterpretationError](enum.TextureReinterpretationError.html "enum bevy::image::TextureReinterpretationError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TextureReinterpretationError](enum.TextureReinterpretationError.html "enum bevy::image::TextureReinterpretationError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TextureReinterpretationError](enum.TextureReinterpretationError.html "enum bevy::image::TextureReinterpretationError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TextureReinterpretationError](enum.TextureReinterpretationError.html "enum bevy::image::TextureReinterpretationError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TextureReinterpretationError](enum.TextureReinterpretationError.html "enum bevy::image::TextureReinterpretationError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TextureReinterpretationError](enum.TextureReinterpretationError.html "enum bevy::image::TextureReinterpretationError")
