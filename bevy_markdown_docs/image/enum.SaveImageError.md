...
[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/saver.rs.html#128)
...
### MissingExtension([AssetPath](../asset/struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>)

Cannot deduce file format from extension because there is no extension.

### UnknownExtension([String](../prelude/struct.String.html "struct bevy::prelude::String"))

Cannot deduce file format from extension since this extension is unknown. Holds the extension that could not be matched.

### ImageMissingData

[`Image::data`](../prelude/struct.Image.html#structfield.data "field bevy::prelude::Image::data") is [`None`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.None "variant core::option::Option::None"), so there is no data to save. See [`RenderAssetUsages`](../asset/struct.RenderAssetUsages.html "struct bevy::asset::RenderAssetUsages") for more.

### UnsupportedFormat([ImageFormat](../prelude/enum.ImageFormat.html "enum bevy::prelude::ImageFormat"))

The image saver doesn’t support the file format being requested.

### UnsupportedSaveColorTypeForFormat([ImageFormat](../prelude/enum.ImageFormat.html "enum bevy::prelude::ImageFormat"), [TextureFormat](../render/render_resource/enum.TextureFormat.html "enum bevy::render::render_resource::TextureFormat"))

The image saver doesn’t support the texture format of the image data for the image format.

### ImageError([ImageError](https://docs.rs/image/0.25.9/x86_64-unknown-linux-gnu/image/error/enum.ImageError.html "enum image::error::ImageError"))

The [`image`](https://docs.rs/image/0.25.9/x86_64-unknown-linux-gnu/image/index.html "mod image") crate returned an error.

### IoError([Error](../tasks/futures_lite/io/struct.Error.html "struct bevy::tasks::futures_lite::io::Error"))
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [SaveImageError](enum.SaveImageError.html "enum bevy::image::SaveImageError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [SaveImageError](enum.SaveImageError.html "enum bevy::image::SaveImageError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [SaveImageError](enum.SaveImageError.html "enum bevy::image::SaveImageError")
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Error](../tasks/futures_lite/io/struct.Error.html "struct bevy::tasks::futures_lite::io::Error")\> for [SaveImageError](enum.SaveImageError.html "enum bevy::image::SaveImageError")

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/saver.rs.html#127)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(source: [Error](../tasks/futures_lite/io/struct.Error.html "struct bevy::tasks::futures_lite::io::Error")) -> [SaveImageError](enum.SaveImageError.html "enum bevy::image::SaveImageError")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/saver.rs.html#148)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[ImageError](https://docs.rs/image/0.25.9/x86_64-unknown-linux-gnu/image/error/enum.ImageError.html "enum image::error::ImageError")\> for [SaveImageError](enum.SaveImageError.html "enum bevy::image::SaveImageError")

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/saver.rs.html#127)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(source: [ImageError](https://docs.rs/image/0.25.9/x86_64-unknown-linux-gnu/image/error/enum.ImageError.html "enum image::error::ImageError")) -> [SaveImageError](enum.SaveImageError.html "enum bevy::image::SaveImageError")

Converts to this type from the input type.

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SaveImageError](enum.SaveImageError.html "enum bevy::image::SaveImageError")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SaveImageError](enum.SaveImageError.html "enum bevy::image::SaveImageError")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SaveImageError](enum.SaveImageError.html "enum bevy::image::SaveImageError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SaveImageError](enum.SaveImageError.html "enum bevy::image::SaveImageError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SaveImageError](enum.SaveImageError.html "enum bevy::image::SaveImageError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SaveImageError](enum.SaveImageError.html "enum bevy::image::SaveImageError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SaveImageError](enum.SaveImageError.html "enum bevy::image::SaveImageError")
