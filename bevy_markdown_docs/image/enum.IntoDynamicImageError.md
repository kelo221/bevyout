...
# Enum IntoDynamicImageError 

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image_texture_conversion.rs.html#208)
...
### UnsupportedFormat([TextureFormat](../render/render_resource/enum.TextureFormat.html "enum bevy::render::render_resource::TextureFormat"))

Conversion into dynamic image not supported for source format.

### UnknownConversionError([TextureFormat](../render/render_resource/enum.TextureFormat.html "enum bevy::render::render_resource::TextureFormat"))
...
[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image_texture_conversion.rs.html#207)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [IntoDynamicImageError](enum.IntoDynamicImageError.html "enum bevy::image::IntoDynamicImageError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [IntoDynamicImageError](enum.IntoDynamicImageError.html "enum bevy::image::IntoDynamicImageError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [IntoDynamicImageError](enum.IntoDynamicImageError.html "enum bevy::image::IntoDynamicImageError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [IntoDynamicImageError](enum.IntoDynamicImageError.html "enum bevy::image::IntoDynamicImageError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [IntoDynamicImageError](enum.IntoDynamicImageError.html "enum bevy::image::IntoDynamicImageError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [IntoDynamicImageError](enum.IntoDynamicImageError.html "enum bevy::image::IntoDynamicImageError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [IntoDynamicImageError](enum.IntoDynamicImageError.html "enum bevy::image::IntoDynamicImageError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [IntoDynamicImageError](enum.IntoDynamicImageError.html "enum bevy::image::IntoDynamicImageError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [IntoDynamicImageError](enum.IntoDynamicImageError.html "enum bevy::image::IntoDynamicImageError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [IntoDynamicImageError](enum.IntoDynamicImageError.html "enum bevy::image::IntoDynamicImageError")
