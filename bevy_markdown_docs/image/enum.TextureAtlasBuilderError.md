...
# Enum TextureAtlasBuilderError 

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/texture_atlas_builder.rs.html#17)
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [TextureAtlasBuilderError](enum.TextureAtlasBuilderError.html "enum bevy::image::TextureAtlasBuilderError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [TextureAtlasBuilderError](enum.TextureAtlasBuilderError.html "enum bevy::image::TextureAtlasBuilderError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [TextureAtlasBuilderError](enum.TextureAtlasBuilderError.html "enum bevy::image::TextureAtlasBuilderError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TextureAtlasBuilderError](enum.TextureAtlasBuilderError.html "enum bevy::image::TextureAtlasBuilderError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TextureAtlasBuilderError](enum.TextureAtlasBuilderError.html "enum bevy::image::TextureAtlasBuilderError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TextureAtlasBuilderError](enum.TextureAtlasBuilderError.html "enum bevy::image::TextureAtlasBuilderError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TextureAtlasBuilderError](enum.TextureAtlasBuilderError.html "enum bevy::image::TextureAtlasBuilderError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TextureAtlasBuilderError](enum.TextureAtlasBuilderError.html "enum bevy::image::TextureAtlasBuilderError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TextureAtlasBuilderError](enum.TextureAtlasBuilderError.html "enum bevy::image::TextureAtlasBuilderError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TextureAtlasBuilderError](enum.TextureAtlasBuilderError.html "enum bevy::image::TextureAtlasBuilderError")
