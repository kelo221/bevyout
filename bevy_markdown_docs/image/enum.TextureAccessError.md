...
# Enum TextureAccessError 

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#2220)
...
### UnsupportedTextureFormat([TextureFormat](../render/render_resource/enum.TextureFormat.html "enum bevy::render::render_resource::TextureFormat"))
...
Attempted to access the data of an image before it was initialized, or after it was moved to the GPU.

See [`RenderAssetUsages`](../asset/struct.RenderAssetUsages.html "struct bevy::asset::RenderAssetUsages") for more information about when an asset’s data is moved, and how to retain it if necessary.
...
[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/image.rs.html#2219)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [TextureAccessError](enum.TextureAccessError.html "enum bevy::image::TextureAccessError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [TextureAccessError](enum.TextureAccessError.html "enum bevy::image::TextureAccessError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [TextureAccessError](enum.TextureAccessError.html "enum bevy::image::TextureAccessError")
...
[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/dynamic_texture_atlas_builder.rs.html#22)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[TextureAccessError](enum.TextureAccessError.html "enum bevy::image::TextureAccessError")\> for [DynamicTextureAtlasBuilderError](enum.DynamicTextureAtlasBuilderError.html "enum bevy::image::DynamicTextureAtlasBuilderError")

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/dynamic_texture_atlas_builder.rs.html#9)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(source: [TextureAccessError](enum.TextureAccessError.html "enum bevy::image::TextureAccessError")) -> [DynamicTextureAtlasBuilderError](enum.DynamicTextureAtlasBuilderError.html "enum bevy::image::DynamicTextureAtlasBuilderError")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/texture_atlas_builder.rs.html#32)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[TextureAccessError](enum.TextureAccessError.html "enum bevy::image::TextureAccessError")\> for [TextureAtlasBuilderError](enum.TextureAtlasBuilderError.html "enum bevy::image::TextureAtlasBuilderError")

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/texture_atlas_builder.rs.html#16)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(source: [TextureAccessError](enum.TextureAccessError.html "enum bevy::image::TextureAccessError")) -> [TextureAtlasBuilderError](enum.TextureAtlasBuilderError.html "enum bevy::image::TextureAtlasBuilderError")

Converts to this type from the input type.

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TextureAccessError](enum.TextureAccessError.html "enum bevy::image::TextureAccessError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TextureAccessError](enum.TextureAccessError.html "enum bevy::image::TextureAccessError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TextureAccessError](enum.TextureAccessError.html "enum bevy::image::TextureAccessError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TextureAccessError](enum.TextureAccessError.html "enum bevy::image::TextureAccessError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TextureAccessError](enum.TextureAccessError.html "enum bevy::image::TextureAccessError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TextureAccessError](enum.TextureAccessError.html "enum bevy::image::TextureAccessError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TextureAccessError](enum.TextureAccessError.html "enum bevy::image::TextureAccessError")
