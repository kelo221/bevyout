...
# Struct CompressedImageSaver 

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/compressed_image_saver.rs.html#13)
...
### impl [AssetSaver](../asset/saver/trait.AssetSaver.html "trait bevy::asset::saver::AssetSaver") for [CompressedImageSaver](struct.CompressedImageSaver.html "struct bevy::image::CompressedImageSaver")
...
#### type [Settings](../asset/saver/trait.AssetSaver.html#associatedtype.Settings) = [()](https://doc.rust-lang.org/nightly/std/primitive.unit.html)
...
#### type [Error](../asset/saver/trait.AssetSaver.html#associatedtype.Error) = [CompressedImageSaverError](enum.CompressedImageSaverError.html "enum bevy::image::CompressedImageSaverError")
...
[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/compressed_image_saver.rs.html#34-40)

#### async fn [save](../asset/saver/trait.AssetSaver.html#tymethod.save)( &self, writer: &mut (dyn [AsyncWrite](../tasks/futures_lite/trait.AsyncWrite.html "trait bevy::tasks::futures_lite::AsyncWrite") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static), image: [SavedAsset](../asset/saver/struct.SavedAsset.html "struct bevy::asset::saver::SavedAsset")<'\_, '\_, <[CompressedImageSaver](struct.CompressedImageSaver.html "struct bevy::image::CompressedImageSaver") as [AssetSaver](../asset/saver/trait.AssetSaver.html "trait bevy::asset::saver::AssetSaver")\>::[Asset](../asset/saver/trait.AssetSaver.html#associatedtype.Asset "type bevy::asset::saver::AssetSaver::Asset")\>, \_settings: &<[CompressedImageSaver](struct.CompressedImageSaver.html "struct bevy::image::CompressedImageSaver") as [AssetSaver](../asset/saver/trait.AssetSaver.html "trait bevy::asset::saver::AssetSaver")\>::[Settings](../asset/saver/trait.AssetSaver.html#associatedtype.Settings "type bevy::asset::saver::AssetSaver::Settings"), \_asset\_path: [AssetPath](../asset/struct.AssetPath.html "struct bevy::asset::AssetPath")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[ImageLoaderSettings](struct.ImageLoaderSettings.html "struct bevy::image::ImageLoaderSettings"), <[CompressedImageSaver](struct.CompressedImageSaver.html "struct bevy::image::CompressedImageSaver") as [AssetSaver](../asset/saver/trait.AssetSaver.html "trait bevy::asset::saver::AssetSaver")\>::[Error](../asset/saver/trait.AssetSaver.html#associatedtype.Error "type bevy::asset::saver::AssetSaver::Error")\>
...
### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [CompressedImageSaver](struct.CompressedImageSaver.html "struct bevy::image::CompressedImageSaver")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [CompressedImageSaver](struct.CompressedImageSaver.html "struct bevy::image::CompressedImageSaver")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [CompressedImageSaver](struct.CompressedImageSaver.html "struct bevy::image::CompressedImageSaver")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [CompressedImageSaver](struct.CompressedImageSaver.html "struct bevy::image::CompressedImageSaver")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [CompressedImageSaver](struct.CompressedImageSaver.html "struct bevy::image::CompressedImageSaver")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [CompressedImageSaver](struct.CompressedImageSaver.html "struct bevy::image::CompressedImageSaver")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [CompressedImageSaver](struct.CompressedImageSaver.html "struct bevy::image::CompressedImageSaver")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [CompressedImageSaver](struct.CompressedImageSaver.html "struct bevy::image::CompressedImageSaver")
