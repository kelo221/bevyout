...
[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/saver.rs.html#21)
...
Unlike `CompressedImageSaver`, this does not attempt to do any “texture optimization”, like compression (though some file formats intrinsically perform some compression, e.g., JPEG).

Some file formats do not support all texture formats (e.g., PNG does not support [`TextureFormat::Rg8Unorm`](../render/render_resource/enum.TextureFormat.html#variant.Rg8Unorm "variant bevy::render::render_resource::TextureFormat::Rg8Unorm")). In some cases, [`ImageSaver`](struct.ImageSaver.html "struct bevy::image::ImageSaver") will convert the image to allow writing as the requested file format.

## Trait Implementations

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/saver.rs.html#23)

### impl [AssetSaver](../asset/saver/trait.AssetSaver.html "trait bevy::asset::saver::AssetSaver") for [ImageSaver](struct.ImageSaver.html "struct bevy::image::ImageSaver")

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/saver.rs.html#24)

#### type [Asset](../asset/saver/trait.AssetSaver.html#associatedtype.Asset) = [Image](../prelude/struct.Image.html "struct bevy::prelude::Image")

The top level [`Asset`](../prelude/trait.Asset.html "trait bevy::prelude::Asset") saved by this [`AssetSaver`](../asset/saver/trait.AssetSaver.html "trait bevy::asset::saver::AssetSaver").

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/saver.rs.html#25)

#### type [Error](../asset/saver/trait.AssetSaver.html#associatedtype.Error) = [SaveImageError](enum.SaveImageError.html "enum bevy::image::SaveImageError")
...
#### type [OutputLoader](../asset/saver/trait.AssetSaver.html#associatedtype.OutputLoader) = [ImageLoader](struct.ImageLoader.html "struct bevy::image::ImageLoader")

The type of [`AssetLoader`](../asset/trait.AssetLoader.html "trait bevy::asset::AssetLoader") used to load this [`Asset`](../prelude/trait.Asset.html "trait bevy::prelude::Asset")

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/saver.rs.html#27)

#### type [Settings](../asset/saver/trait.AssetSaver.html#associatedtype.Settings) = [ImageSaverSettings](struct.ImageSaverSettings.html "struct bevy::image::ImageSaverSettings")

The settings type used by this [`AssetSaver`](../asset/saver/trait.AssetSaver.html "trait bevy::asset::saver::AssetSaver").

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/saver.rs.html#29-35)

#### async fn [save](../asset/saver/trait.AssetSaver.html#tymethod.save)( &self, \_writer: &mut (dyn [AsyncWrite](../tasks/futures_lite/trait.AsyncWrite.html "trait bevy::tasks::futures_lite::AsyncWrite") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static), asset: [SavedAsset](../asset/saver/struct.SavedAsset.html "struct bevy::asset::saver::SavedAsset")<'\_, '\_, <[ImageSaver](struct.ImageSaver.html "struct bevy::image::ImageSaver") as [AssetSaver](../asset/saver/trait.AssetSaver.html "trait bevy::asset::saver::AssetSaver")\>::[Asset](../asset/saver/trait.AssetSaver.html#associatedtype.Asset "type bevy::asset::saver::AssetSaver::Asset")\>, settings: &<[ImageSaver](struct.ImageSaver.html "struct bevy::image::ImageSaver") as [AssetSaver](../asset/saver/trait.AssetSaver.html "trait bevy::asset::saver::AssetSaver")\>::[Settings](../asset/saver/trait.AssetSaver.html#associatedtype.Settings "type bevy::asset::saver::AssetSaver::Settings"), asset\_path: [AssetPath](../asset/struct.AssetPath.html "struct bevy::asset::AssetPath")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[ImageLoaderSettings](struct.ImageLoaderSettings.html "struct bevy::image::ImageLoaderSettings"), <[ImageSaver](struct.ImageSaver.html "struct bevy::image::ImageSaver") as [AssetSaver](../asset/saver/trait.AssetSaver.html "trait bevy::asset::saver::AssetSaver")\>::[Error](../asset/saver/trait.AssetSaver.html#associatedtype.Error "type bevy::asset::saver::AssetSaver::Error")\>
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ImageSaver](struct.ImageSaver.html "struct bevy::image::ImageSaver")

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/saver.rs.html#20)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ImageSaver](struct.ImageSaver.html "struct bevy::image::ImageSaver")
...
### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [ImageSaver](struct.ImageSaver.html "struct bevy::image::ImageSaver")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ImageSaver](struct.ImageSaver.html "struct bevy::image::ImageSaver")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ImageSaver](struct.ImageSaver.html "struct bevy::image::ImageSaver")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ImageSaver](struct.ImageSaver.html "struct bevy::image::ImageSaver")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ImageSaver](struct.ImageSaver.html "struct bevy::image::ImageSaver")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ImageSaver](struct.ImageSaver.html "struct bevy::image::ImageSaver")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ImageSaver](struct.ImageSaver.html "struct bevy::image::ImageSaver")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ImageSaver](struct.ImageSaver.html "struct bevy::image::ImageSaver")
...
### impl<S> [ErasedAssetSaver](../asset/saver/trait.ErasedAssetSaver.html "trait bevy::asset::saver::ErasedAssetSaver") for S

where S: [AssetSaver](../asset/saver/trait.AssetSaver.html "trait bevy::asset::saver::AssetSaver"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/saver.rs.html#69-75)

#### fn [save](../asset/saver/trait.ErasedAssetSaver.html#tymethod.save)<'a>( &'a self, writer: &'a mut (dyn [AsyncWrite](../tasks/futures_lite/trait.AsyncWrite.html "trait bevy::tasks::futures_lite::AsyncWrite") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static), asset: &'a [ErasedLoadedAsset](../asset/struct.ErasedLoadedAsset.html "struct bevy::asset::ErasedLoadedAsset"), settings: &'a (dyn [Settings](../asset/meta/trait.Settings.html "trait bevy::asset::meta::Settings") + 'static), asset\_path: [AssetPath](../asset/struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>, ) -> [Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [ConditionalSendFuture](../tasks/trait.ConditionalSendFuture.html "trait bevy::tasks::ConditionalSendFuture")<Output = [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [BevyError](../prelude/struct.BevyError.html "struct bevy::prelude::BevyError")\>> + 'a>>

Saves the given runtime [`ErasedLoadedAsset`](../asset/struct.ErasedLoadedAsset.html "struct bevy::asset::ErasedLoadedAsset") by writing it to a byte format using `writer`. The passed in `settings` can influence how the `asset` is saved.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/saver.rs.html#87)

#### fn [type\_name](../asset/saver/trait.ErasedAssetSaver.html#tymethod.type_name)(&self) -> &'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)

The type name of the [`AssetSaver`](../asset/saver/trait.AssetSaver.html "trait bevy::asset::saver::AssetSaver").
