...
You cannot directly mutate [`GlobalTransform`](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform"); instead, you change an entity’s transform by manipulating its [`Transform`](../../prelude/struct.Transform.html "struct bevy::prelude::Transform"), which indirectly causes Bevy to update its [`GlobalTransform`](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform").
...
[`Transform`](../../prelude/struct.Transform.html "struct bevy::prelude::Transform") transforms an entity relative to its parent’s reference frame, or relative to world space coordinates, if it doesn’t have a [`ChildOf`](../../prelude/struct.ChildOf.html "struct bevy::prelude::ChildOf") component.

[`GlobalTransform`](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform") is managed by Bevy; it is computed by successively applying the [`Transform`](../../prelude/struct.Transform.html "struct bevy::prelude::Transform") of each ancestor entity which has a Transform. This is done automatically by Bevy-internal systems in the [`TransformSystems::Propagate`](../../prelude/enum.TransformSystems.html#variant.Propagate "variant bevy::prelude::TransformSystems::Propagate") system set.

This system runs during [`PostUpdate`](../../prelude/struct.PostUpdate.html "struct bevy::prelude::PostUpdate"). If you update the [`Transform`](../../prelude/struct.Transform.html "struct bevy::prelude::Transform") of an entity in this schedule or after, you will notice a 1 frame lag before the [`GlobalTransform`](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform") is updated.
...
### impl [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")
...
#### pub const [IDENTITY](#associatedconstant.IDENTITY): [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")

An identity [`GlobalTransform`](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform") that maps all points in space to themselves.
...
Returns the 3d affine transformation matrix as a [`Mat4`](../../prelude/struct.Mat4.html "struct bevy::prelude::Mat4").
...
#### pub fn [compute\_transform](#method.compute_transform)(&self) -> [Transform](../../prelude/struct.Transform.html "struct bevy::prelude::Transform")

Returns the transformation as a [`Transform`](../../prelude/struct.Transform.html "struct bevy::prelude::Transform").
...
Computes a Scale-Rotation-Translation decomposition of the transformation and returns the isometric part as an [isometry](../../prelude/struct.Isometry3d.html "struct bevy::prelude::Isometry3d"). Any scaling done by the transformation will be ignored. Note: this is a somewhat costly and lossy conversion.
...
#### pub fn [reparented\_to](#method.reparented_to)(&self, parent: &[GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")) -> [Transform](../../prelude/struct.Transform.html "struct bevy::prelude::Transform")

Returns the [`Transform`](../../prelude/struct.Transform.html "struct bevy::prelude::Transform") `self` would have if it was a child of an entity with the `parent` [`GlobalTransform`](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform").

This is useful if you want to “reparent” an [`Entity`](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"). Say you have an entity `e1` that you want to turn into a child of `e2`, but you want `e1` to keep the same global transform, even after re-parenting. You would use:
...
#### pub fn [translation](#method.translation)(&self) -> [Vec3](../../prelude/struct.Vec3.html "struct bevy::prelude::Vec3")

Get the translation as a [`Vec3`](../../prelude/struct.Vec3.html "struct bevy::prelude::Vec3").
...
#### pub fn [translation\_vec3a](#method.translation_vec3a)(&self) -> [Vec3A](../../prelude/struct.Vec3A.html "struct bevy::prelude::Vec3A")

Get the translation as a [`Vec3A`](../../prelude/struct.Vec3A.html "struct bevy::prelude::Vec3A").
...
#### pub fn [rotation](#method.rotation)(&self) -> [Quat](../../prelude/struct.Quat.html "struct bevy::prelude::Quat")

Get the rotation as a [`Quat`](../../prelude/struct.Quat.html "struct bevy::prelude::Quat").
...
#### pub fn [scale](#method.scale)(&self) -> [Vec3](../../prelude/struct.Vec3.html "struct bevy::prelude::Vec3")

Get the scale as a [`Vec3`](../../prelude/struct.Vec3.html "struct bevy::prelude::Vec3").
...
#### pub fn [radius\_vec3a](#method.radius_vec3a)(&self, extents: [Vec3A](../../prelude/struct.Vec3A.html "struct bevy::prelude::Vec3A")) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)
...
#### pub fn [mul\_transform](#method.mul_transform)(&self, transform: [Transform](../../prelude/struct.Transform.html "struct bevy::prelude::Transform")) -> [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")

Multiplies `self` with `transform` component by component, returning the resulting [`GlobalTransform`](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")

[Source](https://docs.rs/bevy_transform/0.19.0/x86_64-unknown-linux-gnu/src/bevy_transform/components/global_transform.rs.html#48)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")

where [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")

[Source](https://docs.rs/bevy_transform/0.19.0/x86_64-unknown-linux-gnu/src/bevy_transform/components/global_transform.rs.html#48)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")
...
#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")
...
### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")

[Source](https://docs.rs/bevy_transform/0.19.0/x86_64-unknown-linux-gnu/src/bevy_transform/components/global_transform.rs.html#49)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Affine3A](../../math/struct.Affine3A.html "struct bevy::math::Affine3A")\> for [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")

[Source](https://docs.rs/bevy_transform/0.19.0/x86_64-unknown-linux-gnu/src/bevy_transform/components/global_transform.rs.html#48)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Affine3A](../../math/struct.Affine3A.html "struct bevy::math::Affine3A")) -> [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")
...
### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")

[Source](https://docs.rs/bevy_transform/0.19.0/x86_64-unknown-linux-gnu/src/bevy_transform/components/global_transform.rs.html#53)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_transform/0.19.0/x86_64-unknown-linux-gnu/src/bevy_transform/components/global_transform.rs.html#53)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")
...
where [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform"): 'into\_return,
...
### impl [Mul](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Mul.html "trait core::ops::arith::Mul") for [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")

[Source](https://docs.rs/bevy_transform/0.19.0/x86_64-unknown-linux-gnu/src/bevy_transform/components/global_transform.rs.html#48)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_transform/0.19.0/x86_64-unknown-linux-gnu/src/bevy_transform/components/global_transform.rs.html#53)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")
