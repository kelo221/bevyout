...
# Enum ComputeGlobalTransformError 

[Source](https://docs.rs/bevy_transform/0.19.0/x86_64-unknown-linux-gnu/src/bevy_transform/helper.rs.html#69)
...
Error returned by [`TransformHelper::compute_global_transform`](../../prelude/struct.TransformHelper.html#method.compute_global_transform "method bevy::prelude::TransformHelper::compute_global_transform").

## Variants

### MissingTransform([Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"))

The entity or one of its ancestors is missing the [`Transform`](../../prelude/struct.Transform.html "struct bevy::prelude::Transform") component.

### NoSuchEntity([EntityNotSpawnedError](../../ecs/entity/enum.EntityNotSpawnedError.html "enum bevy::ecs::entity::EntityNotSpawnedError"))

The entity does not exist.

### MalformedHierarchy([EntityNotSpawnedError](../../ecs/entity/enum.EntityNotSpawnedError.html "enum bevy::ecs::entity::EntityNotSpawnedError"))

An ancestor is missing. This probably means that your hierarchy has been improperly maintained.

## Trait Implementations

[Source](https://docs.rs/bevy_transform/0.19.0/x86_64-unknown-linux-gnu/src/bevy_transform/helper.rs.html#68)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ComputeGlobalTransformError](enum.ComputeGlobalTransformError.html "enum bevy::transform::helper::ComputeGlobalTransformError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [ComputeGlobalTransformError](enum.ComputeGlobalTransformError.html "enum bevy::transform::helper::ComputeGlobalTransformError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [ComputeGlobalTransformError](enum.ComputeGlobalTransformError.html "enum bevy::transform::helper::ComputeGlobalTransformError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ComputeGlobalTransformError](enum.ComputeGlobalTransformError.html "enum bevy::transform::helper::ComputeGlobalTransformError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ComputeGlobalTransformError](enum.ComputeGlobalTransformError.html "enum bevy::transform::helper::ComputeGlobalTransformError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ComputeGlobalTransformError](enum.ComputeGlobalTransformError.html "enum bevy::transform::helper::ComputeGlobalTransformError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ComputeGlobalTransformError](enum.ComputeGlobalTransformError.html "enum bevy::transform::helper::ComputeGlobalTransformError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ComputeGlobalTransformError](enum.ComputeGlobalTransformError.html "enum bevy::transform::helper::ComputeGlobalTransformError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ComputeGlobalTransformError](enum.ComputeGlobalTransformError.html "enum bevy::transform::helper::ComputeGlobalTransformError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ComputeGlobalTransformError](enum.ComputeGlobalTransformError.html "enum bevy::transform::helper::ComputeGlobalTransformError")
