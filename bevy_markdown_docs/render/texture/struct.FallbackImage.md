...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/texture/fallback_image.rs.html#23)
...
Defaults to a 1x1 fully opaque white texture, (1.0, 1.0, 1.0, 1.0) which makes multiplying it with other colors a no-op.

## Fields

`d1: [GpuImage](struct.GpuImage.html "struct bevy::render::texture::GpuImage")`

Fallback image for [`TextureViewDimension::D1`](../render_resource/enum.TextureViewDimension.html#variant.D1 "variant bevy::render::render_resource::TextureViewDimension::D1").

`d2: [GpuImage](struct.GpuImage.html "struct bevy::render::texture::GpuImage")`

Fallback image for [`TextureViewDimension::D2`](../render_resource/enum.TextureViewDimension.html#variant.D2 "variant bevy::render::render_resource::TextureViewDimension::D2").

`d2_array: [GpuImage](struct.GpuImage.html "struct bevy::render::texture::GpuImage")`

Fallback image for [`TextureViewDimension::D2Array`](../render_resource/enum.TextureViewDimension.html#variant.D2Array "variant bevy::render::render_resource::TextureViewDimension::D2Array").

`cube: [GpuImage](struct.GpuImage.html "struct bevy::render::texture::GpuImage")`

Fallback image for [`TextureViewDimension::Cube`](../render_resource/enum.TextureViewDimension.html#variant.Cube "variant bevy::render::render_resource::TextureViewDimension::Cube").

`cube_array: [GpuImage](struct.GpuImage.html "struct bevy::render::texture::GpuImage")`

Fallback image for [`TextureViewDimension::CubeArray`](../render_resource/enum.TextureViewDimension.html#variant.CubeArray "variant bevy::render::render_resource::TextureViewDimension::CubeArray").

`d3: [GpuImage](struct.GpuImage.html "struct bevy::render::texture::GpuImage")`

Fallback image for [`TextureViewDimension::D3`](../render_resource/enum.TextureViewDimension.html#variant.D3 "variant bevy::render::render_resource::TextureViewDimension::D3").

## Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/texture/fallback_image.rs.html#38)

### impl [FallbackImage](struct.FallbackImage.html "struct bevy::render::texture::FallbackImage")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/texture/fallback_image.rs.html#40)

#### pub fn [get](#method.get)(&self, texture\_dimension: [TextureViewDimension](../render_resource/enum.TextureViewDimension.html "enum bevy::render::render_resource::TextureViewDimension")) -> &[GpuImage](struct.GpuImage.html "struct bevy::render::texture::GpuImage")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [FallbackImage](struct.FallbackImage.html "struct bevy::render::texture::FallbackImage")

where [FallbackImage](struct.FallbackImage.html "struct bevy::render::texture::FallbackImage"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [FromWorld](../../prelude/trait.FromWorld.html "trait bevy::prelude::FromWorld") for [FallbackImage](struct.FallbackImage.html "struct bevy::render::texture::FallbackImage")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/texture/fallback_image.rs.html#145)

#### fn [from\_world](../../prelude/trait.FromWorld.html#tymethod.from_world)(world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World")) -> [FallbackImage](struct.FallbackImage.html "struct bevy::render::texture::FallbackImage")

Creates `Self` using data from the given [`World`](../../prelude/struct.World.html "struct bevy::prelude::World").

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/texture/fallback_image.rs.html#22)

### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [FallbackImage](struct.FallbackImage.html "struct bevy::render::texture::FallbackImage")

where [FallbackImage](struct.FallbackImage.html "struct bevy::render::texture::FallbackImage"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [FallbackImage](struct.FallbackImage.html "struct bevy::render::texture::FallbackImage")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [FallbackImage](struct.FallbackImage.html "struct bevy::render::texture::FallbackImage")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [FallbackImage](struct.FallbackImage.html "struct bevy::render::texture::FallbackImage")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [FallbackImage](struct.FallbackImage.html "struct bevy::render::texture::FallbackImage")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [FallbackImage](struct.FallbackImage.html "struct bevy::render::texture::FallbackImage")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [FallbackImage](struct.FallbackImage.html "struct bevy::render::texture::FallbackImage")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [FallbackImage](struct.FallbackImage.html "struct bevy::render::texture::FallbackImage")
