...
[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#23)
...
A TLAS contains a series of [TLAS instances](struct.TlasInstance.html "struct bevy::render::render_resource::TlasInstance"), which are a reference to a BLAS and a transformation matrix placing the geometry in the world.

A TLAS also contains an extra set of TLAS instances in a device readable form, you cant interact directly with these, instead you have to build the TLAS with [TLAS instances](struct.TlasInstance.html "struct bevy::render::render_resource::TlasInstance").

## Implementations

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#32)

### impl [Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#71-73)

#### pub unsafe fn [as\_hal](#method.as_hal)<A>( &mut self, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<impl [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")<Target = <A as [Api](https://docs.rs/wgpu-hal/29.0.3/x86_64-unknown-linux-gnu/wgpu_hal/trait.Api.html "trait wgpu_hal::Api")\>::[AccelerationStructure](https://docs.rs/wgpu-hal/29.0.3/x86_64-unknown-linux-gnu/wgpu_hal/trait.Api.html#associatedtype.AccelerationStructure "type wgpu_hal::Api::AccelerationStructure")\>>

where A: [Api](https://docs.rs/wgpu-hal/29.0.3/x86_64-unknown-linux-gnu/wgpu_hal/trait.Api.html "trait wgpu_hal::Api"),

Available on **`wgpu_core`** only.

Get the [`wgpu_hal`](https://docs.rs/wgpu-hal/29.0.3/x86_64-unknown-linux-gnu/wgpu_hal/index.html "mod wgpu_hal") acceleration structure from this `Tlas`.

Find the Api struct corresponding to the active backend in [`wgpu_hal::api`](https://docs.rs/wgpu-hal/29.0.3/x86_64-unknown-linux-gnu/wgpu_hal/api/index.html "mod wgpu_hal::api"), and pass that struct to the to the `A` type parameter.

Returns a guard that dereferences to the type of the hal backend which implements [`A::AccelerationStructure`](https://docs.rs/wgpu-hal/29.0.3/x86_64-unknown-linux-gnu/wgpu_hal/trait.Api.html#associatedtype.AccelerationStructure "associated type wgpu_hal::Api::AccelerationStructure").

##### Types

The returned type depends on the backend:

*   [`hal::api::Vulkan`](https://docs.rs/wgpu-hal/29.0.3/x86_64-unknown-linux-gnu/wgpu_hal/vulkan/struct.Api.html "struct wgpu_hal::vulkan::Api") uses [`hal::vulkan::AccelerationStructure`](https://docs.rs/wgpu-hal/29.0.3/x86_64-unknown-linux-gnu/wgpu_hal/vulkan/struct.AccelerationStructure.html "struct wgpu_hal::vulkan::AccelerationStructure")
...
[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#85)

#### pub fn [get](#method.get)(&self) -> &\[[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[TlasInstance](struct.TlasInstance.html "struct bevy::render::render_resource::TlasInstance")\>\]

Get a reference to all instances.

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#96)

#### pub fn [get\_mut\_slice](#method.get_mut_slice)( &mut self, range: [Range](https://doc.rust-lang.org/nightly/core/ops/range/struct.Range.html "struct core::ops::range::Range")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\>, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&mut \[[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[TlasInstance](struct.TlasInstance.html "struct bevy::render::render_resource::TlasInstance")\>\]>

Get a mutable slice to a range of instances. Returns None if the range is out of bounds. All elements from the lowest accessed index up are marked as modified. For best performance it is recommended to prefer access to low elements and modify higher elements as little as possible. This can be done by ordering instances from the most to the least used. It is recommended to use [`Self::index_mut`](struct.Tlas.html#method.index_mut "method bevy::render::render_resource::Tlas::index_mut") unless the option if out of bounds is required

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#113)

#### pub fn [get\_mut\_single](#method.get_mut_single)( &mut self, index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&mut [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[TlasInstance](struct.TlasInstance.html "struct bevy::render::render_resource::TlasInstance")\>>

Get a single mutable reference to an instance. Returns None if the range is out of bounds. All elements from the lowest accessed index up are marked as modified. For best performance it is recommended to prefer access to low elements and modify higher elements as little as possible. This can be done by ordering instances from the most to the least used. It is recommended to use [`Self::index_mut`](struct.Tlas.html#method.index_mut "method bevy::render::render_resource::Tlas::index_mut") unless the option if out of bounds is required

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#126)

#### pub fn [as\_binding](#method.as_binding)(&self) -> [BindingResource](enum.BindingResource.html "enum bevy::render::render_resource::BindingResource")<'\_>

Get the binding resource for the underling acceleration structure, to be used when creating a [`BindGroup`](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/wgpu/api/bind_group/struct.BindGroup.html "struct wgpu::api::bind_group::BindGroup")

## Trait Implementations

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#13)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#13)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas")
...
[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#30)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#30)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas")
...
[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#139)

### impl [Index](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html "trait core::ops::index::Index")<[Range](https://doc.rust-lang.org/nightly/core/ops/range/struct.Range.html "struct core::ops::range::Range")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\>> for [Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#140)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html#associatedtype.Output) = \[[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[TlasInstance](struct.TlasInstance.html "struct bevy::render::render_resource::TlasInstance")\>\]

The returned type after indexing.

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#142)

#### fn [index](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html#tymethod.index)(&self, index: [Range](https://doc.rust-lang.org/nightly/core/ops/range/struct.Range.html "struct core::ops::range::Range")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\>) -> &<[Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas") as [Index](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html "trait core::ops::index::Index")<[Range](https://doc.rust-lang.org/nightly/core/ops/range/struct.Range.html "struct core::ops::range::Range")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\>>>::[Output](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html#associatedtype.Output "type core::ops::index::Index::Output")
...
[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#131)

### impl [Index](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html "trait core::ops::index::Index")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> for [Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#132)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html#associatedtype.Output) = [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[TlasInstance](struct.TlasInstance.html "struct bevy::render::render_resource::TlasInstance")\>

The returned type after indexing.

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#134)

#### fn [index](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html#tymethod.index)(&self, index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> &<[Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas") as [Index](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html "trait core::ops::index::Index")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\>>::[Output](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html#associatedtype.Output "type core::ops::index::Index::Output")

Performs the indexing (`container[index]`) operation. [Read more](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html#tymethod.index)

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#157)
...
[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#158)

#### fn [index\_mut](https://doc.rust-lang.org/nightly/core/ops/index/trait.IndexMut.html#tymethod.index_mut)( &mut self, index: [Range](https://doc.rust-lang.org/nightly/core/ops/range/struct.Range.html "struct core::ops::range::Range")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\>, ) -> &mut <[Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas") as [Index](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html "trait core::ops::index::Index")<[Range](https://doc.rust-lang.org/nightly/core/ops/range/struct.Range.html "struct core::ops::range::Range")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\>>>::[Output](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html#associatedtype.Output "type core::ops::index::Index::Output")
...
[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#147)

### impl [IndexMut](https://doc.rust-lang.org/nightly/core/ops/index/trait.IndexMut.html "trait core::ops::index::IndexMut")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> for [Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#148)

#### fn [index\_mut](https://doc.rust-lang.org/nightly/core/ops/index/trait.IndexMut.html#tymethod.index_mut)(&mut self, index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> &mut <[Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas") as [Index](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html "trait core::ops::index::Index")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\>>::[Output](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html#associatedtype.Output "type core::ops::index::Index::Output")

Performs the mutable indexing (`container[index]`) operation. [Read more](https://doc.rust-lang.org/nightly/core/ops/index/trait.IndexMut.html#tymethod.index_mut)

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#30)

### impl [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#30)

#### fn [cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html#tymethod.cmp)(&self, other: &[Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas")) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#30)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/tlas.rs.html#30)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")\>
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas")
