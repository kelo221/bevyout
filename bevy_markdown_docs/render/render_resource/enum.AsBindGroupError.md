...
# Enum AsBindGroupError 

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_resource/bind_group.rs.html#623)
...
### InvalidSamplerType([u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html), [String](../../prelude/struct.String.html "struct bevy::prelude::String"), [String](../../prelude/struct.String.html "struct bevy::prelude::String"))

## Trait Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_resource/bind_group.rs.html#622)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [AsBindGroupError](enum.AsBindGroupError.html "enum bevy::render::render_resource::AsBindGroupError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [AsBindGroupError](enum.AsBindGroupError.html "enum bevy::render::render_resource::AsBindGroupError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [AsBindGroupError](enum.AsBindGroupError.html "enum bevy::render::render_resource::AsBindGroupError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AsBindGroupError](enum.AsBindGroupError.html "enum bevy::render::render_resource::AsBindGroupError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AsBindGroupError](enum.AsBindGroupError.html "enum bevy::render::render_resource::AsBindGroupError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AsBindGroupError](enum.AsBindGroupError.html "enum bevy::render::render_resource::AsBindGroupError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AsBindGroupError](enum.AsBindGroupError.html "enum bevy::render::render_resource::AsBindGroupError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AsBindGroupError](enum.AsBindGroupError.html "enum bevy::render::render_resource::AsBindGroupError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AsBindGroupError](enum.AsBindGroupError.html "enum bevy::render::render_resource::AsBindGroupError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AsBindGroupError](enum.AsBindGroupError.html "enum bevy::render::render_resource::AsBindGroupError")
