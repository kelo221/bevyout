...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/binding.rs.html#25)
...
For each binding in a layout, a [`BindGroup`](../wgpu/struct.BindGroup.html) must provide a [`BindingResource`](../wgpu/enum.BindingResource.html) of the corresponding type.

Corresponds to WebGPU’s mutually exclusive fields within [`GPUBindGroupLayoutEntry`](https://gpuweb.github.io/gpuweb/#dictdef-gpubindgrouplayoutentry).
...
Corresponds to [WebGPU `GPUBufferBindingLayout`](https://gpuweb.github.io/gpuweb/#dictdef-gpubufferbindinglayout).

#### Fields

`ty: [BufferBindingType](enum.BufferBindingType.html "enum bevy::render::render_resource::BufferBindingType")`

Sub-type of the buffer binding.

`has_dynamic_offset: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

Indicates that the binding has a dynamic offset.

One offset must be passed to [`RenderPass::set_bind_group`](../wgpu/struct.RenderPass.html#method.set_bind_group) for each dynamic binding in increasing order of binding number.

`min_binding_size: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[NonZero](https://doc.rust-lang.org/nightly/core/num/nonzero/struct.NonZero.html "struct core::num::nonzero::NonZero")<[u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)>>`

The minimum size for a [`BufferBinding`](../wgpu/struct.BufferBinding.html) matching this entry, in bytes.

If this is `Some(size)`:

*   When calling [`create_bind_group`](../wgpu/struct.Device.html#method.create_bind_group), the resource at this bind point must be a [`BindingResource::Buffer`](../wgpu/enum.BindingResource.html#variant.Buffer) whose effective size is at least `size`.
    
*   When calling [`create_render_pipeline`](../wgpu/struct.Device.html#method.create_render_pipeline) or [`create_compute_pipeline`](../wgpu/struct.Device.html#method.create_compute_pipeline), `size` must be at least the [minimum buffer binding size](https://www.w3.org/TR/webgpu/#minimum-buffer-binding-size) for the shader module global at this bind point: large enough to hold the global’s value, along with one element of a trailing runtime-sized array, if present.
    

If this is `None`:

*   Each draw or dispatch command checks that the buffer range at this bind point satisfies the [minimum buffer binding size](https://www.w3.org/TR/webgpu/#minimum-buffer-binding-size).

### Sampler([SamplerBindingType](enum.SamplerBindingType.html "enum bevy::render::render_resource::SamplerBindingType"))
...
Corresponds to [WebGPU `GPUSamplerBindingLayout`](https://gpuweb.github.io/gpuweb/#dictdef-gpusamplerbindinglayout).
...
Corresponds to [WebGPU `GPUTextureBindingLayout`](https://gpuweb.github.io/gpuweb/#dictdef-gputexturebindinglayout).

#### Fields

`sample_type: [TextureSampleType](enum.TextureSampleType.html "enum bevy::render::render_resource::TextureSampleType")`

Sample type of the texture binding.

`view_dimension: [TextureViewDimension](enum.TextureViewDimension.html "enum bevy::render::render_resource::TextureViewDimension")`

Dimension of the texture view that is going to be sampled.

`multisampled: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`
...
Note that the texture format must be specified in the shader, along with the access mode. For WGSL, the format must be one of the enumerants in the list of [storage texel formats](https://gpuweb.github.io/gpuweb/wgsl/#storage-texel-formats).

Corresponds to [WebGPU `GPUStorageTextureBindingLayout`](https://gpuweb.github.io/gpuweb/#dictdef-gpustoragetexturebindinglayout).

#### Fields

`access: [StorageTextureAccess](enum.StorageTextureAccess.html "enum bevy::render::render_resource::StorageTextureAccess")`
...
`vertex_return: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

Whether this acceleration structure can be used to create a ray query that has flag vertex return in the shader
...
Corresponds to [WebGPU `GPUExternalTextureBindingLayout`](https://gpuweb.github.io/gpuweb/#dictdef-gpuexternaltexturebindinglayout).

Requires \[`Features::EXTERNAL_TEXTURE`\]

## Implementations

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/binding.rs.html#183)

### impl [BindingType](enum.BindingType.html "enum bevy::render::render_resource::BindingType")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/binding.rs.html#186)

#### pub fn [has\_dynamic\_offset](#method.has_dynamic_offset)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns true for buffer bindings with dynamic offset enabled.

## Trait Implementations

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/binding.rs.html#23)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [BindingType](enum.BindingType.html "enum bevy::render::render_resource::BindingType")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/binding.rs.html#23)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [BindingType](enum.BindingType.html "enum bevy::render::render_resource::BindingType")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [BindingType](enum.BindingType.html "enum bevy::render::render_resource::BindingType")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/binding.rs.html#23)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [BindingType](enum.BindingType.html "enum bevy::render::render_resource::BindingType")
...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/binding.rs.html#24)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [BindingType](enum.BindingType.html "enum bevy::render::render_resource::BindingType")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/binding.rs.html#24)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[BindingType](enum.BindingType.html "enum bevy::render::render_resource::BindingType"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [BindingType](enum.BindingType.html "enum bevy::render::render_resource::BindingType")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/binding.rs.html#23)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [BindingType](enum.BindingType.html "enum bevy::render::render_resource::BindingType")
...
### impl [IntoBindGroupLayoutEntryBuilder](../../material/bind_group_layout_entries/trait.IntoBindGroupLayoutEntryBuilder.html "trait bevy::material::bind_group_layout_entries::IntoBindGroupLayoutEntryBuilder") for [BindingType](enum.BindingType.html "enum bevy::render::render_resource::BindingType")

[Source](https://docs.rs/bevy_material/0.19.0/x86_64-unknown-linux-gnu/src/bevy_material/bind_group_layout_entries.rs.html#213)

#### fn [into\_bind\_group\_layout\_entry\_builder](../../material/bind_group_layout_entries/trait.IntoBindGroupLayoutEntryBuilder.html#tymethod.into_bind_group_layout_entry_builder)(self) -> [BindGroupLayoutEntryBuilder](../../material/bind_group_layout_entries/struct.BindGroupLayoutEntryBuilder.html "struct bevy::material::bind_group_layout_entries::BindGroupLayoutEntryBuilder")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/binding.rs.html#23)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [BindingType](enum.BindingType.html "enum bevy::render::render_resource::BindingType")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/binding.rs.html#23)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[BindingType](enum.BindingType.html "enum bevy::render::render_resource::BindingType")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [BindingType](enum.BindingType.html "enum bevy::render::render_resource::BindingType")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [BindingType](enum.BindingType.html "enum bevy::render::render_resource::BindingType")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [BindingType](enum.BindingType.html "enum bevy::render::render_resource::BindingType")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [BindingType](enum.BindingType.html "enum bevy::render::render_resource::BindingType")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [BindingType](enum.BindingType.html "enum bevy::render::render_resource::BindingType")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [BindingType](enum.BindingType.html "enum bevy::render::render_resource::BindingType")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [BindingType](enum.BindingType.html "enum bevy::render::render_resource::BindingType")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [BindingType](enum.BindingType.html "enum bevy::render::render_resource::BindingType")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [BindingType](enum.BindingType.html "enum bevy::render::render_resource::BindingType")
