...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/vertex.rs.html#72)
...
Consider a call to [`RenderPass::draw`](../wgpu/struct.RenderPass.html#method.draw) like this:
...
Each vertex buffer has a step mode, established by the [`step_mode`](../wgpu/struct.VertexBufferLayout.html#structfield.step_mode) field of its [`VertexBufferLayout`](../wgpu/struct.VertexBufferLayout.html), given when the pipeline was created. Buffers whose step mode is [`Vertex`](enum.VertexStepMode.html#variant.Vertex "variant bevy::render::render_resource::VertexStepMode::Vertex") use `v` as the index into their contents, whereas buffers whose step mode is [`Instance`](enum.VertexStepMode.html#variant.Instance "variant bevy::render::render_resource::VertexStepMode::Instance") use `i`. The indicated buffer element then contributes zero or more attribute values for the `(v, i)` vertex shader invocation to use, based on the [`VertexBufferLayout`](../wgpu/struct.VertexBufferLayout.html)’s [`attributes`](../wgpu/struct.VertexBufferLayout.html#structfield.attributes) list.
...
Corresponds to [WebGPU `GPUVertexStepMode`](https://gpuweb.github.io/gpuweb/#enumdef-gpuvertexstepmode).
...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/vertex.rs.html#69)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [VertexStepMode](enum.VertexStepMode.html "enum bevy::render::render_resource::VertexStepMode")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/vertex.rs.html#69)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [VertexStepMode](enum.VertexStepMode.html "enum bevy::render::render_resource::VertexStepMode")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [VertexStepMode](enum.VertexStepMode.html "enum bevy::render::render_resource::VertexStepMode")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/vertex.rs.html#69)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [VertexStepMode](enum.VertexStepMode.html "enum bevy::render::render_resource::VertexStepMode")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [VertexStepMode](enum.VertexStepMode.html "enum bevy::render::render_resource::VertexStepMode")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/vertex.rs.html#69)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [VertexStepMode](enum.VertexStepMode.html "enum bevy::render::render_resource::VertexStepMode")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/vertex.rs.html#70)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [VertexStepMode](enum.VertexStepMode.html "enum bevy::render::render_resource::VertexStepMode")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/vertex.rs.html#70)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[VertexStepMode](enum.VertexStepMode.html "enum bevy::render::render_resource::VertexStepMode"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [VertexStepMode](enum.VertexStepMode.html "enum bevy::render::render_resource::VertexStepMode")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/vertex.rs.html#69)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [VertexStepMode](enum.VertexStepMode.html "enum bevy::render::render_resource::VertexStepMode")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [VertexStepMode](enum.VertexStepMode.html "enum bevy::render::render_resource::VertexStepMode")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/vertex.rs.html#69)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[VertexStepMode](enum.VertexStepMode.html "enum bevy::render::render_resource::VertexStepMode")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [VertexStepMode](enum.VertexStepMode.html "enum bevy::render::render_resource::VertexStepMode")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [VertexStepMode](enum.VertexStepMode.html "enum bevy::render::render_resource::VertexStepMode")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [VertexStepMode](enum.VertexStepMode.html "enum bevy::render::render_resource::VertexStepMode")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [VertexStepMode](enum.VertexStepMode.html "enum bevy::render::render_resource::VertexStepMode")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [VertexStepMode](enum.VertexStepMode.html "enum bevy::render::render_resource::VertexStepMode")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [VertexStepMode](enum.VertexStepMode.html "enum bevy::render::render_resource::VertexStepMode")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [VertexStepMode](enum.VertexStepMode.html "enum bevy::render::render_resource::VertexStepMode")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [VertexStepMode](enum.VertexStepMode.html "enum bevy::render::render_resource::VertexStepMode")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [VertexStepMode](enum.VertexStepMode.html "enum bevy::render::render_resource::VertexStepMode")
