...
The given runtime-sized array type should implement [`Length`](trait.Length.html "trait bevy::render::render_resource::encase::rts_array::Length") and optionally [`Truncate`](trait.Truncate.html "trait bevy::render::render_resource::encase::rts_array::Truncate") depending on needed capability (they can also be derived via `$using`)
