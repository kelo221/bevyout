...
[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/texture_view.rs.html#16)

```rust
pub struct WgpuTextureView { /* private fields */ }
```

Handle to a texture view.

A `TextureView` object refers to a [`Texture`](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/wgpu/api/texture/struct.Texture.html "struct wgpu::api::texture::Texture"), or a subset of its layers and mip levels, and specifies an interpretation of the texture’s texels, which is needed to use a texture as a binding in a [`BindGroup`](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/wgpu/api/bind_group/struct.BindGroup.html "struct wgpu::api::bind_group::BindGroup") or as an attachment in a [`RenderPass`](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/wgpu/api/render_pass/struct.RenderPass.html "struct wgpu::api::render_pass::RenderPass"). It can be created using [`Texture::create_view()`](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/wgpu/api/texture/struct.Texture.html#method.create_view "method wgpu::api::texture::Texture::create_view"), which accepts a [`TextureViewDescriptor`](type.TextureViewDescriptor.html "type bevy::render::render_resource::TextureViewDescriptor") specifying the properties of the view.

Corresponds to [WebGPU `GPUTextureView`](https://gpuweb.github.io/gpuweb/#gputextureview).

## Implementations

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/texture_view.rs.html#25)

### impl [TextureView](struct.WgpuTextureView.html "struct bevy::render::render_resource::WgpuTextureView")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/texture_view.rs.html#30)

#### pub fn [texture](#method.texture)(&self) -> &[Texture](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/wgpu/api/texture/struct.Texture.html "struct wgpu::api::texture::Texture")

Returns the [`Texture`](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/wgpu/api/texture/struct.Texture.html "struct wgpu::api::texture::Texture") that this `TextureView` refers to.

All wgpu resources are refcounted, so you can own the returned [`Texture`](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/wgpu/api/texture/struct.Texture.html "struct wgpu::api::texture::Texture") by cloning it.

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/texture_view.rs.html#73)

#### pub unsafe fn [as\_hal](#method.as_hal)<A>( &self, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<impl [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")<Target = <A as [Api](https://docs.rs/wgpu-hal/29.0.3/x86_64-unknown-linux-gnu/wgpu_hal/trait.Api.html "trait wgpu_hal::Api")\>::[TextureView](https://docs.rs/wgpu-hal/29.0.3/x86_64-unknown-linux-gnu/wgpu_hal/trait.Api.html#associatedtype.TextureView "type wgpu_hal::Api::TextureView")\>>

where A: [Api](https://docs.rs/wgpu-hal/29.0.3/x86_64-unknown-linux-gnu/wgpu_hal/trait.Api.html "trait wgpu_hal::Api"),

Available on **`wgpu_core`** only.

Get the [`wgpu_hal`](https://docs.rs/wgpu-hal/29.0.3/x86_64-unknown-linux-gnu/wgpu_hal/index.html "mod wgpu_hal") texture view from this `TextureView`.
...
Returns a guard that dereferences to the type of the hal backend which implements [`A::TextureView`](https://docs.rs/wgpu-hal/29.0.3/x86_64-unknown-linux-gnu/wgpu_hal/trait.Api.html#associatedtype.TextureView "associated type wgpu_hal::Api::TextureView").

##### Types

The returned type depends on the backend:

*   [`hal::api::Vulkan`](https://docs.rs/wgpu-hal/29.0.3/x86_64-unknown-linux-gnu/wgpu_hal/vulkan/struct.Api.html "struct wgpu_hal::vulkan::Api") uses [`hal::vulkan::TextureView`](https://docs.rs/wgpu-hal/29.0.3/x86_64-unknown-linux-gnu/wgpu_hal/vulkan/struct.TextureView.html "struct wgpu_hal::vulkan::TextureView")
...
*   The texture this view points to has had [`Texture::destroy()`](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/wgpu/api/texture/struct.Texture.html#method.destroy "method wgpu::api::texture::Texture::destroy") called on it.
...
[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/texture_view.rs.html#15)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [TextureView](struct.WgpuTextureView.html "struct bevy::render::render_resource::WgpuTextureView")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/texture_view.rs.html#15)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [TextureView](struct.WgpuTextureView.html "struct bevy::render::render_resource::WgpuTextureView")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [TextureView](struct.WgpuTextureView.html "struct bevy::render::render_resource::WgpuTextureView")
...
[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/texture_view.rs.html#23)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [TextureView](struct.WgpuTextureView.html "struct bevy::render::render_resource::WgpuTextureView")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_resource/texture.rs.html#90)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[TextureView](struct.WgpuTextureView.html "struct bevy::render::render_resource::WgpuTextureView")\> for [TextureView](struct.TextureView.html "struct bevy::render::render_resource::TextureView")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_resource/texture.rs.html#91)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [TextureView](struct.WgpuTextureView.html "struct bevy::render::render_resource::WgpuTextureView")) -> [TextureView](struct.TextureView.html "struct bevy::render::render_resource::TextureView")

Converts to this type from the input type.

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/texture_view.rs.html#23)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [TextureView](struct.WgpuTextureView.html "struct bevy::render::render_resource::WgpuTextureView")
...
### impl<'a> [IntoBinding](trait.IntoBinding.html "trait bevy::render::render_resource::IntoBinding")<'a> for &'a [TextureView](struct.WgpuTextureView.html "struct bevy::render::render_resource::WgpuTextureView")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_resource/bind_group_entries.rs.html#152)

#### fn [into\_binding](trait.IntoBinding.html#tymethod.into_binding)(self) -> [BindingResource](enum.BindingResource.html "enum bevy::render::render_resource::BindingResource")<'a>

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/texture_view.rs.html#23)

### impl [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [TextureView](struct.WgpuTextureView.html "struct bevy::render::render_resource::WgpuTextureView")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/texture_view.rs.html#23)

#### fn [cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html#tymethod.cmp)(&self, other: &[TextureView](struct.WgpuTextureView.html "struct bevy::render::render_resource::WgpuTextureView")) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [TextureView](struct.WgpuTextureView.html "struct bevy::render::render_resource::WgpuTextureView")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/texture_view.rs.html#23)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[TextureView](struct.WgpuTextureView.html "struct bevy::render::render_resource::WgpuTextureView")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [TextureView](struct.WgpuTextureView.html "struct bevy::render::render_resource::WgpuTextureView")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/texture_view.rs.html#23)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[TextureView](struct.WgpuTextureView.html "struct bevy::render::render_resource::WgpuTextureView")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")\>
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TextureView](struct.WgpuTextureView.html "struct bevy::render::render_resource::WgpuTextureView")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TextureView](struct.WgpuTextureView.html "struct bevy::render::render_resource::WgpuTextureView")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TextureView](struct.WgpuTextureView.html "struct bevy::render::render_resource::WgpuTextureView")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TextureView](struct.WgpuTextureView.html "struct bevy::render::render_resource::WgpuTextureView")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TextureView](struct.WgpuTextureView.html "struct bevy::render::render_resource::WgpuTextureView")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TextureView](struct.WgpuTextureView.html "struct bevy::render::render_resource::WgpuTextureView")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TextureView](struct.WgpuTextureView.html "struct bevy::render::render_resource::WgpuTextureView")
