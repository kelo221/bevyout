...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/render.rs.html#697)
...
Corresponds to [WebGPU `GPULoadOp`](https://gpuweb.github.io/gpuweb/#enumdef-gpuloadop), plus the corresponding clearValue.
...
### DontCare([LoadOpDontCare](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/tokens/struct.LoadOpDontCare.html "struct wgpu_types::tokens::LoadOpDontCare"))
...
Backends that don’t support `DontCare` internally, will pick a different (unspecified) load op instead.

#### Safety

*   All pixels in the render target must be written to before any read or a [`StoreOp::Store`](enum.StoreOp.html#variant.Store "variant bevy::render::render_resource::StoreOp::Store") occurs.

## Implementations

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/render.rs.html#731)

### impl<V> [LoadOp](enum.LoadOp.html "enum bevy::render::render_resource::LoadOp")<V>

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/render.rs.html#733)

#### pub fn [eq\_variant](#method.eq_variant)<T>(&self, other: [LoadOp](enum.LoadOp.html "enum bevy::render::render_resource::LoadOp")<T>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns true if variants are same (ignoring clear value)

## Trait Implementations

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/render.rs.html#694)

### impl<V> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [LoadOp](enum.LoadOp.html "enum bevy::render::render_resource::LoadOp")<V>

where V: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/render.rs.html#694)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [LoadOp](enum.LoadOp.html "enum bevy::render::render_resource::LoadOp")<V>
...
### impl<V> [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [LoadOp](enum.LoadOp.html "enum bevy::render::render_resource::LoadOp")<V>

where V: [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy"),

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/render.rs.html#694)

### impl<V> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [LoadOp](enum.LoadOp.html "enum bevy::render::render_resource::LoadOp")<V>
...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/render.rs.html#743)

### impl<V> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [LoadOp](enum.LoadOp.html "enum bevy::render::render_resource::LoadOp")<V>

where V: [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default"),

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/render.rs.html#744)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [LoadOp](enum.LoadOp.html "enum bevy::render::render_resource::LoadOp")<V>

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/render.rs.html#695)

### impl<'de, V> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [LoadOp](enum.LoadOp.html "enum bevy::render::render_resource::LoadOp")<V>
...
### impl<V> [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [LoadOp](enum.LoadOp.html "enum bevy::render::render_resource::LoadOp")<V>
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Camera3dDepthLoadOp](../../camera/enum.Camera3dDepthLoadOp.html "enum bevy::camera::Camera3dDepthLoadOp")\> for [LoadOp](enum.LoadOp.html "enum bevy::render::render_resource::LoadOp")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\>

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/components.rs.html#75)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(config: [Camera3dDepthLoadOp](../../camera/enum.Camera3dDepthLoadOp.html "enum bevy::camera::Camera3dDepthLoadOp")) -> [LoadOp](enum.LoadOp.html "enum bevy::render::render_resource::LoadOp")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\>

Converts to this type from the input type.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/render.rs.html#694)

### impl<V> [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [LoadOp](enum.LoadOp.html "enum bevy::render::render_resource::LoadOp")<V>
...
### impl<V> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [LoadOp](enum.LoadOp.html "enum bevy::render::render_resource::LoadOp")<V>

where V: [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"),

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/render.rs.html#694)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[LoadOp](enum.LoadOp.html "enum bevy::render::render_resource::LoadOp")<V>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl<V> [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [LoadOp](enum.LoadOp.html "enum bevy::render::render_resource::LoadOp")<V>
...
### impl<V> [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [LoadOp](enum.LoadOp.html "enum bevy::render::render_resource::LoadOp")<V>

where V: [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"),

## Auto Trait Implementations

### impl<V> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [LoadOp](enum.LoadOp.html "enum bevy::render::render_resource::LoadOp")<V>

where V: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"),

### impl<V> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [LoadOp](enum.LoadOp.html "enum bevy::render::render_resource::LoadOp")<V>
...
### impl<V> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [LoadOp](enum.LoadOp.html "enum bevy::render::render_resource::LoadOp")<V>

where V: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<V> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [LoadOp](enum.LoadOp.html "enum bevy::render::render_resource::LoadOp")<V>

where V: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<V> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [LoadOp](enum.LoadOp.html "enum bevy::render::render_resource::LoadOp")<V>

where V: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<V> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [LoadOp](enum.LoadOp.html "enum bevy::render::render_resource::LoadOp")<V>

where V: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"),

### impl<V> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [LoadOp](enum.LoadOp.html "enum bevy::render::render_resource::LoadOp")<V>
