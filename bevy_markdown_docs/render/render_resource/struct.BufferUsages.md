...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)
...
Specifying only usages the application will actually perform may increase performance. Additionally, on the WebGL backend, there are restrictions on [`BufferUsages::INDEX`](struct.BufferUsages.html#associatedconstant.INDEX "associated constant bevy::render::render_resource::BufferUsages::INDEX"); see \[`DownlevelFlags::UNRESTRICTED_INDEX_BUFFER`\] for more information.

Corresponds to [WebGPU `GPUBufferUsageFlags`](https://gpuweb.github.io/gpuweb/#typedefdef-gpubufferusageflags).

## Implementations

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

### impl [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### pub const [MAP\_READ](#associatedconstant.MAP_READ): [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

Allow a buffer to be mapped for reading using \[`Buffer::map_async`\] + \[`Buffer::get_mapped_range`\]. This does not include creating a buffer with [`BufferDescriptor::mapped_at_creation`](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/buffer/struct.BufferDescriptor.html#structfield.mapped_at_creation "field wgpu_types::buffer::BufferDescriptor::mapped_at_creation") set.

If \[`Features::MAPPABLE_PRIMARY_BUFFERS`\] isn’t enabled, the only other usage a buffer may have is COPY\_DST.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### pub const [MAP\_WRITE](#associatedconstant.MAP_WRITE): [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

Allow a buffer to be mapped for writing using \[`Buffer::map_async`\] + \[`Buffer::get_mapped_range_mut`\]. This does not include creating a buffer with [`BufferDescriptor::mapped_at_creation`](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/buffer/struct.BufferDescriptor.html#structfield.mapped_at_creation "field wgpu_types::buffer::BufferDescriptor::mapped_at_creation") set.

If \[`Features::MAPPABLE_PRIMARY_BUFFERS`\] feature isn’t enabled, the only other usage a buffer may have is COPY\_SRC.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### pub const [COPY\_SRC](#associatedconstant.COPY_SRC): [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")
...
#### pub const [COPY\_DST](#associatedconstant.COPY_DST): [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")
...
#### pub const [INDEX](#associatedconstant.INDEX): [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

Allow a buffer to be the index buffer in a draw operation.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### pub const [VERTEX](#associatedconstant.VERTEX): [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

Allow a buffer to be the vertex buffer in a draw operation.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### pub const [UNIFORM](#associatedconstant.UNIFORM): [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

Allow a buffer to be a \[`BufferBindingType::Uniform`\] inside a bind group.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### pub const [STORAGE](#associatedconstant.STORAGE): [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

Allow a buffer to be a \[`BufferBindingType::Storage`\] inside a bind group.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### pub const [INDIRECT](#associatedconstant.INDIRECT): [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

Allow a buffer to be the indirect buffer in an indirect draw call.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### pub const [QUERY\_RESOLVE](#associatedconstant.QUERY_RESOLVE): [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

Allow a buffer to be the destination buffer for a \[`CommandEncoder::resolve_query_set`\] operation.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### pub const [BLAS\_INPUT](#associatedconstant.BLAS_INPUT): [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

Allows a buffer to be used as input for a bottom level acceleration structure build

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### pub const [TLAS\_INPUT](#associatedconstant.TLAS_INPUT): [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")
...
#### pub const fn [empty](#method.empty)() -> [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

Get a flags value with all bits unset.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### pub const fn [all](#method.all)() -> [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")
...
#### pub const fn [from\_bits](#method.from_bits)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")\>
...
#### pub const fn [from\_bits\_truncate](#method.from_bits_truncate)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

Convert from a bits value, unsetting any unknown bits.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### pub const fn [from\_bits\_retain](#method.from_bits_retain)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

Convert from a bits value exactly.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### pub fn [from\_name](#method.from_name)(name: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")\>
...
#### pub const fn [intersects](#method.intersects)(&self, other: [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Whether any set bits in `other` are also set in `self`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### pub const fn [contains](#method.contains)(&self, other: [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Whether all set bits in `other` are also set in `self`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### pub fn [insert](#method.insert)(&mut self, other: [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages"))

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### pub fn [remove](#method.remove)(&mut self, other: [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages"))
...
#### pub fn [toggle](#method.toggle)(&mut self, other: [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages"))

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### pub fn [set](#method.set)(&mut self, other: [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages"), value: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Call `insert` when `value` is `true` or `remove` when `value` is `false`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### pub const fn [intersection](#method.intersection)(self, other: [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")) -> [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

The bitwise and (`&`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### pub const fn [union](#method.union)(self, other: [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")) -> [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### pub const fn [difference](#method.difference)(self, other: [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")) -> [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")
...
#### pub const fn [symmetric\_difference](#method.symmetric_difference)(self, other: [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")) -> [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### pub const fn [complement](#method.complement)(self) -> [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")
...
#### pub const fn [iter](#method.iter)(&self) -> [Iter](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.Iter.html "struct bitflags::iter::Iter")<[BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")\> [ⓘ](#)
...
#### pub const fn [iter\_names](#method.iter_names)(&self) -> [IterNames](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.IterNames.html "struct bitflags::iter::IterNames")<[BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")\> [ⓘ](#)
...
### impl [Binary](https://doc.rust-lang.org/nightly/core/fmt/trait.Binary.html "trait core::fmt::Binary") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")
...
### impl [BitAnd](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html "trait core::ops::bit::BitAnd") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### fn [bitand](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html#tymethod.bitand)(self, other: [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")) -> [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

The bitwise and (`&`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html#associatedtype.Output) = [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

The resulting type after applying the `&` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

### impl [BitAndAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAndAssign.html "trait core::ops::bit::BitAndAssign") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### fn [bitand\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAndAssign.html#tymethod.bitand_assign)(&mut self, other: [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages"))

The bitwise and (`&`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

### impl [BitOr](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html "trait core::ops::bit::BitOr") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### fn [bitor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html#tymethod.bitor)(self, other: [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")) -> [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html#associatedtype.Output) = [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

The resulting type after applying the `|` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

### impl [BitOrAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOrAssign.html "trait core::ops::bit::BitOrAssign") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### fn [bitor\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOrAssign.html#tymethod.bitor_assign)(&mut self, other: [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages"))

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

### impl [BitXor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html "trait core::ops::bit::BitXor") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### fn [bitxor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html#tymethod.bitxor)(self, other: [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")) -> [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html#associatedtype.Output) = [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

The resulting type after applying the `^` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

### impl [BitXorAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXorAssign.html "trait core::ops::bit::BitXorAssign") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### fn [bitxor\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXorAssign.html#tymethod.bitxor_assign)(&mut self, other: [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages"))

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#62)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#62)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#62)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")
...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#60)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#60)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

### impl [Extend](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.Extend.html "trait core::iter::traits::collect::Extend")<[BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")\> for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")
...
where T: [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")\>,
...
### impl [Flags](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html "trait bitflags::traits::Flags") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### const [FLAGS](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#associatedconstant.FLAGS): &'static \[[Flag](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/struct.Flag.html "struct bitflags::traits::Flag")<[BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")\>\]
...
#### fn [from\_bits\_retain](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#tymethod.from_bits_retain)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

Convert from a bits value exactly.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### fn [all\_named](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#method.all_named)() -> [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")
...
### impl [FromIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html "trait core::iter::traits::collect::FromIterator")<[BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")\> for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### fn [from\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html#tymethod.from_iter)<T>(iterator: T) -> [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")
...
### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")
...
### impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### type [Item](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.Item) = [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

The type of the elements being iterated over.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### type [IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter) = [Iter](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.Iter.html "struct bitflags::iter::Iter")<[BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")\>

Which kind of iterator are we turning this into?

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### fn [into\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)(self) -> <[BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages") as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter "type core::iter::traits::collect::IntoIterator::IntoIter")

Creates an iterator from a value. [Read more](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

### impl [LowerHex](https://doc.rust-lang.org/nightly/core/fmt/trait.LowerHex.html "trait core::fmt::LowerHex") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")
...
### impl [Not](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html "trait core::ops::bit::Not") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### fn [not](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html#tymethod.not)(self) -> [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

The bitwise negation (`!`) of the bits in `self`, truncating the result.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html#associatedtype.Output) = [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

The resulting type after applying the `!` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

### impl [Octal](https://doc.rust-lang.org/nightly/core/fmt/trait.Octal.html "trait core::fmt::Octal") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#62)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

### impl [Sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html "trait core::ops::arith::Sub") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### fn [sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#tymethod.sub)(self, other: [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")) -> [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")
...
#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#associatedtype.Output) = [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

The resulting type after applying the `-` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

### impl [SubAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html "trait core::ops::arith::SubAssign") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/buffer.rs.html#47-99)

#### fn [sub\_assign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html#tymethod.sub_assign)(&mut self, other: [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages"))
...
### impl [UpperHex](https://doc.rust-lang.org/nightly/core/fmt/trait.UpperHex.html "trait core::fmt::UpperHex") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [BufferUsages](struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")
