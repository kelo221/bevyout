...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)
...
You can check whether a set of flags is compliant through the [`DownlevelCapabilities::is_webgpu_compliant()`](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/limits/struct.DownlevelCapabilities.html#method.is_webgpu_compliant "method wgpu_types::limits::DownlevelCapabilities::is_webgpu_compliant") function.

## Implementations

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

### impl [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### pub const [COMPUTE\_SHADERS](#associatedconstant.COMPUTE_SHADERS): [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
#### pub const [FRAGMENT\_WRITABLE\_STORAGE](#associatedconstant.FRAGMENT_WRITABLE_STORAGE): [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

Supports binding storage buffers and textures to fragment shaders.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### pub const [INDIRECT\_EXECUTION](#associatedconstant.INDIRECT_EXECUTION): [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

Supports indirect drawing and dispatching.

[`Self::COMPUTE_SHADERS`](struct.DownlevelFlags.html#associatedconstant.COMPUTE_SHADERS "associated constant bevy::render::render_resource::DownlevelFlags::COMPUTE_SHADERS") must be present for this flag.

WebGL2, GLES 3.0, and Metal on Apple1/Apple2 GPUs do not support indirect.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### pub const [BASE\_VERTEX](#associatedconstant.BASE_VERTEX): [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
#### pub const [READ\_ONLY\_DEPTH\_STENCIL](#associatedconstant.READ_ONLY_DEPTH_STENCIL): [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
#### pub const [NON\_POWER\_OF\_TWO\_MIPMAPPED\_TEXTURES](#associatedconstant.NON_POWER_OF_TWO_MIPMAPPED_TEXTURES): [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

Supports textures with mipmaps which have a non power of two size.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### pub const [CUBE\_ARRAY\_TEXTURES](#associatedconstant.CUBE_ARRAY_TEXTURES): [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

Supports textures that are cube arrays.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### pub const [COMPARISON\_SAMPLERS](#associatedconstant.COMPARISON_SAMPLERS): [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

Supports comparison samplers.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### pub const [INDEPENDENT\_BLEND](#associatedconstant.INDEPENDENT_BLEND): [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

Supports different blend operations per color attachment.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### pub const [VERTEX\_STORAGE](#associatedconstant.VERTEX_STORAGE): [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

Supports storage buffers in vertex shaders.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### pub const [ANISOTROPIC\_FILTERING](#associatedconstant.ANISOTROPIC_FILTERING): [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
#### pub const [FRAGMENT\_STORAGE](#associatedconstant.FRAGMENT_STORAGE): [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

Supports storage buffers in fragment shaders.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### pub const [MULTISAMPLED\_SHADING](#associatedconstant.MULTISAMPLED_SHADING): [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

Supports sample-rate shading.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### pub const [DEPTH\_TEXTURE\_AND\_BUFFER\_COPIES](#associatedconstant.DEPTH_TEXTURE_AND_BUFFER_COPIES): [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
#### pub const [WEBGPU\_TEXTURE\_FORMAT\_SUPPORT](#associatedconstant.WEBGPU_TEXTURE_FORMAT_SUPPORT): [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
#### pub const [BUFFER\_BINDINGS\_NOT\_16\_BYTE\_ALIGNED](#associatedconstant.BUFFER_BINDINGS_NOT_16_BYTE_ALIGNED): [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
#### pub const [UNRESTRICTED\_INDEX\_BUFFER](#associatedconstant.UNRESTRICTED_INDEX_BUFFER): [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
#### pub const [FULL\_DRAW\_INDEX\_UINT32](#associatedconstant.FULL_DRAW_INDEX_UINT32): [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
#### pub const [DEPTH\_BIAS\_CLAMP](#associatedconstant.DEPTH_BIAS_CLAMP): [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
#### pub const [VIEW\_FORMATS](#associatedconstant.VIEW_FORMATS): [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

Supports specifying which view format values are allowed when create\_view() is called on a texture.

The WebGL and GLES backends doesn’t support this.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### pub const [UNRESTRICTED\_EXTERNAL\_TEXTURE\_COPIES](#associatedconstant.UNRESTRICTED_EXTERNAL_TEXTURE_COPIES): [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
#### pub const [SURFACE\_VIEW\_FORMATS](#associatedconstant.SURFACE_VIEW_FORMATS): [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

Supports specifying which view formats are allowed when calling create\_view on the texture returned by `Surface::get_current_texture`.

The GLES/WebGL and Vulkan on Android doesn’t support this.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### pub const [NONBLOCKING\_QUERY\_RESOLVE](#associatedconstant.NONBLOCKING_QUERY_RESOLVE): [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

If this is true, calls to `CommandEncoder::resolve_query_set` will be performed on the queue timeline.

If this is false, calls to `CommandEncoder::resolve_query_set` will be performed on the device (i.e. cpu) timeline and will block that timeline until the query has data. You may work around this limitation by waiting until the submit whose queries you are resolving is fully finished (through use of `queue.on_submitted_work_done`) and only then submitting the resolve\_query\_set command. The queries will be guaranteed finished, so will not block.
...
#### pub const [SHADER\_F16\_IN\_F32](#associatedconstant.SHADER_F16_IN_F32): [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

Allows shaders to use `quantizeToF16`, `pack2x16float`, and `unpack2x16float`, which operate on `f16`\-precision values stored in `f32`s.
...
#### pub const fn [empty](#method.empty)() -> [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

Get a flags value with all bits unset.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### pub const fn [all](#method.all)() -> [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
#### pub const fn [from\_bits](#method.from_bits)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")\>
...
#### pub const fn [from\_bits\_truncate](#method.from_bits_truncate)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

Convert from a bits value, unsetting any unknown bits.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### pub const fn [from\_bits\_retain](#method.from_bits_retain)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

Convert from a bits value exactly.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### pub fn [from\_name](#method.from_name)(name: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")\>
...
#### pub const fn [intersects](#method.intersects)(&self, other: [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Whether any set bits in `other` are also set in `self`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### pub const fn [contains](#method.contains)(&self, other: [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Whether all set bits in `other` are also set in `self`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### pub fn [insert](#method.insert)(&mut self, other: [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags"))

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### pub fn [remove](#method.remove)(&mut self, other: [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags"))
...
#### pub fn [toggle](#method.toggle)(&mut self, other: [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags"))

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### pub fn [set](#method.set)(&mut self, other: [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags"), value: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Call `insert` when `value` is `true` or `remove` when `value` is `false`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### pub const fn [intersection](#method.intersection)(self, other: [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")) -> [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

The bitwise and (`&`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### pub const fn [union](#method.union)(self, other: [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")) -> [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### pub const fn [difference](#method.difference)(self, other: [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")) -> [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
#### pub const fn [symmetric\_difference](#method.symmetric_difference)(self, other: [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")) -> [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### pub const fn [complement](#method.complement)(self) -> [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
#### pub const fn [iter](#method.iter)(&self) -> [Iter](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.Iter.html "struct bitflags::iter::Iter")<[DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")\> [ⓘ](#)
...
#### pub const fn [iter\_names](#method.iter_names)(&self) -> [IterNames](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.IterNames.html "struct bitflags::iter::IterNames")<[DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")\> [ⓘ](#)
...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#971)

### impl [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#974)

#### pub const fn [compliant](#method.compliant)() -> [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
### impl [Binary](https://doc.rust-lang.org/nightly/core/fmt/trait.Binary.html "trait core::fmt::Binary") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
### impl [BitAnd](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html "trait core::ops::bit::BitAnd") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### fn [bitand](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html#tymethod.bitand)(self, other: [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")) -> [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

The bitwise and (`&`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html#associatedtype.Output) = [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

The resulting type after applying the `&` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

### impl [BitAndAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAndAssign.html "trait core::ops::bit::BitAndAssign") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### fn [bitand\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAndAssign.html#tymethod.bitand_assign)(&mut self, other: [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags"))

The bitwise and (`&`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

### impl [BitOr](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html "trait core::ops::bit::BitOr") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### fn [bitor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html#tymethod.bitor)(self, other: [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")) -> [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html#associatedtype.Output) = [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

The resulting type after applying the `|` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

### impl [BitOrAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOrAssign.html "trait core::ops::bit::BitOrAssign") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### fn [bitor\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOrAssign.html#tymethod.bitor_assign)(&mut self, other: [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags"))

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

### impl [BitXor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html "trait core::ops::bit::BitXor") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### fn [bitxor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html#tymethod.bitxor)(self, other: [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")) -> [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html#associatedtype.Output) = [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

The resulting type after applying the `^` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

### impl [BitXorAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXorAssign.html "trait core::ops::bit::BitXorAssign") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### fn [bitxor\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXorAssign.html#tymethod.bitxor_assign)(&mut self, other: [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags"))

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#839)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#839)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#839)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#837)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#837)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

### impl [Extend](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.Extend.html "trait core::iter::traits::collect::Extend")<[DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")\> for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
where T: [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")\>,
...
### impl [Flags](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html "trait bitflags::traits::Flags") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### const [FLAGS](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#associatedconstant.FLAGS): &'static \[[Flag](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/struct.Flag.html "struct bitflags::traits::Flag")<[DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")\>\]
...
#### fn [from\_bits\_retain](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#tymethod.from_bits_retain)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

Convert from a bits value exactly.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### fn [all\_named](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#method.all_named)() -> [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
### impl [FromIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html "trait core::iter::traits::collect::FromIterator")<[DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")\> for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### fn [from\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html#tymethod.from_iter)<T>(iterator: T) -> [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
### impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### type [Item](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.Item) = [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

The type of the elements being iterated over.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### type [IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter) = [Iter](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.Iter.html "struct bitflags::iter::Iter")<[DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")\>

Which kind of iterator are we turning this into?

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### fn [into\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)(self) -> <[DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags") as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter "type core::iter::traits::collect::IntoIterator::IntoIter")

Creates an iterator from a value. [Read more](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

### impl [LowerHex](https://doc.rust-lang.org/nightly/core/fmt/trait.LowerHex.html "trait core::fmt::LowerHex") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
### impl [Not](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html "trait core::ops::bit::Not") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### fn [not](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html#tymethod.not)(self) -> [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

The bitwise negation (`!`) of the bits in `self`, truncating the result.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html#associatedtype.Output) = [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

The resulting type after applying the `!` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

### impl [Octal](https://doc.rust-lang.org/nightly/core/fmt/trait.Octal.html "trait core::fmt::Octal") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
### impl [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#839)

#### fn [cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html#tymethod.cmp)(&self, other: &[DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#839)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#839)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")\>
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

### impl [Sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html "trait core::ops::arith::Sub") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### fn [sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#tymethod.sub)(self, other: [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")) -> [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#associatedtype.Output) = [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

The resulting type after applying the `-` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

### impl [SubAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html "trait core::ops::arith::SubAssign") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#826-969)

#### fn [sub\_assign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html#tymethod.sub_assign)(&mut self, other: [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags"))
...
### impl [UpperHex](https://doc.rust-lang.org/nightly/core/fmt/trait.UpperHex.html "trait core::fmt::UpperHex") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DownlevelFlags](struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags")
