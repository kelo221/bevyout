...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/adapter.rs.html#111)
...
`vendor: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

[`Backend`](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/backend/enum.Backend.html "enum wgpu_types::backend::Backend")\-specific vendor ID of the adapter
...
*   For [`Backend::Vulkan`](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/backend/enum.Backend.html#variant.Vulkan "variant wgpu_types::backend::Backend::Vulkan"), the [`VkPhysicalDeviceProperties::vendorID`](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceProperties.html) is used, which is a superset of PCI IDs.

`device: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

[`Backend`](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/backend/enum.Backend.html "enum wgpu_types::backend::Backend")\-specific device ID of the adapter
...
*   For [`Backend::Vulkan`](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/backend/enum.Backend.html#variant.Vulkan "variant wgpu_types::backend::Backend::Vulkan"), the [`VkPhysicalDeviceProperties::deviceID`](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPhysicalDeviceProperties.html) is used, which is a superset of PCI IDs.

`device_type: [DeviceType](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/adapter/enum.DeviceType.html "enum wgpu_types::adapter::DeviceType")`

Type of device

`device_pci_bus_id: [String](../../prelude/struct.String.html "struct bevy::prelude::String")`

[`Backend`](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/backend/enum.Backend.html "enum wgpu_types::backend::Backend")\-specific PCI bus ID of the adapter.

*   For [`Backend::Vulkan`](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/backend/enum.Backend.html#variant.Vulkan "variant wgpu_types::backend::Backend::Vulkan"), [`VkPhysicalDevicePCIBusInfoPropertiesEXT`](https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDevicePCIBusInfoPropertiesEXT.html) is used, if available, in the form `bus:device.function`, e.g. `0000:01:00.0`.

`driver: [String](../../prelude/struct.String.html "struct bevy::prelude::String")`

Driver name

`driver_info: [String](../../prelude/struct.String.html "struct bevy::prelude::String")`

Driver info

`backend: [Backend](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/backend/enum.Backend.html "enum wgpu_types::backend::Backend")`

Backend used for device

`subgroup_min_size: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

Minimum possible size of a subgroup on this adapter. Will never be lower than [`crate::MINIMUM_SUBGROUP_MIN_SIZE`](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/constant.MINIMUM_SUBGROUP_MIN_SIZE.html "constant wgpu_types::MINIMUM_SUBGROUP_MIN_SIZE").
...
`subgroup_max_size: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

Maximum possible size of a subgroup on this adapter. Will never be higher than [`crate::MAXIMUM_SUBGROUP_MAX_SIZE`](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/constant.MAXIMUM_SUBGROUP_MAX_SIZE.html "constant wgpu_types::MAXIMUM_SUBGROUP_MAX_SIZE").
...
`transient_saves_memory: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

If true, adding \[`TextureUsages::TRANSIENT`\] to a texture will decrease memory usage.

## Trait Implementations

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/adapter.rs.html#109)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [AdapterInfo](struct.WgpuAdapterInfo.html "struct bevy::render::render_resource::WgpuAdapterInfo")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/adapter.rs.html#109)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [AdapterInfo](struct.WgpuAdapterInfo.html "struct bevy::render::render_resource::WgpuAdapterInfo")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [AdapterInfo](struct.WgpuAdapterInfo.html "struct bevy::render::render_resource::WgpuAdapterInfo")
...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/adapter.rs.html#110)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [AdapterInfo](struct.WgpuAdapterInfo.html "struct bevy::render::render_resource::WgpuAdapterInfo")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/adapter.rs.html#110)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[AdapterInfo](struct.WgpuAdapterInfo.html "struct bevy::render::render_resource::WgpuAdapterInfo"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [AdapterInfo](struct.WgpuAdapterInfo.html "struct bevy::render::render_resource::WgpuAdapterInfo")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/adapter.rs.html#109)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [AdapterInfo](struct.WgpuAdapterInfo.html "struct bevy::render::render_resource::WgpuAdapterInfo")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [AdapterInfo](struct.WgpuAdapterInfo.html "struct bevy::render::render_resource::WgpuAdapterInfo")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/adapter.rs.html#109)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[AdapterInfo](struct.WgpuAdapterInfo.html "struct bevy::render::render_resource::WgpuAdapterInfo")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [AdapterInfo](struct.WgpuAdapterInfo.html "struct bevy::render::render_resource::WgpuAdapterInfo")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [AdapterInfo](struct.WgpuAdapterInfo.html "struct bevy::render::render_resource::WgpuAdapterInfo")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AdapterInfo](struct.WgpuAdapterInfo.html "struct bevy::render::render_resource::WgpuAdapterInfo")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AdapterInfo](struct.WgpuAdapterInfo.html "struct bevy::render::render_resource::WgpuAdapterInfo")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AdapterInfo](struct.WgpuAdapterInfo.html "struct bevy::render::render_resource::WgpuAdapterInfo")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AdapterInfo](struct.WgpuAdapterInfo.html "struct bevy::render::render_resource::WgpuAdapterInfo")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AdapterInfo](struct.WgpuAdapterInfo.html "struct bevy::render::render_resource::WgpuAdapterInfo")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AdapterInfo](struct.WgpuAdapterInfo.html "struct bevy::render::render_resource::WgpuAdapterInfo")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AdapterInfo](struct.WgpuAdapterInfo.html "struct bevy::render::render_resource::WgpuAdapterInfo")
