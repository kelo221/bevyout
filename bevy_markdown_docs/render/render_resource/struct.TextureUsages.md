...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)
...
Corresponds to [WebGPU `GPUTextureUsageFlags`](https://gpuweb.github.io/gpuweb/#typedefdef-gputextureusageflags).

## Implementations

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

### impl [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### pub const [COPY\_SRC](#associatedconstant.COPY_SRC): [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")
...
#### pub const [COPY\_DST](#associatedconstant.COPY_DST): [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")
...
#### pub const [TEXTURE\_BINDING](#associatedconstant.TEXTURE_BINDING): [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

Allows a texture to be a \[`BindingType::Texture`\] in a bind group.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### pub const [STORAGE\_BINDING](#associatedconstant.STORAGE_BINDING): [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

Allows a texture to be a \[`BindingType::StorageTexture`\] in a bind group.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### pub const [RENDER\_ATTACHMENT](#associatedconstant.RENDER_ATTACHMENT): [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

Allows a texture to be an output attachment of a render pass.

Consider adding [`TextureUsages::TRANSIENT`](struct.TextureUsages.html#associatedconstant.TRANSIENT "associated constant bevy::render::render_resource::TextureUsages::TRANSIENT") if the contents are not reused.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### pub const [STORAGE\_ATOMIC](#associatedconstant.STORAGE_ATOMIC): [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

Allows a texture to be used with image atomics. Requires \[`Features::TEXTURE_ATOMIC`\].

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### pub const [TRANSIENT](#associatedconstant.TRANSIENT): [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

Specifies the contents of this texture will not be used in another pass to potentially reduce memory usage and bandwidth.

No-op on platforms on platforms that do not benefit from transient textures. Generally mobile and Apple chips care about this.

Incompatible with ALL other usages except [`TextureUsages::RENDER_ATTACHMENT`](struct.TextureUsages.html#associatedconstant.RENDER_ATTACHMENT "associated constant bevy::render::render_resource::TextureUsages::RENDER_ATTACHMENT") and requires it.
...
#### pub const fn [empty](#method.empty)() -> [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

Get a flags value with all bits unset.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### pub const fn [all](#method.all)() -> [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")
...
#### pub const fn [from\_bits](#method.from_bits)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")\>
...
#### pub const fn [from\_bits\_truncate](#method.from_bits_truncate)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

Convert from a bits value, unsetting any unknown bits.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### pub const fn [from\_bits\_retain](#method.from_bits_retain)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

Convert from a bits value exactly.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### pub fn [from\_name](#method.from_name)(name: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")\>
...
#### pub const fn [intersects](#method.intersects)(&self, other: [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Whether any set bits in `other` are also set in `self`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### pub const fn [contains](#method.contains)(&self, other: [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Whether all set bits in `other` are also set in `self`.

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/3d/reflection\_probes.rs ([line 380](../../../src/reflection_probes/reflection_probes.rs.html#380))
...
#### pub fn [insert](#method.insert)(&mut self, other: [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages"))

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### pub fn [remove](#method.remove)(&mut self, other: [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages"))
...
#### pub fn [toggle](#method.toggle)(&mut self, other: [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages"))

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### pub fn [set](#method.set)(&mut self, other: [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages"), value: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Call `insert` when `value` is `true` or `remove` when `value` is `false`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### pub const fn [intersection](#method.intersection)(self, other: [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")) -> [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

The bitwise and (`&`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### pub const fn [union](#method.union)(self, other: [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")) -> [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### pub const fn [difference](#method.difference)(self, other: [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")) -> [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")
...
#### pub const fn [symmetric\_difference](#method.symmetric_difference)(self, other: [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")) -> [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### pub const fn [complement](#method.complement)(self) -> [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")
...
#### pub const fn [iter](#method.iter)(&self) -> [Iter](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.Iter.html "struct bitflags::iter::Iter")<[TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")\> [ⓘ](#)
...
#### pub const fn [iter\_names](#method.iter_names)(&self) -> [IterNames](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.IterNames.html "struct bitflags::iter::IterNames")<[TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")\> [ⓘ](#)
...
### impl [Binary](https://doc.rust-lang.org/nightly/core/fmt/trait.Binary.html "trait core::fmt::Binary") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")
...
### impl [BitAnd](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html "trait core::ops::bit::BitAnd") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### fn [bitand](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html#tymethod.bitand)(self, other: [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")) -> [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

The bitwise and (`&`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html#associatedtype.Output) = [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

The resulting type after applying the `&` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

### impl [BitAndAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAndAssign.html "trait core::ops::bit::BitAndAssign") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### fn [bitand\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAndAssign.html#tymethod.bitand_assign)(&mut self, other: [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages"))

The bitwise and (`&`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

### impl [BitOr](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html "trait core::ops::bit::BitOr") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### fn [bitor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html#tymethod.bitor)(self, other: [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")) -> [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html#associatedtype.Output) = [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

The resulting type after applying the `|` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

### impl [BitOrAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOrAssign.html "trait core::ops::bit::BitOrAssign") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### fn [bitor\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOrAssign.html#tymethod.bitor_assign)(&mut self, other: [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages"))

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

### impl [BitXor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html "trait core::ops::bit::BitXor") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### fn [bitxor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html#tymethod.bitxor)(self, other: [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")) -> [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html#associatedtype.Output) = [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

The resulting type after applying the `^` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

### impl [BitXorAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXorAssign.html "trait core::ops::bit::BitXorAssign") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### fn [bitxor\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXorAssign.html#tymethod.bitxor_assign)(&mut self, other: [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages"))

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#169)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#169)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#169)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")
...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#167)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#167)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

### impl [Extend](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.Extend.html "trait core::iter::traits::collect::Extend")<[TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")\> for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")
...
where T: [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")\>,
...
### impl [Flags](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html "trait bitflags::traits::Flags") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### const [FLAGS](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#associatedconstant.FLAGS): &'static \[[Flag](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/struct.Flag.html "struct bitflags::traits::Flag")<[TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")\>\]
...
#### fn [from\_bits\_retain](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#tymethod.from_bits_retain)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

Convert from a bits value exactly.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### fn [all\_named](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#method.all_named)() -> [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")
...
[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/components.rs.html#51)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Camera3dDepthTextureUsage](../../camera/struct.Camera3dDepthTextureUsage.html "struct bevy::camera::Camera3dDepthTextureUsage")\> for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/components.rs.html#52)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Camera3dDepthTextureUsage](../../camera/struct.Camera3dDepthTextureUsage.html "struct bevy::camera::Camera3dDepthTextureUsage")) -> [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/components.rs.html#45)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")\> for [Camera3dDepthTextureUsage](../../camera/struct.Camera3dDepthTextureUsage.html "struct bevy::camera::Camera3dDepthTextureUsage")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/components.rs.html#46)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")) -> [Camera3dDepthTextureUsage](../../camera/struct.Camera3dDepthTextureUsage.html "struct bevy::camera::Camera3dDepthTextureUsage")

Converts to this type from the input type.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

### impl [FromIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html "trait core::iter::traits::collect::FromIterator")<[TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")\> for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### fn [from\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html#tymethod.from_iter)<T>(iterator: T) -> [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")
...
### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")
...
### impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### type [Item](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.Item) = [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

The type of the elements being iterated over.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### type [IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter) = [Iter](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.Iter.html "struct bitflags::iter::Iter")<[TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")\>

Which kind of iterator are we turning this into?

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### fn [into\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)(self) -> <[TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages") as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter "type core::iter::traits::collect::IntoIterator::IntoIter")

Creates an iterator from a value. [Read more](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

### impl [LowerHex](https://doc.rust-lang.org/nightly/core/fmt/trait.LowerHex.html "trait core::fmt::LowerHex") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")
...
### impl [Not](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html "trait core::ops::bit::Not") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### fn [not](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html#tymethod.not)(self) -> [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

The bitwise negation (`!`) of the bits in `self`, truncating the result.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html#associatedtype.Output) = [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

The resulting type after applying the `!` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

### impl [Octal](https://doc.rust-lang.org/nightly/core/fmt/trait.Octal.html "trait core::fmt::Octal") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#169)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

### impl [Sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html "trait core::ops::arith::Sub") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### fn [sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#tymethod.sub)(self, other: [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")) -> [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")
...
#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#associatedtype.Output) = [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

The resulting type after applying the `-` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

### impl [SubAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html "trait core::ops::arith::SubAssign") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/texture.rs.html#158-208)

#### fn [sub\_assign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html#tymethod.sub_assign)(&mut self, other: [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages"))
...
### impl [UpperHex](https://doc.rust-lang.org/nightly/core/fmt/trait.UpperHex.html "trait core::fmt::UpperHex") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TextureUsages](struct.TextureUsages.html "struct bevy::render::render_resource::TextureUsages")
