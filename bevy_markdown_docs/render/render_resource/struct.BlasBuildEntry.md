...
[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/blas.rs.html#127)
...
`blas: &'a [Blas](struct.Blas.html "struct bevy::render::render_resource::Blas")`

Reference to the acceleration structure.

`geometry: [BlasGeometries](enum.BlasGeometries.html "enum bevy::render::render_resource::BlasGeometries")<'a>`

Geometries.

## Auto Trait Implementations

### impl<'a> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [BlasBuildEntry](struct.BlasBuildEntry.html "struct bevy::render::render_resource::BlasBuildEntry")<'a>

### impl<'a> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [BlasBuildEntry](struct.BlasBuildEntry.html "struct bevy::render::render_resource::BlasBuildEntry")<'a>

### impl<'a> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [BlasBuildEntry](struct.BlasBuildEntry.html "struct bevy::render::render_resource::BlasBuildEntry")<'a>

### impl<'a> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [BlasBuildEntry](struct.BlasBuildEntry.html "struct bevy::render::render_resource::BlasBuildEntry")<'a>

### impl<'a> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [BlasBuildEntry](struct.BlasBuildEntry.html "struct bevy::render::render_resource::BlasBuildEntry")<'a>

### impl<'a> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [BlasBuildEntry](struct.BlasBuildEntry.html "struct bevy::render::render_resource::BlasBuildEntry")<'a>

### impl<'a> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [BlasBuildEntry](struct.BlasBuildEntry.html "struct bevy::render::render_resource::BlasBuildEntry")<'a>
