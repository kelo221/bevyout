...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/render.rs.html#805)
...
Corresponds to [WebGPU `GPUDepthStencilState`](https://gpuweb.github.io/gpuweb/#dictdef-gpudepthstencilstate).

## Fields

`format: [TextureFormat](enum.TextureFormat.html "enum bevy::render::render_resource::TextureFormat")`

Format of the depth/stencil buffer, must be special depth format. Must match the format of the depth/stencil attachment in [`CommandEncoder::begin_render_pass`](../wgpu/struct.CommandEncoder.html#method.begin_render_pass).

`depth_write_enabled: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)>`

Whether to write updated depth values to the depth attachment.

If `format` is a depth or depth/stencil format, then this must be `Some`. Otherwise, specifying `None` is preferred, but `Some(false)` is also accepted.

`depth_compare: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[CompareFunction](enum.CompareFunction.html "enum bevy::render::render_resource::CompareFunction")>`

Comparison function used to compare depth values in the depth test.

If `depth_write_enabled` is `Some(true)` or if `depth_fail_op` for either stencil face is not `Keep`, then this must be `Some`. Otherwise, specifying `None` is preferred, but `Some(CompareFunction::Always)` is also accepted.

`stencil: [StencilState](struct.StencilState.html "struct bevy::render::render_resource::StencilState")`

Stencil state.

`bias: [DepthBiasState](struct.DepthBiasState.html "struct bevy::render::render_resource::DepthBiasState")`

Depth bias state.

## Implementations

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/render.rs.html#831)

### impl [DepthStencilState](struct.DepthStencilState.html "struct bevy::render::render_resource::DepthStencilState")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/render.rs.html#835)

#### pub fn [stencil](#method.stencil)( format: [TextureFormat](enum.TextureFormat.html "enum bevy::render::render_resource::TextureFormat"), stencil: [StencilState](struct.StencilState.html "struct bevy::render::render_resource::StencilState"), ) -> [DepthStencilState](struct.DepthStencilState.html "struct bevy::render::render_resource::DepthStencilState")
...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/render.rs.html#851)

#### pub fn [is\_depth\_enabled](#method.is_depth_enabled)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns true if the depth testing is enabled.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/render.rs.html#858)

#### pub fn [is\_depth\_read\_only](#method.is_depth_read_only)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns true if the state doesn’t mutate the depth buffer.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/render.rs.html#864)

#### pub fn [is\_stencil\_read\_only](#method.is_stencil_read_only)(&self, cull\_mode: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Face](enum.Face.html "enum bevy::render::render_resource::Face")\>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns true if the state doesn’t mutate the stencil.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/render.rs.html#870)

#### pub fn [is\_read\_only](#method.is_read_only)(&self, cull\_mode: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Face](enum.Face.html "enum bevy::render::render_resource::Face")\>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns true if the state doesn’t mutate either depth or stencil of the target.

## Trait Implementations

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/render.rs.html#803)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [DepthStencilState](struct.DepthStencilState.html "struct bevy::render::render_resource::DepthStencilState")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/render.rs.html#803)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [DepthStencilState](struct.DepthStencilState.html "struct bevy::render::render_resource::DepthStencilState")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [DepthStencilState](struct.DepthStencilState.html "struct bevy::render::render_resource::DepthStencilState")
...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/render.rs.html#804)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [DepthStencilState](struct.DepthStencilState.html "struct bevy::render::render_resource::DepthStencilState")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/render.rs.html#804)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[DepthStencilState](struct.DepthStencilState.html "struct bevy::render::render_resource::DepthStencilState"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [DepthStencilState](struct.DepthStencilState.html "struct bevy::render::render_resource::DepthStencilState")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/render.rs.html#803)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [DepthStencilState](struct.DepthStencilState.html "struct bevy::render::render_resource::DepthStencilState")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [DepthStencilState](struct.DepthStencilState.html "struct bevy::render::render_resource::DepthStencilState")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/render.rs.html#803)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[DepthStencilState](struct.DepthStencilState.html "struct bevy::render::render_resource::DepthStencilState")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [DepthStencilState](struct.DepthStencilState.html "struct bevy::render::render_resource::DepthStencilState")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [DepthStencilState](struct.DepthStencilState.html "struct bevy::render::render_resource::DepthStencilState")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DepthStencilState](struct.DepthStencilState.html "struct bevy::render::render_resource::DepthStencilState")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DepthStencilState](struct.DepthStencilState.html "struct bevy::render::render_resource::DepthStencilState")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DepthStencilState](struct.DepthStencilState.html "struct bevy::render::render_resource::DepthStencilState")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DepthStencilState](struct.DepthStencilState.html "struct bevy::render::render_resource::DepthStencilState")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DepthStencilState](struct.DepthStencilState.html "struct bevy::render::render_resource::DepthStencilState")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DepthStencilState](struct.DepthStencilState.html "struct bevy::render::render_resource::DepthStencilState")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DepthStencilState](struct.DepthStencilState.html "struct bevy::render::render_resource::DepthStencilState")
