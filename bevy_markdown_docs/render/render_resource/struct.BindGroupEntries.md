...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_resource/bind_group_entries.rs.html#95)
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_resource/bind_group_entries.rs.html#99)

### impl<'b, const N: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> [BindGroupEntries](struct.BindGroupEntries.html "struct bevy::render::render_resource::BindGroupEntries")<'b, N>

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_resource/bind_group_entries.rs.html#101)

#### pub fn [sequential](#method.sequential)( resources: impl [IntoBindingArray](trait.IntoBindingArray.html "trait bevy::render::render_resource::IntoBindingArray")<'b, N>, ) -> [BindGroupEntries](struct.BindGroupEntries.html "struct bevy::render::render_resource::BindGroupEntries")<'b, N>

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/shader/gpu\_readback.rs ([lines 157-160](../../../src/gpu_readback/gpu_readback.rs.html#157-160))
...
examples/shader\_advanced/texture\_binding\_array.rs ([line 134](../../../src/texture_binding_array/texture_binding_array.rs.html#134))
...
examples/shader/compute\_shader\_game\_of\_life.rs ([lines 149-153](../../../src/compute_shader_game_of_life/compute_shader_game_of_life.rs.html#149-153))
...
examples/shader\_advanced/compute\_mesh.rs ([lines 296-300](../../../src/compute_mesh/compute_mesh.rs.html#296-300))
...
examples/shader\_advanced/custom\_post\_processing.rs ([lines 125-132](../../../src/custom_post_processing/custom_post_processing.rs.html#125-132))
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_resource/bind_group_entries.rs.html#113)

#### pub fn [with\_indices](#method.with_indices)( indexed\_resources: impl [IntoIndexedBindingArray](trait.IntoIndexedBindingArray.html "trait bevy::render::render_resource::IntoIndexedBindingArray")<'b, N>, ) -> [BindGroupEntries](struct.BindGroupEntries.html "struct bevy::render::render_resource::BindGroupEntries")<'b, N>

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_resource/bind_group_entries.rs.html#122)

### impl<'b> [BindGroupEntries](struct.BindGroupEntries.html "struct bevy::render::render_resource::BindGroupEntries")<'b>

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_resource/bind_group_entries.rs.html#123)

#### pub fn [single](#method.single)(resource: impl [IntoBinding](trait.IntoBinding.html "trait bevy::render::render_resource::IntoBinding")<'b>) -> \[[BindGroupEntry](struct.BindGroupEntry.html "struct bevy::render::render_resource::BindGroupEntry")<'b>; [1](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_resource/bind_group_entries.rs.html#131)

### impl<'b, const N: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [BindGroupEntries](struct.BindGroupEntries.html "struct bevy::render::render_resource::BindGroupEntries")<'b, N>

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_resource/bind_group_entries.rs.html#132)
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_resource/bind_group_entries.rs.html#134)
...
### impl<'b, const N: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html) = 1> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [BindGroupEntries](struct.BindGroupEntries.html "struct bevy::render::render_resource::BindGroupEntries")<'b, N>

### impl<'b, const N: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html) = 1> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [BindGroupEntries](struct.BindGroupEntries.html "struct bevy::render::render_resource::BindGroupEntries")<'b, N>

### impl<'b, const N: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [BindGroupEntries](struct.BindGroupEntries.html "struct bevy::render::render_resource::BindGroupEntries")<'b, N>

### impl<'b, const N: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [BindGroupEntries](struct.BindGroupEntries.html "struct bevy::render::render_resource::BindGroupEntries")<'b, N>

### impl<'b, const N: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [BindGroupEntries](struct.BindGroupEntries.html "struct bevy::render::render_resource::BindGroupEntries")<'b, N>

### impl<'b, const N: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [BindGroupEntries](struct.BindGroupEntries.html "struct bevy::render::render_resource::BindGroupEntries")<'b, N>

### impl<'b, const N: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [BindGroupEntries](struct.BindGroupEntries.html "struct bevy::render::render_resource::BindGroupEntries")<'b, N>
