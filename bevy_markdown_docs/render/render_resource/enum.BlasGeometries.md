...
[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/blas.rs.html#120)
...
### TriangleGeometries([Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[BlasTriangleGeometry](struct.BlasTriangleGeometry.html "struct bevy::render::render_resource::BlasTriangleGeometry")<'a>>)

Triangle geometry variant.

## Auto Trait Implementations

### impl<'a> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [BlasGeometries](enum.BlasGeometries.html "enum bevy::render::render_resource::BlasGeometries")<'a>

### impl<'a> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [BlasGeometries](enum.BlasGeometries.html "enum bevy::render::render_resource::BlasGeometries")<'a>

### impl<'a> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [BlasGeometries](enum.BlasGeometries.html "enum bevy::render::render_resource::BlasGeometries")<'a>

### impl<'a> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [BlasGeometries](enum.BlasGeometries.html "enum bevy::render::render_resource::BlasGeometries")<'a>

### impl<'a> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [BlasGeometries](enum.BlasGeometries.html "enum bevy::render::render_resource::BlasGeometries")<'a>

### impl<'a> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [BlasGeometries](enum.BlasGeometries.html "enum bevy::render::render_resource::BlasGeometries")<'a>

### impl<'a> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [BlasGeometries](enum.BlasGeometries.html "enum bevy::render::render_resource::BlasGeometries")<'a>
