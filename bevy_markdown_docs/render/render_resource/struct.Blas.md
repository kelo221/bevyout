...
[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/blas.rs.html#143)

```rust
pub struct Blas { /* private fields */ }
```
...
These BLASes are combined with transform in a [TlasInstance](struct.TlasInstance.html "struct bevy::render::render_resource::TlasInstance") to create a [Tlas](struct.Tlas.html "struct bevy::render::render_resource::Tlas").

## Implementations

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/blas.rs.html#151)

### impl [Blas](struct.Blas.html "struct bevy::render::render_resource::Blas")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/blas.rs.html#153)

#### pub fn [handle](#method.handle)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)\>

Raw handle to the acceleration structure, used inside raw instance buffers.

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/blas.rs.html#195-197)

#### pub unsafe fn [as\_hal](#method.as_hal)<A>( &mut self, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<impl [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")<Target = <A as [Api](https://docs.rs/wgpu-hal/29.0.3/x86_64-unknown-linux-gnu/wgpu_hal/trait.Api.html "trait wgpu_hal::Api")\>::[AccelerationStructure](https://docs.rs/wgpu-hal/29.0.3/x86_64-unknown-linux-gnu/wgpu_hal/trait.Api.html#associatedtype.AccelerationStructure "type wgpu_hal::Api::AccelerationStructure")\> + [WasmNotSendSync](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/send_sync/trait.WasmNotSendSync.html "trait wgpu_types::send_sync::WasmNotSendSync")\>

where A: [Api](https://docs.rs/wgpu-hal/29.0.3/x86_64-unknown-linux-gnu/wgpu_hal/trait.Api.html "trait wgpu_hal::Api"),

Available on **`wgpu_core`** only.

Get the [`wgpu_hal`](https://docs.rs/wgpu-hal/29.0.3/x86_64-unknown-linux-gnu/wgpu_hal/index.html "mod wgpu_hal") acceleration structure from this `Blas`.
...
[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/blas.rs.html#259)

### impl [Blas](struct.Blas.html "struct bevy::render::render_resource::Blas")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/blas.rs.html#273-276)

#### pub fn [prepare\_compaction\_async](#method.prepare_compaction_async)( &self, callback: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")([Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [BlasAsyncError](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/wgpu/api/blas/struct.BlasAsyncError.html "struct wgpu::api::blas::BlasAsyncError")\>) + [WasmNotSend](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/send_sync/trait.WasmNotSend.html "trait wgpu_types::send_sync::WasmNotSend") + 'static, )

Asynchronously prepares this BLAS for compaction. The callback is called once all builds using this BLAS are finished and the BLAS is compactable. This can be checked using [`Blas::ready_for_compaction`](struct.Blas.html#method.ready_for_compaction "method bevy::render::render_resource::Blas::ready_for_compaction"). Rebuilding this BLAS will reset its compacted state, and it will need to be prepared again.

###### Interaction with other functions

On native, `queue.submit(..)` and polling devices (that is calling `instance.poll_all` or `device.poll`) with [`PollType::Poll`](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/enum.PollType.html#variant.Poll "variant wgpu_types::PollType::Poll") may call the callback. On native, polling devices with [`PollType::Wait`](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/enum.PollType.html#variant.Wait "variant wgpu_types::PollType::Wait") (optionally with a submission index greater than the last submit the BLAS was used in) will guarantee callback is called.

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/blas.rs.html#283)

#### pub fn [ready\_for\_compaction](#method.ready_for_compaction)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Checks whether this BLAS is ready for compaction. The returned value is `true` if [`Blas::prepare_compaction_async`](struct.Blas.html#method.prepare_compaction_async "method bevy::render::render_resource::Blas::prepare_compaction_async")’s callback was called with a non-error value, otherwise this is `false`.

## Trait Implementations

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/blas.rs.html#135)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Blas](struct.Blas.html "struct bevy::render::render_resource::Blas")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/blas.rs.html#135)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Blas](struct.Blas.html "struct bevy::render::render_resource::Blas")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Blas](struct.Blas.html "struct bevy::render::render_resource::Blas")
...
[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/blas.rs.html#149)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [Blas](struct.Blas.html "struct bevy::render::render_resource::Blas")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/blas.rs.html#149)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [Blas](struct.Blas.html "struct bevy::render::render_resource::Blas")
...
### impl [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [Blas](struct.Blas.html "struct bevy::render::render_resource::Blas")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/blas.rs.html#149)

#### fn [cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html#tymethod.cmp)(&self, other: &[Blas](struct.Blas.html "struct bevy::render::render_resource::Blas")) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Blas](struct.Blas.html "struct bevy::render::render_resource::Blas")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/blas.rs.html#149)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Blas](struct.Blas.html "struct bevy::render::render_resource::Blas")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [Blas](struct.Blas.html "struct bevy::render::render_resource::Blas")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/blas.rs.html#149)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[Blas](struct.Blas.html "struct bevy::render::render_resource::Blas")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")\>
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Blas](struct.Blas.html "struct bevy::render::render_resource::Blas")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Blas](struct.Blas.html "struct bevy::render::render_resource::Blas")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Blas](struct.Blas.html "struct bevy::render::render_resource::Blas")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Blas](struct.Blas.html "struct bevy::render::render_resource::Blas")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Blas](struct.Blas.html "struct bevy::render::render_resource::Blas")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Blas](struct.Blas.html "struct bevy::render::render_resource::Blas")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Blas](struct.Blas.html "struct bevy::render::render_resource::Blas")
