...
# Struct RawVertexBufferLayout 

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/render_pipeline.rs.html#76)

```rust
pub struct RawVertexBufferLayout<'a> {
...
Use this in a [`RenderPipelineDescriptor`](struct.RawRenderPipelineDescriptor.html "struct bevy::render::render_resource::RawRenderPipelineDescriptor") to describe the format of the vertex buffers that are passed to [`RenderPass::set_vertex_buffer()`](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/wgpu/api/render_pass/struct.RenderPass.html#method.set_vertex_buffer "method wgpu::api::render_pass::RenderPass::set_vertex_buffer").

Corresponds to [WebGPU `GPUVertexBufferLayout`](https://gpuweb.github.io/gpuweb/#dictdef-gpuvertexbufferlayout).

## Example

The following example defines a `struct` with three fields, and a [`VertexBufferLayout`](struct.RawVertexBufferLayout.html "struct bevy::render::render_resource::RawVertexBufferLayout") that contains [`VertexAttribute`](struct.VertexAttribute.html "struct bevy::render::render_resource::VertexAttribute")s for each field, using the [`vertex_attr_array!`](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/wgpu/macro.vertex_attr_array.html "macro wgpu::vertex_attr_array") macro to compute attribute offsets:
...
This must be a multiple of [`VERTEX_ALIGNMENT`](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/constant.VERTEX_ALIGNMENT.html "constant wgpu_types::VERTEX_ALIGNMENT").

`step_mode: [VertexStepMode](enum.VertexStepMode.html "enum bevy::render::render_resource::VertexStepMode")`

How often this vertex buffer is “stepped” forward.

`attributes: &'a [[VertexAttribute](struct.VertexAttribute.html "struct bevy::render::render_resource::VertexAttribute")]`

The list of attributes which comprise a single vertex.

## Trait Implementations

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/render_pipeline.rs.html#75)

### impl<'a> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [VertexBufferLayout](struct.RawVertexBufferLayout.html "struct bevy::render::render_resource::RawVertexBufferLayout")<'a>

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/render_pipeline.rs.html#75)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [VertexBufferLayout](struct.RawVertexBufferLayout.html "struct bevy::render::render_resource::RawVertexBufferLayout")<'a>
...
### impl<'a> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [VertexBufferLayout](struct.RawVertexBufferLayout.html "struct bevy::render::render_resource::RawVertexBufferLayout")<'a>
...
### impl<'a> [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [VertexBufferLayout](struct.RawVertexBufferLayout.html "struct bevy::render::render_resource::RawVertexBufferLayout")<'a>

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/render_pipeline.rs.html#75)

### impl<'a> [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [VertexBufferLayout](struct.RawVertexBufferLayout.html "struct bevy::render::render_resource::RawVertexBufferLayout")<'a>
...
### impl<'a> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [VertexBufferLayout](struct.RawVertexBufferLayout.html "struct bevy::render::render_resource::RawVertexBufferLayout")<'a>

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/render_pipeline.rs.html#75)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[VertexBufferLayout](struct.RawVertexBufferLayout.html "struct bevy::render::render_resource::RawVertexBufferLayout")<'a>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl<'a> [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [VertexBufferLayout](struct.RawVertexBufferLayout.html "struct bevy::render::render_resource::RawVertexBufferLayout")<'a>

## Auto Trait Implementations

### impl<'a> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [VertexBufferLayout](struct.RawVertexBufferLayout.html "struct bevy::render::render_resource::RawVertexBufferLayout")<'a>

### impl<'a> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [VertexBufferLayout](struct.RawVertexBufferLayout.html "struct bevy::render::render_resource::RawVertexBufferLayout")<'a>

### impl<'a> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [VertexBufferLayout](struct.RawVertexBufferLayout.html "struct bevy::render::render_resource::RawVertexBufferLayout")<'a>

### impl<'a> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [VertexBufferLayout](struct.RawVertexBufferLayout.html "struct bevy::render::render_resource::RawVertexBufferLayout")<'a>

### impl<'a> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [VertexBufferLayout](struct.RawVertexBufferLayout.html "struct bevy::render::render_resource::RawVertexBufferLayout")<'a>

### impl<'a> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [VertexBufferLayout](struct.RawVertexBufferLayout.html "struct bevy::render::render_resource::RawVertexBufferLayout")<'a>

### impl<'a> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [VertexBufferLayout](struct.RawVertexBufferLayout.html "struct bevy::render::render_resource::RawVertexBufferLayout")<'a>
