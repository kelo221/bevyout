...
[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/sampler.rs.html#13)

```rust
pub struct WgpuSampler { /* private fields */ }
```

Handle to a sampler.

A `Sampler` object defines how a pipeline will sample from a [`TextureView`](struct.WgpuTextureView.html "struct bevy::render::render_resource::WgpuTextureView"). Samplers define image filters (including anisotropy) and address (wrapping) modes, among other things. See the documentation for [`SamplerDescriptor`](type.SamplerDescriptor.html "type bevy::render::render_resource::SamplerDescriptor") for more information.

It can be created with [`Device::create_sampler`](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/wgpu/api/device/struct.Device.html#method.create_sampler "method wgpu::api::device::Device::create_sampler").

Corresponds to [WebGPU `GPUSampler`](https://gpuweb.github.io/gpuweb/#sampler-interface).

## Trait Implementations

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/sampler.rs.html#12)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Sampler](struct.WgpuSampler.html "struct bevy::render::render_resource::WgpuSampler")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/sampler.rs.html#12)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Sampler](struct.WgpuSampler.html "struct bevy::render::render_resource::WgpuSampler")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Sampler](struct.WgpuSampler.html "struct bevy::render::render_resource::WgpuSampler")
...
[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/sampler.rs.html#19)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [Sampler](struct.WgpuSampler.html "struct bevy::render::render_resource::WgpuSampler")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_resource/texture.rs.html#146)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Sampler](struct.WgpuSampler.html "struct bevy::render::render_resource::WgpuSampler")\> for [Sampler](struct.Sampler.html "struct bevy::render::render_resource::Sampler")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_resource/texture.rs.html#147)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Sampler](struct.WgpuSampler.html "struct bevy::render::render_resource::WgpuSampler")) -> [Sampler](struct.Sampler.html "struct bevy::render::render_resource::Sampler")

Converts to this type from the input type.

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/sampler.rs.html#19)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [Sampler](struct.WgpuSampler.html "struct bevy::render::render_resource::WgpuSampler")
...
### impl [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [Sampler](struct.WgpuSampler.html "struct bevy::render::render_resource::WgpuSampler")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/sampler.rs.html#19)

#### fn [cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html#tymethod.cmp)(&self, other: &[Sampler](struct.WgpuSampler.html "struct bevy::render::render_resource::WgpuSampler")) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Sampler](struct.WgpuSampler.html "struct bevy::render::render_resource::WgpuSampler")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/sampler.rs.html#19)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Sampler](struct.WgpuSampler.html "struct bevy::render::render_resource::WgpuSampler")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [Sampler](struct.WgpuSampler.html "struct bevy::render::render_resource::WgpuSampler")

[Source](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/src/wgpu/api/sampler.rs.html#19)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[Sampler](struct.WgpuSampler.html "struct bevy::render::render_resource::WgpuSampler")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")\>
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Sampler](struct.WgpuSampler.html "struct bevy::render::render_resource::WgpuSampler")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Sampler](struct.WgpuSampler.html "struct bevy::render::render_resource::WgpuSampler")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Sampler](struct.WgpuSampler.html "struct bevy::render::render_resource::WgpuSampler")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Sampler](struct.WgpuSampler.html "struct bevy::render::render_resource::WgpuSampler")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Sampler](struct.WgpuSampler.html "struct bevy::render::render_resource::WgpuSampler")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Sampler](struct.WgpuSampler.html "struct bevy::render::render_resource::WgpuSampler")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Sampler](struct.WgpuSampler.html "struct bevy::render::render_resource::WgpuSampler")
