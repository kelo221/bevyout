...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#16)

```rust
pub struct StoragePlugin;
```

Adds [`ShaderBuffer`](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer") as an asset that is extracted and uploaded to the GPU.

## Trait Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#15)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [StoragePlugin](struct.StoragePlugin.html "struct bevy::render::storage::StoragePlugin")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#15)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [StoragePlugin](struct.StoragePlugin.html "struct bevy::render::storage::StoragePlugin")
...
### impl [Plugin](../../prelude/trait.Plugin.html "trait bevy::prelude::Plugin") for [StoragePlugin](struct.StoragePlugin.html "struct bevy::render::storage::StoragePlugin")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#19)
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [StoragePlugin](struct.StoragePlugin.html "struct bevy::render::storage::StoragePlugin")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [StoragePlugin](struct.StoragePlugin.html "struct bevy::render::storage::StoragePlugin")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [StoragePlugin](struct.StoragePlugin.html "struct bevy::render::storage::StoragePlugin")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [StoragePlugin](struct.StoragePlugin.html "struct bevy::render::storage::StoragePlugin")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [StoragePlugin](struct.StoragePlugin.html "struct bevy::render::storage::StoragePlugin")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [StoragePlugin](struct.StoragePlugin.html "struct bevy::render::storage::StoragePlugin")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [StoragePlugin](struct.StoragePlugin.html "struct bevy::render::storage::StoragePlugin")
