[bevy](../../index.html)::[render](../index.html)::[storage](index.html)

# Struct ShaderBuffer 

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#30)

```rust
pub struct ShaderBuffer {
    pub data: Option<Vec<u8>>,
    pub buffer_description: BufferDescriptor<Option<&'static str>>,
    pub asset_usage: RenderAssetUsages,
    pub copy_on_resize: bool,
}
```

A storage buffer that is prepared as a [`RenderAsset`](../render_asset/trait.RenderAsset.html "trait bevy::render::render_asset::RenderAsset") and uploaded to the GPU.
...
`buffer_description: [BufferDescriptor](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/buffer/struct.BufferDescriptor.html "struct wgpu_types::buffer::BufferDescriptor")<[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)>>`
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#57)

### impl [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#59)

#### pub fn [new](#method.new)(data: &\[[u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)\], asset\_usage: [RenderAssetUsages](../../asset/struct.RenderAssetUsages.html "struct bevy::asset::RenderAssetUsages")) -> [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")

Creates a new storage buffer with the given data and asset usage.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#69)

#### pub fn [with\_size](#method.with_size)(size: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), asset\_usage: [RenderAssetUsages](../../asset/struct.RenderAssetUsages.html "struct bevy::asset::RenderAssetUsages")) -> [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")

Creates a new storage buffer with the given size and asset usage.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#81-83)

#### pub fn [set\_data](#method.set_data)<T>(&mut self, value: T)

where T: [ShaderType](../render_resource/trait.ShaderType.html "trait bevy::render::render_resource::ShaderType") + [WriteInto](../render_resource/encase/internal/trait.WriteInto.html "trait bevy::render::render_resource::encase::internal::WriteInto"),

Sets the data of the storage buffer to the given [`ShaderType`](../render_resource/trait.ShaderType.html "trait bevy::render::render_resource::ShaderType").

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/shader/storage\_buffer.rs ([lines 77-89](../../../src/storage_buffer/storage_buffer.rs.html#77-89))
...
72    mut buffers: ResMut<Assets<ShaderBuffer>>,
73) {
74    let material = materials.get_mut(&material_handles.0).unwrap();
75
76    let mut buffer = buffers.get_mut(&material.colors).unwrap();
77    buffer.set_data(
78        (0..5)
79            .map(|i| {
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#95)

#### pub fn [resize](#method.resize)(&mut self, size: [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html))

Resizes the buffer to the new size.

If CPU data is present, it will be truncated or zero-extended. Does not preserve GPU data when the descriptor changes.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#106)

#### pub fn [resize\_in\_place](#method.resize_in_place)(&mut self, size: [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html))

Resizes the buffer to the new size, preserving existing data.

If CPU data is present, it will be truncated or zero-extended. If no CPU data is present, sets `copy_on_resize` to preserve GPU data.

## Trait Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#27)

### impl [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset") for [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#27)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#27)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#41)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#42)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#116-118)

### impl<T> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<T> for [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")

where T: [ShaderType](../render_resource/trait.ShaderType.html "trait bevy::render::render_resource::ShaderType") + [WriteInto](../render_resource/encase/internal/trait.WriteInto.html "trait bevy::render::render_resource::encase::internal::WriteInto"),

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#120)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: T) -> [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#27)

### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#27)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#27)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#27)

### impl [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#27)

#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")
...
where [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer"): 'into\_return,
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#27)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#29)
...
### impl [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/storage.rs.html#27)

#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")
...
### impl [VisitAssetDependencies](../../asset/trait.VisitAssetDependencies.html "trait bevy::asset::VisitAssetDependencies") for [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ShaderBuffer](struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")
