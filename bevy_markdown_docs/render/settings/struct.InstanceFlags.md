...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)
...
### impl [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### pub const [DEBUG](#associatedconstant.DEBUG): [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")
...
#### pub const [VALIDATION](#associatedconstant.VALIDATION): [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

Enable validation in the backend API, if possible:

*   On the Direct3D `dx12` backend, this calls [`ID3D12Debug::EnableDebugLayer`](https://learn.microsoft.com/en-us/windows/win32/api/d3d12sdklayers/nf-d3d12sdklayers-id3d12debug-enabledebuglayer).
    
*   On the Vulkan backend, this enables the [Vulkan Validation Layer](https://github.com/KhronosGroup/Vulkan-ValidationLayers).
    
*   On the `gles` backend driving Windows OpenGL, this enables [debug output](https://www.khronos.org/opengl/wiki/Debug_Output), effectively calling `glEnable(GL_DEBUG_OUTPUT)`.
    
*   On non-Windows `gles` backends, this calls [`eglDebugMessageControlKHR`](https://registry.khronos.org/EGL/extensions/KHR/EGL_KHR_debug.txt) to enable all debugging messages. If the GLES implementation is ANGLE running on Vulkan, this also enables the Vulkan validation layers by setting [`EGL_PLATFORM_ANGLE_DEBUG_LAYERS_ENABLED`](https://chromium.googlesource.com/angle/angle/+/HEAD/extensions/EGL_ANGLE_platform_angle.txt).
    

When `Self::from_env()` is used, this bit is set if the `WGPU_VALIDATION` environment variable has any value but “0”.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### pub const [DISCARD\_HAL\_LABELS](#associatedconstant.DISCARD_HAL_LABELS): [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")
...
#### pub const [ALLOW\_UNDERLYING\_NONCOMPLIANT\_ADAPTER](#associatedconstant.ALLOW_UNDERLYING_NONCOMPLIANT_ADAPTER): [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")
...
#### pub const [GPU\_BASED\_VALIDATION](#associatedconstant.GPU_BASED_VALIDATION): [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

Enable GPU-based validation. Implies [`Self::VALIDATION`](struct.InstanceFlags.html#associatedconstant.VALIDATION "associated constant bevy::render::settings::InstanceFlags::VALIDATION"). Currently, this only changes behavior on the DX12 and Vulkan backends.

Supported platforms:

*   D3D12; called [“GPU-based validation”, or “GBV”](https://web.archive.org/web/20230206120404/https://learn.microsoft.com/en-us/windows/win32/direct3d12/using-d3d12-debug-layer-gpu-based-validation)
*   Vulkan, via the `VK_LAYER_KHRONOS_validation` layer; called [“GPU-Assisted Validation”](https://github.com/KhronosGroup/Vulkan-ValidationLayers/blob/e45aeb85079e0835694cb8f03e6681fd18ae72c9/docs/gpu_validation.md#gpu-assisted-validation)

When `Self::from_env()` is used takes value from `WGPU_GPU_BASED_VALIDATION` environment variable.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### pub const [VALIDATION\_INDIRECT\_CALL](#associatedconstant.VALIDATION_INDIRECT_CALL): [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")
...
*   When calling `dispatch_workgroups_indirect`, all 3 indirect arguments encoded in the buffer must be less than the `max_compute_workgroups_per_dimension` device limit.
...
**Behavior is undefined if this validation is disabled and the rules above are not satisfied.**
...
#### pub const [AUTOMATIC\_TIMESTAMP\_NORMALIZATION](#associatedconstant.AUTOMATIC_TIMESTAMP_NORMALIZATION): [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

Enable automatic timestamp normalization. This means that in [`CommandEncoder::resolve_query_set`](../wgpu/struct.CommandEncoder.html#method.resolve_query_set), the timestamps will automatically be normalized to be in nanoseconds instead of the raw timestamp values.

This is disabled by default because it introduces a compute shader into the resolution of query sets.

This can be useful for users that need to read timestamps on the gpu, as the normalization can be a hassle to do manually. When this is enabled, the timestamp period returned by the queue will always be `1.0`.
...
#### pub const fn [empty](#method.empty)() -> [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

Get a flags value with all bits unset.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### pub const fn [all](#method.all)() -> [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")
...
#### pub const fn [from\_bits](#method.from_bits)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")\>
...
#### pub const fn [from\_bits\_truncate](#method.from_bits_truncate)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

Convert from a bits value, unsetting any unknown bits.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### pub const fn [from\_bits\_retain](#method.from_bits_retain)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

Convert from a bits value exactly.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### pub fn [from\_name](#method.from_name)(name: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")\>
...
#### pub const fn [intersects](#method.intersects)(&self, other: [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Whether any set bits in `other` are also set in `self`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### pub const fn [contains](#method.contains)(&self, other: [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Whether all set bits in `other` are also set in `self`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### pub fn [insert](#method.insert)(&mut self, other: [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags"))

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### pub fn [remove](#method.remove)(&mut self, other: [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags"))
...
#### pub fn [toggle](#method.toggle)(&mut self, other: [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags"))

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### pub fn [set](#method.set)(&mut self, other: [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags"), value: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Call `insert` when `value` is `true` or `remove` when `value` is `false`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### pub const fn [intersection](#method.intersection)(self, other: [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")) -> [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

The bitwise and (`&`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### pub const fn [union](#method.union)(self, other: [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")) -> [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### pub const fn [difference](#method.difference)(self, other: [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")) -> [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")
...
#### pub const fn [symmetric\_difference](#method.symmetric_difference)(self, other: [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")) -> [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### pub const fn [complement](#method.complement)(self) -> [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")
...
#### pub const fn [iter](#method.iter)(&self) -> [Iter](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.Iter.html "struct bitflags::iter::Iter")<[InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")\> [ⓘ](#)
...
#### pub const fn [iter\_names](#method.iter_names)(&self) -> [IterNames](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.IterNames.html "struct bitflags::iter::IterNames")<[InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")\> [ⓘ](#)
...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#240)

### impl [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#243)

#### pub fn [debugging](#method.debugging)() -> [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

Enable recommended debugging and validation flags.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#249)

#### pub fn [advanced\_debugging](#method.advanced_debugging)() -> [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

Enable advanced debugging and validation flags (potentially very slow).

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#258)

#### pub fn [from\_build\_config](#method.from_build_config)() -> [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

Infer decent defaults from the build type.

If `cfg!(debug_assertions)` is true, then this returns [`Self::debugging()`](struct.InstanceFlags.html#method.debugging "associated function bevy::render::settings::InstanceFlags::debugging"). Otherwise, it returns [`Self::empty()`](struct.InstanceFlags.html#method.empty "associated function bevy::render::settings::InstanceFlags::empty").

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#268)

#### pub fn [from\_env\_or\_default](#method.from_env_or_default)() -> [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

Derive defaults from environment variables. See [`Self::with_env()`](struct.InstanceFlags.html#method.with_env "method bevy::render::settings::InstanceFlags::with_env") for more information.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#289)

#### pub fn [with\_env](#method.with_env)(self) -> [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")
...
For example `let flags = InstanceFlags::debugging().with_env();` with `WGPU_VALIDATION=0` does not contain [`InstanceFlags::VALIDATION`](struct.InstanceFlags.html#associatedconstant.VALIDATION "associated constant bevy::render::settings::InstanceFlags::VALIDATION").

The environment variables are named after the flags prefixed with “WGPU\_”. For example:
...
### impl [Binary](https://doc.rust-lang.org/nightly/core/fmt/trait.Binary.html "trait core::fmt::Binary") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")
...
### impl [BitAnd](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html "trait core::ops::bit::BitAnd") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### fn [bitand](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html#tymethod.bitand)(self, other: [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")) -> [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

The bitwise and (`&`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html#associatedtype.Output) = [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

The resulting type after applying the `&` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

### impl [BitAndAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAndAssign.html "trait core::ops::bit::BitAndAssign") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### fn [bitand\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAndAssign.html#tymethod.bitand_assign)(&mut self, other: [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags"))

The bitwise and (`&`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

### impl [BitOr](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html "trait core::ops::bit::BitOr") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### fn [bitor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html#tymethod.bitor)(self, other: [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")) -> [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html#associatedtype.Output) = [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

The resulting type after applying the `|` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

### impl [BitOrAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOrAssign.html "trait core::ops::bit::BitOrAssign") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### fn [bitor\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOrAssign.html#tymethod.bitor_assign)(&mut self, other: [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags"))

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

### impl [BitXor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html "trait core::ops::bit::BitXor") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### fn [bitxor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html#tymethod.bitxor)(self, other: [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")) -> [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html#associatedtype.Output) = [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

The resulting type after applying the `^` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

### impl [BitXorAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXorAssign.html "trait core::ops::bit::BitXorAssign") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### fn [bitxor\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXorAssign.html#tymethod.bitxor_assign)(&mut self, other: [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags"))

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#136)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#136)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#136)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")
...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#234)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#235)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#136)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

### impl [Extend](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.Extend.html "trait core::iter::traits::collect::Extend")<[InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")\> for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")
...
where T: [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")\>,
...
### impl [Flags](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html "trait bitflags::traits::Flags") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### const [FLAGS](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#associatedconstant.FLAGS): &'static \[[Flag](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/struct.Flag.html "struct bitflags::traits::Flag")<[InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")\>\]
...
#### fn [from\_bits\_retain](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#tymethod.from_bits_retain)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

Convert from a bits value exactly.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### fn [all\_named](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#method.all_named)() -> [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")
...
### impl [FromIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html "trait core::iter::traits::collect::FromIterator")<[InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")\> for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### fn [from\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html#tymethod.from_iter)<T>(iterator: T) -> [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")
...
### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")
...
### impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### type [Item](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.Item) = [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

The type of the elements being iterated over.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### type [IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter) = [Iter](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.Iter.html "struct bitflags::iter::Iter")<[InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")\>

Which kind of iterator are we turning this into?

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### fn [into\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)(self) -> <[InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags") as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter "type core::iter::traits::collect::IntoIterator::IntoIter")

Creates an iterator from a value. [Read more](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

### impl [LowerHex](https://doc.rust-lang.org/nightly/core/fmt/trait.LowerHex.html "trait core::fmt::LowerHex") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")
...
### impl [Not](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html "trait core::ops::bit::Not") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### fn [not](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html#tymethod.not)(self) -> [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

The bitwise negation (`!`) of the bits in `self`, truncating the result.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html#associatedtype.Output) = [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

The resulting type after applying the `!` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

### impl [Octal](https://doc.rust-lang.org/nightly/core/fmt/trait.Octal.html "trait core::fmt::Octal") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#136)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

### impl [Sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html "trait core::ops::arith::Sub") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### fn [sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#tymethod.sub)(self, other: [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")) -> [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")
...
#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#associatedtype.Output) = [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

The resulting type after applying the `-` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

### impl [SubAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html "trait core::ops::arith::SubAssign") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/instance.rs.html#129-232)

#### fn [sub\_assign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html#tymethod.sub_assign)(&mut self, other: [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags"))
...
### impl [UpperHex](https://doc.rust-lang.org/nightly/core/fmt/trait.UpperHex.html "trait core::fmt::UpperHex") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")
