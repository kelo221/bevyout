[bevy](../../index.html)::[render](../index.html)::[settings](index.html)
...
### impl [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### pub const [SHADER\_FLOAT32\_ATOMIC](#associatedconstant.SHADER_FLOAT32_ATOMIC): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [TEXTURE\_FORMAT\_16BIT\_NORM](#associatedconstant.TEXTURE_FORMAT_16BIT_NORM): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [TEXTURE\_COMPRESSION\_ASTC\_HDR](#associatedconstant.TEXTURE_COMPRESSION_ASTC_HDR): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Enables ASTC HDR family of compressed textures.

Compressed textures sacrifice some quality in exchange for significantly reduced bandwidth usage.

Support for this feature guarantees availability of \[`TextureUsages::COPY_SRC | TextureUsages::COPY_DST | TextureUsages::TEXTURE_BINDING`\] for ASTC formats with the HDR channel type. [`Features::TEXTURE_ADAPTER_SPECIFIC_FORMAT_FEATURES`](../render_resource/struct.WgpuFeatures.html#associatedconstant.TEXTURE_ADAPTER_SPECIFIC_FORMAT_FEATURES "associated constant bevy::render::render_resource::WgpuFeatures::TEXTURE_ADAPTER_SPECIFIC_FORMAT_FEATURES") may enable additional usages.
...
#### pub const [TEXTURE\_ADAPTER\_SPECIFIC\_FORMAT\_FEATURES](#associatedconstant.TEXTURE_ADAPTER_SPECIFIC_FORMAT_FEATURES): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [PIPELINE\_STATISTICS\_QUERY](#associatedconstant.PIPELINE_STATISTICS_QUERY): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [TIMESTAMP\_QUERY\_INSIDE\_ENCODERS](#associatedconstant.TIMESTAMP_QUERY_INSIDE_ENCODERS): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Allows for timestamp queries directly on command encoders.

Implies [`Features::TIMESTAMP_QUERY`](../render_resource/struct.WgpuFeatures.html#associatedconstant.TIMESTAMP_QUERY "associated constant bevy::render::render_resource::WgpuFeatures::TIMESTAMP_QUERY") is supported.
...
#### pub const [TIMESTAMP\_QUERY\_INSIDE\_PASSES](#associatedconstant.TIMESTAMP_QUERY_INSIDE_PASSES): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Allows for timestamp queries directly on command encoders.

Implies [`Features::TIMESTAMP_QUERY`](../render_resource/struct.WgpuFeatures.html#associatedconstant.TIMESTAMP_QUERY "associated constant bevy::render::render_resource::WgpuFeatures::TIMESTAMP_QUERY") & [`Features::TIMESTAMP_QUERY_INSIDE_ENCODERS`](../render_resource/struct.WgpuFeatures.html#associatedconstant.TIMESTAMP_QUERY_INSIDE_ENCODERS "associated constant bevy::render::render_resource::WgpuFeatures::TIMESTAMP_QUERY_INSIDE_ENCODERS") is supported.
...
#### pub const [MAPPABLE\_PRIMARY\_BUFFERS](#associatedconstant.MAPPABLE_PRIMARY_BUFFERS): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [TEXTURE\_BINDING\_ARRAY](#associatedconstant.TEXTURE_BINDING_ARRAY): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
If [`Features::STORAGE_RESOURCE_BINDING_ARRAY`](../render_resource/struct.WgpuFeatures.html#associatedconstant.STORAGE_RESOURCE_BINDING_ARRAY "associated constant bevy::render::render_resource::WgpuFeatures::STORAGE_RESOURCE_BINDING_ARRAY") is supported as well as this, the user may also create uniform arrays of storage textures.
...
#### pub const [BUFFER\_BINDING\_ARRAY](#associatedconstant.BUFFER_BINDING_ARRAY): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
If [`Features::STORAGE_RESOURCE_BINDING_ARRAY`](../render_resource/struct.WgpuFeatures.html#associatedconstant.STORAGE_RESOURCE_BINDING_ARRAY "associated constant bevy::render::render_resource::WgpuFeatures::STORAGE_RESOURCE_BINDING_ARRAY") is supported as well as this, the user may also create arrays of storage buffers.
...
#### pub const [STORAGE\_RESOURCE\_BINDING\_ARRAY](#associatedconstant.STORAGE_RESOURCE_BINDING_ARRAY): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Allows the user to create uniform arrays of storage buffers or textures in shaders, if resp. [`Features::BUFFER_BINDING_ARRAY`](../render_resource/struct.WgpuFeatures.html#associatedconstant.BUFFER_BINDING_ARRAY "associated constant bevy::render::render_resource::WgpuFeatures::BUFFER_BINDING_ARRAY") or [`Features::TEXTURE_BINDING_ARRAY`](../render_resource/struct.WgpuFeatures.html#associatedconstant.TEXTURE_BINDING_ARRAY "associated constant bevy::render::render_resource::WgpuFeatures::TEXTURE_BINDING_ARRAY") is supported.
...
#### pub const [SAMPLED\_TEXTURE\_AND\_STORAGE\_BUFFER\_ARRAY\_NON\_UNIFORM\_INDEXING](#associatedconstant.SAMPLED_TEXTURE_AND_STORAGE_BUFFER_ARRAY_NON_UNIFORM_INDEXING): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [STORAGE\_TEXTURE\_ARRAY\_NON\_UNIFORM\_INDEXING](#associatedconstant.STORAGE_TEXTURE_ARRAY_NON_UNIFORM_INDEXING): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [PARTIALLY\_BOUND\_BINDING\_ARRAY](#associatedconstant.PARTIALLY_BOUND_BINDING_ARRAY): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [MULTI\_DRAW\_INDIRECT\_COUNT](#associatedconstant.MULTI_DRAW_INDIRECT_COUNT): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [ADDRESS\_MODE\_CLAMP\_TO\_ZERO](#associatedconstant.ADDRESS_MODE_CLAMP_TO_ZERO): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Allows the use of [`AddressMode::ClampToBorder`](../render_resource/enum.AddressMode.html#variant.ClampToBorder "variant bevy::render::render_resource::AddressMode::ClampToBorder") with a border color of [`SamplerBorderColor::Zero`](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/texture/enum.SamplerBorderColor.html#variant.Zero "variant wgpu_types::texture::SamplerBorderColor::Zero").
...
#### pub const [ADDRESS\_MODE\_CLAMP\_TO\_BORDER](#associatedconstant.ADDRESS_MODE_CLAMP_TO_BORDER): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [POLYGON\_MODE\_LINE](#associatedconstant.POLYGON_MODE_LINE): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Allows the user to set [`PolygonMode::Line`](../render_resource/enum.PolygonMode.html#variant.Line "variant bevy::render::render_resource::PolygonMode::Line") in [`PrimitiveState::polygon_mode`](../render_resource/struct.PrimitiveState.html "struct bevy::render::render_resource::PrimitiveState")
...
#### pub const [POLYGON\_MODE\_POINT](#associatedconstant.POLYGON_MODE_POINT): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Allows the user to set [`PolygonMode::Point`](../render_resource/enum.PolygonMode.html#variant.Point "variant bevy::render::render_resource::PolygonMode::Point") in [`PrimitiveState::polygon_mode`](../render_resource/struct.PrimitiveState.html "struct bevy::render::render_resource::PrimitiveState")
...
#### pub const [CONSERVATIVE\_RASTERIZATION](#associatedconstant.CONSERVATIVE_RASTERIZATION): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Allows the user to set a overestimation-conservative-rasterization in [`PrimitiveState::conservative`](../render_resource/struct.PrimitiveState.html#structfield.conservative "field bevy::render::render_resource::PrimitiveState::conservative")
...
#### pub const [VERTEX\_WRITABLE\_STORAGE](#associatedconstant.VERTEX_WRITABLE_STORAGE): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [CLEAR\_TEXTURE](#associatedconstant.CLEAR_TEXTURE): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [MULTIVIEW](#associatedconstant.MULTIVIEW): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [VERTEX\_ATTRIBUTE\_64BIT](#associatedconstant.VERTEX_ATTRIBUTE_64BIT): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [TEXTURE\_ATOMIC](#associatedconstant.TEXTURE_ATOMIC): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [TEXTURE\_FORMAT\_NV12](#associatedconstant.TEXTURE_FORMAT_NV12): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Allows for creation of textures of format [`TextureFormat::NV12`](../render_resource/enum.TextureFormat.html#variant.NV12 "variant bevy::render::render_resource::TextureFormat::NV12")
...
#### pub const [TEXTURE\_FORMAT\_P010](#associatedconstant.TEXTURE_FORMAT_P010): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Allows for creation of textures of format [`TextureFormat::P010`](../render_resource/enum.TextureFormat.html#variant.P010 "variant bevy::render::render_resource::TextureFormat::P010")
...
#### pub const [EXTERNAL\_TEXTURE](#associatedconstant.EXTERNAL_TEXTURE): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Allows for the creation and usage of `ExternalTexture`s, and bind group layouts containing external texture `BindingType`s.

Conceptually this should really be a [`crate::DownlevelFlags`](../render_resource/struct.DownlevelFlags.html "struct bevy::render::render_resource::DownlevelFlags") as it corresponds to WebGPU’s [`GPUExternalTexture`](https://www.w3.org/TR/webgpu/#gpuexternaltexture). However, the implementation is currently in-progress, and until it is complete we do not want applications to ignore adapters due to a missing downlevel flag, when they may not require this feature at all.
...
#### pub const [EXPERIMENTAL\_RAY\_QUERY](#associatedconstant.EXPERIMENTAL_RAY_QUERY): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [SHADER\_F64](#associatedconstant.SHADER_F64): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [SHADER\_I16](#associatedconstant.SHADER_I16): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [SHADER\_EARLY\_DEPTH\_TEST](#associatedconstant.SHADER_EARLY_DEPTH_TEST): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [SHADER\_INT64](#associatedconstant.SHADER_INT64): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [SUBGROUP](#associatedconstant.SUBGROUP): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [SUBGROUP\_VERTEX](#associatedconstant.SUBGROUP_VERTEX): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [SUBGROUP\_BARRIER](#associatedconstant.SUBGROUP_BARRIER): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Allows compute shaders to use the subgroup barrier.

Requires [`Features::SUBGROUP`](../render_resource/struct.WgpuFeatures.html#associatedconstant.SUBGROUP "associated constant bevy::render::render_resource::WgpuFeatures::SUBGROUP"). Without it, enables nothing.
...
#### pub const [PIPELINE\_CACHE](#associatedconstant.PIPELINE_CACHE): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [SHADER\_INT64\_ATOMIC\_MIN\_MAX](#associatedconstant.SHADER_INT64_ATOMIC_MIN_MAX): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [SHADER\_INT64\_ATOMIC\_ALL\_OPS](#associatedconstant.SHADER_INT64_ATOMIC_ALL_OPS): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [VULKAN\_GOOGLE\_DISPLAY\_TIMING](#associatedconstant.VULKAN_GOOGLE_DISPLAY_TIMING): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [VULKAN\_EXTERNAL\_MEMORY\_WIN32](#associatedconstant.VULKAN_EXTERNAL_MEMORY_WIN32): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [TEXTURE\_INT64\_ATOMIC](#associatedconstant.TEXTURE_INT64_ATOMIC): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [UNIFORM\_BUFFER\_BINDING\_ARRAYS](#associatedconstant.UNIFORM_BUFFER_BINDING_ARRAYS): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [EXPERIMENTAL\_MESH\_SHADER](#associatedconstant.EXPERIMENTAL_MESH_SHADER): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [EXPERIMENTAL\_RAY\_HIT\_VERTEX\_RETURN](#associatedconstant.EXPERIMENTAL_RAY_HIT_VERTEX_RETURN): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [EXPERIMENTAL\_MESH\_SHADER\_MULTIVIEW](#associatedconstant.EXPERIMENTAL_MESH_SHADER_MULTIVIEW): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [EXTENDED\_ACCELERATION\_STRUCTURE\_VERTEX\_FORMATS](#associatedconstant.EXTENDED_ACCELERATION_STRUCTURE_VERTEX_FORMATS): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [PASSTHROUGH\_SHADERS](#associatedconstant.PASSTHROUGH_SHADERS): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [SHADER\_BARYCENTRICS](#associatedconstant.SHADER_BARYCENTRICS): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [SELECTIVE\_MULTIVIEW](#associatedconstant.SELECTIVE_MULTIVIEW): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [EXPERIMENTAL\_MESH\_SHADER\_POINTS](#associatedconstant.EXPERIMENTAL_MESH_SHADER_POINTS): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [MULTISAMPLE\_ARRAY](#associatedconstant.MULTISAMPLE_ARRAY): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [EXPERIMENTAL\_COOPERATIVE\_MATRIX](#associatedconstant.EXPERIMENTAL_COOPERATIVE_MATRIX): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [SHADER\_PER\_VERTEX](#associatedconstant.SHADER_PER_VERTEX): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [SHADER\_DRAW\_INDEX](#associatedconstant.SHADER_DRAW_INDEX): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [ACCELERATION\_STRUCTURE\_BINDING\_ARRAY](#associatedconstant.ACCELERATION_STRUCTURE_BINDING_ARRAY): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [MEMORY\_DECORATION\_COHERENT](#associatedconstant.MEMORY_DECORATION_COHERENT): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [MEMORY\_DECORATION\_VOLATILE](#associatedconstant.MEMORY_DECORATION_VOLATILE): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [DEPTH\_CLIP\_CONTROL](#associatedconstant.DEPTH_CLIP_CONTROL): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [DEPTH32FLOAT\_STENCIL8](#associatedconstant.DEPTH32FLOAT_STENCIL8): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Allows for explicit creation of textures of format [`TextureFormat::Depth32FloatStencil8`](../render_resource/enum.TextureFormat.html#variant.Depth32FloatStencil8 "variant bevy::render::render_resource::TextureFormat::Depth32FloatStencil8")
...
#### pub const [TEXTURE\_COMPRESSION\_BC](#associatedconstant.TEXTURE_COMPRESSION_BC): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Enables BCn family of compressed textures. All BCn textures use 4x4 pixel blocks with 8 or 16 bytes per block.

Compressed textures sacrifice some quality in exchange for significantly reduced bandwidth usage.

Support for this feature guarantees availability of \[`TextureUsages::COPY_SRC | TextureUsages::COPY_DST | TextureUsages::TEXTURE_BINDING`\] for BCn formats. [`Features::TEXTURE_ADAPTER_SPECIFIC_FORMAT_FEATURES`](../render_resource/struct.WgpuFeatures.html#associatedconstant.TEXTURE_ADAPTER_SPECIFIC_FORMAT_FEATURES "associated constant bevy::render::render_resource::WgpuFeatures::TEXTURE_ADAPTER_SPECIFIC_FORMAT_FEATURES") may enable additional usages.
...
#### pub const [TEXTURE\_COMPRESSION\_BC\_SLICED\_3D](#associatedconstant.TEXTURE_COMPRESSION_BC_SLICED_3D): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [TEXTURE\_COMPRESSION\_ETC2](#associatedconstant.TEXTURE_COMPRESSION_ETC2): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
Support for this feature guarantees availability of \[`TextureUsages::COPY_SRC | TextureUsages::COPY_DST | TextureUsages::TEXTURE_BINDING`\] for ETC2 formats. [`Features::TEXTURE_ADAPTER_SPECIFIC_FORMAT_FEATURES`](../render_resource/struct.WgpuFeatures.html#associatedconstant.TEXTURE_ADAPTER_SPECIFIC_FORMAT_FEATURES "associated constant bevy::render::render_resource::WgpuFeatures::TEXTURE_ADAPTER_SPECIFIC_FORMAT_FEATURES") may enable additional usages.
...
#### pub const [TEXTURE\_COMPRESSION\_ASTC](#associatedconstant.TEXTURE_COMPRESSION_ASTC): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [TEXTURE\_COMPRESSION\_ASTC\_SLICED\_3D](#associatedconstant.TEXTURE_COMPRESSION_ASTC_SLICED_3D): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [TIMESTAMP\_QUERY](#associatedconstant.TIMESTAMP_QUERY): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
For arbitrary timestamp write commands on encoders refer to [`Features::TIMESTAMP_QUERY_INSIDE_ENCODERS`](../render_resource/struct.WgpuFeatures.html#associatedconstant.TIMESTAMP_QUERY_INSIDE_ENCODERS "associated constant bevy::render::render_resource::WgpuFeatures::TIMESTAMP_QUERY_INSIDE_ENCODERS"). For arbitrary timestamp write commands on passes refer to [`Features::TIMESTAMP_QUERY_INSIDE_PASSES`](../render_resource/struct.WgpuFeatures.html#associatedconstant.TIMESTAMP_QUERY_INSIDE_PASSES "associated constant bevy::render::render_resource::WgpuFeatures::TIMESTAMP_QUERY_INSIDE_PASSES").
...
#### pub const [INDIRECT\_FIRST\_INSTANCE](#associatedconstant.INDIRECT_FIRST_INSTANCE): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [SHADER\_F16](#associatedconstant.SHADER_F16): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [RG11B10UFLOAT\_RENDERABLE](#associatedconstant.RG11B10UFLOAT_RENDERABLE): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Allows for usage of textures of format [`TextureFormat::Rg11b10Ufloat`](../render_resource/enum.TextureFormat.html#variant.Rg11b10Ufloat "variant bevy::render::render_resource::TextureFormat::Rg11b10Ufloat") as a render target
...
#### pub const [BGRA8UNORM\_STORAGE](#associatedconstant.BGRA8UNORM_STORAGE): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Allows the [`TextureUsages::STORAGE_BINDING`](../render_resource/struct.TextureUsages.html#associatedconstant.STORAGE_BINDING "associated constant bevy::render::render_resource::TextureUsages::STORAGE_BINDING") usage on textures with format [`TextureFormat::Bgra8Unorm`](../render_resource/enum.TextureFormat.html#variant.Bgra8Unorm "variant bevy::render::render_resource::TextureFormat::Bgra8Unorm")
...
#### pub const [FLOAT32\_FILTERABLE](#associatedconstant.FLOAT32_FILTERABLE): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [FLOAT32\_BLENDABLE](#associatedconstant.FLOAT32_BLENDABLE): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [DUAL\_SOURCE\_BLENDING](#associatedconstant.DUAL_SOURCE_BLENDING): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [CLIP\_DISTANCES](#associatedconstant.CLIP_DISTANCES): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const [IMMEDIATES](#associatedconstant.IMMEDIATES): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
Allows the user to call [`RenderPass::set_immediates`](../wgpu/struct.RenderPass.html#method.set_immediates), provide a non-zero immediate data size to [`PipelineLayoutDescriptor`](../wgpu/struct.PipelineLayoutDescriptor.html), and provide a non-zero limit to [`Limits::max_immediate_size`](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits").
...
#### pub const [PRIMITIVE\_INDEX](#associatedconstant.PRIMITIVE_INDEX): [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const fn [empty](#method.empty)() -> [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Returns self with no flags set.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### pub const fn [all](#method.all)() -> [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Returns self with all flags set.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### pub const fn [contains](#method.contains)(self, other: [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
#### pub const fn [intersects](#method.intersects)(self, other: [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
#### pub const fn [union](#method.union)(self, other: [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")) -> [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Bitwise or - `self | other`

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### pub const fn [intersection](#method.intersection)(self, other: [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")) -> [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Bitwise and - `self & other`

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### pub const fn [difference](#method.difference)(self, other: [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")) -> [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Bitwise and of the complement of other - `self & !other`

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### pub const fn [symmetric\_difference](#method.symmetric_difference)(self, other: [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")) -> [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Bitwise xor - `self ^ other`

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### pub const fn [complement](#method.complement)(self) -> [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Bitwise not - `!self`

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### pub fn [set](#method.set)(&mut self, other: [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures"), set: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Calls [`Self::insert`](../render_resource/struct.WgpuFeatures.html#method.insert "method bevy::render::render_resource::WgpuFeatures::insert") if `set` is true and otherwise calls [`Self::remove`](../render_resource/struct.WgpuFeatures.html#method.remove "method bevy::render::render_resource::WgpuFeatures::remove").

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### pub fn [insert](#method.insert)(&mut self, other: [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures"))

Inserts specified flag(s) into self

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### pub fn [remove](#method.remove)(&mut self, other: [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures"))

Removes specified flag(s) from self

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### pub fn [toggle](#method.toggle)(&mut self, other: [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures"))

Toggles specified flag(s) in self

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### pub const fn [from\_bits](#method.from_bits)(bits: [FeatureBits](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/features/struct.FeatureBits.html "struct wgpu_types::features::FeatureBits")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")\>
...
#### pub const fn [from\_bits\_truncate](#method.from_bits_truncate)(bits: [FeatureBits](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/features/struct.FeatureBits.html "struct wgpu_types::features::FeatureBits")) -> [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const fn [from\_bits\_retain](#method.from_bits_retain)(bits: [FeatureBits](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/features/struct.FeatureBits.html "struct wgpu_types::features::FeatureBits")) -> [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub fn [from\_name](#method.from_name)(name: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")\>
...
#### pub fn [from\_internal\_flags](#method.from_internal_flags)( features\_wgpu: [FeaturesWGPU](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/features/struct.FeaturesWGPU.html "struct wgpu_types::features::FeaturesWGPU"), features\_webgpu: [FeaturesWebGPU](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/features/struct.FeaturesWebGPU.html "struct wgpu_types::features::FeaturesWebGPU"), ) -> [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Combines the features from the internal flags into the entire features struct

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### pub const fn [iter](#method.iter)(&self) -> [Iter](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.Iter.html "struct bitflags::iter::Iter")<[Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")\> [ⓘ](#)

Returns an iterator over the set flags.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### pub const fn [iter\_names](#method.iter_names)(&self) -> [IterNames](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.IterNames.html "struct bitflags::iter::IterNames")<[Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")\> [ⓘ](#)
...
If the argument is a single [`Features`](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures") flag, returns the corresponding `kebab-case` feature name, otherwise `None`.
...
#### pub const fn [all\_webgpu\_mask](#method.all_webgpu_mask)() -> [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Mask of all features which are part of the upstream WebGPU standard.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#1803)

#### pub const fn [all\_native\_mask](#method.all_native_mask)() -> [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### pub const fn [all\_experimental\_mask](#method.all_experimental_mask)() -> [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
### impl [BitAnd](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html "trait core::ops::bit::BitAnd") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html#associatedtype.Output) = [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

The resulting type after applying the `&` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### fn [bitand](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html#tymethod.bitand)(self, other: [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")) -> [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Performs the `&` operation. [Read more](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html#tymethod.bitand)

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

### impl [BitAndAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAndAssign.html "trait core::ops::bit::BitAndAssign") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### fn [bitand\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAndAssign.html#tymethod.bitand_assign)(&mut self, other: [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures"))
...
### impl [BitOr](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html "trait core::ops::bit::BitOr") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html#associatedtype.Output) = [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

The resulting type after applying the `|` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### fn [bitor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html#tymethod.bitor)(self, other: [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")) -> [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Performs the `|` operation. [Read more](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html#tymethod.bitor)

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

### impl [BitOrAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOrAssign.html "trait core::ops::bit::BitOrAssign") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### fn [bitor\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOrAssign.html#tymethod.bitor_assign)(&mut self, other: [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures"))
...
### impl [BitXor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html "trait core::ops::bit::BitXor") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html#associatedtype.Output) = [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

The resulting type after applying the `^` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### fn [bitxor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html#tymethod.bitxor)(self, other: [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")) -> [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Performs the `^` operation. [Read more](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html#tymethod.bitxor)

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

### impl [BitXorAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXorAssign.html "trait core::ops::bit::BitXorAssign") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### fn [bitxor\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXorAssign.html#tymethod.bitxor_assign)(&mut self, other: [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures"))
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#590)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#590)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#590)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Available on **crate feature `serde`** only.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<D>( deserializer: D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures"), <D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

### impl [Flags](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html "trait bitflags::traits::Flags") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### const [FLAGS](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#associatedconstant.FLAGS): &'static \[[Flag](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/struct.Flag.html "struct bitflags::traits::Flag")<[Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")\>\] = Features::FLAGS
...
#### fn [empty](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#method.empty)() -> [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Get a flags value with all bits unset.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### fn [all](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#method.all)() -> [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[FeatureBits](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/features/struct.FeatureBits.html "struct wgpu_types::features::FeatureBits")\> for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[FeaturesWGPU](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/features/struct.FeaturesWGPU.html "struct wgpu_types::features::FeaturesWGPU")\> for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(features\_wgpu: [FeaturesWGPU](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/features/struct.FeaturesWGPU.html "struct wgpu_types::features::FeaturesWGPU")) -> [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Converts to this type from the input type.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[FeaturesWebGPU](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/features/struct.FeaturesWebGPU.html "struct wgpu_types::features::FeaturesWebGPU")\> for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
### impl [FromStr](https://doc.rust-lang.org/nightly/core/str/traits/trait.FromStr.html "trait core::str::traits::FromStr") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
#### fn [from\_str](https://doc.rust-lang.org/nightly/core/str/traits/trait.FromStr.html#tymethod.from_str)(s: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures"), <[Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures") as [FromStr](https://doc.rust-lang.org/nightly/core/str/traits/trait.FromStr.html "trait core::str::traits::FromStr")\>::[Err](https://doc.rust-lang.org/nightly/core/str/traits/trait.FromStr.html#associatedtype.Err "type core::str::traits::FromStr::Err")\>
...
### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
### impl [Not](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html "trait core::ops::bit::Not") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html#associatedtype.Output) = [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

The resulting type after applying the `!` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### fn [not](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html#tymethod.not)(self) -> [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Performs the unary `!` operation. [Read more](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html#tymethod.not)

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#590)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#590)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

### impl [Sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html "trait core::ops::arith::Sub") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#associatedtype.Output) = [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

The resulting type after applying the `-` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/features.rs.html#577-1789)

#### fn [sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#tymethod.sub)(self, other: [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")) -> [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

Performs the `-` operation. [Read more](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#tymethod.sub)

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")
