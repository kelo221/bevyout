...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#123)

```rust
#[repr(C)]pub struct WgpuLimits {
...
*   [`Limits::downlevel_defaults()`](../render_resource/struct.WgpuLimits.html#method.downlevel_defaults "associated function bevy::render::render_resource::WgpuLimits::downlevel_defaults"). This is a set of limits that is guaranteed to work on almost all backends, including “downlevel” backends such as OpenGL and D3D11, other than WebGL. For most applications we recommend using these limits, assuming they are high enough for your application, and you do not intend to support WebGL.
*   [`Limits::downlevel_webgl2_defaults()`](../render_resource/struct.WgpuLimits.html#method.downlevel_webgl2_defaults "associated function bevy::render::render_resource::WgpuLimits::downlevel_webgl2_defaults") This is a set of limits that is lower even than the [`downlevel_defaults()`](../render_resource/struct.WgpuLimits.html#method.downlevel_defaults "associated function bevy::render::render_resource::WgpuLimits::downlevel_defaults"), configured to be low enough to support running in the browser using WebGL2.
*   [`Limits::default()`](../render_resource/struct.WgpuLimits.html#method.default "associated function bevy::render::render_resource::WgpuLimits::default"). This is the set of limits that is guaranteed to work on all modern backends and is guaranteed to be supported by WebGPU. Applications needing more modern features can use this as a reasonable set of limits if they are targeting only desktop and modern mobile devices.
...
Limits “better” than the default must be supported by the adapter and requested when requesting a device. If limits “better” than the adapter supports are requested, requesting a device will panic. Once a device is requested, you may only use resources up to the limits requested _even_ if the adapter supports “better” limits.
...
Corresponds to [WebGPU `GPUSupportedLimits`](https://gpuweb.github.io/gpuweb/#gpusupportedlimits).

## Fields

`max_texture_dimension_1d: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

Maximum allowed value for the `size.width` of a texture created with `TextureDimension::D1`. Defaults to 8192. Higher is “better”.

`max_texture_dimension_2d: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
`max_texture_dimension_3d: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
`max_texture_array_layers: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
`max_bind_groups: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

Amount of bind groups that can be attached to a pipeline at the same time. Defaults to 4. Higher is “better”.

`max_bindings_per_bind_group: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

Maximum binding index allowed in `create_bind_group_layout`. Defaults to 1000. Higher is “better”.

`max_dynamic_uniform_buffers_per_pipeline_layout: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

Amount of uniform buffer bindings that can be dynamic in a single pipeline. Defaults to 8. Higher is “better”.

`max_dynamic_storage_buffers_per_pipeline_layout: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

Amount of storage buffer bindings that can be dynamic in a single pipeline. Defaults to 4. Higher is “better”.

`max_sampled_textures_per_shader_stage: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

Amount of sampled textures visible in a single shader stage. Defaults to 16. Higher is “better”.

`max_samplers_per_shader_stage: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

Amount of samplers visible in a single shader stage. Defaults to 16. Higher is “better”.

`max_storage_buffers_per_shader_stage: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

Amount of storage buffers visible in a single shader stage. Defaults to 8. Higher is “better”.

`max_storage_textures_per_shader_stage: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

Amount of storage textures visible in a single shader stage. Defaults to 4. Higher is “better”.

`max_uniform_buffers_per_shader_stage: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

Amount of uniform buffers visible in a single shader stage. Defaults to 12. Higher is “better”.

`max_binding_array_elements_per_shader_stage: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
`max_binding_array_acceleration_structure_elements_per_shader_stage: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
`max_binding_array_sampler_elements_per_shader_stage: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
`max_uniform_buffer_binding_size: [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)`

Maximum size in bytes of a binding to a uniform buffer. Defaults to 64 KiB. Higher is “better”.

`max_storage_buffer_binding_size: [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)`

Maximum size in bytes of a binding to a storage buffer. Defaults to 128 MiB. Higher is “better”.

`max_vertex_buffers: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

Maximum length of `VertexState::buffers` when creating a `RenderPipeline`. Defaults to 8. Higher is “better”.

`max_buffer_size: [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)`
...
`max_vertex_attributes: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
`max_vertex_buffer_array_stride: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

Maximum value for `VertexBufferLayout::array_stride` when creating a `RenderPipeline`. Defaults to 2048. Higher is “better”.

`max_inter_stage_shader_variables: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

Maximum value for the number of input or output variables for inter-stage communication (like vertex outputs or fragment inputs) `@location(…)`s (in WGSL parlance) when creating a `RenderPipeline`. Defaults to 16. Higher is “better”.

`min_uniform_buffer_offset_alignment: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
`min_storage_buffer_offset_alignment: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
`max_color_attachments: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

The maximum allowed number of color attachments.

`max_color_attachment_bytes_per_sample: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
`max_compute_workgroup_storage_size: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

Maximum number of bytes used for workgroup memory in a compute entry point. Defaults to 16384. Higher is “better”.

`max_compute_invocations_per_workgroup: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

Maximum value of the product of the `workgroup_size` dimensions for a compute entry-point. Defaults to 256. Higher is “better”.

`max_compute_workgroup_size_x: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
`max_compute_workgroup_size_y: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
`max_compute_workgroup_size_z: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
`max_compute_workgroups_per_dimension: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

The maximum value for each dimension of a `ComputePass::dispatch(x, y, z)` operation. Defaults to 65535. Higher is “better”.

`max_immediate_size: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

Amount of storage available for immediates in bytes. Defaults to 0. Higher is “better”. Requesting more than 0 during device creation requires \[`Features::IMMEDIATES`\] to be enabled.
...
*   DX12: 128 bytes
*   Metal: 4096 bytes
*   OpenGL doesn’t natively support immediates, and are emulated with uniforms, so this number is less useful but likely 256.

`max_non_sampler_bindings: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

Maximum number of live non-sampler bindings.

The default value is \*\*1\_000\_000\*\*, On systems with integrated GPUs (iGPUs)—particularly on Windows using the D3D12 backend—this can lead to significant system RAM consumption since iGPUs share system memory directly with the CPU.
...
`max_task_mesh_workgroup_total_count: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

The maximum total value for a `RenderPass::draw_mesh_tasks(x, y, z)` operation or the `@builtin(mesh_task_size)` returned from a task shader. Higher is “better”.

`max_task_mesh_workgroups_per_dimension: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

The maximum value for each dimension of a `RenderPass::draw_mesh_tasks(x, y, z)` operation. Also for task shader outputs. Higher is “better”.

`max_task_invocations_per_workgroup: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

Maximum total number of invocations, or threads, per task shader workgroup. Higher is “better”.

`max_task_invocations_per_dimension: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

The maximum value for each dimension of a task shader’s workgroup size. Higher is “better”.

`max_mesh_invocations_per_workgroup: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

Maximum total number of invocations, or threads, per mesh shader workgroup. Higher is “better”.

`max_mesh_invocations_per_dimension: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

The maximum value for each dimension of a mesh shader’s workgroup size. Higher is “better”.

`max_task_payload_size: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

The maximum size of the payload passed from task to mesh shader. Higher is “better”.

`max_mesh_output_vertices: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

The maximum number of vertices that a mesh shader may output. Higher is “better”.

`max_mesh_output_primitives: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

The maximum number of primitives that a mesh shader may output. Higher is “better”.

`max_mesh_output_layers: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

The maximum number of layers that can be output from a mesh shader. Higher is “better”. See [#8509](https://github.com/gfx-rs/wgpu/issues/8509).

`max_mesh_multiview_view_count: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

The maximum number of views that can be used by a mesh shader in multiview rendering. Higher is “better”.

`max_blas_primitive_count: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
`max_blas_geometry_count: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
`max_tlas_instance_count: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
`max_acceleration_structures_per_shader_stage: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
`max_multiview_view_count: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

The maximum number of views that can be used in multiview rendering

## Implementations

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#308)

### impl [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#373)

#### pub const fn [defaults](#method.defaults)() -> [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")

These default limits are guaranteed to to work on all modern backends and guaranteed to be supported by WebGPU
...
Rust doesn’t allow const in trait implementations, so we break this out to allow reusing these defaults in const contexts

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#495)

#### pub const fn [downlevel\_defaults](#method.downlevel_defaults)() -> [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")
...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#574)

#### pub const fn [downlevel\_webgl2\_defaults](#method.downlevel_webgl2_defaults)() -> [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")
...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#603)

#### pub const fn [using\_resolution](#method.using_resolution)(self, other: [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")) -> [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")
...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#616)

#### pub const fn [using\_alignment](#method.using_alignment)(self, other: [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")) -> [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")
...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#626)

#### pub const fn [using\_minimum\_supported\_acceleration\_structure\_values](#method.using_minimum_supported_acceleration_structure_values)( self, ) -> [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")

The minimum guaranteed limits for acceleration structures if you enable \[`Features::EXPERIMENTAL_RAY_QUERY`\]

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#639)

#### pub const fn [using\_acceleration\_structure\_values](#method.using_acceleration_structure_values)(self, other: [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")) -> [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")

Modify the current limits to use the acceleration structure limits of `other` (`other` could be the limits of the adapter).

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#655)

#### pub const fn [using\_recommended\_minimum\_mesh\_shader\_values](#method.using_recommended_minimum_mesh_shader_values)(self) -> [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")

The recommended minimum limits for mesh shaders if you enable \[`Features::EXPERIMENTAL_MESH_SHADER`\]

These are chosen somewhat arbitrarily. They are small enough that they should cover all physical devices, but not necessarily all use cases.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#687)

#### pub fn [check\_limits](#method.check_limits)(&self, allowed: &[Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Compares every limits within self is within the limits given in `allowed`.

If you need detailed information on failures, look at [`Limits::check_limits_with_fail_fn`](../render_resource/struct.WgpuLimits.html#method.check_limits_with_fail_fn "method bevy::render::render_resource::WgpuLimits::check_limits_with_fail_fn").

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#703-708)

#### pub fn [check\_limits\_with\_fail\_fn](#method.check_limits_with_fail_fn)( &self, allowed: &[Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits"), fatal: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), fail\_fn: impl [FnMut](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html "trait core::ops::function::FnMut")(&'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html), [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html), [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)), )

Compares every limits within self is within the limits given in `allowed`. For an easy to use binary choice, use [`Limits::check_limits`](../render_resource/struct.WgpuLimits.html#method.check_limits "method bevy::render::render_resource::WgpuLimits::check_limits").
...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#735)

#### pub fn [or\_better\_values\_from](#method.or_better_values_from)(self, other: &[Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")) -> [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")

For each limit in `other` that is better than the value in `self`, replace the value in `self` with the value from `other`.

A request for a limit value less than the WebGPU-specified default must be ignored. This function is used to clamp such requests to the default value.

This function is not for clamping requests for values beyond the supported limits. For that purpose the desired function would be `or_worse_values_from`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#759)

#### pub fn [or\_worse\_values\_from](#method.or_worse_values_from)(self, other: &[Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")) -> [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")

For each limit in `other` that is worse than the value in `self`, replace the value in `self` with the value from `other`.

This function is for clamping requests for values beyond the supported limits.

## Trait Implementations

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#120)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#120)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")
...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#302)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#303)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#121)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")

where [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits"): [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default"),

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#121)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#120)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/limits.rs.html#120)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")
