...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/settings.rs.html#39)
...
`device_label: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Cow](https://doc.rust-lang.org/nightly/alloc/borrow/enum.Cow.html "enum alloc::borrow::Cow")<'static, [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)>>``backends: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Backends](struct.Backends.html "struct bevy::render::settings::Backends")>``power_preference: [PowerPreference](enum.PowerPreference.html "enum bevy::render::settings::PowerPreference")``priority: [WgpuSettingsPriority](enum.WgpuSettingsPriority.html "enum bevy::render::settings::WgpuSettingsPriority")``features: [Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")`
...
`disabled_features: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Features](../render_resource/struct.WgpuFeatures.html "struct bevy::render::render_resource::WgpuFeatures")>`

The features to ensure are disabled regardless of what the adapter/backend supports

`limits: [Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")`

The imposed limits.

`constrained_limits: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Limits](../render_resource/struct.WgpuLimits.html "struct bevy::render::render_resource::WgpuLimits")>`

The constraints on limits allowed regardless of what the adapter/backend supports

`dx12_shader_compiler: [Dx12Compiler](enum.Dx12Compiler.html "enum bevy::render::settings::Dx12Compiler")`

The shader compiler to use for the DX12 backend.

`gles3_minor_version: [Gles3MinorVersion](enum.Gles3MinorVersion.html "enum bevy::render::settings::Gles3MinorVersion")`
...
`instance_flags: [InstanceFlags](struct.InstanceFlags.html "struct bevy::render::settings::InstanceFlags")`

These are for controlling WGPU’s debug information to eg. enable validation and shader debug info in release builds.

`memory_hints: [MemoryHints](enum.MemoryHints.html "enum bevy::render::settings::MemoryHints")`

This hints to the WGPU device about the preferred memory allocation strategy.

`instance_memory_budget_thresholds: [MemoryBudgetThresholds](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/instance/struct.MemoryBudgetThresholds.html "struct wgpu_types::instance::MemoryBudgetThresholds")`

The thresholds for device memory budget.

`force_fallback_adapter: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

If true, will force wgpu to use a software renderer, if available.

`adapter_name: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[String](../../prelude/struct.String.html "struct bevy::prelude::String")>`

The name of the adapter to use.

## Trait Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/settings.rs.html#38)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [WgpuSettings](struct.WgpuSettings.html "struct bevy::render::settings::WgpuSettings")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/settings.rs.html#38)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [WgpuSettings](struct.WgpuSettings.html "struct bevy::render::settings::WgpuSettings")
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/settings.rs.html#70)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [WgpuSettings](struct.WgpuSettings.html "struct bevy::render::settings::WgpuSettings")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/settings.rs.html#71)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [WgpuSettings](struct.WgpuSettings.html "struct bevy::render::settings::WgpuSettings")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/settings.rs.html#315)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[WgpuSettings](struct.WgpuSettings.html "struct bevy::render::settings::WgpuSettings")\> for [RenderCreation](enum.RenderCreation.html "enum bevy::render::settings::RenderCreation")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/settings.rs.html#316)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [WgpuSettings](struct.WgpuSettings.html "struct bevy::render::settings::WgpuSettings")) -> [RenderCreation](enum.RenderCreation.html "enum bevy::render::settings::RenderCreation")

Converts to this type from the input type.

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [WgpuSettings](struct.WgpuSettings.html "struct bevy::render::settings::WgpuSettings")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [WgpuSettings](struct.WgpuSettings.html "struct bevy::render::settings::WgpuSettings")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [WgpuSettings](struct.WgpuSettings.html "struct bevy::render::settings::WgpuSettings")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [WgpuSettings](struct.WgpuSettings.html "struct bevy::render::settings::WgpuSettings")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [WgpuSettings](struct.WgpuSettings.html "struct bevy::render::settings::WgpuSettings")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [WgpuSettings](struct.WgpuSettings.html "struct bevy::render::settings::WgpuSettings")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [WgpuSettings](struct.WgpuSettings.html "struct bevy::render::settings::WgpuSettings")
