...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)
...
### impl [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### pub const [NOOP](#associatedconstant.NOOP): [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[`Backend::Noop`](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/backend/enum.Backend.html#variant.Noop "variant wgpu_types::backend::Backend::Noop").

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### pub const [VULKAN](#associatedconstant.VULKAN): [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[`Backend::Vulkan`](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/backend/enum.Backend.html#variant.Vulkan "variant wgpu_types::backend::Backend::Vulkan"). Supported on Windows, Linux/Android, and macOS/iOS via Vulkan Portability (with the Vulkan feature enabled)

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### pub const [GL](#associatedconstant.GL): [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[`Backend::Gl`](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/backend/enum.Backend.html#variant.Gl "variant wgpu_types::backend::Backend::Gl"). Supported on Linux/Android, the web through webassembly via WebGL, and Windows and macOS/iOS via ANGLE

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### pub const [METAL](#associatedconstant.METAL): [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[`Backend::Metal`](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/backend/enum.Backend.html#variant.Metal "variant wgpu_types::backend::Backend::Metal"). Supported on macOS and iOS.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### pub const [DX12](#associatedconstant.DX12): [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[`Backend::Dx12`](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/backend/enum.Backend.html#variant.Dx12 "variant wgpu_types::backend::Backend::Dx12"). Supported on Windows 10 and later

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### pub const [BROWSER\_WEBGPU](#associatedconstant.BROWSER_WEBGPU): [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[`Backend::BrowserWebGpu`](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/backend/enum.Backend.html#variant.BrowserWebGpu "variant wgpu_types::backend::Backend::BrowserWebGpu"). Supported when targeting the web through WebAssembly with the `webgpu` feature enabled.

The WebGPU backend is special in several ways: It is not not implemented by `wgpu_core` and instead by the higher level `wgpu` crate. Whether WebGPU is targeted is decided upon the creation of the `wgpu::Instance`, _not_ upon adapter creation. See `wgpu::Instance::new`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### pub const [PRIMARY](#associatedconstant.PRIMARY): [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

All the apis that wgpu offers first tier of support for.

*   [`Backends::VULKAN`](struct.Backends.html#associatedconstant.VULKAN "associated constant bevy::render::settings::Backends::VULKAN")
*   [`Backends::METAL`](struct.Backends.html#associatedconstant.METAL "associated constant bevy::render::settings::Backends::METAL")
*   [`Backends::DX12`](struct.Backends.html#associatedconstant.DX12 "associated constant bevy::render::settings::Backends::DX12")
*   [`Backends::BROWSER_WEBGPU`](struct.Backends.html#associatedconstant.BROWSER_WEBGPU "associated constant bevy::render::settings::Backends::BROWSER_WEBGPU")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### pub const [SECONDARY](#associatedconstant.SECONDARY): [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

All the apis that wgpu offers second tier of support for. These may be unsupported/still experimental.

*   [`Backends::GL`](struct.Backends.html#associatedconstant.GL "associated constant bevy::render::settings::Backends::GL")
...
#### pub const fn [empty](#method.empty)() -> [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

Get a flags value with all bits unset.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### pub const fn [all](#method.all)() -> [Backends](struct.Backends.html "struct bevy::render::settings::Backends")
...
#### pub const fn [from\_bits](#method.from_bits)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Backends](struct.Backends.html "struct bevy::render::settings::Backends")\>
...
#### pub const fn [from\_bits\_truncate](#method.from_bits_truncate)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

Convert from a bits value, unsetting any unknown bits.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### pub const fn [from\_bits\_retain](#method.from_bits_retain)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

Convert from a bits value exactly.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### pub fn [from\_name](#method.from_name)(name: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Backends](struct.Backends.html "struct bevy::render::settings::Backends")\>
...
#### pub const fn [intersects](#method.intersects)(&self, other: [Backends](struct.Backends.html "struct bevy::render::settings::Backends")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Whether any set bits in `other` are also set in `self`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### pub const fn [contains](#method.contains)(&self, other: [Backends](struct.Backends.html "struct bevy::render::settings::Backends")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Whether all set bits in `other` are also set in `self`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### pub fn [insert](#method.insert)(&mut self, other: [Backends](struct.Backends.html "struct bevy::render::settings::Backends"))

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### pub fn [remove](#method.remove)(&mut self, other: [Backends](struct.Backends.html "struct bevy::render::settings::Backends"))
...
#### pub fn [toggle](#method.toggle)(&mut self, other: [Backends](struct.Backends.html "struct bevy::render::settings::Backends"))

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### pub fn [set](#method.set)(&mut self, other: [Backends](struct.Backends.html "struct bevy::render::settings::Backends"), value: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Call `insert` when `value` is `true` or `remove` when `value` is `false`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### pub const fn [intersection](#method.intersection)(self, other: [Backends](struct.Backends.html "struct bevy::render::settings::Backends")) -> [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

The bitwise and (`&`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### pub const fn [union](#method.union)(self, other: [Backends](struct.Backends.html "struct bevy::render::settings::Backends")) -> [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### pub const fn [difference](#method.difference)(self, other: [Backends](struct.Backends.html "struct bevy::render::settings::Backends")) -> [Backends](struct.Backends.html "struct bevy::render::settings::Backends")
...
#### pub const fn [symmetric\_difference](#method.symmetric_difference)(self, other: [Backends](struct.Backends.html "struct bevy::render::settings::Backends")) -> [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### pub const fn [complement](#method.complement)(self) -> [Backends](struct.Backends.html "struct bevy::render::settings::Backends")
...
#### pub const fn [iter](#method.iter)(&self) -> [Iter](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.Iter.html "struct bitflags::iter::Iter")<[Backends](struct.Backends.html "struct bevy::render::settings::Backends")\> [ⓘ](#)
...
#### pub const fn [iter\_names](#method.iter_names)(&self) -> [IterNames](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.IterNames.html "struct bitflags::iter::IterNames")<[Backends](struct.Backends.html "struct bevy::render::settings::Backends")\> [ⓘ](#)
...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#152)

### impl [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#156)

#### pub fn [from\_env](#method.from_env)() -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Backends](struct.Backends.html "struct bevy::render::settings::Backends")\>

Gets a set of backends from the environment variable `WGPU_BACKEND`.

See [`Self::from_comma_list()`](struct.Backends.html#method.from_comma_list "associated function bevy::render::settings::Backends::from_comma_list") for the format of the string.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#162)

#### pub fn [with\_env](#method.with_env)(&self) -> [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

Takes the given options, modifies them based on the `WGPU_BACKEND` environment variable, and returns the result.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#182)

#### pub fn [from\_comma\_list](#method.from_comma_list)(string: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [Backends](struct.Backends.html "struct bevy::render::settings::Backends")
...
### impl [Binary](https://doc.rust-lang.org/nightly/core/fmt/trait.Binary.html "trait core::fmt::Binary") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")
...
### impl [BitAnd](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html "trait core::ops::bit::BitAnd") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### fn [bitand](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html#tymethod.bitand)(self, other: [Backends](struct.Backends.html "struct bevy::render::settings::Backends")) -> [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

The bitwise and (`&`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html#associatedtype.Output) = [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

The resulting type after applying the `&` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

### impl [BitAndAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAndAssign.html "trait core::ops::bit::BitAndAssign") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### fn [bitand\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAndAssign.html#tymethod.bitand_assign)(&mut self, other: [Backends](struct.Backends.html "struct bevy::render::settings::Backends"))

The bitwise and (`&`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

### impl [BitOr](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html "trait core::ops::bit::BitOr") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### fn [bitor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html#tymethod.bitor)(self, other: [Backends](struct.Backends.html "struct bevy::render::settings::Backends")) -> [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html#associatedtype.Output) = [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

The resulting type after applying the `|` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

### impl [BitOrAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOrAssign.html "trait core::ops::bit::BitOrAssign") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### fn [bitor\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOrAssign.html#tymethod.bitor_assign)(&mut self, other: [Backends](struct.Backends.html "struct bevy::render::settings::Backends"))

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

### impl [BitXor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html "trait core::ops::bit::BitXor") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### fn [bitxor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html#tymethod.bitxor)(self, other: [Backends](struct.Backends.html "struct bevy::render::settings::Backends")) -> [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html#associatedtype.Output) = [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

The resulting type after applying the `^` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

### impl [BitXorAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXorAssign.html "trait core::ops::bit::BitXorAssign") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### fn [bitxor\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXorAssign.html#tymethod.bitxor_assign)(&mut self, other: [Backends](struct.Backends.html "struct bevy::render::settings::Backends"))

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#90)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#90)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Backends](struct.Backends.html "struct bevy::render::settings::Backends")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#90)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")
...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#140)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#141)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#88)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#88)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Backends](struct.Backends.html "struct bevy::render::settings::Backends"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

### impl [Extend](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.Extend.html "trait core::iter::traits::collect::Extend")<[Backends](struct.Backends.html "struct bevy::render::settings::Backends")\> for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")
...
where T: [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [Backends](struct.Backends.html "struct bevy::render::settings::Backends")\>,
...
### impl [Flags](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html "trait bitflags::traits::Flags") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### const [FLAGS](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#associatedconstant.FLAGS): &'static \[[Flag](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/struct.Flag.html "struct bitflags::traits::Flag")<[Backends](struct.Backends.html "struct bevy::render::settings::Backends")\>\]
...
#### fn [from\_bits\_retain](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#tymethod.from_bits_retain)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

Convert from a bits value exactly.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### fn [all\_named](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#method.all_named)() -> [Backends](struct.Backends.html "struct bevy::render::settings::Backends")
...
[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#146)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Backend](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/backend/enum.Backend.html "enum wgpu_types::backend::Backend")\> for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#147)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(backend: [Backend](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/wgpu_types/backend/enum.Backend.html "enum wgpu_types::backend::Backend")) -> [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

Converts to this type from the input type.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

### impl [FromIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html "trait core::iter::traits::collect::FromIterator")<[Backends](struct.Backends.html "struct bevy::render::settings::Backends")\> for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### fn [from\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html#tymethod.from_iter)<T>(iterator: T) -> [Backends](struct.Backends.html "struct bevy::render::settings::Backends")
...
### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")
...
### impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### type [Item](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.Item) = [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

The type of the elements being iterated over.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### type [IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter) = [Iter](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.Iter.html "struct bitflags::iter::Iter")<[Backends](struct.Backends.html "struct bevy::render::settings::Backends")\>

Which kind of iterator are we turning this into?

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### fn [into\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)(self) -> <[Backends](struct.Backends.html "struct bevy::render::settings::Backends") as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter "type core::iter::traits::collect::IntoIterator::IntoIter")

Creates an iterator from a value. [Read more](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

### impl [LowerHex](https://doc.rust-lang.org/nightly/core/fmt/trait.LowerHex.html "trait core::fmt::LowerHex") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")
...
### impl [Not](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html "trait core::ops::bit::Not") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### fn [not](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html#tymethod.not)(self) -> [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

The bitwise negation (`!`) of the bits in `self`, truncating the result.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html#associatedtype.Output) = [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

The resulting type after applying the `!` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

### impl [Octal](https://doc.rust-lang.org/nightly/core/fmt/trait.Octal.html "trait core::fmt::Octal") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#90)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Backends](struct.Backends.html "struct bevy::render::settings::Backends")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

### impl [Sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html "trait core::ops::arith::Sub") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### fn [sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#tymethod.sub)(self, other: [Backends](struct.Backends.html "struct bevy::render::settings::Backends")) -> [Backends](struct.Backends.html "struct bevy::render::settings::Backends")
...
#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#associatedtype.Output) = [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

The resulting type after applying the `-` operator.

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

### impl [SubAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html "trait core::ops::arith::SubAssign") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

[Source](https://docs.rs/wgpu-types/29.0.3/x86_64-unknown-linux-gnu/src/wgpu_types/backend.rs.html#85-138)

#### fn [sub\_assign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html#tymethod.sub_assign)(&mut self, other: [Backends](struct.Backends.html "struct bevy::render::settings::Backends"))
...
### impl [UpperHex](https://doc.rust-lang.org/nightly/core/fmt/trait.UpperHex.html "trait core::fmt::UpperHex") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Backends](struct.Backends.html "struct bevy::render::settings::Backends")
