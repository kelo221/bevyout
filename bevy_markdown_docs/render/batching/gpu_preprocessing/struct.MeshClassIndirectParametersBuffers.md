...
# Struct MeshClassIndirectParametersBuffers 

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/batching/gpu_preprocessing.rs.html#1185)

```rust
pub struct MeshClassIndirectParametersBuffers<IP>where
    IP: Clone + ShaderSize + WriteInto,{ /* private fields */ }
```
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/batching/gpu_preprocessing.rs.html#1221-1223)

### impl<IP> [MeshClassIndirectParametersBuffers](struct.MeshClassIndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::MeshClassIndirectParametersBuffers")<IP>

where IP: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") + [ShaderSize](../../render_resource/trait.ShaderSize.html "trait bevy::render::render_resource::ShaderSize") + [WriteInto](../../render_resource/encase/internal/trait.WriteInto.html "trait bevy::render::render_resource::encase::internal::WriteInto"),

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/batching/gpu_preprocessing.rs.html#1248)

#### pub fn [data\_buffer](#method.data_buffer)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[Buffer](../../render_resource/struct.Buffer.html "struct bevy::render::render_resource::Buffer")\>

Returns the GPU buffer that stores the indirect draw parameters for indexed meshes.

The indirect parameters building shader writes to this buffer, while the `multi_draw_indirect` or `multi_draw_indirect_count` commands read from it to perform the draws.

##### [Examples found in repository](#scraped-examples)[?](../../../../scrape-examples-help.html)

examples/3d/occlusion\_culling.rs ([line 411](../../../../src/occlusion_culling/occlusion_culling.rs.html#411))
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/batching/gpu_preprocessing.rs.html#1258)

#### pub fn [cpu\_metadata\_buffer](#method.cpu_metadata_buffer)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[Buffer](../../render_resource/struct.Buffer.html "struct bevy::render::render_resource::Buffer")\>
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/batching/gpu_preprocessing.rs.html#1269)

#### pub fn [gpu\_metadata\_buffer](#method.gpu_metadata_buffer)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[Buffer](../../render_resource/struct.Buffer.html "struct bevy::render::render_resource::Buffer")\>
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/batching/gpu_preprocessing.rs.html#1280)

#### pub fn [batch\_sets\_buffer](#method.batch_sets_buffer)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[Buffer](../../render_resource/struct.Buffer.html "struct bevy::render::render_resource::Buffer")\>

Returns the GPU buffer that holds the number of indirect draw commands for each phase of each view.

The indirect parameters building shader writes to this buffer, and the `multi_draw_indirect_count` command reads from it in order to know how many indirect draw commands to process.

##### [Examples found in repository](#scraped-examples-1)[?](../../../../scrape-examples-help.html)

examples/3d/occlusion\_culling.rs ([line 414](../../../../src/occlusion_culling/occlusion_culling.rs.html#414))
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/batching/gpu_preprocessing.rs.html#1302)

#### pub fn [set](#method.set)(&mut self, index: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html), value: [IndirectParametersCpuMetadata](struct.IndirectParametersCpuMetadata.html "struct bevy::render::batching::gpu_preprocessing::IndirectParametersCpuMetadata"))

Sets the [`IndirectParametersCpuMetadata`](struct.IndirectParametersCpuMetadata.html "struct bevy::render::batching::gpu_preprocessing::IndirectParametersCpuMetadata") for the mesh at the given index.

##### [Examples found in repository](#scraped-examples-2)[?](../../../../scrape-examples-help.html)

examples/shader\_advanced/custom\_render\_phase.rs ([line 481](../../../../src/custom_render_phase/custom_render_phase.rs.html#481))
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/batching/gpu_preprocessing.rs.html#1309)

#### pub fn [batch\_count](#method.batch_count)(&self) -> [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)

Returns the number of batches corresponding to meshes that are currently allocated.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/batching/gpu_preprocessing.rs.html#1314)
...
### impl<IP> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MeshClassIndirectParametersBuffers](struct.MeshClassIndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::MeshClassIndirectParametersBuffers")<IP>

### impl<IP> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MeshClassIndirectParametersBuffers](struct.MeshClassIndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::MeshClassIndirectParametersBuffers")<IP>

### impl<IP> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MeshClassIndirectParametersBuffers](struct.MeshClassIndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::MeshClassIndirectParametersBuffers")<IP>

### impl<IP> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MeshClassIndirectParametersBuffers](struct.MeshClassIndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::MeshClassIndirectParametersBuffers")<IP>

where IP: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<IP> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MeshClassIndirectParametersBuffers](struct.MeshClassIndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::MeshClassIndirectParametersBuffers")<IP>

where IP: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<IP> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MeshClassIndirectParametersBuffers](struct.MeshClassIndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::MeshClassIndirectParametersBuffers")<IP>

where IP: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<IP> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MeshClassIndirectParametersBuffers](struct.MeshClassIndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::MeshClassIndirectParametersBuffers")<IP>
