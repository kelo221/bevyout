...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/batching/gpu_preprocessing.rs.html#908)

```rust
pub struct IndirectParametersBuffers {
    pub buffers: IndexMap<TypeId, UntypedPhaseIndirectParametersBuffers, NoOpHash>,
}
```
...
In addition to the indirect draw buffers themselves, this structure contains the buffers that store [`IndirectParametersGpuMetadata`](struct.IndirectParametersGpuMetadata.html "struct bevy::render::batching::gpu_preprocessing::IndirectParametersGpuMetadata"), which are the structures that culling writes to so that the indirect parameter building pass can determine how many meshes are actually to be drawn.

These buffers will remain empty if indirect drawing isn’t in use.

## Fields

`buffers: [IndexMap](https://docs.rs/indexmap/2.14.0/x86_64-unknown-linux-gnu/indexmap/map/struct.IndexMap.html "struct indexmap::map::IndexMap")<[TypeId](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId"), [UntypedPhaseIndirectParametersBuffers](struct.UntypedPhaseIndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::UntypedPhaseIndirectParametersBuffers"), [NoOpHash](../../../platform/hash/struct.NoOpHash.html "struct bevy::platform::hash::NoOpHash")>`

A mapping from a phase type ID to the indirect parameters buffers for that phase.
...
#### pub fn [iter](#method.iter)(&self) -> [Iter](https://docs.rs/indexmap/2.14.0/x86_64-unknown-linux-gnu/indexmap/map/iter/struct.Iter.html "struct indexmap::map::iter::Iter")<'\_, K, V> [ⓘ](#)

Return an iterator over the key-value pairs of the map, in their order

[Source](https://docs.rs/indexmap/2.14.0/x86_64-unknown-linux-gnu/src/indexmap/map.rs.html#246)

#### pub fn [iter\_mut](#method.iter_mut)(&mut self) -> [IterMut](https://docs.rs/indexmap/2.14.0/x86_64-unknown-linux-gnu/indexmap/map/iter/struct.IterMut.html "struct indexmap::map::iter::IterMut")<'\_, K, V> [ⓘ](#)

Return an iterator over the key-value pairs of the map, in their order

[Source](https://docs.rs/indexmap/2.14.0/x86_64-unknown-linux-gnu/src/indexmap/map.rs.html#251)

#### pub fn [keys](#method.keys)(&self) -> [Keys](https://docs.rs/indexmap/2.14.0/x86_64-unknown-linux-gnu/indexmap/map/iter/struct.Keys.html "struct indexmap::map::iter::Keys")<'\_, K, V> [ⓘ](#)
...
#### pub fn [drain](#method.drain)<R>(&mut self, range: R) -> [Drain](https://docs.rs/indexmap/2.14.0/x86_64-unknown-linux-gnu/indexmap/map/iter/struct.Drain.html "struct indexmap::map::iter::Drain")<'\_, K, V> [ⓘ](#)
...
#### pub fn [as\_slice](#method.as_slice)(&self) -> &[Slice](https://docs.rs/indexmap/2.14.0/x86_64-unknown-linux-gnu/indexmap/map/slice/struct.Slice.html "struct indexmap::map::slice::Slice")<K, V>
...
#### pub fn [as\_mut\_slice](#method.as_mut_slice)(&mut self) -> &mut [Slice](https://docs.rs/indexmap/2.14.0/x86_64-unknown-linux-gnu/indexmap/map/slice/struct.Slice.html "struct indexmap::map::slice::Slice")<K, V>
...
#### pub fn [get\_range](#method.get_range)<R>(&self, range: R) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[Slice](https://docs.rs/indexmap/2.14.0/x86_64-unknown-linux-gnu/indexmap/map/slice/struct.Slice.html "struct indexmap::map::slice::Slice")<K, V>>
...
#### pub fn [get\_range\_mut](#method.get_range_mut)<R>(&mut self, range: R) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&mut [Slice](https://docs.rs/indexmap/2.14.0/x86_64-unknown-linux-gnu/indexmap/map/slice/struct.Slice.html "struct indexmap::map::slice::Slice")<K, V>>
...
### impl [Component](../../../prelude/trait.Component.html "trait bevy::prelude::Component") for [IndirectParametersBuffers](struct.IndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::IndirectParametersBuffers")

where [IndirectParametersBuffers](struct.IndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::IndirectParametersBuffers"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [IndirectParametersBuffers](struct.IndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::IndirectParametersBuffers")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/batching/gpu_preprocessing.rs.html#907)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [IndirectParametersBuffers](struct.IndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::IndirectParametersBuffers")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/batching/gpu_preprocessing.rs.html#907)

### impl [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [IndirectParametersBuffers](struct.IndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::IndirectParametersBuffers")
...
#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[IndirectParametersBuffers](struct.IndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::IndirectParametersBuffers") as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/batching/gpu_preprocessing.rs.html#907)

### impl [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [IndirectParametersBuffers](struct.IndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::IndirectParametersBuffers")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/batching/gpu_preprocessing.rs.html#907)

#### fn [deref\_mut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html#tymethod.deref_mut)(&mut self) -> &mut <[IndirectParametersBuffers](struct.IndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::IndirectParametersBuffers") as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Mutably dereferences the value.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/batching/gpu_preprocessing.rs.html#907)

### impl [Resource](../../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [IndirectParametersBuffers](struct.IndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::IndirectParametersBuffers")

where [IndirectParametersBuffers](struct.IndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::IndirectParametersBuffers"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [IndirectParametersBuffers](struct.IndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::IndirectParametersBuffers")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [IndirectParametersBuffers](struct.IndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::IndirectParametersBuffers")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [IndirectParametersBuffers](struct.IndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::IndirectParametersBuffers")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [IndirectParametersBuffers](struct.IndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::IndirectParametersBuffers")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [IndirectParametersBuffers](struct.IndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::IndirectParametersBuffers")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [IndirectParametersBuffers](struct.IndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::IndirectParametersBuffers")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [IndirectParametersBuffers](struct.IndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::IndirectParametersBuffers")
