...
# Enum MissingRenderTargetInfoError 

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/camera.rs.html#328)
...
`image: [AssetId](../../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[Image](../../prelude/struct.Image.html "struct bevy::prelude::Image")>`

### TextureView

#### Fields

`texture_view: [ManualTextureViewHandle](../../camera/struct.ManualTextureViewHandle.html "struct bevy::camera::ManualTextureViewHandle")`

## Trait Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/camera.rs.html#327)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [MissingRenderTargetInfoError](enum.MissingRenderTargetInfoError.html "enum bevy::render::camera::MissingRenderTargetInfoError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [MissingRenderTargetInfoError](enum.MissingRenderTargetInfoError.html "enum bevy::render::camera::MissingRenderTargetInfoError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [MissingRenderTargetInfoError](enum.MissingRenderTargetInfoError.html "enum bevy::render::camera::MissingRenderTargetInfoError")
...
### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MissingRenderTargetInfoError](enum.MissingRenderTargetInfoError.html "enum bevy::render::camera::MissingRenderTargetInfoError")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MissingRenderTargetInfoError](enum.MissingRenderTargetInfoError.html "enum bevy::render::camera::MissingRenderTargetInfoError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MissingRenderTargetInfoError](enum.MissingRenderTargetInfoError.html "enum bevy::render::camera::MissingRenderTargetInfoError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MissingRenderTargetInfoError](enum.MissingRenderTargetInfoError.html "enum bevy::render::camera::MissingRenderTargetInfoError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MissingRenderTargetInfoError](enum.MissingRenderTargetInfoError.html "enum bevy::render::camera::MissingRenderTargetInfoError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MissingRenderTargetInfoError](enum.MissingRenderTargetInfoError.html "enum bevy::render::camera::MissingRenderTargetInfoError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MissingRenderTargetInfoError](enum.MissingRenderTargetInfoError.html "enum bevy::render::camera::MissingRenderTargetInfoError")
