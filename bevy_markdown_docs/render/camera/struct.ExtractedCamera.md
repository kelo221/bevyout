...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/camera.rs.html#455)
...
Every `ExtractedCamera` also has an [`ExtractedView`](../view/struct.ExtractedView.html "struct bevy::render::view::ExtractedView"), but not every view comes from a camera. For example, views can come from lights, for drawing shadow maps.

## Fields

`target: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[NormalizedRenderTarget](../../camera/enum.NormalizedRenderTarget.html "enum bevy::camera::NormalizedRenderTarget")>``physical_viewport_size: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[UVec2](../../prelude/struct.UVec2.html "struct bevy::prelude::UVec2")>``physical_target_size: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[UVec2](../../prelude/struct.UVec2.html "struct bevy::prelude::UVec2")>``viewport: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Viewport](../../camera/struct.Viewport.html "struct bevy::camera::Viewport")>``schedule: [Interned](../../ecs/intern/struct.Interned.html "struct bevy::ecs::intern::Interned")<dyn [ScheduleLabel](../../ecs/schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")>``order: [isize](https://doc.rust-lang.org/nightly/std/primitive.isize.html)``output_mode: [CameraOutputMode](../../camera/enum.CameraOutputMode.html "enum bevy::camera::CameraOutputMode")``msaa_writeback: [MsaaWriteback](../../prelude/enum.MsaaWriteback.html "enum bevy::prelude::MsaaWriteback")``clear_color: [ClearColorConfig](../../prelude/enum.ClearColorConfig.html "enum bevy::prelude::ClearColorConfig")``sorted_camera_index_for_target: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)``exposure: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)``hdr: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)``compositing_space: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[CompositingSpace](../../prelude/enum.CompositingSpace.html "enum bevy::prelude::CompositingSpace")>`

When [`CompositingSpace::Srgb`](../../prelude/enum.CompositingSpace.html#variant.Srgb "variant bevy::prelude::CompositingSpace::Srgb"), the main texture uses linear storage (`Rgba8Unorm`) and shaders output sRGB-encoded values for gamma-encoded blending.

## Trait Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/camera.rs.html#453)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [ExtractedCamera](struct.ExtractedCamera.html "struct bevy::render::camera::ExtractedCamera")

where [ExtractedCamera](struct.ExtractedCamera.html "struct bevy::render::camera::ExtractedCamera"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

**Required Components**: [`RenderVisibleEntities`](../view/struct.RenderVisibleEntities.html "struct bevy::render::view::RenderVisibleEntities").
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ExtractedCamera](struct.ExtractedCamera.html "struct bevy::render::camera::ExtractedCamera")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ExtractedCamera](struct.ExtractedCamera.html "struct bevy::render::camera::ExtractedCamera")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ExtractedCamera](struct.ExtractedCamera.html "struct bevy::render::camera::ExtractedCamera")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ExtractedCamera](struct.ExtractedCamera.html "struct bevy::render::camera::ExtractedCamera")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ExtractedCamera](struct.ExtractedCamera.html "struct bevy::render::camera::ExtractedCamera")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ExtractedCamera](struct.ExtractedCamera.html "struct bevy::render::camera::ExtractedCamera")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ExtractedCamera](struct.ExtractedCamera.html "struct bevy::render::camera::ExtractedCamera")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ExtractedCamera](struct.ExtractedCamera.html "struct bevy::render::camera::ExtractedCamera")
