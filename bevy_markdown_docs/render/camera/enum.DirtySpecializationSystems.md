...
# Enum DirtySpecializationSystems 

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/camera.rs.html#1087)
...
Systems that clear out [`DirtySpecializations`](struct.DirtySpecializations.html "struct bevy::render::camera::DirtySpecializations") types in preparation for a new frame.

### CheckForChanges

Systems that add entities that need to be re-specialized to [`DirtySpecializations`](struct.DirtySpecializations.html "struct bevy::render::camera::DirtySpecializations").

### CheckForRemovals

Systems that determine which entities need to be removed from render phases and write the results to [`DirtySpecializations`](struct.DirtySpecializations.html "struct bevy::render::camera::DirtySpecializations").

The set of entities that need to be removed from the render phases can only be determined after all systems in [`DirtySpecializationSystems::CheckForChanges`](enum.DirtySpecializationSystems.html#variant.CheckForChanges "variant bevy::render::camera::DirtySpecializationSystems::CheckForChanges") have run. That’s because these systems check `RemovedComponents` resources, and they have to be able to distinguish between the case in which an entity was truly made unrenderable and the case in which an entity appeared in a `RemovedComponents` table simply because its material _type_ changed.

## Trait Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/camera.rs.html#1086)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [DirtySpecializationSystems](enum.DirtySpecializationSystems.html "enum bevy::render::camera::DirtySpecializationSystems")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/camera.rs.html#1086)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [DirtySpecializationSystems](enum.DirtySpecializationSystems.html "enum bevy::render::camera::DirtySpecializationSystems")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [DirtySpecializationSystems](enum.DirtySpecializationSystems.html "enum bevy::render::camera::DirtySpecializationSystems")
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [DirtySpecializationSystems](enum.DirtySpecializationSystems.html "enum bevy::render::camera::DirtySpecializationSystems")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/camera.rs.html#1086)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [DirtySpecializationSystems](enum.DirtySpecializationSystems.html "enum bevy::render::camera::DirtySpecializationSystems")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [DirtySpecializationSystems](enum.DirtySpecializationSystems.html "enum bevy::render::camera::DirtySpecializationSystems")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/camera.rs.html#1086)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[DirtySpecializationSystems](enum.DirtySpecializationSystems.html "enum bevy::render::camera::DirtySpecializationSystems")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [DirtySpecializationSystems](enum.DirtySpecializationSystems.html "enum bevy::render::camera::DirtySpecializationSystems")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/camera.rs.html#1086)

### impl [SystemSet](../../prelude/trait.SystemSet.html "trait bevy::prelude::SystemSet") for [DirtySpecializationSystems](enum.DirtySpecializationSystems.html "enum bevy::render::camera::DirtySpecializationSystems")

where [DirtySpecializationSystems](enum.DirtySpecializationSystems.html "enum bevy::render::camera::DirtySpecializationSystems"): 'static + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") + [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") + [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") + [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash"),
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DirtySpecializationSystems](enum.DirtySpecializationSystems.html "enum bevy::render::camera::DirtySpecializationSystems")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DirtySpecializationSystems](enum.DirtySpecializationSystems.html "enum bevy::render::camera::DirtySpecializationSystems")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DirtySpecializationSystems](enum.DirtySpecializationSystems.html "enum bevy::render::camera::DirtySpecializationSystems")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DirtySpecializationSystems](enum.DirtySpecializationSystems.html "enum bevy::render::camera::DirtySpecializationSystems")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DirtySpecializationSystems](enum.DirtySpecializationSystems.html "enum bevy::render::camera::DirtySpecializationSystems")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DirtySpecializationSystems](enum.DirtySpecializationSystems.html "enum bevy::render::camera::DirtySpecializationSystems")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DirtySpecializationSystems](enum.DirtySpecializationSystems.html "enum bevy::render::camera::DirtySpecializationSystems")
