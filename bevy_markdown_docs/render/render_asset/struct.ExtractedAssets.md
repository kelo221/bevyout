...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_asset.rs.html#175)

```rust
pub struct ExtractedAssets<A>where
    A: RenderAsset,{
    pub extracted: Vec<(AssetId<<A as RenderAsset>::SourceAsset>, <A as RenderAsset>::SourceAsset)>,
    pub removed: HashSet<AssetId<<A as RenderAsset>::SourceAsset>>,
    pub modified: HashSet<AssetId<<A as RenderAsset>::SourceAsset>>,
    pub added: HashSet<AssetId<<A as RenderAsset>::SourceAsset>>,
}
```
...
`extracted: [Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<([AssetId](../../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<<A as [RenderAsset](trait.RenderAsset.html "trait bevy::render::render_asset::RenderAsset")>::[SourceAsset](trait.RenderAsset.html#associatedtype.SourceAsset "type bevy::render::render_asset::RenderAsset::SourceAsset")>, <A as [RenderAsset](trait.RenderAsset.html "trait bevy::render::render_asset::RenderAsset")>::[SourceAsset](trait.RenderAsset.html#associatedtype.SourceAsset "type bevy::render::render_asset::RenderAsset::SourceAsset"))>`

The assets extracted this frame.

These are assets that were either added or modified this frame.

`removed: [HashSet](../../platform/collections/struct.HashSet.html "struct bevy::platform::collections::HashSet")<[AssetId](../../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<<A as [RenderAsset](trait.RenderAsset.html "trait bevy::render::render_asset::RenderAsset")>::[SourceAsset](trait.RenderAsset.html#associatedtype.SourceAsset "type bevy::render::render_asset::RenderAsset::SourceAsset")>>`

IDs of the assets that were removed this frame.

These assets will not be present in [`ExtractedAssets::extracted`](struct.ExtractedAssets.html#structfield.extracted "field bevy::render::render_asset::ExtractedAssets::extracted").

`modified: [HashSet](../../platform/collections/struct.HashSet.html "struct bevy::platform::collections::HashSet")<[AssetId](../../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<<A as [RenderAsset](trait.RenderAsset.html "trait bevy::render::render_asset::RenderAsset")>::[SourceAsset](trait.RenderAsset.html#associatedtype.SourceAsset "type bevy::render::render_asset::RenderAsset::SourceAsset")>>`

IDs of the assets that were modified this frame.

`added: [HashSet](../../platform/collections/struct.HashSet.html "struct bevy::platform::collections::HashSet")<[AssetId](../../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<<A as [RenderAsset](trait.RenderAsset.html "trait bevy::render::render_asset::RenderAsset")>::[SourceAsset](trait.RenderAsset.html#associatedtype.SourceAsset "type bevy::render::render_asset::RenderAsset::SourceAsset")>>`
...
### impl<A> [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [ExtractedAssets](struct.ExtractedAssets.html "struct bevy::render::render_asset::ExtractedAssets")<A>

where A: [RenderAsset](trait.RenderAsset.html "trait bevy::render::render_asset::RenderAsset"), [ExtractedAssets](struct.ExtractedAssets.html "struct bevy::render::render_asset::ExtractedAssets")<A>: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_asset.rs.html#193)

### impl<A> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [ExtractedAssets](struct.ExtractedAssets.html "struct bevy::render::render_asset::ExtractedAssets")<A>

where A: [RenderAsset](trait.RenderAsset.html "trait bevy::render::render_asset::RenderAsset"),

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_asset.rs.html#194)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [ExtractedAssets](struct.ExtractedAssets.html "struct bevy::render::render_asset::ExtractedAssets")<A>

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_asset.rs.html#174)

### impl<A> [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [ExtractedAssets](struct.ExtractedAssets.html "struct bevy::render::render_asset::ExtractedAssets")<A>

where A: [RenderAsset](trait.RenderAsset.html "trait bevy::render::render_asset::RenderAsset"), [ExtractedAssets](struct.ExtractedAssets.html "struct bevy::render::render_asset::ExtractedAssets")<A>: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl<A> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ExtractedAssets](struct.ExtractedAssets.html "struct bevy::render::render_asset::ExtractedAssets")<A>

### impl<A> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ExtractedAssets](struct.ExtractedAssets.html "struct bevy::render::render_asset::ExtractedAssets")<A>

where <A as [RenderAsset](trait.RenderAsset.html "trait bevy::render::render_asset::RenderAsset")\>::[SourceAsset](trait.RenderAsset.html#associatedtype.SourceAsset "type bevy::render::render_asset::RenderAsset::SourceAsset"): [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"),

### impl<A> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ExtractedAssets](struct.ExtractedAssets.html "struct bevy::render::render_asset::ExtractedAssets")<A>

### impl<A> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ExtractedAssets](struct.ExtractedAssets.html "struct bevy::render::render_asset::ExtractedAssets")<A>

### impl<A> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ExtractedAssets](struct.ExtractedAssets.html "struct bevy::render::render_asset::ExtractedAssets")<A>

where <A as [RenderAsset](trait.RenderAsset.html "trait bevy::render::render_asset::RenderAsset")\>::[SourceAsset](trait.RenderAsset.html#associatedtype.SourceAsset "type bevy::render::render_asset::RenderAsset::SourceAsset"): [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<A> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ExtractedAssets](struct.ExtractedAssets.html "struct bevy::render::render_asset::ExtractedAssets")<A>

### impl<A> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ExtractedAssets](struct.ExtractedAssets.html "struct bevy::render::render_asset::ExtractedAssets")<A>

where <A as [RenderAsset](trait.RenderAsset.html "trait bevy::render::render_asset::RenderAsset")\>::[SourceAsset](trait.RenderAsset.html#associatedtype.SourceAsset "type bevy::render::render_asset::RenderAsset::SourceAsset"): [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"),
