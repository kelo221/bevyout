...
# Enum AssetExtractionError 

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_asset.rs.html#33)
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_asset.rs.html#32)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [AssetExtractionError](enum.AssetExtractionError.html "enum bevy::render::render_asset::AssetExtractionError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [AssetExtractionError](enum.AssetExtractionError.html "enum bevy::render::render_asset::AssetExtractionError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [AssetExtractionError](enum.AssetExtractionError.html "enum bevy::render::render_asset::AssetExtractionError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AssetExtractionError](enum.AssetExtractionError.html "enum bevy::render::render_asset::AssetExtractionError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AssetExtractionError](enum.AssetExtractionError.html "enum bevy::render::render_asset::AssetExtractionError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AssetExtractionError](enum.AssetExtractionError.html "enum bevy::render::render_asset::AssetExtractionError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AssetExtractionError](enum.AssetExtractionError.html "enum bevy::render::render_asset::AssetExtractionError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AssetExtractionError](enum.AssetExtractionError.html "enum bevy::render::render_asset::AssetExtractionError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AssetExtractionError](enum.AssetExtractionError.html "enum bevy::render::render_asset::AssetExtractionError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AssetExtractionError](enum.AssetExtractionError.html "enum bevy::render::render_asset::AssetExtractionError")
