...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/extract_plugin.rs.html#16)
...
`pre_extract: [fn](https://doc.rust-lang.org/nightly/std/primitive.fn.html)(&mut [World](../../prelude/struct.World.html "struct bevy::prelude::World"), &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World"))`
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/extract_plugin.rs.html#23)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [ExtractPlugin](struct.ExtractPlugin.html "struct bevy::render::extract_plugin::ExtractPlugin")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/extract_plugin.rs.html#24)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [ExtractPlugin](struct.ExtractPlugin.html "struct bevy::render::extract_plugin::ExtractPlugin")
...
### impl [Plugin](../../prelude/trait.Plugin.html "trait bevy::prelude::Plugin") for [ExtractPlugin](struct.ExtractPlugin.html "struct bevy::render::extract_plugin::ExtractPlugin")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/extract_plugin.rs.html#32)
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ExtractPlugin](struct.ExtractPlugin.html "struct bevy::render::extract_plugin::ExtractPlugin")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ExtractPlugin](struct.ExtractPlugin.html "struct bevy::render::extract_plugin::ExtractPlugin")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ExtractPlugin](struct.ExtractPlugin.html "struct bevy::render::extract_plugin::ExtractPlugin")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ExtractPlugin](struct.ExtractPlugin.html "struct bevy::render::extract_plugin::ExtractPlugin")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ExtractPlugin](struct.ExtractPlugin.html "struct bevy::render::extract_plugin::ExtractPlugin")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ExtractPlugin](struct.ExtractPlugin.html "struct bevy::render::extract_plugin::ExtractPlugin")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ExtractPlugin](struct.ExtractPlugin.html "struct bevy::render::extract_plugin::ExtractPlugin")
