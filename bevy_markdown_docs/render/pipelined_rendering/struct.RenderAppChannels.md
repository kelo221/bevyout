[bevy](../../index.html)::[render](../index.html)::[pipelined\_rendering](index.html)

# Struct RenderAppChannels 

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/pipelined_rendering.rs.html#22)

```rust
pub struct RenderAppChannels { /* private fields */ }
```
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/pipelined_rendering.rs.html#28)

### impl [RenderAppChannels](struct.RenderAppChannels.html "struct bevy::render::pipelined_rendering::RenderAppChannels")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/pipelined_rendering.rs.html#30-33)

#### pub fn [new](#method.new)( app\_to\_render\_sender: [Sender](https://docs.rs/async-channel/2.5.0/x86_64-unknown-linux-gnu/async_channel/struct.Sender.html "struct async_channel::Sender")<[SubApp](../../prelude/struct.SubApp.html "struct bevy::prelude::SubApp")\>, render\_to\_app\_receiver: [Receiver](https://docs.rs/async-channel/2.5.0/x86_64-unknown-linux-gnu/async_channel/struct.Receiver.html "struct async_channel::Receiver")<[SubApp](../../prelude/struct.SubApp.html "struct bevy::prelude::SubApp")\>, ) -> [RenderAppChannels](struct.RenderAppChannels.html "struct bevy::render::pipelined_rendering::RenderAppChannels")

Create a `RenderAppChannels` from a [`async_channel::Receiver`](https://docs.rs/async-channel/2.5.0/x86_64-unknown-linux-gnu/async_channel/struct.Receiver.html "struct async_channel::Receiver") and [`async_channel::Sender`](https://docs.rs/async-channel/2.5.0/x86_64-unknown-linux-gnu/async_channel/struct.Sender.html "struct async_channel::Sender")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/pipelined_rendering.rs.html#42)

#### pub fn [send\_blocking](#method.send_blocking)(&mut self, render\_app: [SubApp](../../prelude/struct.SubApp.html "struct bevy::prelude::SubApp"))

Send the `render_app` to the rendering thread.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/pipelined_rendering.rs.html#49)

#### pub async fn [recv](#method.recv)(&mut self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[SubApp](../../prelude/struct.SubApp.html "struct bevy::prelude::SubApp")\>

Receive the `render_app` from the rendering thread. Return `None` if the render thread has panicked.

## Trait Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/pipelined_rendering.rs.html#21)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [RenderAppChannels](struct.RenderAppChannels.html "struct bevy::render::pipelined_rendering::RenderAppChannels")

where [RenderAppChannels](struct.RenderAppChannels.html "struct bevy::render::pipelined_rendering::RenderAppChannels"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/pipelined_rendering.rs.html#56)

### impl [Drop](https://doc.rust-lang.org/nightly/core/ops/drop/trait.Drop.html "trait core::ops::drop::Drop") for [RenderAppChannels](struct.RenderAppChannels.html "struct bevy::render::pipelined_rendering::RenderAppChannels")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/pipelined_rendering.rs.html#57)
...
### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [RenderAppChannels](struct.RenderAppChannels.html "struct bevy::render::pipelined_rendering::RenderAppChannels")

where [RenderAppChannels](struct.RenderAppChannels.html "struct bevy::render::pipelined_rendering::RenderAppChannels"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RenderAppChannels](struct.RenderAppChannels.html "struct bevy::render::pipelined_rendering::RenderAppChannels")

### impl ![UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RenderAppChannels](struct.RenderAppChannels.html "struct bevy::render::pipelined_rendering::RenderAppChannels")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RenderAppChannels](struct.RenderAppChannels.html "struct bevy::render::pipelined_rendering::RenderAppChannels")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RenderAppChannels](struct.RenderAppChannels.html "struct bevy::render::pipelined_rendering::RenderAppChannels")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RenderAppChannels](struct.RenderAppChannels.html "struct bevy::render::pipelined_rendering::RenderAppChannels")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RenderAppChannels](struct.RenderAppChannels.html "struct bevy::render::pipelined_rendering::RenderAppChannels")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RenderAppChannels](struct.RenderAppChannels.html "struct bevy::render::pipelined_rendering::RenderAppChannels")
