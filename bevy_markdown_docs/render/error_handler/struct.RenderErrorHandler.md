...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/error_handler.rs.html#47)

```rust
pub struct RenderErrorHandler(pub for<'a> fn(&'a RenderError, &'a mut World, &'a mut World) -> RenderErrorPolicy);
```
...
The handler has access to both the main world and the render world in that order. By the time this is invoked, the error has already been logged. The error is provided for the decision-making reason of how to appropriately respond to it.

Note that failing to address the source of an error and continuing to render may cause rapid flashing. Be sure to thoroughly test your error handler to ensure you application remains safe to use.

## Tuple Fields

`0: for<'a> [fn](https://doc.rust-lang.org/nightly/std/primitive.fn.html)(&'a [RenderError](struct.RenderError.html "struct bevy::render::error_handler::RenderError"), &'a mut [World](../../prelude/struct.World.html "struct bevy::prelude::World"), &'a mut [World](../../prelude/struct.World.html "struct bevy::prelude::World")) -> [RenderErrorPolicy](enum.RenderErrorPolicy.html "enum bevy::render::error_handler::RenderErrorPolicy")`

## Trait Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/error_handler.rs.html#46)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [RenderErrorHandler](struct.RenderErrorHandler.html "struct bevy::render::error_handler::RenderErrorHandler")

where [RenderErrorHandler](struct.RenderErrorHandler.html "struct bevy::render::error_handler::RenderErrorHandler"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/error_handler.rs.html#69)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [RenderErrorHandler](struct.RenderErrorHandler.html "struct bevy::render::error_handler::RenderErrorHandler")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/error_handler.rs.html#70)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [RenderErrorHandler](struct.RenderErrorHandler.html "struct bevy::render::error_handler::RenderErrorHandler")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/error_handler.rs.html#46)

### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [RenderErrorHandler](struct.RenderErrorHandler.html "struct bevy::render::error_handler::RenderErrorHandler")

where [RenderErrorHandler](struct.RenderErrorHandler.html "struct bevy::render::error_handler::RenderErrorHandler"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RenderErrorHandler](struct.RenderErrorHandler.html "struct bevy::render::error_handler::RenderErrorHandler")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RenderErrorHandler](struct.RenderErrorHandler.html "struct bevy::render::error_handler::RenderErrorHandler")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RenderErrorHandler](struct.RenderErrorHandler.html "struct bevy::render::error_handler::RenderErrorHandler")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RenderErrorHandler](struct.RenderErrorHandler.html "struct bevy::render::error_handler::RenderErrorHandler")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RenderErrorHandler](struct.RenderErrorHandler.html "struct bevy::render::error_handler::RenderErrorHandler")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RenderErrorHandler](struct.RenderErrorHandler.html "struct bevy::render::error_handler::RenderErrorHandler")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RenderErrorHandler](struct.RenderErrorHandler.html "struct bevy::render::error_handler::RenderErrorHandler")
