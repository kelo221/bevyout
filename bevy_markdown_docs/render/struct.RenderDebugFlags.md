...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)
...
### impl [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### pub const [ALLOW\_COPIES\_FROM\_INDIRECT\_PARAMETERS](#associatedconstant.ALLOW_COPIES_FROM_INDIRECT_PARAMETERS): [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")
...
#### pub const fn [empty](#method.empty)() -> [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

Get a flags value with all bits unset.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### pub const fn [all](#method.all)() -> [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")
...
#### pub const fn [from\_bits](#method.from_bits)(bits: [u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")\>
...
#### pub const fn [from\_bits\_truncate](#method.from_bits_truncate)(bits: [u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)) -> [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

Convert from a bits value, unsetting any unknown bits.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### pub const fn [from\_bits\_retain](#method.from_bits_retain)(bits: [u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)) -> [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

Convert from a bits value exactly.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### pub fn [from\_name](#method.from_name)(name: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")\>
...
#### pub const fn [intersects](#method.intersects)(&self, other: [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Whether any set bits in `other` are also set in `self`.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### pub const fn [contains](#method.contains)(&self, other: [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Whether all set bits in `other` are also set in `self`.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### pub fn [insert](#method.insert)(&mut self, other: [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags"))

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### pub fn [remove](#method.remove)(&mut self, other: [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags"))
...
#### pub fn [toggle](#method.toggle)(&mut self, other: [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags"))

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### pub fn [set](#method.set)(&mut self, other: [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags"), value: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Call `insert` when `value` is `true` or `remove` when `value` is `false`.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### pub const fn [intersection](#method.intersection)(self, other: [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")) -> [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

The bitwise and (`&`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### pub const fn [union](#method.union)(self, other: [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")) -> [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### pub const fn [difference](#method.difference)(self, other: [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")) -> [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")
...
#### pub const fn [symmetric\_difference](#method.symmetric_difference)( self, other: [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags"), ) -> [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### pub const fn [complement](#method.complement)(self) -> [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")
...
#### pub const fn [iter](#method.iter)(&self) -> [Iter](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.Iter.html "struct bitflags::iter::Iter")<[RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")\> [ⓘ](#)
...
#### pub const fn [iter\_names](#method.iter_names)(&self) -> [IterNames](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.IterNames.html "struct bitflags::iter::IterNames")<[RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")\> [ⓘ](#)
...
### impl [Binary](https://doc.rust-lang.org/nightly/core/fmt/trait.Binary.html "trait core::fmt::Binary") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")
...
### impl [BitAnd](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html "trait core::ops::bit::BitAnd") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### fn [bitand](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html#tymethod.bitand)(self, other: [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")) -> [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

The bitwise and (`&`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html#associatedtype.Output) = [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

The resulting type after applying the `&` operator.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

### impl [BitAndAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAndAssign.html "trait core::ops::bit::BitAndAssign") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### fn [bitand\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAndAssign.html#tymethod.bitand_assign)(&mut self, other: [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags"))

The bitwise and (`&`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

### impl [BitOr](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html "trait core::ops::bit::BitOr") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### fn [bitor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html#tymethod.bitor)(self, other: [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")) -> [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html#associatedtype.Output) = [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

The resulting type after applying the `|` operator.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

### impl [BitOrAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOrAssign.html "trait core::ops::bit::BitOrAssign") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### fn [bitor\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOrAssign.html#tymethod.bitor_assign)(&mut self, other: [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags"))

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

### impl [BitXor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html "trait core::ops::bit::BitXor") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### fn [bitxor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html#tymethod.bitxor)(self, other: [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")) -> [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html#associatedtype.Output) = [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

The resulting type after applying the `^` operator.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

### impl [BitXorAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXorAssign.html "trait core::ops::bit::BitXorAssign") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### fn [bitxor\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXorAssign.html#tymethod.bitxor_assign)(&mut self, other: [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags"))

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#140)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#140)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#140)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#140)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

### impl [Extend](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.Extend.html "trait core::iter::traits::collect::Extend")<[RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")\> for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")
...
where T: [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")\>,
...
### impl [Flags](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html "trait bitflags::traits::Flags") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### const [FLAGS](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#associatedconstant.FLAGS): &'static \[[Flag](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/struct.Flag.html "struct bitflags::traits::Flag")<[RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")\>\]
...
#### fn [from\_bits\_retain](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#tymethod.from_bits_retain)(bits: [u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)) -> [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

Convert from a bits value exactly.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### fn [all\_named](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#method.all_named)() -> [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")
...
### impl [FromIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html "trait core::iter::traits::collect::FromIterator")<[RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")\> for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### fn [from\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html#tymethod.from_iter)<T>(iterator: T) -> [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")
...
### impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### type [Item](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.Item) = [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

The type of the elements being iterated over.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### type [IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter) = [Iter](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.Iter.html "struct bitflags::iter::Iter")<[RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")\>

Which kind of iterator are we turning this into?

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### fn [into\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)(self) -> <[RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags") as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter "type core::iter::traits::collect::IntoIterator::IntoIter")

Creates an iterator from a value. [Read more](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

### impl [LowerHex](https://doc.rust-lang.org/nightly/core/fmt/trait.LowerHex.html "trait core::fmt::LowerHex") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")
...
### impl [Not](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html "trait core::ops::bit::Not") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### fn [not](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html#tymethod.not)(self) -> [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

The bitwise negation (`!`) of the bits in `self`, truncating the result.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html#associatedtype.Output) = [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

The resulting type after applying the `!` operator.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

### impl [Octal](https://doc.rust-lang.org/nightly/core/fmt/trait.Octal.html "trait core::fmt::Octal") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#140)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

### impl [Sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html "trait core::ops::arith::Sub") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### fn [sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#tymethod.sub)(self, other: [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")) -> [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")
...
#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#associatedtype.Output) = [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

The resulting type after applying the `-` operator.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

### impl [SubAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html "trait core::ops::arith::SubAssign") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#138-149)

#### fn [sub\_assign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html#tymethod.sub_assign)(&mut self, other: [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags"))
...
### impl [UpperHex](https://doc.rust-lang.org/nightly/core/fmt/trait.UpperHex.html "trait core::fmt::UpperHex") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RenderDebugFlags](struct.RenderDebugFlags.html "struct bevy::render::RenderDebugFlags")
