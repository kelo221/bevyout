...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [MeshMergeDuplicateVerticesError](../../mesh/enum.MeshMergeDuplicateVerticesError.html "enum bevy::mesh::MeshMergeDuplicateVerticesError")

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/mesh.rs.html#2693)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [MeshMergeDuplicateVerticesError](../../mesh/enum.MeshMergeDuplicateVerticesError.html "enum bevy::mesh::MeshMergeDuplicateVerticesError")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [MeshMergeDuplicateVerticesError](../../mesh/enum.MeshMergeDuplicateVerticesError.html "enum bevy::mesh::MeshMergeDuplicateVerticesError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [MeshMergeDuplicateVerticesError](../../mesh/enum.MeshMergeDuplicateVerticesError.html "enum bevy::mesh::MeshMergeDuplicateVerticesError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [MeshMergeDuplicateVerticesError](../../mesh/enum.MeshMergeDuplicateVerticesError.html "enum bevy::mesh::MeshMergeDuplicateVerticesError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MeshMergeDuplicateVerticesError](../../mesh/enum.MeshMergeDuplicateVerticesError.html "enum bevy::mesh::MeshMergeDuplicateVerticesError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MeshMergeDuplicateVerticesError](../../mesh/enum.MeshMergeDuplicateVerticesError.html "enum bevy::mesh::MeshMergeDuplicateVerticesError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MeshMergeDuplicateVerticesError](../../mesh/enum.MeshMergeDuplicateVerticesError.html "enum bevy::mesh::MeshMergeDuplicateVerticesError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MeshMergeDuplicateVerticesError](../../mesh/enum.MeshMergeDuplicateVerticesError.html "enum bevy::mesh::MeshMergeDuplicateVerticesError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MeshMergeDuplicateVerticesError](../../mesh/enum.MeshMergeDuplicateVerticesError.html "enum bevy::mesh::MeshMergeDuplicateVerticesError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MeshMergeDuplicateVerticesError](../../mesh/enum.MeshMergeDuplicateVerticesError.html "enum bevy::mesh::MeshMergeDuplicateVerticesError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MeshMergeDuplicateVerticesError](../../mesh/enum.MeshMergeDuplicateVerticesError.html "enum bevy::mesh::MeshMergeDuplicateVerticesError")
