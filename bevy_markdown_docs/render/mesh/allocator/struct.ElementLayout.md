...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/mesh/allocator.rs.html#176)

```rust
pub struct ElementLayout { /* private fields */ }
```

Information about the size of individual elements (vertices or indices) within a slab.

Slab objects are allocated in units of _slots_. Usually, each element takes up one slot, and so elements and slots are equivalent. Occasionally, however, a slot may consist of 2 or even 4 elements. This occurs when the size of an element isn’t divisible by [`COPY_BUFFER_ALIGNMENT`](../../render_resource/constant.COPY_BUFFER_ALIGNMENT.html "constant bevy::render::render_resource::COPY_BUFFER_ALIGNMENT"). When we resize buffers, we perform GPU-to-GPU copies to shuffle the existing elements into their new positions, and such copies must be on [`COPY_BUFFER_ALIGNMENT`](../../render_resource/constant.COPY_BUFFER_ALIGNMENT.html "constant bevy::render::render_resource::COPY_BUFFER_ALIGNMENT") boundaries. Slots solve this problem by guaranteeing that the size of an allocation quantum is divisible by both the size of an element and [`COPY_BUFFER_ALIGNMENT`](../../render_resource/constant.COPY_BUFFER_ALIGNMENT.html "constant bevy::render::render_resource::COPY_BUFFER_ALIGNMENT"), so we can relocate it freely.

## Trait Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/mesh/allocator.rs.html#175)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ElementLayout](struct.ElementLayout.html "struct bevy::render::mesh::allocator::ElementLayout")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/mesh/allocator.rs.html#175)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ElementLayout](struct.ElementLayout.html "struct bevy::render::mesh::allocator::ElementLayout")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [ElementLayout](struct.ElementLayout.html "struct bevy::render::mesh::allocator::ElementLayout")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/mesh/allocator.rs.html#175)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [ElementLayout](struct.ElementLayout.html "struct bevy::render::mesh::allocator::ElementLayout")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/mesh/allocator.rs.html#175)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [ElementLayout](struct.ElementLayout.html "struct bevy::render::mesh::allocator::ElementLayout")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [ElementLayout](struct.ElementLayout.html "struct bevy::render::mesh::allocator::ElementLayout")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/mesh/allocator.rs.html#175)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[ElementLayout](struct.ElementLayout.html "struct bevy::render::mesh::allocator::ElementLayout")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [SlabItemLayout](../../slab_allocator/trait.SlabItemLayout.html "trait bevy::render::slab_allocator::SlabItemLayout") for [ElementLayout](struct.ElementLayout.html "struct bevy::render::mesh::allocator::ElementLayout")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/mesh/allocator.rs.html#565)

#### fn [size](../../slab_allocator/trait.SlabItemLayout.html#tymethod.size)(&self) -> [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)

The size in bytes of a single element. [Read more](../../slab_allocator/trait.SlabItemLayout.html#tymethod.size)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/mesh/allocator.rs.html#569)

#### fn [elements\_per\_slot](../../slab_allocator/trait.SlabItemLayout.html#tymethod.elements_per_slot)(&self) -> [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)

The number of elements that make up a single slot.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/mesh/allocator.rs.html#573)

#### fn [buffer\_usages](../../slab_allocator/trait.SlabItemLayout.html#tymethod.buffer_usages)(&self) -> [BufferUsages](../../render_resource/struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages")

The `wgpu` buffer usages that the slab allocator will specify when creating buffers. [Read more](../../slab_allocator/trait.SlabItemLayout.html#tymethod.buffer_usages)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/mesh/allocator.rs.html#175)

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [ElementLayout](struct.ElementLayout.html "struct bevy::render::mesh::allocator::ElementLayout")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ElementLayout](struct.ElementLayout.html "struct bevy::render::mesh::allocator::ElementLayout")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ElementLayout](struct.ElementLayout.html "struct bevy::render::mesh::allocator::ElementLayout")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ElementLayout](struct.ElementLayout.html "struct bevy::render::mesh::allocator::ElementLayout")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ElementLayout](struct.ElementLayout.html "struct bevy::render::mesh::allocator::ElementLayout")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ElementLayout](struct.ElementLayout.html "struct bevy::render::mesh::allocator::ElementLayout")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ElementLayout](struct.ElementLayout.html "struct bevy::render::mesh::allocator::ElementLayout")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ElementLayout](struct.ElementLayout.html "struct bevy::render::mesh::allocator::ElementLayout")
