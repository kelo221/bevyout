...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/mesh/allocator.rs.html#32)
...
### impl [Plugin](../../../prelude/trait.Plugin.html "trait bevy::prelude::Plugin") for [MeshAllocatorPlugin](struct.MeshAllocatorPlugin.html "struct bevy::render::mesh::allocator::MeshAllocatorPlugin")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/mesh/allocator.rs.html#192)
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/mesh/allocator.rs.html#207)
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MeshAllocatorPlugin](struct.MeshAllocatorPlugin.html "struct bevy::render::mesh::allocator::MeshAllocatorPlugin")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MeshAllocatorPlugin](struct.MeshAllocatorPlugin.html "struct bevy::render::mesh::allocator::MeshAllocatorPlugin")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MeshAllocatorPlugin](struct.MeshAllocatorPlugin.html "struct bevy::render::mesh::allocator::MeshAllocatorPlugin")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MeshAllocatorPlugin](struct.MeshAllocatorPlugin.html "struct bevy::render::mesh::allocator::MeshAllocatorPlugin")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MeshAllocatorPlugin](struct.MeshAllocatorPlugin.html "struct bevy::render::mesh::allocator::MeshAllocatorPlugin")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MeshAllocatorPlugin](struct.MeshAllocatorPlugin.html "struct bevy::render::mesh::allocator::MeshAllocatorPlugin")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MeshAllocatorPlugin](struct.MeshAllocatorPlugin.html "struct bevy::render::mesh::allocator::MeshAllocatorPlugin")
