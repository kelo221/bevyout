[bevy](../../../index.html)::[render](../../index.html)::[mesh](../index.html)::[morph](index.html)

# Enum RenderMorphTargetAllocator 

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/mesh/morph.rs.html#119)
...
`mesh_id_to_image: [HashMap](../../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[AssetId](../../../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[Mesh](../../../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")>, [MorphTargetImage](struct.MorphTargetImage.html "struct bevy::render::mesh::morph::MorphTargetImage")>`

Maps the ID of each mesh to the image containing its morph target displacements.
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/mesh/morph.rs.html#164)

### impl [RenderMorphTargetAllocator](enum.RenderMorphTargetAllocator.html "enum bevy::render::mesh::morph::RenderMorphTargetAllocator")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/mesh/morph.rs.html#173-180)

#### pub fn [allocate](#method.allocate)( &mut self, render\_device: &[RenderDevice](../../renderer/struct.RenderDevice.html "struct bevy::render::renderer::RenderDevice"), render\_queue: &[RenderQueue](../../renderer/struct.RenderQueue.html "struct bevy::render::renderer::RenderQueue"), mesh\_id: [AssetId](../../../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[Mesh](../../../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")\>, targets: &\[[MorphAttributes](../../../mesh/morph/struct.MorphAttributes.html "struct bevy::mesh::morph::MorphAttributes")\], vertex\_count: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), )

Allocates morph target displacements for the given mesh.

If storage buffers aren’t supported on the current platform, this method creates a new [`MorphTargetImage`](struct.MorphTargetImage.html "struct bevy::render::mesh::morph::MorphTargetImage") and stores it inside the allocator.
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/mesh/morph.rs.html#209)

#### pub fn [free](#method.free)(&mut self, mesh\_id: [AssetId](../../../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[Mesh](../../../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")\>)

Frees the storage associated with morph target displacements for the mesh with the given ID.

If the current platform doesn’t support storage buffers, this drops the reference to the [`MorphTargetImage`](struct.MorphTargetImage.html "struct bevy::render::mesh::morph::MorphTargetImage") that stores the data for the mesh’s morph target displacements. If the current platform does support storage buffers, this method does nothing, as morph target displacements are managed by the mesh allocator in this case.

If passed a mesh without morph targets, this method does nothing.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/mesh/morph.rs.html#230)

#### pub fn [get\_image](#method.get_image)(&self, mesh\_id: [AssetId](../../../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[Mesh](../../../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")\>) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[MorphTargetImage](struct.MorphTargetImage.html "struct bevy::render::mesh::morph::MorphTargetImage")\>

Returns the [`MorphTargetImage`](struct.MorphTargetImage.html "struct bevy::render::mesh::morph::MorphTargetImage") containing the packed morph target displacements for the mesh with the given ID, if that image is present.

A [`MorphTargetImage`](struct.MorphTargetImage.html "struct bevy::render::mesh::morph::MorphTargetImage") is only available if storage buffers aren’t supported on the given platform. If storage buffers are supported, this method returns `None`, as the mesh allocator stores the morph target displacements in that case.

## Trait Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/mesh/morph.rs.html#118)

### impl [Component](../../../prelude/trait.Component.html "trait bevy::prelude::Component") for [RenderMorphTargetAllocator](enum.RenderMorphTargetAllocator.html "enum bevy::render::mesh::morph::RenderMorphTargetAllocator")

where [RenderMorphTargetAllocator](enum.RenderMorphTargetAllocator.html "enum bevy::render::mesh::morph::RenderMorphTargetAllocator"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
#### fn [map\_entities](../../../prelude/trait.Component.html#method.map_entities)<M>(this: &mut [RenderMorphTargetAllocator](enum.RenderMorphTargetAllocator.html "enum bevy::render::mesh::morph::RenderMorphTargetAllocator"), mapper: [&mut M](https://doc.rust-lang.org/nightly/std/primitive.reference.html))
...
### impl [FromWorld](../../../prelude/trait.FromWorld.html "trait bevy::prelude::FromWorld") for [RenderMorphTargetAllocator](enum.RenderMorphTargetAllocator.html "enum bevy::render::mesh::morph::RenderMorphTargetAllocator")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/mesh/morph.rs.html#135)

#### fn [from\_world](../../../prelude/trait.FromWorld.html#tymethod.from_world)(world: &mut [World](../../../prelude/struct.World.html "struct bevy::prelude::World")) -> [RenderMorphTargetAllocator](enum.RenderMorphTargetAllocator.html "enum bevy::render::mesh::morph::RenderMorphTargetAllocator")

Creates `Self` using data from the given [`World`](../../../prelude/struct.World.html "struct bevy::prelude::World").

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/mesh/morph.rs.html#118)

### impl [Resource](../../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [RenderMorphTargetAllocator](enum.RenderMorphTargetAllocator.html "enum bevy::render::mesh::morph::RenderMorphTargetAllocator")

where [RenderMorphTargetAllocator](enum.RenderMorphTargetAllocator.html "enum bevy::render::mesh::morph::RenderMorphTargetAllocator"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RenderMorphTargetAllocator](enum.RenderMorphTargetAllocator.html "enum bevy::render::mesh::morph::RenderMorphTargetAllocator")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RenderMorphTargetAllocator](enum.RenderMorphTargetAllocator.html "enum bevy::render::mesh::morph::RenderMorphTargetAllocator")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RenderMorphTargetAllocator](enum.RenderMorphTargetAllocator.html "enum bevy::render::mesh::morph::RenderMorphTargetAllocator")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RenderMorphTargetAllocator](enum.RenderMorphTargetAllocator.html "enum bevy::render::mesh::morph::RenderMorphTargetAllocator")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RenderMorphTargetAllocator](enum.RenderMorphTargetAllocator.html "enum bevy::render::mesh::morph::RenderMorphTargetAllocator")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RenderMorphTargetAllocator](enum.RenderMorphTargetAllocator.html "enum bevy::render::mesh::morph::RenderMorphTargetAllocator")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RenderMorphTargetAllocator](enum.RenderMorphTargetAllocator.html "enum bevy::render::mesh::morph::RenderMorphTargetAllocator")
