...
[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/vertex.rs.html#149)
...
`pipeline_type: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)>`

## Trait Implementations

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/vertex.rs.html#147)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [MissingVertexAttributeError](../../mesh/struct.MissingVertexAttributeError.html "struct bevy::mesh::MissingVertexAttributeError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [MissingVertexAttributeError](../../mesh/struct.MissingVertexAttributeError.html "struct bevy::mesh::MissingVertexAttributeError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [MissingVertexAttributeError](../../mesh/struct.MissingVertexAttributeError.html "struct bevy::mesh::MissingVertexAttributeError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MissingVertexAttributeError](../../mesh/struct.MissingVertexAttributeError.html "struct bevy::mesh::MissingVertexAttributeError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MissingVertexAttributeError](../../mesh/struct.MissingVertexAttributeError.html "struct bevy::mesh::MissingVertexAttributeError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MissingVertexAttributeError](../../mesh/struct.MissingVertexAttributeError.html "struct bevy::mesh::MissingVertexAttributeError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MissingVertexAttributeError](../../mesh/struct.MissingVertexAttributeError.html "struct bevy::mesh::MissingVertexAttributeError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MissingVertexAttributeError](../../mesh/struct.MissingVertexAttributeError.html "struct bevy::mesh::MissingVertexAttributeError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MissingVertexAttributeError](../../mesh/struct.MissingVertexAttributeError.html "struct bevy::mesh::MissingVertexAttributeError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MissingVertexAttributeError](../../mesh/struct.MissingVertexAttributeError.html "struct bevy::mesh::MissingVertexAttributeError")
