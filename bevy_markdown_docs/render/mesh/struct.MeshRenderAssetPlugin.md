...
# Struct MeshRenderAssetPlugin 

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/mesh/mod.rs.html#33)
...
### impl [Plugin](../../prelude/trait.Plugin.html "trait bevy::prelude::Plugin") for [MeshRenderAssetPlugin](struct.MeshRenderAssetPlugin.html "struct bevy::render::mesh::MeshRenderAssetPlugin")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/mesh/mod.rs.html#36)
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/mesh/mod.rs.html#49)
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MeshRenderAssetPlugin](struct.MeshRenderAssetPlugin.html "struct bevy::render::mesh::MeshRenderAssetPlugin")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MeshRenderAssetPlugin](struct.MeshRenderAssetPlugin.html "struct bevy::render::mesh::MeshRenderAssetPlugin")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MeshRenderAssetPlugin](struct.MeshRenderAssetPlugin.html "struct bevy::render::mesh::MeshRenderAssetPlugin")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MeshRenderAssetPlugin](struct.MeshRenderAssetPlugin.html "struct bevy::render::mesh::MeshRenderAssetPlugin")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MeshRenderAssetPlugin](struct.MeshRenderAssetPlugin.html "struct bevy::render::mesh::MeshRenderAssetPlugin")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MeshRenderAssetPlugin](struct.MeshRenderAssetPlugin.html "struct bevy::render::mesh::MeshRenderAssetPlugin")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MeshRenderAssetPlugin](struct.MeshRenderAssetPlugin.html "struct bevy::render::mesh::MeshRenderAssetPlugin")
