...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [MeshPlugin](../../mesh/struct.MeshPlugin.html "struct bevy::mesh::MeshPlugin")

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/lib.rs.html#59)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [MeshPlugin](../../mesh/struct.MeshPlugin.html "struct bevy::mesh::MeshPlugin")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MeshPlugin](../../mesh/struct.MeshPlugin.html "struct bevy::mesh::MeshPlugin")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MeshPlugin](../../mesh/struct.MeshPlugin.html "struct bevy::mesh::MeshPlugin")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MeshPlugin](../../mesh/struct.MeshPlugin.html "struct bevy::mesh::MeshPlugin")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MeshPlugin](../../mesh/struct.MeshPlugin.html "struct bevy::mesh::MeshPlugin")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MeshPlugin](../../mesh/struct.MeshPlugin.html "struct bevy::mesh::MeshPlugin")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MeshPlugin](../../mesh/struct.MeshPlugin.html "struct bevy::mesh::MeshPlugin")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MeshPlugin](../../mesh/struct.MeshPlugin.html "struct bevy::mesh::MeshPlugin")
