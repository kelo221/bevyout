...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#326)
...
Each entity in the main world can potentially extract to multiple views, each of which have a [`RetainedViewEntity::subview_index`](struct.RetainedViewEntity.html#structfield.subview_index "field bevy::render::view::RetainedViewEntity::subview_index"). For instance, point lights with shadows extract to 6 subviews, one for each side of the shadow cubemap. [`Camera3d`](../../prelude/struct.Camera3d.html "struct bevy::prelude::Camera3d") extracts into a [`ExtractedView`](struct.ExtractedView.html "struct bevy::render::view::ExtractedView") and [`ExtractedCamera`](../camera/struct.ExtractedCamera.html "struct bevy::render::camera::ExtractedCamera") component.

## Fields

`retained_view_entity: [RetainedViewEntity](struct.RetainedViewEntity.html "struct bevy::render::view::RetainedViewEntity")`

The entity in the main world corresponding to this render world view.

`clip_from_view: [Mat4](../../prelude/struct.Mat4.html "struct bevy::prelude::Mat4")`
...
`world_from_view: [GlobalTransform](../../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")``clip_from_world: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Mat4](../../prelude/struct.Mat4.html "struct bevy::prelude::Mat4")>``target_format: [TextureFormat](../render_resource/enum.TextureFormat.html "enum bevy::render::render_resource::TextureFormat")`

The [`TextureFormat`](../render_resource/enum.TextureFormat.html "enum bevy::render::render_resource::TextureFormat") this view will render to. Note that this may diverge from the [`RenderTarget`](../../camera/enum.RenderTarget.html "enum bevy::camera::RenderTarget")’s texture format. Among other reasons, [`Hdr`](../../camera/struct.Hdr.html "struct bevy::camera::Hdr") sets an the internal render target format override to ensure sufficient precision is present for lighting calculations.

`viewport: [UVec4](../../prelude/struct.UVec4.html "struct bevy::prelude::UVec4")``color_grading: [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")``invert_culling: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#386)

### impl [ExtractedView](struct.ExtractedView.html "struct bevy::render::view::ExtractedView")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#388)

#### pub fn [rangefinder3d](#method.rangefinder3d)(&self) -> [ViewRangefinder3d](../render_phase/struct.ViewRangefinder3d.html "struct bevy::render::render_phase::ViewRangefinder3d")

Creates a 3D rangefinder for a view

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/shader\_advanced/custom\_render\_phase.rs ([line 331](../../../src/custom_render_phase/custom_render_phase.rs.html#331))
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#325)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [ExtractedView](struct.ExtractedView.html "struct bevy::render::view::ExtractedView")

where [ExtractedView](struct.ExtractedView.html "struct bevy::render::view::ExtractedView"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ExtractedView](struct.ExtractedView.html "struct bevy::render::view::ExtractedView")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ExtractedView](struct.ExtractedView.html "struct bevy::render::view::ExtractedView")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ExtractedView](struct.ExtractedView.html "struct bevy::render::view::ExtractedView")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ExtractedView](struct.ExtractedView.html "struct bevy::render::view::ExtractedView")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ExtractedView](struct.ExtractedView.html "struct bevy::render::view::ExtractedView")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ExtractedView](struct.ExtractedView.html "struct bevy::render::view::ExtractedView")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ExtractedView](struct.ExtractedView.html "struct bevy::render::view::ExtractedView")
