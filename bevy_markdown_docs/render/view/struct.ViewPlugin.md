...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#167)
...
### impl [Plugin](../../prelude/trait.Plugin.html "trait bevy::prelude::Plugin") for [ViewPlugin](struct.ViewPlugin.html "struct bevy::render::view::ViewPlugin")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#170)
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#208)
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ViewPlugin](struct.ViewPlugin.html "struct bevy::render::view::ViewPlugin")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ViewPlugin](struct.ViewPlugin.html "struct bevy::render::view::ViewPlugin")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ViewPlugin](struct.ViewPlugin.html "struct bevy::render::view::ViewPlugin")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ViewPlugin](struct.ViewPlugin.html "struct bevy::render::view::ViewPlugin")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ViewPlugin](struct.ViewPlugin.html "struct bevy::render::view::ViewPlugin")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ViewPlugin](struct.ViewPlugin.html "struct bevy::render::view::ViewPlugin")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ViewPlugin](struct.ViewPlugin.html "struct bevy::render::view::ViewPlugin")
