...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/window/screenshot.rs.html#84)
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/window/screenshot.rs.html#83)

### impl [Component](../../../../prelude/trait.Component.html "trait bevy::prelude::Component") for [Capturing](struct.Capturing.html "struct bevy::render::view::window::screenshot::Capturing")

where [Capturing](struct.Capturing.html "struct bevy::render::view::window::screenshot::Capturing"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Capturing](struct.Capturing.html "struct bevy::render::view::window::screenshot::Capturing")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/window/screenshot.rs.html#83)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Capturing](struct.Capturing.html "struct bevy::render::view::window::screenshot::Capturing")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Capturing](struct.Capturing.html "struct bevy::render::view::window::screenshot::Capturing")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Capturing](struct.Capturing.html "struct bevy::render::view::window::screenshot::Capturing")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Capturing](struct.Capturing.html "struct bevy::render::view::window::screenshot::Capturing")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Capturing](struct.Capturing.html "struct bevy::render::view::window::screenshot::Capturing")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Capturing](struct.Capturing.html "struct bevy::render::view::window::screenshot::Capturing")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Capturing](struct.Capturing.html "struct bevy::render::view::window::screenshot::Capturing")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Capturing](struct.Capturing.html "struct bevy::render::view::window::screenshot::Capturing")
