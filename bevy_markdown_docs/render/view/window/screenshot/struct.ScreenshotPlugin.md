...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/window/screenshot.rs.html#406)
...
### impl [Plugin](../../../../prelude/trait.Plugin.html "trait bevy::prelude::Plugin") for [ScreenshotPlugin](struct.ScreenshotPlugin.html "struct bevy::render::view::window::screenshot::ScreenshotPlugin")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/window/screenshot.rs.html#409)
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ScreenshotPlugin](struct.ScreenshotPlugin.html "struct bevy::render::view::window::screenshot::ScreenshotPlugin")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ScreenshotPlugin](struct.ScreenshotPlugin.html "struct bevy::render::view::window::screenshot::ScreenshotPlugin")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ScreenshotPlugin](struct.ScreenshotPlugin.html "struct bevy::render::view::window::screenshot::ScreenshotPlugin")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ScreenshotPlugin](struct.ScreenshotPlugin.html "struct bevy::render::view::window::screenshot::ScreenshotPlugin")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ScreenshotPlugin](struct.ScreenshotPlugin.html "struct bevy::render::view::window::screenshot::ScreenshotPlugin")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ScreenshotPlugin](struct.ScreenshotPlugin.html "struct bevy::render::view::window::screenshot::ScreenshotPlugin")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ScreenshotPlugin](struct.ScreenshotPlugin.html "struct bevy::render::view::window::screenshot::ScreenshotPlugin")
