...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#696)
...
`compositing_space: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[CompositingSpace](../../prelude/enum.CompositingSpace.html "enum bevy::prelude::CompositingSpace")>`

Color space of values stored in the main texture (for blit conversion to output)

## Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#818)

### impl [ViewTarget](struct.ViewTarget.html "struct bevy::render::view::ViewTarget")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#822)

#### pub const [TEXTURE\_FORMAT\_HDR](#associatedconstant.TEXTURE_FORMAT_HDR): [TextureFormat](../render_resource/enum.TextureFormat.html "enum bevy::render::render_resource::TextureFormat") = TextureFormat::Rgba16Float

👎Deprecated:

Use ExtractedView::target\_format where possible. Bevy does not encourage a default HDR TextureFormat anymore. If you really need this, use TextureFormat::Rgba16Float

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#825)

#### pub fn [get\_color\_attachment](#method.get_color_attachment)(&self) -> [RenderPassColorAttachment](../render_resource/struct.RenderPassColorAttachment.html "struct bevy::render::render_resource::RenderPassColorAttachment")<'\_>

Retrieve this target’s main texture’s color attachment.

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/shader\_advanced/custom\_render\_phase.rs ([line 672](../../../src/custom_render_phase/custom_render_phase.rs.html#672))
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#834)

#### pub fn [get\_unsampled\_color\_attachment](#method.get_unsampled_color_attachment)(&self) -> [RenderPassColorAttachment](../render_resource/struct.RenderPassColorAttachment.html "struct bevy::render::render_resource::RenderPassColorAttachment")<'\_>

Retrieve this target’s “unsampled” main texture’s color attachment.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#843)

#### pub fn [main\_texture](#method.main_texture)(&self) -> &[Texture](../render_resource/struct.Texture.html "struct bevy::render::render_resource::Texture")

The “main” unsampled texture.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#857)

#### pub fn [main\_texture\_other](#method.main_texture_other)(&self) -> &[Texture](../render_resource/struct.Texture.html "struct bevy::render::render_resource::Texture")

The _other_ “main” unsampled texture. In most cases you should use [`Self::main_texture`](struct.ViewTarget.html#method.main_texture "method bevy::render::view::ViewTarget::main_texture") instead and never this. The textures will naturally be swapped when [`Self::post_process_write`](struct.ViewTarget.html#method.post_process_write "method bevy::render::view::ViewTarget::post_process_write") is called.

A use case for this is to be able to prepare a bind group for all main textures ahead of time.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#866)

#### pub fn [main\_texture\_view](#method.main_texture_view)(&self) -> &[TextureView](../render_resource/struct.TextureView.html "struct bevy::render::render_resource::TextureView")

The “main” unsampled texture.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#880)

#### pub fn [main\_texture\_other\_view](#method.main_texture_other_view)(&self) -> &[TextureView](../render_resource/struct.TextureView.html "struct bevy::render::render_resource::TextureView")

The _other_ “main” unsampled texture view. In most cases you should use [`Self::main_texture_view`](struct.ViewTarget.html#method.main_texture_view "method bevy::render::view::ViewTarget::main_texture_view") instead and never this. The textures will naturally be swapped when [`Self::post_process_write`](struct.ViewTarget.html#method.post_process_write "method bevy::render::view::ViewTarget::post_process_write") is called.

A use case for this is to be able to prepare a bind group for all main textures ahead of time.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#889)

#### pub fn [sampled\_main\_texture](#method.sampled_main_texture)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[Texture](../render_resource/struct.Texture.html "struct bevy::render::render_resource::Texture")\>

The “main” sampled texture.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#898)

#### pub fn [sampled\_main\_texture\_view](#method.sampled_main_texture_view)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[TextureView](../render_resource/struct.TextureView.html "struct bevy::render::render_resource::TextureView")\>

The “main” sampled texture view.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#912)

#### pub fn [main\_texture\_format](#method.main_texture_format)(&self) -> [TextureFormat](../render_resource/enum.TextureFormat.html "enum bevy::render::render_resource::TextureFormat")

Currently bevy’s main texture format can be:

*   If rendering to screen: For HDR, it’s `Rgba16Float`. For LDR, it’s `Rgba8Unorm` when [`CompositingSpace::Srgb`](../../prelude/enum.CompositingSpace.html#variant.Srgb "variant bevy::prelude::CompositingSpace::Srgb"), otherwise `Rgba8UnormSrgb`.
*   If rendering to texture: the format is the same as texture view’s format.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#918)

#### pub fn [out\_texture](#method.out_texture)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[TextureView](../render_resource/struct.TextureView.html "struct bevy::render::render_resource::TextureView")\>

The final texture this view will render to.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#923-926)

#### pub fn [out\_texture\_color\_attachment](#method.out_texture_color_attachment)( &self, clear\_color: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[LinearRgba](../../prelude/struct.LinearRgba.html "struct bevy::prelude::LinearRgba")\>, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[RenderPassColorAttachment](../render_resource/struct.RenderPassColorAttachment.html "struct bevy::render::render_resource::RenderPassColorAttachment")<'\_>>

The final texture this view will render to, as a color attachment.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#933)

#### pub fn [needs\_present](#method.needs_present)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Whether the final texture this view will render to needs to be presented.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#941)

#### pub fn [out\_texture\_view\_format](#method.out_texture_view_format)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[TextureFormat](../render_resource/enum.TextureFormat.html "enum bevy::render::render_resource::TextureFormat")\>

The format of the final texture this view will render to, if any.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#952)

#### pub fn [post\_process\_write](#method.post_process_write)(&self) -> [PostProcessWrite](struct.PostProcessWrite.html "struct bevy::render::view::PostProcessWrite")<'\_>

This will start a new “post process write”, which assumes that the caller will write the [`PostProcessWrite`](struct.PostProcessWrite.html "struct bevy::render::view::PostProcessWrite")’s `source` to the `destination`.

`source` is the “current” main texture. This will internally flip this [`ViewTarget`](struct.ViewTarget.html "struct bevy::render::view::ViewTarget")’s main texture to the `destination` texture, so the caller _must_ ensure `source` is copied to `destination`, with or without modifications. Failing to do so will cause the current main texture information to be lost.

##### [Examples found in repository](#scraped-examples-1)[?](../../../scrape-examples-help.html)

examples/shader\_advanced/custom\_post\_processing.rs ([line 109](../../../src/custom_post_processing/custom_post_processing.rs.html#109))
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#695)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ViewTarget](struct.ViewTarget.html "struct bevy::render::view::ViewTarget")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#695)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ViewTarget](struct.ViewTarget.html "struct bevy::render::view::ViewTarget")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [ViewTarget](struct.ViewTarget.html "struct bevy::render::view::ViewTarget")

where [ViewTarget](struct.ViewTarget.html "struct bevy::render::view::ViewTarget"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ViewTarget](struct.ViewTarget.html "struct bevy::render::view::ViewTarget")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ViewTarget](struct.ViewTarget.html "struct bevy::render::view::ViewTarget")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ViewTarget](struct.ViewTarget.html "struct bevy::render::view::ViewTarget")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ViewTarget](struct.ViewTarget.html "struct bevy::render::view::ViewTarget")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ViewTarget](struct.ViewTarget.html "struct bevy::render::view::ViewTarget")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ViewTarget](struct.ViewTarget.html "struct bevy::render::view::ViewTarget")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ViewTarget](struct.ViewTarget.html "struct bevy::render::view::ViewTarget")
