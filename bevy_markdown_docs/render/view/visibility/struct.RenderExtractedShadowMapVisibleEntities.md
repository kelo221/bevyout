...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#145)
...
This component contains one [`RenderExtractedVisibleEntities`](../struct.RenderExtractedVisibleEntities.html "struct bevy::render::view::RenderExtractedVisibleEntities") object per subview. Directional lights have one subview per cascade, point lights have one subview per cubemap face, and spot lights only have a single subview.

Mesh entities that have [`NoCpuCulling`](../../../camera/visibility/struct.NoCpuCulling.html "struct bevy::camera::visibility::NoCpuCulling") components aren’t in this list. Instead, `collect_gpu_culled_meshes` fetches them directly from the `RenderGpuCulledEntities` table.

The `extract_lights` system populates this component, and the [`collect_visible_cpu_culled_entities`](../fn.collect_visible_cpu_culled_entities.html "fn bevy::render::view::collect_visible_cpu_culled_entities") system reads it.

## Fields

`subviews: [HashMap](../../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[RetainedViewEntity](../struct.RetainedViewEntity.html "struct bevy::render::view::RetainedViewEntity"), [RenderExtractedVisibleEntities](../struct.RenderExtractedVisibleEntities.html "struct bevy::render::view::RenderExtractedVisibleEntities")>`

A mapping from the subview to the list of entities that the CPU has determined are visible from it.

## Trait Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#144)

### impl [Component](../../../prelude/trait.Component.html "trait bevy::prelude::Component") for [RenderExtractedShadowMapVisibleEntities](../struct.RenderExtractedShadowMapVisibleEntities.html "struct bevy::render::view::RenderExtractedShadowMapVisibleEntities")

where [RenderExtractedShadowMapVisibleEntities](../struct.RenderExtractedShadowMapVisibleEntities.html "struct bevy::render::view::RenderExtractedShadowMapVisibleEntities"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [RenderExtractedShadowMapVisibleEntities](../struct.RenderExtractedShadowMapVisibleEntities.html "struct bevy::render::view::RenderExtractedShadowMapVisibleEntities")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#144)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [RenderExtractedShadowMapVisibleEntities](../struct.RenderExtractedShadowMapVisibleEntities.html "struct bevy::render::view::RenderExtractedShadowMapVisibleEntities")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RenderExtractedShadowMapVisibleEntities](../struct.RenderExtractedShadowMapVisibleEntities.html "struct bevy::render::view::RenderExtractedShadowMapVisibleEntities")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RenderExtractedShadowMapVisibleEntities](../struct.RenderExtractedShadowMapVisibleEntities.html "struct bevy::render::view::RenderExtractedShadowMapVisibleEntities")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RenderExtractedShadowMapVisibleEntities](../struct.RenderExtractedShadowMapVisibleEntities.html "struct bevy::render::view::RenderExtractedShadowMapVisibleEntities")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RenderExtractedShadowMapVisibleEntities](../struct.RenderExtractedShadowMapVisibleEntities.html "struct bevy::render::view::RenderExtractedShadowMapVisibleEntities")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RenderExtractedShadowMapVisibleEntities](../struct.RenderExtractedShadowMapVisibleEntities.html "struct bevy::render::view::RenderExtractedShadowMapVisibleEntities")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RenderExtractedShadowMapVisibleEntities](../struct.RenderExtractedShadowMapVisibleEntities.html "struct bevy::render::view::RenderExtractedShadowMapVisibleEntities")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RenderExtractedShadowMapVisibleEntities](../struct.RenderExtractedShadowMapVisibleEntities.html "struct bevy::render::view::RenderExtractedShadowMapVisibleEntities")
