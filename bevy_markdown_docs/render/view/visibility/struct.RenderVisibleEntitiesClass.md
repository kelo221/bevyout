...
# Struct RenderVisibleEntitiesClass 

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#89)

```rust
pub struct RenderVisibleEntitiesClass {
    pub entities_cpu_culling: Vec<(Entity, MainEntity)>,
    pub entities_gpu_culling: HashMap<MainEntity, Entity, EntityHash>,
...
Note that all lists in this component are guaranteed to be sorted. Thus you can test for the presence of an entity in these lists via binary search.

Note also that, for 3D meshes, the render-world [`Entity`](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity") values will always be [`Entity::PLACEHOLDER`](../../../prelude/struct.Entity.html#associatedconstant.PLACEHOLDER "associated constant bevy::prelude::Entity::PLACEHOLDER"). The render-world entities are kept for legacy systems that still need to process visibility of render-world entities.

The [`collect_visible_cpu_culled_entities`](../fn.collect_visible_cpu_culled_entities.html "fn bevy::render::view::collect_visible_cpu_culled_entities") and `collect_gpu_culled_meshes` systems populate this object from the corresponding [`RenderExtractedVisibleEntitiesClass`](../struct.RenderExtractedVisibleEntitiesClass.html "struct bevy::render::view::RenderExtractedVisibleEntitiesClass") object and the `RenderGpuCulledEntities` resource, respectively.

## Fields

`entities_cpu_culling: [Vec](../../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<([Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), [MainEntity](../../sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity"))>`

A sorted list of all entities that don’t have [`NoCpuCulling`](../../../camera/visibility/struct.NoCpuCulling.html "struct bevy::camera::visibility::NoCpuCulling") components and are visible from this view.

`entities_gpu_culling: [HashMap](../../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[MainEntity](../../sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity"), [Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), [EntityHash](../../../ecs/entity/struct.EntityHash.html "struct bevy::ecs::entity::EntityHash")>`

A table of all entities that have [`NoCpuCulling`](../../../camera/visibility/struct.NoCpuCulling.html "struct bevy::camera::visibility::NoCpuCulling") components and have [`bevy_camera::visibility::InheritedVisibility`](../../../prelude/struct.InheritedVisibility.html "struct bevy::prelude::InheritedVisibility") set to true.

The `collect_gpu_culled_meshes` system keeps this up to date.

`added_entities: [Vec](../../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<([Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), [MainEntity](../../sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity"))>`

A sorted list of all entities that were invisible last frame (including ones that didn’t exist at all last frame) and became visible this frame.

`removed_entities: [Vec](../../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<([Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), [MainEntity](../../sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity"))>`

A sorted list of all entities that were visible last frame and became invisible this frame, including those that were despawned this frame.

## Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#179)

### impl [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#182)

#### pub fn [prepare\_for\_new\_frame](#method.prepare_for_new_frame)(&mut self)

Clears out the lists of added and removed entities in preparation for a new frame.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#194-197)

#### pub fn [update\_cpu\_culled\_entities](#method.update_cpu_culled_entities)( &mut self, visible\_mesh\_entities\_cpu\_culling: &\[([Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), [MainEntity](../../sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity"))\], )

Processes a list of visible entities for a new frame, computing the set of newly-added and newly-removed entities as it goes.

This function only handles entities that are culled on CPU (i.e. don’t have `NoCpuCulling` components). Entities that use only GPU culling are instead fetched from the main world and added to the `RenderGpuCulledEntities` table.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#258)

#### pub fn [add\_entity](#method.add_entity)(&mut self, pair: ([Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), [MainEntity](../../sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity")))

Adds a new entity to the [`Self::added_entities`](../struct.RenderVisibleEntitiesClass.html#method.added_entities "method bevy::render::view::RenderVisibleEntitiesClass::added_entities") list.

After calling this method one or more times, you must call [`Self::sort_added_entities`](../struct.RenderVisibleEntitiesClass.html#method.sort_added_entities "method bevy::render::view::RenderVisibleEntitiesClass::sort_added_entities") to ensure the [`Self::added_entities`](../struct.RenderVisibleEntitiesClass.html#method.added_entities "method bevy::render::view::RenderVisibleEntitiesClass::added_entities") list is sorted.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#263)

#### pub fn [added\_entities](#method.added_entities)(&self) -> &\[([Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), [MainEntity](../../sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity"))\]

Returns the list of newly-added entities.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#271)

#### pub fn [entity\_pair\_is\_visible](#method.entity_pair_is_visible)( &self, entity: [Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), main\_entity: [MainEntity](../../sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity"), ) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns true if the given entity pair is known to be visible.

This checks both the CPU culling visible entries table and the no-CPU-culling visible entries table.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#285)

#### pub fn [iter\_visible](#method.iter_visible)<'a>( &'a self, ) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = (&'a [Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), &'a [MainEntity](../../sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity"))>

Iterates over all visible entities.

This is an expensive operation, so try to avoid doing it unless necessary (e.g. the view key changed).

##### [Examples found in repository](#scraped-examples)[?](../../../../scrape-examples-help.html)

examples/2d/mesh2d\_manual.rs ([line 408](../../../../src/mesh2d_manual/mesh2d_manual.rs.html#408))
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#300)

#### pub fn [sort\_added\_entities](#method.sort_added_entities)(&mut self)

Sorts the [`Self::added_entities`](../struct.RenderVisibleEntitiesClass.html#method.added_entities "method bevy::render::view::RenderVisibleEntitiesClass::added_entities") list.

You must call this after adding entities to the list via [`Self::add_entity`](../struct.RenderVisibleEntitiesClass.html#method.add_entity "method bevy::render::view::RenderVisibleEntitiesClass::add_entity").

## Trait Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#87)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#87)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#87)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#87)

### impl [FromArg](../../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#87)

#### type [This](../../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")

The type to convert into. [Read more](../../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#87)

#### fn [from\_arg](../../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass") as [FromArg](../../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#87)

### impl [FromReflect](../../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#87)

#### fn [from\_reflect](../../../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")\>
...
### impl [GetOwnership](../../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")
...
### impl [GetTypeRegistration](../../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")
...
### impl [IntoReturn](../../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")
...
where [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass"): 'into\_return,
...
### impl [PartialReflect](../../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")
...
#### fn [reflect\_owned](../../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../../prelude/struct.Box.html "struct bevy::prelude::Box")<[RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")\>) -> [ReflectOwned](../../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#87)

#### fn [try\_into\_reflect](../../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../../prelude/struct.Box.html "struct bevy::prelude::Box")<[RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)( self: [Box](../../../prelude/struct.Box.html "struct bevy::prelude::Box")<[RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")\>, ) -> [Box](../../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#88)
...
### impl [Reflect](../../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#87)

#### fn [into\_any](../../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../../prelude/struct.Box.html "struct bevy::prelude::Box")<[RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")\>) -> [Box](../../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../../prelude/struct.Box.html "struct bevy::prelude::Box")<[RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")\>) -> [Box](../../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Struct](../../../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")
...
### impl [TypePath](../../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")
...
### impl [Typed](../../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")
