...
# Struct RenderExtractedVisibleEntitiesClass 

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#162)
...
Mesh entities that have [`NoCpuCulling`](../../../camera/visibility/struct.NoCpuCulling.html "struct bevy::camera::visibility::NoCpuCulling") components aren’t in this list. Instead, `collect_gpu_culled_meshes` fetches them directly from the `RenderGpuCulledEntities` table in order to update the [`RenderVisibleEntitiesClass`](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass").
...
`entities: [Vec](../../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<([Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), [MainEntity](../../sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity"))>`

A sorted list of entities that don’t have [`NoCpuCulling`](../../../camera/visibility/struct.NoCpuCulling.html "struct bevy::camera::visibility::NoCpuCulling") components and are visible from this view or subview.

## Trait Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#161)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [RenderExtractedVisibleEntitiesClass](../struct.RenderExtractedVisibleEntitiesClass.html "struct bevy::render::view::RenderExtractedVisibleEntitiesClass")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#161)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [RenderExtractedVisibleEntitiesClass](../struct.RenderExtractedVisibleEntitiesClass.html "struct bevy::render::view::RenderExtractedVisibleEntitiesClass")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [RenderExtractedVisibleEntitiesClass](../struct.RenderExtractedVisibleEntitiesClass.html "struct bevy::render::view::RenderExtractedVisibleEntitiesClass")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [RenderExtractedVisibleEntitiesClass](../struct.RenderExtractedVisibleEntitiesClass.html "struct bevy::render::view::RenderExtractedVisibleEntitiesClass")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#161)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [RenderExtractedVisibleEntitiesClass](../struct.RenderExtractedVisibleEntitiesClass.html "struct bevy::render::view::RenderExtractedVisibleEntitiesClass")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RenderExtractedVisibleEntitiesClass](../struct.RenderExtractedVisibleEntitiesClass.html "struct bevy::render::view::RenderExtractedVisibleEntitiesClass")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RenderExtractedVisibleEntitiesClass](../struct.RenderExtractedVisibleEntitiesClass.html "struct bevy::render::view::RenderExtractedVisibleEntitiesClass")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RenderExtractedVisibleEntitiesClass](../struct.RenderExtractedVisibleEntitiesClass.html "struct bevy::render::view::RenderExtractedVisibleEntitiesClass")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RenderExtractedVisibleEntitiesClass](../struct.RenderExtractedVisibleEntitiesClass.html "struct bevy::render::view::RenderExtractedVisibleEntitiesClass")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RenderExtractedVisibleEntitiesClass](../struct.RenderExtractedVisibleEntitiesClass.html "struct bevy::render::view::RenderExtractedVisibleEntitiesClass")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RenderExtractedVisibleEntitiesClass](../struct.RenderExtractedVisibleEntitiesClass.html "struct bevy::render::view::RenderExtractedVisibleEntitiesClass")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RenderExtractedVisibleEntitiesClass](../struct.RenderExtractedVisibleEntitiesClass.html "struct bevy::render::view::RenderExtractedVisibleEntitiesClass")
