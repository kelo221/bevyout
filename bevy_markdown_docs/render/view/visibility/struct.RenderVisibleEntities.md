...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#45)
...
This component is only placed directly on camera entities. Lights instead have a [`RenderShadowMapVisibleEntities`](../struct.RenderShadowMapVisibleEntities.html "struct bevy::render::view::RenderShadowMapVisibleEntities") component that contains one or more [`RenderVisibleEntities`](../struct.RenderVisibleEntities.html "struct bevy::render::view::RenderVisibleEntities") components, one for each cascade or cubemap side.

The [`crate::camera::extract_cameras`](../../camera/fn.extract_cameras.html "fn bevy::render::camera::extract_cameras") and `extract_lights` systems create this object, but they don’t populate it. Instead, the [`collect_visible_cpu_culled_entities`](../fn.collect_visible_cpu_culled_entities.html "fn bevy::render::view::collect_visible_cpu_culled_entities") and `collect_gpu_culled_meshes` systems are responsible for updating this component from the lists of entities in [`RenderExtractedVisibleEntities`](../struct.RenderExtractedVisibleEntities.html "struct bevy::render::view::RenderExtractedVisibleEntities") and `RenderGpuCulledEntities`, respectively.

## Fields

`classes: [IndexMap](https://docs.rs/indexmap/2.14.0/x86_64-unknown-linux-gnu/indexmap/map/struct.IndexMap.html "struct indexmap::map::IndexMap")<[TypeId](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId"), [RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass"), [NoOpHash](../../../platform/hash/struct.NoOpHash.html "struct bevy::platform::hash::NoOpHash")>`

Entities visible from this view or subview, sorted by [`VisibilityClass`](../../../camera/visibility/struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass").

## Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#168)

### impl [RenderVisibleEntities](../struct.RenderVisibleEntities.html "struct bevy::render::view::RenderVisibleEntities")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#171-173)

#### pub fn [get](#method.get)<QF>(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[RenderVisibleEntitiesClass](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass")\>

where QF: 'static,

Returns the [`RenderVisibleEntitiesClass`](../struct.RenderVisibleEntitiesClass.html "struct bevy::render::view::RenderVisibleEntitiesClass") corresponding to the given [`VisibilityClass`](../../../camera/visibility/struct.VisibilityClass.html "struct bevy::camera::visibility::VisibilityClass").

##### [Examples found in repository](#scraped-examples)[?](../../../../scrape-examples-help.html)

examples/2d/mesh2d\_manual.rs ([line 405](../../../../src/mesh2d_manual/mesh2d_manual.rs.html#405))
...
examples/shader\_advanced/custom\_phase\_item.rs ([line 252](../../../../src/custom_phase_item/custom_phase_item.rs.html#252))
...
examples/shader\_advanced/custom\_render\_phase.rs ([line 559](../../../../src/custom_render_phase/custom_render_phase.rs.html#559))
...
examples/shader\_advanced/specialized\_mesh\_pipeline.rs ([line 315](../../../../src/specialized_mesh_pipeline/specialized_mesh_pipeline.rs.html#315))
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#44)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [RenderVisibleEntities](../struct.RenderVisibleEntities.html "struct bevy::render::view::RenderVisibleEntities")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#44)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [RenderVisibleEntities](../struct.RenderVisibleEntities.html "struct bevy::render::view::RenderVisibleEntities")
...
### impl [Component](../../../prelude/trait.Component.html "trait bevy::prelude::Component") for [RenderVisibleEntities](../struct.RenderVisibleEntities.html "struct bevy::render::view::RenderVisibleEntities")

where [RenderVisibleEntities](../struct.RenderVisibleEntities.html "struct bevy::render::view::RenderVisibleEntities"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [RenderVisibleEntities](../struct.RenderVisibleEntities.html "struct bevy::render::view::RenderVisibleEntities")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [RenderVisibleEntities](../struct.RenderVisibleEntities.html "struct bevy::render::view::RenderVisibleEntities")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/mod.rs.html#44)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [RenderVisibleEntities](../struct.RenderVisibleEntities.html "struct bevy::render::view::RenderVisibleEntities")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RenderVisibleEntities](../struct.RenderVisibleEntities.html "struct bevy::render::view::RenderVisibleEntities")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RenderVisibleEntities](../struct.RenderVisibleEntities.html "struct bevy::render::view::RenderVisibleEntities")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RenderVisibleEntities](../struct.RenderVisibleEntities.html "struct bevy::render::view::RenderVisibleEntities")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RenderVisibleEntities](../struct.RenderVisibleEntities.html "struct bevy::render::view::RenderVisibleEntities")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RenderVisibleEntities](../struct.RenderVisibleEntities.html "struct bevy::render::view::RenderVisibleEntities")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RenderVisibleEntities](../struct.RenderVisibleEntities.html "struct bevy::render::view::RenderVisibleEntities")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RenderVisibleEntities](../struct.RenderVisibleEntities.html "struct bevy::render::view::RenderVisibleEntities")
