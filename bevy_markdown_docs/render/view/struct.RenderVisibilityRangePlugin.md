...
# Struct RenderVisibilityRangePlugin 

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/range.rs.html#43)
...
### impl [Plugin](../../prelude/trait.Plugin.html "trait bevy::prelude::Plugin") for [RenderVisibilityRangePlugin](struct.RenderVisibilityRangePlugin.html "struct bevy::render::view::RenderVisibilityRangePlugin")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/visibility/range.rs.html#46)
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RenderVisibilityRangePlugin](struct.RenderVisibilityRangePlugin.html "struct bevy::render::view::RenderVisibilityRangePlugin")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RenderVisibilityRangePlugin](struct.RenderVisibilityRangePlugin.html "struct bevy::render::view::RenderVisibilityRangePlugin")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RenderVisibilityRangePlugin](struct.RenderVisibilityRangePlugin.html "struct bevy::render::view::RenderVisibilityRangePlugin")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RenderVisibilityRangePlugin](struct.RenderVisibilityRangePlugin.html "struct bevy::render::view::RenderVisibilityRangePlugin")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RenderVisibilityRangePlugin](struct.RenderVisibilityRangePlugin.html "struct bevy::render::view::RenderVisibilityRangePlugin")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RenderVisibilityRangePlugin](struct.RenderVisibilityRangePlugin.html "struct bevy::render::view::RenderVisibilityRangePlugin")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RenderVisibilityRangePlugin](struct.RenderVisibilityRangePlugin.html "struct bevy::render::view::RenderVisibilityRangePlugin")
