...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#401)
...
Color grading is applied just before tonemapping for a given [`Camera`](../../prelude/struct.Camera.html "struct bevy::prelude::Camera") entity, with the sole exception of the `post_saturation` value in [`ColorGradingGlobal`](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal"), which is applied after tonemapping.

## Fields

`global: [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")`
...
`shadows: [ColorGradingSection](struct.ColorGradingSection.html "struct bevy::render::view::ColorGradingSection")`

Color grading values that are applied to the darker parts of the image.

The cutoff points can be customized with the [`ColorGradingGlobal::midtones_range`](struct.ColorGradingGlobal.html#structfield.midtones_range "field bevy::render::view::ColorGradingGlobal::midtones_range") field.

`midtones: [ColorGradingSection](struct.ColorGradingSection.html "struct bevy::render::view::ColorGradingSection")`

Color grading values that are applied to the parts of the image with intermediate brightness.

The cutoff points can be customized with the [`ColorGradingGlobal::midtones_range`](struct.ColorGradingGlobal.html#structfield.midtones_range "field bevy::render::view::ColorGradingGlobal::midtones_range") field.

`highlights: [ColorGradingSection](struct.ColorGradingSection.html "struct bevy::render::view::ColorGradingSection")`
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#574)

### impl [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#577-580)

#### pub fn [with\_identical\_sections](#method.with_identical_sections)( global: [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal"), section: [ColorGradingSection](struct.ColorGradingSection.html "struct bevy::render::view::ColorGradingSection"), ) -> [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")

Creates a new [`ColorGrading`](struct.ColorGrading.html "struct bevy::render::view::ColorGrading") instance in which shadows, midtones, and highlights all have the same set of color grading values.

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/3d/tonemapping.rs ([lines 572-582](../../../src/tonemapping/tonemapping.rs.html#572-582))
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#591)

#### pub fn [all\_sections](#method.all_sections)(&self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = &[ColorGradingSection](struct.ColorGradingSection.html "struct bevy::render::view::ColorGradingSection")\>

Returns an iterator that visits the shadows, midtones, and highlights sections, in that order.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#600)

#### pub fn [all\_sections\_mut](#method.all_sections_mut)( &mut self, ) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = &mut [ColorGradingSection](struct.ColorGradingSection.html "struct bevy::render::view::ColorGradingSection")\>
...
examples/3d/tonemapping.rs ([line 367](../../../src/tonemapping/tonemapping.rs.html#367))
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#399)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")

where [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#399)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")
...
### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#399)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#399)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#399)

### impl [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#399)

#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")
...
where [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading"): 'into\_return,
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#400)
...
### impl [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#399)

#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
### impl [Struct](../../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")
...
### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ColorGrading](struct.ColorGrading.html "struct bevy::render::view::ColorGrading")
