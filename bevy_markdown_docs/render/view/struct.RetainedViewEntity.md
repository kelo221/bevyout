...
# Struct RetainedViewEntity 

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#275)
...
We can’t use [`Entity`](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") for this because render world entities aren’t stable, and we can’t use just [`MainEntity`](../sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity") because some main world views extract to multiple render world views. For example, a directional light extracts to one render world view per cascade, and a point light extracts to one render world view per cubemap face. So we pair the main entity with an _auxiliary entity_ and a _subview index_, which _together_ uniquely identify a view in the render world in a way that’s stable from frame to frame.

## Fields

`main_entity: [MainEntity](../sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity")`

The main entity that this view corresponds to.

`auxiliary_entity: [MainEntity](../sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity")`
...
`subview_index: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#298)

### impl [RetainedViewEntity](struct.RetainedViewEntity.html "struct bevy::render::view::RetainedViewEntity")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#304-308)

#### pub fn [new](#method.new)( main\_entity: [MainEntity](../sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity"), auxiliary\_entity: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[MainEntity](../sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity")\>, subview\_index: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html), ) -> [RetainedViewEntity](struct.RetainedViewEntity.html "struct bevy::render::view::RetainedViewEntity")

Creates a new [`RetainedViewEntity`](struct.RetainedViewEntity.html "struct bevy::render::view::RetainedViewEntity") from the given main world entity, auxiliary main world entity, and subview index.

See [`RetainedViewEntity::subview_index`](struct.RetainedViewEntity.html#structfield.subview_index "field bevy::render::view::RetainedViewEntity::subview_index") for an explanation of what `auxiliary_entity` and `subview_index` are.

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/shader\_advanced/custom\_render\_phase.rs ([line 511](../../../src/custom_render_phase/custom_render_phase.rs.html#511))
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#274)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [RetainedViewEntity](struct.RetainedViewEntity.html "struct bevy::render::view::RetainedViewEntity")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#274)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [RetainedViewEntity](struct.RetainedViewEntity.html "struct bevy::render::view::RetainedViewEntity")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [RetainedViewEntity](struct.RetainedViewEntity.html "struct bevy::render::view::RetainedViewEntity")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#274)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [RetainedViewEntity](struct.RetainedViewEntity.html "struct bevy::render::view::RetainedViewEntity")
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [RetainedViewEntity](struct.RetainedViewEntity.html "struct bevy::render::view::RetainedViewEntity")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#274)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [RetainedViewEntity](struct.RetainedViewEntity.html "struct bevy::render::view::RetainedViewEntity")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [RetainedViewEntity](struct.RetainedViewEntity.html "struct bevy::render::view::RetainedViewEntity")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#274)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[RetainedViewEntity](struct.RetainedViewEntity.html "struct bevy::render::view::RetainedViewEntity")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [RetainedViewEntity](struct.RetainedViewEntity.html "struct bevy::render::view::RetainedViewEntity")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RetainedViewEntity](struct.RetainedViewEntity.html "struct bevy::render::view::RetainedViewEntity")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RetainedViewEntity](struct.RetainedViewEntity.html "struct bevy::render::view::RetainedViewEntity")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RetainedViewEntity](struct.RetainedViewEntity.html "struct bevy::render::view::RetainedViewEntity")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RetainedViewEntity](struct.RetainedViewEntity.html "struct bevy::render::view::RetainedViewEntity")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RetainedViewEntity](struct.RetainedViewEntity.html "struct bevy::render::view::RetainedViewEntity")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RetainedViewEntity](struct.RetainedViewEntity.html "struct bevy::render::view::RetainedViewEntity")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RetainedViewEntity](struct.RetainedViewEntity.html "struct bevy::render::view::RetainedViewEntity")
