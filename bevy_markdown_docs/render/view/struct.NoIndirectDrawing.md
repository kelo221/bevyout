...
# Struct NoIndirectDrawing 

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#816)
...
Indirect mode, automatically enabled on supported hardware, allows Bevy to offload transform and cull operations to the GPU, reducing CPU overhead. Doing this, however, reduces the amount of control that your app has over instancing decisions. In certain circumstances, you may want to disable indirect drawing so that your app can manually instance meshes as it sees fit. See the `custom_shader_instancing` example.
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#815)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [NoIndirectDrawing](struct.NoIndirectDrawing.html "struct bevy::render::view::NoIndirectDrawing")

where [NoIndirectDrawing](struct.NoIndirectDrawing.html "struct bevy::render::view::NoIndirectDrawing"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [NoIndirectDrawing](struct.NoIndirectDrawing.html "struct bevy::render::view::NoIndirectDrawing")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#815)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [NoIndirectDrawing](struct.NoIndirectDrawing.html "struct bevy::render::view::NoIndirectDrawing")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [NoIndirectDrawing](struct.NoIndirectDrawing.html "struct bevy::render::view::NoIndirectDrawing")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [NoIndirectDrawing](struct.NoIndirectDrawing.html "struct bevy::render::view::NoIndirectDrawing")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [NoIndirectDrawing](struct.NoIndirectDrawing.html "struct bevy::render::view::NoIndirectDrawing")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [NoIndirectDrawing](struct.NoIndirectDrawing.html "struct bevy::render::view::NoIndirectDrawing")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [NoIndirectDrawing](struct.NoIndirectDrawing.html "struct bevy::render::view::NoIndirectDrawing")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [NoIndirectDrawing](struct.NoIndirectDrawing.html "struct bevy::render::view::NoIndirectDrawing")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [NoIndirectDrawing](struct.NoIndirectDrawing.html "struct bevy::render::view::NoIndirectDrawing")
