...
# Struct ViewDepthTexture 

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#976)
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#981)

### impl [ViewDepthTexture](struct.ViewDepthTexture.html "struct bevy::render::view::ViewDepthTexture")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#982)

#### pub fn [new](#method.new)(texture: [CachedTexture](../texture/struct.CachedTexture.html "struct bevy::render::texture::CachedTexture"), clear\_value: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)\>) -> [ViewDepthTexture](struct.ViewDepthTexture.html "struct bevy::render::view::ViewDepthTexture")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#989)
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#993)

#### pub fn [view](#method.view)(&self) -> &[TextureView](../render_resource/struct.TextureView.html "struct bevy::render::render_resource::TextureView")

## Trait Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#975)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [ViewDepthTexture](struct.ViewDepthTexture.html "struct bevy::render::view::ViewDepthTexture")

where [ViewDepthTexture](struct.ViewDepthTexture.html "struct bevy::render::view::ViewDepthTexture"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ViewDepthTexture](struct.ViewDepthTexture.html "struct bevy::render::view::ViewDepthTexture")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ViewDepthTexture](struct.ViewDepthTexture.html "struct bevy::render::view::ViewDepthTexture")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ViewDepthTexture](struct.ViewDepthTexture.html "struct bevy::render::view::ViewDepthTexture")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ViewDepthTexture](struct.ViewDepthTexture.html "struct bevy::render::view::ViewDepthTexture")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ViewDepthTexture](struct.ViewDepthTexture.html "struct bevy::render::view::ViewDepthTexture")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ViewDepthTexture](struct.ViewDepthTexture.html "struct bevy::render::view::ViewDepthTexture")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ViewDepthTexture](struct.ViewDepthTexture.html "struct bevy::render::view::ViewDepthTexture")
