...
# Struct ColorGradingGlobal 

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#430)
...
`exposure: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Exposure value (EV) offset, measured in stops.

`temperature: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

An adjustment made to the [CIE 1931](https://en.wikipedia.org/wiki/CIE_1931_color_space#CIE_xy_chromaticity_diagram_and_the_CIE_xyY_color_space) chromaticity _x_ value.

Positive values make the colors redder. Negative values make the colors bluer. This has no effect on luminance (brightness).

`tint: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

An adjustment made to the [CIE 1931](https://en.wikipedia.org/wiki/CIE_1931_color_space#CIE_xy_chromaticity_diagram_and_the_CIE_xyY_color_space) chromaticity _y_ value.

Positive values make the colors more magenta. Negative values make the colors greener. This has no effect on luminance (brightness).

`hue: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

An adjustment to the [hue](https://en.wikipedia.org/wiki/HSL_and_HSV#Formal_derivation), in radians.

Adjusting this value changes the perceived colors in the image: red to yellow to green to blue, etc. It has no effect on the saturation or brightness of the colors.

`post_saturation: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`
...
`midtones_range: [Range](https://doc.rust-lang.org/nightly/core/ops/range/struct.Range.html "struct core::ops::range::Range")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)>`

The luminance (brightness) ranges that are considered part of the “midtones” of the image.

This affects which [`ColorGradingSection`](struct.ColorGradingSection.html "struct bevy::render::view::ColorGradingSection")s apply to which colors. Note that the sections smoothly blend into one another, to avoid abrupt transitions.
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#428)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#549)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#550)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#428)

### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#428)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#428)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#428)

### impl [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#428)

#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")
...
where [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal"): 'into\_return,
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#428)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")\>, ) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#429)
...
### impl [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/view/mod.rs.html#428)

#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Struct](../../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")
...
### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ColorGradingGlobal](struct.ColorGradingGlobal.html "struct bevy::render::view::ColorGradingGlobal")
