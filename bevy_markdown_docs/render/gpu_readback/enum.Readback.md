...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/gpu_readback.rs.html#77)
...
Data is read asynchronously and will be triggered on the entity via the [`ReadbackComplete`](struct.ReadbackComplete.html "struct bevy::render::gpu_readback::ReadbackComplete") event when complete. If this component is not removed, the readback will be attempted every frame

## Variants

### Texture([Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Image](../../prelude/struct.Image.html "struct bevy::prelude::Image")\>)

### Buffer

#### Fields

`buffer: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[ShaderBuffer](../storage/struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")>`

`start_offset_and_size: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<([u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html), [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html))>`

## Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/gpu_readback.rs.html#86)

### impl [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/gpu_readback.rs.html#88)

#### pub fn [texture](#method.texture)(image: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Image](../../prelude/struct.Image.html "struct bevy::prelude::Image")\>) -> [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback")

Create a readback component for a texture using the given handle.

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/shader/gpu\_readback.rs ([line 128](../../../src/gpu_readback/gpu_readback.rs.html#128))
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/gpu_readback.rs.html#93)

#### pub fn [buffer](#method.buffer)(buffer: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[ShaderBuffer](../storage/struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")\>) -> [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback")

Create a readback component for a full buffer using the given handle.

##### [Examples found in repository](#scraped-examples-1)[?](../../../scrape-examples-help.html)

examples/shader/gpu\_readback.rs ([line 102](../../../src/gpu_readback/gpu_readback.rs.html#102))
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/gpu_readback.rs.html#102)

#### pub fn [buffer\_range](#method.buffer_range)( buffer: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[ShaderBuffer](../storage/struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")\>, start\_offset: [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html), size: [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html), ) -> [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback")
...
examples/shader/gpu\_readback.rs ([lines 112-116](../../../src/gpu_readback/gpu_readback.rs.html#112-116))
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/gpu_readback.rs.html#76)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback")

where [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
#### fn [map\_entities](../../prelude/trait.Component.html#method.map_entities)<M>(this: &mut [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback"), mapper: [&mut M](https://doc.rust-lang.org/nightly/std/primitive.reference.html))
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback")
...
### impl [ExtractComponent](../extract_component/trait.ExtractComponent.html "trait bevy::render::extract_component::ExtractComponent") for [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback")

where [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback"): [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/gpu_readback.rs.html#76)

#### type [QueryData](../extract_component/trait.ExtractComponent.html#associatedtype.QueryData) = &'static [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback")
...
#### type [Out](../extract_component/trait.ExtractComponent.html#associatedtype.Out) = [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback")
...
#### fn [extract\_component](../extract_component/trait.ExtractComponent.html#tymethod.extract_component)( item: <<[Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback") as [ExtractComponent](../extract_component/trait.ExtractComponent.html "trait bevy::render::extract_component::ExtractComponent")\>::[QueryData](../extract_component/trait.ExtractComponent.html#associatedtype.QueryData "type bevy::render::extract_component::ExtractComponent::QueryData") as [QueryData](../../ecs/query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../../ecs/query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'\_, '\_>, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback") as [ExtractComponent](../extract_component/trait.ExtractComponent.html "trait bevy::render::extract_component::ExtractComponent")\>::[Out](../extract_component/trait.ExtractComponent.html#associatedtype.Out "type bevy::render::extract_component::ExtractComponent::Out")\>
...
### impl [FromTemplate](../../prelude/trait.FromTemplate.html "trait bevy::prelude::FromTemplate") for [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/gpu_readback.rs.html#76)

#### type [Template](../../prelude/trait.FromTemplate.html#associatedtype.Template) = [ReadbackTemplate](enum.ReadbackTemplate.html "enum bevy::render::gpu_readback::ReadbackTemplate")

The [`Template`](../../prelude/trait.Template.html "trait bevy::prelude::Template") for this type.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/gpu_readback.rs.html#76)

### impl [SyncComponent](../sync_component/trait.SyncComponent.html "trait bevy::render::sync_component::SyncComponent") for [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback")

where [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback"): [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/gpu_readback.rs.html#76)

#### type [Target](../sync_component/trait.SyncComponent.html#associatedtype.Target) = [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback")

Describes what components should be removed from the render world if the implementing component is removed.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/gpu_readback.rs.html#76)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Readback](enum.Readback.html "enum bevy::render::gpu_readback::Readback")
