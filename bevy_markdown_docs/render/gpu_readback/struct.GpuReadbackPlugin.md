...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/gpu_readback.rs.html#36)

```rust
pub struct GpuReadbackPlugin { /* private fields */ }
```
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/gpu_readback.rs.html#42)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [GpuReadbackPlugin](struct.GpuReadbackPlugin.html "struct bevy::render::gpu_readback::GpuReadbackPlugin")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/gpu_readback.rs.html#43)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [GpuReadbackPlugin](struct.GpuReadbackPlugin.html "struct bevy::render::gpu_readback::GpuReadbackPlugin")
...
### impl [Plugin](../../prelude/trait.Plugin.html "trait bevy::prelude::Plugin") for [GpuReadbackPlugin](struct.GpuReadbackPlugin.html "struct bevy::render::gpu_readback::GpuReadbackPlugin")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/gpu_readback.rs.html#51)
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [GpuReadbackPlugin](struct.GpuReadbackPlugin.html "struct bevy::render::gpu_readback::GpuReadbackPlugin")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [GpuReadbackPlugin](struct.GpuReadbackPlugin.html "struct bevy::render::gpu_readback::GpuReadbackPlugin")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [GpuReadbackPlugin](struct.GpuReadbackPlugin.html "struct bevy::render::gpu_readback::GpuReadbackPlugin")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [GpuReadbackPlugin](struct.GpuReadbackPlugin.html "struct bevy::render::gpu_readback::GpuReadbackPlugin")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [GpuReadbackPlugin](struct.GpuReadbackPlugin.html "struct bevy::render::gpu_readback::GpuReadbackPlugin")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [GpuReadbackPlugin](struct.GpuReadbackPlugin.html "struct bevy::render::gpu_readback::GpuReadbackPlugin")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [GpuReadbackPlugin](struct.GpuReadbackPlugin.html "struct bevy::render::gpu_readback::GpuReadbackPlugin")
