...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#155)
...
This is used for applying the commands from the [`ExtractSchedule`](../prelude/struct.ExtractSchedule.html "struct bevy::prelude::ExtractSchedule")
...
A sub-set within [`Queue`](enum.RenderSystems.html#variant.Queue "variant bevy::render::RenderSystems::Queue") where mesh entity queue systems are executed. Ensures `prepare_assets::<RenderMesh>` is completed.

### QueueSweep

A sub-set within [`Queue`](enum.RenderSystems.html#variant.Queue "variant bevy::render::RenderSystems::Queue") where meshes that have become invisible or changed phases are removed from the bins.

### PhaseSort

Sort the [`SortedRenderPhase`](render_phase/struct.SortedRenderPhase.html "struct bevy::render::render_phase::SortedRenderPhase")s and [`BinKey`](render_phase/trait.BinnedPhaseItem.html#associatedtype.BinKey "associated type bevy::render::render_phase::BinnedPhaseItem::BinKey")s here.

### Prepare

Prepare render resources from extracted data for the GPU based on their sorted order. Create [`BindGroups`](render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup") that depend on those data.

### PrepareResources

A sub-set within [`Prepare`](enum.RenderSystems.html#variant.Prepare "variant bevy::render::RenderSystems::Prepare") for initializing buffers, textures and uniforms for use in bind groups.

### PrepareResourcesBatchPhases

A sub-set within [`Prepare`](enum.RenderSystems.html#variant.Prepare "variant bevy::render::RenderSystems::Prepare") that creates batches for render phases.

### PrepareResourcesWritePhaseBuffers

A sub-set within [`Prepare`](enum.RenderSystems.html#variant.Prepare "variant bevy::render::RenderSystems::Prepare") that writes batches for render phases to the GPU.

### PrepareResourcesCollectPhaseBuffers

A sub-set within [`Prepare`](enum.RenderSystems.html#variant.Prepare "variant bevy::render::RenderSystems::Prepare") to collect phase buffers after [`PrepareResourcesBatchPhases`](enum.RenderSystems.html#variant.PrepareResourcesBatchPhases "variant bevy::render::RenderSystems::PrepareResourcesBatchPhases") has run.

### PrepareResourcesFlush

Flush buffers after [`PrepareResources`](enum.RenderSystems.html#variant.PrepareResources "variant bevy::render::RenderSystems::PrepareResources"), but before [`PrepareBindGroups`](enum.RenderSystems.html#variant.PrepareBindGroups "variant bevy::render::RenderSystems::PrepareBindGroups").

### PrepareBindGroups

A sub-set within [`Prepare`](enum.RenderSystems.html#variant.Prepare "variant bevy::render::RenderSystems::Prepare") for constructing bind groups, or other data that relies on render resources prepared in [`PrepareResources`](enum.RenderSystems.html#variant.PrepareResources "variant bevy::render::RenderSystems::PrepareResources").
...
Final cleanup occurs: any entities with [`TemporaryRenderEntity`](sync_world/struct.TemporaryRenderEntity.html "struct bevy::render::sync_world::TemporaryRenderEntity") will be despawned.

Runs after [`Cleanup`](enum.RenderSystems.html#variant.Cleanup "variant bevy::render::RenderSystems::Cleanup").

## Trait Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#154)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [RenderSystems](enum.RenderSystems.html "enum bevy::render::RenderSystems")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#154)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [RenderSystems](enum.RenderSystems.html "enum bevy::render::RenderSystems")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [RenderSystems](enum.RenderSystems.html "enum bevy::render::RenderSystems")
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [RenderSystems](enum.RenderSystems.html "enum bevy::render::RenderSystems")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#154)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [RenderSystems](enum.RenderSystems.html "enum bevy::render::RenderSystems")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [RenderSystems](enum.RenderSystems.html "enum bevy::render::RenderSystems")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#154)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[RenderSystems](enum.RenderSystems.html "enum bevy::render::RenderSystems")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [RenderSystems](enum.RenderSystems.html "enum bevy::render::RenderSystems")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/lib.rs.html#154)

### impl [SystemSet](../prelude/trait.SystemSet.html "trait bevy::prelude::SystemSet") for [RenderSystems](enum.RenderSystems.html "enum bevy::render::RenderSystems")

where [RenderSystems](enum.RenderSystems.html "enum bevy::render::RenderSystems"): 'static + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") + [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") + [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") + [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash"),
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RenderSystems](enum.RenderSystems.html "enum bevy::render::RenderSystems")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RenderSystems](enum.RenderSystems.html "enum bevy::render::RenderSystems")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RenderSystems](enum.RenderSystems.html "enum bevy::render::RenderSystems")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RenderSystems](enum.RenderSystems.html "enum bevy::render::RenderSystems")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RenderSystems](enum.RenderSystems.html "enum bevy::render::RenderSystems")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RenderSystems](enum.RenderSystems.html "enum bevy::render::RenderSystems")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RenderSystems](enum.RenderSystems.html "enum bevy::render::RenderSystems")
