...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/draw.rs.html#57)

```rust
pub struct DrawFunctionsInternal<P>where
    P: PhaseItem,{
    pub draw_functions: Vec<Box<dyn Draw<P>>>,
    pub indices: IndexMap<TypeId, DrawFunctionId, NoOpHash>,
}
```
...
For retrieval, the [`Draw`](trait.Draw.html "trait bevy::render::render_phase::Draw") functions are mapped to their respective [`TypeId`](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId")s.

## Fields

`draw_functions: [Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Draw](trait.Draw.html "trait bevy::render::render_phase::Draw")<P>>>``indices: [IndexMap](https://docs.rs/indexmap/2.14.0/x86_64-unknown-linux-gnu/indexmap/map/struct.IndexMap.html "struct indexmap::map::IndexMap")<[TypeId](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId"), [DrawFunctionId](../../material/labels/struct.DrawFunctionId.html "struct bevy::material::labels::DrawFunctionId"), [NoOpHash](../../platform/hash/struct.NoOpHash.html "struct bevy::platform::hash::NoOpHash")>`

## Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/draw.rs.html#62)

### impl<P> [DrawFunctionsInternal](struct.DrawFunctionsInternal.html "struct bevy::render::render_phase::DrawFunctionsInternal")<P>

where P: [PhaseItem](trait.PhaseItem.html "trait bevy::render::render_phase::PhaseItem"),

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/draw.rs.html#64)

#### pub fn [prepare](#method.prepare)(&mut self, world: &[World](../../prelude/struct.World.html "struct bevy::prelude::World"))

Prepares all draw function. This is called once and only once before the phase begins.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/draw.rs.html#71)

#### pub fn [add](#method.add)<T>(&mut self, draw\_function: T) -> [DrawFunctionId](../../material/labels/struct.DrawFunctionId.html "struct bevy::material::labels::DrawFunctionId")

where T: [Draw](trait.Draw.html "trait bevy::render::render_phase::Draw")<P>,

Adds the [`Draw`](trait.Draw.html "trait bevy::render::render_phase::Draw") function and maps it to its own type.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/draw.rs.html#76)

#### pub fn [add\_with](#method.add_with)<T, D>(&mut self, draw\_function: D) -> [DrawFunctionId](../../material/labels/struct.DrawFunctionId.html "struct bevy::material::labels::DrawFunctionId")

where T: 'static, D: [Draw](trait.Draw.html "trait bevy::render::render_phase::Draw")<P>,

Adds the [`Draw`](trait.Draw.html "trait bevy::render::render_phase::Draw") function and maps it to the type `T`

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/draw.rs.html#84)

#### pub fn [get\_mut](#method.get_mut)( &mut self, id: [DrawFunctionId](../../material/labels/struct.DrawFunctionId.html "struct bevy::material::labels::DrawFunctionId"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&mut (dyn [Draw](trait.Draw.html "trait bevy::render::render_phase::Draw")<P> + 'static)>

Retrieves the [`Draw`](trait.Draw.html "trait bevy::render::render_phase::Draw") function corresponding to the `id` mutably.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/draw.rs.html#89)

#### pub fn [get\_id](#method.get_id)<T>(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[DrawFunctionId](../../material/labels/struct.DrawFunctionId.html "struct bevy::material::labels::DrawFunctionId")\>

where T: 'static,

Retrieves the id of the [`Draw`](trait.Draw.html "trait bevy::render::render_phase::Draw") function corresponding to their associated type `T`.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/draw.rs.html#99)

#### pub fn [id](#method.id)<T>(&self) -> [DrawFunctionId](../../material/labels/struct.DrawFunctionId.html "struct bevy::material::labels::DrawFunctionId")

where T: 'static,

Retrieves the id of the [`Draw`](trait.Draw.html "trait bevy::render::render_phase::Draw") function corresponding to their associated type `T`.

Fallible wrapper for [`Self::get_id()`](struct.DrawFunctionsInternal.html#method.get_id "method bevy::render::render_phase::DrawFunctionsInternal::get_id")
...
examples/shader\_advanced/manual\_material.rs ([line 159](../../../src/manual_material/manual_material.rs.html#159))
...
examples/shader\_advanced/custom\_shader\_instancing.rs ([line 152](../../../src/custom_shader_instancing/custom_shader_instancing.rs.html#152))
...
examples/2d/mesh2d\_manual.rs ([line 399](../../../src/mesh2d_manual/mesh2d_manual.rs.html#399))
...
examples/shader\_advanced/custom\_phase\_item.rs ([line 238](../../../src/custom_phase_item/custom_phase_item.rs.html#238))
...
examples/shader\_advanced/custom\_render\_phase.rs ([line 552](../../../src/custom_render_phase/custom_render_phase.rs.html#552))
...
examples/shader\_advanced/specialized\_mesh\_pipeline.rs ([line 300](../../../src/specialized_mesh_pipeline/specialized_mesh_pipeline.rs.html#300))
...
### impl<P> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DrawFunctionsInternal](struct.DrawFunctionsInternal.html "struct bevy::render::render_phase::DrawFunctionsInternal")<P>

### impl<P> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DrawFunctionsInternal](struct.DrawFunctionsInternal.html "struct bevy::render::render_phase::DrawFunctionsInternal")<P>

### impl<P> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DrawFunctionsInternal](struct.DrawFunctionsInternal.html "struct bevy::render::render_phase::DrawFunctionsInternal")<P>

### impl<P> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DrawFunctionsInternal](struct.DrawFunctionsInternal.html "struct bevy::render::render_phase::DrawFunctionsInternal")<P>

### impl<P> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DrawFunctionsInternal](struct.DrawFunctionsInternal.html "struct bevy::render::render_phase::DrawFunctionsInternal")<P>

### impl<P> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DrawFunctionsInternal](struct.DrawFunctionsInternal.html "struct bevy::render::render_phase::DrawFunctionsInternal")<P>

### impl<P> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DrawFunctionsInternal](struct.DrawFunctionsInternal.html "struct bevy::render::render_phase::DrawFunctionsInternal")<P>
