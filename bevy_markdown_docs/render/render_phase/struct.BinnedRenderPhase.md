...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#110)

```rust
pub struct BinnedRenderPhase<BPI>where
    BPI: BinnedPhaseItem,{
    pub multidrawable_meshes: IndexMap<<BPI as BinnedPhaseItem>::BatchSetKey, RenderMultidrawableBatchSet<BPI>>,
    pub batchable_meshes: IndexMap<(<BPI as BinnedPhaseItem>::BatchSetKey, <BPI as BinnedPhaseItem>::BinKey), RenderBin>,
    pub unbatchable_meshes: IndexMap<(<BPI as BinnedPhaseItem>::BatchSetKey, <BPI as BinnedPhaseItem>::BinKey), UnbatchableBinnedEntities>,
    pub non_mesh_items: IndexMap<(<BPI as BinnedPhaseItem>::BatchSetKey, <BPI as BinnedPhaseItem>::BinKey), NonMeshEntities>,
    /* private fields */
}
```
...
Each view (camera, or shadow-casting light, etc.) can have one or multiple render phases. They are used to queue entities for rendering. Multiple phases might be required due to different sorting/batching behaviors (e.g. opaque: front to back, transparent: back to front) or because one phase depends on the rendered texture of the previous phase (e.g. for screen-space reflections). All [`PhaseItem`](trait.PhaseItem.html "trait bevy::render::render_phase::PhaseItem")s are then rendered using a single [`TrackedRenderPass`](struct.TrackedRenderPass.html "struct bevy::render::render_phase::TrackedRenderPass"). The render pass might be reused for multiple phases to reduce GPU overhead.

This flavor of render phase is used for phases in which the ordering is less critical: for example, `Opaque3d`. It’s generally faster than the alternative [`SortedRenderPhase`](struct.SortedRenderPhase.html "struct bevy::render::render_phase::SortedRenderPhase").

## Fields

`multidrawable_meshes: [IndexMap](https://docs.rs/indexmap/2.14.0/x86_64-unknown-linux-gnu/indexmap/map/struct.IndexMap.html "struct indexmap::map::IndexMap")<<BPI as [BinnedPhaseItem](trait.BinnedPhaseItem.html "trait bevy::render::render_phase::BinnedPhaseItem")>::[BatchSetKey](trait.BinnedPhaseItem.html#associatedtype.BatchSetKey "type bevy::render::render_phase::BinnedPhaseItem::BatchSetKey"), [RenderMultidrawableBatchSet](struct.RenderMultidrawableBatchSet.html "struct bevy::render::render_phase::RenderMultidrawableBatchSet")<BPI>>`

The multidrawable bins.

Each batch set key maps to a _batch set_, which in this case is a set of meshes that can be drawn together in one multidraw call. Each batch set is subdivided into _bins_, each of which represents a particular mesh. Each bin contains the entity IDs of instances of that mesh.
...
`batchable_meshes: [IndexMap](https://docs.rs/indexmap/2.14.0/x86_64-unknown-linux-gnu/indexmap/map/struct.IndexMap.html "struct indexmap::map::IndexMap")<(<BPI as [BinnedPhaseItem](trait.BinnedPhaseItem.html "trait bevy::render::render_phase::BinnedPhaseItem")>::[BatchSetKey](trait.BinnedPhaseItem.html#associatedtype.BatchSetKey "type bevy::render::render_phase::BinnedPhaseItem::BatchSetKey"), <BPI as [BinnedPhaseItem](trait.BinnedPhaseItem.html "trait bevy::render::render_phase::BinnedPhaseItem")>::[BinKey](trait.BinnedPhaseItem.html#associatedtype.BinKey "type bevy::render::render_phase::BinnedPhaseItem::BinKey")), [RenderBin](struct.RenderBin.html "struct bevy::render::render_phase::RenderBin")>`
...
`unbatchable_meshes: [IndexMap](https://docs.rs/indexmap/2.14.0/x86_64-unknown-linux-gnu/indexmap/map/struct.IndexMap.html "struct indexmap::map::IndexMap")<(<BPI as [BinnedPhaseItem](trait.BinnedPhaseItem.html "trait bevy::render::render_phase::BinnedPhaseItem")>::[BatchSetKey](trait.BinnedPhaseItem.html#associatedtype.BatchSetKey "type bevy::render::render_phase::BinnedPhaseItem::BatchSetKey"), <BPI as [BinnedPhaseItem](trait.BinnedPhaseItem.html "trait bevy::render::render_phase::BinnedPhaseItem")>::[BinKey](trait.BinnedPhaseItem.html#associatedtype.BinKey "type bevy::render::render_phase::BinnedPhaseItem::BinKey")), [UnbatchableBinnedEntities](struct.UnbatchableBinnedEntities.html "struct bevy::render::render_phase::UnbatchableBinnedEntities")>`

The unbatchable bins.

Each entity here is rendered in a separate drawcall.

`non_mesh_items: [IndexMap](https://docs.rs/indexmap/2.14.0/x86_64-unknown-linux-gnu/indexmap/map/struct.IndexMap.html "struct indexmap::map::IndexMap")<(<BPI as [BinnedPhaseItem](trait.BinnedPhaseItem.html "trait bevy::render::render_phase::BinnedPhaseItem")>::[BatchSetKey](trait.BinnedPhaseItem.html#associatedtype.BatchSetKey "type bevy::render::render_phase::BinnedPhaseItem::BatchSetKey"), <BPI as [BinnedPhaseItem](trait.BinnedPhaseItem.html "trait bevy::render::render_phase::BinnedPhaseItem")>::[BinKey](trait.BinnedPhaseItem.html#associatedtype.BinKey "type bevy::render::render_phase::BinnedPhaseItem::BinKey")), [NonMeshEntities](struct.NonMeshEntities.html "struct bevy::render::render_phase::NonMeshEntities")>`
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#944-946)

### impl<BPI> [BinnedRenderPhase](struct.BinnedRenderPhase.html "struct bevy::render::render_phase::BinnedRenderPhase")<BPI>

where BPI: [BinnedPhaseItem](trait.BinnedPhaseItem.html "trait bevy::render::render_phase::BinnedPhaseItem"),

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#953-960)

#### pub fn [add](#method.add)( &mut self, batch\_set\_key: <BPI as [BinnedPhaseItem](trait.BinnedPhaseItem.html "trait bevy::render::render_phase::BinnedPhaseItem")\>::[BatchSetKey](trait.BinnedPhaseItem.html#associatedtype.BatchSetKey "type bevy::render::render_phase::BinnedPhaseItem::BatchSetKey"), bin\_key: <BPI as [BinnedPhaseItem](trait.BinnedPhaseItem.html "trait bevy::render::render_phase::BinnedPhaseItem")\>::[BinKey](trait.BinnedPhaseItem.html#associatedtype.BinKey "type bevy::render::render_phase::BinnedPhaseItem::BinKey"), \_: ([Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), [MainEntity](../sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity")), input\_uniform\_index: [InputUniformIndex](struct.InputUniformIndex.html "struct bevy::render::render_phase::InputUniformIndex"), phase\_type: [BinnedRenderPhaseType](enum.BinnedRenderPhaseType.html "enum bevy::render::render_phase::BinnedRenderPhaseType"), )
...
examples/shader\_advanced/custom\_phase\_item.rs ([lines 294-308](../../../src/custom_phase_item/custom_phase_item.rs.html#294-308))
...
examples/shader\_advanced/specialized\_mesh\_pipeline.rs ([lines 385-407](../../../src/specialized_mesh_pipeline/specialized_mesh_pipeline.rs.html#385-407))
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#1048-1052)

#### pub fn [update\_cache](#method.update_cache)( &mut self, main\_entity: [MainEntity](../sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity"), cached\_bin\_key: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[CachedBinKey](struct.CachedBinKey.html "struct bevy::render::render_phase::CachedBinKey")<BPI>>, )

Inserts an entity into the cache with the given change tick.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#1059-1064)

#### pub fn [render](#method.render)<'w>( &self, render\_pass: &mut [TrackedRenderPass](struct.TrackedRenderPass.html "struct bevy::render::render_phase::TrackedRenderPass")<'w>, world: &'w [World](../../prelude/struct.World.html "struct bevy::prelude::World"), view: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [DrawError](enum.DrawError.html "enum bevy::render::render_phase::DrawError")\>

Encodes the GPU commands needed to render all entities in this phase.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#1302)

#### pub fn [is\_empty](#method.is_empty)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#1309)

#### pub fn [prepare\_for\_new\_frame](#method.prepare_for_new_frame)(&mut self)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#1320)

#### pub fn [remove](#method.remove)(&mut self, main\_entity: [MainEntity](../sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity"))
...
examples/shader\_advanced/custom\_phase\_item.rs ([line 265](../../../src/custom_phase_item/custom_phase_item.rs.html#265))
...
examples/shader\_advanced/specialized\_mesh\_pipeline.rs ([line 328](../../../src/specialized_mesh_pipeline/specialized_mesh_pipeline.rs.html#328))
...
### impl<BPI> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [BinnedRenderPhase](struct.BinnedRenderPhase.html "struct bevy::render::render_phase::BinnedRenderPhase")<BPI>

### impl<BPI> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [BinnedRenderPhase](struct.BinnedRenderPhase.html "struct bevy::render::render_phase::BinnedRenderPhase")<BPI>

### impl<BPI> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [BinnedRenderPhase](struct.BinnedRenderPhase.html "struct bevy::render::render_phase::BinnedRenderPhase")<BPI>

### impl<BPI> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [BinnedRenderPhase](struct.BinnedRenderPhase.html "struct bevy::render::render_phase::BinnedRenderPhase")<BPI>

### impl<BPI> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [BinnedRenderPhase](struct.BinnedRenderPhase.html "struct bevy::render::render_phase::BinnedRenderPhase")<BPI>

### impl<BPI> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [BinnedRenderPhase](struct.BinnedRenderPhase.html "struct bevy::render::render_phase::BinnedRenderPhase")<BPI>

where <BPI as [BinnedPhaseItem](trait.BinnedPhaseItem.html "trait bevy::render::render_phase::BinnedPhaseItem")\>::[BinKey](trait.BinnedPhaseItem.html#associatedtype.BinKey "type bevy::render::render_phase::BinnedPhaseItem::BinKey"): [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"), <BPI as [BinnedPhaseItem](trait.BinnedPhaseItem.html "trait bevy::render::render_phase::BinnedPhaseItem")\>::[BatchSetKey](trait.BinnedPhaseItem.html#associatedtype.BatchSetKey "type bevy::render::render_phase::BinnedPhaseItem::BatchSetKey"): [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<BPI> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [BinnedRenderPhase](struct.BinnedRenderPhase.html "struct bevy::render::render_phase::BinnedRenderPhase")<BPI>
