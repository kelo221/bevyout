...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#2146)
...
#### type [Param](trait.RenderCommand.html#associatedtype.Param) = [Res](../../prelude/struct.Res.html "struct bevy::prelude::Res")<'static, [PipelineCache](../render_resource/struct.PipelineCache.html "struct bevy::render::render_resource::PipelineCache")\>

Specifies the general ECS data (e.g. resources) required by [`RenderCommand::render`](trait.RenderCommand.html#tymethod.render "associated function bevy::render::render_phase::RenderCommand::render"). [Read more](trait.RenderCommand.html#associatedtype.Param)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#2150)

#### type [ViewQuery](trait.RenderCommand.html#associatedtype.ViewQuery) = [()](https://doc.rust-lang.org/nightly/std/primitive.unit.html)

Specifies the ECS data of the view entity required by [`RenderCommand::render`](trait.RenderCommand.html#tymethod.render "associated function bevy::render::render_phase::RenderCommand::render"). [Read more](trait.RenderCommand.html#associatedtype.ViewQuery)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#2151)

#### type [ItemQuery](trait.RenderCommand.html#associatedtype.ItemQuery) = [()](https://doc.rust-lang.org/nightly/std/primitive.unit.html)

Specifies the ECS data of the item entity required by [`RenderCommand::render`](trait.RenderCommand.html#tymethod.render "associated function bevy::render::render_phase::RenderCommand::render"). [Read more](trait.RenderCommand.html#associatedtype.ItemQuery)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#2153-2159)

#### fn [render](trait.RenderCommand.html#tymethod.render)<'w>( item: [&P](https://doc.rust-lang.org/nightly/std/primitive.reference.html), \_view: [()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), \_entity: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html)\>, pipeline\_cache: <<[SetItemPipeline](struct.SetItemPipeline.html "struct bevy::render::render_phase::SetItemPipeline") as [RenderCommand](trait.RenderCommand.html "trait bevy::render::render_phase::RenderCommand")<P>>::[Param](trait.RenderCommand.html#associatedtype.Param "type bevy::render::render_phase::RenderCommand::Param") as [SystemParam](../../ecs/system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[Item](../../ecs/system/trait.SystemParam.html#associatedtype.Item "type bevy::ecs::system::SystemParam::Item")<'w, '\_>, pass: &mut [TrackedRenderPass](struct.TrackedRenderPass.html "struct bevy::render::render_phase::TrackedRenderPass")<'w>, ) -> [RenderCommandResult](enum.RenderCommandResult.html "enum bevy::render::render_phase::RenderCommandResult")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SetItemPipeline](struct.SetItemPipeline.html "struct bevy::render::render_phase::SetItemPipeline")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SetItemPipeline](struct.SetItemPipeline.html "struct bevy::render::render_phase::SetItemPipeline")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SetItemPipeline](struct.SetItemPipeline.html "struct bevy::render::render_phase::SetItemPipeline")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SetItemPipeline](struct.SetItemPipeline.html "struct bevy::render::render_phase::SetItemPipeline")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SetItemPipeline](struct.SetItemPipeline.html "struct bevy::render::render_phase::SetItemPipeline")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SetItemPipeline](struct.SetItemPipeline.html "struct bevy::render::render_phase::SetItemPipeline")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SetItemPipeline](struct.SetItemPipeline.html "struct bevy::render::render_phase::SetItemPipeline")
