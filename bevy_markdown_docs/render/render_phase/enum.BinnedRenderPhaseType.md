...
# Enum BinnedRenderPhaseType 

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#869)
...
The item is a mesh that’s eligible for multi-draw indirect rendering and can be batched with other meshes of the same type.

### BatchableMesh

The item is a mesh that can be batched with other meshes of the same type and drawn in a single draw call.

### UnbatchableMesh

The item is a mesh that’s eligible for indirect rendering, but can’t be batched with other meshes of the same type.

### NonMesh

The item isn’t a mesh at all.

Bevy will simply invoke the drawing commands for such items one after another, with no further processing.

The engine itself doesn’t enqueue any items of this type, but it’s available for use in your application and/or plugins.

## Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#2189)

### impl [BinnedRenderPhaseType](enum.BinnedRenderPhaseType.html "enum bevy::render::render_phase::BinnedRenderPhaseType")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#2190-2193)

#### pub fn [mesh](#method.mesh)( batchable: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), gpu\_preprocessing\_support: &[GpuPreprocessingSupport](../batching/gpu_preprocessing/struct.GpuPreprocessingSupport.html "struct bevy::render::batching::gpu_preprocessing::GpuPreprocessingSupport"), ) -> [BinnedRenderPhaseType](enum.BinnedRenderPhaseType.html "enum bevy::render::render_phase::BinnedRenderPhaseType")

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/shader\_advanced/specialized\_mesh\_pipeline.rs ([lines 403-406](../../../src/specialized_mesh_pipeline/specialized_mesh_pipeline.rs.html#403-406))
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#868)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [BinnedRenderPhaseType](enum.BinnedRenderPhaseType.html "enum bevy::render::render_phase::BinnedRenderPhaseType")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#868)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [BinnedRenderPhaseType](enum.BinnedRenderPhaseType.html "enum bevy::render::render_phase::BinnedRenderPhaseType")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [BinnedRenderPhaseType](enum.BinnedRenderPhaseType.html "enum bevy::render::render_phase::BinnedRenderPhaseType")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#868)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [BinnedRenderPhaseType](enum.BinnedRenderPhaseType.html "enum bevy::render::render_phase::BinnedRenderPhaseType")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [BinnedRenderPhaseType](enum.BinnedRenderPhaseType.html "enum bevy::render::render_phase::BinnedRenderPhaseType")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#868)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[BinnedRenderPhaseType](enum.BinnedRenderPhaseType.html "enum bevy::render::render_phase::BinnedRenderPhaseType")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [BinnedRenderPhaseType](enum.BinnedRenderPhaseType.html "enum bevy::render::render_phase::BinnedRenderPhaseType")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [BinnedRenderPhaseType](enum.BinnedRenderPhaseType.html "enum bevy::render::render_phase::BinnedRenderPhaseType")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [BinnedRenderPhaseType](enum.BinnedRenderPhaseType.html "enum bevy::render::render_phase::BinnedRenderPhaseType")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [BinnedRenderPhaseType](enum.BinnedRenderPhaseType.html "enum bevy::render::render_phase::BinnedRenderPhaseType")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [BinnedRenderPhaseType](enum.BinnedRenderPhaseType.html "enum bevy::render::render_phase::BinnedRenderPhaseType")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [BinnedRenderPhaseType](enum.BinnedRenderPhaseType.html "enum bevy::render::render_phase::BinnedRenderPhaseType")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [BinnedRenderPhaseType](enum.BinnedRenderPhaseType.html "enum bevy::render::render_phase::BinnedRenderPhaseType")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [BinnedRenderPhaseType](enum.BinnedRenderPhaseType.html "enum bevy::render::render_phase::BinnedRenderPhaseType")
