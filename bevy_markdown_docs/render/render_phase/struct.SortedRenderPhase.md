...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#1783)
...
This flavor of render phase is used only for meshes that need to be sorted back-to-front, such as transparent meshes. For items that don’t need strict sorting, [`BinnedRenderPhase`](struct.BinnedRenderPhase.html "struct bevy::render::render_phase::BinnedRenderPhase") is preferred, for performance.

## Fields

`items: [IndexMap](https://docs.rs/indexmap/2.14.0/x86_64-unknown-linux-gnu/indexmap/map/struct.IndexMap.html "struct indexmap::map::IndexMap")<([Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), [MainEntity](../sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity")), I, [EntityHash](../../ecs/entity/struct.EntityHash.html "struct bevy::ecs::entity::EntityHash")>`

The items within this [`SortedRenderPhase`](struct.SortedRenderPhase.html "struct bevy::render::render_phase::SortedRenderPhase").

`transient_items: [Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<([Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), [MainEntity](../sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity"))>`

Items within this render phase that will be automatically removed after this frame.

## Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#1806-1808)

### impl<I> [SortedRenderPhase](struct.SortedRenderPhase.html "struct bevy::render::render_phase::SortedRenderPhase")<I>

where I: [SortedPhaseItem](trait.SortedPhaseItem.html "trait bevy::render::render_phase::SortedPhaseItem"),

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#1813)

#### pub fn [add\_retained](#method.add_retained)(&mut self, item: I)

Adds a [`PhaseItem`](trait.PhaseItem.html "trait bevy::render::render_phase::PhaseItem") to this render phase, which will persist between frames until removed.

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/shader\_advanced/custom\_shader\_instancing.rs ([lines 180-203](../../../src/custom_shader_instancing/custom_shader_instancing.rs.html#180-203))
...
examples/2d/mesh2d\_manual.rs ([lines 426-438](../../../src/mesh2d_manual/mesh2d_manual.rs.html#426-438))
...
examples/shader\_advanced/custom\_render\_phase.rs ([lines 620-644](../../../src/custom_render_phase/custom_render_phase.rs.html#620-644))
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#1820)

#### pub fn [add\_transient](#method.add_transient)(&mut self, item: I)

Adds a [`PhaseItem`](trait.PhaseItem.html "trait bevy::render::render_phase::PhaseItem") to this render phase, which will be automatically removed after this frame.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#1829)

#### pub fn [remove](#method.remove)(&mut self, render\_entity: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), main\_entity: [MainEntity](../sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity"))

Removes the [`PhaseItem`](trait.PhaseItem.html "trait bevy::render::render_phase::PhaseItem") corresponding to the given main-world entity from this render phase.

##### [Examples found in repository](#scraped-examples-1)[?](../../../scrape-examples-help.html)

examples/shader\_advanced/custom\_render\_phase.rs ([line 570](../../../src/custom_render_phase/custom_render_phase.rs.html#570))
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#1835)

#### pub fn [clear](#method.clear)(&mut self)

Removes all [`PhaseItem`](trait.PhaseItem.html "trait bevy::render::render_phase::PhaseItem")s from this render phase.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#1844)

#### pub fn [recalculate\_sort\_keys](#method.recalculate_sort_keys)(&mut self, view: &[ExtractedView](../view/struct.ExtractedView.html "struct bevy::render::view::ExtractedView"))
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#1849)

#### pub fn [sort](#method.sort)(&mut self)

Sorts all of its [`PhaseItem`](trait.PhaseItem.html "trait bevy::render::render_phase::PhaseItem")s.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#1855)

#### pub fn [iter\_entities](#method.iter_entities)(&self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\>

An [`Iterator`](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator") through the associated [`Entity`](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") for each [`PhaseItem`](trait.PhaseItem.html "trait bevy::render::render_phase::PhaseItem") in order.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#1860-1865)
...
Renders all of its [`PhaseItem`](trait.PhaseItem.html "trait bevy::render::render_phase::PhaseItem")s using their corresponding draw functions.

##### [Examples found in repository](#scraped-examples-2)[?](../../../scrape-examples-help.html)

examples/shader\_advanced/custom\_render\_phase.rs ([line 686](../../../src/custom_render_phase/custom_render_phase.rs.html#686))
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#1870-1876)

#### pub fn [render\_range](#method.render_range)<'w>( &self, render\_pass: &mut [TrackedRenderPass](struct.TrackedRenderPass.html "struct bevy::render::render_phase::TrackedRenderPass")<'w>, world: &'w [World](../../prelude/struct.World.html "struct bevy::prelude::World"), view: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), range: impl [RangeBounds](https://doc.rust-lang.org/nightly/core/ops/range/trait.RangeBounds.html "trait core::ops::range::RangeBounds")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [DrawError](enum.DrawError.html "enum bevy::render::render_phase::DrawError")\>

Renders all [`PhaseItem`](trait.PhaseItem.html "trait bevy::render::render_phase::PhaseItem")s in the provided `range` (based on their index in `self.items`) using their corresponding draw functions.

## Trait Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#1794-1796)

### impl<I> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [SortedRenderPhase](struct.SortedRenderPhase.html "struct bevy::render::render_phase::SortedRenderPhase")<I>

where I: [SortedPhaseItem](trait.SortedPhaseItem.html "trait bevy::render::render_phase::SortedPhaseItem"),

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_phase/mod.rs.html#1798)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [SortedRenderPhase](struct.SortedRenderPhase.html "struct bevy::render::render_phase::SortedRenderPhase")<I>

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

## Auto Trait Implementations

### impl<I> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SortedRenderPhase](struct.SortedRenderPhase.html "struct bevy::render::render_phase::SortedRenderPhase")<I>

### impl<I> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SortedRenderPhase](struct.SortedRenderPhase.html "struct bevy::render::render_phase::SortedRenderPhase")<I>
...
### impl<I> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SortedRenderPhase](struct.SortedRenderPhase.html "struct bevy::render::render_phase::SortedRenderPhase")<I>

### impl<I> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SortedRenderPhase](struct.SortedRenderPhase.html "struct bevy::render::render_phase::SortedRenderPhase")<I>

### impl<I> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SortedRenderPhase](struct.SortedRenderPhase.html "struct bevy::render::render_phase::SortedRenderPhase")<I>

where I: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<I> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SortedRenderPhase](struct.SortedRenderPhase.html "struct bevy::render::render_phase::SortedRenderPhase")<I>

### impl<I> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SortedRenderPhase](struct.SortedRenderPhase.html "struct bevy::render::render_phase::SortedRenderPhase")<I>
