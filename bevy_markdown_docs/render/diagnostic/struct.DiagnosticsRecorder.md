...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/diagnostic/internal.rs.html#43)

```rust
pub struct DiagnosticsRecorder(/* private fields */);
```
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/diagnostic/internal.rs.html#45)

### impl [DiagnosticsRecorder](struct.DiagnosticsRecorder.html "struct bevy::render::diagnostic::DiagnosticsRecorder")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/diagnostic/internal.rs.html#47-51)

#### pub fn [new](#method.new)( adapter\_info: &[RenderAdapterInfo](../renderer/struct.RenderAdapterInfo.html "struct bevy::render::renderer::RenderAdapterInfo"), device: &[RenderDevice](../renderer/struct.RenderDevice.html "struct bevy::render::renderer::RenderDevice"), queue: &[RenderQueue](../renderer/struct.RenderQueue.html "struct bevy::render::renderer::RenderQueue"), ) -> [DiagnosticsRecorder](struct.DiagnosticsRecorder.html "struct bevy::render::diagnostic::DiagnosticsRecorder")

Creates the new `DiagnosticsRecorder`.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/diagnostic/internal.rs.html#84)

#### pub fn [begin\_frame](#method.begin_frame)(&mut self)

Begins recording diagnostics for a new frame.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/diagnostic/internal.rs.html#103)

#### pub fn [resolve](#method.resolve)(&mut self, encoder: &mut [CommandEncoder](../render_resource/struct.CommandEncoder.html "struct bevy::render::render_resource::CommandEncoder"))

Copies data from [`QuerySet`](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/wgpu/api/query_set/struct.QuerySet.html "struct wgpu::api::query_set::QuerySet")’s to a [`Buffer`](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/wgpu/api/buffer/struct.Buffer.html "struct wgpu::api::buffer::Buffer"), after which it can be downloaded to CPU.

Should be called before [`DiagnosticsRecorder::finish_frame`](struct.DiagnosticsRecorder.html#method.finish_frame "method bevy::render::diagnostic::DiagnosticsRecorder::finish_frame").

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/diagnostic/internal.rs.html#113-117)

#### pub fn [finish\_frame](#method.finish_frame)( &mut self, device: &[RenderDevice](../renderer/struct.RenderDevice.html "struct bevy::render::renderer::RenderDevice"), callback: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")(RenderDiagnostics) + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static, )
...
Should be called after [`DiagnosticsRecorder::resolve`](struct.DiagnosticsRecorder.html#method.resolve "method bevy::render::diagnostic::DiagnosticsRecorder::resolve"), and **after** all commands buffers have been queued.

## Trait Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/diagnostic/internal.rs.html#42)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [DiagnosticsRecorder](struct.DiagnosticsRecorder.html "struct bevy::render::diagnostic::DiagnosticsRecorder")

where [DiagnosticsRecorder](struct.DiagnosticsRecorder.html "struct bevy::render::diagnostic::DiagnosticsRecorder"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [FromWorld](../../prelude/trait.FromWorld.html "trait bevy::prelude::FromWorld") for [DiagnosticsRecorder](struct.DiagnosticsRecorder.html "struct bevy::render::diagnostic::DiagnosticsRecorder")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/diagnostic/mod.rs.html#98)

#### fn [from\_world](../../prelude/trait.FromWorld.html#tymethod.from_world)(world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World")) -> [DiagnosticsRecorder](struct.DiagnosticsRecorder.html "struct bevy::render::diagnostic::DiagnosticsRecorder")
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/diagnostic/internal.rs.html#148-150)

#### fn [record\_f32](trait.RecordDiagnostics.html#tymethod.record_f32)<N>( &self, command\_encoder: &mut [CommandEncoder](../render_resource/struct.CommandEncoder.html "struct bevy::render::render_resource::CommandEncoder"), buffer: &[BufferSlice](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/wgpu/api/buffer/struct.BufferSlice.html "struct wgpu::api::buffer::BufferSlice")<'\_>, name: N, )
...
Reads a f32 from the specified buffer and uploads it as a diagnostic. [Read more](trait.RecordDiagnostics.html#tymethod.record_f32)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/diagnostic/internal.rs.html#166-168)

#### fn [record\_u32](trait.RecordDiagnostics.html#tymethod.record_u32)<N>( &self, command\_encoder: &mut [CommandEncoder](../render_resource/struct.CommandEncoder.html "struct bevy::render::render_resource::CommandEncoder"), buffer: &[BufferSlice](https://docs.rs/wgpu/29.0.3/x86_64-unknown-linux-gnu/wgpu/api/buffer/struct.BufferSlice.html "struct wgpu::api::buffer::BufferSlice")<'\_>, name: N, )

where N: [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Cow](https://doc.rust-lang.org/nightly/alloc/borrow/enum.Cow.html "enum alloc::borrow::Cow")<'static, [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>>,

Reads a u32 from the specified buffer and uploads it as a diagnostic. [Read more](trait.RecordDiagnostics.html#tymethod.record_u32)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/diagnostic/mod.rs.html#137-140)

#### fn [time\_span](trait.RecordDiagnostics.html#method.time_span)<E, N>( &self, encoder: [&mut E](https://doc.rust-lang.org/nightly/std/primitive.reference.html), name: N, ) -> [TimeSpanGuard](struct.TimeSpanGuard.html "struct bevy::render::diagnostic::TimeSpanGuard")<'\_, Self, E>
...
Begin a time span, which will record elapsed CPU and GPU time. [Read more](trait.RecordDiagnostics.html#method.time_span)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/diagnostic/mod.rs.html#153-156)

#### fn [pass\_span](trait.RecordDiagnostics.html#method.pass_span)<P, N>(&self, pass: [&mut P](https://doc.rust-lang.org/nightly/std/primitive.reference.html), name: N) -> [PassSpanGuard](struct.PassSpanGuard.html "struct bevy::render::diagnostic::PassSpanGuard")<'\_, Self, P>
...
Begin a pass span, which will record elapsed CPU and GPU time, as well as pipeline statistics on supported platforms. [Read more](trait.RecordDiagnostics.html#method.pass_span)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/diagnostic/internal.rs.html#42)

### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [DiagnosticsRecorder](struct.DiagnosticsRecorder.html "struct bevy::render::diagnostic::DiagnosticsRecorder")

where [DiagnosticsRecorder](struct.DiagnosticsRecorder.html "struct bevy::render::diagnostic::DiagnosticsRecorder"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DiagnosticsRecorder](struct.DiagnosticsRecorder.html "struct bevy::render::diagnostic::DiagnosticsRecorder")

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DiagnosticsRecorder](struct.DiagnosticsRecorder.html "struct bevy::render::diagnostic::DiagnosticsRecorder")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DiagnosticsRecorder](struct.DiagnosticsRecorder.html "struct bevy::render::diagnostic::DiagnosticsRecorder")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DiagnosticsRecorder](struct.DiagnosticsRecorder.html "struct bevy::render::diagnostic::DiagnosticsRecorder")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DiagnosticsRecorder](struct.DiagnosticsRecorder.html "struct bevy::render::diagnostic::DiagnosticsRecorder")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DiagnosticsRecorder](struct.DiagnosticsRecorder.html "struct bevy::render::diagnostic::DiagnosticsRecorder")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DiagnosticsRecorder](struct.DiagnosticsRecorder.html "struct bevy::render::diagnostic::DiagnosticsRecorder")
