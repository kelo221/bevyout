...
# Struct RenderDiagnosticsPlugin 

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/diagnostic/mod.rs.html#64)
...
To access the diagnostics, you can use the [`DiagnosticsStore`](../../diagnostic/struct.DiagnosticsStore.html "struct bevy::diagnostic::DiagnosticsStore") resource, add [`LogDiagnosticsPlugin`](../../diagnostic/struct.LogDiagnosticsPlugin.html "struct bevy::diagnostic::LogDiagnosticsPlugin"), or use [Tracy](https://github.com/bevyengine/bevy/blob/main/docs/profiling.md#tracy-renderqueue).

To record diagnostics in your own passes:

1.  First, obtain the diagnostic recorder using [`RenderContext::diagnostic_recorder`](../renderer/struct.RenderContext.html#method.diagnostic_recorder "method bevy::render::renderer::RenderContext::diagnostic_recorder").
    
    It won’t do anything unless [`RenderDiagnosticsPlugin`](struct.RenderDiagnosticsPlugin.html "struct bevy::render::diagnostic::RenderDiagnosticsPlugin") is present, so you’re free to omit `#[cfg]` clauses.
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/diagnostic/mod.rs.html#63)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [RenderDiagnosticsPlugin](struct.RenderDiagnosticsPlugin.html "struct bevy::render::diagnostic::RenderDiagnosticsPlugin")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/diagnostic/mod.rs.html#63)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [RenderDiagnosticsPlugin](struct.RenderDiagnosticsPlugin.html "struct bevy::render::diagnostic::RenderDiagnosticsPlugin")
...
### impl [Plugin](../../prelude/trait.Plugin.html "trait bevy::prelude::Plugin") for [RenderDiagnosticsPlugin](struct.RenderDiagnosticsPlugin.html "struct bevy::render::diagnostic::RenderDiagnosticsPlugin")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/diagnostic/mod.rs.html#67)
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/diagnostic/mod.rs.html#77)
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RenderDiagnosticsPlugin](struct.RenderDiagnosticsPlugin.html "struct bevy::render::diagnostic::RenderDiagnosticsPlugin")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RenderDiagnosticsPlugin](struct.RenderDiagnosticsPlugin.html "struct bevy::render::diagnostic::RenderDiagnosticsPlugin")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RenderDiagnosticsPlugin](struct.RenderDiagnosticsPlugin.html "struct bevy::render::diagnostic::RenderDiagnosticsPlugin")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RenderDiagnosticsPlugin](struct.RenderDiagnosticsPlugin.html "struct bevy::render::diagnostic::RenderDiagnosticsPlugin")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RenderDiagnosticsPlugin](struct.RenderDiagnosticsPlugin.html "struct bevy::render::diagnostic::RenderDiagnosticsPlugin")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RenderDiagnosticsPlugin](struct.RenderDiagnosticsPlugin.html "struct bevy::render::diagnostic::RenderDiagnosticsPlugin")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RenderDiagnosticsPlugin](struct.RenderDiagnosticsPlugin.html "struct bevy::render::diagnostic::RenderDiagnosticsPlugin")
