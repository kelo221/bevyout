...
# Struct OcclusionCullingPlugin 

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/occlusion_culling/mod.rs.html#17)
...
### impl [Plugin](../../prelude/trait.Plugin.html "trait bevy::prelude::Plugin") for [OcclusionCullingPlugin](struct.OcclusionCullingPlugin.html "struct bevy::render::occlusion_culling::OcclusionCullingPlugin")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/occlusion_culling/mod.rs.html#20)
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [OcclusionCullingPlugin](struct.OcclusionCullingPlugin.html "struct bevy::render::occlusion_culling::OcclusionCullingPlugin")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [OcclusionCullingPlugin](struct.OcclusionCullingPlugin.html "struct bevy::render::occlusion_culling::OcclusionCullingPlugin")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [OcclusionCullingPlugin](struct.OcclusionCullingPlugin.html "struct bevy::render::occlusion_culling::OcclusionCullingPlugin")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [OcclusionCullingPlugin](struct.OcclusionCullingPlugin.html "struct bevy::render::occlusion_culling::OcclusionCullingPlugin")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [OcclusionCullingPlugin](struct.OcclusionCullingPlugin.html "struct bevy::render::occlusion_culling::OcclusionCullingPlugin")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [OcclusionCullingPlugin](struct.OcclusionCullingPlugin.html "struct bevy::render::occlusion_culling::OcclusionCullingPlugin")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [OcclusionCullingPlugin](struct.OcclusionCullingPlugin.html "struct bevy::render::occlusion_culling::OcclusionCullingPlugin")
