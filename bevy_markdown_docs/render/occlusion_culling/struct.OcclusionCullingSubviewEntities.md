...
# Struct OcclusionCullingSubviewEntities 

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/occlusion_culling/mod.rs.html#98)
...
Bevy automatically places this component on cameras that are drawing shadows, when those shadows come from lights with occlusion culling enabled. You don’t ordinarily need to add this component yourself.

## Tuple Fields

`0: [Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")>`

## Trait Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/occlusion_culling/mod.rs.html#97)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [OcclusionCullingSubviewEntities](struct.OcclusionCullingSubviewEntities.html "struct bevy::render::occlusion_culling::OcclusionCullingSubviewEntities")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/occlusion_culling/mod.rs.html#97)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [OcclusionCullingSubviewEntities](struct.OcclusionCullingSubviewEntities.html "struct bevy::render::occlusion_culling::OcclusionCullingSubviewEntities")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [OcclusionCullingSubviewEntities](struct.OcclusionCullingSubviewEntities.html "struct bevy::render::occlusion_culling::OcclusionCullingSubviewEntities")

where [OcclusionCullingSubviewEntities](struct.OcclusionCullingSubviewEntities.html "struct bevy::render::occlusion_culling::OcclusionCullingSubviewEntities"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [OcclusionCullingSubviewEntities](struct.OcclusionCullingSubviewEntities.html "struct bevy::render::occlusion_culling::OcclusionCullingSubviewEntities")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [OcclusionCullingSubviewEntities](struct.OcclusionCullingSubviewEntities.html "struct bevy::render::occlusion_culling::OcclusionCullingSubviewEntities")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [OcclusionCullingSubviewEntities](struct.OcclusionCullingSubviewEntities.html "struct bevy::render::occlusion_culling::OcclusionCullingSubviewEntities")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [OcclusionCullingSubviewEntities](struct.OcclusionCullingSubviewEntities.html "struct bevy::render::occlusion_culling::OcclusionCullingSubviewEntities")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [OcclusionCullingSubviewEntities](struct.OcclusionCullingSubviewEntities.html "struct bevy::render::occlusion_culling::OcclusionCullingSubviewEntities")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [OcclusionCullingSubviewEntities](struct.OcclusionCullingSubviewEntities.html "struct bevy::render::occlusion_culling::OcclusionCullingSubviewEntities")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [OcclusionCullingSubviewEntities](struct.OcclusionCullingSubviewEntities.html "struct bevy::render::occlusion_culling::OcclusionCullingSubviewEntities")
