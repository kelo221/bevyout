...
# Struct OcclusionCullingSubview 

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/occlusion_culling/mod.rs.html#80)
...
Bevy automatically places this component on views created for shadow mapping. You don’t ordinarily need to add this component yourself.

## Fields

`depth_texture_view: [TextureView](../render_resource/struct.TextureView.html "struct bevy::render::render_resource::TextureView")`

A texture view of the Z-buffer.

`depth_texture_size: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

The size of the texture along both dimensions.

Because [`OcclusionCullingSubview`](struct.OcclusionCullingSubview.html "struct bevy::render::occlusion_culling::OcclusionCullingSubview") is only currently used for shadow maps, they’re guaranteed to have sizes equal to a power of two, so we don’t have to store the two dimensions individually here.

## Trait Implementations

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/occlusion_culling/mod.rs.html#79)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [OcclusionCullingSubview](struct.OcclusionCullingSubview.html "struct bevy::render::occlusion_culling::OcclusionCullingSubview")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/occlusion_culling/mod.rs.html#79)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [OcclusionCullingSubview](struct.OcclusionCullingSubview.html "struct bevy::render::occlusion_culling::OcclusionCullingSubview")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [OcclusionCullingSubview](struct.OcclusionCullingSubview.html "struct bevy::render::occlusion_culling::OcclusionCullingSubview")

where [OcclusionCullingSubview](struct.OcclusionCullingSubview.html "struct bevy::render::occlusion_culling::OcclusionCullingSubview"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [OcclusionCullingSubview](struct.OcclusionCullingSubview.html "struct bevy::render::occlusion_culling::OcclusionCullingSubview")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [OcclusionCullingSubview](struct.OcclusionCullingSubview.html "struct bevy::render::occlusion_culling::OcclusionCullingSubview")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [OcclusionCullingSubview](struct.OcclusionCullingSubview.html "struct bevy::render::occlusion_culling::OcclusionCullingSubview")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [OcclusionCullingSubview](struct.OcclusionCullingSubview.html "struct bevy::render::occlusion_culling::OcclusionCullingSubview")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [OcclusionCullingSubview](struct.OcclusionCullingSubview.html "struct bevy::render::occlusion_culling::OcclusionCullingSubview")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [OcclusionCullingSubview](struct.OcclusionCullingSubview.html "struct bevy::render::occlusion_culling::OcclusionCullingSubview")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [OcclusionCullingSubview](struct.OcclusionCullingSubview.html "struct bevy::render::occlusion_culling::OcclusionCullingSubview")
