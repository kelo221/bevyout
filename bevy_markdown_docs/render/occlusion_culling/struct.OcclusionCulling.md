[bevy](../../index.html)::[render](../index.html)::[occlusion\_culling](index.html)

# Struct OcclusionCulling 

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/occlusion_culling/mod.rs.html#72)
...
_Occlusion culling_ allows Bevy to avoid rendering objects that are fully behind other opaque or alpha tested objects. This is different from, and complements, depth fragment rejection as the `DepthPrepass` enables. While depth rejection allows Bevy to avoid rendering _pixels_ that are behind other objects, the GPU still has to examine those pixels to reject them, which requires transforming the vertices of the objects and performing skinning if the objects were skinned. Occlusion culling allows the GPU to go a step further, avoiding even transforming the vertices of objects that it can quickly prove to be behind other objects.

Occlusion culling inherently has some overhead, because Bevy must examine the objects’ bounding boxes, and create an acceleration structure (hierarchical Z-buffer) to perform the occlusion tests. Therefore, occlusion culling is disabled by default. Only enable it if you measure it to be a speedup on your scene. Note that, because Bevy’s occlusion culling runs on the GPU and is quite efficient, it’s rare for occlusion culling to result in a significant slowdown.

Occlusion culling currently requires a `DepthPrepass`. If no depth prepass is present on the view, the [`OcclusionCulling`](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling") component will be ignored. Additionally, occlusion culling is currently incompatible with deferred shading; including both `DeferredPrepass` and [`OcclusionCulling`](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling") results in unspecified behavior.

The algorithm that Bevy uses is known as [_two-phase occlusion culling_](https://medium.com/@mil_kru/two-pass-occlusion-culling-4100edcad501). When you enable occlusion culling, Bevy splits the depth prepass into two: an _early_ depth prepass and a _late_ depth prepass. The early depth prepass renders all the meshes that were visible last frame to produce a conservative approximation of the depth buffer. Then, after producing an acceleration structure known as a hierarchical Z-buffer or depth pyramid, Bevy tests the bounding boxes of all meshes against that depth buffer. Those that can be quickly proven to be behind the geometry rendered during the early depth prepass are skipped entirely. The other potentially-visible meshes are rendered during the late prepass, and finally all the visible meshes are rendered as usual during the opaque, transparent, etc. passes.
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/occlusion_culling/mod.rs.html#70)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")

where [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/occlusion_culling/mod.rs.html#70)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/occlusion_culling/mod.rs.html#70)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/occlusion_culling/mod.rs.html#70)

### impl [ExtractComponent](../extract_component/trait.ExtractComponent.html "trait bevy::render::extract_component::ExtractComponent") for [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")

where [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling"): [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/occlusion_culling/mod.rs.html#70)

#### type [QueryData](../extract_component/trait.ExtractComponent.html#associatedtype.QueryData) = &'static [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")
...
#### type [Out](../extract_component/trait.ExtractComponent.html#associatedtype.Out) = [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")
...
#### fn [extract\_component](../extract_component/trait.ExtractComponent.html#tymethod.extract_component)( item: <<[OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling") as [ExtractComponent](../extract_component/trait.ExtractComponent.html "trait bevy::render::extract_component::ExtractComponent")\>::[QueryData](../extract_component/trait.ExtractComponent.html#associatedtype.QueryData "type bevy::render::extract_component::ExtractComponent::QueryData") as [QueryData](../../ecs/query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../../ecs/query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'\_, '\_>, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling") as [ExtractComponent](../extract_component/trait.ExtractComponent.html "trait bevy::render::extract_component::ExtractComponent")\>::[Out](../extract_component/trait.ExtractComponent.html#associatedtype.Out "type bevy::render::extract_component::ExtractComponent::Out")\>
...
### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/occlusion_culling/mod.rs.html#70)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/occlusion_culling/mod.rs.html#70)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/occlusion_culling/mod.rs.html#70)

### impl [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/occlusion_culling/mod.rs.html#70)

#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")
...
where [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling"): 'into\_return,
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")
...
[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/occlusion_culling/mod.rs.html#71)
...
### impl [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/occlusion_culling/mod.rs.html#70)

#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
### impl [Struct](../../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")
...
### impl [SyncComponent](../sync_component/trait.SyncComponent.html "trait bevy::render::sync_component::SyncComponent") for [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")

where [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling"): [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/occlusion_culling/mod.rs.html#70)

#### type [Target](../sync_component/trait.SyncComponent.html#associatedtype.Target) = [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")

Describes what components should be removed from the render world if the implementing component is removed.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/occlusion_culling/mod.rs.html#70)

### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [OcclusionCulling](struct.OcclusionCulling.html "struct bevy::render::occlusion_culling::OcclusionCulling")
