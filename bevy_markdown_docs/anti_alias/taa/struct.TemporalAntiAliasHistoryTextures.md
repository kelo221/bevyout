...
[Source](https://docs.rs/bevy_anti_alias/0.19.0/x86_64-unknown-linux-gnu/src/bevy_anti_alias/taa/mod.rs.html#386)

```rust
pub struct TemporalAntiAliasHistoryTextures { /* private fields */ }
```

## Trait Implementations

[Source](https://docs.rs/bevy_anti_alias/0.19.0/x86_64-unknown-linux-gnu/src/bevy_anti_alias/taa/mod.rs.html#385)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [TemporalAntiAliasHistoryTextures](struct.TemporalAntiAliasHistoryTextures.html "struct bevy::anti_alias::taa::TemporalAntiAliasHistoryTextures")

where [TemporalAntiAliasHistoryTextures](struct.TemporalAntiAliasHistoryTextures.html "struct bevy::anti_alias::taa::TemporalAntiAliasHistoryTextures"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TemporalAntiAliasHistoryTextures](struct.TemporalAntiAliasHistoryTextures.html "struct bevy::anti_alias::taa::TemporalAntiAliasHistoryTextures")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TemporalAntiAliasHistoryTextures](struct.TemporalAntiAliasHistoryTextures.html "struct bevy::anti_alias::taa::TemporalAntiAliasHistoryTextures")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TemporalAntiAliasHistoryTextures](struct.TemporalAntiAliasHistoryTextures.html "struct bevy::anti_alias::taa::TemporalAntiAliasHistoryTextures")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TemporalAntiAliasHistoryTextures](struct.TemporalAntiAliasHistoryTextures.html "struct bevy::anti_alias::taa::TemporalAntiAliasHistoryTextures")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TemporalAntiAliasHistoryTextures](struct.TemporalAntiAliasHistoryTextures.html "struct bevy::anti_alias::taa::TemporalAntiAliasHistoryTextures")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TemporalAntiAliasHistoryTextures](struct.TemporalAntiAliasHistoryTextures.html "struct bevy::anti_alias::taa::TemporalAntiAliasHistoryTextures")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TemporalAntiAliasHistoryTextures](struct.TemporalAntiAliasHistoryTextures.html "struct bevy::anti_alias::taa::TemporalAntiAliasHistoryTextures")
