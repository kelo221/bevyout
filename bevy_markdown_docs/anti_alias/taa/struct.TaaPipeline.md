...
[Source](https://docs.rs/bevy_anti_alias/0.19.0/x86_64-unknown-linux-gnu/src/bevy_anti_alias/taa/mod.rs.html#220)

```rust
pub struct TaaPipeline { /* private fields */ }
```
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [TaaPipeline](struct.TaaPipeline.html "struct bevy::anti_alias::taa::TaaPipeline")

where [TaaPipeline](struct.TaaPipeline.html "struct bevy::anti_alias::taa::TaaPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [TaaPipeline](struct.TaaPipeline.html "struct bevy::anti_alias::taa::TaaPipeline")

where [TaaPipeline](struct.TaaPipeline.html "struct bevy::anti_alias::taa::TaaPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TaaPipeline](struct.TaaPipeline.html "struct bevy::anti_alias::taa::TaaPipeline")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TaaPipeline](struct.TaaPipeline.html "struct bevy::anti_alias::taa::TaaPipeline")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TaaPipeline](struct.TaaPipeline.html "struct bevy::anti_alias::taa::TaaPipeline")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TaaPipeline](struct.TaaPipeline.html "struct bevy::anti_alias::taa::TaaPipeline")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TaaPipeline](struct.TaaPipeline.html "struct bevy::anti_alias::taa::TaaPipeline")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TaaPipeline](struct.TaaPipeline.html "struct bevy::anti_alias::taa::TaaPipeline")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TaaPipeline](struct.TaaPipeline.html "struct bevy::anti_alias::taa::TaaPipeline")
