...
# Struct TemporalAntiAliasPipelineId 

[Source](https://docs.rs/bevy_anti_alias/0.19.0/x86_64-unknown-linux-gnu/src/bevy_anti_alias/taa/mod.rs.html#435)

```rust
pub struct TemporalAntiAliasPipelineId(/* private fields */);
```

## Trait Implementations

[Source](https://docs.rs/bevy_anti_alias/0.19.0/x86_64-unknown-linux-gnu/src/bevy_anti_alias/taa/mod.rs.html#434)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [TemporalAntiAliasPipelineId](struct.TemporalAntiAliasPipelineId.html "struct bevy::anti_alias::taa::TemporalAntiAliasPipelineId")

where [TemporalAntiAliasPipelineId](struct.TemporalAntiAliasPipelineId.html "struct bevy::anti_alias::taa::TemporalAntiAliasPipelineId"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TemporalAntiAliasPipelineId](struct.TemporalAntiAliasPipelineId.html "struct bevy::anti_alias::taa::TemporalAntiAliasPipelineId")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TemporalAntiAliasPipelineId](struct.TemporalAntiAliasPipelineId.html "struct bevy::anti_alias::taa::TemporalAntiAliasPipelineId")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TemporalAntiAliasPipelineId](struct.TemporalAntiAliasPipelineId.html "struct bevy::anti_alias::taa::TemporalAntiAliasPipelineId")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TemporalAntiAliasPipelineId](struct.TemporalAntiAliasPipelineId.html "struct bevy::anti_alias::taa::TemporalAntiAliasPipelineId")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TemporalAntiAliasPipelineId](struct.TemporalAntiAliasPipelineId.html "struct bevy::anti_alias::taa::TemporalAntiAliasPipelineId")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TemporalAntiAliasPipelineId](struct.TemporalAntiAliasPipelineId.html "struct bevy::anti_alias::taa::TemporalAntiAliasPipelineId")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TemporalAntiAliasPipelineId](struct.TemporalAntiAliasPipelineId.html "struct bevy::anti_alias::taa::TemporalAntiAliasPipelineId")
