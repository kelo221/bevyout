...
[Source](https://docs.rs/bevy_anti_alias/0.19.0/x86_64-unknown-linux-gnu/src/bevy_anti_alias/contrast_adaptive_sharpening/mod.rs.html#136)

```rust
pub struct CasPipeline { /* private fields */ }
```
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [CasPipeline](struct.CasPipeline.html "struct bevy::anti_alias::contrast_adaptive_sharpening::CasPipeline")

where [CasPipeline](struct.CasPipeline.html "struct bevy::anti_alias::contrast_adaptive_sharpening::CasPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [CasPipeline](struct.CasPipeline.html "struct bevy::anti_alias::contrast_adaptive_sharpening::CasPipeline")

where [CasPipeline](struct.CasPipeline.html "struct bevy::anti_alias::contrast_adaptive_sharpening::CasPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [CasPipeline](struct.CasPipeline.html "struct bevy::anti_alias::contrast_adaptive_sharpening::CasPipeline")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [CasPipeline](struct.CasPipeline.html "struct bevy::anti_alias::contrast_adaptive_sharpening::CasPipeline")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [CasPipeline](struct.CasPipeline.html "struct bevy::anti_alias::contrast_adaptive_sharpening::CasPipeline")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [CasPipeline](struct.CasPipeline.html "struct bevy::anti_alias::contrast_adaptive_sharpening::CasPipeline")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [CasPipeline](struct.CasPipeline.html "struct bevy::anti_alias::contrast_adaptive_sharpening::CasPipeline")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [CasPipeline](struct.CasPipeline.html "struct bevy::anti_alias::contrast_adaptive_sharpening::CasPipeline")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [CasPipeline](struct.CasPipeline.html "struct bevy::anti_alias::contrast_adaptive_sharpening::CasPipeline")
