...
# Struct ViewCasPipeline 

[Source](https://docs.rs/bevy_anti_alias/0.19.0/x86_64-unknown-linux-gnu/src/bevy_anti_alias/contrast_adaptive_sharpening/mod.rs.html#254)

```rust
pub struct ViewCasPipeline(/* private fields */);
```

## Trait Implementations

[Source](https://docs.rs/bevy_anti_alias/0.19.0/x86_64-unknown-linux-gnu/src/bevy_anti_alias/contrast_adaptive_sharpening/mod.rs.html#253)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [ViewCasPipeline](struct.ViewCasPipeline.html "struct bevy::anti_alias::contrast_adaptive_sharpening::ViewCasPipeline")

where [ViewCasPipeline](struct.ViewCasPipeline.html "struct bevy::anti_alias::contrast_adaptive_sharpening::ViewCasPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ViewCasPipeline](struct.ViewCasPipeline.html "struct bevy::anti_alias::contrast_adaptive_sharpening::ViewCasPipeline")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ViewCasPipeline](struct.ViewCasPipeline.html "struct bevy::anti_alias::contrast_adaptive_sharpening::ViewCasPipeline")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ViewCasPipeline](struct.ViewCasPipeline.html "struct bevy::anti_alias::contrast_adaptive_sharpening::ViewCasPipeline")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ViewCasPipeline](struct.ViewCasPipeline.html "struct bevy::anti_alias::contrast_adaptive_sharpening::ViewCasPipeline")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ViewCasPipeline](struct.ViewCasPipeline.html "struct bevy::anti_alias::contrast_adaptive_sharpening::ViewCasPipeline")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ViewCasPipeline](struct.ViewCasPipeline.html "struct bevy::anti_alias::contrast_adaptive_sharpening::ViewCasPipeline")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ViewCasPipeline](struct.ViewCasPipeline.html "struct bevy::anti_alias::contrast_adaptive_sharpening::ViewCasPipeline")
