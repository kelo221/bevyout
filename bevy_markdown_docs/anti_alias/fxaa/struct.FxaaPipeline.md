...
[Source](https://docs.rs/bevy_anti_alias/0.19.0/x86_64-unknown-linux-gnu/src/bevy_anti_alias/fxaa/mod.rs.html#114)

```rust
pub struct FxaaPipeline { /* private fields */ }
```
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [FxaaPipeline](struct.FxaaPipeline.html "struct bevy::anti_alias::fxaa::FxaaPipeline")

where [FxaaPipeline](struct.FxaaPipeline.html "struct bevy::anti_alias::fxaa::FxaaPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [FxaaPipeline](struct.FxaaPipeline.html "struct bevy::anti_alias::fxaa::FxaaPipeline")

where [FxaaPipeline](struct.FxaaPipeline.html "struct bevy::anti_alias::fxaa::FxaaPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

[Source](https://docs.rs/bevy_anti_alias/0.19.0/x86_64-unknown-linux-gnu/src/bevy_anti_alias/fxaa/mod.rs.html#165)

### impl [SpecializedRenderPipeline](../../render/render_resource/trait.SpecializedRenderPipeline.html "trait bevy::render::render_resource::SpecializedRenderPipeline") for [FxaaPipeline](struct.FxaaPipeline.html "struct bevy::anti_alias::fxaa::FxaaPipeline")

[Source](https://docs.rs/bevy_anti_alias/0.19.0/x86_64-unknown-linux-gnu/src/bevy_anti_alias/fxaa/mod.rs.html#166)

#### type [Key](../../render/render_resource/trait.SpecializedRenderPipeline.html#associatedtype.Key) = [FxaaPipelineKey](struct.FxaaPipelineKey.html "struct bevy::anti_alias::fxaa::FxaaPipelineKey")

The key that defines each “variant” of the render pipeline.

[Source](https://docs.rs/bevy_anti_alias/0.19.0/x86_64-unknown-linux-gnu/src/bevy_anti_alias/fxaa/mod.rs.html#168)

#### fn [specialize](../../render/render_resource/trait.SpecializedRenderPipeline.html#tymethod.specialize)( &self, key: <[FxaaPipeline](struct.FxaaPipeline.html "struct bevy::anti_alias::fxaa::FxaaPipeline") as [SpecializedRenderPipeline](../../render/render_resource/trait.SpecializedRenderPipeline.html "trait bevy::render::render_resource::SpecializedRenderPipeline")\>::[Key](../../render/render_resource/trait.SpecializedRenderPipeline.html#associatedtype.Key "type bevy::render::render_resource::SpecializedRenderPipeline::Key"), ) -> [RenderPipelineDescriptor](../../material/descriptor/struct.RenderPipelineDescriptor.html "struct bevy::material::descriptor::RenderPipelineDescriptor")

Construct a new render pipeline based on the provided key.

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [FxaaPipeline](struct.FxaaPipeline.html "struct bevy::anti_alias::fxaa::FxaaPipeline")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [FxaaPipeline](struct.FxaaPipeline.html "struct bevy::anti_alias::fxaa::FxaaPipeline")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [FxaaPipeline](struct.FxaaPipeline.html "struct bevy::anti_alias::fxaa::FxaaPipeline")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [FxaaPipeline](struct.FxaaPipeline.html "struct bevy::anti_alias::fxaa::FxaaPipeline")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [FxaaPipeline](struct.FxaaPipeline.html "struct bevy::anti_alias::fxaa::FxaaPipeline")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [FxaaPipeline](struct.FxaaPipeline.html "struct bevy::anti_alias::fxaa::FxaaPipeline")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [FxaaPipeline](struct.FxaaPipeline.html "struct bevy::anti_alias::fxaa::FxaaPipeline")
