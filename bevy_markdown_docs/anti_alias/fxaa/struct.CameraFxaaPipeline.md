...
# Struct CameraFxaaPipeline 

[Source](https://docs.rs/bevy_anti_alias/0.19.0/x86_64-unknown-linux-gnu/src/bevy_anti_alias/fxaa/mod.rs.html#154)
...
[Source](https://docs.rs/bevy_anti_alias/0.19.0/x86_64-unknown-linux-gnu/src/bevy_anti_alias/fxaa/mod.rs.html#153)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [CameraFxaaPipeline](struct.CameraFxaaPipeline.html "struct bevy::anti_alias::fxaa::CameraFxaaPipeline")

where [CameraFxaaPipeline](struct.CameraFxaaPipeline.html "struct bevy::anti_alias::fxaa::CameraFxaaPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [CameraFxaaPipeline](struct.CameraFxaaPipeline.html "struct bevy::anti_alias::fxaa::CameraFxaaPipeline")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [CameraFxaaPipeline](struct.CameraFxaaPipeline.html "struct bevy::anti_alias::fxaa::CameraFxaaPipeline")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [CameraFxaaPipeline](struct.CameraFxaaPipeline.html "struct bevy::anti_alias::fxaa::CameraFxaaPipeline")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [CameraFxaaPipeline](struct.CameraFxaaPipeline.html "struct bevy::anti_alias::fxaa::CameraFxaaPipeline")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [CameraFxaaPipeline](struct.CameraFxaaPipeline.html "struct bevy::anti_alias::fxaa::CameraFxaaPipeline")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [CameraFxaaPipeline](struct.CameraFxaaPipeline.html "struct bevy::anti_alias::fxaa::CameraFxaaPipeline")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [CameraFxaaPipeline](struct.CameraFxaaPipeline.html "struct bevy::anti_alias::fxaa::CameraFxaaPipeline")
