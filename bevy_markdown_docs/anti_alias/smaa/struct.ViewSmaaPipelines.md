...
# Struct ViewSmaaPipelines 

[Source](https://docs.rs/bevy_anti_alias/0.19.0/x86_64-unknown-linux-gnu/src/bevy_anti_alias/smaa/mod.rs.html#190)

```rust
pub struct ViewSmaaPipelines { /* private fields */ }
```

A render world component that holds the pipeline IDs for the SMAA passes.

There are three separate SMAA passes, each with a different shader and bind group layout, so we need three pipeline IDs.

## Trait Implementations

[Source](https://docs.rs/bevy_anti_alias/0.19.0/x86_64-unknown-linux-gnu/src/bevy_anti_alias/smaa/mod.rs.html#189)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [ViewSmaaPipelines](struct.ViewSmaaPipelines.html "struct bevy::anti_alias::smaa::ViewSmaaPipelines")

where [ViewSmaaPipelines](struct.ViewSmaaPipelines.html "struct bevy::anti_alias::smaa::ViewSmaaPipelines"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ViewSmaaPipelines](struct.ViewSmaaPipelines.html "struct bevy::anti_alias::smaa::ViewSmaaPipelines")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ViewSmaaPipelines](struct.ViewSmaaPipelines.html "struct bevy::anti_alias::smaa::ViewSmaaPipelines")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ViewSmaaPipelines](struct.ViewSmaaPipelines.html "struct bevy::anti_alias::smaa::ViewSmaaPipelines")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ViewSmaaPipelines](struct.ViewSmaaPipelines.html "struct bevy::anti_alias::smaa::ViewSmaaPipelines")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ViewSmaaPipelines](struct.ViewSmaaPipelines.html "struct bevy::anti_alias::smaa::ViewSmaaPipelines")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ViewSmaaPipelines](struct.ViewSmaaPipelines.html "struct bevy::anti_alias::smaa::ViewSmaaPipelines")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ViewSmaaPipelines](struct.ViewSmaaPipelines.html "struct bevy::anti_alias::smaa::ViewSmaaPipelines")
