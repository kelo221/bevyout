...
# Struct SmaaBindGroups 

[Source](https://docs.rs/bevy_anti_alias/0.19.0/x86_64-unknown-linux-gnu/src/bevy_anti_alias/smaa/mod.rs.html#263)
...
`edge_detection_bind_group: [BindGroup](../../render/render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup")`

The bind group for the first pass (edge detection).

`blending_weight_calculation_bind_group: [BindGroup](../../render/render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup")`

The bind group for the second pass (blending weight calculation).

`neighborhood_blending_bind_group: [BindGroup](../../render/render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup")`

The bind group for the final pass (neighborhood blending).

## Trait Implementations

[Source](https://docs.rs/bevy_anti_alias/0.19.0/x86_64-unknown-linux-gnu/src/bevy_anti_alias/smaa/mod.rs.html#262)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [SmaaBindGroups](struct.SmaaBindGroups.html "struct bevy::anti_alias::smaa::SmaaBindGroups")

where [SmaaBindGroups](struct.SmaaBindGroups.html "struct bevy::anti_alias::smaa::SmaaBindGroups"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SmaaBindGroups](struct.SmaaBindGroups.html "struct bevy::anti_alias::smaa::SmaaBindGroups")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SmaaBindGroups](struct.SmaaBindGroups.html "struct bevy::anti_alias::smaa::SmaaBindGroups")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SmaaBindGroups](struct.SmaaBindGroups.html "struct bevy::anti_alias::smaa::SmaaBindGroups")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SmaaBindGroups](struct.SmaaBindGroups.html "struct bevy::anti_alias::smaa::SmaaBindGroups")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SmaaBindGroups](struct.SmaaBindGroups.html "struct bevy::anti_alias::smaa::SmaaBindGroups")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SmaaBindGroups](struct.SmaaBindGroups.html "struct bevy::anti_alias::smaa::SmaaBindGroups")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SmaaBindGroups](struct.SmaaBindGroups.html "struct bevy::anti_alias::smaa::SmaaBindGroups")
