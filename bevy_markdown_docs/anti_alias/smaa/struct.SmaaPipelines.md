...
[Source](https://docs.rs/bevy_anti_alias/0.19.0/x86_64-unknown-linux-gnu/src/bevy_anti_alias/smaa/mod.rs.html#137)

```rust
pub struct SmaaPipelines { /* private fields */ }
```
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [SmaaPipelines](struct.SmaaPipelines.html "struct bevy::anti_alias::smaa::SmaaPipelines")

where [SmaaPipelines](struct.SmaaPipelines.html "struct bevy::anti_alias::smaa::SmaaPipelines"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [SmaaPipelines](struct.SmaaPipelines.html "struct bevy::anti_alias::smaa::SmaaPipelines")

where [SmaaPipelines](struct.SmaaPipelines.html "struct bevy::anti_alias::smaa::SmaaPipelines"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SmaaPipelines](struct.SmaaPipelines.html "struct bevy::anti_alias::smaa::SmaaPipelines")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SmaaPipelines](struct.SmaaPipelines.html "struct bevy::anti_alias::smaa::SmaaPipelines")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SmaaPipelines](struct.SmaaPipelines.html "struct bevy::anti_alias::smaa::SmaaPipelines")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SmaaPipelines](struct.SmaaPipelines.html "struct bevy::anti_alias::smaa::SmaaPipelines")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SmaaPipelines](struct.SmaaPipelines.html "struct bevy::anti_alias::smaa::SmaaPipelines")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SmaaPipelines](struct.SmaaPipelines.html "struct bevy::anti_alias::smaa::SmaaPipelines")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SmaaPipelines](struct.SmaaPipelines.html "struct bevy::anti_alias::smaa::SmaaPipelines")
