...
[Source](https://docs.rs/bevy_anti_alias/0.19.0/x86_64-unknown-linux-gnu/src/bevy_anti_alias/smaa/mod.rs.html#235)
...
`edge_detection_color_texture: [CachedTexture](../../render/texture/struct.CachedTexture.html "struct bevy::render::texture::CachedTexture")`

The two-channel texture that stores the output from the first pass (edge detection).

The second pass (blending weight calculation) reads this texture to do its work.

`edge_detection_stencil_texture: [CachedTexture](../../render/texture/struct.CachedTexture.html "struct bevy::render::texture::CachedTexture")`

The 8-bit stencil texture that records which pixels the first pass touched, so that the second pass doesn’t have to examine other pixels.

Each texel will contain a 0 if the first pass didn’t touch the corresponding pixel or a 1 if the first pass did touch that pixel.

`blend_texture: [CachedTexture](../../render/texture/struct.CachedTexture.html "struct bevy::render::texture::CachedTexture")`

A four-channel RGBA texture that stores the output from the second pass (blending weight calculation).

The final pass (neighborhood blending) reads this texture to do its work.

## Trait Implementations

[Source](https://docs.rs/bevy_anti_alias/0.19.0/x86_64-unknown-linux-gnu/src/bevy_anti_alias/smaa/mod.rs.html#234)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [SmaaTextures](struct.SmaaTextures.html "struct bevy::anti_alias::smaa::SmaaTextures")

where [SmaaTextures](struct.SmaaTextures.html "struct bevy::anti_alias::smaa::SmaaTextures"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SmaaTextures](struct.SmaaTextures.html "struct bevy::anti_alias::smaa::SmaaTextures")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SmaaTextures](struct.SmaaTextures.html "struct bevy::anti_alias::smaa::SmaaTextures")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SmaaTextures](struct.SmaaTextures.html "struct bevy::anti_alias::smaa::SmaaTextures")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SmaaTextures](struct.SmaaTextures.html "struct bevy::anti_alias::smaa::SmaaTextures")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SmaaTextures](struct.SmaaTextures.html "struct bevy::anti_alias::smaa::SmaaTextures")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SmaaTextures](struct.SmaaTextures.html "struct bevy::anti_alias::smaa::SmaaTextures")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SmaaTextures](struct.SmaaTextures.html "struct bevy::anti_alias::smaa::SmaaTextures")
