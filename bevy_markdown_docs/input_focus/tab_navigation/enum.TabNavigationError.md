...
# Enum TabNavigationError 

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/tab_navigation.rs.html#131)
...
`previous_focus: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")`

The entity that was previously focused, and is missing its tab group.

`new_focus: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")`

The new entity that will be focused.

If you want to recover from this error, set [`InputFocus`](../struct.InputFocus.html "struct bevy::input_focus::InputFocus") to this entity.

## Trait Implementations

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/tab_navigation.rs.html#130)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [TabNavigationError](enum.TabNavigationError.html "enum bevy::input_focus::tab_navigation::TabNavigationError")

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/tab_navigation.rs.html#130)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [TabNavigationError](enum.TabNavigationError.html "enum bevy::input_focus::tab_navigation::TabNavigationError")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [TabNavigationError](enum.TabNavigationError.html "enum bevy::input_focus::tab_navigation::TabNavigationError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [TabNavigationError](enum.TabNavigationError.html "enum bevy::input_focus::tab_navigation::TabNavigationError")
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [TabNavigationError](enum.TabNavigationError.html "enum bevy::input_focus::tab_navigation::TabNavigationError")

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/tab_navigation.rs.html#130)

### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [TabNavigationError](enum.TabNavigationError.html "enum bevy::input_focus::tab_navigation::TabNavigationError")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [TabNavigationError](enum.TabNavigationError.html "enum bevy::input_focus::tab_navigation::TabNavigationError")

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/tab_navigation.rs.html#130)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[TabNavigationError](enum.TabNavigationError.html "enum bevy::input_focus::tab_navigation::TabNavigationError")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [TabNavigationError](enum.TabNavigationError.html "enum bevy::input_focus::tab_navigation::TabNavigationError")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TabNavigationError](enum.TabNavigationError.html "enum bevy::input_focus::tab_navigation::TabNavigationError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TabNavigationError](enum.TabNavigationError.html "enum bevy::input_focus::tab_navigation::TabNavigationError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TabNavigationError](enum.TabNavigationError.html "enum bevy::input_focus::tab_navigation::TabNavigationError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TabNavigationError](enum.TabNavigationError.html "enum bevy::input_focus::tab_navigation::TabNavigationError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TabNavigationError](enum.TabNavigationError.html "enum bevy::input_focus::tab_navigation::TabNavigationError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TabNavigationError](enum.TabNavigationError.html "enum bevy::input_focus::tab_navigation::TabNavigationError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TabNavigationError](enum.TabNavigationError.html "enum bevy::input_focus::tab_navigation::TabNavigationError")
