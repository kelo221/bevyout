...
# Struct DirectionalNavigationMap 

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#254)
...
Each entity can have up to 8 neighbors, one for each [`CompassOctant`](../../math/enum.CompassOctant.html "enum bevy::math::CompassOctant").
...
*   **Not self-connected**: An entity should not be a neighbor of itself; use [`None`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.None "variant core::option::Option::None") instead.

This graph must be built and maintained manually, and the developer is responsible for ensuring that it meets the above criteria. Notably, if the developer adds or removes the navigability of an entity, the developer should update the map as necessary.

If the automatic navigation system in `bevy_ui` is being used, this resource can be used to specify manual navigation overrides. Any navigation edges specified in this map take precedence over automatic navigation. For example, if navigation on one side of the window should wrap around to the other side of the window, this navigation behavior can be specified using this map.

## Fields

`neighbors: [EntityHashMap](../../ecs/entity/struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<[NavNeighbors](struct.NavNeighbors.html "struct bevy::input_focus::directional_navigation::NavNeighbors")>`

A directed graph of focusable entities.

Pass in the current focus as a key, and get back a collection of up to 8 neighbors, each keyed by a [`CompassOctant`](../../math/enum.CompassOctant.html "enum bevy::math::CompassOctant").

## Implementations

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#262)

### impl [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#269)

#### pub fn [remove](#method.remove)(&mut self, entity: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"))
...
If you are removing multiple entities, consider using [`remove_multiple`](struct.DirectionalNavigationMap.html#method.remove_multiple "method bevy::input_focus::directional_navigation::DirectionalNavigationMap::remove_multiple") instead.

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#288)

#### pub fn [remove\_multiple](#method.remove_multiple)(&mut self, entities: [EntityHashSet](../../ecs/entity/struct.EntityHashSet.html "struct bevy::ecs::entity::EntityHashSet"))

Removes a collection of entities from the navigation map.

While this is still an O(n) operation, where n is the number of entities in the map, it is more efficient than calling [`remove`](struct.DirectionalNavigationMap.html#method.remove "method bevy::input_focus::directional_navigation::DirectionalNavigationMap::remove") multiple times, as we can check for connections to all removed entities in a single pass.

An [`EntityHashSet`](../../ecs/entity/struct.EntityHashSet.html "struct bevy::ecs::entity::EntityHashSet") must be provided as it is noticeably faster than the standard hasher or a [`Vec`](../../prelude/struct.Vec.html "struct bevy::prelude::Vec").

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#306)

#### pub fn [clear](#method.clear)(&mut self)

Completely clears the navigation map, removing all entities and connections.

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#315)

#### pub fn [add\_edge](#method.add_edge)(&mut self, a: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), b: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), direction: [CompassOctant](../../math/enum.CompassOctant.html "enum bevy::math::CompassOctant"))
...
The reverse edge will not be added, so navigation will only be possible in one direction. If you want to add a symmetrical edge, use [`add_symmetrical_edge`](struct.DirectionalNavigationMap.html#method.add_symmetrical_edge "method bevy::input_focus::directional_navigation::DirectionalNavigationMap::add_symmetrical_edge") instead.

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/ui/navigation/directional\_navigation\_overrides.rs ([lines 359-363](../../../src/directional_navigation_overrides/directional_navigation_overrides.rs.html#359-363))
...
[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#331)

#### pub fn [block\_edge](#method.block_edge)(&mut self, a: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), direction: [CompassOctant](../../math/enum.CompassOctant.html "enum bevy::math::CompassOctant"))

Adds an edge blocking automatic navigation from an entity in a direction. Any existing edge from A in the provided direction will be overwritten.

The reverse block will not be added, so navigation will still be possible from other entities in the direction. If you want to add a symmetrical block, use [`block_symmetrical_edge`](struct.DirectionalNavigationMap.html#method.block_symmetrical_edge "method bevy::input_focus::directional_navigation::DirectionalNavigationMap::block_symmetrical_edge") instead.

Note that blocking a primary cardinal direction will not block intermediates. In other words, blocking `North` will still allow navigation towards `NorthEast`.

##### [Examples found in repository](#scraped-examples-1)[?](../../../scrape-examples-help.html)

examples/ui/navigation/directional\_navigation\_overrides.rs ([line 333](../../../src/directional_navigation_overrides/directional_navigation_overrides.rs.html#333))
...
[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#342)

#### pub fn [add\_symmetrical\_edge](#method.add_symmetrical_edge)( &mut self, a: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), b: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), direction: [CompassOctant](../../math/enum.CompassOctant.html "enum bevy::math::CompassOctant"), )

Adds a symmetrical edge between two entities in the navigation map. The A -> B path will use the provided direction, while B -> A will use the [`CompassOctant::opposite`](../../math/enum.CompassOctant.html#method.opposite "method bevy::math::CompassOctant::opposite") variant.
...
examples/ui/navigation/directional\_navigation\_overrides.rs ([lines 304-308](../../../src/directional_navigation_overrides/directional_navigation_overrides.rs.html#304-308))
...
[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#351)

#### pub fn [block\_symmetrical\_edge](#method.block_symmetrical_edge)( &mut self, a: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), b: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), direction: [CompassOctant](../../math/enum.CompassOctant.html "enum bevy::math::CompassOctant"), )

Adds a symmetrical blocking edge between two entities in the navigation map. The blocked A -> B path will use the provided direction, while B -> A will use the [`CompassOctant::opposite`](../../math/enum.CompassOctant.html#method.opposite "method bevy::math::CompassOctant::opposite") variant.

Any existing connections between the two entities will be overwritten.

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#359)

#### pub fn [add\_edges](#method.add_edges)(&mut self, entities: &\[[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\], direction: [CompassOctant](../../math/enum.CompassOctant.html "enum bevy::math::CompassOctant"))

Add symmetrical edges between each consecutive pair of entities in the provided slice.

Unlike [`add_looping_edges`](struct.DirectionalNavigationMap.html#method.add_looping_edges "method bevy::input_focus::directional_navigation::DirectionalNavigationMap::add_looping_edges"), this method does not loop back to the first entity.

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#368)

#### pub fn [add\_looping\_edges](#method.add_looping_edges)( &mut self, entities: &\[[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\], direction: [CompassOctant](../../math/enum.CompassOctant.html "enum bevy::math::CompassOctant"), )
...
examples/ui/navigation/directional\_navigation\_overrides.rs ([line 343](../../../src/directional_navigation_overrides/directional_navigation_overrides.rs.html#343))
...
[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#378)

#### pub fn [get\_neighbor](#method.get_neighbor)(&self, focus: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), octant: [CompassOctant](../../math/enum.CompassOctant.html "enum bevy::math::CompassOctant")) -> [NavNeighbor](enum.NavNeighbor.html "enum bevy::input_focus::directional_navigation::NavNeighbor")

Gets the entity in a given direction from the current focus, if any.

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#389)

#### pub fn [get\_neighbors](#method.get_neighbors)(&self, entity: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[NavNeighbors](struct.NavNeighbors.html "struct bevy::input_focus::directional_navigation::NavNeighbors")\>

Looks up the neighbors of a given entity.

If the entity is not in the map, [`None`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.None "variant core::option::Option::None") will be returned. Note that the set of neighbors may be empty!
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#248)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")

where [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#248)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")
...
### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#251)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#251)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#251)

### impl [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#251)

#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")
...
where [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#248)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#251)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")\>, ) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#252)
...
### impl [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#251)

#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")

where [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#251)

### impl [Struct](../../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")

[Source](https://docs.rs/bevy_input_focus/0.19.0/x86_64-unknown-linux-gnu/src/bevy_input_focus/directional_navigation.rs.html#251)

### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DirectionalNavigationMap](struct.DirectionalNavigationMap.html "struct bevy::input_focus::directional_navigation::DirectionalNavigationMap")
