...
[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/dof/mod.rs.html#77)
...
`mode: [DepthOfFieldMode](enum.DepthOfFieldMode.html "enum bevy::post_process::dof::DepthOfFieldMode")`

The appearance of the effect.

`focal_distance: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

The distance in meters to the location in focus.

`sensor_height: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

The height of the [image sensor format](https://en.wikipedia.org/wiki/Image_sensor_format) in meters.

Focal length is derived from the FOV and this value. The default is 18.66mm, matching the [Super 35](https://en.wikipedia.org/wiki/Super_35) format, which is popular in cinema.

`aperture_f_stops: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Along with the focal length, controls how much objects not in focus are blurred.

`max_circle_of_confusion_diameter: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`
...
`max_depth: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`
...
This is primarily useful for skyboxes and background colors. The Bevy renderer considers them to be infinitely far away. Without this value, that would cause the circle of confusion to be infinitely large, capped only by the `max_circle_of_confusion_diameter`. As that’s unsightly, this value can be used to essentially adjust how “far away” the skybox or background are.

## Implementations

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/dof/mod.rs.html#322)

### impl [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/dof/mod.rs.html#333)

#### pub fn [from\_physical\_camera](#method.from_physical_camera)(camera: &[PhysicalCameraParameters](../../camera/struct.PhysicalCameraParameters.html "struct bevy::camera::PhysicalCameraParameters")) -> [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")

Initializes [`DepthOfField`](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField") from a set of [`PhysicalCameraParameters`](../../camera/struct.PhysicalCameraParameters.html "struct bevy::camera::PhysicalCameraParameters").

By passing the same [`PhysicalCameraParameters`](../../camera/struct.PhysicalCameraParameters.html "struct bevy::camera::PhysicalCameraParameters") object to this function and to [`bevy_camera::Exposure::from_physical_camera`](../../camera/struct.Exposure.html#method.from_physical_camera "associated function bevy::camera::Exposure::from_physical_camera"), matching results for both the exposure and depth of field effects can be obtained.

All fields of the returned [`DepthOfField`](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField") other than `focal_length` and `aperture_f_stops` are set to their default values.

## Trait Implementations

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/dof/mod.rs.html#75)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/dof/mod.rs.html#75)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")

where [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/dof/mod.rs.html#308)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/dof/mod.rs.html#309)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/dof/mod.rs.html#75)

### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/dof/mod.rs.html#75)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/dof/mod.rs.html#75)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/dof/mod.rs.html#75)

### impl [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/dof/mod.rs.html#75)

#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")
...
where [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField"): 'into\_return,
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/dof/mod.rs.html#75)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/dof/mod.rs.html#76)
...
### impl [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/dof/mod.rs.html#75)

#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Struct](../../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")
...
### impl [SyncComponent](../../render/sync_component/trait.SyncComponent.html "trait bevy::render::sync_component::SyncComponent") for [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/dof/mod.rs.html#653)

#### type [Target](../../render/sync_component/trait.SyncComponent.html#associatedtype.Target) = ([DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField"), [DepthOfFieldUniform](struct.DepthOfFieldUniform.html "struct bevy::post_process::dof::DepthOfFieldUniform"), [DepthOfFieldPipelines](enum.DepthOfFieldPipelines.html "enum bevy::post_process::dof::DepthOfFieldPipelines"), [AuxiliaryDepthOfFieldTexture](struct.AuxiliaryDepthOfFieldTexture.html "struct bevy::post_process::dof::AuxiliaryDepthOfFieldTexture"), [ViewDepthOfFieldBindGroupLayouts](struct.ViewDepthOfFieldBindGroupLayouts.html "struct bevy::post_process::dof::ViewDepthOfFieldBindGroupLayouts"))

Describes what components should be removed from the render world if the implementing component is removed.

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/dof/mod.rs.html#75)

### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DepthOfField](struct.DepthOfField.html "struct bevy::post_process::dof::DepthOfField")
