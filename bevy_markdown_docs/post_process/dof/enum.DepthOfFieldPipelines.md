...
# Enum DepthOfFieldPipelines 

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/dof/mod.rs.html#255)
...
`horizontal: [CachedRenderPipelineId](../../material/descriptor/struct.CachedRenderPipelineId.html "struct bevy::material::descriptor::CachedRenderPipelineId")`

`vertical: [CachedRenderPipelineId](../../material/descriptor/struct.CachedRenderPipelineId.html "struct bevy::material::descriptor::CachedRenderPipelineId")`

### Bokeh

#### Fields

`pass_0: [CachedRenderPipelineId](../../material/descriptor/struct.CachedRenderPipelineId.html "struct bevy::material::descriptor::CachedRenderPipelineId")`

`pass_1: [CachedRenderPipelineId](../../material/descriptor/struct.CachedRenderPipelineId.html "struct bevy::material::descriptor::CachedRenderPipelineId")`

## Trait Implementations

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/dof/mod.rs.html#254)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [DepthOfFieldPipelines](enum.DepthOfFieldPipelines.html "enum bevy::post_process::dof::DepthOfFieldPipelines")

where [DepthOfFieldPipelines](enum.DepthOfFieldPipelines.html "enum bevy::post_process::dof::DepthOfFieldPipelines"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
#### fn [map\_entities](../../prelude/trait.Component.html#method.map_entities)<M>(this: &mut [DepthOfFieldPipelines](enum.DepthOfFieldPipelines.html "enum bevy::post_process::dof::DepthOfFieldPipelines"), mapper: [&mut M](https://doc.rust-lang.org/nightly/std/primitive.reference.html))
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DepthOfFieldPipelines](enum.DepthOfFieldPipelines.html "enum bevy::post_process::dof::DepthOfFieldPipelines")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DepthOfFieldPipelines](enum.DepthOfFieldPipelines.html "enum bevy::post_process::dof::DepthOfFieldPipelines")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DepthOfFieldPipelines](enum.DepthOfFieldPipelines.html "enum bevy::post_process::dof::DepthOfFieldPipelines")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DepthOfFieldPipelines](enum.DepthOfFieldPipelines.html "enum bevy::post_process::dof::DepthOfFieldPipelines")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DepthOfFieldPipelines](enum.DepthOfFieldPipelines.html "enum bevy::post_process::dof::DepthOfFieldPipelines")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DepthOfFieldPipelines](enum.DepthOfFieldPipelines.html "enum bevy::post_process::dof::DepthOfFieldPipelines")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DepthOfFieldPipelines](enum.DepthOfFieldPipelines.html "enum bevy::post_process::dof::DepthOfFieldPipelines")
