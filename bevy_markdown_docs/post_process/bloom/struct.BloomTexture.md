...
[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/bloom/mod.rs.html#278)

```rust
pub struct BloomTexture { /* private fields */ }
```

## Trait Implementations

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/bloom/mod.rs.html#277)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [BloomTexture](struct.BloomTexture.html "struct bevy::post_process::bloom::BloomTexture")

where [BloomTexture](struct.BloomTexture.html "struct bevy::post_process::bloom::BloomTexture"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [BloomTexture](struct.BloomTexture.html "struct bevy::post_process::bloom::BloomTexture")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [BloomTexture](struct.BloomTexture.html "struct bevy::post_process::bloom::BloomTexture")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [BloomTexture](struct.BloomTexture.html "struct bevy::post_process::bloom::BloomTexture")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [BloomTexture](struct.BloomTexture.html "struct bevy::post_process::bloom::BloomTexture")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [BloomTexture](struct.BloomTexture.html "struct bevy::post_process::bloom::BloomTexture")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [BloomTexture](struct.BloomTexture.html "struct bevy::post_process::bloom::BloomTexture")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [BloomTexture](struct.BloomTexture.html "struct bevy::post_process::bloom::BloomTexture")
