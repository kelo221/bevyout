...
[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/bloom/mod.rs.html#380)

```rust
pub struct BloomBindGroups { /* private fields */ }
```

## Trait Implementations

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/bloom/mod.rs.html#379)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [BloomBindGroups](struct.BloomBindGroups.html "struct bevy::post_process::bloom::BloomBindGroups")

where [BloomBindGroups](struct.BloomBindGroups.html "struct bevy::post_process::bloom::BloomBindGroups"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [BloomBindGroups](struct.BloomBindGroups.html "struct bevy::post_process::bloom::BloomBindGroups")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [BloomBindGroups](struct.BloomBindGroups.html "struct bevy::post_process::bloom::BloomBindGroups")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [BloomBindGroups](struct.BloomBindGroups.html "struct bevy::post_process::bloom::BloomBindGroups")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [BloomBindGroups](struct.BloomBindGroups.html "struct bevy::post_process::bloom::BloomBindGroups")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [BloomBindGroups](struct.BloomBindGroups.html "struct bevy::post_process::bloom::BloomBindGroups")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [BloomBindGroups](struct.BloomBindGroups.html "struct bevy::post_process::bloom::BloomBindGroups")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [BloomBindGroups](struct.BloomBindGroups.html "struct bevy::post_process::bloom::BloomBindGroups")
