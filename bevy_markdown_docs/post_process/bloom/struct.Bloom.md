...
[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/bloom/settings.rs.html#33)
...
See also [https://en.wikipedia.org/wiki/Bloom\_(shader\_effect)](https://en.wikipedia.org/wiki/Bloom_\(shader_effect\)).

## Usage Notes

Often used in conjunction with `bevy_pbr::StandardMaterial::emissive` for 3d meshes.

Bloom is best used alongside a tonemapping function that desaturates bright colors, such as [`bevy_core_pipeline::tonemapping::Tonemapping::TonyMcMapface`](../../core_pipeline/tonemapping/enum.Tonemapping.html#variant.TonyMcMapface "variant bevy::core_pipeline::tonemapping::Tonemapping::TonyMcMapface").

Bevy’s implementation uses a parametric curve to blend between a set of blurred (lower frequency) images generated from the camera’s view. See [https://starlederer.github.io/bloom/](https://starlederer.github.io/bloom/) for a visualization of the parametric curve used in Bevy as well as a visualization of the curve’s respective scattering profile.

## Fields

`intensity: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`
...
`low_frequency_boost: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`
...
`low_frequency_boost_curvature: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`
...
`high_pass_frequency: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`
...
`prefilter: [BloomPrefilter](struct.BloomPrefilter.html "struct bevy::post_process::bloom::BloomPrefilter")`
...
Changing these settings creates a physically inaccurate image and makes it easy to make the final result look worse. However, they can be useful when emulating the 1990s-2000s game look. See [`BloomPrefilter`](struct.BloomPrefilter.html "struct bevy::post_process::bloom::BloomPrefilter") for more information.

`composite_mode: [BloomCompositeMode](enum.BloomCompositeMode.html "enum bevy::post_process::bloom::BloomCompositeMode")`
...
Set to [`BloomCompositeMode::Additive`](enum.BloomCompositeMode.html#variant.Additive "variant bevy::post_process::bloom::BloomCompositeMode::Additive") if `prefilter` is configured in a non-energy-conserving way, otherwise set to [`BloomCompositeMode::EnergyConserving`](enum.BloomCompositeMode.html#variant.EnergyConserving "variant bevy::post_process::bloom::BloomCompositeMode::EnergyConserving").

`max_mip_dimension: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
`scale: [Vec2](../../prelude/struct.Vec2.html "struct bevy::prelude::Vec2")`

Amount to stretch the bloom on each axis. Artistic control, can be used to emulate anamorphic blur by using a large x-value. For large values, you may need to increase [`Bloom::max_mip_dimension`](struct.Bloom.html#structfield.max_mip_dimension "field bevy::post_process::bloom::Bloom::max_mip_dimension") to reduce sampling artifacts.

## Implementations

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/bloom/settings.rs.html#126)

### impl [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/bloom/settings.rs.html#132)

#### pub const [NATURAL](#associatedconstant.NATURAL): [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")

The default bloom preset.

This uses the [`EnergyConserving`](enum.BloomCompositeMode.html#variant.EnergyConserving "variant bevy::post_process::bloom::BloomCompositeMode::EnergyConserving") composite mode.

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/bloom/settings.rs.html#147)

#### pub const [ANAMORPHIC](#associatedconstant.ANAMORPHIC): [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")

Emulates the look of stylized anamorphic bloom, stretched horizontally.

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/bloom/settings.rs.html#155)

#### pub const [OLD\_SCHOOL](#associatedconstant.OLD_SCHOOL): [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")

A preset that’s similar to how older games did bloom.

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/bloom/settings.rs.html#170)

#### pub const [SCREEN\_BLUR](#associatedconstant.SCREEN_BLUR): [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/bloom/settings.rs.html#30)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")

where [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

**Required Components**: [`Hdr`](../../camera/struct.Hdr.html "struct bevy::camera::Hdr").
...
[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/bloom/settings.rs.html#185)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/bloom/settings.rs.html#186)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")
...
### impl [ExtractComponent](../../render/extract_component/trait.ExtractComponent.html "trait bevy::render::extract_component::ExtractComponent") for [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/bloom/settings.rs.html#228)

#### type [QueryData](../../render/extract_component/trait.ExtractComponent.html#associatedtype.QueryData) = (&'static [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom"), &'static [Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera"))
...
#### type [QueryFilter](../../render/extract_component/trait.ExtractComponent.html#associatedtype.QueryFilter) = [With](../../prelude/struct.With.html "struct bevy::prelude::With")<[Hdr](../../camera/struct.Hdr.html "struct bevy::camera::Hdr")\>
...
#### type [Out](../../render/extract_component/trait.ExtractComponent.html#associatedtype.Out) = ([Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom"), BloomUniforms)
...
[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/bloom/settings.rs.html#232)

#### fn [extract\_component](../../render/extract_component/trait.ExtractComponent.html#tymethod.extract_component)( \_: <<[Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom") as [ExtractComponent](../../render/extract_component/trait.ExtractComponent.html "trait bevy::render::extract_component::ExtractComponent")\>::[QueryData](../../render/extract_component/trait.ExtractComponent.html#associatedtype.QueryData "type bevy::render::extract_component::ExtractComponent::QueryData") as [QueryData](../../ecs/query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../../ecs/query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'\_, '\_>, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom") as [ExtractComponent](../../render/extract_component/trait.ExtractComponent.html "trait bevy::render::extract_component::ExtractComponent")\>::[Out](../../render/extract_component/trait.ExtractComponent.html#associatedtype.Out "type bevy::render::extract_component::ExtractComponent::Out")\>
...
### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/bloom/settings.rs.html#30)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/bloom/settings.rs.html#30)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/bloom/settings.rs.html#30)

### impl [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/bloom/settings.rs.html#30)

#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")
...
where [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom"): 'into\_return,
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/bloom/settings.rs.html#30)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/bloom/settings.rs.html#31)
...
### impl [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/bloom/settings.rs.html#30)

#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Struct](../../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")
...
### impl [SyncComponent](../../render/sync_component/trait.SyncComponent.html "trait bevy::render::sync_component::SyncComponent") for [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/bloom/settings.rs.html#224)

#### type [Target](../../render/sync_component/trait.SyncComponent.html#associatedtype.Target) = ([Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom"), BloomUniforms)

Describes what components should be removed from the render world if the implementing component is removed.

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/bloom/settings.rs.html#30)

### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Bloom](struct.Bloom.html "struct bevy::post_process::bloom::Bloom")
