...
[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/effect_stack/mod.rs.html#80)

```rust
pub struct PostProcessingPipeline { /* private fields */ }
```
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [PostProcessingPipeline](struct.PostProcessingPipeline.html "struct bevy::post_process::effect_stack::PostProcessingPipeline")

where [PostProcessingPipeline](struct.PostProcessingPipeline.html "struct bevy::post_process::effect_stack::PostProcessingPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [PostProcessingPipeline](struct.PostProcessingPipeline.html "struct bevy::post_process::effect_stack::PostProcessingPipeline")
...
### impl [SpecializedRenderPipeline](../../render/render_resource/trait.SpecializedRenderPipeline.html "trait bevy::render::render_resource::SpecializedRenderPipeline") for [PostProcessingPipeline](struct.PostProcessingPipeline.html "struct bevy::post_process::effect_stack::PostProcessingPipeline")
...
#### type [Key](../../render/render_resource/trait.SpecializedRenderPipeline.html#associatedtype.Key) = [PostProcessingPipelineKey](struct.PostProcessingPipelineKey.html "struct bevy::post_process::effect_stack::PostProcessingPipelineKey")

The key that defines each “variant” of the render pipeline.

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/effect_stack/mod.rs.html#224)

#### fn [specialize](../../render/render_resource/trait.SpecializedRenderPipeline.html#tymethod.specialize)( &self, key: <[PostProcessingPipeline](struct.PostProcessingPipeline.html "struct bevy::post_process::effect_stack::PostProcessingPipeline") as [SpecializedRenderPipeline](../../render/render_resource/trait.SpecializedRenderPipeline.html "trait bevy::render::render_resource::SpecializedRenderPipeline")\>::[Key](../../render/render_resource/trait.SpecializedRenderPipeline.html#associatedtype.Key "type bevy::render::render_resource::SpecializedRenderPipeline::Key"), ) -> [RenderPipelineDescriptor](../../material/descriptor/struct.RenderPipelineDescriptor.html "struct bevy::material::descriptor::RenderPipelineDescriptor")

Construct a new render pipeline based on the provided key.

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [PostProcessingPipeline](struct.PostProcessingPipeline.html "struct bevy::post_process::effect_stack::PostProcessingPipeline")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [PostProcessingPipeline](struct.PostProcessingPipeline.html "struct bevy::post_process::effect_stack::PostProcessingPipeline")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [PostProcessingPipeline](struct.PostProcessingPipeline.html "struct bevy::post_process::effect_stack::PostProcessingPipeline")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [PostProcessingPipeline](struct.PostProcessingPipeline.html "struct bevy::post_process::effect_stack::PostProcessingPipeline")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [PostProcessingPipeline](struct.PostProcessingPipeline.html "struct bevy::post_process::effect_stack::PostProcessingPipeline")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [PostProcessingPipeline](struct.PostProcessingPipeline.html "struct bevy::post_process::effect_stack::PostProcessingPipeline")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [PostProcessingPipeline](struct.PostProcessingPipeline.html "struct bevy::post_process::effect_stack::PostProcessingPipeline")
