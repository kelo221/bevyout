...
# Struct MsaaWritebackBlitPipeline 

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/msaa_writeback.rs.html#98)

```rust
pub struct MsaaWritebackBlitPipeline(/* private fields */);
```

## Trait Implementations

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/msaa_writeback.rs.html#97)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [MsaaWritebackBlitPipeline](struct.MsaaWritebackBlitPipeline.html "struct bevy::post_process::msaa_writeback::MsaaWritebackBlitPipeline")

where [MsaaWritebackBlitPipeline](struct.MsaaWritebackBlitPipeline.html "struct bevy::post_process::msaa_writeback::MsaaWritebackBlitPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MsaaWritebackBlitPipeline](struct.MsaaWritebackBlitPipeline.html "struct bevy::post_process::msaa_writeback::MsaaWritebackBlitPipeline")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MsaaWritebackBlitPipeline](struct.MsaaWritebackBlitPipeline.html "struct bevy::post_process::msaa_writeback::MsaaWritebackBlitPipeline")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MsaaWritebackBlitPipeline](struct.MsaaWritebackBlitPipeline.html "struct bevy::post_process::msaa_writeback::MsaaWritebackBlitPipeline")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MsaaWritebackBlitPipeline](struct.MsaaWritebackBlitPipeline.html "struct bevy::post_process::msaa_writeback::MsaaWritebackBlitPipeline")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MsaaWritebackBlitPipeline](struct.MsaaWritebackBlitPipeline.html "struct bevy::post_process::msaa_writeback::MsaaWritebackBlitPipeline")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MsaaWritebackBlitPipeline](struct.MsaaWritebackBlitPipeline.html "struct bevy::post_process::msaa_writeback::MsaaWritebackBlitPipeline")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MsaaWritebackBlitPipeline](struct.MsaaWritebackBlitPipeline.html "struct bevy::post_process::msaa_writeback::MsaaWritebackBlitPipeline")
