...
[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/motion_blur/mod.rs.html#76)
...
Other approaches, such as _A Reconstruction Filter for Plausible Motion Blur_ produce more correct results, but are more expensive and complex, and have other kinds of artifacts. This implementation is relatively inexpensive and effective.

## Usage

Add the [`MotionBlur`](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur") component to a camera to enable and configure motion blur for that camera.
...
`shutter_angle: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`
...
*   Set the shutter angle greater than one. For example, to emulate the blur strength of film while rendering at 60fps, you would set the shutter angle to `60/24 * 0.5 = 1.25`. Note that this will result in artifacts where the motion of objects will stretch further than they moved between frames; users may find this distracting.

`samples: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

The quality of motion blur, corresponding to the number of per-pixel samples taken in each direction during blur.

Setting this to `1` results in each pixel being sampled once in the leading direction, once in the trailing direction, and once in the middle, for a total of 3 samples (`1 * 2 + 1`). Setting this to `3` will result in `3 * 2 + 1 = 7` samples. Setting this to `0` is equivalent to disabling motion blur.
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/motion_blur/mod.rs.html#73)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")

where [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

**Required Components**: [`MotionVectorPrepass`](../../core_pipeline/prepass/struct.MotionVectorPrepass.html "struct bevy::core_pipeline::prepass::MotionVectorPrepass").
...
[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/motion_blur/mod.rs.html#109)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/motion_blur/mod.rs.html#110)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")
...
### impl [ExtractComponent](../../render/extract_component/trait.ExtractComponent.html "trait bevy::render::extract_component::ExtractComponent") for [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/motion_blur/mod.rs.html#123)

#### type [QueryData](../../render/extract_component/trait.ExtractComponent.html#associatedtype.QueryData) = &'static [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")
...
#### type [Out](../../render/extract_component/trait.ExtractComponent.html#associatedtype.Out) = MotionBlurUniform
...
[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/motion_blur/mod.rs.html#127)

#### fn [extract\_component](../../render/extract_component/trait.ExtractComponent.html#tymethod.extract_component)( item: <<[MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur") as [ExtractComponent](../../render/extract_component/trait.ExtractComponent.html "trait bevy::render::extract_component::ExtractComponent")\>::[QueryData](../../render/extract_component/trait.ExtractComponent.html#associatedtype.QueryData "type bevy::render::extract_component::ExtractComponent::QueryData") as [QueryData](../../ecs/query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../../ecs/query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'\_, '\_>, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur") as [ExtractComponent](../../render/extract_component/trait.ExtractComponent.html "trait bevy::render::extract_component::ExtractComponent")\>::[Out](../../render/extract_component/trait.ExtractComponent.html#associatedtype.Out "type bevy::render::extract_component::ExtractComponent::Out")\>
...
### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/motion_blur/mod.rs.html#73)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/motion_blur/mod.rs.html#73)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/motion_blur/mod.rs.html#73)

### impl [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/motion_blur/mod.rs.html#73)

#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")
...
where [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur"): 'into\_return,
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/motion_blur/mod.rs.html#73)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/motion_blur/mod.rs.html#74)
...
### impl [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/motion_blur/mod.rs.html#73)

#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Struct](../../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")
...
### impl [SyncComponent](../../render/sync_component/trait.SyncComponent.html "trait bevy::render::sync_component::SyncComponent") for [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/motion_blur/mod.rs.html#119)

#### type [Target](../../render/sync_component/trait.SyncComponent.html#associatedtype.Target) = MotionBlurUniform

Describes what components should be removed from the render world if the implementing component is removed.

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/motion_blur/mod.rs.html#73)

### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MotionBlur](struct.MotionBlur.html "struct bevy::post_process::motion_blur::MotionBlur")
