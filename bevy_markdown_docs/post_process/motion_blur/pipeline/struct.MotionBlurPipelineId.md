...
# Struct MotionBlurPipelineId 

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/motion_blur/pipeline.rs.html#158)
...
[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/motion_blur/pipeline.rs.html#157)

### impl [Component](../../../prelude/trait.Component.html "trait bevy::prelude::Component") for [MotionBlurPipelineId](struct.MotionBlurPipelineId.html "struct bevy::post_process::motion_blur::pipeline::MotionBlurPipelineId")

where [MotionBlurPipelineId](struct.MotionBlurPipelineId.html "struct bevy::post_process::motion_blur::pipeline::MotionBlurPipelineId"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MotionBlurPipelineId](struct.MotionBlurPipelineId.html "struct bevy::post_process::motion_blur::pipeline::MotionBlurPipelineId")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MotionBlurPipelineId](struct.MotionBlurPipelineId.html "struct bevy::post_process::motion_blur::pipeline::MotionBlurPipelineId")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MotionBlurPipelineId](struct.MotionBlurPipelineId.html "struct bevy::post_process::motion_blur::pipeline::MotionBlurPipelineId")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MotionBlurPipelineId](struct.MotionBlurPipelineId.html "struct bevy::post_process::motion_blur::pipeline::MotionBlurPipelineId")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MotionBlurPipelineId](struct.MotionBlurPipelineId.html "struct bevy::post_process::motion_blur::pipeline::MotionBlurPipelineId")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MotionBlurPipelineId](struct.MotionBlurPipelineId.html "struct bevy::post_process::motion_blur::pipeline::MotionBlurPipelineId")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MotionBlurPipelineId](struct.MotionBlurPipelineId.html "struct bevy::post_process::motion_blur::pipeline::MotionBlurPipelineId")
