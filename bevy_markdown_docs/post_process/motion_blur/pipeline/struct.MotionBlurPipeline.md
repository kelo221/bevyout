...
# Struct MotionBlurPipeline 

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/motion_blur/pipeline.rs.html#29)

```rust
pub struct MotionBlurPipeline { /* private fields */ }
```
...
### impl [Component](../../../prelude/trait.Component.html "trait bevy::prelude::Component") for [MotionBlurPipeline](struct.MotionBlurPipeline.html "struct bevy::post_process::motion_blur::pipeline::MotionBlurPipeline")

where [MotionBlurPipeline](struct.MotionBlurPipeline.html "struct bevy::post_process::motion_blur::pipeline::MotionBlurPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [MotionBlurPipeline](struct.MotionBlurPipeline.html "struct bevy::post_process::motion_blur::pipeline::MotionBlurPipeline")
...
### impl [SpecializedRenderPipeline](../../../render/render_resource/trait.SpecializedRenderPipeline.html "trait bevy::render::render_resource::SpecializedRenderPipeline") for [MotionBlurPipeline](struct.MotionBlurPipeline.html "struct bevy::post_process::motion_blur::pipeline::MotionBlurPipeline")
...
#### type [Key](../../../render/render_resource/trait.SpecializedRenderPipeline.html#associatedtype.Key) = [MotionBlurPipelineKey](struct.MotionBlurPipelineKey.html "struct bevy::post_process::motion_blur::pipeline::MotionBlurPipelineKey")

The key that defines each “variant” of the render pipeline.

[Source](https://docs.rs/bevy_post_process/0.19.0/x86_64-unknown-linux-gnu/src/bevy_post_process/motion_blur/pipeline.rs.html#121)

#### fn [specialize](../../../render/render_resource/trait.SpecializedRenderPipeline.html#tymethod.specialize)( &self, key: <[MotionBlurPipeline](struct.MotionBlurPipeline.html "struct bevy::post_process::motion_blur::pipeline::MotionBlurPipeline") as [SpecializedRenderPipeline](../../../render/render_resource/trait.SpecializedRenderPipeline.html "trait bevy::render::render_resource::SpecializedRenderPipeline")\>::[Key](../../../render/render_resource/trait.SpecializedRenderPipeline.html#associatedtype.Key "type bevy::render::render_resource::SpecializedRenderPipeline::Key"), ) -> [RenderPipelineDescriptor](../../../material/descriptor/struct.RenderPipelineDescriptor.html "struct bevy::material::descriptor::RenderPipelineDescriptor")

Construct a new render pipeline based on the provided key.

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MotionBlurPipeline](struct.MotionBlurPipeline.html "struct bevy::post_process::motion_blur::pipeline::MotionBlurPipeline")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MotionBlurPipeline](struct.MotionBlurPipeline.html "struct bevy::post_process::motion_blur::pipeline::MotionBlurPipeline")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MotionBlurPipeline](struct.MotionBlurPipeline.html "struct bevy::post_process::motion_blur::pipeline::MotionBlurPipeline")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MotionBlurPipeline](struct.MotionBlurPipeline.html "struct bevy::post_process::motion_blur::pipeline::MotionBlurPipeline")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MotionBlurPipeline](struct.MotionBlurPipeline.html "struct bevy::post_process::motion_blur::pipeline::MotionBlurPipeline")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MotionBlurPipeline](struct.MotionBlurPipeline.html "struct bevy::post_process::motion_blur::pipeline::MotionBlurPipeline")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MotionBlurPipeline](struct.MotionBlurPipeline.html "struct bevy::post_process::motion_blur::pipeline::MotionBlurPipeline")
