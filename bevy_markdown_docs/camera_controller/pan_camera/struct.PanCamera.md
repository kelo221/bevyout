[bevy](../../index.html)::[camera\_controller](../index.html)::[pan\_camera](index.html)

# Struct PanCamera 

[Source](https://docs.rs/bevy_camera_controller/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera_controller/pan_camera.rs.html#44)
...
Add this component to a [`Camera`](../../prelude/struct.Camera.html "struct bevy::prelude::Camera") entity to enable keyboard and mouse controls for panning, zooming, and optional rotation. Requires the [`PanCameraPlugin`](struct.PanCameraPlugin.html "struct bevy::camera_controller::pan_camera::PanCameraPlugin").

## Fields

`enabled: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

Enables this [`PanCamera`](struct.PanCamera.html "struct bevy::camera_controller::pan_camera::PanCamera") when `true`.

`zoom_factor: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Current zoom level (factor applied to camera scale).

`min_zoom: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Minimum allowed zoom level.

`max_zoom: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Maximum allowed zoom level.

`zoom_speed: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Translation speed for panning movement.

`key_zoom_in: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[KeyCode](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode")>`

[`KeyCode`](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode") to zoom in.

`key_zoom_out: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[KeyCode](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode")>`

[`KeyCode`](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode") to zoom out.

`pan_speed: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

This [`PanCamera`](struct.PanCamera.html "struct bevy::camera_controller::pan_camera::PanCamera")’s translation speed.

`key_up: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[KeyCode](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode")>`

[`KeyCode`](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode") for upward translation.

`key_down: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[KeyCode](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode")>`

[`KeyCode`](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode") for downward translation.

`key_left: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[KeyCode](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode")>`

[`KeyCode`](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode") for leftward translation.

`key_right: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[KeyCode](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode")>`

[`KeyCode`](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode") for rightward translation.

`rotation_speed: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Rotation speed multiplier (in radians per second).

`key_rotate_ccw: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[KeyCode](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode")>`

[`KeyCode`](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode") for counter-clockwise rotation.

`key_rotate_cw: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[KeyCode](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode")>`

[`KeyCode`](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode") for clockwise rotation.

`mouse_pan_settings: [MousePanSettings](struct.MousePanSettings.html "struct bevy::camera_controller::pan_camera::MousePanSettings")`

Mouse pan settings.

## Trait Implementations

[Source](https://docs.rs/bevy_camera_controller/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera_controller/pan_camera.rs.html#43)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [PanCamera](struct.PanCamera.html "struct bevy::camera_controller::pan_camera::PanCamera")

where [PanCamera](struct.PanCamera.html "struct bevy::camera_controller::pan_camera::PanCamera"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
[Source](https://docs.rs/bevy_camera_controller/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera_controller/pan_camera.rs.html#100)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [PanCamera](struct.PanCamera.html "struct bevy::camera_controller::pan_camera::PanCamera")
...
[Source](https://docs.rs/bevy_camera_controller/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera_controller/pan_camera.rs.html#105)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [PanCamera](struct.PanCamera.html "struct bevy::camera_controller::pan_camera::PanCamera")

Provides the default values for the `PanCamera` controller.

Users can override these values by manually creating a `PanCamera` instance or modifying the default instance.

[Source](https://docs.rs/bevy_camera_controller/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera_controller/pan_camera.rs.html#136)

### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [PanCamera](struct.PanCamera.html "struct bevy::camera_controller::pan_camera::PanCamera")

[Source](https://docs.rs/bevy_camera_controller/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera_controller/pan_camera.rs.html#137)
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [PanCamera](struct.PanCamera.html "struct bevy::camera_controller::pan_camera::PanCamera")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [PanCamera](struct.PanCamera.html "struct bevy::camera_controller::pan_camera::PanCamera")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [PanCamera](struct.PanCamera.html "struct bevy::camera_controller::pan_camera::PanCamera")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [PanCamera](struct.PanCamera.html "struct bevy::camera_controller::pan_camera::PanCamera")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [PanCamera](struct.PanCamera.html "struct bevy::camera_controller::pan_camera::PanCamera")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [PanCamera](struct.PanCamera.html "struct bevy::camera_controller::pan_camera::PanCamera")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [PanCamera](struct.PanCamera.html "struct bevy::camera_controller::pan_camera::PanCamera")
