...
[Source](https://docs.rs/bevy_camera_controller/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera_controller/free_camera.rs.html#225)
...
This component holds dynamic data that changes during camera operation, such as pitch, yaw, velocity, and whether the controller is currently enabled.

It is automatically added to any entity that has a [`FreeCamera`](struct.FreeCamera.html "struct bevy::camera_controller::free_camera::FreeCamera") component, and is updated by the [`FreeCameraPlugin`](struct.FreeCameraPlugin.html "struct bevy::camera_controller::free_camera::FreeCameraPlugin") systems in response to user input.

## Fields

`enabled: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

Enables [`FreeCamera`](struct.FreeCamera.html "struct bevy::camera_controller::free_camera::FreeCamera") controls when `true`.

`pitch: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

This [`FreeCamera`](struct.FreeCamera.html "struct bevy::camera_controller::free_camera::FreeCamera")’s pitch rotation.

`yaw: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

This [`FreeCamera`](struct.FreeCamera.html "struct bevy::camera_controller::free_camera::FreeCamera")’s yaw rotation.

`speed_multiplier: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Multiplier applied to movement speed.

`velocity: [Vec3](../../prelude/struct.Vec3.html "struct bevy::prelude::Vec3")`

This [`FreeCamera`](struct.FreeCamera.html "struct bevy::camera_controller::free_camera::FreeCamera")’s translation velocity.

`rotation_curve: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<([f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), [SampleAutoCurve](../../prelude/struct.SampleAutoCurve.html "struct bevy::prelude::SampleAutoCurve")<[Quat](../../prelude/struct.Quat.html "struct bevy::prelude::Quat")>)>`

Dictates camera movement during camera snap at speed, specified in [`FreeCamera`](struct.FreeCamera.html "struct bevy::camera_controller::free_camera::FreeCamera") by [`FreeCamera::rotation_speed`](struct.FreeCamera.html#structfield.rotation_speed "field bevy::camera_controller::free_camera::FreeCamera::rotation_speed") field. Consist of counter of seconds from pressing curve snap hotkeys and curve that used to interpolate between old and new rotation

## Trait Implementations

[Source](https://docs.rs/bevy_camera_controller/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera_controller/free_camera.rs.html#224)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [FreeCameraState](struct.FreeCameraState.html "struct bevy::camera_controller::free_camera::FreeCameraState")

where [FreeCameraState](struct.FreeCameraState.html "struct bevy::camera_controller::free_camera::FreeCameraState"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
[Source](https://docs.rs/bevy_camera_controller/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera_controller/free_camera.rs.html#243)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [FreeCameraState](struct.FreeCameraState.html "struct bevy::camera_controller::free_camera::FreeCameraState")

[Source](https://docs.rs/bevy_camera_controller/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera_controller/free_camera.rs.html#244)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [FreeCameraState](struct.FreeCameraState.html "struct bevy::camera_controller::free_camera::FreeCameraState")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [FreeCameraState](struct.FreeCameraState.html "struct bevy::camera_controller::free_camera::FreeCameraState")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [FreeCameraState](struct.FreeCameraState.html "struct bevy::camera_controller::free_camera::FreeCameraState")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [FreeCameraState](struct.FreeCameraState.html "struct bevy::camera_controller::free_camera::FreeCameraState")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [FreeCameraState](struct.FreeCameraState.html "struct bevy::camera_controller::free_camera::FreeCameraState")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [FreeCameraState](struct.FreeCameraState.html "struct bevy::camera_controller::free_camera::FreeCameraState")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [FreeCameraState](struct.FreeCameraState.html "struct bevy::camera_controller::free_camera::FreeCameraState")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [FreeCameraState](struct.FreeCameraState.html "struct bevy::camera_controller::free_camera::FreeCameraState")
