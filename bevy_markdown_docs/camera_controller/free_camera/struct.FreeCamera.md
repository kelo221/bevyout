...
[Source](https://docs.rs/bevy_camera_controller/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera_controller/free_camera.rs.html#77)
...
This component defines static configuration for camera controls, including movement speed, sensitivity, and input bindings.

From the controller’s perspective, this data is treated as immutable, but it may be modified externally (e.g., by a settings UI) at runtime.

Add this component to a [`Camera`](../../prelude/struct.Camera.html "struct bevy::prelude::Camera") entity to enable `FreeCamera` controls. The associated dynamic state is automatically handled by [`FreeCameraState`](struct.FreeCameraState.html "struct bevy::camera_controller::free_camera::FreeCameraState"), which is added to the entity as a required component.

To activate the controller, add the [`FreeCameraPlugin`](struct.FreeCameraPlugin.html "struct bevy::camera_controller::free_camera::FreeCameraPlugin") to your [`App`](../../prelude/struct.App.html "struct bevy::prelude::App").

## Fields

`sensitivity: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Multiplier for pitch and yaw rotation speed.

`key_forward: [KeyCode](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode")`

[`KeyCode`](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode") for forward translation.

`key_back: [KeyCode](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode")`

[`KeyCode`](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode") for backward translation.

`key_left: [KeyCode](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode")`

[`KeyCode`](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode") for left translation.

`key_right: [KeyCode](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode")`

[`KeyCode`](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode") for right translation.

`key_up: [KeyCode](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode")`

[`KeyCode`](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode") for up translation.

`key_down: [KeyCode](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode")`

[`KeyCode`](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode") for down translation.

`key_run: [KeyCode](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode")`

[`KeyCode`](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode") to use [`run_speed`](struct.FreeCamera.html#structfield.run_speed "field bevy::camera_controller::free_camera::FreeCamera::run_speed") instead of [`walk_speed`](struct.FreeCamera.html#structfield.walk_speed "field bevy::camera_controller::free_camera::FreeCamera::walk_speed") for translation.

`mouse_key_cursor_grab: [MouseButton](../../prelude/enum.MouseButton.html "enum bevy::prelude::MouseButton")`

[`MouseButton`](../../prelude/enum.MouseButton.html "enum bevy::prelude::MouseButton") for grabbing the mouse focus.

`keyboard_key_toggle_cursor_grab: [KeyCode](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode")`

[`KeyCode`](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode") for grabbing the keyboard focus.

`key_snap_reverse: [KeyCode](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode")`

Modifier [`KeyCode`](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode") for making pressed axis alignment buttons go in opposite direction

`axis_top: [KeyCode](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode")`

[`KeyCode`](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode") for snapping camera to top/bottom (+Y/-Y).

`axis_right: [KeyCode](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode")`

[`KeyCode`](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode") for snapping camera to right/left (+X/-X).

`axis_front: [KeyCode](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode")`

[`KeyCode`](../../prelude/enum.KeyCode.html "enum bevy::prelude::KeyCode") for snapping camera to front/back (-Z/+Z).

`walk_speed: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Base multiplier for unmodified translation speed.

`run_speed: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Base multiplier for running translation speed.

`scroll_factor: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Multiplier for how much the mouse scroll wheel affects [`walk_speed`](struct.FreeCamera.html#structfield.walk_speed "field bevy::camera_controller::free_camera::FreeCamera::walk_speed") and [`run_speed`](struct.FreeCamera.html#structfield.run_speed "field bevy::camera_controller::free_camera::FreeCamera::run_speed").

Mouse scroll affects speed exponentially. This is to ensure that scrolling the same amount always has the same effect on speed, regardless of how the scroll amount is reported by the hardware (i.e. as one big event vs many smaller events). This also allows the free camera to navigate very large scenes easier.

For every unit of scroll, the speed of the camera is multiplied by a factor of `e^(scroll_factor)`.

A reasonable value to start with is a `scroll_factor` between 0.04879016 (~ln(1.05)) and 0.0953102 (~ln(1.1)). They represent an increase by a factor between 1.05 and 1.1 per positive unit scroll and a reduction between ~0.952 (~e^-0.04879016) and ~0.909 (~e^-0.0953102) times its value per negative unit scroll

A `scroll_factor` closer to 0.0 means that speed will be less sensitive to scroll. A `scroll_factor` equal to 0.0 means that speed is unaffected by scroll (it will be multiplied by a factor of 1.0 per positive and negative unit scroll).

`friction: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Friction factor used to exponentially decay [`velocity`](struct.FreeCameraState.html#structfield.velocity "field bevy::camera_controller::free_camera::FreeCameraState::velocity") over time.

`rotation_speed: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Speed of camera rotation to snapped axis in radians/second

`vertical_movement_axis: [VerticalMovementAxis](enum.VerticalMovementAxis.html "enum bevy::camera_controller::free_camera::VerticalMovementAxis")`

Whether the vertical inputs translate the camera in world or local space axes.

## Trait Implementations

[Source](https://docs.rs/bevy_camera_controller/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera_controller/free_camera.rs.html#75)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [FreeCamera](struct.FreeCamera.html "struct bevy::camera_controller::free_camera::FreeCamera")

[Source](https://docs.rs/bevy_camera_controller/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera_controller/free_camera.rs.html#75)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [FreeCamera](struct.FreeCamera.html "struct bevy::camera_controller::free_camera::FreeCamera")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [FreeCamera](struct.FreeCamera.html "struct bevy::camera_controller::free_camera::FreeCamera")

where [FreeCamera](struct.FreeCamera.html "struct bevy::camera_controller::free_camera::FreeCamera"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

**Required Components**: [`FreeCameraState`](struct.FreeCameraState.html "struct bevy::camera_controller::free_camera::FreeCameraState").
...
[Source](https://docs.rs/bevy_camera_controller/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera_controller/free_camera.rs.html#139)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [FreeCamera](struct.FreeCamera.html "struct bevy::camera_controller::free_camera::FreeCamera")

[Source](https://docs.rs/bevy_camera_controller/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera_controller/free_camera.rs.html#140)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [FreeCamera](struct.FreeCamera.html "struct bevy::camera_controller::free_camera::FreeCamera")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_camera_controller/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera_controller/free_camera.rs.html#167)

### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [FreeCamera](struct.FreeCamera.html "struct bevy::camera_controller::free_camera::FreeCamera")

[Source](https://docs.rs/bevy_camera_controller/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera_controller/free_camera.rs.html#168)
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [FreeCamera](struct.FreeCamera.html "struct bevy::camera_controller::free_camera::FreeCamera")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [FreeCamera](struct.FreeCamera.html "struct bevy::camera_controller::free_camera::FreeCamera")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [FreeCamera](struct.FreeCamera.html "struct bevy::camera_controller::free_camera::FreeCamera")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [FreeCamera](struct.FreeCamera.html "struct bevy::camera_controller::free_camera::FreeCamera")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [FreeCamera](struct.FreeCamera.html "struct bevy::camera_controller::free_camera::FreeCamera")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [FreeCamera](struct.FreeCamera.html "struct bevy::camera_controller::free_camera::FreeCamera")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [FreeCamera](struct.FreeCamera.html "struct bevy::camera_controller::free_camera::FreeCamera")
