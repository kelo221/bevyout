...
# Struct OitResolvePipeline 

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/oit/resolve/mod.rs.html#103)
...
`view_bind_group_layout: [BindGroupLayoutDescriptor](../../../material/descriptor/struct.BindGroupLayoutDescriptor.html "struct bevy::material::descriptor::BindGroupLayoutDescriptor")`

View bind group layout.

`oit_depth_bind_group_layout: [BindGroupLayoutDescriptor](../../../material/descriptor/struct.BindGroupLayoutDescriptor.html "struct bevy::material::descriptor::BindGroupLayoutDescriptor")`
...
### impl [Component](../../../prelude/trait.Component.html "trait bevy::prelude::Component") for [OitResolvePipeline](struct.OitResolvePipeline.html "struct bevy::core_pipeline::oit::resolve::OitResolvePipeline")

where [OitResolvePipeline](struct.OitResolvePipeline.html "struct bevy::core_pipeline::oit::resolve::OitResolvePipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [OitResolvePipeline](struct.OitResolvePipeline.html "struct bevy::core_pipeline::oit::resolve::OitResolvePipeline")

where [OitResolvePipeline](struct.OitResolvePipeline.html "struct bevy::core_pipeline::oit::resolve::OitResolvePipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [OitResolvePipeline](struct.OitResolvePipeline.html "struct bevy::core_pipeline::oit::resolve::OitResolvePipeline")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [OitResolvePipeline](struct.OitResolvePipeline.html "struct bevy::core_pipeline::oit::resolve::OitResolvePipeline")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [OitResolvePipeline](struct.OitResolvePipeline.html "struct bevy::core_pipeline::oit::resolve::OitResolvePipeline")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [OitResolvePipeline](struct.OitResolvePipeline.html "struct bevy::core_pipeline::oit::resolve::OitResolvePipeline")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [OitResolvePipeline](struct.OitResolvePipeline.html "struct bevy::core_pipeline::oit::resolve::OitResolvePipeline")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [OitResolvePipeline](struct.OitResolvePipeline.html "struct bevy::core_pipeline::oit::resolve::OitResolvePipeline")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [OitResolvePipeline](struct.OitResolvePipeline.html "struct bevy::core_pipeline::oit::resolve::OitResolvePipeline")
