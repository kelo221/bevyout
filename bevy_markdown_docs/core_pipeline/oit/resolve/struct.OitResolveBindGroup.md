...
[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/oit/resolve/mod.rs.html#99)
...
`0: [BindGroup](../../../render/render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup")`
...
### impl [Component](../../../prelude/trait.Component.html "trait bevy::prelude::Component") for [OitResolveBindGroup](struct.OitResolveBindGroup.html "struct bevy::core_pipeline::oit::resolve::OitResolveBindGroup")

where [OitResolveBindGroup](struct.OitResolveBindGroup.html "struct bevy::core_pipeline::oit::resolve::OitResolveBindGroup"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [OitResolveBindGroup](struct.OitResolveBindGroup.html "struct bevy::core_pipeline::oit::resolve::OitResolveBindGroup")
...
#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[OitResolveBindGroup](struct.OitResolveBindGroup.html "struct bevy::core_pipeline::oit::resolve::OitResolveBindGroup") as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/oit/resolve/mod.rs.html#98)

### impl [Resource](../../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [OitResolveBindGroup](struct.OitResolveBindGroup.html "struct bevy::core_pipeline::oit::resolve::OitResolveBindGroup")

where [OitResolveBindGroup](struct.OitResolveBindGroup.html "struct bevy::core_pipeline::oit::resolve::OitResolveBindGroup"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [OitResolveBindGroup](struct.OitResolveBindGroup.html "struct bevy::core_pipeline::oit::resolve::OitResolveBindGroup")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [OitResolveBindGroup](struct.OitResolveBindGroup.html "struct bevy::core_pipeline::oit::resolve::OitResolveBindGroup")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [OitResolveBindGroup](struct.OitResolveBindGroup.html "struct bevy::core_pipeline::oit::resolve::OitResolveBindGroup")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [OitResolveBindGroup](struct.OitResolveBindGroup.html "struct bevy::core_pipeline::oit::resolve::OitResolveBindGroup")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [OitResolveBindGroup](struct.OitResolveBindGroup.html "struct bevy::core_pipeline::oit::resolve::OitResolveBindGroup")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [OitResolveBindGroup](struct.OitResolveBindGroup.html "struct bevy::core_pipeline::oit::resolve::OitResolveBindGroup")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [OitResolveBindGroup](struct.OitResolveBindGroup.html "struct bevy::core_pipeline::oit::resolve::OitResolveBindGroup")
