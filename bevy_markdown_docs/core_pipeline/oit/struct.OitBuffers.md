...
[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/oit/mod.rs.html#152)
...
`settings: [DynamicUniformBuffer](../../render/render_resource/struct.DynamicUniformBuffer.html "struct bevy::render::render_resource::DynamicUniformBuffer")<[OrderIndependentTransparencySettings](struct.OrderIndependentTransparencySettings.html "struct bevy::core_pipeline::oit::OrderIndependentTransparencySettings")>``nodes_capacity: [UniformBuffer](../../render/render_resource/struct.UniformBuffer.html "struct bevy::render::render_resource::UniformBuffer")<[u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)>``nodes: [UninitBufferVec](../../render/render_resource/struct.UninitBufferVec.html "struct bevy::render::render_resource::UninitBufferVec")<[OitFragmentNode](struct.OitFragmentNode.html "struct bevy::core_pipeline::oit::OitFragmentNode")>`

OIT nodes buffer contains color, depth and linked next node for each fragments.

`heads: [UninitBufferVec](../../render/render_resource/struct.UninitBufferVec.html "struct bevy::render::render_resource::UninitBufferVec")<[u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)>`

OIT heads buffer contains the head that pointers nodes buffer, essentially used as a 2d array where xy is the screen coordinate. We don’t use storage texture as it requires native only [`bevy_render::settings::WgpuFeatures::TEXTURE_ATOMIC`](../../render/render_resource/struct.WgpuFeatures.html#associatedconstant.TEXTURE_ATOMIC "associated constant bevy::render::render_resource::WgpuFeatures::TEXTURE_ATOMIC").

`atomic_counter: [UninitBufferVec](../../render/render_resource/struct.UninitBufferVec.html "struct bevy::render::render_resource::UninitBufferVec")<[u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)>`

## Trait Implementations

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/oit/mod.rs.html#151)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [OitBuffers](struct.OitBuffers.html "struct bevy::core_pipeline::oit::OitBuffers")

where [OitBuffers](struct.OitBuffers.html "struct bevy::core_pipeline::oit::OitBuffers"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [OitBuffers](struct.OitBuffers.html "struct bevy::core_pipeline::oit::OitBuffers")

where [OitBuffers](struct.OitBuffers.html "struct bevy::core_pipeline::oit::OitBuffers"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [OitBuffers](struct.OitBuffers.html "struct bevy::core_pipeline::oit::OitBuffers")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [OitBuffers](struct.OitBuffers.html "struct bevy::core_pipeline::oit::OitBuffers")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [OitBuffers](struct.OitBuffers.html "struct bevy::core_pipeline::oit::OitBuffers")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [OitBuffers](struct.OitBuffers.html "struct bevy::core_pipeline::oit::OitBuffers")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [OitBuffers](struct.OitBuffers.html "struct bevy::core_pipeline::oit::OitBuffers")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [OitBuffers](struct.OitBuffers.html "struct bevy::core_pipeline::oit::OitBuffers")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [OitBuffers](struct.OitBuffers.html "struct bevy::core_pipeline::oit::OitBuffers")
