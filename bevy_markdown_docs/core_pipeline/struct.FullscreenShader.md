...
[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/fullscreen_vertex_shader/mod.rs.html#8)
...
[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/fullscreen_vertex_shader/mod.rs.html#16)

### impl [FullscreenShader](struct.FullscreenShader.html "struct bevy::core_pipeline::FullscreenShader")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/fullscreen_vertex_shader/mod.rs.html#18)

#### pub fn [shader](#method.shader)(&self) -> [Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Shader](../prelude/struct.Shader.html "struct bevy::prelude::Shader")\>

Gets the raw shader handle.

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/fullscreen_vertex_shader/mod.rs.html#33)

#### pub fn [to\_vertex\_state](#method.to_vertex_state)(&self) -> [VertexState](../material/descriptor/struct.VertexState.html "struct bevy::material::descriptor::VertexState")

Creates a [`VertexState`](../material/descriptor/struct.VertexState.html "struct bevy::material::descriptor::VertexState") that uses the [`FullscreenShader`](struct.FullscreenShader.html "struct bevy::core_pipeline::FullscreenShader") to output a
...
examples/shader\_advanced/custom\_post\_processing.rs ([line 203](../../src/custom_post_processing/custom_post_processing.rs.html#203))
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [FullscreenShader](struct.FullscreenShader.html "struct bevy::core_pipeline::FullscreenShader")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/fullscreen_vertex_shader/mod.rs.html#7)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [FullscreenShader](struct.FullscreenShader.html "struct bevy::core_pipeline::FullscreenShader")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [FullscreenShader](struct.FullscreenShader.html "struct bevy::core_pipeline::FullscreenShader")

where [FullscreenShader](struct.FullscreenShader.html "struct bevy::core_pipeline::FullscreenShader"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [FromWorld](../prelude/trait.FromWorld.html "trait bevy::prelude::FromWorld") for [FullscreenShader](struct.FullscreenShader.html "struct bevy::core_pipeline::FullscreenShader")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/fullscreen_vertex_shader/mod.rs.html#11)

#### fn [from\_world](../prelude/trait.FromWorld.html#tymethod.from_world)(world: &mut [World](../prelude/struct.World.html "struct bevy::prelude::World")) -> [FullscreenShader](struct.FullscreenShader.html "struct bevy::core_pipeline::FullscreenShader")

Creates `Self` using data from the given [`World`](../prelude/struct.World.html "struct bevy::prelude::World").

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/fullscreen_vertex_shader/mod.rs.html#7)

### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [FullscreenShader](struct.FullscreenShader.html "struct bevy::core_pipeline::FullscreenShader")

where [FullscreenShader](struct.FullscreenShader.html "struct bevy::core_pipeline::FullscreenShader"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [FullscreenShader](struct.FullscreenShader.html "struct bevy::core_pipeline::FullscreenShader")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [FullscreenShader](struct.FullscreenShader.html "struct bevy::core_pipeline::FullscreenShader")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [FullscreenShader](struct.FullscreenShader.html "struct bevy::core_pipeline::FullscreenShader")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [FullscreenShader](struct.FullscreenShader.html "struct bevy::core_pipeline::FullscreenShader")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [FullscreenShader](struct.FullscreenShader.html "struct bevy::core_pipeline::FullscreenShader")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [FullscreenShader](struct.FullscreenShader.html "struct bevy::core_pipeline::FullscreenShader")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [FullscreenShader](struct.FullscreenShader.html "struct bevy::core_pipeline::FullscreenShader")
