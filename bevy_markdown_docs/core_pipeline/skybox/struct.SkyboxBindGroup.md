...
[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/skybox/mod.rs.html#221)
...
`0: ([BindGroup](../../render/render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup"), [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html))`

## Trait Implementations

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/skybox/mod.rs.html#220)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [SkyboxBindGroup](struct.SkyboxBindGroup.html "struct bevy::core_pipeline::skybox::SkyboxBindGroup")

where [SkyboxBindGroup](struct.SkyboxBindGroup.html "struct bevy::core_pipeline::skybox::SkyboxBindGroup"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SkyboxBindGroup](struct.SkyboxBindGroup.html "struct bevy::core_pipeline::skybox::SkyboxBindGroup")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SkyboxBindGroup](struct.SkyboxBindGroup.html "struct bevy::core_pipeline::skybox::SkyboxBindGroup")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SkyboxBindGroup](struct.SkyboxBindGroup.html "struct bevy::core_pipeline::skybox::SkyboxBindGroup")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SkyboxBindGroup](struct.SkyboxBindGroup.html "struct bevy::core_pipeline::skybox::SkyboxBindGroup")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SkyboxBindGroup](struct.SkyboxBindGroup.html "struct bevy::core_pipeline::skybox::SkyboxBindGroup")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SkyboxBindGroup](struct.SkyboxBindGroup.html "struct bevy::core_pipeline::skybox::SkyboxBindGroup")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SkyboxBindGroup](struct.SkyboxBindGroup.html "struct bevy::core_pipeline::skybox::SkyboxBindGroup")
