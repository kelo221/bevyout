...
# Struct SkyboxPipelineId 

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/skybox/mod.rs.html#194)
...
[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/skybox/mod.rs.html#193)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [SkyboxPipelineId](struct.SkyboxPipelineId.html "struct bevy::core_pipeline::skybox::SkyboxPipelineId")

where [SkyboxPipelineId](struct.SkyboxPipelineId.html "struct bevy::core_pipeline::skybox::SkyboxPipelineId"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SkyboxPipelineId](struct.SkyboxPipelineId.html "struct bevy::core_pipeline::skybox::SkyboxPipelineId")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SkyboxPipelineId](struct.SkyboxPipelineId.html "struct bevy::core_pipeline::skybox::SkyboxPipelineId")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SkyboxPipelineId](struct.SkyboxPipelineId.html "struct bevy::core_pipeline::skybox::SkyboxPipelineId")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SkyboxPipelineId](struct.SkyboxPipelineId.html "struct bevy::core_pipeline::skybox::SkyboxPipelineId")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SkyboxPipelineId](struct.SkyboxPipelineId.html "struct bevy::core_pipeline::skybox::SkyboxPipelineId")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SkyboxPipelineId](struct.SkyboxPipelineId.html "struct bevy::core_pipeline::skybox::SkyboxPipelineId")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SkyboxPipelineId](struct.SkyboxPipelineId.html "struct bevy::core_pipeline::skybox::SkyboxPipelineId")
