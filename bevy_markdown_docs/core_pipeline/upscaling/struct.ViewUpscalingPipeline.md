...
# Struct ViewUpscalingPipeline 

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/upscaling/mod.rs.html#36)

```rust
pub struct ViewUpscalingPipeline(/* private fields */);
```

## Trait Implementations

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/upscaling/mod.rs.html#35)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [ViewUpscalingPipeline](struct.ViewUpscalingPipeline.html "struct bevy::core_pipeline::upscaling::ViewUpscalingPipeline")

where [ViewUpscalingPipeline](struct.ViewUpscalingPipeline.html "struct bevy::core_pipeline::upscaling::ViewUpscalingPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ViewUpscalingPipeline](struct.ViewUpscalingPipeline.html "struct bevy::core_pipeline::upscaling::ViewUpscalingPipeline")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ViewUpscalingPipeline](struct.ViewUpscalingPipeline.html "struct bevy::core_pipeline::upscaling::ViewUpscalingPipeline")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ViewUpscalingPipeline](struct.ViewUpscalingPipeline.html "struct bevy::core_pipeline::upscaling::ViewUpscalingPipeline")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ViewUpscalingPipeline](struct.ViewUpscalingPipeline.html "struct bevy::core_pipeline::upscaling::ViewUpscalingPipeline")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ViewUpscalingPipeline](struct.ViewUpscalingPipeline.html "struct bevy::core_pipeline::upscaling::ViewUpscalingPipeline")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ViewUpscalingPipeline](struct.ViewUpscalingPipeline.html "struct bevy::core_pipeline::upscaling::ViewUpscalingPipeline")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ViewUpscalingPipeline](struct.ViewUpscalingPipeline.html "struct bevy::core_pipeline::upscaling::ViewUpscalingPipeline")
