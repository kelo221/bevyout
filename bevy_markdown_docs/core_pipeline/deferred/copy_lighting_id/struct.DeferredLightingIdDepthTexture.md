...
# Struct DeferredLightingIdDepthTexture 

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/deferred/copy_lighting_id.rs.html#142)
...
`texture: [CachedTexture](../../../render/texture/struct.CachedTexture.html "struct bevy::render::texture::CachedTexture")`

## Trait Implementations

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/deferred/copy_lighting_id.rs.html#141)

### impl [Component](../../../prelude/trait.Component.html "trait bevy::prelude::Component") for [DeferredLightingIdDepthTexture](struct.DeferredLightingIdDepthTexture.html "struct bevy::core_pipeline::deferred::copy_lighting_id::DeferredLightingIdDepthTexture")

where [DeferredLightingIdDepthTexture](struct.DeferredLightingIdDepthTexture.html "struct bevy::core_pipeline::deferred::copy_lighting_id::DeferredLightingIdDepthTexture"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DeferredLightingIdDepthTexture](struct.DeferredLightingIdDepthTexture.html "struct bevy::core_pipeline::deferred::copy_lighting_id::DeferredLightingIdDepthTexture")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DeferredLightingIdDepthTexture](struct.DeferredLightingIdDepthTexture.html "struct bevy::core_pipeline::deferred::copy_lighting_id::DeferredLightingIdDepthTexture")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DeferredLightingIdDepthTexture](struct.DeferredLightingIdDepthTexture.html "struct bevy::core_pipeline::deferred::copy_lighting_id::DeferredLightingIdDepthTexture")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DeferredLightingIdDepthTexture](struct.DeferredLightingIdDepthTexture.html "struct bevy::core_pipeline::deferred::copy_lighting_id::DeferredLightingIdDepthTexture")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DeferredLightingIdDepthTexture](struct.DeferredLightingIdDepthTexture.html "struct bevy::core_pipeline::deferred::copy_lighting_id::DeferredLightingIdDepthTexture")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DeferredLightingIdDepthTexture](struct.DeferredLightingIdDepthTexture.html "struct bevy::core_pipeline::deferred::copy_lighting_id::DeferredLightingIdDepthTexture")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DeferredLightingIdDepthTexture](struct.DeferredLightingIdDepthTexture.html "struct bevy::core_pipeline::deferred::copy_lighting_id::DeferredLightingIdDepthTexture")
