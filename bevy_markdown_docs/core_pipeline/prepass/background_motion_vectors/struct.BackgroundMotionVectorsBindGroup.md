...
# Struct BackgroundMotionVectorsBindGroup 

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/prepass/background_motion_vectors.rs.html#79)
...
[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/prepass/background_motion_vectors.rs.html#78)

### impl [Component](../../../prelude/trait.Component.html "trait bevy::prelude::Component") for [BackgroundMotionVectorsBindGroup](../struct.BackgroundMotionVectorsBindGroup.html "struct bevy::core_pipeline::prepass::BackgroundMotionVectorsBindGroup")

where [BackgroundMotionVectorsBindGroup](../struct.BackgroundMotionVectorsBindGroup.html "struct bevy::core_pipeline::prepass::BackgroundMotionVectorsBindGroup"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [BackgroundMotionVectorsBindGroup](../struct.BackgroundMotionVectorsBindGroup.html "struct bevy::core_pipeline::prepass::BackgroundMotionVectorsBindGroup")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [BackgroundMotionVectorsBindGroup](../struct.BackgroundMotionVectorsBindGroup.html "struct bevy::core_pipeline::prepass::BackgroundMotionVectorsBindGroup")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [BackgroundMotionVectorsBindGroup](../struct.BackgroundMotionVectorsBindGroup.html "struct bevy::core_pipeline::prepass::BackgroundMotionVectorsBindGroup")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [BackgroundMotionVectorsBindGroup](../struct.BackgroundMotionVectorsBindGroup.html "struct bevy::core_pipeline::prepass::BackgroundMotionVectorsBindGroup")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [BackgroundMotionVectorsBindGroup](../struct.BackgroundMotionVectorsBindGroup.html "struct bevy::core_pipeline::prepass::BackgroundMotionVectorsBindGroup")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [BackgroundMotionVectorsBindGroup](../struct.BackgroundMotionVectorsBindGroup.html "struct bevy::core_pipeline::prepass::BackgroundMotionVectorsBindGroup")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [BackgroundMotionVectorsBindGroup](../struct.BackgroundMotionVectorsBindGroup.html "struct bevy::core_pipeline::prepass::BackgroundMotionVectorsBindGroup")
