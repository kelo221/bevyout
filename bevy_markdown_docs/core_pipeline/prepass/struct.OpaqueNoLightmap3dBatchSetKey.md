...
# Struct OpaqueNoLightmap3dBatchSetKey 

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/prepass/mod.rs.html#203)
...
`pipeline: [CachedRenderPipelineId](../../material/descriptor/struct.CachedRenderPipelineId.html "struct bevy::material::descriptor::CachedRenderPipelineId")`

The ID of the GPU pipeline.

`draw_function: [DrawFunctionId](../../material/labels/struct.DrawFunctionId.html "struct bevy::material::labels::DrawFunctionId")`

The function used to draw the mesh.

`material_bind_group_index: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)>`

The ID of a bind group specific to the material.

In the case of PBR, this is the `MaterialBindGroupIndex`.

`slabs: [MeshSlabs](../../render/mesh/allocator/struct.MeshSlabs.html "struct bevy::render::mesh::allocator::MeshSlabs")`

The IDs of the slabs of GPU memory in the mesh allocator that contain the mesh data.

For non-mesh items, you can fill the [`MeshSlabs::vertex_slab_id`](../../render/mesh/allocator/struct.MeshSlabs.html#structfield.vertex_slab_id "field bevy::render::mesh::allocator::MeshSlabs::vertex_slab_id") with 0 if your items can be multi-drawn, or with a unique value if they can’t.

## Trait Implementations

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/prepass/mod.rs.html#202)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [OpaqueNoLightmap3dBatchSetKey](struct.OpaqueNoLightmap3dBatchSetKey.html "struct bevy::core_pipeline::prepass::OpaqueNoLightmap3dBatchSetKey")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/prepass/mod.rs.html#202)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [OpaqueNoLightmap3dBatchSetKey](struct.OpaqueNoLightmap3dBatchSetKey.html "struct bevy::core_pipeline::prepass::OpaqueNoLightmap3dBatchSetKey")
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [OpaqueNoLightmap3dBatchSetKey](struct.OpaqueNoLightmap3dBatchSetKey.html "struct bevy::core_pipeline::prepass::OpaqueNoLightmap3dBatchSetKey")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/prepass/mod.rs.html#202)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [OpaqueNoLightmap3dBatchSetKey](struct.OpaqueNoLightmap3dBatchSetKey.html "struct bevy::core_pipeline::prepass::OpaqueNoLightmap3dBatchSetKey")
...
### impl [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [OpaqueNoLightmap3dBatchSetKey](struct.OpaqueNoLightmap3dBatchSetKey.html "struct bevy::core_pipeline::prepass::OpaqueNoLightmap3dBatchSetKey")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/prepass/mod.rs.html#202)

#### fn [cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html#tymethod.cmp)(&self, other: &[OpaqueNoLightmap3dBatchSetKey](struct.OpaqueNoLightmap3dBatchSetKey.html "struct bevy::core_pipeline::prepass::OpaqueNoLightmap3dBatchSetKey")) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [OpaqueNoLightmap3dBatchSetKey](struct.OpaqueNoLightmap3dBatchSetKey.html "struct bevy::core_pipeline::prepass::OpaqueNoLightmap3dBatchSetKey")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/prepass/mod.rs.html#202)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[OpaqueNoLightmap3dBatchSetKey](struct.OpaqueNoLightmap3dBatchSetKey.html "struct bevy::core_pipeline::prepass::OpaqueNoLightmap3dBatchSetKey")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [OpaqueNoLightmap3dBatchSetKey](struct.OpaqueNoLightmap3dBatchSetKey.html "struct bevy::core_pipeline::prepass::OpaqueNoLightmap3dBatchSetKey")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/prepass/mod.rs.html#202)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[OpaqueNoLightmap3dBatchSetKey](struct.OpaqueNoLightmap3dBatchSetKey.html "struct bevy::core_pipeline::prepass::OpaqueNoLightmap3dBatchSetKey")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")\>
...
### impl [PhaseItemBatchSetKey](../../render/render_phase/trait.PhaseItemBatchSetKey.html "trait bevy::render::render_phase::PhaseItemBatchSetKey") for [OpaqueNoLightmap3dBatchSetKey](struct.OpaqueNoLightmap3dBatchSetKey.html "struct bevy::core_pipeline::prepass::OpaqueNoLightmap3dBatchSetKey")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/prepass/mod.rs.html#225)

#### fn [indexed](../../render/render_phase/trait.PhaseItemBatchSetKey.html#tymethod.indexed)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns true if this batch set key describes indexed meshes or false if it describes non-indexed meshes. [Read more](../../render/render_phase/trait.PhaseItemBatchSetKey.html#tymethod.indexed)

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/prepass/mod.rs.html#202)

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [OpaqueNoLightmap3dBatchSetKey](struct.OpaqueNoLightmap3dBatchSetKey.html "struct bevy::core_pipeline::prepass::OpaqueNoLightmap3dBatchSetKey")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [OpaqueNoLightmap3dBatchSetKey](struct.OpaqueNoLightmap3dBatchSetKey.html "struct bevy::core_pipeline::prepass::OpaqueNoLightmap3dBatchSetKey")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [OpaqueNoLightmap3dBatchSetKey](struct.OpaqueNoLightmap3dBatchSetKey.html "struct bevy::core_pipeline::prepass::OpaqueNoLightmap3dBatchSetKey")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [OpaqueNoLightmap3dBatchSetKey](struct.OpaqueNoLightmap3dBatchSetKey.html "struct bevy::core_pipeline::prepass::OpaqueNoLightmap3dBatchSetKey")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [OpaqueNoLightmap3dBatchSetKey](struct.OpaqueNoLightmap3dBatchSetKey.html "struct bevy::core_pipeline::prepass::OpaqueNoLightmap3dBatchSetKey")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [OpaqueNoLightmap3dBatchSetKey](struct.OpaqueNoLightmap3dBatchSetKey.html "struct bevy::core_pipeline::prepass::OpaqueNoLightmap3dBatchSetKey")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [OpaqueNoLightmap3dBatchSetKey](struct.OpaqueNoLightmap3dBatchSetKey.html "struct bevy::core_pipeline::prepass::OpaqueNoLightmap3dBatchSetKey")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [OpaqueNoLightmap3dBatchSetKey](struct.OpaqueNoLightmap3dBatchSetKey.html "struct bevy::core_pipeline::prepass::OpaqueNoLightmap3dBatchSetKey")
