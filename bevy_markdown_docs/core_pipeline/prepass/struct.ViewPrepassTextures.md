...
# Struct ViewPrepassTextures 

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/prepass/mod.rs.html#124)
...
`depth: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ColorAttachment](../../render/texture/struct.ColorAttachment.html "struct bevy::render::texture::ColorAttachment")>`

The depth texture generated by the prepass. Exists only if [`DepthPrepass`](struct.DepthPrepass.html "struct bevy::core_pipeline::prepass::DepthPrepass") is added to the [`ViewTarget`](../../render/view/struct.ViewTarget.html "struct bevy::render::view::ViewTarget")

`normal: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ColorAttachment](../../render/texture/struct.ColorAttachment.html "struct bevy::render::texture::ColorAttachment")>`

The normals texture generated by the prepass. Exists only if [`NormalPrepass`](struct.NormalPrepass.html "struct bevy::core_pipeline::prepass::NormalPrepass") is added to the [`ViewTarget`](../../render/view/struct.ViewTarget.html "struct bevy::render::view::ViewTarget")

`motion_vectors: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ColorAttachment](../../render/texture/struct.ColorAttachment.html "struct bevy::render::texture::ColorAttachment")>`

The motion vectors texture generated by the prepass. Exists only if [`MotionVectorPrepass`](struct.MotionVectorPrepass.html "struct bevy::core_pipeline::prepass::MotionVectorPrepass") is added to the `ViewTarget`

`deferred: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ColorAttachment](../../render/texture/struct.ColorAttachment.html "struct bevy::render::texture::ColorAttachment")>`

The deferred gbuffer generated by the deferred pass. Exists only if [`DeferredPrepass`](struct.DeferredPrepass.html "struct bevy::core_pipeline::prepass::DeferredPrepass") is added to the `ViewTarget`

`deferred_lighting_pass_id: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ColorAttachment](../../render/texture/struct.ColorAttachment.html "struct bevy::render::texture::ColorAttachment")>`

A texture that specifies the deferred lighting pass id for a material. Exists only if [`DeferredPrepass`](struct.DeferredPrepass.html "struct bevy::core_pipeline::prepass::DeferredPrepass") is added to the `ViewTarget`

`size: [Extent3d](../../render/render_resource/struct.Extent3d.html "struct bevy::render::render_resource::Extent3d")`

The size of the textures.

## Implementations

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/prepass/mod.rs.html#144)

### impl [ViewPrepassTextures](struct.ViewPrepassTextures.html "struct bevy::core_pipeline::prepass::ViewPrepassTextures")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/prepass/mod.rs.html#145)

#### pub fn [depth\_view](#method.depth_view)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[TextureView](../../render/render_resource/struct.TextureView.html "struct bevy::render::render_resource::TextureView")\>

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/prepass/mod.rs.html#149)

#### pub fn [previous\_depth\_view](#method.previous_depth_view)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[TextureView](../../render/render_resource/struct.TextureView.html "struct bevy::render::render_resource::TextureView")\>

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/prepass/mod.rs.html#155)

#### pub fn [normal\_view](#method.normal_view)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[TextureView](../../render/render_resource/struct.TextureView.html "struct bevy::render::render_resource::TextureView")\>

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/prepass/mod.rs.html#159)

#### pub fn [motion\_vectors\_view](#method.motion_vectors_view)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[TextureView](../../render/render_resource/struct.TextureView.html "struct bevy::render::render_resource::TextureView")\>

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/prepass/mod.rs.html#165)

#### pub fn [deferred\_view](#method.deferred_view)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[TextureView](../../render/render_resource/struct.TextureView.html "struct bevy::render::render_resource::TextureView")\>

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/prepass/mod.rs.html#169)

#### pub fn [previous\_deferred\_view](#method.previous_deferred_view)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[TextureView](../../render/render_resource/struct.TextureView.html "struct bevy::render::render_resource::TextureView")\>

## Trait Implementations

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/prepass/mod.rs.html#123)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [ViewPrepassTextures](struct.ViewPrepassTextures.html "struct bevy::core_pipeline::prepass::ViewPrepassTextures")

where [ViewPrepassTextures](struct.ViewPrepassTextures.html "struct bevy::core_pipeline::prepass::ViewPrepassTextures"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ViewPrepassTextures](struct.ViewPrepassTextures.html "struct bevy::core_pipeline::prepass::ViewPrepassTextures")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ViewPrepassTextures](struct.ViewPrepassTextures.html "struct bevy::core_pipeline::prepass::ViewPrepassTextures")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ViewPrepassTextures](struct.ViewPrepassTextures.html "struct bevy::core_pipeline::prepass::ViewPrepassTextures")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ViewPrepassTextures](struct.ViewPrepassTextures.html "struct bevy::core_pipeline::prepass::ViewPrepassTextures")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ViewPrepassTextures](struct.ViewPrepassTextures.html "struct bevy::core_pipeline::prepass::ViewPrepassTextures")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ViewPrepassTextures](struct.ViewPrepassTextures.html "struct bevy::core_pipeline::prepass::ViewPrepassTextures")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ViewPrepassTextures](struct.ViewPrepassTextures.html "struct bevy::core_pipeline::prepass::ViewPrepassTextures")
