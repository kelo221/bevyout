...
[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#119)
...
Same base implementation that Godot 4.0 uses for Tonemap ACES. [https://github.com/TheRealMJP/BakingLab/blob/master/BakingLab/ACES.hlsl](https://github.com/TheRealMJP/BakingLab/blob/master/BakingLab/ACES.hlsl) Not neutral, has a very specific aesthetic, intentional and dramatic hue shifting. Bright greens and reds turn orange. Bright blues turn magenta. Significantly increased contrast. Brights desaturate across the spectrum.

### AgX

By Troy Sobotka [https://github.com/sobotka/AgX](https://github.com/sobotka/AgX) Very neutral. Image is somewhat desaturated when compared to other tonemappers. Little to no hue shifting. Subtle [Abney shifting](https://en.wikipedia.org/wiki/Abney_effect). NOTE: Requires the `tonemapping_luts` cargo feature.

### SomewhatBoringDisplayTransform

By Tomasz Stachowiak Has little hue shifting in the darks and mids, but lots in the brights. Brights desaturate across the spectrum. Is sort of between Reinhard and `ReinhardLuminance`. Conceptually similar to reinhard-jodie. Designed as a compromise if you want e.g. decent skin tones in low light, but can’t afford to re-do your VFX to look good without hue shifting.

### TonyMcMapface

Current Bevy default. By Tomasz Stachowiak [https://github.com/h3r2tic/tony-mc-mapface](https://github.com/h3r2tic/tony-mc-mapface) Very neutral. Subtle but intentional hue shifting. Brights desaturate across the spectrum. Comment from author: Tony is a display transform intended for real-time applications such as games. It is intentionally boring, does not increase contrast or saturation, and stays close to the input stimulus where compression isn’t necessary. Brightness-equivalent luminance of the input stimulus is compressed. The non-linearity resembles Reinhard. Color hues are preserved during compression, except for a deliberate [Bezold–Brücke shift](https://en.wikipedia.org/wiki/Bezold%E2%80%93Br%C3%BCcke_shift). To avoid posterization, selective desaturation is employed, with care to avoid the [Abney effect](https://en.wikipedia.org/wiki/Abney_effect). NOTE: Requires the `tonemapping_luts` cargo feature.

### BlenderFilmic

Default Filmic Display Transform from blender. Somewhat neutral. Suffers from hue shifting. Brights desaturate across the spectrum. NOTE: Requires the `tonemapping_luts` cargo feature.

### KhronosPbrNeutral

Despite its name, it is not considered to be neutral. Highly saturated colors and tends to produce a very high contrast image. Suffers from significant [Abney shifting](https://en.wikipedia.org/wiki/Abney_effect), and tends to crush grays and desaturated colors. Designed for e-commerce to faithfully reproduce the colors of brand’s logos when used with low brightness grayscale lighting. See [the KhronosGroup spec](https://github.com/KhronosGroup/ToneMapping/tree/main/PBR_Neutral) for more information.

## Implementations

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#171)

### impl [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#172)
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#115)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")

where [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
#### fn [map\_entities](../../prelude/trait.Component.html#method.map_entities)<M>(this: &mut [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping"), mapper: [&mut M](https://doc.rust-lang.org/nightly/std/primitive.reference.html))
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#115)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#115)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#115)

### impl [Enum](../../reflect/enums/trait.Enum.html "trait bevy::reflect::enums::Enum") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#115)

### impl [ExtractComponent](../../render/extract_component/trait.ExtractComponent.html "trait bevy::render::extract_component::ExtractComponent") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")

where [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping"): [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#115)

#### type [QueryData](../../render/extract_component/trait.ExtractComponent.html#associatedtype.QueryData) = &'static [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")
...
#### type [QueryFilter](../../render/extract_component/trait.ExtractComponent.html#associatedtype.QueryFilter) = [With](../../prelude/struct.With.html "struct bevy::prelude::With")<[Camera](../../prelude/struct.Camera.html "struct bevy::prelude::Camera")\>

Filters the entities with additional constraints.

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#115)

#### type [Out](../../render/extract_component/trait.ExtractComponent.html#associatedtype.Out) = [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")
...
#### fn [extract\_component](../../render/extract_component/trait.ExtractComponent.html#tymethod.extract_component)( item: <<[Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping") as [ExtractComponent](../../render/extract_component/trait.ExtractComponent.html "trait bevy::render::extract_component::ExtractComponent")\>::[QueryData](../../render/extract_component/trait.ExtractComponent.html#associatedtype.QueryData "type bevy::render::extract_component::ExtractComponent::QueryData") as [QueryData](../../ecs/query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../../ecs/query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'\_, '\_>, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping") as [ExtractComponent](../../render/extract_component/trait.ExtractComponent.html "trait bevy::render::extract_component::ExtractComponent")\>::[Out](../../render/extract_component/trait.ExtractComponent.html#associatedtype.Out "type bevy::render::extract_component::ExtractComponent::Out")\>
...
### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#115)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#115)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#115)

### impl [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#115)

#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( \_\_param0: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")
...
### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")
...
where [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#115)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#115)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#118)
...
### impl [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#115)

#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#115)

### impl [SyncComponent](../../render/sync_component/trait.SyncComponent.html "trait bevy::render::sync_component::SyncComponent") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")

where [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping"): [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#115)

#### type [Target](../../render/sync_component/trait.SyncComponent.html#associatedtype.Target) = [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")

Describes what components should be removed from the render world if the implementing component is removed.

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#115)

### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Tonemapping](enum.Tonemapping.html "enum bevy::core_pipeline::tonemapping::Tonemapping")
