...
# Struct ViewTonemappingPipeline 

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#329)

```rust
pub struct ViewTonemappingPipeline(/* private fields */);
```

## Trait Implementations

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#328)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [ViewTonemappingPipeline](struct.ViewTonemappingPipeline.html "struct bevy::core_pipeline::tonemapping::ViewTonemappingPipeline")

where [ViewTonemappingPipeline](struct.ViewTonemappingPipeline.html "struct bevy::core_pipeline::tonemapping::ViewTonemappingPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ViewTonemappingPipeline](struct.ViewTonemappingPipeline.html "struct bevy::core_pipeline::tonemapping::ViewTonemappingPipeline")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ViewTonemappingPipeline](struct.ViewTonemappingPipeline.html "struct bevy::core_pipeline::tonemapping::ViewTonemappingPipeline")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ViewTonemappingPipeline](struct.ViewTonemappingPipeline.html "struct bevy::core_pipeline::tonemapping::ViewTonemappingPipeline")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ViewTonemappingPipeline](struct.ViewTonemappingPipeline.html "struct bevy::core_pipeline::tonemapping::ViewTonemappingPipeline")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ViewTonemappingPipeline](struct.ViewTonemappingPipeline.html "struct bevy::core_pipeline::tonemapping::ViewTonemappingPipeline")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ViewTonemappingPipeline](struct.ViewTonemappingPipeline.html "struct bevy::core_pipeline::tonemapping::ViewTonemappingPipeline")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ViewTonemappingPipeline](struct.ViewTonemappingPipeline.html "struct bevy::core_pipeline::tonemapping::ViewTonemappingPipeline")
