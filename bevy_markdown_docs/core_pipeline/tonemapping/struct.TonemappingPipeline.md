...
[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#106)

```rust
pub struct TonemappingPipeline { /* private fields */ }
```
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [TonemappingPipeline](struct.TonemappingPipeline.html "struct bevy::core_pipeline::tonemapping::TonemappingPipeline")

where [TonemappingPipeline](struct.TonemappingPipeline.html "struct bevy::core_pipeline::tonemapping::TonemappingPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [TonemappingPipeline](struct.TonemappingPipeline.html "struct bevy::core_pipeline::tonemapping::TonemappingPipeline")
...
### impl [SpecializedRenderPipeline](../../render/render_resource/trait.SpecializedRenderPipeline.html "trait bevy::render::render_resource::SpecializedRenderPipeline") for [TonemappingPipeline](struct.TonemappingPipeline.html "struct bevy::core_pipeline::tonemapping::TonemappingPipeline")
...
#### type [Key](../../render/render_resource/trait.SpecializedRenderPipeline.html#associatedtype.Key) = [TonemappingPipelineKey](struct.TonemappingPipelineKey.html "struct bevy::core_pipeline::tonemapping::TonemappingPipelineKey")

The key that defines each “variant” of the render pipeline.

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/tonemapping/mod.rs.html#204)

#### fn [specialize](../../render/render_resource/trait.SpecializedRenderPipeline.html#tymethod.specialize)( &self, key: <[TonemappingPipeline](struct.TonemappingPipeline.html "struct bevy::core_pipeline::tonemapping::TonemappingPipeline") as [SpecializedRenderPipeline](../../render/render_resource/trait.SpecializedRenderPipeline.html "trait bevy::render::render_resource::SpecializedRenderPipeline")\>::[Key](../../render/render_resource/trait.SpecializedRenderPipeline.html#associatedtype.Key "type bevy::render::render_resource::SpecializedRenderPipeline::Key"), ) -> [RenderPipelineDescriptor](../../material/descriptor/struct.RenderPipelineDescriptor.html "struct bevy::material::descriptor::RenderPipelineDescriptor")

Construct a new render pipeline based on the provided key.

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TonemappingPipeline](struct.TonemappingPipeline.html "struct bevy::core_pipeline::tonemapping::TonemappingPipeline")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TonemappingPipeline](struct.TonemappingPipeline.html "struct bevy::core_pipeline::tonemapping::TonemappingPipeline")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TonemappingPipeline](struct.TonemappingPipeline.html "struct bevy::core_pipeline::tonemapping::TonemappingPipeline")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TonemappingPipeline](struct.TonemappingPipeline.html "struct bevy::core_pipeline::tonemapping::TonemappingPipeline")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TonemappingPipeline](struct.TonemappingPipeline.html "struct bevy::core_pipeline::tonemapping::TonemappingPipeline")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TonemappingPipeline](struct.TonemappingPipeline.html "struct bevy::core_pipeline::tonemapping::TonemappingPipeline")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TonemappingPipeline](struct.TonemappingPipeline.html "struct bevy::core_pipeline::tonemapping::TonemappingPipeline")
