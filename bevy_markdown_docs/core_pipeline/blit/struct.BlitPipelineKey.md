...
[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/blit/mod.rs.html#86)
...
`target_format: [TextureFormat](../../render/render_resource/enum.TextureFormat.html "enum bevy::render::render_resource::TextureFormat")``blend_state: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[BlendState](../../render/render_resource/struct.BlendState.html "struct bevy::render::render_resource::BlendState")>``samples: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)``source_space: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[CompositingSpace](../../prelude/enum.CompositingSpace.html "enum bevy::prelude::CompositingSpace")>`

Color space of the source texture. When `Some(Srgb)` or `Some(Oklab)`, the blit converts to linear RGB before writing to the output target.

## Trait Implementations

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/blit/mod.rs.html#85)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [BlitPipelineKey](struct.BlitPipelineKey.html "struct bevy::core_pipeline::blit::BlitPipelineKey")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/blit/mod.rs.html#85)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [BlitPipelineKey](struct.BlitPipelineKey.html "struct bevy::core_pipeline::blit::BlitPipelineKey")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [BlitPipelineKey](struct.BlitPipelineKey.html "struct bevy::core_pipeline::blit::BlitPipelineKey")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/blit/mod.rs.html#85)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [BlitPipelineKey](struct.BlitPipelineKey.html "struct bevy::core_pipeline::blit::BlitPipelineKey")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/blit/mod.rs.html#85)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [BlitPipelineKey](struct.BlitPipelineKey.html "struct bevy::core_pipeline::blit::BlitPipelineKey")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [BlitPipelineKey](struct.BlitPipelineKey.html "struct bevy::core_pipeline::blit::BlitPipelineKey")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/blit/mod.rs.html#85)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[BlitPipelineKey](struct.BlitPipelineKey.html "struct bevy::core_pipeline::blit::BlitPipelineKey")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [BlitPipelineKey](struct.BlitPipelineKey.html "struct bevy::core_pipeline::blit::BlitPipelineKey")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [BlitPipelineKey](struct.BlitPipelineKey.html "struct bevy::core_pipeline::blit::BlitPipelineKey")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [BlitPipelineKey](struct.BlitPipelineKey.html "struct bevy::core_pipeline::blit::BlitPipelineKey")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [BlitPipelineKey](struct.BlitPipelineKey.html "struct bevy::core_pipeline::blit::BlitPipelineKey")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [BlitPipelineKey](struct.BlitPipelineKey.html "struct bevy::core_pipeline::blit::BlitPipelineKey")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [BlitPipelineKey](struct.BlitPipelineKey.html "struct bevy::core_pipeline::blit::BlitPipelineKey")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [BlitPipelineKey](struct.BlitPipelineKey.html "struct bevy::core_pipeline::blit::BlitPipelineKey")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [BlitPipelineKey](struct.BlitPipelineKey.html "struct bevy::core_pipeline::blit::BlitPipelineKey")
