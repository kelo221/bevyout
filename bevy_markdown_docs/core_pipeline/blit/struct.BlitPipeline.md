...
[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/blit/mod.rs.html#36)
...
`layout: [BindGroupLayoutDescriptor](../../material/descriptor/struct.BindGroupLayoutDescriptor.html "struct bevy::material::descriptor::BindGroupLayoutDescriptor")``sampler: [Sampler](../../render/render_resource/struct.Sampler.html "struct bevy::render::render_resource::Sampler")``fullscreen_shader: [FullscreenShader](../struct.FullscreenShader.html "struct bevy::core_pipeline::FullscreenShader")``fragment_shader: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Shader](../../prelude/struct.Shader.html "struct bevy::prelude::Shader")>`

## Implementations

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/blit/mod.rs.html#70)

### impl [BlitPipeline](struct.BlitPipeline.html "struct bevy::core_pipeline::blit::BlitPipeline")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/blit/mod.rs.html#71-76)

#### pub fn [create\_bind\_group](#method.create_bind_group)( &self, render\_device: &[RenderDevice](../../render/renderer/struct.RenderDevice.html "struct bevy::render::renderer::RenderDevice"), src\_texture: &[TextureView](../../render/render_resource/struct.TextureView.html "struct bevy::render::render_resource::TextureView"), pipeline\_cache: &[PipelineCache](../../render/render_resource/struct.PipelineCache.html "struct bevy::render::render_resource::PipelineCache"), ) -> [BindGroup](../../render/render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup")

## Trait Implementations

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/blit/mod.rs.html#35)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [BlitPipeline](struct.BlitPipeline.html "struct bevy::core_pipeline::blit::BlitPipeline")

where [BlitPipeline](struct.BlitPipeline.html "struct bevy::core_pipeline::blit::BlitPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [BlitPipeline](struct.BlitPipeline.html "struct bevy::core_pipeline::blit::BlitPipeline")

where [BlitPipeline](struct.BlitPipeline.html "struct bevy::core_pipeline::blit::BlitPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/blit/mod.rs.html#95)

### impl [SpecializedRenderPipeline](../../render/render_resource/trait.SpecializedRenderPipeline.html "trait bevy::render::render_resource::SpecializedRenderPipeline") for [BlitPipeline](struct.BlitPipeline.html "struct bevy::core_pipeline::blit::BlitPipeline")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/blit/mod.rs.html#96)

#### type [Key](../../render/render_resource/trait.SpecializedRenderPipeline.html#associatedtype.Key) = [BlitPipelineKey](struct.BlitPipelineKey.html "struct bevy::core_pipeline::blit::BlitPipelineKey")

The key that defines each “variant” of the render pipeline.

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/blit/mod.rs.html#98)

#### fn [specialize](../../render/render_resource/trait.SpecializedRenderPipeline.html#tymethod.specialize)( &self, key: <[BlitPipeline](struct.BlitPipeline.html "struct bevy::core_pipeline::blit::BlitPipeline") as [SpecializedRenderPipeline](../../render/render_resource/trait.SpecializedRenderPipeline.html "trait bevy::render::render_resource::SpecializedRenderPipeline")\>::[Key](../../render/render_resource/trait.SpecializedRenderPipeline.html#associatedtype.Key "type bevy::render::render_resource::SpecializedRenderPipeline::Key"), ) -> [RenderPipelineDescriptor](../../material/descriptor/struct.RenderPipelineDescriptor.html "struct bevy::material::descriptor::RenderPipelineDescriptor")

Construct a new render pipeline based on the provided key.

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [BlitPipeline](struct.BlitPipeline.html "struct bevy::core_pipeline::blit::BlitPipeline")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [BlitPipeline](struct.BlitPipeline.html "struct bevy::core_pipeline::blit::BlitPipeline")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [BlitPipeline](struct.BlitPipeline.html "struct bevy::core_pipeline::blit::BlitPipeline")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [BlitPipeline](struct.BlitPipeline.html "struct bevy::core_pipeline::blit::BlitPipeline")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [BlitPipeline](struct.BlitPipeline.html "struct bevy::core_pipeline::blit::BlitPipeline")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [BlitPipeline](struct.BlitPipeline.html "struct bevy::core_pipeline::blit::BlitPipeline")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [BlitPipeline](struct.BlitPipeline.html "struct bevy::core_pipeline::blit::BlitPipeline")
