...
# Struct DownsampleDepthPipelines 

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/mip_generation/experimental/depth.rs.html#286)
...
`first: [DownsampleDepthPipeline](struct.DownsampleDepthPipeline.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipeline")`

The first pass of the pipeline, when the depth buffer is _not_ multisampled.

`second: [DownsampleDepthPipeline](struct.DownsampleDepthPipeline.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipeline")`

The second pass of the pipeline, when the depth buffer is _not_ multisampled.

`first_multisample: [DownsampleDepthPipeline](struct.DownsampleDepthPipeline.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipeline")`

The first pass of the pipeline, when the depth buffer is multisampled.

`second_multisample: [DownsampleDepthPipeline](struct.DownsampleDepthPipeline.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipeline")`

The second pass of the pipeline, when the depth buffer is multisampled.

`sampler: [Sampler](../../../../render/render_resource/struct.Sampler.html "struct bevy::render::render_resource::Sampler")`

The sampler that the depth downsampling shader uses to sample the depth buffer.
...
### impl [Component](../../../../prelude/trait.Component.html "trait bevy::prelude::Component") for [DownsampleDepthPipelines](struct.DownsampleDepthPipelines.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipelines")

where [DownsampleDepthPipelines](struct.DownsampleDepthPipelines.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipelines"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../../../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [DownsampleDepthPipelines](struct.DownsampleDepthPipelines.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipelines")

where [DownsampleDepthPipelines](struct.DownsampleDepthPipelines.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipelines"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DownsampleDepthPipelines](struct.DownsampleDepthPipelines.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipelines")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DownsampleDepthPipelines](struct.DownsampleDepthPipelines.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipelines")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DownsampleDepthPipelines](struct.DownsampleDepthPipelines.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipelines")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DownsampleDepthPipelines](struct.DownsampleDepthPipelines.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipelines")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DownsampleDepthPipelines](struct.DownsampleDepthPipelines.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipelines")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DownsampleDepthPipelines](struct.DownsampleDepthPipelines.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipelines")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DownsampleDepthPipelines](struct.DownsampleDepthPipelines.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipelines")
