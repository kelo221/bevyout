...
# Function early\_downsample\_depth 

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/mip_generation/experimental/depth.rs.html#63-78)
...
The _early_ downsample depth pass is the first hierarchical Z-buffer stage, which runs after the early prepass and before the late prepass. It prepares the Z-buffer for the bounding box tests that the late mesh preprocessing stage will perform.
