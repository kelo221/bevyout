...
[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/mip_generation/experimental/depth.rs.html#257)
...
`bind_group_layout: [BindGroupLayoutDescriptor](../../../../material/descriptor/struct.BindGroupLayoutDescriptor.html "struct bevy::material::descriptor::BindGroupLayoutDescriptor")`

The bind group layout for this pipeline.

`pipeline_id: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[CachedComputePipelineId](../../../../material/descriptor/struct.CachedComputePipelineId.html "struct bevy::material::descriptor::CachedComputePipelineId")>`
...
### impl [Component](../../../../prelude/trait.Component.html "trait bevy::prelude::Component") for [DownsampleDepthPipeline](struct.DownsampleDepthPipeline.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipeline")

where [DownsampleDepthPipeline](struct.DownsampleDepthPipeline.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../../../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [DownsampleDepthPipeline](struct.DownsampleDepthPipeline.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipeline")
...
### impl [SpecializedComputePipeline](../../../../render/render_resource/trait.SpecializedComputePipeline.html "trait bevy::render::render_resource::SpecializedComputePipeline") for [DownsampleDepthPipeline](struct.DownsampleDepthPipeline.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipeline")
...
#### type [Key](../../../../render/render_resource/trait.SpecializedComputePipeline.html#associatedtype.Key) = [DownsampleDepthPipelineKey](struct.DownsampleDepthPipelineKey.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipelineKey")

The key that defines each “variant” of the compute pipeline.

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/mip_generation/experimental/depth.rs.html#446)

#### fn [specialize](../../../../render/render_resource/trait.SpecializedComputePipeline.html#tymethod.specialize)( &self, key: <[DownsampleDepthPipeline](struct.DownsampleDepthPipeline.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipeline") as [SpecializedComputePipeline](../../../../render/render_resource/trait.SpecializedComputePipeline.html "trait bevy::render::render_resource::SpecializedComputePipeline")\>::[Key](../../../../render/render_resource/trait.SpecializedComputePipeline.html#associatedtype.Key "type bevy::render::render_resource::SpecializedComputePipeline::Key"), ) -> [ComputePipelineDescriptor](../../../../material/descriptor/struct.ComputePipelineDescriptor.html "struct bevy::material::descriptor::ComputePipelineDescriptor")

Construct a new compute pipeline based on the provided key.

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DownsampleDepthPipeline](struct.DownsampleDepthPipeline.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipeline")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DownsampleDepthPipeline](struct.DownsampleDepthPipeline.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipeline")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DownsampleDepthPipeline](struct.DownsampleDepthPipeline.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipeline")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DownsampleDepthPipeline](struct.DownsampleDepthPipeline.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipeline")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DownsampleDepthPipeline](struct.DownsampleDepthPipeline.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipeline")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DownsampleDepthPipeline](struct.DownsampleDepthPipeline.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipeline")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DownsampleDepthPipeline](struct.DownsampleDepthPipeline.html "struct bevy::core_pipeline::mip_generation::experimental::depth::DownsampleDepthPipeline")
