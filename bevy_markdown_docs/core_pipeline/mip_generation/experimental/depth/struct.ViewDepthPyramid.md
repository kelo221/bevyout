...
# Struct ViewDepthPyramid 

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/mip_generation/experimental/depth.rs.html#534)
...
`all_mips: [TextureView](../../../../render/render_resource/struct.TextureView.html "struct bevy::render::render_resource::TextureView")`

A texture view containing the entire depth texture.

`mips: [[TextureView](../../../../render/render_resource/struct.TextureView.html "struct bevy::render::render_resource::TextureView"); [12](https://doc.rust-lang.org/nightly/std/primitive.array.html)]`

A series of texture views containing one mip level each.

`mip_count: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/mip_generation/experimental/depth.rs.html#546)

### impl [ViewDepthPyramid](struct.ViewDepthPyramid.html "struct bevy::core_pipeline::mip_generation::experimental::depth::ViewDepthPyramid")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/mip_generation/experimental/depth.rs.html#548-555)

#### pub fn [new](#method.new)( render\_device: &[RenderDevice](../../../../render/renderer/struct.RenderDevice.html "struct bevy::render::renderer::RenderDevice"), texture\_cache: &mut [TextureCache](../../../../render/texture/struct.TextureCache.html "struct bevy::render::texture::TextureCache"), depth\_pyramid\_dummy\_texture: &[TextureView](../../../../render/render_resource/struct.TextureView.html "struct bevy::render::render_resource::TextureView"), size: [UVec2](../../../../prelude/struct.UVec2.html "struct bevy::prelude::UVec2"), texture\_label: &'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html), texture\_view\_label: &'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html), ) -> [ViewDepthPyramid](struct.ViewDepthPyramid.html "struct bevy::core_pipeline::mip_generation::experimental::depth::ViewDepthPyramid")

Allocates a new depth pyramid for a depth buffer with the given size.

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/mip_generation/experimental/depth.rs.html#613-622)

#### pub fn [create\_bind\_group](#method.create_bind_group)<'a, R>( &'a self, render\_device: &[RenderDevice](../../../../render/renderer/struct.RenderDevice.html "struct bevy::render::renderer::RenderDevice"), label: &'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html), bind\_group\_layout: &[BindGroupLayout](../../../../render/render_resource/struct.BindGroupLayout.html "struct bevy::render::render_resource::BindGroupLayout"), source\_image: R, sampler: &'a [Sampler](../../../../render/render_resource/struct.Sampler.html "struct bevy::render::render_resource::Sampler"), ) -> [BindGroup](../../../../render/render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup")

where R: [IntoBinding](../../../../render/render_resource/trait.IntoBinding.html "trait bevy::render::render_resource::IntoBinding")<'a>,

Creates a bind group that allows the depth buffer to be attached to the `downsample_depth.wgsl` shader.

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/mip_generation/experimental/depth.rs.html#646-654)

#### pub fn [downsample\_depth\_with\_ctx](#method.downsample_depth_with_ctx)( &self, label: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html), ctx: &mut [RenderContext](../../../../render/renderer/struct.RenderContext.html "struct bevy::render::renderer::RenderContext")<'\_, '\_>, view\_size: [UVec2](../../../../prelude/struct.UVec2.html "struct bevy::prelude::UVec2"), downsample\_depth\_bind\_group: &[BindGroup](../../../../render/render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup"), downsample\_depth\_first\_pipeline: &[ComputePipeline](../../../../render/render_resource/struct.ComputePipeline.html "struct bevy::render::render_resource::ComputePipeline"), downsample\_depth\_second\_pipeline: &[ComputePipeline](../../../../render/render_resource/struct.ComputePipeline.html "struct bevy::render::render_resource::ComputePipeline"), )

## Trait Implementations

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/mip_generation/experimental/depth.rs.html#533)

### impl [Component](../../../../prelude/trait.Component.html "trait bevy::prelude::Component") for [ViewDepthPyramid](struct.ViewDepthPyramid.html "struct bevy::core_pipeline::mip_generation::experimental::depth::ViewDepthPyramid")

where [ViewDepthPyramid](struct.ViewDepthPyramid.html "struct bevy::core_pipeline::mip_generation::experimental::depth::ViewDepthPyramid"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ViewDepthPyramid](struct.ViewDepthPyramid.html "struct bevy::core_pipeline::mip_generation::experimental::depth::ViewDepthPyramid")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ViewDepthPyramid](struct.ViewDepthPyramid.html "struct bevy::core_pipeline::mip_generation::experimental::depth::ViewDepthPyramid")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ViewDepthPyramid](struct.ViewDepthPyramid.html "struct bevy::core_pipeline::mip_generation::experimental::depth::ViewDepthPyramid")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ViewDepthPyramid](struct.ViewDepthPyramid.html "struct bevy::core_pipeline::mip_generation::experimental::depth::ViewDepthPyramid")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ViewDepthPyramid](struct.ViewDepthPyramid.html "struct bevy::core_pipeline::mip_generation::experimental::depth::ViewDepthPyramid")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ViewDepthPyramid](struct.ViewDepthPyramid.html "struct bevy::core_pipeline::mip_generation::experimental::depth::ViewDepthPyramid")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ViewDepthPyramid](struct.ViewDepthPyramid.html "struct bevy::core_pipeline::mip_generation::experimental::depth::ViewDepthPyramid")
