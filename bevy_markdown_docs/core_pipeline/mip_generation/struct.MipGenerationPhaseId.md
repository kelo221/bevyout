...
# Struct MipGenerationPhaseId 

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/mip_generation/mod.rs.html#184)
...
Sometimes, mipmaps must be generated at a specific time during the rendering process. This typically occurs when a camera renders to the image and then the image is sampled later in the frame as a second camera renders the scene. In this case, the mipmaps must be generated after the first camera renders to the image rendered to but before the second camera’s rendering samples the image. To express these kinds of dependencies, you group images into _phases_ and schedule systems that call [`generate_mips_for_phase`](fn.generate_mips_for_phase.html "fn bevy::core_pipeline::mip_generation::generate_mips_for_phase") targeting each phase at the appropriate time.

Each phase has an ID, which is an arbitrary 32-bit integer. You may specify any value you wish as a phase ID, so long as the system that calls [`generate_mips_for_phase`](fn.generate_mips_for_phase.html "fn bevy::core_pipeline::mip_generation::generate_mips_for_phase") uses the same ID.
...
[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/mip_generation/mod.rs.html#183)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [MipGenerationPhaseId](struct.MipGenerationPhaseId.html "struct bevy::core_pipeline::mip_generation::MipGenerationPhaseId")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/mip_generation/mod.rs.html#183)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [MipGenerationPhaseId](struct.MipGenerationPhaseId.html "struct bevy::core_pipeline::mip_generation::MipGenerationPhaseId")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [MipGenerationPhaseId](struct.MipGenerationPhaseId.html "struct bevy::core_pipeline::mip_generation::MipGenerationPhaseId")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/mip_generation/mod.rs.html#183)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [MipGenerationPhaseId](struct.MipGenerationPhaseId.html "struct bevy::core_pipeline::mip_generation::MipGenerationPhaseId")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/mip_generation/mod.rs.html#183)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [MipGenerationPhaseId](struct.MipGenerationPhaseId.html "struct bevy::core_pipeline::mip_generation::MipGenerationPhaseId")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [MipGenerationPhaseId](struct.MipGenerationPhaseId.html "struct bevy::core_pipeline::mip_generation::MipGenerationPhaseId")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/mip_generation/mod.rs.html#183)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[MipGenerationPhaseId](struct.MipGenerationPhaseId.html "struct bevy::core_pipeline::mip_generation::MipGenerationPhaseId")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [MipGenerationPhaseId](struct.MipGenerationPhaseId.html "struct bevy::core_pipeline::mip_generation::MipGenerationPhaseId")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MipGenerationPhaseId](struct.MipGenerationPhaseId.html "struct bevy::core_pipeline::mip_generation::MipGenerationPhaseId")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MipGenerationPhaseId](struct.MipGenerationPhaseId.html "struct bevy::core_pipeline::mip_generation::MipGenerationPhaseId")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MipGenerationPhaseId](struct.MipGenerationPhaseId.html "struct bevy::core_pipeline::mip_generation::MipGenerationPhaseId")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MipGenerationPhaseId](struct.MipGenerationPhaseId.html "struct bevy::core_pipeline::mip_generation::MipGenerationPhaseId")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MipGenerationPhaseId](struct.MipGenerationPhaseId.html "struct bevy::core_pipeline::mip_generation::MipGenerationPhaseId")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MipGenerationPhaseId](struct.MipGenerationPhaseId.html "struct bevy::core_pipeline::mip_generation::MipGenerationPhaseId")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MipGenerationPhaseId](struct.MipGenerationPhaseId.html "struct bevy::core_pipeline::mip_generation::MipGenerationPhaseId")
