...
# Struct DownsampleShaders 

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/mip_generation/mod.rs.html#62)
...
`depth: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Shader](../../prelude/struct.Shader.html "struct bevy::prelude::Shader")>`

The experimental shader that downsamples depth (`downsample_depth.wgsl`).

`general: [HashMap](../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[TextureFormat](../../render/render_resource/enum.TextureFormat.html "enum bevy::render::render_resource::TextureFormat"), [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Shader](../../prelude/struct.Shader.html "struct bevy::prelude::Shader")>>`

The shaders that perform downsampling of color textures.

This table maps a [`TextureFormat`](../../render/render_resource/enum.TextureFormat.html "enum bevy::render::render_resource::TextureFormat") to the shader that performs downsampling for textures in that format.
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [DownsampleShaders](struct.DownsampleShaders.html "struct bevy::core_pipeline::mip_generation::DownsampleShaders")

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/mip_generation/mod.rs.html#61)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [DownsampleShaders](struct.DownsampleShaders.html "struct bevy::core_pipeline::mip_generation::DownsampleShaders")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [DownsampleShaders](struct.DownsampleShaders.html "struct bevy::core_pipeline::mip_generation::DownsampleShaders")

where [DownsampleShaders](struct.DownsampleShaders.html "struct bevy::core_pipeline::mip_generation::DownsampleShaders"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [DownsampleShaders](struct.DownsampleShaders.html "struct bevy::core_pipeline::mip_generation::DownsampleShaders")

where [DownsampleShaders](struct.DownsampleShaders.html "struct bevy::core_pipeline::mip_generation::DownsampleShaders"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DownsampleShaders](struct.DownsampleShaders.html "struct bevy::core_pipeline::mip_generation::DownsampleShaders")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DownsampleShaders](struct.DownsampleShaders.html "struct bevy::core_pipeline::mip_generation::DownsampleShaders")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DownsampleShaders](struct.DownsampleShaders.html "struct bevy::core_pipeline::mip_generation::DownsampleShaders")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DownsampleShaders](struct.DownsampleShaders.html "struct bevy::core_pipeline::mip_generation::DownsampleShaders")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DownsampleShaders](struct.DownsampleShaders.html "struct bevy::core_pipeline::mip_generation::DownsampleShaders")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DownsampleShaders](struct.DownsampleShaders.html "struct bevy::core_pipeline::mip_generation::DownsampleShaders")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DownsampleShaders](struct.DownsampleShaders.html "struct bevy::core_pipeline::mip_generation::DownsampleShaders")
