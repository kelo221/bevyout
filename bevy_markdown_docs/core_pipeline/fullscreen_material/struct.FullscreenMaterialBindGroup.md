...
# Struct FullscreenMaterialBindGroup 

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/fullscreen_material.rs.html#217)

```rust
pub struct FullscreenMaterialBindGroup<T>where
    T: FullscreenMaterial,{ /* private fields */ }
```

Holds the bind groups for both main textures

We can’t know ahead of time which one is the source or destination so we create a bind group for both

## Trait Implementations

[Source](https://docs.rs/bevy_core_pipeline/0.19.0/x86_64-unknown-linux-gnu/src/bevy_core_pipeline/fullscreen_material.rs.html#216)

### impl<T> [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [FullscreenMaterialBindGroup](struct.FullscreenMaterialBindGroup.html "struct bevy::core_pipeline::fullscreen_material::FullscreenMaterialBindGroup")<T>

where T: [FullscreenMaterial](trait.FullscreenMaterial.html "trait bevy::core_pipeline::fullscreen_material::FullscreenMaterial"), [FullscreenMaterialBindGroup](struct.FullscreenMaterialBindGroup.html "struct bevy::core_pipeline::fullscreen_material::FullscreenMaterialBindGroup")<T>: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl<T> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [FullscreenMaterialBindGroup](struct.FullscreenMaterialBindGroup.html "struct bevy::core_pipeline::fullscreen_material::FullscreenMaterialBindGroup")<T>

### impl<T> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [FullscreenMaterialBindGroup](struct.FullscreenMaterialBindGroup.html "struct bevy::core_pipeline::fullscreen_material::FullscreenMaterialBindGroup")<T>

### impl<T> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [FullscreenMaterialBindGroup](struct.FullscreenMaterialBindGroup.html "struct bevy::core_pipeline::fullscreen_material::FullscreenMaterialBindGroup")<T>

### impl<T> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [FullscreenMaterialBindGroup](struct.FullscreenMaterialBindGroup.html "struct bevy::core_pipeline::fullscreen_material::FullscreenMaterialBindGroup")<T>

### impl<T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [FullscreenMaterialBindGroup](struct.FullscreenMaterialBindGroup.html "struct bevy::core_pipeline::fullscreen_material::FullscreenMaterialBindGroup")<T>

### impl<T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [FullscreenMaterialBindGroup](struct.FullscreenMaterialBindGroup.html "struct bevy::core_pipeline::fullscreen_material::FullscreenMaterialBindGroup")<T>

where T: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<T> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [FullscreenMaterialBindGroup](struct.FullscreenMaterialBindGroup.html "struct bevy::core_pipeline::fullscreen_material::FullscreenMaterialBindGroup")<T>
