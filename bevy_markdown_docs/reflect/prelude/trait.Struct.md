...
#### fn [iter\_fields](#tymethod.iter_fields)(&self) -> [FieldIter](../structs/struct.FieldIter.html "struct bevy::reflect::structs::FieldIter")<'\_> [ⓘ](#)
...
#### fn [to\_dynamic\_struct](#method.to_dynamic_struct)(&self) -> [DynamicStruct](../structs/struct.DynamicStruct.html "struct bevy::reflect::structs::DynamicStruct")
...
#### fn [get\_represented\_struct\_info](#method.get_represented_struct_info)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&'static [StructInfo](../structs/struct.StructInfo.html "struct bevy::reflect::structs::StructInfo")\>
...
#### type [IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter) = [FieldIter](../structs/struct.FieldIter.html "struct bevy::reflect::structs::FieldIter")<'a>
...
### impl [Struct](../../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [DynamicStruct](../structs/struct.DynamicStruct.html "struct bevy::reflect::structs::DynamicStruct")
