...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#369)
...
This struct can be constructed manually from its [`Access`](enum.Access.html "enum bevy::reflect::Access")es or with the [parse](struct.ParsedPath.html#method.parse "associated function bevy::reflect::ParsedPath::parse") method.

This struct may be used like [`GetPath`](../prelude/trait.GetPath.html "trait bevy::prelude::GetPath") but removes the cost of parsing the path string at each element access.

It’s recommended to use this in place of [`GetPath`](../prelude/trait.GetPath.html "trait bevy::prelude::GetPath") when the path string is unlikely to be changed and will be accessed repeatedly.

### Examples

Parsing a [`&'static str`](https://doc.rust-lang.org/nightly/std/primitive.str.html "primitive str"):
...
Parsing a non-static [`&str`](https://doc.rust-lang.org/nightly/std/primitive.str.html "primitive str"):
...
Manually constructing a [`ParsedPath`](struct.ParsedPath.html "struct bevy::reflect::ParsedPath"):
...
`0: [Vec](../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[OffsetAccess](struct.OffsetAccess.html "struct bevy::reflect::OffsetAccess")>`

This is a vector of pre-parsed [`OffsetAccess`](struct.OffsetAccess.html "struct bevy::reflect::OffsetAccess")es.

## Implementations

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#374)

### impl [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#419)

#### pub fn [parse](#method.parse)(string: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath"), [ReflectPathError](enum.ReflectPathError.html "enum bevy::reflect::ReflectPathError")<'\_>>

Parses a [`ParsedPath`](struct.ParsedPath.html "struct bevy::reflect::ParsedPath") from a string.

Returns an error if the string does not represent a valid path to an element.

The exact format for path strings can be found in the documentation for [`GetPath`](../prelude/trait.GetPath.html "trait bevy::prelude::GetPath"). In short, though, a path consists of one or more chained accessor strings. These are:
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#432)

#### pub fn [parse\_static](#method.parse_static)( string: &'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath"), [ReflectPathError](enum.ReflectPathError.html "enum bevy::reflect::ReflectPathError")<'static>>

Similar to [`Self::parse`](struct.ParsedPath.html#method.parse "associated function bevy::reflect::ParsedPath::parse") but only works on `&'static str` and does not allocate per named field.

## Trait Implementations

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#367)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#367)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#495)

### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#496)
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#468)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Vec](../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[Access](enum.Access.html "enum bevy::reflect::Access")<'static>>> for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#469)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Vec](../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[Access](enum.Access.html "enum bevy::reflect::Access")<'static>>) -> [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#367)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Vec](../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[OffsetAccess](struct.OffsetAccess.html "struct bevy::reflect::OffsetAccess")\>> for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#367)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Vec](../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[OffsetAccess](struct.OffsetAccess.html "struct bevy::reflect::OffsetAccess")\>) -> [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#482)

### impl<const N: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<\[[Access](enum.Access.html "enum bevy::reflect::Access")<'static>; [N](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]> for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#483)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: \[[Access](enum.Access.html "enum bevy::reflect::Access")<'static>; [N](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]) -> [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#462)

### impl<const N: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<\[[OffsetAccess](struct.OffsetAccess.html "struct bevy::reflect::OffsetAccess"); [N](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]> for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#463)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: \[[OffsetAccess](struct.OffsetAccess.html "struct bevy::reflect::OffsetAccess"); [N](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]) -> [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#367)

### impl [FromArg](func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#367)

#### type [This](func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

The type to convert into. [Read more](func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#367)

#### fn [from\_arg](func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath") as [FromArg](func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](func/args/trait.FromArg.html#tymethod.from_arg)
...
#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")\>
...
### impl [GetOwnership](func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#367)

#### fn [ownership](func/args/trait.GetOwnership.html#method.ownership)() -> [Ownership](func/args/enum.Ownership.html "enum bevy::reflect::func::args::Ownership")

Returns the ownership of [`Self`](func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership").
...
#### fn [get\_type\_registration](trait.GetTypeRegistration.html#tymethod.get_type_registration)() -> [TypeRegistration](struct.TypeRegistration.html "struct bevy::reflect::TypeRegistration")

Returns the default [`TypeRegistration`](struct.TypeRegistration.html "struct bevy::reflect::TypeRegistration") for this type.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#367)

#### fn [register\_type\_dependencies](trait.GetTypeRegistration.html#method.register_type_dependencies)(registry: &mut [TypeRegistry](struct.TypeRegistry.html "struct bevy::reflect::TypeRegistry"))

Registers other types needed by this type. [Read more](trait.GetTypeRegistration.html#method.register_type_dependencies)

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#367)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#504)

### impl [Index](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html "trait core::ops::index::Index")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#505)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html#associatedtype.Output) = [OffsetAccess](struct.OffsetAccess.html "struct bevy::reflect::OffsetAccess")

The returned type after indexing.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#506)

#### fn [index](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html#tymethod.index)(&self, index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> &<[ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath") as [Index](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html "trait core::ops::index::Index")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\>>::[Output](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html#associatedtype.Output "type core::ops::index::Index::Output")
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#511)

### impl [IndexMut](https://doc.rust-lang.org/nightly/core/ops/index/trait.IndexMut.html "trait core::ops::index::IndexMut")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#512)

#### fn [index\_mut](https://doc.rust-lang.org/nightly/core/ops/index/trait.IndexMut.html#tymethod.index_mut)( &mut self, index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), ) -> &mut <[ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath") as [Index](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html "trait core::ops::index::Index")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\>>::[Output](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html#associatedtype.Output "type core::ops::index::Index::Output")
...
### impl [IntoReturn](func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#367)

#### fn [into\_return](func/trait.IntoReturn.html#tymethod.into_return)<'into\_return>(self) -> [Return](func/enum.Return.html "enum bevy::reflect::func::Return")<'into\_return>

where [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath"): 'into\_return,

Converts [`Self`](func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") into a [`Return`](func/enum.Return.html "enum bevy::reflect::func::Return") value.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#367)

### impl [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#367)

#### fn [cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html#tymethod.cmp)(&self, other: &[ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#367)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#367)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")\>
...
### impl [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")
...
#### fn [reflect\_owned](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")\>) -> [ReflectOwned](enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#367)

#### fn [try\_into\_reflect](../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#368)
...
#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<'a> [ReflectPath](../prelude/trait.ReflectPath.html "trait bevy::prelude::ReflectPath")<'a> for &'a [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#445)

#### fn [reflect\_element](../prelude/trait.ReflectPath.html#tymethod.reflect_element)( self, root: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<&(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), [ReflectPathError](enum.ReflectPathError.html "enum bevy::reflect::ReflectPathError")<'a>>

Gets a reference to the specified element on the given [`Reflect`](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") object. [Read more](../prelude/trait.ReflectPath.html#tymethod.reflect_element)

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#451-454)

#### fn [reflect\_element\_mut](../prelude/trait.ReflectPath.html#tymethod.reflect_element_mut)( self, root: &mut (dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<&mut (dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), [ReflectPathError](enum.ReflectPathError.html "enum bevy::reflect::ReflectPathError")<'a>>

Gets a mutable reference to the specified element on the given [`Reflect`](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") object. [Read more](../prelude/trait.ReflectPath.html#tymethod.reflect_element_mut)

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#68)

#### fn [element](../prelude/trait.ReflectPath.html#method.element)<T>( self, root: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[&T](https://doc.rust-lang.org/nightly/std/primitive.reference.html), [ReflectPathError](enum.ReflectPathError.html "enum bevy::reflect::ReflectPathError")<'a>>

where T: [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect"),

Gets a `&T` to the specified element on the given [`Reflect`](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") object. [Read more](../prelude/trait.ReflectPath.html#method.element)

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#78)

#### fn [element\_mut](../prelude/trait.ReflectPath.html#method.element_mut)<T>( self, root: &mut (dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html), [ReflectPathError](enum.ReflectPathError.html "enum bevy::reflect::ReflectPathError")<'a>>

where T: [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect"),

Gets a `&mut T` to the specified element on the given [`Reflect`](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") object. [Read more](../prelude/trait.ReflectPath.html#method.element_mut)

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#367)

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#488)

### impl<'a> [TryFrom](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html "trait core::convert::TryFrom")<&'a [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\> for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#489)

#### type [Error](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html#associatedtype.Error) = [ReflectPathError](enum.ReflectPathError.html "enum bevy::reflect::ReflectPathError")<'a>

The type returned in the event of a conversion error.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#490)

#### fn [try\_from](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html#tymethod.try_from)( value: &'a [str](https://doc.rust-lang.org/nightly/std/primitive.str.html), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath"), <[ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath") as [TryFrom](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html "trait core::convert::TryFrom")<&'a [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>>::[Error](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html#associatedtype.Error "type core::convert::TryFrom::Error")\>
...
#### fn [iter\_fields](../prelude/trait.TupleStruct.html#tymethod.iter_fields)(&self) -> [TupleStructFieldIter](tuple_struct/struct.TupleStructFieldIter.html "struct bevy::reflect::tuple_struct::TupleStructFieldIter")<'\_> [ⓘ](#)

Returns an iterator over the values of the tuple struct’s fields.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#367)

#### fn [to\_dynamic\_tuple\_struct](../prelude/trait.TupleStruct.html#method.to_dynamic_tuple_struct)(&self) -> [DynamicTupleStruct](tuple_struct/struct.DynamicTupleStruct.html "struct bevy::reflect::tuple_struct::DynamicTupleStruct")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ParsedPath](struct.ParsedPath.html "struct bevy::reflect::ParsedPath")
...
#### fn [reflect\_type\_info](trait.DynamicTyped.html#tymethod.reflect_type_info)(&self) -> &'static [TypeInfo](enum.TypeInfo.html "enum bevy::reflect::TypeInfo")
...
#### fn [path](../prelude/trait.GetPath.html#method.path)<'p, T>( &self, path: impl [ReflectPath](../prelude/trait.ReflectPath.html "trait bevy::prelude::ReflectPath")<'p>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[&T](https://doc.rust-lang.org/nightly/std/primitive.reference.html), [ReflectPathError](enum.ReflectPathError.html "enum bevy::reflect::ReflectPathError")<'p>>
...
#### fn [path\_mut](../prelude/trait.GetPath.html#method.path_mut)<'p, T>( &mut self, path: impl [ReflectPath](../prelude/trait.ReflectPath.html "trait bevy::prelude::ReflectPath")<'p>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html), [ReflectPathError](enum.ReflectPathError.html "enum bevy::reflect::ReflectPathError")<'p>>
