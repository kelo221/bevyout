[bevy](../../index.html)::[reflect](../index.html)::[convert](index.html)

# Struct ReflectConvert 

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/convert.rs.html#36)

```rust
pub struct ReflectConvert { /* private fields */ }
```

Provides a mechanism for converting values of one type to another.

This [`crate::type_registry::TypeData`](../trait.TypeData.html "trait bevy::reflect::TypeData") is associated with the type to be converted _into_, not the type to be converted _from_. To convert a value, use code like the following:
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/convert.rs.html#65)

### impl [ReflectConvert](struct.ReflectConvert.html "struct bevy::reflect::convert::ReflectConvert")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/convert.rs.html#72-75)

#### pub fn [try\_convert\_from](#method.try_convert_from)( &self, input: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>>

Attempts to construct an instance of this type from the provided `input`.

If the conversion fails, either because no conversion has been registered from the type of `input` or because the conversion function itself returned `Err`, the `input` value is returned as an error.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/convert.rs.html#88-92)
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/convert.rs.html#104)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ReflectConvert](struct.ReflectConvert.html "struct bevy::reflect::convert::ReflectConvert")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/convert.rs.html#105)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ReflectConvert](struct.ReflectConvert.html "struct bevy::reflect::convert::ReflectConvert")
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/convert.rs.html#35)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [ReflectConvert](struct.ReflectConvert.html "struct bevy::reflect::convert::ReflectConvert")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/convert.rs.html#35)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [ReflectConvert](struct.ReflectConvert.html "struct bevy::reflect::convert::ReflectConvert")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ReflectConvert](struct.ReflectConvert.html "struct bevy::reflect::convert::ReflectConvert")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ReflectConvert](struct.ReflectConvert.html "struct bevy::reflect::convert::ReflectConvert")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ReflectConvert](struct.ReflectConvert.html "struct bevy::reflect::convert::ReflectConvert")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ReflectConvert](struct.ReflectConvert.html "struct bevy::reflect::convert::ReflectConvert")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ReflectConvert](struct.ReflectConvert.html "struct bevy::reflect::convert::ReflectConvert")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ReflectConvert](struct.ReflectConvert.html "struct bevy::reflect::convert::ReflectConvert")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ReflectConvert](struct.ReflectConvert.html "struct bevy::reflect::convert::ReflectConvert")
