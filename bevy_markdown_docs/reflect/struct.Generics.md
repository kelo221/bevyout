...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/generics.rs.html#26)

```rust
pub struct Generics(/* private fields */);
```

The generic parameters of a type.

This is automatically generated via the [`Reflect` derive macro](../prelude/derive.Reflect.html "derive bevy::prelude::Reflect") and stored on the [`TypeInfo`](enum.TypeInfo.html "enum bevy::reflect::TypeInfo") returned by [`Typed::type_info`](trait.Typed.html#tymethod.type_info "associated function bevy::reflect::Typed::type_info") for types that have generics.

It supports both type parameters and const parameters so long as they implement [`TypePath`](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath").

If the type has no generics, this will be empty.

If the type is marked with `#[reflect(type_path = false)]`, the generics will be empty even if the type has generics.

## Implementations

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/generics.rs.html#28)

### impl [Generics](struct.Generics.html "struct bevy::reflect::Generics")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/generics.rs.html#30)

#### pub fn [new](#method.new)() -> [Generics](struct.Generics.html "struct bevy::reflect::Generics")

Creates an empty set of generics.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/generics.rs.html#37)

#### pub fn [get\_named](#method.get_named)(&self, name: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[GenericInfo](enum.GenericInfo.html "enum bevy::reflect::GenericInfo")\>

Finds the generic parameter with the given name.

Returns `None` if no such parameter exists.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/generics.rs.html#44)

#### pub fn [with](#method.with)(self, info: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[GenericInfo](enum.GenericInfo.html "enum bevy::reflect::GenericInfo")\>) -> [Generics](struct.Generics.html "struct bevy::reflect::Generics")

Adds the given generic parameter to the set.

## Methods from [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")<Target = \[[GenericInfo](enum.GenericInfo.html "enum bevy::reflect::GenericInfo")\]>
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/generics.rs.html#25)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Generics](struct.Generics.html "struct bevy::reflect::Generics")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/generics.rs.html#25)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Generics](struct.Generics.html "struct bevy::reflect::Generics")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Generics](struct.Generics.html "struct bevy::reflect::Generics")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Generics](struct.Generics.html "struct bevy::reflect::Generics")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/generics.rs.html#25)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Generics](struct.Generics.html "struct bevy::reflect::Generics")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/generics.rs.html#58)

### impl [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [Generics](struct.Generics.html "struct bevy::reflect::Generics")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/generics.rs.html#59)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = \[[GenericInfo](enum.GenericInfo.html "enum bevy::reflect::GenericInfo")\]

The resulting type after dereferencing.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/generics.rs.html#61)

#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[Generics](struct.Generics.html "struct bevy::reflect::Generics") as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/generics.rs.html#52)

### impl<T> [FromIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html "trait core::iter::traits::collect::FromIterator")<T> for [Generics](struct.Generics.html "struct bevy::reflect::Generics")

where T: [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[GenericInfo](enum.GenericInfo.html "enum bevy::reflect::GenericInfo")\>,

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/generics.rs.html#53)

#### fn [from\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html#tymethod.from_iter)<I>(iter: I) -> [Generics](struct.Generics.html "struct bevy::reflect::Generics")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Generics](struct.Generics.html "struct bevy::reflect::Generics")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Generics](struct.Generics.html "struct bevy::reflect::Generics")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Generics](struct.Generics.html "struct bevy::reflect::Generics")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Generics](struct.Generics.html "struct bevy::reflect::Generics")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Generics](struct.Generics.html "struct bevy::reflect::Generics")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Generics](struct.Generics.html "struct bevy::reflect::Generics")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Generics](struct.Generics.html "struct bevy::reflect::Generics")
