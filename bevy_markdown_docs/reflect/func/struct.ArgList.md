...
#### pub fn [take\_arg](#method.take_arg)(&mut self) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Arg](args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'a>, [ArgError](enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### pub fn [take](#method.take)<T>(&mut self) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<T as [FromArg](args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'a>, [ArgError](enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

where T: [FromArg](args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg"),

Remove the first argument in the list and return `Ok(T::This)`.

If the list is empty or the [`FromArg::from_arg`](args/trait.FromArg.html#tymethod.from_arg "associated function bevy::reflect::func::args::FromArg::from_arg") call fails, returns an error.
...
#### pub fn [pop\_arg](#method.pop_arg)(&mut self) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Arg](args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'a>, [ArgError](enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### pub fn [pop](#method.pop)<T>(&mut self) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<T as [FromArg](args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'a>, [ArgError](enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### pub fn [iter](#method.iter)(&self) -> [Iter](https://doc.rust-lang.org/nightly/alloc/collections/vec_deque/iter/struct.Iter.html "struct alloc::collections::vec_deque::iter::Iter")<'\_, [Arg](args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'a>> [ⓘ](#)
