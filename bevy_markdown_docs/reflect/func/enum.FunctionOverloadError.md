...
# Enum FunctionOverloadError 

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/func/error.rs.html#48)
...
A [`SignatureInfo`](struct.SignatureInfo.html "struct bevy::reflect::func::SignatureInfo") was expected, but none was found.

### DuplicateSignature([ArgumentSignature](signature/struct.ArgumentSignature.html "struct bevy::reflect::func::signature::ArgumentSignature"))

An error that occurs when attempting to add a function overload with a duplicate signature.

### TooManyArguments([ArgumentSignature](signature/struct.ArgumentSignature.html "struct bevy::reflect::func::signature::ArgumentSignature"))

An attempt was made to add an overload with more than [`ArgCount::MAX_COUNT`](args/struct.ArgCount.html "struct bevy::reflect::func::args::ArgCount") arguments.

## Trait Implementations

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/func/error.rs.html#47)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [FunctionOverloadError](enum.FunctionOverloadError.html "enum bevy::reflect::func::FunctionOverloadError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [FunctionOverloadError](enum.FunctionOverloadError.html "enum bevy::reflect::func::FunctionOverloadError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [FunctionOverloadError](enum.FunctionOverloadError.html "enum bevy::reflect::func::FunctionOverloadError")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [FunctionOverloadError](enum.FunctionOverloadError.html "enum bevy::reflect::func::FunctionOverloadError")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/func/error.rs.html#47)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[FunctionOverloadError](enum.FunctionOverloadError.html "enum bevy::reflect::func::FunctionOverloadError")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [FunctionOverloadError](enum.FunctionOverloadError.html "enum bevy::reflect::func::FunctionOverloadError")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [FunctionOverloadError](enum.FunctionOverloadError.html "enum bevy::reflect::func::FunctionOverloadError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [FunctionOverloadError](enum.FunctionOverloadError.html "enum bevy::reflect::func::FunctionOverloadError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [FunctionOverloadError](enum.FunctionOverloadError.html "enum bevy::reflect::func::FunctionOverloadError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [FunctionOverloadError](enum.FunctionOverloadError.html "enum bevy::reflect::func::FunctionOverloadError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [FunctionOverloadError](enum.FunctionOverloadError.html "enum bevy::reflect::func::FunctionOverloadError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [FunctionOverloadError](enum.FunctionOverloadError.html "enum bevy::reflect::func::FunctionOverloadError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [FunctionOverloadError](enum.FunctionOverloadError.html "enum bevy::reflect::func::FunctionOverloadError")
