...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/func/info.rs.html#245)

```rust
pub struct SignatureInfo { /* private fields */ }
```
...
Every [`FunctionInfo`](struct.FunctionInfo.html "struct bevy::reflect::func::FunctionInfo") contains one or more [`SignatureInfo`](struct.SignatureInfo.html "struct bevy::reflect::func::SignatureInfo")s.

## Implementations

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/func/info.rs.html#251)

### impl [SignatureInfo](struct.SignatureInfo.html "struct bevy::reflect::func::SignatureInfo")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/func/info.rs.html#253)

#### pub fn [named](#method.named)(name: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Cow](https://doc.rust-lang.org/nightly/alloc/borrow/enum.Cow.html "enum alloc::borrow::Cow")<'static, [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>>) -> [SignatureInfo](struct.SignatureInfo.html "struct bevy::reflect::func::SignatureInfo")

Create a new [`SignatureInfo`](struct.SignatureInfo.html "struct bevy::reflect::func::SignatureInfo") for a function with the given name.

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/reflection/function\_reflection.rs ([line 196](../../../src/function_reflection/function_reflection.rs.html#196))
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/func/info.rs.html#267)

#### pub fn [anonymous](#method.anonymous)() -> [SignatureInfo](struct.SignatureInfo.html "struct bevy::reflect::func::SignatureInfo")

Create a new [`SignatureInfo`](struct.SignatureInfo.html "struct bevy::reflect::func::SignatureInfo") with no name.

For the purposes of debugging and [registration](struct.FunctionRegistry.html "struct bevy::reflect::func::FunctionRegistry"), it’s recommended to use [`Self::named`](struct.SignatureInfo.html#method.named "associated function bevy::reflect::func::SignatureInfo::named") instead.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/func/info.rs.html#276)
...
examples/reflection/function\_reflection.rs ([line 200](../../../src/function_reflection/function_reflection.rs.html#200))
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/func/info.rs.html#285-288)

#### pub fn [with\_arg](#method.with_arg)<T>(self, name: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Cow](https://doc.rust-lang.org/nightly/alloc/borrow/enum.Cow.html "enum alloc::borrow::Cow")<'static, [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>>) -> [SignatureInfo](struct.SignatureInfo.html "struct bevy::reflect::func::SignatureInfo")

where T: [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") + [GetOwnership](args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership"),

Push an argument onto the function’s argument list.

The order in which this method is called matters as it will determine the index of the argument based on the current number of arguments.

##### [Examples found in repository](#scraped-examples-2)[?](../../../scrape-examples-help.html)

examples/reflection/function\_reflection.rs ([line 205](../../../src/function_reflection/function_reflection.rs.html#205))
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/func/info.rs.html#302)

#### pub fn [with\_args](#method.with_args)(self, args: [Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[ArgInfo](args/struct.ArgInfo.html "struct bevy::reflect::func::args::ArgInfo")\>) -> [SignatureInfo](struct.SignatureInfo.html "struct bevy::reflect::func::SignatureInfo")

Set the arguments of the function.

This will completely replace any existing arguments.

It’s preferable to use [`Self::with_arg`](struct.SignatureInfo.html#method.with_arg "method bevy::reflect::func::SignatureInfo::with_arg") to add arguments to the function as it will automatically set the index of the argument.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/func/info.rs.html#312)

#### pub fn [with\_return](#method.with_return)<T>(self) -> [SignatureInfo](struct.SignatureInfo.html "struct bevy::reflect::func::SignatureInfo")

where T: [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") + [GetOwnership](args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership"),

Set the [return information](struct.ReturnInfo.html "struct bevy::reflect::func::ReturnInfo") of the function.

To manually set the [`ReturnInfo`](struct.ReturnInfo.html "struct bevy::reflect::func::ReturnInfo") of the function, see [`Self::with_return_info`](struct.SignatureInfo.html#method.with_return_info "method bevy::reflect::func::SignatureInfo::with_return_info").

##### [Examples found in repository](#scraped-examples-3)[?](../../../scrape-examples-help.html)

examples/reflection/function\_reflection.rs ([line 208](../../../src/function_reflection/function_reflection.rs.html#208))
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/func/info.rs.html#324)

#### pub fn [with\_return\_info](#method.with_return_info)(self, return\_info: [ReturnInfo](struct.ReturnInfo.html "struct bevy::reflect::func::ReturnInfo")) -> [SignatureInfo](struct.SignatureInfo.html "struct bevy::reflect::func::SignatureInfo")

Set the [return information](struct.ReturnInfo.html "struct bevy::reflect::func::ReturnInfo") of the function.

This will completely replace any existing return information.

For a simpler, static version of this method, see [`Self::with_return`](struct.SignatureInfo.html#method.with_return "method bevy::reflect::func::SignatureInfo::with_return").

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/func/info.rs.html#340)
...
For [`DynamicFunctions`](struct.DynamicFunction.html "struct bevy::reflect::func::DynamicFunction") created using [`IntoFunction`](../../prelude/trait.IntoFunction.html "trait bevy::prelude::IntoFunction") or [`DynamicFunctionMuts`](struct.DynamicFunctionMut.html "struct bevy::reflect::func::DynamicFunctionMut") created using [`IntoFunctionMut`](../../prelude/trait.IntoFunctionMut.html "trait bevy::prelude::IntoFunctionMut"), the default name will always be the full path to the function as returned by [`core::any::type_name`](https://doc.rust-lang.org/nightly/core/any/fn.type_name.html "fn core::any::type_name"), unless the function is a closure, anonymous function, or function pointer, in which case the name will be `None`.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/func/info.rs.html#345)

#### pub fn [args](#method.args)(&self) -> &\[[ArgInfo](args/struct.ArgInfo.html "struct bevy::reflect::func::args::ArgInfo")\]

The arguments of the function.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/func/info.rs.html#350)

#### pub fn [arg\_count](#method.arg_count)(&self) -> [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)

The number of arguments the function takes.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/func/info.rs.html#355)

#### pub fn [return\_info](#method.return_info)(&self) -> &[ReturnInfo](struct.ReturnInfo.html "struct bevy::reflect::func::ReturnInfo")

The return information of the function.

## Trait Implementations

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/func/info.rs.html#244)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [SignatureInfo](struct.SignatureInfo.html "struct bevy::reflect::func::SignatureInfo")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/func/info.rs.html#244)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [SignatureInfo](struct.SignatureInfo.html "struct bevy::reflect::func::SignatureInfo")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [SignatureInfo](struct.SignatureInfo.html "struct bevy::reflect::func::SignatureInfo")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SignatureInfo](struct.SignatureInfo.html "struct bevy::reflect::func::SignatureInfo")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SignatureInfo](struct.SignatureInfo.html "struct bevy::reflect::func::SignatureInfo")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SignatureInfo](struct.SignatureInfo.html "struct bevy::reflect::func::SignatureInfo")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SignatureInfo](struct.SignatureInfo.html "struct bevy::reflect::func::SignatureInfo")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SignatureInfo](struct.SignatureInfo.html "struct bevy::reflect::func::SignatureInfo")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SignatureInfo](struct.SignatureInfo.html "struct bevy::reflect::func::SignatureInfo")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SignatureInfo](struct.SignatureInfo.html "struct bevy::reflect::func::SignatureInfo")
