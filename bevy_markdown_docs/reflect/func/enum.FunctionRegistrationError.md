...
# Enum FunctionRegistrationError 

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/func/error.rs.html#72)
...
### DuplicateName([Cow](https://doc.rust-lang.org/nightly/alloc/borrow/enum.Cow.html "enum alloc::borrow::Cow")<'static, [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>)
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/func/error.rs.html#71)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [FunctionRegistrationError](enum.FunctionRegistrationError.html "enum bevy::reflect::func::FunctionRegistrationError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [FunctionRegistrationError](enum.FunctionRegistrationError.html "enum bevy::reflect::func::FunctionRegistrationError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [FunctionRegistrationError](enum.FunctionRegistrationError.html "enum bevy::reflect::func::FunctionRegistrationError")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [FunctionRegistrationError](enum.FunctionRegistrationError.html "enum bevy::reflect::func::FunctionRegistrationError")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/func/error.rs.html#71)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[FunctionRegistrationError](enum.FunctionRegistrationError.html "enum bevy::reflect::func::FunctionRegistrationError")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [FunctionRegistrationError](enum.FunctionRegistrationError.html "enum bevy::reflect::func::FunctionRegistrationError")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [FunctionRegistrationError](enum.FunctionRegistrationError.html "enum bevy::reflect::func::FunctionRegistrationError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [FunctionRegistrationError](enum.FunctionRegistrationError.html "enum bevy::reflect::func::FunctionRegistrationError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [FunctionRegistrationError](enum.FunctionRegistrationError.html "enum bevy::reflect::func::FunctionRegistrationError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [FunctionRegistrationError](enum.FunctionRegistrationError.html "enum bevy::reflect::func::FunctionRegistrationError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [FunctionRegistrationError](enum.FunctionRegistrationError.html "enum bevy::reflect::func::FunctionRegistrationError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [FunctionRegistrationError](enum.FunctionRegistrationError.html "enum bevy::reflect::func::FunctionRegistrationError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [FunctionRegistrationError](enum.FunctionRegistrationError.html "enum bevy::reflect::func::FunctionRegistrationError")
