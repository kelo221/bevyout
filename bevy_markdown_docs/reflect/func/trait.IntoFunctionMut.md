...
This trait is automatically implemented for any type that implements [`ReflectFnMut`](trait.ReflectFnMut.html "trait bevy::reflect::func::ReflectFnMut") and [`TypedFunction`](trait.TypedFunction.html "trait bevy::reflect::func::TypedFunction").
...
#### fn [into\_function\_mut](#tymethod.into_function_mut)(self) -> [DynamicFunctionMut](struct.DynamicFunctionMut.html "struct bevy::reflect::func::DynamicFunctionMut")<'env>
...
where F: [ReflectFnMut](trait.ReflectFnMut.html "trait bevy::reflect::func::ReflectFnMut")<'env, Marker1> + [TypedFunction](trait.TypedFunction.html "trait bevy::reflect::func::TypedFunction")<Marker2> + 'env,
...
### impl<'env> [IntoFunctionMut](../../prelude/trait.IntoFunctionMut.html "trait bevy::prelude::IntoFunctionMut")<'env, [()](https://doc.rust-lang.org/nightly/std/primitive.unit.html)\> for [DynamicFunctionMut](struct.DynamicFunctionMut.html "struct bevy::reflect::func::DynamicFunctionMut")<'env>