...
This trait allows types to be called like regular functions with [`Reflect`](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\-based [arguments](args/index.html "mod bevy::reflect::func::args") and return values.

By default, this trait is currently only implemented for [`DynamicFunction`](struct.DynamicFunction.html "struct bevy::reflect::func::DynamicFunction"), however, it is possible to implement this trait for custom function-like types.
...
#### fn [info](#tymethod.info)(&self) -> &[FunctionInfo](struct.FunctionInfo.html "struct bevy::reflect::func::FunctionInfo")
...
#### fn [to\_dynamic\_function](#tymethod.to_dynamic_function)(&self) -> [DynamicFunction](struct.DynamicFunction.html "struct bevy::reflect::func::DynamicFunction")<'static>
...
#### fn [arg\_count](#method.arg_count)(&self) -> [ArgCount](args/struct.ArgCount.html "struct bevy::reflect::func::args::ArgCount")
