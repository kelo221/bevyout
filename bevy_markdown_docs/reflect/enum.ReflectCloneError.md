...
# Enum ReflectCloneError 

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/error.rs.html#9)
...
The type does not have a custom implementation for [`PartialReflect::reflect_clone`](../prelude/trait.PartialReflect.html#method.reflect_clone "method bevy::prelude::PartialReflect::reflect_clone").

#### Fields

`type_path: [Cow](https://doc.rust-lang.org/nightly/alloc/borrow/enum.Cow.html "enum alloc::borrow::Cow")<'static, [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)>`

The fully qualified path of the type that [`PartialReflect::reflect_clone`](../prelude/trait.PartialReflect.html#method.reflect_clone "method bevy::prelude::PartialReflect::reflect_clone") is not implemented for.

### NotCloneable

The type cannot be cloned via [`PartialReflect::reflect_clone`](../prelude/trait.PartialReflect.html#method.reflect_clone "method bevy::prelude::PartialReflect::reflect_clone").
...
The fully qualified path of the type that cannot be cloned via [`PartialReflect::reflect_clone`](../prelude/trait.PartialReflect.html#method.reflect_clone "method bevy::prelude::PartialReflect::reflect_clone").

### FieldNotCloneable

The field cannot be cloned via [`PartialReflect::reflect_clone`](../prelude/trait.PartialReflect.html#method.reflect_clone "method bevy::prelude::PartialReflect::reflect_clone").

When [deriving `Reflect`](../prelude/derive.Reflect.html "derive bevy::prelude::Reflect"), this usually means that a field marked with `#[reflect(ignore)]` is missing a `#[reflect(clone)]` attribute.

This may be intentional if the field is not meant/able to be cloned.

#### Fields

`field: [FieldId](enum.FieldId.html "enum bevy::reflect::FieldId")`

Struct field or enum variant field which cannot be cloned.

`variant: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Cow](https://doc.rust-lang.org/nightly/alloc/borrow/enum.Cow.html "enum alloc::borrow::Cow")<'static, [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)>>`

Variant this field is part of if the container is an enum, otherwise [`None`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.None "variant core::option::Option::None").

`container_type_path: [Cow](https://doc.rust-lang.org/nightly/alloc/borrow/enum.Cow.html "enum alloc::borrow::Cow")<'static, [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)>`
...
Realistically this should only occur when a type has incorrectly implemented [`Reflect`](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect").

#### Fields

`expected: [Cow](https://doc.rust-lang.org/nightly/alloc/borrow/enum.Cow.html "enum alloc::borrow::Cow")<'static, [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)>`

The fully qualified path of the type that was expected.

`received: [Cow](https://doc.rust-lang.org/nightly/alloc/borrow/enum.Cow.html "enum alloc::borrow::Cow")<'static, [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)>`

The fully qualified path of the type that was received.

## Trait Implementations

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/error.rs.html#8)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ReflectCloneError](enum.ReflectCloneError.html "enum bevy::reflect::ReflectCloneError")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/error.rs.html#8)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ReflectCloneError](enum.ReflectCloneError.html "enum bevy::reflect::ReflectCloneError")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ReflectCloneError](enum.ReflectCloneError.html "enum bevy::reflect::ReflectCloneError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [ReflectCloneError](enum.ReflectCloneError.html "enum bevy::reflect::ReflectCloneError")
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [ReflectCloneError](enum.ReflectCloneError.html "enum bevy::reflect::ReflectCloneError")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/error.rs.html#8)

### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [ReflectCloneError](enum.ReflectCloneError.html "enum bevy::reflect::ReflectCloneError")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [ReflectCloneError](enum.ReflectCloneError.html "enum bevy::reflect::ReflectCloneError")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/error.rs.html#8)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[ReflectCloneError](enum.ReflectCloneError.html "enum bevy::reflect::ReflectCloneError")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [ReflectCloneError](enum.ReflectCloneError.html "enum bevy::reflect::ReflectCloneError")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ReflectCloneError](enum.ReflectCloneError.html "enum bevy::reflect::ReflectCloneError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ReflectCloneError](enum.ReflectCloneError.html "enum bevy::reflect::ReflectCloneError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ReflectCloneError](enum.ReflectCloneError.html "enum bevy::reflect::ReflectCloneError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ReflectCloneError](enum.ReflectCloneError.html "enum bevy::reflect::ReflectCloneError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ReflectCloneError](enum.ReflectCloneError.html "enum bevy::reflect::ReflectCloneError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ReflectCloneError](enum.ReflectCloneError.html "enum bevy::reflect::ReflectCloneError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ReflectCloneError](enum.ReflectCloneError.html "enum bevy::reflect::ReflectCloneError")
