...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#71)
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#78)

### impl [DynamicEnum](struct.DynamicEnum.html "struct bevy::reflect::enums::DynamicEnum")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#85)

#### pub fn [new](#method.new)<I, V>(variant\_name: I, variant: V) -> [DynamicEnum](struct.DynamicEnum.html "struct bevy::reflect::enums::DynamicEnum")

where I: [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[String](../../prelude/struct.String.html "struct bevy::prelude::String")\>, V: [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[DynamicVariant](enum.DynamicVariant.html "enum bevy::reflect::enums::DynamicVariant")\>,

Create a new [`DynamicEnum`](struct.DynamicEnum.html "struct bevy::reflect::enums::DynamicEnum") to represent an enum at runtime.
...
examples/reflection/dynamic\_types.rs ([line 276](../../../src/dynamic_types/dynamic_types.rs.html#276))
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#101-105)

#### pub fn [new\_with\_index](#method.new_with_index)<I, V>( variant\_index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), variant\_name: I, variant: V, ) -> [DynamicEnum](struct.DynamicEnum.html "struct bevy::reflect::enums::DynamicEnum")

where I: [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[String](../../prelude/struct.String.html "struct bevy::prelude::String")\>, V: [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[DynamicVariant](enum.DynamicVariant.html "enum bevy::reflect::enums::DynamicVariant")\>,

Create a new [`DynamicEnum`](struct.DynamicEnum.html "struct bevy::reflect::enums::DynamicEnum") with a variant index to represent an enum at runtime.
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#121)

#### pub fn [set\_represented\_type](#method.set_represented_type)( &mut self, represented\_type: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&'static [TypeInfo](../enum.TypeInfo.html "enum bevy::reflect::TypeInfo")\>, )

Sets the [type](../enum.TypeInfo.html "enum bevy::reflect::TypeInfo") to be represented by this `DynamicEnum`.

##### Panics

Panics if the given [type](../enum.TypeInfo.html "enum bevy::reflect::TypeInfo") is not a [`TypeInfo::Enum`](../enum.TypeInfo.html#variant.Enum "variant bevy::reflect::TypeInfo::Enum").

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#133)

#### pub fn [set\_variant](#method.set_variant)<I, V>(&mut self, name: I, variant: V)

where I: [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[String](../../prelude/struct.String.html "struct bevy::prelude::String")\>, V: [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[DynamicVariant](enum.DynamicVariant.html "enum bevy::reflect::enums::DynamicVariant")\>,

Set the current enum variant represented by this struct.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#139-144)

#### pub fn [set\_variant\_with\_index](#method.set_variant_with_index)<I, V>( &mut self, variant\_index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), variant\_name: I, variant: V, )

where I: [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[String](../../prelude/struct.String.html "struct bevy::prelude::String")\>, V: [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[DynamicVariant](enum.DynamicVariant.html "enum bevy::reflect::enums::DynamicVariant")\>,

Set the current enum variant represented by this struct along with its variant index.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#151)

#### pub fn [variant](#method.variant)(&self) -> &[DynamicVariant](enum.DynamicVariant.html "enum bevy::reflect::enums::DynamicVariant")

Get a reference to the [`DynamicVariant`](enum.DynamicVariant.html "enum bevy::reflect::enums::DynamicVariant") contained in `self`.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#162)

#### pub fn [variant\_mut](#method.variant_mut)(&mut self) -> &mut [DynamicVariant](enum.DynamicVariant.html "enum bevy::reflect::enums::DynamicVariant")

Get a mutable reference to the [`DynamicVariant`](enum.DynamicVariant.html "enum bevy::reflect::enums::DynamicVariant") contained in `self`.

Using the mut reference to switch to a different variant will _**not**_ update the internal tracking of the variant name and index.

If you want to switch variants, prefer one of the setters: [`DynamicEnum::set_variant`](struct.DynamicEnum.html#method.set_variant "method bevy::reflect::enums::DynamicEnum::set_variant") or [`DynamicEnum::set_variant_with_index`](struct.DynamicEnum.html#method.set_variant_with_index "method bevy::reflect::enums::DynamicEnum::set_variant_with_index").

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#169)

#### pub fn [from](#method.from)<TEnum>(value: TEnum) -> [DynamicEnum](struct.DynamicEnum.html "struct bevy::reflect::enums::DynamicEnum")

where TEnum: [Enum](trait.Enum.html "trait bevy::reflect::enums::Enum"),

Create a [`DynamicEnum`](struct.DynamicEnum.html "struct bevy::reflect::enums::DynamicEnum") from an existing one.

This is functionally the same as [`DynamicEnum::from_ref`](struct.DynamicEnum.html#method.from_ref "associated function bevy::reflect::enums::DynamicEnum::from_ref") except it takes an owned value.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#176)

#### pub fn [from\_ref](#method.from_ref)<TEnum>(value: [&TEnum](https://doc.rust-lang.org/nightly/std/primitive.reference.html)) -> [DynamicEnum](struct.DynamicEnum.html "struct bevy::reflect::enums::DynamicEnum")

where TEnum: [Enum](trait.Enum.html "trait bevy::reflect::enums::Enum") + ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

Create a [`DynamicEnum`](struct.DynamicEnum.html "struct bevy::reflect::enums::DynamicEnum") from an existing one.

This is functionally the same as [`DynamicEnum::from`](struct.DynamicEnum.html#method.from "associated function bevy::reflect::enums::DynamicEnum::from") except it takes a reference.

## Trait Implementations

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#70)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [DynamicEnum](struct.DynamicEnum.html "struct bevy::reflect::enums::DynamicEnum")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [DynamicEnum](struct.DynamicEnum.html "struct bevy::reflect::enums::DynamicEnum")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#70)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [DynamicEnum](struct.DynamicEnum.html "struct bevy::reflect::enums::DynamicEnum")
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#215)

#### fn [field](trait.Enum.html#tymethod.field)(&self, name: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)>

Returns a reference to the value of the field (in the current variant) with the given name. [Read more](trait.Enum.html#tymethod.field)

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#223)

#### fn [field\_at](trait.Enum.html#tymethod.field_at)(&self, index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)>

Returns a reference to the value of the field (in the current variant) at the given index.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#231)

#### fn [field\_mut](trait.Enum.html#tymethod.field_mut)( &mut self, name: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&mut (dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)>

Returns a mutable reference to the value of the field (in the current variant) with the given name. [Read more](trait.Enum.html#tymethod.field_mut)

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#239)

#### fn [field\_at\_mut](trait.Enum.html#tymethod.field_at_mut)( &mut self, index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&mut (dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)>

Returns a mutable reference to the value of the field (in the current variant) at the given index.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#247)

#### fn [index\_of](trait.Enum.html#tymethod.index_of)(&self, name: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\>

Returns the index of the field (in the current variant) with the given name. [Read more](trait.Enum.html#tymethod.index_of)

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#255)

#### fn [name\_at](trait.Enum.html#tymethod.name_at)(&self, index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>

Returns the name of the field (in the current variant) with the given index. [Read more](trait.Enum.html#tymethod.name_at)

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#263)

#### fn [iter\_fields](trait.Enum.html#tymethod.iter_fields)(&self) -> [VariantFieldIter](struct.VariantFieldIter.html "struct bevy::reflect::enums::VariantFieldIter")<'\_> [ⓘ](#)

Returns an iterator over the values of the current variant’s fields.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#267)

#### fn [field\_len](trait.Enum.html#tymethod.field_len)(&self) -> [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)

Returns the number of fields in the current variant.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#275)

#### fn [variant\_name](trait.Enum.html#tymethod.variant_name)(&self) -> &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)

The name of the current variant.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#279)

#### fn [variant\_index](trait.Enum.html#tymethod.variant_index)(&self) -> [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)

The index of the current variant.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#283)

#### fn [variant\_type](trait.Enum.html#tymethod.variant_type)(&self) -> [VariantType](enum.VariantType.html "enum bevy::reflect::enums::VariantType")

The type of the current variant.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/enum_trait.rs.html#129)

#### fn [to\_dynamic\_enum](trait.Enum.html#method.to_dynamic_enum)(&self) -> [DynamicEnum](struct.DynamicEnum.html "struct bevy::reflect::enums::DynamicEnum")
...
#### fn [is\_variant](trait.Enum.html#method.is_variant)(&self, variant\_type: [VariantType](enum.VariantType.html "enum bevy::reflect::enums::VariantType")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
#### fn [variant\_path](trait.Enum.html#method.variant_path)(&self) -> [String](../../prelude/struct.String.html "struct bevy::prelude::String")

Returns the full path to the current variant.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/enum_trait.rs.html#144)

#### fn [get\_represented\_enum\_info](trait.Enum.html#method.get_represented_enum_info)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&'static [EnumInfo](struct.EnumInfo.html "struct bevy::reflect::enums::EnumInfo")\>

Will return `None` if [`TypeInfo`](../enum.TypeInfo.html "enum bevy::reflect::TypeInfo") is not available.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#292)

### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [DynamicEnum](struct.DynamicEnum.html "struct bevy::reflect::enums::DynamicEnum")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#294)
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#299)

#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[DynamicEnum](struct.DynamicEnum.html "struct bevy::reflect::enums::DynamicEnum")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>

Casts this type to a boxed, reflected value. [Read more](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#304)
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#309)
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#321)
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#326)
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#375)
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#380)
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#385)
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#390)

#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[DynamicEnum](struct.DynamicEnum.html "struct bevy::reflect::enums::DynamicEnum")\>) -> [ReflectOwned](../enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#395)
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#400)
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#405)
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#410)
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/dynamic_enum.rs.html#417)
...
### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [DynamicEnum](struct.DynamicEnum.html "struct bevy::reflect::enums::DynamicEnum")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DynamicEnum](struct.DynamicEnum.html "struct bevy::reflect::enums::DynamicEnum")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DynamicEnum](struct.DynamicEnum.html "struct bevy::reflect::enums::DynamicEnum")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DynamicEnum](struct.DynamicEnum.html "struct bevy::reflect::enums::DynamicEnum")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DynamicEnum](struct.DynamicEnum.html "struct bevy::reflect::enums::DynamicEnum")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DynamicEnum](struct.DynamicEnum.html "struct bevy::reflect::enums::DynamicEnum")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DynamicEnum](struct.DynamicEnum.html "struct bevy::reflect::enums::DynamicEnum")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DynamicEnum](struct.DynamicEnum.html "struct bevy::reflect::enums::DynamicEnum")
