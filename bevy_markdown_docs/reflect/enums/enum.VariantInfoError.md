...
# Enum VariantInfoError 

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/variants.rs.html#44)
...
Caused when a variant was expected to be of a certain [type](enum.VariantType.html "enum bevy::reflect::enums::VariantType"), but was not.

#### Fields

`expected: [VariantType](enum.VariantType.html "enum bevy::reflect::enums::VariantType")`

Expected variant type.

`received: [VariantType](enum.VariantType.html "enum bevy::reflect::enums::VariantType")`

Received variant type.

## Trait Implementations

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/enums/variants.rs.html#43)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [VariantInfoError](enum.VariantInfoError.html "enum bevy::reflect::enums::VariantInfoError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [VariantInfoError](enum.VariantInfoError.html "enum bevy::reflect::enums::VariantInfoError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [VariantInfoError](enum.VariantInfoError.html "enum bevy::reflect::enums::VariantInfoError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [VariantInfoError](enum.VariantInfoError.html "enum bevy::reflect::enums::VariantInfoError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [VariantInfoError](enum.VariantInfoError.html "enum bevy::reflect::enums::VariantInfoError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [VariantInfoError](enum.VariantInfoError.html "enum bevy::reflect::enums::VariantInfoError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [VariantInfoError](enum.VariantInfoError.html "enum bevy::reflect::enums::VariantInfoError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [VariantInfoError](enum.VariantInfoError.html "enum bevy::reflect::enums::VariantInfoError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [VariantInfoError](enum.VariantInfoError.html "enum bevy::reflect::enums::VariantInfoError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [VariantInfoError](enum.VariantInfoError.html "enum bevy::reflect::enums::VariantInfoError")
