...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/parse.rs.html#13)
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/parse.rs.html#11)

### impl<'a> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ParseError](struct.ParseError.html "struct bevy::reflect::ParseError")<'a>
...
### impl<'a> [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [ParseError](struct.ParseError.html "struct bevy::reflect::ParseError")<'a>
...
### impl<'a> [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [ParseError](struct.ParseError.html "struct bevy::reflect::ParseError")<'a>

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/parse.rs.html#11)

### impl<'a> [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [ParseError](struct.ParseError.html "struct bevy::reflect::ParseError")<'a>
...
### impl<'a> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [ParseError](struct.ParseError.html "struct bevy::reflect::ParseError")<'a>

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/parse.rs.html#11)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[ParseError](struct.ParseError.html "struct bevy::reflect::ParseError")<'a>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl<'a> [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [ParseError](struct.ParseError.html "struct bevy::reflect::ParseError")<'a>

## Auto Trait Implementations

### impl<'a> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ParseError](struct.ParseError.html "struct bevy::reflect::ParseError")<'a>

### impl<'a> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ParseError](struct.ParseError.html "struct bevy::reflect::ParseError")<'a>

### impl<'a> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ParseError](struct.ParseError.html "struct bevy::reflect::ParseError")<'a>

### impl<'a> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ParseError](struct.ParseError.html "struct bevy::reflect::ParseError")<'a>

### impl<'a> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ParseError](struct.ParseError.html "struct bevy::reflect::ParseError")<'a>

### impl<'a> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ParseError](struct.ParseError.html "struct bevy::reflect::ParseError")<'a>

### impl<'a> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ParseError](struct.ParseError.html "struct bevy::reflect::ParseError")<'a>
