...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/serde/de/deserializer.rs.html#273)

```rust
pub struct TypedReflectDeserializer<'a, P = ()>where
...
This is the deserializer counterpart to [`TypedReflectSerializer`](struct.TypedReflectSerializer.html "struct bevy::reflect::serde::TypedReflectSerializer").

See [`ReflectDeserializer`](struct.ReflectDeserializer.html "struct bevy::reflect::serde::ReflectDeserializer") for a deserializer that expects an unknown type.
...
If you want to override deserialization for a specific [`TypeRegistration`](../struct.TypeRegistration.html "struct bevy::reflect::TypeRegistration"), you can pass in a reference to a [`ReflectDeserializerProcessor`](trait.ReflectDeserializerProcessor.html "trait bevy::reflect::serde::ReflectDeserializerProcessor") which will take priority over all other deserialization methods - see [`with_processor`](struct.TypedReflectDeserializer.html#method.with_processor "associated function bevy::reflect::serde::TypedReflectDeserializer::with_processor").
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/serde/de/deserializer.rs.html#279)

### impl<'a> [TypedReflectDeserializer](struct.TypedReflectDeserializer.html "struct bevy::reflect::serde::TypedReflectDeserializer")<'a>

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/serde/de/deserializer.rs.html#286)

#### pub fn [new](#method.new)( registration: &'a [TypeRegistration](../struct.TypeRegistration.html "struct bevy::reflect::TypeRegistration"), registry: &'a [TypeRegistry](../struct.TypeRegistry.html "struct bevy::reflect::TypeRegistry"), ) -> [TypedReflectDeserializer](struct.TypedReflectDeserializer.html "struct bevy::reflect::serde::TypedReflectDeserializer")<'a>

Creates a typed deserializer with no processor.

If you want to add custom logic for deserializing certain types, use [`with_processor`](struct.TypedReflectDeserializer.html#method.with_processor "associated function bevy::reflect::serde::TypedReflectDeserializer::with_processor").

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/reflection/dynamic\_types.rs ([line 84](../../../src/dynamic_types/dynamic_types.rs.html#84))
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/serde/de/deserializer.rs.html#303)

#### pub fn [of](#method.of)<T>(registry: &'a [TypeRegistry](../struct.TypeRegistry.html "struct bevy::reflect::TypeRegistry")) -> [TypedReflectDeserializer](struct.TypedReflectDeserializer.html "struct bevy::reflect::serde::TypedReflectDeserializer")<'a>

where T: [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath"),

Creates a new [`TypedReflectDeserializer`](struct.TypedReflectDeserializer.html "struct bevy::reflect::serde::TypedReflectDeserializer") for the given type `T` without a processor.

##### Panics

Panics if `T` is not registered in the given [`TypeRegistry`](../struct.TypeRegistry.html "struct bevy::reflect::TypeRegistry").

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/serde/de/deserializer.rs.html#316)

### impl<'a, P> [TypedReflectDeserializer](struct.TypedReflectDeserializer.html "struct bevy::reflect::serde::TypedReflectDeserializer")<'a, P>
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/serde/de/deserializer.rs.html#323-327)

#### pub fn [with\_processor](#method.with_processor)( registration: &'a [TypeRegistration](../struct.TypeRegistration.html "struct bevy::reflect::TypeRegistration"), registry: &'a [TypeRegistry](../struct.TypeRegistry.html "struct bevy::reflect::TypeRegistry"), processor: [&'a mut P](https://doc.rust-lang.org/nightly/std/primitive.reference.html), ) -> [TypedReflectDeserializer](struct.TypedReflectDeserializer.html "struct bevy::reflect::serde::TypedReflectDeserializer")<'a, P>

Creates a typed deserializer with a processor.

If you do not need any custom logic for handling certain types, use [`new`](struct.TypedReflectDeserializer.html#method.new "associated function bevy::reflect::serde::TypedReflectDeserializer::new").

## Trait Implementations

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/serde/de/deserializer.rs.html#352-353)

### impl<'de, P> [DeserializeSeed](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.DeserializeSeed.html "trait serde_core::de::DeserializeSeed")<'de> for [TypedReflectDeserializer](struct.TypedReflectDeserializer.html "struct bevy::reflect::serde::TypedReflectDeserializer")<'\_, P>

where P: [ReflectDeserializerProcessor](trait.ReflectDeserializerProcessor.html "trait bevy::reflect::serde::ReflectDeserializerProcessor"),

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/serde/de/deserializer.rs.html#355)
...
### impl<'a, P = [()](https://doc.rust-lang.org/nightly/std/primitive.unit.html)\> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TypedReflectDeserializer](struct.TypedReflectDeserializer.html "struct bevy::reflect::serde::TypedReflectDeserializer")<'a, P>

### impl<'a, P = [()](https://doc.rust-lang.org/nightly/std/primitive.unit.html)\> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TypedReflectDeserializer](struct.TypedReflectDeserializer.html "struct bevy::reflect::serde::TypedReflectDeserializer")<'a, P>

### impl<'a, P> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TypedReflectDeserializer](struct.TypedReflectDeserializer.html "struct bevy::reflect::serde::TypedReflectDeserializer")<'a, P>

### impl<'a, P> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TypedReflectDeserializer](struct.TypedReflectDeserializer.html "struct bevy::reflect::serde::TypedReflectDeserializer")<'a, P>

where P: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<'a, P> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TypedReflectDeserializer](struct.TypedReflectDeserializer.html "struct bevy::reflect::serde::TypedReflectDeserializer")<'a, P>

where P: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<'a, P> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TypedReflectDeserializer](struct.TypedReflectDeserializer.html "struct bevy::reflect::serde::TypedReflectDeserializer")<'a, P>

### impl<'a, P> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TypedReflectDeserializer](struct.TypedReflectDeserializer.html "struct bevy::reflect::serde::TypedReflectDeserializer")<'a, P>
