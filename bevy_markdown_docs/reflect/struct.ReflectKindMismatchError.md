...
# Struct ReflectKindMismatchError 

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/kind.rs.html#139)
...
`received: [ReflectKind](enum.ReflectKind.html "enum bevy::reflect::ReflectKind")`

Received kind.

## Trait Implementations

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/kind.rs.html#137)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ReflectKindMismatchError](struct.ReflectKindMismatchError.html "struct bevy::reflect::ReflectKindMismatchError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [ReflectKindMismatchError](struct.ReflectKindMismatchError.html "struct bevy::reflect::ReflectKindMismatchError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [ReflectKindMismatchError](struct.ReflectKindMismatchError.html "struct bevy::reflect::ReflectKindMismatchError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ReflectKindMismatchError](struct.ReflectKindMismatchError.html "struct bevy::reflect::ReflectKindMismatchError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ReflectKindMismatchError](struct.ReflectKindMismatchError.html "struct bevy::reflect::ReflectKindMismatchError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ReflectKindMismatchError](struct.ReflectKindMismatchError.html "struct bevy::reflect::ReflectKindMismatchError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ReflectKindMismatchError](struct.ReflectKindMismatchError.html "struct bevy::reflect::ReflectKindMismatchError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ReflectKindMismatchError](struct.ReflectKindMismatchError.html "struct bevy::reflect::ReflectKindMismatchError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ReflectKindMismatchError](struct.ReflectKindMismatchError.html "struct bevy::reflect::ReflectKindMismatchError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ReflectKindMismatchError](struct.ReflectKindMismatchError.html "struct bevy::reflect::ReflectKindMismatchError")
