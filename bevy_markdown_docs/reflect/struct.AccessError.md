...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/error.rs.html#54)

```rust
pub struct AccessError<'a> { /* private fields */ }
```
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/error.rs.html#60)

### impl<'a> [AccessError](struct.AccessError.html "struct bevy::reflect::AccessError")<'a>

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/error.rs.html#62)

#### pub const fn [kind](#method.kind)(&self) -> &[AccessErrorKind](enum.AccessErrorKind.html "enum bevy::reflect::AccessErrorKind")

Returns the kind of [`AccessError`](struct.AccessError.html "struct bevy::reflect::AccessError").

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/error.rs.html#67)

#### pub const fn [access](#method.access)(&self) -> &[Access](enum.Access.html "enum bevy::reflect::Access")<'\_>

The returns the [`Access`](enum.Access.html "enum bevy::reflect::Access") that this [`AccessError`](struct.AccessError.html "struct bevy::reflect::AccessError") occurred in.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/error.rs.html#73)

#### pub const fn [offset](#method.offset)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\>

If the [`Access`](enum.Access.html "enum bevy::reflect::Access") was created with a parser or an offset was manually provided, returns the offset of the [`Access`](enum.Access.html "enum bevy::reflect::Access") in its path string.

## Trait Implementations

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/error.rs.html#53)

### impl<'a> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [AccessError](struct.AccessError.html "struct bevy::reflect::AccessError")<'a>

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/error.rs.html#53)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [AccessError](struct.AccessError.html "struct bevy::reflect::AccessError")<'a>
...
### impl<'a> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [AccessError](struct.AccessError.html "struct bevy::reflect::AccessError")<'a>
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/error.rs.html#78)

### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [AccessError](struct.AccessError.html "struct bevy::reflect::AccessError")<'\_>

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/error.rs.html#79)
...
### impl<'a> [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [AccessError](struct.AccessError.html "struct bevy::reflect::AccessError")<'a>

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/error.rs.html#131)

### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [AccessError](struct.AccessError.html "struct bevy::reflect::AccessError")<'\_>
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#43)

### impl<'a> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[AccessError](struct.AccessError.html "struct bevy::reflect::AccessError")<'a>> for [ReflectPathError](enum.ReflectPathError.html "enum bevy::reflect::ReflectPathError")<'a>

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/mod.rs.html#44)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [AccessError](struct.AccessError.html "struct bevy::reflect::AccessError")<'a>) -> [ReflectPathError](enum.ReflectPathError.html "enum bevy::reflect::ReflectPathError")<'a>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/error.rs.html#53)

### impl<'a> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [AccessError](struct.AccessError.html "struct bevy::reflect::AccessError")<'a>

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/path/error.rs.html#53)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[AccessError](struct.AccessError.html "struct bevy::reflect::AccessError")<'a>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl<'a> [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [AccessError](struct.AccessError.html "struct bevy::reflect::AccessError")<'a>

## Auto Trait Implementations

### impl<'a> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AccessError](struct.AccessError.html "struct bevy::reflect::AccessError")<'a>

### impl<'a> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AccessError](struct.AccessError.html "struct bevy::reflect::AccessError")<'a>

### impl<'a> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AccessError](struct.AccessError.html "struct bevy::reflect::AccessError")<'a>

### impl<'a> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AccessError](struct.AccessError.html "struct bevy::reflect::AccessError")<'a>

### impl<'a> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AccessError](struct.AccessError.html "struct bevy::reflect::AccessError")<'a>

### impl<'a> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AccessError](struct.AccessError.html "struct bevy::reflect::AccessError")<'a>

### impl<'a> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AccessError](struct.AccessError.html "struct bevy::reflect::AccessError")<'a>
