[bevy](../../../index.html)::[asset](../../index.html)::[uuid](../index.html)::[fmt](index.html)

# Struct Hyphenated 

[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/fmt.rs.html#82)
...
[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/fmt.rs.html#288)

### impl [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")

[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/fmt.rs.html#292)

#### pub const [LENGTH](#associatedconstant.LENGTH): [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html) = 36

The length of a hyphenated [`Uuid`](../struct.Uuid.html) string.

[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/fmt.rs.html#298)

#### pub const fn [from\_uuid](#method.from_uuid)(uuid: [Uuid](../struct.Uuid.html "struct bevy::asset::uuid::Uuid")) -> [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")

Creates a [`Hyphenated`](struct.Hyphenated.html) from a [`Uuid`](../struct.Uuid.html).

[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/fmt.rs.html#349)

#### pub fn [encode\_lower](#method.encode_lower)<'buf>(&self, buffer: &'buf mut \[[u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)\]) -> &'buf mut [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)

Writes the [`Uuid`](../struct.Uuid.html) as a lower-case hyphenated string to `buffer`, and returns the subslice of the buffer that contains the encoded UUID.
...
Panics if the buffer is not large enough: it must have length at least [`LENGTH`](#associatedconstant.LENGTH). [`Uuid::encode_buffer`](../struct.Uuid.html#method.encode_buffer) can be used to get a sufficiently-large temporary buffer.
...
[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/fmt.rs.html#400)

#### pub fn [encode\_upper](#method.encode_upper)<'buf>(&self, buffer: &'buf mut \[[u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)\]) -> &'buf mut [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)

Writes the [`Uuid`](../struct.Uuid.html) as an upper-case hyphenated string to `buffer`, and returns the subslice of the buffer that contains the encoded UUID.
...
[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/fmt.rs.html#414)

#### pub const fn [as\_uuid](#method.as_uuid)(&self) -> &[Uuid](../struct.Uuid.html "struct bevy::asset::uuid::Uuid")

Get a reference to the underlying [`Uuid`](../struct.Uuid.html "struct bevy::asset::uuid::Uuid").
...
[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/fmt.rs.html#428)

#### pub const fn [into\_uuid](#method.into_uuid)(self) -> [Uuid](../struct.Uuid.html "struct bevy::asset::uuid::Uuid")

Consumes the [`Hyphenated`](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated"), returning the underlying [`Uuid`](../struct.Uuid.html "struct bevy::asset::uuid::Uuid").
...
### impl [AsRef](https://doc.rust-lang.org/nightly/core/convert/trait.AsRef.html "trait core::convert::AsRef")<[Uuid](../struct.Uuid.html "struct bevy::asset::uuid::Uuid")\> for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")
...
### impl [Borrow](https://doc.rust-lang.org/nightly/core/borrow/trait.Borrow.html "trait core::borrow::Borrow")<[Uuid](../struct.Uuid.html "struct bevy::asset::uuid::Uuid")\> for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")
...
[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/fmt.rs.html#70)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")

[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/fmt.rs.html#70)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")

[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/fmt.rs.html#70)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")

[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/fmt.rs.html#70)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/external/serde_support.rs.html#215)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")

[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/external/serde_support.rs.html#216)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<D>( deserializer: D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated"), <D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")

[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/fmt.rs.html#997-1002)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")\> for [Uuid](../struct.Uuid.html "struct bevy::asset::uuid::Uuid")

[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/fmt.rs.html#997-1002)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(f: [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")) -> [Uuid](../struct.Uuid.html "struct bevy::asset::uuid::Uuid")

Converts to this type from the input type.

[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/fmt.rs.html#997-1002)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Uuid](../struct.Uuid.html "struct bevy::asset::uuid::Uuid")\> for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")

[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/fmt.rs.html#997-1002)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(f: [Uuid](../struct.Uuid.html "struct bevy::asset::uuid::Uuid")) -> [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")

Converts to this type from the input type.

[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/fmt.rs.html#871)

### impl [FromStr](https://doc.rust-lang.org/nightly/core/str/traits/trait.FromStr.html "trait core::str::traits::FromStr") for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")

[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/fmt.rs.html#872)
...
[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/fmt.rs.html#874)

#### fn [from\_str](https://doc.rust-lang.org/nightly/core/str/traits/trait.FromStr.html#tymethod.from_str)(s: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated"), <[Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated") as [FromStr](https://doc.rust-lang.org/nightly/core/str/traits/trait.FromStr.html "trait core::str::traits::FromStr")\>::[Err](https://doc.rust-lang.org/nightly/core/str/traits/trait.FromStr.html#associatedtype.Err "type core::str::traits::FromStr::Err")\>
...
### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")
...
### impl [LowerHex](https://doc.rust-lang.org/nightly/core/fmt/trait.LowerHex.html "trait core::fmt::LowerHex") for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")
...
### impl [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")

[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/fmt.rs.html#70)

#### fn [cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html#tymethod.cmp)(&self, other: &[Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")

[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/fmt.rs.html#70)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")

[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/fmt.rs.html#70)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")\>
...
[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/external/serde_support.rs.html#45)

### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")

[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/external/serde_support.rs.html#46)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")

[Source](https://docs.rs/uuid/1.23.2/x86_64-unknown-linux-gnu/src/uuid/fmt.rs.html#997-1002)

### impl [UpperHex](https://doc.rust-lang.org/nightly/core/fmt/trait.UpperHex.html "trait core::fmt::UpperHex") for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Hyphenated](struct.Hyphenated.html "struct bevy::asset::uuid::fmt::Hyphenated")
