...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/assets.rs.html#631)

```rust
pub struct AssetMut<'a, A>where
    A: Asset,{ /* private fields */ }
```

Unique mutable borrow of an asset.

[`AssetEvent::Modified`](../prelude/enum.AssetEvent.html#variant.Modified "variant bevy::prelude::AssetEvent::Modified") events will be only triggered if an asset itself is mutably borrowed.

Just as an example, this allows checking if a material property has changed before modifying it to avoid unnecessary material extraction down the pipeline.

## Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/assets.rs.html#636)

### impl<'a, A> [AssetMut](struct.AssetMut.html "struct bevy::asset::AssetMut")<'a, A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/assets.rs.html#638)

#### pub fn [into\_inner](#method.into_inner)(self) -> [&'a mut A](https://doc.rust-lang.org/nightly/std/primitive.reference.html)

Marks with inner asset as modified and returns reference to it.

##### [Examples found in repository](#scraped-examples)[?](../../scrape-examples-help.html)

examples/animation/animated\_mesh\_events.rs ([line 158](../../src/animated_mesh_events/animated_mesh_events.rs.html#158))
...
examples/3d/generate\_custom\_mesh.rs ([line 81](../../src/generate_custom_mesh/generate_custom_mesh.rs.html#81))
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/assets.rs.html#644)

#### pub fn [into\_inner\_untracked](#method.into_inner_untracked)(self) -> [&'a mut A](https://doc.rust-lang.org/nightly/std/primitive.reference.html)

Returns reference to the inner asset but doesn’t mark it as modified.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/assets.rs.html#655)

#### pub fn [bypass\_change\_detection](#method.bypass_change_detection)(&mut self) -> [&mut A](https://doc.rust-lang.org/nightly/std/primitive.reference.html)

Manually bypasses change detection, allowing you to mutate the underlying value without emitting [`AssetEvent::Modified`](../prelude/enum.AssetEvent.html#variant.Modified "variant bevy::prelude::AssetEvent::Modified") event.
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/assets.rs.html#660)

### impl<'a, A> [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [AssetMut](struct.AssetMut.html "struct bevy::asset::AssetMut")<'a, A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/assets.rs.html#661)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = A

The resulting type after dereferencing.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/assets.rs.html#663)

#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[AssetMut](struct.AssetMut.html "struct bevy::asset::AssetMut")<'a, A> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/assets.rs.html#668)

### impl<'a, A> [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [AssetMut](struct.AssetMut.html "struct bevy::asset::AssetMut")<'a, A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/assets.rs.html#669)

#### fn [deref\_mut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html#tymethod.deref_mut)(&mut self) -> &mut <[AssetMut](struct.AssetMut.html "struct bevy::asset::AssetMut")<'a, A> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Mutably dereferences the value.

## Auto Trait Implementations

### impl<'a, A> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AssetMut](struct.AssetMut.html "struct bevy::asset::AssetMut")<'a, A>

### impl<'a, A> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AssetMut](struct.AssetMut.html "struct bevy::asset::AssetMut")<'a, A>

### impl<'a, A> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AssetMut](struct.AssetMut.html "struct bevy::asset::AssetMut")<'a, A>
...
### impl<'a, A> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AssetMut](struct.AssetMut.html "struct bevy::asset::AssetMut")<'a, A>

### impl<'a, A> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AssetMut](struct.AssetMut.html "struct bevy::asset::AssetMut")<'a, A>

### impl<'a, A> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AssetMut](struct.AssetMut.html "struct bevy::asset::AssetMut")<'a, A>

### impl<'a, A> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AssetMut](struct.AssetMut.html "struct bevy::asset::AssetMut")<'a, A>
