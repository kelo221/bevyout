...
# Struct AssetsMutIterator 

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/assets.rs.html#693)
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/assets.rs.html#699)

### impl<'a, A> [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator") for [AssetsMutIterator](struct.AssetsMutIterator.html "struct bevy::asset::AssetsMutIterator")<'a, A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/assets.rs.html#700)

#### type [Item](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#associatedtype.Item) = ([AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>, [&'a mut A](https://doc.rust-lang.org/nightly/std/primitive.reference.html))

The type of the elements being iterated over.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/assets.rs.html#702)

#### fn [next](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#tymethod.next)(&mut self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[AssetsMutIterator](struct.AssetsMutIterator.html "struct bevy::asset::AssetsMutIterator")<'a, A> as [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")\>::[Item](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#associatedtype.Item "type core::iter::traits::iterator::Iterator::Item")\>
...
### impl<'a, A> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AssetsMutIterator](struct.AssetsMutIterator.html "struct bevy::asset::AssetsMutIterator")<'a, A>

### impl<'a, A> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AssetsMutIterator](struct.AssetsMutIterator.html "struct bevy::asset::AssetsMutIterator")<'a, A>

### impl<'a, A> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AssetsMutIterator](struct.AssetsMutIterator.html "struct bevy::asset::AssetsMutIterator")<'a, A>
...
### impl<'a, A> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AssetsMutIterator](struct.AssetsMutIterator.html "struct bevy::asset::AssetsMutIterator")<'a, A>

### impl<'a, A> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AssetsMutIterator](struct.AssetsMutIterator.html "struct bevy::asset::AssetsMutIterator")<'a, A>

### impl<'a, A> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AssetsMutIterator](struct.AssetsMutIterator.html "struct bevy::asset::AssetsMutIterator")<'a, A>

### impl<'a, A> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AssetsMutIterator](struct.AssetsMutIterator.html "struct bevy::asset::AssetsMutIterator")<'a, A>
