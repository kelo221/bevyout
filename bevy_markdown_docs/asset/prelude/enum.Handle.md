...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#134)
...
If a [`Handle`](../../prelude/enum.Handle.html "enum bevy::prelude::Handle") is [`Handle::Strong`](../../prelude/enum.Handle.html#variant.Strong "variant bevy::prelude::Handle::Strong"), the [`Asset`](../../prelude/trait.Asset.html "trait bevy::prelude::Asset") will be kept alive until the [`Handle`](../../prelude/enum.Handle.html "enum bevy::prelude::Handle") is dropped. If a [`Handle`](../../prelude/enum.Handle.html "enum bevy::prelude::Handle") is [`Handle::Uuid`](../../prelude/enum.Handle.html#variant.Uuid "variant bevy::prelude::Handle::Uuid"), it does not necessarily reference a live [`Asset`](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"), nor will it keep assets alive.

Modifying a _handle_ will change which existing asset is referenced, but modifying the _asset_ (by mutating the [`Assets`](../../prelude/struct.Assets.html "struct bevy::prelude::Assets") resource) will change the asset for all handles referencing it.

[`Handle`](../../prelude/enum.Handle.html "enum bevy::prelude::Handle") can be cloned. If a [`Handle::Strong`](../../prelude/enum.Handle.html#variant.Strong "variant bevy::prelude::Handle::Strong") is cloned, the referenced [`Asset`](../../prelude/trait.Asset.html "trait bevy::prelude::Asset") will not be freed until _all_ instances of the [`Handle`](../../prelude/enum.Handle.html "enum bevy::prelude::Handle") are dropped.

[`Handle::Strong`](../../prelude/enum.Handle.html#variant.Strong "variant bevy::prelude::Handle::Strong"), via [`StrongHandle`](../struct.StrongHandle.html "struct bevy::asset::StrongHandle") also provides access to useful [`Asset`](../../prelude/trait.Asset.html "trait bevy::prelude::Asset") metadata, such as the [`AssetPath`](../struct.AssetPath.html "struct bevy::asset::AssetPath") (if it exists).

## Variants

### Strong([Arc](../../platform/sync/struct.Arc.html "struct bevy::platform::sync::Arc")<[StrongHandle](../struct.StrongHandle.html "struct bevy::asset::StrongHandle")\>)

A “strong” reference to a live (or loading) [`Asset`](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"). If a [`Handle`](../../prelude/enum.Handle.html "enum bevy::prelude::Handle") is [`Handle::Strong`](../../prelude/enum.Handle.html#variant.Strong "variant bevy::prelude::Handle::Strong"), the [`Asset`](../../prelude/trait.Asset.html "trait bevy::prelude::Asset") will be kept alive until the [`Handle`](../../prelude/enum.Handle.html "enum bevy::prelude::Handle") is dropped. Strong handles also provide access to additional asset metadata.

### Uuid([Uuid](../uuid/struct.Uuid.html "struct bevy::asset::uuid::Uuid"), [PhantomData](https://doc.rust-lang.org/nightly/core/marker/struct.PhantomData.html "struct core::marker::PhantomData")<[fn](https://doc.rust-lang.org/nightly/std/primitive.fn.html)() -> A>)

A reference to an [`Asset`](../../prelude/trait.Asset.html "trait bevy::prelude::Asset") using a stable-across-runs / const identifier. Dropping this handle will not result in the asset being dropped.

## Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#189)

### impl<A> [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>

where A: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#192)

#### pub fn [id](#method.id)(&self) -> [AssetId](../../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

Returns the [`AssetId`](../../prelude/enum.AssetId.html "enum bevy::prelude::AssetId") of this [`Asset`](../../prelude/trait.Asset.html "trait bevy::prelude::Asset").

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/shader\_advanced/manual\_material.rs ([line 123](../../../src/manual_material/manual_material.rs.html#123))
...
examples/2d/dynamic\_mip\_generation.rs ([line 463](../../../src/dynamic_mip_generation/dynamic_mip_generation.rs.html#463))
...
examples/shader\_advanced/compute\_mesh.rs ([line 193](../../../src/compute_mesh/compute_mesh.rs.html#193))
...
examples/3d/tonemapping.rs ([line 248](../../../src/tonemapping/tonemapping.rs.html#248))
...
examples/2d/mesh2d\_manual.rs ([line 366](../../../src/mesh2d_manual/mesh2d_manual.rs.html#366))
...
*   [examples/shader\_advanced/render\_depth\_to\_texture.rs](../../../src/render_depth_to_texture/render_depth_to_texture.rs.html#147)
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#204)

#### pub fn [path](#method.path)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[AssetPath](../struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>>

Returns the path if this is (1) a strong handle and (2) the asset has a path

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#213)

#### pub fn [is\_uuid](#method.is_uuid)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if this is a uuid handle.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#219)

#### pub fn [is\_strong](#method.is_strong)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if this is a strong handle.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#227)

#### pub fn [untyped](#method.untyped)(self) -> [UntypedHandle](../../prelude/enum.UntypedHandle.html "enum bevy::prelude::UntypedHandle")

Converts this [`Handle`](../../prelude/enum.Handle.html "enum bevy::prelude::Handle") to an “untyped” / “generic-less” [`UntypedHandle`](../../prelude/enum.UntypedHandle.html "enum bevy::prelude::UntypedHandle"), which stores the [`Asset`](../../prelude/trait.Asset.html "trait bevy::prelude::Asset") type information _inside_ [`UntypedHandle`](../../prelude/enum.UntypedHandle.html "enum bevy::prelude::UntypedHandle"). This will return [`UntypedHandle::Strong`](../../prelude/enum.UntypedHandle.html#variant.Strong "variant bevy::prelude::UntypedHandle::Strong") for [`Handle::Strong`](../../prelude/enum.Handle.html#variant.Strong "variant bevy::prelude::Handle::Strong") and [`UntypedHandle::Uuid`](../../prelude/enum.UntypedHandle.html#variant.Uuid "variant bevy::prelude::UntypedHandle::Uuid") for [`Handle::Uuid`](../../prelude/enum.Handle.html#variant.Uuid "variant bevy::prelude::Handle::Uuid").

## Trait Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#180)

### impl<T> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<T>

where T: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#181)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<T>
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#383)

### impl<A> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>

where A: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#384)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")\>

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#232)

### impl<A> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>

where A: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#233)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>
...
### impl<A> [Enum](../../reflect/enums/trait.Enum.html "trait bevy::reflect::enums::Enum") for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#432)

### impl<A> [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>

where A: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#407)

### impl<T> [Equivalent](../../platform/collections/trait.Equivalent.html "trait bevy::platform::collections::Equivalent")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<T>> for [AssetId](../../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<T>

where T: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#408)

#### fn [equivalent](../../platform/collections/trait.Equivalent.html#tymethod.equivalent)(&self, key: &[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<T>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Compare self to `key` and return `true` if they are equal.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#434)

### impl<A> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>> for [AssetId](../../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

where A: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#436)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: &[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>) -> [AssetId](../../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#441)

### impl<A> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>> for [UntypedAssetId](../enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

where A: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#443)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: &[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>) -> [UntypedAssetId](../enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#354)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Font](../../prelude/struct.Font.html "struct bevy::prelude::Font")\>> for [FontSource](../../prelude/enum.FontSource.html "enum bevy::prelude::FontSource")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#355)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(handle: &[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Font](../../prelude/struct.Font.html "struct bevy::prelude::Font")\>) -> [FontSource](../../prelude/enum.FontSource.html "enum bevy::prelude::FontSource")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#448)

### impl<A> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&mut [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>> for [AssetId](../../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

where A: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#450)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: &mut [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>) -> [AssetId](../../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#455)

### impl<A> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&mut [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>> for [UntypedAssetId](../enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

where A: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#457)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: &mut [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>) -> [UntypedAssetId](../enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#666)

### impl<A> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>> for [UntypedHandle](../../prelude/enum.UntypedHandle.html "enum bevy::prelude::UntypedHandle")

where A: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#667)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>) -> [UntypedHandle](../../prelude/enum.UntypedHandle.html "enum bevy::prelude::UntypedHandle")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/graph.rs.html#135)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[AnimationGraph](../../prelude/struct.AnimationGraph.html "struct bevy::prelude::AnimationGraph")\>> for [AnimationGraphHandle](../../prelude/struct.AnimationGraphHandle.html "struct bevy::prelude::AnimationGraphHandle")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/graph.rs.html#135)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[AnimationGraph](../../prelude/struct.AnimationGraph.html "struct bevy::prelude::AnimationGraph")\>) -> [AnimationGraphHandle](../../prelude/struct.AnimationGraphHandle.html "struct bevy::prelude::AnimationGraphHandle")
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[DynamicWorld](../../prelude/struct.DynamicWorld.html "struct bevy::prelude::DynamicWorld")\>> for [DynamicWorldRoot](../../prelude/struct.DynamicWorldRoot.html "struct bevy::prelude::DynamicWorldRoot")

[Source](https://docs.rs/bevy_world_serialization/0.19.0/x86_64-unknown-linux-gnu/src/bevy_world_serialization/components.rs.html#36)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[DynamicWorld](../../prelude/struct.DynamicWorld.html "struct bevy::prelude::DynamicWorld")\>) -> [DynamicWorldRoot](../../prelude/struct.DynamicWorldRoot.html "struct bevy::prelude::DynamicWorldRoot")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#348)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Font](../../prelude/struct.Font.html "struct bevy::prelude::Font")\>> for [FontSource](../../prelude/enum.FontSource.html "enum bevy::prelude::FontSource")

[Source](https://docs.rs/bevy_text/0.19.0/x86_64-unknown-linux-gnu/src/bevy_text/text.rs.html#349)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(handle: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Font](../../prelude/struct.Font.html "struct bevy::prelude::Font")\>) -> [FontSource](../../prelude/enum.FontSource.html "enum bevy::prelude::FontSource")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#1022)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Image](../../prelude/struct.Image.html "struct bevy::prelude::Image")\>> for [RenderTarget](../../camera/enum.RenderTarget.html "enum bevy::camera::RenderTarget")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#1023)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(handle: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Image](../../prelude/struct.Image.html "struct bevy::prelude::Image")\>) -> [RenderTarget](../../camera/enum.RenderTarget.html "enum bevy::camera::RenderTarget")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#1028)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Image](../../prelude/struct.Image.html "struct bevy::prelude::Image")\>> for [ImageRenderTarget](../../camera/struct.ImageRenderTarget.html "struct bevy::camera::ImageRenderTarget")

[Source](https://docs.rs/bevy_camera/0.19.0/x86_64-unknown-linux-gnu/src/bevy_camera/camera.rs.html#1029)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(handle: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Image](../../prelude/struct.Image.html "struct bevy::prelude::Image")\>) -> [ImageRenderTarget](../../camera/struct.ImageRenderTarget.html "struct bevy::camera::ImageRenderTarget")
...
[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/widget/image.rs.html#141)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Image](../../prelude/struct.Image.html "struct bevy::prelude::Image")\>> for [ImageNode](../../prelude/struct.ImageNode.html "struct bevy::prelude::ImageNode")

[Source](https://docs.rs/bevy_ui/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui/widget/image.rs.html#142)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(texture: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Image](../../prelude/struct.Image.html "struct bevy::prelude::Image")\>) -> [ImageNode](../../prelude/struct.ImageNode.html "struct bevy::prelude::ImageNode")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_sprite/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite/sprite.rs.html#151)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Image](../../prelude/struct.Image.html "struct bevy::prelude::Image")\>> for [Sprite](../../prelude/struct.Sprite.html "struct bevy::prelude::Sprite")

[Source](https://docs.rs/bevy_sprite/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite/sprite.rs.html#152)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(image: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Image](../../prelude/struct.Image.html "struct bevy::prelude::Image")\>) -> [Sprite](../../prelude/struct.Sprite.html "struct bevy::prelude::Sprite")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/color_material.rs.html#81)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Image](../../prelude/struct.Image.html "struct bevy::prelude::Image")\>> for [ColorMaterial](../../prelude/struct.ColorMaterial.html "struct bevy::prelude::ColorMaterial")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/color_material.rs.html#82)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(texture: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Image](../../prelude/struct.Image.html "struct bevy::prelude::Image")\>) -> [ColorMaterial](../../prelude/struct.ColorMaterial.html "struct bevy::prelude::ColorMaterial")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/mesh_material.rs.html#39)

### impl<M> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<M>> for [MeshMaterial3d](../../prelude/struct.MeshMaterial3d.html "struct bevy::prelude::MeshMaterial3d")<M>

where M: [Material](../../prelude/trait.Material.html "trait bevy::prelude::Material"),

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/mesh_material.rs.html#39)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<M>) -> [MeshMaterial3d](../../prelude/struct.MeshMaterial3d.html "struct bevy::prelude::MeshMaterial3d")<M>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/ui_material.rs.html#176)

### impl<M> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<M>> for [MaterialNode](../../prelude/struct.MaterialNode.html "struct bevy::prelude::MaterialNode")<M>

where M: [UiMaterial](../../prelude/trait.UiMaterial.html "trait bevy::prelude::UiMaterial"),

[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/ui_material.rs.html#176)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<M>) -> [MaterialNode](../../prelude/struct.MaterialNode.html "struct bevy::prelude::MaterialNode")<M>
...
### impl<M> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<M>> for [MeshMaterial2d](../../prelude/struct.MeshMaterial2d.html "struct bevy::prelude::MeshMaterial2d")<M>

where M: [Material2d](../../sprite_render/trait.Material2d.html "trait bevy::sprite_render::Material2d"),

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/material.rs.html#202)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<M>) -> [MeshMaterial2d](../../prelude/struct.MeshMaterial2d.html "struct bevy::prelude::MeshMaterial2d")<M>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/components.rs.html#41)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Mesh](../../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")\>> for [Mesh2d](../../prelude/struct.Mesh2d.html "struct bevy::prelude::Mesh2d")

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/components.rs.html#41)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Mesh](../../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")\>) -> [Mesh2d](../../prelude/struct.Mesh2d.html "struct bevy::prelude::Mesh2d")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/components.rs.html#98)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Mesh](../../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")\>> for [Mesh3d](../../prelude/struct.Mesh3d.html "struct bevy::prelude::Mesh3d")

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/components.rs.html#98)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Mesh](../../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")\>) -> [Mesh3d](../../prelude/struct.Mesh3d.html "struct bevy::prelude::Mesh3d")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_solari/0.19.0/x86_64-unknown-linux-gnu/src/bevy_solari/scene/types.rs.html#19)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Mesh](../../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")\>> for [RaytracingMesh3d](../../solari/scene/struct.RaytracingMesh3d.html "struct bevy::solari::scene::RaytracingMesh3d")

[Source](https://docs.rs/bevy_solari/0.19.0/x86_64-unknown-linux-gnu/src/bevy_solari/scene/types.rs.html#19)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Mesh](../../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")\>) -> [RaytracingMesh3d](../../solari/scene/struct.RaytracingMesh3d.html "struct bevy::solari::scene::RaytracingMesh3d")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/meshlet/mod.rs.html#230)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[MeshletMesh](../../pbr/experimental/meshlet/struct.MeshletMesh.html "struct bevy::pbr::experimental::meshlet::MeshletMesh")\>> for [MeshletMesh3d](../../pbr/experimental/meshlet/struct.MeshletMesh3d.html "struct bevy::pbr::experimental::meshlet::MeshletMesh3d")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/meshlet/mod.rs.html#230)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[MeshletMesh](../../pbr/experimental/meshlet/struct.MeshletMesh.html "struct bevy::pbr::experimental::meshlet::MeshletMesh")\>) -> [MeshletMesh3d](../../pbr/experimental/meshlet/struct.MeshletMesh3d.html "struct bevy::pbr::experimental::meshlet::MeshletMesh3d")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_shader/0.19.0/x86_64-unknown-linux-gnu/src/bevy_shader/shader.rs.html#416)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Shader](../../prelude/struct.Shader.html "struct bevy::prelude::Shader")\>> for [ShaderRef](../../shader/enum.ShaderRef.html "enum bevy::shader::ShaderRef")

[Source](https://docs.rs/bevy_shader/0.19.0/x86_64-unknown-linux-gnu/src/bevy_shader/shader.rs.html#417)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(handle: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Shader](../../prelude/struct.Shader.html "struct bevy::prelude::Shader")\>) -> [ShaderRef](../../shader/enum.ShaderRef.html "enum bevy::shader::ShaderRef")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#335)

### impl<T> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<T>> for [HandleTemplate](../enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>

where T: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#336)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<T>) -> [HandleTemplate](../enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/texture_atlas.rs.html#241)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[TextureAtlasLayout](../../prelude/struct.TextureAtlasLayout.html "struct bevy::prelude::TextureAtlasLayout")\>> for [TextureAtlas](../../prelude/struct.TextureAtlas.html "struct bevy::prelude::TextureAtlas")

[Source](https://docs.rs/bevy_image/0.19.0/x86_64-unknown-linux-gnu/src/bevy_image/texture_atlas.rs.html#242)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(texture\_atlas: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[TextureAtlasLayout](../../prelude/struct.TextureAtlasLayout.html "struct bevy::prelude::TextureAtlasLayout")\>) -> [TextureAtlas](../../prelude/struct.TextureAtlas.html "struct bevy::prelude::TextureAtlas")
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[WorldAsset](../../prelude/struct.WorldAsset.html "struct bevy::prelude::WorldAsset")\>> for [WorldAssetRoot](../../prelude/struct.WorldAssetRoot.html "struct bevy::prelude::WorldAssetRoot")

[Source](https://docs.rs/bevy_world_serialization/0.19.0/x86_64-unknown-linux-gnu/src/bevy_world_serialization/components.rs.html#18)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[WorldAsset](../../prelude/struct.WorldAsset.html "struct bevy::prelude::WorldAsset")\>) -> [WorldAssetRoot](../../prelude/struct.WorldAssetRoot.html "struct bevy::prelude::WorldAssetRoot")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#462)

### impl<A> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Uuid](../uuid/struct.Uuid.html "struct bevy::asset::uuid::Uuid")\> for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>

where A: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#464)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(uuid: [Uuid](../uuid/struct.Uuid.html "struct bevy::asset::uuid::Uuid")) -> [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#132)

### impl<A> [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>

where A: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset") + [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath"), [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>: [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#132)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#132)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A> as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#152)

#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect\_value: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>>
...
#### type [Template](../../prelude/trait.FromTemplate.html#associatedtype.Template) = [HandleTemplate](../enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>
...
### impl<A> [FromType](../../reflect/trait.FromType.html "trait bevy::reflect::FromType")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>> for [ReflectHandle](../struct.ReflectHandle.html "struct bevy::asset::ReflectHandle")

where A: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/reflect.rs.html#257)

#### fn [from\_type](../../reflect/trait.FromType.html#tymethod.from_type)() -> [ReflectHandle](../struct.ReflectHandle.html "struct bevy::asset::ReflectHandle")
...
#### fn [insert\_dependencies](../../reflect/trait.FromType.html#method.insert_dependencies)(\_type\_registration: &mut [TypeRegistration](../../reflect/struct.TypeRegistration.html "struct bevy::reflect::TypeRegistration"))

Inserts [`TypeData`](../../reflect/trait.TypeData.html "trait bevy::reflect::TypeData") dependencies of this [`TypeData`](../../reflect/trait.TypeData.html "trait bevy::reflect::TypeData"). This is especially useful for trait [`TypeData`](../../reflect/trait.TypeData.html "trait bevy::reflect::TypeData") that has a supertrait (ex: `A: B`). When the [`TypeData`](../../reflect/trait.TypeData.html "trait bevy::reflect::TypeData") for `A` is inserted, the `B` [`TypeData`](../../reflect/trait.TypeData.html "trait bevy::reflect::TypeData") will also be inserted.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#132)

### impl<A> [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>
...
### impl<A> [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#399)

### impl<A> [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>

where A: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#401)
...
### impl<A> [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>
...
where [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>: 'into\_return,
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#419)

### impl<A> [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>

where A: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#420)

#### fn [cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html#tymethod.cmp)(&self, other: &[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#425)

### impl<A> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>

where A: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#427)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#641)

### impl<A> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>> for [UntypedHandle](../../prelude/enum.UntypedHandle.html "enum bevy::prelude::UntypedHandle")

where A: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#643)
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#634)

### impl<A> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq")<[UntypedHandle](../../prelude/enum.UntypedHandle.html "enum bevy::prelude::UntypedHandle")\> for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>

where A: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#636)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[UntypedHandle](../../prelude/enum.UntypedHandle.html "enum bevy::prelude::UntypedHandle")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#413)

### impl<A> [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>

where A: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#414)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")\>
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#659)

### impl<A> [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>> for [UntypedHandle](../../prelude/enum.UntypedHandle.html "enum bevy::prelude::UntypedHandle")

where A: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#661)
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#648)

### impl<A> [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd")<[UntypedHandle](../../prelude/enum.UntypedHandle.html "enum bevy::prelude::UntypedHandle")\> for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>

where A: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#650)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[UntypedHandle](../../prelude/enum.UntypedHandle.html "enum bevy::prelude::UntypedHandle")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")\>
...
### impl<A> [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#132)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#133)
...
#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#678)

### impl<A> [TryFrom](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html "trait core::convert::TryFrom")<[UntypedHandle](../../prelude/enum.UntypedHandle.html "enum bevy::prelude::UntypedHandle")\> for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>

where A: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#679)

#### type [Error](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html#associatedtype.Error) = [UntypedAssetConversionError](../enum.UntypedAssetConversionError.html "enum bevy::asset::UntypedAssetConversionError")

The type returned in the event of a conversion error.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#681)

#### fn [try\_from](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html#tymethod.try_from)( value: [UntypedHandle](../../prelude/enum.UntypedHandle.html "enum bevy::prelude::UntypedHandle"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>, <[Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A> as [TryFrom](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html "trait core::convert::TryFrom")<[UntypedHandle](../../prelude/enum.UntypedHandle.html "enum bevy::prelude::UntypedHandle")\>>::[Error](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html#associatedtype.Error "type core::convert::TryFrom::Error")\>
...
### impl<A> [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#242)

### impl<T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<T>

where T: [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"), \[[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html)\]: for<'a> [SpecializeFromTemplate](../../ecs/template/trait.SpecializeFromTemplate.html "trait bevy::ecs::template::SpecializeFromTemplate"),
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/lib.rs.html#472)

#### fn [visit\_dependencies](../trait.VisitAssetDependencies.html#tymethod.visit_dependencies)(&self, visit: &mut impl [FnMut](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html "trait core::ops::function::FnMut")([UntypedAssetId](../enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")))

## Auto Trait Implementations

### impl<A> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>

### impl<A> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>

### impl<A> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>

### impl<A> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>

### impl<A> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>

### impl<A> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<A>
