...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/embedded/mod.rs.html#32)

```rust
pub struct EmbeddedAssetRegistry { /* private fields */ }
```
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/embedded/mod.rs.html#38)

### impl [EmbeddedAssetRegistry](struct.EmbeddedAssetRegistry.html "struct bevy::asset::io::embedded::EmbeddedAssetRegistry")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/embedded/mod.rs.html#43)

#### pub fn [insert\_asset](#method.insert_asset)( &self, full\_path: [PathBuf](https://doc.rust-lang.org/nightly/std/path/struct.PathBuf.html "struct std::path::PathBuf"), asset\_path: &[Path](https://doc.rust-lang.org/nightly/std/path/struct.Path.html "struct std::path::Path"), value: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Value](../memory/enum.Value.html "enum bevy::asset::io::memory::Value")\>, )

Inserts a new asset. `full_path` is the full path (as [`file`](https://doc.rust-lang.org/nightly/core/macro.file.html "macro core::file") would return for that file, if it was capable of running in a non-rust file). `asset_path` is the path that will be used to identify the asset in the `embedded` [`AssetSource`](../struct.AssetSource.html "struct bevy::asset::io::AssetSource"). `value` is the bytes that will be returned for the asset. This can be _either_ a `&'static [u8]` or a [`Vec<u8>`](../../../prelude/struct.Vec.html "struct bevy::prelude::Vec").

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/embedded/mod.rs.html#76)

#### pub fn [insert\_meta](#method.insert_meta)( &self, full\_path: &[Path](https://doc.rust-lang.org/nightly/std/path/struct.Path.html "struct std::path::Path"), asset\_path: &[Path](https://doc.rust-lang.org/nightly/std/path/struct.Path.html "struct std::path::Path"), value: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Value](../memory/enum.Value.html "enum bevy::asset::io::memory::Value")\>, )

Inserts new asset metadata. `full_path` is the full path (as [`file`](https://doc.rust-lang.org/nightly/core/macro.file.html "macro core::file") would return for that file, if it was capable of running in a non-rust file). `asset_path` is the path that will be used to identify the asset in the `embedded` [`AssetSource`](../struct.AssetSource.html "struct bevy::asset::io::AssetSource"). `value` is the bytes that will be returned for the asset. This can be _either_ a `&'static [u8]` or a [`Vec<u8>`](../../../prelude/struct.Vec.html "struct bevy::prelude::Vec").

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/embedded/mod.rs.html#88)

#### pub fn [remove\_asset](#method.remove_asset)(&self, full\_path: &[Path](https://doc.rust-lang.org/nightly/std/path/struct.Path.html "struct std::path::Path")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Data](../memory/struct.Data.html "struct bevy::asset::io::memory::Data")\>

Removes an asset stored using `full_path` (the full path as [`file`](https://doc.rust-lang.org/nightly/core/macro.file.html "macro core::file") would return for that file, if it was capable of running in a non-rust file). If no asset is stored with at `full_path` its a no-op. It returning `Option` contains the originally stored `Data` or `None`.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/embedded/mod.rs.html#93)

#### pub fn [register\_source](#method.register_source)(&self, sources: &mut [AssetSourceBuilders](../struct.AssetSourceBuilders.html "struct bevy::asset::io::AssetSourceBuilders"))

Registers the [`EMBEDDED`](constant.EMBEDDED.html "constant bevy::asset::io::embedded::EMBEDDED") [`AssetSource`](../struct.AssetSource.html "struct bevy::asset::io::AssetSource") with the given [`AssetSourceBuilders`](../struct.AssetSourceBuilders.html "struct bevy::asset::io::AssetSourceBuilders").

## Trait Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/embedded/mod.rs.html#31)

### impl [Component](../../../prelude/trait.Component.html "trait bevy::prelude::Component") for [EmbeddedAssetRegistry](struct.EmbeddedAssetRegistry.html "struct bevy::asset::io::embedded::EmbeddedAssetRegistry")

where [EmbeddedAssetRegistry](struct.EmbeddedAssetRegistry.html "struct bevy::asset::io::embedded::EmbeddedAssetRegistry"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [EmbeddedAssetRegistry](struct.EmbeddedAssetRegistry.html "struct bevy::asset::io::embedded::EmbeddedAssetRegistry")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/embedded/mod.rs.html#31)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [EmbeddedAssetRegistry](struct.EmbeddedAssetRegistry.html "struct bevy::asset::io::embedded::EmbeddedAssetRegistry")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/embedded/mod.rs.html#31)

### impl [Resource](../../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [EmbeddedAssetRegistry](struct.EmbeddedAssetRegistry.html "struct bevy::asset::io::embedded::EmbeddedAssetRegistry")

where [EmbeddedAssetRegistry](struct.EmbeddedAssetRegistry.html "struct bevy::asset::io::embedded::EmbeddedAssetRegistry"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [EmbeddedAssetRegistry](struct.EmbeddedAssetRegistry.html "struct bevy::asset::io::embedded::EmbeddedAssetRegistry")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [EmbeddedAssetRegistry](struct.EmbeddedAssetRegistry.html "struct bevy::asset::io::embedded::EmbeddedAssetRegistry")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [EmbeddedAssetRegistry](struct.EmbeddedAssetRegistry.html "struct bevy::asset::io::embedded::EmbeddedAssetRegistry")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [EmbeddedAssetRegistry](struct.EmbeddedAssetRegistry.html "struct bevy::asset::io::embedded::EmbeddedAssetRegistry")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [EmbeddedAssetRegistry](struct.EmbeddedAssetRegistry.html "struct bevy::asset::io::embedded::EmbeddedAssetRegistry")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [EmbeddedAssetRegistry](struct.EmbeddedAssetRegistry.html "struct bevy::asset::io::embedded::EmbeddedAssetRegistry")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [EmbeddedAssetRegistry](struct.EmbeddedAssetRegistry.html "struct bevy::asset::io::embedded::EmbeddedAssetRegistry")
