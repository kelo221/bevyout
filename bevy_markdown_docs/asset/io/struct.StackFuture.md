...
[Source](https://docs.rs/stackfuture/0.3.1/x86_64-unknown-linux-gnu/src/stackfuture/lib.rs.html#79)
...
[Source](https://docs.rs/stackfuture/0.3.1/x86_64-unknown-linux-gnu/src/stackfuture/lib.rs.html#97)

### impl<'a, T, const STACK\_SIZE: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> [StackFuture](struct.StackFuture.html "struct bevy::asset::io::StackFuture")<'a, T, STACK\_SIZE>

[Source](https://docs.rs/stackfuture/0.3.1/x86_64-unknown-linux-gnu/src/stackfuture/lib.rs.html#136-138)

#### pub fn [from](#method.from)<F>(future: F) -> [StackFuture](struct.StackFuture.html "struct bevy::asset::io::StackFuture")<'a, T, STACK\_SIZE> [ⓘ](#)

where F: [Future](../../tasks/futures_lite/trait.Future.html "trait bevy::tasks::futures_lite::Future")<Output = T> + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + 'a,

Creates a `StackFuture` from an existing future

See the documentation on [`StackFuture`](struct.StackFuture.html "struct bevy::asset::io::StackFuture") for examples of how to use this.

The size and alignment requirements are statically checked, so it is a compiler error to use this with a future that does not fit within the [`StackFuture`](struct.StackFuture.html "struct bevy::asset::io::StackFuture")’s size and alignment requirements.
...
[Source](https://docs.rs/stackfuture/0.3.1/x86_64-unknown-linux-gnu/src/stackfuture/lib.rs.html#164-166)

#### pub fn [try\_from](#method.try_from)<F>( future: F, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[StackFuture](struct.StackFuture.html "struct bevy::asset::io::StackFuture")<'a, T, STACK\_SIZE>, [IntoStackFutureError](https://docs.rs/stackfuture/0.3.1/x86_64-unknown-linux-gnu/stackfuture/struct.IntoStackFutureError.html "struct stackfuture::IntoStackFutureError")<F>>
...
[Source](https://docs.rs/stackfuture/0.3.1/x86_64-unknown-linux-gnu/src/stackfuture/lib.rs.html#258)

#### pub const fn [has\_space\_for](#method.has_space_for)<F>() -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Determines whether this `StackFuture` can hold a value of type `F`

[Source](https://docs.rs/stackfuture/0.3.1/x86_64-unknown-linux-gnu/src/stackfuture/lib.rs.html#263)

#### pub const fn [has\_space\_for\_val](#method.has_space_for_val)<F>(\_: [&F](https://doc.rust-lang.org/nightly/std/primitive.reference.html)) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Determines whether this `StackFuture` can hold the referenced value

[Source](https://docs.rs/stackfuture/0.3.1/x86_64-unknown-linux-gnu/src/stackfuture/lib.rs.html#269)

#### pub const fn [has\_alignment\_for](#method.has_alignment_for)<F>() -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Determines whether this `StackFuture`’s alignment is compatible with the type `F`.

[Source](https://docs.rs/stackfuture/0.3.1/x86_64-unknown-linux-gnu/src/stackfuture/lib.rs.html#275)

#### pub const fn [has\_alignment\_for\_val](#method.has_alignment_for_val)<F>(\_: [&F](https://doc.rust-lang.org/nightly/std/primitive.reference.html)) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Determines whether this `StackFuture`’s alignment is compatible with the referenced value.

## Trait Implementations

[Source](https://docs.rs/stackfuture/0.3.1/x86_64-unknown-linux-gnu/src/stackfuture/lib.rs.html#297)

### impl<'a, T, const STACK\_SIZE: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> [Drop](https://doc.rust-lang.org/nightly/core/ops/drop/trait.Drop.html "trait core::ops::drop::Drop") for [StackFuture](struct.StackFuture.html "struct bevy::asset::io::StackFuture")<'a, T, STACK\_SIZE>

[Source](https://docs.rs/stackfuture/0.3.1/x86_64-unknown-linux-gnu/src/stackfuture/lib.rs.html#298)
...
### impl<'a, T, const STACK\_SIZE: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> [Future](../../tasks/futures_lite/trait.Future.html "trait bevy::tasks::futures_lite::Future") for [StackFuture](struct.StackFuture.html "struct bevy::asset::io::StackFuture")<'a, T, STACK\_SIZE>

[Source](https://docs.rs/stackfuture/0.3.1/x86_64-unknown-linux-gnu/src/stackfuture/lib.rs.html#281)

#### type [Output](../../tasks/futures_lite/trait.Future.html#associatedtype.Output) = T

The type of value produced on completion.

[Source](https://docs.rs/stackfuture/0.3.1/x86_64-unknown-linux-gnu/src/stackfuture/lib.rs.html#283)

#### fn [poll](../../tasks/futures_lite/trait.Future.html#tymethod.poll)( self: [Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<&mut [StackFuture](struct.StackFuture.html "struct bevy::asset::io::StackFuture")<'a, T, STACK\_SIZE>>, cx: &mut [Context](https://doc.rust-lang.org/nightly/core/task/wake/struct.Context.html "struct core::task::wake::Context")<'\_>, ) -> [Poll](https://doc.rust-lang.org/nightly/core/task/poll/enum.Poll.html "enum core::task::poll::Poll")<<[StackFuture](struct.StackFuture.html "struct bevy::asset::io::StackFuture")<'a, T, STACK\_SIZE> as [Future](../../tasks/futures_lite/trait.Future.html "trait bevy::tasks::futures_lite::Future")\>::[Output](../../tasks/futures_lite/trait.Future.html#associatedtype.Output "type bevy::tasks::futures_lite::Future::Output")\>
...
### impl<'a, T, const STACK\_SIZE: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [StackFuture](struct.StackFuture.html "struct bevy::asset::io::StackFuture")<'a, T, STACK\_SIZE>

### impl<'a, T, const STACK\_SIZE: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [StackFuture](struct.StackFuture.html "struct bevy::asset::io::StackFuture")<'a, T, STACK\_SIZE>

### impl<'a, T, const STACK\_SIZE: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [StackFuture](struct.StackFuture.html "struct bevy::asset::io::StackFuture")<'a, T, STACK\_SIZE>

### impl<'a, T, const STACK\_SIZE: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [StackFuture](struct.StackFuture.html "struct bevy::asset::io::StackFuture")<'a, T, STACK\_SIZE>

### impl<'a, T, const STACK\_SIZE: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [StackFuture](struct.StackFuture.html "struct bevy::asset::io::StackFuture")<'a, T, STACK\_SIZE>

### impl<'a, T, const STACK\_SIZE: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [StackFuture](struct.StackFuture.html "struct bevy::asset::io::StackFuture")<'a, T, STACK\_SIZE>

### impl<'a, T, const STACK\_SIZE: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [StackFuture](struct.StackFuture.html "struct bevy::asset::io::StackFuture")<'a, T, STACK\_SIZE>
...
#### type [Value](trait.AssetReaderFuture.html#associatedtype.Value) = T
