...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#24)
...
*   [`AssetSourceId::Default`](enum.AssetSourceId.html#variant.Default "variant bevy::asset::io::AssetSourceId::Default") corresponds to “default asset paths” that don’t specify a source: `/path/to/asset.png`
*   [`AssetSourceId::Name`](enum.AssetSourceId.html#variant.Name "variant bevy::asset::io::AssetSourceId::Name") corresponds to asset paths that _do_ specify a source: `remote://path/to/asset.png`, where `remote` is the name.
...
### Name([CowArc](https://docs.rs/atomicow/1.2.0/x86_64-unknown-linux-gnu/atomicow/enum.CowArc.html "enum atomicow::CowArc")<'a, [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>)

A non-default named asset source.

## Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#41)

### impl<'a> [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'a>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#43)

#### pub fn [new](#method.new)(source: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[CowArc](https://docs.rs/atomicow/1.2.0/x86_64-unknown-linux-gnu/atomicow/enum.CowArc.html "enum atomicow::CowArc")<'a, [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>>>) -> [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'a>

Creates a new [`AssetSourceId`](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#52)

#### pub fn [as\_str](#method.as_str)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>

Returns [`None`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.None "variant core::option::Option::None") if this is [`AssetSourceId::Default`](enum.AssetSourceId.html#variant.Default "variant bevy::asset::io::AssetSourceId::Default") and [`Some`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.Some "variant core::option::Option::Some") containing the name if this is [`AssetSourceId::Name`](enum.AssetSourceId.html#variant.Name "variant bevy::asset::io::AssetSourceId::Name").

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#60)

#### pub fn [into\_owned](#method.into_owned)(self) -> [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'static>

If this is not already an owned / static id, create one. Otherwise, it will return itself (with a static lifetime).

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#70)

#### pub fn [clone\_owned](#method.clone_owned)(&self) -> [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'static>

Clones into an owned [`AssetSourceId<'static>`](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId"). This is equivalent to `.clone().into_owned()`.

## Trait Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#23)

### impl<'a> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'a>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#23)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'a>
...
### impl<'a> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'a>
...
### impl<'a> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'a>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#23)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'a>

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#32)

### impl<'a> [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'a>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#33)
...
### impl<'a> [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'a>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#84)

### impl<'a, 'b> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'a [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'b>> for [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'b>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#85)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: &'a [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'b>) -> [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'b>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#78)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\> for [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'static>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#79)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: &'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'static>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#90)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>> for [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'static>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#91)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>) -> [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'static>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#99)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[String](../../prelude/struct.String.html "struct bevy::prelude::String")\> for [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'static>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#100)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [String](../../prelude/struct.String.html "struct bevy::prelude::String")) -> [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'static>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#105)

### impl<'a> [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'a>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#106)
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#111)

### impl<'a> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'a>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#112)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'a>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl<'a> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'a>

### impl<'a> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'a>

### impl<'a> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'a>

### impl<'a> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'a>

### impl<'a> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'a>

### impl<'a> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'a>

### impl<'a> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'a>
