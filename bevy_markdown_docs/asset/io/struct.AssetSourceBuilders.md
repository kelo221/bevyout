...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#329)

```rust
pub struct AssetSourceBuilders { /* private fields */ }
```
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#334)

### impl [AssetSourceBuilders](struct.AssetSourceBuilders.html "struct bevy::asset::io::AssetSourceBuilders")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#336)

#### pub fn [insert](#method.insert)( &mut self, id: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'static>>, source: [AssetSourceBuilder](struct.AssetSourceBuilder.html "struct bevy::asset::io::AssetSourceBuilder"), )

Inserts a new builder with the given `id`

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#348-351)

#### pub fn [get\_mut](#method.get_mut)<'a, 'b>( &'a mut self, id: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[AssetSourceId](enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'b>>, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&'a mut [AssetSourceBuilder](struct.AssetSourceBuilder.html "struct bevy::asset::io::AssetSourceBuilder")\>

Gets a mutable builder with the given `id`, if it exists.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#360)

#### pub fn [build\_sources](#method.build_sources)( &mut self, watch: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), watch\_processed: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), ) -> [AssetSources](struct.AssetSources.html "struct bevy::asset::io::AssetSources")

Builds a new [`AssetSources`](struct.AssetSources.html "struct bevy::asset::io::AssetSources") collection. If `watch` is true, the unprocessed sources will watch for changes. If `watch_processed` is true, the processed sources will watch for changes.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#382)

#### pub fn [init\_default\_source](#method.init_default_source)(&mut self, path: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html), processed\_path: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>)

Initializes the default [`AssetSourceBuilder`](struct.AssetSourceBuilder.html "struct bevy::asset::io::AssetSourceBuilder") if it has not already been set.

## Trait Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#328)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [AssetSourceBuilders](struct.AssetSourceBuilders.html "struct bevy::asset::io::AssetSourceBuilders")

where [AssetSourceBuilders](struct.AssetSourceBuilders.html "struct bevy::asset::io::AssetSourceBuilders"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [AssetSourceBuilders](struct.AssetSourceBuilders.html "struct bevy::asset::io::AssetSourceBuilders")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#328)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [AssetSourceBuilders](struct.AssetSourceBuilders.html "struct bevy::asset::io::AssetSourceBuilders")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/io/source.rs.html#328)

### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [AssetSourceBuilders](struct.AssetSourceBuilders.html "struct bevy::asset::io::AssetSourceBuilders")

where [AssetSourceBuilders](struct.AssetSourceBuilders.html "struct bevy::asset::io::AssetSourceBuilders"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AssetSourceBuilders](struct.AssetSourceBuilders.html "struct bevy::asset::io::AssetSourceBuilders")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AssetSourceBuilders](struct.AssetSourceBuilders.html "struct bevy::asset::io::AssetSourceBuilders")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AssetSourceBuilders](struct.AssetSourceBuilders.html "struct bevy::asset::io::AssetSourceBuilders")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AssetSourceBuilders](struct.AssetSourceBuilders.html "struct bevy::asset::io::AssetSourceBuilders")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AssetSourceBuilders](struct.AssetSourceBuilders.html "struct bevy::asset::io::AssetSourceBuilders")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AssetSourceBuilders](struct.AssetSourceBuilders.html "struct bevy::asset::io::AssetSourceBuilders")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AssetSourceBuilders](struct.AssetSourceBuilders.html "struct bevy::asset::io::AssetSourceBuilders")
