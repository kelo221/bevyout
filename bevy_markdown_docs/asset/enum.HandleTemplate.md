...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#273)
...
When a type with a [`Handle<T>`](../prelude/enum.Handle.html "enum bevy::prelude::Handle") field derives [`FromTemplate`](../prelude/trait.FromTemplate.html "trait bevy::prelude::FromTemplate"), that field is replaced by its template type, [`HandleTemplate<T>`](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate"), when created via BSN. We can see that [`HandleTemplate<T>`](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate") has the following trait impl block:
...
[`AssetPath<'static>`](struct.AssetPath.html "struct bevy::asset::AssetPath") implements [`From<&'static str>`](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From"). Because of that, assigning a string literal to a `Handle<T>` field automatically converts it into [`HandleTemplate<T>::Path`](enum.HandleTemplate.html#variant.Path "variant bevy::asset::HandleTemplate::Path") with that asset path when used in the `bsn!` macro. Calls to `bsn!` automatically insert `.into()` conversions, and due to Rust’s blanket impl that turns [`From`](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From") trait impls into their [`Into`](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into") equivalents, the conversion from `&'static str` to `AssetPath<'static>` is handled automatically. Finally, the [`HandleTemplate<T>::Path`](enum.HandleTemplate.html#variant.Path "variant bevy::asset::HandleTemplate::Path") generated gets converted to a [`Handle<T>`](../prelude/enum.Handle.html "enum bevy::prelude::Handle") during scene initialization, as the asset is loaded from the given path, and the resulting handle is assigned to the field, pointing to the asset that was found at the file path in our original string.

## Variants

### Path([AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>)

Creates a [`Handle`](../prelude/enum.Handle.html "enum bevy::prelude::Handle") by calling [`AssetServer::load`](../prelude/struct.AssetServer.html#method.load "method bevy::prelude::AssetServer::load") on the given [`AssetPath`](struct.AssetPath.html "struct bevy::asset::AssetPath").

### Handle([Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<T>)

Creates a [`Handle`](../prelude/enum.Handle.html "enum bevy::prelude::Handle") by cloning the given [`Handle`](../prelude/enum.Handle.html "enum bevy::prelude::Handle") value.

### Value([ArcMutexValue](struct.ArcMutexValue.html "struct bevy::asset::ArcMutexValue")<T>)

Creates a [`Handle`](../prelude/enum.Handle.html "enum bevy::prelude::Handle") by adding the given asset value using [`AssetServer::add`](../prelude/struct.AssetServer.html#method.add "method bevy::prelude::AssetServer::add"). This will cache the resulting [`Handle`](../prelude/enum.Handle.html "enum bevy::prelude::Handle") on the template and reuse it for future template builds.

This should generally be constructed using [`HandleTemplate::value`](enum.HandleTemplate.html#method.value "associated function bevy::asset::HandleTemplate::value") or [`asset_value`](../prelude/fn.asset_value.html "fn bevy::prelude::asset_value").

## Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#285)

### impl<T> [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>

where T: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#291)

#### pub fn [value](#method.value)(value: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<T>) -> [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#323)

### impl<T> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>

where T: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#324)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>
...
### impl<T> [Enum](../reflect/enums/trait.Enum.html "trait bevy::reflect::enums::Enum") for [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>

where T: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset") + [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath"), [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>: [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"), [Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<T>: [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") + [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") + MaybeTyped + RegisterForReflection, [ArcMutexValue](struct.ArcMutexValue.html "struct bevy::asset::ArcMutexValue")<T>: [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") + [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") + MaybeTyped + RegisterForReflection,
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#329)

### impl<I, T> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<I> for [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>

where I: [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>>, T: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#330)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: I) -> [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#272)

### impl<T> [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>

where T: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset") + [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath"), [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>: [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"), [Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<T>: [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") + [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") + MaybeTyped + RegisterForReflection, [ArcMutexValue](struct.ArcMutexValue.html "struct bevy::asset::ArcMutexValue")<T>: [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") + [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") + MaybeTyped + RegisterForReflection,

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#272)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#272)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T> as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#272)

### impl<T> [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>

where T: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset") + [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath"), [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>: [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"), [Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<T>: [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") + [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") + MaybeTyped + RegisterForReflection, [ArcMutexValue](struct.ArcMutexValue.html "struct bevy::asset::ArcMutexValue")<T>: [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") + [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") + MaybeTyped + RegisterForReflection,

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#272)

#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)( \_\_param0: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>>
...
### impl<T> [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>
...
### impl<T> [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>
...
### impl<T> [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>
...
where [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>: 'into\_return,
...
### impl<T> [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>
...
#### fn [reflect\_owned](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#272)

#### fn [try\_into\_reflect](../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
### impl<T> [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>

where T: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset") + [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath"), [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>: [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"), [Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<T>: [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") + [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") + MaybeTyped + RegisterForReflection, [ArcMutexValue](struct.ArcMutexValue.html "struct bevy::asset::ArcMutexValue")<T>: [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") + [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") + MaybeTyped + RegisterForReflection,

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#272)

#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<T> [Template](../prelude/trait.Template.html "trait bevy::prelude::Template") for [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>

where T: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#342)

#### type [Output](../prelude/trait.Template.html#associatedtype.Output) = [Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<T>

The type of value produced by this [`Template`](../prelude/trait.Template.html "trait bevy::prelude::Template").

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#343)

#### fn [build\_template](../prelude/trait.Template.html#tymethod.build_template)( &self, context: &mut [TemplateContext](../ecs/template/struct.TemplateContext.html "struct bevy::ecs::template::TemplateContext")<'\_, '\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<T>, [BevyError](../prelude/struct.BevyError.html "struct bevy::prelude::BevyError")\>
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#365)

#### fn [clone\_template](../prelude/trait.Template.html#tymethod.clone_template)(&self) -> [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>

Clones this template. See [`Clone`](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone").

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#272)

### impl<T> [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>
...
### impl<T> [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>
...
### impl<T> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>

### impl<T> ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>

### impl<T> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>

### impl<T> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>

### impl<T> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>

### impl<T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>

### impl<T> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [HandleTemplate](enum.HandleTemplate.html "enum bevy::asset::HandleTemplate")<T>
