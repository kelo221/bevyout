...
# Enum UntypedAssetIdConversionError 

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#463)
...
Caused when trying to convert an [`UntypedAssetId`](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId") into an [`AssetId`](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId") of the wrong type.

#### Fields

`expected: [TypeId](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId")`

The [`TypeId`](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId") of the asset that we are trying to convert to.

`found: [TypeId](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId")`

The [`TypeId`](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId") of the asset that we are trying to convert from.

## Trait Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#461)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [UntypedAssetIdConversionError](enum.UntypedAssetIdConversionError.html "enum bevy::asset::UntypedAssetIdConversionError")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#461)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [UntypedAssetIdConversionError](enum.UntypedAssetIdConversionError.html "enum bevy::asset::UntypedAssetIdConversionError")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [UntypedAssetIdConversionError](enum.UntypedAssetIdConversionError.html "enum bevy::asset::UntypedAssetIdConversionError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [UntypedAssetIdConversionError](enum.UntypedAssetIdConversionError.html "enum bevy::asset::UntypedAssetIdConversionError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [UntypedAssetIdConversionError](enum.UntypedAssetIdConversionError.html "enum bevy::asset::UntypedAssetIdConversionError")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [UntypedAssetIdConversionError](enum.UntypedAssetIdConversionError.html "enum bevy::asset::UntypedAssetIdConversionError")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#461)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[UntypedAssetIdConversionError](enum.UntypedAssetIdConversionError.html "enum bevy::asset::UntypedAssetIdConversionError")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [UntypedAssetIdConversionError](enum.UntypedAssetIdConversionError.html "enum bevy::asset::UntypedAssetIdConversionError")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [UntypedAssetIdConversionError](enum.UntypedAssetIdConversionError.html "enum bevy::asset::UntypedAssetIdConversionError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [UntypedAssetIdConversionError](enum.UntypedAssetIdConversionError.html "enum bevy::asset::UntypedAssetIdConversionError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [UntypedAssetIdConversionError](enum.UntypedAssetIdConversionError.html "enum bevy::asset::UntypedAssetIdConversionError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [UntypedAssetIdConversionError](enum.UntypedAssetIdConversionError.html "enum bevy::asset::UntypedAssetIdConversionError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [UntypedAssetIdConversionError](enum.UntypedAssetIdConversionError.html "enum bevy::asset::UntypedAssetIdConversionError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [UntypedAssetIdConversionError](enum.UntypedAssetIdConversionError.html "enum bevy::asset::UntypedAssetIdConversionError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [UntypedAssetIdConversionError](enum.UntypedAssetIdConversionError.html "enum bevy::asset::UntypedAssetIdConversionError")
