...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/folder.rs.html#12)
...
This is produced by [`AssetServer::load_folder`](../prelude/struct.AssetServer.html#method.load_folder "method bevy::prelude::AssetServer::load_folder").

## Fields

`handles: [Vec](../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[UntypedHandle](../prelude/enum.UntypedHandle.html "enum bevy::prelude::UntypedHandle")>`
...
### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [LoadedFolder](struct.LoadedFolder.html "struct bevy::asset::LoadedFolder")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [LoadedFolder](struct.LoadedFolder.html "struct bevy::asset::LoadedFolder")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [LoadedFolder](struct.LoadedFolder.html "struct bevy::asset::LoadedFolder")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [LoadedFolder](struct.LoadedFolder.html "struct bevy::asset::LoadedFolder")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [LoadedFolder](struct.LoadedFolder.html "struct bevy::asset::LoadedFolder")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [LoadedFolder](struct.LoadedFolder.html "struct bevy::asset::LoadedFolder")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [LoadedFolder](struct.LoadedFolder.html "struct bevy::asset::LoadedFolder")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [LoadedFolder](struct.LoadedFolder.html "struct bevy::asset::LoadedFolder")
