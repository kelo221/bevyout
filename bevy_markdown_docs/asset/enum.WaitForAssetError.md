...
# Enum WaitForAssetError 

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2499)
...
### DependencyFailed([Arc](../platform/sync/struct.Arc.html "struct bevy::platform::sync::Arc")<[AssetLoadError](enum.AssetLoadError.html "enum bevy::asset::AssetLoadError")\>)

A dependency of the asset failed to load.

## Trait Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2498)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [WaitForAssetError](enum.WaitForAssetError.html "enum bevy::asset::WaitForAssetError")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2498)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [WaitForAssetError](enum.WaitForAssetError.html "enum bevy::asset::WaitForAssetError")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [WaitForAssetError](enum.WaitForAssetError.html "enum bevy::asset::WaitForAssetError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [WaitForAssetError](enum.WaitForAssetError.html "enum bevy::asset::WaitForAssetError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [WaitForAssetError](enum.WaitForAssetError.html "enum bevy::asset::WaitForAssetError")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [WaitForAssetError](enum.WaitForAssetError.html "enum bevy::asset::WaitForAssetError")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [WaitForAssetError](enum.WaitForAssetError.html "enum bevy::asset::WaitForAssetError")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [WaitForAssetError](enum.WaitForAssetError.html "enum bevy::asset::WaitForAssetError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [WaitForAssetError](enum.WaitForAssetError.html "enum bevy::asset::WaitForAssetError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [WaitForAssetError](enum.WaitForAssetError.html "enum bevy::asset::WaitForAssetError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [WaitForAssetError](enum.WaitForAssetError.html "enum bevy::asset::WaitForAssetError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [WaitForAssetError](enum.WaitForAssetError.html "enum bevy::asset::WaitForAssetError")
