...
# Struct AssetLoaderError 

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2422)
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2428)

### impl [AssetLoaderError](struct.AssetLoaderError.html "struct bevy::asset::AssetLoaderError")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2430)
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2438)

#### pub fn [error](#method.error)(&self) -> &[BevyError](../prelude/struct.BevyError.html "struct bevy::prelude::BevyError")

The error the loader reported when attempting to load the asset.

If you know the type of the error the asset loader returned, you can use [`BevyError::downcast_ref()`](../prelude/struct.BevyError.html#method.downcast_ref "method bevy::prelude::BevyError::downcast_ref") to get it.

## Trait Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2420)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [AssetLoaderError](struct.AssetLoaderError.html "struct bevy::asset::AssetLoaderError")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2420)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [AssetLoaderError](struct.AssetLoaderError.html "struct bevy::asset::AssetLoaderError")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [AssetLoaderError](struct.AssetLoaderError.html "struct bevy::asset::AssetLoaderError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [AssetLoaderError](struct.AssetLoaderError.html "struct bevy::asset::AssetLoaderError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [AssetLoaderError](struct.AssetLoaderError.html "struct bevy::asset::AssetLoaderError")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AssetLoaderError](struct.AssetLoaderError.html "struct bevy::asset::AssetLoaderError")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AssetLoaderError](struct.AssetLoaderError.html "struct bevy::asset::AssetLoaderError")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AssetLoaderError](struct.AssetLoaderError.html "struct bevy::asset::AssetLoaderError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AssetLoaderError](struct.AssetLoaderError.html "struct bevy::asset::AssetLoaderError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AssetLoaderError](struct.AssetLoaderError.html "struct bevy::asset::AssetLoaderError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AssetLoaderError](struct.AssetLoaderError.html "struct bevy::asset::AssetLoaderError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AssetLoaderError](struct.AssetLoaderError.html "struct bevy::asset::AssetLoaderError")
