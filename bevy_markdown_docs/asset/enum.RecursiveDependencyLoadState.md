...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2318)
...
### Failed([Arc](../platform/sync/struct.Arc.html "struct bevy::platform::sync::Arc")<[AssetLoadError](enum.AssetLoadError.html "enum bevy::asset::AssetLoadError")\>)

One or more dependencies have failed to load in this asset’s dependency tree. The underlying [`AssetLoadError`](enum.AssetLoadError.html "enum bevy::asset::AssetLoadError") is referenced by [`Arc`](../platform/sync/struct.Arc.html "struct bevy::platform::sync::Arc") clones in all related [`LoadState`](enum.LoadState.html "enum bevy::asset::LoadState")s and [`DependencyLoadState`](enum.DependencyLoadState.html "enum bevy::asset::DependencyLoadState")s in the asset’s dependency tree.

## Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2335)

### impl [RecursiveDependencyLoadState](enum.RecursiveDependencyLoadState.html "enum bevy::asset::RecursiveDependencyLoadState")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2337)

#### pub fn [is\_loading](#method.is_loading)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if this instance is [`RecursiveDependencyLoadState::Loading`](enum.RecursiveDependencyLoadState.html#variant.Loading "variant bevy::asset::RecursiveDependencyLoadState::Loading")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2342)

#### pub fn [is\_loaded](#method.is_loaded)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if this instance is [`RecursiveDependencyLoadState::Loaded`](enum.RecursiveDependencyLoadState.html#variant.Loaded "variant bevy::asset::RecursiveDependencyLoadState::Loaded")

##### [Examples found in repository](#scraped-examples)[?](../../scrape-examples-help.html)

examples/showcase/loading\_screen.rs ([line 211](../../src/loading_screen/loading_screen.rs.html#211))
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2347)

#### pub fn [is\_failed](#method.is_failed)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if this instance is [`RecursiveDependencyLoadState::Failed`](enum.RecursiveDependencyLoadState.html#variant.Failed "variant bevy::asset::RecursiveDependencyLoadState::Failed")

## Trait Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2317)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [RecursiveDependencyLoadState](enum.RecursiveDependencyLoadState.html "enum bevy::asset::RecursiveDependencyLoadState")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2317)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [RecursiveDependencyLoadState](enum.RecursiveDependencyLoadState.html "enum bevy::asset::RecursiveDependencyLoadState")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [RecursiveDependencyLoadState](enum.RecursiveDependencyLoadState.html "enum bevy::asset::RecursiveDependencyLoadState")

where [RecursiveDependencyLoadState](enum.RecursiveDependencyLoadState.html "enum bevy::asset::RecursiveDependencyLoadState"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
#### fn [map\_entities](../prelude/trait.Component.html#method.map_entities)<M>(this: &mut [RecursiveDependencyLoadState](enum.RecursiveDependencyLoadState.html "enum bevy::asset::RecursiveDependencyLoadState"), mapper: [&mut M](https://doc.rust-lang.org/nightly/std/primitive.reference.html))
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [RecursiveDependencyLoadState](enum.RecursiveDependencyLoadState.html "enum bevy::asset::RecursiveDependencyLoadState")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RecursiveDependencyLoadState](enum.RecursiveDependencyLoadState.html "enum bevy::asset::RecursiveDependencyLoadState")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RecursiveDependencyLoadState](enum.RecursiveDependencyLoadState.html "enum bevy::asset::RecursiveDependencyLoadState")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RecursiveDependencyLoadState](enum.RecursiveDependencyLoadState.html "enum bevy::asset::RecursiveDependencyLoadState")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RecursiveDependencyLoadState](enum.RecursiveDependencyLoadState.html "enum bevy::asset::RecursiveDependencyLoadState")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RecursiveDependencyLoadState](enum.RecursiveDependencyLoadState.html "enum bevy::asset::RecursiveDependencyLoadState")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RecursiveDependencyLoadState](enum.RecursiveDependencyLoadState.html "enum bevy::asset::RecursiveDependencyLoadState")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RecursiveDependencyLoadState](enum.RecursiveDependencyLoadState.html "enum bevy::asset::RecursiveDependencyLoadState")
