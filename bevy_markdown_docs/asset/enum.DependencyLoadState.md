...
# Enum DependencyLoadState 

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2283)
...
One or more dependencies have failed to load. The underlying [`AssetLoadError`](enum.AssetLoadError.html "enum bevy::asset::AssetLoadError") is referenced by [`Arc`](../platform/sync/struct.Arc.html "struct bevy::platform::sync::Arc") clones in all related [`LoadState`](enum.LoadState.html "enum bevy::asset::LoadState") and [`RecursiveDependencyLoadState`](enum.RecursiveDependencyLoadState.html "enum bevy::asset::RecursiveDependencyLoadState")s in the asset’s dependency tree.

## Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2299)

### impl [DependencyLoadState](enum.DependencyLoadState.html "enum bevy::asset::DependencyLoadState")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2301)

#### pub fn [is\_loading](#method.is_loading)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if this instance is [`DependencyLoadState::Loading`](enum.DependencyLoadState.html#variant.Loading "variant bevy::asset::DependencyLoadState::Loading")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2306)

#### pub fn [is\_loaded](#method.is_loaded)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if this instance is [`DependencyLoadState::Loaded`](enum.DependencyLoadState.html#variant.Loaded "variant bevy::asset::DependencyLoadState::Loaded")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2311)

#### pub fn [is\_failed](#method.is_failed)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if this instance is [`DependencyLoadState::Failed`](enum.DependencyLoadState.html#variant.Failed "variant bevy::asset::DependencyLoadState::Failed")

## Trait Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2282)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [DependencyLoadState](enum.DependencyLoadState.html "enum bevy::asset::DependencyLoadState")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2282)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [DependencyLoadState](enum.DependencyLoadState.html "enum bevy::asset::DependencyLoadState")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [DependencyLoadState](enum.DependencyLoadState.html "enum bevy::asset::DependencyLoadState")

where [DependencyLoadState](enum.DependencyLoadState.html "enum bevy::asset::DependencyLoadState"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
#### fn [map\_entities](../prelude/trait.Component.html#method.map_entities)<M>(this: &mut [DependencyLoadState](enum.DependencyLoadState.html "enum bevy::asset::DependencyLoadState"), mapper: [&mut M](https://doc.rust-lang.org/nightly/std/primitive.reference.html))
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [DependencyLoadState](enum.DependencyLoadState.html "enum bevy::asset::DependencyLoadState")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DependencyLoadState](enum.DependencyLoadState.html "enum bevy::asset::DependencyLoadState")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DependencyLoadState](enum.DependencyLoadState.html "enum bevy::asset::DependencyLoadState")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DependencyLoadState](enum.DependencyLoadState.html "enum bevy::asset::DependencyLoadState")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DependencyLoadState](enum.DependencyLoadState.html "enum bevy::asset::DependencyLoadState")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DependencyLoadState](enum.DependencyLoadState.html "enum bevy::asset::DependencyLoadState")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DependencyLoadState](enum.DependencyLoadState.html "enum bevy::asset::DependencyLoadState")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DependencyLoadState](enum.DependencyLoadState.html "enum bevy::asset::DependencyLoadState")
