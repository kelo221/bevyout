...
# Struct AddAsyncError 

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2446)
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2444)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [AddAsyncError](struct.AddAsyncError.html "struct bevy::asset::AddAsyncError")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/server/mod.rs.html#2444)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [AddAsyncError](struct.AddAsyncError.html "struct bevy::asset::AddAsyncError")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [AddAsyncError](struct.AddAsyncError.html "struct bevy::asset::AddAsyncError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [AddAsyncError](struct.AddAsyncError.html "struct bevy::asset::AddAsyncError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [AddAsyncError](struct.AddAsyncError.html "struct bevy::asset::AddAsyncError")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AddAsyncError](struct.AddAsyncError.html "struct bevy::asset::AddAsyncError")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AddAsyncError](struct.AddAsyncError.html "struct bevy::asset::AddAsyncError")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AddAsyncError](struct.AddAsyncError.html "struct bevy::asset::AddAsyncError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AddAsyncError](struct.AddAsyncError.html "struct bevy::asset::AddAsyncError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AddAsyncError](struct.AddAsyncError.html "struct bevy::asset::AddAsyncError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AddAsyncError](struct.AddAsyncError.html "struct bevy::asset::AddAsyncError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AddAsyncError](struct.AddAsyncError.html "struct bevy::asset::AddAsyncError")
