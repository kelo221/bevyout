...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#57)
...
*   [`AssetPath::source`](struct.AssetPath.html#method.source "method bevy::asset::AssetPath::source"): The name of the [`AssetSource`](io/struct.AssetSource.html "struct bevy::asset::io::AssetSource") to load the asset from. This is optional. If one is not set the default source will be used (which is the `assets` folder by default).
*   [`AssetPath::path`](struct.AssetPath.html#method.path "method bevy::asset::AssetPath::path"): The “virtual filesystem path” pointing to an asset source file.
*   [`AssetPath::label`](struct.AssetPath.html#method.label "method bevy::asset::AssetPath::label"): An optional “named sub asset”. When assets are loaded, they are allowed to load “sub assets” of any type, which are identified by a named “label”.
...
[`AssetPath`](struct.AssetPath.html "struct bevy::asset::AssetPath") implements [`From`](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From") for `&'static str`, `&'static Path`, and `&'a String`, which allows us to optimize the static cases. This means that the common case of `asset_server.load("my_scene.scn")` when it creates and clones internal owned [`AssetPaths`](struct.AssetPath.html "struct bevy::asset::AssetPath"). This also means that you should use [`AssetPath::parse`](struct.AssetPath.html#method.parse "associated function bevy::asset::AssetPath::parse") in cases where `&str` is the explicit type.

## Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#99)

### impl<'a> [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#111)

#### pub fn [parse](#method.parse)(asset\_path: &'a [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

Creates a new [`AssetPath`](struct.AssetPath.html "struct bevy::asset::AssetPath") from a string in the asset path format:
...
Prefer [`From<'static str>`](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From") for static strings, as this will prevent allocations and reference counting for [`AssetPath::into_owned`](struct.AssetPath.html#method.into_owned "method bevy::asset::AssetPath::into_owned").

##### Panics

Panics if the asset path is in an invalid format. Use [`AssetPath::try_parse`](struct.AssetPath.html#method.try_parse "associated function bevy::asset::AssetPath::try_parse") for a fallible variant

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#125)

#### pub fn [try\_parse](#method.try_parse)( asset\_path: &'a [str](https://doc.rust-lang.org/nightly/std/primitive.str.html), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>, [ParseAssetPathError](enum.ParseAssetPathError.html "enum bevy::asset::ParseAssetPathError")\>
...
This will return a [`ParseAssetPathError`](enum.ParseAssetPathError.html "enum bevy::asset::ParseAssetPathError") if `asset_path` is in an invalid format.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#228)

#### pub fn [from\_path\_buf](#method.from_path_buf)(path\_buf: [PathBuf](https://doc.rust-lang.org/nightly/std/path/struct.PathBuf.html "struct std::path::PathBuf")) -> [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

Creates a new [`AssetPath`](struct.AssetPath.html "struct bevy::asset::AssetPath") from a [`PathBuf`](https://doc.rust-lang.org/nightly/std/path/struct.PathBuf.html "struct std::path::PathBuf").

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#238)

#### pub fn [from\_path](#method.from_path)(path: &'a [Path](https://doc.rust-lang.org/nightly/std/path/struct.Path.html "struct std::path::Path")) -> [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

Creates a new [`AssetPath`](struct.AssetPath.html "struct bevy::asset::AssetPath") from a [`Path`](https://doc.rust-lang.org/nightly/std/path/struct.Path.html "struct std::path::Path").

##### [Examples found in repository](#scraped-examples)[?](../../scrape-examples-help.html)

examples/asset/extra\_source.rs ([line 39](../../src/extra_asset_source/extra_source.rs.html#39))
...
examples/asset/embedded\_asset.rs ([line 48](../../src/embedded_asset/embedded_asset.rs.html#48))
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#249)

#### pub fn [source](#method.source)(&self) -> &[AssetSourceId](io/enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'\_>

Gets the “asset source”, if one was defined. If none was defined, the default source will be used.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#255)
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#261)

#### pub fn [label\_cow](#method.label_cow)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[CowArc](https://docs.rs/atomicow/1.2.0/x86_64-unknown-linux-gnu/atomicow/enum.CowArc.html "enum atomicow::CowArc")<'a, [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>>

Gets the “sub-asset label”.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#267)
...
examples/asset/asset\_decompression.rs ([line 51](../../src/asset_decompression/asset_decompression.rs.html#51))
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#273)

#### pub fn [without\_label](#method.without_label)(&self) -> [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'\_>

Gets the path to the asset in the “virtual filesystem” without a label (if a label is currently set).

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#283)

#### pub fn [remove\_label](#method.remove_label)(&mut self)

Removes a “sub-asset label” from this [`AssetPath`](struct.AssetPath.html "struct bevy::asset::AssetPath"), if one was set.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#289)

#### pub fn [take\_label](#method.take_label)(&mut self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[CowArc](https://docs.rs/atomicow/1.2.0/x86_64-unknown-linux-gnu/atomicow/enum.CowArc.html "enum atomicow::CowArc")<'a, [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>>

Takes the “sub-asset label” from this [`AssetPath`](struct.AssetPath.html "struct bevy::asset::AssetPath"), if one was set.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#296)

#### pub fn [with\_label](#method.with_label)(self, label: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[CowArc](https://docs.rs/atomicow/1.2.0/x86_64-unknown-linux-gnu/atomicow/enum.CowArc.html "enum atomicow::CowArc")<'a, [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>>) -> [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

Returns this asset path with the given label. This will replace the previous label if it exists.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#307)

#### pub fn [with\_source](#method.with_source)(self, source: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[AssetSourceId](io/enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'a>>) -> [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#316)

#### pub fn [parent](#method.parent)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>>

Returns an [`AssetPath`](struct.AssetPath.html "struct bevy::asset::AssetPath") for the parent folder of this path, if there is a parent folder in the path.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#334)

#### pub fn [into\_owned](#method.into_owned)(self) -> [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>

Converts this into an “owned” value. If internally a value is borrowed, it will be cloned into an “owned [`Arc`](../platform/sync/struct.Arc.html "struct bevy::platform::sync::Arc")”. If internally a value is a static reference, the static reference will be used unchanged. If internally a value is an “owned [`Arc`](../platform/sync/struct.Arc.html "struct bevy::platform::sync::Arc")”, it will remain unchanged.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#348)

#### pub fn [clone\_owned](#method.clone_owned)(&self) -> [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>

Clones this into an “owned” value. If internally a value is borrowed, it will be cloned into an “owned [`Arc`](../platform/sync/struct.Arc.html "struct bevy::platform::sync::Arc")”. If internally a value is a static reference, the static reference will be used unchanged. If internally a value is an “owned [`Arc`](../platform/sync/struct.Arc.html "struct bevy::platform::sync::Arc")”, the [`Arc`](../platform/sync/struct.Arc.html "struct bevy::platform::sync::Arc") will be cloned.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#373)

#### pub fn [resolve](#method.resolve)(&self, path: &[AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'\_>) -> [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>

Resolves an [`AssetPath`](struct.AssetPath.html "struct bevy::asset::AssetPath") relative to `self`.
...
See also [`AssetPath::resolve_str`](struct.AssetPath.html#method.resolve_str "method bevy::asset::AssetPath::resolve_str").

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#410)

#### pub fn [resolve\_embed](#method.resolve_embed)(&self, path: &[AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'\_>) -> [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>

Resolves an [`AssetPath`](struct.AssetPath.html "struct bevy::asset::AssetPath") relative to `self` using embedded (RFC 1808) semantics.

Semantics:

*   Remove the “file portion” of the base before concatenation (unless the base ends with `/`).
*   Otherwise identical to [`AssetPath::resolve`](struct.AssetPath.html#method.resolve "method bevy::asset::AssetPath::resolve").
...
See also [`AssetPath::resolve_embed_str`](struct.AssetPath.html#method.resolve_embed_str "method bevy::asset::AssetPath::resolve_embed_str").

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#433)

#### pub fn [resolve\_str](#method.resolve_str)( &self, path: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>, [ParseAssetPathError](enum.ParseAssetPathError.html "enum bevy::asset::ParseAssetPathError")\>

Parses `path` as an [`AssetPath`](struct.AssetPath.html "struct bevy::asset::AssetPath"), then resolves it relative to `self`.

Returns an error if parsing fails.

For more details, see [`AssetPath::resolve`](struct.AssetPath.html#method.resolve "method bevy::asset::AssetPath::resolve").

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#443)

#### pub fn [resolve\_embed\_str](#method.resolve_embed_str)( &self, path: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>, [ParseAssetPathError](enum.ParseAssetPathError.html "enum bevy::asset::ParseAssetPathError")\>

Parses `path` as an [`AssetPath`](struct.AssetPath.html "struct bevy::asset::AssetPath"), then resolves it relative to `self` using embedded (RFC 1808) semantics.

Returns an error if parsing fails.

For more details, see [`AssetPath::resolve_embed`](struct.AssetPath.html#method.resolve_embed "method bevy::asset::AssetPath::resolve_embed").

##### [Examples found in repository](#scraped-examples-3)[?](../../scrape-examples-help.html)

examples/asset/asset\_decompression.rs ([line 59](../../src/asset_decompression/asset_decompression.rs.html#59))
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#506)

#### pub fn [get\_full\_extension](#method.get_full_extension)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#525)

#### pub fn [get\_extension](#method.get_extension)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#569)

#### pub fn [is\_unapproved](#method.is_unapproved)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if this [`AssetPath`](struct.AssetPath.html "struct bevy::asset::AssetPath") points to a file that is outside of its [`AssetSource`](io/struct.AssetSource.html "struct bevy::asset::io::AssetSource") folder.
...
### impl<'a> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#54)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#63)

### impl<'a> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#64)
...
### impl<'a> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#54)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#661)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#662-664)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<D>( deserializer: D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>, <D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#69)

### impl<'a> [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#70)
...
### impl<'a> [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#640)

### impl<'a, 'b> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'a [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'b>> for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'b>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#641)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: &'a [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'b>) -> [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'b>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#604)

### impl<'a> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'a [String](../prelude/struct.String.html "struct bevy::prelude::String")\> for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#606)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(asset\_path: &'a [String](../prelude/struct.String.html "struct bevy::prelude::String")) -> [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#618)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'static [Path](https://doc.rust-lang.org/nightly/std/path/struct.Path.html "struct std::path::Path")\> for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#620)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(path: &'static [Path](https://doc.rust-lang.org/nightly/std/path/struct.Path.html "struct std::path::Path")) -> [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#592)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\> for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#594)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(asset\_path: &'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_shader/0.19.0/x86_64-unknown-linux-gnu/src/bevy_shader/shader.rs.html#422)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>> for [ShaderRef](../shader/enum.ShaderRef.html "enum bevy::shader::ShaderRef")

[Source](https://docs.rs/bevy_shader/0.19.0/x86_64-unknown-linux-gnu/src/bevy_shader/shader.rs.html#423)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(path: [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>) -> [ShaderRef](../shader/enum.ShaderRef.html "enum bevy::shader::ShaderRef")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#629)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[PathBuf](https://doc.rust-lang.org/nightly/std/path/struct.PathBuf.html "struct std::path::PathBuf")\> for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#631)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(path: [PathBuf](https://doc.rust-lang.org/nightly/std/path/struct.PathBuf.html "struct std::path::PathBuf")) -> [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#611)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[String](../prelude/struct.String.html "struct bevy::prelude::String")\> for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#613)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(asset\_path: [String](../prelude/struct.String.html "struct bevy::prelude::String")) -> [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#54)

### impl<'a> [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

where [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>: 'static,

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#54)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#54)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a> as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#54)

### impl<'a> [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

where [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>: 'static,

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#54)

#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>>
...
### impl<'a> [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>
...
### impl<'a> [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>
...
### impl<'a> [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>
...
### impl<'a> [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>
...
where [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>: 'into\_return,
...
### impl<'a> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#54)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl<'a> [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>
...
#### fn [reflect\_owned](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#54)

#### fn [try\_into\_reflect](../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#56)
...
### impl<'a> [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

where [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>: 'static,

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#54)

#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#652)

### impl<'a> [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#653-655)
...
### impl<'a> [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#54)

### impl<'a> [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>
...
### impl<'a> [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>
...
### impl<'a> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

### impl<'a> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

### impl<'a> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

### impl<'a> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

### impl<'a> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

### impl<'a> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>

### impl<'a> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'a>
