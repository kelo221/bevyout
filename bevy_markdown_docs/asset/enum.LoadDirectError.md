...
# Enum LoadDirectError 

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/loader.rs.html#344)
...
### RequestedSubasset([AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>)

### LoadError

#### Fields

`dependency: [AssetPath](struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>`

`error: [AssetLoadError](enum.AssetLoadError.html "enum bevy::asset::AssetLoadError")`

## Trait Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/loader.rs.html#343)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [LoadDirectError](enum.LoadDirectError.html "enum bevy::asset::LoadDirectError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [LoadDirectError](enum.LoadDirectError.html "enum bevy::asset::LoadDirectError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [LoadDirectError](enum.LoadDirectError.html "enum bevy::asset::LoadDirectError")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [LoadDirectError](enum.LoadDirectError.html "enum bevy::asset::LoadDirectError")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [LoadDirectError](enum.LoadDirectError.html "enum bevy::asset::LoadDirectError")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [LoadDirectError](enum.LoadDirectError.html "enum bevy::asset::LoadDirectError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [LoadDirectError](enum.LoadDirectError.html "enum bevy::asset::LoadDirectError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [LoadDirectError](enum.LoadDirectError.html "enum bevy::asset::LoadDirectError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [LoadDirectError](enum.LoadDirectError.html "enum bevy::asset::LoadDirectError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [LoadDirectError](enum.LoadDirectError.html "enum bevy::asset::LoadDirectError")
