...
# Enum ParseAssetPathError 

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#84)
...
Error that occurs when the [`AssetPath::source`](struct.AssetPath.html#method.source "method bevy::asset::AssetPath::source") section of a path string contains the [`AssetPath::label`](struct.AssetPath.html#method.label "method bevy::asset::AssetPath::label") delimiter `#`. E.g. `bad#source://file.test`.

### InvalidLabelSyntax

Error that occurs when the [`AssetPath::label`](struct.AssetPath.html#method.label "method bevy::asset::AssetPath::label") section of a path string contains the [`AssetPath::source`](struct.AssetPath.html#method.source "method bevy::asset::AssetPath::source") delimiter `://`. E.g. `source://file.test#bad://label`.

### MissingSource

Error that occurs when a path string has an [`AssetPath::source`](struct.AssetPath.html#method.source "method bevy::asset::AssetPath::source") delimiter `://` with no characters preceding it. E.g. `://file.test`.

### MissingLabel

Error that occurs when a path string has an [`AssetPath::label`](struct.AssetPath.html#method.label "method bevy::asset::AssetPath::label") delimiter `#` with no characters succeeding it. E.g. `file.test#`

## Trait Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#83)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ParseAssetPathError](enum.ParseAssetPathError.html "enum bevy::asset::ParseAssetPathError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [ParseAssetPathError](enum.ParseAssetPathError.html "enum bevy::asset::ParseAssetPathError")
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [ParseAssetPathError](enum.ParseAssetPathError.html "enum bevy::asset::ParseAssetPathError")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#83)

### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [ParseAssetPathError](enum.ParseAssetPathError.html "enum bevy::asset::ParseAssetPathError")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [ParseAssetPathError](enum.ParseAssetPathError.html "enum bevy::asset::ParseAssetPathError")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/path.rs.html#83)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[ParseAssetPathError](enum.ParseAssetPathError.html "enum bevy::asset::ParseAssetPathError")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [ParseAssetPathError](enum.ParseAssetPathError.html "enum bevy::asset::ParseAssetPathError")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ParseAssetPathError](enum.ParseAssetPathError.html "enum bevy::asset::ParseAssetPathError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ParseAssetPathError](enum.ParseAssetPathError.html "enum bevy::asset::ParseAssetPathError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ParseAssetPathError](enum.ParseAssetPathError.html "enum bevy::asset::ParseAssetPathError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ParseAssetPathError](enum.ParseAssetPathError.html "enum bevy::asset::ParseAssetPathError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ParseAssetPathError](enum.ParseAssetPathError.html "enum bevy::asset::ParseAssetPathError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ParseAssetPathError](enum.ParseAssetPathError.html "enum bevy::asset::ParseAssetPathError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ParseAssetPathError](enum.ParseAssetPathError.html "enum bevy::asset::ParseAssetPathError")
