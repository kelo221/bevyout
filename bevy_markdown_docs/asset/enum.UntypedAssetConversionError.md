...
# Enum UntypedAssetConversionError 

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#723)
...
Caused when trying to convert an [`UntypedHandle`](../prelude/enum.UntypedHandle.html "enum bevy::prelude::UntypedHandle") into a [`Handle`](../prelude/enum.Handle.html "enum bevy::prelude::Handle") of the wrong type.

#### Fields

`expected: [TypeId](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId")`

The expected [`TypeId`](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId") of the [`Handle`](../prelude/enum.Handle.html "enum bevy::prelude::Handle") being converted to.

`found: [TypeId](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId")`

The [`TypeId`](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId") of the [`UntypedHandle`](../prelude/enum.UntypedHandle.html "enum bevy::prelude::UntypedHandle") being converted from.

## Trait Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#721)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [UntypedAssetConversionError](enum.UntypedAssetConversionError.html "enum bevy::asset::UntypedAssetConversionError")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#721)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [UntypedAssetConversionError](enum.UntypedAssetConversionError.html "enum bevy::asset::UntypedAssetConversionError")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [UntypedAssetConversionError](enum.UntypedAssetConversionError.html "enum bevy::asset::UntypedAssetConversionError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [UntypedAssetConversionError](enum.UntypedAssetConversionError.html "enum bevy::asset::UntypedAssetConversionError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [UntypedAssetConversionError](enum.UntypedAssetConversionError.html "enum bevy::asset::UntypedAssetConversionError")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [UntypedAssetConversionError](enum.UntypedAssetConversionError.html "enum bevy::asset::UntypedAssetConversionError")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#721)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[UntypedAssetConversionError](enum.UntypedAssetConversionError.html "enum bevy::asset::UntypedAssetConversionError")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [UntypedAssetConversionError](enum.UntypedAssetConversionError.html "enum bevy::asset::UntypedAssetConversionError")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [UntypedAssetConversionError](enum.UntypedAssetConversionError.html "enum bevy::asset::UntypedAssetConversionError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [UntypedAssetConversionError](enum.UntypedAssetConversionError.html "enum bevy::asset::UntypedAssetConversionError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [UntypedAssetConversionError](enum.UntypedAssetConversionError.html "enum bevy::asset::UntypedAssetConversionError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [UntypedAssetConversionError](enum.UntypedAssetConversionError.html "enum bevy::asset::UntypedAssetConversionError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [UntypedAssetConversionError](enum.UntypedAssetConversionError.html "enum bevy::asset::UntypedAssetConversionError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [UntypedAssetConversionError](enum.UntypedAssetConversionError.html "enum bevy::asset::UntypedAssetConversionError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [UntypedAssetConversionError](enum.UntypedAssetConversionError.html "enum bevy::asset::UntypedAssetConversionError")
