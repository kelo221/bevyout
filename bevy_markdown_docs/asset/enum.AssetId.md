...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#23)
...
For an identifier tied to the lifetime of an asset, see [`Handle`](../prelude/enum.Handle.html "enum bevy::prelude::Handle").

For an “untyped” / “generic-less” id, see [`UntypedAssetId`](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId").

## Variants

### Index

A small / efficient runtime identifier that can be used to efficiently look up an asset stored in [`Assets`](../prelude/struct.Assets.html "struct bevy::prelude::Assets"). This is the “default” identifier used for assets. The alternative(s) (ex: [`AssetId::Uuid`](../prelude/enum.AssetId.html#variant.Uuid "variant bevy::prelude::AssetId::Uuid")) will only be used if assets are explicitly registered that way.

#### Fields

`index: [AssetIndex](struct.AssetIndex.html "struct bevy::asset::AssetIndex")`

The unstable, opaque index of the asset.

`marker: [PhantomData](https://doc.rust-lang.org/nightly/core/marker/struct.PhantomData.html "struct core::marker::PhantomData")<[fn](https://doc.rust-lang.org/nightly/std/primitive.fn.html)() -> A>`

A marker to store the type information of the asset.

### Uuid

A stable-across-runs / const asset identifier. This will only be used if an asset is explicitly registered in [`Assets`](../prelude/struct.Assets.html "struct bevy::prelude::Assets") with one.

#### Fields

`uuid: [Uuid](uuid/struct.Uuid.html "struct bevy::asset::uuid::Uuid")`

The UUID provided during asset registration.

## Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#46)

### impl<A> [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#49)

#### pub const [DEFAULT\_UUID](#associatedconstant.DEFAULT_UUID): [Uuid](uuid/struct.Uuid.html "struct bevy::asset::uuid::Uuid")

The uuid for the default [`AssetId`](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId"). It is valid to assign a value to this in [`Assets`](../prelude/struct.Assets.html "struct bevy::prelude::Assets") and by convention (where appropriate) assets should support this pattern.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#53)

#### pub const [INVALID\_UUID](#associatedconstant.INVALID_UUID): [Uuid](uuid/struct.Uuid.html "struct bevy::asset::uuid::Uuid")

This asset id _should_ never be valid. Assigning a value to this in [`Assets`](../prelude/struct.Assets.html "struct bevy::prelude::Assets") will produce undefined behavior, so don’t do it!

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#57)

#### pub const fn [invalid](#method.invalid)() -> [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

Returns an [`AssetId`](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId") with [`Self::INVALID_UUID`](../prelude/enum.AssetId.html#associatedconstant.INVALID_UUID "associated constant bevy::prelude::AssetId::INVALID_UUID"), which _should_ never be assigned to.

##### [Examples found in repository](#scraped-examples)[?](../../scrape-examples-help.html)

examples/shader\_advanced/custom\_phase\_item.rs ([line 303](../../src/custom_phase_item/custom_phase_item.rs.html#303))
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#66)

#### pub fn [untyped](#method.untyped)(self) -> [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

Converts this to an “untyped” / “generic-less” [`Asset`](../prelude/trait.Asset.html "trait bevy::prelude::Asset") identifier that stores the type information _inside_ the [`UntypedAssetId`](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId").

##### [Examples found in repository](#scraped-examples-1)[?](../../scrape-examples-help.html)

examples/shader\_advanced/manual\_material.rs ([line 258](../../src/manual_material/manual_material.rs.html#258))
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#87)

### impl<A> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#88)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#93)

### impl<A> [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#101)

### impl<A> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#102)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")\>

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#79)

### impl<A> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#80)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#21)

### impl<'de, A> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#21)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>, <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#95)

### impl<A> [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#96)
...
### impl<A> [Enum](../reflect/enums/trait.Enum.html "trait bevy::reflect::enums::Enum") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#140)

### impl<A> [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>
...
[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/graph.rs.html#146)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&[AnimationGraphHandle](../prelude/struct.AnimationGraphHandle.html "struct bevy::prelude::AnimationGraphHandle")\> for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[AnimationGraph](../prelude/struct.AnimationGraph.html "struct bevy::prelude::AnimationGraph")\>

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/graph.rs.html#147)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(handle: &[AnimationGraphHandle](../prelude/struct.AnimationGraphHandle.html "struct bevy::prelude::AnimationGraphHandle")) -> [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[AnimationGraph](../prelude/struct.AnimationGraph.html "struct bevy::prelude::AnimationGraph")\>
...
[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/ui_material.rs.html#194)

### impl<M> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&[MaterialNode](../prelude/struct.MaterialNode.html "struct bevy::prelude::MaterialNode")<M>> for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<M>

where M: [UiMaterial](../prelude/trait.UiMaterial.html "trait bevy::prelude::UiMaterial"),

[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/ui_material.rs.html#195)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(material: &[MaterialNode](../prelude/struct.MaterialNode.html "struct bevy::prelude::MaterialNode")<M>) -> [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<M>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/components.rs.html#53)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&[Mesh2d](../prelude/struct.Mesh2d.html "struct bevy::prelude::Mesh2d")\> for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[Mesh](../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")\>

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/components.rs.html#54)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(mesh: &[Mesh2d](../prelude/struct.Mesh2d.html "struct bevy::prelude::Mesh2d")) -> [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[Mesh](../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")\>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/components.rs.html#110)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&[Mesh3d](../prelude/struct.Mesh3d.html "struct bevy::prelude::Mesh3d")\> for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[Mesh](../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")\>

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/components.rs.html#111)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(mesh: &[Mesh3d](../prelude/struct.Mesh3d.html "struct bevy::prelude::Mesh3d")) -> [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[Mesh](../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")\>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/material.rs.html#226)

### impl<M> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&[MeshMaterial2d](../prelude/struct.MeshMaterial2d.html "struct bevy::prelude::MeshMaterial2d")<M>> for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<M>

where M: [Material2d](../sprite_render/trait.Material2d.html "trait bevy::sprite_render::Material2d"),

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/material.rs.html#227)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(material: &[MeshMaterial2d](../prelude/struct.MeshMaterial2d.html "struct bevy::prelude::MeshMaterial2d")<M>) -> [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<M>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/mesh_material.rs.html#63)

### impl<M> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&[MeshMaterial3d](../prelude/struct.MeshMaterial3d.html "struct bevy::prelude::MeshMaterial3d")<M>> for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<M>

where M: [Material](../prelude/trait.Material.html "trait bevy::prelude::Material"),

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/mesh_material.rs.html#64)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(material: &[MeshMaterial3d](../prelude/struct.MeshMaterial3d.html "struct bevy::prelude::MeshMaterial3d")<M>) -> [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<M>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/meshlet/mod.rs.html#243)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&[MeshletMesh3d](../pbr/experimental/meshlet/struct.MeshletMesh3d.html "struct bevy::pbr::experimental::meshlet::MeshletMesh3d")\> for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[MeshletMesh](../pbr/experimental/meshlet/struct.MeshletMesh.html "struct bevy::pbr::experimental::meshlet::MeshletMesh")\>

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/meshlet/mod.rs.html#244)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(mesh: &[MeshletMesh3d](../pbr/experimental/meshlet/struct.MeshletMesh3d.html "struct bevy::pbr::experimental::meshlet::MeshletMesh3d")) -> [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[MeshletMesh](../pbr/experimental/meshlet/struct.MeshletMesh.html "struct bevy::pbr::experimental::meshlet::MeshletMesh")\>
...
### impl<A> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<([AssetIndex](struct.AssetIndex.html "struct bevy::asset::AssetIndex"), [PhantomData](https://doc.rust-lang.org/nightly/core/marker/struct.PhantomData.html "struct core::marker::PhantomData")<[fn](https://doc.rust-lang.org/nightly/std/primitive.fn.html)() -> A>)> for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#21)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: ([AssetIndex](struct.AssetIndex.html "struct bevy::asset::AssetIndex"), [PhantomData](https://doc.rust-lang.org/nightly/core/marker/struct.PhantomData.html "struct core::marker::PhantomData")<[fn](https://doc.rust-lang.org/nightly/std/primitive.fn.html)() -> A>)) -> [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/graph.rs.html#140)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[AnimationGraphHandle](../prelude/struct.AnimationGraphHandle.html "struct bevy::prelude::AnimationGraphHandle")\> for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[AnimationGraph](../prelude/struct.AnimationGraph.html "struct bevy::prelude::AnimationGraph")\>

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/graph.rs.html#141)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(handle: [AnimationGraphHandle](../prelude/struct.AnimationGraphHandle.html "struct bevy::prelude::AnimationGraphHandle")) -> [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[AnimationGraph](../prelude/struct.AnimationGraph.html "struct bevy::prelude::AnimationGraph")\>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#381)

### impl<A> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>> for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#383)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>) -> [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#154)

### impl<A> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[AssetIndex](struct.AssetIndex.html "struct bevy::asset::AssetIndex")\> for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#156)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [AssetIndex](struct.AssetIndex.html "struct bevy::asset::AssetIndex")) -> [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/ui_material.rs.html#188)

### impl<M> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[MaterialNode](../prelude/struct.MaterialNode.html "struct bevy::prelude::MaterialNode")<M>> for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<M>

where M: [UiMaterial](../prelude/trait.UiMaterial.html "trait bevy::prelude::UiMaterial"),

[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/ui_material.rs.html#189)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(material: [MaterialNode](../prelude/struct.MaterialNode.html "struct bevy::prelude::MaterialNode")<M>) -> [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<M>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/components.rs.html#47)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Mesh2d](../prelude/struct.Mesh2d.html "struct bevy::prelude::Mesh2d")\> for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[Mesh](../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")\>

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/components.rs.html#48)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(mesh: [Mesh2d](../prelude/struct.Mesh2d.html "struct bevy::prelude::Mesh2d")) -> [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[Mesh](../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")\>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/components.rs.html#104)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Mesh3d](../prelude/struct.Mesh3d.html "struct bevy::prelude::Mesh3d")\> for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[Mesh](../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")\>

[Source](https://docs.rs/bevy_mesh/0.19.0/x86_64-unknown-linux-gnu/src/bevy_mesh/components.rs.html#105)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(mesh: [Mesh3d](../prelude/struct.Mesh3d.html "struct bevy::prelude::Mesh3d")) -> [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[Mesh](../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")\>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#948)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<MeshAssetIdFlat> for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[Mesh](../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")\>

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#950)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: MeshAssetIdFlat) -> [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[Mesh](../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")\>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/material.rs.html#220)

### impl<M> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[MeshMaterial2d](../prelude/struct.MeshMaterial2d.html "struct bevy::prelude::MeshMaterial2d")<M>> for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<M>

where M: [Material2d](../sprite_render/trait.Material2d.html "trait bevy::sprite_render::Material2d"),

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/material.rs.html#221)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(material: [MeshMaterial2d](../prelude/struct.MeshMaterial2d.html "struct bevy::prelude::MeshMaterial2d")<M>) -> [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<M>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/mesh_material.rs.html#57)

### impl<M> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[MeshMaterial3d](../prelude/struct.MeshMaterial3d.html "struct bevy::prelude::MeshMaterial3d")<M>> for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<M>

where M: [Material](../prelude/trait.Material.html "trait bevy::prelude::Material"),

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/mesh_material.rs.html#58)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(material: [MeshMaterial3d](../prelude/struct.MeshMaterial3d.html "struct bevy::prelude::MeshMaterial3d")<M>) -> [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<M>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/meshlet/mod.rs.html#237)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[MeshletMesh3d](../pbr/experimental/meshlet/struct.MeshletMesh3d.html "struct bevy::pbr::experimental::meshlet::MeshletMesh3d")\> for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[MeshletMesh](../pbr/experimental/meshlet/struct.MeshletMesh.html "struct bevy::pbr::experimental::meshlet::MeshletMesh")\>

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/meshlet/mod.rs.html#238)
...
### impl<A> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Uuid](uuid/struct.Uuid.html "struct bevy::asset::uuid::Uuid")\> for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#21)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Uuid](uuid/struct.Uuid.html "struct bevy::asset::uuid::Uuid")) -> [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#21)

### impl<A> [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset") + [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath"), [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>: [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#21)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#21)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A> as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)(\_\_param0: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>>
...
### impl<A> [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>
...
### impl<A> [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#125)

### impl<A> [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#127)
...
### impl<A> [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>
...
where [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>: 'into\_return,
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#148)

### impl<A> [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#149)

#### fn [cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html#tymethod.cmp)(&self, other: &[AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#133)

### impl<A> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#135)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#356)

### impl<A> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq")<[AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>> for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#358)
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#349)

### impl<A> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq")<[UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")\> for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#351)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#142)

### impl<A> [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#143)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")\>
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#374)

### impl<A> [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd")<[AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>> for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#376)
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#363)

### impl<A> [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd")<[UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")\> for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#365)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")\>
...
### impl<A> [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>
...
#### fn [reflect\_owned](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#21)

#### fn [try\_into\_reflect](../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#22)
...
#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<A> [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#393)

### impl<A> [TryFrom](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html "trait core::convert::TryFrom")<[UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")\> for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#394)

#### type [Error](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html#associatedtype.Error) = [UntypedAssetIdConversionError](enum.UntypedAssetIdConversionError.html "enum bevy::asset::UntypedAssetIdConversionError")

The type returned in the event of a conversion error.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#397)

#### fn [try\_from](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html#tymethod.try_from)( value: [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>, <[AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A> as [TryFrom](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html "trait core::convert::TryFrom")<[UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")\>>::[Error](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html#associatedtype.Error "type core::convert::TryFrom::Error")\>
...
### impl<A> [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>
...
### impl<A> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

### impl<A> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

### impl<A> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

### impl<A> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

### impl<A> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

### impl<A> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

### impl<A> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>
