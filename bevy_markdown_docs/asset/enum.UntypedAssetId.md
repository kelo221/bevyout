...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#168)
...
A small / efficient runtime identifier that can be used to efficiently look up an asset stored in [`Assets`](../prelude/struct.Assets.html "struct bevy::prelude::Assets"). This is the “default” identifier used for assets. The alternative(s) (ex: [`UntypedAssetId::Uuid`](enum.UntypedAssetId.html#variant.Uuid "variant bevy::asset::UntypedAssetId::Uuid")) will only be used if assets are explicitly registered that way.

#### Fields

`type_id: [TypeId](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId")`
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#192)

### impl [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#197)

#### pub fn [typed\_unchecked](#method.typed_unchecked)<A>(self) -> [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

Converts this to a “typed” [`AssetId`](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId") without checking the stored type to see if it matches the target `A` [`Asset`](../prelude/trait.Asset.html "trait bevy::prelude::Asset") type. This should only be called if you are _absolutely certain_ the asset type matches the stored type. And even then, you should consider using [`UntypedAssetId::typed_debug_checked`](enum.UntypedAssetId.html#method.typed_debug_checked "method bevy::asset::UntypedAssetId::typed_debug_checked") instead.

##### [Examples found in repository](#scraped-examples)[?](../../scrape-examples-help.html)

examples/2d/texture\_atlas.rs ([line 227](../../src/texture_atlas/texture_atlas.rs.html#227))
...
244    let mut image = textures.get_mut(&texture).unwrap();
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#214)

#### pub fn [typed\_debug\_checked](#method.typed_debug_checked)<A>(self) -> [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

Converts this to a “typed” [`AssetId`](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId"). When compiled in debug-mode it will check to see if the stored type matches the target `A` [`Asset`](../prelude/trait.Asset.html "trait bevy::prelude::Asset") type. When compiled in release-mode, this check will be skipped.

##### Panics

Panics if compiled in debug mode and the [`TypeId`](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId") of `A` does not match the stored [`TypeId`](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId").

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#230)

#### pub fn [typed](#method.typed)<A>(self) -> [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

Converts this to a “typed” [`AssetId`](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId").

##### Panics

Panics if the [`TypeId`](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId") of `A` does not match the stored type id.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#243)

#### pub fn [try\_typed](#method.try_typed)<A>(self) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<A>, [UntypedAssetIdConversionError](enum.UntypedAssetIdConversionError.html "enum bevy::asset::UntypedAssetIdConversionError")\>

where A: [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset"),

Try to convert this to a “typed” [`AssetId`](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId").

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#249)

#### pub fn [type\_id](#method.type_id)(&self) -> [TypeId](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId")

Returns the stored [`TypeId`](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId") of the referenced [`Asset`](../prelude/trait.Asset.html "trait bevy::prelude::Asset").

## Trait Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#167)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#167)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#167)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#266)

### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#267)
...
### impl [Enum](../reflect/enums/trait.Enum.html "trait bevy::reflect::enums::Enum") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#291)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#625)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&[UntypedHandle](../prelude/enum.UntypedHandle.html "enum bevy::prelude::UntypedHandle")\> for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/handle.rs.html#627)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: &[UntypedHandle](../prelude/enum.UntypedHandle.html "enum bevy::prelude::UntypedHandle")) -> [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#447)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<ErasedAssetIndex> for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#448)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: ErasedAssetIndex) -> [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#167)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#167)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#167)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#167)

### impl [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#167)

#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)( \_\_param0: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#293)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#295)
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")
...
where [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId"): 'into\_return,
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#301)

### impl [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#302)

#### fn [cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html#tymethod.cmp)(&self, other: &[UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#284)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#286)
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#309)

### impl [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#310)
...
### impl [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")
...
#### fn [reflect\_owned](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#167)

#### fn [try\_into\_reflect](../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
### impl [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/id.rs.html#167)

#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/lib.rs.html#500)
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [UntypedAssetId](enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")
