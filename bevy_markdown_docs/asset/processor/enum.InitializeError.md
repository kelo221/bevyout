...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/mod.rs.html#1821)
...
### FailedToReadSourcePaths([AssetReaderError](../io/enum.AssetReaderError.html "enum bevy::asset::io::AssetReaderError"))

### FailedToReadDestinationPaths([AssetReaderError](../io/enum.AssetReaderError.html "enum bevy::asset::io::AssetReaderError"))

### ValidateLogError([ValidateLogError](enum.ValidateLogError.html "enum bevy::asset::processor::ValidateLogError"))

## Trait Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/mod.rs.html#1820)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [InitializeError](enum.InitializeError.html "enum bevy::asset::processor::InitializeError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [InitializeError](enum.InitializeError.html "enum bevy::asset::processor::InitializeError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [InitializeError](enum.InitializeError.html "enum bevy::asset::processor::InitializeError")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [InitializeError](enum.InitializeError.html "enum bevy::asset::processor::InitializeError")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [InitializeError](enum.InitializeError.html "enum bevy::asset::processor::InitializeError")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [InitializeError](enum.InitializeError.html "enum bevy::asset::processor::InitializeError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [InitializeError](enum.InitializeError.html "enum bevy::asset::processor::InitializeError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [InitializeError](enum.InitializeError.html "enum bevy::asset::processor::InitializeError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [InitializeError](enum.InitializeError.html "enum bevy::asset::processor::InitializeError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [InitializeError](enum.InitializeError.html "enum bevy::asset::processor::InitializeError")
