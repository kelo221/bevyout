...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/log.rs.html#239)
...
### InvalidLine([String](../../prelude/struct.String.html "struct bevy::prelude::String"))
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ReadLogError](enum.ReadLogError.html "enum bevy::asset::processor::ReadLogError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [ReadLogError](enum.ReadLogError.html "enum bevy::asset::processor::ReadLogError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [ReadLogError](enum.ReadLogError.html "enum bevy::asset::processor::ReadLogError")
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Error](../../tasks/futures_lite/io/struct.Error.html "struct bevy::tasks::futures_lite::io::Error")\> for [ReadLogError](enum.ReadLogError.html "enum bevy::asset::processor::ReadLogError")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/log.rs.html#238)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(source: [Error](../../tasks/futures_lite/io/struct.Error.html "struct bevy::tasks::futures_lite::io::Error")) -> [ReadLogError](enum.ReadLogError.html "enum bevy::asset::processor::ReadLogError")

Converts to this type from the input type.

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ReadLogError](enum.ReadLogError.html "enum bevy::asset::processor::ReadLogError")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ReadLogError](enum.ReadLogError.html "enum bevy::asset::processor::ReadLogError")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ReadLogError](enum.ReadLogError.html "enum bevy::asset::processor::ReadLogError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ReadLogError](enum.ReadLogError.html "enum bevy::asset::processor::ReadLogError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ReadLogError](enum.ReadLogError.html "enum bevy::asset::processor::ReadLogError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ReadLogError](enum.ReadLogError.html "enum bevy::asset::processor::ReadLogError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ReadLogError](enum.ReadLogError.html "enum bevy::asset::processor::ReadLogError")
