...
# Enum GetProcessorError 

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/mod.rs.html#1839)
...
### Missing([String](../../prelude/struct.String.html "struct bevy::prelude::String"))
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/mod.rs.html#1838)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [GetProcessorError](enum.GetProcessorError.html "enum bevy::asset::processor::GetProcessorError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [GetProcessorError](enum.GetProcessorError.html "enum bevy::asset::processor::GetProcessorError")
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [GetProcessorError](enum.GetProcessorError.html "enum bevy::asset::processor::GetProcessorError")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/mod.rs.html#1838)

### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [GetProcessorError](enum.GetProcessorError.html "enum bevy::asset::processor::GetProcessorError")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [GetProcessorError](enum.GetProcessorError.html "enum bevy::asset::processor::GetProcessorError")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/mod.rs.html#1838)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[GetProcessorError](enum.GetProcessorError.html "enum bevy::asset::processor::GetProcessorError")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [GetProcessorError](enum.GetProcessorError.html "enum bevy::asset::processor::GetProcessorError")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [GetProcessorError](enum.GetProcessorError.html "enum bevy::asset::processor::GetProcessorError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [GetProcessorError](enum.GetProcessorError.html "enum bevy::asset::processor::GetProcessorError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [GetProcessorError](enum.GetProcessorError.html "enum bevy::asset::processor::GetProcessorError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [GetProcessorError](enum.GetProcessorError.html "enum bevy::asset::processor::GetProcessorError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [GetProcessorError](enum.GetProcessorError.html "enum bevy::asset::processor::GetProcessorError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [GetProcessorError](enum.GetProcessorError.html "enum bevy::asset::processor::GetProcessorError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [GetProcessorError](enum.GetProcessorError.html "enum bevy::asset::processor::GetProcessorError")
