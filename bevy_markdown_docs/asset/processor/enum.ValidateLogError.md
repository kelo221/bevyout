...
# Enum ValidateLogError 

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/log.rs.html#260)
...
### ReadLogError([BevyError](../../prelude/struct.BevyError.html "struct bevy::prelude::BevyError"))

A [`ReadLogError`](enum.ReadLogError.html "enum bevy::asset::processor::ReadLogError").

### EntryErrors([Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[LogEntryError](enum.LogEntryError.html "enum bevy::asset::processor::LogEntryError")\>)

Duplicated process asset transactions occurred.

## Trait Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/log.rs.html#259)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ValidateLogError](enum.ValidateLogError.html "enum bevy::asset::processor::ValidateLogError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [ValidateLogError](enum.ValidateLogError.html "enum bevy::asset::processor::ValidateLogError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [ValidateLogError](enum.ValidateLogError.html "enum bevy::asset::processor::ValidateLogError")
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/mod.rs.html#1827)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[ValidateLogError](enum.ValidateLogError.html "enum bevy::asset::processor::ValidateLogError")\> for [InitializeError](enum.InitializeError.html "enum bevy::asset::processor::InitializeError")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/mod.rs.html#1820)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(source: [ValidateLogError](enum.ValidateLogError.html "enum bevy::asset::processor::ValidateLogError")) -> [InitializeError](enum.InitializeError.html "enum bevy::asset::processor::InitializeError")

Converts to this type from the input type.

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ValidateLogError](enum.ValidateLogError.html "enum bevy::asset::processor::ValidateLogError")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ValidateLogError](enum.ValidateLogError.html "enum bevy::asset::processor::ValidateLogError")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ValidateLogError](enum.ValidateLogError.html "enum bevy::asset::processor::ValidateLogError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ValidateLogError](enum.ValidateLogError.html "enum bevy::asset::processor::ValidateLogError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ValidateLogError](enum.ValidateLogError.html "enum bevy::asset::processor::ValidateLogError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ValidateLogError](enum.ValidateLogError.html "enum bevy::asset::processor::ValidateLogError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ValidateLogError](enum.ValidateLogError.html "enum bevy::asset::processor::ValidateLogError")
