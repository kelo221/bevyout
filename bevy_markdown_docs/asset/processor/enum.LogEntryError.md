...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/log.rs.html#274)
...
### DuplicateTransaction([AssetPath](../struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>)

A duplicate process asset transaction occurred for the given asset path.

### EndedMissingTransaction([AssetPath](../struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>)

A transaction was ended that never started for the given asset path.

### UnfinishedTransaction([AssetPath](../struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>)

An asset started processing but never finished at the given asset path.

## Trait Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/log.rs.html#273)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [LogEntryError](enum.LogEntryError.html "enum bevy::asset::processor::LogEntryError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [LogEntryError](enum.LogEntryError.html "enum bevy::asset::processor::LogEntryError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [LogEntryError](enum.LogEntryError.html "enum bevy::asset::processor::LogEntryError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [LogEntryError](enum.LogEntryError.html "enum bevy::asset::processor::LogEntryError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [LogEntryError](enum.LogEntryError.html "enum bevy::asset::processor::LogEntryError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [LogEntryError](enum.LogEntryError.html "enum bevy::asset::processor::LogEntryError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [LogEntryError](enum.LogEntryError.html "enum bevy::asset::processor::LogEntryError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [LogEntryError](enum.LogEntryError.html "enum bevy::asset::processor::LogEntryError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [LogEntryError](enum.LogEntryError.html "enum bevy::asset::processor::LogEntryError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [LogEntryError](enum.LogEntryError.html "enum bevy::asset::processor::LogEntryError")
