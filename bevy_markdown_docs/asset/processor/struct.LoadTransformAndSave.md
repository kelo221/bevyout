...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/process.rs.html#66-70)

```rust
pub struct LoadTransformAndSave<L, T, S>where
    L: AssetLoader,
...
When creating custom processors, it is generally recommended to use the [`LoadTransformAndSave`](struct.LoadTransformAndSave.html "struct bevy::asset::processor::LoadTransformAndSave") [`Process`](trait.Process.html "trait bevy::asset::processor::Process") implementation, as it encourages you to separate your code into an [`AssetLoader`](../trait.AssetLoader.html "trait bevy::asset::AssetLoader") capable of loading assets without processing enabled, an [`AssetTransformer`](../transformer/trait.AssetTransformer.html "trait bevy::asset::transformer::AssetTransformer") capable of converting from an `L` asset to an `S` asset, and an [`AssetSaver`](../saver/trait.AssetSaver.html "trait bevy::asset::saver::AssetSaver") that allows you save any `S` asset. However you can also implement [`Process`](trait.Process.html "trait bevy::asset::processor::Process") directly if [`LoadTransformAndSave`](struct.LoadTransformAndSave.html "struct bevy::asset::processor::LoadTransformAndSave") feels limiting or unnecessary.

If your [`Process`](trait.Process.html "trait bevy::asset::processor::Process") does not need to transform the [`Asset`](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"), you can use [`IdentityAssetTransformer`](../transformer/struct.IdentityAssetTransformer.html "struct bevy::asset::transformer::IdentityAssetTransformer") as `T`. This will directly return the input [`Asset`](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"), allowing your [`Process`](trait.Process.html "trait bevy::asset::processor::Process") to directly load and then save an [`Asset`](../../prelude/trait.Asset.html "trait bevy::prelude::Asset"). However, this pattern should only be used for cases such as file format conversion. Otherwise, consider refactoring your [`AssetLoader`](../trait.AssetLoader.html "trait bevy::asset::AssetLoader") and [`AssetSaver`](../saver/trait.AssetSaver.html "trait bevy::asset::saver::AssetSaver") to isolate the transformation step into an explicit [`AssetTransformer`](../transformer/trait.AssetTransformer.html "trait bevy::asset::transformer::AssetTransformer").

This uses [`LoadTransformAndSaveSettings`](struct.LoadTransformAndSaveSettings.html "struct bevy::asset::processor::LoadTransformAndSaveSettings") to configure the processor.

## Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/process.rs.html#102-106)

### impl<L, T, S> [LoadTransformAndSave](struct.LoadTransformAndSave.html "struct bevy::asset::processor::LoadTransformAndSave")<L, T, S>

where L: [AssetLoader](../trait.AssetLoader.html "trait bevy::asset::AssetLoader"), T: [AssetTransformer](../transformer/trait.AssetTransformer.html "trait bevy::asset::transformer::AssetTransformer")<AssetInput = <L as [AssetLoader](../trait.AssetLoader.html "trait bevy::asset::AssetLoader")\>::[Asset](../trait.AssetLoader.html#associatedtype.Asset "type bevy::asset::AssetLoader::Asset")\>, S: [AssetSaver](../saver/trait.AssetSaver.html "trait bevy::asset::saver::AssetSaver")<Asset = <T as [AssetTransformer](../transformer/trait.AssetTransformer.html "trait bevy::asset::transformer::AssetTransformer")\>::[AssetOutput](../transformer/trait.AssetTransformer.html#associatedtype.AssetOutput "type bevy::asset::transformer::AssetTransformer::AssetOutput")\>,

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/process.rs.html#108)

#### pub fn [new](#method.new)(transformer: T, saver: S) -> [LoadTransformAndSave](struct.LoadTransformAndSave.html "struct bevy::asset::processor::LoadTransformAndSave")<L, T, S>

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/asset/processing/asset\_processing.rs ([line 63](../../../src/asset_processing/asset_processing.rs.html#63))
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/process.rs.html#76-77)

### impl<L, S> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<S> for [LoadTransformAndSave](struct.LoadTransformAndSave.html "struct bevy::asset::processor::LoadTransformAndSave")<L, [IdentityAssetTransformer](../transformer/struct.IdentityAssetTransformer.html "struct bevy::asset::transformer::IdentityAssetTransformer")<<L as [AssetLoader](../trait.AssetLoader.html "trait bevy::asset::AssetLoader")\>::[Asset](../trait.AssetLoader.html#associatedtype.Asset "type bevy::asset::AssetLoader::Asset")\>, S>

where L: [AssetLoader](../trait.AssetLoader.html "trait bevy::asset::AssetLoader"), S: [AssetSaver](../saver/trait.AssetSaver.html "trait bevy::asset::saver::AssetSaver")<Asset = <L as [AssetLoader](../trait.AssetLoader.html "trait bevy::asset::AssetLoader")\>::[Asset](../trait.AssetLoader.html#associatedtype.Asset "type bevy::asset::AssetLoader::Asset")\>,

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/process.rs.html#79)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)( value: S, ) -> [LoadTransformAndSave](struct.LoadTransformAndSave.html "struct bevy::asset::processor::LoadTransformAndSave")<L, [IdentityAssetTransformer](../transformer/struct.IdentityAssetTransformer.html "struct bevy::asset::transformer::IdentityAssetTransformer")<<L as [AssetLoader](../trait.AssetLoader.html "trait bevy::asset::AssetLoader")\>::[Asset](../trait.AssetLoader.html#associatedtype.Asset "type bevy::asset::AssetLoader::Asset")\>, S>
...
#### type [OutputLoader](trait.Process.html#associatedtype.OutputLoader) = <Saver as [AssetSaver](../saver/trait.AssetSaver.html "trait bevy::asset::saver::AssetSaver")\>::[OutputLoader](../saver/trait.AssetSaver.html#associatedtype.OutputLoader "type bevy::asset::saver::AssetSaver::OutputLoader")

The [`AssetLoader`](../trait.AssetLoader.html "trait bevy::asset::AssetLoader") that will be used to load the final processed asset.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/process.rs.html#182-187)

#### async fn [process](trait.Process.html#tymethod.process)( &self, context: &mut [ProcessContext](struct.ProcessContext.html "struct bevy::asset::processor::ProcessContext")<'\_>, settings: &<[LoadTransformAndSave](struct.LoadTransformAndSave.html "struct bevy::asset::processor::LoadTransformAndSave")<Loader, Transformer, Saver> as [Process](trait.Process.html "trait bevy::asset::processor::Process")\>::[Settings](trait.Process.html#associatedtype.Settings "type bevy::asset::processor::Process::Settings"), writer: &mut (dyn [AsyncWrite](../../tasks/futures_lite/trait.AsyncWrite.html "trait bevy::tasks::futures_lite::AsyncWrite") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<<[LoadTransformAndSave](struct.LoadTransformAndSave.html "struct bevy::asset::processor::LoadTransformAndSave")<Loader, Transformer, Saver> as [Process](trait.Process.html "trait bevy::asset::processor::Process")\>::[OutputLoader](trait.Process.html#associatedtype.OutputLoader "type bevy::asset::processor::Process::OutputLoader") as [AssetLoader](../trait.AssetLoader.html "trait bevy::asset::AssetLoader")\>::[Settings](../trait.AssetLoader.html#associatedtype.Settings "type bevy::asset::AssetLoader::Settings"), [ProcessError](enum.ProcessError.html "enum bevy::asset::processor::ProcessError")\>
...
### impl<L, T, S> [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [LoadTransformAndSave](struct.LoadTransformAndSave.html "struct bevy::asset::processor::LoadTransformAndSave")<L, T, S>

where L: [AssetLoader](../trait.AssetLoader.html "trait bevy::asset::AssetLoader") + [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath"), T: [AssetTransformer](../transformer/trait.AssetTransformer.html "trait bevy::asset::transformer::AssetTransformer")<AssetInput = <L as [AssetLoader](../trait.AssetLoader.html "trait bevy::asset::AssetLoader")\>::[Asset](../trait.AssetLoader.html#associatedtype.Asset "type bevy::asset::AssetLoader::Asset")\> + [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath"), S: [AssetSaver](../saver/trait.AssetSaver.html "trait bevy::asset::saver::AssetSaver")<Asset = <T as [AssetTransformer](../transformer/trait.AssetTransformer.html "trait bevy::asset::transformer::AssetTransformer")\>::[AssetOutput](../transformer/trait.AssetTransformer.html#associatedtype.AssetOutput "type bevy::asset::transformer::AssetTransformer::AssetOutput")\> + [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath"), [LoadTransformAndSave](struct.LoadTransformAndSave.html "struct bevy::asset::processor::LoadTransformAndSave")<L, T, S>: [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),
...
### impl<L, T, S> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [LoadTransformAndSave](struct.LoadTransformAndSave.html "struct bevy::asset::processor::LoadTransformAndSave")<L, T, S>

where T: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"), S: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"),

### impl<L, T, S> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [LoadTransformAndSave](struct.LoadTransformAndSave.html "struct bevy::asset::processor::LoadTransformAndSave")<L, T, S>

where T: [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"), S: [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"),

### impl<L, T, S> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [LoadTransformAndSave](struct.LoadTransformAndSave.html "struct bevy::asset::processor::LoadTransformAndSave")<L, T, S>

### impl<L, T, S> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [LoadTransformAndSave](struct.LoadTransformAndSave.html "struct bevy::asset::processor::LoadTransformAndSave")<L, T, S>

### impl<L, T, S> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [LoadTransformAndSave](struct.LoadTransformAndSave.html "struct bevy::asset::processor::LoadTransformAndSave")<L, T, S>

where T: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"), S: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<L, T, S> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [LoadTransformAndSave](struct.LoadTransformAndSave.html "struct bevy::asset::processor::LoadTransformAndSave")<L, T, S>

where T: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"), S: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"),

### impl<L, T, S> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [LoadTransformAndSave](struct.LoadTransformAndSave.html "struct bevy::asset::processor::LoadTransformAndSave")<L, T, S>

where T: [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"), S: [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"),
...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/process.rs.html#271)

#### fn [type\_path](trait.ErasedProcessor.html#tymethod.type_path)(&self) -> &'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)

Returns the type-path of the original [`Process`](trait.Process.html "trait bevy::asset::processor::Process").

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/process.rs.html#275)

#### fn [short\_type\_path](trait.ErasedProcessor.html#tymethod.short_type_path)(&self) -> &'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)

Returns the short type path of this processor.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/process.rs.html#279)

#### fn [default\_meta](trait.ErasedProcessor.html#tymethod.default_meta)( &self, processor\_path\_kind: [MetaTypePathKind](enum.MetaTypePathKind.html "enum bevy::asset::processor::MetaTypePathKind"), ) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [AssetMetaDyn](../meta/trait.AssetMetaDyn.html "trait bevy::asset::meta::AssetMetaDyn")\>
