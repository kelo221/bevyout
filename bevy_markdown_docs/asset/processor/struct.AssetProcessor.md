...
[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/mod.rs.html#98)
...
This will create .meta files (a human-editable serialized form of [`AssetMeta`](../meta/struct.AssetMeta.html "struct bevy::asset::meta::AssetMeta")) in the source [`AssetSource`](../io/struct.AssetSource.html "struct bevy::asset::io::AssetSource") for assets that can be loaded and/or processed. This enables developers to configure how each asset should be loaded and/or processed.

[`AssetProcessor`](struct.AssetProcessor.html "struct bevy::asset::processor::AssetProcessor") can be run in the background while a Bevy App is running. Changes to assets will be automatically detected and hot-reloaded.
...
A [`ProcessorTransactionLog`](trait.ProcessorTransactionLog.html "trait bevy::asset::processor::ProcessorTransactionLog") is produced, which uses “write-ahead logging” to make the [`AssetProcessor`](struct.AssetProcessor.html "struct bevy::asset::processor::AssetProcessor") crash and failure resistant. If a failed/unfinished transaction from a previous run is detected, the affected asset(s) will be re-processed.

[`AssetProcessor`](struct.AssetProcessor.html "struct bevy::asset::processor::AssetProcessor") can be cloned. It is backed by an [`Arc`](../../platform/sync/struct.Arc.html "struct bevy::platform::sync::Arc") so clones will share state. Clones can be freely used in parallel.

## Implementations

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/mod.rs.html#158)

### impl [AssetProcessor](struct.AssetProcessor.html "struct bevy::asset::processor::AssetProcessor")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/mod.rs.html#160-163)

#### pub fn [new](#method.new)( sources: &mut [AssetSourceBuilders](../io/struct.AssetSourceBuilders.html "struct bevy::asset::io::AssetSourceBuilders"), watch\_processed: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), ) -> ([AssetProcessor](struct.AssetProcessor.html "struct bevy::asset::processor::AssetProcessor"), [Arc](../../platform/sync/struct.Arc.html "struct bevy::platform::sync::Arc")<[AssetSources](../io/struct.AssetSources.html "struct bevy::asset::io::AssetSources")\>)

Creates a new [`AssetProcessor`](struct.AssetProcessor.html "struct bevy::asset::processor::AssetProcessor") instance.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/mod.rs.html#182)

#### pub fn [data](#method.data)(&self) -> &[Arc](../../platform/sync/struct.Arc.html "struct bevy::platform::sync::Arc")<[AssetProcessorData](struct.AssetProcessorData.html "struct bevy::asset::processor::AssetProcessorData")\> [ⓘ](#)

Gets a reference to the [`Arc`](../../platform/sync/struct.Arc.html "struct bevy::platform::sync::Arc") containing the [`AssetProcessorData`](struct.AssetProcessorData.html "struct bevy::asset::processor::AssetProcessorData").

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/mod.rs.html#188)

#### pub fn [server](#method.server)(&self) -> &[AssetServer](../../prelude/struct.AssetServer.html "struct bevy::prelude::AssetServer")

The “internal” [`AssetServer`](../../prelude/struct.AssetServer.html "struct bevy::prelude::AssetServer") used by the [`AssetProcessor`](struct.AssetProcessor.html "struct bevy::asset::processor::AssetProcessor"). This is _separate_ from the asset processor used by the main App. It has different processor-specific configuration and a different ID space.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/mod.rs.html#193)

#### pub async fn [get\_state](#method.get_state)(&self) -> [ProcessorState](enum.ProcessorState.html "enum bevy::asset::processor::ProcessorState")

Retrieves the current [`ProcessorState`](enum.ProcessorState.html "enum bevy::asset::processor::ProcessorState")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/mod.rs.html#199-202)

#### pub fn [get\_source](#method.get_source)<'a>( &self, id: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[AssetSourceId](../io/enum.AssetSourceId.html "enum bevy::asset::io::AssetSourceId")<'a>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<&[AssetSource](../io/struct.AssetSource.html "struct bevy::asset::io::AssetSource"), [MissingAssetSourceError](../io/struct.MissingAssetSourceError.html "struct bevy::asset::io::MissingAssetSourceError")\>

Retrieves the [`AssetSource`](../io/struct.AssetSource.html "struct bevy::asset::io::AssetSource") for this processor

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/mod.rs.html#207)

#### pub fn [sources](#method.sources)(&self) -> &[AssetSources](../io/struct.AssetSources.html "struct bevy::asset::io::AssetSources")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/mod.rs.html#253)

#### pub fn [start](#method.start)(processor: [Res](../../prelude/struct.Res.html "struct bevy::prelude::Res")<'\_, [AssetProcessor](struct.AssetProcessor.html "struct bevy::asset::processor::AssetProcessor")\>)

Starts the processor in a background thread.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/mod.rs.html#432-435)

#### pub async fn [write\_default\_meta\_file\_for\_path](#method.write_default_meta_file_for_path)( &self, path: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[AssetPath](../struct.AssetPath.html "struct bevy::asset::AssetPath")<'\_>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [WriteDefaultMetaError](../enum.WriteDefaultMetaError.html "enum bevy::asset::WriteDefaultMetaError")\>

Writes the default meta file for the provided `path`.

This function generates the appropriate meta file to process `path` with the default processor. If there is no default processor, it falls back to the default loader.

Note if there is already a meta file for `path`, this function returns `Err(WriteDefaultMetaError::MetaAlreadyExists)`.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/mod.rs.html#746)

#### pub fn [register\_processor](#method.register_processor)<P>(&self, processor: P)

where P: [Process](trait.Process.html "trait bevy::asset::processor::Process"),

Register a new asset processor.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/mod.rs.html#780)

#### pub fn [set\_default\_processor](#method.set_default_processor)<P>(&self, extension: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html))

where P: [Process](trait.Process.html "trait bevy::asset::processor::Process"),

Set the default processor for the given `extension`. Make sure `P` is registered with [`AssetProcessor::register_processor`](struct.AssetProcessor.html#method.register_processor "method bevy::asset::processor::AssetProcessor::register_processor").

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/mod.rs.html#792)

#### pub fn [get\_default\_processor](#method.get_default_processor)( &self, extension: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Arc](../../platform/sync/struct.Arc.html "struct bevy::platform::sync::Arc")<dyn [ErasedProcessor](trait.ErasedProcessor.html "trait bevy::asset::processor::ErasedProcessor")\>>

Returns the default processor for the given `extension`, if it exists.

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/mod.rs.html#805-808)

#### pub fn [get\_processor](#method.get_processor)( &self, processor\_type\_name: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Arc](../../platform/sync/struct.Arc.html "struct bevy::platform::sync::Arc")<dyn [ErasedProcessor](trait.ErasedProcessor.html "trait bevy::asset::processor::ErasedProcessor")\>, [GetProcessorError](enum.GetProcessorError.html "enum bevy::asset::processor::GetProcessorError")\>
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [AssetProcessor](struct.AssetProcessor.html "struct bevy::asset::processor::AssetProcessor")

[Source](https://docs.rs/bevy_asset/0.19.0/x86_64-unknown-linux-gnu/src/bevy_asset/processor/mod.rs.html#97)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [AssetProcessor](struct.AssetProcessor.html "struct bevy::asset::processor::AssetProcessor")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [AssetProcessor](struct.AssetProcessor.html "struct bevy::asset::processor::AssetProcessor")

where [AssetProcessor](struct.AssetProcessor.html "struct bevy::asset::processor::AssetProcessor"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [AssetProcessor](struct.AssetProcessor.html "struct bevy::asset::processor::AssetProcessor")

where [AssetProcessor](struct.AssetProcessor.html "struct bevy::asset::processor::AssetProcessor"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AssetProcessor](struct.AssetProcessor.html "struct bevy::asset::processor::AssetProcessor")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AssetProcessor](struct.AssetProcessor.html "struct bevy::asset::processor::AssetProcessor")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AssetProcessor](struct.AssetProcessor.html "struct bevy::asset::processor::AssetProcessor")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AssetProcessor](struct.AssetProcessor.html "struct bevy::asset::processor::AssetProcessor")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AssetProcessor](struct.AssetProcessor.html "struct bevy::asset::processor::AssetProcessor")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AssetProcessor](struct.AssetProcessor.html "struct bevy::asset::processor::AssetProcessor")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AssetProcessor](struct.AssetProcessor.html "struct bevy::asset::processor::AssetProcessor")
