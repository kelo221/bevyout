...
# Struct MeshViewBindGroup 

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh_view_bindings.rs.html#619)
...
`main: [BindGroup](../render/render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup")``main_offsets: [ArrayVec](https://docs.rs/arrayvec/0.7.6/x86_64-unknown-linux-gnu/arrayvec/arrayvec/struct.ArrayVec.html "struct arrayvec::arrayvec::ArrayVec")<[u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html), 7>``binding_array: [BindGroup](../render/render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup")``empty: [BindGroup](../render/render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup")`

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh_view_bindings.rs.html#618)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [MeshViewBindGroup](struct.MeshViewBindGroup.html "struct bevy::pbr::MeshViewBindGroup")

where [MeshViewBindGroup](struct.MeshViewBindGroup.html "struct bevy::pbr::MeshViewBindGroup"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MeshViewBindGroup](struct.MeshViewBindGroup.html "struct bevy::pbr::MeshViewBindGroup")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MeshViewBindGroup](struct.MeshViewBindGroup.html "struct bevy::pbr::MeshViewBindGroup")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MeshViewBindGroup](struct.MeshViewBindGroup.html "struct bevy::pbr::MeshViewBindGroup")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MeshViewBindGroup](struct.MeshViewBindGroup.html "struct bevy::pbr::MeshViewBindGroup")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MeshViewBindGroup](struct.MeshViewBindGroup.html "struct bevy::pbr::MeshViewBindGroup")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MeshViewBindGroup](struct.MeshViewBindGroup.html "struct bevy::pbr::MeshViewBindGroup")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MeshViewBindGroup](struct.MeshViewBindGroup.html "struct bevy::pbr::MeshViewBindGroup")
