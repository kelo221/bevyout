...
# Struct PrepassViewBindGroup 

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/prepass/mod.rs.html#712)
...
`motion_vectors: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[BindGroup](../render/render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup")>``no_motion_vectors: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[BindGroup](../render/render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup")>``empty_bind_group: [BindGroup](../render/render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup")`

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/prepass/mod.rs.html#711)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [PrepassViewBindGroup](struct.PrepassViewBindGroup.html "struct bevy::pbr::PrepassViewBindGroup")

where [PrepassViewBindGroup](struct.PrepassViewBindGroup.html "struct bevy::pbr::PrepassViewBindGroup"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [PrepassViewBindGroup](struct.PrepassViewBindGroup.html "struct bevy::pbr::PrepassViewBindGroup")

where [PrepassViewBindGroup](struct.PrepassViewBindGroup.html "struct bevy::pbr::PrepassViewBindGroup"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [PrepassViewBindGroup](struct.PrepassViewBindGroup.html "struct bevy::pbr::PrepassViewBindGroup")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [PrepassViewBindGroup](struct.PrepassViewBindGroup.html "struct bevy::pbr::PrepassViewBindGroup")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [PrepassViewBindGroup](struct.PrepassViewBindGroup.html "struct bevy::pbr::PrepassViewBindGroup")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [PrepassViewBindGroup](struct.PrepassViewBindGroup.html "struct bevy::pbr::PrepassViewBindGroup")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [PrepassViewBindGroup](struct.PrepassViewBindGroup.html "struct bevy::pbr::PrepassViewBindGroup")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [PrepassViewBindGroup](struct.PrepassViewBindGroup.html "struct bevy::pbr::PrepassViewBindGroup")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [PrepassViewBindGroup](struct.PrepassViewBindGroup.html "struct bevy::pbr::PrepassViewBindGroup")
