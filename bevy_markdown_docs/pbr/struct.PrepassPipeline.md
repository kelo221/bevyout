...
# Struct PrepassPipeline 

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/prepass/mod.rs.html#247)
...
`view_layout_motion_vectors: [BindGroupLayoutDescriptor](../material/descriptor/struct.BindGroupLayoutDescriptor.html "struct bevy::material::descriptor::BindGroupLayoutDescriptor")``view_layout_no_motion_vectors: [BindGroupLayoutDescriptor](../material/descriptor/struct.BindGroupLayoutDescriptor.html "struct bevy::material::descriptor::BindGroupLayoutDescriptor")``mesh_layouts: [MeshLayouts](struct.MeshLayouts.html "struct bevy::pbr::MeshLayouts")``empty_layout: [BindGroupLayoutDescriptor](../material/descriptor/struct.BindGroupLayoutDescriptor.html "struct bevy::material::descriptor::BindGroupLayoutDescriptor")``default_prepass_shader: [Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Shader](../prelude/struct.Shader.html "struct bevy::prelude::Shader")>``skins_use_uniform_buffers: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

Whether skins will use uniform buffers on account of storage buffers being unavailable on this platform.

`depth_clip_control_supported: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)``binding_arrays_are_usable: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

Whether binding arrays (a.k.a. bindless textures) are usable on the current render device.

`material_pipeline: [MaterialPipeline](struct.MaterialPipeline.html "struct bevy::pbr::MaterialPipeline")`

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/prepass/mod.rs.html#246)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [PrepassPipeline](struct.PrepassPipeline.html "struct bevy::pbr::PrepassPipeline")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/prepass/mod.rs.html#246)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [PrepassPipeline](struct.PrepassPipeline.html "struct bevy::pbr::PrepassPipeline")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [PrepassPipeline](struct.PrepassPipeline.html "struct bevy::pbr::PrepassPipeline")

where [PrepassPipeline](struct.PrepassPipeline.html "struct bevy::pbr::PrepassPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [PrepassPipeline](struct.PrepassPipeline.html "struct bevy::pbr::PrepassPipeline")

where [PrepassPipeline](struct.PrepassPipeline.html "struct bevy::pbr::PrepassPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [PrepassPipeline](struct.PrepassPipeline.html "struct bevy::pbr::PrepassPipeline")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [PrepassPipeline](struct.PrepassPipeline.html "struct bevy::pbr::PrepassPipeline")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [PrepassPipeline](struct.PrepassPipeline.html "struct bevy::pbr::PrepassPipeline")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [PrepassPipeline](struct.PrepassPipeline.html "struct bevy::pbr::PrepassPipeline")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [PrepassPipeline](struct.PrepassPipeline.html "struct bevy::pbr::PrepassPipeline")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [PrepassPipeline](struct.PrepassPipeline.html "struct bevy::pbr::PrepassPipeline")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [PrepassPipeline](struct.PrepassPipeline.html "struct bevy::pbr::PrepassPipeline")
