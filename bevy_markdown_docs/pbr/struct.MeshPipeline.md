...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#2666)
...
`view_layouts: [MeshPipelineViewLayouts](struct.MeshPipelineViewLayouts.html "struct bevy::pbr::MeshPipelineViewLayouts")`

A reference to all the mesh pipeline view layouts.

`clustered_forward_buffer_binding_type: [BufferBindingType](../render/render_resource/enum.BufferBindingType.html "enum bevy::render::render_resource::BufferBindingType")``mesh_layouts: [MeshLayouts](struct.MeshLayouts.html "struct bevy::pbr::MeshLayouts")``shader: [Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Shader](../prelude/struct.Shader.html "struct bevy::prelude::Shader")>`

The shader asset handle.

`per_object_buffer_batch_size: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)>`

`MeshUniform`s are stored in arrays in buffers. If storage buffers are available, they are used and this will be `None`, otherwise uniform buffers will be used with batches of this many `MeshUniform`s, stored at dynamic offsets within the uniform buffer. Use code like this in custom shaders:
...
`binding_arrays_are_usable: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`
...
`clustered_decals_are_usable: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

Whether clustered decals are usable on the current render device.

`skins_use_uniform_buffers: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

Whether skins will use uniform buffers on account of storage buffers being unavailable on this platform.

## Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#2731)

### impl [MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#2732)

#### pub fn [get\_view\_layout](#method.get_view_layout)( &self, layout\_key: [MeshPipelineViewLayoutKey](struct.MeshPipelineViewLayoutKey.html "struct bevy::pbr::MeshPipelineViewLayoutKey"), ) -> [MeshPipelineViewLayout](struct.MeshPipelineViewLayout.html "struct bevy::pbr::MeshPipelineViewLayout")

##### [Examples found in repository](#scraped-examples)[?](../../scrape-examples-help.html)

examples/shader\_advanced/custom\_render\_phase.rs ([line 200](../../src/custom_render_phase/custom_render_phase.rs.html#200))
...
examples/shader\_advanced/specialized\_mesh\_pipeline.rs ([line 212](../../src/specialized_mesh_pipeline/specialized_mesh_pipeline.rs.html#212))
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#2665)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline")

where [MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [GetBatchData](../render/batching/trait.GetBatchData.html "trait bevy::render::batching::GetBatchData") for [MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#2804)

#### type [Param](../render/batching/trait.GetBatchData.html#associatedtype.Param) = ([Res](../prelude/struct.Res.html "struct bevy::prelude::Res")<'static, [RenderMeshInstances](enum.RenderMeshInstances.html "enum bevy::pbr::RenderMeshInstances")\>, [Res](../prelude/struct.Res.html "struct bevy::prelude::Res")<'static, [RenderLightmaps](struct.RenderLightmaps.html "struct bevy::pbr::RenderLightmaps")\>, [Res](../prelude/struct.Res.html "struct bevy::prelude::Res")<'static, [RenderAssets](../render/render_asset/struct.RenderAssets.html "struct bevy::render::render_asset::RenderAssets")<[RenderMesh](../render/mesh/struct.RenderMesh.html "struct bevy::render::mesh::RenderMesh")\>>, [Res](../prelude/struct.Res.html "struct bevy::prelude::Res")<'static, [MeshAllocator](../render/mesh/allocator/struct.MeshAllocator.html "struct bevy::render::mesh::allocator::MeshAllocator")\>, [Res](../prelude/struct.Res.html "struct bevy::prelude::Res")<'static, [SkinUniforms](struct.SkinUniforms.html "struct bevy::pbr::SkinUniforms")\>, [Res](../prelude/struct.Res.html "struct bevy::prelude::Res")<'static, [MorphIndices](enum.MorphIndices.html "enum bevy::pbr::MorphIndices")\>)

The system parameters [`GetBatchData::get_batch_data`](../render/batching/trait.GetBatchData.html#tymethod.get_batch_data "associated function bevy::render::batching::GetBatchData::get_batch_data") needs in order to compute the batch data.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#2812)

#### type [BatchSetCompareData](../render/batching/trait.GetBatchData.html#associatedtype.BatchSetCompareData) = [MeshBatchSetCompareData](struct.MeshBatchSetCompareData.html "struct bevy::pbr::MeshBatchSetCompareData")

Data used for comparison between phase items to decide whether items can be grouped in the same batch set (i.e. multi-drawn). [Read more](../render/batching/trait.GetBatchData.html#associatedtype.BatchSetCompareData)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#2813)

#### type [BatchCompareData](../render/batching/trait.GetBatchData.html#associatedtype.BatchCompareData) = [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[Mesh](../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")\>

Data used for comparison between phase items to decide whether items can be batched. [Read more](../render/batching/trait.GetBatchData.html#associatedtype.BatchCompareData)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#2815)

#### type [BufferData](../render/batching/trait.GetBatchData.html#associatedtype.BufferData) = [MeshUniform](struct.MeshUniform.html "struct bevy::pbr::MeshUniform")

The per-instance data to be inserted into the [`crate::render_resource::GpuArrayBuffer`](../render/render_resource/enum.GpuArrayBuffer.html "enum bevy::render::render_resource::GpuArrayBuffer") containing these data for all instances.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#2817-2825)

#### fn [get\_batch\_data](../render/batching/trait.GetBatchData.html#tymethod.get_batch_data)( \_: &<<[MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline") as [GetBatchData](../render/batching/trait.GetBatchData.html "trait bevy::render::batching::GetBatchData")\>::[Param](../render/batching/trait.GetBatchData.html#associatedtype.Param "type bevy::render::batching::GetBatchData::Param") as [SystemParam](../ecs/system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[Item](../ecs/system/trait.SystemParam.html#associatedtype.Item "type bevy::ecs::system::SystemParam::Item")<'\_, '\_>, \_: ([Entity](../prelude/struct.Entity.html "struct bevy::prelude::Entity"), [MainEntity](../render/sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity")), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<(<[MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline") as [GetBatchData](../render/batching/trait.GetBatchData.html "trait bevy::render::batching::GetBatchData")\>::[BufferData](../render/batching/trait.GetBatchData.html#associatedtype.BufferData "type bevy::render::batching::GetBatchData::BufferData"), [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<(<[MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline") as [GetBatchData](../render/batching/trait.GetBatchData.html "trait bevy::render::batching::GetBatchData")\>::[BatchSetCompareData](../render/batching/trait.GetBatchData.html#associatedtype.BatchSetCompareData "type bevy::render::batching::GetBatchData::BatchSetCompareData"), <[MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline") as [GetBatchData](../render/batching/trait.GetBatchData.html "trait bevy::render::batching::GetBatchData")\>::[BatchCompareData](../render/batching/trait.GetBatchData.html#associatedtype.BatchCompareData "type bevy::render::batching::GetBatchData::BatchCompareData"))>)>

Get the per-instance data to be inserted into the [`crate::render_resource::GpuArrayBuffer`](../render/render_resource/enum.GpuArrayBuffer.html "enum bevy::render::render_resource::GpuArrayBuffer"). If the instance can be batched, also return the data used for comparison when deciding whether draws can be batched, else return None for the `CompareData`. [Read more](../render/batching/trait.GetBatchData.html#tymethod.get_batch_data)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#2868)

### impl [GetFullBatchData](../render/batching/trait.GetFullBatchData.html "trait bevy::render::batching::GetFullBatchData") for [MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#2869)

#### type [BufferInputData](../render/batching/trait.GetFullBatchData.html#associatedtype.BufferInputData) = [MeshInputUniform](struct.MeshInputUniform.html "struct bevy::pbr::MeshInputUniform")

The per-instance data that was inserted into the [`crate::render_resource::BufferVec`](../render/render_resource/struct.BufferVec.html "struct bevy::render::render_resource::BufferVec") during extraction.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#2871-2877)

#### fn [get\_index\_and\_compare\_data](../render/batching/trait.GetFullBatchData.html#tymethod.get_index_and_compare_data)( \_: &<<[MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline") as [GetBatchData](../render/batching/trait.GetBatchData.html "trait bevy::render::batching::GetBatchData")\>::[Param](../render/batching/trait.GetBatchData.html#associatedtype.Param "type bevy::render::batching::GetBatchData::Param") as [SystemParam](../ecs/system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[Item](../ecs/system/trait.SystemParam.html#associatedtype.Item "type bevy::ecs::system::SystemParam::Item")<'\_, '\_>, main\_entity: [MainEntity](../render/sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<([NonMaxU32](https://docs.rs/nonmax/0.5.5/x86_64-unknown-linux-gnu/nonmax/struct.NonMaxU32.html "struct nonmax::NonMaxU32"), [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<(<[MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline") as [GetBatchData](../render/batching/trait.GetBatchData.html "trait bevy::render::batching::GetBatchData")\>::[BatchSetCompareData](../render/batching/trait.GetBatchData.html#associatedtype.BatchSetCompareData "type bevy::render::batching::GetBatchData::BatchSetCompareData"), <[MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline") as [GetBatchData](../render/batching/trait.GetBatchData.html "trait bevy::render::batching::GetBatchData")\>::[BatchCompareData](../render/batching/trait.GetBatchData.html#associatedtype.BatchCompareData "type bevy::render::batching::GetBatchData::BatchCompareData"))>)>

Returns the index of the [`GetFullBatchData::BufferInputData`](../render/batching/trait.GetFullBatchData.html#associatedtype.BufferInputData "associated type bevy::render::batching::GetFullBatchData::BufferInputData") that the GPU preprocessing phase will use. [Read more](../render/batching/trait.GetFullBatchData.html#tymethod.get_index_and_compare_data)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#2905-2910)

#### fn [get\_binned\_batch\_data](../render/batching/trait.GetFullBatchData.html#tymethod.get_binned_batch_data)( \_: &<<[MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline") as [GetBatchData](../render/batching/trait.GetBatchData.html "trait bevy::render::batching::GetBatchData")\>::[Param](../render/batching/trait.GetBatchData.html#associatedtype.Param "type bevy::render::batching::GetBatchData::Param") as [SystemParam](../ecs/system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[Item](../ecs/system/trait.SystemParam.html#associatedtype.Item "type bevy::ecs::system::SystemParam::Item")<'\_, '\_>, main\_entity: [MainEntity](../render/sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline") as [GetBatchData](../render/batching/trait.GetBatchData.html "trait bevy::render::batching::GetBatchData")\>::[BufferData](../render/batching/trait.GetBatchData.html#associatedtype.BufferData "type bevy::render::batching::GetBatchData::BufferData")\>

Get the per-instance data to be inserted into the [`crate::render_resource::GpuArrayBuffer`](../render/render_resource/enum.GpuArrayBuffer.html "enum bevy::render::render_resource::GpuArrayBuffer"). [Read more](../render/batching/trait.GetFullBatchData.html#tymethod.get_binned_batch_data)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#2939-2942)

#### fn [get\_binned\_index](../render/batching/trait.GetFullBatchData.html#tymethod.get_binned_index)( \_: &<<[MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline") as [GetBatchData](../render/batching/trait.GetBatchData.html "trait bevy::render::batching::GetBatchData")\>::[Param](../render/batching/trait.GetBatchData.html#associatedtype.Param "type bevy::render::batching::GetBatchData::Param") as [SystemParam](../ecs/system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[Item](../ecs/system/trait.SystemParam.html#associatedtype.Item "type bevy::ecs::system::SystemParam::Item")<'\_, '\_>, main\_entity: [MainEntity](../render/sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[NonMaxU32](https://docs.rs/nonmax/0.5.5/x86_64-unknown-linux-gnu/nonmax/struct.NonMaxU32.html "struct nonmax::NonMaxU32")\>

Returns the index of the [`GetFullBatchData::BufferInputData`](../render/batching/trait.GetFullBatchData.html#associatedtype.BufferInputData "associated type bevy::render::batching::GetFullBatchData::BufferInputData") that the GPU preprocessing phase will use. [Read more](../render/batching/trait.GetFullBatchData.html#tymethod.get_binned_index)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#2957-2963)

#### fn [write\_batch\_indirect\_parameters\_metadata](../render/batching/trait.GetFullBatchData.html#tymethod.write_batch_indirect_parameters_metadata)( indexed: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), base\_output\_index: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html), batch\_set\_index: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[NonMaxU32](https://docs.rs/nonmax/0.5.5/x86_64-unknown-linux-gnu/nonmax/struct.NonMaxU32.html "struct nonmax::NonMaxU32")\>, phase\_indirect\_parameters\_buffers: &mut [UntypedPhaseIndirectParametersBuffers](../render/batching/gpu_preprocessing/struct.UntypedPhaseIndirectParametersBuffers.html "struct bevy::render::batching::gpu_preprocessing::UntypedPhaseIndirectParametersBuffers"), indirect\_parameters\_offset: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html), )

Writes the [`gpu_preprocessing::IndirectParametersGpuMetadata`](../render/batching/gpu_preprocessing/struct.IndirectParametersGpuMetadata.html "struct bevy::render::batching::gpu_preprocessing::IndirectParametersGpuMetadata") necessary to draw this batch into the given metadata buffer at the given index. [Read more](../render/batching/trait.GetFullBatchData.html#tymethod.write_batch_indirect_parameters_metadata)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#2665)

### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline")

where [MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#3281)

### impl [SpecializedMeshPipeline](../render/render_resource/trait.SpecializedMeshPipeline.html "trait bevy::render::render_resource::SpecializedMeshPipeline") for [MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#3282)

#### type [Key](../render/render_resource/trait.SpecializedMeshPipeline.html#associatedtype.Key) = [MeshPipelineKey](struct.MeshPipelineKey.html "struct bevy::pbr::MeshPipelineKey")

The key that defines each “variant” of the render pipeline.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#3284-3288)

#### fn [specialize](../render/render_resource/trait.SpecializedMeshPipeline.html#tymethod.specialize)( &self, key: <[MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline") as [SpecializedMeshPipeline](../render/render_resource/trait.SpecializedMeshPipeline.html "trait bevy::render::render_resource::SpecializedMeshPipeline")\>::[Key](../render/render_resource/trait.SpecializedMeshPipeline.html#associatedtype.Key "type bevy::render::render_resource::SpecializedMeshPipeline::Key"), layout: &[MeshVertexBufferLayoutRef](../mesh/struct.MeshVertexBufferLayoutRef.html "struct bevy::mesh::MeshVertexBufferLayoutRef"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[RenderPipelineDescriptor](../material/descriptor/struct.RenderPipelineDescriptor.html "struct bevy::material::descriptor::RenderPipelineDescriptor"), [SpecializedMeshPipelineError](../material/specialize/enum.SpecializedMeshPipelineError.html "enum bevy::material::specialize::SpecializedMeshPipelineError")\>

Construct a new render pipeline based on the provided key and vertex layout. [Read more](../render/render_resource/trait.SpecializedMeshPipeline.html#tymethod.specialize)

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MeshPipeline](struct.MeshPipeline.html "struct bevy::pbr::MeshPipeline")
