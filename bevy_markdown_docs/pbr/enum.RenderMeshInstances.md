...
# Enum RenderMeshInstances 

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#1176)
...
The set of information needed is different depending on whether CPU or GPU [`MeshUniform`](struct.MeshUniform.html "struct bevy::pbr::MeshUniform") building is in use.

## Variants

### CpuBuilding([RenderMeshInstancesCpu](struct.RenderMeshInstancesCpu.html "struct bevy::pbr::RenderMeshInstancesCpu"))

Information needed when using CPU mesh instance data building.

### GpuBuilding([RenderMeshInstancesGpu](struct.RenderMeshInstancesGpu.html "struct bevy::pbr::RenderMeshInstancesGpu"))

Information needed when using GPU mesh instance data building.

## Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#1193)

### impl [RenderMeshInstances](enum.RenderMeshInstances.html "enum bevy::pbr::RenderMeshInstances")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#1204)

#### pub fn [mesh\_asset\_id](#method.mesh_asset_id)(&self, entity: [MainEntity](../render/sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[Mesh](../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")\>>

Returns the ID of the mesh asset attached to the given entity, if any.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#1213)

#### pub fn [render\_mesh\_queue\_data](#method.render_mesh_queue_data)( &self, entity: [MainEntity](../render/sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[RenderMeshQueueData](struct.RenderMeshQueueData.html "struct bevy::pbr::RenderMeshQueueData")<'\_>>

Constructs [`RenderMeshQueueData`](struct.RenderMeshQueueData.html "struct bevy::pbr::RenderMeshQueueData") for the given entity, if it has a mesh attached.

##### [Examples found in repository](#scraped-examples)[?](../../scrape-examples-help.html)

examples/shader\_advanced/custom\_shader\_instancing.rs ([line 165](../../src/custom_shader_instancing/custom_shader_instancing.rs.html#165))
...
examples/shader\_advanced/custom\_render\_phase.rs ([line 582](../../src/custom_render_phase/custom_render_phase.rs.html#582))
...
examples/shader\_advanced/specialized\_mesh\_pipeline.rs ([line 339](../../src/specialized_mesh_pipeline/specialized_mesh_pipeline.rs.html#339))
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [RenderMeshInstances](enum.RenderMeshInstances.html "enum bevy::pbr::RenderMeshInstances")

where [RenderMeshInstances](enum.RenderMeshInstances.html "enum bevy::pbr::RenderMeshInstances"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
#### fn [map\_entities](../prelude/trait.Component.html#method.map_entities)<M>(this: &mut [RenderMeshInstances](enum.RenderMeshInstances.html "enum bevy::pbr::RenderMeshInstances"), mapper: [&mut M](https://doc.rust-lang.org/nightly/std/primitive.reference.html))
...
### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [RenderMeshInstances](enum.RenderMeshInstances.html "enum bevy::pbr::RenderMeshInstances")

where [RenderMeshInstances](enum.RenderMeshInstances.html "enum bevy::pbr::RenderMeshInstances"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RenderMeshInstances](enum.RenderMeshInstances.html "enum bevy::pbr::RenderMeshInstances")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RenderMeshInstances](enum.RenderMeshInstances.html "enum bevy::pbr::RenderMeshInstances")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RenderMeshInstances](enum.RenderMeshInstances.html "enum bevy::pbr::RenderMeshInstances")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RenderMeshInstances](enum.RenderMeshInstances.html "enum bevy::pbr::RenderMeshInstances")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RenderMeshInstances](enum.RenderMeshInstances.html "enum bevy::pbr::RenderMeshInstances")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RenderMeshInstances](enum.RenderMeshInstances.html "enum bevy::pbr::RenderMeshInstances")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RenderMeshInstances](enum.RenderMeshInstances.html "enum bevy::pbr::RenderMeshInstances")
