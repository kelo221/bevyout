...
# Struct RenderMeshInstanceGpuQueues 

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#1085)
...
These are filled in [`extract_meshes_for_gpu_building`](fn.extract_meshes_for_gpu_building.html "fn bevy::pbr::extract_meshes_for_gpu_building") and consumed in [`collect_meshes_for_gpu_building`](fn.collect_meshes_for_gpu_building.html "fn bevy::pbr::collect_meshes_for_gpu_building").

## Methods from [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")<Target = [Parallel](../utils/struct.Parallel.html "struct bevy::utils::Parallel")<[RenderMeshInstanceGpuQueue](enum.RenderMeshInstanceGpuQueue.html "enum bevy::pbr::RenderMeshInstanceGpuQueue")\>>

[Source](https://docs.rs/bevy_utils/0.19.0/x86_64-unknown-linux-gnu/src/bevy_utils/parallel_queue.rs.html#14)

#### pub fn [iter\_mut](#method.iter_mut)(&mut self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = [&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\>

Gets a mutable iterator over all of the per-thread queues.

[Source](https://docs.rs/bevy_utils/0.19.0/x86_64-unknown-linux-gnu/src/bevy_utils/parallel_queue.rs.html#19)

#### pub fn [clear](#method.clear)(&mut self)

Clears all of the stored thread local values.

[Source](https://docs.rs/bevy_utils/0.19.0/x86_64-unknown-linux-gnu/src/bevy_utils/parallel_queue.rs.html#27)

#### pub fn [scope\_or](#method.scope_or)<R>( &self, create: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")() -> T, f: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")([&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)) -> R, ) -> R
...
[Source](https://docs.rs/bevy_utils/0.19.0/x86_64-unknown-linux-gnu/src/bevy_utils/parallel_queue.rs.html#35-38)

#### pub fn [borrow\_local\_mut\_or](#method.borrow_local_mut_or)(&self, create: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")() -> T) -> impl [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut")

Mutably borrows the thread-local value.

If there is no thread-local value, it will be initialized to the result of `create`.

[Source](https://docs.rs/bevy_utils/0.19.0/x86_64-unknown-linux-gnu/src/bevy_utils/parallel_queue.rs.html#47)

#### pub fn [scope](#method.scope)<R>(&self, f: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")([&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)) -> R) -> R

Retrieves the thread-local value for the current thread and runs `f` on it.

If there is no thread-local value, it will be initialized to its default.

[Source](https://docs.rs/bevy_utils/0.19.0/x86_64-unknown-linux-gnu/src/bevy_utils/parallel_queue.rs.html#54)

#### pub fn [borrow\_local\_mut](#method.borrow_local_mut)(&self) -> impl [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut")
...
examples/shader\_advanced/manual\_material.rs ([line 294](../../src/manual_material/manual_material.rs.html#294))
...
[Source](https://docs.rs/bevy_utils/0.19.0/x86_64-unknown-linux-gnu/src/bevy_utils/parallel_queue.rs.html#70)

#### pub fn [drain](#method.drain)(&mut self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = T>

Drains all enqueued items from all threads and returns an iterator over them.

Unlike [`Vec::drain`](../prelude/struct.Vec.html#method.drain "method bevy::prelude::Vec::drain"), this will piecemeal remove chunks of the data stored. If iteration is terminated part way, the rest of the enqueued items in the same chunk will be dropped, and the rest of the undrained elements will remain.
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [RenderMeshInstanceGpuQueues](struct.RenderMeshInstanceGpuQueues.html "struct bevy::pbr::RenderMeshInstanceGpuQueues")

where [RenderMeshInstanceGpuQueues](struct.RenderMeshInstanceGpuQueues.html "struct bevy::pbr::RenderMeshInstanceGpuQueues"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [RenderMeshInstanceGpuQueues](struct.RenderMeshInstanceGpuQueues.html "struct bevy::pbr::RenderMeshInstanceGpuQueues")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#1084)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [RenderMeshInstanceGpuQueues](struct.RenderMeshInstanceGpuQueues.html "struct bevy::pbr::RenderMeshInstanceGpuQueues")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#1084)

### impl [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [RenderMeshInstanceGpuQueues](struct.RenderMeshInstanceGpuQueues.html "struct bevy::pbr::RenderMeshInstanceGpuQueues")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#1084)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = [Parallel](../utils/struct.Parallel.html "struct bevy::utils::Parallel")<[RenderMeshInstanceGpuQueue](enum.RenderMeshInstanceGpuQueue.html "enum bevy::pbr::RenderMeshInstanceGpuQueue")\>

The resulting type after dereferencing.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#1084)

#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[RenderMeshInstanceGpuQueues](struct.RenderMeshInstanceGpuQueues.html "struct bevy::pbr::RenderMeshInstanceGpuQueues") as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#1084)

### impl [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [RenderMeshInstanceGpuQueues](struct.RenderMeshInstanceGpuQueues.html "struct bevy::pbr::RenderMeshInstanceGpuQueues")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#1084)

#### fn [deref\_mut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html#tymethod.deref_mut)(&mut self) -> &mut <[RenderMeshInstanceGpuQueues](struct.RenderMeshInstanceGpuQueues.html "struct bevy::pbr::RenderMeshInstanceGpuQueues") as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Mutably dereferences the value.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#1084)

### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [RenderMeshInstanceGpuQueues](struct.RenderMeshInstanceGpuQueues.html "struct bevy::pbr::RenderMeshInstanceGpuQueues")

where [RenderMeshInstanceGpuQueues](struct.RenderMeshInstanceGpuQueues.html "struct bevy::pbr::RenderMeshInstanceGpuQueues"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RenderMeshInstanceGpuQueues](struct.RenderMeshInstanceGpuQueues.html "struct bevy::pbr::RenderMeshInstanceGpuQueues")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RenderMeshInstanceGpuQueues](struct.RenderMeshInstanceGpuQueues.html "struct bevy::pbr::RenderMeshInstanceGpuQueues")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RenderMeshInstanceGpuQueues](struct.RenderMeshInstanceGpuQueues.html "struct bevy::pbr::RenderMeshInstanceGpuQueues")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RenderMeshInstanceGpuQueues](struct.RenderMeshInstanceGpuQueues.html "struct bevy::pbr::RenderMeshInstanceGpuQueues")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RenderMeshInstanceGpuQueues](struct.RenderMeshInstanceGpuQueues.html "struct bevy::pbr::RenderMeshInstanceGpuQueues")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RenderMeshInstanceGpuQueues](struct.RenderMeshInstanceGpuQueues.html "struct bevy::pbr::RenderMeshInstanceGpuQueues")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RenderMeshInstanceGpuQueues](struct.RenderMeshInstanceGpuQueues.html "struct bevy::pbr::RenderMeshInstanceGpuQueues")
