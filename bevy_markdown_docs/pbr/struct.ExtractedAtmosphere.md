...
# Struct ExtractedAtmosphere 

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/atmosphere/mod.rs.html#260)
...
`inner_radius: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)``outer_radius: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)``ground_albedo: [Vec3](../prelude/struct.Vec3.html "struct bevy::prelude::Vec3")``medium: [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[ScatteringMedium](../light/atmosphere/struct.ScatteringMedium.html "struct bevy::light::atmosphere::ScatteringMedium")>``world_to_atmosphere: [Mat4](../prelude/struct.Mat4.html "struct bevy::prelude::Mat4")`

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/atmosphere/mod.rs.html#259)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ExtractedAtmosphere](struct.ExtractedAtmosphere.html "struct bevy::pbr::ExtractedAtmosphere")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/atmosphere/mod.rs.html#259)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ExtractedAtmosphere](struct.ExtractedAtmosphere.html "struct bevy::pbr::ExtractedAtmosphere")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [ExtractedAtmosphere](struct.ExtractedAtmosphere.html "struct bevy::pbr::ExtractedAtmosphere")

where [ExtractedAtmosphere](struct.ExtractedAtmosphere.html "struct bevy::pbr::ExtractedAtmosphere"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ExtractedAtmosphere](struct.ExtractedAtmosphere.html "struct bevy::pbr::ExtractedAtmosphere")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ExtractedAtmosphere](struct.ExtractedAtmosphere.html "struct bevy::pbr::ExtractedAtmosphere")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ExtractedAtmosphere](struct.ExtractedAtmosphere.html "struct bevy::pbr::ExtractedAtmosphere")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ExtractedAtmosphere](struct.ExtractedAtmosphere.html "struct bevy::pbr::ExtractedAtmosphere")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ExtractedAtmosphere](struct.ExtractedAtmosphere.html "struct bevy::pbr::ExtractedAtmosphere")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ExtractedAtmosphere](struct.ExtractedAtmosphere.html "struct bevy::pbr::ExtractedAtmosphere")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ExtractedAtmosphere](struct.ExtractedAtmosphere.html "struct bevy::pbr::ExtractedAtmosphere")
