...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/light.rs.html#79)
...
`color: [LinearRgba](../prelude/struct.LinearRgba.html "struct bevy::prelude::LinearRgba")``intensity: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

luminous intensity in lumens per steradian

`range: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)``radius: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)``transform: [GlobalTransform](../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")``shadow_maps_enabled: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)``contact_shadows_enabled: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)``shadow_depth_bias: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)``shadow_normal_bias: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)``shadow_map_near_z: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)``spot_light_angles: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<([f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html))>``volumetric: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)``soft_shadows_enabled: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)``affects_lightmapped_mesh_diffuse: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

whether this point light contributes diffuse light to lightmapped meshes

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/light.rs.html#77)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [ExtractedPointLight](struct.ExtractedPointLight.html "struct bevy::pbr::ExtractedPointLight")

where [ExtractedPointLight](struct.ExtractedPointLight.html "struct bevy::pbr::ExtractedPointLight"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

**Required Components**: [`PointAndSpotLightViewEntities`](struct.PointAndSpotLightViewEntities.html "struct bevy::pbr::PointAndSpotLightViewEntities").
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ExtractedPointLight](struct.ExtractedPointLight.html "struct bevy::pbr::ExtractedPointLight")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ExtractedPointLight](struct.ExtractedPointLight.html "struct bevy::pbr::ExtractedPointLight")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ExtractedPointLight](struct.ExtractedPointLight.html "struct bevy::pbr::ExtractedPointLight")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ExtractedPointLight](struct.ExtractedPointLight.html "struct bevy::pbr::ExtractedPointLight")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ExtractedPointLight](struct.ExtractedPointLight.html "struct bevy::pbr::ExtractedPointLight")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ExtractedPointLight](struct.ExtractedPointLight.html "struct bevy::pbr::ExtractedPointLight")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ExtractedPointLight](struct.ExtractedPointLight.html "struct bevy::pbr::ExtractedPointLight")
