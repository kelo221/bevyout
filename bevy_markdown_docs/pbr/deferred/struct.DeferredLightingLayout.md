...
# Struct DeferredLightingLayout 

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/deferred/mod.rs.html#189)

```rust
pub struct DeferredLightingLayout { /* private fields */ }
```
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [DeferredLightingLayout](struct.DeferredLightingLayout.html "struct bevy::pbr::deferred::DeferredLightingLayout")

where [DeferredLightingLayout](struct.DeferredLightingLayout.html "struct bevy::pbr::deferred::DeferredLightingLayout"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [DeferredLightingLayout](struct.DeferredLightingLayout.html "struct bevy::pbr::deferred::DeferredLightingLayout")

where [DeferredLightingLayout](struct.DeferredLightingLayout.html "struct bevy::pbr::deferred::DeferredLightingLayout"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/deferred/mod.rs.html#200)

### impl [SpecializedRenderPipeline](../../render/render_resource/trait.SpecializedRenderPipeline.html "trait bevy::render::render_resource::SpecializedRenderPipeline") for [DeferredLightingLayout](struct.DeferredLightingLayout.html "struct bevy::pbr::deferred::DeferredLightingLayout")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/deferred/mod.rs.html#201)

#### type [Key](../../render/render_resource/trait.SpecializedRenderPipeline.html#associatedtype.Key) = [MeshPipelineKey](../struct.MeshPipelineKey.html "struct bevy::pbr::MeshPipelineKey")

The key that defines each “variant” of the render pipeline.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/deferred/mod.rs.html#203)

#### fn [specialize](../../render/render_resource/trait.SpecializedRenderPipeline.html#tymethod.specialize)( &self, key: <[DeferredLightingLayout](struct.DeferredLightingLayout.html "struct bevy::pbr::deferred::DeferredLightingLayout") as [SpecializedRenderPipeline](../../render/render_resource/trait.SpecializedRenderPipeline.html "trait bevy::render::render_resource::SpecializedRenderPipeline")\>::[Key](../../render/render_resource/trait.SpecializedRenderPipeline.html#associatedtype.Key "type bevy::render::render_resource::SpecializedRenderPipeline::Key"), ) -> [RenderPipelineDescriptor](../../material/descriptor/struct.RenderPipelineDescriptor.html "struct bevy::material::descriptor::RenderPipelineDescriptor")

Construct a new render pipeline based on the provided key.

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DeferredLightingLayout](struct.DeferredLightingLayout.html "struct bevy::pbr::deferred::DeferredLightingLayout")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DeferredLightingLayout](struct.DeferredLightingLayout.html "struct bevy::pbr::deferred::DeferredLightingLayout")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DeferredLightingLayout](struct.DeferredLightingLayout.html "struct bevy::pbr::deferred::DeferredLightingLayout")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DeferredLightingLayout](struct.DeferredLightingLayout.html "struct bevy::pbr::deferred::DeferredLightingLayout")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DeferredLightingLayout](struct.DeferredLightingLayout.html "struct bevy::pbr::deferred::DeferredLightingLayout")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DeferredLightingLayout](struct.DeferredLightingLayout.html "struct bevy::pbr::deferred::DeferredLightingLayout")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DeferredLightingLayout](struct.DeferredLightingLayout.html "struct bevy::pbr::deferred::DeferredLightingLayout")
