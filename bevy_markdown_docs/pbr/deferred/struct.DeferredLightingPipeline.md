...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/deferred/mod.rs.html#196)
...
`pipeline_id: [CachedRenderPipelineId](../../material/descriptor/struct.CachedRenderPipelineId.html "struct bevy::material::descriptor::CachedRenderPipelineId")`

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/deferred/mod.rs.html#195)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [DeferredLightingPipeline](struct.DeferredLightingPipeline.html "struct bevy::pbr::deferred::DeferredLightingPipeline")

where [DeferredLightingPipeline](struct.DeferredLightingPipeline.html "struct bevy::pbr::deferred::DeferredLightingPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DeferredLightingPipeline](struct.DeferredLightingPipeline.html "struct bevy::pbr::deferred::DeferredLightingPipeline")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DeferredLightingPipeline](struct.DeferredLightingPipeline.html "struct bevy::pbr::deferred::DeferredLightingPipeline")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DeferredLightingPipeline](struct.DeferredLightingPipeline.html "struct bevy::pbr::deferred::DeferredLightingPipeline")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DeferredLightingPipeline](struct.DeferredLightingPipeline.html "struct bevy::pbr::deferred::DeferredLightingPipeline")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DeferredLightingPipeline](struct.DeferredLightingPipeline.html "struct bevy::pbr::deferred::DeferredLightingPipeline")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DeferredLightingPipeline](struct.DeferredLightingPipeline.html "struct bevy::pbr::deferred::DeferredLightingPipeline")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DeferredLightingPipeline](struct.DeferredLightingPipeline.html "struct bevy::pbr::deferred::DeferredLightingPipeline")
