...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/light.rs.html#109)
...
`color: [LinearRgba](../prelude/struct.LinearRgba.html "struct bevy::prelude::LinearRgba")``illuminance: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)``transform: [GlobalTransform](../prelude/struct.GlobalTransform.html "struct bevy::prelude::GlobalTransform")``shadow_maps_enabled: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)``contact_shadows_enabled: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)``volumetric: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)``affects_lightmapped_mesh_diffuse: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

whether this directional light contributes diffuse light to lightmapped meshes

`shadow_depth_bias: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)``shadow_normal_bias: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)``cascade_shadow_config: [CascadeShadowConfig](../light/struct.CascadeShadowConfig.html "struct bevy::light::CascadeShadowConfig")``cascades: [EntityHashMap](../ecs/entity/struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<[Vec](../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[Cascade](../light/cascade/struct.Cascade.html "struct bevy::light::cascade::Cascade")>>``frusta: [EntityHashMap](../ecs/entity/struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<[Vec](../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[Frustum](../camera/primitives/struct.Frustum.html "struct bevy::camera::primitives::Frustum")>>``render_layers: [RenderLayers](../camera/visibility/struct.RenderLayers.html "struct bevy::camera::visibility::RenderLayers")``soft_shadow_size: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)>``occlusion_culling: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

True if this light is using two-phase occlusion culling.

`sun_disk_angular_size: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)``sun_disk_intensity: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/light.rs.html#108)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [ExtractedDirectionalLight](struct.ExtractedDirectionalLight.html "struct bevy::pbr::ExtractedDirectionalLight")

where [ExtractedDirectionalLight](struct.ExtractedDirectionalLight.html "struct bevy::pbr::ExtractedDirectionalLight"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ExtractedDirectionalLight](struct.ExtractedDirectionalLight.html "struct bevy::pbr::ExtractedDirectionalLight")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ExtractedDirectionalLight](struct.ExtractedDirectionalLight.html "struct bevy::pbr::ExtractedDirectionalLight")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ExtractedDirectionalLight](struct.ExtractedDirectionalLight.html "struct bevy::pbr::ExtractedDirectionalLight")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ExtractedDirectionalLight](struct.ExtractedDirectionalLight.html "struct bevy::pbr::ExtractedDirectionalLight")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ExtractedDirectionalLight](struct.ExtractedDirectionalLight.html "struct bevy::pbr::ExtractedDirectionalLight")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ExtractedDirectionalLight](struct.ExtractedDirectionalLight.html "struct bevy::pbr::ExtractedDirectionalLight")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ExtractedDirectionalLight](struct.ExtractedDirectionalLight.html "struct bevy::pbr::ExtractedDirectionalLight")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ExtractedDirectionalLight](struct.ExtractedDirectionalLight.html "struct bevy::pbr::ExtractedDirectionalLight")
