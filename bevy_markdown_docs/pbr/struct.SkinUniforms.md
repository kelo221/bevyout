...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/skin.rs.html#76)
...
`current_staging_buffer: [Vec](../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[Mat4](../prelude/struct.Mat4.html "struct bevy::prelude::Mat4")>`

The CPU-side buffer that stores the joint matrices for skinned meshes in the current frame.

`current_buffer: [Buffer](../render/render_resource/struct.Buffer.html "struct bevy::render::render_resource::Buffer")`

The GPU-side buffer that stores the joint matrices for skinned meshes in the current frame.

`prev_buffer: [Buffer](../render/render_resource/struct.Buffer.html "struct bevy::render::render_resource::Buffer")`

The GPU-side buffer that stores the joint matrices for skinned meshes in the previous frame.

## Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/skin.rs.html#133)

### impl [SkinUniforms](struct.SkinUniforms.html "struct bevy::pbr::SkinUniforms")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/skin.rs.html#135)

#### pub fn [skin\_index](#method.skin_index)(&self, skin: [MainEntity](../render/sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)\>

Returns the current offset in joints of the skin in the buffer.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/skin.rs.html#142)

#### pub fn [skin\_byte\_offset](#method.skin_byte_offset)(&self, skin: [MainEntity](../render/sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<SkinByteOffset>

Returns the current offset in bytes of the skin in the buffer.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/skin.rs.html#149)

#### pub fn [all\_skins](#method.all_skins)(&self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = &[MainEntity](../render/sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity")\>
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [SkinUniforms](struct.SkinUniforms.html "struct bevy::pbr::SkinUniforms")

where [SkinUniforms](struct.SkinUniforms.html "struct bevy::pbr::SkinUniforms"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [SkinUniforms](struct.SkinUniforms.html "struct bevy::pbr::SkinUniforms")

where [SkinUniforms](struct.SkinUniforms.html "struct bevy::pbr::SkinUniforms"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SkinUniforms](struct.SkinUniforms.html "struct bevy::pbr::SkinUniforms")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SkinUniforms](struct.SkinUniforms.html "struct bevy::pbr::SkinUniforms")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SkinUniforms](struct.SkinUniforms.html "struct bevy::pbr::SkinUniforms")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SkinUniforms](struct.SkinUniforms.html "struct bevy::pbr::SkinUniforms")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SkinUniforms](struct.SkinUniforms.html "struct bevy::pbr::SkinUniforms")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SkinUniforms](struct.SkinUniforms.html "struct bevy::pbr::SkinUniforms")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SkinUniforms](struct.SkinUniforms.html "struct bevy::pbr::SkinUniforms")
