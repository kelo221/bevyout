...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/lib.rs.html#178)
...
It is a texture array containing 2 LUT textures: The first entry encodes the 4 non-trivial elements of the inverse GGX LTC matrix. The second entry encodes amplitude and Fresnel-related weights.
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [AreaLightLuts](struct.AreaLightLuts.html "struct bevy::pbr::AreaLightLuts")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/lib.rs.html#177)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [AreaLightLuts](struct.AreaLightLuts.html "struct bevy::pbr::AreaLightLuts")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [AreaLightLuts](struct.AreaLightLuts.html "struct bevy::pbr::AreaLightLuts")

where [AreaLightLuts](struct.AreaLightLuts.html "struct bevy::pbr::AreaLightLuts"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [AreaLightLuts](struct.AreaLightLuts.html "struct bevy::pbr::AreaLightLuts")

where [AreaLightLuts](struct.AreaLightLuts.html "struct bevy::pbr::AreaLightLuts"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AreaLightLuts](struct.AreaLightLuts.html "struct bevy::pbr::AreaLightLuts")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AreaLightLuts](struct.AreaLightLuts.html "struct bevy::pbr::AreaLightLuts")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AreaLightLuts](struct.AreaLightLuts.html "struct bevy::pbr::AreaLightLuts")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AreaLightLuts](struct.AreaLightLuts.html "struct bevy::pbr::AreaLightLuts")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AreaLightLuts](struct.AreaLightLuts.html "struct bevy::pbr::AreaLightLuts")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AreaLightLuts](struct.AreaLightLuts.html "struct bevy::pbr::AreaLightLuts")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AreaLightLuts](struct.AreaLightLuts.html "struct bevy::pbr::AreaLightLuts")
