...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/light.rs.html#235)
...
`point_light_comparison_sampler: [Sampler](../render/render_resource/struct.Sampler.html "struct bevy::render::render_resource::Sampler")``point_light_linear_sampler: [Sampler](../render/render_resource/struct.Sampler.html "struct bevy::render::render_resource::Sampler")`

Available on **crate feature `experimental_pbr_pcss`** only.

`directional_light_comparison_sampler: [Sampler](../render/render_resource/struct.Sampler.html "struct bevy::render::render_resource::Sampler")``directional_light_linear_sampler: [Sampler](../render/render_resource/struct.Sampler.html "struct bevy::render::render_resource::Sampler")`
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ShadowSamplers](struct.ShadowSamplers.html "struct bevy::pbr::ShadowSamplers")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/light.rs.html#234)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ShadowSamplers](struct.ShadowSamplers.html "struct bevy::pbr::ShadowSamplers")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [ShadowSamplers](struct.ShadowSamplers.html "struct bevy::pbr::ShadowSamplers")

where [ShadowSamplers](struct.ShadowSamplers.html "struct bevy::pbr::ShadowSamplers"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [ShadowSamplers](struct.ShadowSamplers.html "struct bevy::pbr::ShadowSamplers")

where [ShadowSamplers](struct.ShadowSamplers.html "struct bevy::pbr::ShadowSamplers"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ShadowSamplers](struct.ShadowSamplers.html "struct bevy::pbr::ShadowSamplers")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ShadowSamplers](struct.ShadowSamplers.html "struct bevy::pbr::ShadowSamplers")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ShadowSamplers](struct.ShadowSamplers.html "struct bevy::pbr::ShadowSamplers")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ShadowSamplers](struct.ShadowSamplers.html "struct bevy::pbr::ShadowSamplers")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ShadowSamplers](struct.ShadowSamplers.html "struct bevy::pbr::ShadowSamplers")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ShadowSamplers](struct.ShadowSamplers.html "struct bevy::pbr::ShadowSamplers")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ShadowSamplers](struct.ShadowSamplers.html "struct bevy::pbr::ShadowSamplers")
