...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssao/mod.rs.html#632)
...
`common_bind_group: [BindGroup](../render/render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup")``preprocess_depth_bind_group: [BindGroup](../render/render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup")``ssao_bind_group: [BindGroup](../render/render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup")``spatial_denoise_bind_group: [BindGroup](../render/render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup")`

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssao/mod.rs.html#631)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [SsaoBindGroups](struct.SsaoBindGroups.html "struct bevy::pbr::SsaoBindGroups")

where [SsaoBindGroups](struct.SsaoBindGroups.html "struct bevy::pbr::SsaoBindGroups"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SsaoBindGroups](struct.SsaoBindGroups.html "struct bevy::pbr::SsaoBindGroups")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SsaoBindGroups](struct.SsaoBindGroups.html "struct bevy::pbr::SsaoBindGroups")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SsaoBindGroups](struct.SsaoBindGroups.html "struct bevy::pbr::SsaoBindGroups")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SsaoBindGroups](struct.SsaoBindGroups.html "struct bevy::pbr::SsaoBindGroups")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SsaoBindGroups](struct.SsaoBindGroups.html "struct bevy::pbr::SsaoBindGroups")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SsaoBindGroups](struct.SsaoBindGroups.html "struct bevy::pbr::SsaoBindGroups")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SsaoBindGroups](struct.SsaoBindGroups.html "struct bevy::pbr::SsaoBindGroups")
