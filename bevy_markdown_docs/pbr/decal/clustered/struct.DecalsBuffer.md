...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/decal/clustered.rs.html#152)
...
## Methods from [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")<Target = [RawBufferVec](../../../render/render_resource/struct.RawBufferVec.html "struct bevy::render::render_resource::RawBufferVec")<[RenderClusteredDecal](struct.RenderClusteredDecal.html "struct bevy::pbr::decal::clustered::RenderClusteredDecal")\>>

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_resource/buffer_vec.rs.html#66)

#### pub fn [buffer](#method.buffer)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[Buffer](../../../render/render_resource/struct.Buffer.html "struct bevy::render::render_resource::Buffer")\>
...
#### pub fn [binding](#method.binding)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[BindingResource](../../../render/render_resource/enum.BindingResource.html "enum bevy::render::render_resource::BindingResource")<'\_>>
...
#### pub fn [append](#method.append)(&mut self, other: &mut [RawBufferVec](../../../render/render_resource/struct.RawBufferVec.html "struct bevy::render::render_resource::RawBufferVec")<T>)
...
The index must be less than [`RawBufferVec::len`](../../../render/render_resource/struct.RawBufferVec.html#method.len "method bevy::render::render_resource::RawBufferVec::len").
...
Unlike [`RawBufferVec::reserve`](../../../render/render_resource/struct.RawBufferVec.html#method.reserve "method bevy::render::render_resource::RawBufferVec::reserve"), this doesn’t have any effect on the GPU buffer.
...
The next time the buffer is updated (via [`reserve`](../../../render/render_resource/struct.RawBufferVec.html#method.reserve "method bevy::render::render_resource::RawBufferVec::reserve")), Bevy will inform the driver of the new label.
...
#### pub fn [reserve](#method.reserve)(&mut self, capacity: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), device: &[RenderDevice](../../../render/renderer/struct.RenderDevice.html "struct bevy::render::renderer::RenderDevice"))

Creates a [`Buffer`](../../../render/render_resource/struct.Buffer.html "struct bevy::render::render_resource::Buffer") on the [`RenderDevice`](../../../render/renderer/struct.RenderDevice.html "struct bevy::render::renderer::RenderDevice") with size at least `size_of::<T>() * capacity`, unless a such a buffer already exists.

If a [`Buffer`](../../../render/render_resource/struct.Buffer.html "struct bevy::render::render_resource::Buffer") exists, but is too small, references to it will be discarded, and a new [`Buffer`](../../../render/render_resource/struct.Buffer.html "struct bevy::render::render_resource::Buffer") will be created. Any previously created [`Buffer`](../../../render/render_resource/struct.Buffer.html "struct bevy::render::render_resource::Buffer")s that are no longer referenced will be deleted by the [`RenderDevice`](../../../render/renderer/struct.RenderDevice.html "struct bevy::render::renderer::RenderDevice") once it is done using them (typically 1-2 frames).

In addition to any [`BufferUsages`](../../../render/render_resource/struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages") provided when the `RawBufferVec` was created, the buffer on the [`RenderDevice`](../../../render/renderer/struct.RenderDevice.html "struct bevy::render::renderer::RenderDevice") is marked as [`BufferUsages::COPY_DST`](../../../render/render_resource/struct.BufferUsages.html "struct bevy::render::render_resource::BufferUsages").

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/render_resource/buffer_vec.rs.html#175)

#### pub fn [write\_buffer](#method.write_buffer)(&mut self, device: &[RenderDevice](../../../render/renderer/struct.RenderDevice.html "struct bevy::render::renderer::RenderDevice"), queue: &[RenderQueue](../../../render/renderer/struct.RenderQueue.html "struct bevy::render::renderer::RenderQueue"))

Queues writing of data from system RAM to VRAM using the [`RenderDevice`](../../../render/renderer/struct.RenderDevice.html "struct bevy::render::renderer::RenderDevice") and the provided [`RenderQueue`](../../../render/renderer/struct.RenderQueue.html "struct bevy::render::renderer::RenderQueue").

Before queuing the write, a [`reserve`](../../../render/render_resource/struct.RawBufferVec.html#method.reserve "method bevy::render::render_resource::RawBufferVec::reserve") operation is executed.
...
#### pub fn [write\_buffer\_range](#method.write_buffer_range)( &mut self, render\_queue: &[RenderQueue](../../../render/renderer/struct.RenderQueue.html "struct bevy::render::renderer::RenderQueue"), range: [Range](https://doc.rust-lang.org/nightly/core/ops/range/struct.Range.html "struct core::ops::range::Range")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [WriteBufferRangeError](../../../render/render_resource/enum.WriteBufferRangeError.html "enum bevy::render::render_resource::WriteBufferRangeError")\>
...
### impl [Component](../../../prelude/trait.Component.html "trait bevy::prelude::Component") for [DecalsBuffer](struct.DecalsBuffer.html "struct bevy::pbr::decal::clustered::DecalsBuffer")

where [DecalsBuffer](struct.DecalsBuffer.html "struct bevy::pbr::decal::clustered::DecalsBuffer"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/decal/clustered.rs.html#154)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [DecalsBuffer](struct.DecalsBuffer.html "struct bevy::pbr::decal::clustered::DecalsBuffer")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/decal/clustered.rs.html#155)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [DecalsBuffer](struct.DecalsBuffer.html "struct bevy::pbr::decal::clustered::DecalsBuffer")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/decal/clustered.rs.html#151)

### impl [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [DecalsBuffer](struct.DecalsBuffer.html "struct bevy::pbr::decal::clustered::DecalsBuffer")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/decal/clustered.rs.html#151)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = [RawBufferVec](../../../render/render_resource/struct.RawBufferVec.html "struct bevy::render::render_resource::RawBufferVec")<[RenderClusteredDecal](struct.RenderClusteredDecal.html "struct bevy::pbr::decal::clustered::RenderClusteredDecal")\>

The resulting type after dereferencing.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/decal/clustered.rs.html#151)

#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[DecalsBuffer](struct.DecalsBuffer.html "struct bevy::pbr::decal::clustered::DecalsBuffer") as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/decal/clustered.rs.html#151)

### impl [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [DecalsBuffer](struct.DecalsBuffer.html "struct bevy::pbr::decal::clustered::DecalsBuffer")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/decal/clustered.rs.html#151)

#### fn [deref\_mut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html#tymethod.deref_mut)(&mut self) -> &mut <[DecalsBuffer](struct.DecalsBuffer.html "struct bevy::pbr::decal::clustered::DecalsBuffer") as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Mutably dereferences the value.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/decal/clustered.rs.html#151)

### impl [Resource](../../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [DecalsBuffer](struct.DecalsBuffer.html "struct bevy::pbr::decal::clustered::DecalsBuffer")

where [DecalsBuffer](struct.DecalsBuffer.html "struct bevy::pbr::decal::clustered::DecalsBuffer"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DecalsBuffer](struct.DecalsBuffer.html "struct bevy::pbr::decal::clustered::DecalsBuffer")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DecalsBuffer](struct.DecalsBuffer.html "struct bevy::pbr::decal::clustered::DecalsBuffer")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DecalsBuffer](struct.DecalsBuffer.html "struct bevy::pbr::decal::clustered::DecalsBuffer")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DecalsBuffer](struct.DecalsBuffer.html "struct bevy::pbr::decal::clustered::DecalsBuffer")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DecalsBuffer](struct.DecalsBuffer.html "struct bevy::pbr::decal::clustered::DecalsBuffer")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DecalsBuffer](struct.DecalsBuffer.html "struct bevy::pbr::decal::clustered::DecalsBuffer")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DecalsBuffer](struct.DecalsBuffer.html "struct bevy::pbr::decal::clustered::DecalsBuffer")
