...
# Struct ForwardDecalMaterialExt 

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/decal/forward.rs.html#84)
...
In addition to wrapping your material type with this extension, your shader must use the `bevy_pbr::decal::forward::get_forward_decal_info` function.

The `FORWARD_DECAL` shader define will be made available to your shader so that you can gate the forward decal code behind an ifdef.

## Fields

`depth_fade_factor: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`
...
### impl [AsBindGroup](../../render/render_resource/trait.AsBindGroup.html "trait bevy::render::render_resource::AsBindGroup") for [ForwardDecalMaterialExt](struct.ForwardDecalMaterialExt.html "struct bevy::pbr::decal::ForwardDecalMaterialExt")
...
#### fn [bind\_group\_data](../../render/render_resource/trait.AsBindGroup.html#tymethod.bind_group_data)(&self) -> <[ForwardDecalMaterialExt](struct.ForwardDecalMaterialExt.html "struct bevy::pbr::decal::ForwardDecalMaterialExt") as [AsBindGroup](../../render/render_resource/trait.AsBindGroup.html "trait bevy::render::render_resource::AsBindGroup")\>::[Data](../../render/render_resource/trait.AsBindGroup.html#associatedtype.Data "type bevy::render::render_resource::AsBindGroup::Data")
...
### impl [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset") for [ForwardDecalMaterialExt](struct.ForwardDecalMaterialExt.html "struct bevy::pbr::decal::ForwardDecalMaterialExt")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/decal/forward.rs.html#82)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ForwardDecalMaterialExt](struct.ForwardDecalMaterialExt.html "struct bevy::pbr::decal::ForwardDecalMaterialExt")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/decal/forward.rs.html#82)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ForwardDecalMaterialExt](struct.ForwardDecalMaterialExt.html "struct bevy::pbr::decal::ForwardDecalMaterialExt")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ForwardDecalMaterialExt](struct.ForwardDecalMaterialExt.html "struct bevy::pbr::decal::ForwardDecalMaterialExt")
...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/decal/forward.rs.html#144)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [ForwardDecalMaterialExt](struct.ForwardDecalMaterialExt.html "struct bevy::pbr::decal::ForwardDecalMaterialExt")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/decal/forward.rs.html#145)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [ForwardDecalMaterialExt](struct.ForwardDecalMaterialExt.html "struct bevy::pbr::decal::ForwardDecalMaterialExt")
...
### impl [MaterialExtension](../trait.MaterialExtension.html "trait bevy::pbr::MaterialExtension") for [ForwardDecalMaterialExt](struct.ForwardDecalMaterialExt.html "struct bevy::pbr::decal::ForwardDecalMaterialExt")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/decal/forward.rs.html#114)

#### fn [alpha\_mode](../trait.MaterialExtension.html#method.alpha_mode)() -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[AlphaMode](../../prelude/enum.AlphaMode.html "enum bevy::prelude::AlphaMode")\>

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/decal/forward.rs.html#118)

#### fn [enable\_shadows](../trait.MaterialExtension.html#method.enable_shadows)() -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Controls if shadows are enabled for the Material.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/decal/forward.rs.html#122-127)

#### fn [specialize](../trait.MaterialExtension.html#method.specialize)( \_pipeline: &[MaterialExtensionPipeline](../struct.MaterialExtensionPipeline.html "struct bevy::pbr::MaterialExtensionPipeline"), descriptor: &mut [RenderPipelineDescriptor](../../material/descriptor/struct.RenderPipelineDescriptor.html "struct bevy::material::descriptor::RenderPipelineDescriptor"), \_layout: &[MeshVertexBufferLayoutRef](../../mesh/struct.MeshVertexBufferLayoutRef.html "struct bevy::mesh::MeshVertexBufferLayoutRef"), \_key: [MaterialExtensionKey](../struct.MaterialExtensionKey.html "struct bevy::pbr::MaterialExtensionKey")<[ForwardDecalMaterialExt](struct.ForwardDecalMaterialExt.html "struct bevy::pbr::decal::ForwardDecalMaterialExt")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [SpecializedMeshPipelineError](../../material/specialize/enum.SpecializedMeshPipelineError.html "enum bevy::material::specialize::SpecializedMeshPipelineError")\>
...
#### fn [vertex\_shader](../trait.MaterialExtension.html#method.vertex_shader)() -> [ShaderRef](../../shader/enum.ShaderRef.html "enum bevy::shader::ShaderRef")
...
#### fn [fragment\_shader](../trait.MaterialExtension.html#method.fragment_shader)() -> [ShaderRef](../../shader/enum.ShaderRef.html "enum bevy::shader::ShaderRef")
...
#### fn [enable\_prepass](../trait.MaterialExtension.html#method.enable_prepass)() -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
#### fn [prepass\_vertex\_shader](../trait.MaterialExtension.html#method.prepass_vertex_shader)() -> [ShaderRef](../../shader/enum.ShaderRef.html "enum bevy::shader::ShaderRef")
...
#### fn [prepass\_fragment\_shader](../trait.MaterialExtension.html#method.prepass_fragment_shader)() -> [ShaderRef](../../shader/enum.ShaderRef.html "enum bevy::shader::ShaderRef")
...
#### fn [deferred\_vertex\_shader](../trait.MaterialExtension.html#method.deferred_vertex_shader)() -> [ShaderRef](../../shader/enum.ShaderRef.html "enum bevy::shader::ShaderRef")
...
#### fn [deferred\_fragment\_shader](../trait.MaterialExtension.html#method.deferred_fragment_shader)() -> [ShaderRef](../../shader/enum.ShaderRef.html "enum bevy::shader::ShaderRef")
...
#### fn [meshlet\_mesh\_fragment\_shader](../trait.MaterialExtension.html#method.meshlet_mesh_fragment_shader)() -> [ShaderRef](../../shader/enum.ShaderRef.html "enum bevy::shader::ShaderRef")
...
#### fn [meshlet\_mesh\_prepass\_fragment\_shader](../trait.MaterialExtension.html#method.meshlet_mesh_prepass_fragment_shader)() -> [ShaderRef](../../shader/enum.ShaderRef.html "enum bevy::shader::ShaderRef")
...
#### fn [meshlet\_mesh\_deferred\_fragment\_shader](../trait.MaterialExtension.html#method.meshlet_mesh_deferred_fragment_shader)() -> [ShaderRef](../../shader/enum.ShaderRef.html "enum bevy::shader::ShaderRef")
...
### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [ForwardDecalMaterialExt](struct.ForwardDecalMaterialExt.html "struct bevy::pbr::decal::ForwardDecalMaterialExt")
...
### impl [VisitAssetDependencies](../../asset/trait.VisitAssetDependencies.html "trait bevy::asset::VisitAssetDependencies") for [ForwardDecalMaterialExt](struct.ForwardDecalMaterialExt.html "struct bevy::pbr::decal::ForwardDecalMaterialExt")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ForwardDecalMaterialExt](struct.ForwardDecalMaterialExt.html "struct bevy::pbr::decal::ForwardDecalMaterialExt")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ForwardDecalMaterialExt](struct.ForwardDecalMaterialExt.html "struct bevy::pbr::decal::ForwardDecalMaterialExt")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ForwardDecalMaterialExt](struct.ForwardDecalMaterialExt.html "struct bevy::pbr::decal::ForwardDecalMaterialExt")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ForwardDecalMaterialExt](struct.ForwardDecalMaterialExt.html "struct bevy::pbr::decal::ForwardDecalMaterialExt")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ForwardDecalMaterialExt](struct.ForwardDecalMaterialExt.html "struct bevy::pbr::decal::ForwardDecalMaterialExt")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ForwardDecalMaterialExt](struct.ForwardDecalMaterialExt.html "struct bevy::pbr::decal::ForwardDecalMaterialExt")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ForwardDecalMaterialExt](struct.ForwardDecalMaterialExt.html "struct bevy::pbr::decal::ForwardDecalMaterialExt")
