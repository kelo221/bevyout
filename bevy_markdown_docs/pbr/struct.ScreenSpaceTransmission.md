...
# Struct ScreenSpaceTransmission 

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/transmission/mod.rs.html#67)
...
`steps: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)`
...
*   Setting this to `0` disables the screen-space refraction effect entirely, and falls back to refracting only the environment map light’s texture.
*   If set to more than `0`, any opaque [`clear_color`](../prelude/struct.Camera.html#structfield.clear_color "field bevy::prelude::Camera::clear_color") will obscure the environment map light’s texture, preventing it from being visible through transmissive materials. If you’d like to still have the environment map show up in your refractions, you can set the clear color’s alpha to `0.0`. Keep in mind that depending on the platform and your window settings, this may cause the window to become transparent.

`quality: [ScreenSpaceTransmissionQuality](enum.ScreenSpaceTransmissionQuality.html "enum bevy::pbr::ScreenSpaceTransmissionQuality")`
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/transmission/mod.rs.html#65)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")

where [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/transmission/mod.rs.html#95)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/transmission/mod.rs.html#96)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/transmission/mod.rs.html#65)

### impl [ExtractComponent](../render/extract_component/trait.ExtractComponent.html "trait bevy::render::extract_component::ExtractComponent") for [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")

where [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission"): [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/transmission/mod.rs.html#65)

#### type [QueryData](../render/extract_component/trait.ExtractComponent.html#associatedtype.QueryData) = &'static [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")
...
#### type [Out](../render/extract_component/trait.ExtractComponent.html#associatedtype.Out) = [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")
...
#### fn [extract\_component](../render/extract_component/trait.ExtractComponent.html#tymethod.extract_component)( item: <<[ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission") as [ExtractComponent](../render/extract_component/trait.ExtractComponent.html "trait bevy::render::extract_component::ExtractComponent")\>::[QueryData](../render/extract_component/trait.ExtractComponent.html#associatedtype.QueryData "type bevy::render::extract_component::ExtractComponent::QueryData") as [QueryData](../ecs/query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../ecs/query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'\_, '\_>, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission") as [ExtractComponent](../render/extract_component/trait.ExtractComponent.html "trait bevy::render::extract_component::ExtractComponent")\>::[Out](../render/extract_component/trait.ExtractComponent.html#associatedtype.Out "type bevy::render::extract_component::ExtractComponent::Out")\>
...
### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/transmission/mod.rs.html#65)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/transmission/mod.rs.html#65)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/transmission/mod.rs.html#65)

### impl [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/transmission/mod.rs.html#65)

#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")
...
where [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission"): 'into\_return,
...
### impl [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")
...
#### fn [reflect\_owned](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/transmission/mod.rs.html#65)

#### fn [try\_into\_reflect](../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")\>, ) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/transmission/mod.rs.html#66)
...
### impl [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/transmission/mod.rs.html#65)

#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Struct](../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")
...
### impl [SyncComponent](../render/sync_component/trait.SyncComponent.html "trait bevy::render::sync_component::SyncComponent") for [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")

where [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission"): [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/transmission/mod.rs.html#65)

#### type [Target](../render/sync_component/trait.SyncComponent.html#associatedtype.Target) = [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")

Describes what components should be removed from the render world if the implementing component is removed.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/transmission/mod.rs.html#65)

### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ScreenSpaceTransmission](struct.ScreenSpaceTransmission.html "struct bevy::pbr::ScreenSpaceTransmission")
