...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/light_probe/generate.rs.html#479)
...
`environment_map: [GpuImage](../../render/texture/struct.GpuImage.html "struct bevy::render::texture::GpuImage")``diffuse_map: [GpuImage](../../render/texture/struct.GpuImage.html "struct bevy::render::texture::GpuImage")``specular_map: [GpuImage](../../render/texture/struct.GpuImage.html "struct bevy::render::texture::GpuImage")``intensity: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)``rotation: [Quat](../../prelude/struct.Quat.html "struct bevy::prelude::Quat")``affects_lightmapped_mesh_diffuse: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/light_probe/generate.rs.html#478)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [RenderEnvironmentMap](struct.RenderEnvironmentMap.html "struct bevy::pbr::generate::RenderEnvironmentMap")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/light_probe/generate.rs.html#478)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [RenderEnvironmentMap](struct.RenderEnvironmentMap.html "struct bevy::pbr::generate::RenderEnvironmentMap")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [RenderEnvironmentMap](struct.RenderEnvironmentMap.html "struct bevy::pbr::generate::RenderEnvironmentMap")

where [RenderEnvironmentMap](struct.RenderEnvironmentMap.html "struct bevy::pbr::generate::RenderEnvironmentMap"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RenderEnvironmentMap](struct.RenderEnvironmentMap.html "struct bevy::pbr::generate::RenderEnvironmentMap")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RenderEnvironmentMap](struct.RenderEnvironmentMap.html "struct bevy::pbr::generate::RenderEnvironmentMap")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RenderEnvironmentMap](struct.RenderEnvironmentMap.html "struct bevy::pbr::generate::RenderEnvironmentMap")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RenderEnvironmentMap](struct.RenderEnvironmentMap.html "struct bevy::pbr::generate::RenderEnvironmentMap")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RenderEnvironmentMap](struct.RenderEnvironmentMap.html "struct bevy::pbr::generate::RenderEnvironmentMap")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RenderEnvironmentMap](struct.RenderEnvironmentMap.html "struct bevy::pbr::generate::RenderEnvironmentMap")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RenderEnvironmentMap](struct.RenderEnvironmentMap.html "struct bevy::pbr::generate::RenderEnvironmentMap")
