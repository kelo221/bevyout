...
# Struct GeneratorBindGroups 

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/light_probe/generate.rs.html#550)
...
`downsampling_first: [BindGroup](../../render/render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup")``downsampling_second: [BindGroup](../../render/render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup")``radiance: [Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[BindGroup](../../render/render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup")>``irradiance: [BindGroup](../../render/render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup")``copy: [BindGroup](../../render/render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup")`

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/light_probe/generate.rs.html#549)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [GeneratorBindGroups](struct.GeneratorBindGroups.html "struct bevy::pbr::generate::GeneratorBindGroups")

where [GeneratorBindGroups](struct.GeneratorBindGroups.html "struct bevy::pbr::generate::GeneratorBindGroups"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [GeneratorBindGroups](struct.GeneratorBindGroups.html "struct bevy::pbr::generate::GeneratorBindGroups")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [GeneratorBindGroups](struct.GeneratorBindGroups.html "struct bevy::pbr::generate::GeneratorBindGroups")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [GeneratorBindGroups](struct.GeneratorBindGroups.html "struct bevy::pbr::generate::GeneratorBindGroups")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [GeneratorBindGroups](struct.GeneratorBindGroups.html "struct bevy::pbr::generate::GeneratorBindGroups")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [GeneratorBindGroups](struct.GeneratorBindGroups.html "struct bevy::pbr::generate::GeneratorBindGroups")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [GeneratorBindGroups](struct.GeneratorBindGroups.html "struct bevy::pbr::generate::GeneratorBindGroups")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [GeneratorBindGroups](struct.GeneratorBindGroups.html "struct bevy::pbr::generate::GeneratorBindGroups")
