...
# Struct ScreenSpaceAmbientOcclusionResources 

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssao/mod.rs.html#507)
...
`screen_space_ambient_occlusion_texture: [CachedTexture](../render/texture/struct.CachedTexture.html "struct bevy::render::texture::CachedTexture")`

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssao/mod.rs.html#506)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [ScreenSpaceAmbientOcclusionResources](struct.ScreenSpaceAmbientOcclusionResources.html "struct bevy::pbr::ScreenSpaceAmbientOcclusionResources")

where [ScreenSpaceAmbientOcclusionResources](struct.ScreenSpaceAmbientOcclusionResources.html "struct bevy::pbr::ScreenSpaceAmbientOcclusionResources"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ScreenSpaceAmbientOcclusionResources](struct.ScreenSpaceAmbientOcclusionResources.html "struct bevy::pbr::ScreenSpaceAmbientOcclusionResources")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ScreenSpaceAmbientOcclusionResources](struct.ScreenSpaceAmbientOcclusionResources.html "struct bevy::pbr::ScreenSpaceAmbientOcclusionResources")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ScreenSpaceAmbientOcclusionResources](struct.ScreenSpaceAmbientOcclusionResources.html "struct bevy::pbr::ScreenSpaceAmbientOcclusionResources")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ScreenSpaceAmbientOcclusionResources](struct.ScreenSpaceAmbientOcclusionResources.html "struct bevy::pbr::ScreenSpaceAmbientOcclusionResources")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ScreenSpaceAmbientOcclusionResources](struct.ScreenSpaceAmbientOcclusionResources.html "struct bevy::pbr::ScreenSpaceAmbientOcclusionResources")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ScreenSpaceAmbientOcclusionResources](struct.ScreenSpaceAmbientOcclusionResources.html "struct bevy::pbr::ScreenSpaceAmbientOcclusionResources")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ScreenSpaceAmbientOcclusionResources](struct.ScreenSpaceAmbientOcclusionResources.html "struct bevy::pbr::ScreenSpaceAmbientOcclusionResources")
