...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#3727)

```rust
pub enum MeshBindGroups {
    CpuPreprocessing(MeshPhaseBindGroups),
    GpuPreprocessing(IndexMap<TypeId, MeshPhaseBindGroups, NoOpHash>),
}
```
...
### CpuPreprocessing([MeshPhaseBindGroups](struct.MeshPhaseBindGroups.html "struct bevy::pbr::MeshPhaseBindGroups"))

The bind groups for the meshes for the entire scene, if GPU mesh preprocessing isn’t in use.

### GpuPreprocessing([IndexMap](https://docs.rs/indexmap/2.14.0/x86_64-unknown-linux-gnu/indexmap/map/struct.IndexMap.html "struct indexmap::map::IndexMap")<[TypeId](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId"), [MeshPhaseBindGroups](struct.MeshPhaseBindGroups.html "struct bevy::pbr::MeshPhaseBindGroups"), [NoOpHash](../platform/hash/struct.NoOpHash.html "struct bevy::platform::hash::NoOpHash")\>)

A mapping from the type ID of a phase (e.g. [`Opaque3d`](../core_pipeline/core_3d/struct.Opaque3d.html "struct bevy::core_pipeline::core_3d::Opaque3d")) to the mesh bind groups for that phase.

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#3726)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [MeshBindGroups](enum.MeshBindGroups.html "enum bevy::pbr::MeshBindGroups")

where [MeshBindGroups](enum.MeshBindGroups.html "enum bevy::pbr::MeshBindGroups"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
#### fn [map\_entities](../prelude/trait.Component.html#method.map_entities)<M>(this: &mut [MeshBindGroups](enum.MeshBindGroups.html "enum bevy::pbr::MeshBindGroups"), mapper: [&mut M](https://doc.rust-lang.org/nightly/std/primitive.reference.html))
...
### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [MeshBindGroups](enum.MeshBindGroups.html "enum bevy::pbr::MeshBindGroups")

where [MeshBindGroups](enum.MeshBindGroups.html "enum bevy::pbr::MeshBindGroups"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MeshBindGroups](enum.MeshBindGroups.html "enum bevy::pbr::MeshBindGroups")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MeshBindGroups](enum.MeshBindGroups.html "enum bevy::pbr::MeshBindGroups")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MeshBindGroups](enum.MeshBindGroups.html "enum bevy::pbr::MeshBindGroups")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MeshBindGroups](enum.MeshBindGroups.html "enum bevy::pbr::MeshBindGroups")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MeshBindGroups](enum.MeshBindGroups.html "enum bevy::pbr::MeshBindGroups")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MeshBindGroups](enum.MeshBindGroups.html "enum bevy::pbr::MeshBindGroups")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MeshBindGroups](enum.MeshBindGroups.html "enum bevy::pbr::MeshBindGroups")
