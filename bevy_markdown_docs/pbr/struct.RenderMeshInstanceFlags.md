...
# Struct RenderMeshInstanceFlags 

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)
...
### impl [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### pub const [SHADOW\_CASTER](#associatedconstant.SHADOW_CASTER): [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

The mesh casts shadows.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### pub const [AUTOMATIC\_BATCHING](#associatedconstant.AUTOMATIC_BATCHING): [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

The mesh can participate in automatic batching.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### pub const [HAS\_PREVIOUS\_TRANSFORM](#associatedconstant.HAS_PREVIOUS_TRANSFORM): [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

The mesh had a transform last frame and so is eligible for motion vector computation.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### pub const [HAS\_PREVIOUS\_SKIN](#associatedconstant.HAS_PREVIOUS_SKIN): [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

The mesh had a skin last frame and so that skin should be taken into account for motion vector computation.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### pub const [HAS\_PREVIOUS\_MORPH](#associatedconstant.HAS_PREVIOUS_MORPH): [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

The mesh had morph targets last frame and so they should be taken into account for motion vector computation.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### pub const [NO\_CPU\_CULLING](#associatedconstant.NO_CPU_CULLING): [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

CPU culling has been disabled because the `NoCpuCulling` component is present on the mesh instance.
...
#### pub const fn [empty](#method.empty)() -> [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

Get a flags value with all bits unset.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### pub const fn [all](#method.all)() -> [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")
...
#### pub const fn [from\_bits](#method.from_bits)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")\>
...
#### pub const fn [from\_bits\_truncate](#method.from_bits_truncate)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

Convert from a bits value, unsetting any unknown bits.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### pub const fn [from\_bits\_retain](#method.from_bits_retain)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

Convert from a bits value exactly.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### pub fn [from\_name](#method.from_name)(name: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")\>
...
#### pub const fn [intersects](#method.intersects)(&self, other: [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Whether any set bits in `other` are also set in `self`.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### pub const fn [contains](#method.contains)(&self, other: [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Whether all set bits in `other` are also set in `self`.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### pub fn [insert](#method.insert)(&mut self, other: [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags"))

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### pub fn [remove](#method.remove)(&mut self, other: [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags"))
...
#### pub fn [toggle](#method.toggle)(&mut self, other: [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags"))

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### pub fn [set](#method.set)(&mut self, other: [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags"), value: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Call `insert` when `value` is `true` or `remove` when `value` is `false`.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### pub const fn [intersection](#method.intersection)( self, other: [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags"), ) -> [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

The bitwise and (`&`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### pub const fn [union](#method.union)( self, other: [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags"), ) -> [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### pub const fn [difference](#method.difference)( self, other: [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags"), ) -> [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")
...
#### pub const fn [symmetric\_difference](#method.symmetric_difference)( self, other: [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags"), ) -> [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### pub const fn [complement](#method.complement)(self) -> [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")
...
#### pub const fn [iter](#method.iter)(&self) -> [Iter](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.Iter.html "struct bitflags::iter::Iter")<[RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")\> [ⓘ](#)
...
#### pub const fn [iter\_names](#method.iter_names)(&self) -> [IterNames](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.IterNames.html "struct bitflags::iter::IterNames")<[RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")\> [ⓘ](#)
...
### impl [Binary](https://doc.rust-lang.org/nightly/core/fmt/trait.Binary.html "trait core::fmt::Binary") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")
...
### impl [BitAnd](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html "trait core::ops::bit::BitAnd") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### fn [bitand](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html#tymethod.bitand)(self, other: [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")) -> [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

The bitwise and (`&`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html#associatedtype.Output) = [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

The resulting type after applying the `&` operator.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

### impl [BitAndAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAndAssign.html "trait core::ops::bit::BitAndAssign") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### fn [bitand\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAndAssign.html#tymethod.bitand_assign)(&mut self, other: [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags"))

The bitwise and (`&`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

### impl [BitOr](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html "trait core::ops::bit::BitOr") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### fn [bitor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html#tymethod.bitor)(self, other: [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")) -> [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html#associatedtype.Output) = [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

The resulting type after applying the `|` operator.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

### impl [BitOrAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOrAssign.html "trait core::ops::bit::BitOrAssign") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### fn [bitor\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOrAssign.html#tymethod.bitor_assign)(&mut self, other: [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags"))

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

### impl [BitXor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html "trait core::ops::bit::BitXor") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### fn [bitxor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html#tymethod.bitxor)(self, other: [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")) -> [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html#associatedtype.Output) = [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

The resulting type after applying the `^` operator.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

### impl [BitXorAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXorAssign.html "trait core::ops::bit::BitXorAssign") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### fn [bitxor\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXorAssign.html#tymethod.bitxor_assign)(&mut self, other: [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags"))

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#774)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#774)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#774)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#774)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

### impl [Extend](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.Extend.html "trait core::iter::traits::collect::Extend")<[RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")\> for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")
...
where T: [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")\>,
...
### impl [Flags](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html "trait bitflags::traits::Flags") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### const [FLAGS](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#associatedconstant.FLAGS): &'static \[[Flag](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/struct.Flag.html "struct bitflags::traits::Flag")<[RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")\>\]
...
#### fn [from\_bits\_retain](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#tymethod.from_bits_retain)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

Convert from a bits value exactly.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### fn [all\_named](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#method.all_named)() -> [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")
...
### impl [FromIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html "trait core::iter::traits::collect::FromIterator")<[RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")\> for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### fn [from\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html#tymethod.from_iter)<T>(iterator: T) -> [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")
...
### impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### type [Item](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.Item) = [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

The type of the elements being iterated over.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### type [IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter) = [Iter](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.Iter.html "struct bitflags::iter::Iter")<[RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")\>

Which kind of iterator are we turning this into?

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### fn [into\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)(self) -> <[RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags") as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter "type core::iter::traits::collect::IntoIterator::IntoIter")

Creates an iterator from a value. [Read more](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

### impl [LowerHex](https://doc.rust-lang.org/nightly/core/fmt/trait.LowerHex.html "trait core::fmt::LowerHex") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")
...
### impl [Not](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html "trait core::ops::bit::Not") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### fn [not](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html#tymethod.not)(self) -> [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

The bitwise negation (`!`) of the bits in `self`, truncating the result.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html#associatedtype.Output) = [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

The resulting type after applying the `!` operator.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

### impl [Octal](https://doc.rust-lang.org/nightly/core/fmt/trait.Octal.html "trait core::fmt::Octal") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")
...
### impl [Pod](https://docs.rs/bytemuck/1.25.0/x86_64-unknown-linux-gnu/bytemuck/pod/trait.Pod.html "trait bytemuck::pod::Pod") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

### impl [Sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html "trait core::ops::arith::Sub") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### fn [sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#tymethod.sub)(self, other: [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")) -> [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")
...
#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#associatedtype.Output) = [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

The resulting type after applying the `-` operator.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

### impl [SubAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html "trait core::ops::arith::SubAssign") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#772-794)

#### fn [sub\_assign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html#tymethod.sub_assign)(&mut self, other: [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags"))
...
### impl [UpperHex](https://doc.rust-lang.org/nightly/core/fmt/trait.UpperHex.html "trait core::fmt::UpperHex") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")
...
### impl [Zeroable](https://docs.rs/bytemuck/1.25.0/x86_64-unknown-linux-gnu/bytemuck/zeroable/trait.Zeroable.html "trait bytemuck::zeroable::Zeroable") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RenderMeshInstanceFlags](struct.RenderMeshInstanceFlags.html "struct bevy::pbr::RenderMeshInstanceFlags")
