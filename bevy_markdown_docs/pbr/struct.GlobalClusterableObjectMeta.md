...
# Struct GlobalClusterableObjectMeta 

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#136)
...
`gpu_clustered_lights: [GpuClusteredLights](struct.GpuClusteredLights.html "struct bevy::pbr::GpuClusteredLights")`

GPU buffers that hold data about the clustered lights.

This is only for lights. Data about other clusterable objects are stored in other buffers.

`entity_to_index: [EntityHashMap](../ecs/entity/struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)>`

Maps a _render-world_ entity to the index in the appropriate list.

Only clusterable objects that have render-world entities are in this list! In particular, light probes (reflection probes and irradiance volumes) are not.

## Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#264)

### impl [GlobalClusterableObjectMeta](struct.GlobalClusterableObjectMeta.html "struct bevy::pbr::GlobalClusterableObjectMeta")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#265)

#### pub fn [new](#method.new)( buffer\_binding\_type: [BufferBindingType](../render/render_resource/enum.BufferBindingType.html "enum bevy::render::render_resource::BufferBindingType"), ) -> [GlobalClusterableObjectMeta](struct.GlobalClusterableObjectMeta.html "struct bevy::pbr::GlobalClusterableObjectMeta")

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#135)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [GlobalClusterableObjectMeta](struct.GlobalClusterableObjectMeta.html "struct bevy::pbr::GlobalClusterableObjectMeta")

where [GlobalClusterableObjectMeta](struct.GlobalClusterableObjectMeta.html "struct bevy::pbr::GlobalClusterableObjectMeta"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [GlobalClusterableObjectMeta](struct.GlobalClusterableObjectMeta.html "struct bevy::pbr::GlobalClusterableObjectMeta")

where [GlobalClusterableObjectMeta](struct.GlobalClusterableObjectMeta.html "struct bevy::pbr::GlobalClusterableObjectMeta"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [GlobalClusterableObjectMeta](struct.GlobalClusterableObjectMeta.html "struct bevy::pbr::GlobalClusterableObjectMeta")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [GlobalClusterableObjectMeta](struct.GlobalClusterableObjectMeta.html "struct bevy::pbr::GlobalClusterableObjectMeta")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [GlobalClusterableObjectMeta](struct.GlobalClusterableObjectMeta.html "struct bevy::pbr::GlobalClusterableObjectMeta")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [GlobalClusterableObjectMeta](struct.GlobalClusterableObjectMeta.html "struct bevy::pbr::GlobalClusterableObjectMeta")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [GlobalClusterableObjectMeta](struct.GlobalClusterableObjectMeta.html "struct bevy::pbr::GlobalClusterableObjectMeta")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [GlobalClusterableObjectMeta](struct.GlobalClusterableObjectMeta.html "struct bevy::pbr::GlobalClusterableObjectMeta")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [GlobalClusterableObjectMeta](struct.GlobalClusterableObjectMeta.html "struct bevy::pbr::GlobalClusterableObjectMeta")
