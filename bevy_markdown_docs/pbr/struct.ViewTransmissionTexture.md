...
# Struct ViewTransmissionTexture 

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/transmission/texture.rs.html#24)
...
`texture: [Texture](../render/render_resource/struct.Texture.html "struct bevy::render::render_resource::Texture")``view: [TextureView](../render/render_resource/struct.TextureView.html "struct bevy::render::render_resource::TextureView")``sampler: [Sampler](../render/render_resource/struct.Sampler.html "struct bevy::render::render_resource::Sampler")`

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/transmission/texture.rs.html#23)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [ViewTransmissionTexture](struct.ViewTransmissionTexture.html "struct bevy::pbr::ViewTransmissionTexture")

where [ViewTransmissionTexture](struct.ViewTransmissionTexture.html "struct bevy::pbr::ViewTransmissionTexture"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ViewTransmissionTexture](struct.ViewTransmissionTexture.html "struct bevy::pbr::ViewTransmissionTexture")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ViewTransmissionTexture](struct.ViewTransmissionTexture.html "struct bevy::pbr::ViewTransmissionTexture")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ViewTransmissionTexture](struct.ViewTransmissionTexture.html "struct bevy::pbr::ViewTransmissionTexture")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ViewTransmissionTexture](struct.ViewTransmissionTexture.html "struct bevy::pbr::ViewTransmissionTexture")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ViewTransmissionTexture](struct.ViewTransmissionTexture.html "struct bevy::pbr::ViewTransmissionTexture")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ViewTransmissionTexture](struct.ViewTransmissionTexture.html "struct bevy::pbr::ViewTransmissionTexture")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ViewTransmissionTexture](struct.ViewTransmissionTexture.html "struct bevy::pbr::ViewTransmissionTexture")
