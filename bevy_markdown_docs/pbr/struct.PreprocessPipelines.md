...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/gpu_preprocess.rs.html#97)
...
`direct_preprocess: [PreprocessPipeline](struct.PreprocessPipeline.html "struct bevy::pbr::PreprocessPipeline")`

The pipeline used for CPU culling. This pipeline doesn’t populate indirect parameter metadata.

`gpu_frustum_culling_preprocess: [PreprocessPipeline](struct.PreprocessPipeline.html "struct bevy::pbr::PreprocessPipeline")`
...
`early_gpu_occlusion_culling_preprocess: [PreprocessPipeline](struct.PreprocessPipeline.html "struct bevy::pbr::PreprocessPipeline")`
...
`late_gpu_occlusion_culling_preprocess: [PreprocessPipeline](struct.PreprocessPipeline.html "struct bevy::pbr::PreprocessPipeline")`

The pipeline used for the second phase of occlusion culling.

This pipeline culls, transforms meshes, and populates indirect parameter metadata.

`gpu_frustum_culling_build_indexed_indirect_params: [BuildIndirectParametersPipeline](struct.BuildIndirectParametersPipeline.html "struct bevy::pbr::BuildIndirectParametersPipeline")`

The pipeline that builds indirect draw parameters for indexed meshes, when frustum culling is enabled but occlusion culling _isn’t_ enabled.

`gpu_frustum_culling_build_non_indexed_indirect_params: [BuildIndirectParametersPipeline](struct.BuildIndirectParametersPipeline.html "struct bevy::pbr::BuildIndirectParametersPipeline")`

The pipeline that builds indirect draw parameters for non-indexed meshes, when frustum culling is enabled but occlusion culling _isn’t_ enabled.

`early_phase: [PreprocessPhasePipelines](struct.PreprocessPhasePipelines.html "struct bevy::pbr::PreprocessPhasePipelines")`

Compute shader pipelines for the early prepass phase that draws meshes visible in the previous frame.

`late_phase: [PreprocessPhasePipelines](struct.PreprocessPhasePipelines.html "struct bevy::pbr::PreprocessPhasePipelines")`
...
`main_phase: [PreprocessPhasePipelines](struct.PreprocessPhasePipelines.html "struct bevy::pbr::PreprocessPhasePipelines")`

Compute shader pipelines for the main color phase.

`bin_unpacking: [BinUnpackingPipeline](struct.BinUnpackingPipeline.html "struct bevy::pbr::BinUnpackingPipeline")`
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [PreprocessPipelines](struct.PreprocessPipelines.html "struct bevy::pbr::PreprocessPipelines")

where [PreprocessPipelines](struct.PreprocessPipelines.html "struct bevy::pbr::PreprocessPipelines"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [FromWorld](../prelude/trait.FromWorld.html "trait bevy::prelude::FromWorld") for [PreprocessPipelines](struct.PreprocessPipelines.html "struct bevy::pbr::PreprocessPipelines")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/gpu_preprocess.rs.html#1262)

#### fn [from\_world](../prelude/trait.FromWorld.html#tymethod.from_world)(world: &mut [World](../prelude/struct.World.html "struct bevy::prelude::World")) -> [PreprocessPipelines](struct.PreprocessPipelines.html "struct bevy::pbr::PreprocessPipelines")

Creates `Self` using data from the given [`World`](../prelude/struct.World.html "struct bevy::prelude::World").

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/gpu_preprocess.rs.html#96)

### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [PreprocessPipelines](struct.PreprocessPipelines.html "struct bevy::pbr::PreprocessPipelines")

where [PreprocessPipelines](struct.PreprocessPipelines.html "struct bevy::pbr::PreprocessPipelines"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [PreprocessPipelines](struct.PreprocessPipelines.html "struct bevy::pbr::PreprocessPipelines")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [PreprocessPipelines](struct.PreprocessPipelines.html "struct bevy::pbr::PreprocessPipelines")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [PreprocessPipelines](struct.PreprocessPipelines.html "struct bevy::pbr::PreprocessPipelines")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [PreprocessPipelines](struct.PreprocessPipelines.html "struct bevy::pbr::PreprocessPipelines")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [PreprocessPipelines](struct.PreprocessPipelines.html "struct bevy::pbr::PreprocessPipelines")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [PreprocessPipelines](struct.PreprocessPipelines.html "struct bevy::pbr::PreprocessPipelines")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [PreprocessPipelines](struct.PreprocessPipelines.html "struct bevy::pbr::PreprocessPipelines")
