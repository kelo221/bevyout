...
# Struct ViewShadowBindings 

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/light.rs.html#934)
...
`point_light_depth_texture: [Texture](../render/render_resource/struct.Texture.html "struct bevy::render::render_resource::Texture")``point_light_depth_texture_view: [TextureView](../render/render_resource/struct.TextureView.html "struct bevy::render::render_resource::TextureView")``directional_light_depth_texture: [Texture](../render/render_resource/struct.Texture.html "struct bevy::render::render_resource::Texture")``directional_light_depth_texture_view: [TextureView](../render/render_resource/struct.TextureView.html "struct bevy::render::render_resource::TextureView")`

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/light.rs.html#933)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [ViewShadowBindings](struct.ViewShadowBindings.html "struct bevy::pbr::ViewShadowBindings")

where [ViewShadowBindings](struct.ViewShadowBindings.html "struct bevy::pbr::ViewShadowBindings"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ViewShadowBindings](struct.ViewShadowBindings.html "struct bevy::pbr::ViewShadowBindings")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ViewShadowBindings](struct.ViewShadowBindings.html "struct bevy::pbr::ViewShadowBindings")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ViewShadowBindings](struct.ViewShadowBindings.html "struct bevy::pbr::ViewShadowBindings")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ViewShadowBindings](struct.ViewShadowBindings.html "struct bevy::pbr::ViewShadowBindings")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ViewShadowBindings](struct.ViewShadowBindings.html "struct bevy::pbr::ViewShadowBindings")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ViewShadowBindings](struct.ViewShadowBindings.html "struct bevy::pbr::ViewShadowBindings")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ViewShadowBindings](struct.ViewShadowBindings.html "struct bevy::pbr::ViewShadowBindings")
