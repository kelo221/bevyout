...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssr/mod.rs.html#82)
...
Screen-space reflections currently require deferred rendering in order to appear. Therefore, they also need the [`DepthPrepass`](../core_pipeline/prepass/struct.DepthPrepass.html "struct bevy::core_pipeline::prepass::DepthPrepass") and [`DeferredPrepass`](../core_pipeline/prepass/struct.DeferredPrepass.html "struct bevy::core_pipeline::prepass::DeferredPrepass") components, which are inserted automatically, but deferred rendering itself is not automatically enabled.

Enable the `bluenoise_texture` feature to improve the quality of noise on rough reflections.

As with all screen-space techniques, SSR can only reflect objects on screen. When objects leave the camera, they will disappear from reflections. An alternative that doesn’t suffer from this problem is the combination of a [`LightProbe`](../prelude/struct.LightProbe.html "struct bevy::prelude::LightProbe") and [`EnvironmentMapLight`](../prelude/struct.EnvironmentMapLight.html "struct bevy::prelude::EnvironmentMapLight"). The advantage of SSR is that it can reflect all objects, not just static ones.
...
`min_perceptual_roughness: [Range](https://doc.rust-lang.org/nightly/core/ops/range/struct.Range.html "struct core::ops::range::Range")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)>`

The perceptual roughness range over which SSR begins to fade in.

The first value is the roughness at which SSR begins to appear; the second value is the roughness at which SSR is fully active.

`max_perceptual_roughness: [Range](https://doc.rust-lang.org/nightly/core/ops/range/struct.Range.html "struct core::ops::range::Range")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)>`

The perceptual roughness range over which SSR begins to fade out.

The first value is the roughness at which SSR begins to fade out; the second value is the roughness at which SSR is no longer active.
...
`linear_steps: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
`linear_march_exponent: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`
...
`edge_fadeout: [Range](https://doc.rust-lang.org/nightly/core/ops/range/struct.Range.html "struct core::ops::range::Range")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)>`

The range over which SSR begins to fade out at the edges of the screen, in terms of a percentage of the screen dimensions.

The first value is the percentage from the edge at which SSR is no longer active; the second value is the percentage at which SSR is fully active.

`bisection_steps: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`
...
`use_secant: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssr/mod.rs.html#78)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")

where [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

**Required Components**: [`DepthPrepass`](../core_pipeline/prepass/struct.DepthPrepass.html "struct bevy::core_pipeline::prepass::DepthPrepass"), [`DeferredPrepass`](../core_pipeline/prepass/struct.DeferredPrepass.html "struct bevy::core_pipeline::prepass::DeferredPrepass").
...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssr/mod.rs.html#226)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssr/mod.rs.html#231)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssr/mod.rs.html#456)

### impl [ExtractComponent](../render/extract_component/trait.ExtractComponent.html "trait bevy::render::extract_component::ExtractComponent") for [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssr/mod.rs.html#457)

#### type [QueryData](../render/extract_component/trait.ExtractComponent.html#associatedtype.QueryData) = &'static [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")
...
#### type [Out](../render/extract_component/trait.ExtractComponent.html#associatedtype.Out) = [ScreenSpaceReflectionsUniform](struct.ScreenSpaceReflectionsUniform.html "struct bevy::pbr::ScreenSpaceReflectionsUniform")
...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssr/mod.rs.html#461)

#### fn [extract\_component](../render/extract_component/trait.ExtractComponent.html#tymethod.extract_component)( settings: <<[ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections") as [ExtractComponent](../render/extract_component/trait.ExtractComponent.html "trait bevy::render::extract_component::ExtractComponent")\>::[QueryData](../render/extract_component/trait.ExtractComponent.html#associatedtype.QueryData "type bevy::render::extract_component::ExtractComponent::QueryData") as [QueryData](../ecs/query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../ecs/query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'\_, '\_>, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections") as [ExtractComponent](../render/extract_component/trait.ExtractComponent.html "trait bevy::render::extract_component::ExtractComponent")\>::[Out](../render/extract_component/trait.ExtractComponent.html#associatedtype.Out "type bevy::render::extract_component::ExtractComponent::Out")\>
...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssr/mod.rs.html#543)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")\> for [ScreenSpaceReflectionsUniform](struct.ScreenSpaceReflectionsUniform.html "struct bevy::pbr::ScreenSpaceReflectionsUniform")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssr/mod.rs.html#544)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(settings: [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")) -> [ScreenSpaceReflectionsUniform](struct.ScreenSpaceReflectionsUniform.html "struct bevy::pbr::ScreenSpaceReflectionsUniform")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssr/mod.rs.html#78)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssr/mod.rs.html#78)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssr/mod.rs.html#78)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssr/mod.rs.html#78)

### impl [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssr/mod.rs.html#78)

#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")
...
where [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections"): 'into\_return,
...
### impl [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")
...
#### fn [reflect\_owned](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssr/mod.rs.html#78)

#### fn [try\_into\_reflect](../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")\>, ) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssr/mod.rs.html#79)
...
### impl [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssr/mod.rs.html#78)

#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Struct](../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")
...
### impl [SyncComponent](../render/sync_component/trait.SyncComponent.html "trait bevy::render::sync_component::SyncComponent") for [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssr/mod.rs.html#449)

#### type [Target](../render/sync_component/trait.SyncComponent.html#associatedtype.Target) = ([ScreenSpaceReflectionsUniform](struct.ScreenSpaceReflectionsUniform.html "struct bevy::pbr::ScreenSpaceReflectionsUniform"), [ViewScreenSpaceReflectionsUniformOffset](struct.ViewScreenSpaceReflectionsUniformOffset.html "struct bevy::pbr::ViewScreenSpaceReflectionsUniformOffset"), [ScreenSpaceReflectionsPipelineId](struct.ScreenSpaceReflectionsPipelineId.html "struct bevy::pbr::ScreenSpaceReflectionsPipelineId"))

Describes what components should be removed from the render world if the implementing component is removed.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssr/mod.rs.html#78)

### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ScreenSpaceReflections](struct.ScreenSpaceReflections.html "struct bevy::pbr::ScreenSpaceReflections")
