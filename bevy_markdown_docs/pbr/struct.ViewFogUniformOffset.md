...
# Struct ViewFogUniformOffset 

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/fog.rs.html#120)
...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/fog.rs.html#119)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [ViewFogUniformOffset](struct.ViewFogUniformOffset.html "struct bevy::pbr::ViewFogUniformOffset")

where [ViewFogUniformOffset](struct.ViewFogUniformOffset.html "struct bevy::pbr::ViewFogUniformOffset"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ViewFogUniformOffset](struct.ViewFogUniformOffset.html "struct bevy::pbr::ViewFogUniformOffset")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ViewFogUniformOffset](struct.ViewFogUniformOffset.html "struct bevy::pbr::ViewFogUniformOffset")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ViewFogUniformOffset](struct.ViewFogUniformOffset.html "struct bevy::pbr::ViewFogUniformOffset")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ViewFogUniformOffset](struct.ViewFogUniformOffset.html "struct bevy::pbr::ViewFogUniformOffset")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ViewFogUniformOffset](struct.ViewFogUniformOffset.html "struct bevy::pbr::ViewFogUniformOffset")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ViewFogUniformOffset](struct.ViewFogUniformOffset.html "struct bevy::pbr::ViewFogUniformOffset")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ViewFogUniformOffset](struct.ViewFogUniformOffset.html "struct bevy::pbr::ViewFogUniformOffset")
