...
# Struct ViewClusterBindings 

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#249)
...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#574)

### impl [ViewClusterBindings](struct.ViewClusterBindings.html "struct bevy::pbr::ViewClusterBindings")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#575)

#### pub const [MAX\_OFFSETS](#associatedconstant.MAX_OFFSETS): [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#577)

#### pub const [MAX\_INDICES](#associatedconstant.MAX_INDICES): [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html) = 16384

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#579)

#### pub fn [new](#method.new)(buffer\_binding\_type: [BufferBindingType](../render/render_resource/enum.BufferBindingType.html "enum bevy::render::render_resource::BufferBindingType")) -> [ViewClusterBindings](struct.ViewClusterBindings.html "struct bevy::pbr::ViewClusterBindings")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#587)

#### pub fn [clear](#method.clear)(&mut self)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#644)

#### pub fn [n\_indices](#method.n_indices)(&self) -> [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#675)

#### pub fn [push\_index](#method.push_index)(&mut self, index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html))

Pushes the index of a clustered object to the GPU buffer.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#683)

#### pub fn [push\_dummy\_index](#method.push_dummy_index)(&mut self)

Pushes a placeholder -1 index to the GPU buffer.

This is used when processing reflection probes and irradiance volumes that haven’t loaded yet.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#689)

#### pub fn [reserve\_clusters](#method.reserve_clusters)(&mut self, clusters: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html))

Reserves space in the cluster offsets-and-counts list for `clusters` clusters.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#711)

#### pub fn [reserve\_indices](#method.reserve_indices)(&mut self, elements: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html))

Reserves space in the index lists for `elements` indices.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#729)
...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#748)

#### pub fn [clusterable\_object\_index\_lists\_binding](#method.clusterable_object_index_lists_binding)( &self, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[BindingResource](../render/render_resource/enum.BindingResource.html "enum bevy::render::render_resource::BindingResource")<'\_>>

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#761)

#### pub fn [offsets\_and\_counts\_binding](#method.offsets_and_counts_binding)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[BindingResource](../render/render_resource/enum.BindingResource.html "enum bevy::render::render_resource::BindingResource")<'\_>>

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#774-776)

#### pub fn [min\_size\_clusterable\_object\_index\_lists](#method.min_size_clusterable_object_index_lists)( buffer\_binding\_type: [BufferBindingType](../render/render_resource/enum.BufferBindingType.html "enum bevy::render::render_resource::BufferBindingType"), ) -> [NonZero](https://doc.rust-lang.org/nightly/core/num/nonzero/struct.NonZero.html "struct core::num::nonzero::NonZero")<[u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)\>

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#783-785)

#### pub fn [min\_size\_cluster\_offsets\_and\_counts](#method.min_size_cluster_offsets_and_counts)( buffer\_binding\_type: [BufferBindingType](../render/render_resource/enum.BufferBindingType.html "enum bevy::render::render_resource::BufferBindingType"), ) -> [NonZero](https://doc.rust-lang.org/nightly/core/num/nonzero/struct.NonZero.html "struct core::num::nonzero::NonZero")<[u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)\>

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#248)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [ViewClusterBindings](struct.ViewClusterBindings.html "struct bevy::pbr::ViewClusterBindings")

where [ViewClusterBindings](struct.ViewClusterBindings.html "struct bevy::pbr::ViewClusterBindings"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ViewClusterBindings](struct.ViewClusterBindings.html "struct bevy::pbr::ViewClusterBindings")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ViewClusterBindings](struct.ViewClusterBindings.html "struct bevy::pbr::ViewClusterBindings")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ViewClusterBindings](struct.ViewClusterBindings.html "struct bevy::pbr::ViewClusterBindings")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ViewClusterBindings](struct.ViewClusterBindings.html "struct bevy::pbr::ViewClusterBindings")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ViewClusterBindings](struct.ViewClusterBindings.html "struct bevy::pbr::ViewClusterBindings")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ViewClusterBindings](struct.ViewClusterBindings.html "struct bevy::pbr::ViewClusterBindings")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ViewClusterBindings](struct.ViewClusterBindings.html "struct bevy::pbr::ViewClusterBindings")
