...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/morph.rs.html#104)
...
`current_buffer: [RawBufferVec](../render/render_resource/struct.RawBufferVec.html "struct bevy::render::render_resource::RawBufferVec")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)>`

The morph weights for the current frame.

`prev_buffer: [RawBufferVec](../render/render_resource/struct.RawBufferVec.html "struct bevy::render::render_resource::RawBufferVec")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)>`

The morph weights for the previous frame.

`descriptors_buffer: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[RawBufferVec](../render/render_resource/struct.RawBufferVec.html "struct bevy::render::render_resource::RawBufferVec")<[GpuMorphDescriptor](struct.GpuMorphDescriptor.html "struct bevy::pbr::GpuMorphDescriptor")>>`

Information that the GPU needs about each morph target.

This is only present if morph targets use storage buffers. If the platform doesn’t support storage buffers, we’re using morph target images instead, and the shader can determine the relevant info from the texture dimensions.

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/morph.rs.html#103)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [MorphUniforms](struct.MorphUniforms.html "struct bevy::pbr::MorphUniforms")

where [MorphUniforms](struct.MorphUniforms.html "struct bevy::pbr::MorphUniforms"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [FromWorld](../prelude/trait.FromWorld.html "trait bevy::prelude::FromWorld") for [MorphUniforms](struct.MorphUniforms.html "struct bevy::pbr::MorphUniforms")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/morph.rs.html#119)

#### fn [from\_world](../prelude/trait.FromWorld.html#tymethod.from_world)(world: &mut [World](../prelude/struct.World.html "struct bevy::prelude::World")) -> [MorphUniforms](struct.MorphUniforms.html "struct bevy::pbr::MorphUniforms")

Creates `Self` using data from the given [`World`](../prelude/struct.World.html "struct bevy::prelude::World").

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/morph.rs.html#103)

### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [MorphUniforms](struct.MorphUniforms.html "struct bevy::pbr::MorphUniforms")

where [MorphUniforms](struct.MorphUniforms.html "struct bevy::pbr::MorphUniforms"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MorphUniforms](struct.MorphUniforms.html "struct bevy::pbr::MorphUniforms")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MorphUniforms](struct.MorphUniforms.html "struct bevy::pbr::MorphUniforms")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MorphUniforms](struct.MorphUniforms.html "struct bevy::pbr::MorphUniforms")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MorphUniforms](struct.MorphUniforms.html "struct bevy::pbr::MorphUniforms")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MorphUniforms](struct.MorphUniforms.html "struct bevy::pbr::MorphUniforms")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MorphUniforms](struct.MorphUniforms.html "struct bevy::pbr::MorphUniforms")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MorphUniforms](struct.MorphUniforms.html "struct bevy::pbr::MorphUniforms")
