...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/atmosphere/resources.rs.html#807)

```rust
pub struct AtmosphereBuffer { /* private fields */ }
```
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [AtmosphereBuffer](struct.AtmosphereBuffer.html "struct bevy::pbr::resources::AtmosphereBuffer")

where [AtmosphereBuffer](struct.AtmosphereBuffer.html "struct bevy::pbr::resources::AtmosphereBuffer"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [AtmosphereBuffer](struct.AtmosphereBuffer.html "struct bevy::pbr::resources::AtmosphereBuffer")

where [AtmosphereBuffer](struct.AtmosphereBuffer.html "struct bevy::pbr::resources::AtmosphereBuffer"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AtmosphereBuffer](struct.AtmosphereBuffer.html "struct bevy::pbr::resources::AtmosphereBuffer")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AtmosphereBuffer](struct.AtmosphereBuffer.html "struct bevy::pbr::resources::AtmosphereBuffer")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AtmosphereBuffer](struct.AtmosphereBuffer.html "struct bevy::pbr::resources::AtmosphereBuffer")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AtmosphereBuffer](struct.AtmosphereBuffer.html "struct bevy::pbr::resources::AtmosphereBuffer")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AtmosphereBuffer](struct.AtmosphereBuffer.html "struct bevy::pbr::resources::AtmosphereBuffer")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AtmosphereBuffer](struct.AtmosphereBuffer.html "struct bevy::pbr::resources::AtmosphereBuffer")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AtmosphereBuffer](struct.AtmosphereBuffer.html "struct bevy::pbr::resources::AtmosphereBuffer")
