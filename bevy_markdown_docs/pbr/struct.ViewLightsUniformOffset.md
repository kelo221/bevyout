...
# Struct ViewLightsUniformOffset 

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/light.rs.html#957)
...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/light.rs.html#956)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [ViewLightsUniformOffset](struct.ViewLightsUniformOffset.html "struct bevy::pbr::ViewLightsUniformOffset")

where [ViewLightsUniformOffset](struct.ViewLightsUniformOffset.html "struct bevy::pbr::ViewLightsUniformOffset"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ViewLightsUniformOffset](struct.ViewLightsUniformOffset.html "struct bevy::pbr::ViewLightsUniformOffset")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ViewLightsUniformOffset](struct.ViewLightsUniformOffset.html "struct bevy::pbr::ViewLightsUniformOffset")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ViewLightsUniformOffset](struct.ViewLightsUniformOffset.html "struct bevy::pbr::ViewLightsUniformOffset")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ViewLightsUniformOffset](struct.ViewLightsUniformOffset.html "struct bevy::pbr::ViewLightsUniformOffset")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ViewLightsUniformOffset](struct.ViewLightsUniformOffset.html "struct bevy::pbr::ViewLightsUniformOffset")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ViewLightsUniformOffset](struct.ViewLightsUniformOffset.html "struct bevy::pbr::ViewLightsUniformOffset")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ViewLightsUniformOffset](struct.ViewLightsUniformOffset.html "struct bevy::pbr::ViewLightsUniformOffset")
