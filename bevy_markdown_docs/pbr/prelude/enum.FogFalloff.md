...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#102)
...
*   For `FogFalloff::Exponential`:
    ...
    *   [`FogFalloff::from_visibility()`](../../prelude/enum.FogFalloff.html#method.from_visibility "associated function bevy::prelude::FogFalloff::from_visibility")
    *   [`FogFalloff::from_visibility_contrast()`](../../prelude/enum.FogFalloff.html#method.from_visibility_contrast "associated function bevy::prelude::FogFalloff::from_visibility_contrast")
*   For `FogFalloff::ExponentialSquared`:
    
    *   [`FogFalloff::from_visibility_squared()`](../../prelude/enum.FogFalloff.html#method.from_visibility_squared "associated function bevy::prelude::FogFalloff::from_visibility_squared")
    *   [`FogFalloff::from_visibility_contrast_squared()`](../../prelude/enum.FogFalloff.html#method.from_visibility_contrast_squared "associated function bevy::prelude::FogFalloff::from_visibility_contrast_squared")
*   For `FogFalloff::Atmospheric`:
    
    *   [`FogFalloff::from_visibility_color()`](../../prelude/enum.FogFalloff.html#method.from_visibility_color "associated function bevy::prelude::FogFalloff::from_visibility_color")
    *   [`FogFalloff::from_visibility_colors()`](../../prelude/enum.FogFalloff.html#method.from_visibility_colors "associated function bevy::prelude::FogFalloff::from_visibility_colors")
    *   [`FogFalloff::from_visibility_contrast_color()`](../../prelude/enum.FogFalloff.html#method.from_visibility_contrast_color "associated function bevy::prelude::FogFalloff::from_visibility_contrast_color")
    *   [`FogFalloff::from_visibility_contrast_colors()`](../../prelude/enum.FogFalloff.html#method.from_visibility_contrast_colors "associated function bevy::prelude::FogFalloff::from_visibility_contrast_colors")
...
`start: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Distance from the camera where fog is completely transparent, in world units.

`end: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`
...
Initially gains intensity quickly with distance, then more slowly. Typically produces more natural results than [`FogFalloff::Linear`](../../prelude/enum.FogFalloff.html#variant.Linear "variant bevy::prelude::FogFalloff::Linear"), but is a bit harder to control.

To move the fog “further away”, use lower density values. To move it “closer” use higher density values.

##### Tips

*   Use the [`FogFalloff::from_visibility()`](../../prelude/enum.FogFalloff.html#method.from_visibility "associated function bevy::prelude::FogFalloff::from_visibility") convenience method to create an exponential falloff with the proper density for a desired visibility distance in world units;
...
*   Combine the `density` parameter with the [`DistanceFog`](../../prelude/struct.DistanceFog.html "struct bevy::prelude::DistanceFog") `color`’s alpha channel for easier artistic control.
...
`density: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`
...
Similar to [`FogFalloff::Exponential`](../../prelude/enum.FogFalloff.html#variant.Exponential "variant bevy::prelude::FogFalloff::Exponential"), but grows more slowly in intensity for closer distances before “catching up”.

To move the fog “further away”, use lower density values. To move it “closer” use higher density values.

##### Tips

*   Use the [`FogFalloff::from_visibility_squared()`](../../prelude/enum.FogFalloff.html#method.from_visibility_squared "associated function bevy::prelude::FogFalloff::from_visibility_squared") convenience method to create an exponential squared falloff with the proper density for a desired visibility distance in world units;
*   Combine the `density` parameter with the [`DistanceFog`](../../prelude/struct.DistanceFog.html "struct bevy::prelude::DistanceFog") `color`’s alpha channel for easier artistic control.
...
A more general form of the [`FogFalloff::Exponential`](../../prelude/enum.FogFalloff.html#variant.Exponential "variant bevy::prelude::FogFalloff::Exponential") mode. The falloff formula is separated into two terms, `extinction` and `inscattering`, for a somewhat simplified atmospheric scattering model. Additionally, individual color channels can have their own density values, resulting in a total of six different configuration parameters.

##### Tips

*   Use the [`FogFalloff::from_visibility_colors()`](../../prelude/enum.FogFalloff.html#method.from_visibility_colors "associated function bevy::prelude::FogFalloff::from_visibility_colors") or [`FogFalloff::from_visibility_color()`](../../prelude/enum.FogFalloff.html#method.from_visibility_color "associated function bevy::prelude::FogFalloff::from_visibility_color") convenience methods to create an atmospheric falloff with the proper densities for a desired visibility distance in world units and extinction and inscattering colors;
*   Combine the atmospheric fog parameters with the [`DistanceFog`](../../prelude/struct.DistanceFog.html "struct bevy::prelude::DistanceFog") `color`’s alpha channel for easier artistic control.
...
##### Equivalence to [`FogFalloff::Exponential`](../../prelude/enum.FogFalloff.html#variant.Exponential "variant bevy::prelude::FogFalloff::Exponential")
...
**Note:** While the results are identical, [`FogFalloff::Atmospheric`](../../prelude/enum.FogFalloff.html#variant.Atmospheric "variant bevy::prelude::FogFalloff::Atmospheric") is computationally more expensive.

#### Fields

`extinction: [Vec3](../../prelude/struct.Vec3.html "struct bevy::prelude::Vec3")`
...
Each component can be thought of as an independent per `R`/`G`/`B` channel `density` factor from [`FogFalloff::Exponential`](../../prelude/enum.FogFalloff.html#variant.Exponential "variant bevy::prelude::FogFalloff::Exponential"): Multiplier applied to the world distance (within the fog falloff calculation) for that specific channel.

**Note:** This value is not a `Color`, since it affects the channels exponentially in a non-intuitive way. For artistic control, use the [`FogFalloff::from_visibility_colors()`](../../prelude/enum.FogFalloff.html#method.from_visibility_colors "associated function bevy::prelude::FogFalloff::from_visibility_colors") convenience method.

`inscattering: [Vec3](../../prelude/struct.Vec3.html "struct bevy::prelude::Vec3")`

Controls how much light is added due to light scattering from the sun through the atmosphere.

Each component can be thought of as an independent per `R`/`G`/`B` channel `density` factor from [`FogFalloff::Exponential`](../../prelude/enum.FogFalloff.html#variant.Exponential "variant bevy::prelude::FogFalloff::Exponential"): A multiplier applied to the world distance (within the fog falloff calculation) for that specific channel.

**Note:** This value is not a `Color`, since it affects the channels exponentially in a non-intuitive way. For artistic control, use the [`FogFalloff::from_visibility_colors()`](../../prelude/enum.FogFalloff.html#method.from_visibility_colors "associated function bevy::prelude::FogFalloff::from_visibility_colors") convenience method.

## Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#309)

### impl [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#436)

#### pub const [REVISED\_KOSCHMIEDER\_CONTRAST\_THRESHOLD](#associatedconstant.REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD): [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html) = 0.05
...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#312)

#### pub fn [from\_visibility](#method.from_visibility)(visibility: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

Creates a [`FogFalloff::Exponential`](../../prelude/enum.FogFalloff.html#variant.Exponential "variant bevy::prelude::FogFalloff::Exponential") value from the given visibility distance in world units, using the revised Koschmieder contrast threshold, [`FogFalloff::REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD`](../../prelude/enum.FogFalloff.html#associatedconstant.REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD "associated constant bevy::prelude::FogFalloff::REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD").

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#321)

#### pub fn [from\_visibility\_contrast](#method.from_visibility_contrast)( visibility: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), contrast\_threshold: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

Creates a [`FogFalloff::Exponential`](../../prelude/enum.FogFalloff.html#variant.Exponential "variant bevy::prelude::FogFalloff::Exponential") value from the given visibility distance in world units, and a given contrast threshold in the range of `0.0` to `1.0`.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#329)

#### pub fn [from\_visibility\_squared](#method.from_visibility_squared)(visibility: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

Creates a [`FogFalloff::ExponentialSquared`](../../prelude/enum.FogFalloff.html#variant.ExponentialSquared "variant bevy::prelude::FogFalloff::ExponentialSquared") value from the given visibility distance in world units, using the revised Koschmieder contrast threshold, [`FogFalloff::REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD`](../../prelude/enum.FogFalloff.html#associatedconstant.REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD "associated constant bevy::prelude::FogFalloff::REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD").

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#338-341)

#### pub fn [from\_visibility\_contrast\_squared](#method.from_visibility_contrast_squared)( visibility: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), contrast\_threshold: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

Creates a [`FogFalloff::ExponentialSquared`](../../prelude/enum.FogFalloff.html#variant.ExponentialSquared "variant bevy::prelude::FogFalloff::ExponentialSquared") value from the given visibility distance in world units, and a given contrast threshold in the range of `0.0` to `1.0`.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#350-353)

#### pub fn [from\_visibility\_color](#method.from_visibility_color)( visibility: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), extinction\_inscattering\_color: [Color](../../prelude/enum.Color.html "enum bevy::prelude::Color"), ) -> [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

Creates a [`FogFalloff::Atmospheric`](../../prelude/enum.FogFalloff.html#variant.Atmospheric "variant bevy::prelude::FogFalloff::Atmospheric") value from the given visibility distance in world units, and a shared color for both extinction and inscattering, using the revised Koschmieder contrast threshold, [`FogFalloff::REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD`](../../prelude/enum.FogFalloff.html#associatedconstant.REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD "associated constant bevy::prelude::FogFalloff::REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD").

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#370-374)

#### pub fn [from\_visibility\_colors](#method.from_visibility_colors)( visibility: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), extinction\_color: [Color](../../prelude/enum.Color.html "enum bevy::prelude::Color"), inscattering\_color: [Color](../../prelude/enum.Color.html "enum bevy::prelude::Color"), ) -> [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

Creates a [`FogFalloff::Atmospheric`](../../prelude/enum.FogFalloff.html#variant.Atmospheric "variant bevy::prelude::FogFalloff::Atmospheric") value from the given visibility distance in world units, extinction and inscattering colors, using the revised Koschmieder contrast threshold, [`FogFalloff::REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD`](../../prelude/enum.FogFalloff.html#associatedconstant.REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD "associated constant bevy::prelude::FogFalloff::REVISED_KOSCHMIEDER_CONTRAST_THRESHOLD").

###### Tips

*   Alpha values of the provided colors can modulate the `extinction` and `inscattering` effects;
*   Using an `extinction_color` of [`Color::WHITE`](../../prelude/enum.Color.html#associatedconstant.WHITE "associated constant bevy::prelude::Color::WHITE") or [`Color::NONE`](../../prelude/enum.Color.html#associatedconstant.NONE "associated constant bevy::prelude::Color::NONE") disables the extinction effect;
*   Using an `inscattering_color` of [`Color::BLACK`](../../prelude/enum.Color.html#associatedconstant.BLACK "associated constant bevy::prelude::Color::BLACK") or [`Color::NONE`](../../prelude/enum.Color.html#associatedconstant.NONE "associated constant bevy::prelude::Color::NONE") disables the inscattering effect.

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/3d/atmospheric\_fog.rs ([lines 34-38](../../../src/atmospheric_fog/atmospheric_fog.rs.html#34-38))
...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#385-389)

#### pub fn [from\_visibility\_contrast\_color](#method.from_visibility_contrast_color)( visibility: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), contrast\_threshold: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), extinction\_inscattering\_color: [Color](../../prelude/enum.Color.html "enum bevy::prelude::Color"), ) -> [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

Creates a [`FogFalloff::Atmospheric`](../../prelude/enum.FogFalloff.html#variant.Atmospheric "variant bevy::prelude::FogFalloff::Atmospheric") value from the given visibility distance in world units, a contrast threshold in the range of `0.0` to `1.0`, and a shared color for both extinction and inscattering.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#405-410)

#### pub fn [from\_visibility\_contrast\_colors](#method.from_visibility_contrast_colors)( visibility: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), contrast\_threshold: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), extinction\_color: [Color](../../prelude/enum.Color.html "enum bevy::prelude::Color"), inscattering\_color: [Color](../../prelude/enum.Color.html "enum bevy::prelude::Color"), ) -> [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

Creates a [`FogFalloff::Atmospheric`](../../prelude/enum.FogFalloff.html#variant.Atmospheric "variant bevy::prelude::FogFalloff::Atmospheric") value from the given visibility distance in world units, a contrast threshold in the range of `0.0` to `1.0`, extinction and inscattering colors.
...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#463)

#### pub fn [koschmieder](#method.koschmieder)(v: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), c\_t: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)
...
*   [https://en.wikipedia.org/wiki/Visibility](https://en.wikipedia.org/wiki/Visibility)
*   [https://www.biral.com/wp-content/uploads/2015/02/Introduction\_to\_visibility-v2-2.pdf](https://www.biral.com/wp-content/uploads/2015/02/Introduction_to_visibility-v2-2.pdf)

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#100)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#100)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")
...
### impl [Enum](../../reflect/enums/trait.Enum.html "trait bevy::reflect::enums::Enum") for [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")
...
### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#100)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#100)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)(\_\_param0: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")
...
where [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff"): 'into\_return,
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#100)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/fog.rs.html#101)
...
#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [FogFalloff](../../prelude/enum.FogFalloff.html "enum bevy::prelude::FogFalloff")
