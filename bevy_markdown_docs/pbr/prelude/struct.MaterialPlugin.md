...
### impl<M> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [MaterialPlugin](../../prelude/struct.MaterialPlugin.html "struct bevy::prelude::MaterialPlugin")<M>
...
#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [MaterialPlugin](../../prelude/struct.MaterialPlugin.html "struct bevy::prelude::MaterialPlugin")<M>
...
### impl<M> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MaterialPlugin](../../prelude/struct.MaterialPlugin.html "struct bevy::prelude::MaterialPlugin")<M>

### impl<M> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MaterialPlugin](../../prelude/struct.MaterialPlugin.html "struct bevy::prelude::MaterialPlugin")<M>
...
### impl<M> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MaterialPlugin](../../prelude/struct.MaterialPlugin.html "struct bevy::prelude::MaterialPlugin")<M>

### impl<M> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MaterialPlugin](../../prelude/struct.MaterialPlugin.html "struct bevy::prelude::MaterialPlugin")<M>

### impl<M> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MaterialPlugin](../../prelude/struct.MaterialPlugin.html "struct bevy::prelude::MaterialPlugin")<M>

where M: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<M> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MaterialPlugin](../../prelude/struct.MaterialPlugin.html "struct bevy::prelude::MaterialPlugin")<M>

### impl<M> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MaterialPlugin](../../prelude/struct.MaterialPlugin.html "struct bevy::prelude::MaterialPlugin")<M>
