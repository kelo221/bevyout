...
# Struct RenderLightmaps 

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/lightmap/mod.rs.html#142)
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [RenderLightmaps](struct.RenderLightmaps.html "struct bevy::pbr::RenderLightmaps")

where [RenderLightmaps](struct.RenderLightmaps.html "struct bevy::pbr::RenderLightmaps"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [RenderLightmaps](struct.RenderLightmaps.html "struct bevy::pbr::RenderLightmaps")

where [RenderLightmaps](struct.RenderLightmaps.html "struct bevy::pbr::RenderLightmaps"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RenderLightmaps](struct.RenderLightmaps.html "struct bevy::pbr::RenderLightmaps")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RenderLightmaps](struct.RenderLightmaps.html "struct bevy::pbr::RenderLightmaps")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RenderLightmaps](struct.RenderLightmaps.html "struct bevy::pbr::RenderLightmaps")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RenderLightmaps](struct.RenderLightmaps.html "struct bevy::pbr::RenderLightmaps")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RenderLightmaps](struct.RenderLightmaps.html "struct bevy::pbr::RenderLightmaps")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RenderLightmaps](struct.RenderLightmaps.html "struct bevy::pbr::RenderLightmaps")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RenderLightmaps](struct.RenderLightmaps.html "struct bevy::pbr::RenderLightmaps")
