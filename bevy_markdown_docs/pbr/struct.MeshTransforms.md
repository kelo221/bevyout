...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#508)
...
`world_from_local: [Affine3](../math/struct.Affine3.html "struct bevy::math::Affine3")``previous_world_from_local: [Affine3](../math/struct.Affine3.html "struct bevy::math::Affine3")``flags: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/mesh.rs.html#507)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [MeshTransforms](struct.MeshTransforms.html "struct bevy::pbr::MeshTransforms")

where [MeshTransforms](struct.MeshTransforms.html "struct bevy::pbr::MeshTransforms"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MeshTransforms](struct.MeshTransforms.html "struct bevy::pbr::MeshTransforms")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MeshTransforms](struct.MeshTransforms.html "struct bevy::pbr::MeshTransforms")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MeshTransforms](struct.MeshTransforms.html "struct bevy::pbr::MeshTransforms")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MeshTransforms](struct.MeshTransforms.html "struct bevy::pbr::MeshTransforms")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MeshTransforms](struct.MeshTransforms.html "struct bevy::pbr::MeshTransforms")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MeshTransforms](struct.MeshTransforms.html "struct bevy::pbr::MeshTransforms")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MeshTransforms](struct.MeshTransforms.html "struct bevy::pbr::MeshTransforms")
