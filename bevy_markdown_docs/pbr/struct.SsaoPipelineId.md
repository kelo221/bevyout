...
# Struct SsaoPipelineId 

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssao/mod.rs.html#604)
...
`0: [CachedComputePipelineId](../material/descriptor/struct.CachedComputePipelineId.html "struct bevy::material::descriptor::CachedComputePipelineId")`

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/ssao/mod.rs.html#603)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [SsaoPipelineId](struct.SsaoPipelineId.html "struct bevy::pbr::SsaoPipelineId")

where [SsaoPipelineId](struct.SsaoPipelineId.html "struct bevy::pbr::SsaoPipelineId"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SsaoPipelineId](struct.SsaoPipelineId.html "struct bevy::pbr::SsaoPipelineId")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SsaoPipelineId](struct.SsaoPipelineId.html "struct bevy::pbr::SsaoPipelineId")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SsaoPipelineId](struct.SsaoPipelineId.html "struct bevy::pbr::SsaoPipelineId")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SsaoPipelineId](struct.SsaoPipelineId.html "struct bevy::pbr::SsaoPipelineId")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SsaoPipelineId](struct.SsaoPipelineId.html "struct bevy::pbr::SsaoPipelineId")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SsaoPipelineId](struct.SsaoPipelineId.html "struct bevy::pbr::SsaoPipelineId")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SsaoPipelineId](struct.SsaoPipelineId.html "struct bevy::pbr::SsaoPipelineId")
