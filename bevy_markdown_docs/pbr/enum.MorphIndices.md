...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/morph.rs.html#38)

```rust
pub enum MorphIndices {
    Uniform {
        current: HashMap<MainEntity, MorphIndex, EntityHash>,
        prev: HashMap<MainEntity, MorphIndex, EntityHash>,
    },
    Storage {
        morph_weights_info: HashMap<MainEntity, MorphWeightsInfo, EntityHash>,
        gpu_descriptor_indices: HashMap<MainEntity, MorphDescriptorIndex, EntityHash>,
...
The variant used when storage buffers aren’t supported on the current platform.

#### Fields

`current: [HashMap](../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[MainEntity](../render/sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity"), [MorphIndex](struct.MorphIndex.html "struct bevy::pbr::MorphIndex"), [EntityHash](../ecs/entity/struct.EntityHash.html "struct bevy::ecs::entity::EntityHash")>`

Maps each entity with a morphed mesh to the appropriate offset within [`MorphUniforms::current_buffer`](struct.MorphUniforms.html#structfield.current_buffer "field bevy::pbr::MorphUniforms::current_buffer").

`prev: [HashMap](../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[MainEntity](../render/sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity"), [MorphIndex](struct.MorphIndex.html "struct bevy::pbr::MorphIndex"), [EntityHash](../ecs/entity/struct.EntityHash.html "struct bevy::ecs::entity::EntityHash")>`

Maps each entity with a morphed mesh to the appropriate offset within [`MorphUniforms::prev_buffer`](struct.MorphUniforms.html#structfield.prev_buffer "field bevy::pbr::MorphUniforms::prev_buffer").

### Storage

The variant used when storage buffers are supported on the current platform.

#### Fields

`morph_weights_info: [HashMap](../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[MainEntity](../render/sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity"), [MorphWeightsInfo](struct.MorphWeightsInfo.html "struct bevy::pbr::MorphWeightsInfo"), [EntityHash](../ecs/entity/struct.EntityHash.html "struct bevy::ecs::entity::EntityHash")>`

Maps each entity with a morphed mesh to the [`MorphWeightsInfo`](struct.MorphWeightsInfo.html "struct bevy::pbr::MorphWeightsInfo").

`gpu_descriptor_indices: [HashMap](../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[MainEntity](../render/sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity"), [MorphDescriptorIndex](struct.MorphDescriptorIndex.html "struct bevy::pbr::MorphDescriptorIndex"), [EntityHash](../ecs/entity/struct.EntityHash.html "struct bevy::ecs::entity::EntityHash")>`

Maps each entity with a morphed mesh to the [`GpuMorphDescriptor`](struct.GpuMorphDescriptor.html "struct bevy::pbr::GpuMorphDescriptor") in the `morph_descriptors` buffer.

`gpu_descriptor_free_list: [Vec](../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[MorphDescriptorIndex](struct.MorphDescriptorIndex.html "struct bevy::pbr::MorphDescriptorIndex")>`

Indices in the `morph_descriptors` buffer available for use.

## Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/morph.rs.html#154)

### impl [MorphIndices](enum.MorphIndices.html "enum bevy::pbr::MorphIndices")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/morph.rs.html#161)

#### pub fn [morph\_descriptor\_index](#method.morph_descriptor_index)( &self, main\_entity: [MainEntity](../render/sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[MorphDescriptorIndex](struct.MorphDescriptorIndex.html "struct bevy::pbr::MorphDescriptorIndex")\>

Returns the index of the morph descriptor in the morph descriptor table for the given entity.

As morph descriptors are only present if the platform supports storage buffers, this method returns `None` if the platform doesn’t support them.

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/morph.rs.html#37)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [MorphIndices](enum.MorphIndices.html "enum bevy::pbr::MorphIndices")

where [MorphIndices](enum.MorphIndices.html "enum bevy::pbr::MorphIndices"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
#### fn [map\_entities](../prelude/trait.Component.html#method.map_entities)<M>(this: &mut [MorphIndices](enum.MorphIndices.html "enum bevy::pbr::MorphIndices"), mapper: [&mut M](https://doc.rust-lang.org/nightly/std/primitive.reference.html))
...
### impl [FromWorld](../prelude/trait.FromWorld.html "trait bevy::prelude::FromWorld") for [MorphIndices](enum.MorphIndices.html "enum bevy::pbr::MorphIndices")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/morph.rs.html#79)

#### fn [from\_world](../prelude/trait.FromWorld.html#tymethod.from_world)(world: &mut [World](../prelude/struct.World.html "struct bevy::prelude::World")) -> [MorphIndices](enum.MorphIndices.html "enum bevy::pbr::MorphIndices")

Creates `Self` using data from the given [`World`](../prelude/struct.World.html "struct bevy::prelude::World").

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/morph.rs.html#37)

### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [MorphIndices](enum.MorphIndices.html "enum bevy::pbr::MorphIndices")

where [MorphIndices](enum.MorphIndices.html "enum bevy::pbr::MorphIndices"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MorphIndices](enum.MorphIndices.html "enum bevy::pbr::MorphIndices")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MorphIndices](enum.MorphIndices.html "enum bevy::pbr::MorphIndices")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MorphIndices](enum.MorphIndices.html "enum bevy::pbr::MorphIndices")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MorphIndices](enum.MorphIndices.html "enum bevy::pbr::MorphIndices")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MorphIndices](enum.MorphIndices.html "enum bevy::pbr::MorphIndices")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MorphIndices](enum.MorphIndices.html "enum bevy::pbr::MorphIndices")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MorphIndices](enum.MorphIndices.html "enum bevy::pbr::MorphIndices")
