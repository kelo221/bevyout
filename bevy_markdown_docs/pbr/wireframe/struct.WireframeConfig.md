...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/wireframe.rs.html#885)
...
`global: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

Whether to show wireframes for all meshes. Can be overridden for individual meshes by adding a [`Wireframe`](struct.Wireframe.html "struct bevy::pbr::wireframe::Wireframe") or [`NoWireframe`](struct.NoWireframe.html "struct bevy::pbr::wireframe::NoWireframe") component.

`default_color: [Color](../../prelude/enum.Color.html "enum bevy::prelude::Color")`

If [`Self::global`](struct.WireframeConfig.html#structfield.global "field bevy::pbr::wireframe::WireframeConfig::global") is set, any [`Entity`](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") that does not have a [`Wireframe`](struct.Wireframe.html "struct bevy::pbr::wireframe::Wireframe") component attached to it will have wireframes using this color. Otherwise, this will be the fallback color for any entity that has a [`Wireframe`](struct.Wireframe.html "struct bevy::pbr::wireframe::Wireframe"), but no [`WireframeColor`](struct.WireframeColor.html "struct bevy::pbr::wireframe::WireframeColor").

`default_line_width: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Default line width in screen-space pixels.

`default_topology: [WireframeTopology](enum.WireframeTopology.html "enum bevy::pbr::wireframe::WireframeTopology")`
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/wireframe.rs.html#883)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")

where [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")
...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/wireframe.rs.html#899)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/wireframe.rs.html#900)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/wireframe.rs.html#883)

### impl [ExtractResource](../../render/extract_resource/trait.ExtractResource.html "trait bevy::render::extract_resource::ExtractResource") for [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")

where [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig"): [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/wireframe.rs.html#883)

#### type [Source](../../render/extract_resource/trait.ExtractResource.html#associatedtype.Source) = [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/wireframe.rs.html#883)

#### fn [extract\_resource](../../render/extract_resource/trait.ExtractResource.html#tymethod.extract_resource)( source: &<[WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig") as [ExtractResource](../../render/extract_resource/trait.ExtractResource.html "trait bevy::render::extract_resource::ExtractResource")\>::[Source](../../render/extract_resource/trait.ExtractResource.html#associatedtype.Source "type bevy::render::extract_resource::ExtractResource::Source"), ) -> [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")

Defines how the resource is transferred into the “render world”.

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/wireframe.rs.html#883)

### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/wireframe.rs.html#883)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/wireframe.rs.html#883)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/wireframe.rs.html#883)

### impl [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/wireframe.rs.html#883)

#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")
...
where [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig"): 'into\_return,
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/wireframe.rs.html#883)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/wireframe.rs.html#884)
...
### impl [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/wireframe.rs.html#883)

#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")

where [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/wireframe.rs.html#883)

### impl [Struct](../../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")
...
### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [WireframeConfig](struct.WireframeConfig.html "struct bevy::pbr::wireframe::WireframeConfig")
