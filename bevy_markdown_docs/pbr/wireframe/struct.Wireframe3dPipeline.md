...
# Struct Wireframe3dPipeline 

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/wireframe.rs.html#696)
...
`wide_bind_group_layout: [BindGroupLayout](../../render/render_resource/struct.BindGroupLayout.html "struct bevy::render::render_resource::BindGroupLayout")``wide_bind_group_layout_descriptor: [BindGroupLayoutDescriptor](../../material/descriptor/struct.BindGroupLayoutDescriptor.html "struct bevy::material::descriptor::BindGroupLayoutDescriptor")`

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/wireframe.rs.html#695)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Wireframe3dPipeline](struct.Wireframe3dPipeline.html "struct bevy::pbr::wireframe::Wireframe3dPipeline")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/wireframe.rs.html#695)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Wireframe3dPipeline](struct.Wireframe3dPipeline.html "struct bevy::pbr::wireframe::Wireframe3dPipeline")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [Wireframe3dPipeline](struct.Wireframe3dPipeline.html "struct bevy::pbr::wireframe::Wireframe3dPipeline")

where [Wireframe3dPipeline](struct.Wireframe3dPipeline.html "struct bevy::pbr::wireframe::Wireframe3dPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Wireframe3dPipeline](struct.Wireframe3dPipeline.html "struct bevy::pbr::wireframe::Wireframe3dPipeline")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Wireframe3dPipeline](struct.Wireframe3dPipeline.html "struct bevy::pbr::wireframe::Wireframe3dPipeline")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Wireframe3dPipeline](struct.Wireframe3dPipeline.html "struct bevy::pbr::wireframe::Wireframe3dPipeline")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Wireframe3dPipeline](struct.Wireframe3dPipeline.html "struct bevy::pbr::wireframe::Wireframe3dPipeline")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Wireframe3dPipeline](struct.Wireframe3dPipeline.html "struct bevy::pbr::wireframe::Wireframe3dPipeline")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Wireframe3dPipeline](struct.Wireframe3dPipeline.html "struct bevy::pbr::wireframe::Wireframe3dPipeline")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Wireframe3dPipeline](struct.Wireframe3dPipeline.html "struct bevy::pbr::wireframe::Wireframe3dPipeline")
