...
# Struct FallbackBindlessResources 

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/material_bind_groups.rs.html#218)
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [FallbackBindlessResources](struct.FallbackBindlessResources.html "struct bevy::pbr::FallbackBindlessResources")

where [FallbackBindlessResources](struct.FallbackBindlessResources.html "struct bevy::pbr::FallbackBindlessResources"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [FallbackBindlessResources](struct.FallbackBindlessResources.html "struct bevy::pbr::FallbackBindlessResources")

where [FallbackBindlessResources](struct.FallbackBindlessResources.html "struct bevy::pbr::FallbackBindlessResources"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [FallbackBindlessResources](struct.FallbackBindlessResources.html "struct bevy::pbr::FallbackBindlessResources")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [FallbackBindlessResources](struct.FallbackBindlessResources.html "struct bevy::pbr::FallbackBindlessResources")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [FallbackBindlessResources](struct.FallbackBindlessResources.html "struct bevy::pbr::FallbackBindlessResources")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [FallbackBindlessResources](struct.FallbackBindlessResources.html "struct bevy::pbr::FallbackBindlessResources")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [FallbackBindlessResources](struct.FallbackBindlessResources.html "struct bevy::pbr::FallbackBindlessResources")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [FallbackBindlessResources](struct.FallbackBindlessResources.html "struct bevy::pbr::FallbackBindlessResources")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [FallbackBindlessResources](struct.FallbackBindlessResources.html "struct bevy::pbr::FallbackBindlessResources")
