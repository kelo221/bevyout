...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/light.rs.html#928)
...
`depth_attachment: [DepthAttachment](../render/texture/struct.DepthAttachment.html "struct bevy::render::texture::DepthAttachment")``pass_name: [String](../prelude/struct.String.html "struct bevy::prelude::String")`

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/light.rs.html#927)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [ShadowView](struct.ShadowView.html "struct bevy::pbr::ShadowView")

where [ShadowView](struct.ShadowView.html "struct bevy::pbr::ShadowView"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ShadowView](struct.ShadowView.html "struct bevy::pbr::ShadowView")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ShadowView](struct.ShadowView.html "struct bevy::pbr::ShadowView")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ShadowView](struct.ShadowView.html "struct bevy::pbr::ShadowView")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ShadowView](struct.ShadowView.html "struct bevy::pbr::ShadowView")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ShadowView](struct.ShadowView.html "struct bevy::pbr::ShadowView")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ShadowView](struct.ShadowView.html "struct bevy::pbr::ShadowView")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ShadowView](struct.ShadowView.html "struct bevy::pbr::ShadowView")
