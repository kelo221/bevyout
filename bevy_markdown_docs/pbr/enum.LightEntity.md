...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/light.rs.html#967)
...
`light_entity: [Entity](../prelude/struct.Entity.html "struct bevy::prelude::Entity")`

`cascade_index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)`
...
`face_index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)`
...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/light.rs.html#966)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [LightEntity](enum.LightEntity.html "enum bevy::pbr::LightEntity")

where [LightEntity](enum.LightEntity.html "enum bevy::pbr::LightEntity"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
#### fn [map\_entities](../prelude/trait.Component.html#method.map_entities)<M>(this: &mut [LightEntity](enum.LightEntity.html "enum bevy::pbr::LightEntity"), mapper: [&mut M](https://doc.rust-lang.org/nightly/std/primitive.reference.html))
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [LightEntity](enum.LightEntity.html "enum bevy::pbr::LightEntity")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [LightEntity](enum.LightEntity.html "enum bevy::pbr::LightEntity")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [LightEntity](enum.LightEntity.html "enum bevy::pbr::LightEntity")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [LightEntity](enum.LightEntity.html "enum bevy::pbr::LightEntity")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [LightEntity](enum.LightEntity.html "enum bevy::pbr::LightEntity")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [LightEntity](enum.LightEntity.html "enum bevy::pbr::LightEntity")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [LightEntity](enum.LightEntity.html "enum bevy::pbr::LightEntity")
