...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/lib.rs.html#165)
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [Bluenoise](struct.Bluenoise.html "struct bevy::pbr::Bluenoise")

where [Bluenoise](struct.Bluenoise.html "struct bevy::pbr::Bluenoise"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [Bluenoise](struct.Bluenoise.html "struct bevy::pbr::Bluenoise")

where [Bluenoise](struct.Bluenoise.html "struct bevy::pbr::Bluenoise"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Bluenoise](struct.Bluenoise.html "struct bevy::pbr::Bluenoise")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Bluenoise](struct.Bluenoise.html "struct bevy::pbr::Bluenoise")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Bluenoise](struct.Bluenoise.html "struct bevy::pbr::Bluenoise")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Bluenoise](struct.Bluenoise.html "struct bevy::pbr::Bluenoise")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Bluenoise](struct.Bluenoise.html "struct bevy::pbr::Bluenoise")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Bluenoise](struct.Bluenoise.html "struct bevy::pbr::Bluenoise")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Bluenoise](struct.Bluenoise.html "struct bevy::pbr::Bluenoise")
