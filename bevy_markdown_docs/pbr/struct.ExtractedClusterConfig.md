...
# Struct ExtractedClusterConfig 

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#164)
...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#163)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [ExtractedClusterConfig](struct.ExtractedClusterConfig.html "struct bevy::pbr::ExtractedClusterConfig")

where [ExtractedClusterConfig](struct.ExtractedClusterConfig.html "struct bevy::pbr::ExtractedClusterConfig"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#172)

### impl<'a> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'a [Clusters](../light/cluster/struct.Clusters.html "struct bevy::light::cluster::Clusters")\> for [ExtractedClusterConfig](struct.ExtractedClusterConfig.html "struct bevy::pbr::ExtractedClusterConfig")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/cluster/mod.rs.html#173)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(clusters: &'a [Clusters](../light/cluster/struct.Clusters.html "struct bevy::light::cluster::Clusters")) -> [ExtractedClusterConfig](struct.ExtractedClusterConfig.html "struct bevy::pbr::ExtractedClusterConfig")

Converts to this type from the input type.

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ExtractedClusterConfig](struct.ExtractedClusterConfig.html "struct bevy::pbr::ExtractedClusterConfig")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ExtractedClusterConfig](struct.ExtractedClusterConfig.html "struct bevy::pbr::ExtractedClusterConfig")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ExtractedClusterConfig](struct.ExtractedClusterConfig.html "struct bevy::pbr::ExtractedClusterConfig")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ExtractedClusterConfig](struct.ExtractedClusterConfig.html "struct bevy::pbr::ExtractedClusterConfig")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ExtractedClusterConfig](struct.ExtractedClusterConfig.html "struct bevy::pbr::ExtractedClusterConfig")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ExtractedClusterConfig](struct.ExtractedClusterConfig.html "struct bevy::pbr::ExtractedClusterConfig")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ExtractedClusterConfig](struct.ExtractedClusterConfig.html "struct bevy::pbr::ExtractedClusterConfig")
