...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/meshlet/from_mesh.rs.html#1084)
...
### WrongMeshVertexAttributes([Vec](../../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[String](../../../prelude/struct.String.html "struct bevy::prelude::String")\>)

### MeshMissingIndices

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/meshlet/from_mesh.rs.html#1083)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [MeshToMeshletMeshConversionError](enum.MeshToMeshletMeshConversionError.html "enum bevy::pbr::experimental::meshlet::MeshToMeshletMeshConversionError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [MeshToMeshletMeshConversionError](enum.MeshToMeshletMeshConversionError.html "enum bevy::pbr::experimental::meshlet::MeshToMeshletMeshConversionError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [MeshToMeshletMeshConversionError](enum.MeshToMeshletMeshConversionError.html "enum bevy::pbr::experimental::meshlet::MeshToMeshletMeshConversionError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MeshToMeshletMeshConversionError](enum.MeshToMeshletMeshConversionError.html "enum bevy::pbr::experimental::meshlet::MeshToMeshletMeshConversionError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MeshToMeshletMeshConversionError](enum.MeshToMeshletMeshConversionError.html "enum bevy::pbr::experimental::meshlet::MeshToMeshletMeshConversionError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MeshToMeshletMeshConversionError](enum.MeshToMeshletMeshConversionError.html "enum bevy::pbr::experimental::meshlet::MeshToMeshletMeshConversionError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MeshToMeshletMeshConversionError](enum.MeshToMeshletMeshConversionError.html "enum bevy::pbr::experimental::meshlet::MeshToMeshletMeshConversionError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MeshToMeshletMeshConversionError](enum.MeshToMeshletMeshConversionError.html "enum bevy::pbr::experimental::meshlet::MeshToMeshletMeshConversionError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MeshToMeshletMeshConversionError](enum.MeshToMeshletMeshConversionError.html "enum bevy::pbr::experimental::meshlet::MeshToMeshletMeshConversionError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MeshToMeshletMeshConversionError](enum.MeshToMeshletMeshConversionError.html "enum bevy::pbr::experimental::meshlet::MeshToMeshletMeshConversionError")
