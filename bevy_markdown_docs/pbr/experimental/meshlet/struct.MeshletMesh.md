...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/meshlet/asset.rs.html#41)
...
A [`bevy_mesh::Mesh`](../../../prelude/struct.Mesh.html "struct bevy::prelude::Mesh") can be converted to a [`MeshletMesh`](struct.MeshletMesh.html "struct bevy::pbr::experimental::meshlet::MeshletMesh") using `MeshletMesh::from_mesh` when the `meshlet_processor` cargo feature is enabled. The conversion step is very slow, and is meant to be ran once ahead of time, and not during runtime. This type of mesh is not suitable for dynamically generated geometry.

There are restrictions on the [`Material`](../../../prelude/trait.Material.html "trait bevy::prelude::Material") functionality that can be used with this type of mesh.
...
*   Material shaders must not use builtin functions that automatically calculate derivatives [https://gpuweb.github.io/gpuweb/wgsl/#derivatives](https://gpuweb.github.io/gpuweb/wgsl/#derivatives).
...
*   Limited control over [`bevy_render::render_resource::RenderPipelineDescriptor`](../../../material/descriptor/struct.RenderPipelineDescriptor.html "struct bevy::material::descriptor::RenderPipelineDescriptor") attributes.
*   Materials must use the [`Material::meshlet_mesh_fragment_shader`](../../../prelude/trait.Material.html#method.meshlet_mesh_fragment_shader "associated function bevy::prelude::Material::meshlet_mesh_fragment_shader") method (and similar variants for prepass/deferred shaders) which requires certain shader patterns that differ from the regular material shaders.

See also [`MeshletMesh3d`](struct.MeshletMesh3d.html "struct bevy::pbr::experimental::meshlet::MeshletMesh3d") and [`MeshletPlugin`](struct.MeshletPlugin.html "struct bevy::pbr::experimental::meshlet::MeshletPlugin").

## Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/meshlet/from_mesh.rs.html#39)

### impl [MeshletMesh](struct.MeshletMesh.html "struct bevy::pbr::experimental::meshlet::MeshletMesh")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/meshlet/from_mesh.rs.html#67-70)

#### pub fn [from\_mesh](#method.from_mesh)( mesh: &[Mesh](../../../prelude/struct.Mesh.html "struct bevy::prelude::Mesh"), vertex\_position\_quantization\_factor: [u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[MeshletMesh](struct.MeshletMesh.html "struct bevy::pbr::experimental::meshlet::MeshletMesh"), [MeshToMeshletMeshConversionError](enum.MeshToMeshletMeshConversionError.html "enum bevy::pbr::experimental::meshlet::MeshToMeshletMeshConversionError")\>

Process a [`Mesh`](../../../prelude/struct.Mesh.html "struct bevy::prelude::Mesh") to generate a [`MeshletMesh`](struct.MeshletMesh.html "struct bevy::pbr::experimental::meshlet::MeshletMesh").
...
1.  Use [`PrimitiveTopology::TriangleList`](../../../mesh/enum.PrimitiveTopology.html#variant.TriangleList "variant bevy::mesh::PrimitiveTopology::TriangleList")
2.  Use indices
...
Use [`MESHLET_DEFAULT_VERTEX_POSITION_QUANTIZATION_FACTOR`](constant.MESHLET_DEFAULT_VERTEX_POSITION_QUANTIZATION_FACTOR.html "constant bevy::pbr::experimental::meshlet::MESHLET_DEFAULT_VERTEX_POSITION_QUANTIZATION_FACTOR") as a default, adjusting lower to save memory and disk space, and higher to prevent artifacts if needed.
...
*   Ensure that their [`bevy_transform::components::Transform::translation`](../../../prelude/struct.Transform.html#structfield.translation "field bevy::prelude::Transform::translation")s are a multiple of 1/2^x centimeters (note that translations are in meters)
*   Ensure that their [`bevy_transform::components::Transform::scale`](../../../prelude/struct.Transform.html#structfield.scale "field bevy::prelude::Transform::scale")s are the same
*   Ensure that their [`bevy_transform::components::Transform::rotation`](../../../prelude/struct.Transform.html#structfield.rotation "field bevy::prelude::Transform::rotation")s are a multiple of 90 degrees

## Trait Implementations

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/meshlet/asset.rs.html#40)

### impl [Asset](../../../prelude/trait.Asset.html "trait bevy::prelude::Asset") for [MeshletMesh](struct.MeshletMesh.html "struct bevy::pbr::experimental::meshlet::MeshletMesh")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/meshlet/asset.rs.html#40)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [MeshletMesh](struct.MeshletMesh.html "struct bevy::pbr::experimental::meshlet::MeshletMesh")

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/meshlet/asset.rs.html#40)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [MeshletMesh](struct.MeshletMesh.html "struct bevy::pbr::experimental::meshlet::MeshletMesh")
...
### impl [TypePath](../../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [MeshletMesh](struct.MeshletMesh.html "struct bevy::pbr::experimental::meshlet::MeshletMesh")
...
### impl [VisitAssetDependencies](../../../asset/trait.VisitAssetDependencies.html "trait bevy::asset::VisitAssetDependencies") for [MeshletMesh](struct.MeshletMesh.html "struct bevy::pbr::experimental::meshlet::MeshletMesh")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MeshletMesh](struct.MeshletMesh.html "struct bevy::pbr::experimental::meshlet::MeshletMesh")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MeshletMesh](struct.MeshletMesh.html "struct bevy::pbr::experimental::meshlet::MeshletMesh")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MeshletMesh](struct.MeshletMesh.html "struct bevy::pbr::experimental::meshlet::MeshletMesh")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MeshletMesh](struct.MeshletMesh.html "struct bevy::pbr::experimental::meshlet::MeshletMesh")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MeshletMesh](struct.MeshletMesh.html "struct bevy::pbr::experimental::meshlet::MeshletMesh")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MeshletMesh](struct.MeshletMesh.html "struct bevy::pbr::experimental::meshlet::MeshletMesh")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MeshletMesh](struct.MeshletMesh.html "struct bevy::pbr::experimental::meshlet::MeshletMesh")
