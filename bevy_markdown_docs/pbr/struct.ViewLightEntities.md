...
# Struct ViewLightEntities 

[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/light.rs.html#947)
...
`lights: [Vec](../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[Entity](../prelude/struct.Entity.html "struct bevy::prelude::Entity")>`
...
[Source](https://docs.rs/bevy_pbr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_pbr/render/light.rs.html#946)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [ViewLightEntities](struct.ViewLightEntities.html "struct bevy::pbr::ViewLightEntities")

where [ViewLightEntities](struct.ViewLightEntities.html "struct bevy::pbr::ViewLightEntities"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ViewLightEntities](struct.ViewLightEntities.html "struct bevy::pbr::ViewLightEntities")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ViewLightEntities](struct.ViewLightEntities.html "struct bevy::pbr::ViewLightEntities")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ViewLightEntities](struct.ViewLightEntities.html "struct bevy::pbr::ViewLightEntities")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ViewLightEntities](struct.ViewLightEntities.html "struct bevy::pbr::ViewLightEntities")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ViewLightEntities](struct.ViewLightEntities.html "struct bevy::pbr::ViewLightEntities")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ViewLightEntities](struct.ViewLightEntities.html "struct bevy::pbr::ViewLightEntities")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ViewLightEntities](struct.ViewLightEntities.html "struct bevy::pbr::ViewLightEntities")
