...
# Enum ExtractAppDataError 

[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/schedule_data/serde.rs.html#319)
...
### ScheduleNotInitialized([String](../../../prelude/struct.String.html "struct bevy::prelude::String"))

A schedule has not been initialized through [`Schedule::initialize`](../../../prelude/struct.Schedule.html#method.initialize "method bevy::prelude::Schedule::initialize").

## Trait Implementations

[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/schedule_data/serde.rs.html#318)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ExtractAppDataError](enum.ExtractAppDataError.html "enum bevy::dev_tools::schedule_data::serde::ExtractAppDataError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [ExtractAppDataError](enum.ExtractAppDataError.html "enum bevy::dev_tools::schedule_data::serde::ExtractAppDataError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [ExtractAppDataError](enum.ExtractAppDataError.html "enum bevy::dev_tools::schedule_data::serde::ExtractAppDataError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ExtractAppDataError](enum.ExtractAppDataError.html "enum bevy::dev_tools::schedule_data::serde::ExtractAppDataError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ExtractAppDataError](enum.ExtractAppDataError.html "enum bevy::dev_tools::schedule_data::serde::ExtractAppDataError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ExtractAppDataError](enum.ExtractAppDataError.html "enum bevy::dev_tools::schedule_data::serde::ExtractAppDataError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ExtractAppDataError](enum.ExtractAppDataError.html "enum bevy::dev_tools::schedule_data::serde::ExtractAppDataError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ExtractAppDataError](enum.ExtractAppDataError.html "enum bevy::dev_tools::schedule_data::serde::ExtractAppDataError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ExtractAppDataError](enum.ExtractAppDataError.html "enum bevy::dev_tools::schedule_data::serde::ExtractAppDataError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ExtractAppDataError](enum.ExtractAppDataError.html "enum bevy::dev_tools::schedule_data::serde::ExtractAppDataError")
