...
# Struct FrametimeGraphMaterial 

[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/frame_time_graph/mod.rs.html#81)

```rust
pub struct FrametimeGraphMaterial {
    pub values: Handle<ShaderBuffer>,
...
`values: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[ShaderBuffer](../../render/storage/struct.ShaderBuffer.html "struct bevy::render::storage::ShaderBuffer")>`

The history of the previous frame times value.

This should be updated every frame to match the frame time history from the [`DiagnosticsStore`](../../diagnostic/struct.DiagnosticsStore.html "struct bevy::diagnostic::DiagnosticsStore")

`config: [FrameTimeGraphConfigUniform](struct.FrameTimeGraphConfigUniform.html "struct bevy::dev_tools::frame_time_graph::FrameTimeGraphConfigUniform")`
...
### impl [AsBindGroup](../../render/render_resource/trait.AsBindGroup.html "trait bevy::render::render_resource::AsBindGroup") for [FrametimeGraphMaterial](struct.FrametimeGraphMaterial.html "struct bevy::dev_tools::frame_time_graph::FrametimeGraphMaterial")
...
#### fn [bind\_group\_data](../../render/render_resource/trait.AsBindGroup.html#tymethod.bind_group_data)(&self) -> <[FrametimeGraphMaterial](struct.FrametimeGraphMaterial.html "struct bevy::dev_tools::frame_time_graph::FrametimeGraphMaterial") as [AsBindGroup](../../render/render_resource/trait.AsBindGroup.html "trait bevy::render::render_resource::AsBindGroup")\>::[Data](../../render/render_resource/trait.AsBindGroup.html#associatedtype.Data "type bevy::render::render_resource::AsBindGroup::Data")
...
### impl [Asset](../../prelude/trait.Asset.html "trait bevy::prelude::Asset") for [FrametimeGraphMaterial](struct.FrametimeGraphMaterial.html "struct bevy::dev_tools::frame_time_graph::FrametimeGraphMaterial")

[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/frame_time_graph/mod.rs.html#80)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [FrametimeGraphMaterial](struct.FrametimeGraphMaterial.html "struct bevy::dev_tools::frame_time_graph::FrametimeGraphMaterial")

[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/frame_time_graph/mod.rs.html#80)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [FrametimeGraphMaterial](struct.FrametimeGraphMaterial.html "struct bevy::dev_tools::frame_time_graph::FrametimeGraphMaterial")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [FrametimeGraphMaterial](struct.FrametimeGraphMaterial.html "struct bevy::dev_tools::frame_time_graph::FrametimeGraphMaterial")
...
### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [FrametimeGraphMaterial](struct.FrametimeGraphMaterial.html "struct bevy::dev_tools::frame_time_graph::FrametimeGraphMaterial")
...
### impl [UiMaterial](../../prelude/trait.UiMaterial.html "trait bevy::prelude::UiMaterial") for [FrametimeGraphMaterial](struct.FrametimeGraphMaterial.html "struct bevy::dev_tools::frame_time_graph::FrametimeGraphMaterial")

[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/frame_time_graph/mod.rs.html#93)

#### fn [fragment\_shader](../../prelude/trait.UiMaterial.html#method.fragment_shader)() -> [ShaderRef](../../shader/enum.ShaderRef.html "enum bevy::shader::ShaderRef")
...
#### fn [vertex\_shader](../../prelude/trait.UiMaterial.html#method.vertex_shader)() -> [ShaderRef](../../shader/enum.ShaderRef.html "enum bevy::shader::ShaderRef")
...
#### fn [stack\_z\_offset](../../prelude/trait.UiMaterial.html#method.stack_z_offset)() -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/ui_material.rs.html#124)

#### fn [specialize](../../prelude/trait.UiMaterial.html#method.specialize)( descriptor: &mut [RenderPipelineDescriptor](../../material/descriptor/struct.RenderPipelineDescriptor.html "struct bevy::material::descriptor::RenderPipelineDescriptor"), key: [UiMaterialKey](../../prelude/struct.UiMaterialKey.html "struct bevy::prelude::UiMaterialKey")<Self>, )

[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/frame_time_graph/mod.rs.html#80)

### impl [VisitAssetDependencies](../../asset/trait.VisitAssetDependencies.html "trait bevy::asset::VisitAssetDependencies") for [FrametimeGraphMaterial](struct.FrametimeGraphMaterial.html "struct bevy::dev_tools::frame_time_graph::FrametimeGraphMaterial")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [FrametimeGraphMaterial](struct.FrametimeGraphMaterial.html "struct bevy::dev_tools::frame_time_graph::FrametimeGraphMaterial")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [FrametimeGraphMaterial](struct.FrametimeGraphMaterial.html "struct bevy::dev_tools::frame_time_graph::FrametimeGraphMaterial")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [FrametimeGraphMaterial](struct.FrametimeGraphMaterial.html "struct bevy::dev_tools::frame_time_graph::FrametimeGraphMaterial")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [FrametimeGraphMaterial](struct.FrametimeGraphMaterial.html "struct bevy::dev_tools::frame_time_graph::FrametimeGraphMaterial")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [FrametimeGraphMaterial](struct.FrametimeGraphMaterial.html "struct bevy::dev_tools::frame_time_graph::FrametimeGraphMaterial")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [FrametimeGraphMaterial](struct.FrametimeGraphMaterial.html "struct bevy::dev_tools::frame_time_graph::FrametimeGraphMaterial")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [FrametimeGraphMaterial](struct.FrametimeGraphMaterial.html "struct bevy::dev_tools::frame_time_graph::FrametimeGraphMaterial")
