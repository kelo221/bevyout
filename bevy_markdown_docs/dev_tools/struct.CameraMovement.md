...
[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/easy_screenshot.rs.html#362)
...
[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/easy_screenshot.rs.html#361)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [CameraMovement](struct.CameraMovement.html "struct bevy::dev_tools::CameraMovement")

where [CameraMovement](struct.CameraMovement.html "struct bevy::dev_tools::CameraMovement"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [CameraMovement](struct.CameraMovement.html "struct bevy::dev_tools::CameraMovement")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [CameraMovement](struct.CameraMovement.html "struct bevy::dev_tools::CameraMovement")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [CameraMovement](struct.CameraMovement.html "struct bevy::dev_tools::CameraMovement")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [CameraMovement](struct.CameraMovement.html "struct bevy::dev_tools::CameraMovement")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [CameraMovement](struct.CameraMovement.html "struct bevy::dev_tools::CameraMovement")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [CameraMovement](struct.CameraMovement.html "struct bevy::dev_tools::CameraMovement")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [CameraMovement](struct.CameraMovement.html "struct bevy::dev_tools::CameraMovement")
