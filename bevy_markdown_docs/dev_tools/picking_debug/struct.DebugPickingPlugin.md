...
# Struct DebugPickingPlugin 

[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/picking_debug.rs.html#81)
...
“Normal” events are logged at the `debug` level. “Noisy” events are logged at the `trace` level. See [Bevy’s LogPlugin](https://docs.rs/bevy/latest/bevy/log/struct.LogPlugin.html) and [Bevy Cheatbook: Logging, Console Messages](https://bevy-cheatbook.github.io/features/log.html) for details.

Usually, the default level printed is `info`, so debug and trace messages will not be displayed even when this plugin is active. You can set `RUST_LOG` to change this.

You can also change the log filter at runtime in your code. The [LogPlugin docs](https://docs.rs/bevy/latest/bevy/log/struct.LogPlugin.html) give an example.

Use the [`DebugPickingMode`](enum.DebugPickingMode.html "enum bevy::dev_tools::picking_debug::DebugPickingMode") state resource to control this plugin. Example:
...
This sets the starting mode of the plugin to [`DebugPickingMode::Disabled`](enum.DebugPickingMode.html#variant.Disabled "variant bevy::dev_tools::picking_debug::DebugPickingMode::Disabled") and binds the F3 key to toggle it.

## Trait Implementations

[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/picking_debug.rs.html#80)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [DebugPickingPlugin](struct.DebugPickingPlugin.html "struct bevy::dev_tools::picking_debug::DebugPickingPlugin")

[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/picking_debug.rs.html#80)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [DebugPickingPlugin](struct.DebugPickingPlugin.html "struct bevy::dev_tools::picking_debug::DebugPickingPlugin")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [DebugPickingPlugin](struct.DebugPickingPlugin.html "struct bevy::dev_tools::picking_debug::DebugPickingPlugin")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [DebugPickingPlugin](struct.DebugPickingPlugin.html "struct bevy::dev_tools::picking_debug::DebugPickingPlugin")

[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/picking_debug.rs.html#80)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [DebugPickingPlugin](struct.DebugPickingPlugin.html "struct bevy::dev_tools::picking_debug::DebugPickingPlugin")
...
### impl [Plugin](../../prelude/trait.Plugin.html "trait bevy::prelude::Plugin") for [DebugPickingPlugin](struct.DebugPickingPlugin.html "struct bevy::dev_tools::picking_debug::DebugPickingPlugin")

[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/picking_debug.rs.html#84)
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DebugPickingPlugin](struct.DebugPickingPlugin.html "struct bevy::dev_tools::picking_debug::DebugPickingPlugin")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DebugPickingPlugin](struct.DebugPickingPlugin.html "struct bevy::dev_tools::picking_debug::DebugPickingPlugin")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DebugPickingPlugin](struct.DebugPickingPlugin.html "struct bevy::dev_tools::picking_debug::DebugPickingPlugin")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DebugPickingPlugin](struct.DebugPickingPlugin.html "struct bevy::dev_tools::picking_debug::DebugPickingPlugin")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DebugPickingPlugin](struct.DebugPickingPlugin.html "struct bevy::dev_tools::picking_debug::DebugPickingPlugin")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DebugPickingPlugin](struct.DebugPickingPlugin.html "struct bevy::dev_tools::picking_debug::DebugPickingPlugin")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DebugPickingPlugin](struct.DebugPickingPlugin.html "struct bevy::dev_tools::picking_debug::DebugPickingPlugin")
