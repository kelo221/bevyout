...
[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/diagnostics_overlay.rs.html#186)
...
Initially the [`DiagnosticsOverlayPlane`](struct.DiagnosticsOverlayPlane.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlayPlane") will be positioned at the [`GlobalZIndex`](../../prelude/struct.GlobalZIndex.html "struct bevy::prelude::GlobalZIndex") of [`INITIAL_DIAGNOSTICS_OVERLAY_PLANE_Z_INDEX`](constant.INITIAL_DIAGNOSTICS_OVERLAY_PLANE_Z_INDEX.html "constant bevy::dev_tools::diagnostics_overlay::INITIAL_DIAGNOSTICS_OVERLAY_PLANE_Z_INDEX"). You are free to edit the z index of the plane or have your ui hierarchies be relative to it.

## Trait Implementations

[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/diagnostics_overlay.rs.html#185)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [DiagnosticsOverlayPlane](struct.DiagnosticsOverlayPlane.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlayPlane")

where [DiagnosticsOverlayPlane](struct.DiagnosticsOverlayPlane.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlayPlane"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DiagnosticsOverlayPlane](struct.DiagnosticsOverlayPlane.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlayPlane")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DiagnosticsOverlayPlane](struct.DiagnosticsOverlayPlane.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlayPlane")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DiagnosticsOverlayPlane](struct.DiagnosticsOverlayPlane.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlayPlane")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DiagnosticsOverlayPlane](struct.DiagnosticsOverlayPlane.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlayPlane")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DiagnosticsOverlayPlane](struct.DiagnosticsOverlayPlane.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlayPlane")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DiagnosticsOverlayPlane](struct.DiagnosticsOverlayPlane.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlayPlane")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DiagnosticsOverlayPlane](struct.DiagnosticsOverlayPlane.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlayPlane")
