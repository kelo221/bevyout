...
[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/diagnostics_overlay.rs.html#74)
...
A [`DiagnosticsOverlay`](struct.DiagnosticsOverlay.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlay") entity will be managed by [`DiagnosticsOverlayPlugin`](struct.DiagnosticsOverlayPlugin.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlayPlugin"), and be added as a child of the [`DiagnosticsOverlayPlane`](struct.DiagnosticsOverlayPlane.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlayPlane").

If any value is showing as `Missing`, means that the [`DiagnosticPath`](../../diagnostic/struct.DiagnosticPath.html "struct bevy::diagnostic::DiagnosticPath") is not registered, so make sure that the plugin that writes to it is properly set up.

## Fields

`title: [Cow](https://doc.rust-lang.org/nightly/alloc/borrow/enum.Cow.html "enum alloc::borrow::Cow")<'static, [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)>`

Title that will appear on the overlay window

`items: [Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[DiagnosticsOverlayItem](struct.DiagnosticsOverlayItem.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlayItem")>`

Items that will appear on this overlay window

## Implementations

[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/diagnostics_overlay.rs.html#90)

### impl [DiagnosticsOverlay](struct.DiagnosticsOverlay.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlay")

[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/diagnostics_overlay.rs.html#92-95)

#### pub fn [new](#method.new)( title: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[Cow](https://doc.rust-lang.org/nightly/alloc/borrow/enum.Cow.html "enum alloc::borrow::Cow")<'static, [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)\>>, diagnostic\_paths: [Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[DiagnosticsOverlayItem](struct.DiagnosticsOverlayItem.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlayItem")\>, ) -> [DiagnosticsOverlay](struct.DiagnosticsOverlay.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlay")

Creates a new instance of a [`DiagnosticsOverlay`](struct.DiagnosticsOverlay.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlay")

[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/diagnostics_overlay.rs.html#103)

#### pub fn [fps](#method.fps)() -> [DiagnosticsOverlay](struct.DiagnosticsOverlay.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlay")

Create a [`DiagnosticsOverlay`](struct.DiagnosticsOverlay.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlay") with the diagnostcs from [`FrameTimeDiagnosticsPlugin`](../../diagnostic/struct.FrameTimeDiagnosticsPlugin.html "struct bevy::diagnostic::FrameTimeDiagnosticsPlugin")

[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/diagnostics_overlay.rs.html#121)

#### pub fn [mesh\_and\_standard\_material](#method.mesh_and_standard_material)() -> [DiagnosticsOverlay](struct.DiagnosticsOverlay.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlay")

Create a [`DiagnosticsOverlay`](struct.DiagnosticsOverlay.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlay") with the diagnostics from [`MaterialAllocatorDiagnosticPlugin`](../../pbr/diagnostic/struct.MaterialAllocatorDiagnosticPlugin.html "struct bevy::pbr::diagnostic::MaterialAllocatorDiagnosticPlugin") of [`StandardMaterial`](../../prelude/struct.StandardMaterial.html "struct bevy::prelude::StandardMaterial") and [`MeshAllocatorDiagnosticPlugin`](../../render/diagnostic/struct.MeshAllocatorDiagnosticPlugin.html "struct bevy::render::diagnostic::MeshAllocatorDiagnosticPlugin")

## Trait Implementations

[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/diagnostics_overlay.rs.html#73)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [DiagnosticsOverlay](struct.DiagnosticsOverlay.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlay")

[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/diagnostics_overlay.rs.html#73)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [DiagnosticsOverlay](struct.DiagnosticsOverlay.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlay")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [DiagnosticsOverlay](struct.DiagnosticsOverlay.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlay")

where [DiagnosticsOverlay](struct.DiagnosticsOverlay.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlay"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/diagnostics_overlay.rs.html#81)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [DiagnosticsOverlay](struct.DiagnosticsOverlay.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlay")

[Source](https://docs.rs/bevy_dev_tools/0.19.0/x86_64-unknown-linux-gnu/src/bevy_dev_tools/diagnostics_overlay.rs.html#82)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [DiagnosticsOverlay](struct.DiagnosticsOverlay.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlay")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DiagnosticsOverlay](struct.DiagnosticsOverlay.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlay")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DiagnosticsOverlay](struct.DiagnosticsOverlay.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlay")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DiagnosticsOverlay](struct.DiagnosticsOverlay.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlay")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DiagnosticsOverlay](struct.DiagnosticsOverlay.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlay")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DiagnosticsOverlay](struct.DiagnosticsOverlay.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlay")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DiagnosticsOverlay](struct.DiagnosticsOverlay.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlay")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DiagnosticsOverlay](struct.DiagnosticsOverlay.html "struct bevy::dev_tools::diagnostics_overlay::DiagnosticsOverlay")
