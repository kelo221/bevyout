...
# Struct SpriteViewBindGroup 

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/render/mod.rs.html#481)
...
[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/render/mod.rs.html#480)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [SpriteViewBindGroup](struct.SpriteViewBindGroup.html "struct bevy::sprite_render::SpriteViewBindGroup")

where [SpriteViewBindGroup](struct.SpriteViewBindGroup.html "struct bevy::sprite_render::SpriteViewBindGroup"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SpriteViewBindGroup](struct.SpriteViewBindGroup.html "struct bevy::sprite_render::SpriteViewBindGroup")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SpriteViewBindGroup](struct.SpriteViewBindGroup.html "struct bevy::sprite_render::SpriteViewBindGroup")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SpriteViewBindGroup](struct.SpriteViewBindGroup.html "struct bevy::sprite_render::SpriteViewBindGroup")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SpriteViewBindGroup](struct.SpriteViewBindGroup.html "struct bevy::sprite_render::SpriteViewBindGroup")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SpriteViewBindGroup](struct.SpriteViewBindGroup.html "struct bevy::sprite_render::SpriteViewBindGroup")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SpriteViewBindGroup](struct.SpriteViewBindGroup.html "struct bevy::sprite_render::SpriteViewBindGroup")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SpriteViewBindGroup](struct.SpriteViewBindGroup.html "struct bevy::sprite_render::SpriteViewBindGroup")
