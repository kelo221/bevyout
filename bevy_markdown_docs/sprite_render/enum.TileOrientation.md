...
[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tile_orientation.rs.html#40)

```rust
#[repr(u8)]pub enum TileOrientation {
    Default = 0,
    Rotate90 = 3,
    Rotate180 = 6,
    Rotate270 = 5,
...
The representation is a u8 value where the bits (from most significant to least significant), represent:
...
The order in which the mirroring is performed matters - the tile is first mirrored horizontally (if specified), then vertically, then finally diagonally, in the UV coordinate system.

Note that different coordinate systems are used for UV mapping and Bevy world coordinates (e.g. in UV maps, the y component increases towards the bottom of the tile, in Bevy it increases towards the top). This means that the ordering in which the mirroring is applied differs in different coordinate systems.

The ordering of the enum starts from the default orientation (no rotation or mirroring), then we have successive 90 degree counter-clockwise rotations. Then we have a tile mirrored horizontally, and then the results of successive 90 degree counter-clockwise rotations of the mirrored tile.

The enum values can be easily converted to the format used for tile indices in [Tiled](https://www.mapeditor.org/) maps, where bits 31, 30 and 29 correspond to bits 2, 1 and 0 of this enum’s values. So for a given enum value, we can just use `value << 29` to produce the bits required in a Tiled index.
...
[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tile_orientation.rs.html#52)

### impl [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tile_orientation.rs.html#63)

#### pub fn [from\_bools](#method.from_bools)( mirror\_h: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), mirror\_v: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), mirror\_d: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), ) -> [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")

Create a [`TileOrientation`](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation") based on whether each mirror is applied

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tile_orientation.rs.html#77)

#### pub fn [mirror\_h](#method.mirror_h)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

True if the tile is mirrored horizontally

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tile_orientation.rs.html#82)

#### pub fn [mirror\_v](#method.mirror_v)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

True if the tile is mirrored vertically

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tile_orientation.rs.html#87)

#### pub fn [mirror\_d](#method.mirror_d)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

True if the tile is mirrored diagonally

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tile_orientation.rs.html#95)

#### pub fn [inverse](#method.inverse)(&self) -> [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")

This method treats each [`TileOrientation`](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation") as the transform from [`TileOrientation::Default`](enum.TileOrientation.html#variant.Default "variant bevy::sprite_render::TileOrientation::Default") to that orientation. Find the [`TileOrientation`](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation") that when applied will undo the effect of this [`TileOrientation`](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tile_orientation.rs.html#111)

#### pub fn [apply\_to\_ivec2](#method.apply_to_ivec2)(&self, pos: &[IVec2](../prelude/struct.IVec2.html "struct bevy::prelude::IVec2")) -> [IVec2](../prelude/struct.IVec2.html "struct bevy::prelude::IVec2")

This method treats the [`TileOrientation`](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation") as the transform from [`TileOrientation::Default`](enum.TileOrientation.html#variant.Default "variant bevy::sprite_render::TileOrientation::Default") to this orientation. Apply this transformation to an [`IVec2`](../prelude/struct.IVec2.html "struct bevy::prelude::IVec2")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tile_orientation.rs.html#138)

#### pub fn [and\_then](#method.and_then)(&self, then: [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")) -> [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")

This method treats each [`TileOrientation`](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation") as the transform from [`TileOrientation::Default`](enum.TileOrientation.html#variant.Default "variant bevy::sprite_render::TileOrientation::Default") to that orientation. Produce a [`TileOrientation`](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation") that will give the same effect as applying this transform, then applying `then`.
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tile_orientation.rs.html#37)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tile_orientation.rs.html#37)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tile_orientation.rs.html#37)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tile_orientation.rs.html#158)

### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tile_orientation.rs.html#159)
...
### impl [Enum](../reflect/enums/trait.Enum.html "trait bevy::reflect::enums::Enum") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tile_orientation.rs.html#37)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tile_orientation.rs.html#37)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tile_orientation.rs.html#37)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tile_orientation.rs.html#37)

### impl [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tile_orientation.rs.html#37)

#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)( \_\_param0: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")
...
### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")
...
where [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tile_orientation.rs.html#37)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")
...
[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tile_orientation.rs.html#38)
...
### impl [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tile_orientation.rs.html#37)

#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tile_orientation.rs.html#37)

### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TileOrientation](enum.TileOrientation.html "enum bevy::sprite_render::TileOrientation")
