...
# Struct Mesh2dViewBindGroup 

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/mesh.rs.html#770)
...
`value: [BindGroup](../render/render_resource/struct.BindGroup.html "struct bevy::render::render_resource::BindGroup")`

## Trait Implementations

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/mesh.rs.html#769)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [Mesh2dViewBindGroup](struct.Mesh2dViewBindGroup.html "struct bevy::sprite_render::Mesh2dViewBindGroup")

where [Mesh2dViewBindGroup](struct.Mesh2dViewBindGroup.html "struct bevy::sprite_render::Mesh2dViewBindGroup"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Mesh2dViewBindGroup](struct.Mesh2dViewBindGroup.html "struct bevy::sprite_render::Mesh2dViewBindGroup")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Mesh2dViewBindGroup](struct.Mesh2dViewBindGroup.html "struct bevy::sprite_render::Mesh2dViewBindGroup")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Mesh2dViewBindGroup](struct.Mesh2dViewBindGroup.html "struct bevy::sprite_render::Mesh2dViewBindGroup")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Mesh2dViewBindGroup](struct.Mesh2dViewBindGroup.html "struct bevy::sprite_render::Mesh2dViewBindGroup")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Mesh2dViewBindGroup](struct.Mesh2dViewBindGroup.html "struct bevy::sprite_render::Mesh2dViewBindGroup")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Mesh2dViewBindGroup](struct.Mesh2dViewBindGroup.html "struct bevy::sprite_render::Mesh2dViewBindGroup")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Mesh2dViewBindGroup](struct.Mesh2dViewBindGroup.html "struct bevy::sprite_render::Mesh2dViewBindGroup")
