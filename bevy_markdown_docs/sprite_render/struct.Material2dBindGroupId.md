...
# Struct Material2dBindGroupId 

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/material.rs.html#1062)
...
`0: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[BindGroupId](../render/render_resource/struct.BindGroupId.html "struct bevy::render::render_resource::BindGroupId")>`

## Methods from [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")<Target = [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[BindGroupId](../render/render_resource/struct.BindGroupId.html "struct bevy::render::render_resource::BindGroupId")\>>

1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/core/option.rs.html#632)

#### pub fn [is\_some](#method.is_some)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if the option is a [`Some`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.Some "variant core::option::Option::Some") value.
...
1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/core/option.rs.html#681)

#### pub fn [is\_none](#method.is_none)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if the option is a [`None`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.None "variant core::option::Option::None") value.
...
1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/core/option.rs.html#741)

#### pub fn [as\_ref](#method.as_ref)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[&T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\>

Converts from `&Option<T>` to `Option<&T>`.

##### Examples

Calculates the length of an `Option<[String](../../std/string/struct.String.html "String")>` as an `Option<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html "primitive usize")>` without moving the [`String`](../../std/string/struct.String.html "String"). The [`map`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#method.map "method core::option::Option::map") method takes the `self` argument by value, consuming the original, so this technique uses `as_ref` to first take an `Option` to a reference to the value inside the original.
...
1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/core/option.rs.html#763)

#### pub fn [as\_mut](#method.as_mut)(&mut self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\>
...
1.33.0 · [Source](https://doc.rust-lang.org/nightly/src/core/option.rs.html#777)

#### pub fn [as\_pin\_ref](#method.as_pin_ref)(self: [Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<&[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<T>>) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<[&T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\>>

Converts from `[Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<[&](https://doc.rust-lang.org/nightly/std/primitive.reference.html "shared reference")Option<T>>` to `Option<[Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<[&](https://doc.rust-lang.org/nightly/std/primitive.reference.html "shared reference")T>>`.

1.33.0 · [Source](https://doc.rust-lang.org/nightly/src/core/option.rs.html#794)

#### pub fn [as\_pin\_mut](#method.as_pin_mut)(self: [Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<&mut [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<T>>) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<[&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\>>

Converts from `[Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<[&mut](https://doc.rust-lang.org/nightly/std/primitive.reference.html "mutable reference") Option<T>>` to `Option<[Pin](https://doc.rust-lang.org/nightly/core/pin/struct.Pin.html "struct core::pin::Pin")<[&mut](https://doc.rust-lang.org/nightly/std/primitive.reference.html "mutable reference") T>>`.

1.75.0 · [Source](https://doc.rust-lang.org/nightly/src/core/option.rs.html#841)
...
The inverse of this function is (discounting borrowing) [`[_]::first`](https://doc.rust-lang.org/nightly/std/primitive.slice.html#method.first "method slice::first"):
...
1.75.0 · [Source](https://doc.rust-lang.org/nightly/src/core/option.rs.html#896)
...
The inverse of this method (discounting borrowing) is [`[_]::first_mut`](https://doc.rust-lang.org/nightly/std/primitive.slice.html#method.first_mut "method slice::first_mut"):

```rust
assert_eq!(Some(123).as_mut_slice().first_mut(), Some(&mut 123))
```

1.40.0 · [Source](https://doc.rust-lang.org/nightly/src/core/option.rs.html#1385-1387)

#### pub fn [as\_deref](#method.as_deref)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&<T as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")\>

where T: [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref"),

Converts from `Option<T>` (or `&Option<T>`) to `Option<&T::Target>`.

Leaves the original Option in-place, creating a new one with a reference to the original one, additionally coercing the contents via [`Deref`](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref").
...
1.40.0 · [Source](https://doc.rust-lang.org/nightly/src/core/option.rs.html#1409-1411)

#### pub fn [as\_deref\_mut](#method.as_deref_mut)(&mut self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&mut <T as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")\>
...
Leaves the original `Option` in-place, creating a new one containing a mutable reference to the inner type’s [`Deref::Target`](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "associated type core::ops::deref::Deref::Target") type.
...
1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/core/option.rs.html#1433)

#### pub fn [iter](#method.iter)(&self) -> [Iter](https://doc.rust-lang.org/nightly/core/option/struct.Iter.html "struct core::option::Iter")<'\_, T> [ⓘ](#)
...
1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/core/option.rs.html#1454)

#### pub fn [iter\_mut](#method.iter_mut)(&mut self) -> [IterMut](https://doc.rust-lang.org/nightly/core/option/struct.IterMut.html "struct core::option::IterMut")<'\_, T> [ⓘ](#)
...
1.53.0 · [Source](https://doc.rust-lang.org/nightly/src/core/option.rs.html#1717-1719)

#### pub fn [insert](#method.insert)(&mut self, value: T) -> [&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)

Inserts `value` into the option, then returns a mutable reference to it.

If the option already contains a value, the old value is dropped.

See also [`Option::get_or_insert`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#method.get_or_insert "method core::option::Option::get_or_insert"), which doesn’t update the value if the option already contains [`Some`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.Some "variant core::option::Option::Some").
...
1.20.0 · [Source](https://doc.rust-lang.org/nightly/src/core/option.rs.html#1750-1752)

#### pub fn [get\_or\_insert](#method.get_or_insert)(&mut self, value: T) -> [&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)

Inserts `value` into the option if it is [`None`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.None "variant core::option::Option::None"), then returns a mutable reference to the contained value.

See also [`Option::insert`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#method.insert "method core::option::Option::insert"), which updates the value even if the option already contains [`Some`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.Some "variant core::option::Option::Some").
...
1.83.0 · [Source](https://doc.rust-lang.org/nightly/src/core/option.rs.html#1777-1779)

#### pub fn [get\_or\_insert\_default](#method.get_or_insert_default)(&mut self) -> [&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)

where T: [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default"),

Inserts the default value into the option if it is [`None`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.None "variant core::option::Option::None"), then returns a mutable reference to the contained value.
...
1.20.0 · [Source](https://doc.rust-lang.org/nightly/src/core/option.rs.html#1804-1806)

#### pub fn [get\_or\_insert\_with](#method.get_or_insert_with)<F>(&mut self, f: F) -> [&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)

where F: [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")() -> T,

Inserts a value computed from `f` into the option if it is [`None`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.None "variant core::option::Option::None"), then returns a mutable reference to the contained value.
...
[Source](https://doc.rust-lang.org/nightly/src/core/option.rs.html#1859-1865)

#### pub fn [get\_or\_try\_insert\_with](#method.get_or_try_insert_with)<'a, R, F>( &'a mut self, f: F, ) -> <<R as [Try](https://doc.rust-lang.org/nightly/core/ops/try_trait/trait.Try.html "trait core::ops::try_trait::Try")\>::[Residual](https://doc.rust-lang.org/nightly/core/ops/try_trait/trait.Try.html#associatedtype.Residual "type core::ops::try_trait::Try::Residual") as [Residual](https://doc.rust-lang.org/nightly/core/ops/try_trait/trait.Residual.html "trait core::ops::try_trait::Residual")<[&'a mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\>>::[TryType](https://doc.rust-lang.org/nightly/core/ops/try_trait/trait.Residual.html#associatedtype.TryType "type core::ops::try_trait::Residual::TryType")

where F: [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")() -> R, R: [Try](https://doc.rust-lang.org/nightly/core/ops/try_trait/trait.Try.html "trait core::ops::try_trait::Try")<Output = T>, <R as [Try](https://doc.rust-lang.org/nightly/core/ops/try_trait/trait.Try.html "trait core::ops::try_trait::Try")\>::[Residual](https://doc.rust-lang.org/nightly/core/ops/try_trait/trait.Try.html#associatedtype.Residual "type core::ops::try_trait::Try::Residual"): [Residual](https://doc.rust-lang.org/nightly/core/ops/try_trait/trait.Residual.html "trait core::ops::try_trait::Residual")<[&'a mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\>,
...
1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/core/option.rs.html#1898)

#### pub fn [take](#method.take)(&mut self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<T>

Takes the value out of the option, leaving a [`None`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.None "variant core::option::Option::None") in its place.
...
1.80.0 · [Source](https://doc.rust-lang.org/nightly/src/core/option.rs.html#1930-1932)

#### pub fn [take\_if](#method.take_if)<P>(&mut self, predicate: P) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<T>

where P: [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")([&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html),

Takes the value out of the option, but only if the predicate evaluates to `true` on a mutable reference to the value.

In other words, replaces `self` with `None` if the predicate returns `true`. This method operates similar to [`Option::take`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#method.take "method core::option::Option::take") but conditional.
...
1.31.0 · [Source](https://doc.rust-lang.org/nightly/src/core/option.rs.html#1957)
...
Replaces the actual value in the option by the value given in parameter, returning the old value if present, leaving a [`Some`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.Some "variant core::option::Option::Some") in its place without deinitializing either one.
...
[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/material.rs.html#1061)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Material2dBindGroupId](struct.Material2dBindGroupId.html "struct bevy::sprite_render::Material2dBindGroupId")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/material.rs.html#1061)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Material2dBindGroupId](struct.Material2dBindGroupId.html "struct bevy::sprite_render::Material2dBindGroupId")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [Material2dBindGroupId](struct.Material2dBindGroupId.html "struct bevy::sprite_render::Material2dBindGroupId")

where [Material2dBindGroupId](struct.Material2dBindGroupId.html "struct bevy::sprite_render::Material2dBindGroupId"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [Material2dBindGroupId](struct.Material2dBindGroupId.html "struct bevy::sprite_render::Material2dBindGroupId")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/material.rs.html#1061)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Material2dBindGroupId](struct.Material2dBindGroupId.html "struct bevy::sprite_render::Material2dBindGroupId")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/material.rs.html#1061)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Material2dBindGroupId](struct.Material2dBindGroupId.html "struct bevy::sprite_render::Material2dBindGroupId")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/material.rs.html#1061)

### impl [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [Material2dBindGroupId](struct.Material2dBindGroupId.html "struct bevy::sprite_render::Material2dBindGroupId")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/material.rs.html#1061)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[BindGroupId](../render/render_resource/struct.BindGroupId.html "struct bevy::render::render_resource::BindGroupId")\>

The resulting type after dereferencing.

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/material.rs.html#1061)

#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[Material2dBindGroupId](struct.Material2dBindGroupId.html "struct bevy::sprite_render::Material2dBindGroupId") as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/material.rs.html#1061)

### impl [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [Material2dBindGroupId](struct.Material2dBindGroupId.html "struct bevy::sprite_render::Material2dBindGroupId")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/material.rs.html#1061)

#### fn [deref\_mut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html#tymethod.deref_mut)(&mut self) -> &mut <[Material2dBindGroupId](struct.Material2dBindGroupId.html "struct bevy::sprite_render::Material2dBindGroupId") as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Mutably dereferences the value.

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/material.rs.html#1061)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [Material2dBindGroupId](struct.Material2dBindGroupId.html "struct bevy::sprite_render::Material2dBindGroupId")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/material.rs.html#1061)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Material2dBindGroupId](struct.Material2dBindGroupId.html "struct bevy::sprite_render::Material2dBindGroupId")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/material.rs.html#1061)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Material2dBindGroupId](struct.Material2dBindGroupId.html "struct bevy::sprite_render::Material2dBindGroupId")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Material2dBindGroupId](struct.Material2dBindGroupId.html "struct bevy::sprite_render::Material2dBindGroupId")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Material2dBindGroupId](struct.Material2dBindGroupId.html "struct bevy::sprite_render::Material2dBindGroupId")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Material2dBindGroupId](struct.Material2dBindGroupId.html "struct bevy::sprite_render::Material2dBindGroupId")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Material2dBindGroupId](struct.Material2dBindGroupId.html "struct bevy::sprite_render::Material2dBindGroupId")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Material2dBindGroupId](struct.Material2dBindGroupId.html "struct bevy::sprite_render::Material2dBindGroupId")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Material2dBindGroupId](struct.Material2dBindGroupId.html "struct bevy::sprite_render::Material2dBindGroupId")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Material2dBindGroupId](struct.Material2dBindGroupId.html "struct bevy::sprite_render::Material2dBindGroupId")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Material2dBindGroupId](struct.Material2dBindGroupId.html "struct bevy::sprite_render::Material2dBindGroupId")
