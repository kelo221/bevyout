...
# Struct Mesh2dTransforms 

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/mesh.rs.html#212)
...
`world_from_local: [Affine3](../math/struct.Affine3.html "struct bevy::math::Affine3")``flags: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)`

## Trait Implementations

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/mesh.rs.html#211)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [Mesh2dTransforms](struct.Mesh2dTransforms.html "struct bevy::sprite_render::Mesh2dTransforms")

where [Mesh2dTransforms](struct.Mesh2dTransforms.html "struct bevy::sprite_render::Mesh2dTransforms"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Mesh2dTransforms](struct.Mesh2dTransforms.html "struct bevy::sprite_render::Mesh2dTransforms")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Mesh2dTransforms](struct.Mesh2dTransforms.html "struct bevy::sprite_render::Mesh2dTransforms")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Mesh2dTransforms](struct.Mesh2dTransforms.html "struct bevy::sprite_render::Mesh2dTransforms")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Mesh2dTransforms](struct.Mesh2dTransforms.html "struct bevy::sprite_render::Mesh2dTransforms")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Mesh2dTransforms](struct.Mesh2dTransforms.html "struct bevy::sprite_render::Mesh2dTransforms")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Mesh2dTransforms](struct.Mesh2dTransforms.html "struct bevy::sprite_render::Mesh2dTransforms")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Mesh2dTransforms](struct.Mesh2dTransforms.html "struct bevy::sprite_render::Mesh2dTransforms")
