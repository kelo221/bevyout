...
# Struct Material2dPipeline 

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/material.rs.html#399)
...
`mesh2d_pipeline: [Mesh2dPipeline](struct.Mesh2dPipeline.html "struct bevy::sprite_render::Mesh2dPipeline")``material2d_layout: [BindGroupLayoutDescriptor](../material/descriptor/struct.BindGroupLayoutDescriptor.html "struct bevy::material::descriptor::BindGroupLayoutDescriptor")``vertex_shader: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Shader](../prelude/struct.Shader.html "struct bevy::prelude::Shader")>>``fragment_shader: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Shader](../prelude/struct.Shader.html "struct bevy::prelude::Shader")>>`

## Trait Implementations

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/material.rs.html#445)

### impl<M> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Material2dPipeline](struct.Material2dPipeline.html "struct bevy::sprite_render::Material2dPipeline")<M>

where M: [Material2d](trait.Material2d.html "trait bevy::sprite_render::Material2d"),

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/material.rs.html#446)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Material2dPipeline](struct.Material2dPipeline.html "struct bevy::sprite_render::Material2dPipeline")<M>
...
### impl<M> [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [Material2dPipeline](struct.Material2dPipeline.html "struct bevy::sprite_render::Material2dPipeline")<M>

where M: [Material2d](trait.Material2d.html "trait bevy::sprite_render::Material2d"), [Material2dPipeline](struct.Material2dPipeline.html "struct bevy::sprite_render::Material2dPipeline")<M>: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl<M> [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [Material2dPipeline](struct.Material2dPipeline.html "struct bevy::sprite_render::Material2dPipeline")<M>
...
### impl<M> [SpecializedMeshPipeline](../render/render_resource/trait.SpecializedMeshPipeline.html "trait bevy::render::render_resource::SpecializedMeshPipeline") for [Material2dPipeline](struct.Material2dPipeline.html "struct bevy::sprite_render::Material2dPipeline")<M>

where M: [Material2d](trait.Material2d.html "trait bevy::sprite_render::Material2d"), <M as [AsBindGroup](../render/render_resource/trait.AsBindGroup.html "trait bevy::render::render_resource::AsBindGroup")\>::[Data](../render/render_resource/trait.AsBindGroup.html#associatedtype.Data "type bevy::render::render_resource::AsBindGroup::Data"): [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") + [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") + [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") + [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),
...
### impl<M> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Material2dPipeline](struct.Material2dPipeline.html "struct bevy::sprite_render::Material2dPipeline")<M>

### impl<M> ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Material2dPipeline](struct.Material2dPipeline.html "struct bevy::sprite_render::Material2dPipeline")<M>

### impl<M> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Material2dPipeline](struct.Material2dPipeline.html "struct bevy::sprite_render::Material2dPipeline")<M>

### impl<M> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Material2dPipeline](struct.Material2dPipeline.html "struct bevy::sprite_render::Material2dPipeline")<M>

### impl<M> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Material2dPipeline](struct.Material2dPipeline.html "struct bevy::sprite_render::Material2dPipeline")<M>

### impl<M> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Material2dPipeline](struct.Material2dPipeline.html "struct bevy::sprite_render::Material2dPipeline")<M>

### impl<M> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Material2dPipeline](struct.Material2dPipeline.html "struct bevy::sprite_render::Material2dPipeline")<M>
