...
[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tilemap_chunk_material.rs.html#28)
...
This material is used internally by the tilemap system to render chunks of tiles efficiently using a single draw call per chunk.

## Fields

`alpha_mode: [AlphaMode2d](enum.AlphaMode2d.html "enum bevy::sprite_render::AlphaMode2d")``tileset: [Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Image](../prelude/struct.Image.html "struct bevy::prelude::Image")>``tile_data: [Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Image](../prelude/struct.Image.html "struct bevy::prelude::Image")>`
...
### impl [AsBindGroup](../render/render_resource/trait.AsBindGroup.html "trait bevy::render::render_resource::AsBindGroup") for [TilemapChunkMaterial](struct.TilemapChunkMaterial.html "struct bevy::sprite_render::TilemapChunkMaterial")
...
#### fn [bind\_group\_data](../render/render_resource/trait.AsBindGroup.html#tymethod.bind_group_data)(&self) -> <[TilemapChunkMaterial](struct.TilemapChunkMaterial.html "struct bevy::sprite_render::TilemapChunkMaterial") as [AsBindGroup](../render/render_resource/trait.AsBindGroup.html "trait bevy::render::render_resource::AsBindGroup")\>::[Data](../render/render_resource/trait.AsBindGroup.html#associatedtype.Data "type bevy::render::render_resource::AsBindGroup::Data")
...
### impl [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset") for [TilemapChunkMaterial](struct.TilemapChunkMaterial.html "struct bevy::sprite_render::TilemapChunkMaterial")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tilemap_chunk_material.rs.html#27)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [TilemapChunkMaterial](struct.TilemapChunkMaterial.html "struct bevy::sprite_render::TilemapChunkMaterial")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tilemap_chunk_material.rs.html#27)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [TilemapChunkMaterial](struct.TilemapChunkMaterial.html "struct bevy::sprite_render::TilemapChunkMaterial")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [TilemapChunkMaterial](struct.TilemapChunkMaterial.html "struct bevy::sprite_render::TilemapChunkMaterial")
...
[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tilemap_chunk_material.rs.html#40)
...
[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/tilemap_chunk/tilemap_chunk_material.rs.html#47)
...
### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [TilemapChunkMaterial](struct.TilemapChunkMaterial.html "struct bevy::sprite_render::TilemapChunkMaterial")
...
### impl [VisitAssetDependencies](../asset/trait.VisitAssetDependencies.html "trait bevy::asset::VisitAssetDependencies") for [TilemapChunkMaterial](struct.TilemapChunkMaterial.html "struct bevy::sprite_render::TilemapChunkMaterial")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TilemapChunkMaterial](struct.TilemapChunkMaterial.html "struct bevy::sprite_render::TilemapChunkMaterial")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TilemapChunkMaterial](struct.TilemapChunkMaterial.html "struct bevy::sprite_render::TilemapChunkMaterial")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TilemapChunkMaterial](struct.TilemapChunkMaterial.html "struct bevy::sprite_render::TilemapChunkMaterial")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TilemapChunkMaterial](struct.TilemapChunkMaterial.html "struct bevy::sprite_render::TilemapChunkMaterial")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TilemapChunkMaterial](struct.TilemapChunkMaterial.html "struct bevy::sprite_render::TilemapChunkMaterial")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TilemapChunkMaterial](struct.TilemapChunkMaterial.html "struct bevy::sprite_render::TilemapChunkMaterial")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TilemapChunkMaterial](struct.TilemapChunkMaterial.html "struct bevy::sprite_render::TilemapChunkMaterial")
