...
[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/wireframe2d.rs.html#319)

```rust
pub struct Wireframe2dPipeline { /* private fields */ }
```
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Wireframe2dPipeline](struct.Wireframe2dPipeline.html "struct bevy::sprite_render::Wireframe2dPipeline")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/mesh2d/wireframe2d.rs.html#318)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Wireframe2dPipeline](struct.Wireframe2dPipeline.html "struct bevy::sprite_render::Wireframe2dPipeline")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [Wireframe2dPipeline](struct.Wireframe2dPipeline.html "struct bevy::sprite_render::Wireframe2dPipeline")

where [Wireframe2dPipeline](struct.Wireframe2dPipeline.html "struct bevy::sprite_render::Wireframe2dPipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [Wireframe2dPipeline](struct.Wireframe2dPipeline.html "struct bevy::sprite_render::Wireframe2dPipeline")
...
### impl [SpecializedMeshPipeline](../render/render_resource/trait.SpecializedMeshPipeline.html "trait bevy::render::render_resource::SpecializedMeshPipeline") for [Wireframe2dPipeline](struct.Wireframe2dPipeline.html "struct bevy::sprite_render::Wireframe2dPipeline")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Wireframe2dPipeline](struct.Wireframe2dPipeline.html "struct bevy::sprite_render::Wireframe2dPipeline")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Wireframe2dPipeline](struct.Wireframe2dPipeline.html "struct bevy::sprite_render::Wireframe2dPipeline")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Wireframe2dPipeline](struct.Wireframe2dPipeline.html "struct bevy::sprite_render::Wireframe2dPipeline")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Wireframe2dPipeline](struct.Wireframe2dPipeline.html "struct bevy::sprite_render::Wireframe2dPipeline")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Wireframe2dPipeline](struct.Wireframe2dPipeline.html "struct bevy::sprite_render::Wireframe2dPipeline")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Wireframe2dPipeline](struct.Wireframe2dPipeline.html "struct bevy::sprite_render::Wireframe2dPipeline")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Wireframe2dPipeline](struct.Wireframe2dPipeline.html "struct bevy::sprite_render::Wireframe2dPipeline")
