...
[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/render/mod.rs.html#55)

```rust
pub struct SpritePipeline { /* private fields */ }
```
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [SpritePipeline](struct.SpritePipeline.html "struct bevy::sprite_render::SpritePipeline")

where [SpritePipeline](struct.SpritePipeline.html "struct bevy::sprite_render::SpritePipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [SpritePipeline](struct.SpritePipeline.html "struct bevy::sprite_render::SpritePipeline")

where [SpritePipeline](struct.SpritePipeline.html "struct bevy::sprite_render::SpritePipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/render/mod.rs.html#161)

### impl [SpecializedRenderPipeline](../render/render_resource/trait.SpecializedRenderPipeline.html "trait bevy::render::render_resource::SpecializedRenderPipeline") for [SpritePipeline](struct.SpritePipeline.html "struct bevy::sprite_render::SpritePipeline")

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/render/mod.rs.html#162)

#### type [Key](../render/render_resource/trait.SpecializedRenderPipeline.html#associatedtype.Key) = [SpritePipelineKey](struct.SpritePipelineKey.html "struct bevy::sprite_render::SpritePipelineKey")

The key that defines each “variant” of the render pipeline.

[Source](https://docs.rs/bevy_sprite_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_sprite_render/render/mod.rs.html#164)

#### fn [specialize](../render/render_resource/trait.SpecializedRenderPipeline.html#tymethod.specialize)( &self, key: <[SpritePipeline](struct.SpritePipeline.html "struct bevy::sprite_render::SpritePipeline") as [SpecializedRenderPipeline](../render/render_resource/trait.SpecializedRenderPipeline.html "trait bevy::render::render_resource::SpecializedRenderPipeline")\>::[Key](../render/render_resource/trait.SpecializedRenderPipeline.html#associatedtype.Key "type bevy::render::render_resource::SpecializedRenderPipeline::Key"), ) -> [RenderPipelineDescriptor](../material/descriptor/struct.RenderPipelineDescriptor.html "struct bevy::material::descriptor::RenderPipelineDescriptor")

Construct a new render pipeline based on the provided key.

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SpritePipeline](struct.SpritePipeline.html "struct bevy::sprite_render::SpritePipeline")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SpritePipeline](struct.SpritePipeline.html "struct bevy::sprite_render::SpritePipeline")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SpritePipeline](struct.SpritePipeline.html "struct bevy::sprite_render::SpritePipeline")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SpritePipeline](struct.SpritePipeline.html "struct bevy::sprite_render::SpritePipeline")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SpritePipeline](struct.SpritePipeline.html "struct bevy::sprite_render::SpritePipeline")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SpritePipeline](struct.SpritePipeline.html "struct bevy::sprite_render::SpritePipeline")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SpritePipeline](struct.SpritePipeline.html "struct bevy::sprite_render::SpritePipeline")
