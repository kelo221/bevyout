...
# Struct UiShadowsBatch 

[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/box_shadow.rs.html#82)
...
`range: [Range](https://doc.rust-lang.org/nightly/core/ops/range/struct.Range.html "struct core::ops::range::Range")<[u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)>``camera: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")`

## Trait Implementations

[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/box_shadow.rs.html#81)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [UiShadowsBatch](struct.UiShadowsBatch.html "struct bevy::ui_render::box_shadow::UiShadowsBatch")

where [UiShadowsBatch](struct.UiShadowsBatch.html "struct bevy::ui_render::box_shadow::UiShadowsBatch"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [UiShadowsBatch](struct.UiShadowsBatch.html "struct bevy::ui_render::box_shadow::UiShadowsBatch")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [UiShadowsBatch](struct.UiShadowsBatch.html "struct bevy::ui_render::box_shadow::UiShadowsBatch")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [UiShadowsBatch](struct.UiShadowsBatch.html "struct bevy::ui_render::box_shadow::UiShadowsBatch")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [UiShadowsBatch](struct.UiShadowsBatch.html "struct bevy::ui_render::box_shadow::UiShadowsBatch")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [UiShadowsBatch](struct.UiShadowsBatch.html "struct bevy::ui_render::box_shadow::UiShadowsBatch")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [UiShadowsBatch](struct.UiShadowsBatch.html "struct bevy::ui_render::box_shadow::UiShadowsBatch")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [UiShadowsBatch](struct.UiShadowsBatch.html "struct bevy::ui_render::box_shadow::UiShadowsBatch")
