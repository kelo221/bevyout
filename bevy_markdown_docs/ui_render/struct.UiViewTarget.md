...
[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/lib.rs.html#773)
...
For example, if the UI is being rendered to a 3D camera, this component lives on the UI view and contains the entity corresponding to the 3D camera.

This is the inverse of [`UiCameraView`](struct.UiCameraView.html "struct bevy::ui_render::UiCameraView").
...
[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/lib.rs.html#772)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [UiViewTarget](struct.UiViewTarget.html "struct bevy::ui_render::UiViewTarget")

where [UiViewTarget](struct.UiViewTarget.html "struct bevy::ui_render::UiViewTarget"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [UiViewTarget](struct.UiViewTarget.html "struct bevy::ui_render::UiViewTarget")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [UiViewTarget](struct.UiViewTarget.html "struct bevy::ui_render::UiViewTarget")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [UiViewTarget](struct.UiViewTarget.html "struct bevy::ui_render::UiViewTarget")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [UiViewTarget](struct.UiViewTarget.html "struct bevy::ui_render::UiViewTarget")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [UiViewTarget](struct.UiViewTarget.html "struct bevy::ui_render::UiViewTarget")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [UiViewTarget](struct.UiViewTarget.html "struct bevy::ui_render::UiViewTarget")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [UiViewTarget](struct.UiViewTarget.html "struct bevy::ui_render::UiViewTarget")
