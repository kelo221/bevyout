...
# Struct UiTextureSlicerBatch 

[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/ui_texture_slice_pipeline.rs.html#78)
...
`range: [Range](https://doc.rust-lang.org/nightly/core/ops/range/struct.Range.html "struct core::ops::range::Range")<[u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)>``image: [AssetId](../../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[Image](../../prelude/struct.Image.html "struct bevy::prelude::Image")>`

## Trait Implementations

[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/ui_texture_slice_pipeline.rs.html#77)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [UiTextureSlicerBatch](struct.UiTextureSlicerBatch.html "struct bevy::ui_render::ui_texture_slice_pipeline::UiTextureSlicerBatch")

where [UiTextureSlicerBatch](struct.UiTextureSlicerBatch.html "struct bevy::ui_render::ui_texture_slice_pipeline::UiTextureSlicerBatch"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [UiTextureSlicerBatch](struct.UiTextureSlicerBatch.html "struct bevy::ui_render::ui_texture_slice_pipeline::UiTextureSlicerBatch")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [UiTextureSlicerBatch](struct.UiTextureSlicerBatch.html "struct bevy::ui_render::ui_texture_slice_pipeline::UiTextureSlicerBatch")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [UiTextureSlicerBatch](struct.UiTextureSlicerBatch.html "struct bevy::ui_render::ui_texture_slice_pipeline::UiTextureSlicerBatch")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [UiTextureSlicerBatch](struct.UiTextureSlicerBatch.html "struct bevy::ui_render::ui_texture_slice_pipeline::UiTextureSlicerBatch")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [UiTextureSlicerBatch](struct.UiTextureSlicerBatch.html "struct bevy::ui_render::ui_texture_slice_pipeline::UiTextureSlicerBatch")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [UiTextureSlicerBatch](struct.UiTextureSlicerBatch.html "struct bevy::ui_render::ui_texture_slice_pipeline::UiTextureSlicerBatch")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [UiTextureSlicerBatch](struct.UiTextureSlicerBatch.html "struct bevy::ui_render::ui_texture_slice_pipeline::UiTextureSlicerBatch")
