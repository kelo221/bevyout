...
# Struct UiTextureSlicePipeline 

[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/ui_texture_slice_pipeline.rs.html#106)
...
`view_layout: [BindGroupLayoutDescriptor](../../material/descriptor/struct.BindGroupLayoutDescriptor.html "struct bevy::material::descriptor::BindGroupLayoutDescriptor")``image_layout: [BindGroupLayoutDescriptor](../../material/descriptor/struct.BindGroupLayoutDescriptor.html "struct bevy::material::descriptor::BindGroupLayoutDescriptor")``shader: [Handle](../../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Shader](../../prelude/struct.Shader.html "struct bevy::prelude::Shader")>`
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [UiTextureSlicePipeline](struct.UiTextureSlicePipeline.html "struct bevy::ui_render::ui_texture_slice_pipeline::UiTextureSlicePipeline")

where [UiTextureSlicePipeline](struct.UiTextureSlicePipeline.html "struct bevy::ui_render::ui_texture_slice_pipeline::UiTextureSlicePipeline"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [UiTextureSlicePipeline](struct.UiTextureSlicePipeline.html "struct bevy::ui_render::ui_texture_slice_pipeline::UiTextureSlicePipeline")
...
### impl [SpecializedRenderPipeline](../../render/render_resource/trait.SpecializedRenderPipeline.html "trait bevy::render::render_resource::SpecializedRenderPipeline") for [UiTextureSlicePipeline](struct.UiTextureSlicePipeline.html "struct bevy::ui_render::ui_texture_slice_pipeline::UiTextureSlicePipeline")
...
#### type [Key](../../render/render_resource/trait.SpecializedRenderPipeline.html#associatedtype.Key) = [UiTextureSlicePipelineKey](struct.UiTextureSlicePipelineKey.html "struct bevy::ui_render::ui_texture_slice_pipeline::UiTextureSlicePipelineKey")

The key that defines each “variant” of the render pipeline.

[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/ui_texture_slice_pipeline.rs.html#147)

#### fn [specialize](../../render/render_resource/trait.SpecializedRenderPipeline.html#tymethod.specialize)( &self, key: <[UiTextureSlicePipeline](struct.UiTextureSlicePipeline.html "struct bevy::ui_render::ui_texture_slice_pipeline::UiTextureSlicePipeline") as [SpecializedRenderPipeline](../../render/render_resource/trait.SpecializedRenderPipeline.html "trait bevy::render::render_resource::SpecializedRenderPipeline")\>::[Key](../../render/render_resource/trait.SpecializedRenderPipeline.html#associatedtype.Key "type bevy::render::render_resource::SpecializedRenderPipeline::Key"), ) -> [RenderPipelineDescriptor](../../material/descriptor/struct.RenderPipelineDescriptor.html "struct bevy::material::descriptor::RenderPipelineDescriptor")

Construct a new render pipeline based on the provided key.

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [UiTextureSlicePipeline](struct.UiTextureSlicePipeline.html "struct bevy::ui_render::ui_texture_slice_pipeline::UiTextureSlicePipeline")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [UiTextureSlicePipeline](struct.UiTextureSlicePipeline.html "struct bevy::ui_render::ui_texture_slice_pipeline::UiTextureSlicePipeline")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [UiTextureSlicePipeline](struct.UiTextureSlicePipeline.html "struct bevy::ui_render::ui_texture_slice_pipeline::UiTextureSlicePipeline")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [UiTextureSlicePipeline](struct.UiTextureSlicePipeline.html "struct bevy::ui_render::ui_texture_slice_pipeline::UiTextureSlicePipeline")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [UiTextureSlicePipeline](struct.UiTextureSlicePipeline.html "struct bevy::ui_render::ui_texture_slice_pipeline::UiTextureSlicePipeline")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [UiTextureSlicePipeline](struct.UiTextureSlicePipeline.html "struct bevy::ui_render::ui_texture_slice_pipeline::UiTextureSlicePipeline")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [UiTextureSlicePipeline](struct.UiTextureSlicePipeline.html "struct bevy::ui_render::ui_texture_slice_pipeline::UiTextureSlicePipeline")
