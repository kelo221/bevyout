...
# Struct UiMaterialBatch 

[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/ui_material_pipeline.rs.html#107)

```rust
pub struct UiMaterialBatch<M>where
    M: UiMaterial,{
    pub range: Range<u32>,
...
The range of vertices inside the [`UiMaterialMeta`](struct.UiMaterialMeta.html "struct bevy::ui_render::UiMaterialMeta")

`material: [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<M>`

## Trait Implementations

[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/ui_material_pipeline.rs.html#106)

### impl<M> [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [UiMaterialBatch](struct.UiMaterialBatch.html "struct bevy::ui_render::UiMaterialBatch")<M>

where M: [UiMaterial](../prelude/trait.UiMaterial.html "trait bevy::prelude::UiMaterial"), [UiMaterialBatch](struct.UiMaterialBatch.html "struct bevy::ui_render::UiMaterialBatch")<M>: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl<M> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [UiMaterialBatch](struct.UiMaterialBatch.html "struct bevy::ui_render::UiMaterialBatch")<M>

### impl<M> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [UiMaterialBatch](struct.UiMaterialBatch.html "struct bevy::ui_render::UiMaterialBatch")<M>

### impl<M> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [UiMaterialBatch](struct.UiMaterialBatch.html "struct bevy::ui_render::UiMaterialBatch")<M>

### impl<M> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [UiMaterialBatch](struct.UiMaterialBatch.html "struct bevy::ui_render::UiMaterialBatch")<M>

### impl<M> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [UiMaterialBatch](struct.UiMaterialBatch.html "struct bevy::ui_render::UiMaterialBatch")<M>

### impl<M> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [UiMaterialBatch](struct.UiMaterialBatch.html "struct bevy::ui_render::UiMaterialBatch")<M>

### impl<M> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [UiMaterialBatch](struct.UiMaterialBatch.html "struct bevy::ui_render::UiMaterialBatch")<M>
