...
# Struct UiMaterialPipeline 

[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/ui_material_pipeline.rs.html#115)

```rust
pub struct UiMaterialPipeline<M>where
    M: UiMaterial,{
...
`ui_layout: [BindGroupLayoutDescriptor](../material/descriptor/struct.BindGroupLayoutDescriptor.html "struct bevy::material::descriptor::BindGroupLayoutDescriptor")``view_layout: [BindGroupLayoutDescriptor](../material/descriptor/struct.BindGroupLayoutDescriptor.html "struct bevy::material::descriptor::BindGroupLayoutDescriptor")``vertex_shader: [Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Shader](../prelude/struct.Shader.html "struct bevy::prelude::Shader")>``fragment_shader: [Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Shader](../prelude/struct.Shader.html "struct bevy::prelude::Shader")>`
...
### impl<M> [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [UiMaterialPipeline](struct.UiMaterialPipeline.html "struct bevy::ui_render::UiMaterialPipeline")<M>

where M: [UiMaterial](../prelude/trait.UiMaterial.html "trait bevy::prelude::UiMaterial"), [UiMaterialPipeline](struct.UiMaterialPipeline.html "struct bevy::ui_render::UiMaterialPipeline")<M>: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl<M> [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [UiMaterialPipeline](struct.UiMaterialPipeline.html "struct bevy::ui_render::UiMaterialPipeline")<M>
...
### impl<M> [SpecializedRenderPipeline](../render/render_resource/trait.SpecializedRenderPipeline.html "trait bevy::render::render_resource::SpecializedRenderPipeline") for [UiMaterialPipeline](struct.UiMaterialPipeline.html "struct bevy::ui_render::UiMaterialPipeline")<M>
...
#### type [Key](../render/render_resource/trait.SpecializedRenderPipeline.html#associatedtype.Key) = [UiMaterialKey](../prelude/struct.UiMaterialKey.html "struct bevy::prelude::UiMaterialKey")<M>

The key that defines each “variant” of the render pipeline.

[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/ui_material_pipeline.rs.html#129)

#### fn [specialize](../render/render_resource/trait.SpecializedRenderPipeline.html#tymethod.specialize)( &self, key: <[UiMaterialPipeline](struct.UiMaterialPipeline.html "struct bevy::ui_render::UiMaterialPipeline")<M> as [SpecializedRenderPipeline](../render/render_resource/trait.SpecializedRenderPipeline.html "trait bevy::render::render_resource::SpecializedRenderPipeline")\>::[Key](../render/render_resource/trait.SpecializedRenderPipeline.html#associatedtype.Key "type bevy::render::render_resource::SpecializedRenderPipeline::Key"), ) -> [RenderPipelineDescriptor](../material/descriptor/struct.RenderPipelineDescriptor.html "struct bevy::material::descriptor::RenderPipelineDescriptor")

Construct a new render pipeline based on the provided key.

## Auto Trait Implementations

### impl<M> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [UiMaterialPipeline](struct.UiMaterialPipeline.html "struct bevy::ui_render::UiMaterialPipeline")<M>

### impl<M> ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [UiMaterialPipeline](struct.UiMaterialPipeline.html "struct bevy::ui_render::UiMaterialPipeline")<M>

### impl<M> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [UiMaterialPipeline](struct.UiMaterialPipeline.html "struct bevy::ui_render::UiMaterialPipeline")<M>

### impl<M> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [UiMaterialPipeline](struct.UiMaterialPipeline.html "struct bevy::ui_render::UiMaterialPipeline")<M>

### impl<M> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [UiMaterialPipeline](struct.UiMaterialPipeline.html "struct bevy::ui_render::UiMaterialPipeline")<M>

### impl<M> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [UiMaterialPipeline](struct.UiMaterialPipeline.html "struct bevy::ui_render::UiMaterialPipeline")<M>

### impl<M> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [UiMaterialPipeline](struct.UiMaterialPipeline.html "struct bevy::ui_render::UiMaterialPipeline")<M>
