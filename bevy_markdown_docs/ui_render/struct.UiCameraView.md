...
[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/lib.rs.html#763)
...
For example, if UI is being rendered to a 3D camera, this component lives on the 3D camera and contains the entity corresponding to the UI view. Entity id of the temporary render entity with the corresponding extracted UI view.
...
[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/lib.rs.html#761)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [UiCameraView](struct.UiCameraView.html "struct bevy::ui_render::UiCameraView")

where [UiCameraView](struct.UiCameraView.html "struct bevy::ui_render::UiCameraView"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [UiCameraView](struct.UiCameraView.html "struct bevy::ui_render::UiCameraView")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [UiCameraView](struct.UiCameraView.html "struct bevy::ui_render::UiCameraView")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [UiCameraView](struct.UiCameraView.html "struct bevy::ui_render::UiCameraView")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [UiCameraView](struct.UiCameraView.html "struct bevy::ui_render::UiCameraView")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [UiCameraView](struct.UiCameraView.html "struct bevy::ui_render::UiCameraView")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [UiCameraView](struct.UiCameraView.html "struct bevy::ui_render::UiCameraView")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [UiCameraView](struct.UiCameraView.html "struct bevy::ui_render::UiCameraView")
