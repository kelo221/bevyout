...
### impl<M> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [UiMaterialPlugin](../../prelude/struct.UiMaterialPlugin.html "struct bevy::prelude::UiMaterialPlugin")<M>
...
#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [UiMaterialPlugin](../../prelude/struct.UiMaterialPlugin.html "struct bevy::prelude::UiMaterialPlugin")<M>
...
### impl<M> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [UiMaterialPlugin](../../prelude/struct.UiMaterialPlugin.html "struct bevy::prelude::UiMaterialPlugin")<M>

### impl<M> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [UiMaterialPlugin](../../prelude/struct.UiMaterialPlugin.html "struct bevy::prelude::UiMaterialPlugin")<M>
...
### impl<M> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [UiMaterialPlugin](../../prelude/struct.UiMaterialPlugin.html "struct bevy::prelude::UiMaterialPlugin")<M>

### impl<M> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [UiMaterialPlugin](../../prelude/struct.UiMaterialPlugin.html "struct bevy::prelude::UiMaterialPlugin")<M>

### impl<M> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [UiMaterialPlugin](../../prelude/struct.UiMaterialPlugin.html "struct bevy::prelude::UiMaterialPlugin")<M>

where M: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<M> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [UiMaterialPlugin](../../prelude/struct.UiMaterialPlugin.html "struct bevy::prelude::UiMaterialPlugin")<M>

### impl<M> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [UiMaterialPlugin](../../prelude/struct.UiMaterialPlugin.html "struct bevy::prelude::UiMaterialPlugin")<M>
