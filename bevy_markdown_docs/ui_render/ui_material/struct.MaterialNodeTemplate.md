...
### impl<M> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [MaterialNodeTemplate](../../prelude/struct.MaterialNodeTemplate.html "struct bevy::prelude::MaterialNodeTemplate")<M>

where M: [UiMaterial](../../prelude/trait.UiMaterial.html "trait bevy::prelude::UiMaterial"),

[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/ui_material.rs.html#167)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [MaterialNodeTemplate](../../prelude/struct.MaterialNodeTemplate.html "struct bevy::prelude::MaterialNodeTemplate")<M>
...
#### type [Output](../../prelude/trait.Template.html#associatedtype.Output) = [MaterialNode](../../prelude/struct.MaterialNode.html "struct bevy::prelude::MaterialNode")<M>

The type of value produced by this [`Template`](../../prelude/trait.Template.html "trait bevy::prelude::Template").

[Source](https://docs.rs/bevy_ui_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_render/ui_material.rs.html#167)

#### fn [build\_template](../../prelude/trait.Template.html#tymethod.build_template)( &self, context: &mut [TemplateContext](../../ecs/template/struct.TemplateContext.html "struct bevy::ecs::template::TemplateContext")<'\_, '\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[MaterialNodeTemplate](../../prelude/struct.MaterialNodeTemplate.html "struct bevy::prelude::MaterialNodeTemplate")<M> as [Template](../../prelude/trait.Template.html "trait bevy::prelude::Template")\>::[Output](../../prelude/trait.Template.html#associatedtype.Output "type bevy::prelude::Template::Output"), [BevyError](../../prelude/struct.BevyError.html "struct bevy::prelude::BevyError")\>
...
#### fn [clone\_template](../../prelude/trait.Template.html#tymethod.clone_template)(&self) -> [MaterialNodeTemplate](../../prelude/struct.MaterialNodeTemplate.html "struct bevy::prelude::MaterialNodeTemplate")<M>

Clones this template. See [`Clone`](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone").

## Auto Trait Implementations

### impl<M> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MaterialNodeTemplate](../../prelude/struct.MaterialNodeTemplate.html "struct bevy::prelude::MaterialNodeTemplate")<M>

### impl<M> ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MaterialNodeTemplate](../../prelude/struct.MaterialNodeTemplate.html "struct bevy::prelude::MaterialNodeTemplate")<M>

### impl<M> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MaterialNodeTemplate](../../prelude/struct.MaterialNodeTemplate.html "struct bevy::prelude::MaterialNodeTemplate")<M>

### impl<M> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MaterialNodeTemplate](../../prelude/struct.MaterialNodeTemplate.html "struct bevy::prelude::MaterialNodeTemplate")<M>

### impl<M> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MaterialNodeTemplate](../../prelude/struct.MaterialNodeTemplate.html "struct bevy::prelude::MaterialNodeTemplate")<M>

### impl<M> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MaterialNodeTemplate](../../prelude/struct.MaterialNodeTemplate.html "struct bevy::prelude::MaterialNodeTemplate")<M>

### impl<M> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MaterialNodeTemplate](../../prelude/struct.MaterialNodeTemplate.html "struct bevy::prelude::MaterialNodeTemplate")<M>
