...
The [`LevelFilter`](tracing/level_filters/struct.LevelFilter.html "struct bevy::log::tracing::level_filters::LevelFilter") type is provided to enable filtering traces by verbosity. `Level`s can be compared against [`LevelFilter`](tracing/level_filters/struct.LevelFilter.html "struct bevy::log::tracing::level_filters::LevelFilter")s, and [`LevelFilter`](tracing/level_filters/struct.LevelFilter.html "struct bevy::log::tracing::level_filters::LevelFilter") has a variant for each `Level`, which compares analogously to that level. In addition, [`LevelFilter`](tracing/level_filters/struct.LevelFilter.html "struct bevy::log::tracing::level_filters::LevelFilter") adds a [`LevelFilter::OFF`](tracing/level_filters/struct.LevelFilter.html#associatedconstant.OFF "associated constant bevy::log::tracing::level_filters::LevelFilter::OFF") variant, which is considered “less verbose” than every other `Level`. This is intended to allow filters to completely disable tracing in a particular context.
...
Below is a simple example of how a [`Subscriber`](tracing/trait.Subscriber.html "trait bevy::log::tracing::Subscriber") could implement filtering through a [`LevelFilter`](tracing/level_filters/struct.LevelFilter.html "struct bevy::log::tracing::level_filters::LevelFilter"). When a span or event is recorded, the [`Subscriber::enabled`](tracing/trait.Subscriber.html#tymethod.enabled "method bevy::log::tracing::Subscriber::enabled") method compares the span or event’s `Level` against the configured [`LevelFilter`](tracing/level_filters/struct.LevelFilter.html "struct bevy::log::tracing::level_filters::LevelFilter"). The optional [`Subscriber::max_level_hint`](tracing/trait.Subscriber.html#method.max_level_hint "method bevy::log::tracing::Subscriber::max_level_hint") method can also be implemented to allow spans and events above a maximum verbosity level to be skipped more efficiently, often improving performance in short-lived programs.
