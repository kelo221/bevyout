...
### impl<'writer> [FormatFields](trait.FormatFields.html "trait bevy::log::tracing_subscriber::fmt::FormatFields")<'writer> for [Pretty](format/struct.Pretty.html "struct bevy::log::tracing_subscriber::fmt::format::Pretty")