...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/writer.rs.html#659)
...
This is used by the [`MakeWriter`](../trait.MakeWriter.html "trait bevy::log::tracing_subscriber::fmt::MakeWriter") implementation for [`Mutex`](../../../../platform/sync/struct.Mutex.html "struct bevy::platform::sync::Mutex"), because [`MutexGuard`](../../../../platform/sync/struct.MutexGuard.html "struct bevy::platform::sync::MutexGuard") itself will not implement [`io::Write`](https://doc.rust-lang.org/nightly/std/io/trait.Write.html "trait std::io::Write") — instead, it _dereferences_ to a type implementing [`io::Write`](https://doc.rust-lang.org/nightly/std/io/trait.Write.html "trait std::io::Write"). Because [`MakeWriter`](../trait.MakeWriter.html "trait bevy::log::tracing_subscriber::fmt::MakeWriter") requires the `Writer` type to implement [`io::Write`](https://doc.rust-lang.org/nightly/std/io/trait.Write.html "trait std::io::Write"), it’s necessary to add a newtype that forwards the trait implementation.

## Trait Implementations

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/writer.rs.html#658)

### impl<'a, W> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [MutexGuardWriter](struct.MutexGuardWriter.html "struct bevy::log::tracing_subscriber::fmt::writer::MutexGuardWriter")<'a, W>

where W: [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug"),
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/writer.rs.html#819-821)

### impl<W> [Write](https://doc.rust-lang.org/nightly/std/io/trait.Write.html "trait std::io::Write") for [MutexGuardWriter](struct.MutexGuardWriter.html "struct bevy::log::tracing_subscriber::fmt::writer::MutexGuardWriter")<'\_, W>

where W: [Write](https://doc.rust-lang.org/nightly/std/io/trait.Write.html "trait std::io::Write"),

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/writer.rs.html#824)
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/writer.rs.html#829)
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/writer.rs.html#834)
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/writer.rs.html#839)
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/writer.rs.html#844)
...
### impl<'a, W> ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MutexGuardWriter](struct.MutexGuardWriter.html "struct bevy::log::tracing_subscriber::fmt::writer::MutexGuardWriter")<'a, W>

### impl<'a, W> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MutexGuardWriter](struct.MutexGuardWriter.html "struct bevy::log::tracing_subscriber::fmt::writer::MutexGuardWriter")<'a, W>

### impl<'a, W> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MutexGuardWriter](struct.MutexGuardWriter.html "struct bevy::log::tracing_subscriber::fmt::writer::MutexGuardWriter")<'a, W>

### impl<'a, W> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MutexGuardWriter](struct.MutexGuardWriter.html "struct bevy::log::tracing_subscriber::fmt::writer::MutexGuardWriter")<'a, W>

where W: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<'a, W> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MutexGuardWriter](struct.MutexGuardWriter.html "struct bevy::log::tracing_subscriber::fmt::writer::MutexGuardWriter")<'a, W>

### impl<'a, W> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MutexGuardWriter](struct.MutexGuardWriter.html "struct bevy::log::tracing_subscriber::fmt::writer::MutexGuardWriter")<'a, W>

### impl<'a, W> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MutexGuardWriter](struct.MutexGuardWriter.html "struct bevy::log::tracing_subscriber::fmt::writer::MutexGuardWriter")<'a, W>
