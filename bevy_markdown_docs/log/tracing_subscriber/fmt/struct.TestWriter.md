...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/writer.rs.html#516)

```rust
pub struct TestWriter { /* private fields */ }
```
...
`TestWriter` is used by [`fmt::Subscriber`](../struct.FmtSubscriber.html "struct bevy::log::tracing_subscriber::FmtSubscriber") or [`fmt::Layer`](struct.Layer.html "struct bevy::log::tracing_subscriber::fmt::Layer") to enable capturing support.

`cargo test` can only capture output from the standard library’s [`print!`](https://doc.rust-lang.org/nightly/std/macro.print.html "macro std::print") and [`eprint!`](https://doc.rust-lang.org/nightly/std/macro.eprint.html "macro std::eprint") macros. See [`libtest`’s output capturing](https://doc.rust-lang.org/book/ch11-02-running-tests.html#showing-function-output) and [rust-lang/rust#90785](https://github.com/rust-lang/rust/issues/90785) for more details about output capturing.

Writing to [`io::stdout`](https://doc.rust-lang.org/nightly/std/io/stdio/fn.stdout.html "fn std::io::stdio::stdout") and [`io::stderr`](https://doc.rust-lang.org/nightly/std/io/stdio/fn.stderr.html "fn std::io::stdio::stderr") produces the same results as using [`libtest`’s `--nocapture` option](https://doc.rust-lang.org/cargo/commands/cargo-test.html) which may make the results look unreadable.

## Implementations

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/writer.rs.html#713)

### impl [TestWriter](struct.TestWriter.html "struct bevy::log::tracing_subscriber::fmt::TestWriter")

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/writer.rs.html#715)

#### pub fn [new](#method.new)() -> [TestWriter](struct.TestWriter.html "struct bevy::log::tracing_subscriber::fmt::TestWriter") [ⓘ](#)

Returns a new `TestWriter` with the default configuration.

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/writer.rs.html#720)

#### pub fn [with\_stderr](#method.with_stderr)() -> [TestWriter](struct.TestWriter.html "struct bevy::log::tracing_subscriber::fmt::TestWriter") [ⓘ](#)

Returns a new `TestWriter` that writes to `stderr` instead of `stdout`.

## Trait Implementations

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/writer.rs.html#515)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [TestWriter](struct.TestWriter.html "struct bevy::log::tracing_subscriber::fmt::TestWriter")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [TestWriter](struct.TestWriter.html "struct bevy::log::tracing_subscriber::fmt::TestWriter")

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/writer.rs.html#515)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [TestWriter](struct.TestWriter.html "struct bevy::log::tracing_subscriber::fmt::TestWriter") [ⓘ](#)
...
#### type [Writer](trait.MakeWriter.html#associatedtype.Writer) = [TestWriter](struct.TestWriter.html "struct bevy::log::tracing_subscriber::fmt::TestWriter")
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/writer.rs.html#744)

#### fn [make\_writer](trait.MakeWriter.html#tymethod.make_writer)(&'a self) -> <[TestWriter](struct.TestWriter.html "struct bevy::log::tracing_subscriber::fmt::TestWriter") as [MakeWriter](trait.MakeWriter.html "trait bevy::log::tracing_subscriber::fmt::MakeWriter")<'a>>::[Writer](trait.MakeWriter.html#associatedtype.Writer "type bevy::log::tracing_subscriber::fmt::MakeWriter::Writer") [ⓘ](#)
...
#### fn [make\_writer\_for](trait.MakeWriter.html#method.make_writer_for)(&'a self, meta: &[Metadata](../../tracing/struct.Metadata.html "struct bevy::log::tracing::Metadata")<'\_>) -> Self::[Writer](trait.MakeWriter.html#associatedtype.Writer "type bevy::log::tracing_subscriber::fmt::MakeWriter::Writer")
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/writer.rs.html#725)

### impl [Write](https://doc.rust-lang.org/nightly/std/io/trait.Write.html "trait std::io::Write") for [TestWriter](struct.TestWriter.html "struct bevy::log::tracing_subscriber::fmt::TestWriter")

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/writer.rs.html#726)
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/writer.rs.html#736)
...
1.36.0 · [Source](https://doc.rust-lang.org/nightly/src/std/io/mod.rs.html#1531)
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TestWriter](struct.TestWriter.html "struct bevy::log::tracing_subscriber::fmt::TestWriter")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TestWriter](struct.TestWriter.html "struct bevy::log::tracing_subscriber::fmt::TestWriter")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TestWriter](struct.TestWriter.html "struct bevy::log::tracing_subscriber::fmt::TestWriter")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TestWriter](struct.TestWriter.html "struct bevy::log::tracing_subscriber::fmt::TestWriter")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TestWriter](struct.TestWriter.html "struct bevy::log::tracing_subscriber::fmt::TestWriter")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TestWriter](struct.TestWriter.html "struct bevy::log::tracing_subscriber::fmt::TestWriter")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TestWriter](struct.TestWriter.html "struct bevy::log::tracing_subscriber::fmt::TestWriter")
...
#### fn [with\_max\_level](../prelude/trait._.html#method.with_max_level)(self, level: [Level](../../struct.Level.html "struct bevy::log::Level")) -> [WithMaxLevel](writer/struct.WithMaxLevel.html "struct bevy::log::tracing_subscriber::fmt::writer::WithMaxLevel")<Self>
...
#### fn [with\_min\_level](../prelude/trait._.html#method.with_min_level)(self, level: [Level](../../struct.Level.html "struct bevy::log::Level")) -> [WithMinLevel](writer/struct.WithMinLevel.html "struct bevy::log::tracing_subscriber::fmt::writer::WithMinLevel")<Self>
...
#### fn [with\_filter](../prelude/trait._.html#method.with_filter)<F>(self, filter: F) -> [WithFilter](writer/struct.WithFilter.html "struct bevy::log::tracing_subscriber::fmt::writer::WithFilter")<Self, F>
...
#### fn [and](../prelude/trait._.html#method.and)<B>(self, other: B) -> [Tee](writer/struct.Tee.html "struct bevy::log::tracing_subscriber::fmt::writer::Tee")<Self, B> [ⓘ](#)
