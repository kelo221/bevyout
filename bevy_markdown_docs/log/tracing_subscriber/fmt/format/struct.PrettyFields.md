...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/pretty.rs.html#119)
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/pretty.rs.html#365)

### impl [PrettyFields](struct.PrettyFields.html "struct bevy::log::tracing_subscriber::fmt::format::PrettyFields")

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/pretty.rs.html#367)

#### pub fn [new](#method.new)() -> [PrettyFields](struct.PrettyFields.html "struct bevy::log::tracing_subscriber::fmt::format::PrettyFields")

Returns a new default [`PrettyFields`](struct.PrettyFields.html "struct bevy::log::tracing_subscriber::fmt::format::PrettyFields") implementation.

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/pretty.rs.html#379)

#### pub fn [with\_ansi](#method.with_ansi)(self, ansi: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)) -> [PrettyFields](struct.PrettyFields.html "struct bevy::log::tracing_subscriber::fmt::format::PrettyFields")

👎Deprecated since 0.3.3:

Use `fmt::Subscriber::with_ansi` or `fmt::Layer::with_ansi` instead.

Enable ANSI encoding for formatted fields.

## Trait Implementations

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/pretty.rs.html#118)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [PrettyFields](struct.PrettyFields.html "struct bevy::log::tracing_subscriber::fmt::format::PrettyFields")
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/pretty.rs.html#359)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [PrettyFields](struct.PrettyFields.html "struct bevy::log::tracing_subscriber::fmt::format::PrettyFields")

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/pretty.rs.html#360)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [PrettyFields](struct.PrettyFields.html "struct bevy::log::tracing_subscriber::fmt::format::PrettyFields")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [PrettyFields](struct.PrettyFields.html "struct bevy::log::tracing_subscriber::fmt::format::PrettyFields")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [PrettyFields](struct.PrettyFields.html "struct bevy::log::tracing_subscriber::fmt::format::PrettyFields")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [PrettyFields](struct.PrettyFields.html "struct bevy::log::tracing_subscriber::fmt::format::PrettyFields")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [PrettyFields](struct.PrettyFields.html "struct bevy::log::tracing_subscriber::fmt::format::PrettyFields")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [PrettyFields](struct.PrettyFields.html "struct bevy::log::tracing_subscriber::fmt::format::PrettyFields")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [PrettyFields](struct.PrettyFields.html "struct bevy::log::tracing_subscriber::fmt::format::PrettyFields")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [PrettyFields](struct.PrettyFields.html "struct bevy::log::tracing_subscriber::fmt::format::PrettyFields")
...
#### fn [debug\_alt](../../field/trait.MakeExt.html#method.debug_alt)(self) -> [Alt](../../field/debug/struct.Alt.html "struct bevy::log::tracing_subscriber::field::debug::Alt")<Self>
...
#### fn [display\_messages](../../field/trait.MakeExt.html#method.display_messages)(self) -> [Messages](../../field/display/struct.Messages.html "struct bevy::log::tracing_subscriber::field::display::Messages")<Self>
...
#### fn [delimited](../../field/trait.MakeExt.html#method.delimited)<D>(self, delimiter: D) -> [Delimited](../../field/delimited/struct.Delimited.html "struct bevy::log::tracing_subscriber::field::delimited::Delimited")<D, Self>
