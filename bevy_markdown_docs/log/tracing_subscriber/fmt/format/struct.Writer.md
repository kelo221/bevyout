...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/mod.rs.html#309)
...
This type is provided as input to the [`FormatEvent::format_event`](../trait.FormatEvent.html#tymethod.format_event "method bevy::log::tracing_subscriber::fmt::FormatEvent::format_event") and [`FormatFields::format_fields`](../trait.FormatFields.html#tymethod.format_fields "method bevy::log::tracing_subscriber::fmt::FormatFields::format_fields") methods, which will write formatted representations of [`Event`](../../../tracing/struct.Event.html "struct bevy::log::tracing::Event")s and [fields](https://docs.rs/tracing-core/0.1.36/x86_64-unknown-linux-gnu/tracing_core/field/index.html "mod tracing_core::field") to the [`Writer`](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer").

This type implements the [`std::fmt::Write`](https://doc.rust-lang.org/nightly/core/fmt/trait.Write.html "trait core::fmt::Write") trait, allowing it to be used with any function that takes an instance of [`std::fmt::Write`](https://doc.rust-lang.org/nightly/core/fmt/trait.Write.html "trait core::fmt::Write"). Additionally, it can be used with the standard library’s [`std::write!`](https://doc.rust-lang.org/nightly/core/macro.write.html "macro core::write") and [`std::writeln!`](https://doc.rust-lang.org/nightly/core/macro.writeln.html "macro core::writeln") macros.

Additionally, a [`Writer`](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer") may expose additional [`tracing`](../../../tracing/index.html "mod bevy::log::tracing")\-specific information to the formatter implementation.

## Implementations

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/mod.rs.html#422)

### impl<'writer> [Writer](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")<'writer>

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/mod.rs.html#441)

#### pub fn [new](#method.new)(writer: &'writer mut impl [Write](https://doc.rust-lang.org/nightly/core/fmt/trait.Write.html "trait core::fmt::Write")) -> [Writer](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")<'writer>

Create a new [`Writer`](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer") from any type that implements [`fmt::Write`](https://doc.rust-lang.org/nightly/core/fmt/trait.Write.html "trait core::fmt::Write").

The returned `Writer` value may be passed as an argument to methods such as [`Format::format_event`](struct.Format.html#method.format_event "method bevy::log::tracing_subscriber::fmt::format::Format::format_event"). Since constructing a [`Writer`](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer") mutably borrows the underlying [`fmt::Write`](https://doc.rust-lang.org/nightly/core/fmt/trait.Write.html "trait core::fmt::Write") instance, that value may be accessed again once the [`Writer`](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer") is dropped. For example, if the value implementing [`fmt::Write`](https://doc.rust-lang.org/nightly/core/fmt/trait.Write.html "trait core::fmt::Write") is a [`String`](../../../../prelude/struct.String.html "struct bevy::prelude::String"), it will contain the formatted output of [`Format::format_event`](struct.Format.html#method.format_event "method bevy::log::tracing_subscriber::fmt::format::Format::format_event"), which may then be used for other purposes.

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/mod.rs.html#466)

#### pub fn [by\_ref](#method.by_ref)(&mut self) -> [Writer](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")<'\_>

Return a new [`Writer`](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer") that mutably borrows [`self`](index.html "mod bevy::log::tracing_subscriber::fmt::format").

This can be used to temporarily borrow a [`Writer`](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer") to pass a new [`Writer`](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer") to a function that takes a [`Writer`](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer") by value, allowing the original writer to still be used once that function returns.

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/mod.rs.html#493)

#### pub fn [write\_str](#method.write_str)(&mut self, s: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")\>

Writes a string slice into this [`Writer`](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer"), returning whether the write succeeded.
...
This is identical to calling the [`write_str` method](https://doc.rust-lang.org/nightly/core/fmt/trait.Write.html#tymethod.write_str "method core::fmt::Write::write_str") from the [`Writer`](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")’s [`std::fmt::Write`](https://doc.rust-lang.org/nightly/core/fmt/trait.Write.html "trait core::fmt::Write") implementation. However, it is also provided as an inherent method, so that [`Writer`](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")s can be used without needing to import the [`std::fmt::Write`](https://doc.rust-lang.org/nightly/core/fmt/trait.Write.html "trait core::fmt::Write") trait.

##### Errors

This function will return an instance of [`std::fmt::Error`](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error") on error.

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/mod.rs.html#515)

#### pub fn [write\_char](#method.write_char)(&mut self, c: [char](https://doc.rust-lang.org/nightly/std/primitive.char.html)) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")\>

Writes a [`char`](https://doc.rust-lang.org/nightly/std/primitive.char.html "primitive char") into this writer, returning whether the write succeeded.

A single [`char`](https://doc.rust-lang.org/nightly/std/primitive.char.html "primitive char") may be encoded as more than one byte. This method can only succeed if the entire byte sequence was successfully written, and this method will not return until all data has been written or an error occurs.

This is identical to calling the [`write_char` method](https://doc.rust-lang.org/nightly/core/fmt/trait.Write.html#method.write_char "method core::fmt::Write::write_char") from the [`Writer`](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")’s [`std::fmt::Write`](https://doc.rust-lang.org/nightly/core/fmt/trait.Write.html "trait core::fmt::Write") implementation. However, it is also provided as an inherent method, so that [`Writer`](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")s can be used without needing to import the [`std::fmt::Write`](https://doc.rust-lang.org/nightly/core/fmt/trait.Write.html "trait core::fmt::Write") trait.

##### Errors

This function will return an instance of [`std::fmt::Error`](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error") on error.

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/mod.rs.html#531)

#### pub fn [write\_fmt](#method.write_fmt)(&mut self, args: [Arguments](https://doc.rust-lang.org/nightly/core/fmt/struct.Arguments.html "struct core::fmt::Arguments")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")\>

Glue for usage of the [`write!`](https://doc.rust-lang.org/nightly/core/macro.write.html "macro core::write") macro with [`Writer`](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")s.

This method should generally not be invoked manually, but rather through the [`write!`](https://doc.rust-lang.org/nightly/core/macro.write.html "macro core::write") macro itself.

This is identical to calling the [`write_fmt` method](https://doc.rust-lang.org/nightly/core/fmt/trait.Write.html#method.write_fmt "method core::fmt::Write::write_fmt") from the [`Writer`](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")’s [`std::fmt::Write`](https://doc.rust-lang.org/nightly/core/fmt/trait.Write.html "trait core::fmt::Write") implementation. However, it is also provided as an inherent method, so that [`Writer`](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")s can be used with the [`write!`](https://doc.rust-lang.org/nightly/core/macro.write.html "macro core::write") macro without needing to import the [`std::fmt::Write`](https://doc.rust-lang.org/nightly/core/fmt/trait.Write.html "trait core::fmt::Write") trait.

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/mod.rs.html#541)

#### pub fn [has\_ansi\_escapes](#method.has_ansi_escapes)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if [ANSI escape codes](https://en.wikipedia.org/wiki/ANSI_escape_code) may be used to add colors and other formatting when writing to this `Writer`.

If this returns `false`, formatters should not emit ANSI escape codes.

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/mod.rs.html#546)

#### pub fn [sanitizes\_ansi\_escapes](#method.sanitizes_ansi_escapes)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns `true` if ANSI escape codes should be sanitized.

## Trait Implementations

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/mod.rs.html#601)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Writer](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")<'\_>

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/mod.rs.html#602)
...
### impl<'a> [MakeVisitor](../../field/trait.MakeVisitor.html "trait bevy::log::tracing_subscriber::field::MakeVisitor")<[Writer](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")<'a>> for [PrettyFields](struct.PrettyFields.html "struct bevy::log::tracing_subscriber::fmt::format::PrettyFields")
...
#### type [Visitor](../../field/trait.MakeVisitor.html#associatedtype.Visitor) = [PrettyVisitor](struct.PrettyVisitor.html "struct bevy::log::tracing_subscriber::fmt::format::PrettyVisitor")<'a>

The visitor type produced by this `MakeVisitor`.

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/pretty.rs.html#391)

#### fn [make\_visitor](../../field/trait.MakeVisitor.html#tymethod.make_visitor)( &self, target: [Writer](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")<'a>, ) -> <[PrettyFields](struct.PrettyFields.html "struct bevy::log::tracing_subscriber::fmt::format::PrettyFields") as [MakeVisitor](../../field/trait.MakeVisitor.html "trait bevy::log::tracing_subscriber::field::MakeVisitor")<[Writer](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")<'a>>>::[Visitor](../../field/trait.MakeVisitor.html#associatedtype.Visitor "type bevy::log::tracing_subscriber::field::MakeVisitor::Visitor")
...
### impl<'a> [MakeVisitor](../../field/trait.MakeVisitor.html "trait bevy::log::tracing_subscriber::field::MakeVisitor")<[Writer](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")<'a>> for [DefaultFields](struct.DefaultFields.html "struct bevy::log::tracing_subscriber::fmt::format::DefaultFields")
...
#### type [Visitor](../../field/trait.MakeVisitor.html#associatedtype.Visitor) = [DefaultVisitor](struct.DefaultVisitor.html "struct bevy::log::tracing_subscriber::fmt::format::DefaultVisitor")<'a>

The visitor type produced by this `MakeVisitor`.

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/mod.rs.html#1232)

#### fn [make\_visitor](../../field/trait.MakeVisitor.html#tymethod.make_visitor)( &self, target: [Writer](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")<'a>, ) -> <[DefaultFields](struct.DefaultFields.html "struct bevy::log::tracing_subscriber::fmt::format::DefaultFields") as [MakeVisitor](../../field/trait.MakeVisitor.html "trait bevy::log::tracing_subscriber::field::MakeVisitor")<[Writer](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")<'a>>>::[Visitor](../../field/trait.MakeVisitor.html#associatedtype.Visitor "type bevy::log::tracing_subscriber::field::MakeVisitor::Visitor")
...
### impl<'a, F> [MakeVisitor](../../field/trait.MakeVisitor.html "trait bevy::log::tracing_subscriber::field::MakeVisitor")<[Writer](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")<'a>> for [FieldFn](struct.FieldFn.html "struct bevy::log::tracing_subscriber::fmt::format::FieldFn")<F>

where F: [Fn](https://doc.rust-lang.org/nightly/core/ops/function/trait.Fn.html "trait core::ops::function::Fn")(&mut [Writer](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")<'a>, &[Field](../../../tracing/field/struct.Field.html "struct bevy::log::tracing::field::Field"), &dyn [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug")) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")\> + [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),
...
#### type [Visitor](../../field/trait.MakeVisitor.html#associatedtype.Visitor) = [FieldFnVisitor](struct.FieldFnVisitor.html "struct bevy::log::tracing_subscriber::fmt::format::FieldFnVisitor")<'a, F>

The visitor type produced by this `MakeVisitor`.

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/mod.rs.html#1588)

#### fn [make\_visitor](../../field/trait.MakeVisitor.html#tymethod.make_visitor)( &self, writer: [Writer](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")<'a>, ) -> <[FieldFn](struct.FieldFn.html "struct bevy::log::tracing_subscriber::fmt::format::FieldFn")<F> as [MakeVisitor](../../field/trait.MakeVisitor.html "trait bevy::log::tracing_subscriber::field::MakeVisitor")<[Writer](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")<'a>>>::[Visitor](../../field/trait.MakeVisitor.html#associatedtype.Visitor "type bevy::log::tracing_subscriber::field::MakeVisitor::Visitor")

Make a new visitor for the provided `target`.

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/mod.rs.html#584)

### impl [Write](https://doc.rust-lang.org/nightly/core/fmt/trait.Write.html "trait core::fmt::Write") for [Writer](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")<'\_>

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/mod.rs.html#586)
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/mod.rs.html#591)
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/format/mod.rs.html#596)
...
### impl<'writer> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Writer](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")<'writer>

### impl<'writer> ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Writer](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")<'writer>

### impl<'writer> ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Writer](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")<'writer>

### impl<'writer> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Writer](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")<'writer>

### impl<'writer> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Writer](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")<'writer>

### impl<'writer> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Writer](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")<'writer>

### impl<'writer> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Writer](struct.Writer.html "struct bevy::log::tracing_subscriber::fmt::format::Writer")<'writer>
