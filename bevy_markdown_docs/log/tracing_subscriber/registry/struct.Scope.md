...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/registry/mod.rs.html#220)

```rust
pub struct Scope<'a, R> { /* private fields */ }
```

An iterator over the parents of a span, ordered from leaf to root.

This is returned by the [`SpanRef::scope`](struct.SpanRef.html#method.scope "method bevy::log::tracing_subscriber::registry::SpanRef::scope") method.

## Implementations

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/registry/mod.rs.html#252-254)

### impl<'a, R> [Scope](struct.Scope.html "struct bevy::log::tracing_subscriber::registry::Scope")<'a, R>

where R: [LookupSpan](trait.LookupSpan.html "trait bevy::log::tracing_subscriber::registry::LookupSpan")<'a>,

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/registry/mod.rs.html#267)

#### pub fn [from\_root](#method.from_root)(self) -> [ScopeFromRoot](struct.ScopeFromRoot.html "struct bevy::log::tracing_subscriber::registry::ScopeFromRoot")<'a, R> [ⓘ](#)

Available on **crate features `alloc` or `std`** only.

Flips the order of the iterator, so that it is ordered from root to leaf.

The iterator will first return the root span, then that span’s immediate child, and so on until it finally returns the span that [`SpanRef::scope`](struct.SpanRef.html#method.scope "method bevy::log::tracing_subscriber::registry::SpanRef::scope") was called on.

If any items were consumed from the [`Scope`](struct.Scope.html "struct bevy::log::tracing_subscriber::registry::Scope") before calling this method then they will _not_ be returned from the [`ScopeFromRoot`](struct.ScopeFromRoot.html "struct bevy::log::tracing_subscriber::registry::ScopeFromRoot").

**Note**: this will allocate if there are many spans remaining, or if the “smallvec” feature flag is not enabled.

## Trait Implementations

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/registry/mod.rs.html#219)

### impl<'a, R> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Scope](struct.Scope.html "struct bevy::log::tracing_subscriber::registry::Scope")<'a, R>
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/registry/mod.rs.html#305-307)

### impl<'a, R> [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator") for [Scope](struct.Scope.html "struct bevy::log::tracing_subscriber::registry::Scope")<'a, R>

where R: [LookupSpan](trait.LookupSpan.html "trait bevy::log::tracing_subscriber::registry::LookupSpan")<'a>,

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/registry/mod.rs.html#309)

#### type [Item](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#associatedtype.Item) = [SpanRef](struct.SpanRef.html "struct bevy::log::tracing_subscriber::registry::SpanRef")<'a, R>

The type of the elements being iterated over.

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/registry/mod.rs.html#311)

#### fn [next](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#tymethod.next)(&mut self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[Scope](struct.Scope.html "struct bevy::log::tracing_subscriber::registry::Scope")<'a, R> as [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")\>::[Item](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#associatedtype.Item "type core::iter::traits::iterator::Iterator::Item")\>
...
### impl<'a, R> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Scope](struct.Scope.html "struct bevy::log::tracing_subscriber::registry::Scope")<'a, R>

### impl<'a, R> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Scope](struct.Scope.html "struct bevy::log::tracing_subscriber::registry::Scope")<'a, R>
...
### impl<'a, R> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Scope](struct.Scope.html "struct bevy::log::tracing_subscriber::registry::Scope")<'a, R>

where R: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<'a, R> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Scope](struct.Scope.html "struct bevy::log::tracing_subscriber::registry::Scope")<'a, R>

where R: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<'a, R> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Scope](struct.Scope.html "struct bevy::log::tracing_subscriber::registry::Scope")<'a, R>

### impl<'a, R> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Scope](struct.Scope.html "struct bevy::log::tracing_subscriber::registry::Scope")<'a, R>

### impl<'a, R> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Scope](struct.Scope.html "struct bevy::log::tracing_subscriber::registry::Scope")<'a, R>
