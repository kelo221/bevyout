...
#### pub fn [iter](#method.iter)(&self) -> [Iter](struct.Iter.html "struct bevy::log::tracing_subscriber::filter::targets::Iter")<'\_> [ⓘ](#)
...
#### type [IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter) = [IntoIter](struct.IntoIter.html "struct bevy::log::tracing_subscriber::filter::targets::IntoIter")
...
#### type [IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter) = [Iter](struct.Iter.html "struct bevy::log::tracing_subscriber::filter::targets::Iter")<'a>
