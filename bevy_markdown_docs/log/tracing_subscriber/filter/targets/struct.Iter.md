[bevy](../../../../index.html)::[log](../../../index.html)::[tracing\_subscriber](../../index.html)::[filter](../index.html)::[targets](index.html)

# Struct Iter 

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/filter/targets.rs.html#565)
...
This struct is created by [`iter`](../struct.Targets.html#method.iter "method bevy::log::tracing_subscriber::filter::Targets::iter") method of [`Targets`](../struct.Targets.html "struct bevy::log::tracing_subscriber::filter::Targets"), or from the `IntoIterator` implementation for `&Targets`.

## Trait Implementations

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/filter/targets.rs.html#564)

### impl<'a> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Iter](struct.Iter.html "struct bevy::log::tracing_subscriber::filter::targets::Iter")<'a>
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/filter/targets.rs.html#583)

### impl<'a> [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator") for [Iter](struct.Iter.html "struct bevy::log::tracing_subscriber::filter::targets::Iter")<'a>

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/filter/targets.rs.html#584)

#### type [Item](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#associatedtype.Item) = (&'a [str](https://doc.rust-lang.org/nightly/std/primitive.str.html), [LevelFilter](../../../tracing/level_filters/struct.LevelFilter.html "struct bevy::log::tracing::level_filters::LevelFilter"))

The type of the elements being iterated over.

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/filter/targets.rs.html#586)

#### fn [next](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#tymethod.next)(&mut self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[Iter](struct.Iter.html "struct bevy::log::tracing_subscriber::filter::targets::Iter")<'a> as [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")\>::[Item](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#associatedtype.Item "type core::iter::traits::iterator::Iterator::Item")\>
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/filter/targets.rs.html#590)
...
### impl<'a> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Iter](struct.Iter.html "struct bevy::log::tracing_subscriber::filter::targets::Iter")<'a>

### impl<'a> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Iter](struct.Iter.html "struct bevy::log::tracing_subscriber::filter::targets::Iter")<'a>

### impl<'a> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Iter](struct.Iter.html "struct bevy::log::tracing_subscriber::filter::targets::Iter")<'a>

### impl<'a> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Iter](struct.Iter.html "struct bevy::log::tracing_subscriber::filter::targets::Iter")<'a>

### impl<'a> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Iter](struct.Iter.html "struct bevy::log::tracing_subscriber::filter::targets::Iter")<'a>

### impl<'a> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Iter](struct.Iter.html "struct bevy::log::tracing_subscriber::filter::targets::Iter")<'a>

### impl<'a> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Iter](struct.Iter.html "struct bevy::log::tracing_subscriber::filter::targets::Iter")<'a>
