...
The [`Targets`](struct.Targets.html "struct bevy::log::tracing_subscriber::filter::Targets") type implements a similar form of filtering, but without the ability to dynamically enable events based on the current span context, and without filtering on field values. When these features are not required, [`Targets`](struct.Targets.html "struct bevy::log::tracing_subscriber::filter::Targets") provides a lighter-weight alternative to [`EnvFilter`](../struct.EnvFilter.html "struct bevy::log::tracing_subscriber::EnvFilter").
...
**Note**: When filters are constructed from potentially untrusted inputs, [disabling regular expression matching](struct.Builder.html#method.with_regex "method bevy::log::tracing_subscriber::filter::Builder::with_regex") is strongly recommended.
...
#### pub fn [builder](#method.builder)() -> [Builder](struct.Builder.html "struct bevy::log::tracing_subscriber::filter::Builder")
...
The [`Builder`](struct.Builder.html "struct bevy::log::tracing_subscriber::filter::Builder") type is used to set additional configurations, such as [whether regular expressions are enabled](struct.Builder.html#method.with_regex "method bevy::log::tracing_subscriber::filter::Builder::with_regex") or [the default directive](struct.Builder.html#method.with_default_directive "method bevy::log::tracing_subscriber::filter::Builder::with_default_directive") before parsing an [`EnvFilter`](../struct.EnvFilter.html "struct bevy::log::tracing_subscriber::EnvFilter") from a string or environment variable.
...
To set additional configuration options prior to parsing the filter, use the [`Builder`](struct.Builder.html "struct bevy::log::tracing_subscriber::filter::Builder") type instead.
...
#### pub fn [try\_new](#method.try_new)<S>(dirs: S) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[EnvFilter](../struct.EnvFilter.html "struct bevy::log::tracing_subscriber::EnvFilter"), [ParseError](struct.ParseError.html "struct bevy::log::tracing_subscriber::filter::ParseError")\>
...
#### pub fn [try\_from\_default\_env](#method.try_from_default_env)() -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[EnvFilter](../struct.EnvFilter.html "struct bevy::log::tracing_subscriber::EnvFilter"), [FromEnvError](struct.FromEnvError.html "struct bevy::log::tracing_subscriber::filter::FromEnvError")\>
...
#### pub fn [try\_from\_env](#method.try_from_env)<A>(env: A) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[EnvFilter](../struct.EnvFilter.html "struct bevy::log::tracing_subscriber::EnvFilter"), [FromEnvError](struct.FromEnvError.html "struct bevy::log::tracing_subscriber::filter::FromEnvError")\>
...
#### pub fn [add\_directive](#method.add_directive)(self, directive: [Directive](struct.Directive.html "struct bevy::log::tracing_subscriber::filter::Directive")) -> [EnvFilter](../struct.EnvFilter.html "struct bevy::log::tracing_subscriber::EnvFilter")
