...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ParseLevelFilterError](../../tracing/level_filters/struct.ParseLevelFilterError.html "struct bevy::log::tracing::level_filters::ParseLevelFilterError")

[Source](https://docs.rs/tracing-core/0.1.36/x86_64-unknown-linux-gnu/src/tracing_core/metadata.rs.html#242)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ParseLevelFilterError](../../tracing/level_filters/struct.ParseLevelFilterError.html "struct bevy::log::tracing::level_filters::ParseLevelFilterError")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ParseLevelFilterError](../../tracing/level_filters/struct.ParseLevelFilterError.html "struct bevy::log::tracing::level_filters::ParseLevelFilterError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [ParseLevelFilterError](../../tracing/level_filters/struct.ParseLevelFilterError.html "struct bevy::log::tracing::level_filters::ParseLevelFilterError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [ParseLevelFilterError](../../tracing/level_filters/struct.ParseLevelFilterError.html "struct bevy::log::tracing::level_filters::ParseLevelFilterError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ParseLevelFilterError](../../tracing/level_filters/struct.ParseLevelFilterError.html "struct bevy::log::tracing::level_filters::ParseLevelFilterError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ParseLevelFilterError](../../tracing/level_filters/struct.ParseLevelFilterError.html "struct bevy::log::tracing::level_filters::ParseLevelFilterError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ParseLevelFilterError](../../tracing/level_filters/struct.ParseLevelFilterError.html "struct bevy::log::tracing::level_filters::ParseLevelFilterError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ParseLevelFilterError](../../tracing/level_filters/struct.ParseLevelFilterError.html "struct bevy::log::tracing::level_filters::ParseLevelFilterError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ParseLevelFilterError](../../tracing/level_filters/struct.ParseLevelFilterError.html "struct bevy::log::tracing::level_filters::ParseLevelFilterError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ParseLevelFilterError](../../tracing/level_filters/struct.ParseLevelFilterError.html "struct bevy::log::tracing::level_filters::ParseLevelFilterError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ParseLevelFilterError](../../tracing/level_filters/struct.ParseLevelFilterError.html "struct bevy::log::tracing::level_filters::ParseLevelFilterError")
