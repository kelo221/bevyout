...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/filter/filter_fn.rs.html#46-51)

```rust
pub struct DynFilterFn<S, F = fn(&Metadata<'_>, &Context<'_, S>) -> bool, R = fn(&'static Metadata<'static>) -> Interest> { /* private fields */ }
```
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/filter/filter_fn.rs.html#362-364)

### impl<S, F> [DynFilterFn](struct.DynFilterFn.html "struct bevy::log::tracing_subscriber::filter::DynFilterFn")<S, F>
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/filter/filter_fn.rs.html#424)

#### pub fn [new](#method.new)(enabled: F) -> [DynFilterFn](struct.DynFilterFn.html "struct bevy::log::tracing_subscriber::filter::DynFilterFn")<S, F>

Constructs a [`Filter`](../layer/trait.Filter.html "trait bevy::log::tracing_subscriber::layer::Filter") from a function or closure that returns `true` if a span or event should be enabled in the current [span context](../layer/struct.Context.html "struct bevy::log::tracing_subscriber::layer::Context").

Unlike [`FilterFn`](struct.FilterFn.html "struct bevy::log::tracing_subscriber::filter::FilterFn"), a `DynFilterFn` is constructed from a closure or function pointer that takes both the [`Metadata`](../../tracing/struct.Metadata.html "struct bevy::log::tracing::Metadata") for a span or event _and_ the current [`Context`](../layer/struct.Context.html "struct bevy::log::tracing_subscriber::layer::Context"). This means that a [`DynFilterFn`](struct.DynFilterFn.html "struct bevy::log::tracing_subscriber::filter::DynFilterFn") can choose whether to enable spans or events based on information about the _current_ span (or its parents).

If this is _not_ necessary, use [`FilterFn`](struct.FilterFn.html "struct bevy::log::tracing_subscriber::filter::FilterFn") instead.

See the [documentation on per-layer filtering](../layer/index.html#per-layer-filtering "mod bevy::log::tracing_subscriber::layer") for details on using [`Filter`](../layer/trait.Filter.html "trait bevy::log::tracing_subscriber::layer::Filter")s.
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/filter/filter_fn.rs.html#434-436)

### impl<S, F, R> [DynFilterFn](struct.DynFilterFn.html "struct bevy::log::tracing_subscriber::filter::DynFilterFn")<S, F, R>

where F: [Fn](https://doc.rust-lang.org/nightly/core/ops/function/trait.Fn.html "trait core::ops::function::Fn")(&[Metadata](../../tracing/struct.Metadata.html "struct bevy::log::tracing::Metadata")<'\_>, &[Context](../layer/struct.Context.html "struct bevy::log::tracing_subscriber::layer::Context")<'\_, S>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html),

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/filter/filter_fn.rs.html#489)

#### pub fn [with\_max\_level\_hint](#method.with_max_level_hint)( self, max\_level\_hint: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[LevelFilter](../../tracing/level_filters/struct.LevelFilter.html "struct bevy::log::tracing::level_filters::LevelFilter")\>, ) -> [DynFilterFn](struct.DynFilterFn.html "struct bevy::log::tracing_subscriber::filter::DynFilterFn")<S, F, R>

Sets the highest verbosity [`Level`](../../struct.Level.html "struct bevy::log::Level") the filter function will enable.

The value passed to this method will be returned by this `DynFilterFn`’s [`Filter::max_level_hint`](../layer/trait.Filter.html#method.max_level_hint "method bevy::log::tracing_subscriber::layer::Filter::max_level_hint") method.
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/filter/filter_fn.rs.html#558-560)

#### pub fn [with\_callsite\_filter](#method.with_callsite_filter)<R2>( self, callsite\_enabled: R2, ) -> [DynFilterFn](struct.DynFilterFn.html "struct bevy::log::tracing_subscriber::filter::DynFilterFn")<S, F, R2>

where R2: [Fn](https://doc.rust-lang.org/nightly/core/ops/function/trait.Fn.html "trait core::ops::function::Fn")(&'static [Metadata](../../tracing/struct.Metadata.html "struct bevy::log::tracing::Metadata")<'static>) -> [Interest](../../tracing/subscriber/struct.Interest.html "struct bevy::log::tracing::subscriber::Interest"),

Adds a function for filtering callsites to this filter.

When this filter’s [`Filter::callsite_enabled`](../layer/trait.Filter.html#method.callsite_enabled "method bevy::log::tracing_subscriber::layer::Filter::callsite_enabled") method is called, the provided function will be used rather than the default.

By default, `DynFilterFn` assumes that, because the filter _may_ depend dynamically on the current [span context](../layer/struct.Context.html "struct bevy::log::tracing_subscriber::layer::Context"), its result should never be cached. However, some filtering strategies may require dynamic information from the current span context in _some_ cases, but are able to make static filtering decisions from [`Metadata`](../../tracing/struct.Metadata.html "struct bevy::log::tracing::Metadata") alone in others.

For example, consider the filter given in the example for [`DynFilterFn::new`](struct.DynFilterFn.html#method.new "associated function bevy::log::tracing_subscriber::filter::DynFilterFn::new"). That filter enables all spans named “interesting\_span”, and any events and spans that occur inside of an interesting span. Since the span’s name is part of its static [`Metadata`](../../tracing/struct.Metadata.html "struct bevy::log::tracing::Metadata"), the “interesting\_span” can be enabled in [`callsite_enabled`](../layer/trait.Filter.html#method.callsite_enabled "method bevy::log::tracing_subscriber::layer::Filter::callsite_enabled"):
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/filter/filter_fn.rs.html#679-682)

### impl<S, F, R> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [DynFilterFn](struct.DynFilterFn.html "struct bevy::log::tracing_subscriber::filter::DynFilterFn")<S, F, R>

where F: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"), R: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/filter/filter_fn.rs.html#684)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [DynFilterFn](struct.DynFilterFn.html "struct bevy::log::tracing_subscriber::filter::DynFilterFn")<S, F, R>
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/filter/filter_fn.rs.html#662)

### impl<S, F, R> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [DynFilterFn](struct.DynFilterFn.html "struct bevy::log::tracing_subscriber::filter::DynFilterFn")<S, F, R>

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/filter/filter_fn.rs.html#663)
...
### impl<S, F, R> [Filter](../layer/trait.Filter.html "trait bevy::log::tracing_subscriber::layer::Filter")<S> for [DynFilterFn](struct.DynFilterFn.html "struct bevy::log::tracing_subscriber::filter::DynFilterFn")<S, F, R>
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/filter/filter_fn.rs.html#731)

#### fn [enabled](../layer/trait.Filter.html#tymethod.enabled)(&self, metadata: &[Metadata](../../tracing/struct.Metadata.html "struct bevy::log::tracing::Metadata")<'\_>, cx: &[Context](../layer/struct.Context.html "struct bevy::log::tracing_subscriber::layer::Context")<'\_, S>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/filter/filter_fn.rs.html#735)
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/filter/filter_fn.rs.html#739)
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/filter/filter_fn.rs.html#694-696)

### impl<F, S> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<F> for [DynFilterFn](struct.DynFilterFn.html "struct bevy::log::tracing_subscriber::filter::DynFilterFn")<S, F>

where F: [Fn](https://doc.rust-lang.org/nightly/core/ops/function/trait.Fn.html "trait core::ops::function::Fn")(&[Metadata](../../tracing/struct.Metadata.html "struct bevy::log::tracing::Metadata")<'\_>, &[Context](../layer/struct.Context.html "struct bevy::log::tracing_subscriber::layer::Context")<'\_, S>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html),

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/filter/filter_fn.rs.html#698)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(f: F) -> [DynFilterFn](struct.DynFilterFn.html "struct bevy::log::tracing_subscriber::filter::DynFilterFn")<S, F>
...
### impl<S, F, R> [Layer](../trait.Layer.html "trait bevy::log::tracing_subscriber::Layer")<S> for [DynFilterFn](struct.DynFilterFn.html "struct bevy::log::tracing_subscriber::filter::DynFilterFn")<S, F, R>
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/filter/filter_fn.rs.html#649)
...
[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/filter/filter_fn.rs.html#653)
...
### impl<S, F, R> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DynFilterFn](struct.DynFilterFn.html "struct bevy::log::tracing_subscriber::filter::DynFilterFn")<S, F, R>

where F: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"), R: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"),

### impl<S, F, R> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DynFilterFn](struct.DynFilterFn.html "struct bevy::log::tracing_subscriber::filter::DynFilterFn")<S, F, R>

where F: [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"), R: [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"),

### impl<S, F, R> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DynFilterFn](struct.DynFilterFn.html "struct bevy::log::tracing_subscriber::filter::DynFilterFn")<S, F, R>

where F: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"), R: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<S, F, R> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DynFilterFn](struct.DynFilterFn.html "struct bevy::log::tracing_subscriber::filter::DynFilterFn")<S, F, R>

where F: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"), R: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<S, F, R> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DynFilterFn](struct.DynFilterFn.html "struct bevy::log::tracing_subscriber::filter::DynFilterFn")<S, F, R>

where F: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"), R: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<S, F, R> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DynFilterFn](struct.DynFilterFn.html "struct bevy::log::tracing_subscriber::filter::DynFilterFn")<S, F, R>

where F: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"), R: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"),

### impl<S, F, R> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DynFilterFn](struct.DynFilterFn.html "struct bevy::log::tracing_subscriber::filter::DynFilterFn")<S, F, R>

where F: [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"), R: [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"),
