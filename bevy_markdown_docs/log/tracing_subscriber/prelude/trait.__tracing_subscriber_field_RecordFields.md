...
# Trait \_\_tracing\_subscriber\_field\_RecordFields 

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/field/mod.rs.html#88)

```rust
pub trait __tracing_subscriber_field_RecordFields: Sealed<RecordFieldsMarker> {
    // Required method
...
### impl<F> [RecordFields](../field/trait.RecordFields.html "trait bevy::log::tracing_subscriber::field::RecordFields") for [&F](https://doc.rust-lang.org/nightly/std/primitive.reference.html)

where F: [RecordFields](../field/trait.RecordFields.html "trait bevy::log::tracing_subscriber::field::RecordFields"),
...
### impl [RecordFields](../field/trait.RecordFields.html "trait bevy::log::tracing_subscriber::field::RecordFields") for [Attributes](../../tracing/span/struct.Attributes.html "struct bevy::log::tracing::span::Attributes")<'\_>

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/field/mod.rs.html#161)

### impl [RecordFields](../field/trait.RecordFields.html "trait bevy::log::tracing_subscriber::field::RecordFields") for [Event](../../tracing/struct.Event.html "struct bevy::log::tracing::Event")<'\_>

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/field/mod.rs.html#175)

### impl [RecordFields](../field/trait.RecordFields.html "trait bevy::log::tracing_subscriber::field::RecordFields") for [Record](../../tracing/span/struct.Record.html "struct bevy::log::tracing::span::Record")<'\_>