...
# Trait \_\_tracing\_subscriber\_SubscriberExt 
...
#### fn [with](#method.with)<L>(self, layer: L) -> [Layered](../layer/struct.Layered.html "struct bevy::log::tracing_subscriber::layer::Layered")<L, Self>
...
### impl<S> [SubscriberExt](trait.__tracing_subscriber_SubscriberExt.html "trait bevy::log::tracing_subscriber::prelude::__tracing_subscriber_SubscriberExt") for S
