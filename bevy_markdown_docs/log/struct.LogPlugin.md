...
[Source](https://docs.rs/bevy_log/0.19.0/x86_64-unknown-linux-gnu/src/bevy_log/lib.rs.html#218)

```rust
pub struct LogPlugin {
    pub filter: String,
    pub level: Level,
    pub custom_layer: fn(&mut App) -> Option<Box<dyn Layer<Registry> + Send + Sync>>,
    pub fmt_layer: fn(&mut App) -> Option<Box<dyn Layer<Layered<ErrorLayer<Layered<EnvFilter, Layered<Option<Box<dyn Layer<Registry> + Send + Sync>>, Registry>>>, Layered<EnvFilter, Layered<Option<Box<dyn Layer<Registry> + Send + Sync>>, Registry>>>> + Send + Sync>>,
}
```
...
*   Using [`tracing-subscriber`](https://crates.io/crates/tracing-subscriber) by default, logging to `stdout`.
*   Using [`android_log-sys`](https://crates.io/crates/android_log-sys) on Android, logging to Android logs.
*   Using [`tracing-wasm`](https://crates.io/crates/tracing-wasm) in Wasm, logging to the browser console.
...
It has the same syntax as the field [`LogPlugin::filter`](struct.LogPlugin.html#structfield.filter "field bevy::log::LogPlugin::filter"), see [`EnvFilter`](tracing_subscriber/struct.EnvFilter.html "struct bevy::log::tracing_subscriber::EnvFilter"). If you define the `RUST_LOG` environment variable, the [`LogPlugin`](struct.LogPlugin.html "struct bevy::log::LogPlugin") settings will be ignored.

Also, to disable color terminal output (ANSI escape codes), you can set the environment variable `NO_COLOR` to any value. This common convention is documented at [no-color.org](https://no-color.org/). For example:
...
Filters applied through this plugin are computed at _runtime_, which will have a non-zero impact on performance. To achieve maximum performance, consider using [_compile time_ filters](https://docs.rs/log/#compile-time-filters) provided by the [`log`](https://crates.io/crates/log) crate.
...
`filter: [String](../prelude/struct.String.html "struct bevy::prelude::String")`

Filters logs using the [`EnvFilter`](tracing_subscriber/struct.EnvFilter.html "struct bevy::log::tracing_subscriber::EnvFilter") format
...
`custom_layer: [fn](https://doc.rust-lang.org/nightly/std/primitive.fn.html)(&mut [App](../prelude/struct.App.html "struct bevy::prelude::App")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Layer](tracing_subscriber/trait.Layer.html "trait bevy::log::tracing_subscriber::Layer")<[Registry](tracing_subscriber/struct.Registry.html "struct bevy::log::tracing_subscriber::Registry")> + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync")>>`

Optionally add an extra [`Layer`](tracing_subscriber/trait.Layer.html "trait bevy::log::tracing_subscriber::Layer") to the tracing subscriber

This function is only called once, when the plugin is built.

Because [`BoxedLayer`](type.BoxedLayer.html "type bevy::log::BoxedLayer") takes a `dyn Layer`, `Vec<Layer>` is also an acceptable return value.

Access to [`App`](../prelude/struct.App.html "struct bevy::prelude::App") is also provided to allow for communication between the [`Subscriber`](tracing/trait.Subscriber.html "trait bevy::log::tracing::Subscriber") and the [`App`](../prelude/struct.App.html "struct bevy::prelude::App").

Please see the `examples/app/log_layers.rs` for a complete example.

`fmt_layer: [fn](https://doc.rust-lang.org/nightly/std/primitive.fn.html)(&mut [App](../prelude/struct.App.html "struct bevy::prelude::App")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Layer](tracing_subscriber/trait.Layer.html "trait bevy::log::tracing_subscriber::Layer")<[Layered](tracing_subscriber/layer/struct.Layered.html "struct bevy::log::tracing_subscriber::layer::Layered")<[ErrorLayer](https://docs.rs/tracing-error/0.2.1/x86_64-unknown-linux-gnu/tracing_error/layer/struct.ErrorLayer.html "struct tracing_error::layer::ErrorLayer")<[Layered](tracing_subscriber/layer/struct.Layered.html "struct bevy::log::tracing_subscriber::layer::Layered")<[EnvFilter](tracing_subscriber/struct.EnvFilter.html "struct bevy::log::tracing_subscriber::EnvFilter"), [Layered](tracing_subscriber/layer/struct.Layered.html "struct bevy::log::tracing_subscriber::layer::Layered")<[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Layer](tracing_subscriber/trait.Layer.html "trait bevy::log::tracing_subscriber::Layer")<[Registry](tracing_subscriber/struct.Registry.html "struct bevy::log::tracing_subscriber::Registry")> + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync")>>, [Registry](tracing_subscriber/struct.Registry.html "struct bevy::log::tracing_subscriber::Registry")>>>, [Layered](tracing_subscriber/layer/struct.Layered.html "struct bevy::log::tracing_subscriber::layer::Layered")<[EnvFilter](tracing_subscriber/struct.EnvFilter.html "struct bevy::log::tracing_subscriber::EnvFilter"), [Layered](tracing_subscriber/layer/struct.Layered.html "struct bevy::log::tracing_subscriber::layer::Layered")<[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Layer](tracing_subscriber/trait.Layer.html "trait bevy::log::tracing_subscriber::Layer")<[Registry](tracing_subscriber/struct.Registry.html "struct bevy::log::tracing_subscriber::Registry")> + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync")>>, [Registry](tracing_subscriber/struct.Registry.html "struct bevy::log::tracing_subscriber::Registry")>>>> + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync")>>`

Override the default [`tracing_subscriber::fmt::Layer`](tracing_subscriber/fmt/struct.Layer.html "struct bevy::log::tracing_subscriber::fmt::Layer") with a custom one.

This differs from [`custom_layer`](struct.LogPlugin.html#structfield.custom_layer "field bevy::log::LogPlugin::custom_layer") in that [`fmt_layer`](struct.LogPlugin.html#structfield.fmt_layer "field bevy::log::LogPlugin::fmt_layer") allows you to overwrite the default formatter layer, while `custom_layer` only allows you to add additional layers (which are unable to modify the default formatter).

For example, you can use [`tracing_subscriber::fmt::Layer::without_time`](tracing_subscriber/fmt/struct.Layer.html#method.without_time "method bevy::log::tracing_subscriber::fmt::Layer::without_time") to remove the timestamp from the log output.

Please see the `examples/app/log_layers.rs` for a complete example.

## Trait Implementations

[Source](https://docs.rs/bevy_log/0.19.0/x86_64-unknown-linux-gnu/src/bevy_log/lib.rs.html#284)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [LogPlugin](struct.LogPlugin.html "struct bevy::log::LogPlugin")

[Source](https://docs.rs/bevy_log/0.19.0/x86_64-unknown-linux-gnu/src/bevy_log/lib.rs.html#285)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [LogPlugin](struct.LogPlugin.html "struct bevy::log::LogPlugin")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_log/0.19.0/x86_64-unknown-linux-gnu/src/bevy_log/lib.rs.html#295)

### impl [Plugin](../prelude/trait.Plugin.html "trait bevy::prelude::Plugin") for [LogPlugin](struct.LogPlugin.html "struct bevy::log::LogPlugin")

[Source](https://docs.rs/bevy_log/0.19.0/x86_64-unknown-linux-gnu/src/bevy_log/lib.rs.html#296)

#### fn [build](../prelude/trait.Plugin.html#tymethod.build)(&self, app: &mut [App](../prelude/struct.App.html "struct bevy::prelude::App"))
...
#### fn [ready](../prelude/trait.Plugin.html#method.ready)(&self, \_app: &[App](../prelude/struct.App.html "struct bevy::prelude::App")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
#### fn [finish](../prelude/trait.Plugin.html#method.finish)(&self, \_app: &mut [App](../prelude/struct.App.html "struct bevy::prelude::App"))
...
#### fn [cleanup](../prelude/trait.Plugin.html#method.cleanup)(&self, \_app: &mut [App](../prelude/struct.App.html "struct bevy::prelude::App"))
...
#### fn [name](../prelude/trait.Plugin.html#method.name)(&self) -> &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)
...
#### fn [is\_unique](../prelude/trait.Plugin.html#method.is_unique)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [LogPlugin](struct.LogPlugin.html "struct bevy::log::LogPlugin")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [LogPlugin](struct.LogPlugin.html "struct bevy::log::LogPlugin")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [LogPlugin](struct.LogPlugin.html "struct bevy::log::LogPlugin")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [LogPlugin](struct.LogPlugin.html "struct bevy::log::LogPlugin")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [LogPlugin](struct.LogPlugin.html "struct bevy::log::LogPlugin")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [LogPlugin](struct.LogPlugin.html "struct bevy::log::LogPlugin")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [LogPlugin](struct.LogPlugin.html "struct bevy::log::LogPlugin")
