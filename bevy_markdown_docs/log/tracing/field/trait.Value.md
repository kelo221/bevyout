...
Implementors of `Value` may call the appropriate typed recording methods on the [visitor](trait.Visit.html "trait bevy::log::tracing::field::Visit") passed to their `record` method in order to indicate how their data should be recorded.

## Required Methods

[Source](https://docs.rs/tracing-core/0.1.36/x86_64-unknown-linux-gnu/src/tracing_core/field.rs.html#352)

#### fn [record](#tymethod.record)(&self, key: &[Field](struct.Field.html "struct bevy::log::tracing::field::Field"), visitor: &mut dyn [Visit](trait.Visit.html "trait bevy::log::tracing::field::Visit"))
