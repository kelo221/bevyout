...
See the [module-level documentation](callsite/index.html "mod bevy::log::tracing::callsite") for details on callsites.
...
See the [documentation on callsite interest caching](callsite/index.html#performing-static-filtering "mod bevy::log::tracing::callsite") for details.
...
that share the same callsite [`Identifier`](callsite/struct.Identifier.html "struct bevy::log::tracing::callsite::Identifier") but otherwise differ in any
...
### impl [Callsite](trait.Callsite.html "trait bevy::log::tracing::Callsite") for [DefaultCallsite](callsite/struct.DefaultCallsite.html "struct bevy::log::tracing::callsite::DefaultCallsite")