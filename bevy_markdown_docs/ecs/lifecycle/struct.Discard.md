...
Runs before the value is replaced, so you can still access the original component data. See [`ComponentHooks::on_discard`](struct.ComponentHooks.html#method.on_discard "method bevy::ecs::lifecycle::ComponentHooks::on_discard") for more information.
