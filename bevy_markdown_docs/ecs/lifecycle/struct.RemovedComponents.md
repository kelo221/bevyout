...
#### pub fn [reader](#method.reader)(&self) -> &[MessageCursor](../message/struct.MessageCursor.html "struct bevy::ecs::message::MessageCursor")<[RemovedComponentEntity](struct.RemovedComponentEntity.html "struct bevy::ecs::lifecycle::RemovedComponentEntity")\>
...
#### pub fn [reader\_mut](#method.reader_mut)(&mut self) -> &mut [MessageCursor](../message/struct.MessageCursor.html "struct bevy::ecs::message::MessageCursor")<[RemovedComponentEntity](struct.RemovedComponentEntity.html "struct bevy::ecs::lifecycle::RemovedComponentEntity")\>
...
#### pub fn [messages](#method.messages)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<[RemovedComponentEntity](struct.RemovedComponentEntity.html "struct bevy::ecs::lifecycle::RemovedComponentEntity")\>>
...
#### pub fn [reader\_mut\_with\_messages](#method.reader_mut_with_messages)( &mut self, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<(&mut [RemovedComponentReader](struct.RemovedComponentReader.html "struct bevy::ecs::lifecycle::RemovedComponentReader")<T>, &[Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<[RemovedComponentEntity](struct.RemovedComponentEntity.html "struct bevy::ecs::lifecycle::RemovedComponentEntity")\>)>
...
#### pub fn [read\_with\_id](#method.read_with_id)( &mut self, ) -> [Map](https://doc.rust-lang.org/nightly/core/iter/adapters/map/struct.Map.html "struct core::iter::adapters::map::Map")<[Flatten](https://doc.rust-lang.org/nightly/core/iter/adapters/flatten/struct.Flatten.html "struct core::iter::adapters::flatten::Flatten")<[IntoIter](https://doc.rust-lang.org/nightly/core/option/struct.IntoIter.html "struct core::option::IntoIter")<[MessageIteratorWithId](../message/struct.MessageIteratorWithId.html "struct bevy::ecs::message::MessageIteratorWithId")<'\_, [RemovedComponentEntity](struct.RemovedComponentEntity.html "struct bevy::ecs::lifecycle::RemovedComponentEntity")\>>>, [fn](https://doc.rust-lang.org/nightly/std/primitive.fn.html)((&[RemovedComponentEntity](struct.RemovedComponentEntity.html "struct bevy::ecs::lifecycle::RemovedComponentEntity"), [MessageId](../message/struct.MessageId.html "struct bevy::ecs::message::MessageId")<[RemovedComponentEntity](struct.RemovedComponentEntity.html "struct bevy::ecs::lifecycle::RemovedComponentEntity")\>)) -> ([Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), [MessageId](../message/struct.MessageId.html "struct bevy::ecs::message::MessageId")<[RemovedComponentEntity](struct.RemovedComponentEntity.html "struct bevy::ecs::lifecycle::RemovedComponentEntity")\>)> [ⓘ](#)
...
where T: [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component"), [ComponentIdFor](../component/struct.ComponentIdFor.html "struct bevy::ecs::component::ComponentIdFor")<'s, T>: [ReadOnlySystemParam](../system/trait.ReadOnlySystemParam.html "trait bevy::ecs::system::ReadOnlySystemParam"), [Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'s, [RemovedComponentReader](struct.RemovedComponentReader.html "struct bevy::ecs::lifecycle::RemovedComponentReader")<T>>: [ReadOnlySystemParam](../system/trait.ReadOnlySystemParam.html "trait bevy::ecs::system::ReadOnlySystemParam"), &'w [RemovedComponentMessages](struct.RemovedComponentMessages.html "struct bevy::ecs::lifecycle::RemovedComponentMessages"): [ReadOnlySystemParam](../system/trait.ReadOnlySystemParam.html "trait bevy::ecs::system::ReadOnlySystemParam"),
