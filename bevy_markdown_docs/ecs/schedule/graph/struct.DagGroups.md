...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/graph/dag.rs.html#506)

```rust
pub struct DagGroups<K, V, S = FixedHasher>(/* private fields */);
```
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/graph/dag.rs.html#508)

### impl<K, V, S> [DagGroups](struct.DagGroups.html "struct bevy::ecs::schedule::graph::DagGroups")<K, V, S>

where K: [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") + [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash"), V: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") + [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") + [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash"), S: [BuildHasher](https://doc.rust-lang.org/nightly/core/hash/trait.BuildHasher.html "trait core::hash::BuildHasher") + [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/graph/dag.rs.html#514-516)

#### pub fn [new](#method.new)<N>(graph: &Graph<true, N, S>, toposort: &[\[N\]](https://doc.rust-lang.org/nightly/std/primitive.slice.html)) -> [DagGroups](struct.DagGroups.html "struct bevy::ecs::schedule::graph::DagGroups")<K, V, S>

where N: [GraphNodeId](trait.GraphNodeId.html "trait bevy::ecs::schedule::graph::GraphNodeId") + [TryInto](https://doc.rust-lang.org/nightly/core/convert/trait.TryInto.html "trait core::convert::TryInto")<K, Error = V>,

Groups nodes in this DAG by a key type `K`, collecting value nodes `V` under all of their ancestor key nodes.
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/graph/dag.rs.html#527-529)

#### pub fn [with\_capacity](#method.with_capacity)<N>( capacity: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), graph: &Graph<true, N, S>, toposort: &[\[N\]](https://doc.rust-lang.org/nightly/std/primitive.slice.html), ) -> [DagGroups](struct.DagGroups.html "struct bevy::ecs::schedule::graph::DagGroups")<K, V, S>

where N: [GraphNodeId](trait.GraphNodeId.html "trait bevy::ecs::schedule::graph::GraphNodeId") + [TryInto](https://doc.rust-lang.org/nightly/core/convert/trait.TryInto.html "trait core::convert::TryInto")<K, Error = V>,

Groups nodes in this DAG by a key type `K`, collecting value nodes `V` under all of their ancestor key nodes. `capacity` hints at the expected number of groups, for memory allocation optimization.

The node type `N` must be convertible into either a key type `K` or a value type `V` via the [`TryInto`](https://doc.rust-lang.org/nightly/core/convert/trait.TryInto.html "trait core::convert::TryInto") trait.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/graph/dag.rs.html#563)

### impl<K, V, S> [DagGroups](struct.DagGroups.html "struct bevy::ecs::schedule::graph::DagGroups")<K, V, S>

where K: [GraphNodeId](trait.GraphNodeId.html "trait bevy::ecs::schedule::graph::GraphNodeId"), V: [GraphNodeId](trait.GraphNodeId.html "trait bevy::ecs::schedule::graph::GraphNodeId"), S: [BuildHasher](https://doc.rust-lang.org/nightly/core/hash/trait.BuildHasher.html "trait core::hash::BuildHasher"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/graph/dag.rs.html#572-578)

#### pub fn [flatten](#method.flatten)<N>( &self, dag: [Dag](struct.Dag.html "struct bevy::ecs::schedule::graph::Dag")<N>, collapse\_group: impl [FnMut](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html "trait core::ops::function::FnMut")(K, &[IndexSet](https://docs.rs/indexmap/2.14.0/x86_64-unknown-linux-gnu/indexmap/set/struct.IndexSet.html "struct indexmap::set::IndexSet")<V, S>, &[Dag](struct.Dag.html "struct bevy::ecs::schedule::graph::Dag")<N>, &mut [Vec](../../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[(N, N)](https://doc.rust-lang.org/nightly/std/primitive.tuple.html)\>), ) -> [Dag](struct.Dag.html "struct bevy::ecs::schedule::graph::Dag")<V>

where N: [GraphNodeId](trait.GraphNodeId.html "trait bevy::ecs::schedule::graph::GraphNodeId") + [TryInto](https://doc.rust-lang.org/nightly/core/convert/trait.TryInto.html "trait core::convert::TryInto")<V, Error = K> + [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<K> + [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<V>,

Converts the given [`Dag`](struct.Dag.html "struct bevy::ecs::schedule::graph::Dag") into a flattened version where key nodes (`K`) are replaced by their associated value nodes (`V`). Edges to/from key nodes are redirected to connect their value nodes instead.

The `collapse_group` function is called for each key node to customize how its group is collapsed.

The resulting [`Dag`](struct.Dag.html "struct bevy::ecs::schedule::graph::Dag") will have only value nodes (`V`).

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/graph/dag.rs.html#629-631)

#### pub fn [flatten\_undirected](#method.flatten_undirected)<N>(&self, graph: &Graph<false, N>) -> Graph<false, V>

where N: [GraphNodeId](trait.GraphNodeId.html "trait bevy::ecs::schedule::graph::GraphNodeId") + [TryInto](https://doc.rust-lang.org/nightly/core/convert/trait.TryInto.html "trait core::convert::TryInto")<V, Error = K>,

Converts an undirected graph by replacing key nodes (`K`) with their associated value nodes (`V`). Edges connected to key nodes are redirected to connect their value nodes instead.

The resulting undirected graph will have only value nodes (`V`).

## Methods from [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")<Target = [HashMap](../../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<K, [IndexSet](https://docs.rs/indexmap/2.14.0/x86_64-unknown-linux-gnu/indexmap/set/struct.IndexSet.html "struct indexmap::set::IndexSet")<V, S>, S>>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/graph/dag.rs.html#706)

### impl<K, V, S> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [DagGroups](struct.DagGroups.html "struct bevy::ecs::schedule::graph::DagGroups")<K, V, S>

where K: [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug"), V: [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/graph/dag.rs.html#707)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")\>

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/graph/dag.rs.html#697-699)

### impl<K, V, S> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [DagGroups](struct.DagGroups.html "struct bevy::ecs::schedule::graph::DagGroups")<K, V, S>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/graph/dag.rs.html#701)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [DagGroups](struct.DagGroups.html "struct bevy::ecs::schedule::graph::DagGroups")<K, V, S>

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/graph/dag.rs.html#683)

### impl<K, V, S> [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [DagGroups](struct.DagGroups.html "struct bevy::ecs::schedule::graph::DagGroups")<K, V, S>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/graph/dag.rs.html#684)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = [HashMap](../../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<K, [IndexSet](https://docs.rs/indexmap/2.14.0/x86_64-unknown-linux-gnu/indexmap/set/struct.IndexSet.html "struct indexmap::set::IndexSet")<V, S>, S>

The resulting type after dereferencing.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/graph/dag.rs.html#686)

#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[DagGroups](struct.DagGroups.html "struct bevy::ecs::schedule::graph::DagGroups")<K, V, S> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/graph/dag.rs.html#691)

### impl<K, V, S> [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [DagGroups](struct.DagGroups.html "struct bevy::ecs::schedule::graph::DagGroups")<K, V, S>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/graph/dag.rs.html#692)

#### fn [deref\_mut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html#tymethod.deref_mut)(&mut self) -> &mut <[DagGroups](struct.DagGroups.html "struct bevy::ecs::schedule::graph::DagGroups")<K, V, S> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Mutably dereferences the value.

## Auto Trait Implementations

### impl<K, V, S> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DagGroups](struct.DagGroups.html "struct bevy::ecs::schedule::graph::DagGroups")<K, V, S>

where S: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"),

### impl<K, V, S> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DagGroups](struct.DagGroups.html "struct bevy::ecs::schedule::graph::DagGroups")<K, V, S>
...
### impl<K, V, S> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DagGroups](struct.DagGroups.html "struct bevy::ecs::schedule::graph::DagGroups")<K, V, S>
...
### impl<K, V, S> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DagGroups](struct.DagGroups.html "struct bevy::ecs::schedule::graph::DagGroups")<K, V, S>
...
### impl<K, V, S> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DagGroups](struct.DagGroups.html "struct bevy::ecs::schedule::graph::DagGroups")<K, V, S>
...
### impl<K, V, S> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DagGroups](struct.DagGroups.html "struct bevy::ecs::schedule::graph::DagGroups")<K, V, S>

where S: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"),

### impl<K, V, S> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DagGroups](struct.DagGroups.html "struct bevy::ecs::schedule::graph::DagGroups")<K, V, S>
