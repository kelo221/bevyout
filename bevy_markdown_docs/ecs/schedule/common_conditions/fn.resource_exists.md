...
To skip a system with a [`Res`](../../../prelude/struct.Res.html "struct bevy::prelude::Res") or [`ResMut`](../../../prelude/struct.ResMut.html "struct bevy::prelude::ResMut") parameter if the resource does not exist, you may instead wrap the parameter in [`If`](../../../prelude/struct.If.html "struct bevy::prelude::If"), like `If<Res<T>>` or `If<ResMut<T>>`.
