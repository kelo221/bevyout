...
#### pub fn [remove](#method.remove)(&mut self, label: impl [ScheduleLabel](trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Schedule](../../prelude/struct.Schedule.html "struct bevy::prelude::Schedule")\>
...
#### pub fn [get\_empty\_labels](#method.get_empty_labels)(&self) -> [HashSet](../../platform/collections/struct.HashSet.html "struct bevy::platform::collections::HashSet")<[Interned](../intern/struct.Interned.html "struct bevy::ecs::intern::Interned")<dyn [ScheduleLabel](trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")\>>
...
#### pub fn [contains](#method.contains)(&self, label: impl [ScheduleLabel](trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Does a schedule with the provided label already exist?

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#126)

#### pub fn [get](#method.get)(&self, label: impl [ScheduleLabel](trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[Schedule](../../prelude/struct.Schedule.html "struct bevy::prelude::Schedule")\>
...
#### pub fn [get\_mut](#method.get_mut)(&mut self, label: impl [ScheduleLabel](trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&mut [Schedule](../../prelude/struct.Schedule.html "struct bevy::prelude::Schedule")\>

Returns a mutable reference to the schedule associated with `label`, if it exists.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#136)

#### pub fn [entry](#method.entry)(&mut self, label: impl [ScheduleLabel](trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")) -> &mut [Schedule](../../prelude/struct.Schedule.html "struct bevy::prelude::Schedule")
...
#### pub fn [iter](#method.iter)( &self, ) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = (&(dyn [ScheduleLabel](trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel") + 'static), &[Schedule](../../prelude/struct.Schedule.html "struct bevy::prelude::Schedule"))>
...
#### pub fn [iter\_mut](#method.iter_mut)( &mut self, ) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = (&(dyn [ScheduleLabel](trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel") + 'static), &mut [Schedule](../../prelude/struct.Schedule.html "struct bevy::prelude::Schedule"))>
...
#### pub fn [configure\_schedules](#method.configure_schedules)( &mut self, schedule\_build\_settings: [ScheduleBuildSettings](struct.ScheduleBuildSettings.html "struct bevy::ecs::schedule::ScheduleBuildSettings"), )

Applies the provided [`ScheduleBuildSettings`](struct.ScheduleBuildSettings.html "struct bevy::ecs::schedule::ScheduleBuildSettings") to all schedules.
...
Adds one or more systems to the [`Schedule`](../../prelude/struct.Schedule.html "struct bevy::prelude::Schedule") matching the provided [`ScheduleLabel`](trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#233-239)

#### pub fn [remove\_systems\_in\_set](#method.remove_systems_in_set)<M>( &mut self, schedule: impl [ScheduleLabel](trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel"), set: impl [IntoSystemSet](../../prelude/trait.IntoSystemSet.html "trait bevy::prelude::IntoSystemSet")<M>, world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World"), policy: [ScheduleCleanupPolicy](enum.ScheduleCleanupPolicy.html "enum bevy::ecs::schedule::ScheduleCleanupPolicy"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), [ScheduleError](enum.ScheduleError.html "enum bevy::ecs::schedule::ScheduleError")\>
...
#### pub fn [ignore\_ambiguity](#method.ignore_ambiguity)<M1, M2, S1, S2>( &mut self, schedule: impl [ScheduleLabel](trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel"), a: S1, b: S2, ) -> &mut [Schedules](../../prelude/struct.Schedules.html "struct bevy::prelude::Schedules")
