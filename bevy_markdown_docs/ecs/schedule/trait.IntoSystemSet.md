...
#### type [Set](#associatedtype.Set) = [SystemTypeSet](struct.SystemTypeSet.html "struct bevy::ecs::schedule::SystemTypeSet")<[ApplyDeferred](../../prelude/struct.ApplyDeferred.html "struct bevy::prelude::ApplyDeferred")\>
...
#### type [Set](#associatedtype.Set) = [SystemTypeSet](struct.SystemTypeSet.html "struct bevy::ecs::schedule::SystemTypeSet")<F>
