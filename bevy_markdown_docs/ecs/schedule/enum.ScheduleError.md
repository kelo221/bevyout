...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/error.rs.html#284)
...
### ScheduleBuildError([ScheduleBuildError](enum.ScheduleBuildError.html "enum bevy::ecs::schedule::ScheduleBuildError"))

Error initializing schedule

## Trait Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/error.rs.html#283)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ScheduleError](enum.ScheduleError.html "enum bevy::ecs::schedule::ScheduleError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [ScheduleError](enum.ScheduleError.html "enum bevy::ecs::schedule::ScheduleError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [ScheduleError](enum.ScheduleError.html "enum bevy::ecs::schedule::ScheduleError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ScheduleError](enum.ScheduleError.html "enum bevy::ecs::schedule::ScheduleError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ScheduleError](enum.ScheduleError.html "enum bevy::ecs::schedule::ScheduleError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ScheduleError](enum.ScheduleError.html "enum bevy::ecs::schedule::ScheduleError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ScheduleError](enum.ScheduleError.html "enum bevy::ecs::schedule::ScheduleError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ScheduleError](enum.ScheduleError.html "enum bevy::ecs::schedule::ScheduleError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ScheduleError](enum.ScheduleError.html "enum bevy::ecs::schedule::ScheduleError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ScheduleError](enum.ScheduleError.html "enum bevy::ecs::schedule::ScheduleError")
