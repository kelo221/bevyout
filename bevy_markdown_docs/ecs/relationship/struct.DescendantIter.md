...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/relationship_query.rs.html#149)

```rust
pub struct DescendantIter<'w, 's, D, F, S>where
    D: QueryData,
    F: QueryFilter,
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/relationship_query.rs.html#157-159)

### impl<'w, 's, D, F, S> [DescendantIter](struct.DescendantIter.html "struct bevy::ecs::relationship::DescendantIter")<'w, 's, D, F, S>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/relationship_query.rs.html#162)

#### pub fn [new](#method.new)( children\_query: &'w [Query](../../prelude/struct.Query.html "struct bevy::prelude::Query")<'w, 's, D, F>, entity: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), ) -> [DescendantIter](struct.DescendantIter.html "struct bevy::ecs::relationship::DescendantIter")<'w, 's, D, F, S> [ⓘ](#)

Returns a new [`DescendantIter`](struct.DescendantIter.html "struct bevy::ecs::relationship::DescendantIter").

## Trait Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/relationship_query.rs.html#174-177)

### impl<'w, 's, D, F, S> [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator") for [DescendantIter](struct.DescendantIter.html "struct bevy::ecs::relationship::DescendantIter")<'w, 's, D, F, S>

where D: [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData"), F: [QueryFilter](../query/trait.QueryFilter.html "trait bevy::ecs::query::QueryFilter"), S: [RelationshipTarget](../../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget"), <D as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[ReadOnly](../query/trait.QueryData.html#associatedtype.ReadOnly "type bevy::ecs::query::QueryData::ReadOnly"): [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")<Item<'w, 's> = [&'w S](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\>,

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/relationship_query.rs.html#179)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/relationship_query.rs.html#181)

#### fn [next](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#tymethod.next)( &mut self, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[DescendantIter](struct.DescendantIter.html "struct bevy::ecs::relationship::DescendantIter")<'w, 's, D, F, S> as [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")\>::[Item](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#associatedtype.Item "type core::iter::traits::iterator::Iterator::Item")\>
...
### impl<'w, 's, D, F, S> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DescendantIter](struct.DescendantIter.html "struct bevy::ecs::relationship::DescendantIter")<'w, 's, D, F, S>

### impl<'w, 's, D, F, S> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DescendantIter](struct.DescendantIter.html "struct bevy::ecs::relationship::DescendantIter")<'w, 's, D, F, S>

### impl<'w, 's, D, F, S> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DescendantIter](struct.DescendantIter.html "struct bevy::ecs::relationship::DescendantIter")<'w, 's, D, F, S>

### impl<'w, 's, D, F, S> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DescendantIter](struct.DescendantIter.html "struct bevy::ecs::relationship::DescendantIter")<'w, 's, D, F, S>

### impl<'w, 's, D, F, S> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DescendantIter](struct.DescendantIter.html "struct bevy::ecs::relationship::DescendantIter")<'w, 's, D, F, S>

### impl<'w, 's, D, F, S> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DescendantIter](struct.DescendantIter.html "struct bevy::ecs::relationship::DescendantIter")<'w, 's, D, F, S>

### impl<'w, 's, D, F, S> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DescendantIter](struct.DescendantIter.html "struct bevy::ecs::relationship::DescendantIter")<'w, 's, D, F, S>
