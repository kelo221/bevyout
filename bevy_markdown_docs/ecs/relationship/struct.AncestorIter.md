...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/relationship_query.rs.html#240)

```rust
pub struct AncestorIter<'w, 's, D, F, R>where
    D: QueryData,
    F: QueryFilter,
    R: Relationship,
    <D as QueryData>::ReadOnly: QueryData<Item<'w, 's> = &'w R>,{ /* private fields */ }
```
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/relationship_query.rs.html#248-250)

### impl<'w, 's, D, F, R> [AncestorIter](struct.AncestorIter.html "struct bevy::ecs::relationship::AncestorIter")<'w, 's, D, F, R>

where D: [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData"), F: [QueryFilter](../query/trait.QueryFilter.html "trait bevy::ecs::query::QueryFilter"), R: [Relationship](trait.Relationship.html "trait bevy::ecs::relationship::Relationship"), <D as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[ReadOnly](../query/trait.QueryData.html#associatedtype.ReadOnly "type bevy::ecs::query::QueryData::ReadOnly"): [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")<Item<'w, 's> = [&'w R](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\>,

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/relationship_query.rs.html#253)

#### pub fn [new](#method.new)( parent\_query: &'w [Query](../../prelude/struct.Query.html "struct bevy::prelude::Query")<'w, 's, D, F>, entity: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), ) -> [AncestorIter](struct.AncestorIter.html "struct bevy::ecs::relationship::AncestorIter")<'w, 's, D, F, R> [ⓘ](#)

Returns a new [`AncestorIter`](struct.AncestorIter.html "struct bevy::ecs::relationship::AncestorIter").

## Trait Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/relationship_query.rs.html#261-264)

### impl<'w, 's, D, F, R> [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator") for [AncestorIter](struct.AncestorIter.html "struct bevy::ecs::relationship::AncestorIter")<'w, 's, D, F, R>

where D: [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData"), F: [QueryFilter](../query/trait.QueryFilter.html "trait bevy::ecs::query::QueryFilter"), R: [Relationship](trait.Relationship.html "trait bevy::ecs::relationship::Relationship"), <D as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[ReadOnly](../query/trait.QueryData.html#associatedtype.ReadOnly "type bevy::ecs::query::QueryData::ReadOnly"): [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")<Item<'w, 's> = [&'w R](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\>,

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/relationship_query.rs.html#266)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/relationship_query.rs.html#268)

#### fn [next](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#tymethod.next)(&mut self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[AncestorIter](struct.AncestorIter.html "struct bevy::ecs::relationship::AncestorIter")<'w, 's, D, F, R> as [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")\>::[Item](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#associatedtype.Item "type core::iter::traits::iterator::Iterator::Item")\>
...
### impl<'w, 's, D, F, R> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AncestorIter](struct.AncestorIter.html "struct bevy::ecs::relationship::AncestorIter")<'w, 's, D, F, R>

### impl<'w, 's, D, F, R> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AncestorIter](struct.AncestorIter.html "struct bevy::ecs::relationship::AncestorIter")<'w, 's, D, F, R>

### impl<'w, 's, D, F, R> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AncestorIter](struct.AncestorIter.html "struct bevy::ecs::relationship::AncestorIter")<'w, 's, D, F, R>

### impl<'w, 's, D, F, R> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AncestorIter](struct.AncestorIter.html "struct bevy::ecs::relationship::AncestorIter")<'w, 's, D, F, R>

### impl<'w, 's, D, F, R> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AncestorIter](struct.AncestorIter.html "struct bevy::ecs::relationship::AncestorIter")<'w, 's, D, F, R>

### impl<'w, 's, D, F, R> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AncestorIter](struct.AncestorIter.html "struct bevy::ecs::relationship::AncestorIter")<'w, 's, D, F, R>

### impl<'w, 's, D, F, R> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AncestorIter](struct.AncestorIter.html "struct bevy::ecs::relationship::AncestorIter")<'w, 's, D, F, R>
