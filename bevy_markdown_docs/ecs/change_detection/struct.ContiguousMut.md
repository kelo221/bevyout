...
#### pub fn [added\_ticks\_slice](#method.added_ticks_slice)(&self) -> &\[[Tick](struct.Tick.html "struct bevy::ecs::change_detection::Tick")\]
...
#### pub fn [changed\_ticks\_slice](#method.changed_ticks_slice)(&self) -> &\[[Tick](struct.Tick.html "struct bevy::ecs::change_detection::Tick")\]
...
#### pub fn [changed\_by\_ticks\_mut](#method.changed_by_ticks_mut)( &self, ) -> [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<&\[&'static [Location](https://doc.rust-lang.org/nightly/core/panic/location/struct.Location.html "struct core::panic::location::Location")<'static>\]>
...
#### pub fn [added\_ticks\_slice\_mut](#method.added_ticks_slice_mut)(&mut self) -> &mut \[[Tick](struct.Tick.html "struct bevy::ecs::change_detection::Tick")\]
...
#### pub fn [changed\_ticks\_slice\_mut](#method.changed_ticks_slice_mut)(&mut self) -> &mut \[[Tick](struct.Tick.html "struct bevy::ecs::change_detection::Tick")\]
...
#### pub fn [new](#method.new)( value: &'w mut [\[T\]](https://doc.rust-lang.org/nightly/std/primitive.slice.html), added: &'w mut \[[Tick](struct.Tick.html "struct bevy::ecs::change_detection::Tick")\], changed: &'w mut \[[Tick](struct.Tick.html "struct bevy::ecs::change_detection::Tick")\], last\_run: [Tick](struct.Tick.html "struct bevy::ecs::change_detection::Tick"), this\_run: [Tick](struct.Tick.html "struct bevy::ecs::change_detection::Tick"), caller: [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<&'w mut \[&'static [Location](https://doc.rust-lang.org/nightly/core/panic/location/struct.Location.html "struct core::panic::location::Location")<'static>\]>, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ContiguousMut](../../prelude/struct.ContiguousMut.html "struct bevy::prelude::ContiguousMut")<'w, T>>
