...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#22)

```rust
pub struct MaybeLocation<T = &'static Location<'static>>where
    T: ?Sized,{ /* private fields */ }
```

A value that contains a `T` if the `track_location` feature is enabled, and is a ZST if it is not.

The overall API is similar to [`Option`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option"), but whether the value is `Some` or `None` is set at compile time and is the same for all values.
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#39)

### impl<T> [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#51-53)

#### pub const fn [new](#method.new)(\_value: T) -> [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>
...
This may only accept `Copy` types, since it needs to drop the value if the `track_location` feature is disabled, and non-`Copy` types cannot be dropped in `const` context. Use [`new_with`](struct.MaybeLocation.html#method.new_with "associated function bevy::ecs::change_detection::MaybeLocation::new_with") if you need to construct a non-`Copy` value.

##### See also

*   [`new_with`](struct.MaybeLocation.html#method.new_with "associated function bevy::ecs::change_detection::MaybeLocation::new_with") to initialize using a closure.
*   [`new_with_flattened`](struct.MaybeLocation.html#method.new_with_flattened "associated function bevy::ecs::change_detection::MaybeLocation::new_with_flattened") to initialize using a closure that returns an `Option<MaybeLocation<T>>`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#68)

#### pub fn [new\_with](#method.new_with)(\_f: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")() -> T) -> [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>

Constructs a new `MaybeLocation` that wraps the result of the given closure.

##### See also

*   [`new`](struct.MaybeLocation.html#method.new "associated function bevy::ecs::change_detection::MaybeLocation::new") to initialize using a value.
*   [`new_with_flattened`](struct.MaybeLocation.html#method.new_with_flattened "associated function bevy::ecs::change_detection::MaybeLocation::new_with_flattened") to initialize using a closure that returns an `Option<MaybeLocation<T>>`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#78)

#### pub fn [map](#method.map)<U>(self, \_f: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")(T) -> U) -> [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<U>

Maps an `MaybeLocation<T>` to `MaybeLocation<U>` by applying a function to a contained value.

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/ecs/component\_hooks.rs ([line 90](../../../src/component_hooks/component_hooks.rs.html#90))
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#88)

#### pub fn [zip](#method.zip)<U>(self, \_other: [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<U>) -> [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<[(T, U)](https://doc.rust-lang.org/nightly/std/primitive.tuple.html)\>

Converts a pair of `MaybeLocation` values to an `MaybeLocation` of a tuple.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#100-102)

#### pub fn [unwrap\_or\_default](#method.unwrap_or_default)(self) -> T
...
examples/ecs/component\_hooks.rs ([line 91](../../../src/component_hooks/component_hooks.rs.html#91))
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#111)

#### pub fn [into\_option](#method.into_option)(self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<T>

Converts an `MaybeLocation` to an [`Option`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option") to allow run-time branching. If the `track_location` feature is enabled, this always returns `Some`. If it is disabled, this always returns `None`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#123)

### impl<T> [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<T>>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#131)

#### pub fn [new\_with\_flattened](#method.new_with_flattened)( \_f: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")() -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>>, ) -> [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<T>>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#173)

#### pub fn [transpose](#method.transpose)(self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>>

Transposes a `MaybeLocation` of an [`Option`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option") into an [`Option`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option") of a `MaybeLocation`.
...
*   [`into_option`](struct.MaybeLocation.html#method.into_option "method bevy::ecs::change_detection::MaybeLocation::into_option") to convert to an `Option<Option<T>>`. When used with [`Option::flatten`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#method.flatten "method core::option::Option::flatten"), this will have a similar effect, but will return `None` when the `track_location` feature is disabled.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#190)

### impl<T> [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<[&T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#193-195)

#### pub const fn [copied](#method.copied)(&self) -> [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>

where T: [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy"),

Maps an `MaybeLocation<&T>` to an `MaybeLocation<T>` by copying the contents.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#205)

### impl<T> [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<[&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#208-210)

#### pub const fn [copied](#method.copied-1)(&self) -> [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>

where T: [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy"),

Maps an `MaybeLocation<&mut T>` to an `MaybeLocation<T>` by copying the contents.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#221)

#### pub fn [assign](#method.assign)(&mut self, \_value: [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>)

Assigns the contents of an `MaybeLocation<T>` to an `MaybeLocation<&mut T>`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#229)

### impl<T> [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#232)

#### pub const fn [as\_ref](#method.as_ref)(&self) -> [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<[&T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\>

Converts from `&MaybeLocation<T>` to `MaybeLocation<&T>`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#242)

#### pub const fn [as\_mut](#method.as_mut)(&mut self) -> [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<[&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\>

Converts from `&mut MaybeLocation<T>` to `MaybeLocation<&mut T>`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#252-254)

#### pub fn [as\_deref](#method.as_deref)(&self) -> [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<&<T as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")\>

where T: [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref"),

Converts from `&MaybeLocation<T>` to `MaybeLocation<&T::Target>`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#265-267)

#### pub fn [as\_deref\_mut](#method.as_deref_mut)(&mut self) -> [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<&mut <T as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")\>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#277)

### impl [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#283)

#### pub const fn [caller](#method.caller)() -> [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#21)

### impl<T> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>

where T: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") + ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#21)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>
...
### impl<T> [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>

where T: [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") + ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#21)

### impl<T> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#29)

### impl<T> [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>

where T: [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#30)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html#tymethod.fmt)(&self, \_f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")\>

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html#tymethod.fmt)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#21)

### impl<T> [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>

where T: [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") + ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#20)

### impl<T> [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>

where [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>: [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"), T: [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") + [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") + MaybeTyped + RegisterForReflection + ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#20)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#20)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T> as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#20)

### impl<T> [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>

where [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>: [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"), T: [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") + [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") + MaybeTyped + RegisterForReflection + ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#20)

#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>>
...
### impl<T> [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>
...
### impl<T> [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>
...
### impl<T> [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>

where T: [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") + ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),
...
### impl<T> [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>
...
where [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>: 'into\_return,
...
### impl<T> [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>

where T: [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") + ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#21)

#### fn [cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html#tymethod.cmp)(&self, other: &[MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")
...
### impl<T> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>

where T: [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") + ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#21)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl<T> [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>

where T: [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") + ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#21)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")\>
...
### impl<T> [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#20)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
### impl<T> [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>

where [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>: [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"), T: [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") + [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") + MaybeTyped + RegisterForReflection + ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#20)

#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<T> [Struct](../../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>
...
### impl<T> [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>

where T: [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") + ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/change_detection/maybe_location.rs.html#20)

### impl<T> [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>
...
### impl<T> [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>
...
### impl<T> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>

where T: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") + ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

### impl<T> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>
...
### impl<T> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>
...
### impl<T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>
...
### impl<T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>
...
### impl<T> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>
...
### impl<T> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MaybeLocation](struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<T>

where T: [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") + ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),
