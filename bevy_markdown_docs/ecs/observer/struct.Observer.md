...
When entities are observed, they will receive an [`ObservedBy`](struct.ObservedBy.html "struct bevy::ecs::observer::ObservedBy") component, which will be updated to track the observers that are currently observing them.
...
#### pub fn [descriptor](#method.descriptor)(&self) -> &[ObserverDescriptor](struct.ObserverDescriptor.html "struct bevy::ecs::observer::ObserverDescriptor")

Returns the [`ObserverDescriptor`](struct.ObserverDescriptor.html "struct bevy::ecs::observer::ObserverDescriptor") for this [`Observer`](../../prelude/struct.Observer.html "struct bevy::prelude::Observer").
...
#### fn [into\_observer](trait.IntoObserver.html#tymethod.into_observer)(self) -> [Observer](../../prelude/struct.Observer.html "struct bevy::prelude::Observer")
