...
#### fn [run\_if](#method.run_if)<C, CM>(self, condition: C) -> [ObserverWithCondition](struct.ObserverWithCondition.html "struct bevy::ecs::observer::ObserverWithCondition")<E, B, M, Self>
