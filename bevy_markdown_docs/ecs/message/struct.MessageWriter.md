...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/message_writer.rs.html#62)
...
This system parameter takes exclusive access to the [`Messages<T>`](../../prelude/struct.Messages.html "struct bevy::prelude::Messages") resource, so a system cannot also have a [`MessageReader`](../../prelude/struct.MessageReader.html "struct bevy::prelude::MessageReader") parameter of the same type. If you need to both read and write messages of the same type, use [`MessageMutator`](../../prelude/struct.MessageMutator.html "struct bevy::prelude::MessageMutator").

## Usage

`MessageWriter`s are usually declared as a [`SystemParam`](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam").
...
`MessageWriter` param has [`ResMut<Messages<T>>`](../../prelude/struct.Messages.html "struct bevy::prelude::Messages") inside. So two systems declaring `MessageWriter<T>` params for the same message type won’t be executed concurrently.
...
Note that this is considered _non-idiomatic_, and should only be used when `MessageWriter` will not work.

## Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/message_writer.rs.html#67)

### impl<'w, M> [MessageWriter](../../prelude/struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'w, M>

where M: [Message](../../prelude/trait.Message.html "trait bevy::prelude::Message"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/message_writer.rs.html#74)
...
examples/remote/app\_under\_test.rs ([line 45](../../../src/app_under_test/app_under_test.rs.html#45))
...
examples/app/custom\_loop.rs ([line 38](../../../src/custom_loop/custom_loop.rs.html#38))
...
examples/ecs/extraction.rs ([line 107](../../../src/extraction/extraction.rs.html#107))
...
examples/async\_tasks/external\_source\_external\_thread.rs ([line 49](../../../src/external_source_external_thread/external_source_external_thread.rs.html#49))
...
examples/ecs/message.rs ([line 47](../../../src/message/message.rs.html#47))
...
examples/2d/dynamic\_mip\_generation.rs ([line 323](../../../src/dynamic_mip_generation/dynamic_mip_generation.rs.html#323))
...
*   [examples/3d/../helpers/widgets.rs](../../../src/clustered_decal_maps/helpers/widgets.rs.html#175)
*   [examples/ecs/ecs\_guide.rs](../../../src/ecs_guide/ecs_guide.rs.html#171)
*   [examples/audio/pitch.rs](../../../src/pitch/pitch.rs.html#53)
*   [examples/ecs/observer\_propagation.rs](../../../src/observer_propagation/observer_propagation.rs.html#118)
*   [examples/showcase/desk\_toy.rs](../../../src/desk_toy/desk_toy.rs.html#319)
*   [examples/3d/mixed\_lighting.rs](../../../src/mixed_lighting/mixed_lighting.rs.html#179)
*   [examples/ui/styling/box\_shadow.rs](../../../src/box_shadow/box_shadow.rs.html#605)
*   [examples/picking/custom\_hit\_data.rs](../../../src/custom_hit_data/custom_hit_data.rs.html#152)
*   [examples/showcase/game\_menu.rs](../../../src/game_menu/game_menu.rs.html#707)
*   [examples/input/gamepad\_rumble.rs](../../../src/gamepad_rumble/gamepad_rumble.rs.html#26-30)
*   [examples/ui/layout/size\_constraints.rs](../../../src/size_constraints/size_constraints.rs.html#272)
*   [examples/ui/render\_ui\_to\_texture.rs](../../../src/render_ui_to_texture/render_ui_to_texture.rs.html#207-216)
*   [examples/window/low\_power.rs](../../../src/low_power/low_power.rs.html#90)
*   [examples/app/headless\_renderer.rs](../../../src/headless_renderer/headless_renderer.rs.html#516)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/message_writer.rs.html#85)
...
examples/app/log\_layers\_ecs.rs ([line 58](../../../src/log_layers_ecs/log_layers_ecs.rs.html#58))
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/message_writer.rs.html#95-97)
...
examples/ecs/message.rs ([line 105](../../../src/message/message.rs.html#105))
...
### impl<'w, 's, M> [ReadOnlySystemParam](../system/trait.ReadOnlySystemParam.html "trait bevy::ecs::system::ReadOnlySystemParam") for [MessageWriter](../../prelude/struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'w, M>

where M: [Message](../../prelude/trait.Message.html "trait bevy::prelude::Message"), [ResMut](../../prelude/struct.ResMut.html "struct bevy::prelude::ResMut")<'w, [Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>>: [ReadOnlySystemParam](../system/trait.ReadOnlySystemParam.html "trait bevy::ecs::system::ReadOnlySystemParam"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/message_writer.rs.html#61)

### impl<M> [SystemParam](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam") for [MessageWriter](../../prelude/struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'\_, M>
...
#### type [Item](../system/trait.SystemParam.html#associatedtype.Item)<'w, 's> = [MessageWriter](../../prelude/struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'w, M>
...
#### fn [init\_state](../system/trait.SystemParam.html#tymethod.init_state)(world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World")) -> <[MessageWriter](../../prelude/struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'\_, M> as [SystemParam](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](../system/trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State")
...
#### unsafe fn [get\_param](../system/trait.SystemParam.html#tymethod.get_param)<'w, 's>( state: &'s mut <[MessageWriter](../../prelude/struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'\_, M> as [SystemParam](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](../system/trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State"), system\_meta: &[SystemMeta](../system/struct.SystemMeta.html "struct bevy::ecs::system::SystemMeta"), world: [UnsafeWorldCell](../world/unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'w>, change\_tick: [Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[MessageWriter](../../prelude/struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'\_, M> as [SystemParam](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[Item](../system/trait.SystemParam.html#associatedtype.Item "type bevy::ecs::system::SystemParam::Item")<'w, 's>, [SystemParamValidationError](../system/struct.SystemParamValidationError.html "struct bevy::ecs::system::SystemParamValidationError")\>
...
### impl<'w, M> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MessageWriter](../../prelude/struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'w, M>

### impl<'w, M> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MessageWriter](../../prelude/struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'w, M>

### impl<'w, M> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MessageWriter](../../prelude/struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'w, M>
...
### impl<'w, M> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MessageWriter](../../prelude/struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'w, M>

### impl<'w, M> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MessageWriter](../../prelude/struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'w, M>

### impl<'w, M> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MessageWriter](../../prelude/struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'w, M>

### impl<'w, M> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MessageWriter](../../prelude/struct.MessageWriter.html "struct bevy::prelude::MessageWriter")<'w, M>
