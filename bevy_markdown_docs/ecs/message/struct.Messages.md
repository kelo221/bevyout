...
#### pub fn [write](#method.write)(&mut self, message: M) -> [MessageId](struct.MessageId.html "struct bevy::ecs::message::MessageId")<M>

Writes an `message` to the current message buffer. [`MessageReader`](../../prelude/struct.MessageReader.html "struct bevy::prelude::MessageReader")s can then read the message. This method returns the [ID](struct.MessageId.html "struct bevy::ecs::message::MessageId") of the written `message`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#153)

#### pub fn [write\_batch](#method.write_batch)( &mut self, messages: impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = M>, ) -> [WriteBatchIds](struct.WriteBatchIds.html "struct bevy::ecs::message::WriteBatchIds")<M> [ⓘ](#)

Writes a list of `messages` all at once, which can later be read by [`MessageReader`](../../prelude/struct.MessageReader.html "struct bevy::prelude::MessageReader")s. This is more efficient than writing each message individually. This method returns the [IDs](struct.MessageId.html "struct bevy::ecs::message::MessageId") of the written `messages`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#168-170)

#### pub fn [write\_default](#method.write_default)(&mut self) -> [MessageId](struct.MessageId.html "struct bevy::ecs::message::MessageId")<M>

where M: [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default"),

Writes the default value of the message. Useful when the message is an empty struct. This method returns the [ID](struct.MessageId.html "struct bevy::ecs::message::MessageId") of the written `message`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#176)

#### pub fn [get\_cursor](#method.get_cursor)(&self) -> [MessageCursor](struct.MessageCursor.html "struct bevy::ecs::message::MessageCursor")<M>

Gets a new [`MessageCursor`](struct.MessageCursor.html "struct bevy::ecs::message::MessageCursor"). This will include all messages already in the message buffers.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#182)

#### pub fn [get\_cursor\_current](#method.get_cursor_current)(&self) -> [MessageCursor](struct.MessageCursor.html "struct bevy::ecs::message::MessageCursor")<M>

Gets a new [`MessageCursor`](struct.MessageCursor.html "struct bevy::ecs::message::MessageCursor"). This will ignore all messages already in the message buffers. It will read all future messages.
...
#### pub fn [get\_message](#method.get_message)(&self, id: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<([&M](https://doc.rust-lang.org/nightly/std/primitive.reference.html), [MessageId](struct.MessageId.html "struct bevy::ecs::message::MessageId")<M>)>
