...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/message_registry.rs.html#23)
...
`should_update: [ShouldUpdateMessages](enum.ShouldUpdateMessages.html "enum bevy::ecs::message::ShouldUpdateMessages")`

Should the messages be updated?

This field is generally automatically updated by the [`signal_message_update_system`](fn.signal_message_update_system.html "fn bevy::ecs::message::signal_message_update_system").

## Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/message_registry.rs.html#43)

### impl [MessageRegistry](struct.MessageRegistry.html "struct bevy::ecs::message::MessageRegistry")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/message_registry.rs.html#48)

#### pub fn [register\_message](#method.register_message)<T>(world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World"))

where T: [Message](../../prelude/trait.Message.html "trait bevy::prelude::Message"),

Registers a message type to be updated in a given [`World`](../../prelude/struct.World.html "struct bevy::prelude::World")

If no instance of the [`MessageRegistry`](struct.MessageRegistry.html "struct bevy::ecs::message::MessageRegistry") exists in the world, this will add one - otherwise it will use the existing instance.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/message_registry.rs.html#66)

#### pub fn [run\_updates](#method.run_updates)(&mut self, world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World"), last\_change\_tick: [Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"))

Updates all of the registered messages in the World.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/message_registry.rs.html#87)

#### pub fn [deregister\_messages](#method.deregister_messages)<T>(world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World"))

where T: [Message](../../prelude/trait.Message.html "trait bevy::prelude::Message"),

Removes a message from the world and its associated [`MessageRegistry`](struct.MessageRegistry.html "struct bevy::ecs::message::MessageRegistry").

## Trait Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/message_registry.rs.html#22)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [MessageRegistry](struct.MessageRegistry.html "struct bevy::ecs::message::MessageRegistry")

where [MessageRegistry](struct.MessageRegistry.html "struct bevy::ecs::message::MessageRegistry"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [MessageRegistry](struct.MessageRegistry.html "struct bevy::ecs::message::MessageRegistry")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/message_registry.rs.html#22)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [MessageRegistry](struct.MessageRegistry.html "struct bevy::ecs::message::MessageRegistry")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/message_registry.rs.html#22)

### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [MessageRegistry](struct.MessageRegistry.html "struct bevy::ecs::message::MessageRegistry")

where [MessageRegistry](struct.MessageRegistry.html "struct bevy::ecs::message::MessageRegistry"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MessageRegistry](struct.MessageRegistry.html "struct bevy::ecs::message::MessageRegistry")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MessageRegistry](struct.MessageRegistry.html "struct bevy::ecs::message::MessageRegistry")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MessageRegistry](struct.MessageRegistry.html "struct bevy::ecs::message::MessageRegistry")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MessageRegistry](struct.MessageRegistry.html "struct bevy::ecs::message::MessageRegistry")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MessageRegistry](struct.MessageRegistry.html "struct bevy::ecs::message::MessageRegistry")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MessageRegistry](struct.MessageRegistry.html "struct bevy::ecs::message::MessageRegistry")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MessageRegistry](struct.MessageRegistry.html "struct bevy::ecs::message::MessageRegistry")
