...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/par_iter.rs.html#16)

```rust
pub struct QueryParIter<'w, 's, D, F>where
    D: IterQueryData,
...
This struct is created by the [`Query::par_iter`](../../prelude/struct.Query.html#method.par_iter "method bevy::prelude::Query::par_iter") and [`Query::par_iter_mut`](../../prelude/struct.Query.html#method.par_iter_mut "method bevy::prelude::Query::par_iter_mut") methods.

## Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/par_iter.rs.html#24)

### impl<'w, 's, D, F> [QueryParIter](struct.QueryParIter.html "struct bevy::ecs::query::QueryParIter")<'w, 's, D, F>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/par_iter.rs.html#29)

#### pub fn [batching\_strategy](#method.batching_strategy)( self, strategy: [BatchingStrategy](../batching/struct.BatchingStrategy.html "struct bevy::ecs::batching::BatchingStrategy"), ) -> [QueryParIter](struct.QueryParIter.html "struct bevy::ecs::query::QueryParIter")<'w, 's, D, F>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/par_iter.rs.html#42)
...
examples/stress\_tests/bevymark\_3d.rs ([lines 451-453](../../../src/bevymark_3d/bevymark_3d.rs.html#451-453))
...
examples/stress\_tests/many\_cubes.rs ([lines 602-604](../../../src/many_cubes/many_cubes.rs.html#602-604))
...
examples/ecs/parallel\_query.rs ([lines 39-41](../../../src/parallel_query/parallel_query.rs.html#39-41))
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/par_iter.rs.html#77-80)
...
### impl<'w, 's, D, F> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [QueryParIter](struct.QueryParIter.html "struct bevy::ecs::query::QueryParIter")<'w, 's, D, F>

### impl<'w, 's, D, F> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [QueryParIter](struct.QueryParIter.html "struct bevy::ecs::query::QueryParIter")<'w, 's, D, F>

### impl<'w, 's, D, F> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [QueryParIter](struct.QueryParIter.html "struct bevy::ecs::query::QueryParIter")<'w, 's, D, F>

### impl<'w, 's, D, F> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [QueryParIter](struct.QueryParIter.html "struct bevy::ecs::query::QueryParIter")<'w, 's, D, F>

### impl<'w, 's, D, F> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [QueryParIter](struct.QueryParIter.html "struct bevy::ecs::query::QueryParIter")<'w, 's, D, F>

### impl<'w, 's, D, F> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [QueryParIter](struct.QueryParIter.html "struct bevy::ecs::query::QueryParIter")<'w, 's, D, F>

### impl<'w, 's, D, F> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [QueryParIter](struct.QueryParIter.html "struct bevy::ecs::query::QueryParIter")<'w, 's, D, F>
