...
#### pub fn [extend\_access](#method.extend_access)(&mut self, access: [FilteredAccess](struct.FilteredAccess.html "struct bevy::ecs::query::FilteredAccess"))

Adds access to self’s underlying [`FilteredAccess`](struct.FilteredAccess.html "struct bevy::ecs::query::FilteredAccess") respecting [`Self::or`](../../prelude/struct.QueryBuilder.html#method.or "method bevy::prelude::QueryBuilder::or") and [`Self::and`](../../prelude/struct.QueryBuilder.html#method.and "method bevy::prelude::QueryBuilder::and")
...
where T: [QueryFilter](trait.QueryFilter.html "trait bevy::ecs::query::QueryFilter"),
...
Adds [`With<T>`](../../prelude/struct.With.html "struct bevy::prelude::With") to the [`FilteredAccess`](struct.FilteredAccess.html "struct bevy::ecs::query::FilteredAccess") of self.
...
Adds [`With<T>`](../../prelude/struct.With.html "struct bevy::prelude::With") to the [`FilteredAccess`](struct.FilteredAccess.html "struct bevy::ecs::query::FilteredAccess") of self from a runtime [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId").
...
Adds [`Without<T>`](../../prelude/struct.Without.html "struct bevy::prelude::Without") to the [`FilteredAccess`](struct.FilteredAccess.html "struct bevy::ecs::query::FilteredAccess") of self.
...
Adds [`Without<T>`](../../prelude/struct.Without.html "struct bevy::prelude::Without") to the [`FilteredAccess`](struct.FilteredAccess.html "struct bevy::ecs::query::FilteredAccess") of self from a runtime [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId").
...
Adds `&T` to the [`FilteredAccess`](struct.FilteredAccess.html "struct bevy::ecs::query::FilteredAccess") of self.
...
Adds `&mut T` to the [`FilteredAccess`](struct.FilteredAccess.html "struct bevy::ecs::query::FilteredAccess") of self.
...
#### pub fn [access](#method.access)(&self) -> &[FilteredAccess](struct.FilteredAccess.html "struct bevy::ecs::query::FilteredAccess")

Returns a reference to the [`FilteredAccess`](struct.FilteredAccess.html "struct bevy::ecs::query::FilteredAccess") that will be provided to the built [`Query`](../../prelude/struct.Query.html "struct bevy::prelude::Query").
...
where NewD: [QueryData](trait.QueryData.html "trait bevy::ecs::query::QueryData"),
...
where NewD: [QueryData](trait.QueryData.html "trait bevy::ecs::query::QueryData"), NewF: [QueryFilter](trait.QueryFilter.html "trait bevy::ecs::query::QueryFilter"),
