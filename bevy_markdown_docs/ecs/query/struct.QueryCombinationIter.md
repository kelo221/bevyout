...
# Struct QueryCombinationIter 

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/iter.rs.html#2548)

```rust
pub struct QueryCombinationIter<'w, 's, D, F, const K: usize>where
    D: IterQueryData,
...
`K` is the number of items that make up each subset, and the number of items returned by the iterator. `N` is the number of total entities output by the query.
...
The number of combinations depend on how `K` relates to the number of entities matching the [`Query`](../../prelude/struct.Query.html "struct bevy::prelude::Query"):

*   if `K = N`, only one combination exists,
*   if `K < N`, there are NCK combinations (see the [performance section](../../prelude/struct.Query.html#performance "struct bevy::prelude::Query") of `Query`),
...
This type is returned by calling [`Query::iter_combinations`](../../prelude/struct.Query.html#method.iter_combinations "method bevy::prelude::Query::iter_combinations") or [`Query::iter_combinations_mut`](../../prelude/struct.Query.html#method.iter_combinations_mut "method bevy::prelude::Query::iter_combinations_mut").

It implements [`Iterator`](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator") only if it iterates over read-only query items ([learn more](struct.QueryCombinationIter.html#impl-Iterator "struct bevy::ecs::query::QueryCombinationIter")).

In the case of mutable query items, it can be iterated by calling [`fetch_next`](struct.QueryCombinationIter.html#method.fetch_next "method bevy::ecs::query::QueryCombinationIter::fetch_next") in a `while let` loop.
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/iter.rs.html#2555-2556)

### impl<'w, 's, D, F, const K: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> [QueryCombinationIter](struct.QueryCombinationIter.html "struct bevy::ecs::query::QueryCombinationIter")<'w, 's, D, F, K>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/iter.rs.html#2645)

#### pub fn [fetch\_next](#method.fetch_next)(&mut self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<\[<D as [QueryData](trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'\_, 's>; [K](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]>

Get next combination of queried components

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/ecs/iter\_combinations.rs ([line 125](../../../src/iter_combinations/iter_combinations.rs.html#125))
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/iter.rs.html#2716-2717)

### impl<'w, 's, D, F, const K: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [QueryCombinationIter](struct.QueryCombinationIter.html "struct bevy::ecs::query::QueryCombinationIter")<'w, 's, D, F, K>

where D: [IterQueryData](trait.IterQueryData.html "trait bevy::ecs::query::IterQueryData"), F: [QueryFilter](trait.QueryFilter.html "trait bevy::ecs::query::QueryFilter"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/iter.rs.html#2719)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")\>

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/iter.rs.html#2711-2712)

### impl<'w, 's, D, F, const K: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> [FusedIterator](https://doc.rust-lang.org/nightly/core/iter/traits/marker/trait.FusedIterator.html "trait core::iter::traits::marker::FusedIterator") for [QueryCombinationIter](struct.QueryCombinationIter.html "struct bevy::ecs::query::QueryCombinationIter")<'w, 's, D, F, K>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/iter.rs.html#2659-2660)

### impl<'w, 's, D, F, const K: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator") for [QueryCombinationIter](struct.QueryCombinationIter.html "struct bevy::ecs::query::QueryCombinationIter")<'w, 's, D, F, K>

where D: [ReadOnlyQueryData](trait.ReadOnlyQueryData.html "trait bevy::ecs::query::ReadOnlyQueryData"), F: [QueryFilter](trait.QueryFilter.html "trait bevy::ecs::query::QueryFilter"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/iter.rs.html#2662)

#### type [Item](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#associatedtype.Item) = \[<D as [QueryData](trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'w, 's>; [K](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]

The type of the elements being iterated over.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/iter.rs.html#2665)

#### fn [next](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#tymethod.next)( &mut self, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[QueryCombinationIter](struct.QueryCombinationIter.html "struct bevy::ecs::query::QueryCombinationIter")<'w, 's, D, F, K> as [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")\>::[Item](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#associatedtype.Item "type core::iter::traits::iterator::Iterator::Item")\>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/iter.rs.html#2670)
...
### impl<'w, 's, D, F, const K: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [QueryCombinationIter](struct.QueryCombinationIter.html "struct bevy::ecs::query::QueryCombinationIter")<'w, 's, D, F, K>

### impl<'w, 's, D, F, const K: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [QueryCombinationIter](struct.QueryCombinationIter.html "struct bevy::ecs::query::QueryCombinationIter")<'w, 's, D, F, K>

### impl<'w, 's, D, F, const K: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [QueryCombinationIter](struct.QueryCombinationIter.html "struct bevy::ecs::query::QueryCombinationIter")<'w, 's, D, F, K>

### impl<'w, 's, D, F, const K: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [QueryCombinationIter](struct.QueryCombinationIter.html "struct bevy::ecs::query::QueryCombinationIter")<'w, 's, D, F, K>

### impl<'w, 's, D, F, const K: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [QueryCombinationIter](struct.QueryCombinationIter.html "struct bevy::ecs::query::QueryCombinationIter")<'w, 's, D, F, K>
...
### impl<'w, 's, D, F, const K: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [QueryCombinationIter](struct.QueryCombinationIter.html "struct bevy::ecs::query::QueryCombinationIter")<'w, 's, D, F, K>
...
### impl<'w, 's, D, F, const K: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [QueryCombinationIter](struct.QueryCombinationIter.html "struct bevy::ecs::query::QueryCombinationIter")<'w, 's, D, F, K>
