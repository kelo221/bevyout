...
# Struct QueryContiguousIter 

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/iter.rs.html#1139)

```rust
pub struct QueryContiguousIter<'w, 's, D, F>where
    D: ContiguousQueryData,
    F: ArchetypeFilter,{ /* private fields */ }
```
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/iter.rs.html#1218-1219)

### impl<'w, 's, D, F> [FusedIterator](https://doc.rust-lang.org/nightly/core/iter/traits/marker/trait.FusedIterator.html "trait core::iter::traits::marker::FusedIterator") for [QueryContiguousIter](struct.QueryContiguousIter.html "struct bevy::ecs::query::QueryContiguousIter")<'w, 's, D, F>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/iter.rs.html#1168-1169)

### impl<'w, 's, D, F> [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator") for [QueryContiguousIter](struct.QueryContiguousIter.html "struct bevy::ecs::query::QueryContiguousIter")<'w, 's, D, F>

where D: [ContiguousQueryData](trait.ContiguousQueryData.html "trait bevy::ecs::query::ContiguousQueryData"), F: [ArchetypeFilter](trait.ArchetypeFilter.html "trait bevy::ecs::query::ArchetypeFilter"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/iter.rs.html#1171)

#### type [Item](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#associatedtype.Item) = <D as [ContiguousQueryData](trait.ContiguousQueryData.html "trait bevy::ecs::query::ContiguousQueryData")\>::[Contiguous](trait.ContiguousQueryData.html#associatedtype.Contiguous "type bevy::ecs::query::ContiguousQueryData::Contiguous")<'w, 's>

The type of the elements being iterated over.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/iter.rs.html#1174)

#### fn [next](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#tymethod.next)( &mut self, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[QueryContiguousIter](struct.QueryContiguousIter.html "struct bevy::ecs::query::QueryContiguousIter")<'w, 's, D, F> as [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")\>::[Item](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#associatedtype.Item "type core::iter::traits::iterator::Iterator::Item")\>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/iter.rs.html#1212)
...
### impl<'w, 's, D, F> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [QueryContiguousIter](struct.QueryContiguousIter.html "struct bevy::ecs::query::QueryContiguousIter")<'w, 's, D, F>

### impl<'w, 's, D, F> ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [QueryContiguousIter](struct.QueryContiguousIter.html "struct bevy::ecs::query::QueryContiguousIter")<'w, 's, D, F>

### impl<'w, 's, D, F> ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [QueryContiguousIter](struct.QueryContiguousIter.html "struct bevy::ecs::query::QueryContiguousIter")<'w, 's, D, F>

### impl<'w, 's, D, F> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [QueryContiguousIter](struct.QueryContiguousIter.html "struct bevy::ecs::query::QueryContiguousIter")<'w, 's, D, F>

### impl<'w, 's, D, F> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [QueryContiguousIter](struct.QueryContiguousIter.html "struct bevy::ecs::query::QueryContiguousIter")<'w, 's, D, F>

where <D as [WorldQuery](trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'w>: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"),

### impl<'w, 's, D, F> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [QueryContiguousIter](struct.QueryContiguousIter.html "struct bevy::ecs::query::QueryContiguousIter")<'w, 's, D, F>

where <D as [WorldQuery](trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'w>: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<'w, 's, D, F> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [QueryContiguousIter](struct.QueryContiguousIter.html "struct bevy::ecs::query::QueryContiguousIter")<'w, 's, D, F>

where <D as [WorldQuery](trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'w>: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"),
