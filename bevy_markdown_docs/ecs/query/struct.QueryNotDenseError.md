...
# Struct QueryNotDenseError 

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/error.rs.html#43)
...
`0: [DebugName](../../prelude/struct.DebugName.html "struct bevy::prelude::DebugName")`

## Trait Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/error.rs.html#41)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [QueryNotDenseError](struct.QueryNotDenseError.html "struct bevy::ecs::query::QueryNotDenseError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [QueryNotDenseError](struct.QueryNotDenseError.html "struct bevy::ecs::query::QueryNotDenseError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [QueryNotDenseError](struct.QueryNotDenseError.html "struct bevy::ecs::query::QueryNotDenseError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [QueryNotDenseError](struct.QueryNotDenseError.html "struct bevy::ecs::query::QueryNotDenseError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [QueryNotDenseError](struct.QueryNotDenseError.html "struct bevy::ecs::query::QueryNotDenseError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [QueryNotDenseError](struct.QueryNotDenseError.html "struct bevy::ecs::query::QueryNotDenseError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [QueryNotDenseError](struct.QueryNotDenseError.html "struct bevy::ecs::query::QueryNotDenseError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [QueryNotDenseError](struct.QueryNotDenseError.html "struct bevy::ecs::query::QueryNotDenseError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [QueryNotDenseError](struct.QueryNotDenseError.html "struct bevy::ecs::query::QueryNotDenseError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [QueryNotDenseError](struct.QueryNotDenseError.html "struct bevy::ecs::query::QueryNotDenseError")
