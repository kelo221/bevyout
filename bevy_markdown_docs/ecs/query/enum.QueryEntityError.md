...
# Enum QueryEntityError 

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/error.rs.html#11)
...
### QueryDoesNotMatch([Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), [ArchetypeId](../archetype/struct.ArchetypeId.html "struct bevy::ecs::archetype::ArchetypeId"))

The given [`Entity`](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")’s components do not match the query.
...
The given [`Entity`](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") is not spawned.

### AliasedMutability([Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"))

The [`Entity`](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") was requested mutably more than once.

See [`Query::get_many_mut`](../../prelude/struct.Query.html#method.get_many_mut "method bevy::prelude::Query::get_many_mut") for an example.

## Trait Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/error.rs.html#10)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [QueryEntityError](enum.QueryEntityError.html "enum bevy::ecs::query::QueryEntityError")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/error.rs.html#10)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [QueryEntityError](enum.QueryEntityError.html "enum bevy::ecs::query::QueryEntityError")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [QueryEntityError](enum.QueryEntityError.html "enum bevy::ecs::query::QueryEntityError")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/error.rs.html#10)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [QueryEntityError](enum.QueryEntityError.html "enum bevy::ecs::query::QueryEntityError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [QueryEntityError](enum.QueryEntityError.html "enum bevy::ecs::query::QueryEntityError")
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [QueryEntityError](enum.QueryEntityError.html "enum bevy::ecs::query::QueryEntityError")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/error.rs.html#10)

### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [QueryEntityError](enum.QueryEntityError.html "enum bevy::ecs::query::QueryEntityError")
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[EntityNotSpawnedError](../entity/enum.EntityNotSpawnedError.html "enum bevy::ecs::entity::EntityNotSpawnedError")\> for [QueryEntityError](enum.QueryEntityError.html "enum bevy::ecs::query::QueryEntityError")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/error.rs.html#10)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(source: [EntityNotSpawnedError](../entity/enum.EntityNotSpawnedError.html "enum bevy::ecs::entity::EntityNotSpawnedError")) -> [QueryEntityError](enum.QueryEntityError.html "enum bevy::ecs::query::QueryEntityError")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/error.rs.html#10)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [QueryEntityError](enum.QueryEntityError.html "enum bevy::ecs::query::QueryEntityError")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/error.rs.html#10)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[QueryEntityError](enum.QueryEntityError.html "enum bevy::ecs::query::QueryEntityError")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [QueryEntityError](enum.QueryEntityError.html "enum bevy::ecs::query::QueryEntityError")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [QueryEntityError](enum.QueryEntityError.html "enum bevy::ecs::query::QueryEntityError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [QueryEntityError](enum.QueryEntityError.html "enum bevy::ecs::query::QueryEntityError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [QueryEntityError](enum.QueryEntityError.html "enum bevy::ecs::query::QueryEntityError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [QueryEntityError](enum.QueryEntityError.html "enum bevy::ecs::query::QueryEntityError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [QueryEntityError](enum.QueryEntityError.html "enum bevy::ecs::query::QueryEntityError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [QueryEntityError](enum.QueryEntityError.html "enum bevy::ecs::query::QueryEntityError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [QueryEntityError](enum.QueryEntityError.html "enum bevy::ecs::query::QueryEntityError")
