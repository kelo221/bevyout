...
# Struct AccessConflictError 

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/access_iter.rs.html#207)

```rust
pub struct AccessConflictError<'a>(/* private fields */);
```
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/access_iter.rs.html#209)

### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [AccessConflictError](struct.AccessConflictError.html "struct bevy::ecs::query::AccessConflictError")<'\_>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/access_iter.rs.html#210)
...
### impl<'a> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AccessConflictError](struct.AccessConflictError.html "struct bevy::ecs::query::AccessConflictError")<'a>

### impl<'a> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AccessConflictError](struct.AccessConflictError.html "struct bevy::ecs::query::AccessConflictError")<'a>

### impl<'a> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AccessConflictError](struct.AccessConflictError.html "struct bevy::ecs::query::AccessConflictError")<'a>

### impl<'a> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AccessConflictError](struct.AccessConflictError.html "struct bevy::ecs::query::AccessConflictError")<'a>

### impl<'a> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AccessConflictError](struct.AccessConflictError.html "struct bevy::ecs::query::AccessConflictError")<'a>

### impl<'a> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AccessConflictError](struct.AccessConflictError.html "struct bevy::ecs::query::AccessConflictError")<'a>

### impl<'a> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AccessConflictError](struct.AccessConflictError.html "struct bevy::ecs::query::AccessConflictError")<'a>
