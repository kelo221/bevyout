...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/event/mod.rs.html#395)
...
You can look up the key for your event by calling the [`World::event_key`](../../prelude/struct.World.html#method.event_key "method bevy::prelude::World::event_key") method.

For dynamic events not backed by a Rust type, create an `EventKey` from a [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId") using [`EventKey::new`](struct.EventKey.html#method.new "associated function bevy::ecs::event::EventKey::new"). Obtain a [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId") via [`World::register_component_with_descriptor`](../../prelude/struct.World.html#method.register_component_with_descriptor "method bevy::prelude::World::register_component_with_descriptor").

## Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/event/mod.rs.html#397)

### impl [EventKey](struct.EventKey.html "struct bevy::ecs::event::EventKey")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/event/mod.rs.html#412)

#### pub const unsafe fn [new](#method.new)(component\_id: [ComponentId](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")) -> [EventKey](struct.EventKey.html "struct bevy::ecs::event::EventKey")

Creates a new [`EventKey`](struct.EventKey.html "struct bevy::ecs::event::EventKey") from a [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId").

Useful for dynamic events not backed by a Rust type. Obtain a [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId") via [`World::register_component_with_descriptor`](../../prelude/struct.World.html#method.register_component_with_descriptor "method bevy::prelude::World::register_component_with_descriptor").

##### Safety

The caller must ensure that `component_id` was registered for use as an event (e.g. via [`World::register_component_with_descriptor`](../../prelude/struct.World.html#method.register_component_with_descriptor "method bevy::prelude::World::register_component_with_descriptor")). Using an unrelated [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId") may cause observers to receive data with an unexpected layout.

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/ecs/dynamic.rs ([line 236](../../../src/dynamic/dynamic.rs.html#236))
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/event/mod.rs.html#418)

#### pub const fn [component\_id](#method.component_id)(self) -> [ComponentId](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")

Returns the underlying [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId") for this event key.

## Trait Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/event/mod.rs.html#394)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [EventKey](struct.EventKey.html "struct bevy::ecs::event::EventKey")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/event/mod.rs.html#394)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [EventKey](struct.EventKey.html "struct bevy::ecs::event::EventKey")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [EventKey](struct.EventKey.html "struct bevy::ecs::event::EventKey")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/event/mod.rs.html#394)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [EventKey](struct.EventKey.html "struct bevy::ecs::event::EventKey")
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [EventKey](struct.EventKey.html "struct bevy::ecs::event::EventKey")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/event/mod.rs.html#394)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [EventKey](struct.EventKey.html "struct bevy::ecs::event::EventKey")
...
### impl [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [EventKey](struct.EventKey.html "struct bevy::ecs::event::EventKey")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/event/mod.rs.html#394)

#### fn [cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html#tymethod.cmp)(&self, other: &[EventKey](struct.EventKey.html "struct bevy::ecs::event::EventKey")) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [EventKey](struct.EventKey.html "struct bevy::ecs::event::EventKey")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/event/mod.rs.html#394)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[EventKey](struct.EventKey.html "struct bevy::ecs::event::EventKey")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [EventKey](struct.EventKey.html "struct bevy::ecs::event::EventKey")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/event/mod.rs.html#394)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[EventKey](struct.EventKey.html "struct bevy::ecs::event::EventKey")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")\>
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [EventKey](struct.EventKey.html "struct bevy::ecs::event::EventKey")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [EventKey](struct.EventKey.html "struct bevy::ecs::event::EventKey")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [EventKey](struct.EventKey.html "struct bevy::ecs::event::EventKey")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [EventKey](struct.EventKey.html "struct bevy::ecs::event::EventKey")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [EventKey](struct.EventKey.html "struct bevy::ecs::event::EventKey")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [EventKey](struct.EventKey.html "struct bevy::ecs::event::EventKey")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [EventKey](struct.EventKey.html "struct bevy::ecs::event::EventKey")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [EventKey](struct.EventKey.html "struct bevy::ecs::event::EventKey")
