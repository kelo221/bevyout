...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/error.rs.html#26)
...
`bundle_type: [DebugName](../../../prelude/struct.DebugName.html "struct bevy::prelude::DebugName")`
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/error.rs.html#24)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [TryInsertBatchError](struct.TryInsertBatchError.html "struct bevy::ecs::world::error::TryInsertBatchError")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/error.rs.html#24)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [TryInsertBatchError](struct.TryInsertBatchError.html "struct bevy::ecs::world::error::TryInsertBatchError")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [TryInsertBatchError](struct.TryInsertBatchError.html "struct bevy::ecs::world::error::TryInsertBatchError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [TryInsertBatchError](struct.TryInsertBatchError.html "struct bevy::ecs::world::error::TryInsertBatchError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [TryInsertBatchError](struct.TryInsertBatchError.html "struct bevy::ecs::world::error::TryInsertBatchError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TryInsertBatchError](struct.TryInsertBatchError.html "struct bevy::ecs::world::error::TryInsertBatchError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TryInsertBatchError](struct.TryInsertBatchError.html "struct bevy::ecs::world::error::TryInsertBatchError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TryInsertBatchError](struct.TryInsertBatchError.html "struct bevy::ecs::world::error::TryInsertBatchError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TryInsertBatchError](struct.TryInsertBatchError.html "struct bevy::ecs::world::error::TryInsertBatchError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TryInsertBatchError](struct.TryInsertBatchError.html "struct bevy::ecs::world::error::TryInsertBatchError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [TryInsertBatchError](struct.TryInsertBatchError.html "struct bevy::ecs::world::error::TryInsertBatchError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TryInsertBatchError](struct.TryInsertBatchError.html "struct bevy::ecs::world::error::TryInsertBatchError")
