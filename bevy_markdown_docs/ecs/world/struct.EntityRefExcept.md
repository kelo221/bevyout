...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#23)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#32-34)

### impl<'w, 's, B> [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'w, 's, B>

where B: [Bundle](../../prelude/trait.Bundle.html "trait bevy::prelude::Bundle"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#50)

#### pub fn [into\_filtered](#method.into_filtered)(self) -> [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'w, 's>

Consumes `self` and returns a [`FilteredEntityRef`](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef"), which provides read-only access to all of the entity’s components, except for the ones in `B`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#59)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#67-69)

#### pub fn [get](#method.get)<C>(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[&'w C](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#87-89)

#### pub fn [get\_ref](#method.get_ref)<C>(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ref](../../prelude/struct.Ref.html "struct bevy::prelude::Ref")<'w, C>>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#103)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#108)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#121)
...
**You should prefer to use the typed API [`Self::get`](struct.EntityRefExcept.html#method.get "method bevy::ecs::world::EntityRefExcept::get") where possible and only use this in cases where the actual component types are not known at compile time.**

Unlike [`EntityRefExcept::get`](struct.EntityRefExcept.html#method.get "method bevy::ecs::world::EntityRefExcept::get"), this returns a raw pointer to the component, which is only valid while the [`EntityRefExcept`](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept") is alive.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#139)
...
If you do not know the concrete type of a component, consider using [`Self::contains_id`](struct.EntityRefExcept.html#method.contains_id "method bevy::ecs::world::EntityRefExcept::contains_id") or [`Self::contains_type_id`](struct.EntityRefExcept.html#method.contains_type_id "method bevy::ecs::world::EntityRefExcept::contains_type_id").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#152)
...
*   If you know the concrete type of the component, you should prefer [`Self::contains`](struct.EntityRefExcept.html#method.contains "method bevy::ecs::world::EntityRefExcept::contains").
*   If you know the component’s [`TypeId`](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId") but not its [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId"), consider using [`Self::contains_type_id`](struct.EntityRefExcept.html#method.contains_type_id "method bevy::ecs::world::EntityRefExcept::contains_type_id").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#164)
...
*   If you know the concrete type of the component, you should prefer [`Self::contains`](struct.EntityRefExcept.html#method.contains "method bevy::ecs::world::EntityRefExcept::contains").
*   If you have a [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId") instead of a [`TypeId`](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId"), consider using [`Self::contains_id`](struct.EntityRefExcept.html#method.contains_id "method bevy::ecs::world::EntityRefExcept::contains_id").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#171)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#193)
...
**You should prefer to use the typed API [`Self::get_change_ticks`](struct.EntityRefExcept.html#method.get_change_ticks "method bevy::ecs::world::EntityRefExcept::get_change_ticks") where possible and only use this in cases where the actual component types are not known at compile time.**

## Trait Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#1525)

### impl<B> [ArchetypeQueryData](../query/trait.ArchetypeQueryData.html "trait bevy::ecs::query::ArchetypeQueryData") for [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'\_, '\_, B>

where B: [Bundle](../../prelude/trait.Bundle.html "trait bevy::prelude::Bundle"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#216)

### impl<B> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'\_, '\_, B>

where B: [Bundle](../../prelude/trait.Bundle.html "trait bevy::prelude::Bundle"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#217)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'\_, '\_, B>
...
### impl<B> [ContainsEntity](../../prelude/trait.ContainsEntity.html "trait bevy::prelude::ContainsEntity") for [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'\_, '\_, B>

where B: [Bundle](../../prelude/trait.Bundle.html "trait bevy::prelude::Bundle"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#253)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#222)

### impl<B> [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'\_, '\_, B>

where B: [Bundle](../../prelude/trait.Bundle.html "trait bevy::prelude::Bundle"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#259)

### impl<B> [EntityEquivalent](../entity/trait.EntityEquivalent.html "trait bevy::ecs::entity::EntityEquivalent") for [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'\_, '\_, B>

where B: [Bundle](../../prelude/trait.Bundle.html "trait bevy::prelude::Bundle"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#230)

### impl<B> [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'\_, '\_, B>

where B: [Bundle](../../prelude/trait.Bundle.html "trait bevy::prelude::Bundle"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#501)

### impl<'w, 's, B> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'w [EntityMutExcept](struct.EntityMutExcept.html "struct bevy::ecs::world::EntityMutExcept")<'\_, 's, B>> for [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'w, 's, B>

where B: [Bundle](../../prelude/trait.Bundle.html "trait bevy::prelude::Bundle"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#503)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(entity: &'w [EntityMutExcept](struct.EntityMutExcept.html "struct bevy::ecs::world::EntityMutExcept")<'\_, 's, B>) -> [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'w, 's, B>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#494)

### impl<'w, 's, B> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[EntityMutExcept](struct.EntityMutExcept.html "struct bevy::ecs::world::EntityMutExcept")<'w, 's, B>> for [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'w, 's, B>

where B: [Bundle](../../prelude/trait.Bundle.html "trait bevy::prelude::Bundle"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#496)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(entity: [EntityMutExcept](struct.EntityMutExcept.html "struct bevy::ecs::world::EntityMutExcept")<'w, 's, B>) -> [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'w, 's, B>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#246)

### impl<B> [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'\_, '\_, B>

where B: [Bundle](../../prelude/trait.Bundle.html "trait bevy::prelude::Bundle"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#247)
...
### impl<B> [IterQueryData](../query/trait.IterQueryData.html "trait bevy::ecs::query::IterQueryData") for [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'\_, '\_, B>

where B: [Bundle](../../prelude/trait.Bundle.html "trait bevy::prelude::Bundle"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#240)

### impl<B> [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'\_, '\_, B>

where B: [Bundle](../../prelude/trait.Bundle.html "trait bevy::prelude::Bundle"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#241)

#### fn [cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html#tymethod.cmp)(&self, other: &[EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'\_, '\_, B>) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#224)

### impl<B> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'\_, '\_, B>

where B: [Bundle](../../prelude/trait.Bundle.html "trait bevy::prelude::Bundle"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#225)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'\_, '\_, B>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#232)

### impl<B> [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'\_, '\_, B>

where B: [Bundle](../../prelude/trait.Bundle.html "trait bevy::prelude::Bundle"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#235)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'\_, '\_, B>) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")\>

[`EntityRefExcept`](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")’s comparison trait implementations match the underlying [`Entity`](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), and cannot discern between different worlds.
...
### impl<'a, 'b, B> [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData") for [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'a, 'b, B>
...
#### type [ReadOnly](../query/trait.QueryData.html#associatedtype.ReadOnly) = [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'a, 'b, B>
...
#### type [Item](../query/trait.QueryData.html#associatedtype.Item)<'w, 's> = [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'w, 's, B>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#1492-1494)

#### fn [shrink](../query/trait.QueryData.html#tymethod.shrink)<'wlong, 'wshort, 's>( item: <[EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'a, 'b, B> as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'wlong, 's>, ) -> <[EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'a, 'b, B> as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'wshort, 's>

where 'wlong: 'wshort,

This function manually implements subtyping for the query items.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#1498-1503)

#### unsafe fn [fetch](../query/trait.QueryData.html#tymethod.fetch)<'w, 's>( access: &'s <[EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'a, 'b, B> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[State](../query/trait.WorldQuery.html#associatedtype.State "type bevy::ecs::query::WorldQuery::State"), fetch: &mut <[EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'a, 'b, B> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'w>, entity: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), \_: [TableRow](../storage/struct.TableRow.html "struct bevy::ecs::storage::TableRow"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'a, 'b, B> as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'w, 's>>
...
### impl<B> [ReadOnlyQueryData](../query/trait.ReadOnlyQueryData.html "trait bevy::ecs::query::ReadOnlyQueryData") for [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'\_, '\_, B>

where B: [Bundle](../../prelude/trait.Bundle.html "trait bevy::prelude::Bundle"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#1523)

### impl<B> [SingleEntityQueryData](../query/trait.SingleEntityQueryData.html "trait bevy::ecs::query::SingleEntityQueryData") for [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'\_, '\_, B>

where B: [Bundle](../../prelude/trait.Bundle.html "trait bevy::prelude::Bundle"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#1407-1409)

### impl<'a, 'b, B> [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery") for [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'a, 'b, B>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#1414)

#### fn [shrink\_fetch](../query/trait.WorldQuery.html#tymethod.shrink_fetch)<'wlong, 'wshort>( fetch: <[EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'a, 'b, B> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'wlong>, ) -> <[EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'a, 'b, B> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'wshort>

where 'wlong: 'wshort,

This function manually implements subtyping for the query fetches.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#1418-1423)

#### unsafe fn [init\_fetch](../query/trait.WorldQuery.html#tymethod.init_fetch)<'w, 's>( world: [UnsafeWorldCell](unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'w>, \_: &'s <[EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'a, 'b, B> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[State](../query/trait.WorldQuery.html#associatedtype.State "type bevy::ecs::query::WorldQuery::State"), last\_run: [Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"), this\_run: [Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"), ) -> <[EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'a, 'b, B> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'w>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#1433-1438)

#### unsafe fn [set\_archetype](../query/trait.WorldQuery.html#tymethod.set_archetype)<'w, 's>( \_: &mut <[EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'a, 'b, B> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'w>, \_: &'s <[EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'a, 'b, B> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[State](../query/trait.WorldQuery.html#associatedtype.State "type bevy::ecs::query::WorldQuery::State"), \_: &'w [Archetype](../archetype/struct.Archetype.html "struct bevy::ecs::archetype::Archetype"), \_: &'w [Table](../storage/struct.Table.html "struct bevy::ecs::storage::Table"), )
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#1441)

#### unsafe fn [set\_table](../query/trait.WorldQuery.html#tymethod.set_table)<'w, 's>( \_: &mut <[EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'a, 'b, B> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'w>, \_: &'s <[EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'a, 'b, B> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[State](../query/trait.WorldQuery.html#associatedtype.State "type bevy::ecs::query::WorldQuery::State"), \_: &'w [Table](../storage/struct.Table.html "struct bevy::ecs::storage::Table"), )
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#1443)

#### fn [update\_component\_access](../query/trait.WorldQuery.html#tymethod.update_component_access)( state: &<[EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'a, 'b, B> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[State](../query/trait.WorldQuery.html#associatedtype.State "type bevy::ecs::query::WorldQuery::State"), filtered\_access: &mut [FilteredAccess](../query/struct.FilteredAccess.html "struct bevy::ecs::query::FilteredAccess"), )
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#1453)

#### fn [init\_state](../query/trait.WorldQuery.html#tymethod.init_state)( world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World"), ) -> <[EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'a, 'b, B> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[State](../query/trait.WorldQuery.html#associatedtype.State "type bevy::ecs::query::WorldQuery::State")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#1462)

#### fn [get\_state](../query/trait.WorldQuery.html#tymethod.get_state)( components: &[Components](../component/struct.Components.html "struct bevy::ecs::component::Components"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'a, 'b, B> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[State](../query/trait.WorldQuery.html#associatedtype.State "type bevy::ecs::query::WorldQuery::State")\>
...
### impl<'w, 's, B> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'w, 's, B>

### impl<'w, 's, B> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'w, 's, B>

### impl<'w, 's, B> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'w, 's, B>

### impl<'w, 's, B> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'w, 's, B>

### impl<'w, 's, B> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'w, 's, B>

### impl<'w, 's, B> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'w, 's, B>

where B: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<'w, 's, B> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'w, 's, B>
