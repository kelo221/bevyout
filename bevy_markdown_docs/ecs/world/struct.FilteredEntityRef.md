...
# Struct FilteredEntityRef 

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#42)

```rust
pub struct FilteredEntityRef<'w, 's> { /* private fields */ }
```
...
To define the access when used as a [`QueryData`](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData"), use a [`QueryBuilder`](../../prelude/struct.QueryBuilder.html "struct bevy::prelude::QueryBuilder") or [`QueryParamBuilder`](../system/struct.QueryParamBuilder.html "struct bevy::ecs::system::QueryParamBuilder"). The [`FilteredEntityRef`](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef") must be the entire [`QueryData`](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData"), and not nested inside a tuple with other data.
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#47)

### impl<'w, 's> [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'w, 's>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#66)

#### pub fn [try\_into\_all](#method.try_into_all)(self) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[EntityRef](../../prelude/struct.EntityRef.html "struct bevy::prelude::EntityRef")<'w>, [TryFromFilteredError](enum.TryFromFilteredError.html "enum bevy::ecs::world::TryFromFilteredError")\>

Consumes self and returns read-only access to the entity and _all_ of its components, with the world `'w` lifetime. Returns an error if the access does not include read access to all components.
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#78)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#84)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#90)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#96)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#108)
...
If you do not know the concrete type of a component, consider using [`Self::contains_id`](struct.FilteredEntityRef.html#method.contains_id "method bevy::ecs::world::FilteredEntityRef::contains_id") or [`Self::contains_type_id`](struct.FilteredEntityRef.html#method.contains_type_id "method bevy::ecs::world::FilteredEntityRef::contains_type_id").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#121)
...
*   If you know the concrete type of the component, you should prefer [`Self::contains`](struct.FilteredEntityRef.html#method.contains "method bevy::ecs::world::FilteredEntityRef::contains").
*   If you know the component’s [`TypeId`](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId") but not its [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId"), consider using [`Self::contains_type_id`](struct.FilteredEntityRef.html#method.contains_type_id "method bevy::ecs::world::FilteredEntityRef::contains_type_id").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#133)
...
*   If you know the concrete type of the component, you should prefer [`Self::contains`](struct.FilteredEntityRef.html#method.contains "method bevy::ecs::world::FilteredEntityRef::contains").
*   If you have a [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId") instead of a [`TypeId`](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId"), consider using [`Self::contains_id`](struct.FilteredEntityRef.html#method.contains_id "method bevy::ecs::world::FilteredEntityRef::contains_id").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#140)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#158)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#174)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#194)
...
**You should prefer to use the typed API [`Self::get_change_ticks`](struct.FilteredEntityRef.html#method.get_change_ticks "method bevy::ecs::world::FilteredEntityRef::get_change_ticks") where possible and only use this in cases where the actual component types are not known at compile time.**

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#211)

#### pub fn [get\_by\_id](#method.get_by_id)(&self, component\_id: [ComponentId](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ptr](../ptr/struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'w>>
...
**You should prefer to use the typed API [`Self::get`](struct.FilteredEntityRef.html#method.get "method bevy::ecs::world::FilteredEntityRef::get") where possible and only use this in cases where the actual component types are not known at compile time.**

Unlike [`FilteredEntityRef::get`](struct.FilteredEntityRef.html#method.get "method bevy::ecs::world::FilteredEntityRef::get"), this returns a raw pointer to the component, which is only valid while the [`FilteredEntityRef`](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef") is alive.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#220)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#225)
...
### impl [ArchetypeQueryData](../query/trait.ArchetypeQueryData.html "trait bevy::ecs::query::ArchetypeQueryData") for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#41)

### impl<'w, 's> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'w, 's>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#41)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'w, 's>
...
### impl [ContainsEntity](../../prelude/trait.ContainsEntity.html "trait bevy::prelude::ContainsEntity") for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#275)
...
### impl<'w, 's> [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'w, 's>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#281)

### impl [EntityEquivalent](../entity/trait.EntityEquivalent.html "trait bevy::ecs::entity::EntityEquivalent") for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#252)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_>
...
### impl<'a> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&[EntityRef](../../prelude/struct.EntityRef.html "struct bevy::prelude::EntityRef")<'a>> for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'a, 'static>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/entity_ref.rs.html#321)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(entity: &[EntityRef](../../prelude/struct.EntityRef.html "struct bevy::prelude::EntityRef")<'a>) -> [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'a, 'static>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#210)

### impl<'w, 's, B> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&[EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'w, 's, B>> for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'w, 's>

where B: [Bundle](../../prelude/trait.Bundle.html "trait bevy::prelude::Bundle"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#211)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(entity: &[EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'w, 's, B>) -> [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'w, 's>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#204)

### impl<'w, 's, B> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[EntityRefExcept](struct.EntityRefExcept.html "struct bevy::ecs::world::EntityRefExcept")<'w, 's, B>> for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'w, 's>

where B: [Bundle](../../prelude/trait.Bundle.html "trait bevy::prelude::Bundle"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/except.rs.html#205)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#268)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#269)
...
### impl [IterQueryData](../query/trait.IterQueryData.html "trait bevy::ecs::query::IterQueryData") for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#262)

### impl [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#263)

#### fn [cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html#tymethod.cmp)(&self, other: &[FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_>) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#246)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#247)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#254)

### impl [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#257)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_>) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")\>

[`FilteredEntityRef`](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")’s comparison trait implementations match the underlying [`Entity`](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), and cannot discern between different worlds.
...
### impl<'a, 'b> [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData") for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'a, 'b>
...
#### type [Item](../query/trait.QueryData.html#associatedtype.Item)<'w, 's> = [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'w, 's>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#1219-1221)

#### fn [shrink](../query/trait.QueryData.html#tymethod.shrink)<'wlong, 'wshort, 's>( item: <[FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'a, 'b> as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'wlong, 's>, ) -> <[FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'a, 'b> as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'wshort, 's>

where 'wlong: 'wshort,

This function manually implements subtyping for the query items.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#1226-1230)

#### fn [provide\_extra\_access](../query/trait.QueryData.html#method.provide_extra_access)( state: &mut <[FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'a, 'b> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[State](../query/trait.WorldQuery.html#associatedtype.State "type bevy::ecs::query::WorldQuery::State"), access: &mut [Access](../query/struct.Access.html "struct bevy::ecs::query::Access"), available\_access: &[Access](../query/struct.Access.html "struct bevy::ecs::query::Access"), )
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#1245-1250)

#### unsafe fn [fetch](../query/trait.QueryData.html#tymethod.fetch)<'w, 's>( access: &'s <[FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'a, 'b> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[State](../query/trait.WorldQuery.html#associatedtype.State "type bevy::ecs::query::WorldQuery::State"), fetch: &mut <[FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'a, 'b> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'w>, entity: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), \_table\_row: [TableRow](../storage/struct.TableRow.html "struct bevy::ecs::storage::TableRow"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'a, 'b> as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'w, 's>>
...
### impl [ReadOnlyQueryData](../query/trait.ReadOnlyQueryData.html "trait bevy::ecs::query::ReadOnlyQueryData") for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#1274)

### impl [SingleEntityQueryData](../query/trait.SingleEntityQueryData.html "trait bevy::ecs::query::SingleEntityQueryData") for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#238)

### impl<'a> [TryFrom](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html "trait core::convert::TryFrom")<&[FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'a, '\_>> for [EntityRef](../../prelude/struct.EntityRef.html "struct bevy::prelude::EntityRef")<'a>
...
#### fn [try\_from](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html#tymethod.try_from)( entity: &[FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'a, '\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[EntityRef](../../prelude/struct.EntityRef.html "struct bevy::prelude::EntityRef")<'a>, <[EntityRef](../../prelude/struct.EntityRef.html "struct bevy::prelude::EntityRef")<'a> as [TryFrom](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html "trait core::convert::TryFrom")<&[FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'a, '\_>>>::[Error](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html#associatedtype.Error "type core::convert::TryFrom::Error")\>
...
### impl [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery") for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#1152)

#### fn [shrink\_fetch](../query/trait.WorldQuery.html#tymethod.shrink_fetch)<'wlong, 'wshort>( fetch: <[FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'wlong>, ) -> <[FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'wshort>

where 'wlong: 'wshort,

This function manually implements subtyping for the query fetches.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#1158-1163)

#### unsafe fn [init\_fetch](../query/trait.WorldQuery.html#tymethod.init_fetch)<'w, 's>( world: [UnsafeWorldCell](unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'w>, \_state: &'s <[FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[State](../query/trait.WorldQuery.html#associatedtype.State "type bevy::ecs::query::WorldQuery::State"), last\_run: [Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"), this\_run: [Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"), ) -> <[FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'w>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#1172-1177)

#### unsafe fn [set\_archetype](../query/trait.WorldQuery.html#tymethod.set_archetype)<'w, 's>( \_fetch: &mut <[FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'w>, \_state: &'s <[FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[State](../query/trait.WorldQuery.html#associatedtype.State "type bevy::ecs::query::WorldQuery::State"), \_: &'w [Archetype](../archetype/struct.Archetype.html "struct bevy::ecs::archetype::Archetype"), \_table: &[Table](../storage/struct.Table.html "struct bevy::ecs::storage::Table"), )
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#1181-1185)

#### unsafe fn [set\_table](../query/trait.WorldQuery.html#tymethod.set_table)<'w, 's>( \_fetch: &mut <[FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'w>, \_state: &'s <[FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[State](../query/trait.WorldQuery.html#associatedtype.State "type bevy::ecs::query::WorldQuery::State"), \_: &'w [Table](../storage/struct.Table.html "struct bevy::ecs::storage::Table"), )
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#1188)

#### fn [update\_component\_access](../query/trait.WorldQuery.html#tymethod.update_component_access)( state: &<[FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[State](../query/trait.WorldQuery.html#associatedtype.State "type bevy::ecs::query::WorldQuery::State"), filtered\_access: &mut [FilteredAccess](../query/struct.FilteredAccess.html "struct bevy::ecs::query::FilteredAccess"), )
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#1196)

#### fn [init\_state](../query/trait.WorldQuery.html#tymethod.init_state)( \_world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World"), ) -> <[FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[State](../query/trait.WorldQuery.html#associatedtype.State "type bevy::ecs::query::WorldQuery::State")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#1200)

#### fn [get\_state](../query/trait.WorldQuery.html#tymethod.get_state)( \_components: &[Components](../component/struct.Components.html "struct bevy::ecs::component::Components"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'\_, '\_> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[State](../query/trait.WorldQuery.html#associatedtype.State "type bevy::ecs::query::WorldQuery::State")\>
...
### impl<'w, 's> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'w, 's>

### impl<'w, 's> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'w, 's>

### impl<'w, 's> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'w, 's>

### impl<'w, 's> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'w, 's>

### impl<'w, 's> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'w, 's>

### impl<'w, 's> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'w, 's>

### impl<'w, 's> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'w, 's>
