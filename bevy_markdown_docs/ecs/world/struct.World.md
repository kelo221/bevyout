...
If [`usize::MAX`](https://doc.rust-lang.org/nightly/std/primitive.usize.html#associatedconstant.MAX "associated constant usize::MAX") [`World`](../../prelude/struct.World.html "struct bevy::prelude::World")s have been created. This guarantee allows System Parameters to safely uniquely identify a [`World`](../../prelude/struct.World.html "struct bevy::prelude::World"), since its [`WorldId`](struct.WorldId.html "struct bevy::ecs::world::WorldId") is unique
...
Creates a new [`UnsafeWorldCell`](unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell") view with complete read+write access.
...
#### pub fn [entity\_mut](#method.entity_mut)<F>(&mut self, entities: F) -> <F as [WorldEntityFetch](trait.WorldEntityFetch.html "trait bevy::ecs::world::WorldEntityFetch")\>::[Mut](trait.WorldEntityFetch.html#associatedtype.Mut "type bevy::ecs::world::WorldEntityFetch::Mut")<'\_>
...
#### pub fn [get\_entity\_mut](#method.get_entity_mut)<F>( &mut self, entities: F, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<F as [WorldEntityFetch](trait.WorldEntityFetch.html "trait bevy::ecs::world::WorldEntityFetch")\>::[Mut](trait.WorldEntityFetch.html#associatedtype.Mut "type bevy::ecs::world::WorldEntityFetch::Mut")<'\_>, [EntityMutableFetchError](error/enum.EntityMutableFetchError.html "enum bevy::ecs::world::error::EntityMutableFetchError")\>
...
See [`DeferredWorld::entities_and_commands`](struct.DeferredWorld.html#method.entities_and_commands "method bevy::ecs::world::DeferredWorld::entities_and_commands") for the deferred version.
...
#### pub fn [modify\_component](#method.modify_component)<T, R>( &mut self, entity: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), f: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")([&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)) -> R, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<R>, [EntityMutableFetchError](error/enum.EntityMutableFetchError.html "enum bevy::ecs::world::error::EntityMutableFetchError")\>
...
#### pub fn [modify\_component\_by\_id](#method.modify_component_by_id)<R>( &mut self, entity: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), component\_id: [ComponentId](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId"), f: impl for<'a> [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")([MutUntyped](../change_detection/struct.MutUntyped.html "struct bevy::ecs::change_detection::MutUntyped")<'a>) -> R, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<R>, [EntityMutableFetchError](error/enum.EntityMutableFetchError.html "enum bevy::ecs::world::error::EntityMutableFetchError")\>
...
#### pub fn [modify\_resource](#method.modify_resource)<R, S>( &mut self, f: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")([&mut R](https://doc.rust-lang.org/nightly/std/primitive.reference.html)) -> S, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<S>, [EntityMutableFetchError](error/enum.EntityMutableFetchError.html "enum bevy::ecs::world::error::EntityMutableFetchError")\>
...
#### pub fn [modify\_resource\_by\_id](#method.modify_resource_by_id)<S>( &mut self, component\_id: [ComponentId](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId"), f: impl for<'a> [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")([MutUntyped](../change_detection/struct.MutUntyped.html "struct bevy::ecs::change_detection::MutUntyped")<'a>) -> S, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<S>, [EntityMutableFetchError](error/enum.EntityMutableFetchError.html "enum bevy::ecs::world::error::EntityMutableFetchError")\>
...
#### pub fn [try\_despawn](#method.try_despawn)(&mut self, entity: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [EntityDespawnError](error/struct.EntityDespawnError.html "struct bevy::ecs::world::error::EntityDespawnError")\>
...
Returns an [`EntityDespawnError`](error/struct.EntityDespawnError.html "struct bevy::ecs::world::error::EntityDespawnError") if the entity is not spawned to be despawned.
...
#### pub fn [try\_despawn\_no\_free](#method.try_despawn_no_free)( &mut self, entity: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), [EntityDespawnError](error/struct.EntityDespawnError.html "struct bevy::ecs::world::error::EntityDespawnError")\>
...
Returns the new [`Entity`](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") if of the despawned [`EntityIndex`](../entity/struct.EntityIndex.html "struct bevy::ecs::entity::EntityIndex"), which should eventually either be re-spawned or freed to the allocator. Returns an [`EntityDespawnError`](error/struct.EntityDespawnError.html "struct bevy::ecs::world::error::EntityDespawnError") if the entity is not spawned.
...
Returns a [`TryInsertBatchError`](error/struct.TryInsertBatchError.html "struct bevy::ecs::world::error::TryInsertBatchError") if any of the provided entities do not exist.
...
#### pub fn [try\_schedule\_scope](#method.try_schedule_scope)<R>( &mut self, label: impl [ScheduleLabel](../schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel"), f: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")(&mut [World](../../prelude/struct.World.html "struct bevy::prelude::World"), &mut [Schedule](../../prelude/struct.Schedule.html "struct bevy::prelude::Schedule")) -> R, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<R, [TryRunScheduleError](error/struct.TryRunScheduleError.html "struct bevy::ecs::world::error::TryRunScheduleError")\>

Temporarily removes the schedule associated with `label` from the world, runs user code, and finally re-adds the schedule. This returns a [`TryRunScheduleError`](error/struct.TryRunScheduleError.html "struct bevy::ecs::world::error::TryRunScheduleError") if there is no schedule associated with `label`.
...
#### pub fn [try\_run\_schedule](#method.try_run_schedule)( &mut self, label: impl [ScheduleLabel](../schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [TryRunScheduleError](error/struct.TryRunScheduleError.html "struct bevy::ecs::world::error::TryRunScheduleError")\>

Attempts to run the [`Schedule`](../../prelude/struct.Schedule.html "struct bevy::prelude::Schedule") associated with the `label` a single time, and returns a [`TryRunScheduleError`](error/struct.TryRunScheduleError.html "struct bevy::ecs::world::error::TryRunScheduleError") if the schedule does not exist.
...
### impl<'w> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'w [World](../../prelude/struct.World.html "struct bevy::prelude::World")\> for [UnsafeWorldCell](unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'w>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/unsafe_world_cell.rs.html#104)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: &'w [World](../../prelude/struct.World.html "struct bevy::prelude::World")) -> [UnsafeWorldCell](unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'w>
...
### impl<'w> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'w mut [World](../../prelude/struct.World.html "struct bevy::prelude::World")\> for [UnsafeWorldCell](unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'w>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/unsafe_world_cell.rs.html#98)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: &'w mut [World](../../prelude/struct.World.html "struct bevy::prelude::World")) -> [UnsafeWorldCell](unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'w>
