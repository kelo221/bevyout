...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/identifier.rs.html#22)
...
The trait [`FromWorld`](../../prelude/trait.FromWorld.html "trait bevy::prelude::FromWorld") is implemented for this type, which returns the ID of the world passed to [`FromWorld::from_world`](../../prelude/trait.FromWorld.html#tymethod.from_world "associated function bevy::prelude::FromWorld::from_world").

## Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/identifier.rs.html#27)

### impl [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/identifier.rs.html#33)

#### pub fn [new](#method.new)() -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")\>

Create a new, unique [`WorldId`](struct.WorldId.html "struct bevy::ecs::world::WorldId"). Returns [`None`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html#variant.None "variant core::option::Option::None") if the supply of unique [`WorldId`](struct.WorldId.html "struct bevy::ecs::world::WorldId")s has been exhausted

Please note that the [`WorldId`](struct.WorldId.html "struct bevy::ecs::world::WorldId")s created from this method are unique across time - if a given [`WorldId`](struct.WorldId.html "struct bevy::ecs::world::WorldId") is [`Drop`](https://doc.rust-lang.org/nightly/core/ops/drop/trait.Drop.html "trait core::ops::drop::Drop")ped its value still cannot be reused

## Trait Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/identifier.rs.html#15)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/identifier.rs.html#15)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/identifier.rs.html#15)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/identifier.rs.html#81)

### impl [ExclusiveSystemParam](../system/trait.ExclusiveSystemParam.html "trait bevy::ecs::system::ExclusiveSystemParam") for [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/identifier.rs.html#82)

#### type [State](../system/trait.ExclusiveSystemParam.html#associatedtype.State) = [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")

Used to store data which persists across invocations of a system.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/identifier.rs.html#83)

#### type [Item](../system/trait.ExclusiveSystemParam.html#associatedtype.Item)<'s> = [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/identifier.rs.html#85)

#### fn [init](../system/trait.ExclusiveSystemParam.html#tymethod.init)( world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World"), \_system\_meta: &mut [SystemMeta](../system/struct.SystemMeta.html "struct bevy::ecs::system::SystemMeta"), ) -> <[WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId") as [ExclusiveSystemParam](../system/trait.ExclusiveSystemParam.html "trait bevy::ecs::system::ExclusiveSystemParam")\>::[State](../system/trait.ExclusiveSystemParam.html#associatedtype.State "type bevy::ecs::system::ExclusiveSystemParam::State")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/identifier.rs.html#89-92)

#### fn [get\_param](../system/trait.ExclusiveSystemParam.html#tymethod.get_param)<'s>( state: &'s mut <[WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId") as [ExclusiveSystemParam](../system/trait.ExclusiveSystemParam.html "trait bevy::ecs::system::ExclusiveSystemParam")\>::[State](../system/trait.ExclusiveSystemParam.html#associatedtype.State "type bevy::ecs::system::ExclusiveSystemParam::State"), \_system\_meta: &[SystemMeta](../system/struct.SystemMeta.html "struct bevy::ecs::system::SystemMeta"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId") as [ExclusiveSystemParam](../system/trait.ExclusiveSystemParam.html "trait bevy::ecs::system::ExclusiveSystemParam")\>::[Item](../system/trait.ExclusiveSystemParam.html#associatedtype.Item "type bevy::ecs::system::ExclusiveSystemParam::Item")<'s>, [SystemParamValidationError](../system/struct.SystemParamValidationError.html "struct bevy::ecs::system::SystemParamValidationError")\>
...
### impl [FromWorld](../../prelude/trait.FromWorld.html "trait bevy::prelude::FromWorld") for [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/identifier.rs.html#46)

#### fn [from\_world](../../prelude/trait.FromWorld.html#tymethod.from_world)(world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World")) -> [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")

Creates `Self` using data from the given [`World`](../../prelude/struct.World.html "struct bevy::prelude::World").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/identifier.rs.html#15)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/identifier.rs.html#15)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [ReadOnlySystemParam](../system/trait.ReadOnlySystemParam.html "trait bevy::ecs::system::ReadOnlySystemParam") for [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/identifier.rs.html#97)

### impl [SparseSetIndex](../storage/trait.SparseSetIndex.html "trait bevy::ecs::storage::SparseSetIndex") for [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/identifier.rs.html#99)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/identifier.rs.html#104)

#### fn [get\_sparse\_set\_index](../storage/trait.SparseSetIndex.html#tymethod.get_sparse_set_index)(value: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")

Creates a new instance of this type with the specified index.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/identifier.rs.html#15)

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/identifier.rs.html#55)

### impl [SystemParam](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam") for [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")
...
#### type [Item](../system/trait.SystemParam.html#associatedtype.Item)<'world, 'state> = [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/identifier.rs.html#60)

#### fn [init\_state](../system/trait.SystemParam.html#tymethod.init_state)(\_: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World")) -> <[WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId") as [SystemParam](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](../system/trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/identifier.rs.html#71-76)

#### unsafe fn [get\_param](../system/trait.SystemParam.html#tymethod.get_param)<'world, 'state>( \_: &'state mut <[WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId") as [SystemParam](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](../system/trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State"), \_: &[SystemMeta](../system/struct.SystemMeta.html "struct bevy::ecs::system::SystemMeta"), world: [UnsafeWorldCell](unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'world>, \_: [Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId") as [SystemParam](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[Item](../system/trait.SystemParam.html#associatedtype.Item "type bevy::ecs::system::SystemParam::Item")<'world, 'state>, [SystemParamValidationError](../system/struct.SystemParamValidationError.html "struct bevy::ecs::system::SystemParamValidationError")\>
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [WorldId](struct.WorldId.html "struct bevy::ecs::world::WorldId")
