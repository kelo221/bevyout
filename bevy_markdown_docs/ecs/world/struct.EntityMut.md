...
#### pub fn [into\_filtered](#method.into_filtered)(self) -> [FilteredEntityMut](struct.FilteredEntityMut.html "struct bevy::ecs::world::FilteredEntityMut")<'w, 'static>

Consumes `self` and returns a [`FilteredEntityMut`](struct.FilteredEntityMut.html "struct bevy::ecs::world::FilteredEntityMut") which has mutable access to all of the entity’s components, with the world `'w` lifetime.
...
#### pub unsafe fn [get\_mut\_by\_id\_unchecked](#method.get_mut_by_id_unchecked)<F>( &self, component\_ids: F, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<F as [DynamicComponentFetch](trait.DynamicComponentFetch.html "trait bevy::ecs::world::DynamicComponentFetch")\>::[Mut](trait.DynamicComponentFetch.html#associatedtype.Mut "type bevy::ecs::world::DynamicComponentFetch::Mut")<'\_>, [EntityComponentError](error/enum.EntityComponentError.html "enum bevy::ecs::world::error::EntityComponentError")\>
...
*   the [`UnsafeEntityCell`](unsafe_world_cell/struct.UnsafeEntityCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeEntityCell") has permission to access the component mutably
...
#### pub unsafe fn [get\_mut\_assume\_mutable\_by\_id\_unchecked](#method.get_mut_assume_mutable_by_id_unchecked)<F>( &self, component\_ids: F, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<F as [DynamicComponentFetch](trait.DynamicComponentFetch.html "trait bevy::ecs::world::DynamicComponentFetch")\>::[Mut](trait.DynamicComponentFetch.html#associatedtype.Mut "type bevy::ecs::world::DynamicComponentFetch::Mut")<'\_>, [EntityComponentError](error/enum.EntityComponentError.html "enum bevy::ecs::world::error::EntityComponentError")\>
...
### impl<'a> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'a [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_>> for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'a, 'static>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/entity_mut.rs.html#817)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(entity: &'a [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_>) -> [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'a, 'static>
...
### impl<'a> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'a>> for [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'a, 'static>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/entity_mut.rs.html#810)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(entity: [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'a>) -> [FilteredEntityRef](struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'a, 'static>
