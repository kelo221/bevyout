[bevy](../../index.html)::[ecs](../index.html)::[hierarchy](index.html)

# Struct Children 

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#152)
...
A [`RelationshipTarget`](../../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") collection component that is populated with entities that “target” this entity with the [`ChildOf`](../../prelude/struct.ChildOf.html "struct bevy::prelude::ChildOf") [`Relationship`](../relationship/trait.Relationship.html "trait bevy::ecs::relationship::Relationship") component.

Together, these components form the “canonical parent-child hierarchy”. See the [`ChildOf`](../../prelude/struct.ChildOf.html "struct bevy::prelude::ChildOf") component for the full description of this relationship and instructions on how to use it.

## Usage

Like all [`RelationshipTarget`](../../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") components, this data should not be directly manipulated to avoid desynchronization. Instead, modify the [`ChildOf`](../../prelude/struct.ChildOf.html "struct bevy::prelude::ChildOf") components on the “source” entities.

To access the children of an entity, you can iterate over the [`Children`](../../prelude/struct.Children.html "struct bevy::prelude::Children") component, using the [`IntoIterator`](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") trait. For more complex access patterns, see the [`RelationshipTarget`](../../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") trait.

## Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#154)

### impl [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#157)

#### pub fn [swap](#method.swap)(&mut self, a\_index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), b\_index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html))

Swaps the child at `a_index` with the child at `b_index`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#170-172)

#### pub fn [sort\_by](#method.sort_by)<F>(&mut self, compare: F)

where F: [FnMut](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html "trait core::ops::function::FnMut")(&[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), &[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering"),

Sorts children [stably](https://en.wikipedia.org/wiki/Sorting_algorithm#Stability) in place using the provided comparator function.

For the underlying implementation, see [`slice::sort_by`](https://doc.rust-lang.org/nightly/std/primitive.slice.html#method.sort_by "method slice::sort_by").

For the unstable version, see [`sort_unstable_by`](../../prelude/struct.Children.html#method.sort_unstable_by "method bevy::prelude::Children::sort_unstable_by").

See also [`sort_by_key`](../../prelude/struct.Children.html#method.sort_by_key "method bevy::prelude::Children::sort_by_key"), [`sort_by_cached_key`](../../prelude/struct.Children.html#method.sort_by_cached_key "method bevy::prelude::Children::sort_by_cached_key").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#186-189)

#### pub fn [sort\_by\_key](#method.sort_by_key)<K, F>(&mut self, compare: F)

where F: [FnMut](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html "trait core::ops::function::FnMut")(&[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")) -> K, K: [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord"),

Sorts children [stably](https://en.wikipedia.org/wiki/Sorting_algorithm#Stability) in place using the provided key extraction function.

For the underlying implementation, see [`slice::sort_by_key`](https://doc.rust-lang.org/nightly/std/primitive.slice.html#method.sort_by_key "method slice::sort_by_key").

For the unstable version, see [`sort_unstable_by_key`](../../prelude/struct.Children.html#method.sort_unstable_by_key "method bevy::prelude::Children::sort_unstable_by_key").

See also [`sort_by`](../../prelude/struct.Children.html#method.sort_by "method bevy::prelude::Children::sort_by"), [`sort_by_cached_key`](../../prelude/struct.Children.html#method.sort_by_cached_key "method bevy::prelude::Children::sort_by_cached_key").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#202-205)

#### pub fn [sort\_by\_cached\_key](#method.sort_by_cached_key)<K, F>(&mut self, compare: F)

where F: [FnMut](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html "trait core::ops::function::FnMut")(&[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")) -> K, K: [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord"),

Sorts children [stably](https://en.wikipedia.org/wiki/Sorting_algorithm#Stability) in place using the provided key extraction function. Only evaluates each key at most once per sort, caching the intermediate results in memory.

For the underlying implementation, see [`slice::sort_by_cached_key`](https://doc.rust-lang.org/nightly/std/primitive.slice.html#method.sort_by_cached_key "method slice::sort_by_cached_key").

See also [`sort_by`](../../prelude/struct.Children.html#method.sort_by "method bevy::prelude::Children::sort_by"), [`sort_by_key`](../../prelude/struct.Children.html#method.sort_by_key "method bevy::prelude::Children::sort_by_key").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#219-221)

#### pub fn [sort\_unstable\_by](#method.sort_unstable_by)<F>(&mut self, compare: F)

where F: [FnMut](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html "trait core::ops::function::FnMut")(&[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), &[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering"),

Sorts children [unstably](https://en.wikipedia.org/wiki/Sorting_algorithm#Stability) in place using the provided comparator function.

For the underlying implementation, see [`slice::sort_unstable_by`](https://doc.rust-lang.org/nightly/std/primitive.slice.html#method.sort_unstable_by "method slice::sort_unstable_by").

For the stable version, see [`sort_by`](../../prelude/struct.Children.html#method.sort_by "method bevy::prelude::Children::sort_by").

See also [`sort_unstable_by_key`](../../prelude/struct.Children.html#method.sort_unstable_by_key "method bevy::prelude::Children::sort_unstable_by_key").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#235-238)

#### pub fn [sort\_unstable\_by\_key](#method.sort_unstable_by_key)<K, F>(&mut self, compare: F)

where F: [FnMut](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html "trait core::ops::function::FnMut")(&[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")) -> K, K: [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord"),

Sorts children [unstably](https://en.wikipedia.org/wiki/Sorting_algorithm#Stability) in place using the provided key extraction function.

For the underlying implementation, see [`slice::sort_unstable_by_key`](https://doc.rust-lang.org/nightly/std/primitive.slice.html#method.sort_unstable_by_key "method slice::sort_unstable_by_key").

For the stable version, see [`sort_by_key`](../../prelude/struct.Children.html#method.sort_by_key "method bevy::prelude::Children::sort_by_key").

See also [`sort_unstable_by`](../../prelude/struct.Children.html#method.sort_unstable_by "method bevy::prelude::Children::sort_unstable_by").
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")

where [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#147)

#### const [STORAGE\_TYPE](../../prelude/trait.Component.html#associatedconstant.STORAGE_TYPE): [StorageType](../component/enum.StorageType.html "enum bevy::ecs::component::StorageType") = bevy\_ecs::component::StorageType::Table
...
#### fn [map\_entities](../../prelude/trait.Component.html#method.map_entities)<M>(this: &mut [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children"), mapper: [&mut M](https://doc.rust-lang.org/nightly/std/primitive.reference.html))
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#147)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#255)

### impl [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#256)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#258)

#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[Children](../../prelude/struct.Children.html "struct bevy::prelude::Children") as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#147)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#149)

### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#149)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#149)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Children](../../prelude/struct.Children.html "struct bevy::prelude::Children") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#244)

### impl<'a> [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") for &'a [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#245)

#### type [Item](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.Item) = <<&'a [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children") as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter "type core::iter::traits::collect::IntoIterator::IntoIter") as [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")\>::[Item](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html#associatedtype.Item "type core::iter::traits::iterator::Iterator::Item")

The type of the elements being iterated over.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#247)

#### type [IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter) = [Iter](https://doc.rust-lang.org/nightly/core/slice/iter/struct.Iter.html "struct core::slice::iter::Iter")<'a, [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\>

Which kind of iterator are we turning this into?

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#250)

#### fn [into\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)(self) -> <&'a [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children") as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter "type core::iter::traits::collect::IntoIterator::IntoIter")

Creates an iterator from a value. [Read more](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#149)

### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")
...
where [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#147)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#149)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
#### const [LINKED\_SPAWN](../../prelude/trait.RelationshipTarget.html#associatedconstant.LINKED_SPAWN): [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html) = true

If this is true, when despawning or cloning (when [linked cloning is enabled](../entity/struct.EntityClonerBuilder.html#method.linked_cloning "method bevy::ecs::entity::EntityClonerBuilder::linked_cloning")), the related entities targeting this entity will also be despawned or cloned. [Read more](../../prelude/trait.RelationshipTarget.html#associatedconstant.LINKED_SPAWN)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#147)

#### type [Relationship](../../prelude/trait.RelationshipTarget.html#associatedtype.Relationship) = [ChildOf](../../prelude/struct.ChildOf.html "struct bevy::prelude::ChildOf")

The [`Relationship`](../relationship/trait.Relationship.html "trait bevy::ecs::relationship::Relationship") that populates this [`RelationshipTarget`](../../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") collection.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#147)

#### type [Collection](../../prelude/trait.RelationshipTarget.html#associatedtype.Collection) = [Vec](../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\>

The collection type that stores the “source” entities for this [`RelationshipTarget`](../../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") component. [Read more](../../prelude/trait.RelationshipTarget.html#associatedtype.Collection)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#147)

#### fn [collection](../../prelude/trait.RelationshipTarget.html#tymethod.collection)(&self) -> &<[Children](../../prelude/struct.Children.html "struct bevy::prelude::Children") as [RelationshipTarget](../../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget")\>::[Collection](../../prelude/trait.RelationshipTarget.html#associatedtype.Collection "type bevy::prelude::RelationshipTarget::Collection")
...
#### fn [collection\_mut\_risky](../../prelude/trait.RelationshipTarget.html#tymethod.collection_mut_risky)( &mut self, ) -> &mut <[Children](../../prelude/struct.Children.html "struct bevy::prelude::Children") as [RelationshipTarget](../../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget")\>::[Collection](../../prelude/trait.RelationshipTarget.html#associatedtype.Collection "type bevy::prelude::RelationshipTarget::Collection")

Returns a mutable reference to the stored [`RelationshipTarget::Collection`](../../prelude/trait.RelationshipTarget.html#associatedtype.Collection "associated type bevy::prelude::RelationshipTarget::Collection"). [Read more](../../prelude/trait.RelationshipTarget.html#tymethod.collection_mut_risky)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#147)

#### fn [from\_collection\_risky](../../prelude/trait.RelationshipTarget.html#tymethod.from_collection_risky)( collection: <[Children](../../prelude/struct.Children.html "struct bevy::prelude::Children") as [RelationshipTarget](../../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget")\>::[Collection](../../prelude/trait.RelationshipTarget.html#associatedtype.Collection "type bevy::prelude::RelationshipTarget::Collection"), ) -> [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")

Creates a new [`RelationshipTarget`](../../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") from the given [`RelationshipTarget::Collection`](../../prelude/trait.RelationshipTarget.html#associatedtype.Collection "associated type bevy::prelude::RelationshipTarget::Collection"). [Read more](../../prelude/trait.RelationshipTarget.html#tymethod.from_collection_risky)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/mod.rs.html#307-314)

#### fn [on\_discard](../../prelude/trait.RelationshipTarget.html#method.on_discard)(world: [DeferredWorld](../world/struct.DeferredWorld.html "struct bevy::ecs::world::DeferredWorld")<'\_>, \_: [HookContext](../lifecycle/struct.HookContext.html "struct bevy::ecs::lifecycle::HookContext"))

The `on_discard` component hook that maintains the [`Relationship`](../relationship/trait.Relationship.html "trait bevy::ecs::relationship::Relationship") / [`RelationshipTarget`](../../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") connection.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/mod.rs.html#332)

#### fn [on\_despawn](../../prelude/trait.RelationshipTarget.html#method.on_despawn)(world: [DeferredWorld](../world/struct.DeferredWorld.html "struct bevy::ecs::world::DeferredWorld")<'\_>, \_: [HookContext](../lifecycle/struct.HookContext.html "struct bevy::ecs::lifecycle::HookContext"))
...
#### fn [with\_capacity](../../prelude/trait.RelationshipTarget.html#method.with_capacity)(capacity: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> Self
...
#### fn [len](../../prelude/trait.RelationshipTarget.html#method.len)(&self) -> [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)
...
#### fn [is\_empty](../../prelude/trait.RelationshipTarget.html#method.is_empty)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns true if this entity collection is empty.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/hierarchy.rs.html#147)

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Children](../../prelude/struct.Children.html "struct bevy::prelude::Children")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/spawn.rs.html#443-445)

#### fn [spawn](../../prelude/trait.SpawnRelated.html#tymethod.spawn)<L>( list: L, ) -> [SpawnRelatedBundle](../spawn/struct.SpawnRelatedBundle.html "struct bevy::ecs::spawn::SpawnRelatedBundle")<<T as [RelationshipTarget](../../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget")\>::[Relationship](../../prelude/trait.RelationshipTarget.html#associatedtype.Relationship "type bevy::prelude::RelationshipTarget::Relationship"), L>

where L: [SpawnableList](../spawn/trait.SpawnableList.html "trait bevy::ecs::spawn::SpawnableList")<<T as [RelationshipTarget](../../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget")\>::[Relationship](../../prelude/trait.RelationshipTarget.html#associatedtype.Relationship "type bevy::prelude::RelationshipTarget::Relationship")\>,

Returns a [`Bundle`](../../prelude/trait.Bundle.html "trait bevy::prelude::Bundle") containing this [`RelationshipTarget`](../../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") component. It also spawns a [`SpawnableList`](../spawn/trait.SpawnableList.html "trait bevy::ecs::spawn::SpawnableList") of entities, each related to the bundle’s entity via [`RelationshipTarget::Relationship`](../../prelude/trait.RelationshipTarget.html#associatedtype.Relationship "associated type bevy::prelude::RelationshipTarget::Relationship"). The [`RelationshipTarget`](../../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") (when possible) will pre-allocate space for the related entities. [Read more](../../prelude/trait.SpawnRelated.html#tymethod.spawn)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/spawn.rs.html#452)

#### fn [spawn\_one](../../prelude/trait.SpawnRelated.html#tymethod.spawn_one)<B>( bundle: B, ) -> [SpawnOneRelated](../spawn/struct.SpawnOneRelated.html "struct bevy::ecs::spawn::SpawnOneRelated")<<T as [RelationshipTarget](../../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget")\>::[Relationship](../../prelude/trait.RelationshipTarget.html#associatedtype.Relationship "type bevy::prelude::RelationshipTarget::Relationship"), B>

where B: [Bundle](../../prelude/trait.Bundle.html "trait bevy::prelude::Bundle"),

Returns a [`Bundle`](../../prelude/trait.Bundle.html "trait bevy::prelude::Bundle") containing this [`RelationshipTarget`](../../prelude/trait.RelationshipTarget.html "trait bevy::prelude::RelationshipTarget") component. It also spawns a single entity containing [`Bundle`](../../prelude/trait.Bundle.html "trait bevy::prelude::Bundle") that is related to the bundle’s entity via [`RelationshipTarget::Relationship`](../../prelude/trait.RelationshipTarget.html#associatedtype.Relationship "associated type bevy::prelude::RelationshipTarget::Relationship"). [Read more](../../prelude/trait.SpawnRelated.html#tymethod.spawn_one)
