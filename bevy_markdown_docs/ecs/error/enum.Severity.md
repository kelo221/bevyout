...
To change the behavior of unhandled errors returned from systems, you can modify the [fallback error handler](struct.FallbackErrorHandler.html "struct bevy::ecs::error::FallbackErrorHandler"), and read the [`Severity`](../../prelude/enum.Severity.html "enum bevy::prelude::Severity") stored inside of each [`BevyError`](../../prelude/struct.BevyError.html "struct bevy::prelude::BevyError").
