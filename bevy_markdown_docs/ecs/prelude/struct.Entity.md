...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#424)
...
Once an entity is despawned, it ceases to exist. However, its [`Entity`](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") id is still present, and may still be contained in some data. This becomes problematic because it is possible for a later entity to be spawned at the exact same id! If this happens, which is rare but very possible, it will be logged.

Aliasing can happen without warning. Holding onto a [`Entity`](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") id corresponding to an entity well after that entity was despawned can cause un-intuitive behavior for both ordering, and comparing in general. To prevent these bugs, it is generally best practice to stop holding an [`Entity`](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") or [`EntityGeneration`](../entity/struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration") value as soon as you know it has been despawned. If you must do otherwise, do not assume the [`Entity`](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") id corresponds to the same entity it originally did. See [`EntityGeneration`](../entity/struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")’s docs for more information about aliasing and why it occurs.

## Stability warning

For all intents and purposes, `Entity` should be treated as an opaque identifier. The internal bit representation is liable to change from release to release as are the behaviors or performance characteristics of any of its trait implementations (i.e. `Ord`, `Hash`, etc.). This means that changes in `Entity`’s representation, though made readable through various functions on the type, are not considered breaking changes under [SemVer](https://semver.org/).
...
This data type is returned by iterating a `Query` that has `Entity` as part of its query fetch type parameter ([learn more](../../prelude/struct.Query.html#entity-id-access "struct bevy::prelude::Query")). It can also be obtained by calling [`EntityCommands::id`](../../prelude/struct.EntityCommands.html#method.id "method bevy::prelude::EntityCommands::id") or [`EntityWorldMut::id`](../../prelude/struct.EntityWorldMut.html#method.id "method bevy::prelude::EntityWorldMut::id").
...
It can be used to refer to a specific entity to apply [`EntityCommands`](../../prelude/struct.EntityCommands.html "struct bevy::prelude::EntityCommands"), or to call [`Query::get`](../../prelude/struct.Query.html#method.get "method bevy::prelude::Query::get") (or similar methods) to access its components.
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#485)

### impl [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#529)

#### pub const [PLACEHOLDER](#associatedconstant.PLACEHOLDER): [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")
...
Deriving [`Reflect`](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for a component that has an `Entity` field:
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#488-491)

#### pub const fn [from\_index\_and\_generation](#method.from_index_and_generation)( index: [EntityIndex](../entity/struct.EntityIndex.html "struct bevy::ecs::entity::EntityIndex"), generation: [EntityGeneration](../entity/struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration"), ) -> [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

Creates a new instance with the given index and generation.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#544)

#### pub const fn [from\_index](#method.from_index)(index: [EntityIndex](../entity/struct.EntityIndex.html "struct bevy::ecs::entity::EntityIndex")) -> [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

Creates a new entity ID with the specified `index` and an unspecified generation.

##### Note

Spawning a specific `entity` value is **rarely the right choice**. Most apps should favor [`Commands::spawn`](../../prelude/struct.Commands.html#method.spawn "method bevy::prelude::Commands::spawn"). This method should generally only be used for sharing entities across apps, and only when they have a scheme worked out to share an index space (which doesn’t happen by default).
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#552)

#### pub const fn [from\_raw\_u32](#method.from_raw_u32)(index: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\>

This is equivalent to [`from_index`](../../prelude/struct.Entity.html#method.from_index "associated function bevy::prelude::Entity::from_index") except that it takes a `u32` instead of an [`EntityIndex`](../entity/struct.EntityIndex.html "struct bevy::ecs::entity::EntityIndex").
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#566)

#### pub const fn [to\_bits](#method.to_bits)(self) -> [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#578)

#### pub const fn [from\_bits](#method.from_bits)(bits: [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)) -> [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

Reconstruct an `Entity` previously destructured with [`Entity::to_bits`](../../prelude/struct.Entity.html#method.to_bits "method bevy::prelude::Entity::to_bits").

Only useful when applied to results from `to_bits` in the same instance of an application.

##### Panics

This method will likely panic if given `u64` values that did not come from [`Entity::to_bits`](../../prelude/struct.Entity.html#method.to_bits "method bevy::prelude::Entity::to_bits").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#592)

#### pub const fn [try\_from\_bits](#method.try_from_bits)(bits: [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\>

Reconstruct an `Entity` previously destructured with [`Entity::to_bits`](../../prelude/struct.Entity.html#method.to_bits "method bevy::prelude::Entity::to_bits").

Only useful when applied to results from `to_bits` in the same instance of an application.

This method is the fallible counterpart to [`Entity::from_bits`](../../prelude/struct.Entity.html#method.from_bits "associated function bevy::prelude::Entity::from_bits").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#613)

#### pub const fn [index](#method.index)(self) -> [EntityIndex](../entity/struct.EntityIndex.html "struct bevy::ecs::entity::EntityIndex")

Return a transiently unique identifier. See also [`EntityIndex`](../entity/struct.EntityIndex.html "struct bevy::ecs::entity::EntityIndex").
...
examples/scene/world\_serialization.rs ([line 147](../../../src/world_serialization/world_serialization.rs.html#147))
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#619)

#### pub const fn [index\_u32](#method.index_u32)(self) -> [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)

Equivalent to `self.index().index()`. See [`Self::index`](../../prelude/struct.Entity.html#method.index "method bevy::prelude::Entity::index") for details.
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#627)

#### pub const fn [generation](#method.generation)(self) -> [EntityGeneration](../entity/struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")
...
### impl [ArchetypeQueryData](../query/trait.ArchetypeQueryData.html "trait bevy::ecs::query::ArchetypeQueryData") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#413)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#413)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/entity_set.rs.html#71)
...
### impl [ContiguousQueryData](../query/trait.ContiguousQueryData.html "trait bevy::ecs::query::ContiguousQueryData") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#598)

#### type [Contiguous](../query/trait.ContiguousQueryData.html#associatedtype.Contiguous)<'w, 's> = &'w \[[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\]
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#600-604)

#### unsafe fn [fetch\_contiguous](../query/trait.ContiguousQueryData.html#tymethod.fetch_contiguous)<'w, 's>( \_state: &'s <[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[State](../query/trait.WorldQuery.html#associatedtype.State "type bevy::ecs::query::WorldQuery::State"), \_fetch: &mut <[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'w>, entities: &'w \[[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\], ) -> <[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") as [ContiguousQueryData](../query/trait.ContiguousQueryData.html "trait bevy::ecs::query::ContiguousQueryData")\>::[Contiguous](../query/trait.ContiguousQueryData.html#associatedtype.Contiguous "type bevy::ecs::query::ContiguousQueryData::Contiguous")<'w, 's>
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#662)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

Outputs the short entity identifier, including the index and generation.

This takes the format: `{index}v{generation}`.

For [`Entity::PLACEHOLDER`](../../prelude/struct.Entity.html#associatedconstant.PLACEHOLDER "associated constant bevy::prelude::Entity::PLACEHOLDER"), this outputs `PLACEHOLDER`.

For a unique [`u64`](https://doc.rust-lang.org/nightly/std/primitive.u64.html "primitive u64") representation, use [`Entity::to_bits`](../../prelude/struct.Entity.html#method.to_bits "method bevy::prelude::Entity::to_bits").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#663)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")\>

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#643)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

Available on **crate feature `serialize`** only.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#644-646)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<D>( deserializer: D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), <D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#673)

### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#674)
...
### impl [EntityEquivalent](../entity/trait.EntityEquivalent.html "trait bevy::ecs::entity::EntityEquivalent") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#446)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_set.rs.html#175)

### impl<'a> [Extend](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.Extend.html "trait core::iter::traits::collect::Extend")<&'a [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\> for [EntityHashSet](../entity/struct.EntityHashSet.html "struct bevy::ecs::entity::EntityHashSet")
...
### impl<'a> [Extend](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.Extend.html "trait core::iter::traits::collect::Extend")<&'a [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\> for [EntityIndexSet](../entity/struct.EntityIndexSet.html "struct bevy::ecs::entity::EntityIndexSet")
...
### impl [Extend](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.Extend.html "trait core::iter::traits::collect::Extend")<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\> for [EntityHashSet](../entity/struct.EntityHashSet.html "struct bevy::ecs::entity::EntityHashSet")
...
### impl [Extend](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.Extend.html "trait core::iter::traits::collect::Extend")<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\> for [EntityIndexSet](../entity/struct.EntityIndexSet.html "struct bevy::ecs::entity::EntityIndexSet")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/template.rs.html#444)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\> for [EntityTemplate](../template/enum.EntityTemplate.html "enum bevy::ecs::template::EntityTemplate")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/template.rs.html#445)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(entity: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")) -> [EntityTemplate](../template/enum.EntityTemplate.html "enum bevy::ecs::template::EntityTemplate")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/sync_world.rs.html#140)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\> for [RenderEntity](../../render/sync_world/struct.RenderEntity.html "struct bevy::render::sync_world::RenderEntity")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/sync_world.rs.html#141)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(entity: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")) -> [RenderEntity](../../render/sync_world/struct.RenderEntity.html "struct bevy::render::sync_world::RenderEntity")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/sync_world.rs.html#168)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\> for [MainEntity](../../render/sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity")

[Source](https://docs.rs/bevy_render/0.19.0/x86_64-unknown-linux-gnu/src/bevy_render/sync_world.rs.html#169)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(entity: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")) -> [MainEntity](../../render/sync_world/struct.MainEntity.html "struct bevy::render::sync_world::MainEntity")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/lifecycle.rs.html#398)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[RemovedComponentEntity](../lifecycle/struct.RemovedComponentEntity.html "struct bevy::ecs::lifecycle::RemovedComponentEntity")\> for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/lifecycle.rs.html#398)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [RemovedComponentEntity](../lifecycle/struct.RemovedComponentEntity.html "struct bevy::ecs::lifecycle::RemovedComponentEntity")) -> [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#414)

### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#414)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#414)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
### impl [FromEntitySetIterator](../entity/trait.FromEntitySetIterator.html "trait bevy::ecs::entity::FromEntitySetIterator")<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\> for [EntityHashSet](../entity/struct.EntityHashSet.html "struct bevy::ecs::entity::EntityHashSet")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_set.rs.html#200)

#### fn [from\_entity\_set\_iter](../entity/trait.FromEntitySetIterator.html#tymethod.from_entity_set_iter)<I>(set\_iter: I) -> [EntityHashSet](../entity/struct.EntityHashSet.html "struct bevy::ecs::entity::EntityHashSet")

where I: [EntitySet](../entity/trait.EntitySet.html "trait bevy::ecs::entity::EntitySet")<Item = [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\>,

Creates a value from an [`EntitySetIterator`](../entity/trait.EntitySetIterator.html "trait bevy::ecs::entity::EntitySetIterator").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_set.rs.html#193)

### impl [FromIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html "trait core::iter::traits::collect::FromIterator")<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\> for [EntityHashSet](../entity/struct.EntityHashSet.html "struct bevy::ecs::entity::EntityHashSet")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_set.rs.html#194)

#### fn [from\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html#tymethod.from_iter)<I>(iterable: I) -> [EntityHashSet](../entity/struct.EntityHashSet.html "struct bevy::ecs::entity::EntityHashSet")
...
### impl [FromIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html "trait core::iter::traits::collect::FromIterator")<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\> for [EntityIndexSet](../entity/struct.EntityIndexSet.html "struct bevy::ecs::entity::EntityIndexSet")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/index_set.rs.html#189)

#### fn [from\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html#tymethod.from_iter)<I>(iterable: I) -> [EntityIndexSet](../entity/struct.EntityIndexSet.html "struct bevy::ecs::entity::EntityIndexSet")
...
#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\>
...
#### type [Template](../../prelude/trait.FromTemplate.html#associatedtype.Template) = [EntityTemplate](../template/enum.EntityTemplate.html "enum bevy::ecs::template::EntityTemplate")

The [`Template`](../../prelude/trait.Template.html "trait bevy::prelude::Template") for this type.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#414)

### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#478)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#480)
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")
...
where [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"): 'into\_return,
...
### impl [IterQueryData](../query/trait.IterQueryData.html "trait bevy::ecs::query::IterQueryData") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/map_entities.rs.html#62)

### impl [MapEntities](../entity/trait.MapEntities.html "trait bevy::ecs::entity::MapEntities") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/map_entities.rs.html#63)

#### fn [map\_entities](../entity/trait.MapEntities.html#tymethod.map_entities)<E>(&mut self, entity\_mapper: [&mut E](https://doc.rust-lang.org/nightly/std/primitive.reference.html))

where E: [EntityMapper](../../prelude/trait.EntityMapper.html "trait bevy::prelude::EntityMapper"),

Updates all [`Entity`](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") references stored inside using `entity_mapper`. [Read more](../entity/trait.MapEntities.html#tymethod.map_entities)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#468)

### impl [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#470)

#### fn [cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html#tymethod.cmp)(&self, other: &[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#436)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#438)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#454)

### impl [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#456)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")\>
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#414)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#416)
...
### impl [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")
...
#### type [ReadOnly](../query/trait.QueryData.html#associatedtype.ReadOnly) = [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")
...
#### type [Item](../query/trait.QueryData.html#associatedtype.Item)<'w, 's> = [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#559-561)

#### fn [shrink](../query/trait.QueryData.html#tymethod.shrink)<'wlong, 'wshort, 's>( item: <[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'wlong, 's>, ) -> <[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'wshort, 's>

where 'wlong: 'wshort,

This function manually implements subtyping for the query items.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#566-571)

#### unsafe fn [fetch](../query/trait.QueryData.html#tymethod.fetch)<'w, 's>( \_state: &'s <[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[State](../query/trait.WorldQuery.html#associatedtype.State "type bevy::ecs::query::WorldQuery::State"), \_fetch: &mut <[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'w>, entity: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), \_table\_row: [TableRow](../storage/struct.TableRow.html "struct bevy::ecs::storage::TableRow"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'w, 's>>
...
### impl [ReadOnlyQueryData](../query/trait.ReadOnlyQueryData.html "trait bevy::ecs::query::ReadOnlyQueryData") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")
...
#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [RelationshipSourceCollection](../relationship/trait.RelationshipSourceCollection.html "trait bevy::ecs::relationship::RelationshipSourceCollection") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")
...
#### type [SourceIter](../relationship/trait.RelationshipSourceCollection.html#associatedtype.SourceIter)<'a> = [IntoIter](https://doc.rust-lang.org/nightly/core/option/struct.IntoIter.html "struct core::option::IntoIter")<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/relationship_source_collection.rs.html#337)

#### fn [new](../relationship/trait.RelationshipSourceCollection.html#tymethod.new)() -> [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

Creates a new empty instance.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/relationship_source_collection.rs.html#341)

#### fn [reserve](../relationship/trait.RelationshipSourceCollection.html#tymethod.reserve)(&mut self, \_: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html))
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/relationship_source_collection.rs.html#343)

#### fn [with\_capacity](../relationship/trait.RelationshipSourceCollection.html#tymethod.with_capacity)(\_capacity: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/relationship_source_collection.rs.html#347)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/relationship_source_collection.rs.html#352)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/relationship_source_collection.rs.html#362)

#### fn [iter](../relationship/trait.RelationshipSourceCollection.html#tymethod.iter)(&self) -> <[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") as [RelationshipSourceCollection](../relationship/trait.RelationshipSourceCollection.html "trait bevy::ecs::relationship::RelationshipSourceCollection")\>::[SourceIter](../relationship/trait.RelationshipSourceCollection.html#associatedtype.SourceIter "type bevy::ecs::relationship::RelationshipSourceCollection::SourceIter")<'\_>

Iterates all entities in the collection.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/relationship_source_collection.rs.html#370)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/relationship_source_collection.rs.html#377)

#### fn [clear](../relationship/trait.RelationshipSourceCollection.html#tymethod.clear)(&mut self)

Clears the collection.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/relationship_source_collection.rs.html#381)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/relationship_source_collection.rs.html#383)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/relationship/relationship_source_collection.rs.html#389)
...
### impl [ReleaseStateQueryData](../query/trait.ReleaseStateQueryData.html "trait bevy::ecs::query::ReleaseStateQueryData") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#590)

#### fn [release\_state](../query/trait.ReleaseStateQueryData.html#tymethod.release_state)<'w>( item: <[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'w, '\_>, ) -> <[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'w, 'static>

Releases the borrow from the query state by converting an item to have a `'static` state lifetime.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#633)

### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

Available on **crate feature `serialize`** only.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#634-636)
...
### impl [SingleEntityQueryData](../query/trait.SingleEntityQueryData.html "trait bevy::ecs::query::SingleEntityQueryData") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#687)

### impl [SparseSetIndex](../storage/trait.SparseSetIndex.html "trait bevy::ecs::storage::SparseSetIndex") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#689)

#### fn [sparse\_set\_index](../storage/trait.SparseSetIndex.html#tymethod.sparse_set_index)(&self) -> [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)

Gets the sparse set index corresponding to this instance.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#694)

#### fn [get\_sparse\_set\_index](../storage/trait.SparseSetIndex.html#tymethod.get_sparse_set_index)(value: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")
...
### impl [WorldEntityFetch](../world/trait.WorldEntityFetch.html "trait bevy::ecs::world::WorldEntityFetch") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_fetch.rs.html#199)

#### type [Ref](../world/trait.WorldEntityFetch.html#associatedtype.Ref)<'w> = [EntityRef](../../prelude/struct.EntityRef.html "struct bevy::prelude::EntityRef")<'w>
...
#### type [Mut](../world/trait.WorldEntityFetch.html#associatedtype.Mut)<'w> = [EntityWorldMut](../../prelude/struct.EntityWorldMut.html "struct bevy::prelude::EntityWorldMut")<'w>
...
#### type [DeferredMut](../world/trait.WorldEntityFetch.html#associatedtype.DeferredMut)<'w> = [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'w>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_fetch.rs.html#204-207)

#### unsafe fn [fetch\_ref](../world/trait.WorldEntityFetch.html#tymethod.fetch_ref)( self, cell: [UnsafeWorldCell](../world/unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") as [WorldEntityFetch](../world/trait.WorldEntityFetch.html "trait bevy::ecs::world::WorldEntityFetch")\>::[Ref](../world/trait.WorldEntityFetch.html#associatedtype.Ref "type bevy::ecs::world::WorldEntityFetch::Ref")<'\_>, [EntityNotSpawnedError](../entity/enum.EntityNotSpawnedError.html "enum bevy::ecs::entity::EntityNotSpawnedError")\>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_fetch.rs.html#214-217)

#### unsafe fn [fetch\_mut](../world/trait.WorldEntityFetch.html#tymethod.fetch_mut)( self, cell: [UnsafeWorldCell](../world/unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") as [WorldEntityFetch](../world/trait.WorldEntityFetch.html "trait bevy::ecs::world::WorldEntityFetch")\>::[Mut](../world/trait.WorldEntityFetch.html#associatedtype.Mut "type bevy::ecs::world::WorldEntityFetch::Mut")<'\_>, [EntityMutableFetchError](../world/error/enum.EntityMutableFetchError.html "enum bevy::ecs::world::error::EntityMutableFetchError")\>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_fetch.rs.html#226-229)

#### unsafe fn [fetch\_deferred\_mut](../world/trait.WorldEntityFetch.html#tymethod.fetch_deferred_mut)( self, cell: [UnsafeWorldCell](../world/unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") as [WorldEntityFetch](../world/trait.WorldEntityFetch.html "trait bevy::ecs::world::WorldEntityFetch")\>::[DeferredMut](../world/trait.WorldEntityFetch.html#associatedtype.DeferredMut "type bevy::ecs::world::WorldEntityFetch::DeferredMut")<'\_>, [EntityMutableFetchError](../world/error/enum.EntityMutableFetchError.html "enum bevy::ecs::world::error::EntityMutableFetchError")\>
...
### impl [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#506)

#### fn [shrink\_fetch](../query/trait.WorldQuery.html#tymethod.shrink_fetch)<'wlong, 'wshort>( \_: <[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'wlong>, ) -> <[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'wshort>

where 'wlong: 'wshort,

This function manually implements subtyping for the query fetches.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#508-513)

#### unsafe fn [init\_fetch](../query/trait.WorldQuery.html#tymethod.init_fetch)<'w, 's>( \_world: [UnsafeWorldCell](../world/unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'w>, \_state: &'s <[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[State](../query/trait.WorldQuery.html#associatedtype.State "type bevy::ecs::query::WorldQuery::State"), \_last\_run: [Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"), \_this\_run: [Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"), ) -> <[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'w>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#519-524)

#### unsafe fn [set\_archetype](../query/trait.WorldQuery.html#tymethod.set_archetype)<'w, 's>( \_fetch: &mut <[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'w>, \_state: &'s <[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[State](../query/trait.WorldQuery.html#associatedtype.State "type bevy::ecs::query::WorldQuery::State"), \_archetype: &'w [Archetype](../archetype/struct.Archetype.html "struct bevy::ecs::archetype::Archetype"), \_table: &[Table](../storage/struct.Table.html "struct bevy::ecs::storage::Table"), )
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#528-532)

#### unsafe fn [set\_table](../query/trait.WorldQuery.html#tymethod.set_table)<'w, 's>( \_fetch: &mut <[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'w>, \_state: &'s <[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[State](../query/trait.WorldQuery.html#associatedtype.State "type bevy::ecs::query::WorldQuery::State"), \_table: &'w [Table](../storage/struct.Table.html "struct bevy::ecs::storage::Table"), )
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#535)

#### fn [update\_component\_access](../query/trait.WorldQuery.html#tymethod.update_component_access)( \_state: &<[Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[State](../query/trait.WorldQuery.html#associatedtype.State "type bevy::ecs::query::WorldQuery::State"), \_access: &mut [FilteredAccess](../query/struct.FilteredAccess.html "struct bevy::ecs::query::FilteredAccess"), )
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#537)

#### fn [init\_state](../query/trait.WorldQuery.html#tymethod.init_state)(\_world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World"))
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#539)

#### fn [get\_state](../query/trait.WorldQuery.html#tymethod.get_state)(\_components: &[Components](../component/struct.Components.html "struct bevy::ecs::component::Components")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html)\>
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")
