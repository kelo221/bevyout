...
This acts effectively the same as a [`MessageReader`](../../prelude/struct.MessageReader.html "struct bevy::prelude::MessageReader").

Unlike hooks or observers (see the [lifecycle](../index.html "mod bevy::ecs") module docs), this does not allow you to see which data existed before removal.

If you are using `bevy_ecs` as a standalone crate, note that the [`RemovedComponents`](../../prelude/struct.RemovedComponents.html "struct bevy::prelude::RemovedComponents") list will not be automatically cleared for you, and will need to be manually flushed using [`World::clear_trackers`](../../prelude/struct.World.html#method.clear_trackers "method bevy::prelude::World::clear_trackers").

For users of `bevy` and `bevy_app`, [`World::clear_trackers`](../../prelude/struct.World.html#method.clear_trackers "method bevy::prelude::World::clear_trackers") is automatically called by `bevy_app::App::update` and `bevy_app::SubApp::update`. For the main world, this is delayed until after all `SubApp`s have run.
...
### impl<'w, 's, T> [RemovedComponents](../../prelude/struct.RemovedComponents.html "struct bevy::prelude::RemovedComponents")<'w, 's, T>
...
#### pub fn [reader](#method.reader)(&self) -> &[MessageCursor](../message/struct.MessageCursor.html "struct bevy::ecs::message::MessageCursor")<[RemovedComponentEntity](../lifecycle/struct.RemovedComponentEntity.html "struct bevy::ecs::lifecycle::RemovedComponentEntity")\>

Fetch underlying [`MessageCursor`](../message/struct.MessageCursor.html "struct bevy::ecs::message::MessageCursor").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/lifecycle.rs.html#549)

#### pub fn [reader\_mut](#method.reader_mut)(&mut self) -> &mut [MessageCursor](../message/struct.MessageCursor.html "struct bevy::ecs::message::MessageCursor")<[RemovedComponentEntity](../lifecycle/struct.RemovedComponentEntity.html "struct bevy::ecs::lifecycle::RemovedComponentEntity")\>

Fetch underlying [`MessageCursor`](../message/struct.MessageCursor.html "struct bevy::ecs::message::MessageCursor") mutably.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/lifecycle.rs.html#554)

#### pub fn [messages](#method.messages)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<[RemovedComponentEntity](../lifecycle/struct.RemovedComponentEntity.html "struct bevy::ecs::lifecycle::RemovedComponentEntity")\>>

Fetch underlying [`Messages`](../../prelude/struct.Messages.html "struct bevy::prelude::Messages").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/lifecycle.rs.html#563-568)

#### pub fn [reader\_mut\_with\_messages](#method.reader_mut_with_messages)( &mut self, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<(&mut [RemovedComponentReader](../lifecycle/struct.RemovedComponentReader.html "struct bevy::ecs::lifecycle::RemovedComponentReader")<T>, &[Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<[RemovedComponentEntity](../lifecycle/struct.RemovedComponentEntity.html "struct bevy::ecs::lifecycle::RemovedComponentEntity")\>)>
...
#### pub fn [read](#method.read)( &mut self, ) -> [Map](https://doc.rust-lang.org/nightly/core/iter/adapters/map/struct.Map.html "struct core::iter::adapters::map::Map")<[Flatten](https://doc.rust-lang.org/nightly/core/iter/adapters/flatten/struct.Flatten.html "struct core::iter::adapters::flatten::Flatten")<[IntoIter](https://doc.rust-lang.org/nightly/core/option/struct.IntoIter.html "struct core::option::IntoIter")<[Cloned](https://doc.rust-lang.org/nightly/core/iter/adapters/cloned/struct.Cloned.html "struct core::iter::adapters::cloned::Cloned")<[MessageIterator](../message/struct.MessageIterator.html "struct bevy::ecs::message::MessageIterator")<'\_, [RemovedComponentEntity](../lifecycle/struct.RemovedComponentEntity.html "struct bevy::ecs::lifecycle::RemovedComponentEntity")\>>>>, [fn](https://doc.rust-lang.org/nightly/std/primitive.fn.html)([RemovedComponentEntity](../lifecycle/struct.RemovedComponentEntity.html "struct bevy::ecs::lifecycle::RemovedComponentEntity")) -> [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\> [ⓘ](#)

Iterates over the messages this [`RemovedComponents`](../../prelude/struct.RemovedComponents.html "struct bevy::prelude::RemovedComponents") has not seen yet. This updates the [`RemovedComponents`](../../prelude/struct.RemovedComponents.html "struct bevy::prelude::RemovedComponents")’s message counter, which means subsequent message reads will not include messages that happened before now.
...
#### pub fn [read\_with\_id](#method.read_with_id)( &mut self, ) -> [Map](https://doc.rust-lang.org/nightly/core/iter/adapters/map/struct.Map.html "struct core::iter::adapters::map::Map")<[Flatten](https://doc.rust-lang.org/nightly/core/iter/adapters/flatten/struct.Flatten.html "struct core::iter::adapters::flatten::Flatten")<[IntoIter](https://doc.rust-lang.org/nightly/core/option/struct.IntoIter.html "struct core::option::IntoIter")<[MessageIteratorWithId](../message/struct.MessageIteratorWithId.html "struct bevy::ecs::message::MessageIteratorWithId")<'\_, [RemovedComponentEntity](../lifecycle/struct.RemovedComponentEntity.html "struct bevy::ecs::lifecycle::RemovedComponentEntity")\>>>, [fn](https://doc.rust-lang.org/nightly/std/primitive.fn.html)((&[RemovedComponentEntity](../lifecycle/struct.RemovedComponentEntity.html "struct bevy::ecs::lifecycle::RemovedComponentEntity"), [MessageId](../message/struct.MessageId.html "struct bevy::ecs::message::MessageId")<[RemovedComponentEntity](../lifecycle/struct.RemovedComponentEntity.html "struct bevy::ecs::lifecycle::RemovedComponentEntity")\>)) -> ([Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), [MessageId](../message/struct.MessageId.html "struct bevy::ecs::message::MessageId")<[RemovedComponentEntity](../lifecycle/struct.RemovedComponentEntity.html "struct bevy::ecs::lifecycle::RemovedComponentEntity")\>)> [ⓘ](#)

Like [`read`](../../prelude/struct.RemovedComponents.html#method.read "method bevy::prelude::RemovedComponents::read"), except also returning the [`MessageId`](../message/struct.MessageId.html "struct bevy::ecs::message::MessageId") of the messages.
...
Determines the number of removal messages available to be read from this [`RemovedComponents`](../../prelude/struct.RemovedComponents.html "struct bevy::prelude::RemovedComponents") without consuming any.
...
This means these messages will not appear in calls to [`RemovedComponents::read()`](../../prelude/struct.RemovedComponents.html#method.read "method bevy::prelude::RemovedComponents::read") or [`RemovedComponents::read_with_id()`](../../prelude/struct.RemovedComponents.html#method.read_with_id "method bevy::prelude::RemovedComponents::read_with_id") and [`RemovedComponents::is_empty()`](../../prelude/struct.RemovedComponents.html#method.is_empty "method bevy::prelude::RemovedComponents::is_empty") will return `true`.

## Trait Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/lifecycle.rs.html#509)

### impl<'w, 's, T> [ReadOnlySystemParam](../system/trait.ReadOnlySystemParam.html "trait bevy::ecs::system::ReadOnlySystemParam") for [RemovedComponents](../../prelude/struct.RemovedComponents.html "struct bevy::prelude::RemovedComponents")<'w, 's, T>

where T: [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component"), [ComponentIdFor](../component/struct.ComponentIdFor.html "struct bevy::ecs::component::ComponentIdFor")<'s, T>: [ReadOnlySystemParam](../system/trait.ReadOnlySystemParam.html "trait bevy::ecs::system::ReadOnlySystemParam"), [Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'s, [RemovedComponentReader](../lifecycle/struct.RemovedComponentReader.html "struct bevy::ecs::lifecycle::RemovedComponentReader")<T>>: [ReadOnlySystemParam](../system/trait.ReadOnlySystemParam.html "trait bevy::ecs::system::ReadOnlySystemParam"), &'w [RemovedComponentMessages](../lifecycle/struct.RemovedComponentMessages.html "struct bevy::ecs::lifecycle::RemovedComponentMessages"): [ReadOnlySystemParam](../system/trait.ReadOnlySystemParam.html "trait bevy::ecs::system::ReadOnlySystemParam"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/lifecycle.rs.html#509)

### impl<T> [SystemParam](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam") for [RemovedComponents](../../prelude/struct.RemovedComponents.html "struct bevy::prelude::RemovedComponents")<'\_, '\_, T>

where T: [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/lifecycle.rs.html#509)

#### type [State](../system/trait.SystemParam.html#associatedtype.State) = FetchState<T>

Used to store data which persists across invocations of a system.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/lifecycle.rs.html#509)

#### type [Item](../system/trait.SystemParam.html#associatedtype.Item)<'w, 's> = [RemovedComponents](../../prelude/struct.RemovedComponents.html "struct bevy::prelude::RemovedComponents")<'w, 's, T>
...
#### fn [init\_state](../system/trait.SystemParam.html#tymethod.init_state)( world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World"), ) -> <[RemovedComponents](../../prelude/struct.RemovedComponents.html "struct bevy::prelude::RemovedComponents")<'\_, '\_, T> as [SystemParam](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](../system/trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State")
...
#### fn [apply](../system/trait.SystemParam.html#method.apply)( state: &mut <[RemovedComponents](../../prelude/struct.RemovedComponents.html "struct bevy::prelude::RemovedComponents")<'\_, '\_, T> as [SystemParam](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](../system/trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State"), system\_meta: &[SystemMeta](../system/struct.SystemMeta.html "struct bevy::ecs::system::SystemMeta"), world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World"), )
...
#### fn [queue](../system/trait.SystemParam.html#method.queue)( state: &mut <[RemovedComponents](../../prelude/struct.RemovedComponents.html "struct bevy::prelude::RemovedComponents")<'\_, '\_, T> as [SystemParam](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](../system/trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State"), system\_meta: &[SystemMeta](../system/struct.SystemMeta.html "struct bevy::ecs::system::SystemMeta"), world: [DeferredWorld](../world/struct.DeferredWorld.html "struct bevy::ecs::world::DeferredWorld")<'\_>, )
...
#### unsafe fn [get\_param](../system/trait.SystemParam.html#tymethod.get_param)<'w, 's>( state: &'s mut <[RemovedComponents](../../prelude/struct.RemovedComponents.html "struct bevy::prelude::RemovedComponents")<'\_, '\_, T> as [SystemParam](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](../system/trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State"), system\_meta: &[SystemMeta](../system/struct.SystemMeta.html "struct bevy::ecs::system::SystemMeta"), world: [UnsafeWorldCell](../world/unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'w>, change\_tick: [Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[RemovedComponents](../../prelude/struct.RemovedComponents.html "struct bevy::prelude::RemovedComponents")<'\_, '\_, T> as [SystemParam](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[Item](../system/trait.SystemParam.html#associatedtype.Item "type bevy::ecs::system::SystemParam::Item")<'w, 's>, [SystemParamValidationError](../system/struct.SystemParamValidationError.html "struct bevy::ecs::system::SystemParamValidationError")\>
...
### impl<'w, 's, T> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RemovedComponents](../../prelude/struct.RemovedComponents.html "struct bevy::prelude::RemovedComponents")<'w, 's, T>

### impl<'w, 's, T> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RemovedComponents](../../prelude/struct.RemovedComponents.html "struct bevy::prelude::RemovedComponents")<'w, 's, T>

### impl<'w, 's, T> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RemovedComponents](../../prelude/struct.RemovedComponents.html "struct bevy::prelude::RemovedComponents")<'w, 's, T>
...
### impl<'w, 's, T> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RemovedComponents](../../prelude/struct.RemovedComponents.html "struct bevy::prelude::RemovedComponents")<'w, 's, T>

### impl<'w, 's, T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RemovedComponents](../../prelude/struct.RemovedComponents.html "struct bevy::prelude::RemovedComponents")<'w, 's, T>

### impl<'w, 's, T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RemovedComponents](../../prelude/struct.RemovedComponents.html "struct bevy::prelude::RemovedComponents")<'w, 's, T>

### impl<'w, 's, T> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RemovedComponents](../../prelude/struct.RemovedComponents.html "struct bevy::prelude::RemovedComponents")<'w, 's, T>
