...
`Query` has few sibling [`SystemParam`](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")s, which perform additional validation:
...
#### pub fn [transmute\_lens](#method.transmute_lens)<NewD>(&mut self) -> [QueryLens](../system/struct.QueryLens.html "struct bevy::ecs::system::QueryLens")<'\_, NewD>

where NewD: [SingleEntityQueryData](../query/trait.SingleEntityQueryData.html "trait bevy::ecs::query::SingleEntityQueryData"),

Returns a [`QueryLens`](../system/struct.QueryLens.html "struct bevy::ecs::system::QueryLens") that can be used to construct a new [`Query`](../../prelude/struct.Query.html "struct bevy::prelude::Query") giving more restrictive access to the entities matched by the current query.
...
`transmute_lens` drops filter terms, but [`Self::transmute_lens_filtered`](../../prelude/struct.Query.html#method.transmute_lens_filtered "method bevy::prelude::Query::transmute_lens_filtered") supports returning a [`QueryLens`](../system/struct.QueryLens.html "struct bevy::ecs::system::QueryLens") with a new filter type - the access required by filter parameters are as follows.
...
#### pub fn [transmute\_lens\_inner](#method.transmute_lens_inner)<NewD>(self) -> [QueryLens](../system/struct.QueryLens.html "struct bevy::ecs::system::QueryLens")<'w, NewD>

where NewD: [SingleEntityQueryData](../query/trait.SingleEntityQueryData.html "trait bevy::ecs::query::SingleEntityQueryData"),

Returns a [`QueryLens`](../system/struct.QueryLens.html "struct bevy::ecs::system::QueryLens") that can be used to construct a new `Query` giving more restrictive access to the entities matched by the current query.
...
#### pub fn [transmute\_lens\_filtered](#method.transmute_lens_filtered)<NewD, NewF>( &mut self, ) -> [QueryLens](../system/struct.QueryLens.html "struct bevy::ecs::system::QueryLens")<'\_, NewD, NewF>
...
#### pub fn [transmute\_lens\_filtered\_inner](#method.transmute_lens_filtered_inner)<NewD, NewF>( self, ) -> [QueryLens](../system/struct.QueryLens.html "struct bevy::ecs::system::QueryLens")<'w, NewD, NewF>
...
#### pub fn [as\_query\_lens](#method.as_query_lens)(&mut self) -> [QueryLens](../system/struct.QueryLens.html "struct bevy::ecs::system::QueryLens")<'\_, D>

where D: [SingleEntityQueryData](../query/trait.SingleEntityQueryData.html "trait bevy::ecs::query::SingleEntityQueryData"),

Gets a [`QueryLens`](../system/struct.QueryLens.html "struct bevy::ecs::system::QueryLens") with the same accesses as the existing query

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/query.rs.html#2581-2583)

#### pub fn [into\_query\_lens](#method.into_query_lens)(self) -> [QueryLens](../system/struct.QueryLens.html "struct bevy::ecs::system::QueryLens")<'w, D>
...
#### pub fn [join](#method.join)<'a, OtherD, NewD>( &'a mut self, other: &'a mut [Query](../../prelude/struct.Query.html "struct bevy::prelude::Query")<'\_, '\_, OtherD>, ) -> [QueryLens](../system/struct.QueryLens.html "struct bevy::ecs::system::QueryLens")<'a, NewD>
...
Returns a [`QueryLens`](../system/struct.QueryLens.html "struct bevy::ecs::system::QueryLens") that can be used to get a query with the combined fetch.
...
#### pub fn [join\_inner](#method.join_inner)<OtherD, NewD>( self, other: [Query](../../prelude/struct.Query.html "struct bevy::prelude::Query")<'w, '\_, OtherD>, ) -> [QueryLens](../system/struct.QueryLens.html "struct bevy::ecs::system::QueryLens")<'w, NewD>

where OtherD: [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData"), NewD: [SingleEntityQueryData](../query/trait.SingleEntityQueryData.html "trait bevy::ecs::query::SingleEntityQueryData"),

Returns a [`QueryLens`](../system/struct.QueryLens.html "struct bevy::ecs::system::QueryLens") that can be used to get a query with the combined fetch. This consumes the [`Query`](../../prelude/struct.Query.html "struct bevy::prelude::Query") to return results with the actual “inner” world lifetime.
...
#### pub fn [join\_filtered](#method.join_filtered)<'a, OtherD, OtherF, NewD, NewF>( &'a mut self, other: &'a mut [Query](../../prelude/struct.Query.html "struct bevy::prelude::Query")<'\_, '\_, OtherD, OtherF>, ) -> [QueryLens](../system/struct.QueryLens.html "struct bevy::ecs::system::QueryLens")<'a, NewD, NewF>
...
#### pub fn [join\_filtered\_inner](#method.join_filtered_inner)<OtherD, OtherF, NewD, NewF>( self, other: [Query](../../prelude/struct.Query.html "struct bevy::prelude::Query")<'w, '\_, OtherD, OtherF>, ) -> [QueryLens](../system/struct.QueryLens.html "struct bevy::ecs::system::QueryLens")<'w, NewD, NewF>
...
### impl<'w, 'q, Q, F> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'q mut [Query](../../prelude/struct.Query.html "struct bevy::prelude::Query")<'w, '\_, Q, F>> for [QueryLens](../system/struct.QueryLens.html "struct bevy::ecs::system::QueryLens")<'q, Q, F>
...
#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: &'q mut [Query](../../prelude/struct.Query.html "struct bevy::prelude::Query")<'w, '\_, Q, F>) -> [QueryLens](../system/struct.QueryLens.html "struct bevy::ecs::system::QueryLens")<'q, Q, F>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/query.rs.html#2792-2793)

### impl<'w, 's, Q, F> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'s mut [QueryLens](../system/struct.QueryLens.html "struct bevy::ecs::system::QueryLens")<'w, Q, F>> for [Query](../../prelude/struct.Query.html "struct bevy::prelude::Query")<'s, 's, Q, F>
...
#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: &'s mut [QueryLens](../system/struct.QueryLens.html "struct bevy::ecs::system::QueryLens")<'w, Q, F>) -> [Query](../../prelude/struct.Query.html "struct bevy::prelude::Query")<'s, 's, Q, F>
...
### impl<'w, 's, D, F> [ReadOnlySystemParam](../system/trait.ReadOnlySystemParam.html "trait bevy::ecs::system::ReadOnlySystemParam") for [Query](../../prelude/struct.Query.html "struct bevy::prelude::Query")<'w, 's, D, F>
...
### impl<D, F> [SystemParam](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam") for [Query](../../prelude/struct.Query.html "struct bevy::prelude::Query")<'\_, '\_, D, F>
...
#### type [State](../system/trait.SystemParam.html#associatedtype.State) = [QueryState](../../prelude/struct.QueryState.html "struct bevy::prelude::QueryState")<D, F>

Used to store data which persists across invocations of a system.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#306)

#### type [Item](../system/trait.SystemParam.html#associatedtype.Item)<'w, 's> = [Query](../../prelude/struct.Query.html "struct bevy::prelude::Query")<'w, 's, D, F>
...
### impl<'w, 's, D, F, T> [SystemParamBuilder](../../prelude/trait.SystemParamBuilder.html "trait bevy::prelude::SystemParamBuilder")<[Query](../../prelude/struct.Query.html "struct bevy::prelude::Query")<'w, 's, D, F>> for [QueryParamBuilder](../system/struct.QueryParamBuilder.html "struct bevy::ecs::system::QueryParamBuilder")<T>
