...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#46)
...
`ignored_scheduling_ambiguities: [BTreeSet](https://doc.rust-lang.org/nightly/alloc/collections/btree/set/struct.BTreeSet.html "struct alloc::collections::btree::set::BTreeSet")<[ComponentId](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")>`

List of [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")s to ignore when reporting system order ambiguity conflicts

## Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#57)

### impl [Schedules](../../prelude/struct.Schedules.html "struct bevy::prelude::Schedules")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#59)

#### pub fn [new](#method.new)() -> [Schedules](../../prelude/struct.Schedules.html "struct bevy::prelude::Schedules")

Constructs an empty `Schedules` with zero initial capacity.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#67)

#### pub fn [insert](#method.insert)(&mut self, schedule: [Schedule](../../prelude/struct.Schedule.html "struct bevy::prelude::Schedule")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Schedule](../../prelude/struct.Schedule.html "struct bevy::prelude::Schedule")\>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#77)

#### pub fn [reinsert](#method.reinsert)(&mut self, schedule: [Schedule](../../prelude/struct.Schedule.html "struct bevy::prelude::Schedule")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Schedule](../../prelude/struct.Schedule.html "struct bevy::prelude::Schedule")\>

Inserts a labeled schedule into the map.

If the map already had an entry for `label`, `schedule` is inserted, and the old schedule is returned. Otherwise, `None` is returned.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#84)

#### pub fn [remove](#method.remove)(&mut self, label: impl [ScheduleLabel](../schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Schedule](../../prelude/struct.Schedule.html "struct bevy::prelude::Schedule")\>

Removes the schedule corresponding to the `label` from the map, returning it if it existed.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#89)

#### pub fn [remove\_temporarily](#method.remove_temporarily)( &mut self, label: impl [ScheduleLabel](../schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Schedule](../../prelude/struct.Schedule.html "struct bevy::prelude::Schedule")\>

Removes the schedule corresponding to the `label` from the map, returning it if it existed, tracks.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#103-106)

#### pub fn [remove\_entry](#method.remove_entry)( &mut self, label: impl [ScheduleLabel](../schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<([Interned](../intern/struct.Interned.html "struct bevy::ecs::intern::Interned")<dyn [ScheduleLabel](../schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")\>, [Schedule](../../prelude/struct.Schedule.html "struct bevy::prelude::Schedule"))>

Removes the (schedule, label) pair corresponding to the `label` from the map, returning it if it existed.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#111)

#### pub fn [get\_temporarily\_removed](#method.get_temporarily_removed)(&self) -> [HashSet](../../platform/collections/struct.HashSet.html "struct bevy::platform::collections::HashSet")<[Interned](../intern/struct.Interned.html "struct bevy::ecs::intern::Interned")<dyn [ScheduleLabel](../schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")\>>

Gets a set of temporarily removed schedules

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#116)

#### pub fn [get\_empty\_labels](#method.get_empty_labels)(&self) -> [HashSet](../../platform/collections/struct.HashSet.html "struct bevy::platform::collections::HashSet")<[Interned](../intern/struct.Interned.html "struct bevy::ecs::intern::Interned")<dyn [ScheduleLabel](../schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")\>>

Gets a set of empty schedule labels

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#121)

#### pub fn [contains](#method.contains)(&self, label: impl [ScheduleLabel](../schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Does a schedule with the provided label already exist?

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#126)

#### pub fn [get](#method.get)(&self, label: impl [ScheduleLabel](../schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[Schedule](../../prelude/struct.Schedule.html "struct bevy::prelude::Schedule")\>

Returns a reference to the schedule associated with `label`, if it exists.

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/showcase/stepping.rs ([line 119](../../../src/breakout/stepping.rs.html#119))
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#131)

#### pub fn [get\_mut](#method.get_mut)(&mut self, label: impl [ScheduleLabel](../schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&mut [Schedule](../../prelude/struct.Schedule.html "struct bevy::prelude::Schedule")\>

Returns a mutable reference to the schedule associated with `label`, if it exists.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#136)

#### pub fn [entry](#method.entry)(&mut self, label: impl [ScheduleLabel](../schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel")) -> &mut [Schedule](../../prelude/struct.Schedule.html "struct bevy::prelude::Schedule")

Returns a mutable reference to the schedules associated with `label`, creating one if it doesn’t already exist.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#143)

#### pub fn [iter](#method.iter)( &self, ) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = (&(dyn [ScheduleLabel](../schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel") + 'static), &[Schedule](../../prelude/struct.Schedule.html "struct bevy::prelude::Schedule"))>

Returns an iterator over all schedules. Iteration order is undefined.

##### [Examples found in repository](#scraped-examples-1)[?](../../../scrape-examples-help.html)

tests/ecs/ambiguity\_detection.rs ([line 95](../../../src/ambiguity_detection/ambiguity_detection.rs.html#95))
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#149)

#### pub fn [iter\_mut](#method.iter_mut)( &mut self, ) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = (&(dyn [ScheduleLabel](../schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel") + 'static), &mut [Schedule](../../prelude/struct.Schedule.html "struct bevy::prelude::Schedule"))>
...
tests/ecs/ambiguity\_detection.rs ([line 72](../../../src/ambiguity_detection/ambiguity_detection.rs.html#72))
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#181)

#### pub fn [configure\_schedules](#method.configure_schedules)( &mut self, schedule\_build\_settings: [ScheduleBuildSettings](../schedule/struct.ScheduleBuildSettings.html "struct bevy::ecs::schedule::ScheduleBuildSettings"), )

Applies the provided [`ScheduleBuildSettings`](../schedule/struct.ScheduleBuildSettings.html "struct bevy::ecs::schedule::ScheduleBuildSettings") to all schedules.

This mutates all currently present schedules, but does not apply to schedules added in the future.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#188)

#### pub fn [allow\_ambiguous\_component](#method.allow_ambiguous_component)<T>(&mut self, world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World"))
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#194)

#### pub fn [allow\_ambiguous\_resource](#method.allow_ambiguous_resource)<T>(&mut self, world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World"))
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#200)

#### pub fn [iter\_ignored\_ambiguities](#method.iter_ignored_ambiguities)(&self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = &[ComponentId](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")\>

Iterate through the [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")’s that will be ignored.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#208)

#### pub fn [print\_ignored\_ambiguities](#method.print_ignored_ambiguities)(&self, components: &[Components](../component/struct.Components.html "struct bevy::ecs::component::Components"))

Prints the names of the components and resources with [`info`](https://docs.rs/log/0.4.32/x86_64-unknown-linux-gnu/log/macro.info.html "macro log::info")

May panic or retrieve incorrect names if [`Components`](../component/struct.Components.html "struct bevy::ecs::component::Components") is not from the same world

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#220-224)

#### pub fn [add\_systems](#method.add_systems)<M>( &mut self, schedule: impl [ScheduleLabel](../schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel"), systems: impl [IntoScheduleConfigs](../../prelude/trait.IntoScheduleConfigs.html "trait bevy::prelude::IntoScheduleConfigs")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [System](../../prelude/trait.System.html "trait bevy::prelude::System")<Out = [()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), In = [()](https://doc.rust-lang.org/nightly/std/primitive.unit.html)\>>, M>, ) -> &mut [Schedules](../../prelude/struct.Schedules.html "struct bevy::prelude::Schedules")

Adds one or more systems to the [`Schedule`](../../prelude/struct.Schedule.html "struct bevy::prelude::Schedule") matching the provided [`ScheduleLabel`](../schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#233-239)

#### pub fn [remove\_systems\_in\_set](#method.remove_systems_in_set)<M>( &mut self, schedule: impl [ScheduleLabel](../schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel"), set: impl [IntoSystemSet](../../prelude/trait.IntoSystemSet.html "trait bevy::prelude::IntoSystemSet")<M>, world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World"), policy: [ScheduleCleanupPolicy](../schedule/enum.ScheduleCleanupPolicy.html "enum bevy::ecs::schedule::ScheduleCleanupPolicy"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), [ScheduleError](../schedule/enum.ScheduleError.html "enum bevy::ecs::schedule::ScheduleError")\>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#247-251)

#### pub fn [configure\_sets](#method.configure_sets)<M>( &mut self, schedule: impl [ScheduleLabel](../schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel"), sets: impl [IntoScheduleConfigs](../../prelude/trait.IntoScheduleConfigs.html "trait bevy::prelude::IntoScheduleConfigs")<[Interned](../intern/struct.Interned.html "struct bevy::ecs::intern::Interned")<dyn [SystemSet](../../prelude/trait.SystemSet.html "trait bevy::prelude::SystemSet")\>, M>, ) -> &mut [Schedules](../../prelude/struct.Schedules.html "struct bevy::prelude::Schedules")

Configures a collection of system sets in the provided schedule, adding any sets that do not exist.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#264-272)

#### pub fn [ignore\_ambiguity](#method.ignore_ambiguity)<M1, M2, S1, S2>( &mut self, schedule: impl [ScheduleLabel](../schedule/trait.ScheduleLabel.html "trait bevy::ecs::schedule::ScheduleLabel"), a: S1, b: S2, ) -> &mut [Schedules](../../prelude/struct.Schedules.html "struct bevy::prelude::Schedules")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [Schedules](../../prelude/struct.Schedules.html "struct bevy::prelude::Schedules")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Schedules](../../prelude/struct.Schedules.html "struct bevy::prelude::Schedules")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/schedule/schedule.rs.html#45)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Schedules](../../prelude/struct.Schedules.html "struct bevy::prelude::Schedules")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Schedules](../../prelude/struct.Schedules.html "struct bevy::prelude::Schedules")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Schedules](../../prelude/struct.Schedules.html "struct bevy::prelude::Schedules")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Schedules](../../prelude/struct.Schedules.html "struct bevy::prelude::Schedules")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Schedules](../../prelude/struct.Schedules.html "struct bevy::prelude::Schedules")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Schedules](../../prelude/struct.Schedules.html "struct bevy::prelude::Schedules")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Schedules](../../prelude/struct.Schedules.html "struct bevy::prelude::Schedules")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Schedules](../../prelude/struct.Schedules.html "struct bevy::prelude::Schedules")
