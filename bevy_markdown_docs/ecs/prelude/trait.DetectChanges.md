...
#### fn [is\_added\_after](#tymethod.is_added_after)(&self, other: [Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
#### fn [is\_changed\_after](#tymethod.is_changed_after)(&self, other: [Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
#### fn [last\_changed](#tymethod.last_changed)(&self) -> [Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick")
...
#### fn [added](#tymethod.added)(&self) -> [Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick")
...
#### fn [changed\_by](#tymethod.changed_by)(&self) -> [MaybeLocation](../change_detection/struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")
...
### impl<'w> [DetectChanges](../../prelude/trait.DetectChanges.html "trait bevy::prelude::DetectChanges") for [MutUntyped](../change_detection/struct.MutUntyped.html "struct bevy::ecs::change_detection::MutUntyped")<'w>