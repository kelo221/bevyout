...
#### pub fn [added\_ticks\_slice](#method.added_ticks_slice)(&self) -> &'w \[[Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick")\]
...
#### pub fn [changed\_ticks\_slice](#method.changed_ticks_slice)(&self) -> &'w \[[Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick")\]
...
#### pub fn [changed\_by\_ticks\_slice](#method.changed_by_ticks_slice)( &self, ) -> [MaybeLocation](../change_detection/struct.MaybeLocation.html "struct bevy::ecs::change_detection::MaybeLocation")<&\[&'static [Location](https://doc.rust-lang.org/nightly/core/panic/location/struct.Location.html "struct core::panic::location::Location")<'static>\]>
...
#### pub fn [split](#method.split)( this: [ContiguousRef](../../prelude/struct.ContiguousRef.html "struct bevy::prelude::ContiguousRef")<'w, T>, ) -> (&'w [\[T\]](https://doc.rust-lang.org/nightly/std/primitive.slice.html), [ContiguousComponentTicksRef](../change_detection/struct.ContiguousComponentTicksRef.html "struct bevy::ecs::change_detection::ContiguousComponentTicksRef")<'w>)
...
#### pub fn [from\_parts](#method.from_parts)( value: &'w [\[T\]](https://doc.rust-lang.org/nightly/std/primitive.slice.html), ticks: [ContiguousComponentTicksRef](../change_detection/struct.ContiguousComponentTicksRef.html "struct bevy::ecs::change_detection::ContiguousComponentTicksRef")<'w>, ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ContiguousRef](../../prelude/struct.ContiguousRef.html "struct bevy::prelude::ContiguousRef")<'w, T>>
