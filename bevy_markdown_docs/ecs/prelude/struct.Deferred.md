...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#1184)
...
Note that deferring mutations is _not_ free, and should only be used if the gains in parallelization outweigh the time it takes to apply deferred mutations. In general, [`Deferred`](../../prelude/struct.Deferred.html "struct bevy::prelude::Deferred") should only be used for mutations that are infrequent, or which otherwise take up a small portion of a system’s run-time.
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#1201)

### impl<T> [Deferred](../../prelude/struct.Deferred.html "struct bevy::prelude::Deferred")<'\_, T>

where T: [SystemBuffer](../system/trait.SystemBuffer.html "trait bevy::ecs::system::SystemBuffer"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#1204)

#### pub fn [reborrow](#method.reborrow)(&mut self) -> [Deferred](../../prelude/struct.Deferred.html "struct bevy::prelude::Deferred")<'\_, T>

Returns a [`Deferred<T>`](../../prelude/struct.Deferred.html "struct bevy::prelude::Deferred") with a smaller lifetime. This is useful if you have `&mut Deferred<T>` but need `Deferred<T>`.

## Trait Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#1186)

### impl<'a, T> [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [Deferred](../../prelude/struct.Deferred.html "struct bevy::prelude::Deferred")<'a, T>

where T: [SystemBuffer](../system/trait.SystemBuffer.html "trait bevy::ecs::system::SystemBuffer"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#1187)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = T

The resulting type after dereferencing.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#1189)

#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[Deferred](../../prelude/struct.Deferred.html "struct bevy::prelude::Deferred")<'a, T> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#1194)

### impl<'a, T> [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [Deferred](../../prelude/struct.Deferred.html "struct bevy::prelude::Deferred")<'a, T>

where T: [SystemBuffer](../system/trait.SystemBuffer.html "trait bevy::ecs::system::SystemBuffer"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#1196)

#### fn [deref\_mut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html#tymethod.deref_mut)(&mut self) -> &mut <[Deferred](../../prelude/struct.Deferred.html "struct bevy::prelude::Deferred")<'a, T> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Mutably dereferences the value.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#1210)

### impl<T> [ReadOnlySystemParam](../system/trait.ReadOnlySystemParam.html "trait bevy::ecs::system::ReadOnlySystemParam") for [Deferred](../../prelude/struct.Deferred.html "struct bevy::prelude::Deferred")<'\_, T>

where T: [SystemBuffer](../system/trait.SystemBuffer.html "trait bevy::ecs::system::SystemBuffer"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#1213)

### impl<T> [SystemParam](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam") for [Deferred](../../prelude/struct.Deferred.html "struct bevy::prelude::Deferred")<'\_, T>
...
#### type [Item](../system/trait.SystemParam.html#associatedtype.Item)<'w, 's> = [Deferred](../../prelude/struct.Deferred.html "struct bevy::prelude::Deferred")<'s, T>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#1218)

#### fn [init\_state](../system/trait.SystemParam.html#tymethod.init_state)(world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World")) -> <[Deferred](../../prelude/struct.Deferred.html "struct bevy::prelude::Deferred")<'\_, T> as [SystemParam](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](../system/trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#1235)

#### fn [queue](../system/trait.SystemParam.html#method.queue)( state: &mut <[Deferred](../../prelude/struct.Deferred.html "struct bevy::prelude::Deferred")<'\_, T> as [SystemParam](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](../system/trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State"), system\_meta: &[SystemMeta](../system/struct.SystemMeta.html "struct bevy::ecs::system::SystemMeta"), world: [DeferredWorld](../world/struct.DeferredWorld.html "struct bevy::ecs::world::DeferredWorld")<'\_>, )
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#1240-1245)

#### unsafe fn [get\_param](../system/trait.SystemParam.html#tymethod.get_param)<'w, 's>( state: &'s mut <[Deferred](../../prelude/struct.Deferred.html "struct bevy::prelude::Deferred")<'\_, T> as [SystemParam](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](../system/trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State"), \_system\_meta: &[SystemMeta](../system/struct.SystemMeta.html "struct bevy::ecs::system::SystemMeta"), \_world: [UnsafeWorldCell](../world/unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'w>, \_change\_tick: [Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Deferred](../../prelude/struct.Deferred.html "struct bevy::prelude::Deferred")<'\_, T> as [SystemParam](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[Item](../system/trait.SystemParam.html#associatedtype.Item "type bevy::ecs::system::SystemParam::Item")<'w, 's>, [SystemParamValidationError](../system/struct.SystemParamValidationError.html "struct bevy::ecs::system::SystemParamValidationError")\>
...
### impl<'a, T> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Deferred](../../prelude/struct.Deferred.html "struct bevy::prelude::Deferred")<'a, T>

### impl<'a, T> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Deferred](../../prelude/struct.Deferred.html "struct bevy::prelude::Deferred")<'a, T>

### impl<'a, T> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Deferred](../../prelude/struct.Deferred.html "struct bevy::prelude::Deferred")<'a, T>
...
### impl<'a, T> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Deferred](../../prelude/struct.Deferred.html "struct bevy::prelude::Deferred")<'a, T>

### impl<'a, T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Deferred](../../prelude/struct.Deferred.html "struct bevy::prelude::Deferred")<'a, T>

where T: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<'a, T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Deferred](../../prelude/struct.Deferred.html "struct bevy::prelude::Deferred")<'a, T>

### impl<'a, T> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Deferred](../../prelude/struct.Deferred.html "struct bevy::prelude::Deferred")<'a, T>
