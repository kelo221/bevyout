...
This trait should only be used as a bound for trait implementations or as an argument to a function. If system configs need to be returned from a function or stored somewhere, use [`ScheduleConfigs`](../schedule/enum.ScheduleConfigs.html "enum bevy::ecs::schedule::ScheduleConfigs") instead of this trait.
...
#### fn [into\_configs](#tymethod.into_configs)(self) -> [ScheduleConfigs](../schedule/enum.ScheduleConfigs.html "enum bevy::ecs::schedule::ScheduleConfigs")<T>
...
#### fn [in\_set](#method.in_set)(self, set: impl [SystemSet](../../prelude/trait.SystemSet.html "trait bevy::prelude::SystemSet")) -> [ScheduleConfigs](../schedule/enum.ScheduleConfigs.html "enum bevy::ecs::schedule::ScheduleConfigs")<T>
...
#### fn [before](#method.before)<M>(self, set: impl [IntoSystemSet](../../prelude/trait.IntoSystemSet.html "trait bevy::prelude::IntoSystemSet")<M>) -> [ScheduleConfigs](../schedule/enum.ScheduleConfigs.html "enum bevy::ecs::schedule::ScheduleConfigs")<T>
...
#### fn [after](#method.after)<M>(self, set: impl [IntoSystemSet](../../prelude/trait.IntoSystemSet.html "trait bevy::prelude::IntoSystemSet")<M>) -> [ScheduleConfigs](../schedule/enum.ScheduleConfigs.html "enum bevy::ecs::schedule::ScheduleConfigs")<T>
...
#### fn [before\_ignore\_deferred](#method.before_ignore_deferred)<M>( self, set: impl [IntoSystemSet](../../prelude/trait.IntoSystemSet.html "trait bevy::prelude::IntoSystemSet")<M>, ) -> [ScheduleConfigs](../schedule/enum.ScheduleConfigs.html "enum bevy::ecs::schedule::ScheduleConfigs")<T>
...
#### fn [after\_ignore\_deferred](#method.after_ignore_deferred)<M>( self, set: impl [IntoSystemSet](../../prelude/trait.IntoSystemSet.html "trait bevy::prelude::IntoSystemSet")<M>, ) -> [ScheduleConfigs](../schedule/enum.ScheduleConfigs.html "enum bevy::ecs::schedule::ScheduleConfigs")<T>
...
#### fn [run\_if](#method.run_if)<M>(self, condition: impl [SystemCondition](../../prelude/trait.SystemCondition.html "trait bevy::prelude::SystemCondition")<M>) -> [ScheduleConfigs](../schedule/enum.ScheduleConfigs.html "enum bevy::ecs::schedule::ScheduleConfigs")<T>
...
#### fn [ambiguous\_with](#method.ambiguous_with)<M>(self, set: impl [IntoSystemSet](../../prelude/trait.IntoSystemSet.html "trait bevy::prelude::IntoSystemSet")<M>) -> [ScheduleConfigs](../schedule/enum.ScheduleConfigs.html "enum bevy::ecs::schedule::ScheduleConfigs")<T>
...
#### fn [ambiguous\_with\_all](#method.ambiguous_with_all)(self) -> [ScheduleConfigs](../schedule/enum.ScheduleConfigs.html "enum bevy::ecs::schedule::ScheduleConfigs")<T>
...
#### fn [chain](#method.chain)(self) -> [ScheduleConfigs](../schedule/enum.ScheduleConfigs.html "enum bevy::ecs::schedule::ScheduleConfigs")<T>
...
#### fn [chain\_ignore\_deferred](#method.chain_ignore_deferred)(self) -> [ScheduleConfigs](../schedule/enum.ScheduleConfigs.html "enum bevy::ecs::schedule::ScheduleConfigs")<T>
...
where T: [Schedulable](../schedule/trait.Schedulable.html "trait bevy::ecs::schedule::Schedulable")<Metadata = [GraphInfo](../schedule/struct.GraphInfo.html "struct bevy::ecs::schedule::GraphInfo"), GroupMetadata = [Chain](../schedule/enum.Chain.html "enum bevy::ecs::schedule::Chain")\>, S: [IntoScheduleConfigs](../../prelude/trait.IntoScheduleConfigs.html "trait bevy::prelude::IntoScheduleConfigs")<T, P>,
...
### impl<T> [IntoScheduleConfigs](../../prelude/trait.IntoScheduleConfigs.html "trait bevy::prelude::IntoScheduleConfigs")<T, [()](https://doc.rust-lang.org/nightly/std/primitive.unit.html)\> for [ScheduleConfigs](../schedule/enum.ScheduleConfigs.html "enum bevy::ecs::schedule::ScheduleConfigs")<T>

where T: [Schedulable](../schedule/trait.Schedulable.html "trait bevy::ecs::schedule::Schedulable")<Metadata = [GraphInfo](../schedule/struct.GraphInfo.html "struct bevy::ecs::schedule::GraphInfo"), GroupMetadata = [Chain](../schedule/enum.Chain.html "enum bevy::ecs::schedule::Chain")\>,