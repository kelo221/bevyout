...
#### fn [spawn](#tymethod.spawn)<L>(list: L) -> [SpawnRelatedBundle](../spawn/struct.SpawnRelatedBundle.html "struct bevy::ecs::spawn::SpawnRelatedBundle")<Self::[Relationship](../../prelude/trait.RelationshipTarget.html#associatedtype.Relationship "type bevy::prelude::RelationshipTarget::Relationship"), L>

where L: [SpawnableList](../spawn/trait.SpawnableList.html "trait bevy::ecs::spawn::SpawnableList")<Self::[Relationship](../../prelude/trait.RelationshipTarget.html#associatedtype.Relationship "type bevy::prelude::RelationshipTarget::Relationship")\>,
...
#### fn [spawn\_one](#tymethod.spawn_one)<B>(bundle: B) -> [SpawnOneRelated](../spawn/struct.SpawnOneRelated.html "struct bevy::ecs::spawn::SpawnOneRelated")<Self::[Relationship](../../prelude/trait.RelationshipTarget.html#associatedtype.Relationship "type bevy::prelude::RelationshipTarget::Relationship"), B>
