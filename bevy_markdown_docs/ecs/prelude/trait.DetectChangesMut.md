...
#### fn [set\_last\_changed](#tymethod.set_last_changed)(&mut self, last\_changed: [Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"))
...
#### fn [set\_last\_added](#tymethod.set_last_added)(&mut self, last\_added: [Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"))
...
### impl<'w> [DetectChangesMut](../../prelude/trait.DetectChangesMut.html "trait bevy::prelude::DetectChangesMut") for [MutUntyped](../change_detection/struct.MutUntyped.html "struct bevy::ecs::change_detection::MutUntyped")<'w>
