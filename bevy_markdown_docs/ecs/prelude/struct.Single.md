...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/query.rs.html#2850)
...
This [`SystemParam`](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam") fails validation if zero or more than one matching entity exists. This will cause the system to be skipped, according to the rules laid out in [`SystemParamValidationError`](../system/struct.SystemParamValidationError.html "struct bevy::ecs::system::SystemParamValidationError").

Use [`Option<Single<D, F>>`](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option") instead if zero or one matching entities can exist.

Note that [`Single`](../../prelude/struct.Single.html "struct bevy::prelude::Single") is not used as a search optimization. It is used as a validation with slight overhead compared to [`Query`](../../prelude/struct.Query.html "struct bevy::prelude::Query").
...
Note that because [`Single`](../../prelude/struct.Single.html "struct bevy::prelude::Single") implements [`Deref`](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") and [`DerefMut`](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut"), methods and fields like `health` can be accessed directly. You can also access the underlying data manually, by calling `.deref`/`.deref_mut`, or by using the `*` operator. When mutable elements appear in [`Single`](../../prelude/struct.Single.html "struct bevy::prelude::Single"), use `.into_inner` to extract the tuple elements to mutate them.

## Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/query.rs.html#2869)

### impl<'w, 's, D, F> [Single](../../prelude/struct.Single.html "struct bevy::prelude::Single")<'w, 's, D, F>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/query.rs.html#2871)

#### pub fn [into\_inner](#method.into_inner)(self) -> <D as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'w, 's>

Returns the inner item with ownership.

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/animation/animation\_events.rs ([line 32](../../../src/animation_events/animation_events.rs.html#32))
...
examples/2d/tilemap\_chunk.rs ([line 135](../../../src/tilemap_chunk/tilemap_chunk.rs.html#135))
...
examples/transforms/align.rs ([line 141](../../../src/align/align.rs.html#141))
...
examples/ui/relative\_cursor\_position.rs ([line 66](../../../src/relative_cursor_position/relative_cursor_position.rs.html#66))

```rust
62fn relative_cursor_position_system(
...
examples/asset/alter\_sprite.rs ([line 115](../../../src/alter_sprite/alter_sprite.rs.html#115))
...
examples/asset/asset\_saving\_with\_subassets.rs ([line 278](../../../src/asset_saving_with_subassets/asset_saving_with_subassets.rs.html#278))
...
*   [examples/math/render\_primitives.rs](../../../src/render_primitives/render_primitives.rs.html#339)
*   [examples/animation/animated\_mesh\_control.rs](../../../src/animated_mesh_control/animated_mesh_control.rs.html#148)
*   [examples/asset/alter\_mesh.rs](../../../src/alter_mesh/alter_mesh.rs.html#158)
*   [examples/math/custom\_primitives.rs](../../../src/custom_primitives/custom_primitives.rs.html#380)
*   [examples/showcase/game\_menu.rs](../../../src/game_menu/game_menu.rs.html#351)
*   [examples/3d/motion\_blur.rs](../../../src/motion_blur/motion_blur.rs.html#335)
*   [examples/showcase/desk\_toy.rs](../../../src/desk_toy/desk_toy.rs.html#225)
*   [examples/ui/widgets/standard\_widgets.rs](../../../src/standard_widgets/standard_widgets.rs.html#795)
*   [examples/asset/asset\_saving.rs](../../../src/asset_saving/asset_saving.rs.html#219)
*   [examples/2d/rotation.rs](../../../src/rotation/rotation.rs.html#117)
*   [examples/movement/physics\_in\_fixed\_timestep.rs](../../../src/physics_in_fixed_timestep/physics_in_fixed_timestep.rs.html#248)
*   [examples/camera/projection\_zoom.rs](../../../src/projection_zoom/projection_zoom.rs.html#141)
*   [examples/3d/auto\_exposure.rs](../../../src/auto_exposure/auto_exposure.rs.html#167)
*   [examples/camera/first\_person\_view\_model.rs](../../../src/first_person_view_model/first_person_view_model.rs.html#209)
*   [examples/showcase/breakout.rs](../../../src/breakout/breakout.rs.html#340)
*   [examples/3d/blend\_modes.rs](../../../src/blend_modes/blend_modes.rs.html#300)
*   [examples/2d/2d\_viewport\_to\_world.rs](../../../src/2d_viewport_to_world/2d_viewport_to_world.rs.html#48)
*   [examples/ui/widgets/feathers\_gallery.rs](../../../src/feathers_gallery/feathers_gallery.rs.html#813)
*   [examples/camera/2d\_screen\_shake.rs](../../../src/2d_screen_shake/2d_screen_shake.rs.html#76)
*   [examples/3d/bloom\_3d.rs](../../../src/bloom_3d/bloom_3d.rs.html#104)
*   [examples/3d/fog.rs](../../../src/fog/fog.rs.html#146)
*   [examples/2d/bloom\_2d.rs](../../../src/bloom_2d/bloom_2d.rs.html#79)
*   [examples/3d/anti\_aliasing.rs](../../../src/anti_aliasing/anti_aliasing.rs.html#97)
*   [examples/3d/transmission.rs](../../../src/transmission/transmission.rs.html#460)

## Trait Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/query.rs.html#2855)

### impl<'w, 's, D, F> [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [Single](../../prelude/struct.Single.html "struct bevy::prelude::Single")<'w, 's, D, F>

where D: [IterQueryData](../query/trait.IterQueryData.html "trait bevy::ecs::query::IterQueryData"), F: [QueryFilter](../query/trait.QueryFilter.html "trait bevy::ecs::query::QueryFilter"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/query.rs.html#2856)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = <D as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'w, 's>

The resulting type after dereferencing.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/query.rs.html#2858)

#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[Single](../../prelude/struct.Single.html "struct bevy::prelude::Single")<'w, 's, D, F> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/query.rs.html#2863)

### impl<'w, 's, D, F> [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [Single](../../prelude/struct.Single.html "struct bevy::prelude::Single")<'w, 's, D, F>

where D: [IterQueryData](../query/trait.IterQueryData.html "trait bevy::ecs::query::IterQueryData"), F: [QueryFilter](../query/trait.QueryFilter.html "trait bevy::ecs::query::QueryFilter"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/query.rs.html#2864)

#### fn [deref\_mut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html#tymethod.deref_mut)(&mut self) -> &mut <[Single](../../prelude/struct.Single.html "struct bevy::prelude::Single")<'w, 's, D, F> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Mutably dereferences the value.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#387-388)

### impl<'a, 'b, D, F> [ReadOnlySystemParam](../system/trait.ReadOnlySystemParam.html "trait bevy::ecs::system::ReadOnlySystemParam") for [Single](../../prelude/struct.Single.html "struct bevy::prelude::Single")<'a, 'b, D, F>
...
### impl<'a, 'b, D, F> [SystemParam](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam") for [Single](../../prelude/struct.Single.html "struct bevy::prelude::Single")<'a, 'b, D, F>
...
#### type [Item](../system/trait.SystemParam.html#associatedtype.Item)<'w, 's> = [Single](../../prelude/struct.Single.html "struct bevy::prelude::Single")<'w, 's, D, F>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#347)

#### fn [init\_state](../system/trait.SystemParam.html#tymethod.init_state)(world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World")) -> <[Single](../../prelude/struct.Single.html "struct bevy::prelude::Single")<'a, 'b, D, F> as [SystemParam](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](../system/trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#361-366)

#### unsafe fn [get\_param](../system/trait.SystemParam.html#tymethod.get_param)<'w, 's>( state: &'s mut <[Single](../../prelude/struct.Single.html "struct bevy::prelude::Single")<'a, 'b, D, F> as [SystemParam](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](../system/trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State"), system\_meta: &[SystemMeta](../system/struct.SystemMeta.html "struct bevy::ecs::system::SystemMeta"), world: [UnsafeWorldCell](../world/unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'w>, change\_tick: [Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Single](../../prelude/struct.Single.html "struct bevy::prelude::Single")<'a, 'b, D, F> as [SystemParam](../system/trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[Item](../system/trait.SystemParam.html#associatedtype.Item "type bevy::ecs::system::SystemParam::Item")<'w, 's>, [SystemParamValidationError](../system/struct.SystemParamValidationError.html "struct bevy::ecs::system::SystemParamValidationError")\>
...
### impl<'w, 's, D, F> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Single](../../prelude/struct.Single.html "struct bevy::prelude::Single")<'w, 's, D, F>

where <D as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'w, 's>: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"),

### impl<'w, 's, D, F> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Single](../../prelude/struct.Single.html "struct bevy::prelude::Single")<'w, 's, D, F>

where <D as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'w, 's>: [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"), F: [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"),

### impl<'w, 's, D, F> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Single](../../prelude/struct.Single.html "struct bevy::prelude::Single")<'w, 's, D, F>

where <D as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'w, 's>: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"), F: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<'w, 's, D, F> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Single](../../prelude/struct.Single.html "struct bevy::prelude::Single")<'w, 's, D, F>

where <D as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'w, 's>: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"), F: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<'w, 's, D, F> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Single](../../prelude/struct.Single.html "struct bevy::prelude::Single")<'w, 's, D, F>

where <D as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'w, 's>: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"), F: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<'w, 's, D, F> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Single](../../prelude/struct.Single.html "struct bevy::prelude::Single")<'w, 's, D, F>

where <D as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'w, 's>: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"),

### impl<'w, 's, D, F> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Single](../../prelude/struct.Single.html "struct bevy::prelude::Single")<'w, 's, D, F>

where <D as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'w, 's>: [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"), F: [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"),
