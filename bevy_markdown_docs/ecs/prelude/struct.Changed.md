...
`Changed` is not [`ArchetypeFilter`](../query/trait.ArchetypeFilter.html "trait bevy::ecs::query::ArchetypeFilter"), which practically means that if query (with `T` component filter) matches million entities, `Changed<T>` filter will iterate over all of them even if none of them were changed.
...
### impl<T> [QueryFilter](../query/trait.QueryFilter.html "trait bevy::ecs::query::QueryFilter") for [Changed](../../prelude/struct.Changed.html "struct bevy::prelude::Changed")<T>
...
#### const [IS\_ARCHETYPAL](../query/trait.QueryFilter.html#associatedconstant.IS_ARCHETYPAL): [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html) = false
...
### impl<T> [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery") for [Changed](../../prelude/struct.Changed.html "struct bevy::prelude::Changed")<T>
...
#### type [Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch)<'w> = ChangedFetch<'w, T>
