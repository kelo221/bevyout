...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#95)
...
Each message can be consumed by multiple systems, in parallel, with consumption tracked by the [`MessageReader`](../../prelude/struct.MessageReader.html "struct bevy::prelude::MessageReader") on a per-system basis.

If no [ordering](https://github.com/bevyengine/bevy/blob/main/examples/ecs/ecs_guide.rs) is applied between writing and reading systems, there is a risk of a race condition. This means that whether the messages arrive before or after the next [`Messages::update`](../../prelude/struct.Messages.html#method.update "method bevy::prelude::Messages::update") is unpredictable.

This collection is meant to be paired with a system that calls [`Messages::update`](../../prelude/struct.Messages.html#method.update "method bevy::prelude::Messages::update") exactly once per update/frame.

[`message_update_system`](../message/fn.message_update_system.html "fn bevy::ecs::message::message_update_system") is a system that does this, typically initialized automatically using [`add_message`](https://docs.rs/bevy/*/bevy/app/struct.App.html#method.add_message). [`MessageReader`](../../prelude/struct.MessageReader.html "struct bevy::prelude::MessageReader")s are expected to read messages from this collection at least once per loop/frame. Messages will persist across a single frame boundary and so ordering of message producers and consumers is not critical (although poorly-planned ordering may cause accumulating lag). If messages are not handled by the end of the frame after they are updated, they will be dropped silently.
...
[`Messages`](../../prelude/struct.Messages.html "struct bevy::prelude::Messages") is implemented using a variation of a double buffer strategy. Each call to [`update`](../../prelude/struct.Messages.html#method.update "method bevy::prelude::Messages::update") swaps buffers and clears out the oldest one.

*   [`MessageReader`](../../prelude/struct.MessageReader.html "struct bevy::prelude::MessageReader")s will read messages from both buffers.
*   [`MessageReader`](../../prelude/struct.MessageReader.html "struct bevy::prelude::MessageReader")s that read at least once per update will never drop messages.
*   [`MessageReader`](../../prelude/struct.MessageReader.html "struct bevy::prelude::MessageReader")s that read once within two updates might still receive some messages
*   [`MessageReader`](../../prelude/struct.MessageReader.html "struct bevy::prelude::MessageReader")s that read after two updates are guaranteed to drop all messages that occurred before those updates.

The buffers in [`Messages`](../../prelude/struct.Messages.html "struct bevy::prelude::Messages") will grow indefinitely if [`update`](../../prelude/struct.Messages.html#method.update "method bevy::prelude::Messages::update") is never called.

An alternative call pattern would be to call [`update`](../../prelude/struct.Messages.html#method.update "method bevy::prelude::Messages::update") manually across frames to control when messages are cleared. This complicates consumption and risks ever-expanding memory usage if not cleaned up, but can be done by adding your message as a resource instead of using [`add_message`](https://docs.rs/bevy/*/bevy/app/struct.App.html#method.add_message).

[Example usage.](https://github.com/bevyengine/bevy/blob/latest/examples/ecs/message.rs) [Example usage standalone.](https://github.com/bevyengine/bevy/blob/latest/crates/bevy_ecs/examples/messages.rs)

## Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#115)

### impl<M> [Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>

where M: [Message](../../prelude/trait.Message.html "trait bevy::prelude::Message"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#117)

#### pub fn [oldest\_message\_count](#method.oldest_message_count)(&self) -> [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)

Returns the index of the oldest message stored in the message buffer.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#125)

#### pub fn [write](#method.write)(&mut self, message: M) -> [MessageId](../message/struct.MessageId.html "struct bevy::ecs::message::MessageId")<M>

Writes an `message` to the current message buffer. [`MessageReader`](../../prelude/struct.MessageReader.html "struct bevy::prelude::MessageReader")s can then read the message. This method returns the [ID](../message/struct.MessageId.html "struct bevy::ecs::message::MessageId") of the written `message`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#153)

#### pub fn [write\_batch](#method.write_batch)( &mut self, messages: impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = M>, ) -> [WriteBatchIds](../message/struct.WriteBatchIds.html "struct bevy::ecs::message::WriteBatchIds")<M> [ⓘ](#)

Writes a list of `messages` all at once, which can later be read by [`MessageReader`](../../prelude/struct.MessageReader.html "struct bevy::prelude::MessageReader")s. This is more efficient than writing each message individually. This method returns the [IDs](../message/struct.MessageId.html "struct bevy::ecs::message::MessageId") of the written `messages`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#168-170)

#### pub fn [write\_default](#method.write_default)(&mut self) -> [MessageId](../message/struct.MessageId.html "struct bevy::ecs::message::MessageId")<M>

where M: [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default"),

Writes the default value of the message. Useful when the message is an empty struct. This method returns the [ID](../message/struct.MessageId.html "struct bevy::ecs::message::MessageId") of the written `message`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#176)

#### pub fn [get\_cursor](#method.get_cursor)(&self) -> [MessageCursor](../message/struct.MessageCursor.html "struct bevy::ecs::message::MessageCursor")<M>

Gets a new [`MessageCursor`](../message/struct.MessageCursor.html "struct bevy::ecs::message::MessageCursor"). This will include all messages already in the message buffers.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#182)

#### pub fn [get\_cursor\_current](#method.get_cursor_current)(&self) -> [MessageCursor](../message/struct.MessageCursor.html "struct bevy::ecs::message::MessageCursor")<M>

Gets a new [`MessageCursor`](../message/struct.MessageCursor.html "struct bevy::ecs::message::MessageCursor"). This will ignore all messages already in the message buffers. It will read all future messages.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#193)
...
If you need access to the messages that were removed, consider using [`Messages::update_drain`](../../prelude/struct.Messages.html#method.update_drain "method bevy::prelude::Messages::update_drain").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#208)

#### pub fn [update\_drain](#method.update_drain)(&mut self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = M>
...
If you do not need to take ownership of the removed messages, use [`Messages::update`](../../prelude/struct.Messages.html#method.update "method bevy::prelude::Messages::update") instead.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#228)

#### pub fn [clear](#method.clear)(&mut self)

Removes all messages.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#236)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#242)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#247)

#### pub fn [drain](#method.drain)(&mut self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = M>

Creates a draining iterator that removes all messages.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#265)

#### pub fn [iter\_current\_update\_messages](#method.iter_current_update_messages)(&self) -> impl [ExactSizeIterator](https://doc.rust-lang.org/nightly/core/iter/traits/exact_size/trait.ExactSizeIterator.html "trait core::iter::traits::exact_size::ExactSizeIterator")

Iterates over messages that happened since the last “update” call. WARNING: You probably don’t want to use this call. In most cases you should use an [`MessageReader`](../../prelude/struct.MessageReader.html "struct bevy::prelude::MessageReader"). You should only use this if you know you only need to consume messages between the last `update()` call and your call to `iter_current_update_messages`. If messages happen outside that window, they will not be handled. For example, any messages that happen after this call and before the next `update()` call will be dropped.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#270)

#### pub fn [get\_message](#method.get_message)(&self, id: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<([&M](https://doc.rust-lang.org/nightly/std/primitive.reference.html), [MessageId](../message/struct.MessageId.html "struct bevy::ecs::message::MessageId")<M>)>
...
### impl<M> [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>
...
### impl<M> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#105)

### impl<M> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>

where M: [Message](../../prelude/trait.Message.html "trait bevy::prelude::Message"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#106)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#293)

### impl<M> [Extend](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.Extend.html "trait core::iter::traits::collect::Extend")<M> for [Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>

where M: [Message](../../prelude/trait.Message.html "trait bevy::prelude::Message"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#295-297)

#### fn [extend](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.Extend.html#tymethod.extend)<I>(&mut self, iter: I)

where I: [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = M>,
...
### impl<M> [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>
...
#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#94)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M> as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>>
...
### impl<M> [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>
...
### impl<M> [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>
...
### impl<M> [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>
...
where [Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>: 'into\_return,
...
### impl<M> [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/message/messages.rs.html#94)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<M> [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>
...
### impl<M> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>

### impl<M> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>
...
### impl<M> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>

### impl<M> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>

### impl<M> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>

where M: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<M> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>

### impl<M> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Messages](../../prelude/struct.Messages.html "struct bevy::prelude::Messages")<M>

where M: [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"),
