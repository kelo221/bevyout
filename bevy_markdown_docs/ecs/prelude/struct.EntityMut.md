...
Contrast with [`EntityWorldMut`](../../prelude/struct.EntityWorldMut.html "struct bevy::prelude::EntityWorldMut"), which allows adding and removing components, despawning the entity, and provides mutable access to the entire world. Because of this, `EntityWorldMut` cannot coexist with any other world accesses.
...
### impl<'w> [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'w>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/entity_mut.rs.html#62)

#### pub fn [reborrow](#method.reborrow)(&mut self) -> [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_>
...
#### pub fn [into\_filtered](#method.into_filtered)(self) -> [FilteredEntityMut](../world/struct.FilteredEntityMut.html "struct bevy::ecs::world::FilteredEntityMut")<'w, 'static>

Consumes `self` and returns a [`FilteredEntityMut`](../world/struct.FilteredEntityMut.html "struct bevy::ecs::world::FilteredEntityMut") which has mutable access to all of the entity’s components, with the world `'w` lifetime.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/entity_mut.rs.html#100)

#### pub fn [as\_unsafe\_entity\_cell](#method.as_unsafe_entity_cell)(&mut self) -> [UnsafeEntityCell](../world/unsafe_world_cell/struct.UnsafeEntityCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeEntityCell")<'\_>

Get access to the underlying [`UnsafeEntityCell`](../world/unsafe_world_cell/struct.UnsafeEntityCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeEntityCell").
...
If you do not know the concrete type of a component, consider using [`Self::contains_id`](../../prelude/struct.EntityMut.html#method.contains_id "method bevy::prelude::EntityMut::contains_id") or [`Self::contains_type_id`](../../prelude/struct.EntityMut.html#method.contains_type_id "method bevy::prelude::EntityMut::contains_type_id").
...
*   If you know the concrete type of the component, you should prefer [`Self::contains`](../../prelude/struct.EntityMut.html#method.contains "method bevy::prelude::EntityMut::contains").
*   If you know the component’s [`TypeId`](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId") but not its [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId"), consider using [`Self::contains_type_id`](../../prelude/struct.EntityMut.html#method.contains_type_id "method bevy::prelude::EntityMut::contains_type_id").
...
*   [`Self::get_components_mut`](../../prelude/struct.EntityMut.html#method.get_components_mut "method bevy::prelude::EntityMut::get_components_mut") for the safe version that performs aliasing checks
...
Note that this does a O(n^2) check that the [`QueryData`](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData") does not conflict. If performance is a consideration you should use [`Self::get_components_mut_unchecked`](../../prelude/struct.EntityMut.html#method.get_components_mut_unchecked "method bevy::prelude::EntityMut::get_components_mut_unchecked") instead.
...
*   [`Self::into_components_mut`](../../prelude/struct.EntityMut.html#method.into_components_mut "method bevy::prelude::EntityMut::into_components_mut") for the safe version that performs aliasing checks
...
The checks for aliasing mutable references may be expensive. If performance is a concern, consider making multiple calls to [`Self::get_mut`](../../prelude/struct.EntityMut.html#method.get_mut "method bevy::prelude::EntityMut::get_mut"). If that is not possible, consider using [`Self::into_components_mut_unchecked`](../../prelude/struct.EntityMut.html#method.into_components_mut_unchecked "method bevy::prelude::EntityMut::into_components_mut_unchecked") to skip the checks.
...
Consumes `self` and gets access to the component of type `T` with world `'w` lifetime for the current entity, including change detection information as a [`Ref<'w>`](../../prelude/struct.Ref.html "struct bevy::prelude::Ref").
...
#### pub fn [get\_by\_id](#method.get_by_id)<F>( &self, component\_ids: F, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<F as [DynamicComponentFetch](../world/trait.DynamicComponentFetch.html "trait bevy::ecs::world::DynamicComponentFetch")\>::[Ref](../world/trait.DynamicComponentFetch.html#associatedtype.Ref "type bevy::ecs::world::DynamicComponentFetch::Ref")<'\_>, [EntityComponentError](../world/error/enum.EntityComponentError.html "enum bevy::ecs::world::error::EntityComponentError")\>

where F: [DynamicComponentFetch](../world/trait.DynamicComponentFetch.html "trait bevy::ecs::world::DynamicComponentFetch"),
...
**You should prefer to use the typed API [`EntityMut::get`](../../prelude/struct.EntityMut.html#method.get "method bevy::prelude::EntityMut::get") where possible and only use this in cases where the actual component types are not known at compile time.**

Unlike [`EntityMut::get`](../../prelude/struct.EntityMut.html#method.get "method bevy::prelude::EntityMut::get"), this returns untyped reference(s) to component(s), and it’s the job of the caller to ensure the correct type(s) are dereferenced (if necessary).

##### Errors

Returns [`EntityComponentError::MissingComponent`](../world/error/enum.EntityComponentError.html#variant.MissingComponent "variant bevy::ecs::world::error::EntityComponentError::MissingComponent") if the entity does not have a component.
...
#### pub fn [into\_borrow\_by\_id](#method.into_borrow_by_id)<F>( self, component\_ids: F, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<F as [DynamicComponentFetch](../world/trait.DynamicComponentFetch.html "trait bevy::ecs::world::DynamicComponentFetch")\>::[Ref](../world/trait.DynamicComponentFetch.html#associatedtype.Ref "type bevy::ecs::world::DynamicComponentFetch::Ref")<'w>, [EntityComponentError](../world/error/enum.EntityComponentError.html "enum bevy::ecs::world::error::EntityComponentError")\>
...
**You should prefer to use the typed API [`EntityMut::into_borrow`](../../prelude/struct.EntityMut.html#method.into_borrow "method bevy::prelude::EntityMut::into_borrow") where possible and only use this in cases where the actual component types are not known at compile time.**

Unlike [`EntityMut::into_borrow`](../../prelude/struct.EntityMut.html#method.into_borrow "method bevy::prelude::EntityMut::into_borrow"), this returns untyped reference(s) to component(s), and it’s the job of the caller to ensure the correct type(s) are dereferenced (if necessary).
...
#### pub fn [get\_mut\_by\_id](#method.get_mut_by_id)<F>( &mut self, component\_ids: F, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<F as [DynamicComponentFetch](../world/trait.DynamicComponentFetch.html "trait bevy::ecs::world::DynamicComponentFetch")\>::[Mut](../world/trait.DynamicComponentFetch.html#associatedtype.Mut "type bevy::ecs::world::DynamicComponentFetch::Mut")<'\_>, [EntityComponentError](../world/error/enum.EntityComponentError.html "enum bevy::ecs::world::error::EntityComponentError")\>

where F: [DynamicComponentFetch](../world/trait.DynamicComponentFetch.html "trait bevy::ecs::world::DynamicComponentFetch"),

Returns untyped mutable reference(s) to component(s) for the current entity, based on the given [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")s.

**You should prefer to use the typed API [`EntityMut::get_mut`](../../prelude/struct.EntityMut.html#method.get_mut "method bevy::prelude::EntityMut::get_mut") where possible and only use this in cases where the actual component types are not known at compile time.**

Unlike [`EntityMut::get_mut`](../../prelude/struct.EntityMut.html#method.get_mut "method bevy::prelude::EntityMut::get_mut"), this returns untyped reference(s) to component(s), and it’s the job of the caller to ensure the correct type(s) are dereferenced (if necessary).

##### Errors

*   Returns [`EntityComponentError::MissingComponent`](../world/error/enum.EntityComponentError.html#variant.MissingComponent "variant bevy::ecs::world::error::EntityComponentError::MissingComponent") if the entity does not have a component.
*   Returns [`EntityComponentError::AliasedMutability`](../world/error/enum.EntityComponentError.html#variant.AliasedMutability "variant bevy::ecs::world::error::EntityComponentError::AliasedMutability") if a component is requested multiple times.

##### Examples

###### Single [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")
...
###### Array of [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")s
...
###### Slice of [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")s
...
###### `HashSet` of [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")s
...
#### pub unsafe fn [get\_mut\_assume\_mutable\_by\_id](#method.get_mut_assume_mutable_by_id)<F>( &mut self, component\_ids: F, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<F as [DynamicComponentFetch](../world/trait.DynamicComponentFetch.html "trait bevy::ecs::world::DynamicComponentFetch")\>::[Mut](../world/trait.DynamicComponentFetch.html#associatedtype.Mut "type bevy::ecs::world::DynamicComponentFetch::Mut")<'\_>, [EntityComponentError](../world/error/enum.EntityComponentError.html "enum bevy::ecs::world::error::EntityComponentError")\>

where F: [DynamicComponentFetch](../world/trait.DynamicComponentFetch.html "trait bevy::ecs::world::DynamicComponentFetch"),

Returns untyped mutable reference(s) to component(s) for the current entity, based on the given [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")s. Assumes the given [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")s refer to mutable components.

**You should prefer to use the typed API [`EntityMut::get_mut_assume_mutable`](../../prelude/struct.EntityMut.html#method.get_mut_assume_mutable "method bevy::prelude::EntityMut::get_mut_assume_mutable") where possible and only use this in cases where the actual component types are not known at compile time.**

Unlike [`EntityMut::get_mut_assume_mutable`](../../prelude/struct.EntityMut.html#method.get_mut_assume_mutable "method bevy::prelude::EntityMut::get_mut_assume_mutable"), this returns untyped reference(s) to component(s), and it’s the job of the caller to ensure the correct type(s) are dereferenced (if necessary).
...
#### pub unsafe fn [get\_mut\_by\_id\_unchecked](#method.get_mut_by_id_unchecked)<F>( &self, component\_ids: F, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<F as [DynamicComponentFetch](../world/trait.DynamicComponentFetch.html "trait bevy::ecs::world::DynamicComponentFetch")\>::[Mut](../world/trait.DynamicComponentFetch.html#associatedtype.Mut "type bevy::ecs::world::DynamicComponentFetch::Mut")<'\_>, [EntityComponentError](../world/error/enum.EntityComponentError.html "enum bevy::ecs::world::error::EntityComponentError")\>

where F: [DynamicComponentFetch](../world/trait.DynamicComponentFetch.html "trait bevy::ecs::world::DynamicComponentFetch"),

Returns untyped mutable reference to component for the current entity, based on the given [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId").

Unlike [`EntityMut::get_mut_by_id`](../../prelude/struct.EntityMut.html#method.get_mut_by_id "method bevy::prelude::EntityMut::get_mut_by_id"), this method borrows &self instead of &mut self, allowing the caller to access multiple components simultaneously.
...
*   the [`UnsafeEntityCell`](../world/unsafe_world_cell/struct.UnsafeEntityCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeEntityCell") has permission to access the component mutably
...
#### pub unsafe fn [get\_mut\_assume\_mutable\_by\_id\_unchecked](#method.get_mut_assume_mutable_by_id_unchecked)<F>( &self, component\_ids: F, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<F as [DynamicComponentFetch](../world/trait.DynamicComponentFetch.html "trait bevy::ecs::world::DynamicComponentFetch")\>::[Mut](../world/trait.DynamicComponentFetch.html#associatedtype.Mut "type bevy::ecs::world::DynamicComponentFetch::Mut")<'\_>, [EntityComponentError](../world/error/enum.EntityComponentError.html "enum bevy::ecs::world::error::EntityComponentError")\>

where F: [DynamicComponentFetch](../world/trait.DynamicComponentFetch.html "trait bevy::ecs::world::DynamicComponentFetch"),

Returns untyped mutable reference to component for the current entity, based on the given [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId"). Assumes the given [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")s refer to mutable components.

Unlike [`EntityMut::get_mut_assume_mutable_by_id`](../../prelude/struct.EntityMut.html#method.get_mut_assume_mutable_by_id "method bevy::prelude::EntityMut::get_mut_assume_mutable_by_id"), this method borrows &self instead of &mut self, allowing the caller to access multiple components simultaneously.
...
#### pub fn [into\_mut\_by\_id](#method.into_mut_by_id)<F>( self, component\_ids: F, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<F as [DynamicComponentFetch](../world/trait.DynamicComponentFetch.html "trait bevy::ecs::world::DynamicComponentFetch")\>::[Mut](../world/trait.DynamicComponentFetch.html#associatedtype.Mut "type bevy::ecs::world::DynamicComponentFetch::Mut")<'w>, [EntityComponentError](../world/error/enum.EntityComponentError.html "enum bevy::ecs::world::error::EntityComponentError")\>

where F: [DynamicComponentFetch](../world/trait.DynamicComponentFetch.html "trait bevy::ecs::world::DynamicComponentFetch"),

Consumes `self` and returns untyped mutable reference(s) to component(s) with lifetime `'w` for the current entity, based on the given [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")s.

**You should prefer to use the typed API [`EntityMut::into_mut`](../../prelude/struct.EntityMut.html#method.into_mut "method bevy::prelude::EntityMut::into_mut") where possible and only use this in cases where the actual component types are not known at compile time.**

Unlike [`EntityMut::into_mut`](../../prelude/struct.EntityMut.html#method.into_mut "method bevy::prelude::EntityMut::into_mut"), this returns untyped reference(s) to component(s), and it’s the job of the caller to ensure the correct type(s) are dereferenced (if necessary).
...
#### pub unsafe fn [into\_mut\_assume\_mutable\_by\_id](#method.into_mut_assume_mutable_by_id)<F>( self, component\_ids: F, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<F as [DynamicComponentFetch](../world/trait.DynamicComponentFetch.html "trait bevy::ecs::world::DynamicComponentFetch")\>::[Mut](../world/trait.DynamicComponentFetch.html#associatedtype.Mut "type bevy::ecs::world::DynamicComponentFetch::Mut")<'w>, [EntityComponentError](../world/error/enum.EntityComponentError.html "enum bevy::ecs::world::error::EntityComponentError")\>

where F: [DynamicComponentFetch](../world/trait.DynamicComponentFetch.html "trait bevy::ecs::world::DynamicComponentFetch"),

Consumes `self` and returns untyped mutable reference(s) to component(s) with lifetime `'w` for the current entity, based on the given [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")s. Assumes the given [`ComponentId`](../component/struct.ComponentId.html "struct bevy::ecs::component::ComponentId")s refer to mutable components.

**You should prefer to use the typed API [`EntityMut::into_mut_assume_mutable`](../../prelude/struct.EntityMut.html#method.into_mut_assume_mutable "method bevy::prelude::EntityMut::into_mut_assume_mutable") where possible and only use this in cases where the actual component types are not known at compile time.**

Unlike [`EntityMut::into_mut_assume_mutable`](../../prelude/struct.EntityMut.html#method.into_mut_assume_mutable "method bevy::prelude::EntityMut::into_mut_assume_mutable"), this returns untyped reference(s) to component(s), and it’s the job of the caller to ensure the correct type(s) are dereferenced (if necessary).
...
### impl [ArchetypeQueryData](../query/trait.ArchetypeQueryData.html "trait bevy::ecs::query::ArchetypeQueryData") for [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_>
...
### impl [EntityEquivalent](../entity/trait.EntityEquivalent.html "trait bevy::ecs::entity::EntityEquivalent") for [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/entity_mut.rs.html#842)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/entity_mut.rs.html#794)

### impl<'a> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'a [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_>> for [EntityRef](../../prelude/struct.EntityRef.html "struct bevy::prelude::EntityRef")<'a>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/entity_mut.rs.html#796)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(entity: &'a [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_>) -> [EntityRef](../../prelude/struct.EntityRef.html "struct bevy::prelude::EntityRef")<'a>
...
### impl<'a> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'a [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_>> for [FilteredEntityRef](../world/struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'a, 'static>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/entity_mut.rs.html#817)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(entity: &'a [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_>) -> [FilteredEntityRef](../world/struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'a, 'static>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/entity_mut.rs.html#829)

### impl<'a> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'a mut [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_>> for [FilteredEntityMut](../world/struct.FilteredEntityMut.html "struct bevy::ecs::world::FilteredEntityMut")<'a, 'static>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/entity_mut.rs.html#831)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(entity: &'a mut [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_>) -> [FilteredEntityMut](../world/struct.FilteredEntityMut.html "struct bevy::ecs::world::FilteredEntityMut")<'a, 'static>
...
### impl<'w> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'w mut [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_>> for [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'w>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/entity_mut.rs.html#803)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(entity: &'w mut [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_>) -> [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'w>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/entity_mut.rs.html#808)

### impl<'a> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'a>> for [FilteredEntityRef](../world/struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'a, 'static>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/entity_mut.rs.html#810)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(entity: [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'a>) -> [FilteredEntityRef](../world/struct.FilteredEntityRef.html "struct bevy::ecs::world::FilteredEntityRef")<'a, 'static>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/entity_mut.rs.html#822)

### impl<'a> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'a>> for [FilteredEntityMut](../world/struct.FilteredEntityMut.html "struct bevy::ecs::world::FilteredEntityMut")<'a, 'static>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/entity_mut.rs.html#824)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(entity: [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'a>) -> [FilteredEntityMut](../world/struct.FilteredEntityMut.html "struct bevy::ecs::world::FilteredEntityMut")<'a, 'static>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/entity_mut.rs.html#787)

### impl<'w> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'w>> for [EntityRef](../../prelude/struct.EntityRef.html "struct bevy::prelude::EntityRef")<'w>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/entity_mut.rs.html#789)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(entity: [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'w>) -> [EntityRef](../../prelude/struct.EntityRef.html "struct bevy::prelude::EntityRef")<'w>
...
### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_>
...
### impl [IterQueryData](../query/trait.IterQueryData.html "trait bevy::ecs::query::IterQueryData") for [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/entity_mut.rs.html#852)

### impl [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/entity_mut.rs.html#853)

#### fn [cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html#tymethod.cmp)(&self, other: &[EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_>) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/entity_mut.rs.html#837)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/entity_mut.rs.html#847)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_>) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")\>

[`EntityMut`](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")’s comparison trait implementations match the underlying [`Entity`](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), and cannot discern between different worlds.
...
### impl<'a> [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData") for [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'a>
...
#### type [ReadOnly](../query/trait.QueryData.html#associatedtype.ReadOnly) = [EntityRef](../../prelude/struct.EntityRef.html "struct bevy::prelude::EntityRef")<'a>
...
#### type [Item](../query/trait.QueryData.html#associatedtype.Item)<'w, 's> = [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'w>
...
#### fn [shrink](../query/trait.QueryData.html#tymethod.shrink)<'wlong, 'wshort, 's>( item: <[EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'a> as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'wlong, 's>, ) -> <[EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'a> as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'wshort, 's>
...
#### unsafe fn [fetch](../query/trait.QueryData.html#tymethod.fetch)<'w, 's>( \_state: &'s <[EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'a> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[State](../query/trait.WorldQuery.html#associatedtype.State "type bevy::ecs::query::WorldQuery::State"), fetch: &mut <[EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'a> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'w>, entity: [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), \_table\_row: [TableRow](../storage/struct.TableRow.html "struct bevy::ecs::storage::TableRow"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<[EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'a> as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'w, 's>>
...
### impl [ReleaseStateQueryData](../query/trait.ReleaseStateQueryData.html "trait bevy::ecs::query::ReleaseStateQueryData") for [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/fetch.rs.html#1140)

#### fn [release\_state](../query/trait.ReleaseStateQueryData.html#tymethod.release_state)<'w>( item: <[EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_> as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'w, '\_>, ) -> <[EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_> as [QueryData](../query/trait.QueryData.html "trait bevy::ecs::query::QueryData")\>::[Item](../query/trait.QueryData.html#associatedtype.Item "type bevy::ecs::query::QueryData::Item")<'w, 'static>
...
### impl [SingleEntityQueryData](../query/trait.SingleEntityQueryData.html "trait bevy::ecs::query::SingleEntityQueryData") for [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'\_>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#733)

### impl<'a> [TryFrom](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html "trait core::convert::TryFrom")<&'a mut [FilteredEntityMut](../world/struct.FilteredEntityMut.html "struct bevy::ecs::world::FilteredEntityMut")<'\_, '\_>> for [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'a>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/filtered.rs.html#734)

#### type [Error](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html#associatedtype.Error) = [TryFromFilteredError](../world/enum.TryFromFilteredError.html "enum bevy::ecs::world::TryFromFilteredError")
...
#### fn [shrink\_fetch](../query/trait.WorldQuery.html#tymethod.shrink_fetch)<'wlong, 'wshort>( fetch: <[EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'a> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'wlong>, ) -> <[EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'a> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'wshort>
...
#### unsafe fn [init\_fetch](../query/trait.WorldQuery.html#tymethod.init_fetch)<'w, 's>( world: [UnsafeWorldCell](../world/unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'w>, \_state: &'s <[EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'a> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[State](../query/trait.WorldQuery.html#associatedtype.State "type bevy::ecs::query::WorldQuery::State"), last\_run: [Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"), this\_run: [Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"), ) -> <[EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'a> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'w>
...
#### unsafe fn [set\_archetype](../query/trait.WorldQuery.html#tymethod.set_archetype)<'w, 's>( \_fetch: &mut <[EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'a> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch "type bevy::ecs::query::WorldQuery::Fetch")<'w>, \_state: &'s <[EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'a> as [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery")\>::[State](../query/trait.WorldQuery.html#associatedtype.State "type bevy::ecs::query::WorldQuery::State"), \_archetype: &'w [Archetype](../archetype/struct.Archetype.html "struct bevy::ecs::archetype::Archetype"), \_table: &[Table](../storage/struct.Table.html "struct bevy::ecs::storage::Table"), )
...
### impl<'w> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'w>

### impl<'w> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'w>

### impl<'w> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'w>

### impl<'w> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'w>

### impl<'w> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'w>

### impl<'w> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'w>

### impl<'w> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [EntityMut](../../prelude/struct.EntityMut.html "struct bevy::prelude::EntityMut")<'w>
