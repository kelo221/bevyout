...
`Added` is not [`ArchetypeFilter`](../query/trait.ArchetypeFilter.html "trait bevy::ecs::query::ArchetypeFilter"), which practically means that if the query (with `T` component filter) matches a million entities, `Added<T>` filter will iterate over all of them even if none of them were just added.
...
### impl<T> [QueryFilter](../query/trait.QueryFilter.html "trait bevy::ecs::query::QueryFilter") for [Added](../../prelude/struct.Added.html "struct bevy::prelude::Added")<T>
...
### impl<T> [WorldQuery](../query/trait.WorldQuery.html "trait bevy::ecs::query::WorldQuery") for [Added](../../prelude/struct.Added.html "struct bevy::prelude::Added")<T>
...
#### type [Fetch](../query/trait.WorldQuery.html#associatedtype.Fetch)<'w> = AddedFetch<'w, T>
