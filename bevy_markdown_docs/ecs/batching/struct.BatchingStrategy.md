[bevy](../../index.html)::[ecs](../index.html)::[batching](index.html)

# Struct BatchingStrategy 

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/batching.rs.html#24)
...
See [`Query::par_iter`](../../prelude/struct.Query.html#method.par_iter "method bevy::prelude::Query::par_iter"), [`MessageReader::par_read`](../../prelude/struct.MessageReader.html#method.par_read "method bevy::prelude::MessageReader::par_read") for more information.

## Fields

`batch_size_limits: [Range](https://doc.rust-lang.org/nightly/core/ops/range/struct.Range.html "struct core::ops::range::Range")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)>`
...
`batches_per_thread: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)`

The number of batches per thread in the [`ComputeTaskPool`](../../tasks/struct.ComputeTaskPool.html "struct bevy::tasks::ComputeTaskPool"). Increasing this value will decrease the batch size, which may increase the scheduling overhead for the iteration.

Defaults to 1.

## Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/batching.rs.html#48)

### impl [BatchingStrategy](struct.BatchingStrategy.html "struct bevy::ecs::batching::BatchingStrategy")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/batching.rs.html#50)

#### pub const fn [new](#method.new)() -> [BatchingStrategy](struct.BatchingStrategy.html "struct bevy::ecs::batching::BatchingStrategy")

Creates a new unconstrained default batching strategy.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/batching.rs.html#58)

#### pub const fn [fixed](#method.fixed)(batch\_size: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [BatchingStrategy](struct.BatchingStrategy.html "struct bevy::ecs::batching::BatchingStrategy")

Declares a batching strategy with a fixed batch size.

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/ecs/parallel\_query.rs ([line 60](../../../src/parallel_query/parallel_query.rs.html#60))
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/batching.rs.html#66)

#### pub const fn [min\_batch\_size](#method.min_batch_size)(self, batch\_size: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [BatchingStrategy](struct.BatchingStrategy.html "struct bevy::ecs::batching::BatchingStrategy")

Configures the minimum allowed batch size of this instance.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/batching.rs.html#72)

#### pub const fn [max\_batch\_size](#method.max_batch_size)(self, batch\_size: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [BatchingStrategy](struct.BatchingStrategy.html "struct bevy::ecs::batching::BatchingStrategy")

Configures the maximum allowed batch size of this instance.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/batching.rs.html#78)

#### pub fn [batches\_per\_thread](#method.batches_per_thread)(self, batches\_per\_thread: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [BatchingStrategy](struct.BatchingStrategy.html "struct bevy::ecs::batching::BatchingStrategy")

Configures the number of batches to assign to each thread for this instance.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/batching.rs.html#94)

#### pub fn [calc\_batch\_size](#method.calc_batch_size)( &self, max\_items: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")() -> [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), thread\_count: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), ) -> [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/batching.rs.html#23)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [BatchingStrategy](struct.BatchingStrategy.html "struct bevy::ecs::batching::BatchingStrategy")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/batching.rs.html#23)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [BatchingStrategy](struct.BatchingStrategy.html "struct bevy::ecs::batching::BatchingStrategy")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [BatchingStrategy](struct.BatchingStrategy.html "struct bevy::ecs::batching::BatchingStrategy")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/batching.rs.html#42)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [BatchingStrategy](struct.BatchingStrategy.html "struct bevy::ecs::batching::BatchingStrategy")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/batching.rs.html#43)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [BatchingStrategy](struct.BatchingStrategy.html "struct bevy::ecs::batching::BatchingStrategy")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [BatchingStrategy](struct.BatchingStrategy.html "struct bevy::ecs::batching::BatchingStrategy")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [BatchingStrategy](struct.BatchingStrategy.html "struct bevy::ecs::batching::BatchingStrategy")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [BatchingStrategy](struct.BatchingStrategy.html "struct bevy::ecs::batching::BatchingStrategy")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [BatchingStrategy](struct.BatchingStrategy.html "struct bevy::ecs::batching::BatchingStrategy")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [BatchingStrategy](struct.BatchingStrategy.html "struct bevy::ecs::batching::BatchingStrategy")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [BatchingStrategy](struct.BatchingStrategy.html "struct bevy::ecs::batching::BatchingStrategy")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [BatchingStrategy](struct.BatchingStrategy.html "struct bevy::ecs::batching::BatchingStrategy")
