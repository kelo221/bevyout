...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/required.rs.html#521)
...
### DuplicateRegistration([ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId"), [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId"))

The component is already a directly required component for the requiree.

### CyclicRequirement([ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId"), [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId"))

Adding the given requirement would create a cycle.

### ArchetypeExists([ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId"))

An archetype with the component that requires other components already exists

## Trait Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/required.rs.html#519)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [RequiredComponentsError](enum.RequiredComponentsError.html "enum bevy::ecs::component::RequiredComponentsError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [RequiredComponentsError](enum.RequiredComponentsError.html "enum bevy::ecs::component::RequiredComponentsError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [RequiredComponentsError](enum.RequiredComponentsError.html "enum bevy::ecs::component::RequiredComponentsError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RequiredComponentsError](enum.RequiredComponentsError.html "enum bevy::ecs::component::RequiredComponentsError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RequiredComponentsError](enum.RequiredComponentsError.html "enum bevy::ecs::component::RequiredComponentsError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RequiredComponentsError](enum.RequiredComponentsError.html "enum bevy::ecs::component::RequiredComponentsError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RequiredComponentsError](enum.RequiredComponentsError.html "enum bevy::ecs::component::RequiredComponentsError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RequiredComponentsError](enum.RequiredComponentsError.html "enum bevy::ecs::component::RequiredComponentsError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RequiredComponentsError](enum.RequiredComponentsError.html "enum bevy::ecs::component::RequiredComponentsError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RequiredComponentsError](enum.RequiredComponentsError.html "enum bevy::ecs::component::RequiredComponentsError")
