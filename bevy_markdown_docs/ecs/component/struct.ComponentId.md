...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/info.rs.html#181)
...
Each time a new `Component` type is registered within a `World` using e.g. [`World::register_component`](../../prelude/struct.World.html#method.register_component "method bevy::prelude::World::register_component") or [`World::register_component_with_descriptor`](../../prelude/struct.World.html#method.register_component_with_descriptor "method bevy::prelude::World::register_component_with_descriptor") or a Resource with e.g. [`World::init_resource`](../../prelude/struct.World.html#method.init_resource "method bevy::prelude::World::init_resource"), a corresponding `ComponentId` is created to track it.

While the distinction between `ComponentId` and [`TypeId`](https://doc.rust-lang.org/nightly/core/any/struct.TypeId.html "struct core::any::TypeId") may seem superficial, breaking them into two separate but related concepts allows components to exist outside of Rust’s type system. Each Rust type registered as a `Component` will have a corresponding `ComponentId`, but additional `ComponentId`s may exist in a `World` to track components which cannot be represented as Rust types for scripting or other advanced use-cases.
...
Given a type `T` which implements [`Component`](../../prelude/trait.Component.html "trait bevy::prelude::Component") (including [`Resource`](../../prelude/trait.Resource.html "trait bevy::prelude::Resource")), the `ComponentId` for `T` can be retrieved from a `World` using [`World::component_id()`](../../prelude/struct.World.html#method.component_id "method bevy::prelude::World::component_id") or via [`Components::component_id()`](struct.Components.html#method.component_id "method bevy::ecs::component::Components::component_id").

## Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/info.rs.html#183)

### impl [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/info.rs.html#189)

#### pub const fn [new](#method.new)(index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")

Creates a new [`ComponentId`](struct.ComponentId.html "struct bevy::ecs::component::ComponentId").

The `index` is a unique value associated with each type of component in a given world. Usually, this value is taken from a counter incremented for each type of component registered with the world.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/info.rs.html#195)

#### pub fn [index](#method.index)(self) -> [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)

Returns the index of the current component.

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/ecs/dynamic.rs ([line 129](../../../src/dynamic/dynamic.rs.html#129))
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/info.rs.html#175)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/info.rs.html#175)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/info.rs.html#175)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")
...
### impl [DynamicComponentFetch](../world/trait.DynamicComponentFetch.html "trait bevy::ecs::world::DynamicComponentFetch") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")
...
#### type [Ref](../world/trait.DynamicComponentFetch.html#associatedtype.Ref)<'w> = [Ptr](../ptr/struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'w>

The read-only reference type returned by [`DynamicComponentFetch::fetch_ref`](../world/trait.DynamicComponentFetch.html#tymethod.fetch_ref "method bevy::ecs::world::DynamicComponentFetch::fetch_ref").
...
#### type [Mut](../world/trait.DynamicComponentFetch.html#associatedtype.Mut)<'w> = [MutUntyped](../change_detection/struct.MutUntyped.html "struct bevy::ecs::change_detection::MutUntyped")<'w>

The mutable reference type returned by [`DynamicComponentFetch::fetch_mut`](../world/trait.DynamicComponentFetch.html#tymethod.fetch_mut "method bevy::ecs::world::DynamicComponentFetch::fetch_mut").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/component_fetch.rs.html#105-108)

#### unsafe fn [fetch\_ref](../world/trait.DynamicComponentFetch.html#tymethod.fetch_ref)( self, cell: [UnsafeEntityCell](../world/unsafe_world_cell/struct.UnsafeEntityCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeEntityCell")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId") as [DynamicComponentFetch](../world/trait.DynamicComponentFetch.html "trait bevy::ecs::world::DynamicComponentFetch")\>::[Ref](../world/trait.DynamicComponentFetch.html#associatedtype.Ref "type bevy::ecs::world::DynamicComponentFetch::Ref")<'\_>, [EntityComponentError](../world/error/enum.EntityComponentError.html "enum bevy::ecs::world::error::EntityComponentError")\>

Returns untyped read-only reference(s) to the component(s) with the given [`ComponentId`](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")s, as determined by `self`. [Read more](../world/trait.DynamicComponentFetch.html#tymethod.fetch_ref)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/component_fetch.rs.html#113-116)

#### unsafe fn [fetch\_mut](../world/trait.DynamicComponentFetch.html#tymethod.fetch_mut)( self, cell: [UnsafeEntityCell](../world/unsafe_world_cell/struct.UnsafeEntityCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeEntityCell")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId") as [DynamicComponentFetch](../world/trait.DynamicComponentFetch.html "trait bevy::ecs::world::DynamicComponentFetch")\>::[Mut](../world/trait.DynamicComponentFetch.html#associatedtype.Mut "type bevy::ecs::world::DynamicComponentFetch::Mut")<'\_>, [EntityComponentError](../world/error/enum.EntityComponentError.html "enum bevy::ecs::world::error::EntityComponentError")\>

Returns untyped mutable reference(s) to the component(s) with the given [`ComponentId`](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")s, as determined by `self`. [Read more](../world/trait.DynamicComponentFetch.html#tymethod.fetch_mut)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/world/entity_access/component_fetch.rs.html#122-125)

#### unsafe fn [fetch\_mut\_assume\_mutable](../world/trait.DynamicComponentFetch.html#tymethod.fetch_mut_assume_mutable)( self, cell: [UnsafeEntityCell](../world/unsafe_world_cell/struct.UnsafeEntityCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeEntityCell")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId") as [DynamicComponentFetch](../world/trait.DynamicComponentFetch.html "trait bevy::ecs::world::DynamicComponentFetch")\>::[Mut](../world/trait.DynamicComponentFetch.html#associatedtype.Mut "type bevy::ecs::world::DynamicComponentFetch::Mut")<'\_>, [EntityComponentError](../world/error/enum.EntityComponentError.html "enum bevy::ecs::world::error::EntityComponentError")\>

Returns untyped mutable reference(s) to the component(s) with the given [`ComponentId`](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")s, as determined by `self`. Assumes all [`ComponentId`](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")s refer to mutable components. [Read more](../world/trait.DynamicComponentFetch.html#tymethod.fetch_mut_assume_mutable)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/info.rs.html#175)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/access.rs.html#1459)

### impl [Extend](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.Extend.html "trait core::iter::traits::collect::Extend")<[ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")\> for [ComponentIdSet](../query/struct.ComponentIdSet.html "struct bevy::ecs::query::ComponentIdSet")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/access.rs.html#1461)

#### fn [extend](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.Extend.html#tymethod.extend)<T>(&mut self, iter: T)

where T: [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")\>,
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/mod.rs.html#767)

### impl<T> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[ComponentIdFor](struct.ComponentIdFor.html "struct bevy::ecs::component::ComponentIdFor")<'\_, T>> for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")

where T: [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/mod.rs.html#769)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(to\_component\_id: [ComponentIdFor](struct.ComponentIdFor.html "struct bevy::ecs::component::ComponentIdFor")<'\_, T>) -> [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/info.rs.html#178)

### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/info.rs.html#178)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/info.rs.html#178)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/access.rs.html#1450)

### impl [FromIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html "trait core::iter::traits::collect::FromIterator")<[ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")\> for [ComponentIdSet](../query/struct.ComponentIdSet.html "struct bevy::ecs::query::ComponentIdSet")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/query/access.rs.html#1452)

#### fn [from\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html#tymethod.from_iter)<T>(iter: T) -> [ComponentIdSet](../query/struct.ComponentIdSet.html "struct bevy::ecs::query::ComponentIdSet")
...
### impl [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/info.rs.html#178)

#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")
...
### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")
...
where [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId"): 'into\_return,
...
### impl [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/info.rs.html#175)

#### fn [cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html#tymethod.cmp)(&self, other: &[ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/info.rs.html#175)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/info.rs.html#175)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")\>
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/info.rs.html#178)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/info.rs.html#179)
...
### impl [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/info.rs.html#178)

#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [SparseSetIndex](../storage/trait.SparseSetIndex.html "trait bevy::ecs::storage::SparseSetIndex") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/info.rs.html#202)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/info.rs.html#207)

#### fn [get\_sparse\_set\_index](../storage/trait.SparseSetIndex.html#tymethod.get_sparse_set_index)(value: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")

Creates a new instance of this type with the specified index.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/info.rs.html#175)

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/component/info.rs.html#178)

### impl [TupleStruct](../../prelude/trait.TupleStruct.html "trait bevy::prelude::TupleStruct") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")
...
### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ComponentId](struct.ComponentId.html "struct bevy::ecs::component::ComponentId")
