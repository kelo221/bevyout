...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/archetype.rs.html#88)
...
Archetype IDs are only valid for a given World, and are not globally unique. Attempting to use an archetype ID on a world that it wasn’t sourced from will not return the archetype with the same components. The only exception to this is [`EMPTY`](struct.ArchetypeId.html#associatedconstant.EMPTY "associated constant bevy::ecs::archetype::ArchetypeId::EMPTY") which is guaranteed to be identical for all Worlds.

## Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/archetype.rs.html#90)

### impl [ArchetypeId](struct.ArchetypeId.html "struct bevy::ecs::archetype::ArchetypeId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/archetype.rs.html#92)

#### pub const [EMPTY](#associatedconstant.EMPTY): [ArchetypeId](struct.ArchetypeId.html "struct bevy::ecs::archetype::ArchetypeId")

The ID for the [`Archetype`](struct.Archetype.html "struct bevy::ecs::archetype::Archetype") without any components.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/archetype.rs.html#103)

#### pub const fn [new](#method.new)(index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [ArchetypeId](struct.ArchetypeId.html "struct bevy::ecs::archetype::ArchetypeId")

Create an `ArchetypeId` from a plain value.

This is useful if you need to store the `ArchetypeId` as a plain value, for example in a specialized data structure such as a bitset.

While it doesn’t break any safety invariants, you should ensure the values comes from a pre-existing [`ArchetypeId::index`](struct.ArchetypeId.html#method.index "method bevy::ecs::archetype::ArchetypeId::index") in this world to avoid panics and other unexpected behaviors.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/archetype.rs.html#113)
...
In bevy, this is mostly used to store archetype ids in [`FixedBitSet`](../schedule/struct.FixedBitSet.html "struct bevy::ecs::schedule::FixedBitSet")s.

## Trait Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/archetype.rs.html#85)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ArchetypeId](struct.ArchetypeId.html "struct bevy::ecs::archetype::ArchetypeId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/archetype.rs.html#85)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ArchetypeId](struct.ArchetypeId.html "struct bevy::ecs::archetype::ArchetypeId")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [ArchetypeId](struct.ArchetypeId.html "struct bevy::ecs::archetype::ArchetypeId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/archetype.rs.html#85)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ArchetypeId](struct.ArchetypeId.html "struct bevy::ecs::archetype::ArchetypeId")
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [ArchetypeId](struct.ArchetypeId.html "struct bevy::ecs::archetype::ArchetypeId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/archetype.rs.html#85)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [ArchetypeId](struct.ArchetypeId.html "struct bevy::ecs::archetype::ArchetypeId")
...
### impl [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [ArchetypeId](struct.ArchetypeId.html "struct bevy::ecs::archetype::ArchetypeId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/archetype.rs.html#85)

#### fn [cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html#tymethod.cmp)(&self, other: &[ArchetypeId](struct.ArchetypeId.html "struct bevy::ecs::archetype::ArchetypeId")) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [ArchetypeId](struct.ArchetypeId.html "struct bevy::ecs::archetype::ArchetypeId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/archetype.rs.html#85)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[ArchetypeId](struct.ArchetypeId.html "struct bevy::ecs::archetype::ArchetypeId")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [ArchetypeId](struct.ArchetypeId.html "struct bevy::ecs::archetype::ArchetypeId")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/archetype.rs.html#85)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[ArchetypeId](struct.ArchetypeId.html "struct bevy::ecs::archetype::ArchetypeId")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")\>
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [ArchetypeId](struct.ArchetypeId.html "struct bevy::ecs::archetype::ArchetypeId")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ArchetypeId](struct.ArchetypeId.html "struct bevy::ecs::archetype::ArchetypeId")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ArchetypeId](struct.ArchetypeId.html "struct bevy::ecs::archetype::ArchetypeId")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ArchetypeId](struct.ArchetypeId.html "struct bevy::ecs::archetype::ArchetypeId")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ArchetypeId](struct.ArchetypeId.html "struct bevy::ecs::archetype::ArchetypeId")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ArchetypeId](struct.ArchetypeId.html "struct bevy::ecs::archetype::ArchetypeId")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ArchetypeId](struct.ArchetypeId.html "struct bevy::ecs::archetype::ArchetypeId")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ArchetypeId](struct.ArchetypeId.html "struct bevy::ecs::archetype::ArchetypeId")
