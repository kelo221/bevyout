...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#252)
...
Internally [`EntityGeneration`](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration") wraps a `u32`, so it can’t represent _every_ possible generation. Eventually, generations can (and do) wrap or alias. This can cause [`Entity`](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") and [`EntityGeneration`](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration") values to be equal while still referring to different conceptual entities. This can cause some surprising behavior:
...
This can cause some unintended side effects. See [`Entity`](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") docs for practical concerns and how to minimize any risks.

## Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#254)

### impl [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#256)

#### pub const [FIRST](#associatedconstant.FIRST): [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")

Represents the first generation of an [`EntityIndex`](struct.EntityIndex.html "struct bevy::ecs::entity::EntityIndex").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#264)

#### pub const fn [to\_bits](#method.to_bits)(self) -> [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)

Gets some bits that represent this value. The bits are opaque and should not be regarded as meaningful.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#272)

#### pub const fn [from\_bits](#method.from_bits)(bits: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")

Reconstruct an [`EntityGeneration`](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration") previously destructured with [`EntityGeneration::to_bits`](struct.EntityGeneration.html#method.to_bits "method bevy::ecs::entity::EntityGeneration::to_bits").

Only useful when applied to results from `to_bits` in the same instance of an application.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#278)

#### pub const fn [after\_versions](#method.after_versions)(self, versions: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")

Returns the [`EntityGeneration`](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration") that would result from this many more `versions` of the corresponding [`EntityIndex`](struct.EntityIndex.html "struct bevy::ecs::entity::EntityIndex") from passing.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#288)

#### pub const fn [after\_versions\_and\_could\_alias](#method.after_versions_and_could_alias)( self, versions: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html), ) -> ([EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration"), [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Identical to [`after_versions`](struct.EntityGeneration.html#method.after_versions "method bevy::ecs::entity::EntityGeneration::after_versions") but also returns a `bool` indicating if, after these `versions`, one such version could conflict with a previous one.

If this happens, this will no longer uniquely identify a version of an [`EntityIndex`](struct.EntityIndex.html "struct bevy::ecs::entity::EntityIndex"). This is called entity aliasing.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#327)

#### pub const fn [cmp\_approx](#method.cmp_approx)(&self, other: &[EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")

Compares two generations.

Generations that are later will be [`Greater`](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html#variant.Greater "variant core::cmp::Ordering::Greater") than earlier ones.
...
Ordering will be incorrect and [non-transitive](https://en.wikipedia.org/wiki/Transitive_relation) for distant generations:
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#247)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#247)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#247)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#247)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html#tymethod.fmt)(&self, \_\_derive\_more\_f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")\>

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html#tymethod.fmt)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#247)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#248)

### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#248)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#248)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#248)

### impl [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#248)

#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")
...
### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")
...
where [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#247)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#248)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#250)
...
### impl [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#248)

#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/mod.rs.html#248)

### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")
