...
#### pub fn [drain](#method.drain)(&mut self) -> [Drain](hash_set/struct.Drain.html "struct bevy::ecs::entity::hash_set::Drain")<'\_> [ⓘ](#)
...
#### pub fn [iter](#method.iter)(&self) -> [Iter](hash_set/struct.Iter.html "struct bevy::ecs::entity::hash_set::Iter")<'\_> [ⓘ](#)
...
#### pub fn [extract\_if](#method.extract_if)<F>(&mut self, f: F) -> [ExtractIf](hash_set/struct.ExtractIf.html "struct bevy::ecs::entity::hash_set::ExtractIf")<'\_, F> [ⓘ](#)
...
#### type [IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter) = [Iter](hash_set/struct.Iter.html "struct bevy::ecs::entity::hash_set::Iter")<'a>
...
#### type [IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter) = [IntoIter](hash_set/struct.IntoIter.html "struct bevy::ecs::entity::hash_set::IntoIter")
...
#### type [SourceIter](../relationship/trait.RelationshipSourceCollection.html#associatedtype.SourceIter)<'a> = [Copied](https://doc.rust-lang.org/nightly/core/iter/adapters/copied/struct.Copied.html "struct core::iter::adapters::copied::Copied")<[Iter](hash_set/struct.Iter.html "struct bevy::ecs::entity::hash_set::Iter")<'a>>
