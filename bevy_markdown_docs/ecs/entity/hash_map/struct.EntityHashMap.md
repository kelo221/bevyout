[bevy](../../../index.html)::[ecs](../../index.html)::[entity](../index.html)::[hash\_map](index.html)

# Struct EntityHashMap 

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#22)

```rust
pub struct EntityHashMap<V>(/* private fields */);
```
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#24)

### impl<V> [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#30)

#### pub const fn [new](#method.new)() -> [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

Creates an empty `EntityHashMap`.

Equivalent to [`HashMap::with_hasher(EntityHash)`](../../../platform/collections/struct.HashMap.html#method.with_hasher "associated function bevy::platform::collections::HashMap::with_hasher").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#39)

#### pub fn [with\_capacity](#method.with_capacity)(n: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

Creates an empty `EntityHashMap` with the specified capacity.

Equivalent to [`HashMap::with_capacity_and_hasher(n, EntityHash)`](../../../platform/collections/struct.HashMap.html#method.with_capacity_and_hasher "associated function bevy::platform::collections::HashMap::with_capacity_and_hasher").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#44)

#### pub const fn [from\_index\_map](#method.from_index_map)( set: [HashMap](../../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), V, [EntityHash](../struct.EntityHash.html "struct bevy::ecs::entity::EntityHash")\>, ) -> [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

Constructs an `EntityHashMap` from an [`HashMap`](../../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#49)

#### pub fn [into\_inner](#method.into_inner)(self) -> [HashMap](../../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), V, [EntityHash](../struct.EntityHash.html "struct bevy::ecs::entity::EntityHash")\>

Returns the inner [`HashMap`](../../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#57)

#### pub fn [keys](#method.keys)(&self) -> [Keys](struct.Keys.html "struct bevy::ecs::entity::hash_map::Keys")<'\_, V> [ⓘ](#)

An iterator visiting all keys in arbitrary order. The iterator element type is `&'a Entity`.

Equivalent to [`HashMap::keys`](../../../platform/collections/struct.HashMap.html#method.keys "method bevy::platform::collections::HashMap::keys").

##### [Examples found in repository](#scraped-examples)[?](../../../../scrape-examples-help.html)

examples/ui/scroll\_and\_overflow/scroll.rs ([line 45](../../../../src/scroll/scroll.rs.html#45))
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#66)

#### pub fn [into\_keys](#method.into_keys)(self) -> [IntoKeys](struct.IntoKeys.html "struct bevy::ecs::entity::hash_map::IntoKeys")<V> [ⓘ](#)

Creates a consuming iterator visiting all the keys in arbitrary order. The map cannot be used after calling this. The iterator element type is [`Entity`](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity").

Equivalent to [`HashMap::into_keys`](../../../platform/collections/struct.HashMap.html#method.into_keys "method bevy::platform::collections::HashMap::into_keys").

## Methods from [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")<Target = [HashMap](../../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), V, [EntityHash](../struct.EntityHash.html "struct bevy::ecs::entity::EntityHash")\>>
...
#### pub fn [keys](#method.keys-2)(&self) -> [Keys](../../../platform/collections/hash_map/struct.Keys.html "struct bevy::platform::collections::hash_map::Keys")<'\_, K, V> [ⓘ](#)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#21)

### impl<V> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

where V: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#21)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>
...
### impl<V> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#71)

### impl<V> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#72)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#77)

### impl<V> [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#78)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = [HashMap](../../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), V, [EntityHash](../struct.EntityHash.html "struct bevy::ecs::entity::EntityHash")\>

The resulting type after dereferencing.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#80)

#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#85)

### impl<V> [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#86)

#### fn [deref\_mut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html#tymethod.deref_mut)(&mut self) -> &mut <[EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Mutably dereferences the value.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#20)

### impl<'de, V> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>
...
### impl [EntityMapper](../../../prelude/trait.EntityMapper.html "trait bevy::prelude::EntityMapper") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<[Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity")\>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/map_entities.rs.html#299)

#### fn [get\_mapped](../../../prelude/trait.EntityMapper.html#tymethod.get_mapped)(&mut self, source: [Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity")) -> [Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity")

Returns the corresponding mapped entity or returns `entity` if there is no mapped entity

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/map_entities.rs.html#303)

#### fn [set\_mapped](../../../prelude/trait.EntityMapper.html#tymethod.set_mapped)(&mut self, source: [Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), target: [Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"))

Maps the `target` entity to the given `source`. For some implementations this might not actually determine the result of [`EntityMapper::get_mapped`](../../../prelude/trait.EntityMapper.html#tymethod.get_mapped "method bevy::prelude::EntityMapper::get_mapped").

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#21)

### impl<V> [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

where V: [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#91)

### impl<'a, V> [Extend](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.Extend.html "trait core::iter::traits::collect::Extend")<&'a ([Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), V)> for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

where V: [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#92)

#### fn [extend](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.Extend.html#tymethod.extend)<T>(&mut self, iter: T)

where T: [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = &'a ([Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), V)>,
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#97)

### impl<'a, V> [Extend](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.Extend.html "trait core::iter::traits::collect::Extend")<(&'a [Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), [&'a V](https://doc.rust-lang.org/nightly/std/primitive.reference.html))> for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

where V: [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#98)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#103)

### impl<V> [Extend](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.Extend.html "trait core::iter::traits::collect::Extend")<([Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), V)> for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#104)
...
### impl<V> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[HashMap](../../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), V, [EntityHash](../struct.EntityHash.html "struct bevy::ecs::entity::EntityHash")\>> for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#122)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [HashMap](../../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), V, [EntityHash](../struct.EntityHash.html "struct bevy::ecs::entity::EntityHash")\>) -> [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#109)

### impl<V, const N: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)\> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<\[([Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), V); [N](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]> for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#110)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: \[([Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), V); [N](https://doc.rust-lang.org/nightly/std/primitive.array.html)\]) -> [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#19)

### impl<V> [FromArg](../../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

where [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>: [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"), V: [TypePath](../../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath"), [HashMap](../../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), V, [EntityHash](../struct.EntityHash.html "struct bevy::ecs::entity::EntityHash")\>: [FromReflect](../../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") + [TypePath](../../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") + MaybeTyped + RegisterForReflection,

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#19)

#### type [This](../../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

The type to convert into. [Read more](../../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#19)

#### fn [from\_arg](../../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V> as [FromArg](../../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#115)

### impl<V> [FromIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html "trait core::iter::traits::collect::FromIterator")<([Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), V)> for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#116)

#### fn [from\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html#tymethod.from_iter)<I>(iterable: I) -> [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>
...
### impl<V> [FromReflect](../../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

where [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>: [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"), V: [TypePath](../../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath"), [HashMap](../../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), V, [EntityHash](../struct.EntityHash.html "struct bevy::ecs::entity::EntityHash")\>: [FromReflect](../../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") + [TypePath](../../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") + MaybeTyped + RegisterForReflection,

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#19)

#### fn [from\_reflect](../../../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>>
...
### impl<V> [GetOwnership](../../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>
...
### impl<V> [GetTypeRegistration](../../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#127)

### impl<V, Q> [Index](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html "trait core::ops::index::Index")<[&Q](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\> for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#128)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html#associatedtype.Output) = V

The returned type after indexing.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#130)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#135)

### impl<'a, V> [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") for &'a [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#136)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#137)

#### type [IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter) = [Iter](../../../platform/collections/hash_map/struct.Iter.html "struct bevy::platform::collections::hash_map::Iter")<'a, [Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), V>

Which kind of iterator are we turning this into?

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#139)

#### fn [into\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)(self) -> <&'a [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V> as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter "type core::iter::traits::collect::IntoIterator::IntoIter")

Creates an iterator from a value. [Read more](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#144)

### impl<'a, V> [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") for &'a mut [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#145)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#146)

#### type [IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter) = [IterMut](../../../platform/collections/hash_map/struct.IterMut.html "struct bevy::platform::collections::hash_map::IterMut")<'a, [Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), V>

Which kind of iterator are we turning this into?

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#148)

#### fn [into\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)(self) -> <&'a mut [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V> as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter "type core::iter::traits::collect::IntoIterator::IntoIter")

Creates an iterator from a value. [Read more](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#153)

### impl<V> [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#154)
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#155)

#### type [IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter) = [IntoIter](../../../platform/collections/hash_map/struct.IntoIter.html "struct bevy::platform::collections::hash_map::IntoIter")<[Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), V>

Which kind of iterator are we turning this into?

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#157)

#### fn [into\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)(self) -> <[EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V> as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter "type core::iter::traits::collect::IntoIterator::IntoIter")

Creates an iterator from a value. [Read more](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#19)

### impl<V> [IntoReturn](../../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>
...
where [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>: 'into\_return,
...
### impl<V> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

where V: [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#21)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl<V> [PartialReflect](../../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>
...
#### fn [reflect\_owned](../../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../../prelude/struct.Box.html "struct bevy::prelude::Box")<[EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>>) -> [ReflectOwned](../../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#19)

#### fn [try\_into\_reflect](../../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../../prelude/struct.Box.html "struct bevy::prelude::Box")<[EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../../prelude/struct.Box.html "struct bevy::prelude::Box")<[EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>>) -> [Box](../../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
### impl<V> [Reflect](../../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

where [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>: [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"), V: [TypePath](../../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath"), [HashMap](../../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[Entity](../../../prelude/struct.Entity.html "struct bevy::prelude::Entity"), V, [EntityHash](../struct.EntityHash.html "struct bevy::ecs::entity::EntityHash")\>: [FromReflect](../../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") + [TypePath](../../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") + MaybeTyped + RegisterForReflection,

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#19)

#### fn [into\_any](../../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../../prelude/struct.Box.html "struct bevy::prelude::Box")<[EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>>) -> [Box](../../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../../prelude/struct.Box.html "struct bevy::prelude::Box")<[EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>>) -> [Box](../../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl<V> [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>
...
### impl<V> [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

where V: [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/entity/hash_map.rs.html#19)

### impl<V> [TupleStruct](../../../prelude/trait.TupleStruct.html "trait bevy::prelude::TupleStruct") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>
...
### impl<V> [TypePath](../../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>
...
### impl<V> [Typed](../../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>
...
### impl<V> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

### impl<V> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>
...
### impl<V> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

where V: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<V> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

where V: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<V> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

where V: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<V> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>

### impl<V> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [EntityHashMap](../struct.EntityHashMap.html "struct bevy::ecs::entity::EntityHashMap")<V>
