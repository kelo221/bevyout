...
Aliasing can happen without warning. Holding onto a [`Entity`](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") id corresponding to an entity well after that entity was despawned can cause un-intuitive behavior for both ordering, and comparing in general. To prevent these bugs, it is generally best practice to stop holding an [`Entity`](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") or [`EntityGeneration`](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration") value as soon as you know it has been despawned. If you must do otherwise, do not assume the [`Entity`](../../prelude/struct.Entity.html "struct bevy::prelude::Entity") id corresponds to the same entity it originally did. See [`EntityGeneration`](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")’s docs for more information about aliasing and why it occurs.
...
#### pub const fn [from\_index\_and\_generation](#method.from_index_and_generation)( index: [EntityIndex](struct.EntityIndex.html "struct bevy::ecs::entity::EntityIndex"), generation: [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration"), ) -> [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")
...
#### pub const fn [from\_index](#method.from_index)(index: [EntityIndex](struct.EntityIndex.html "struct bevy::ecs::entity::EntityIndex")) -> [Entity](../../prelude/struct.Entity.html "struct bevy::prelude::Entity")
...
This is equivalent to [`from_index`](../../prelude/struct.Entity.html#method.from_index "associated function bevy::prelude::Entity::from_index") except that it takes a `u32` instead of an [`EntityIndex`](struct.EntityIndex.html "struct bevy::ecs::entity::EntityIndex").
...
#### pub const fn [index](#method.index)(self) -> [EntityIndex](struct.EntityIndex.html "struct bevy::ecs::entity::EntityIndex")

Return a transiently unique identifier. See also [`EntityIndex`](struct.EntityIndex.html "struct bevy::ecs::entity::EntityIndex").
...
#### pub const fn [generation](#method.generation)(self) -> [EntityGeneration](struct.EntityGeneration.html "struct bevy::ecs::entity::EntityGeneration")
