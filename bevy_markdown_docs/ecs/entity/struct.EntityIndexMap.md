...
#### pub fn [as\_slice](#method.as_slice)(&self) -> &[Slice](index_map/struct.Slice.html "struct bevy::ecs::entity::index_map::Slice")<V>
...
#### pub fn [as\_mut\_slice](#method.as_mut_slice)(&mut self) -> &mut [Slice](index_map/struct.Slice.html "struct bevy::ecs::entity::index_map::Slice")<V>
...
#### pub fn [into\_boxed\_slice](#method.into_boxed_slice)(self) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Slice](index_map/struct.Slice.html "struct bevy::ecs::entity::index_map::Slice")<V>>
...
#### pub fn [get\_range](#method.get_range)<R>(&self, range: R) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[Slice](index_map/struct.Slice.html "struct bevy::ecs::entity::index_map::Slice")<V>>
...
#### pub fn [get\_range\_mut](#method.get_range_mut)<R>(&mut self, range: R) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&mut [Slice](index_map/struct.Slice.html "struct bevy::ecs::entity::index_map::Slice")<V>>
...
#### pub fn [iter](#method.iter)(&self) -> [Iter](index_map/struct.Iter.html "struct bevy::ecs::entity::index_map::Iter")<'\_, V> [ⓘ](#)
...
#### pub fn [iter\_mut](#method.iter_mut)(&mut self) -> [IterMut](index_map/struct.IterMut.html "struct bevy::ecs::entity::index_map::IterMut")<'\_, V> [ⓘ](#)
...
#### pub fn [drain](#method.drain)<R>(&mut self, range: R) -> [Drain](index_map/struct.Drain.html "struct bevy::ecs::entity::index_map::Drain")<'\_, V> [ⓘ](#)
...
#### pub fn [keys](#method.keys)(&self) -> [Keys](index_map/struct.Keys.html "struct bevy::ecs::entity::index_map::Keys")<'\_, V> [ⓘ](#)
...
#### pub fn [into\_keys](#method.into_keys)(self) -> [IntoKeys](index_map/struct.IntoKeys.html "struct bevy::ecs::entity::index_map::IntoKeys")<V> [ⓘ](#)
...
#### type [Output](https://doc.rust-lang.org/nightly/core/ops/index/trait.Index.html#associatedtype.Output) = [Slice](index_map/struct.Slice.html "struct bevy::ecs::entity::index_map::Slice")<V>
...
#### type [IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter) = [Iter](index_map/struct.Iter.html "struct bevy::ecs::entity::index_map::Iter")<'a, V>
...
#### type [IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter) = [IterMut](index_map/struct.IterMut.html "struct bevy::ecs::entity::index_map::IterMut")<'a, V>
...
#### type [IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter) = [IntoIter](index_map/struct.IntoIter.html "struct bevy::ecs::entity::index_map::IntoIter")<V>
