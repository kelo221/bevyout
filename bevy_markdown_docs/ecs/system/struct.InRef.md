...
This is similar to [`In`](../../prelude/struct.In.html "struct bevy::prelude::In") but takes a reference to a value instead of the value itself. See [`InMut`](../../prelude/struct.InMut.html "struct bevy::prelude::InMut") for the mutable version.
...
### impl<'i, T> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [InRef](../../prelude/struct.InRef.html "struct bevy::prelude::InRef")<'i, T>
...
### impl<'i, T> [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [InRef](../../prelude/struct.InRef.html "struct bevy::prelude::InRef")<'i, T>
...
#### type [Param](../../prelude/trait.SystemInput.html#associatedtype.Param)<'i> = [InRef](../../prelude/struct.InRef.html "struct bevy::prelude::InRef")<'i, T>
...
#### type [Inner](../../prelude/trait.SystemInput.html#associatedtype.Inner)<'i> = [&'i T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)
...
#### fn [wrap](../../prelude/trait.SystemInput.html#tymethod.wrap)( this: <[InRef](../../prelude/struct.InRef.html "struct bevy::prelude::InRef")<'\_, T> as [SystemInput](../../prelude/trait.SystemInput.html "trait bevy::prelude::SystemInput")\>::[Inner](../../prelude/trait.SystemInput.html#associatedtype.Inner "type bevy::prelude::SystemInput::Inner")<'\_>, ) -> <[InRef](../../prelude/struct.InRef.html "struct bevy::prelude::InRef")<'\_, T> as [SystemInput](../../prelude/trait.SystemInput.html "trait bevy::prelude::SystemInput")\>::[Param](../../prelude/trait.SystemInput.html#associatedtype.Param "type bevy::prelude::SystemInput::Param")<'\_>
...
### impl<'i, T> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [InRef](../../prelude/struct.InRef.html "struct bevy::prelude::InRef")<'i, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

### impl<'i, T> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [InRef](../../prelude/struct.InRef.html "struct bevy::prelude::InRef")<'i, T>
...
### impl<'i, T> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [InRef](../../prelude/struct.InRef.html "struct bevy::prelude::InRef")<'i, T>
...
### impl<'i, T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [InRef](../../prelude/struct.InRef.html "struct bevy::prelude::InRef")<'i, T>

where T: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

### impl<'i, T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [InRef](../../prelude/struct.InRef.html "struct bevy::prelude::InRef")<'i, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

### impl<'i, T> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [InRef](../../prelude/struct.InRef.html "struct bevy::prelude::InRef")<'i, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

### impl<'i, T> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [InRef](../../prelude/struct.InRef.html "struct bevy::prelude::InRef")<'i, T>
