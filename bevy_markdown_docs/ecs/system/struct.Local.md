...
N.B. A [`Local`](../../prelude/struct.Local.html "struct bevy::prelude::Local")s value cannot be read or written to outside of the containing system. To add configuration to a system, convert a capturing closure into the system instead:
...
### impl<'s, T> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'s, T>

where T: [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") + [FromWorld](../../prelude/trait.FromWorld.html "trait bevy::prelude::FromWorld") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + 'static,
...
### impl<'s, T> [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'s, T>
...
#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'s, T> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#987)

### impl<'s, T> [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'s, T>

where T: [FromWorld](../../prelude/trait.FromWorld.html "trait bevy::prelude::FromWorld") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + 'static,

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#989)

#### fn [deref\_mut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html#tymethod.deref_mut)(&mut self) -> &mut <[Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'s, T> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")
...
#### type [State](trait.ExclusiveSystemParam.html#associatedtype.State) = [SyncCell](../../platform/cell/struct.SyncCell.html "struct bevy::platform::cell::SyncCell")<T>
...
#### type [Item](trait.ExclusiveSystemParam.html#associatedtype.Item)<'s> = [Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'s, T>
...
#### fn [get\_param](trait.ExclusiveSystemParam.html#tymethod.get_param)<'s>( state: &'s mut <[Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'\_s, T> as [ExclusiveSystemParam](trait.ExclusiveSystemParam.html "trait bevy::ecs::system::ExclusiveSystemParam")\>::[State](trait.ExclusiveSystemParam.html#associatedtype.State "type bevy::ecs::system::ExclusiveSystemParam::State"), \_system\_meta: &[SystemMeta](struct.SystemMeta.html "struct bevy::ecs::system::SystemMeta"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'\_s, T> as [ExclusiveSystemParam](trait.ExclusiveSystemParam.html "trait bevy::ecs::system::ExclusiveSystemParam")\>::[Item](trait.ExclusiveSystemParam.html#associatedtype.Item "type bevy::ecs::system::ExclusiveSystemParam::Item")<'s>, [SystemParamValidationError](struct.SystemParamValidationError.html "struct bevy::ecs::system::SystemParamValidationError")\>
...
### impl<'s, 'a, T> [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") for &'a [Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'s, T>

where T: [FromWorld](../../prelude/trait.FromWorld.html "trait bevy::prelude::FromWorld") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + 'static, [&'a T](https://doc.rust-lang.org/nightly/std/primitive.reference.html): [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator"),
...
#### fn [into\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)(self) -> <&'a [Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'s, T> as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter "type core::iter::traits::collect::IntoIterator::IntoIter")
...
### impl<'s, 'a, T> [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") for &'a mut [Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'s, T>
...
#### fn [into\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)(self) -> <&'a mut [Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'s, T> as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter "type core::iter::traits::collect::IntoIterator::IntoIter")
...
#### type [State](trait.SystemParam.html#associatedtype.State) = [SyncCell](../../platform/cell/struct.SyncCell.html "struct bevy::platform::cell::SyncCell")<T>

Used to store data which persists across invocations of a system.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#1021)

#### type [Item](trait.SystemParam.html#associatedtype.Item)<'w, 's> = [Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'s, T>
...
#### fn [init\_state](trait.SystemParam.html#tymethod.init_state)(world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World")) -> <[Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'a, T> as [SystemParam](trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State")
...
#### unsafe fn [get\_param](trait.SystemParam.html#tymethod.get_param)<'w, 's>( state: &'s mut <[Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'a, T> as [SystemParam](trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State"), \_system\_meta: &[SystemMeta](struct.SystemMeta.html "struct bevy::ecs::system::SystemMeta"), \_world: [UnsafeWorldCell](../world/unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'w>, \_change\_tick: [Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'a, T> as [SystemParam](trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[Item](trait.SystemParam.html#associatedtype.Item "type bevy::ecs::system::SystemParam::Item")<'w, 's>, [SystemParamValidationError](struct.SystemParamValidationError.html "struct bevy::ecs::system::SystemParamValidationError")\>
...
#### fn [build](../../prelude/trait.SystemParamBuilder.html#tymethod.build)(self, \_world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World")) -> <[Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'s, T> as [SystemParam](trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State")
...
### impl<'s, T> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'s, T>

### impl<'s, T> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'s, T>

### impl<'s, T> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'s, T>
...
### impl<'s, T> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'s, T>

### impl<'s, T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'s, T>

where T: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<'s, T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'s, T>

### impl<'s, T> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Local](../../prelude/struct.Local.html "struct bevy::prelude::Local")<'s, T>
