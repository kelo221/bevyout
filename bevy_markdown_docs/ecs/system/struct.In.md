...
[`System`](../../prelude/trait.System.html "trait bevy::prelude::System")s may take an optional input which they require to be passed to them when they are being [`run`](../../prelude/trait.System.html#method.run "method bevy::prelude::System::run"). For [`FunctionSystem`](struct.FunctionSystem.html "struct bevy::ecs::system::FunctionSystem")s the input may be marked with this `In` type, but only the first param of a function may be tagged as an input. This also means a system can only have one or zero input parameters.
...
### impl<T> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [In](../../prelude/struct.In.html "struct bevy::prelude::In")<T>
...
### impl<T> [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [In](../../prelude/struct.In.html "struct bevy::prelude::In")<T>
...
#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[In](../../prelude/struct.In.html "struct bevy::prelude::In")<T> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/input.rs.html#133)

### impl<T> [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [In](../../prelude/struct.In.html "struct bevy::prelude::In")<T>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/input.rs.html#134)

#### fn [deref\_mut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html#tymethod.deref_mut)(&mut self) -> &mut <[In](../../prelude/struct.In.html "struct bevy::prelude::In")<T> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")
...
#### type [Param](../../prelude/trait.SystemInput.html#associatedtype.Param)<'i> = [In](../../prelude/struct.In.html "struct bevy::prelude::In")<T>
...
#### type [Inner](../../prelude/trait.SystemInput.html#associatedtype.Inner)<'i> = T
...
#### fn [wrap](../../prelude/trait.SystemInput.html#tymethod.wrap)( this: <[In](../../prelude/struct.In.html "struct bevy::prelude::In")<T> as [SystemInput](../../prelude/trait.SystemInput.html "trait bevy::prelude::SystemInput")\>::[Inner](../../prelude/trait.SystemInput.html#associatedtype.Inner "type bevy::prelude::SystemInput::Inner")<'\_>, ) -> <[In](../../prelude/struct.In.html "struct bevy::prelude::In")<T> as [SystemInput](../../prelude/trait.SystemInput.html "trait bevy::prelude::SystemInput")\>::[Param](../../prelude/trait.SystemInput.html#associatedtype.Param "type bevy::prelude::SystemInput::Param")<'\_>
...
### impl<T> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [In](../../prelude/struct.In.html "struct bevy::prelude::In")<T>

where T: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"),

### impl<T> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [In](../../prelude/struct.In.html "struct bevy::prelude::In")<T>
...
### impl<T> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [In](../../prelude/struct.In.html "struct bevy::prelude::In")<T>

where T: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [In](../../prelude/struct.In.html "struct bevy::prelude::In")<T>

where T: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl<T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [In](../../prelude/struct.In.html "struct bevy::prelude::In")<T>

where T: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<T> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [In](../../prelude/struct.In.html "struct bevy::prelude::In")<T>

where T: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"),

### impl<T> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [In](../../prelude/struct.In.html "struct bevy::prelude::In")<T>
