...
# Enum RegisteredSystemError 

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_registry.rs.html#841)

```rust
pub enum RegisteredSystemError<I = (), O = ()>where
    I: SystemInput,{
...
### SystemIdNotRegistered([SystemId](struct.SystemId.html "struct bevy::ecs::system::SystemId")<I, O>)
...
### MissingRegisteredSystemComponent([SystemId](struct.SystemId.html "struct bevy::ecs::system::SystemId")<I, O>)

The `RegisteredSystem` component is missing.

### SelfRemove([SystemId](struct.SystemId.html "struct bevy::ecs::system::SystemId")<I, O>)

A system tried to remove itself.

### Skipped([SystemParamValidationError](struct.SystemParamValidationError.html "struct bevy::ecs::system::SystemParamValidationError"))

System could not be run due to parameters that failed validation. This is not considered an error.

### Failed([BevyError](../../prelude/struct.BevyError.html "struct bevy::prelude::BevyError"))

System returned an error or failed required parameter validation.

### IncorrectType([SystemId](struct.SystemId.html "struct bevy::ecs::system::SystemId")<I, O>, [SystemIdMarker](struct.SystemIdMarker.html "struct bevy::ecs::system::SystemIdMarker"))

[`SystemId`](struct.SystemId.html "struct bevy::ecs::system::SystemId") had different input and/or output types than [`SystemIdMarker`](struct.SystemIdMarker.html "struct bevy::ecs::system::SystemIdMarker")

### SystemMissing([SystemId](struct.SystemId.html "struct bevy::ecs::system::SystemId")<I, O>)

System is not present in the `RegisteredSystem` component.

## Trait Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_registry.rs.html#883)

### impl<I, O> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [RegisteredSystemError](enum.RegisteredSystemError.html "enum bevy::ecs::system::RegisteredSystemError")<I, O>

where I: [SystemInput](../../prelude/trait.SystemInput.html "trait bevy::prelude::SystemInput"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_registry.rs.html#884)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")\>

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_registry.rs.html#840)

### impl<I, O> [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [RegisteredSystemError](enum.RegisteredSystemError.html "enum bevy::ecs::system::RegisteredSystemError")<I, O>

where I: [SystemInput](../../prelude/trait.SystemInput.html "trait bevy::prelude::SystemInput"), [SystemId](struct.SystemId.html "struct bevy::ecs::system::SystemId")<I, O>: [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug"),
...
### impl<I, O> [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [RegisteredSystemError](enum.RegisteredSystemError.html "enum bevy::ecs::system::RegisteredSystemError")<I, O>

where I: [SystemInput](../../prelude/trait.SystemInput.html "trait bevy::prelude::SystemInput"), [RegisteredSystemError](enum.RegisteredSystemError.html "enum bevy::ecs::system::RegisteredSystemError")<I, O>: [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") + [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display"),
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_registry.rs.html#874)

### impl<I, O> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[RunSystemError](enum.RunSystemError.html "enum bevy::ecs::system::RunSystemError")\> for [RegisteredSystemError](enum.RegisteredSystemError.html "enum bevy::ecs::system::RegisteredSystemError")<I, O>

where I: [SystemInput](../../prelude/trait.SystemInput.html "trait bevy::prelude::SystemInput"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_registry.rs.html#875)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [RunSystemError](enum.RunSystemError.html "enum bevy::ecs::system::RunSystemError")) -> [RegisteredSystemError](enum.RegisteredSystemError.html "enum bevy::ecs::system::RegisteredSystemError")<I, O>

Converts to this type from the input type.

## Auto Trait Implementations

### impl<I = [()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), O = [()](https://doc.rust-lang.org/nightly/std/primitive.unit.html)\> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RegisteredSystemError](enum.RegisteredSystemError.html "enum bevy::ecs::system::RegisteredSystemError")<I, O>

### impl<I = [()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), O = [()](https://doc.rust-lang.org/nightly/std/primitive.unit.html)\> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RegisteredSystemError](enum.RegisteredSystemError.html "enum bevy::ecs::system::RegisteredSystemError")<I, O>

### impl<I, O> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RegisteredSystemError](enum.RegisteredSystemError.html "enum bevy::ecs::system::RegisteredSystemError")<I, O>

### impl<I, O> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RegisteredSystemError](enum.RegisteredSystemError.html "enum bevy::ecs::system::RegisteredSystemError")<I, O>

### impl<I, O> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RegisteredSystemError](enum.RegisteredSystemError.html "enum bevy::ecs::system::RegisteredSystemError")<I, O>

### impl<I, O> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RegisteredSystemError](enum.RegisteredSystemError.html "enum bevy::ecs::system::RegisteredSystemError")<I, O>

### impl<I, O> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RegisteredSystemError](enum.RegisteredSystemError.html "enum bevy::ecs::system::RegisteredSystemError")<I, O>
