...
# Struct CachedSystemId 

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_registry.rs.html#427)
...
This resource is inserted by [`World::register_system_cached`](../../prelude/struct.World.html#method.register_system_cached "method bevy::prelude::World::register_system_cached").
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_registry.rs.html#433)

### impl<S> [CachedSystemId](struct.CachedSystemId.html "struct bevy::ecs::system::CachedSystemId")<S>

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_registry.rs.html#435)

#### pub fn [new](#method.new)<I, O>(id: [SystemId](struct.SystemId.html "struct bevy::ecs::system::SystemId")<I, O>) -> [CachedSystemId](struct.CachedSystemId.html "struct bevy::ecs::system::CachedSystemId")<S>
...
### impl<S> [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [CachedSystemId](struct.CachedSystemId.html "struct bevy::ecs::system::CachedSystemId")<S>

where [CachedSystemId](struct.CachedSystemId.html "struct bevy::ecs::system::CachedSystemId")<S>: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl<S> [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [CachedSystemId](struct.CachedSystemId.html "struct bevy::ecs::system::CachedSystemId")<S>

where [CachedSystemId](struct.CachedSystemId.html "struct bevy::ecs::system::CachedSystemId")<S>: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl<S> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [CachedSystemId](struct.CachedSystemId.html "struct bevy::ecs::system::CachedSystemId")<S>

### impl<S> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [CachedSystemId](struct.CachedSystemId.html "struct bevy::ecs::system::CachedSystemId")<S>

### impl<S> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [CachedSystemId](struct.CachedSystemId.html "struct bevy::ecs::system::CachedSystemId")<S>

### impl<S> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [CachedSystemId](struct.CachedSystemId.html "struct bevy::ecs::system::CachedSystemId")<S>

### impl<S> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [CachedSystemId](struct.CachedSystemId.html "struct bevy::ecs::system::CachedSystemId")<S>

### impl<S> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [CachedSystemId](struct.CachedSystemId.html "struct bevy::ecs::system::CachedSystemId")<S>

### impl<S> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [CachedSystemId](struct.CachedSystemId.html "struct bevy::ecs::system::CachedSystemId")<S>
