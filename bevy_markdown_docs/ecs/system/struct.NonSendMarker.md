...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#1285)

```rust
pub struct NonSendMarker(/* private fields */);
```
...
#### type [Item](trait.SystemParam.html#associatedtype.Item)<'w, 's> = [NonSendMarker](struct.NonSendMarker.html "struct bevy::ecs::system::NonSendMarker")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#1293)

#### fn [init\_state](trait.SystemParam.html#tymethod.init_state)(\_world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World")) -> <[NonSendMarker](struct.NonSendMarker.html "struct bevy::ecs::system::NonSendMarker") as [SystemParam](trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#1305-1310)

#### unsafe fn [get\_param](trait.SystemParam.html#tymethod.get_param)<'world, 'state>( \_state: &'state mut <[NonSendMarker](struct.NonSendMarker.html "struct bevy::ecs::system::NonSendMarker") as [SystemParam](trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State"), \_system\_meta: &[SystemMeta](struct.SystemMeta.html "struct bevy::ecs::system::SystemMeta"), \_world: [UnsafeWorldCell](../world/unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'world>, \_change\_tick: [Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[NonSendMarker](struct.NonSendMarker.html "struct bevy::ecs::system::NonSendMarker") as [SystemParam](trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[Item](trait.SystemParam.html#associatedtype.Item "type bevy::ecs::system::SystemParam::Item")<'world, 'state>, [SystemParamValidationError](struct.SystemParamValidationError.html "struct bevy::ecs::system::SystemParamValidationError")\>
...
### impl ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [NonSendMarker](struct.NonSendMarker.html "struct bevy::ecs::system::NonSendMarker")

### impl ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [NonSendMarker](struct.NonSendMarker.html "struct bevy::ecs::system::NonSendMarker")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [NonSendMarker](struct.NonSendMarker.html "struct bevy::ecs::system::NonSendMarker")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [NonSendMarker](struct.NonSendMarker.html "struct bevy::ecs::system::NonSendMarker")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [NonSendMarker](struct.NonSendMarker.html "struct bevy::ecs::system::NonSendMarker")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [NonSendMarker](struct.NonSendMarker.html "struct bevy::ecs::system::NonSendMarker")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [NonSendMarker](struct.NonSendMarker.html "struct bevy::ecs::system::NonSendMarker")
