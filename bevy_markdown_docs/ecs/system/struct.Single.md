...
This [`SystemParam`](trait.SystemParam.html "trait bevy::ecs::system::SystemParam") fails validation if zero or more than one matching entity exists. This will cause the system to be skipped, according to the rules laid out in [`SystemParamValidationError`](struct.SystemParamValidationError.html "struct bevy::ecs::system::SystemParamValidationError").
...
#### type [Item](trait.SystemParam.html#associatedtype.Item)<'w, 's> = [Single](../../prelude/struct.Single.html "struct bevy::prelude::Single")<'w, 's, D, F>
...
#### fn [init\_state](trait.SystemParam.html#tymethod.init_state)(world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World")) -> <[Single](../../prelude/struct.Single.html "struct bevy::prelude::Single")<'a, 'b, D, F> as [SystemParam](trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State")
