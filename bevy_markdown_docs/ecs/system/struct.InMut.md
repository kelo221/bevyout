...
This is similar to [`In`](../../prelude/struct.In.html "struct bevy::prelude::In") but takes a mutable reference to a value instead of the value itself. See [`InRef`](../../prelude/struct.InRef.html "struct bevy::prelude::InRef") for the read-only version.
...
### impl<'a, T> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [InMut](../../prelude/struct.InMut.html "struct bevy::prelude::InMut")<'a, T>
...
### impl<'i, T> [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [InMut](../../prelude/struct.InMut.html "struct bevy::prelude::InMut")<'i, T>
...
#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[InMut](../../prelude/struct.InMut.html "struct bevy::prelude::InMut")<'i, T> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/input.rs.html#241)

### impl<'i, T> [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [InMut](../../prelude/struct.InMut.html "struct bevy::prelude::InMut")<'i, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/input.rs.html#242)

#### fn [deref\_mut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html#tymethod.deref_mut)(&mut self) -> &mut <[InMut](../../prelude/struct.InMut.html "struct bevy::prelude::InMut")<'i, T> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")
...
#### type [Param](../../prelude/trait.SystemInput.html#associatedtype.Param)<'i> = [InMut](../../prelude/struct.InMut.html "struct bevy::prelude::InMut")<'i, T>
...
#### type [Inner](../../prelude/trait.SystemInput.html#associatedtype.Inner)<'i> = [&'i mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)
...
#### fn [wrap](../../prelude/trait.SystemInput.html#tymethod.wrap)( this: <[InMut](../../prelude/struct.InMut.html "struct bevy::prelude::InMut")<'\_, T> as [SystemInput](../../prelude/trait.SystemInput.html "trait bevy::prelude::SystemInput")\>::[Inner](../../prelude/trait.SystemInput.html#associatedtype.Inner "type bevy::prelude::SystemInput::Inner")<'\_>, ) -> <[InMut](../../prelude/struct.InMut.html "struct bevy::prelude::InMut")<'\_, T> as [SystemInput](../../prelude/trait.SystemInput.html "trait bevy::prelude::SystemInput")\>::[Param](../../prelude/trait.SystemInput.html#associatedtype.Param "type bevy::prelude::SystemInput::Param")<'\_>
...
### impl<'a, T> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [InMut](../../prelude/struct.InMut.html "struct bevy::prelude::InMut")<'a, T>

### impl<'a, T> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [InMut](../../prelude/struct.InMut.html "struct bevy::prelude::InMut")<'a, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

### impl<'a, T> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [InMut](../../prelude/struct.InMut.html "struct bevy::prelude::InMut")<'a, T>
...
### impl<'a, T> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [InMut](../../prelude/struct.InMut.html "struct bevy::prelude::InMut")<'a, T>
...
### impl<'a, T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [InMut](../../prelude/struct.InMut.html "struct bevy::prelude::InMut")<'a, T>
...
### impl<'a, T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [InMut](../../prelude/struct.InMut.html "struct bevy::prelude::InMut")<'a, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

### impl<'a, T> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [InMut](../../prelude/struct.InMut.html "struct bevy::prelude::InMut")<'a, T>
