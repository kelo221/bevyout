...
Only [`Send`](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") resources may be accessed with the [`ResMut`](../../prelude/struct.ResMut.html "struct bevy::prelude::ResMut") [`SystemParam`](trait.SystemParam.html "trait bevy::ecs::system::SystemParam"). In case that the resource does not implement `Send`, this `SystemParam` wrapper can be used. This will instruct the scheduler to instead run the system on the main thread so that it doesn’t send the resource over to another thread.

This [`SystemParam`](trait.SystemParam.html "trait bevy::ecs::system::SystemParam") fails validation if non-send resource doesn’t exist. This will cause a panic, but can be configured to do nothing or warn once.
...
#### type [Item](trait.SystemParam.html#associatedtype.Item)<'w, 's> = [NonSendMut](../../prelude/struct.NonSendMut.html "struct bevy::prelude::NonSendMut")<'w, T>
...
#### fn [init\_state](trait.SystemParam.html#tymethod.init_state)(world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World")) -> <[NonSendMut](../../prelude/struct.NonSendMut.html "struct bevy::prelude::NonSendMut")<'a, T> as [SystemParam](trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State")
...
#### unsafe fn [get\_param](trait.SystemParam.html#tymethod.get_param)<'w, 's>( \_: &'s mut <[NonSendMut](../../prelude/struct.NonSendMut.html "struct bevy::prelude::NonSendMut")<'a, T> as [SystemParam](trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State"), system\_meta: &[SystemMeta](struct.SystemMeta.html "struct bevy::ecs::system::SystemMeta"), world: [UnsafeWorldCell](../world/unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'w>, change\_tick: [Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[NonSendMut](../../prelude/struct.NonSendMut.html "struct bevy::prelude::NonSendMut")<'a, T> as [SystemParam](trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[Item](trait.SystemParam.html#associatedtype.Item "type bevy::ecs::system::SystemParam::Item")<'w, 's>, [SystemParamValidationError](struct.SystemParamValidationError.html "struct bevy::ecs::system::SystemParamValidationError")\>
