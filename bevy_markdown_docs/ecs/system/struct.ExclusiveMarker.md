...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#1251)

```rust
pub struct ExclusiveMarker(/* private fields */);
```
...
#### type [Item](trait.SystemParam.html#associatedtype.Item)<'w, 's> = [ExclusiveMarker](struct.ExclusiveMarker.html "struct bevy::ecs::system::ExclusiveMarker")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#1259)

#### fn [init\_state](trait.SystemParam.html#tymethod.init_state)(\_world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World")) -> <[ExclusiveMarker](struct.ExclusiveMarker.html "struct bevy::ecs::system::ExclusiveMarker") as [SystemParam](trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State")
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#1261-1266)

#### fn [init\_access](trait.SystemParam.html#tymethod.init_access)( \_state: &<[ExclusiveMarker](struct.ExclusiveMarker.html "struct bevy::ecs::system::ExclusiveMarker") as [SystemParam](trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State"), system\_meta: &mut [SystemMeta](struct.SystemMeta.html "struct bevy::ecs::system::SystemMeta"), \_component\_access\_set: &mut [FilteredAccessSet](../query/struct.FilteredAccessSet.html "struct bevy::ecs::query::FilteredAccessSet"), \_world: &mut [World](../../prelude/struct.World.html "struct bevy::prelude::World"), )
...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system_param.rs.html#1271-1276)

#### unsafe fn [get\_param](trait.SystemParam.html#tymethod.get_param)<'world, 'state>( \_state: &'state mut <[ExclusiveMarker](struct.ExclusiveMarker.html "struct bevy::ecs::system::ExclusiveMarker") as [SystemParam](trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[State](trait.SystemParam.html#associatedtype.State "type bevy::ecs::system::SystemParam::State"), \_system\_meta: &[SystemMeta](struct.SystemMeta.html "struct bevy::ecs::system::SystemMeta"), \_world: [UnsafeWorldCell](../world/unsafe_world_cell/struct.UnsafeWorldCell.html "struct bevy::ecs::world::unsafe_world_cell::UnsafeWorldCell")<'world>, \_change\_tick: [Tick](../change_detection/struct.Tick.html "struct bevy::ecs::change_detection::Tick"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[ExclusiveMarker](struct.ExclusiveMarker.html "struct bevy::ecs::system::ExclusiveMarker") as [SystemParam](trait.SystemParam.html "trait bevy::ecs::system::SystemParam")\>::[Item](trait.SystemParam.html#associatedtype.Item "type bevy::ecs::system::SystemParam::Item")<'world, 'state>, [SystemParamValidationError](struct.SystemParamValidationError.html "struct bevy::ecs::system::SystemParamValidationError")\>
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ExclusiveMarker](struct.ExclusiveMarker.html "struct bevy::ecs::system::ExclusiveMarker")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ExclusiveMarker](struct.ExclusiveMarker.html "struct bevy::ecs::system::ExclusiveMarker")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ExclusiveMarker](struct.ExclusiveMarker.html "struct bevy::ecs::system::ExclusiveMarker")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ExclusiveMarker](struct.ExclusiveMarker.html "struct bevy::ecs::system::ExclusiveMarker")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ExclusiveMarker](struct.ExclusiveMarker.html "struct bevy::ecs::system::ExclusiveMarker")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ExclusiveMarker](struct.ExclusiveMarker.html "struct bevy::ecs::system::ExclusiveMarker")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ExclusiveMarker](struct.ExclusiveMarker.html "struct bevy::ecs::system::ExclusiveMarker")
