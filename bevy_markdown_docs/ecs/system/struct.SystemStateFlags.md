...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

```rust
pub struct SystemStateFlags(/* private fields */);
```
...
### impl [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### pub const [NON\_SEND](#associatedconstant.NON_SEND): [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

Set if system cannot be sent across threads

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### pub const [EXCLUSIVE](#associatedconstant.EXCLUSIVE): [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

Set if system requires exclusive World access

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### pub const [DEFERRED](#associatedconstant.DEFERRED): [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")
...
#### pub const fn [empty](#method.empty)() -> [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

Get a flags value with all bits unset.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### pub const fn [all](#method.all)() -> [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")
...
#### pub const fn [from\_bits](#method.from_bits)(bits: [u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")\>
...
#### pub const fn [from\_bits\_truncate](#method.from_bits_truncate)(bits: [u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)) -> [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

Convert from a bits value, unsetting any unknown bits.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### pub const fn [from\_bits\_retain](#method.from_bits_retain)(bits: [u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)) -> [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

Convert from a bits value exactly.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### pub fn [from\_name](#method.from_name)(name: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")\>
...
#### pub const fn [intersects](#method.intersects)(&self, other: [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Whether any set bits in `other` are also set in `self`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### pub const fn [contains](#method.contains)(&self, other: [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Whether all set bits in `other` are also set in `self`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### pub fn [insert](#method.insert)(&mut self, other: [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags"))

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### pub fn [remove](#method.remove)(&mut self, other: [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags"))
...
#### pub fn [toggle](#method.toggle)(&mut self, other: [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags"))

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### pub fn [set](#method.set)(&mut self, other: [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags"), value: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Call `insert` when `value` is `true` or `remove` when `value` is `false`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### pub const fn [intersection](#method.intersection)(self, other: [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")) -> [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

The bitwise and (`&`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### pub const fn [union](#method.union)(self, other: [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")) -> [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### pub const fn [difference](#method.difference)(self, other: [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")) -> [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")
...
#### pub const fn [symmetric\_difference](#method.symmetric_difference)( self, other: [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags"), ) -> [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### pub const fn [complement](#method.complement)(self) -> [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")
...
#### pub const fn [iter](#method.iter)(&self) -> [Iter](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.Iter.html "struct bitflags::iter::Iter")<[SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")\> [ⓘ](#)
...
#### pub const fn [iter\_names](#method.iter_names)(&self) -> [IterNames](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.IterNames.html "struct bitflags::iter::IterNames")<[SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")\> [ⓘ](#)
...
### impl [Binary](https://doc.rust-lang.org/nightly/core/fmt/trait.Binary.html "trait core::fmt::Binary") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")
...
### impl [BitAnd](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html "trait core::ops::bit::BitAnd") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### fn [bitand](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html#tymethod.bitand)(self, other: [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")) -> [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

The bitwise and (`&`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAnd.html#associatedtype.Output) = [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

The resulting type after applying the `&` operator.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

### impl [BitAndAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAndAssign.html "trait core::ops::bit::BitAndAssign") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### fn [bitand\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitAndAssign.html#tymethod.bitand_assign)(&mut self, other: [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags"))

The bitwise and (`&`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

### impl [BitOr](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html "trait core::ops::bit::BitOr") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### fn [bitor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html#tymethod.bitor)(self, other: [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")) -> [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOr.html#associatedtype.Output) = [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

The resulting type after applying the `|` operator.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

### impl [BitOrAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOrAssign.html "trait core::ops::bit::BitOrAssign") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### fn [bitor\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitOrAssign.html#tymethod.bitor_assign)(&mut self, other: [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags"))

The bitwise or (`|`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

### impl [BitXor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html "trait core::ops::bit::BitXor") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### fn [bitxor](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html#tymethod.bitxor)(self, other: [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")) -> [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXor.html#associatedtype.Output) = [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

The resulting type after applying the `^` operator.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

### impl [BitXorAssign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXorAssign.html "trait core::ops::bit::BitXorAssign") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### fn [bitxor\_assign](https://doc.rust-lang.org/nightly/core/ops/bit/trait.BitXorAssign.html#tymethod.bitxor_assign)(&mut self, other: [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags"))

The bitwise exclusive-or (`^`) of the bits in `self` and `other`.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#26)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#26)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#26)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

### impl [Extend](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.Extend.html "trait core::iter::traits::collect::Extend")<[SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")\> for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")
...
where T: [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")\>,
...
### impl [Flags](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html "trait bitflags::traits::Flags") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### const [FLAGS](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#associatedconstant.FLAGS): &'static \[[Flag](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/struct.Flag.html "struct bitflags::traits::Flag")<[SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")\>\]
...
#### fn [from\_bits\_retain](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#tymethod.from_bits_retain)(bits: [u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)) -> [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

Convert from a bits value exactly.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### fn [all\_named](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/traits/trait.Flags.html#method.all_named)() -> [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")
...
### impl [FromIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html "trait core::iter::traits::collect::FromIterator")<[SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")\> for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### fn [from\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html#tymethod.from_iter)<T>(iterator: T) -> [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")
...
### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")
...
### impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### type [Item](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.Item) = [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

The type of the elements being iterated over.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### type [IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter) = [Iter](https://docs.rs/bitflags/1.3.2/x86_64-unknown-linux-gnu/bitflags/iter/struct.Iter.html "struct bitflags::iter::Iter")<[SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")\>

Which kind of iterator are we turning this into?

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### fn [into\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)(self) -> <[SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags") as [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")\>::[IntoIter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#associatedtype.IntoIter "type core::iter::traits::collect::IntoIterator::IntoIter")

Creates an iterator from a value. [Read more](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html#tymethod.into_iter)

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

### impl [LowerHex](https://doc.rust-lang.org/nightly/core/fmt/trait.LowerHex.html "trait core::fmt::LowerHex") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")
...
### impl [Not](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html "trait core::ops::bit::Not") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### fn [not](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html#tymethod.not)(self) -> [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

The bitwise negation (`!`) of the bits in `self`, truncating the result.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/bit/trait.Not.html#associatedtype.Output) = [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

The resulting type after applying the `!` operator.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

### impl [Octal](https://doc.rust-lang.org/nightly/core/fmt/trait.Octal.html "trait core::fmt::Octal") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#26)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

### impl [Sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html "trait core::ops::arith::Sub") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### fn [sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#tymethod.sub)(self, other: [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")) -> [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")
...
#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#associatedtype.Output) = [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

The resulting type after applying the `-` operator.

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

### impl [SubAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html "trait core::ops::arith::SubAssign") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/system/system.rs.html#24-35)

#### fn [sub\_assign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html#tymethod.sub_assign)(&mut self, other: [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags"))
...
### impl [UpperHex](https://doc.rust-lang.org/nightly/core/fmt/trait.UpperHex.html "trait core::fmt::UpperHex") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SystemStateFlags](struct.SystemStateFlags.html "struct bevy::ecs::system::SystemStateFlags")
