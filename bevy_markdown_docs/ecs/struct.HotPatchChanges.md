...
[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/lib.rs.html#155)
...
Used by Executors and other places which run systems [`System::refresh_hotpatch`](../prelude/trait.System.html#tymethod.refresh_hotpatch "method bevy::prelude::System::refresh_hotpatch") only when necessary.

## Trait Implementations

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/lib.rs.html#154)

### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [HotPatchChanges](struct.HotPatchChanges.html "struct bevy::ecs::HotPatchChanges")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [HotPatchChanges](struct.HotPatchChanges.html "struct bevy::ecs::HotPatchChanges")

[Source](https://docs.rs/bevy_ecs/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ecs/lib.rs.html#154)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [HotPatchChanges](struct.HotPatchChanges.html "struct bevy::ecs::HotPatchChanges")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [HotPatchChanges](struct.HotPatchChanges.html "struct bevy::ecs::HotPatchChanges")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [HotPatchChanges](struct.HotPatchChanges.html "struct bevy::ecs::HotPatchChanges")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [HotPatchChanges](struct.HotPatchChanges.html "struct bevy::ecs::HotPatchChanges")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [HotPatchChanges](struct.HotPatchChanges.html "struct bevy::ecs::HotPatchChanges")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [HotPatchChanges](struct.HotPatchChanges.html "struct bevy::ecs::HotPatchChanges")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [HotPatchChanges](struct.HotPatchChanges.html "struct bevy::ecs::HotPatchChanges")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [HotPatchChanges](struct.HotPatchChanges.html "struct bevy::ecs::HotPatchChanges")
