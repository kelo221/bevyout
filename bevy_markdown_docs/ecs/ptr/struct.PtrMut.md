...
[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#307)
...
*   If `A` is [`Aligned`](struct.Aligned.html "struct bevy::ecs::ptr::Aligned"), the pointer must always be [properly aligned](https://doc.rust-lang.org/std/ptr/index.html#alignment) for the unknown pointee type.
...
[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#440)

### impl<'a> [PtrMut](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'a>

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#440)

#### pub fn [to\_unaligned](#method.to_unaligned)(self) -> [PtrMut](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'a, [Unaligned](struct.Unaligned.html "struct bevy::ecs::ptr::Unaligned")\>

Removes the alignment requirement of this pointer

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#440)

### impl<A> [PtrMut](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'\_, A>

where A: [IsAligned](trait.IsAligned.html "trait bevy::ecs::ptr::IsAligned"),

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#440)

#### pub unsafe fn [byte\_offset](#method.byte_offset)(self, count: [isize](https://doc.rust-lang.org/nightly/std/primitive.isize.html)) -> [PtrMut](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'\_, A>
...
_See also: [`ptr::offset`](https://doc.rust-lang.org/std/primitive.pointer.html#method.offset)_

##### Safety

*   The offset cannot make the existing ptr null, or take it out of bounds for its allocation.
*   If the `A` type parameter is [`Aligned`](struct.Aligned.html "struct bevy::ecs::ptr::Aligned") then the offset must not make the resulting pointer be unaligned for the pointee type.
*   The value pointed by the resulting pointer must outlive the lifetime of this pointer.

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#440)

#### pub unsafe fn [byte\_add](#method.byte_add)(self, count: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [PtrMut](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'\_, A>
...
_See also: [`ptr::add`](https://doc.rust-lang.org/std/primitive.pointer.html#method.add)_
...
[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#871)

### impl<'a, A> [PtrMut](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'a, A>

where A: [IsAligned](trait.IsAligned.html "trait bevy::ecs::ptr::IsAligned"),

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#883)

#### pub unsafe fn [new](#method.new)(inner: [NonNull](https://doc.rust-lang.org/nightly/core/ptr/non_null/struct.NonNull.html "struct core::ptr::non_null::NonNull")<[u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)\>) -> [PtrMut](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'a, A>
...
*   If the `A` type parameter is [`Aligned`](struct.Aligned.html "struct bevy::ecs::ptr::Aligned") then `inner` must be [properly aligned](https://doc.rust-lang.org/std/ptr/index.html#alignment) for the pointee type.
*   `inner` must have correct provenance to allow read and writes of the pointee type.
*   The lifetime `'a` must be constrained such that this [`PtrMut`](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut") will stay valid and nothing else can read or mutate the pointee while this [`PtrMut`](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut") is live.

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#892)

#### pub unsafe fn [promote](#method.promote)(self) -> [OwningPtr](struct.OwningPtr.html "struct bevy::ecs::ptr::OwningPtr")<'a, A>

Transforms this [`PtrMut`](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut") into an [`OwningPtr`](struct.OwningPtr.html "struct bevy::ecs::ptr::OwningPtr")

##### Safety

Must have right to drop or move out of [`PtrMut`](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut").

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/stress\_tests/many\_components.rs ([line 149](../../../src/many_components/many_components.rs.html#149))
...
[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#905)

#### pub unsafe fn [deref\_mut](#method.deref_mut)<T>(self) -> [&'a mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)

Transforms this [`PtrMut<T>`](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut") into a `&mut T` with the same lifetime

##### Safety

*   `T` must be the erased pointee type for this [`PtrMut`](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut").
*   If the type parameter `A` is [`Unaligned`](struct.Unaligned.html "struct bevy::ecs::ptr::Unaligned") then this pointer must be [properly aligned](https://doc.rust-lang.org/std/ptr/index.html#alignment) for the pointee type `T`.

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#916)

#### pub fn [as\_ptr](#method.as_ptr)(&self) -> [\*mut](https://doc.rust-lang.org/nightly/std/primitive.pointer.html) [u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)

Gets the underlying pointer, erasing the associated lifetime.

If possible, it is strongly encouraged to use [`deref_mut`](struct.PtrMut.html#method.deref_mut "method bevy::ecs::ptr::PtrMut::deref_mut") over this function, as it retains the lifetime.

##### [Examples found in repository](#scraped-examples-1)[?](../../../scrape-examples-help.html)

examples/ecs/dynamic.rs ([line 195](../../../src/dynamic/dynamic.rs.html#195))
...
[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#922)

#### pub fn [reborrow](#method.reborrow)(&mut self) -> [PtrMut](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'\_, A>

Gets a [`PtrMut`](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut") from this with a smaller lifetime.

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#929)

#### pub fn [as\_ref](#method.as_ref)(&self) -> [Ptr](struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'\_, A>
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [PtrMut](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'\_>
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [PtrMut](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'\_, [Unaligned](struct.Unaligned.html "struct bevy::ecs::ptr::Unaligned")\>
...
[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#935)

### impl<'a, T> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[&'a mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\> for [PtrMut](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'a>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#937)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(val: [&'a mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)) -> [PtrMut](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'a>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#440)

### impl<A> [Pointer](https://doc.rust-lang.org/nightly/core/fmt/trait.Pointer.html "trait core::fmt::Pointer") for [PtrMut](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'\_, A>
...
### impl<'a, A = [Aligned](struct.Aligned.html "struct bevy::ecs::ptr::Aligned")\> ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [PtrMut](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'a, A>

### impl<'a, A = [Aligned](struct.Aligned.html "struct bevy::ecs::ptr::Aligned")\> ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [PtrMut](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'a, A>

### impl<'a, A = [Aligned](struct.Aligned.html "struct bevy::ecs::ptr::Aligned")\> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [PtrMut](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'a, A>

### impl<'a, A> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [PtrMut](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'a, A>

### impl<'a, A> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [PtrMut](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'a, A>
...
### impl<'a, A> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [PtrMut](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'a, A>

where A: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<'a, A> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [PtrMut](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'a, A>
