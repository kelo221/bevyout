...
[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#353)
...
A [`Box`](https://doc.rust-lang.org/std/boxed/struct.Box.html)\-like pointer for moving a value to a new memory location without needing to pass by value.

Conceptually represents ownership of whatever data is being pointed to and will call its [`Drop`](https://doc.rust-lang.org/nightly/core/ops/drop/trait.Drop.html "trait core::ops::drop::Drop") impl upon being dropped. This pointer is _not_ responsible for freeing the memory pointed to by this pointer as it may be pointing to an element in a `Vec` or to a local in a function etc.
...
*   If `A` is [`Aligned`](struct.Aligned.html "struct bevy::ecs::ptr::Aligned"), the pointer must always be [properly aligned](https://doc.rust-lang.org/std/ptr/index.html#alignment) for the type `T`.

A value can be deconstructed into its fields via [`deconstruct_moving_ptr`](macro.deconstruct_moving_ptr.html "macro bevy::ecs::ptr::deconstruct_moving_ptr"), see it’s documentation for an example on how to use it.

## Implementations

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#443)

### impl<'a, T> [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, T>

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#446)

#### pub fn [to\_unaligned](#method.to_unaligned)(self) -> [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, T, [Unaligned](struct.Unaligned.html "struct bevy::ecs::ptr::Unaligned")\>

Removes the alignment requirement of this pointer

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#461)

#### pub unsafe fn [from\_value](#method.from_value)(value: &'a mut [MaybeUninit](https://doc.rust-lang.org/nightly/core/mem/maybe_uninit/union.MaybeUninit.html "union core::mem::maybe_uninit::MaybeUninit")<T>) -> [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, T>

Creates a [`MovingPtr`](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr") from a provided value of type `T`.

For a safer alternative, it is strongly advised to use [`move_as_ptr`](macro.move_as_ptr.html "macro bevy::ecs::ptr::move_as_ptr") where possible.

##### Safety

*   `value` must store a properly initialized value of type `T`.
*   Once the returned [`MovingPtr`](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr") has been used, `value` must be treated as it were uninitialized unless it was explicitly leaked via [`core::mem::forget`](https://doc.rust-lang.org/nightly/core/mem/fn.forget.html "fn core::mem::forget").

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#469)

### impl<'a, T, A> [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, T, A>

where A: [IsAligned](trait.IsAligned.html "trait bevy::ecs::ptr::IsAligned"),

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#483)

#### pub unsafe fn [new](#method.new)(inner: [NonNull](https://doc.rust-lang.org/nightly/core/ptr/non_null/struct.NonNull.html "struct core::ptr::non_null::NonNull")<T>) -> [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, T, A>
...
*   If the `A` type parameter is [`Aligned`](struct.Aligned.html "struct bevy::ecs::ptr::Aligned") then `inner` must be [properly aligned](https://doc.rust-lang.org/std/ptr/index.html#alignment) for `T`.
*   `inner` must have correct provenance to allow read and writes of the pointee type.
*   The lifetime `'a` must be constrained such that this [`MovingPtr`](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr") will stay valid and nothing else can read or mutate the pointee while this [`MovingPtr`](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr") is live.

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#546-549)

#### pub fn [partial\_move](#method.partial_move)<R>( self, f: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")([MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'\_, T, A>) -> R, ) -> ([MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, [MaybeUninit](https://doc.rust-lang.org/nightly/core/mem/maybe_uninit/union.MaybeUninit.html "union core::mem::maybe_uninit::MaybeUninit")<T>, A>, R)

Partially moves out some fields inside of `self`.

The partially returned value is returned back pointing to [`MaybeUninit<T>`](https://doc.rust-lang.org/nightly/core/mem/maybe_uninit/union.MaybeUninit.html "union core::mem::maybe_uninit::MaybeUninit").
...
[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#560)

#### pub fn [read](#method.read)(self) -> T

Reads the value pointed to by this pointer.

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#581)

#### pub unsafe fn [write\_to](#method.write_to)(self, dst: [\*mut T](https://doc.rust-lang.org/nightly/std/primitive.pointer.html))

Writes the value pointed to by this pointer to a provided location.

This does _not_ drop the value stored at `dst` and it’s the caller’s responsibility to ensure that it’s properly dropped.

##### Safety

*   `dst` must be valid for writes.
*   If the `A` type parameter is [`Aligned`](struct.Aligned.html "struct bevy::ecs::ptr::Aligned") then `dst` must be [properly aligned](https://doc.rust-lang.org/std/ptr/index.html#alignment) for `T`.

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#596)

#### pub fn [assign\_to](#method.assign_to)(self, dst: [&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html))

Writes the value pointed to by this pointer into `dst`.

The value previously stored at `dst` will be dropped.

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#671)

#### pub unsafe fn [move\_field](#method.move_field)<U>( &self, f: impl [Fn](https://doc.rust-lang.org/nightly/core/ops/function/trait.Fn.html "trait core::ops::function::Fn")([\*mut T](https://doc.rust-lang.org/nightly/std/primitive.pointer.html)) -> [\*mut U](https://doc.rust-lang.org/nightly/std/primitive.pointer.html), ) -> [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, U, A>

Creates a [`MovingPtr`](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr") for a specific field within `self`.

This function is explicitly made for deconstructive moves.

The correct `byte_offset` for a field can be obtained via [`core::mem::offset_of`](https://doc.rust-lang.org/nightly/core/mem/macro.offset_of.html "macro core::mem::offset_of").

##### Safety

*   `f` must return a non-null pointer to a valid field inside `T`
*   If `A` is [`Aligned`](struct.Aligned.html "struct bevy::ecs::ptr::Aligned"), then `T` must not be `repr(packed)`
...
*   This function cannot alias the field with any other access, including other calls to [`move_field`](struct.MovingPtr.html#method.move_field "method bevy::ecs::ptr::MovingPtr::move_field") for the same field, without first calling [`forget`](https://doc.rust-lang.org/nightly/core/mem/fn.forget.html "fn core::mem::forget") on it first.

A result of the above invariants means that any operation that could cause `self` to be dropped while the pointers to the fields are held will result in undefined behavior. This requires extra caution around code that may panic. See the example below for an example of how to safely use this function.
...
[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#680)

### impl<'a, T, A> [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, [MaybeUninit](https://doc.rust-lang.org/nightly/core/mem/maybe_uninit/union.MaybeUninit.html "union core::mem::maybe_uninit::MaybeUninit")<T>, A>

where A: [IsAligned](trait.IsAligned.html "trait bevy::ecs::ptr::IsAligned"),

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#698-701)

#### pub unsafe fn [move\_maybe\_uninit\_field](#method.move_maybe_uninit_field)<U>( &self, f: impl [Fn](https://doc.rust-lang.org/nightly/core/ops/function/trait.Fn.html "trait core::ops::function::Fn")([\*mut T](https://doc.rust-lang.org/nightly/std/primitive.pointer.html)) -> [\*mut U](https://doc.rust-lang.org/nightly/std/primitive.pointer.html), ) -> [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, [MaybeUninit](https://doc.rust-lang.org/nightly/core/mem/maybe_uninit/union.MaybeUninit.html "union core::mem::maybe_uninit::MaybeUninit")<U>, A>
...
[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#712)

### impl<'a, T, A> [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, [MaybeUninit](https://doc.rust-lang.org/nightly/core/mem/maybe_uninit/union.MaybeUninit.html "union core::mem::maybe_uninit::MaybeUninit")<T>, A>

where A: [IsAligned](trait.IsAligned.html "trait bevy::ecs::ptr::IsAligned"),

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#722)

#### pub unsafe fn [assume\_init](#method.assume_init)(self) -> [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, T, A>

Creates a [`MovingPtr`](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr") pointing to a valid instance of `T`.

See also: [`MaybeUninit::assume_init`](https://doc.rust-lang.org/nightly/core/mem/maybe_uninit/union.MaybeUninit.html#method.assume_init "method core::mem::maybe_uninit::MaybeUninit::assume_init").
...
[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#736)

### impl<T> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'\_, T>

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#738)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")\>

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#743)

### impl<T> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'\_, T, [Unaligned](struct.Unaligned.html "struct bevy::ecs::ptr::Unaligned")\>

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#745)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")\>

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#779)

### impl<T> [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'\_, T>

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#780)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = T

The resulting type after dereferencing.

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#782)

#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'\_, T> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#789)

### impl<T> [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'\_, T>

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#791)

#### fn [deref\_mut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html#tymethod.deref_mut)(&mut self) -> &mut <[MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'\_, T> as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Mutably dereferences the value.

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#798)

### impl<T, A> [Drop](https://doc.rust-lang.org/nightly/core/ops/drop/trait.Drop.html "trait core::ops::drop::Drop") for [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'\_, T, A>

where A: [IsAligned](trait.IsAligned.html "trait bevy::ecs::ptr::IsAligned"),

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#799)
...
[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#750)

### impl<'a, T, A> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, T, A>> for [OwningPtr](struct.OwningPtr.html "struct bevy::ecs::ptr::OwningPtr")<'a, A>

where A: [IsAligned](trait.IsAligned.html "trait bevy::ecs::ptr::IsAligned"),

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#752)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, T, A>) -> [OwningPtr](struct.OwningPtr.html "struct bevy::ecs::ptr::OwningPtr")<'a, A>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#729)

### impl<T, A> [Pointer](https://doc.rust-lang.org/nightly/core/fmt/trait.Pointer.html "trait core::fmt::Pointer") for [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'\_, T, A>

where A: [IsAligned](trait.IsAligned.html "trait bevy::ecs::ptr::IsAligned"),

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#731)
...
[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#765)

### impl<'a, T> [TryFrom](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html "trait core::convert::TryFrom")<[MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, T, [Unaligned](struct.Unaligned.html "struct bevy::ecs::ptr::Unaligned")\>> for [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, T>

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#766)

#### type [Error](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html#associatedtype.Error) = [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, T, [Unaligned](struct.Unaligned.html "struct bevy::ecs::ptr::Unaligned")\>

The type returned in the event of a conversion error.

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#768)

#### fn [try\_from](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html#tymethod.try_from)( value: [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, T, [Unaligned](struct.Unaligned.html "struct bevy::ecs::ptr::Unaligned")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, T>, <[MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, T> as [TryFrom](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html "trait core::convert::TryFrom")<[MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, T, [Unaligned](struct.Unaligned.html "struct bevy::ecs::ptr::Unaligned")\>>>::[Error](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html#associatedtype.Error "type core::convert::TryFrom::Error")\>

Performs the conversion.

## Auto Trait Implementations

### impl<'a, T, A = [Aligned](struct.Aligned.html "struct bevy::ecs::ptr::Aligned")\> ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, T, A>

### impl<'a, T, A = [Aligned](struct.Aligned.html "struct bevy::ecs::ptr::Aligned")\> ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, T, A>

### impl<'a, T, A = [Aligned](struct.Aligned.html "struct bevy::ecs::ptr::Aligned")\> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, T, A>

### impl<'a, T, A> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, T, A>

### impl<'a, T, A> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, T, A>
...
### impl<'a, T, A> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, T, A>

where A: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<'a, T, A> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MovingPtr](struct.MovingPtr.html "struct bevy::ecs::ptr::MovingPtr")<'a, T, A>
