...
[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#291)
...
[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#439)

### impl<'a> [Ptr](struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'a>

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#439)

#### pub fn [to\_unaligned](#method.to_unaligned)(self) -> [Ptr](struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'a, [Unaligned](struct.Unaligned.html "struct bevy::ecs::ptr::Unaligned")\>

Removes the alignment requirement of this pointer

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#439)

### impl<A> [Ptr](struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'\_, A>

where A: [IsAligned](trait.IsAligned.html "trait bevy::ecs::ptr::IsAligned"),

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#439)

#### pub unsafe fn [byte\_offset](#method.byte_offset)(self, count: [isize](https://doc.rust-lang.org/nightly/std/primitive.isize.html)) -> [Ptr](struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'\_, A>
...
#### pub unsafe fn [byte\_add](#method.byte_add)(self, count: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [Ptr](struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'\_, A>
...
[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#810)

### impl<'a, A> [Ptr](struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'a, A>

where A: [IsAligned](trait.IsAligned.html "trait bevy::ecs::ptr::IsAligned"),

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#822)

#### pub unsafe fn [new](#method.new)(inner: [NonNull](https://doc.rust-lang.org/nightly/core/ptr/non_null/struct.NonNull.html "struct core::ptr::non_null::NonNull")<[u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)\>) -> [Ptr](struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'a, A>
...
*   The lifetime `'a` must be constrained such that this [`Ptr`](struct.Ptr.html "struct bevy::ecs::ptr::Ptr") will stay valid and nothing can mutate the pointee while this [`Ptr`](struct.Ptr.html "struct bevy::ecs::ptr::Ptr") is live except through an [`UnsafeCell`](https://doc.rust-lang.org/nightly/core/cell/struct.UnsafeCell.html "struct core::cell::UnsafeCell").

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#833)

#### pub unsafe fn [assert\_unique](#method.assert_unique)(self) -> [PtrMut](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")<'a, A>

Transforms this [`Ptr`](struct.Ptr.html "struct bevy::ecs::ptr::Ptr") into an [`PtrMut`](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut")
...
*   Another [`PtrMut`](struct.PtrMut.html "struct bevy::ecs::ptr::PtrMut") for the same [`Ptr`](struct.Ptr.html "struct bevy::ecs::ptr::Ptr") must not be created until the first is dropped.
...
[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#846)

#### pub unsafe fn [deref](#method.deref)<T>(self) -> [&'a T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)

Transforms this [`Ptr<T>`](struct.Ptr.html "struct bevy::ecs::ptr::Ptr") into a `&T` with the same lifetime

##### Safety

*   `T` must be the erased pointee type for this [`Ptr`](struct.Ptr.html "struct bevy::ecs::ptr::Ptr").
...
examples/stress\_tests/many\_components.rs ([line 53](../../../src/many_components/many_components.rs.html#53))
...
[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#857)
...
If possible, it is strongly encouraged to use [`deref`](struct.Ptr.html#method.deref "method bevy::ecs::ptr::Ptr::deref") over this function, as it retains the lifetime.

## Trait Implementations

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#289)

### impl<'a, A> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Ptr](struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'a, A>

where A: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") + [IsAligned](trait.IsAligned.html "trait bevy::ecs::ptr::IsAligned"),

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#289)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Ptr](struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'a, A>
...
### impl<'a, A> [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [Ptr](struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'a, A>

where A: [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") + [IsAligned](trait.IsAligned.html "trait bevy::ecs::ptr::IsAligned"),

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#439)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Ptr](struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'\_>
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Ptr](struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'\_, [Unaligned](struct.Unaligned.html "struct bevy::ecs::ptr::Unaligned")\>
...
[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#862)

### impl<'a, T> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[&'a T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\> for [Ptr](struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'a>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#864)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(val: [&'a T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)) -> [Ptr](struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'a>

Converts to this type from the input type.

[Source](https://docs.rs/bevy_ptr/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ptr/lib.rs.html#439)

### impl<A> [Pointer](https://doc.rust-lang.org/nightly/core/fmt/trait.Pointer.html "trait core::fmt::Pointer") for [Ptr](struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'\_, A>
...
### impl<'a, A = [Aligned](struct.Aligned.html "struct bevy::ecs::ptr::Aligned")\> ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Ptr](struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'a, A>

### impl<'a, A = [Aligned](struct.Aligned.html "struct bevy::ecs::ptr::Aligned")\> ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Ptr](struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'a, A>

### impl<'a, A> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Ptr](struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'a, A>

### impl<'a, A> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Ptr](struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'a, A>
...
### impl<'a, A> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Ptr](struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'a, A>

where A: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<'a, A> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Ptr](struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'a, A>

### impl<'a, A> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Ptr](struct.Ptr.html "struct bevy::ecs::ptr::Ptr")<'a, A>
