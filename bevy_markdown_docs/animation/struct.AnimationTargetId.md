...
[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#187)
...
`AnimationTargetId` is implemented as a [UUID](https://en.wikipedia.org/wiki/Universally_unique_identifier). When importing an armature or an animation clip, asset loaders typically use the full path name from the armature to the bone to generate these UUIDs. The ID is unique to the full path name and based only on the names. So, for example, any imported armature with a bone at the root named `Hips` will assign the same [`AnimationTargetId`](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId") to its root bone. Likewise, any imported animation clip that animates a root bone named `Hips` will reference the same [`AnimationTargetId`](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId"). Any animation is playable on any armature as long as the bone names match, which allows for easy animation retargeting.

Note that asset loaders generally use the _full_ path name to generate the [`AnimationTargetId`](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId"). Thus a bone named `Chest` directly connected to a bone named `Hips` will have a different ID from a bone named `Chest` that’s connected to a bone named `Stomach`.

## Tuple Fields

`0: [Uuid](../asset/uuid/struct.Uuid.html "struct bevy::asset::uuid::Uuid")`

## Implementations

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#1311)

### impl [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#1316)

#### pub fn [from\_names](#method.from_names)<'a>( names: impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = &'a [Name](../prelude/struct.Name.html "struct bevy::prelude::Name")\>, ) -> [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

Creates a new [`AnimationTargetId`](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId") by hashing a list of names.
...
examples/animation/animation\_masks.rs ([lines 373-375](../../src/animation_masks/animation_masks.rs.html#373-375))
...
examples/animation/animated\_transform.rs ([line 74](../../src/animated_transform/animated_transform.rs.html#74))
...
[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#1321)

#### pub fn [from\_name](#method.from_name)(name: &[Name](../prelude/struct.Name.html "struct bevy::prelude::Name")) -> [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

Creates a new [`AnimationTargetId`](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId") by hashing a single name.

##### [Examples found in repository](#scraped-examples-1)[?](../../scrape-examples-help.html)

examples/animation/eased\_motion.rs ([line 98](../../src/eased_motion/eased_motion.rs.html#98))
...
examples/animation/animated\_ui.rs ([line 43](../../src/animated_ui/animated_ui.rs.html#43))
...
examples/animation/animated\_transform.rs ([line 53](../../src/animated_transform/animated_transform.rs.html#53))
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#184)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

where [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#184)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")
...
### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#184)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#1345)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&[Name](../prelude/struct.Name.html "struct bevy::prelude::Name")\> for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#1346)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(name: &[Name](../prelude/struct.Name.html "struct bevy::prelude::Name")) -> [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#184)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#184)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#184)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#1326)

### impl<T> [FromIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html "trait core::iter::traits::collect::FromIterator")<T> for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")
...
[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#1331)

#### fn [from\_iter](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.FromIterator.html#tymethod.from_iter)<I>(iter: I) -> [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")
...
Creates a new [`AnimationTargetId`](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId") by hashing a list of strings.

Typically, this will be the path from the animation root to the animation target (e.g. bone) that is to be animated.

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#184)

### impl [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#184)

#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")
...
[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#189)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#190)
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")
...
where [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId"): 'into\_return,
...
### impl [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#184)

#### fn [cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html#tymethod.cmp)(&self, other: &[AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#184)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#184)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")\>
...
### impl [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")
...
#### fn [reflect\_owned](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#184)

#### fn [try\_into\_reflect](../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#186)
...
### impl [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#184)

#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#184)

### impl [TupleStruct](../prelude/trait.TupleStruct.html "trait bevy::prelude::TupleStruct") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")
...
### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId")
