...
[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#215)
...
By convention, asset loaders add [`AnimationTargetId`](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId") components to the descendants of an [`AnimationPlayer`](../prelude/struct.AnimationPlayer.html "struct bevy::prelude::AnimationPlayer"), as well as to the [`AnimationPlayer`](../prelude/struct.AnimationPlayer.html "struct bevy::prelude::AnimationPlayer") entity itself, but Bevy doesn’t require this in any way. So, for example, it’s entirely possible for an [`AnimationPlayer`](../prelude/struct.AnimationPlayer.html "struct bevy::prelude::AnimationPlayer") to animate a target that it isn’t an ancestor of. If you add a new bone to or delete a bone from an armature at runtime, you may want to update the [`AnimationTargetId`](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId") component as appropriate, as Bevy won’t do this automatically.

Note that each entity can only be animated by one animation player at a time. However, you can change [`AnimatedBy`](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy") components at runtime and link them to a different player.
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#213)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")

where [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
#### fn [map\_entities](../prelude/trait.Component.html#method.map_entities)<M>(this: &mut [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy"), mapper: [&mut M](https://doc.rust-lang.org/nightly/std/primitive.reference.html))
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#213)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")
...
### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#213)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#213)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#213)

### impl [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#213)

#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")
...
where [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy"): 'into\_return,
...
### impl [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")
...
[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#214)
...
### impl [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#213)

#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
### impl [TupleStruct](../prelude/trait.TupleStruct.html "trait bevy::prelude::TupleStruct") for [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")
...
### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AnimatedBy](struct.AnimatedBy.html "struct bevy::animation::AnimatedBy")
