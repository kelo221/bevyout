...
[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#105)
...
[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#217)

### impl [AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#220)

#### pub fn [curves](#method.curves)( &self, ) -> &[HashMap](../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId"), [Vec](../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[VariableCurve](../prelude/struct.VariableCurve.html "struct bevy::prelude::VariableCurve")\>, [NoOpHash](../platform/hash/struct.NoOpHash.html "struct bevy::platform::hash::NoOpHash")\>

[`VariableCurve`](../prelude/struct.VariableCurve.html "struct bevy::prelude::VariableCurve")s for each animation target. Indexed by the [`AnimationTargetId`](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId").

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#226)

#### pub fn [curves\_mut](#method.curves_mut)( &mut self, ) -> &mut [HashMap](../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId"), [Vec](../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[VariableCurve](../prelude/struct.VariableCurve.html "struct bevy::prelude::VariableCurve")\>, [NoOpHash](../platform/hash/struct.NoOpHash.html "struct bevy::platform::hash::NoOpHash")\>

Get mutable references of [`VariableCurve`](../prelude/struct.VariableCurve.html "struct bevy::prelude::VariableCurve")s for each animation target. Indexed by the [`AnimationTargetId`](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId").

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#234-237)

#### pub fn [curves\_for\_target](#method.curves_for_target)( &self, target\_id: [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[Vec](../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[VariableCurve](../prelude/struct.VariableCurve.html "struct bevy::prelude::VariableCurve")\>>

Gets the curves for a single animation target.

Returns `None` if this clip doesn’t animate the target.

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#245-248)

#### pub fn [curves\_for\_target\_mut](#method.curves_for_target_mut)( &mut self, target\_id: [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&mut [Vec](../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[VariableCurve](../prelude/struct.VariableCurve.html "struct bevy::prelude::VariableCurve")\>>

Gets mutable references of the curves for a single animation target.

Returns `None` if this clip doesn’t animate the target.

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#254)

#### pub fn [duration](#method.duration)(&self) -> [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)

Duration of the clip, represented in seconds.

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#260)

#### pub fn [set\_duration](#method.set_duration)(&mut self, duration\_sec: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html))

Set the duration of the clip in seconds.

##### [Examples found in repository](#scraped-examples)[?](../../scrape-examples-help.html)

examples/animation/animation\_events.rs ([line 71](../../src/animation_events/animation_events.rs.html#71))
...
58        Text2d::default(),
59        TextFont {
60            font_size: FontSize::Px(119.0),
61            ..default()
62        },
...
[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#284-288)

#### pub fn [add\_curve\_to\_target](#method.add_curve_to_target)( &mut self, target\_id: [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId"), curve: impl [AnimationCurve](../prelude/trait.AnimationCurve.html "trait bevy::prelude::AnimationCurve"), )

Adds an [`AnimationCurve`](../prelude/trait.AnimationCurve.html "trait bevy::prelude::AnimationCurve") that can target an entity with the given [`AnimationTargetId`](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId") component.
...
*   Each curve in the clip is sampled by first clamping the sample time to its [domain](../prelude/trait.AnimationCurve.html#tymethod.domain "method bevy::prelude::AnimationCurve::domain").
...
examples/animation/eased\_motion.rs ([lines 129-132](../../src/eased_motion/eased_motion.rs.html#129-132))
...
examples/animation/animated\_ui.rs ([lines 49-62](../../src/animated_ui/animated_ui.rs.html#49-62))
...
examples/animation/animated\_transform.rs ([lines 54-69](../../src/animated_transform/animated_transform.rs.html#54-69))
...
[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#305-309)

#### pub fn [add\_variable\_curve\_to\_target](#method.add_variable_curve_to_target)( &mut self, target\_id: [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId"), variable\_curve: [VariableCurve](../prelude/struct.VariableCurve.html "struct bevy::prelude::VariableCurve"), )

Like [`add_curve_to_target`](../prelude/struct.AnimationClip.html#method.add_curve_to_target "method bevy::prelude::AnimationClip::add_curve_to_target"), but adding a [`VariableCurve`](../prelude/struct.VariableCurve.html "struct bevy::prelude::VariableCurve") directly.

Under normal circumstances, that method is generally more convenient.

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#326)

#### pub fn [add\_event](#method.add_event)(&mut self, time: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), event: impl [AnimationEvent](trait.AnimationEvent.html "trait bevy::animation::AnimationEvent"))

Add an [`EntityEvent`](../prelude/trait.EntityEvent.html "trait bevy::prelude::EntityEvent") with no [`AnimationTargetId`](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId").

The `event` will be cloned and triggered on the [`AnimationPlayer`](../prelude/struct.AnimationPlayer.html "struct bevy::prelude::AnimationPlayer") entity once the `time` (in seconds) is reached in the animation.

See also [`add_event_to_target`](../prelude/struct.AnimationClip.html#method.add_event_to_target "method bevy::prelude::AnimationClip::add_event_to_target").

##### [Examples found in repository](#scraped-examples-2)[?](../../scrape-examples-help.html)

examples/animation/animation\_events.rs ([lines 74-80](../../src/animation_events/animation_events.rs.html#74-80))
...
[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#341-346)

#### pub fn [add\_event\_to\_target](#method.add_event_to_target)( &mut self, target\_id: [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId"), time: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), event: impl [AnimationEvent](trait.AnimationEvent.html "trait bevy::animation::AnimationEvent"), )

Add an [`EntityEvent`](../prelude/trait.EntityEvent.html "trait bevy::prelude::EntityEvent") with an [`AnimationTargetId`](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId").
...
Use [`add_event`](../prelude/struct.AnimationClip.html#method.add_event "method bevy::prelude::AnimationClip::add_event") instead if you don’t have a specific target.

##### [Examples found in repository](#scraped-examples-3)[?](../../scrape-examples-help.html)

examples/animation/animated\_mesh\_events.rs ([line 170](../../src/animated_mesh_events/animated_mesh_events.rs.html#170))
...
examples/gltf/gltf\_extension\_animation\_graph.rs ([lines 208-212](../../src/gltf_extension_animation_graph/gltf_extension_animation_graph.rs.html#208-212))
...
[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#382-387)

#### pub fn [sample\_clamped](#method.sample_clamped)<P>( &self, animatable\_property: P, target: [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId"), time: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<P as [AnimatableProperty](../prelude/trait.AnimatableProperty.html "trait bevy::prelude::AnimatableProperty")\>::[Property](../prelude/trait.AnimatableProperty.html#associatedtype.Property "type bevy::prelude::AnimatableProperty::Property")\>

where P: [AnimatableProperty](../prelude/trait.AnimatableProperty.html "trait bevy::prelude::AnimatableProperty"),

Samples an [`AnimatableProperty`](../prelude/trait.AnimatableProperty.html "trait bevy::prelude::AnimatableProperty") of a specific [`AnimationTargetId`](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId").

See [`crate::morph::WeightsCurveSample`](../prelude/struct.WeightsCurveSample.html "struct bevy::prelude::WeightsCurveSample") if you want to sample [`crate::morph::WeightsCurve`](../prelude/struct.WeightsCurve.html "struct bevy::prelude::WeightsCurve").
...
[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#414-418)

#### pub fn [add\_event\_fn](#method.add_event_fn)( &mut self, time: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), func: impl [Fn](https://doc.rust-lang.org/nightly/core/ops/function/trait.Fn.html "trait core::ops::function::Fn")(&mut [Commands](../prelude/struct.Commands.html "struct bevy::prelude::Commands")<'\_, '\_>, [Entity](../prelude/struct.Entity.html "struct bevy::prelude::Entity"), [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static, )

Add an event function with no [`AnimationTargetId`](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId") to this [`AnimationClip`](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip").

The `func` will trigger on the [`AnimationPlayer`](../prelude/struct.AnimationPlayer.html "struct bevy::prelude::AnimationPlayer") entity once the `time` (in seconds) is reached in the animation.

For a simpler [`EntityEvent`](../prelude/trait.EntityEvent.html "trait bevy::prelude::EntityEvent")\-based alternative, see [`AnimationClip::add_event`](../prelude/struct.AnimationClip.html#method.add_event "method bevy::prelude::AnimationClip::add_event"). See also [`add_event_to_target`](../prelude/struct.AnimationClip.html#method.add_event_to_target "method bevy::prelude::AnimationClip::add_event_to_target").
...
[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#437-442)

#### pub fn [add\_event\_fn\_to\_target](#method.add_event_fn_to_target)( &mut self, target\_id: [AnimationTargetId](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId"), time: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), func: impl [Fn](https://doc.rust-lang.org/nightly/core/ops/function/trait.Fn.html "trait core::ops::function::Fn")(&mut [Commands](../prelude/struct.Commands.html "struct bevy::prelude::Commands")<'\_, '\_>, [Entity](../prelude/struct.Entity.html "struct bevy::prelude::Entity"), [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static, )

Add an event function with an [`AnimationTargetId`](struct.AnimationTargetId.html "struct bevy::animation::AnimationTargetId").

The `func` will trigger on the entity matching the target once the `time` (in seconds) is reached in the animation.

For a simpler [`EntityEvent`](../prelude/trait.EntityEvent.html "trait bevy::prelude::EntityEvent")\-based alternative, see [`AnimationClip::add_event_to_target`](../prelude/struct.AnimationClip.html#method.add_event_to_target "method bevy::prelude::AnimationClip::add_event_to_target"). Use [`add_event`](../prelude/struct.AnimationClip.html#method.add_event "method bevy::prelude::AnimationClip::add_event") instead if you don’t have a specific target.
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#103)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#103)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#103)

### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#103)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#103)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")
...
where [AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip"): 'into\_return,
...
### impl [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")
...
#### fn [reflect\_owned](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#103)

#### fn [try\_into\_reflect](../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/lib.rs.html#104)
...
#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")
...
### impl [VisitAssetDependencies](../asset/trait.VisitAssetDependencies.html "trait bevy::asset::VisitAssetDependencies") for [AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AnimationClip](../prelude/struct.AnimationClip.html "struct bevy::prelude::AnimationClip")
