...
# Enum WideKeyframeCurveError 

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/gltf_curves.rs.html#325)
...
`values_given: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)`

The number of values given.

`divisor: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)`

The number that `values_given` was supposed to be divisible by.

### CoreError([ChunkedUnevenCoreError](../../prelude/cores/enum.ChunkedUnevenCoreError.html "enum bevy::prelude::cores::ChunkedUnevenCoreError"))
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [WideKeyframeCurveError](enum.WideKeyframeCurveError.html "enum bevy::animation::gltf_curves::WideKeyframeCurveError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [WideKeyframeCurveError](enum.WideKeyframeCurveError.html "enum bevy::animation::gltf_curves::WideKeyframeCurveError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [WideKeyframeCurveError](enum.WideKeyframeCurveError.html "enum bevy::animation::gltf_curves::WideKeyframeCurveError")
...
### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[ChunkedUnevenCoreError](../../prelude/cores/enum.ChunkedUnevenCoreError.html "enum bevy::prelude::cores::ChunkedUnevenCoreError")\> for [WideKeyframeCurveError](enum.WideKeyframeCurveError.html "enum bevy::animation::gltf_curves::WideKeyframeCurveError")

[Source](https://docs.rs/bevy_animation/0.19.0/x86_64-unknown-linux-gnu/src/bevy_animation/gltf_curves.rs.html#323)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(source: [ChunkedUnevenCoreError](../../prelude/cores/enum.ChunkedUnevenCoreError.html "enum bevy::prelude::cores::ChunkedUnevenCoreError")) -> [WideKeyframeCurveError](enum.WideKeyframeCurveError.html "enum bevy::animation::gltf_curves::WideKeyframeCurveError")

Converts to this type from the input type.

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [WideKeyframeCurveError](enum.WideKeyframeCurveError.html "enum bevy::animation::gltf_curves::WideKeyframeCurveError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [WideKeyframeCurveError](enum.WideKeyframeCurveError.html "enum bevy::animation::gltf_curves::WideKeyframeCurveError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [WideKeyframeCurveError](enum.WideKeyframeCurveError.html "enum bevy::animation::gltf_curves::WideKeyframeCurveError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [WideKeyframeCurveError](enum.WideKeyframeCurveError.html "enum bevy::animation::gltf_curves::WideKeyframeCurveError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [WideKeyframeCurveError](enum.WideKeyframeCurveError.html "enum bevy::animation::gltf_curves::WideKeyframeCurveError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [WideKeyframeCurveError](enum.WideKeyframeCurveError.html "enum bevy::animation::gltf_curves::WideKeyframeCurveError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [WideKeyframeCurveError](enum.WideKeyframeCurveError.html "enum bevy::animation::gltf_curves::WideKeyframeCurveError")
