...
[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/assets.rs.html#223)
...
`joints: [Vec](../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[GltfNode](struct.GltfNode.html "struct bevy::gltf::GltfNode")>>`

All the nodes that form this skin.

`inverse_bind_matrices: [Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[SkinnedMeshInverseBindposes](../mesh/skinning/struct.SkinnedMeshInverseBindposes.html "struct bevy::mesh::skinning::SkinnedMeshInverseBindposes")>`
...
[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/assets.rs.html#236)

### impl [GltfSkin](struct.GltfSkin.html "struct bevy::gltf::GltfSkin")

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/assets.rs.html#238-243)

#### pub fn [new](#method.new)( skin: &[Skin](https://docs.rs/gltf/1.4.1/x86_64-unknown-linux-gnu/gltf/skin/struct.Skin.html "struct gltf::skin::Skin")<'\_>, joints: [Vec](../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[GltfNode](struct.GltfNode.html "struct bevy::gltf::GltfNode")\>>, inverse\_bind\_matrices: [Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[SkinnedMeshInverseBindposes](../mesh/skinning/struct.SkinnedMeshInverseBindposes.html "struct bevy::mesh::skinning::SkinnedMeshInverseBindposes")\>, extras: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[GltfExtras](../prelude/struct.GltfExtras.html "struct bevy::prelude::GltfExtras")\>, ) -> [GltfSkin](struct.GltfSkin.html "struct bevy::gltf::GltfSkin")

Create a skin extracting name and index from glTF def

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/assets.rs.html#258)
...
### impl [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset") for [GltfSkin](struct.GltfSkin.html "struct bevy::gltf::GltfSkin")

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/assets.rs.html#222)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [GltfSkin](struct.GltfSkin.html "struct bevy::gltf::GltfSkin")

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/assets.rs.html#222)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [GltfSkin](struct.GltfSkin.html "struct bevy::gltf::GltfSkin")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [GltfSkin](struct.GltfSkin.html "struct bevy::gltf::GltfSkin")
...
### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [GltfSkin](struct.GltfSkin.html "struct bevy::gltf::GltfSkin")
...
### impl [VisitAssetDependencies](../asset/trait.VisitAssetDependencies.html "trait bevy::asset::VisitAssetDependencies") for [GltfSkin](struct.GltfSkin.html "struct bevy::gltf::GltfSkin")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [GltfSkin](struct.GltfSkin.html "struct bevy::gltf::GltfSkin")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [GltfSkin](struct.GltfSkin.html "struct bevy::gltf::GltfSkin")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [GltfSkin](struct.GltfSkin.html "struct bevy::gltf::GltfSkin")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [GltfSkin](struct.GltfSkin.html "struct bevy::gltf::GltfSkin")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [GltfSkin](struct.GltfSkin.html "struct bevy::gltf::GltfSkin")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [GltfSkin](struct.GltfSkin.html "struct bevy::gltf::GltfSkin")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [GltfSkin](struct.GltfSkin.html "struct bevy::gltf::GltfSkin")
