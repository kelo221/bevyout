...
# Struct DefaultGltfImageSampler 

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/lib.rs.html#174)
...
[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/lib.rs.html#176)

### impl [DefaultGltfImageSampler](struct.DefaultGltfImageSampler.html "struct bevy::gltf::DefaultGltfImageSampler")

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/lib.rs.html#178)

#### pub fn [new](#method.new)(descriptor: &[ImageSamplerDescriptor](../image/struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")) -> [DefaultGltfImageSampler](struct.DefaultGltfImageSampler.html "struct bevy::gltf::DefaultGltfImageSampler")

Creates a new [`DefaultGltfImageSampler`](struct.DefaultGltfImageSampler.html "struct bevy::gltf::DefaultGltfImageSampler").

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/lib.rs.html#183)

#### pub fn [get](#method.get)(&self) -> [ImageSamplerDescriptor](../image/struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")

Returns the current default [`ImageSamplerDescriptor`](../image/struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor").

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/lib.rs.html#190)

#### pub fn [get\_internal](#method.get_internal)(&self) -> [Arc](../platform/sync/struct.Arc.html "struct bevy::platform::sync::Arc")<[Mutex](../platform/sync/struct.Mutex.html "struct bevy::platform::sync::Mutex")<[ImageSamplerDescriptor](../image/struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor")\>> [ⓘ](#)

Makes a clone of internal [`Arc`](../platform/sync/struct.Arc.html "struct bevy::platform::sync::Arc") pointer.

Intended only to be used by code with no access to ECS.

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/lib.rs.html#198)

#### pub fn [set](#method.set)(&self, descriptor: &[ImageSamplerDescriptor](../image/struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor"))

Replaces default [`ImageSamplerDescriptor`](../image/struct.ImageSamplerDescriptor.html "struct bevy::image::ImageSamplerDescriptor").
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [DefaultGltfImageSampler](struct.DefaultGltfImageSampler.html "struct bevy::gltf::DefaultGltfImageSampler")

where [DefaultGltfImageSampler](struct.DefaultGltfImageSampler.html "struct bevy::gltf::DefaultGltfImageSampler"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [DefaultGltfImageSampler](struct.DefaultGltfImageSampler.html "struct bevy::gltf::DefaultGltfImageSampler")

where [DefaultGltfImageSampler](struct.DefaultGltfImageSampler.html "struct bevy::gltf::DefaultGltfImageSampler"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DefaultGltfImageSampler](struct.DefaultGltfImageSampler.html "struct bevy::gltf::DefaultGltfImageSampler")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DefaultGltfImageSampler](struct.DefaultGltfImageSampler.html "struct bevy::gltf::DefaultGltfImageSampler")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DefaultGltfImageSampler](struct.DefaultGltfImageSampler.html "struct bevy::gltf::DefaultGltfImageSampler")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DefaultGltfImageSampler](struct.DefaultGltfImageSampler.html "struct bevy::gltf::DefaultGltfImageSampler")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DefaultGltfImageSampler](struct.DefaultGltfImageSampler.html "struct bevy::gltf::DefaultGltfImageSampler")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [DefaultGltfImageSampler](struct.DefaultGltfImageSampler.html "struct bevy::gltf::DefaultGltfImageSampler")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DefaultGltfImageSampler](struct.DefaultGltfImageSampler.html "struct bevy::gltf::DefaultGltfImageSampler")
