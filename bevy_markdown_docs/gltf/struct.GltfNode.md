...
[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/assets.rs.html#98)
...
`children: [Vec](../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[GltfNode](struct.GltfNode.html "struct bevy::gltf::GltfNode")>>`

Direct children of the node.

`mesh: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[GltfMesh](struct.GltfMesh.html "struct bevy::gltf::GltfMesh")>>`

Mesh of the node.

`skin: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[GltfSkin](struct.GltfSkin.html "struct bevy::gltf::GltfSkin")>>`

Skin of the node.

`transform: [Transform](../prelude/struct.Transform.html "struct bevy::prelude::Transform")`

Local transform.

`is_animation_root: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

Available on **crate feature `bevy_animation`** only.

Is this node used as an animation root

`extras: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[GltfExtras](../prelude/struct.GltfExtras.html "struct bevy::prelude::GltfExtras")>`

Additional data.

## Implementations

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/assets.rs.html#118)

### impl [GltfNode](struct.GltfNode.html "struct bevy::gltf::GltfNode")

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/assets.rs.html#120-127)

#### pub fn [new](#method.new)( node: &[Node](https://docs.rs/gltf/1.4.1/x86_64-unknown-linux-gnu/gltf/scene/struct.Node.html "struct gltf::scene::Node")<'\_>, children: [Vec](../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[GltfNode](struct.GltfNode.html "struct bevy::gltf::GltfNode")\>>, mesh: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[GltfMesh](struct.GltfMesh.html "struct bevy::gltf::GltfMesh")\>>, transform: [Transform](../prelude/struct.Transform.html "struct bevy::prelude::Transform"), skin: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[GltfSkin](struct.GltfSkin.html "struct bevy::gltf::GltfSkin")\>>, extras: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[GltfExtras](../prelude/struct.GltfExtras.html "struct bevy::prelude::GltfExtras")\>, ) -> [GltfNode](struct.GltfNode.html "struct bevy::gltf::GltfNode")

Create a node extracting name and index from glTF def

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/assets.rs.html#147)

#### pub fn [with\_animation\_root](#method.with_animation_root)(self, is\_animation\_root: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)) -> [GltfNode](struct.GltfNode.html "struct bevy::gltf::GltfNode")

Available on **crate feature `bevy_animation`** only.

Create a node with animation root mark

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/assets.rs.html#155)

#### pub fn [asset\_label](#method.asset_label)(&self) -> [GltfAssetLabel](../prelude/enum.GltfAssetLabel.html "enum bevy::prelude::GltfAssetLabel")
...
### impl [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset") for [GltfNode](struct.GltfNode.html "struct bevy::gltf::GltfNode")

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/assets.rs.html#97)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [GltfNode](struct.GltfNode.html "struct bevy::gltf::GltfNode")

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/assets.rs.html#97)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [GltfNode](struct.GltfNode.html "struct bevy::gltf::GltfNode")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [GltfNode](struct.GltfNode.html "struct bevy::gltf::GltfNode")
...
### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [GltfNode](struct.GltfNode.html "struct bevy::gltf::GltfNode")
...
### impl [VisitAssetDependencies](../asset/trait.VisitAssetDependencies.html "trait bevy::asset::VisitAssetDependencies") for [GltfNode](struct.GltfNode.html "struct bevy::gltf::GltfNode")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [GltfNode](struct.GltfNode.html "struct bevy::gltf::GltfNode")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [GltfNode](struct.GltfNode.html "struct bevy::gltf::GltfNode")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [GltfNode](struct.GltfNode.html "struct bevy::gltf::GltfNode")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [GltfNode](struct.GltfNode.html "struct bevy::gltf::GltfNode")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [GltfNode](struct.GltfNode.html "struct bevy::gltf::GltfNode")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [GltfNode](struct.GltfNode.html "struct bevy::gltf::GltfNode")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [GltfNode](struct.GltfNode.html "struct bevy::gltf::GltfNode")
