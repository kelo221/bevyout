...
# Enum ConvertAttributeError 

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/vertex_attributes.rs.html#264)
...
### WrongFormat([String](../../prelude/struct.String.html "struct bevy::prelude::String"), [VertexFormat](../../mesh/enum.VertexFormat.html "enum bevy::mesh::VertexFormat"), [String](../../prelude/struct.String.html "struct bevy::prelude::String"), [VertexFormat](../../mesh/enum.VertexFormat.html "enum bevy::mesh::VertexFormat"))

The loaded format ws different than the attribute’s intended format. Such as if a `Float32x3` was loaded as a `Float32x2`.

### AccessFailed([AccessFailed](enum.AccessFailed.html "enum bevy::gltf::vertex_attributes::AccessFailed"), [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html))

Fetching values from the glTF Accessor failed

### UnknownName([String](../../prelude/struct.String.html "struct bevy::prelude::String"))

A vertex attribute name was not one of the gltf crate’s well-known attributes, nor was it registered by a user as a custom attribute. Therefore it is unknown.

## Trait Implementations

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/vertex_attributes.rs.html#263)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ConvertAttributeError](enum.ConvertAttributeError.html "enum bevy::gltf::vertex_attributes::ConvertAttributeError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [ConvertAttributeError](enum.ConvertAttributeError.html "enum bevy::gltf::vertex_attributes::ConvertAttributeError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [ConvertAttributeError](enum.ConvertAttributeError.html "enum bevy::gltf::vertex_attributes::ConvertAttributeError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ConvertAttributeError](enum.ConvertAttributeError.html "enum bevy::gltf::vertex_attributes::ConvertAttributeError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ConvertAttributeError](enum.ConvertAttributeError.html "enum bevy::gltf::vertex_attributes::ConvertAttributeError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ConvertAttributeError](enum.ConvertAttributeError.html "enum bevy::gltf::vertex_attributes::ConvertAttributeError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ConvertAttributeError](enum.ConvertAttributeError.html "enum bevy::gltf::vertex_attributes::ConvertAttributeError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ConvertAttributeError](enum.ConvertAttributeError.html "enum bevy::gltf::vertex_attributes::ConvertAttributeError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ConvertAttributeError](enum.ConvertAttributeError.html "enum bevy::gltf::vertex_attributes::ConvertAttributeError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ConvertAttributeError](enum.ConvertAttributeError.html "enum bevy::gltf::vertex_attributes::ConvertAttributeError")
