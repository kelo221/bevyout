...
[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/vertex_attributes.rs.html#32)
...
Accessing the data failed because of an issue like a mismatch in stride, or a buffer view slice failing.
...
[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/vertex_attributes.rs.html#31)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [AccessFailed](enum.AccessFailed.html "enum bevy::gltf::vertex_attributes::AccessFailed")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [AccessFailed](enum.AccessFailed.html "enum bevy::gltf::vertex_attributes::AccessFailed")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [AccessFailed](enum.AccessFailed.html "enum bevy::gltf::vertex_attributes::AccessFailed")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AccessFailed](enum.AccessFailed.html "enum bevy::gltf::vertex_attributes::AccessFailed")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AccessFailed](enum.AccessFailed.html "enum bevy::gltf::vertex_attributes::AccessFailed")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AccessFailed](enum.AccessFailed.html "enum bevy::gltf::vertex_attributes::AccessFailed")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AccessFailed](enum.AccessFailed.html "enum bevy::gltf::vertex_attributes::AccessFailed")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AccessFailed](enum.AccessFailed.html "enum bevy::gltf::vertex_attributes::AccessFailed")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AccessFailed](enum.AccessFailed.html "enum bevy::gltf::vertex_attributes::AccessFailed")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AccessFailed](enum.AccessFailed.html "enum bevy::gltf::vertex_attributes::AccessFailed")
