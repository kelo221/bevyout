...
[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/assets.rs.html#164)
...
`parent_mesh_index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)`

Index of the parent [`GltfMesh`](struct.GltfMesh.html "struct bevy::gltf::GltfMesh") of this primitive
...
`mesh: [Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Mesh](../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")>`

Topology to be rendered.

`material: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[GltfMaterial](struct.GltfMaterial.html "struct bevy::gltf::GltfMaterial")>>`
...
`material_extras: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[GltfExtras](../prelude/struct.GltfExtras.html "struct bevy::prelude::GltfExtras")>`

Additional data of the `material`.

## Implementations

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/assets.rs.html#181)

### impl [GltfPrimitive](struct.GltfPrimitive.html "struct bevy::gltf::GltfPrimitive")

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/assets.rs.html#183-190)

#### pub fn [new](#method.new)( gltf\_mesh: &[Mesh](gltf/struct.Mesh.html "struct bevy::gltf::gltf::Mesh")<'\_>, gltf\_primitive: &[Primitive](gltf/struct.Primitive.html "struct bevy::gltf::gltf::Primitive")<'\_>, mesh: [Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[Mesh](../prelude/struct.Mesh.html "struct bevy::prelude::Mesh")\>, material: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Handle](../prelude/enum.Handle.html "enum bevy::prelude::Handle")<[GltfMaterial](struct.GltfMaterial.html "struct bevy::gltf::GltfMaterial")\>>, extras: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[GltfExtras](../prelude/struct.GltfExtras.html "struct bevy::prelude::GltfExtras")\>, material\_extras: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[GltfExtras](../prelude/struct.GltfExtras.html "struct bevy::prelude::GltfExtras")\>, ) -> [GltfPrimitive](struct.GltfPrimitive.html "struct bevy::gltf::GltfPrimitive")

Create a primitive extracting name and index from glTF def

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/assets.rs.html#210)
...
Subasset label for this primitive within its parent [`GltfMesh`](struct.GltfMesh.html "struct bevy::gltf::GltfMesh") within the gLTF parent asset.

## Trait Implementations

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/assets.rs.html#163)

### impl [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset") for [GltfPrimitive](struct.GltfPrimitive.html "struct bevy::gltf::GltfPrimitive")

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/assets.rs.html#163)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [GltfPrimitive](struct.GltfPrimitive.html "struct bevy::gltf::GltfPrimitive")

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/assets.rs.html#163)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [GltfPrimitive](struct.GltfPrimitive.html "struct bevy::gltf::GltfPrimitive")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [GltfPrimitive](struct.GltfPrimitive.html "struct bevy::gltf::GltfPrimitive")
...
### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [GltfPrimitive](struct.GltfPrimitive.html "struct bevy::gltf::GltfPrimitive")
...
### impl [VisitAssetDependencies](../asset/trait.VisitAssetDependencies.html "trait bevy::asset::VisitAssetDependencies") for [GltfPrimitive](struct.GltfPrimitive.html "struct bevy::gltf::GltfPrimitive")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [GltfPrimitive](struct.GltfPrimitive.html "struct bevy::gltf::GltfPrimitive")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [GltfPrimitive](struct.GltfPrimitive.html "struct bevy::gltf::GltfPrimitive")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [GltfPrimitive](struct.GltfPrimitive.html "struct bevy::gltf::GltfPrimitive")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [GltfPrimitive](struct.GltfPrimitive.html "struct bevy::gltf::GltfPrimitive")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [GltfPrimitive](struct.GltfPrimitive.html "struct bevy::gltf::GltfPrimitive")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [GltfPrimitive](struct.GltfPrimitive.html "struct bevy::gltf::GltfPrimitive")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [GltfPrimitive](struct.GltfPrimitive.html "struct bevy::gltf::GltfPrimitive")
