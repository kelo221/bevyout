[bevy](../../index.html)::[gltf](../index.html)::[convert\_coordinates](index.html)

# Struct GltfConvertCoordinates 

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/convert_coordinates.rs.html#64)
...
Options for converting scenes and assets from glTF’s [standard coordinate system](https://registry.khronos.org/glTF/specs/2.0/glTF-2.0.html#coordinate-system-and-units) (+Z forward) to Bevy’s coordinate system (-Z forward).
...
Cameras and lights are an exception - they already use Bevy’s coordinate system. This means cameras and lights will match Bevy’s forward even if conversion is disabled.

If a glTF file uses the standard coordinate system, then the conversion options will behave like so:

*   `rotate_scene_entity` will make the glTF’s scene forward align with the [`Transform::forward`](../../prelude/struct.Transform.html#method.forward "method bevy::prelude::Transform::forward") of the entity with the [`WorldInstance`](../../world_serialization/struct.WorldInstance.html "struct bevy::world_serialization::WorldInstance") component.
*   `rotate_meshes` will do the same for entities with a `Mesh3d` component.

Other entities in the scene are not converted, so their forward may not match `Transform::forward`. In particular, the entities that correspond to glTF nodes are not converted.

## Fields

`rotate_scene_entity: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

If true, convert scenes by rotating the top-level transform of the scene entity. This will ensure that [`Transform::forward`](../../prelude/struct.Transform.html#method.forward "method bevy::prelude::Transform::forward") of the “root” entity (the one with [`WorldInstance`](../../world_serialization/struct.WorldInstance.html "struct bevy::world_serialization::WorldInstance")) aligns with the “forward” of the glTF scene.

The scene entity is created by the glTF loader. Its parent is the entity with the `SceneInstance` component, and its children are the root nodes of the glTF scene.

This option only changes the transform of the scene entity. It does not directly change the transforms of node entities - it only changes them indirectly through transform inheritance.

`rotate_meshes: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

If true, convert mesh assets and skinned mesh bind poses.

This option only changes mesh assets and the transforms of entities that instance meshes through [`Mesh3d`](../../prelude/struct.Mesh3d.html "struct bevy::prelude::Mesh3d").

## Trait Implementations

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/convert_coordinates.rs.html#63)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [GltfConvertCoordinates](struct.GltfConvertCoordinates.html "struct bevy::gltf::convert_coordinates::GltfConvertCoordinates")

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/convert_coordinates.rs.html#63)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [GltfConvertCoordinates](struct.GltfConvertCoordinates.html "struct bevy::gltf::convert_coordinates::GltfConvertCoordinates")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [GltfConvertCoordinates](struct.GltfConvertCoordinates.html "struct bevy::gltf::convert_coordinates::GltfConvertCoordinates")

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/convert_coordinates.rs.html#63)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [GltfConvertCoordinates](struct.GltfConvertCoordinates.html "struct bevy::gltf::convert_coordinates::GltfConvertCoordinates")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [GltfConvertCoordinates](struct.GltfConvertCoordinates.html "struct bevy::gltf::convert_coordinates::GltfConvertCoordinates")

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/convert_coordinates.rs.html#63)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [GltfConvertCoordinates](struct.GltfConvertCoordinates.html "struct bevy::gltf::convert_coordinates::GltfConvertCoordinates")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/convert_coordinates.rs.html#63)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [GltfConvertCoordinates](struct.GltfConvertCoordinates.html "struct bevy::gltf::convert_coordinates::GltfConvertCoordinates")

[Source](https://docs.rs/bevy_gltf/0.19.0/x86_64-unknown-linux-gnu/src/bevy_gltf/convert_coordinates.rs.html#63)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[GltfConvertCoordinates](struct.GltfConvertCoordinates.html "struct bevy::gltf::convert_coordinates::GltfConvertCoordinates"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [GltfConvertCoordinates](struct.GltfConvertCoordinates.html "struct bevy::gltf::convert_coordinates::GltfConvertCoordinates")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [GltfConvertCoordinates](struct.GltfConvertCoordinates.html "struct bevy::gltf::convert_coordinates::GltfConvertCoordinates")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [GltfConvertCoordinates](struct.GltfConvertCoordinates.html "struct bevy::gltf::convert_coordinates::GltfConvertCoordinates")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [GltfConvertCoordinates](struct.GltfConvertCoordinates.html "struct bevy::gltf::convert_coordinates::GltfConvertCoordinates")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [GltfConvertCoordinates](struct.GltfConvertCoordinates.html "struct bevy::gltf::convert_coordinates::GltfConvertCoordinates")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [GltfConvertCoordinates](struct.GltfConvertCoordinates.html "struct bevy::gltf::convert_coordinates::GltfConvertCoordinates")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [GltfConvertCoordinates](struct.GltfConvertCoordinates.html "struct bevy::gltf::convert_coordinates::GltfConvertCoordinates")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [GltfConvertCoordinates](struct.GltfConvertCoordinates.html "struct bevy::gltf::convert_coordinates::GltfConvertCoordinates")
