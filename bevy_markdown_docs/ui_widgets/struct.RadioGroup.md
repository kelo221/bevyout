...
[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/radio.rs.html#42)
...
The [`RadioGroup`](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup") component does not have any state itself, and makes no assumptions about what, if any, value is associated with each radio button, or what Rust type that value might be. Instead, the output of the group is a [`ValueChange`](struct.ValueChange.html "struct bevy::ui_widgets::ValueChange") event whose payload is the entity id of the selected button. This event is emitted whenever a radio button is clicked, or when using the arrow keys while the radio group is focused. The app can then derive the selected value from this using app-specific means, such as accessing a component on the individual buttons.

The [`RadioGroup`](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup") doesn’t actually set the [`Checked`](../ui/struct.Checked.html "struct bevy::ui::Checked") states directly, that is presumed to happen by the app or via some external data-binding scheme. Typically, each button would be associated with a particular constant value, and would be checked whenever that value is equal to the group’s value. This also means that as long as each button’s associated value is unique within the group, it should never be the case that more than one button is selected at a time.

## Trait Implementations

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/radio.rs.html#38)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/radio.rs.html#38)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")

where [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/radio.rs.html#38)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")
...
### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/radio.rs.html#40)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/radio.rs.html#40)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/radio.rs.html#40)

### impl [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/radio.rs.html#40)

#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")
...
where [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup"): 'into\_return,
...
### impl [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")
...
#### fn [reflect\_owned](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/radio.rs.html#40)

#### fn [try\_into\_reflect](../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
### impl [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/radio.rs.html#40)

#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Struct](../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")
...
### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RadioGroup](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup")
