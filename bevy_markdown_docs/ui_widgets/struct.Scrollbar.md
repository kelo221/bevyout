...
[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/scrollbar.rs.html#69)
...
Unlike sliders, scrollbars don’t have an [`AccessibilityNode`](../a11y/struct.AccessibilityNode.html "struct bevy::a11y::AccessibilityNode") component, nor can they have keyboard focus. This is because scrollbars are usually used in conjunction with a scrollable container, which is itself accessible and focusable. This also means that scrollbars don’t accept keyboard events, which is also the responsibility of the scrollable container.

Scrollbars don’t emit notification events; instead they modify the scroll position of the target entity directly.

A scrollbar can have any number of child entities, but one entity must be the scrollbar thumb, which is marked with the [`ScrollbarThumb`](struct.ScrollbarThumb.html "struct bevy::ui_widgets::ScrollbarThumb") component. Other children are ignored. The core scrollbar will directly update the position and size of this entity; the application is free to set any other style properties as desired.

The application is free to position the scrollbars relative to the scrolling container however it wants: it can overlay them on top of the scrolling content, or use a grid layout to displace the content to make room for the scrollbars.

## Fields

`target: [Entity](../prelude/struct.Entity.html "struct bevy::prelude::Entity")`

Entity being scrolled.

`orientation: [ControlOrientation](enum.ControlOrientation.html "enum bevy::ui_widgets::ControlOrientation")`

Whether the scrollbar is vertical or horizontal.

`min_thumb_length: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Minimum length of the scrollbar thumb, in pixel units, in the direction parallel to the main scrollbar axis. The scrollbar will resize the thumb entity based on the proportion of visible size to content size, but no smaller than this. This prevents the thumb from disappearing in cases where the ratio of content size to visible size is large.

## Implementations

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/scrollbar.rs.html#111)

### impl [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/scrollbar.rs.html#119)

#### pub fn [new](#method.new)( target: [Entity](../prelude/struct.Entity.html "struct bevy::prelude::Entity"), orientation: [ControlOrientation](enum.ControlOrientation.html "enum bevy::ui_widgets::ControlOrientation"), min\_thumb\_length: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html), ) -> [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/scrollbar.rs.html#67)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")

where [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")
...
### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/scrollbar.rs.html#67)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/scrollbar.rs.html#67)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/scrollbar.rs.html#67)

### impl [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/scrollbar.rs.html#67)

#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")\>
...
### impl [FromTemplate](../prelude/trait.FromTemplate.html "trait bevy::prelude::FromTemplate") for [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/scrollbar.rs.html#67)

#### type [Template](../prelude/trait.FromTemplate.html#associatedtype.Template) = [ScrollbarTemplate](struct.ScrollbarTemplate.html "struct bevy::ui_widgets::ScrollbarTemplate")

The [`Template`](../prelude/trait.Template.html "trait bevy::prelude::Template") for this type.

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/scrollbar.rs.html#67)

### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")
...
where [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar"): 'into\_return,
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/scrollbar.rs.html#67)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")
...
#### fn [reflect\_owned](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/scrollbar.rs.html#67)

#### fn [try\_into\_reflect](../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
### impl [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/scrollbar.rs.html#67)

#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
### impl [Struct](../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/scrollbar.rs.html#67)

### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")
...
### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Scrollbar](struct.Scrollbar.html "struct bevy::ui_widgets::Scrollbar")
