...
[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/slider.rs.html#105)
...
You can also control the slider remotely by triggering a [`SetSliderValue`](struct.SetSliderValue.html "struct bevy::ui_widgets::SetSliderValue") event on it. This can be useful in a console environment for controlling the value gamepad inputs.

Typically a slider will contain entities representing the “track” and “thumb” elements. The core slider makes no assumptions about the hierarchical structure of these elements, but expects that the thumb will be marked with a [`SliderThumb`](struct.SliderThumb.html "struct bevy::ui_widgets::SliderThumb") component.
...
`track_click: [TrackClick](enum.TrackClick.html "enum bevy::ui_widgets::TrackClick")`

Set the track-clicking behavior for this slider.

`orientation: [SliderOrientation](enum.SliderOrientation.html "enum bevy::ui_widgets::SliderOrientation")`

Set the slider orientation. Defaults to auto-detection based on dimensions.

## Trait Implementations

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/slider.rs.html#95)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/slider.rs.html#95)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")

where [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

**Required Components**: [`AccessibilityNode`](../a11y/struct.AccessibilityNode.html "struct bevy::a11y::AccessibilityNode"), [`SliderDragState`](struct.SliderDragState.html "struct bevy::ui_widgets::SliderDragState"), [`SliderValue`](struct.SliderValue.html "struct bevy::ui_widgets::SliderValue"), [`SliderRange`](struct.SliderRange.html "struct bevy::ui_widgets::SliderRange"), [`SliderStep`](struct.SliderStep.html "struct bevy::ui_widgets::SliderStep").
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/slider.rs.html#95)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")
...
### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/slider.rs.html#103)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/slider.rs.html#103)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Slider](struct.Slider.html "struct bevy::ui_widgets::Slider") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/slider.rs.html#103)

### impl [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/slider.rs.html#103)

#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")
...
where [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider"): 'into\_return,
...
### impl [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")
...
#### fn [reflect\_owned](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/slider.rs.html#103)

#### fn [try\_into\_reflect](../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
### impl [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/slider.rs.html#103)

#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Struct](../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")
...
### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Slider](struct.Slider.html "struct bevy::ui_widgets::Slider")
