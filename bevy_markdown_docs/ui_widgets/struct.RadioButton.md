...
[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/radio.rs.html#60)
...
According to the WAI-ARIA best practices document, radio buttons should not be focusable, but rather the enclosing group should be focusable. See [https://www.w3.org/WAI/ARIA/apg/patterns/radio](https://www.w3.org/WAI/ARIA/apg/patterns/radio)/

The widget emits a [`ValueChange<bool>`](struct.ValueChange.html "struct bevy::ui_widgets::ValueChange") event with the value `true` whenever it becomes checked, either through a mouse click or when a [`RadioGroup`](struct.RadioGroup.html "struct bevy::ui_widgets::RadioGroup") checks the widget. If the [`RadioButton`](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton") is focusable, it can also be checked using the `Enter` or `Space` keys, in which case the event will likewise be emitted.

## Trait Implementations

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/radio.rs.html#56)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/radio.rs.html#56)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")

where [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

**Required Components**: [`AccessibilityNode`](../a11y/struct.AccessibilityNode.html "struct bevy::a11y::AccessibilityNode"), [`Checkable`](../ui/struct.Checkable.html "struct bevy::ui::Checkable").
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/radio.rs.html#56)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")
...
### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/radio.rs.html#58)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/radio.rs.html#58)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/radio.rs.html#58)

### impl [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/radio.rs.html#58)

#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")
...
where [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton"): 'into\_return,
...
### impl [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")
...
#### fn [reflect\_owned](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/radio.rs.html#58)

#### fn [try\_into\_reflect](../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
### impl [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/radio.rs.html#58)

#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
### impl [Struct](../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")
...
### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RadioButton](struct.RadioButton.html "struct bevy::ui_widgets::RadioButton")
