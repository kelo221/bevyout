...
[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/menu.rs.html#125)
...
Menus are automatically dismissed when the user clicks outside the menu bounds. Unlike a modal dialog, where the click event is intercepted, we don’t want to actually prevent the click event from triggering its normal action. The easiest way to detect this kind of click is to look for keyboard focus loss. When a menu is opened, one of its children will gain focus, and the menu remains open so long as at least one descendant is focused. Arrow keys can be used to navigate between menu items.

This means that popup menu _must_ contain at least one focusable entity. It also means that two menus cannot be displayed at the same time unless one is an ancestor of the other.

Some care needs to be taken in implementing a menu button: we normally want menu buttons to toggle the open state of the menu; but clicking on the button will cause focus loss which means that the menu will always be closed by the time the click event is processed.

## Fields

`layout: [MenuLayout](enum.MenuLayout.html "enum bevy::ui_widgets::MenuLayout")`

The layout orientation of the menu

## Trait Implementations

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/menu.rs.html#117)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/menu.rs.html#117)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")

where [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

**Required Components**: [`AccessibilityNode`](../a11y/struct.AccessibilityNode.html "struct bevy::a11y::AccessibilityNode"), [`TabGroup`](../input_focus/tab_navigation/struct.TabGroup.html "struct bevy::input_focus::tab_navigation::TabGroup"), [`MenuFocusState`](enum.MenuFocusState.html "enum bevy::ui_widgets::MenuFocusState").
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/menu.rs.html#117)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")
...
### impl [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/menu.rs.html#123)

#### type [This](../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")

The type to convert into. [Read more](../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/menu.rs.html#123)

#### fn [from\_arg](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup") as [FromArg](../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/menu.rs.html#123)

### impl [FromReflect](../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/menu.rs.html#123)

#### fn [from\_reflect](../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")\>
...
### impl [GetOwnership](../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")
...
### impl [GetTypeRegistration](../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")
...
### impl [IntoReturn](../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")
...
where [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup"): 'into\_return,
...
### impl [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")
...
#### fn [reflect\_owned](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")\>) -> [ReflectOwned](../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/menu.rs.html#123)

#### fn [try\_into\_reflect](../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
### impl [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")

[Source](https://docs.rs/bevy_ui_widgets/0.19.0/x86_64-unknown-linux-gnu/src/bevy_ui_widgets/menu.rs.html#123)

#### fn [into\_any](../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")\>) -> [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Struct](../prelude/trait.Struct.html "trait bevy::prelude::Struct") for [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")
...
### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")
...
### impl [Typed](../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MenuPopup](struct.MenuPopup.html "struct bevy::ui_widgets::MenuPopup")
