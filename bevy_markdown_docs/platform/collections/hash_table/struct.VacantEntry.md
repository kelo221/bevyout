...
[Source](https://docs.rs/hashbrown/0.15.5/x86_64-unknown-linux-gnu/src/hashbrown/table.rs.html#2286)
...
[Source](https://docs.rs/hashbrown/0.15.5/x86_64-unknown-linux-gnu/src/hashbrown/table.rs.html#2301-2303)

### impl<'a, T, A> [VacantEntry](struct.VacantEntry.html "struct bevy::platform::collections::hash_table::VacantEntry")<'a, T, A>
...
[Source](https://docs.rs/hashbrown/0.15.5/x86_64-unknown-linux-gnu/src/hashbrown/table.rs.html#2337)
...
[Source](https://docs.rs/hashbrown/0.15.5/x86_64-unknown-linux-gnu/src/hashbrown/table.rs.html#2351)
...
[Source](https://docs.rs/hashbrown/0.15.5/x86_64-unknown-linux-gnu/src/hashbrown/table.rs.html#2295)

### impl<T, A> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [VacantEntry](struct.VacantEntry.html "struct bevy::platform::collections::hash_table::VacantEntry")<'\_, T, A>
...
[Source](https://docs.rs/hashbrown/0.15.5/x86_64-unknown-linux-gnu/src/hashbrown/table.rs.html#2296)
...
### impl<'a, T, A = [Global](https://docs.rs/allocator-api2/0.2.21/x86_64-unknown-linux-gnu/allocator_api2/stable/alloc/global/struct.Global.html "struct allocator_api2::stable::alloc::global::Global")\> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [VacantEntry](struct.VacantEntry.html "struct bevy::platform::collections::hash_table::VacantEntry")<'a, T, A>

### impl<'a, T, A> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [VacantEntry](struct.VacantEntry.html "struct bevy::platform::collections::hash_table::VacantEntry")<'a, T, A>

### impl<'a, T, A> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [VacantEntry](struct.VacantEntry.html "struct bevy::platform::collections::hash_table::VacantEntry")<'a, T, A>
...
### impl<'a, T, A> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [VacantEntry](struct.VacantEntry.html "struct bevy::platform::collections::hash_table::VacantEntry")<'a, T, A>
...
### impl<'a, T, A> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [VacantEntry](struct.VacantEntry.html "struct bevy::platform::collections::hash_table::VacantEntry")<'a, T, A>
...
### impl<'a, T, A> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [VacantEntry](struct.VacantEntry.html "struct bevy::platform::collections::hash_table::VacantEntry")<'a, T, A>

### impl<'a, T, A> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [VacantEntry](struct.VacantEntry.html "struct bevy::platform::collections::hash_table::VacantEntry")<'a, T, A>
