...
While you can create one directly with [`FoldHasher::with_seed`](struct.DefaultHasher.html#method.with_seed "associated function bevy::platform::hash::DefaultHasher::with_seed"), you most likely want to use [`RandomState`](struct.RandomState.html "struct bevy::platform::hash::RandomState"), [`SeedableRandomState`](https://docs.rs/foldhash/0.1.5/x86_64-unknown-linux-gnu/foldhash/fast/struct.SeedableRandomState.html "struct foldhash::fast::SeedableRandomState") or [`FixedState`](struct.FixedState.html "struct bevy::platform::hash::FixedState") to create [`FoldHasher`](struct.DefaultHasher.html "struct bevy::platform::hash::DefaultHasher")s.

## Implementations

[Source](https://docs.rs/foldhash/0.1.5/x86_64-unknown-linux-gnu/src/foldhash/fast.rs.html#21)

### impl<'a> [FoldHasher](struct.DefaultHasher.html "struct bevy::platform::hash::DefaultHasher")<'a>

[Source](https://docs.rs/foldhash/0.1.5/x86_64-unknown-linux-gnu/src/foldhash/fast.rs.html#25)

#### pub const fn [with\_seed](#method.with_seed)( per\_hasher\_seed: [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html), shared\_seed: &'a [SharedSeed](https://docs.rs/foldhash/0.1.5/x86_64-unknown-linux-gnu/foldhash/seed/struct.SharedSeed.html "struct foldhash::seed::SharedSeed"), ) -> [FoldHasher](struct.DefaultHasher.html "struct bevy::platform::hash::DefaultHasher")<'a>

Initializes this [`FoldHasher`](struct.DefaultHasher.html "struct bevy::platform::hash::DefaultHasher") with the given per-hasher seed and [`SharedSeed`](https://docs.rs/foldhash/0.1.5/x86_64-unknown-linux-gnu/foldhash/seed/struct.SharedSeed.html "struct foldhash::seed::SharedSeed").

## Trait Implementations

[Source](https://docs.rs/foldhash/0.1.5/x86_64-unknown-linux-gnu/src/foldhash/fast.rs.html#13)

### impl<'a> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [FoldHasher](struct.DefaultHasher.html "struct bevy::platform::hash::DefaultHasher")<'a>

[Source](https://docs.rs/foldhash/0.1.5/x86_64-unknown-linux-gnu/src/foldhash/fast.rs.html#13)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [FoldHasher](struct.DefaultHasher.html "struct bevy::platform::hash::DefaultHasher")<'a>
...
### impl<'a> [Hasher](https://doc.rust-lang.org/nightly/core/hash/trait.Hasher.html "trait core::hash::Hasher") for [FoldHasher](struct.DefaultHasher.html "struct bevy::platform::hash::DefaultHasher")<'a>
...
### impl<'a> [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [FoldHasher](struct.DefaultHasher.html "struct bevy::platform::hash::DefaultHasher")<'a>

where [FoldHasher](struct.DefaultHasher.html "struct bevy::platform::hash::DefaultHasher")<'a>: 'static,
...
### impl<'a> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [FoldHasher](struct.DefaultHasher.html "struct bevy::platform::hash::DefaultHasher")<'a>

### impl<'a> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [FoldHasher](struct.DefaultHasher.html "struct bevy::platform::hash::DefaultHasher")<'a>

### impl<'a> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [FoldHasher](struct.DefaultHasher.html "struct bevy::platform::hash::DefaultHasher")<'a>

### impl<'a> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [FoldHasher](struct.DefaultHasher.html "struct bevy::platform::hash::DefaultHasher")<'a>

### impl<'a> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [FoldHasher](struct.DefaultHasher.html "struct bevy::platform::hash::DefaultHasher")<'a>

### impl<'a> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [FoldHasher](struct.DefaultHasher.html "struct bevy::platform::hash::DefaultHasher")<'a>

### impl<'a> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [FoldHasher](struct.DefaultHasher.html "struct bevy::platform::hash::DefaultHasher")<'a>
