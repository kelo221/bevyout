...
### impl [BuildHasher](https://doc.rust-lang.org/nightly/core/hash/trait.BuildHasher.html "trait core::hash::BuildHasher") for [RandomState](struct.RandomState.html "struct bevy::platform::hash::RandomState")
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [RandomState](struct.RandomState.html "struct bevy::platform::hash::RandomState")

[Source](https://docs.rs/foldhash/0.1.5/x86_64-unknown-linux-gnu/src/foldhash/fast.rs.html#126)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [RandomState](struct.RandomState.html "struct bevy::platform::hash::RandomState")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [RandomState](struct.RandomState.html "struct bevy::platform::hash::RandomState")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [RandomState](struct.RandomState.html "struct bevy::platform::hash::RandomState")

[Source](https://docs.rs/foldhash/0.1.5/x86_64-unknown-linux-gnu/src/foldhash/fast.rs.html#134)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [RandomState](struct.RandomState.html "struct bevy::platform::hash::RandomState")
...
### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [RandomState](struct.RandomState.html "struct bevy::platform::hash::RandomState")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RandomState](struct.RandomState.html "struct bevy::platform::hash::RandomState")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RandomState](struct.RandomState.html "struct bevy::platform::hash::RandomState")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RandomState](struct.RandomState.html "struct bevy::platform::hash::RandomState")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RandomState](struct.RandomState.html "struct bevy::platform::hash::RandomState")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RandomState](struct.RandomState.html "struct bevy::platform::hash::RandomState")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RandomState](struct.RandomState.html "struct bevy::platform::hash::RandomState")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RandomState](struct.RandomState.html "struct bevy::platform::hash::RandomState")
