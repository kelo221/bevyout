...
1.80.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#81)
...
This type is a thread-safe [`LazyCell`](https://doc.rust-lang.org/nightly/core/cell/lazy/struct.LazyCell.html "struct core::cell::lazy::LazyCell"), and can be used in statics. Since initialization may be called from multiple threads, any dereferencing call will block the calling thread if another initialization routine is currently running.

## Poisoning

If the initialization closure passed to [`LazyLock::new`](struct.LazyLock.html#method.new "associated function bevy::platform::sync::LazyLock::new") panics, the lock will be poisoned. Once the lock is poisoned, any threads that attempt to access this lock (via a dereference or via an explicit call to [`force()`](struct.LazyLock.html#method.force "associated function bevy::platform::sync::LazyLock::force")) will panic.

This concept is similar to that of poisoning in the [`std::sync::poison`](https://doc.rust-lang.org/nightly/std/sync/poison/index.html "mod std::sync::poison") module. A key difference, however, is that poisoning in `LazyLock` is _unrecoverable_. All future accesses of the lock from other threads will panic, whereas a type in [`std::sync::poison`](https://doc.rust-lang.org/nightly/std/sync/poison/index.html "mod std::sync::poison") like [`std::sync::poison::Mutex`](struct.Mutex.html "struct bevy::platform::sync::Mutex") allows recovery via [`PoisonError::into_inner()`](struct.PoisonError.html#method.into_inner "method bevy::platform::sync::PoisonError::into_inner").
...
[Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#87)

### impl<T, F> [LazyLock](struct.LazyLock.html "struct bevy::platform::sync::LazyLock")<T, F>

where F: [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")() -> T,

1.80.0 (const: 1.80.0) · [Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#104)

#### pub const fn [new](#method.new)(f: F) -> [LazyLock](struct.LazyLock.html "struct bevy::platform::sync::LazyLock")<T, F>
...
[Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#131)

#### pub fn [into\_inner](#method.into_inner)(this: [LazyLock](struct.LazyLock.html "struct bevy::platform::sync::LazyLock")<T, F>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<T, F>
...
1.94.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#177)

#### pub fn [force\_mut](#method.force_mut)(this: &mut [LazyLock](struct.LazyLock.html "struct bevy::platform::sync::LazyLock")<T, F>) -> [&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)

Forces the evaluation of this lazy value and returns a mutable reference to the result.

##### Panics

If the initialization closure panics (the one that is passed to the [`new()`](struct.LazyLock.html#method.new "associated function bevy::platform::sync::LazyLock::new") method), the panic is propagated to the caller, and the lock becomes poisoned. This will cause all future accesses of the lock (via [`force()`](struct.LazyLock.html#method.force "associated function bevy::platform::sync::LazyLock::force") or a dereference) to panic.
...
1.80.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#241)

#### pub fn [force](#method.force)(this: &[LazyLock](struct.LazyLock.html "struct bevy::platform::sync::LazyLock")<T, F>) -> [&T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)
...
[Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#265)

### impl<T, F> [LazyLock](struct.LazyLock.html "struct bevy::platform::sync::LazyLock")<T, F>

1.94.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#283)

#### pub fn [get\_mut](#method.get_mut)(this: &mut [LazyLock](struct.LazyLock.html "struct bevy::platform::sync::LazyLock")<T, F>) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\>
...
1.94.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#311)

#### pub fn [get](#method.get)(this: &[LazyLock](struct.LazyLock.html "struct bevy::platform::sync::LazyLock")<T, F>) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[&T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\>
...
1.80.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#388)

### impl<T, F> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [LazyLock](struct.LazyLock.html "struct bevy::platform::sync::LazyLock")<T, F>

where T: [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug"),

[Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#389)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")\>

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

1.80.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143894 "Tracking issue for const_default")) · [Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#379)

### impl<T> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [LazyLock](struct.LazyLock.html "struct bevy::platform::sync::LazyLock")<T>

where T: [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default"),

[Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#382)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [LazyLock](struct.LazyLock.html "struct bevy::platform::sync::LazyLock")<T>

Creates a new lazy value using `Default` as the initializing function.

1.80.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#339)

### impl<T, F> [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [LazyLock](struct.LazyLock.html "struct bevy::platform::sync::LazyLock")<T, F>

where F: [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")() -> T,

[Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#356)
...
[Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#340)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = T

The resulting type after dereferencing.

1.89.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#362)

### impl<T, F> [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [LazyLock](struct.LazyLock.html "struct bevy::platform::sync::LazyLock")<T, F>

where F: [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")() -> T,

[Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#372)
...
1.80.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#324)

### impl<T, F> [Drop](https://doc.rust-lang.org/nightly/core/ops/drop/trait.Drop.html "trait core::ops::drop::Drop") for [LazyLock](struct.LazyLock.html "struct bevy::platform::sync::LazyLock")<T, F>

[Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#325)
...
1.96.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#400)

### impl<T, F> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<T> for [LazyLock](struct.LazyLock.html "struct bevy::platform::sync::LazyLock")<T, F>

[Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#404)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: T) -> [LazyLock](struct.LazyLock.html "struct bevy::platform::sync::LazyLock")<T, F>

Constructs a `LazyLock` that starts already initialized with the provided value.

1.80.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#425)

### impl<T, F> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [LazyLock](struct.LazyLock.html "struct bevy::platform::sync::LazyLock")<T, F>

where T: [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") + [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"), F: [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"),

1.80.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#421)

### impl<T, F> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [LazyLock](struct.LazyLock.html "struct bevy::platform::sync::LazyLock")<T, F>

where T: [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"), F: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

1.80.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/lazy_lock.rs.html#427)

### impl<T, F> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [LazyLock](struct.LazyLock.html "struct bevy::platform::sync::LazyLock")<T, F>

where T: [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"), F: [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"),

## Auto Trait Implementations

### impl<T, F = [fn](https://doc.rust-lang.org/nightly/std/primitive.fn.html)() -> T> ![Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [LazyLock](struct.LazyLock.html "struct bevy::platform::sync::LazyLock")<T, F>

### impl<T, F> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [LazyLock](struct.LazyLock.html "struct bevy::platform::sync::LazyLock")<T, F>

where T: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"), F: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

### impl<T, F> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [LazyLock](struct.LazyLock.html "struct bevy::platform::sync::LazyLock")<T, F>

where T: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"), F: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<T, F> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [LazyLock](struct.LazyLock.html "struct bevy::platform::sync::LazyLock")<T, F>

where T: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"), F: [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin"),
