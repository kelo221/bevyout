...
1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#94)
...
In comparison, a [`Mutex`](struct.Mutex.html "struct bevy::platform::sync::Mutex") does not distinguish between readers or writers that acquire the lock, therefore blocking any threads waiting for the lock to become available. An `RwLock` will allow multiple readers to acquire the lock as long as a writer is not holding the lock.
...
The type parameter `T` represents the data that this lock protects. It is required that `T` satisfies [`Send`](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") to be shared across threads and [`Sync`](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") to allow concurrent access through readers. The RAII guards returned from the locking methods implement [`Deref`](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") (and [`DerefMut`](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for the `write` methods) to allow access to the content of the lock.

## Poisoning

An `RwLock`, like [`Mutex`](struct.Mutex.html "struct bevy::platform::sync::Mutex"), will [usually](struct.Mutex.html#poisoning "struct bevy::platform::sync::Mutex") become poisoned on a panic. Note, however, that an `RwLock` may only be poisoned if a panic occurs while it is locked exclusively (write mode). If a panic occurs in any reader, then the lock will not be poisoned.
...
[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#245)

### impl<T> [RwLock](struct.RwLock.html "struct bevy::platform::sync::RwLock")<T>

1.0.0 (const: 1.63.0) · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#258)

#### pub const fn [new](#method.new)(t: T) -> [RwLock](struct.RwLock.html "struct bevy::platform::sync::RwLock")<T>
...
[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#282-284)
...
[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#315)
...
[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#354)
...
[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#362)

### impl<T> [RwLock](struct.RwLock.html "struct bevy::platform::sync::RwLock")<T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#408)

#### pub fn [read](#method.read)( &self, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[RwLockReadGuard](struct.RwLockReadGuard.html "struct bevy::platform::sync::RwLockReadGuard")<'\_, T>, [PoisonError](struct.PoisonError.html "struct bevy::platform::sync::PoisonError")<[RwLockReadGuard](struct.RwLockReadGuard.html "struct bevy::platform::sync::RwLockReadGuard")<'\_, T>>>
...
1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#455)

#### pub fn [try\_read](#method.try_read)( &self, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[RwLockReadGuard](struct.RwLockReadGuard.html "struct bevy::platform::sync::RwLockReadGuard")<'\_, T>, [TryLockError](enum.TryLockError.html "enum bevy::platform::sync::TryLockError")<[RwLockReadGuard](struct.RwLockReadGuard.html "struct bevy::platform::sync::RwLockReadGuard")<'\_, T>>>
...
This function will return the [`Poisoned`](enum.TryLockError.html#variant.Poisoned "variant bevy::platform::sync::TryLockError::Poisoned") error if the `RwLock` is poisoned. An `RwLock` is poisoned whenever a writer panics while holding an exclusive lock. `Poisoned` will only be returned if the lock would have otherwise been acquired. An acquired lock guard will be contained in the returned error.

This function will return the [`WouldBlock`](enum.TryLockError.html#variant.WouldBlock "variant bevy::platform::sync::TryLockError::WouldBlock") error if the `RwLock` could not be acquired because it was already locked exclusively.
...
1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#501)

#### pub fn [write](#method.write)( &self, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[RwLockWriteGuard](struct.RwLockWriteGuard.html "struct bevy::platform::sync::RwLockWriteGuard")<'\_, T>, [PoisonError](struct.PoisonError.html "struct bevy::platform::sync::PoisonError")<[RwLockWriteGuard](struct.RwLockWriteGuard.html "struct bevy::platform::sync::RwLockWriteGuard")<'\_, T>>>
...
1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#549)

#### pub fn [try\_write](#method.try_write)( &self, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[RwLockWriteGuard](struct.RwLockWriteGuard.html "struct bevy::platform::sync::RwLockWriteGuard")<'\_, T>, [TryLockError](enum.TryLockError.html "enum bevy::platform::sync::TryLockError")<[RwLockWriteGuard](struct.RwLockWriteGuard.html "struct bevy::platform::sync::RwLockWriteGuard")<'\_, T>>>
...
This function will return the [`WouldBlock`](enum.TryLockError.html#variant.WouldBlock "variant bevy::platform::sync::TryLockError::WouldBlock") error if the `RwLock` could not be acquired because it was already locked.
...
1.2.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#582)
...
1.77.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#619)
...
1.6.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#645-647)
...
1.6.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#678)
...
[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#690)
...
[Source](https://docs.rs/sharded-slab/0.1.7/x86_64-unknown-linux-gnu/src/sharded_slab/clear.rs.html#88)

### impl<T> [Clear](https://docs.rs/sharded-slab/0.1.7/x86_64-unknown-linux-gnu/sharded_slab/clear/trait.Clear.html "trait sharded_slab::clear::Clear") for [RwLock](struct.RwLock.html "struct bevy::platform::sync::RwLock")<T>
...
[Source](https://docs.rs/sharded-slab/0.1.7/x86_64-unknown-linux-gnu/src/sharded_slab/clear.rs.html#90)
...
1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#696)

### impl<T> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [RwLock](struct.RwLock.html "struct bevy::platform::sync::RwLock")<T>
...
[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#697)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")\>

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

1.10.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#716)

### impl<T> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [RwLock](struct.RwLock.html "struct bevy::platform::sync::RwLock")<T>

where T: [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default"),

[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#718)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [RwLock](struct.RwLock.html "struct bevy::platform::sync::RwLock")<T>

Creates a new `RwLock<T>`, with the `Default` value for T.

[Source](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/src/serde_core/de/impls.rs.html#2113-2117)

### impl<'de, T> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [RwLock](struct.RwLock.html "struct bevy::platform::sync::RwLock")<T>
...
1.24.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#724)

### impl<T> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<T> for [RwLock](struct.RwLock.html "struct bevy::platform::sync::RwLock")<T>

[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#727)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(t: T) -> [RwLock](struct.RwLock.html "struct bevy::platform::sync::RwLock")<T>

Creates a new instance of an `RwLock<T>` which is unlocked. This is equivalent to [`RwLock::new`](struct.RwLock.html#method.new "associated function bevy::platform::sync::RwLock::new").

1.12.0 · [Source](https://doc.rust-lang.org/nightly/src/std/panic.rs.html#273)

### impl<T> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RwLock](struct.RwLock.html "struct bevy::platform::sync::RwLock")<T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#104)

### impl<T> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RwLock](struct.RwLock.html "struct bevy::platform::sync::RwLock")<T>
...
[Source](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/src/serde_core/ser/impls.rs.html#646-648)

### impl<T> [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [RwLock](struct.RwLock.html "struct bevy::platform::sync::RwLock")<T>
...
[Source](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/src/serde_core/ser/impls.rs.html#650-652)
...
1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#107)

### impl<T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RwLock](struct.RwLock.html "struct bevy::platform::sync::RwLock")<T>

where T: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

[Source](https://docs.rs/zvariant/5.9.2/x86_64-unknown-linux-gnu/src/zvariant/type/libstd.rs.html#115)

### impl<T> [Type](https://docs.rs/zvariant/5.9.2/x86_64-unknown-linux-gnu/zvariant/type/trait.Type.html "trait zvariant::type::Type") for [RwLock](struct.RwLock.html "struct bevy::platform::sync::RwLock")<T>
...
1.9.0 · [Source](https://doc.rust-lang.org/nightly/src/std/panic.rs.html#266)

### impl<T> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RwLock](struct.RwLock.html "struct bevy::platform::sync::RwLock")<T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

## Auto Trait Implementations

### impl<T> ![Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RwLock](struct.RwLock.html "struct bevy::platform::sync::RwLock")<T>

### impl<T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RwLock](struct.RwLock.html "struct bevy::platform::sync::RwLock")<T>
...
### impl<T> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RwLock](struct.RwLock.html "struct bevy::platform::sync::RwLock")<T>
