...
1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#160)
...
This structure is created by the [`write`](struct.RwLock.html#method.write "method bevy::platform::sync::RwLock::write") and [`try_write`](struct.RwLock.html#method.try_write "method bevy::platform::sync::RwLock::try_write") methods on [`RwLock`](struct.RwLock.html "struct bevy::platform::sync::RwLock").

## Implementations

[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#812)

### impl<'rwlock, T> [RwLockWriteGuard](struct.RwLockWriteGuard.html "struct bevy::platform::sync::RwLockWriteGuard")<'rwlock, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

1.92.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#883)

#### pub fn [downgrade](#method.downgrade)(s: [RwLockWriteGuard](struct.RwLockWriteGuard.html "struct bevy::platform::sync::RwLockWriteGuard")<'rwlock, T>) -> [RwLockReadGuard](struct.RwLockReadGuard.html "struct bevy::platform::sync::RwLockReadGuard")<'rwlock, T>

Downgrades a write-locked `RwLockWriteGuard` into a read-locked [`RwLockReadGuard`](struct.RwLockReadGuard.html "struct bevy::platform::sync::RwLockReadGuard").

Since we have the `RwLockWriteGuard`, the [`RwLock`](struct.RwLock.html "struct bevy::platform::sync::RwLock") must already be locked for writing, so this method cannot fail.

After downgrading, other readers will be allowed to read the protected data.

##### Examples

`downgrade` takes ownership of the `RwLockWriteGuard` and returns a [`RwLockReadGuard`](struct.RwLockReadGuard.html "struct bevy::platform::sync::RwLockReadGuard").
...
`downgrade` will _atomically_ change the state of the [`RwLock`](struct.RwLock.html "struct bevy::platform::sync::RwLock") from exclusive mode into shared mode. This means that it is impossible for another writing thread to get in between a thread calling `downgrade` and any reads it performs after downgrading.
...
[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#911-914)

#### pub fn [map](#method.map)<U, F>( orig: [RwLockWriteGuard](struct.RwLockWriteGuard.html "struct bevy::platform::sync::RwLockWriteGuard")<'rwlock, T>, f: F, ) -> [MappedRwLockWriteGuard](https://doc.rust-lang.org/nightly/std/sync/poison/rwlock/struct.MappedRwLockWriteGuard.html "struct std::sync::poison::rwlock::MappedRwLockWriteGuard")<'rwlock, U>

where F: [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")([&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)) -> [&mut U](https://doc.rust-lang.org/nightly/std/primitive.reference.html), U: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

🔬This is a nightly-only experimental API. (`mapped_lock_guards`)

Makes a [`MappedRwLockWriteGuard`](https://doc.rust-lang.org/nightly/std/sync/poison/rwlock/struct.MappedRwLockWriteGuard.html "struct std::sync::poison::rwlock::MappedRwLockWriteGuard") for a component of the borrowed data, e.g. an enum variant.
...
[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#946-949)

#### pub fn [filter\_map](#method.filter_map)<U, F>( orig: [RwLockWriteGuard](struct.RwLockWriteGuard.html "struct bevy::platform::sync::RwLockWriteGuard")<'rwlock, T>, f: F, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[MappedRwLockWriteGuard](https://doc.rust-lang.org/nightly/std/sync/poison/rwlock/struct.MappedRwLockWriteGuard.html "struct std::sync::poison::rwlock::MappedRwLockWriteGuard")<'rwlock, U>, [RwLockWriteGuard](struct.RwLockWriteGuard.html "struct bevy::platform::sync::RwLockWriteGuard")<'rwlock, T>>

where F: [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")([&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[&mut U](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\>, U: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

🔬This is a nightly-only experimental API. (`mapped_lock_guards`)

Makes a [`MappedRwLockWriteGuard`](https://doc.rust-lang.org/nightly/std/sync/poison/rwlock/struct.MappedRwLockWriteGuard.html "struct std::sync::poison::rwlock::MappedRwLockWriteGuard") for a component of the borrowed data. The original guard is returned as an `Err(...)` if the closure returns `None`.
...
1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#168)

### impl<T> ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RwLockWriteGuard](struct.RwLockWriteGuard.html "struct bevy::platform::sync::RwLockWriteGuard")<'\_, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

1.16.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#1235)

### impl<T> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [RwLockWriteGuard](struct.RwLockWriteGuard.html "struct bevy::platform::sync::RwLockWriteGuard")<'\_, T>
...
[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#1236)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")\>

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#1172)

### impl<T> [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [RwLockWriteGuard](struct.RwLockWriteGuard.html "struct bevy::platform::sync::RwLockWriteGuard")<'\_, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#1173)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = T

The resulting type after dereferencing.

[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#1175)
...
1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#1182)

### impl<T> [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [RwLockWriteGuard](struct.RwLockWriteGuard.html "struct bevy::platform::sync::RwLockWriteGuard")<'\_, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#1183)
...
1.20.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#1242)

### impl<T> [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [RwLockWriteGuard](struct.RwLockWriteGuard.html "struct bevy::platform::sync::RwLockWriteGuard")<'\_, T>
...
[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#1243)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")\>

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html#tymethod.fmt)

1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#1128)

### impl<T> [Drop](https://doc.rust-lang.org/nightly/core/ops/drop/trait.Drop.html "trait core::ops::drop::Drop") for [RwLockWriteGuard](struct.RwLockWriteGuard.html "struct bevy::platform::sync::RwLockWriteGuard")<'\_, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#1129)
...
1.23.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/rwlock.rs.html#171)

### impl<T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RwLockWriteGuard](struct.RwLockWriteGuard.html "struct bevy::platform::sync::RwLockWriteGuard")<'\_, T>
...
### impl<'rwlock, T> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RwLockWriteGuard](struct.RwLockWriteGuard.html "struct bevy::platform::sync::RwLockWriteGuard")<'rwlock, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

### impl<'rwlock, T> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RwLockWriteGuard](struct.RwLockWriteGuard.html "struct bevy::platform::sync::RwLockWriteGuard")<'rwlock, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

### impl<'rwlock, T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RwLockWriteGuard](struct.RwLockWriteGuard.html "struct bevy::platform::sync::RwLockWriteGuard")<'rwlock, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

### impl<'rwlock, T> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [RwLockWriteGuard](struct.RwLockWriteGuard.html "struct bevy::platform::sync::RwLockWriteGuard")<'rwlock, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

### impl<'rwlock, T> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RwLockWriteGuard](struct.RwLockWriteGuard.html "struct bevy::platform::sync::RwLockWriteGuard")<'rwlock, T>
