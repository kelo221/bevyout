...
1.70.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#109)
...
This type is a thread-safe [`OnceCell`](https://doc.rust-lang.org/nightly/core/cell/once/struct.OnceCell.html "struct core::cell::once::OnceCell"), and can be used in statics. In many simple cases, you can use [`LazyLock<T, F>`](struct.LazyLock.html "struct bevy::platform::sync::LazyLock") instead to get the benefits of this type with less effort: `LazyLock<T, F>` “looks like” `&T` because it initializes with `F` on deref! Where OnceLock shines is when LazyLock is too simple to support a given case, as LazyLock doesn’t allow additional inputs to its function after you call [`LazyLock::new(|| ...)`](struct.LazyLock.html#method.new "associated function bevy::platform::sync::LazyLock::new").

A `OnceLock` can be thought of as a safe abstraction over uninitialized data that becomes initialized once written.

Unlike [`Mutex`](struct.Mutex.html "struct bevy::platform::sync::Mutex"), `OnceLock` is never poisoned on panic.
...
[Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#134)

### impl<T> [OnceLock](struct.OnceLock.html "struct bevy::platform::sync::OnceLock")<T>

1.70.0 (const: 1.70.0) · [Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#140)

#### pub const fn [new](#method.new)() -> [OnceLock](struct.OnceLock.html "struct bevy::platform::sync::OnceLock")<T>

Creates a new uninitialized cell.

1.70.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#155)

#### pub fn [get](#method.get)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[&T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\>

Gets the reference to the underlying value.

Returns `None` if the cell is uninitialized, or being initialized. This method never blocks.

1.70.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#173)

#### pub fn [get\_mut](#method.get_mut)(&mut self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)\>

Gets the mutable reference to the underlying value.

Returns `None` if the cell is uninitialized.

This method never blocks. Since it borrows the `OnceLock` mutably, it is statically guaranteed that no active borrows to the `OnceLock` exist, including from other threads.

1.86.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#203)

#### pub fn [wait](#method.wait)(&self) -> [&T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)
...
1.70.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#238)

#### pub fn [set](#method.set)(&self, value: T) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), T>
...
[Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#278)

#### pub fn [try\_insert](#method.try_insert)(&self, value: T) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[&T](https://doc.rust-lang.org/nightly/std/primitive.reference.html), ([&T](https://doc.rust-lang.org/nightly/std/primitive.reference.html), T)>
...
1.70.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#317-319)

#### pub fn [get\_or\_init](#method.get_or_init)<F>(&self, f: F) -> [&T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)
...
Many threads may call `get_or_init` concurrently with different initializing functions, but it is guaranteed that only one function will be executed if the function doesn’t panic.
...
[Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#357-359)

#### pub fn [get\_mut\_or\_init](#method.get_mut_or_init)<F>(&mut self, f: F) -> [&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)
...
[Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#398-400)

#### pub fn [get\_or\_try\_init](#method.get_or_try_init)<F, E>(&self, f: F) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[&T](https://doc.rust-lang.org/nightly/std/primitive.reference.html), E>

where F: [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")() -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<T, E>,
...
[Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#449-451)

#### pub fn [get\_mut\_or\_try\_init](#method.get_mut_or_try_init)<F, E>(&mut self, f: F) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html), E>
...
1.70.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#478)

#### pub fn [into\_inner](#method.into_inner)(self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<T>
...
1.70.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#504)
...
Since this method borrows the `OnceLock` mutably, it is statically guaranteed that no active borrows to the `OnceLock` exist, including from other threads.
...
1.70.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#626)

### impl<T> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [OnceLock](struct.OnceLock.html "struct bevy::platform::sync::OnceLock")<T>

where T: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),

[Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#628)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [OnceLock](struct.OnceLock.html "struct bevy::platform::sync::OnceLock")<T>
...
1.70.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#614)

### impl<T> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [OnceLock](struct.OnceLock.html "struct bevy::platform::sync::OnceLock")<T>

where T: [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug"),

[Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#615)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")\>

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

1.70.0 (const: [unstable](https://github.com/rust-lang/rust/issues/143894 "Tracking issue for const_default")) · [Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#595)

### impl<T> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [OnceLock](struct.OnceLock.html "struct bevy::platform::sync::OnceLock")<T>

[Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#608)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [OnceLock](struct.OnceLock.html "struct bevy::platform::sync::OnceLock")<T>
...
1.70.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#699)

### impl<T> [Drop](https://doc.rust-lang.org/nightly/core/ops/drop/trait.Drop.html "trait core::ops::drop::Drop") for [OnceLock](struct.OnceLock.html "struct bevy::platform::sync::OnceLock")<T>

[Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#701)
...
1.70.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#696)

### impl<T> [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [OnceLock](struct.OnceLock.html "struct bevy::platform::sync::OnceLock")<T>

where T: [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq"),

1.70.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#641)

### impl<T> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<T> for [OnceLock](struct.OnceLock.html "struct bevy::platform::sync::OnceLock")<T>

[Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#658)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: T) -> [OnceLock](struct.OnceLock.html "struct bevy::platform::sync::OnceLock")<T>
...
1.70.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#668)

### impl<T> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [OnceLock](struct.OnceLock.html "struct bevy::platform::sync::OnceLock")<T>

where T: [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"),

[Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#690)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[OnceLock](struct.OnceLock.html "struct bevy::platform::sync::OnceLock")<T>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Equality for two `OnceLock`s.

Two `OnceLock`s are equal if they either both contain values and their values are equal, or if neither contains a value.
...
1.70.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#589)

### impl<T> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [OnceLock](struct.OnceLock.html "struct bevy::platform::sync::OnceLock")<T>

where T: [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") + [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"),

1.70.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#586)

### impl<T> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [OnceLock](struct.OnceLock.html "struct bevy::platform::sync::OnceLock")<T>

where T: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

1.70.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#584)

### impl<T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [OnceLock](struct.OnceLock.html "struct bevy::platform::sync::OnceLock")<T>
...
1.70.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/once_lock.rs.html#591)

### impl<T> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [OnceLock](struct.OnceLock.html "struct bevy::platform::sync::OnceLock")<T>
...
### impl<T> ![Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [OnceLock](struct.OnceLock.html "struct bevy::platform::sync::OnceLock")<T>

### impl<T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [OnceLock](struct.OnceLock.html "struct bevy::platform::sync::OnceLock")<T>

where T: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

### impl<T> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [OnceLock](struct.OnceLock.html "struct bevy::platform::sync::OnceLock")<T>
