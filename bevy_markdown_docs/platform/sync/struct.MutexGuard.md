...
1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/mutex.rs.html#277)
...
The data protected by the mutex can be accessed through this guard via its [`Deref`](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") and [`DerefMut`](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") implementations.

This structure is created by the [`lock`](struct.Mutex.html#method.lock "method bevy::platform::sync::Mutex::lock") and [`try_lock`](struct.Mutex.html#method.try_lock "method bevy::platform::sync::Mutex::try_lock") methods on [`Mutex`](struct.Mutex.html "struct bevy::platform::sync::Mutex").

## Implementations

[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/mutex.rs.html#775)

### impl<'a, T> [MutexGuard](struct.MutexGuard.html "struct bevy::platform::sync::MutexGuard")<'a, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/mutex.rs.html#785-788)

#### pub fn [map](#method.map)<U, F>(orig: [MutexGuard](struct.MutexGuard.html "struct bevy::platform::sync::MutexGuard")<'a, T>, f: F) -> [MappedMutexGuard](https://doc.rust-lang.org/nightly/std/sync/poison/mutex/struct.MappedMutexGuard.html "struct std::sync::poison::mutex::MappedMutexGuard")<'a, U>
...
Makes a [`MappedMutexGuard`](https://doc.rust-lang.org/nightly/std/sync/poison/mutex/struct.MappedMutexGuard.html "struct std::sync::poison::mutex::MappedMutexGuard") for a component of the borrowed data, e.g. an enum variant.
...
[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/mutex.rs.html#815-818)

#### pub fn [filter\_map](#method.filter_map)<U, F>( orig: [MutexGuard](struct.MutexGuard.html "struct bevy::platform::sync::MutexGuard")<'a, T>, f: F, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[MappedMutexGuard](https://doc.rust-lang.org/nightly/std/sync/poison/mutex/struct.MappedMutexGuard.html "struct std::sync::poison::mutex::MappedMutexGuard")<'a, U>, [MutexGuard](struct.MutexGuard.html "struct bevy::platform::sync::MutexGuard")<'a, T>>
...
Makes a [`MappedMutexGuard`](https://doc.rust-lang.org/nightly/std/sync/poison/mutex/struct.MappedMutexGuard.html "struct std::sync::poison::mutex::MappedMutexGuard") for a component of the borrowed data. The original guard is returned as an `Err(...)` if the closure returns `None`.
...
1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/mutex.rs.html#289)

### impl<T> ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MutexGuard](struct.MutexGuard.html "struct bevy::platform::sync::MutexGuard")<'\_, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

A [`MutexGuard`](struct.MutexGuard.html "struct bevy::platform::sync::MutexGuard") is not `Send` to maximize platform portability.

On platforms that use POSIX threads (commonly referred to as pthreads) there is a requirement to release mutex locks on the same thread they were acquired. For this reason, [`MutexGuard`](struct.MutexGuard.html "struct bevy::platform::sync::MutexGuard") must not implement `Send` to prevent it being dropped from another thread.

1.16.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/mutex.rs.html#752)

### impl<T> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [MutexGuard](struct.MutexGuard.html "struct bevy::platform::sync::MutexGuard")<'\_, T>
...
[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/mutex.rs.html#753)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")\>

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/mutex.rs.html#725)

### impl<T> [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [MutexGuard](struct.MutexGuard.html "struct bevy::platform::sync::MutexGuard")<'\_, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/mutex.rs.html#726)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = T

The resulting type after dereferencing.

[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/mutex.rs.html#728)
...
1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/mutex.rs.html#734)

### impl<T> [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [MutexGuard](struct.MutexGuard.html "struct bevy::platform::sync::MutexGuard")<'\_, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/mutex.rs.html#735)
...
1.20.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/mutex.rs.html#759)

### impl<T> [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [MutexGuard](struct.MutexGuard.html "struct bevy::platform::sync::MutexGuard")<'\_, T>
...
[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/mutex.rs.html#760)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")\>

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html#tymethod.fmt)

1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/mutex.rs.html#741)

### impl<T> [Drop](https://doc.rust-lang.org/nightly/core/ops/drop/trait.Drop.html "trait core::ops::drop::Drop") for [MutexGuard](struct.MutexGuard.html "struct bevy::platform::sync::MutexGuard")<'\_, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

[Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/mutex.rs.html#743)
...
1.19.0 · [Source](https://doc.rust-lang.org/nightly/src/std/sync/poison/mutex.rs.html#294)

### impl<T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MutexGuard](struct.MutexGuard.html "struct bevy::platform::sync::MutexGuard")<'\_, T>
...
`T` must be `Sync` for a [`MutexGuard<T>`](struct.MutexGuard.html "struct bevy::platform::sync::MutexGuard") to be `Sync` because it is possible to get a `&T` from `&MutexGuard` (via `Deref`).

## Auto Trait Implementations

### impl<'a, T> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MutexGuard](struct.MutexGuard.html "struct bevy::platform::sync::MutexGuard")<'a, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

### impl<'a, T> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MutexGuard](struct.MutexGuard.html "struct bevy::platform::sync::MutexGuard")<'a, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

### impl<'a, T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MutexGuard](struct.MutexGuard.html "struct bevy::platform::sync::MutexGuard")<'a, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

### impl<'a, T> [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [MutexGuard](struct.MutexGuard.html "struct bevy::platform::sync::MutexGuard")<'a, T>

where T: ?[Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),

### impl<'a, T> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MutexGuard](struct.MutexGuard.html "struct bevy::platform::sync::MutexGuard")<'a, T>
