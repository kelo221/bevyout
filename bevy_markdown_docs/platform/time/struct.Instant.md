[bevy](../../index.html)::[platform](../index.html)::[time](index.html)

# Struct Instant 

1.8.0 · [Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#156)

```rust
pub struct Instant(/* private fields */);
```

A measurement of a monotonically nondecreasing clock. Opaque and useful only with [`Duration`](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration").

Instants are always guaranteed, barring [platform bugs](struct.Instant.html#monotonicity "struct bevy::platform::time::Instant"), to be no less than any previously measured instant when created, and are often useful for tasks such as measuring benchmarks or timing how long an operation takes.
...
The following system calls are [currently](https://doc.rust-lang.org/nightly/std/io/index.html#platform-specific-behavior "mod std::io") being used by `now()` to find out the current time:
...
| UNIX | [clock\_gettime](https://pubs.opengroup.org/onlinepubs/9799919799/functions/clock_getres.html) with `CLOCK_MONOTONIC` |
| WASI | [clock\_gettime](https://pubs.opengroup.org/onlinepubs/9799919799/functions/clock_getres.html) with `CLOCK_MONOTONIC` |
| Darwin | [clock\_gettime](https://pubs.opengroup.org/onlinepubs/9799919799/functions/clock_getres.html) with `CLOCK_UPTIME_RAW` |
| VXWorks | [clock\_gettime](https://pubs.opengroup.org/onlinepubs/9799919799/functions/clock_getres.html) with `CLOCK_MONOTONIC` |
| SOLID | `get_tim` |
...
> Note: mathematical operations like [`add`](struct.Instant.html#method.add "method bevy::platform::time::Instant::add") may panic if the underlying structure cannot represent the new point in time.

### Monotonicity

On all platforms `Instant` will try to use an OS API that guarantees monotonic behavior if available, which is the case for all [tier 1](https://doc.rust-lang.org/rustc/platform-support.html) platforms. In practice such guarantees are – under rare circumstances – broken by hardware, virtualization or operating system bugs. To work around these bugs and platforms not offering monotonic clocks [`duration_since`](struct.Instant.html#method.duration_since "method bevy::platform::time::Instant::duration_since"), [`elapsed`](struct.Instant.html#method.elapsed "method bevy::platform::time::Instant::elapsed") and [`sub`](#impl-Sub-for-Instant) saturate to zero. In older Rust versions this lead to a panic instead. [`checked_duration_since`](struct.Instant.html#method.checked_duration_since "method bevy::platform::time::Instant::checked_duration_since") can be used to detect and handle situations where monotonicity is violated, or `Instant`s are subtracted in the wrong order.
...
[Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#272)

### impl [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

1.8.0 · [Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#285)

#### pub fn [now](#method.now)() -> [Instant](struct.Instant.html "struct bevy::platform::time::Instant")
...
examples/ecs/hotpatching\_systems.rs ([line 84](../../../src/hotpatching_systems/hotpatching_systems.rs.html#84))
...
1.8.0 · [Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#314)

#### pub fn [duration\_since](#method.duration_since)(&self, earlier: [Instant](struct.Instant.html "struct bevy::platform::time::Instant")) -> [Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration")

Returns the amount of time elapsed from another instant to this one, or zero duration if that instant is later than this one.

##### Panics

Previous Rust versions panicked when `earlier` was later than `self`. Currently this method saturates. Future versions may reintroduce the panic in some circumstances. See [Monotonicity](struct.Instant.html#monotonicity "struct bevy::platform::time::Instant").
...
1.39.0 · [Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#340)

#### pub fn [checked\_duration\_since](#method.checked_duration_since)(&self, earlier: [Instant](struct.Instant.html "struct bevy::platform::time::Instant")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration")\>

Returns the amount of time elapsed from another instant to this one, or None if that instant is later than this one.

Due to [monotonicity bugs](struct.Instant.html#monotonicity "struct bevy::platform::time::Instant"), even under correct logical ordering of the passed `Instant`s, this method can return `None`.
...
1.39.0 · [Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#361)

#### pub fn [saturating\_duration\_since](#method.saturating_duration_since)(&self, earlier: [Instant](struct.Instant.html "struct bevy::platform::time::Instant")) -> [Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration")
...
1.8.0 · [Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#388)
...
Previous Rust versions panicked when the current time was earlier than self. Currently this method returns a Duration of zero in that case. Future versions may reintroduce the panic. See [Monotonicity](struct.Instant.html#monotonicity "struct bevy::platform::time::Instant").
...
examples/ecs/hotpatching\_systems.rs ([line 91](../../../src/hotpatching_systems/hotpatching_systems.rs.html#91))
...
1.34.0 · [Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#396)

#### pub fn [checked\_add](#method.checked_add)(&self, duration: [Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Instant](struct.Instant.html "struct bevy::platform::time::Instant")\>
...
1.34.0 · [Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#404)

#### pub fn [checked\_sub](#method.checked_sub)(&self, duration: [Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Instant](struct.Instant.html "struct bevy::platform::time::Instant")\>

Returns `Some(t)` where `t` is the time `self - duration` if `t` can be represented as `Instant` (which means it’s inside the bounds of the underlying data structure), `None` otherwise.

## Trait Implementations

1.8.0 · [Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#419)

### impl [Add](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Add.html "trait core::ops::arith::Add")<[Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration")\> for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

[Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#427)

#### fn [add](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Add.html#tymethod.add)(self, other: [Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration")) -> [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

##### Panics

This function may panic if the resulting point in time cannot be represented by the underlying data structure. See [`Instant::checked_add`](struct.Instant.html#method.checked_add "method bevy::platform::time::Instant::checked_add") for a version without panic.

[Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#420)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Add.html#associatedtype.Output) = [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

The resulting type after applying the `+` operator.

1.9.0 · [Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#433)

### impl [AddAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.AddAssign.html "trait core::ops::arith::AddAssign")<[Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration")\> for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

[Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#434)

#### fn [add\_assign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.AddAssign.html#tymethod.add_assign)(&mut self, other: [Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration"))

Performs the `+=` operation. [Read more](https://doc.rust-lang.org/nightly/core/ops/arith/trait.AddAssign.html#tymethod.add_assign)

1.8.0 · [Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#153)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

[Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#153)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Instant](struct.Instant.html "struct bevy::platform::time::Instant")
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

1.8.0 · [Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#476)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

[Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#477)
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/time/mod.rs.html#130)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Instant](struct.Instant.html "struct bevy::platform::time::Instant")\> for [Uptime](../../log/tracing_subscriber/fmt/time/struct.Uptime.html "struct bevy::log::tracing_subscriber::fmt::time::Uptime")

[Source](https://docs.rs/tracing-subscriber/0.3.23/x86_64-unknown-linux-gnu/src/tracing_subscriber/fmt/time/mod.rs.html#131)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(epoch: [Instant](struct.Instant.html "struct bevy::platform::time::Instant")) -> [Uptime](../../log/tracing_subscriber/fmt/time/struct.Uptime.html "struct bevy::log::tracing_subscriber::fmt::time::Uptime")
...
### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/impls/bevy_platform/time.rs.html#3-5)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/impls/bevy_platform/time.rs.html#3-5)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)(arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[Instant](struct.Instant.html "struct bevy::platform::time::Instant") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>

Creates an item from an argument. [Read more](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/impls/bevy_platform/time.rs.html#3-5)

### impl [FromReflect](../../prelude/trait.FromReflect.html "trait bevy::prelude::FromReflect") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/impls/bevy_platform/time.rs.html#3-5)

#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)(reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Instant](struct.Instant.html "struct bevy::platform::time::Instant")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")
...
### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")
...
where [Instant](struct.Instant.html "struct bevy::platform::time::Instant"): 'into\_return,
...
### impl [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

[Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#153)

#### fn [cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html#tymethod.cmp)(&self, other: &[Instant](struct.Instant.html "struct bevy::platform::time::Instant")) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

[Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#153)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Instant](struct.Instant.html "struct bevy::platform::time::Instant")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

[Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#153)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[Instant](struct.Instant.html "struct bevy::platform::time::Instant")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")\>
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Instant](struct.Instant.html "struct bevy::platform::time::Instant")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/impls/bevy_platform/time.rs.html#3-5)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Instant](struct.Instant.html "struct bevy::platform::time::Instant")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Instant](struct.Instant.html "struct bevy::platform::time::Instant")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/impls/bevy_platform/time.rs.html#4)
...
### impl [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/impls/bevy_platform/time.rs.html#3-5)

#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Instant](struct.Instant.html "struct bevy::platform::time::Instant")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[Instant](struct.Instant.html "struct bevy::platform::time::Instant")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

1.8.0 · [Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#457)

### impl [Sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html "trait core::ops::arith::Sub") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

[Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#470)

#### fn [sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#tymethod.sub)(self, other: [Instant](struct.Instant.html "struct bevy::platform::time::Instant")) -> [Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration")

Returns the amount of time elapsed from another instant to this one, or zero duration if that instant is later than this one.

##### Panics

Previous Rust versions panicked when `other` was later than `self`. Currently this method saturates. Future versions may reintroduce the panic in some circumstances. See [Monotonicity](struct.Instant.html#monotonicity "struct bevy::platform::time::Instant").

[Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#458)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#associatedtype.Output) = [Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration")

The resulting type after applying the `-` operator.

1.8.0 · [Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#440)

### impl [Sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html "trait core::ops::arith::Sub")<[Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration")\> for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

[Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#441)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#associatedtype.Output) = [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

The resulting type after applying the `-` operator.

[Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#444)

#### fn [sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#tymethod.sub)(self, other: [Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration")) -> [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

Performs the `-` operation. [Read more](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#tymethod.sub)

1.9.0 · [Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#450)

### impl [SubAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html "trait core::ops::arith::SubAssign")<[Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration")\> for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

[Source](https://doc.rust-lang.org/nightly/src/std/time.rs.html#451)

#### fn [sub\_assign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html#tymethod.sub_assign)(&mut self, other: [Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration"))

Performs the `-=` operation. [Read more](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html#tymethod.sub_assign)

[Source](https://docs.rs/bevy_reflect/0.19.0/x86_64-unknown-linux-gnu/src/bevy_reflect/impls/bevy_platform/time.rs.html#3-5)

### impl [TypePath](../../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Instant](struct.Instant.html "struct bevy::platform::time::Instant")
