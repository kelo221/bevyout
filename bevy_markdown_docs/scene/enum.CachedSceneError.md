...
# Enum CachedSceneError 

[Source](https://docs.rs/bevy_scene/0.19.0/x86_64-unknown-linux-gnu/src/bevy_scene/resolved_scene.rs.html#555)
...
`id: [UntypedAssetId](../asset/enum.UntypedAssetId.html "enum bevy::asset::UntypedAssetId")`
...
Caused when attempting to include a cached scene when a [`ResolvedScene`](struct.ResolvedScene.html "struct bevy::scene::ResolvedScene") already has [`Template`](../prelude/trait.Template.html "trait bevy::prelude::Template")s or related scenes.
...
[Source](https://docs.rs/bevy_scene/0.19.0/x86_64-unknown-linux-gnu/src/bevy_scene/resolved_scene.rs.html#554)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [CachedSceneError](enum.CachedSceneError.html "enum bevy::scene::CachedSceneError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [CachedSceneError](enum.CachedSceneError.html "enum bevy::scene::CachedSceneError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [CachedSceneError](enum.CachedSceneError.html "enum bevy::scene::CachedSceneError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [CachedSceneError](enum.CachedSceneError.html "enum bevy::scene::CachedSceneError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [CachedSceneError](enum.CachedSceneError.html "enum bevy::scene::CachedSceneError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [CachedSceneError](enum.CachedSceneError.html "enum bevy::scene::CachedSceneError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [CachedSceneError](enum.CachedSceneError.html "enum bevy::scene::CachedSceneError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [CachedSceneError](enum.CachedSceneError.html "enum bevy::scene::CachedSceneError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [CachedSceneError](enum.CachedSceneError.html "enum bevy::scene::CachedSceneError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [CachedSceneError](enum.CachedSceneError.html "enum bevy::scene::CachedSceneError")
