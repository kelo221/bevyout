...
# Struct SceneListPatch 

[Source](https://docs.rs/bevy_scene/0.19.0/x86_64-unknown-linux-gnu/src/bevy_scene/scene_patch.rs.html#114)
...
`scene_list: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [SceneList](../prelude/trait.SceneList.html "trait bevy::prelude::SceneList")>>`

A [`SceneList`](../prelude/trait.SceneList.html "trait bevy::prelude::SceneList").
...
The dependencies of `scene_list` (populated using [`SceneList::register_dependencies`](../prelude/trait.SceneList.html#tymethod.register_dependencies "method bevy::prelude::SceneList::register_dependencies")). These are “asset dependencies” and will affect the load state.

`resolved: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ResolvedSceneListRoot](struct.ResolvedSceneListRoot.html "struct bevy::scene::ResolvedSceneListRoot")>`

The [`ResolvedSceneListRoot`](struct.ResolvedSceneListRoot.html "struct bevy::scene::ResolvedSceneListRoot"), if exists. This is populated after the scene list and its dependencies have been loaded and resolved.

## Implementations

[Source](https://docs.rs/bevy_scene/0.19.0/x86_64-unknown-linux-gnu/src/bevy_scene/scene_patch.rs.html#127)

### impl [SceneListPatch](struct.SceneListPatch.html "struct bevy::scene::SceneListPatch")

[Source](https://docs.rs/bevy_scene/0.19.0/x86_64-unknown-linux-gnu/src/bevy_scene/scene_patch.rs.html#130)

#### pub fn [load](#method.load)<L>(assets: &[AssetServer](../prelude/struct.AssetServer.html "struct bevy::prelude::AssetServer"), scene\_list: L) -> [SceneListPatch](struct.SceneListPatch.html "struct bevy::scene::SceneListPatch")

where L: [SceneList](../prelude/trait.SceneList.html "trait bevy::prelude::SceneList"),

Kicks off a load of the `scene_list`. This enumerates the scene list’s dependencies using [`SceneList::register_dependencies`](../prelude/trait.SceneList.html#tymethod.register_dependencies "method bevy::prelude::SceneList::register_dependencies"), loads them using the given [`AssetServer`](../prelude/struct.AssetServer.html "struct bevy::prelude::AssetServer"), and assigns the resulting asset handles to [`SceneListPatch::dependencies`](struct.SceneListPatch.html#structfield.dependencies "field bevy::scene::SceneListPatch::dependencies").

[Source](https://docs.rs/bevy_scene/0.19.0/x86_64-unknown-linux-gnu/src/bevy_scene/scene_patch.rs.html#146-150)
...
Resolves the current `scene` (using [`SceneList::resolve_list`](../prelude/trait.SceneList.html#tymethod.resolve_list "method bevy::prelude::SceneList::resolve_list")). This should only be called after every dependency has loaded from the `scene_list`’s [`SceneList::register_dependencies`](../prelude/trait.SceneList.html#tymethod.register_dependencies "method bevy::prelude::SceneList::register_dependencies").

[Source](https://docs.rs/bevy_scene/0.19.0/x86_64-unknown-linux-gnu/src/bevy_scene/scene_patch.rs.html#160)

#### pub fn [spawn](#method.spawn)<'w>( &self, world: &'w mut [World](../prelude/struct.World.html "struct bevy::prelude::World"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Vec](../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[Entity](../prelude/struct.Entity.html "struct bevy::prelude::Entity")\>, [SpawnSceneError](enum.SpawnSceneError.html "enum bevy::scene::SpawnSceneError")\>

Spawns the scene list in `world` as new entities. This should only be called after [`SceneListPatch::resolve`](struct.SceneListPatch.html#method.resolve "method bevy::scene::SceneListPatch::resolve").

## Trait Implementations

[Source](https://docs.rs/bevy_scene/0.19.0/x86_64-unknown-linux-gnu/src/bevy_scene/scene_patch.rs.html#113)

### impl [Asset](../prelude/trait.Asset.html "trait bevy::prelude::Asset") for [SceneListPatch](struct.SceneListPatch.html "struct bevy::scene::SceneListPatch")

[Source](https://docs.rs/bevy_scene/0.19.0/x86_64-unknown-linux-gnu/src/bevy_scene/scene_patch.rs.html#113)

### impl [TypePath](../prelude/trait.TypePath.html "trait bevy::prelude::TypePath") for [SceneListPatch](struct.SceneListPatch.html "struct bevy::scene::SceneListPatch")
...
### impl [VisitAssetDependencies](../asset/trait.VisitAssetDependencies.html "trait bevy::asset::VisitAssetDependencies") for [SceneListPatch](struct.SceneListPatch.html "struct bevy::scene::SceneListPatch")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SceneListPatch](struct.SceneListPatch.html "struct bevy::scene::SceneListPatch")

### impl ![Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SceneListPatch](struct.SceneListPatch.html "struct bevy::scene::SceneListPatch")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SceneListPatch](struct.SceneListPatch.html "struct bevy::scene::SceneListPatch")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SceneListPatch](struct.SceneListPatch.html "struct bevy::scene::SceneListPatch")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SceneListPatch](struct.SceneListPatch.html "struct bevy::scene::SceneListPatch")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SceneListPatch](struct.SceneListPatch.html "struct bevy::scene::SceneListPatch")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SceneListPatch](struct.SceneListPatch.html "struct bevy::scene::SceneListPatch")
