...
# Enum SpawnSceneError 

[Source](https://docs.rs/bevy_scene/0.19.0/x86_64-unknown-linux-gnu/src/bevy_scene/scene_patch.rs.html#94)

```rust
pub enum SpawnSceneError {
    ApplySceneError(ApplySceneError),
    ResolveSceneError(ResolveSceneError),
...
### ApplySceneError([ApplySceneError](enum.ApplySceneError.html "enum bevy::scene::ApplySceneError"))

Failed to apply a [`ResolvedScene`](struct.ResolvedScene.html "struct bevy::scene::ResolvedScene").

### ResolveSceneError([ResolveSceneError](enum.ResolveSceneError.html "enum bevy::scene::ResolveSceneError"))

Calling [`Scene::resolve`](../prelude/trait.Scene.html#tymethod.resolve "method bevy::prelude::Scene::resolve") failed.
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [SpawnSceneError](enum.SpawnSceneError.html "enum bevy::scene::SpawnSceneError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [SpawnSceneError](enum.SpawnSceneError.html "enum bevy::scene::SpawnSceneError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [SpawnSceneError](enum.SpawnSceneError.html "enum bevy::scene::SpawnSceneError")
...
### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SpawnSceneError](enum.SpawnSceneError.html "enum bevy::scene::SpawnSceneError")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SpawnSceneError](enum.SpawnSceneError.html "enum bevy::scene::SpawnSceneError")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SpawnSceneError](enum.SpawnSceneError.html "enum bevy::scene::SpawnSceneError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SpawnSceneError](enum.SpawnSceneError.html "enum bevy::scene::SpawnSceneError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SpawnSceneError](enum.SpawnSceneError.html "enum bevy::scene::SpawnSceneError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SpawnSceneError](enum.SpawnSceneError.html "enum bevy::scene::SpawnSceneError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [SpawnSceneError](enum.SpawnSceneError.html "enum bevy::scene::SpawnSceneError")
