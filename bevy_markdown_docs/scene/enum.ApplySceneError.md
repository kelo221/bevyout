...
# Enum ApplySceneError 

[Source](https://docs.rs/bevy_scene/0.19.0/x86_64-unknown-linux-gnu/src/bevy_scene/resolved_scene.rs.html#578)
...
### TemplateBuildError([BevyError](../prelude/struct.BevyError.html "struct bevy::prelude::BevyError"))

Caused when a [`Template`](../prelude/trait.Template.html "trait bevy::prelude::Template") fails to build

### CachedSceneApplyError

Caused when the cached [`ResolvedScene`](struct.ResolvedScene.html "struct bevy::scene::ResolvedScene") fails to apply a [`ResolvedScene`](struct.ResolvedScene.html "struct bevy::scene::ResolvedScene").

#### Fields

`cached: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[AssetPath](../asset/struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>>`

The asset path of the cached scene that failed to apply.

`error: [Box](../prelude/struct.Box.html "struct bevy::prelude::Box")<[ApplySceneError](enum.ApplySceneError.html "enum bevy::scene::ApplySceneError")>`
...
`path: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[AssetPath](../asset/struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>>`

The path of the cached scene.

`id: [AssetId](../prelude/enum.AssetId.html "enum bevy::prelude::AssetId")<[ScenePatch](struct.ScenePatch.html "struct bevy::scene::ScenePatch")>`
...
Caused when a related [`ResolvedScene`](struct.ResolvedScene.html "struct bevy::scene::ResolvedScene") fails to apply.

#### Fields

`relationship_type_name: &'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)`
...
[Source](https://docs.rs/bevy_scene/0.19.0/x86_64-unknown-linux-gnu/src/bevy_scene/resolved_scene.rs.html#577)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ApplySceneError](enum.ApplySceneError.html "enum bevy::scene::ApplySceneError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [ApplySceneError](enum.ApplySceneError.html "enum bevy::scene::ApplySceneError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [ApplySceneError](enum.ApplySceneError.html "enum bevy::scene::ApplySceneError")
...
[Source](https://docs.rs/bevy_scene/0.19.0/x86_64-unknown-linux-gnu/src/bevy_scene/scene_patch.rs.html#99)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[ApplySceneError](enum.ApplySceneError.html "enum bevy::scene::ApplySceneError")\> for [SpawnSceneError](enum.SpawnSceneError.html "enum bevy::scene::SpawnSceneError")

[Source](https://docs.rs/bevy_scene/0.19.0/x86_64-unknown-linux-gnu/src/bevy_scene/scene_patch.rs.html#93)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(source: [ApplySceneError](enum.ApplySceneError.html "enum bevy::scene::ApplySceneError")) -> [SpawnSceneError](enum.SpawnSceneError.html "enum bevy::scene::SpawnSceneError")

Converts to this type from the input type.

## Auto Trait Implementations

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ApplySceneError](enum.ApplySceneError.html "enum bevy::scene::ApplySceneError")

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ApplySceneError](enum.ApplySceneError.html "enum bevy::scene::ApplySceneError")

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ApplySceneError](enum.ApplySceneError.html "enum bevy::scene::ApplySceneError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ApplySceneError](enum.ApplySceneError.html "enum bevy::scene::ApplySceneError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ApplySceneError](enum.ApplySceneError.html "enum bevy::scene::ApplySceneError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ApplySceneError](enum.ApplySceneError.html "enum bevy::scene::ApplySceneError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ApplySceneError](enum.ApplySceneError.html "enum bevy::scene::ApplySceneError")
