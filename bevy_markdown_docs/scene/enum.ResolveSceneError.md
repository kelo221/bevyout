...
# Enum ResolveSceneError 

[Source](https://docs.rs/bevy_scene/0.19.0/x86_64-unknown-linux-gnu/src/bevy_scene/scene.rs.html#157)

```rust
pub enum ResolveSceneError {
    MissingSceneDependency(AssetPath<'static>),
    CachedSceneError(CachedSceneError),
    MissingScene,
}
```
...
### MissingSceneDependency([AssetPath](../asset/struct.AssetPath.html "struct bevy::asset::AssetPath")<'static>)

Caused when a dependency listed in [`Scene::register_dependencies`](../prelude/trait.Scene.html#method.register_dependencies "method bevy::prelude::Scene::register_dependencies") is not available when calling [`Scene::resolve`](../prelude/trait.Scene.html#tymethod.resolve "method bevy::prelude::Scene::resolve")

### CachedSceneError([CachedSceneError](enum.CachedSceneError.html "enum bevy::scene::CachedSceneError"))

Caused when including a cached scene during [`Scene::resolve`](../prelude/trait.Scene.html#tymethod.resolve "method bevy::prelude::Scene::resolve") fails.

### MissingScene

Caused when a [`Scene`](../prelude/trait.Scene.html "trait bevy::prelude::Scene")/[`SceneList`](../prelude/trait.SceneList.html "trait bevy::prelude::SceneList") is not present on the scene asset.

## Trait Implementations

[Source](https://docs.rs/bevy_scene/0.19.0/x86_64-unknown-linux-gnu/src/bevy_scene/scene.rs.html#156)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ResolveSceneError](enum.ResolveSceneError.html "enum bevy::scene::ResolveSceneError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [ResolveSceneError](enum.ResolveSceneError.html "enum bevy::scene::ResolveSceneError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [ResolveSceneError](enum.ResolveSceneError.html "enum bevy::scene::ResolveSceneError")
...
[Source](https://docs.rs/bevy_scene/0.19.0/x86_64-unknown-linux-gnu/src/bevy_scene/scene.rs.html#163)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[CachedSceneError](enum.CachedSceneError.html "enum bevy::scene::CachedSceneError")\> for [ResolveSceneError](enum.ResolveSceneError.html "enum bevy::scene::ResolveSceneError")

[Source](https://docs.rs/bevy_scene/0.19.0/x86_64-unknown-linux-gnu/src/bevy_scene/scene.rs.html#156)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(source: [CachedSceneError](enum.CachedSceneError.html "enum bevy::scene::CachedSceneError")) -> [ResolveSceneError](enum.ResolveSceneError.html "enum bevy::scene::ResolveSceneError")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_scene/0.19.0/x86_64-unknown-linux-gnu/src/bevy_scene/scene_patch.rs.html#102)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[ResolveSceneError](enum.ResolveSceneError.html "enum bevy::scene::ResolveSceneError")\> for [SpawnSceneError](enum.SpawnSceneError.html "enum bevy::scene::SpawnSceneError")

[Source](https://docs.rs/bevy_scene/0.19.0/x86_64-unknown-linux-gnu/src/bevy_scene/scene_patch.rs.html#93)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(source: [ResolveSceneError](enum.ResolveSceneError.html "enum bevy::scene::ResolveSceneError")) -> [SpawnSceneError](enum.SpawnSceneError.html "enum bevy::scene::SpawnSceneError")

Converts to this type from the input type.

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ResolveSceneError](enum.ResolveSceneError.html "enum bevy::scene::ResolveSceneError")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ResolveSceneError](enum.ResolveSceneError.html "enum bevy::scene::ResolveSceneError")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ResolveSceneError](enum.ResolveSceneError.html "enum bevy::scene::ResolveSceneError")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ResolveSceneError](enum.ResolveSceneError.html "enum bevy::scene::ResolveSceneError")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ResolveSceneError](enum.ResolveSceneError.html "enum bevy::scene::ResolveSceneError")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [ResolveSceneError](enum.ResolveSceneError.html "enum bevy::scene::ResolveSceneError")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ResolveSceneError](enum.ResolveSceneError.html "enum bevy::scene::ResolveSceneError")
