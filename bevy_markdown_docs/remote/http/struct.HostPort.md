...
[Source](https://docs.rs/bevy_remote/0.19.0/x86_64-unknown-linux-gnu/src/bevy_remote/http.rs.html#227)
...
Currently, changing this while the application is running has no effect; this merely reflects the host that is set during the setup of the [`RemoteHttpPlugin`](struct.RemoteHttpPlugin.html "struct bevy::remote::http::RemoteHttpPlugin").
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [HostPort](struct.HostPort.html "struct bevy::remote::http::HostPort")

where [HostPort](struct.HostPort.html "struct bevy::remote::http::HostPort"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [HostPort](struct.HostPort.html "struct bevy::remote::http::HostPort")
...
### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [HostPort](struct.HostPort.html "struct bevy::remote::http::HostPort")

where [HostPort](struct.HostPort.html "struct bevy::remote::http::HostPort"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [HostPort](struct.HostPort.html "struct bevy::remote::http::HostPort")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [HostPort](struct.HostPort.html "struct bevy::remote::http::HostPort")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [HostPort](struct.HostPort.html "struct bevy::remote::http::HostPort")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [HostPort](struct.HostPort.html "struct bevy::remote::http::HostPort")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [HostPort](struct.HostPort.html "struct bevy::remote::http::HostPort")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [HostPort](struct.HostPort.html "struct bevy::remote::http::HostPort")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [HostPort](struct.HostPort.html "struct bevy::remote::http::HostPort")
