...
[Source](https://docs.rs/bevy_remote/0.19.0/x86_64-unknown-linux-gnu/src/bevy_remote/http.rs.html#220)
...
Currently, changing this while the application is running has no effect; this merely reflects the IP address that is set during the setup of the [`RemoteHttpPlugin`](struct.RemoteHttpPlugin.html "struct bevy::remote::http::RemoteHttpPlugin").

## Tuple Fields

`0: [IpAddr](https://doc.rust-lang.org/nightly/core/net/ip_addr/enum.IpAddr.html "enum core::net::ip_addr::IpAddr")`

## Trait Implementations

[Source](https://docs.rs/bevy_remote/0.19.0/x86_64-unknown-linux-gnu/src/bevy_remote/http.rs.html#219)

### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [HostAddress](struct.HostAddress.html "struct bevy::remote::http::HostAddress")

where [HostAddress](struct.HostAddress.html "struct bevy::remote::http::HostAddress"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [HostAddress](struct.HostAddress.html "struct bevy::remote::http::HostAddress")
...
### impl [Resource](../../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [HostAddress](struct.HostAddress.html "struct bevy::remote::http::HostAddress")

where [HostAddress](struct.HostAddress.html "struct bevy::remote::http::HostAddress"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [HostAddress](struct.HostAddress.html "struct bevy::remote::http::HostAddress")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [HostAddress](struct.HostAddress.html "struct bevy::remote::http::HostAddress")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [HostAddress](struct.HostAddress.html "struct bevy::remote::http::HostAddress")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [HostAddress](struct.HostAddress.html "struct bevy::remote::http::HostAddress")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [HostAddress](struct.HostAddress.html "struct bevy::remote::http::HostAddress")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [HostAddress](struct.HostAddress.html "struct bevy::remote::http::HostAddress")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [HostAddress](struct.HostAddress.html "struct bevy::remote::http::HostAddress")
