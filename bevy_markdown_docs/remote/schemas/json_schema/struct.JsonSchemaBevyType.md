...
# Struct JsonSchemaBevyType 

[Source](https://docs.rs/bevy_remote/0.19.0/x86_64-unknown-linux-gnu/src/bevy_remote/schemas/json_schema.rs.html#224)
...
`short_path: [String](../../../prelude/struct.String.html "struct bevy::prelude::String")`

Bevy specific field, short path of the type.

`type_path: [String](../../../prelude/struct.String.html "struct bevy::prelude::String")`

Bevy specific field, full path of the type.

`module_path: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[String](../../../prelude/struct.String.html "struct bevy::prelude::String")>`

Bevy specific field, path of the module that type is part of.

`crate_name: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[String](../../../prelude/struct.String.html "struct bevy::prelude::String")>`

Bevy specific field, name of the crate that type is part of.

`reflect_types: [Vec](../../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[String](../../../prelude/struct.String.html "struct bevy::prelude::String")>`

Bevy specific field, names of the types that type reflects.

`kind: [SchemaKind](enum.SchemaKind.html "enum bevy::remote::schemas::json_schema::SchemaKind")`

Bevy specific field, [`TypeInfo`](../../../reflect/enum.TypeInfo.html "enum bevy::reflect::TypeInfo") type mapping.

`key_type: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Value](https://docs.rs/serde_json/1.0.150/x86_64-unknown-linux-gnu/serde_json/value/enum.Value.html "enum serde_json::value::Value")>`

Bevy specific field, provided when [`SchemaKind`](enum.SchemaKind.html "enum bevy::remote::schemas::json_schema::SchemaKind") `kind` field is equal to [`SchemaKind::Map`](enum.SchemaKind.html#variant.Map "variant bevy::remote::schemas::json_schema::SchemaKind::Map").

It contains type info of key of the Map.

`value_type: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Value](https://docs.rs/serde_json/1.0.150/x86_64-unknown-linux-gnu/serde_json/value/enum.Value.html "enum serde_json::value::Value")>`

Bevy specific field, provided when [`SchemaKind`](enum.SchemaKind.html "enum bevy::remote::schemas::json_schema::SchemaKind") `kind` field is equal to [`SchemaKind::Map`](enum.SchemaKind.html#variant.Map "variant bevy::remote::schemas::json_schema::SchemaKind::Map").

It contains type info of value of the Map.

`schema_type: [SchemaType](enum.SchemaType.html "enum bevy::remote::schemas::json_schema::SchemaType")`

The type keyword is fundamental to JSON Schema. It specifies the data type for a schema.

`additional_properties: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)>`
...
`component_info: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[ComponentMetadata](struct.ComponentMetadata.html "struct bevy::remote::schemas::json_schema::ComponentMetadata")>`

Additional metadata if this schema represents a component.

`properties: [HashMap](../../../platform/collections/struct.HashMap.html "struct bevy::platform::collections::HashMap")<[String](../../../prelude/struct.String.html "struct bevy::prelude::String"), [Value](https://docs.rs/serde_json/1.0.150/x86_64-unknown-linux-gnu/serde_json/value/enum.Value.html "enum serde_json::value::Value")>`

Validation succeeds if, for each name that appears in both the instance and as a name within this keyword’s value, the child instance for that name successfully validates against the corresponding schema.

`required: [Vec](../../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[String](../../../prelude/struct.String.html "struct bevy::prelude::String")>`

An object instance is valid against this keyword if every item in the array is the name of a property in the instance.

`one_of: [Vec](../../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[Value](https://docs.rs/serde_json/1.0.150/x86_64-unknown-linux-gnu/serde_json/value/enum.Value.html "enum serde_json::value::Value")>`

An instance validates successfully against this keyword if it validates successfully against exactly one schema defined by this keyword’s value.

`prefix_items: [Vec](../../../prelude/struct.Vec.html "struct bevy::prelude::Vec")<[Value](https://docs.rs/serde_json/1.0.150/x86_64-unknown-linux-gnu/serde_json/value/enum.Value.html "enum serde_json::value::Value")>`
...
`items: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Value](https://docs.rs/serde_json/1.0.150/x86_64-unknown-linux-gnu/serde_json/value/enum.Value.html "enum serde_json::value::Value")>`
...
[Source](https://docs.rs/bevy_remote/0.19.0/x86_64-unknown-linux-gnu/src/bevy_remote/schemas/json_schema.rs.html#222)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [JsonSchemaBevyType](struct.JsonSchemaBevyType.html "struct bevy::remote::schemas::json_schema::JsonSchemaBevyType")

[Source](https://docs.rs/bevy_remote/0.19.0/x86_64-unknown-linux-gnu/src/bevy_remote/schemas/json_schema.rs.html#222)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [JsonSchemaBevyType](struct.JsonSchemaBevyType.html "struct bevy::remote::schemas::json_schema::JsonSchemaBevyType")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [JsonSchemaBevyType](struct.JsonSchemaBevyType.html "struct bevy::remote::schemas::json_schema::JsonSchemaBevyType")
...
### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [JsonSchemaBevyType](struct.JsonSchemaBevyType.html "struct bevy::remote::schemas::json_schema::JsonSchemaBevyType")

[Source](https://docs.rs/bevy_remote/0.19.0/x86_64-unknown-linux-gnu/src/bevy_remote/schemas/json_schema.rs.html#222)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [JsonSchemaBevyType](struct.JsonSchemaBevyType.html "struct bevy::remote::schemas::json_schema::JsonSchemaBevyType")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_remote/0.19.0/x86_64-unknown-linux-gnu/src/bevy_remote/schemas/json_schema.rs.html#222)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [JsonSchemaBevyType](struct.JsonSchemaBevyType.html "struct bevy::remote::schemas::json_schema::JsonSchemaBevyType")

[Source](https://docs.rs/bevy_remote/0.19.0/x86_64-unknown-linux-gnu/src/bevy_remote/schemas/json_schema.rs.html#222)

#### fn [deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html#tymethod.deserialize)<\_\_D>( \_\_deserializer: \_\_D, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[JsonSchemaBevyType](struct.JsonSchemaBevyType.html "struct bevy::remote::schemas::json_schema::JsonSchemaBevyType"), <\_\_D as [Deserializer](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html "trait serde_core::de::Deserializer")<'de>>::[Error](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserializer.html#associatedtype.Error "type serde_core::de::Deserializer::Error")\>
...
[Source](https://docs.rs/bevy_remote/0.19.0/x86_64-unknown-linux-gnu/src/bevy_remote/schemas/json_schema.rs.html#60)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<(&[TypeRegistration](../../../reflect/struct.TypeRegistration.html "struct bevy::reflect::TypeRegistration"), &[SchemaTypesMetadata](../struct.SchemaTypesMetadata.html "struct bevy::remote::schemas::SchemaTypesMetadata"), &[Components](../../../ecs/component/struct.Components.html "struct bevy::ecs::component::Components"))> for [JsonSchemaBevyType](struct.JsonSchemaBevyType.html "struct bevy::remote::schemas::json_schema::JsonSchemaBevyType")

[Source](https://docs.rs/bevy_remote/0.19.0/x86_64-unknown-linux-gnu/src/bevy_remote/schemas/json_schema.rs.html#61)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)( value: (&[TypeRegistration](../../../reflect/struct.TypeRegistration.html "struct bevy::reflect::TypeRegistration"), &[SchemaTypesMetadata](../struct.SchemaTypesMetadata.html "struct bevy::remote::schemas::SchemaTypesMetadata"), &[Components](../../../ecs/component/struct.Components.html "struct bevy::ecs::component::Components")), ) -> [JsonSchemaBevyType](struct.JsonSchemaBevyType.html "struct bevy::remote::schemas::json_schema::JsonSchemaBevyType")

Converts to this type from the input type.

[Source](https://docs.rs/bevy_remote/0.19.0/x86_64-unknown-linux-gnu/src/bevy_remote/schemas/json_schema.rs.html#222)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [JsonSchemaBevyType](struct.JsonSchemaBevyType.html "struct bevy::remote::schemas::json_schema::JsonSchemaBevyType")

[Source](https://docs.rs/bevy_remote/0.19.0/x86_64-unknown-linux-gnu/src/bevy_remote/schemas/json_schema.rs.html#222)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[JsonSchemaBevyType](struct.JsonSchemaBevyType.html "struct bevy::remote::schemas::json_schema::JsonSchemaBevyType")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [JsonSchemaBevyType](struct.JsonSchemaBevyType.html "struct bevy::remote::schemas::json_schema::JsonSchemaBevyType")
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [JsonSchemaBevyType](struct.JsonSchemaBevyType.html "struct bevy::remote::schemas::json_schema::JsonSchemaBevyType")

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [JsonSchemaBevyType](struct.JsonSchemaBevyType.html "struct bevy::remote::schemas::json_schema::JsonSchemaBevyType")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [JsonSchemaBevyType](struct.JsonSchemaBevyType.html "struct bevy::remote::schemas::json_schema::JsonSchemaBevyType")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [JsonSchemaBevyType](struct.JsonSchemaBevyType.html "struct bevy::remote::schemas::json_schema::JsonSchemaBevyType")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [JsonSchemaBevyType](struct.JsonSchemaBevyType.html "struct bevy::remote::schemas::json_schema::JsonSchemaBevyType")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [JsonSchemaBevyType](struct.JsonSchemaBevyType.html "struct bevy::remote::schemas::json_schema::JsonSchemaBevyType")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [JsonSchemaBevyType](struct.JsonSchemaBevyType.html "struct bevy::remote::schemas::json_schema::JsonSchemaBevyType")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [JsonSchemaBevyType](struct.JsonSchemaBevyType.html "struct bevy::remote::schemas::json_schema::JsonSchemaBevyType")
