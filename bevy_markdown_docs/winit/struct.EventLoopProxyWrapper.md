...
[Source](https://docs.rs/bevy_winit/0.19.0/x86_64-unknown-linux-gnu/src/bevy_winit/lib.rs.html#206)

```rust
pub struct EventLoopProxyWrapper(/* private fields */);
```
...
## Methods from [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")<Target = [EventLoopProxy](struct.EventLoopProxy.html "struct bevy::winit::EventLoopProxy")<[WinitUserEvent](enum.WinitUserEvent.html "enum bevy::winit::WinitUserEvent")\>>

[Source](https://docs.rs/winit/0.30.13/x86_64-unknown-linux-gnu/src/winit/event_loop.rs.html#567)

#### pub fn [send\_event](#method.send_event)(&self, event: T) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [EventLoopClosed](https://docs.rs/winit/0.30.13/x86_64-unknown-linux-gnu/winit/event_loop/struct.EventLoopClosed.html "struct winit::event_loop::EventLoopClosed")<T>>

Send an event to the [`EventLoop`](https://docs.rs/winit/0.30.13/x86_64-unknown-linux-gnu/winit/event_loop/struct.EventLoop.html "struct winit::event_loop::EventLoop") from which this proxy was created. This emits a `UserEvent(event)` event in the event loop, where `event` is the value passed to this function.

Returns an `Err` if the associated [`EventLoop`](https://docs.rs/winit/0.30.13/x86_64-unknown-linux-gnu/winit/event_loop/struct.EventLoop.html "struct winit::event_loop::EventLoop") no longer exists.

##### [Examples found in repository](#scraped-examples)[?](../../scrape-examples-help.html)

examples/window/low\_power.rs ([line 99](../../src/low_power/low_power.rs.html#99))
...
### impl [Component](../prelude/trait.Component.html "trait bevy::prelude::Component") for [EventLoopProxyWrapper](struct.EventLoopProxyWrapper.html "struct bevy::winit::EventLoopProxyWrapper")

where [EventLoopProxyWrapper](struct.EventLoopProxyWrapper.html "struct bevy::winit::EventLoopProxyWrapper"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [EventLoopProxyWrapper](struct.EventLoopProxyWrapper.html "struct bevy::winit::EventLoopProxyWrapper")

[Source](https://docs.rs/bevy_winit/0.19.0/x86_64-unknown-linux-gnu/src/bevy_winit/lib.rs.html#205)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = [EventLoopProxy](struct.EventLoopProxy.html "struct bevy::winit::EventLoopProxy")<[WinitUserEvent](enum.WinitUserEvent.html "enum bevy::winit::WinitUserEvent")\>

The resulting type after dereferencing.

[Source](https://docs.rs/bevy_winit/0.19.0/x86_64-unknown-linux-gnu/src/bevy_winit/lib.rs.html#205)

#### fn [deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#tymethod.deref)(&self) -> &<[EventLoopProxyWrapper](struct.EventLoopProxyWrapper.html "struct bevy::winit::EventLoopProxyWrapper") as [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")\>::[Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target "type core::ops::deref::Deref::Target")

Dereferences the value.

[Source](https://docs.rs/bevy_winit/0.19.0/x86_64-unknown-linux-gnu/src/bevy_winit/lib.rs.html#205)

### impl [Resource](../prelude/trait.Resource.html "trait bevy::prelude::Resource") for [EventLoopProxyWrapper](struct.EventLoopProxyWrapper.html "struct bevy::winit::EventLoopProxyWrapper")

where [EventLoopProxyWrapper](struct.EventLoopProxyWrapper.html "struct bevy::winit::EventLoopProxyWrapper"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,

## Auto Trait Implementations

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [EventLoopProxyWrapper](struct.EventLoopProxyWrapper.html "struct bevy::winit::EventLoopProxyWrapper")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [EventLoopProxyWrapper](struct.EventLoopProxyWrapper.html "struct bevy::winit::EventLoopProxyWrapper")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [EventLoopProxyWrapper](struct.EventLoopProxyWrapper.html "struct bevy::winit::EventLoopProxyWrapper")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [EventLoopProxyWrapper](struct.EventLoopProxyWrapper.html "struct bevy::winit::EventLoopProxyWrapper")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [EventLoopProxyWrapper](struct.EventLoopProxyWrapper.html "struct bevy::winit::EventLoopProxyWrapper")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [EventLoopProxyWrapper](struct.EventLoopProxyWrapper.html "struct bevy::winit::EventLoopProxyWrapper")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [EventLoopProxyWrapper](struct.EventLoopProxyWrapper.html "struct bevy::winit::EventLoopProxyWrapper")
