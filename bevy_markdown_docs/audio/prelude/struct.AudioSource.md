...
### impl [AsRef](https://doc.rust-lang.org/nightly/core/convert/trait.AsRef.html "trait core::convert::AsRef")<\[[u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)\]> for [AudioSource](../../prelude/struct.AudioSource.html "struct bevy::prelude::AudioSource")
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [AudioSource](../../prelude/struct.AudioSource.html "struct bevy::prelude::AudioSource")

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio_source.rs.html#7)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [AudioSource](../../prelude/struct.AudioSource.html "struct bevy::prelude::AudioSource")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [AudioSource](../../prelude/struct.AudioSource.html "struct bevy::prelude::AudioSource")
...
#### fn [decoder](../../prelude/trait.Decodable.html#tymethod.decoder)(&self) -> <[AudioSource](../../prelude/struct.AudioSource.html "struct bevy::prelude::AudioSource") as [Decodable](../../prelude/trait.Decodable.html "trait bevy::prelude::Decodable")\>::[Decoder](../../prelude/trait.Decodable.html#associatedtype.Decoder "type bevy::prelude::Decodable::Decoder")
...
### impl [VisitAssetDependencies](../../asset/trait.VisitAssetDependencies.html "trait bevy::asset::VisitAssetDependencies") for [AudioSource](../../prelude/struct.AudioSource.html "struct bevy::prelude::AudioSource")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AudioSource](../../prelude/struct.AudioSource.html "struct bevy::prelude::AudioSource")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AudioSource](../../prelude/struct.AudioSource.html "struct bevy::prelude::AudioSource")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AudioSource](../../prelude/struct.AudioSource.html "struct bevy::prelude::AudioSource")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AudioSource](../../prelude/struct.AudioSource.html "struct bevy::prelude::AudioSource")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AudioSource](../../prelude/struct.AudioSource.html "struct bevy::prelude::AudioSource")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [AudioSource](../../prelude/struct.AudioSource.html "struct bevy::prelude::AudioSource")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AudioSource](../../prelude/struct.AudioSource.html "struct bevy::prelude::AudioSource")
