[bevy](../../index.html)::[audio](../index.html)::[prelude](index.html)

# Struct PlaybackSettings 

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#35)
...
If you would like to control the audio while it is playing, query for the [`AudioSink`](../../prelude/struct.AudioSink.html "struct bevy::prelude::AudioSink") or [`SpatialAudioSink`](../../prelude/struct.SpatialAudioSink.html "struct bevy::prelude::SpatialAudioSink") components. Changes to this component will _not_ be applied to already-playing audio.

## Fields

`mode: [PlaybackMode](../enum.PlaybackMode.html "enum bevy::audio::PlaybackMode")`

The desired playback behavior.

`volume: [Volume](../enum.Volume.html "enum bevy::audio::Volume")`

Volume to play at.

`speed: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)`

Speed to play at.

`paused: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

Create the sink in paused state. Useful for “deferred playback”, if you want to prepare the entity, but hear the sound later.

`muted: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`
...
`spatial: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)`

Enables spatial audio for this source.

See also: [`SpatialListener`](../../prelude/struct.SpatialListener.html "struct bevy::prelude::SpatialListener").
...
`spatial_scale: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[SpatialScale](../struct.SpatialScale.html "struct bevy::audio::SpatialScale")>`

Optional scale factor applied to the positions of this audio source and the listener, overriding the default value configured on [`AudioPlugin::default_spatial_scale`](../struct.AudioPlugin.html#structfield.default_spatial_scale "field bevy::audio::AudioPlugin::default_spatial_scale").

`start_position: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration")>`
...
`duration: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration")>`
...
[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#79)

### impl [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#87)

#### pub const [ONCE](#associatedconstant.ONCE): [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

Will play the associated audio source once.

Note: It is not possible to reuse an [`AudioPlayer`](../../prelude/struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer") after it has finished playing and the underlying [`AudioSink`](../../prelude/struct.AudioSink.html "struct bevy::prelude::AudioSink") or [`SpatialAudioSink`](../../prelude/struct.SpatialAudioSink.html "struct bevy::prelude::SpatialAudioSink") has been drained.

To replay a sound, the audio components provided by [`AudioPlayer`](../../prelude/struct.AudioPlayer.html "struct bevy::prelude::AudioPlayer") must be removed and added again.

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#100)

#### pub const [LOOP](#associatedconstant.LOOP): [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

Will play the associated audio source in a loop.

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#106)

#### pub const [DESPAWN](#associatedconstant.DESPAWN): [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

Will play the associated audio source once and despawn the entity afterwards.

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#112)

#### pub const [REMOVE](#associatedconstant.REMOVE): [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

Will play the associated audio source once and remove the audio components afterwards.

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#118)

#### pub const fn [paused](#method.paused)(self) -> [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

Helper to start in a paused state.

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#124)

#### pub const fn [muted](#method.muted)(self) -> [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

Helper to start muted.

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#130)

#### pub const fn [with\_volume](#method.with_volume)(self, volume: [Volume](../enum.Volume.html "enum bevy::audio::Volume")) -> [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

Helper to set the volume from start of playback.

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#136)

#### pub const fn [with\_speed](#method.with_speed)(self, speed: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

Helper to set the speed from start of playback.

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#142)

#### pub const fn [with\_spatial](#method.with_spatial)(self, spatial: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)) -> [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

Helper to enable or disable spatial audio.

##### [Examples found in repository](#scraped-examples)[?](../../../scrape-examples-help.html)

examples/audio/spatial\_audio\_2d.rs ([line 42](../../../src/spatial_audio_2d/spatial_audio_2d.rs.html#42))
...
examples/audio/spatial\_audio\_3d.rs ([line 34](../../../src/spatial_audio_3d/spatial_audio_3d.rs.html#34))
...
[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#148)

#### pub const fn [with\_spatial\_scale](#method.with_spatial_scale)( self, spatial\_scale: [SpatialScale](../struct.SpatialScale.html "struct bevy::audio::SpatialScale"), ) -> [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

Helper to use a custom spatial scale.

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#154)

#### pub const fn [with\_start\_position](#method.with_start_position)( self, start\_position: [Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration"), ) -> [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

Helper to use a custom playback start position.

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#160)

#### pub const fn [with\_duration](#method.with_duration)(self, duration: [Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration")) -> [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#33)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")
...
### impl [Component](../../prelude/trait.Component.html "trait bevy::prelude::Component") for [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

where [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") + 'static,
...
### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#33)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")
...
[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#73)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#74)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#33)

### impl [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg") for [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#33)

#### type [This](../../reflect/func/args/trait.FromArg.html#associatedtype.This)<'from\_arg> = [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

The type to convert into. [Read more](../../reflect/func/args/trait.FromArg.html#associatedtype.This)

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#33)

#### fn [from\_arg](../../reflect/func/args/trait.FromArg.html#tymethod.from_arg)( arg: [Arg](../../reflect/func/args/struct.Arg.html "struct bevy::reflect::func::args::Arg")<'\_>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<<[PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings") as [FromArg](../../reflect/func/args/trait.FromArg.html "trait bevy::reflect::func::args::FromArg")\>::[This](../../reflect/func/args/trait.FromArg.html#associatedtype.This "type bevy::reflect::func::args::FromArg::This")<'\_>, [ArgError](../../reflect/func/enum.ArgError.html "enum bevy::reflect::func::ArgError")\>
...
#### fn [from\_reflect](../../prelude/trait.FromReflect.html#tymethod.from_reflect)( reflect: &(dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") + 'static), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")\>
...
### impl [GetOwnership](../../reflect/func/args/trait.GetOwnership.html "trait bevy::reflect::func::args::GetOwnership") for [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")
...
### impl [GetTypeRegistration](../../reflect/trait.GetTypeRegistration.html "trait bevy::reflect::GetTypeRegistration") for [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")
...
### impl [IntoReturn](../../reflect/func/trait.IntoReturn.html "trait bevy::reflect::func::IntoReturn") for [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")
...
where [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings"): 'into\_return,
...
### impl [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect") for [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")
...
#### fn [reflect\_owned](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")\>) -> [ReflectOwned](../../reflect/enum.ReflectOwned.html "enum bevy::reflect::ReflectOwned")

Returns an owned enumeration of “kinds” of type. [Read more](../../prelude/trait.PartialReflect.html#tymethod.reflect_owned)

[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#33)

#### fn [try\_into\_reflect](../../prelude/trait.PartialReflect.html#tymethod.try_into_reflect)( self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")\>, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>, [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>>
...
#### fn [into\_partial\_reflect](../../prelude/trait.PartialReflect.html#tymethod.into_partial_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [PartialReflect](../../prelude/trait.PartialReflect.html "trait bevy::prelude::PartialReflect")\>
...
[Source](https://docs.rs/bevy_audio/0.19.0/x86_64-unknown-linux-gnu/src/bevy_audio/audio.rs.html#34)
...
#### fn [into\_any](../../prelude/trait.Reflect.html#tymethod.into_any)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Any](https://doc.rust-lang.org/nightly/core/any/trait.Any.html "trait core::any::Any")\>
...
#### fn [into\_reflect](../../prelude/trait.Reflect.html#tymethod.into_reflect)(self: [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<[PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")\>) -> [Box](../../prelude/struct.Box.html "struct bevy::prelude::Box")<dyn [Reflect](../../prelude/trait.Reflect.html "trait bevy::prelude::Reflect")\>
...
### impl [Typed](../../reflect/trait.Typed.html "trait bevy::reflect::Typed") for [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

### impl [UnsafeUnpin](https://doc.rust-lang.org/nightly/core/marker/trait.UnsafeUnpin.html "trait core::marker::UnsafeUnpin") for [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [PlaybackSettings](../../prelude/struct.PlaybackSettings.html "struct bevy::prelude::PlaybackSettings")
