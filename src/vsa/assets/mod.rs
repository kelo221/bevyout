...
pub(crate) const NATIVE_NIF_CONVERTER_REVISION: &str = "nifty-fo3-native-v11-normal-y-v1-specular-normal-alpha-v1-fallout-shader-semantics-v2-emissive-quarter-cap-v1-shader-emission-gate-v2-physical-effect-bulb-v1-effect-emission-control-v1-light-card-promotion-v1-env-light-emission-v1-17f5769-pbr-material-v4-workers-v2-anim-xyzw-v1-audio-cues-v1-havok-joints-v1-com-frame-v1-ktx2-uastc-v1-segmented-trishape-v1-external-ktx2-v1";
...
pub(crate) const NATIVE_ACTOR_CONVERTER_REVISION: &str = "nifty-fo3-native-actor-assembly-v21-facegen-head-only-fregm002-fregt003-frtri003-egt-native-row-origin-hair-fit-v1-normal-y-v1-specular-normal-alpha-v1-pbr-material-v4-selective-head-anims-ktx2-uastc-v1-0dfd052-external-ktx2-v1";
...
pub(crate) const NATIVE_PREPARED_CONVERTER_REVISION: &str = "nifty-fo3-native-v11-normal-y-v1-specular-normal-alpha-v1-fallout-shader-semantics-v2-emissive-quarter-cap-v1-shader-emission-gate-v2-physical-effect-bulb-v1-effect-emission-control-v1-light-card-promotion-v1-env-light-emission-v1-17f5769-pbr-material-v4-workers-v2-anim-xyzw-v1-audio-cues-v1-havok-joints-v1-com-frame-v1-ktx2-uastc-v1-segmented-trishape-v1-external-ktx2-v1+actor-assembly-v21-facegen-head-only-fregm002-fregt003-frtri003-egt-native-row-origin-hair-fit-v1-normal-y-v1-specular-normal-alpha-v1-pbr-material-v4-selective-head-anims-ktx2-uastc-v1-17f5769-external-ktx2-v1+day-night-profile-v1";
