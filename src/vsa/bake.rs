...
mod tests {
    ...
    fn placement_with_semantic(semantic: PreparedSemantic) -> PreparedPlacement {
        PreparedPlacement {
            reference_form_id: 1,
            base_form_id: 2,
    ...
    fn only_static_semantics_are_batchable_without_changing_bake_inclusion() {
        let static_placement = placement_with_semantic(PreparedSemantic::Static);
        ...
        for semantic in [
            ...
            let placement = placement_with_semantic(semantic);
    ...
    fn relative_asset_path_requires_the_path_to_be_inside_root() {
        ...
        assert_eq!(
            relative_asset_path(root, Path::new("/cache/assets/scenes/00000001/scene.glb"))
                .unwrap(),
