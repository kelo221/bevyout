...
/// logic.
pub(crate) const PREPARE_PIPELINE_REVISION: &str = "prepare-pipeline-v7-corpse-nested-actors-actor-animations-weapon-animation-type-ktx2-textures-image-space-layouts";
