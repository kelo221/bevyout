...
/// corrected nested actor appearance resolution, and M4 wave 10 (#104)
/// added the prepared actor-animation catalog — all change what
...
pub(crate) const PREPARE_PIPELINE_REVISION: &str =
    "prepare-pipeline-v4-corpse-nested-actors-actor-animations";
