...
/// logic.
pub(crate) const PREPARE_PIPELINE_REVISION: &str = "prepare-pipeline-v10-static-facegen-reconstruction-corpse-nested-actors-actor-animations-weapon-animation-type-ktx2-textures-image-space-layouts-hud-sprites-staged-exterior-assets-only";
