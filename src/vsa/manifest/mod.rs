...
pub(crate) const CURRENT_BAKE_REVISION: &str = "rust-cpu-irradiance-v16-material-extensions-local-thickness-emissive-quarter-cap-shader-emission-gate-v2-physical-effect-bulb-v1-effect-emission-control-v1-light-card-promotion-v1-env-light-emission-v1-17f5769-lighting-contract-v1-uv1-vendored-xatlas-v1-direct-surface-lightmaps-v7-edge-supersample-two-bounce-shared-volume-geometry-aware-ray-bias-invalid-normal-v1-in-tree-rgba16f-rgb9e5-ktx2-v1-adaptive-sampling-v1-feature-guided-atrous-denoise-v1-spot-cone-v1-configurable-bounces-v1-density-overrides-v1-partial-primitive-light-invalidation-v1-debug-images-v1-area-emissive-mis-rr-variance-v1-variance-manifest-v1-environment-map-hdr-v1-environment-mis-v1-linear-factor-env-single-count-solari-transport-v2";
