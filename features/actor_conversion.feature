Feature: PyNifly actor conversion contract
  ...
  Scenario: The skeleton remains the reference when visual paths are sorted
    ...
    And the actor converter profile is "nifty-fo3-native-actor-assembly-v17-facegen-fregm002-fregt003-frtri003-normal-y-v1-specular-normal-alpha-v1-pbr-material-v3-selective-head-anims-ktx2-uastc-v1-0dfd052"
