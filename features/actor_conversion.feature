Feature: PyNifly actor conversion contract
  ...
  Scenario: The skeleton remains the reference when visual paths are sorted
    ...
    And the actor converter profile is "pynifly-v36-niftools-external-kf-pack-v5-normal-y-v1-pbr-material-v2-actor-bindpose-v22-eyes-creature-primary-fallback"
