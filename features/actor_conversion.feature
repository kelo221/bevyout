Feature: PyNifly actor conversion contract
  ...
  Scenario: The skeleton remains the reference when visual paths are sorted
    ...
    And the actor converter profile is "nifty-fo3-native-actor-assembly-v20-facegen-head-only-fregm002-fregt003-frtri003-egt-native-row-origin-hair-fit-v1-normal-y-v1-specular-normal-alpha-v1-pbr-material-v4-selective-head-anims-ktx2-uastc-v1-0dfd052"
