...
async fn given_interior_cell(world: &mut BevyoutWorld, hex: String, editor_id: String) {
...
async fn given_exterior_cell(world: &mut BevyoutWorld, hex: String, editor_id: String) {
    world.cells.push(CellSummary {
        form_id: form_id(&hex),
        editor_id: Some(editor_id),
        name: None,
...
async fn given_exterior_cell_in_worldspace(
    ...
    world.cells.push(CellSummary {
        ...
        name: None,
        interior: false,
        worldspace_form_id: Some(form_id(&worldspace_hex)),
    });
}
...
async fn given_worldspace_named(world: &mut BevyoutWorld, hex: String, name: String) {
    world.worldspace_names.push((form_id(&hex), name));
}
